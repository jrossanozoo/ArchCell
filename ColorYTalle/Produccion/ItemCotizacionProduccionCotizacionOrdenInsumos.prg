define class ItemCotizacionProduccionCotizacionOrdenInsumos as Din_ItemCotizacionProduccionCotizacionOrdenInsumos of Din_ItemCotizacionProduccionCotizacionOrdenInsumos.prg

	#if .f.
		local this as ItemCotizacionProduccionCotizacionOrdenInsumos of ItemCotizacionProduccionCotizacionOrdenInsumos.prg
	#endif
