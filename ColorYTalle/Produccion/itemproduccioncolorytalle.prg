define class ItemProduccionColorYTalle as ItemBaseProduccion of ItemBaseProduccion.prg

	#If .F.
		Local This As ItemProduccionColorYTalle As ItemProduccionColorYTalle.prg
	#Endif
