define class ItemCotizacionProduccionCotizacionOrdenProduccion as Din_ItemCotizacionProduccionCotizacionOrdenProduccion of Din_ItemCotizacionProduccionCotizacionOrdenProduccion.prg

	#if .f.
		local this as ItemCotizacionProduccionCotizacionOrdenProduccion of ItemCotizacionProduccionCotizacionOrdenProduccion.prg
	#endif
