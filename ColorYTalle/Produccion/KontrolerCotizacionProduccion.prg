Define Class kontrolerCotizacionProduccion as din_kontrolerCotizacionProduccion of din_kontrolerCotizacionProduccion.prg

	#if .f.
		local this as kontrolerCotizacionProduccion of kontrolerCotizacionProduccion.prg
	#endif
