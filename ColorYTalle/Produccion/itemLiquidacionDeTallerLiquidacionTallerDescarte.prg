define class itemLiquidaciondeTallerLiquidacionTallerDescarte as Din_itemLiquidaciondeTallerLiquidacionTallerDescarte of Din_itemLiquidaciondeTallerLiquidacionTallerDescarte.prg

	#if .f.
		local this as Din_itemLiquidaciondeTallerLiquidacionTallerDescarte of Din_itemLiquidaciondeTallerLiquidacionTallerDescarte.prg
	#endif
