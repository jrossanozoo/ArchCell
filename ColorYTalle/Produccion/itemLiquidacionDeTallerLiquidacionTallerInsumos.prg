define class itemLiquidaciondeTallerLiquidacionTallerInsumos as Din_itemLiquidaciondeTallerLiquidacionTallerInsumos of Din_itemLiquidaciondeTallerLiquidacionTallerInsumos.prg

	#if .f.
		local this as Din_itemLiquidaciondeTallerLiquidacionTallerInsumos of Din_itemLiquidaciondeTallerLiquidacionTallerInsumos.prg
	#endif
