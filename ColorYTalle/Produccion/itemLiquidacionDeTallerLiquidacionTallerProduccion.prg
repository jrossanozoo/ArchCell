define class itemLiquidaciondeTallerLiquidacionTallerProduccion as Din_itemLiquidaciondeTallerLiquidacionTallerProduccion of Din_itemLiquidaciondeTallerLiquidacionTallerProduccion.prg

	#if .f.
		local this as Din_itemLiquidaciondeTallerLiquidacionTallerProduccion of Din_itemLiquidaciondeTallerLiquidacionTallerProduccion.prg
	#endif
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Articulo( txVal as variant, txValOld as variant ) as Boolean
		...
		lRet = dodefault( txVal, txValOld ) and (empty(txVal) or This.ValidarArticuloTipoConcepto())
