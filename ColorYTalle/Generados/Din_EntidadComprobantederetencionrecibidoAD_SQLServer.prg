...
define class Din_EntidadCOMPROBANTEDERETENCIONRECIBIDOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprrFecexpo, lxComprrFaltafw, lxComprrFecimpo, lxComprrFectrans, lxComprrFmodifw, lxComprrHoraexpo, lxComprrZadsfw, lxComprrDescfw, lxComprrSaltafw, lxComprrHoraimpo, lxComprrUaltafw, lxComprrUmodifw, lxComprrSmodifw, lxComprrVmodifw, lxComprrHmodifw, lxComprrValtafw, lxComprrEsttrans, lxComprrHaltafw, lxComprrBdmodifw, lxComprrBdaltafw, lxComprrTimestamp, lxComprrAnulado, lxComprrCodigo, lxComprrCliente, lxComprrCliedesc, lxComprrCuit, lxComprrTipoimp, lxComprrRegimen, lxComprrRegidesc, lxComprrNumint, lxComprrFechcert, lxComprrNumecert, lxComprrRecibo, lxComprrFechreci, lxComprrRtotal, lxComprrObse
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPRR ( "Fecexpo","Faltafw","Fecimpo","Fectrans","Fmodifw","Horaexpo","Zadsfw","Descfw","Saltafw","Horaimpo","Ualtafw","Umodifw","Smodifw","Vmodifw","Hmodifw","Valtafw","Esttrans","Haltafw","Bdmodifw","Bdaltafw","Timestamp","Anulado","Codigo","Cliente","Cliedesc","Cuit","Tipoimp","Regimen","Regidesc","Numint","Fechcert","Numecert","Recibo","Fechreci","Rtotal","Obse" ) values ( <<"'" + this.ConvertirDateSql( lxComprrFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprrFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprrFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprrFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprrFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrBdaltafw ) + "'" >>, <<lxComprrTimestamp >>, <<iif( lxComprrAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprrCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrCliente ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrCliedesc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrCuit ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrTipoimp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrRegimen ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrRegidesc ) + "'" >>, <<lxComprrNumint >>, <<"'" + this.ConvertirDateSql( lxComprrFechcert ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrNumecert ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprrRecibo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprrFechreci ) + "'" >>, <<lxComprrRtotal >>, <<"'" + this.FormatearTextoSql( lxComprrObse ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPRR set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprrFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprrFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprrFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprrFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprrFmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprrHoraexpo ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprrZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprrDescfw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprrSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprrHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprrUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprrUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprrSmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprrVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprrHmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprrValtafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprrEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprrHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprrBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprrBdaltafw ) + "'">>,"Timestamp" = <<lxComprrTimestamp>>,"Anulado" = <<iif( lxComprrAnulado, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprrCodigo ) + "'">>,"Cliente" = <<"'" + this.FormatearTextoSql( lxComprrCliente ) + "'">>,"Cliedesc" = <<"'" + this.FormatearTextoSql( lxComprrCliedesc ) + "'">>,"Cuit" = <<"'" + this.FormatearTextoSql( lxComprrCuit ) + "'">>,"Tipoimp" = <<"'" + this.FormatearTextoSql( lxComprrTipoimp ) + "'">>,"Regimen" = <<"'" + this.FormatearTextoSql( lxComprrRegimen ) + "'">>,"Regidesc" = <<"'" + this.FormatearTextoSql( lxComprrRegidesc ) + "'">>,"Numint" = <<lxComprrNumint>>,"Fechcert" = <<"'" + this.ConvertirDateSql( lxComprrFechcert ) + "'">>,"Numecert" = <<"'" + this.FormatearTextoSql( lxComprrNumecert ) + "'">>,"Recibo" = <<"'" + this.FormatearTextoSql( lxComprrRecibo ) + "'">>,"Fechreci" = <<"'" + this.ConvertirDateSql( lxComprrFechreci ) + "'">>,"Rtotal" = <<lxComprrRtotal>>,"Obse" = <<"'" + this.FormatearTextoSql( lxComprrObse ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprrCodigo ) + "'">> and  COMPRR.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Codigo" as "Codigo", "Cliente" as "Cliente", "Cliedesc" as "Clientedetalle", "Cuit" as "Cuit", "Tipoimp" as "Tipoimpuesto", "Regimen" as "Regimen", "Regidesc" as "Regimendetalle", "Numint" as "Numerointerno", "Fechcert" as "Fechacertificado", "Numecert" as "Numerocertificado", "Recibo" as "Recibo", "Fechreci" as "Fecharecibo", "Rtotal" as "Total", "Obse" as "Observaciones" from ZooLogic.COMPRR where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprrCodigo ) + "'">> and  COMPRR.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Faltafw,Fecimpo,Fectrans,Fmodifw,Horaexpo,Zadsfw,Descfw,Saltafw,Horaimpo,Ualtafw,Umo" + ;
"difw,Smodifw,Vmodifw,Hmodifw,Valtafw,Esttrans,Haltafw,Bdmodifw,Bdaltafw,Timestamp,Anulado,Codigo,Cli" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPRR set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"+ [, cliente = ] + "'" + this.FormatearTextoSql( &lcCursor..cliente ) + "'"+ [, cliedesc = ] + "'" + this.FormatearTextoSql( &lcCursor..cliedesc ) + "'"+ [, cuit = ] + "'" + this.FormatearTextoSql( &lcCursor..cuit ) + "'"+ [, TipoImp = ] + "'" + this.FormatearTextoSql( &lcCursor..TipoImp ) + "'"+ [, regimen = ] + "'" + this.FormatearTextoSql( &lcCursor..regimen ) + "'"+ [, regidesc = ] + "'" + this.FormatearTextoSql( &lcCursor..regidesc ) + "'"+ [, numint = ] + transform( &lcCursor..numint )+ [, fechcert = ] + "'" + this.ConvertirDateSql( &lcCursor..fechcert ) + "'"+ [, numecert = ] + "'" + this.FormatearTextoSql( &lcCursor..numecert ) + "'"+ [, recibo = ] + "'" + this.FormatearTextoSql( &lcCursor..recibo ) + "'"+ [, fechreci = ] + "'" + this.ConvertirDateSql( &lcCursor..fechreci ) + "'"+ [, RTotal = ] + transform( &lcCursor..RTotal )+ [, obse = ] + "'" + this.FormatearTextoSql( &lcCursor..obse ) + "'" + [ Where codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FALTAFW, FECIMPO, FECTRANS, FMODIFW, HORAEXPO, ZADSFW, DescFW, SALTAFW, HORAIMPO, UALTAFW, UMODIFW, SMODIFW, VMODIFW, HMODIFW, VALTAFW, ESTTRANS, HALTAFW, BDMODIFW, BDALTAFW, TIMESTAMP, Anulado, codigo, cliente, cliedesc, cuit, TipoImp, regimen, regidesc, numint, fechcert, numecert, recibo, fechreci, RTotal, obse
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cliente ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cliedesc ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cuit ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TipoImp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..regimen ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.CLIENTE = isnull( d.CLIENTE, t.CLIENTE ),t.CLIEDESC = isnull( d.CLIEDESC, t.CLIEDESC ),t.CUIT = isnull( d.CUIT, t.CUIT ),t.TIPOIMP = isnull( d.TIPOIMP, t.TIPOIMP ),t.REGIMEN = isnull( d.REGIMEN, t.REGIMEN ),t.REGIDESC = isnull( d.REGIDESC, t.REGIDESC ),t.NUMINT = isnull( d.NUMINT, t.NUMINT ),t.FECHCERT = isnull( d.FECHCERT, t.FECHCERT ),t.NUMECERT = isnull( d.NUMECERT, t.NUMECERT ),t.RECIBO = isnull( d.RECIBO, t.RECIBO ),t.FECHRECI = isnull( d.FECHRECI, t.FECHRECI ),t.RTOTAL = isnull( d.RTOTAL, t.RTOTAL ),t.OBSE = isnull( d.OBSE, t.OBSE )
					from ZooLogic.COMPRR t inner join deleted d 
							 on t.codigo = d.codigo
							 and  t.numint = d.numint
				-- Fin Updates
				insert into ZooLogic.COMPRR(Fecexpo,Faltafw,Fecimpo,Fectrans,Fmodifw,Horaexpo,Zadsfw,Descfw,Saltafw,Horaimpo,Ualtafw,Umodifw,Smodifw,Vmodifw,Hmodifw,Valtafw,Esttrans,Haltafw,Bdmodifw,Bdaltafw,Timestamp,Anulado,Codigo,Cliente,Cliedesc,Cuit,Tipoimp,Regimen,Regidesc,Numint,Fechcert,Numecert,Recibo,Fechreci,Rtotal,Obse)
					Select isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.TIMESTAMP,0),isnull( d.ANULADO,0),isnull( d.CODIGO,''),isnull( d.CLIENTE,''),isnull( d.CLIEDESC,''),isnull( d.CUIT,''),isnull( d.TIPOIMP,''),isnull( d.REGIMEN,''),isnull( d.REGIDESC,''),isnull( d.NUMINT,0),isnull( d.FECHCERT,''),isnull( d.NUMECERT,''),isnull( d.RECIBO,''),isnull( d.FECHRECI,''),isnull( d.RTOTAL,0),isnull( d.OBSE,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="COMPROBANTEDERETENCIONRECIBIDO          " atributo="FECHATRANSFERENCIA                      " tabla="COMPRR         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPROBANTEDERETENCIONRECIBIDO          " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPRR         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPROBANTEDERETENCIONRECIBIDO          " atributo="CLIENTEDETALLE                          " tabla="COMPRR         " campo="CLIEDESC  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Cliente descripción                                                                                                                                             " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="CLIENTE.NOMBRE                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPROBANTEDERETENCIONRECIBIDO          " atributo="OBSERVACIONES                           " tabla="COMPRR         " campo="OBSE      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="14" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
