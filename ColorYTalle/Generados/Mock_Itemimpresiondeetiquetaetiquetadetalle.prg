...
define class Mock_Itemimpresiondeetiquetaetiquetadetalle as MockBase of MockBase.prg

	cClase = 'Itemimpresiondeetiquetaetiquetadetalle'
	...
	lVerificarCombinacion = .F.                                                                                                                                                                                                                               
	lYaAdvirtioFaltantedeStock = .F.                                                                                                                                                                                                                          
	nCantidadAnterior = 0                                                                                                                                                                                                                                     
	nCantidadSeniada = 0                                                                                                                                                                                                                                      
	nMontoAnterior = 0                                                                                                                                                                                                                                        
	oCodigoDeBarras = null                                                                                                                                                                                                                                    
	oColaboradorColoryTalle = null                                                                                                                                                                                                                            
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oCombinacion = null                                                                                                                                                                                                                                       
	...
	*-----------------------------------------------------------------------------------------
	function cantidad_despuesdeasignar() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cantidad_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function color_pk_despuesdeasignar() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Color_pk_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function imagenqrlink1_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Imagenqrlink1_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function imagenqrlink2_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Imagenqrlink2_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function imagenqrlink3_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Imagenqrlink3_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nota_assign( txval as variant ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Nota_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorcolorytalle_access() as variant                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolaboradorcolorytalle_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function secuencial_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Secuencial_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_imagenqrlink1( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_imagenqrlink1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_imagenqrlink2( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_imagenqrlink2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_imagenqrlink3( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_imagenqrlink3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nota( txval as variant ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_nota', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_secuencial( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_secuencial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_urlqrlink1( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_urlqrlink1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_urlqrlink2( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_urlqrlink2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_urlqrlink3( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_urlqrlink3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function talle_pk_despuesdeasignar() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Talle_pk_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function urlqrlink1_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Urlqrlink1_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function urlqrlink2_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Urlqrlink2_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function urlqrlink3_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Urlqrlink3_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_imagenqrlink1( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_imagenqrlink1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_imagenqrlink2( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_imagenqrlink2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_imagenqrlink3( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_imagenqrlink3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nota( txval as variant ) as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_nota', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_secuencial( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_secuencial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_urlqrlink1( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_urlqrlink1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_urlqrlink2( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_urlqrlink2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_urlqrlink3( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_urlqrlink3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcombinacion() as boolean                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonota() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridonota', lcParametros )
	EndFunc
