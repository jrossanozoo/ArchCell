...
define class Din_EntidadComprobantederetencionessuss_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Comprobantederetencionessuss"
	cClaseResponse = this.cNamespaceDTOs + ".ComprobantederetencionessussResponse"
	cClaseModelo = "ComprobantederetencionessussModelo"
	cEntidad = "Comprobantederetencionessuss"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionessussModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionessussListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionessussListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionessussModelo"
		endcase
		return lcRetorno
