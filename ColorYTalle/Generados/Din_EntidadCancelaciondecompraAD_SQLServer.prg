...
define class Din_EntidadCANCELACIONDECOMPRAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCancompraFmodifw, lxCancompraFd2, lxCancompraFecimpo, lxCancompraFectrans, lxCancompraFecexpo, lxCancompraFcuit, lxCancompraIdcaja, lxCancompraFpodes, lxCancompraFpodes1, lxCancompraFpodes2, lxCancompraFturno, lxCancompraFaltafw, lxCancompraBdaltafw, lxCancompraHaltafw, lxCancompraEsttrans, lxCancompraValtafw, lxCancompraBdmodifw, lxCancompraUaltafw, lxCancompraSmodifw, lxCancompraSaltafw, lxCancompraUmodifw, lxCancompraVmodifw, lxCancompraSimbmon, lxCancompraFhora, lxCancompraZadsfw, lxCancompraHoraexpo, lxCancompraHmodifw, lxCancompraDescfw, lxCancompraHoraimpo, lxCancompraTimestamp, lxCancompraTotalcant, lxCancompraSubtotsisi, lxCancompraSubtotcisi, lxCancompraRecmnto2, lxCancompraRecmnto1, lxCancompraCondivalp, lxCancompraRecmntosi, lxCancompraSignomov, lxCancompraSitfiscpro, lxCancompraFsubton, lxCancompraFsubtot, lxCancompraRecmntosi1, lxCancompraFacttipo, lxCancompraRecmntosi2, lxCancompraDesmntosi1, lxCancompraDesmntosi, lxCancompraDesmntosi2, lxCancompraDesauto, lxCancompraAnulado, lxCancompraFcompfis, lxCancompraTcrg1361, lxCancompraIdvuelto, lxCancompraCodigo, lxCancompraMonsis, lxCancompraFmtdes1, lxCancompraFdescu, lxCancompraFmtdes2, lxCancompraFletra, lxCancompraFimpuesto, lxCancompraFobs, lxCancompraFfchfac, lxCancompraFptoven, lxCancompraFmtdes3, lxCancompraDesmntosi3, lxCancompraRecpor, lxCancompraFnumcomp, lxCancompraTotdescsi, lxCancompraFfch, lxCancompraMr, lxCancompraNcai, lxCancompraFperson, lxCancompraFvtocai, lxCancompraRecmnto, lxCancompraMoneda, lxCancompraCotiz, lxCancompraCodlista, lxCancompraFtotal, lxCancompraRecmonto2, lxCancompraRecmonto1, lxCancompraFvuelto, lxCancompraMotivo, lxCancompraNroremito, lxCancompraTotimpue, lxCancompraTotrecarsi, lxCancompraTotrecar, lxCancompraTotdesc
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CANCOMPRA ( "Fmodifw","Fd2","Fecimpo","Fectrans","Fecexpo","Fcuit","Idcaja","Fpodes","Fpodes1","Fpodes2","Fturno","Faltafw","Bdaltafw","Haltafw","Esttrans","Valtafw","Bdmodifw","Ualtafw","Smodifw","Saltafw","Umodifw","Vmodifw","Simbmon","Fhora","Zadsfw","Horaexpo","Hmodifw","Descfw","Horaimpo","Timestamp","Totalcant","Subtotsisi","Subtotcisi","Recmnto2","Recmnto1","Condivalp","Recmntosi","Signomov","Sitfiscpro","Fsubton","Fsubtot","Recmntosi1","Facttipo","Recmntosi2","Desmntosi1","Desmntosi","Desmntosi2","Desauto","Anulado","Fcompfis","Tcrg1361","Idvuelto","Codigo","Monsis","Fmtdes1","Fdescu","Fmtdes2","Fletra","Fimpuesto","Fobs","Ffchfac","Fptoven","Fmtdes3","Desmntosi3","Recpor","Fnumcomp","Totdescsi","Ffch","Mr","Ncai","Fperson","Fvtocai","Recmnto","Moneda","Cotiz","Codlista","Ftotal","Recmonto2","Recmonto1","Fvuelto","Motivo","Nroremito","Totimpue","Totrecarsi","Totrecar","Totdesc" ) values ( <<"'" + this.ConvertirDateSql( lxCancompraFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCancompraFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCancompraFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCancompraFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCancompraFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraFcuit ) + "'" >>, <<lxCancompraIdcaja >>, <<lxCancompraFpodes >>, <<lxCancompraFpodes1 >>, <<lxCancompraFpodes2 >>, <<lxCancompraFturno >>, <<"'" + this.ConvertirDateSql( lxCancompraFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraHoraimpo ) + "'" >>, <<lxCancompraTimestamp >>, <<lxCancompraTotalcant >>, <<lxCancompraSubtotsisi >>, <<lxCancompraSubtotcisi >>, <<lxCancompraRecmnto2 >>, <<lxCancompraRecmnto1 >>, <<lxCancompraCondivalp >>, <<lxCancompraRecmntosi >>, <<lxCancompraSignomov >>, <<lxCancompraSitfiscpro >>, <<lxCancompraFsubton >>, <<lxCancompraFsubtot >>, <<lxCancompraRecmntosi1 >>, <<lxCancompraFacttipo >>, <<lxCancompraRecmntosi2 >>, <<lxCancompraDesmntosi1 >>, <<lxCancompraDesmntosi >>, <<lxCancompraDesmntosi2 >>, <<iif( lxCancompraDesauto, 1, 0 ) >>, <<iif( lxCancompraAnulado, 1, 0 ) >>, <<iif( lxCancompraFcompfis, 1, 0 ) >>, <<lxCancompraTcrg1361 >>, <<"'" + this.FormatearTextoSql( lxCancompraIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraMonsis ) + "'" >>, <<lxCancompraFmtdes1 >>, <<lxCancompraFdescu >>, <<lxCancompraFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxCancompraFletra ) + "'" >>, <<lxCancompraFimpuesto >>, <<"'" + this.FormatearTextoSql( lxCancompraFobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCancompraFfchfac ) + "'" >>, <<lxCancompraFptoven >>, <<lxCancompraFmtdes3 >>, <<lxCancompraDesmntosi3 >>, <<lxCancompraRecpor >>, <<lxCancompraFnumcomp >>, <<lxCancompraTotdescsi >>, <<"'" + this.ConvertirDateSql( lxCancompraFfch ) + "'" >>, <<lxCancompraMr >>, <<lxCancompraNcai >>, <<"'" + this.FormatearTextoSql( lxCancompraFperson ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCancompraFvtocai ) + "'" >>, <<lxCancompraRecmnto >>, <<"'" + this.FormatearTextoSql( lxCancompraMoneda ) + "'" >>, <<lxCancompraCotiz >>, <<"'" + this.FormatearTextoSql( lxCancompraCodlista ) + "'" >>, <<lxCancompraFtotal >>, <<lxCancompraRecmonto2 >>, <<lxCancompraRecmonto1 >>, <<lxCancompraFvuelto >>, <<"'" + this.FormatearTextoSql( lxCancompraMotivo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCancompraNroremito ) + "'" >>, <<lxCancompraTotimpue >>, <<lxCancompraTotrecarsi >>, <<lxCancompraTotrecar >>, <<lxCancompraTotdesc >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.FacturaDetalle
				if this.oEntidad.FacturaDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.CANCOMPRADET("AfeLETRA","AfeNUMCOM","AfePTOVEN","afe_Cod","IdItem","FAMate","MNTPRECCI","MNTPTOT","ACondIvaC","AfeSaldo","AfeCANT","MNTPPER","AfeTS","APorcIvaC","AjuSImp","AjuCImp","COMP","FBruto","ArtPercep","MNDESSI","MNTPDESSI","MNTPRECSI","MNPDSI","MNTPDESCI","MNDESCI","AfeTipoCom","NroItem","FNETO","FX2","FmtoIVA","FporDTO1","FmtoDTO1","FKIT","FCFITot","fporIva","FmtoCFI","FporCFI","prunconimp","ciditem","AfeNroItem","iditemOrig","FN11","FPRUN","Prunsinimp","UsarPLista","ProcStock","FART","CODIGO","FUnid","Equiv","FTXT","FCOLO","FCOTXT","FTALL","seniacance","MNTPIVA","FCANT","FPRECIO","FCFI","MNTDES","FMONTO" ) values ( <<"'" + this.FormatearTextoSql( lxAfe_letra ) + "'">>, <<lxAfe_numero>>, <<lxAfe_puntodeventa>>, <<"'" + this.FormatearTextoSql( lxAfe_codigo ) + "'">>, <<"'" + this.FormatearTextoSql( lxIditemarticulos ) + "'">>, <<"'" + this.FormatearTextoSql( lxMaterial_PK ) + "'">>, <<lxMontoprorrateorecargoconimpuestos>>, <<lxMontoprorrateototal>>, <<lxArticulo_condicionivacompras>>, <<lxAfe_saldo>>, <<lxAfe_cantidad>>, <<lxMontoprorrateopercepciones>>, <<lxAfe_timestamp>>, <<lxArticulo_porcentajeivacompras>>, <<lxAjusteporredondeosinimpuestos>>, <<lxAjusteporredondeoconimpuestos>>, <<lxComportamiento>>, <<lxBruto>>, <<lxPercepcionivarg5329>>, <<lxMontodescuentosinimpuestos>>, <<lxMontoprorrateodescuentosinimpuestos>>, <<lxMontoprorrateorecargosinimpuestos>>, <<lxMontoporcentajedescuentosinimpuesto>>, <<lxMontoprorrateodescuentoconimpuestos>>, <<lxMontodescuentoconimpuestos>>, <<lxAfe_tipocomprobante>>, <<lxNroitem>>, <<lxNeto>>, <<lxOferta>>, <<lxMontoiva>>, <<lxPorcentajedto1>>, <<lxMontodto1>>, <<lxKit>>, <<lxMontoporcentajedescuentoconimpuesto>>, <<lxPorcentajeiva>>, <<lxMontocfi>>, <<lxPorcentajecfi>>, <<lxPrecioconimpuestos>>, <<lxIditem>>, <<lxAfe_nroitem>>, <<lxIdorigen>>, <<lxTipolistadeprecio>>, <<lxPreciounitario>>, <<lxPreciosinimpuestos>>, <<iif( lxUsarpreciodelista, 1, 0 )>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxUnidad_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxIdseniacancelada ) + "'">>, <<lxMontoprorrateoiva>>, <<lxCantidad>>, <<lxPrecio>>, <<lxDescuento>>, <<lxMontodescuento>>, <<lxMonto>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CANCOMPRA set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxCancompraFmodifw ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxCancompraFd2 ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCancompraFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCancompraFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCancompraFecexpo ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxCancompraFcuit ) + "'">>,"Idcaja" = <<lxCancompraIdcaja>>,"Fpodes" = <<lxCancompraFpodes>>,"Fpodes1" = <<lxCancompraFpodes1>>,"Fpodes2" = <<lxCancompraFpodes2>>,"Fturno" = <<lxCancompraFturno>>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCancompraFaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCancompraBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCancompraHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCancompraEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCancompraValtafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCancompraBdmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCancompraUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCancompraSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCancompraSaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCancompraUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCancompraVmodifw ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxCancompraSimbmon ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxCancompraFhora ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCancompraZadsfw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCancompraHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCancompraHmodifw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxCancompraDescfw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCancompraHoraimpo ) + "'">>,"Timestamp" = <<lxCancompraTimestamp>>,"Totalcant" = <<lxCancompraTotalcant>>,"Subtotsisi" = <<lxCancompraSubtotsisi>>,"Subtotcisi" = <<lxCancompraSubtotcisi>>,"Recmnto2" = <<lxCancompraRecmnto2>>,"Recmnto1" = <<lxCancompraRecmnto1>>,"Condivalp" = <<lxCancompraCondivalp>>,"Recmntosi" = <<lxCancompraRecmntosi>>,"Signomov" = <<lxCancompraSignomov>>,"Sitfiscpro" = <<lxCancompraSitfiscpro>>,"Fsubton" = <<lxCancompraFsubton>>,"Fsubtot" = <<lxCancompraFsubtot>>,"Recmntosi1" = <<lxCancompraRecmntosi1>>,"Facttipo" = <<lxCancompraFacttipo>>,"Recmntosi2" = <<lxCancompraRecmntosi2>>,"Desmntosi1" = <<lxCancompraDesmntosi1>>,"Desmntosi" = <<lxCancompraDesmntosi>>,"Desmntosi2" = <<lxCancompraDesmntosi2>>,"Desauto" = <<iif( lxCancompraDesauto, 1, 0 )>>,"Anulado" = <<iif( lxCancompraAnulado, 1, 0 )>>,"Fcompfis" = <<iif( lxCancompraFcompfis, 1, 0 )>>,"Tcrg1361" = <<lxCancompraTcrg1361>>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxCancompraIdvuelto ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCancompraCodigo ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxCancompraMonsis ) + "'">>,"Fmtdes1" = <<lxCancompraFmtdes1>>,"Fdescu" = <<lxCancompraFdescu>>,"Fmtdes2" = <<lxCancompraFmtdes2>>,"Fletra" = <<"'" + this.FormatearTextoSql( lxCancompraFletra ) + "'">>,"Fimpuesto" = <<lxCancompraFimpuesto>>,"Fobs" = <<"'" + this.FormatearTextoSql( lxCancompraFobs ) + "'">>,"Ffchfac" = <<"'" + this.ConvertirDateSql( lxCancompraFfchfac ) + "'">>,"Fptoven" = <<lxCancompraFptoven>>,"Fmtdes3" = <<lxCancompraFmtdes3>>,"Desmntosi3" = <<lxCancompraDesmntosi3>>,"Recpor" = <<lxCancompraRecpor>>,"Fnumcomp" = <<lxCancompraFnumcomp>>,"Totdescsi" = <<lxCancompraTotdescsi>>,"Ffch" = <<"'" + this.ConvertirDateSql( lxCancompraFfch ) + "'">>,"Mr" = <<lxCancompraMr>>,"Ncai" = <<lxCancompraNcai>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxCancompraFperson ) + "'">>,"Fvtocai" = <<"'" + this.ConvertirDateSql( lxCancompraFvtocai ) + "'">>,"Recmnto" = <<lxCancompraRecmnto>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxCancompraMoneda ) + "'">>,"Cotiz" = <<lxCancompraCotiz>>,"Codlista" = <<"'" + this.FormatearTextoSql( lxCancompraCodlista ) + "'">>,"Ftotal" = <<lxCancompraFtotal>>,"Recmonto2" = <<lxCancompraRecmonto2>>,"Recmonto1" = <<lxCancompraRecmonto1>>,"Fvuelto" = <<lxCancompraFvuelto>>,"Motivo" = <<"'" + this.FormatearTextoSql( lxCancompraMotivo ) + "'">>,"Nroremito" = <<"'" + this.FormatearTextoSql( lxCancompraNroremito ) + "'">>,"Totimpue" = <<lxCancompraTotimpue>>,"Totrecarsi" = <<lxCancompraTotrecarsi>>,"Totrecar" = <<lxCancompraTotrecar>>,"Totdesc" = <<lxCancompraTotdesc>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCancompraCodigo ) + "'">> and  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function HayDatos() as boolean
		local llhaydatos as boolean, lcXml as String
			 lcXml = this.oConexion.EjecutarSql( "select Top 1 CODIGO from ZooLogic.CANCOMPRA where " + this.ConvertirFuncionesSql( " CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41" ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes" as "Porcentajedescuento", "Fpodes1" as "Porcentajedescuento1", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Horaimpo" as "Horaimpo", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto1" as "Recargomontoconimpuestos1", "Condivalp" as "Condicioniva", "Recmntosi" as "Recargomontosinimpuestos", "Signomov" as "Signodemovimiento", "Sitfiscpro" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Recmntosi1" as "Recargomontosinimpuestos1", "Facttipo" as "Tipocomprobante", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Tcrg1361" as "Tipocomprobanterg1361", "Idvuelto" as "Idvuelto", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fletra" as "Letra", "Fimpuesto" as "Impuestos", "Fobs" as "Obs", "Ffchfac" as "Fechafactura", "Fptoven" as "Puntodeventa", "Fmtdes3" as "Montodescuentoconimpuestos3", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recpor" as "Recargoporcentaje", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Mr" as "Recargomonto", "Ncai" as "Cai", "Fperson" as "Proveedor", "Fvtocai" as "Fechavtocai", "Recmnto" as "Recargomontoconimpuestos", "Moneda" as "Monedacomprobante", "Cotiz" as "Cotizacion", "Codlista" as "Listadeprecios", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Fvuelto" as "Vuelto", "Motivo" as "Motivo", "Nroremito" as "Remito", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.CANCOMPRA where "Codigo" = <<"'" + this.FormatearTextoSql( lxCancompraCodigo ) + "'">> and  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Afeletra" as "Afe_letra", "Afenumcom" as "Afe_numero", "Afeptoven" as "Afe_puntodeventa", "Afe_cod" as "Afe_codigo", "Iditem" as "Iditemarticulos", "Famate" as "Material", "Mntprecci" as "Montoprorrateorecargoconimpuestos", "Mntptot" as "Montoprorrateototal", "Acondivac" as "Articulo_condicionivacompras", "Afesaldo" as "Afe_saldo", "Afecant" as "Afe_cantidad", "Mntpper" as "Montoprorrateopercepciones", "Afets" as "Afe_timestamp", "Aporcivac" as "Articulo_porcentajeivacompras", "Ajusimp" as "Ajusteporredondeosinimpuestos", "Ajucimp" as "Ajusteporredondeoconimpuestos", "Comp" as "Comportamiento", "Fbruto" as "Bruto", "Artpercep" as "Percepcionivarg5329", "Mndessi" as "Montodescuentosinimpuestos", "Mntpdessi" as "Montoprorrateodescuentosinimpuestos", "Mntprecsi" as "Montoprorrateorecargosinimpuestos", "Mnpdsi" as "Montoporcentajedescuentosinimpuesto", "Mntpdesci" as "Montoprorrateodescuentoconimpuestos", "Mndesci" as "Montodescuentoconimpuestos", "Afetipocom" as "Afe_tipocomprobante", "Nroitem" as "Nroitem", "Fneto" as "Neto", "Fx2" as "Oferta", "Fmtoiva" as "Montoiva", "Fpordto1" as "Porcentajedto1", "Fmtodto1" as "Montodto1", "Fkit" as "Kit", "Fcfitot" as "Montoporcentajedescuentoconimpuesto", "Fporiva" as "Porcentajeiva", "Fmtocfi" as "Montocfi", "Fporcfi" as "Porcentajecfi", "Prunconimp" as "Precioconimpuestos", "Ciditem" as "Iditem", "Afenroitem" as "Afe_nroitem", "Iditemorig" as "Idorigen", "Fn11" as "Tipolistadeprecio", "Fprun" as "Preciounitario", "Prunsinimp" as "Preciosinimpuestos", "Usarplista" as "Usarpreciodelista", "Procstock" as "Noprocesarstock", "Fart" as "Articulo", "Codigo" as "Codigo", "Funid" as "Unidad", "Equiv" as "Equivalencia", "Ftxt" as "Articulodetalle", "Fcolo" as "Color", "Fcotxt" as "Colordetalle", "Ftall" as "Talle", "Seniacance" as "Idseniacancelada", "Mntpiva" as "Montoprorrateoiva", "Fcant" as "Cantidad", "Fprecio" as "Precio", "Fcfi" as "Descuento", "Mntdes" as "Montodescuento", "Fmonto" as "Monto" from ZooLogic.CANCOMPRADET where CODIGO = <<"'" + this.FormatearTextoSql( c_CANCELACIONDECOMPRA.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Codint" as "Codigointerno", "Tipoi" as "Tipoimpuesto", "Porcen" as "Porcentaje", "Minoimp" as "Minimonoimponible", "Nroitem" as "Nroitem", "Ccod" as "Codigo", "Codimp" as "Codimp", "Descri" as "Codimpdetalle", "Monto" as "Monto" from ZooLogic.ImpCanC where cCod = <<"'" + this.FormatearTextoSql( c_CANCELACIONDECOMPRA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes" as "Porcentajedescuento", "Fpodes1" as "Porcentajedescuento1", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Horaimpo" as "Horaimpo", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto1" as "Recargomontoconimpuestos1", "Condivalp" as "Condicioniva", "Recmntosi" as "Recargomontosinimpuestos", "Signomov" as "Signodemovimiento", "Sitfiscpro" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Recmntosi1" as "Recargomontosinimpuestos1", "Facttipo" as "Tipocomprobante", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Tcrg1361" as "Tipocomprobanterg1361", "Idvuelto" as "Idvuelto", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fletra" as "Letra", "Fimpuesto" as "Impuestos", "Fobs" as "Obs", "Ffchfac" as "Fechafactura", "Fptoven" as "Puntodeventa", "Fmtdes3" as "Montodescuentoconimpuestos3", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recpor" as "Recargoporcentaje", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Mr" as "Recargomonto", "Ncai" as "Cai", "Fperson" as "Proveedor", "Fvtocai" as "Fechavtocai", "Recmnto" as "Recargomontoconimpuestos", "Moneda" as "Monedacomprobante", "Cotiz" as "Cotizacion", "Codlista" as "Listadeprecios", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Fvuelto" as "Vuelto", "Motivo" as "Motivo", "Nroremito" as "Remito", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.CANCOMPRA where  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41 And FACTTIPO = <<lxCANCOMPRAFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxCanCompraFLETRA ) + "'">> and FPTOVEN = <<lxCanCompraFPTOVEN>> and FNUMCOMP = <<lxCanCompraFNUMCOMP>>
			endtext
			use in select('c_CANCELACIONDECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CANCELACIONDECOMPRA', set( 'Datasession' ) )
			if reccount( 'c_CANCELACIONDECOMPRA' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	function VerificarExistenciaClavePrimaria( txVal as Variant ) as Boolean
		...
		lxCancompraCodigo = txVal
			...
			text to lcSentencia textmerge noshow
				select count( * ) as CantidadDeRegistros from ZooLogic.CANCOMPRA where "Codigo" = <<"'" + this.FormatearTextoSql( lxCancompraCodigo ) + "'">> and  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes" as "Porcentajedescuento", "Fpodes1" as "Porcentajedescuento1", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Horaimpo" as "Horaimpo", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto1" as "Recargomontoconimpuestos1", "Condivalp" as "Condicioniva", "Recmntosi" as "Recargomontosinimpuestos", "Signomov" as "Signodemovimiento", "Sitfiscpro" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Recmntosi1" as "Recargomontosinimpuestos1", "Facttipo" as "Tipocomprobante", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Tcrg1361" as "Tipocomprobanterg1361", "Idvuelto" as "Idvuelto", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fletra" as "Letra", "Fimpuesto" as "Impuestos", "Fobs" as "Obs", "Ffchfac" as "Fechafactura", "Fptoven" as "Puntodeventa", "Fmtdes3" as "Montodescuentoconimpuestos3", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recpor" as "Recargoporcentaje", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Mr" as "Recargomonto", "Ncai" as "Cai", "Fperson" as "Proveedor", "Fvtocai" as "Fechavtocai", "Recmnto" as "Recargomontoconimpuestos", "Moneda" as "Monedacomprobante", "Cotiz" as "Cotizacion", "Codlista" as "Listadeprecios", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Fvuelto" as "Vuelto", "Motivo" as "Motivo", "Nroremito" as "Remito", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.CANCOMPRA where  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_CANCELACIONDECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CANCELACIONDECOMPRA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes" as "Porcentajedescuento", "Fpodes1" as "Porcentajedescuento1", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Horaimpo" as "Horaimpo", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto1" as "Recargomontoconimpuestos1", "Condivalp" as "Condicioniva", "Recmntosi" as "Recargomontosinimpuestos", "Signomov" as "Signodemovimiento", "Sitfiscpro" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Recmntosi1" as "Recargomontosinimpuestos1", "Facttipo" as "Tipocomprobante", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Tcrg1361" as "Tipocomprobanterg1361", "Idvuelto" as "Idvuelto", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fletra" as "Letra", "Fimpuesto" as "Impuestos", "Fobs" as "Obs", "Ffchfac" as "Fechafactura", "Fptoven" as "Puntodeventa", "Fmtdes3" as "Montodescuentoconimpuestos3", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recpor" as "Recargoporcentaje", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Mr" as "Recargomonto", "Ncai" as "Cai", "Fperson" as "Proveedor", "Fvtocai" as "Fechavtocai", "Recmnto" as "Recargomontoconimpuestos", "Moneda" as "Monedacomprobante", "Cotiz" as "Cotizacion", "Codlista" as "Listadeprecios", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Fvuelto" as "Vuelto", "Motivo" as "Motivo", "Nroremito" as "Remito", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.CANCOMPRA where  funciones.dtos( FAltaFW ) + funciones.padr( HAltaFW, 8, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_CANCELACIONDECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CANCELACIONDECOMPRA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fd2,Fecimpo,Fectrans,Fecexpo,Fcuit,Idcaja,Fpodes,Fpodes1,Fpodes2,Fturno,Faltafw,Bdal" + ;
"tafw,Haltafw,Esttrans,Valtafw,Bdmodifw,Ualtafw,Smodifw,Saltafw,Umodifw,Vmodifw,Simbmon,Fhora,Zadsfw," + ;
"Horaexpo,Hmodifw,Descfw,Horaimpo,Timestamp,Totalcant,Subtotsisi,Subtotcisi,Recmnto2,Recmnto1,Condiva" + ;
"lp,Recmntosi,Signomov,Sitfiscpro,Fsubton,Fsubtot,Recmntosi1,Facttipo,Recmntosi2,Desmntosi1,Desmntosi" + ;
",Desmntosi2,Desauto,Anulado,Fcompfis,Tcrg1361,Idvuelto,Codigo,Monsis,Fmtdes1,Fdescu,Fmtdes2,Fletra,F" + ;
"impuesto,Fobs,Ffchfac,Fptoven,Fmtdes3,Desmntosi3,Recpor,Fnumcomp,Totdescsi,Ffch,Mr,Ncai,Fperson,Fvto" + ;
"cai,Recmnto,Moneda,Cotiz,Codlista,Ftotal,Recmonto2,Recmonto1,Fvuelto,Motivo,Nroremito,Totimpue,Totre" + ;
"carsi,Totrecar,Totdesc" + ;
" from ZooLogic.CANCOMPRA where  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41 and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosEntidad( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		lcWhere = " Where  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes" as "Porcentajedescuento", "Fpodes1" as "Porcentajedescuento1", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Horaimpo" as "Horaimpo", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto1" as "Recargomontoconimpuestos1", "Condivalp" as "Condicioniva", "Recmntosi" as "Recargomontosinimpuestos", "Signomov" as "Signodemovimiento", "Sitfiscpro" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Recmntosi1" as "Recargomontosinimpuestos1", "Facttipo" as "Tipocomprobante", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Tcrg1361" as "Tipocomprobanterg1361", "Idvuelto" as "Idvuelto", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fletra" as "Letra", "Fimpuesto" as "Impuestos", "Fobs" as "Obs", "Ffchfac" as "Fechafactura", "Fptoven" as "Puntodeventa", "Fmtdes3" as "Montodescuentoconimpuestos3", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recpor" as "Recargoporcentaje", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Mr" as "Recargomonto", "Ncai" as "Cai", "Fperson" as "Proveedor", "Fvtocai" as "Fechavtocai", "Recmnto" as "Recargomontoconimpuestos", "Moneda" as "Monedacomprobante", "Cotiz" as "Cotizacion", "Codlista" as "Listadeprecios", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Fvuelto" as "Vuelto", "Motivo" as "Motivo", "Nroremito" as "Remito", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleFacturaDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Afeletra" as "Afe_letra", "Afenumcom" as "Afe_numero", "Afeptoven" as "Afe_puntodeventa", "Afe_cod" as "Afe_codigo", "Iditem" as "Iditemarticulos", "Famate" as "Material", "Mntprecci" as "Montoprorrateorecargoconimpuestos", "Mntptot" as "Montoprorrateototal", "Acondivac" as "Articulo_condicionivacompras", "Afesaldo" as "Afe_saldo", "Afecant" as "Afe_cantidad", "Mntpper" as "Montoprorrateopercepciones", "Afets" as "Afe_timestamp", "Aporcivac" as "Articulo_porcentajeivacompras", "Ajusimp" as "Ajusteporredondeosinimpuestos", "Ajucimp" as "Ajusteporredondeoconimpuestos", "Comp" as "Comportamiento", "Fbruto" as "Bruto", "Artpercep" as "Percepcionivarg5329", "Mndessi" as "Montodescuentosinimpuestos", "Mntpdessi" as "Montoprorrateodescuentosinimpuestos", "Mntprecsi" as "Montoprorrateorecargosinimpuestos", "Mnpdsi" as "Montoporcentajedescuentosinimpuesto", "Mntpdesci" as "Montoprorrateodescuentoconimpuestos", "Mndesci" as "Montodescuentoconimpuestos", "Afetipocom" as "Afe_tipocomprobante", "Nroitem" as "Nroitem", "Fneto" as "Neto", "Fx2" as "Oferta", "Fmtoiva" as "Montoiva", "Fpordto1" as "Porcentajedto1", "Fmtodto1" as "Montodto1", "Fkit" as "Kit", "Fcfitot" as "Montoporcentajedescuentoconimpuesto", "Fporiva" as "Porcentajeiva", "Fmtocfi" as "Montocfi", "Fporcfi" as "Porcentajecfi", "Prunconimp" as "Precioconimpuestos", "Ciditem" as "Iditem", "Afenroitem" as "Afe_nroitem", "Iditemorig" as "Idorigen", "Fn11" as "Tipolistadeprecio", "Fprun" as "Preciounitario", "Prunsinimp" as "Preciosinimpuestos", "Usarplista" as "Usarpreciodelista", "Procstock" as "Noprocesarstock", "Fart" as "Articulo", "Codigo" as "Codigo", "Funid" as "Unidad", "Equiv" as "Equivalencia", "Ftxt" as "Articulodetalle", "Fcolo" as "Color", "Fcotxt" as "Colordetalle", "Ftall" as "Talle", "Seniacance" as "Idseniacancelada", "Mntpiva" as "Montoprorrateoiva", "Fcant" as "Cantidad", "Fprecio" as "Precio", "Fcfi" as "Descuento", "Mntdes" as "Montodescuento", "Fmonto" as "Monto"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			lcFiltro = ["Codigo" = ] + lcValorClavePrimariaString  + [ and  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41]
			text to lcSentencia noshow textmerge
				update ZooLogic.CANCOMPRA set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxCancompraFmodifw ) + "'">>, "Fd2" = <<"'" + this.ConvertirDateSql( lxCancompraFd2 ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCancompraFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxCancompraFectrans ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCancompraFecexpo ) + "'">>, "Fcuit" = <<"'" + this.FormatearTextoSql( lxCancompraFcuit ) + "'">>, "Idcaja" = <<lxCancompraIdcaja>>, "Fpodes" = <<lxCancompraFpodes>>, "Fpodes1" = <<lxCancompraFpodes1>>, "Fpodes2" = <<lxCancompraFpodes2>>, "Fturno" = <<lxCancompraFturno>>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxCancompraFaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCancompraBdaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxCancompraHaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxCancompraEsttrans ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxCancompraValtafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCancompraBdmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxCancompraUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxCancompraSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxCancompraSaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxCancompraUmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxCancompraVmodifw ) + "'">>, "Simbmon" = <<"'" + this.FormatearTextoSql( lxCancompraSimbmon ) + "'">>, "Fhora" = <<"'" + this.FormatearTextoSql( lxCancompraFhora ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxCancompraZadsfw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxCancompraHoraexpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxCancompraHmodifw ) + "'">>, "Descfw" = <<"'" + this.FormatearTextoSql( lxCancompraDescfw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxCancompraHoraimpo ) + "'">>, "Timestamp" = <<lxCancompraTimestamp>>, "Totalcant" = <<lxCancompraTotalcant>>, "Subtotsisi" = <<lxCancompraSubtotsisi>>, "Subtotcisi" = <<lxCancompraSubtotcisi>>, "Recmnto2" = <<lxCancompraRecmnto2>>, "Recmnto1" = <<lxCancompraRecmnto1>>, "Condivalp" = <<lxCancompraCondivalp>>, "Recmntosi" = <<lxCancompraRecmntosi>>, "Signomov" = <<lxCancompraSignomov>>, "Sitfiscpro" = <<lxCancompraSitfiscpro>>, "Fsubton" = <<lxCancompraFsubton>>, "Fsubtot" = <<lxCancompraFsubtot>>, "Recmntosi1" = <<lxCancompraRecmntosi1>>, "Facttipo" = <<lxCancompraFacttipo>>, "Recmntosi2" = <<lxCancompraRecmntosi2>>, "Desmntosi1" = <<lxCancompraDesmntosi1>>, "Desmntosi" = <<lxCancompraDesmntosi>>, "Desmntosi2" = <<lxCancompraDesmntosi2>>, "Desauto" = <<iif( lxCancompraDesauto, 1, 0 )>>, "Anulado" = <<iif( lxCancompraAnulado, 1, 0 )>>, "Fcompfis" = <<iif( lxCancompraFcompfis, 1, 0 )>>, "Tcrg1361" = <<lxCancompraTcrg1361>>, "Idvuelto" = <<"'" + this.FormatearTextoSql( lxCancompraIdvuelto ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxCancompraCodigo ) + "'">>, "Monsis" = <<"'" + this.FormatearTextoSql( lxCancompraMonsis ) + "'">>, "Fmtdes1" = <<lxCancompraFmtdes1>>, "Fdescu" = <<lxCancompraFdescu>>, "Fmtdes2" = <<lxCancompraFmtdes2>>, "Fletra" = <<"'" + this.FormatearTextoSql( lxCancompraFletra ) + "'">>, "Fimpuesto" = <<lxCancompraFimpuesto>>, "Fobs" = <<"'" + this.FormatearTextoSql( lxCancompraFobs ) + "'">>, "Ffchfac" = <<"'" + this.ConvertirDateSql( lxCancompraFfchfac ) + "'">>, "Fptoven" = <<lxCancompraFptoven>>, "Fmtdes3" = <<lxCancompraFmtdes3>>, "Desmntosi3" = <<lxCancompraDesmntosi3>>, "Recpor" = <<lxCancompraRecpor>>, "Fnumcomp" = <<lxCancompraFnumcomp>>, "Totdescsi" = <<lxCancompraTotdescsi>>, "Ffch" = <<"'" + this.ConvertirDateSql( lxCancompraFfch ) + "'">>, "Mr" = <<lxCancompraMr>>, "Ncai" = <<lxCancompraNcai>>, "Fperson" = <<"'" + this.FormatearTextoSql( lxCancompraFperson ) + "'">>, "Fvtocai" = <<"'" + this.ConvertirDateSql( lxCancompraFvtocai ) + "'">>, "Recmnto" = <<lxCancompraRecmnto>>, "Moneda" = <<"'" + this.FormatearTextoSql( lxCancompraMoneda ) + "'">>, "Cotiz" = <<lxCancompraCotiz>>, "Codlista" = <<"'" + this.FormatearTextoSql( lxCancompraCodlista ) + "'">>, "Ftotal" = <<lxCancompraFtotal>>, "Recmonto2" = <<lxCancompraRecmonto2>>, "Recmonto1" = <<lxCancompraRecmonto1>>, "Fvuelto" = <<lxCancompraFvuelto>>, "Motivo" = <<"'" + this.FormatearTextoSql( lxCancompraMotivo ) + "'">>, "Nroremito" = <<"'" + this.FormatearTextoSql( lxCancompraNroremito ) + "'">>, "Totimpue" = <<lxCancompraTotimpue>>, "Totrecarsi" = <<lxCancompraTotrecarsi>>, "Totrecar" = <<lxCancompraTotrecar>>, "Totdesc" = <<lxCancompraTotdesc>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'CANCOMPRA' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerSentenciaActualizacionTimeStamp() As String
		...
		with this.oEntidad
			...
			lcRetorno = [update ZooLogic.CANCOMPRA set TimeStamp = ] + transform( lnTimeStamp ) + lcUpdateRealTime + [ where CODIGO = ] + "'" + this.FormatearTextoSql( .Codigo ) + "'" + [ and  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41] + goServicios.RealTime.ObtenerTagEstimulo( .cNombre )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerCantidadRegistros() as integer
		local lnCantReg as integer
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select count( * ) as Total from ZooLogic.CANCOMPRA where  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerTimestampActual() as integer
		...
		lcCursor = sys(2015)
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select TimeStamp from ZooLogic.CANCOMPRA where CODIGO = " + "'" + this.FormatearTextoSql( this.oEntidad.CODIGO ) + "'"+ " and  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41" )
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.CANCOMPRA set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, SitFiscPro = ] + transform( &lcCursor..SitFiscPro )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, DesAuto = ] + Transform( iif( &lcCursor..DesAuto, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, tcrg1361 = ] + transform( &lcCursor..tcrg1361 )+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, FFCHFAC = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCHFAC ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, MR = ] + transform( &lcCursor..MR )+ [, NCAI = ] + transform( &lcCursor..NCAI )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FVTOCAI = ] + "'" + this.ConvertirDateSql( &lcCursor..FVTOCAI ) + "'"+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, RecMonto2 = ] + transform( &lcCursor..RecMonto2 )+ [, RecMonto1 = ] + transform( &lcCursor..RecMonto1 )+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, MOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"+ [, NROREMITO = ] + "'" + this.FormatearTextoSql( &lcCursor..NROREMITO ) + "'"+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, totdesc = ] + transform( &lcCursor..totdesc ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FMODIFW, FD2, FECIMPO, FECTRANS, FECEXPO, fCuit, IdCaja, FPODES, FPODES1, FPODES2, FTurno, FAltaFW, BDALTAFW, HAltaFW, ESTTRANS, VALTAFW, BDMODIFW, UALTAFW, SMODIFW, SALTAFW, UMODIFW, VMODIFW, SimbMon, FHORA, ZADSFW, HORAEXPO, HMODIFW, DescFW, HORAIMPO, TIMESTAMP, TotalCant, SubTotSISI, SubTotCISI, RecMnto2, RecMnto1, CondivaLp, RecMntoSI, signomov, SitFiscPro, fSubToN, FSubTOT, RecMntoSI1, FACTTIPO, RecMntoSI2, DesMntoSI1, DesMntoSI, DesMntoSI2, DesAuto, Anulado, FCOMPFIS, tcrg1361, idVuelto, CODIGO, MonSis, FMTDES1, fDescu, FMTDES2, FLETRA, fImpuesto, FObs, FFCHFAC, FPTOVEN, FMTDES3, DesMntoSI3, RecPor, FNUMCOMP, totdescSI, FFCH, MR, NCAI, FPerson, FVTOCAI, RecMnto, Moneda, Cotiz, CodLista, FTotal, RecMonto2, RecMonto1, FVuelto, MOTIVO, NROREMITO, totimpue, totrecarSI, totrecar, totdesc
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..IdCaja )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..FPODES1 ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..FTurno ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + Transform( iif( &lcCursor..DesAuto, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + transform( &lcCursor..tcrg1361 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..fDescu ) + ',' + transform( &lcCursor..FMTDES2 )
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..totdescSI ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..NCAI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FVTOCAI ) + "'" + ',' + transform( &lcCursor..RecMnto ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..RecMonto2 ) + ',' + transform( &lcCursor..RecMonto1 ) + ',' + transform( &lcCursor..FVuelto ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..NROREMITO ) + "'" + ',' + transform( &lcCursor..totimpue )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..totdesc )
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirComponentes() As Void
		this.oEntidad.FacturaDetalle.oItem.oCompPrecios.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSCANCOMPRA',this.oEntidad.cPrefijoRecibir + 'CANCELACIONDECOMPRA')
		this.oEntidad.FacturaDetalle.oItem.oCompStock.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSCANCOMPRA',this.oEntidad.cPrefijoRecibir + 'CANCELACIONDECOMPRA')
		this.oEntidad.oCompEnBaseA.Recibir( this.oEntidad, 'FacturaDetalle', this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSCANCOMPRA', this.oEntidad.cPrefijoRecibir + 'CANCELACIONDECOMPRA')
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FD2 = isnull( d.FD2, t.FD2 ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.SITFISCPRO = isnull( d.SITFISCPRO, t.SITFISCPRO ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.DESAUTO = isnull( d.DESAUTO, t.DESAUTO ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.TCRG1361 = isnull( d.TCRG1361, t.TCRG1361 ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FFCHFAC = isnull( d.FFCHFAC, t.FFCHFAC ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.MR = isnull( d.MR, t.MR ),t.NCAI = isnull( d.NCAI, t.NCAI ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FVTOCAI = isnull( d.FVTOCAI, t.FVTOCAI ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.RECMONTO2 = isnull( d.RECMONTO2, t.RECMONTO2 ),t.RECMONTO1 = isnull( d.RECMONTO1, t.RECMONTO1 ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.NROREMITO = isnull( d.NROREMITO, t.NROREMITO ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC )
				...
				-- Fin Updates
				insert into ZooLogic.CANCOMPRA(Fmodifw,Fd2,Fecimpo,Fectrans,Fecexpo,Fcuit,Idcaja,Fpodes,Fpodes1,Fpodes2,Fturno,Faltafw,Bdaltafw,Haltafw,Esttrans,Valtafw,Bdmodifw,Ualtafw,Smodifw,Saltafw,Umodifw,Vmodifw,Simbmon,Fhora,Zadsfw,Horaexpo,Hmodifw,Descfw,Horaimpo,Timestamp,Totalcant,Subtotsisi,Subtotcisi,Recmnto2,Recmnto1,Condivalp,Recmntosi,Signomov,Sitfiscpro,Fsubton,Fsubtot,Recmntosi1,Facttipo,Recmntosi2,Desmntosi1,Desmntosi,Desmntosi2,Desauto,Anulado,Fcompfis,Tcrg1361,Idvuelto,Codigo,Monsis,Fmtdes1,Fdescu,Fmtdes2,Fletra,Fimpuesto,Fobs,Ffchfac,Fptoven,Fmtdes3,Desmntosi3,Recpor,Fnumcomp,Totdescsi,Ffch,Mr,Ncai,Fperson,Fvtocai,Recmnto,Moneda,Cotiz,Codlista,Ftotal,Recmonto2,Recmonto1,Fvuelto,Motivo,Nroremito,Totimpue,Totrecarsi,Totrecar,Totdesc)
					Select isnull( d.FMODIFW,''),isnull( d.FD2,''),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),isnull( d.FCUIT,''),isnull( d.IDCAJA,0),isnull( d.FPODES,0),isnull( d.FPODES1,0),isnull( d.FPODES2,0),isnull( d.FTURNO,0),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.SIMBMON,''),isnull( d.FHORA,''),isnull( d.ZADSFW,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.DESCFW,''),isnull( d.HORAIMPO,''),isnull( d.TIMESTAMP,0),isnull( d.TOTALCANT,0),isnull( d.SUBTOTSISI,0),isnull( d.SUBTOTCISI,0),isnull( d.RECMNTO2,0),isnull( d.RECMNTO1,0),isnull( d.CONDIVALP,0),isnull( d.RECMNTOSI,0),isnull( d.SIGNOMOV,0),isnull( d.SITFISCPRO,0),isnull( d.FSUBTON,0),isnull( d.FSUBTOT,0),isnull( d.RECMNTOSI1,0),isnull( d.FACTTIPO,0),isnull( d.RECMNTOSI2,0),isnull( d.DESMNTOSI1,0),isnull( d.DESMNTOSI,0),isnull( d.DESMNTOSI2,0),isnull( d.DESAUTO,0),isnull( d.ANULADO,0),isnull( d.FCOMPFIS,0),isnull( d.TCRG1361,0),isnull( d.IDVUELTO,''),isnull( d.CODIGO,''),isnull( d.MONSIS,''),isnull( d.FMTDES1,0),isnull( d.FDESCU,0),isnull( d.FMTDES2,0),isnull( d.FLETRA,''),isnull( d.FIMPUESTO,0),isnull( d.FOBS,''),isnull( d.FFCHFAC,''),isnull( d.FPTOVEN,0),isnull( d.FMTDES3,0),isnull( d.DESMNTOSI3,0),isnull( d.RECPOR,0),isnull( d.FNUMCOMP,0),isnull( d.TOTDESCSI,0),isnull( d.FFCH,''),isnull( d.MR,0),isnull( d.NCAI,0),isnull( d.FPERSON,''),isnull( d.FVTOCAI,''),isnull( d.RECMNTO,0),isnull( d.MONEDA,''),isnull( d.COTIZ,0),isnull( d.CODLISTA,''),isnull( d.FTOTAL,0),isnull( d.RECMONTO2,0),isnull( d.RECMONTO1,0),isnull( d.FVUELTO,0),isnull( d.MOTIVO,''),isnull( d.NROREMITO,''),isnull( d.TOTIMPUE,0),isnull( d.TOTRECARSI,0),isnull( d.TOTRECAR,0),isnull( d.TOTDESC,0)
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_CompAfe( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_CANCOMPRA_CompAfe
ON ZooLogic.TablaTrabajo_CANCOMPRA_CompAfe
AFTER DELETE
As
Begin
Update t Set 
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdateNuevoEnBaseA() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			for each loItem in this.oEntidad.FacturaDetalle
				lcSentencia = "UPDATE ZooLogic.CANCOMPRADET"
				...
				SELECT nro,totalRegistros,CODIGO as Id
				    ...
				    CODIGO from (
							select * 
								...
								Where   CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41
									and <<tcFiltro>>
							 ) a
					 ) b
...
define class ObjetoBusqueda as custom
	Tabla = 'CANCOMPRA'
	Filtro = " CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41"
	oEntidad = null
	cEstructura = ''
	cEstructuraDetalle = ''
	cEstructuraSinDetalle = ''
	listadecampos = ''
	Indice = " CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41"
	AnchoCampo = 13
	Caracteres = 13
	nrodecolumnas = 0
	signopregunta = .T.
...
<VFPData xml:space="preserve">
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="CAJA                                    " tabla="CANCOMPRA      " campo="IDCAJA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CAJAESTADO                              " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Caja                                                                                                                                                            " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="PORCENTAJEDESCUENTO                     " tabla="CANCOMPRA      " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Porcentaje de descuento                                                                                                                                         " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="PORCENTAJEDESCUENTO1                    " tabla="CANCOMPRA      " campo="FPODES1   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje descuento 1                                                                                                                                          " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="2" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="PORCENTAJEDESCUENTO2                    " tabla="CANCOMPRA      " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje descuento 2                                                                                                                                          " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="HORAALTAFW                              " tabla="CANCOMPRA      " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="=goservicios.librerias.obtenerHora()                                                                                                                                                                                                                          " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="RECARGOMONTOCONIMPUESTOS2               " tabla="CANCOMPRA      " campo="RECMNTO2  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargo monto con impuestos 2                                                                                                                                   " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="RECARGOMONTOCONIMPUESTOS1               " tabla="CANCOMPRA      " campo="RECMNTO1  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargo monto con impuestos 1                                                                                                                                   " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="SITUACIONFISCAL                         " tabla="CANCOMPRA      " campo="SITFISCPRO" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SITUACIONFISCAL                         " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Situación fiscal                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="proveedor.SituacionFiscal                                                                                                                                                                                                                                     " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="TIPOCOMPROBANTE                         " tabla="CANCOMPRA      " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=41                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="CODIGO                                  " tabla="CANCOMPRA      " campo="CODIGO    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="14" etiqueta="Código número                                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="MONEDASISTEMA                           " tabla="CANCOMPRA      " campo="MONSIS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Moneda Sistema                                                                                                                                                  " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="DESCUENTO                               " tabla="CANCOMPRA      " campo="FDESCU    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Monto % descuento                                                                                                                                               " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="MONTODESCUENTOCONIMPUESTOS2             " tabla="CANCOMPRA      " campo="FMTDES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto descuento con impuestos 2                                                                                                                                 " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="1" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="IMPUESTOSCOMPROBANTE                    " tabla="IMPCANC        " campo="CCOD      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Impuesto comprobante                                                                                                                                            " dominio="DETALLEITEMIMPUESTOCANCOMPRA  " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="1" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="OBS                                     " tabla="CANCOMPRA      " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="PUNTODEVENTA                            " tabla="CANCOMPRA      " campo="FPTOVEN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="=goServicios.Parametros.felino.Numeraciones.BocaDeExpendio                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="4" etiqueta="Punto de venta                                                                                                                                                  " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="3" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="RECARGOPORCENTAJE                       " tabla="CANCOMPRA      " campo="RECPOR    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Recargo porcentaje                                                                                                                                              " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="NUMERO                                  " tabla="CANCOMPRA      " campo="FNUMCOMP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Número                                                                                                                                                          " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="4" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="FECHA                                   " tabla="CANCOMPRA      " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="416" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="RECARGOMONTO                            " tabla="CANCOMPRA      " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Recargo % monto                                                                                                                                                 " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="PROVEEDOR                               " tabla="CANCOMPRA      " campo="FPERSON   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="8" etiqueta="Proveedor                                                                                                                                                       " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="RECARGOMONTOCONIMPUESTOS                " tabla="CANCOMPRA      " campo="RECMNTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargo monto con impuestos                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="MONEDACOMPROBANTE                       " tabla="CANCOMPRA      " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Moneda comprobante                                                                                                                                              " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="COTIZACION                              " tabla="CANCOMPRA      " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="422" etiqueta="Cotización                                                                                                                                                      " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="TOTAL                                   " tabla="CANCOMPRA      " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Total                                                                                                                                                           " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="2" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDECOMPRA                     " atributo="TOTALIMPUESTOS                          " tabla="CANCOMPRA      " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total impuestos                                                                                                                                                 " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="16" orden="51" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="TOTALRECARGOSSINIMPUESTOS               " tabla="CANCOMPRA      " campo="TOTRECARSI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total recargo sin impuestos                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="15" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="TOTALRECARGOS                           " tabla="CANCOMPRA      " campo="TOTRECAR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total recargo                                                                                                                                                   " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="15" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CANCELACIONDECOMPRA                     " atributo="TOTALDESCUENTOS                         " tabla="CANCOMPRA      " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuentos                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="16" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PROVEEDOR                               " atributo="NOMBRE                                  " tabla="PROV           " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="9" etiqueta="Detalle Pro.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join PROV On CANCOMPRA.FPERSON = PROV.CLCOD And  PROV.CLCOD != ''                                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
...
<VFPData xml:space="preserve">
	...
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="ARTICULO                                " tabla="CANCOMPRADET   " campo="FART      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="201" etiqueta="DetalleArtículos, Artículo                                                                                                                                      " dominio="CONSOPORTEPREPANTALLA         " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="ARTICULODETALLE                         " tabla="CANCOMPRADET   " campo="FTXT      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="202" etiqueta="DetalleArtículos, Artículo descripción                                                                                                                          " dominio="DESCRIPCION                   " detalle="false" tipo="I" atributoforaneo="Articulo.Descripcion                                                                                                                                                                                                                                          " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="COLOR                                   " tabla="CANCOMPRADET   " campo="FCOLO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="203" etiqueta="DetalleArtículos, Color                                                                                                                                         " dominio="CODIGO                        " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="COLORDETALLE                            " tabla="CANCOMPRADET   " campo="FCOTXT    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="204" etiqueta="DetalleArtículos, Descripción del color                                                                                                                         " dominio="DESCRIPCION                   " detalle="false" tipo="I" atributoforaneo="Color.Descripcion                                                                                                                                                                                                                                             " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="TALLE                                   " tabla="CANCOMPRADET   " campo="FTALL     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TALLE                                   " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="205" etiqueta="DetalleArtículos, Talle                                                                                                                                         " dominio="CODIGO                        " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="CANTIDAD                                " tabla="CANCOMPRADET   " campo="FCANT     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="206" etiqueta="DetalleArtículos, Cantidad                                                                                                                                      " dominio="NUMERICODECIMALPARAMETRIZADOCO" detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="23" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="PRECIO                                  " tabla="CANCOMPRADET   " campo="FPRECIO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="14" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="207" etiqueta="DetalleArtículos, Precio                                                                                                                                        " dominio="PRECIONONEGATIVOPARAMETROFOCO " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="25" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="DESCUENTO                               " tabla="CANCOMPRADET   " campo="FCFI      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="7" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="208" etiqueta="DetalleArtículos, % Descuento                                                                                                                                   " dominio="NUMERICOCONSIGNO              " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="26" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="MONTODESCUENTO                          " tabla="CANCOMPRADET   " campo="MNTDES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="12" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="209" etiqueta="DetalleArtículos, Monto descuento                                                                                                                               " dominio="NUMERICO                      " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="27" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSCANCOMPRA                  " atributo="MONTO                                   " tabla="CANCOMPRADET   " campo="FMONTO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="210" etiqueta="DetalleArtículos, Monto                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CANCOMPRADET On CANCOMPRA.CODIGO = CANCOMPRADET.CODIGO And  CANCOMPRA.CODIGO != '' AND CANCOMPRA.FACTTIPO = 41                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
