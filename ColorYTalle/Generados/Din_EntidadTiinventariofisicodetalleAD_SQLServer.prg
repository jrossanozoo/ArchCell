	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TIINVFISDET ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Hmodifw","Saltafw","Smodifw","Ualtafw","Vmodifw","Zadsfw","Valtafw","Horaimpo","Umodifw","Haltafw","Esttrans","Bdaltafw","Bdmodifw","Horaexpo","Art","Codigo","Ccolor","Idcabecera","Talle","Mobs","Canti" ) values ( <<"'" + this.ConvertirDateSql( lxTiinvfisdetFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvfisdetFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvfisdetFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvfisdetFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvfisdetFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetArt ) + "'" >>, <<lxTiinvfisdetCodigo >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetCcolor ) + "'" >>, <<lxTiinvfisdetIdcabecera >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetTalle ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvfisdetMobs ) + "'" >>, <<lxTiinvfisdetCanti >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TIINVFISDET set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFecimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetUaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetValtafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHoraimpo ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetUmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHoraexpo ) + "'">>,"Art" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetArt ) + "'">>,"Codigo" = <<lxTiinvfisdetCodigo>>,"Ccolor" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetCcolor ) + "'">>,"Idcabecera" = <<lxTiinvfisdetIdcabecera>>,"Talle" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetTalle ) + "'">>,"Mobs" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetMobs ) + "'">>,"Canti" = <<lxTiinvfisdetCanti>> where "Codigo" = <<lxTiinvfisdetCodigo>> and  TIINVFISDET.CODIGO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Art" as "Articulo", "Codigo" as "Codigo", "Ccolor" as "Color", "Idcabecera" as "Idcabecera", "Talle" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVFISDET where  TIINVFISDET.CODIGO != 0 order by CODIGO
			endtext
			use in select('c_TIINVENTARIOFISICODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOFISICODETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Art" as "Articulo", "Codigo" as "Codigo", "Ccolor" as "Color", "Idcabecera" as "Idcabecera", "Talle" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVFISDET where  str( CODIGO, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIINVFISDET.CODIGO != 0 order by CODIGO
			endtext
			use in select('c_TIINVENTARIOFISICODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOFISICODETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Art" as "Articulo", "Codigo" as "Codigo", "Ccolor" as "Color", "Idcabecera" as "Idcabecera", "Talle" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVFISDET where  str( CODIGO, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIINVFISDET.CODIGO != 0 order by CODIGO desc
			endtext
			use in select('c_TIINVENTARIOFISICODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOFISICODETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Art" as "Articulo", "Codigo" as "Codigo", "Ccolor" as "Color", "Idcabecera" as "Idcabecera", "Talle" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVFISDET where  TIINVFISDET.CODIGO != 0 order by CODIGO desc
			endtext
			use in select('c_TIINVENTARIOFISICODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOFISICODETALLE', set( 'Datasession' ) )
			Endwith
...
"afw,Horaimpo,Umodifw,Haltafw,Esttrans,Bdaltafw,Bdmodifw,Horaexpo,Art,Codigo,Ccolor,Idcabecera,Talle," + ;
"Mobs,Canti" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Art" as "Articulo", "Codigo" as "Codigo", "Ccolor" as "Color", "Idcabecera" as "Idcabecera", "Talle" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.TIINVFISDET set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTiinvfisdetFecimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetSaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetSmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetUaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetValtafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHoraimpo ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetUmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetEsttrans ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetBdmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetHoraexpo ) + "'">>, "Art" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetArt ) + "'">>, "Codigo" = <<lxTiinvfisdetCodigo>>, "Ccolor" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetCcolor ) + "'">>, "Idcabecera" = <<lxTiinvfisdetIdcabecera>>, "Talle" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetTalle ) + "'">>, "Mobs" = <<"'" + this.FormatearTextoSql( lxTiinvfisdetMobs ) + "'">>, "Canti" = <<lxTiinvfisdetCanti>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'TIINVFISDET' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, HMODIFW, SALTAFW, SMODIFW, UALTAFW, VMODIFW, ZADSFW, VALTAFW, HORAIMPO, UMODIFW, HALTAFW, ESTTRANS, BDALTAFW, BDMODIFW, HORAEXPO, ART, CODIGO, cColor, IDCABECERA, Talle, MOBS, CANTI
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ART ) + "'" + ',' + transform( &lcCursor..CODIGO )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cColor ) + "'" + ',' + transform( &lcCursor..IDCABECERA ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Talle ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOBS ) + "'" + ',' + transform( &lcCursor..CANTI )
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplicarReglaDeNegocioTablaDeTrabajo( toConexion as Object ) As Void
		...
		try
			...
			toConexion.EjecutarNonQuery( 'DISABLE TRIGGER ALL ON ZooLogic.TablaTrabajo_TIInvFisDet' )
			...
			*** Valor sugerido Obs
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "TIINVENTARIOFISICODETALLE", "", "Obs" )
			if !empty( NVL( lcExpresionValorSugeridoDefinidoPorElUsuario, "" ) )
				lvValor = &lcExpresionValorSugeridoDefinidoPorElUsuario
				toConexion.EjecutarNonQuery( "UPDATE ZooLogic.TablaTrabajo_TIInvFisDet SET MOBS = " + golibrerias.ValorAStringSegunTipoBase( lvValor  ) + " WHERE Funciones.Empty( MOBS ) = 1" )
			endif
			
			*** Valor sugerido Cantidad
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "TIINVENTARIOFISICODETALLE", "", "Cantidad" )
			if !empty( NVL( lcExpresionValorSugeridoDefinidoPorElUsuario, "" ) )
				lvValor = &lcExpresionValorSugeridoDefinidoPorElUsuario
				toConexion.EjecutarNonQuery( "UPDATE ZooLogic.TablaTrabajo_TIInvFisDet SET CANTI = " + golibrerias.ValorAStringSegunTipoBase( lvValor  ) + " WHERE Funciones.Empty( CANTI ) = 1" )
			endif
			...
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_TIInvFisDet','ZooLogic.TablaTrabajoErroresValidacion_TIInvFisDet', 'FECEXPO', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_TIInvFisDet','ZooLogic.TablaTrabajoErroresValidacion_TIInvFisDet', 'FECTRANS', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_TIInvFisDet','ZooLogic.TablaTrabajoErroresValidacion_TIInvFisDet', 'FMODIFW', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_TIInvFisDet','ZooLogic.TablaTrabajoErroresValidacion_TIInvFisDet', 'FALTAFW', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_TIInvFisDet','ZooLogic.TablaTrabajoErroresValidacion_TIInvFisDet', 'FECIMPO', toConexion )

			* Articulo obligatorio y FK 
			lcWhere = 'WHERE Funciones.Empty( ART ) = 1 or ART NOT IN ( SELECT ARTCOD from ZooLogic.ART )'
			lcExpresionMensaje  = [CASE WHEN Funciones.Empty( ART ) = 1 THEN 'Debe cargar el campo Articulo.' ELSE 'El dato buscado ' + RTRIM( CAST( ART AS VARCHAR(255) ) ) + ' de la entidad ARTICULO no existe.' END]
			this.ValidacionBasicaObligatorioFKArticulo( toConexion, lcExpresionMensaje, lcWhere, lcCamposLogueo, lcValuesLogueoComunes ) 

			* IDCabecera obligatorio y FK 
			lcWhere = 'WHERE Funciones.Empty( IDCABECERA ) = 1 or IDCABECERA NOT IN ( SELECT CODIGO from ZooLogic.TIInvFis )'
			lcExpresionMensaje  = [CASE WHEN Funciones.Empty( IDCABECERA ) = 1 THEN 'Debe cargar el campo IDCabecera.' ELSE 'El dato buscado ' + RTRIM( CAST( IDCABECERA AS VARCHAR(255) ) ) + ' de la entidad TIInventarioFisico no existe.' END]
			this.ValidacionBasicaObligatorioFKIDCabecera( toConexion, lcExpresionMensaje, lcWhere, lcCamposLogueo, lcValuesLogueoComunes ) 
			...
			* Color FK 
			...
			toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.TablaTrabajoErroresValidacion_TIInvFisDet ( NroLinea, Motivo ) SELECT NroLinea, ] + lcExpresionMensaje  + [ FROM ZooLogic.TablaTrabajo_TIInvFisDet ] + lcWhere )
			toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.Logueos ( ] + lcCamposLogueo + [ ) ] + lcValuesLogueoComunes + lcExpresionMensaje  + [ FROM ZooLogic.TablaTrabajo_TIInvFisDet ] + lcWhere )
			toConexion.EjecutarNonQuery( [DELETE FROM ZooLogic.TablaTrabajo_TIInvFisDet ] + lcWhere )
			...
			* Talle FK 
			...
			toConexion.EjecutarNonQuery( 'ENABLE TRIGGER ALL ON ZooLogic.TablaTrabajo_TIInvFisDet' )
		catch to loError
			goServicios.Errores.LevantarExcepcion( loError )
		endtry
	EndFunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionBasicaObligatorioFKIDCabecera( toConexion, lcExpresionMensaje, lcWhere, lcCamposLogueo, lcValuesLogueoComunes ) as void
		toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.TablaTrabajoErroresValidacion_TIInvFisDet ( NroLinea, Motivo ) SELECT NroLinea, ] + lcExpresionMensaje + [ FROM ZooLogic.TablaTrabajo_TIInvFisDet ] + lcWhere )
		toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.Logueos ( ] + lcCamposLogueo + [ ) ] + lcValuesLogueoComunes + lcExpresionMensaje + [ FROM ZooLogic.TablaTrabajo_TIInvFisDet ] + lcWhere )
		toConexion.EjecutarNonQuery( [DELETE FROM ZooLogic.TablaTrabajo_TIInvFisDet ] + lcWhere )
	endfunc
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.ART = isnull( d.ART, t.ART ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.CCOLOR = isnull( d.CCOLOR, t.CCOLOR ),t.IDCABECERA = isnull( d.IDCABECERA, t.IDCABECERA ),t.TALLE = isnull( d.TALLE, t.TALLE ),t.MOBS = isnull( d.MOBS, t.MOBS ),t.CANTI = isnull( d.CANTI, t.CANTI )
					from ZooLogic.TIINVFISDET t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.TIINVFISDET(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Hmodifw,Saltafw,Smodifw,Ualtafw,Vmodifw,Zadsfw,Valtafw,Horaimpo,Umodifw,Haltafw,Esttrans,Bdaltafw,Bdmodifw,Horaexpo,Art,Codigo,Ccolor,Idcabecera,Talle,Mobs,Canti)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.ART,''),isnull( d.CODIGO,0),isnull( d.CCOLOR,''),isnull( d.IDCABECERA,0),isnull( d.TALLE,''),isnull( d.MOBS,''),isnull( d.CANTI,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_TIINVENTARIOFISICODETALLE' ) < 1
				...
				Try
					...
					.Talle_PK =  nvl( c_TIINVENTARIOFISICODETALLE.Talle, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIINVENTARIOFISICODETALLE               " atributo="FECHATRANSFERENCIA                      " tabla="TIINVFISDET    " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIINVENTARIOFISICODETALLE               " atributo="ESTADOTRANSFERENCIA                     " tabla="TIINVFISDET    " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIINVENTARIOFISICODETALLE               " atributo="ARTICULO                                " tabla="TIINVFISDET    " campo="ART       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Artículo                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; art.astock &lt;= 1 &quot;                                                                                                                                                                                     " grupo="1" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIINVENTARIOFISICODETALLE               " atributo="COLOR                                   " tabla="TIINVFISDET    " campo="CCOLOR    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Color                                                                                                                                                           " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
