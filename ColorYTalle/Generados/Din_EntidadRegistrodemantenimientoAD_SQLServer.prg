...
define class Din_EntidadREGISTRODEMANTENIMIENTOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRegactisysFectrans, lxRegactisysFaltafw, lxRegactisysFecexpo, lxRegactisysFmodifw, lxRegactisysFecimpo, lxRegactisysHoraexpo, lxRegactisysHoraimpo, lxRegactisysHaltafw, lxRegactisysUaltafw, lxRegactisysVmodifw, lxRegactisysZadsfw, lxRegactisysValtafw, lxRegactisysUmodifw, lxRegactisysSaltafw, lxRegactisysSmodifw, lxRegactisysHmodifw, lxRegactisysEsttrans, lxRegactisysCsitio, lxRegactisysBdmodifw, lxRegactisysCestado, lxRegactisysCfechafin, lxRegactisysCfechaini, lxRegactisysCtipo, lxRegactisysCcodigo, lxRegactisysChoraini, lxRegactisysChorafin, lxRegactisysCptoventa, lxRegactisysDet, lxRegactisysCnumero, lxRegactisysCresultado, lxRegactisysBdaltafw, lxRegactisysCdescrip
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.REGACTISYS ( "Fectrans","Faltafw","Fecexpo","Fmodifw","Fecimpo","Horaexpo","Horaimpo","Haltafw","Ualtafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Saltafw","Smodifw","Hmodifw","Esttrans","Csitio","Bdmodifw","Cestado","Cfechafin","Cfechaini","Ctipo","Ccodigo","Choraini","Chorafin","Cptoventa","Det","Cnumero","Cresultado","Bdaltafw","Cdescrip" ) values ( <<"'" + this.ConvertirDateSql( lxRegactisysFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactisysFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactisysFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactisysFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactisysFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysCsitio ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysBdmodifw ) + "'" >>, <<lxRegactisysCestado >>, <<"'" + this.ConvertirDateSql( lxRegactisysCfechafin ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactisysCfechaini ) + "'" >>, <<lxRegactisysCtipo >>, <<"'" + this.FormatearTextoSql( lxRegactisysCcodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysChoraini ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysChorafin ) + "'" >>, <<lxRegactisysCptoventa >>, <<"'" + this.FormatearTextoSql( lxRegactisysDet ) + "'" >>, <<lxRegactisysCnumero >>, <<"'" + this.FormatearTextoSql( lxRegactisysCresultado ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactisysCdescrip ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Csitio" as "Sitio", "Bdmodifw" as "Basededatosmodificacionfw", "Cestado" as "Estado", "Cfechafin" as "Fechafin", "Cfechaini" as "Fechainicio", "Ctipo" as "Tipo", "Ccodigo" as "Codigo", "Choraini" as "Horainicio", "Chorafin" as "Horafin", "Cptoventa" as "Puntodeventa", "Det" as "Registro", "Cnumero" as "Numero", "Cresultado" as "Resultadodelatarea", "Bdaltafw" as "Basededatosaltafw", "Cdescrip" as "Descripcion" from ORGANIZACION.REGACTISYS where "Ccodigo" = <<"'" + this.FormatearTextoSql( lxRegactisysCcodigo ) + "'">> and  REGACTISYS.CCODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Faltafw,Fecexpo,Fmodifw,Fecimpo,Horaexpo,Horaimpo,Haltafw,Ualtafw,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Saltafw,Smodifw,Hmodifw,Esttrans,Csitio,Bdmodifw,Cestado,Cfechafin,Cfechaini,Ctipo,Cco" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECTRANS, FALTAFW, FECEXPO, FMODIFW, FECIMPO, HORAEXPO, HORAIMPO, HALTAFW, UALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SALTAFW, SMODIFW, HMODIFW, ESTTRANS, cSitio, BDMODIFW, cEstado, cFechaFin, cFechaIni, cTipo, cCodigo, cHoraIni, cHoraFin, cPtoventa, det, cNumero, cResultado, BDAltaFW, cDescrip
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cSitio ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..cEstado ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..cFechaFin ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function ObtenerIdentificadorParaLoguear( tcCursor as String ) As String
		...
		lcRetorno = lcRetorno + ' - Número interno: ' + transform( &tcCursor..cNumero    )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CSITIO = isnull( d.CSITIO, t.CSITIO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CESTADO = isnull( d.CESTADO, t.CESTADO ),t.CFECHAFIN = isnull( d.CFECHAFIN, t.CFECHAFIN ),t.CFECHAINI = isnull( d.CFECHAINI, t.CFECHAINI ),t.CTIPO = isnull( d.CTIPO, t.CTIPO ),t.CCODIGO = isnull( d.CCODIGO, t.CCODIGO ),t.CHORAINI = isnull( d.CHORAINI, t.CHORAINI ),t.CHORAFIN = isnull( d.CHORAFIN, t.CHORAFIN ),t.CPTOVENTA = isnull( d.CPTOVENTA, t.CPTOVENTA ),t.DET = isnull( d.DET, t.DET ),t.CNUMERO = isnull( d.CNUMERO, t.CNUMERO ),t.CRESULTADO = isnull( d.CRESULTADO, t.CRESULTADO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CDESCRIP = isnull( d.CDESCRIP, t.CDESCRIP )
				...
				-- Fin Updates
				insert into ORGANIZACION.REGACTISYS(Fectrans,Faltafw,Fecexpo,Fmodifw,Fecimpo,Horaexpo,Horaimpo,Haltafw,Ualtafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Saltafw,Smodifw,Hmodifw,Esttrans,Csitio,Bdmodifw,Cestado,Cfechafin,Cfechaini,Ctipo,Ccodigo,Choraini,Chorafin,Cptoventa,Det,Cnumero,Cresultado,Bdaltafw,Cdescrip)
					Select isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.CSITIO,''),isnull( d.BDMODIFW,''),isnull( d.CESTADO,0),isnull( d.CFECHAFIN,''),isnull( d.CFECHAINI,''),isnull( d.CTIPO,0),isnull( d.CCODIGO,''),isnull( d.CHORAINI,''),isnull( d.CHORAFIN,''),isnull( d.CPTOVENTA,0),isnull( d.DET,''),isnull( d.CNUMERO,0),isnull( d.CRESULTADO,''),isnull( d.BDALTAFW,''),isnull( d.CDESCRIP,'')
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					...
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: PUNTO DE VENTA ' + cast( d.cPtoventa as Varchar(4) ) + ', NÚMERO INTERNO ' + cast( d.cNumero as Varchar(8) ) + ', BASE DE DATOS ' + cast( d.BDAltaFW as Varchar(8) ) + '','La clave principal no es la esperada'
					from ORGANIZACION.REGACTISYS t inner join deleted d 
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					<<loLogueo.EstadoSistema>>,'<<loLogueo.Aplicacion>>','<<loLogueo.Version>>',
					'<<loLogueo.Serie>>','<<loLogueo.Usuario>>','<<loLogueo.NombrePc>>',
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: PUNTO DE VENTA ' + cast( d.cPtoventa as Varchar(4) ) + ', NÚMERO INTERNO ' + cast( d.cNumero as Varchar(8) ) + ', BASE DE DATOS ' + cast( d.BDAltaFW as Varchar(8) ) + '','La clave principal a importar ya existe'
					from ORGANIZACION.REGACTISYS t inner join deleted d 
							 on t.cCodigo = d.cCodigo
						left join deleted h 
...
<VFPData xml:space="preserve">
	...
	<row entidad="REGISTRODEMANTENIMIENTO                 " atributo="FECHATRANSFERENCIA                      " tabla="REGACTISYS     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEMANTENIMIENTO                 " atributo="ESTADOTRANSFERENCIA                     " tabla="REGACTISYS     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEMANTENIMIENTO                 " atributo="NUMERO                                  " tabla="REGACTISYS     " campo="CNUMERO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Número interno                                                                                                                                                  " dominio="NUMEROINTERNO                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="2" mascara="X999-99999999            " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
