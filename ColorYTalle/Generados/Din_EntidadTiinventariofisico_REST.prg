...
define class Din_EntidadTiinventariofisico_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Tiinventariofisico"
	cClaseResponse = this.cNamespaceDTOs + ".TiinventariofisicoResponse"
	cClaseModelo = "TiinventariofisicoModelo"
	cEntidad = "Tiinventariofisico"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicoModelo"
		endcase
		return lcRetorno
