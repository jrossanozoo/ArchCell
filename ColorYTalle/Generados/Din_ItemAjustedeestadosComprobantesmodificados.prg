...
define class Din_ItemAJUSTEDEESTADOSComprobantesmodificados as ItemActivo of ItemActivo.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'AJUSTEDEESTADOS', 'Comprobantesmodificados')
	...
	*--------------------------------------------------------------------------------------------------------
	function Detallemodificacion_Assign( txVal as variant ) as void
		...
		Local lxValOld As Variant
		lxValOld = this.Detallemodificacion
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Detallemodificacion( lxVal )
				this.EventoAntesDeSetear( This, 'Detallemodificacion', lxValOld, lxVal  )
				this.Setear_Detallemodificacion( lxVal )
				this.EventoDespuesDeSetear( This, 'Detallemodificacion', lxValOld, lxVal  )
				If lxValOld != lxVal
					If This.PuedeEjecutarHaCambiado()
						this.HaCambiado( 'Detallemodificacion', This )
					Endif
				EndIf
			EndIf
		Else
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Detallemodificacion( txVal as variant ) as void
		...
		this.Detallemodificacion = txVal
		dodefault( txVal )
