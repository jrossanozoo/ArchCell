...
define class Mock_Itemfacturaelectronicaexportacionimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicaexportacionimpuestosdetalle'
