	...
	function ValidarVendedorDesde() as boolean
		...
		if empty( this.VendedorDesde_PK )
			...
			If this.VendedorDesde.oAD.ConsultarPorClavePrimaria()
				This.VendedorDesde.oDesactivador.ValidarEstadoActivacion( this.VendedorDesde_PK , goLibrerias.Valorvacioseguntipo( vartype(this.VendedorDesde_PK ) ), this.lnuevo, this.ledicion )
			Else
	...
	function ValidarVendedorHasta() as boolean
		...
		if empty( this.VendedorHasta_PK )
			...
			If this.VendedorHasta.oAD.ConsultarPorClavePrimaria()
				This.VendedorHasta.oDesactivador.ValidarEstadoActivacion( this.VendedorHasta_PK , goLibrerias.Valorvacioseguntipo( vartype(this.VendedorHasta_PK ) ), this.lnuevo, this.ledicion )
			Else
