...
define class Mock_Itemcotizacionproduccioncotizacionordenproduccion as MockBase of MockBase.prg

	cClase = 'Itemcotizacionproduccioncotizacionordenproduccion'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcosto() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwcosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwmonto() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwmonto', lcParametros )
	EndFunc
