...
define class Din_EntidadDescuento_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Descuento"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Vendedor_clasificacionvdesde", toEntidad, "Vendedor_clasificacionvdesde_PK" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Vendedor_clasificacionvhasta", toEntidad, "Vendedor_clasificacionvhasta_PK" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "Vendedor_ClasificacionVDesde", toEntidad.Vendedor_ClasificacionVDesde_PK)
			this.SetearAtributoString( toModeloResponse, "Vendedor_ClasificacionVHasta", toEntidad.Vendedor_ClasificacionVHasta_PK)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Vendedor_clasificacionvdesde", "CLASVDESDE")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Vendedor_clasificacionvhasta", "CLASVHASTA")
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerBusquedaSegunModeloRequest( toRequest as Object ) as String
		...
		if !isnull( lcExpresionBusqueda )
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Clasvdesde LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Clasvhasta LIKE '%" + lcExpresionBusqueda + "%'"
