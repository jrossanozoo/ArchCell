...
define class Din_DetalleCONCILIACIONDECAJAConciliasaldo as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemCONCILIACIONDECAJAConciliasaldo' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Conciliasaldo
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.NROITEM = c_Conciliasaldo.NROITEM
			loItem.codigo = c_Conciliasaldo.codigo
			loItem.TipoComprobante = c_Conciliasaldo.TipoComprobante
			loItem.DescTipoComprobante = c_Conciliasaldo.DescTipoComprobante
			loItem.Valor_PK = c_Conciliasaldo.Valor
			loItem.ValorDetalle = c_Conciliasaldo.ValorDetalle
			loItem.SaldoAct = c_Conciliasaldo.SaldoAct
			loItem.SaldoProy = c_Conciliasaldo.SaldoProy
			loItem.Ajuste = c_Conciliasaldo.Ajuste
			loItem.NroItem = lnI 
