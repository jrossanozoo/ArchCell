...
define class Mock_Itemindicesinflacionindices as MockBase of MockBase.prg

	cClase = 'Itemindicesinflacionindices'
	...
	*-----------------------------------------------------------------------------------------
	function mes_assign( txval as variant ) as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Mes_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_mes( txval as variant ) as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_mes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_mes( txval as variant ) as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_mes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomes() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridomes', lcParametros )
	EndFunc
