...
define class Mock_Itemcodbarraaltercodbardetalle as MockBase of MockBase.prg

	cClase = 'Itemcodbarraaltercodbardetalle'
	...
	*-----------------------------------------------------------------------------------------
	function cantidadcaracteres_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cantidadcaracteres_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cantidaddecimales_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cantidaddecimales_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function posicioninicial_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Posicioninicial_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidadcaracteres( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_cantidadcaracteres', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidaddecimales( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_cantidaddecimales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_posicioninicial( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_posicioninicial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valorbandera( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_valorbandera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidadcaracteres( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_cantidadcaracteres', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidaddecimales( txval as variant ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_cantidaddecimales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_posicioninicial( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_posicioninicial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valorbandera( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_valorbandera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorbandera_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorbandera_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidadcaracteres() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridocantidadcaracteres', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidaddecimales() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridocantidaddecimales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoposicioninicial() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoposicioninicial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovalorbandera() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridovalorbandera', lcParametros )
	EndFunc
