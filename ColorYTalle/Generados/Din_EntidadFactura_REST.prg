...
define class Din_EntidadFactura_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Factura"
	cClaseResponse = this.cNamespaceDTOs + ".FacturaResponse"
	cClaseModelo = "FacturaModelo"
	cEntidad = "Factura"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaModelo"
		endcase
		return lcRetorno
