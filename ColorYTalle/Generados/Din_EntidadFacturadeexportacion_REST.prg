...
define class Din_EntidadFacturadeexportacion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Facturadeexportacion"
	cClaseResponse = this.cNamespaceDTOs + ".FacturadeexportacionResponse"
	cClaseModelo = "FacturadeexportacionModelo"
	cEntidad = "Facturadeexportacion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturadeexportacionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturadeexportacionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturadeexportacionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "FacturadeexportacionModelo"
		endcase
		return lcRetorno
