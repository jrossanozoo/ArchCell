...
define class Din_EntidadComprobantederetencionesganancias_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Comprobantederetencionesganancias"
	cClaseResponse = this.cNamespaceDTOs + ".ComprobantederetencionesgananciasResponse"
	cClaseModelo = "ComprobantederetencionesgananciasModelo"
	cEntidad = "Comprobantederetencionesganancias"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionesgananciasModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionesgananciasListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionesgananciasListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ComprobantederetencionesgananciasModelo"
		endcase
		return lcRetorno
