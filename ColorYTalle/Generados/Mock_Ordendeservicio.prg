...
define class Mock_ordendeservicio as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function ajustarfiltrobusquedacodigoserv( toobjetobusqueda as object ) as void                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Ajustarfiltrobusquedacodigoserv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallecodigodeservicio() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallecodigodeservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleinteracciones() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleinteracciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function completardatosoriginales() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Completardatosoriginales', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function completardatospresupuesto() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Completardatospresupuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesdecargar() as void                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdecargar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocargardatospresupuesto() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocargardatospresupuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitarpresupuesto() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventohabilitarpresupuesto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventoinformarerroralfacturar( tcmensaje ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventoinformarerroralfacturar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventosetearaccion() as void                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventosetearaccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existepresupuesto() as boolean                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existepresupuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaadicional1_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaadicional1_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaadicional1_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaadicional1		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaadicional1( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Fechaadicional1( lxVal )			EndIf		Else			This.Setear_Fechaadicional1( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function fechaadicional2_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaadicional2_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaadicional2_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaadicional2		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaadicional2( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Fechaadicional2( lxVal )			EndIf		Else			This.Setear_Fechaadicional2( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function fechaadicional3_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaadicional3_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaadicional3_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaadicional3		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaadicional3( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Fechaadicional3( lxVal )			EndIf		Else			This.Setear_Fechaadicional3( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaentrega_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaentrega_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaentrega_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaentrega		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaentrega( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Fechaentrega( lxVal )			EndIf		Else			This.Setear_Fechaentrega( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function grabardiferenciasdeatributos() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Grabardiferenciasdeatributos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function guidpresupuesto_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'guidpresupuesto_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'guidpresupuesto_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Guidpresupuesto		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Guidpresupuesto( lxVal )				this.Setear_Guidpresupuesto( lxVal )			EndIf		Else			This.Setear_Guidpresupuesto( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function letrapresupuesto_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'letrapresupuesto_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'letrapresupuesto_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Letrapresupuesto		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Letrapresupuesto( lxVal )				this.Setear_Letrapresupuesto( lxVal )			EndIf		Else			This.Setear_Letrapresupuesto( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nrofactura_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'nrofactura_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'nrofactura_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Nrofactura		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Nrofactura( lxVal )				this.Setear_Nrofactura( lxVal )			EndIf		Else			This.Setear_Nrofactura( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numeropresupuesto_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numeropresupuesto_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numeropresupuesto_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numeropresupuesto		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numeropresupuesto( lxVal )				this.Setear_Numeropresupuesto( lxVal )			EndIf		Else			This.Setear_Numeropresupuesto( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercliente() as string                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfiltroodsafacturar() as string                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerfiltroodsafacturar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerpreciodecombinacion( tdfecha, tclista, tlmostrarimpuestos ) as float                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenerpreciodecombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerpreciodeorden( tdfecha, tclista, tlmostrarimpuestos ) as float                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenerpreciodeorden', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ordenfacturada() as boolean                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ordenfacturada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function presupuesto_pk_despuesdeasignar() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Presupuesto_pk_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function presupuestoafectado() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Presupuestoafectado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ptovtapresupuesto_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ptovtapresupuesto_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ptovtapresupuesto_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ptovtapresupuesto		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ptovtapresupuesto( lxVal )				this.Setear_Ptovtapresupuesto( lxVal )			EndIf		Else			This.Setear_Ptovtapresupuesto( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function puedefacturarods() as boolean                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Puedefacturarods', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function puedesetearpresupuesto() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Puedesetearpresupuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_color( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_color', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_color', lcParametros )			endif		endif		this.Color.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_entidadadicional1( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_entidadadicional1', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_entidadadicional1', lcParametros )			endif		endif		this.Entidadadicional1.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_entidadadicional2( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_entidadadicional2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_entidadadicional2', lcParametros )			endif		endif		this.Entidadadicional2.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_entidadadicional3( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_entidadadicional3', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_entidadadicional3', lcParametros )			endif		endif		this.Entidadadicional3.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fecha( txval ) as void                                                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaadicional1( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaadicional1', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaadicional1', lcParametros )			endif		endif		this.Fechaadicional1 = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_fechaadicional2( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaadicional2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaadicional2', lcParametros )			endif		endif		this.Fechaadicional2 = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_fechaadicional3( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaadicional3', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaadicional3', lcParametros )			endif		endif		this.Fechaadicional3 = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaentrega( txval ) as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaentrega', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaentrega', lcParametros )			endif		endif		dodefault( txVal )		this.ValidarFechas()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_guidpresupuesto( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_guidpresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_guidpresupuesto', lcParametros )			endif		endif		this.Guidpresupuesto = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idglobalcliente( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_idglobalcliente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_idglobalcliente', lcParametros )			endif		endif		this.Idglobalcliente = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_letrapresupuesto( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_letrapresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_letrapresupuesto', lcParametros )			endif		endif		this.Letrapresupuesto = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_nrofactura( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_nrofactura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_nrofactura', lcParametros )			endif		endif		this.Nrofactura = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_numeropresupuesto( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numeropresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numeropresupuesto', lcParametros )			endif		endif		this.Numeropresupuesto = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_presupuesto( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_presupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_presupuesto', lcParametros )			endif		endif		this.Presupuesto.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_ptovtapresupuesto( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ptovtapresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ptovtapresupuesto', lcParametros )			endif		endif		this.Ptovtapresupuesto = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodeorden( txval ) as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tipodeorden', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tipodeorden', lcParametros )			endif		endif		dodefault( txVal )		this.DetalleCodigoDeServicio.oItem.lHabilitarCodigoServ_PK = !empty( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_vendedordescripcion( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_vendedordescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_vendedordescripcion', lcParametros )			endif		endif		this.Vendedordescripcion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seteardescuentos( toitem ) as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Seteardescuentos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tieneestadoquepermitefacturar() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tieneestadoquepermitefacturar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_color( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_color', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_color', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_entidadadicional1( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_entidadadicional1', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_entidadadicional1', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_entidadadicional2( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_entidadadicional2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_entidadadicional2', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_entidadadicional3( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_entidadadicional3', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_entidadadicional3', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaadicional1( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaadicional1', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaadicional1', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_fechaadicional2( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaadicional2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaadicional2', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_fechaadicional3( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaadicional3', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaadicional3', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaentrega( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaentrega', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaentrega', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_guidpresupuesto( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_guidpresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_guidpresupuesto', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idglobalcliente( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idglobalcliente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idglobalcliente', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_letrapresupuesto( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_letrapresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_letrapresupuesto', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_nrofactura( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_nrofactura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_nrofactura', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_numeropresupuesto( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numeropresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numeropresupuesto', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_presupuesto( txval, txvalold ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_presupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_presupuesto', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal, txValOld )		this.EventoSetearAccion()		if llRetorno and !empty( this.Presupuesto_pk ) and !inlist( alltrim( upper( this.cAccion ) ), "CANCELAR", "SALIR" )			llRetorno = llRetorno and this.PuedeSetearPresupuesto()			*this.VerificarPresupuestoAfectado()		endif			return llRetorno	
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_ptovtapresupuesto( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ptovtapresupuesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ptovtapresupuesto', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_talle( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_talle', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_talle', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodeorden( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipodeorden', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipodeorden', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_vendedordescripcion( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_vendedordescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_vendedordescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validararticulo() as boolean                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validararticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcolor() as boolean                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarcolor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarentidadadicional1() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarentidadadicional1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarentidadadicional2() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarentidadadicional2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarentidadadicional3() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarentidadadicional3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarestado() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechaentrega() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarfechaentrega', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechas() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarfechas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarhabilitaciondelcliente() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarhabilitaciondelcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarpresupuesto() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validarpresupuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartalle() as boolean                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validartalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartipodeorden() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validartipodeorden', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridobasededatosaltafw() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridobasededatosaltafw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoentidadadicional1() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoentidadadicional1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoentidadadicional2() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoentidadadicional2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoentidadadicional3() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoentidadadicional3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaadicional1() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofechaadicional1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaadicional2() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofechaadicional2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaadicional3() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofechaadicional3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaentrega() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofechaentrega', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwbasededatosaltafw() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwbasededatosaltafw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonrofactura() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridonrofactura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopresupuesto() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridopresupuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipodeorden() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridotipodeorden', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovendedordescripcion() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridovendedordescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function vendedordescripcion_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'vendedordescripcion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'vendedordescripcion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Vendedordescripcion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Vendedordescripcion( lxVal )				this.Setear_Vendedordescripcion( lxVal )			EndIf		Else			This.Setear_Vendedordescripcion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarpresupuestoafectado() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarpresupuestoafectado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarfiltrobusquedapresupuesto( toobjetobusqueda as object ) as void                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Ajustarfiltrobusquedapresupuesto', lcParametros )
	EndFunc
