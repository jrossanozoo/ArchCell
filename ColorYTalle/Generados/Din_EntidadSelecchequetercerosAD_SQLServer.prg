...
define class Din_EntidadSELECCHEQUETERCEROSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxSelcheqtrFectrans, lxSelcheqtrFmodifw, lxSelcheqtrFaltafw, lxSelcheqtrFecimpo, lxSelcheqtrFecexpo, lxSelcheqtrHoraimpo, lxSelcheqtrHoraexpo, lxSelcheqtrBdaltafw, lxSelcheqtrHaltafw, lxSelcheqtrBdmodifw, lxSelcheqtrEsttrans, lxSelcheqtrHmodifw, lxSelcheqtrSaltafw, lxSelcheqtrUmodifw, lxSelcheqtrVmodifw, lxSelcheqtrUaltafw, lxSelcheqtrValtafw, lxSelcheqtrZadsfw, lxSelcheqtrSmodifw, lxSelcheqtrCodigo, lxSelcheqtrDescrip, lxSelcheqtrFchdesde, lxSelcheqtrFchhasta, lxSelcheqtrFchemidesd, lxSelcheqtrFchemihast, lxSelcheqtrNumintdesd, lxSelcheqtrNuminthast, lxSelcheqtrMntodesde, lxSelcheqtrMntohasta, lxSelcheqtrMondesde, lxSelcheqtrMonhasta, lxSelcheqtrCliedesde, lxSelcheqtrClihasta, lxSelcheqtrNumdesde, lxSelcheqtrNumhasta, lxSelcheqtrEntfdesde, lxSelcheqtrEntfhasta, lxSelcheqtrCodvaldesd, lxSelcheqtrCodvalhast, lxSelcheqtrCuitdesde, lxSelcheqtrCuithasta, lxSelcheqtrObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.SELCHEQTR ( "Fectrans","Fmodifw","Faltafw","Fecimpo","Fecexpo","Horaimpo","Horaexpo","Bdaltafw","Haltafw","Bdmodifw","Esttrans","Hmodifw","Saltafw","Umodifw","Vmodifw","Ualtafw","Valtafw","Zadsfw","Smodifw","Codigo","Descrip","Fchdesde","Fchhasta","Fchemidesd","Fchemihast","Numintdesd","Numinthast","Mntodesde","Mntohasta","Mondesde","Monhasta","Cliedesde","Clihasta","Numdesde","Numhasta","Entfdesde","Entfhasta","Codvaldesd","Codvalhast","Cuitdesde","Cuithasta","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxSelcheqtrFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrDescrip ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFchdesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFchhasta ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFchemidesd ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSelcheqtrFchemihast ) + "'" >>, <<lxSelcheqtrNumintdesd >>, <<lxSelcheqtrNuminthast >>, <<lxSelcheqtrMntodesde >>, <<lxSelcheqtrMntohasta >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrMondesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrMonhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrCliedesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrClihasta ) + "'" >>, <<lxSelcheqtrNumdesde >>, <<lxSelcheqtrNumhasta >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrEntfdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrEntfhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrCodvaldesd ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrCodvalhast ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrCuitdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrCuithasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSelcheqtrObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.SELCHEQTR set "Fectrans" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFecexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxSelcheqtrHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxSelcheqtrHoraexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxSelcheqtrEsttrans ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrSaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrVmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrZadsfw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxSelcheqtrSmodifw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxSelcheqtrDescrip ) + "'">>,"Fchdesde" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFchdesde ) + "'">>,"Fchhasta" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFchhasta ) + "'">>,"Fchemidesd" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFchemidesd ) + "'">>,"Fchemihast" = <<"'" + this.ConvertirDateSql( lxSelcheqtrFchemihast ) + "'">>,"Numintdesd" = <<lxSelcheqtrNumintdesd>>,"Numinthast" = <<lxSelcheqtrNuminthast>>,"Mntodesde" = <<lxSelcheqtrMntodesde>>,"Mntohasta" = <<lxSelcheqtrMntohasta>>,"Mondesde" = <<"'" + this.FormatearTextoSql( lxSelcheqtrMondesde ) + "'">>,"Monhasta" = <<"'" + this.FormatearTextoSql( lxSelcheqtrMonhasta ) + "'">>,"Cliedesde" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCliedesde ) + "'">>,"Clihasta" = <<"'" + this.FormatearTextoSql( lxSelcheqtrClihasta ) + "'">>,"Numdesde" = <<lxSelcheqtrNumdesde>>,"Numhasta" = <<lxSelcheqtrNumhasta>>,"Entfdesde" = <<"'" + this.FormatearTextoSql( lxSelcheqtrEntfdesde ) + "'">>,"Entfhasta" = <<"'" + this.FormatearTextoSql( lxSelcheqtrEntfhasta ) + "'">>,"Codvaldesd" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCodvaldesd ) + "'">>,"Codvalhast" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCodvalhast ) + "'">>,"Cuitdesde" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCuitdesde ) + "'">>,"Cuithasta" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCuithasta ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxSelcheqtrObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCodigo ) + "'">> and  SELCHEQTR.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Fchdesde" as "Fechadesde", "Fchhasta" as "Fechahasta", "Fchemidesd" as "Fchemdesde", "Fchemihast" as "Fchemhasta", "Numintdesd" as "Numindesde", "Numinthast" as "Numinhasta", "Mntodesde" as "Montodesde", "Mntohasta" as "Montohasta", "Mondesde" as "Mondesde", "Monhasta" as "Monhasta", "Cliedesde" as "Clidesde", "Clihasta" as "Clihasta", "Numdesde" as "Numdesde", "Numhasta" as "Numhasta", "Entfdesde" as "Entfindesde", "Entfhasta" as "Entfinhasta", "Codvaldesd" as "Codvaldesde", "Codvalhast" as "Codvalhasta", "Cuitdesde" as "Cuitdesde", "Cuithasta" as "Cuithasta", "Obs" as "Obs" from ZooLogic.SELCHEQTR where "Codigo" = <<"'" + this.FormatearTextoSql( lxSelcheqtrCodigo ) + "'">> and  SELCHEQTR.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Fchdesde" as "Fechadesde", "Fchhasta" as "Fechahasta", "Fchemidesd" as "Fchemdesde", "Fchemihast" as "Fchemhasta", "Numintdesd" as "Numindesde", "Numinthast" as "Numinhasta", "Mntodesde" as "Montodesde", "Mntohasta" as "Montohasta", "Mondesde" as "Mondesde", "Monhasta" as "Monhasta", "Cliedesde" as "Clidesde", "Clihasta" as "Clihasta", "Numdesde" as "Numdesde", "Numhasta" as "Numhasta", "Entfdesde" as "Entfindesde", "Entfhasta" as "Entfinhasta", "Codvaldesd" as "Codvaldesde", "Codvalhast" as "Codvalhasta", "Cuitdesde" as "Cuitdesde", "Cuithasta" as "Cuithasta", "Obs" as "Obs" from ZooLogic.SELCHEQTR where  SELCHEQTR.CODIGO != '' order by Codigo
			endtext
			use in select('c_SELECCHEQUETERCEROS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SELECCHEQUETERCEROS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Fchdesde" as "Fechadesde", "Fchhasta" as "Fechahasta", "Fchemidesd" as "Fchemdesde", "Fchemihast" as "Fchemhasta", "Numintdesd" as "Numindesde", "Numinthast" as "Numinhasta", "Mntodesde" as "Montodesde", "Mntohasta" as "Montohasta", "Mondesde" as "Mondesde", "Monhasta" as "Monhasta", "Cliedesde" as "Clidesde", "Clihasta" as "Clihasta", "Numdesde" as "Numdesde", "Numhasta" as "Numhasta", "Entfdesde" as "Entfindesde", "Entfhasta" as "Entfinhasta", "Codvaldesd" as "Codvaldesde", "Codvalhast" as "Codvalhasta", "Cuitdesde" as "Cuitdesde", "Cuithasta" as "Cuithasta", "Obs" as "Obs" from ZooLogic.SELCHEQTR where  funciones.padr( Codigo, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  SELCHEQTR.CODIGO != '' order by Codigo
			endtext
			use in select('c_SELECCHEQUETERCEROS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SELECCHEQUETERCEROS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Fchdesde" as "Fechadesde", "Fchhasta" as "Fechahasta", "Fchemidesd" as "Fchemdesde", "Fchemihast" as "Fchemhasta", "Numintdesd" as "Numindesde", "Numinthast" as "Numinhasta", "Mntodesde" as "Montodesde", "Mntohasta" as "Montohasta", "Mondesde" as "Mondesde", "Monhasta" as "Monhasta", "Cliedesde" as "Clidesde", "Clihasta" as "Clihasta", "Numdesde" as "Numdesde", "Numhasta" as "Numhasta", "Entfdesde" as "Entfindesde", "Entfhasta" as "Entfinhasta", "Codvaldesd" as "Codvaldesde", "Codvalhast" as "Codvalhasta", "Cuitdesde" as "Cuitdesde", "Cuithasta" as "Cuithasta", "Obs" as "Obs" from ZooLogic.SELCHEQTR where  SELCHEQTR.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_SELECCHEQUETERCEROS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SELECCHEQUETERCEROS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fmodifw,Faltafw,Fecimpo,Fecexpo,Horaimpo,Horaexpo,Bdaltafw,Haltafw,Bdmodifw,Esttran" + ;
"s,Hmodifw,Saltafw,Umodifw,Vmodifw,Ualtafw,Valtafw,Zadsfw,Smodifw,Codigo,Descrip,Fchdesde,Fchhasta,Fc" + ;
"hemidesd,Fchemihast,Numintdesd,Numinthast,Mntodesde,Mntohasta,Mondesde,Monhasta,Cliedesde,Clihasta,N" + ;
"umdesde,Numhasta,Entfdesde,Entfhasta,Codvaldesd,Codvalhast,Cuitdesde,Cuithasta,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Fchdesde" as "Fechadesde", "Fchhasta" as "Fechahasta", "Fchemidesd" as "Fchemdesde", "Fchemihast" as "Fchemhasta", "Numintdesd" as "Numindesde", "Numinthast" as "Numinhasta", "Mntodesde" as "Montodesde", "Mntohasta" as "Montohasta", "Mondesde" as "Mondesde", "Monhasta" as "Monhasta", "Cliedesde" as "Clidesde", "Clihasta" as "Clihasta", "Numdesde" as "Numdesde", "Numhasta" as "Numhasta", "Entfdesde" as "Entfindesde", "Entfhasta" as "Entfinhasta", "Codvaldesd" as "Codvaldesde", "Codvalhast" as "Codvalhasta", "Cuitdesde" as "Cuitdesde", "Cuithasta" as "Cuithasta", "Obs" as "Obs"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.SELCHEQTR set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, FchDesde = ] + "'" + this.ConvertirDateSql( &lcCursor..FchDesde ) + "'"+ [, FchHasta = ] + "'" + this.ConvertirDateSql( &lcCursor..FchHasta ) + "'"+ [, FchEmiDesd = ] + "'" + this.ConvertirDateSql( &lcCursor..FchEmiDesd ) + "'"+ [, FchEmiHast = ] + "'" + this.ConvertirDateSql( &lcCursor..FchEmiHast ) + "'"+ [, NumIntDesd = ] + transform( &lcCursor..NumIntDesd )+ [, NumIntHast = ] + transform( &lcCursor..NumIntHast )+ [, MntoDesde = ] + transform( &lcCursor..MntoDesde )+ [, MntoHasta = ] + transform( &lcCursor..MntoHasta )+ [, MonDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..MonDesde ) + "'"+ [, MonHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..MonHasta ) + "'"+ [, ClieDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..ClieDesde ) + "'"+ [, CliHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..CliHasta ) + "'"+ [, NumDesde = ] + transform( &lcCursor..NumDesde )+ [, NumHasta = ] + transform( &lcCursor..NumHasta )+ [, EntFDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..EntFDesde ) + "'"+ [, EntFHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..EntFHasta ) + "'"+ [, CodValDesd = ] + "'" + this.FormatearTextoSql( &lcCursor..CodValDesd ) + "'"+ [, CodValHast = ] + "'" + this.FormatearTextoSql( &lcCursor..CodValHast ) + "'"+ [, CuitDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..CuitDesde ) + "'"+ [, CuitHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..CuitHasta ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECTRANS, FMODIFW, FALTAFW, FECIMPO, FECEXPO, HORAIMPO, HORAEXPO, BDALTAFW, HALTAFW, BDMODIFW, ESTTRANS, HMODIFW, SALTAFW, UMODIFW, VMODIFW, UALTAFW, VALTAFW, ZADSFW, SMODIFW, Codigo, Descrip, FchDesde, FchHasta, FchEmiDesd, FchEmiHast, NumIntDesd, NumIntHast, MntoDesde, MntoHasta, MonDesde, MonHasta, ClieDesde, CliHasta, NumDesde, NumHasta, EntFDesde, EntFHasta, CodValDesd, CodValHast, CuitDesde, CuitHasta, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FchDesde ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FchHasta ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FchEmiDesd ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FchEmiHast ) + "'" + ',' + transform( &lcCursor..NumIntDesd ) + ',' + transform( &lcCursor..NumIntHast ) + ',' + transform( &lcCursor..MntoDesde ) + ',' + transform( &lcCursor..MntoHasta )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClieDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CliHasta ) + "'" + ',' + transform( &lcCursor..NumDesde ) + ',' + transform( &lcCursor..NumHasta ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..EntFDesde ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..EntFHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodValDesd ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodValHast ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CuitDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CuitHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.FCHDESDE = isnull( d.FCHDESDE, t.FCHDESDE ),t.FCHHASTA = isnull( d.FCHHASTA, t.FCHHASTA ),t.FCHEMIDESD = isnull( d.FCHEMIDESD, t.FCHEMIDESD ),t.FCHEMIHAST = isnull( d.FCHEMIHAST, t.FCHEMIHAST ),t.NUMINTDESD = isnull( d.NUMINTDESD, t.NUMINTDESD ),t.NUMINTHAST = isnull( d.NUMINTHAST, t.NUMINTHAST ),t.MNTODESDE = isnull( d.MNTODESDE, t.MNTODESDE ),t.MNTOHASTA = isnull( d.MNTOHASTA, t.MNTOHASTA ),t.MONDESDE = isnull( d.MONDESDE, t.MONDESDE ),t.MONHASTA = isnull( d.MONHASTA, t.MONHASTA ),t.CLIEDESDE = isnull( d.CLIEDESDE, t.CLIEDESDE ),t.CLIHASTA = isnull( d.CLIHASTA, t.CLIHASTA ),t.NUMDESDE = isnull( d.NUMDESDE, t.NUMDESDE ),t.NUMHASTA = isnull( d.NUMHASTA, t.NUMHASTA ),t.ENTFDESDE = isnull( d.ENTFDESDE, t.ENTFDESDE ),t.ENTFHASTA = isnull( d.ENTFHASTA, t.ENTFHASTA ),t.CODVALDESD = isnull( d.CODVALDESD, t.CODVALDESD ),t.CODVALHAST = isnull( d.CODVALHAST, t.CODVALHAST ),t.CUITDESDE = isnull( d.CUITDESDE, t.CUITDESDE ),t.CUITHASTA = isnull( d.CUITHASTA, t.CUITHASTA ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.SELCHEQTR t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.SELCHEQTR(Fectrans,Fmodifw,Faltafw,Fecimpo,Fecexpo,Horaimpo,Horaexpo,Bdaltafw,Haltafw,Bdmodifw,Esttrans,Hmodifw,Saltafw,Umodifw,Vmodifw,Ualtafw,Valtafw,Zadsfw,Smodifw,Codigo,Descrip,Fchdesde,Fchhasta,Fchemidesd,Fchemihast,Numintdesd,Numinthast,Mntodesde,Mntohasta,Mondesde,Monhasta,Cliedesde,Clihasta,Numdesde,Numhasta,Entfdesde,Entfhasta,Codvaldesd,Codvalhast,Cuitdesde,Cuithasta,Obs)
					Select isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.SMODIFW,''),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.FCHDESDE,''),isnull( d.FCHHASTA,''),isnull( d.FCHEMIDESD,''),isnull( d.FCHEMIHAST,''),isnull( d.NUMINTDESD,0),isnull( d.NUMINTHAST,0),isnull( d.MNTODESDE,0),isnull( d.MNTOHASTA,0),isnull( d.MONDESDE,''),isnull( d.MONHASTA,''),isnull( d.CLIEDESDE,''),isnull( d.CLIHASTA,''),isnull( d.NUMDESDE,0),isnull( d.NUMHASTA,0),isnull( d.ENTFDESDE,''),isnull( d.ENTFHASTA,''),isnull( d.CODVALDESD,''),isnull( d.CODVALHAST,''),isnull( d.CUITDESDE,''),isnull( d.CUITHASTA,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="SELECCHEQUETERCEROS                     " atributo="FECHATRANSFERENCIA                      " tabla="SELCHEQTR      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCHEQUETERCEROS                     " atributo="ESTADOTRANSFERENCIA                     " tabla="SELCHEQTR      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCHEQUETERCEROS                     " atributo="FCHEMDESDE                              " tabla="SELCHEQTR      " campo="FCHEMIDESD" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Fecha de emisión desde                                                                                                                                          " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="15" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="FCHEMHASTA                              " tabla="SELCHEQTR      " campo="FCHEMIHAST" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="406" etiqueta="Fecha de emisión hasta                                                                                                                                          " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="NUMINDESDE                              " tabla="SELCHEQTR      " campo="NUMINTDESD" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Número interno desde                                                                                                                                            " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="25" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="NUMINHASTA                              " tabla="SELCHEQTR      " campo="NUMINTHAST" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="99999999                                                                                                                                                                                                                                                      " obligatorio="false" admitebusqueda="410" etiqueta="Número interno hasta                                                                                                                                            " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="MONTODESDE                              " tabla="SELCHEQTR      " campo="MNTODESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Monto desde                                                                                                                                                     " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="35" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="MONTOHASTA                              " tabla="SELCHEQTR      " campo="MNTOHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="0" valorsugerido="9999999.99                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="414" etiqueta="Monto hasta                                                                                                                                                     " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="40" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="MONDESDE                                " tabla="SELCHEQTR      " campo="MONDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Moneda desde                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="45" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="MONHASTA                                " tabla="SELCHEQTR      " campo="MONHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="418" etiqueta="Moneda hasta                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="CLIDESDE                                " tabla="SELCHEQTR      " campo="CLIEDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Cliente desde                                                                                                                                                   " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="6" orden="55" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="CLIHASTA                                " tabla="SELCHEQTR      " campo="CLIHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZ                                                                                                                                                                                                                                                     " obligatorio="false" admitebusqueda="422" etiqueta="Cliente hasta                                                                                                                                                   " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="6" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="NUMDESDE                                " tabla="SELCHEQTR      " campo="NUMDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="Número desde                                                                                                                                                    " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="7" orden="65" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="NUMHASTA                                " tabla="SELCHEQTR      " campo="NUMHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="99999999                                                                                                                                                                                                                                                      " obligatorio="false" admitebusqueda="426" etiqueta="Número hasta                                                                                                                                                    " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="7" orden="70" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="ENTFINDESDE                             " tabla="SELCHEQTR      " campo="ENTFDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ENTIDADFINANCIERA                       " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="428" etiqueta="Entidad financiera desde                                                                                                                                        " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="8" orden="75" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="ENTFINHASTA                             " tabla="SELCHEQTR      " campo="ENTFHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ENTIDADFINANCIERA                       " tipodato="C         " longitud="5" decimales="0" valorsugerido="ZZZZ                                                                                                                                                                                                                                                          " obligatorio="false" admitebusqueda="430" etiqueta="Entidad financiera hasta                                                                                                                                        " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="8" orden="80" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="CODVALDESDE                             " tabla="SELCHEQTR      " campo="CODVALDESD" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VALOR                                   " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="Código de valor desde                                                                                                                                           " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="9" orden="85" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCHEQUETERCEROS                     " atributo="CODVALHASTA                             " tabla="SELCHEQTR      " campo="CODVALHAST" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VALOR                                   " tipodato="C         " longitud="5" decimales="0" valorsugerido="ZZZZZZZZZ                                                                                                                                                                                                                                                     " obligatorio="false" admitebusqueda="434" etiqueta="Código de valor hasta                                                                                                                                           " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="9" orden="90" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="421" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On SELCHEQTR.CLIEDESDE = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                        " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="423" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On SELCHEQTR.CLIHASTA = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                         " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADFINANCIERA                       " atributo="DESCRIPCION                             " tabla="ENTFIN         " campo="EFDES     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="429" etiqueta="Detalle Ent.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTFIN On SELCHEQTR.ENTFDESDE = ENTFIN.EfCod And  ENTFIN.EFCOD != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADFINANCIERA                       " atributo="DESCRIPCION                             " tabla="ENTFIN         " campo="EFDES     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="431" etiqueta="Detalle Ent.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTFIN On SELCHEQTR.ENTFHASTA = ENTFIN.EfCod And  ENTFIN.EFCOD != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVAL           " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="433" etiqueta="Detalle Cód.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVAL On SELCHEQTR.CODVALDESD = XVAL.CLCOD And  XVAL.CLCOD != ''                                                                                                                                                                                    " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVAL           " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="435" etiqueta="Detalle Cód.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVAL On SELCHEQTR.CODVALHAST = XVAL.CLCOD And  XVAL.CLCOD != ''                                                                                                                                                                                    " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
