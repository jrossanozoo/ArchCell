...
define class Mock_picking as MockBase of MockBase.prg
	...
	Codigo = ""                                                                                                                                                                                                                                               
	CompAfec = null                                                                                                                                                                                                                                           
	DetalleCoincidencias = null                                                                                                                                                                                                                               
	DetalleComprobantes = null                                                                                                                                                                                                                                
	DetalleControlado = null                                                                                                                                                                                                                                  
	DetalleDiferencias = null                                                                                                                                                                                                                                 
	DetalleDiferenciasOriginal = null                                                                                                                                                                                                                         
	DetallePreparacionMercaderia = null                                                                                                                                                                                                                       
	ESTADOTRANSFERENCIA = ""                                                                                                                                                                                                                                  
	EsPreparacionDeMercaderia = .F.                                                                                                                                                                                                                           
	FECHAALTAFW = ctod( '  /  /    ' )                                                                                                                                                                                                                        
	FECHAEXPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	FECHAIMPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Picking"                                                                                                                                                                                                                                 
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cDetalleComprobante = "DetalleControlado"                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	...
	lGenerarComprobanteEnBaseAPicking = .f.                                                                                                                                                                                                                   
	...
	lProcesando = .F.                                                                                                                                                                                                                                         
	lProcesandoEnBaseADesdeOtroComprobante = .f.                                                                                                                                                                                                              
	lReAsignarPk_Con_CC = .F.                                                                                                                                                                                                                                 
	lSeAgregoUnNuevoItemControlado = .f.                                                                                                                                                                                                                      
	lSeteandoValorSugeridoFWTipocomprobanteorigen = .f.                                                                                                                                                                                                       
	lTieneAccionesAutomaticas = .f.                                                                                                                                                                                                                           
	lTieneDiseñosParaEnviarMail = .t.                                                                                                                                                                                                                         
	lTieneVendedorComoClaveForanea = .t.                                                                                                                                                                                                                      
	lValidarIngresoDesdeTxt = .t.                                                                                                                                                                                                                             
	lWHEliminar = .f.                                                                                                                                                                                                                                         
	lWHIngresar = .f.                                                                                                                                                                                                                                         
	lWHModificar = .f.                                                                                                                                                                                                                                        
	lcComprobantesPickeados = ""                                                                                                                                                                                                                              
	nTipoDeFacturaParaAccionesDePicking = 0                                                                                                                                                                                                                   
	oAD = null                                                                                                                                                                                                                                                
	oActualizadorItemDiferenciasAlCargarItemControlado = null                                                                                                                                                                                                 
	oActualizadorItemDiferenciasAlModificarItemControlado = null                                                                                                                                                                                              
	oAtributosAnulacion = null                                                                                                                                                                                                                                
	oAtributosAuditoria = null                                                                                                                                                                                                                                
	oAtributosCC =  Null                                                                                                                                                                                                                                      
	oAtributosCombinacion = null                                                                                                                                                                                                                              
	oAtributosConEdicionRestringida= null                                                                                                                                                                                                                     
	oBuzon = null                                                                                                                                                                                                                                             
	oColAtributosObligatoriosDefinidosPorUsuario = null                                                                                                                                                                                                       
	oColaborador = null                                                                                                                                                                                                                                       
	oColaboradorCargarComprobantes = null                                                                                                                                                                                                                     
	oColaboradorDatosDetallesPicking = null                                                                                                                                                                                                                   
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oCombinacionesAfectadasMercaderiaEnTransito = null                                                                                                                                                                                                        
	oComparadorItemsControlados = null                                                                                                                                                                                                                        
	...
	oLogueo = null                                                                                                                                                                                                                                            
	oMensaje = null                                                                                                                                                                                                                                           
	oMercaderiaEnTransito = null                                                                                                                                                                                                                              
	oMovimientoDeStock = null                                                                                                                                                                                                                                 
	oNumeraciones =  null                                                                                                                                                                                                                                     
	oObservadoresDeImportacion = null                                                                                                                                                                                                                         
	oPobladorDetalleDiferencias = null                                                                                                                                                                                                                        
	oPobladorItemCoincidencias = null                                                                                                                                                                                                                         
	oProcesadorComprobantes = null                                                                                                                                                                                                                            
	oProveedorAtributosAnulacion = null                                                                                                                                                                                                                       
	oRegistrosDeActividadesAlGrabar = Null                                                                                                                                                                                                                    
	oTalle = null                                                                                                                                                                                                                                             
	oValidacionDominios= null                                                                                                                                                                                                                                 
	oValidadoresComp = null                                                                                                                                                                                                                                   
	oValidadoresDeComprobantesModificadosAntesDeGrabar = null                                                                                                                                                                                                 
	oValidadoresDeComprobantesModificadosAntesDeModificar = null                                                                                                                                                                                              
	...
	*-----------------------------------------------------------------------------------------
	 function validartipodeentregadecomprobantes() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validartipodeentregadecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizardetalleprepm() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizardetalleprepm', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function antesdeactualizaritemcontrolado() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Antesdeactualizaritemcontrolado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallecoincidencias() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallecoincidencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallecontrolado() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallecontrolado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallediferencias() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallediferencias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallediferenciasoriginal() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallediferenciasoriginal', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallepreparacionmercaderia() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallepreparacionmercaderia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardetallemovimientodestock( tntipo as integer ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cargardetallemovimientodestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function comprobantevalidoparahacercancelacion() as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Comprobantevalidoparahacercancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function confirmarmercaderia() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Confirmarmercaderia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearcabeceramovimientodestock( tntipo as integer ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function despuesdeactualizaritemcontrolado() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdeactualizaritemcontrolado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detallecoincidencias_access() as variant                                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallecoincidencias_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallecoincidencias_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallecoincidencias ) = 'O' or isnull( this.Detallecoincidencias ) )			this.Detallecoincidencias = this.crearobjeto( 'DetallePickingDetallecoincidencias' )			this.Detallecoincidencias.inicializar()			this.enlazar( 'Detallecoincidencias.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallecoincidencias.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallecoincidencias, 'CambioSumarizado', this, 'CambiosDetalleDetallecoincidencias', 1)			this.enlazar( 'Detallecoincidencias.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallecoincidencias.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detallecoincidencias
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detallecomprobantes_access() as variant                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallecomprobantes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallecomprobantes_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallecomprobantes ) = 'O' or isnull( this.Detallecomprobantes ) )			this.Detallecomprobantes = this.crearobjeto( 'Din_DetallePickingDetallecomprobantes' )			this.Detallecomprobantes.inicializar()			this.Detallecomprobantes.lPermitirDetalleVacio = .F.			this.enlazar( 'Detallecomprobantes.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallecomprobantes.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallecomprobantes, 'CambioSumarizado', this, 'CambiosDetalleDetallecomprobantes', 1)			this.enlazar( 'Detallecomprobantes.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallecomprobantes.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detallecomprobantes.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detallecomprobantes
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detallecontrolado_access() as variant                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallecontrolado_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallecontrolado_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallecontrolado ) = 'O' or isnull( this.Detallecontrolado ) )			this.Detallecontrolado = this.crearobjeto( 'DetallePickingDetallecontrolado' )			this.Detallecontrolado.inicializar()			this.enlazar( 'Detallecontrolado.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallecontrolado.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallecontrolado, 'CambioSumarizado', this, 'CambiosDetalleDetallecontrolado', 1)			this.enlazar( 'Detallecontrolado.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallecontrolado.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detallecontrolado.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detallecontrolado
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detallediferencias_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallediferencias_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallediferencias_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallediferencias ) = 'O' or isnull( this.Detallediferencias ) )			this.Detallediferencias = this.crearobjeto( 'DetallePickingDetallediferencias' )			this.Detallediferencias.inicializar()			this.enlazar( 'Detallediferencias.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallediferencias.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallediferencias, 'CambioSumarizado', this, 'CambiosDetalleDetallediferencias', 1)			this.enlazar( 'Detallediferencias.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallediferencias.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detallediferencias.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detallediferencias
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detallediferenciasoriginal_access() as variant                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallediferenciasoriginal_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallediferenciasoriginal_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallediferenciasoriginal ) = 'O' or isnull( this.Detallediferenciasoriginal ) )			this.Detallediferenciasoriginal = this.crearobjeto( 'DetallePickingDetallediferenciasoriginal' )			this.Detallediferenciasoriginal.inicializar()			this.enlazar( 'Detallediferenciasoriginal.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallediferenciasoriginal.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallediferenciasoriginal, 'CambioSumarizado', this, 'CambiosDetalleDetallediferenciasoriginal', 1)			this.enlazar( 'Detallediferenciasoriginal.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallediferenciasoriginal.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detallediferenciasoriginal
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detallepreparacionmercaderia_access() as variant                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallepreparacionmercaderia_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallepreparacionmercaderia_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallepreparacionmercaderia ) = 'O' or isnull( this.Detallepreparacionmercaderia ) )			this.Detallepreparacionmercaderia = this.crearobjeto( 'Din_DetallePickingDetallepreparacionmercaderia' )			this.Detallepreparacionmercaderia.inicializar()			this.enlazar( 'Detallepreparacionmercaderia.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallepreparacionmercaderia.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallepreparacionmercaderia, 'CambioSumarizado', this, 'CambiosDetalleDetallepreparacionmercaderia', 1)			this.enlazar( 'Detallepreparacionmercaderia.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallepreparacionmercaderia.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detallepreparacionmercaderia
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminarvaciosdetalleprepm() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eliminarvaciosdetalleprepm', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esfacturadeventascontiposdeentrega( toentidad as object ) as boolean                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esfacturadeventascontiposdeentrega', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function espreparaciondemercaderia_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'espreparaciondemercaderia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'espreparaciondemercaderia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Espreparaciondemercaderia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Espreparaciondemercaderia( lxVal )				this.Setear_Espreparaciondemercaderia( lxVal )			EndIf		Else			This.Setear_Espreparaciondemercaderia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function evaluarycargarcliente() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Evaluarycargarcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoantesdegrabarporcomprobantepicking( tocomprobante as object ) as void                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventoantesdegrabarporcomprobantepicking', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoinformararticuloconcolorotallefueradepaletaocurva( toinformacion ) as void                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function eventollamargeneracionautomaticanuevoenbaseaintervinientecompras( tcclaveforanea as string, tcnombreentidad as string, tlgeneracancelacion as boolean, tccodigo as string ) as void                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tcclaveforanea
		lxParam2 = tcnombreentidad
		...
		return this.ObtenerResultado( 'Eventollamargeneracionautomaticanuevoenbaseaintervinientecompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomostrarformulariofactura( tcentidadagenerar, tcnombreentidad, tccodigo, tlgeneracancelacion, toobjetoretorno ) as void                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = tcentidadagenerar
		lxParam2 = tcnombreentidad
		lxParam3 = tccodigo
		lxParam4 = tlgeneracancelacion
		lxParam5 = toobjetoretorno
		...
		return this.ObtenerResultado( 'Eventomostrarformulariofactura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntargenerarcomprobanteenbaseapicking( tnrespuestasugerida as integer, tcdescrentidadagenerar as string, tcdescrentidaddecancelacion as string ) as void                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tnrespuestasugerida
		lxParam2 = tcdescrentidadagenerar
		lxParam3 = tcdescrentidaddecancelacion
		...
		return this.ObtenerResultado( 'Eventopreguntargenerarcomprobanteenbaseapicking', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventopreguntasigeneraconfirmarstock( tctitulo as string ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventopreguntasigeneraconfirmarstock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventosemodificoeldetallediferencias() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventosemodificoeldetallediferencias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventosetearetiquetasdetallecomprobantes() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventosetearetiquetasdetallecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existendiferencias() as boolean                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existendiferencias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function existendiferenciasnegativas() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existendiferenciasnegativas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function existendiferenciaspositivas() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existendiferenciaspositivas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function forzarllenardetallediferencias() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Forzarllenardetallediferencias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarcomprobanteenbaseapicking( tcentidadagenerar as string, tlgeneracancelacion as boolean, tcaccion as string ) as void                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tcentidadagenerar
		lxParam2 = tlgeneracancelacion
		lxParam3 = tcaccion
		...
		return this.ObtenerResultado( 'Generarcomprobanteenbaseapicking', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarfacturaconcan() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarfacturaconcan', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarfacturasincan() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarfacturasincan', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarpreparacionconcanc() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarpreparacionconcanc', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarpreparacionsincanc() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarpreparacionsincanc', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarremitoconcanc() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarremitoconcanc', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarremitosincanc() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarremitosincanc', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function grabardetalleinformacionadicionalmercaderiaentransitomsdesalida( tomovistock as object, tomertran as object ) as void                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tomovistock
		lxParam2 = tomertran
		...
		return this.ObtenerResultado( 'Grabardetalleinformacionadicionalmercaderiaentransitomsdesalida', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function grabardetalleinformacionadicionalmovimientodestockmtdesalida( tomovistock as object, tomertran as object ) as void                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Grabardetalleinformacionadicionalmovimientodestockmtdesalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llamaraforzarllenardetallediferencias( toitemscargados as zoocoleccion of zoocoleccion.prg, tcnombredetalle as string ) as void                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llamaraforzarllenardetallediferencias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function llenardetallediferencias() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Llenardetallediferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modificar( tlnovalidarafectacion as boolean ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tlnovalidarafectacion
	...
	*-----------------------------------------------------------------------------------------
	function ntipodefacturaparaaccionesdepicking_access() as object                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ntipodefacturaparaaccionesdepicking_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ntipodefacturaparaaccionesdepicking_access', lcParametros )			endif		endif		if this.nTipoDeFacturaParaAccionesDePicking = 0			this.nTipoDeFacturaParaAccionesDePicking = goParametros.Felino.Picking.TipoDeFacturaParaAccionesDePicking		endif		return this.nTipoDeFacturaParaAccionesDePicking
	EndFunc

	*-----------------------------------------------------------------------------------------
	function nuevapreparaciondemercaderia() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Nuevapreparaciondemercaderia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidaddeitemscondiferenciasenpositivo() as integer                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercantidaddeitemscondiferenciasenpositivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermotivoparamovimientosderechazo() as string                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermotivoparamovimientosderechazo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombredeentidadafacturar() as string                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenernombredeentidadafacturar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenernombredeentidadaremitir() as string                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenernombredeentidadaremitir', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenernombredeentidaddecancelacion( tlgestiondeventas ) as string                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tlgestiondeventas
		...
		return this.ObtenerResultado( 'Obtenernombredeentidaddecancelacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenernombredeentidadpickeada() as string                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenernombredeentidadpickeada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorcargarcomprobantes_access() as object                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorcargarcomprobantes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorcargarcomprobantes_access', lcParametros )			endif		endif		if !this.lDestroy and (type("this.oColaboradorCargarComprobantes") <> "O" or isnull(this.oColaboradorCargarComprobantes))			this.oColaboradorCargarComprobantes = _screen.zoo.app.CrearObjeto("ColaboradorCargarComprobantesAControlar")		endif		return this.oColaboradorCargarComprobantes
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omercaderiaentransito_access() as variant                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'omercaderiaentransito_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'omercaderiaentransito_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oMercaderiaEnTransito ) = 'O' or isnull( this.oMercaderiaEnTransito ) )			this.oMercaderiaEnTransito = _screen.zoo.Instanciarentidad( 'MercaderiaEnTransito' )		endif		return this.oMercaderiaEnTransito
	EndFunc

	*-----------------------------------------------------------------------------------------
	function omovimientodestock_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'omovimientodestock_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'omovimientodestock_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oMovimientoDeStock ) = 'O' or isnull( this.oMovimientoDeStock ) )			this.oMovimientoDeStock = _screen.zoo.Instanciarentidad( 'MovimientoDeStock' )		endif		return this.oMovimientoDeStock
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function permiteacciongenerarcomprobanteenbaseapicking( tcentidadagenerar as string, tlevaluacancelacion as boolean ) as boolean                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcentidadagenerar
		lxParam2 = tlevaluacancelacion
		...
		return this.ObtenerResultado( 'Permiteacciongenerarcomprobanteenbaseapicking', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesardiferencias() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesardiferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puedeconfirmarmercaderia() as boolean                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Puedeconfirmarmercaderia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function rechazarmercaderia() as void                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Rechazarmercaderia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function restringir() as boolean                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Restringir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_clientedescripcion( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_clientedescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_clientedescripcion', lcParametros )			endif		endif		this.Clientedescripcion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_espreparaciondemercaderia( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_espreparaciondemercaderia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_espreparaciondemercaderia', lcParametros )			endif		endif		this.Espreparaciondemercaderia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipocomprobanteorigen( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tipocomprobanteorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tipocomprobanteorigen', lcParametros )			endif		endif		dodefault( txVal )		this.AsignarEntidadAlItemComprobantes()		this.EventoSetearEtiquetasDetalleComprobantes()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienediferenciasdestock() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienediferenciasdestock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function tienepermisoparaaceptarcondiferenciasdestock() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienepermisoparaaceptarcondiferenciasdestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipocomprobanteorigen_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tipocomprobanteorigen_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tipocomprobanteorigen_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tipocomprobanteorigen		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tipocomprobanteorigen( lxVal )				this.Setear_Tipocomprobanteorigen( lxVal )			EndIf		Else			This.Setear_Tipocomprobanteorigen( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar( tlesconfirmarmercaderia as boolean ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tlesconfirmarmercaderia
	...
	*-----------------------------------------------------------------------------------------
	function validar_clientedescripcion( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_clientedescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_clientedescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_espreparaciondemercaderia( txval as variant ) as boolean                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_espreparaciondemercaderia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_espreparaciondemercaderia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipocomprobanteorigen( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PICKING' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipocomprobanteorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipocomprobanteorigen', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciaencomprobanteorigen( toitem as object ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarexistenciaencomprobanteorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarpeparacionesdelospedidos() as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarpeparacionesdelospedidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarrestriccionacomprobanteorigen() as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarrestriccionacomprobanteorigen', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarsaldospendientes() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarsaldospendientes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarsiestaafectado() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarsiestaafectado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validartienedisponibleagregados() as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validartienedisponibleagregados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartipocomprobante() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validartipocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoclientedescripcion() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridoclientedescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwtipocomprobanteorigen() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwtipocomprobanteorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipocomprobanteorigen() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotipocomprobanteorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcombinacionsegunpaletaycurva() as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarcombinacionsegunpaletaycurva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificardatosdecomprobantes() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificardatosdecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarsihayquerecalculardiferencias() as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarsihayquerecalculardiferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	hidden function completardatoscombinacion( loitem as object, toitem as object, toatributoscombinacion as zoocoleccion of zoocoleccion.prg ) as void                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		lxParam1 = loitem
		lxParam2 = toitem
		lxParam3 = toatributoscombinacion
	...
	*-----------------------------------------------------------------------------------------
	hidden function ejecutarvalidador( tovalidador as object ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tovalidador
		...
		return this.ObtenerResultado( 'Ejecutarvalidador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	hidden function instanciarcolaboradoresdecomprobantes() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Instanciarcolaboradoresdecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	hidden function reajustardiferenciasenbasealocontrolado() as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Reajustardiferenciasenbasealocontrolado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	hidden function renumerarnroitemdeldetallediferencias() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Renumerarnroitemdeldetallediferencias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	hidden function sinosepuedeagregaritemcrearnuevomovimiento( tomovimiento as object ) as void                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Sinosepuedeagregaritemcrearnuevomovimiento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	hidden function validarsisepuedemodificar() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarsisepuedemodificar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	hidden function verificarmodificaciondecomprobantes() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarmodificaciondecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarobservacioncomprobantes() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarobservacioncomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarobservacionpickingacomprobantes() as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Agregarobservacionpickingacomprobantes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function armarobservacionesconfirmarstock() as string                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Armarobservacionesconfirmarstock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function asignarentidadalitemcomprobantes() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Asignarentidadalitemcomprobantes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function confirmargenerarcomprobanteenbaseapicking( tcentidadagenerar as string, tlgeneracancelacion as boolean ) as boolean                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Confirmargenerarcomprobanteenbaseapicking', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esgestiondeventas( todetalle as object ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esgestiondeventas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existemotivocargadoenparametro() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existemotivocargadoenparametro', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarconfirmarstock() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarconfirmarstock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function generardevolucion() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function generarmercaderiaentransitoderechazo() as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function generarmovimientodeentradapordiferenciasnegativas() as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarmovimientodeentradapordiferenciasnegativas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function generarmovimientoderechazopordiferenciaspositivas() as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarmovimientoderechazopordiferenciaspositivas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function generarmovimientodestock() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function generarremitodecompra() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function grabaraccionesdesistema( todetalle as object, tcaccion as string ) as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Grabaraccionesdesistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llamargeneracionautomaticanuevoenbaseaintervinienteventas( tcentidadagenerar as string, tcnombreentidad as string, tlgeneracancelacion as boolean, tccodigo as string ) as void                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Llamargeneracionautomaticanuevoenbaseaintervinienteventas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenardetallecoincidencias() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Llenardetallecoincidencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneratributoscombinacion( tomovimiento as object ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdescripcionentidadsecundaria( tcnombreentidad as string ) as string                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerdescripcionentidadsecundaria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermensajeaccionesdesistema( todetalle as object, tcaccion as string ) as string                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenermensajeaccionesdesistema', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenermensajecomprobantesgenerados( tcentidadagenerar as string, tocomprobanteagenerar as object, tlgeneracancelacion as boolean, toinforetorno as object ) as void                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tcentidadagenerar
		lxParam2 = tocomprobanteagenerar
		lxParam3 = tlgeneracancelacion
		lxParam4 = toinforetorno
		...
		return this.ObtenerResultado( 'Obtenermensajecomprobantesgenerados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenernombredecomprobante() as string                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function parametromotivodemovimientodemercaderiaderechazoestavacio() as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Parametromotivodemovimientodemercaderiaderechazoestavacio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function recibeparcialmentelamercaderia() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Recibeparcialmentelamercaderia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function solicitargeneraciondecomprobanteenbaseapicking( tcentidadagenerar as string, tlgeneracancelacion as boolean, tccodigo as string ) as void                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Solicitargeneraciondecomprobanteenbaseapicking', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validamotivomercaderiaderechazo() as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validamotivomercaderiaderechazo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarentidadaccionfacturar( tcentidadagenerar as string ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarentidadaccionfacturar', lcParametros )
	EndFunc
