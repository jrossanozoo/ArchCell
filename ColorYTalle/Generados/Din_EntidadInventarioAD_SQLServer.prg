...
define class Din_EntidadINVENTARIOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxInvFecexpo, lxInvFmodifw, lxInvFecimpo, lxInvFaltafw, lxInvFectrans, lxInvSmodifw, lxInvSaltafw, lxInvUaltafw, lxInvValtafw, lxInvUmodifw, lxInvZadsfw, lxInvVmodifw, lxInvHmodifw, lxInvHoraexpo, lxInvHoraimpo, lxInvBdmodifw, lxInvBdaltafw, lxInvEsttrans, lxInvHaltafw, lxInvInvcod, lxInvInvdes, lxInvContrstock, lxInvInvobs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.INV ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaexpo","Horaimpo","Bdmodifw","Bdaltafw","Esttrans","Haltafw","Invcod","Invdes","Contrstock","Invobs" ) values ( <<"'" + this.ConvertirDateSql( lxInvFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInvFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInvFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInvFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInvFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvInvcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInvInvdes ) + "'" >>, <<iif( lxInvContrstock, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxInvInvobs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.INV set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxInvFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxInvFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxInvFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxInvFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxInvFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxInvSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxInvSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxInvUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxInvValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxInvUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxInvZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxInvVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxInvHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxInvHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxInvHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxInvBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxInvBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxInvEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxInvHaltafw ) + "'">>,"Invcod" = <<"'" + this.FormatearTextoSql( lxInvInvcod ) + "'">>,"Invdes" = <<"'" + this.FormatearTextoSql( lxInvInvdes ) + "'">>,"Contrstock" = <<iif( lxInvContrstock, 1, 0 )>>,"Invobs" = <<"'" + this.FormatearTextoSql( lxInvInvobs ) + "'">> where "Invcod" = <<"'" + this.FormatearTextoSql( lxInvInvcod ) + "'">> and  INV.INVCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Invcod" as "Codigo", "Invdes" as "Descripcion", "Contrstock" as "Controlastock", "Invobs" as "Observaciones" from ZooLogic.INV where "Invcod" = <<"'" + this.FormatearTextoSql( lxInvInvcod ) + "'">> and  INV.INVCOD != ''
			endtext
...
"ifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Invcod,Invdes,Contrstock,Invobs" + ;
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.INV set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxInvFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxInvFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxInvFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxInvFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxInvFectrans ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxInvSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxInvSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxInvUaltafw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxInvValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxInvUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxInvZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxInvVmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxInvHmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxInvHoraexpo ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxInvHoraimpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxInvBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxInvBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxInvEsttrans ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxInvHaltafw ) + "'">>, "Invcod" = <<"'" + this.FormatearTextoSql( lxInvInvcod ) + "'">>, "Invdes" = <<"'" + this.FormatearTextoSql( lxInvInvdes ) + "'">>, "Contrstock" = <<iif( lxInvContrstock, 1, 0 )>>, "Invobs" = <<"'" + this.FormatearTextoSql( lxInvInvobs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'INV' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.INV set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, invcod = ] + "'" + this.FormatearTextoSql( &lcCursor..invcod ) + "'"+ [, invdes = ] + "'" + this.FormatearTextoSql( &lcCursor..invdes ) + "'"+ [, ContrStock = ] + Transform( iif( &lcCursor..ContrStock, 1, 0 ))+ [, invobs = ] + "'" + this.FormatearTextoSql( &lcCursor..invobs ) + "'" + [ Where invcod = ] + "'" + this.FormatearTextoSql( &lcCursor..invcod ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAEXPO, HORAIMPO, BDMODIFW, BDALTAFW, ESTTRANS, HALTAFW, invcod, invdes, ContrStock, invobs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..invcod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..invdes ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..ContrStock, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..invobs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.INVCOD = isnull( d.INVCOD, t.INVCOD ),t.INVDES = isnull( d.INVDES, t.INVDES ),t.CONTRSTOCK = isnull( d.CONTRSTOCK, t.CONTRSTOCK ),t.INVOBS = isnull( d.INVOBS, t.INVOBS )
					from ZooLogic.INV t inner join deleted d 
							 on t.invcod = d.invcod
				-- Fin Updates
				insert into ZooLogic.INV(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Invcod,Invdes,Contrstock,Invobs)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.INVCOD,''),isnull( d.INVDES,''),isnull( d.CONTRSTOCK,0),isnull( d.INVOBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="INVENTARIO                              " atributo="FECHATRANSFERENCIA                      " tabla="INV            " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="INVENTARIO                              " atributo="ESTADOTRANSFERENCIA                     " tabla="INV            " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="INVENTARIO                              " atributo="CODIGO                                  " tabla="INV            " campo="INVCOD    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="1" etiqueta="Código de inventario                                                                                                                                                                                                                                      " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="INVENTARIO                              " atributo="DESCRIPCION                             " tabla="INV            " campo="INVDES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Descripción del inventario                                                                                                                                                                                                                                " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
