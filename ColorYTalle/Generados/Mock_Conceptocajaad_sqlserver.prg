...
define class Mock_Conceptocajaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Conceptocajaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubcca( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubcca', lcParametros )
	EndFunc
