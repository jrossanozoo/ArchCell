...
define class Din_ItemPAISAFIPDetallecuits as ItemActivo of ItemActivo.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'PAISAFIP', 'Detallecuits')
	...
	function Cuit_Assign( txVal as variant ) as void
		...
		if This.CargaManual()
			if this.Validar_Cuit( lxVal )
				this.EventoAntesDeSetear( This, 'Cuit', lxValOld, lxVal  )
				this.Setear_Cuit( lxVal )
				this.EventoDespuesDeSetear( This, 'Cuit', lxValOld, lxVal  )
				If lxValOld != lxVal
					If This.PuedeEjecutarHaCambiado()
						this.HaCambiado( 'Cuit', This )
					Endif
				EndIf
			EndIf
		Else
