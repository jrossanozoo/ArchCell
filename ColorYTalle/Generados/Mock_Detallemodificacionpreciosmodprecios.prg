...
define class Mock_Detallemodificacionpreciosmodprecios as MockBase of MockBase.prg

	cClase = 'Detallemodificacionpreciosmodprecios'
	...
	cCopiadorDeDetalle = "CopiadorDeDetallesModificacionPrecios"                                                                                                                                                                                              
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function validartipodeitemalcopiar( toitem as object ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
