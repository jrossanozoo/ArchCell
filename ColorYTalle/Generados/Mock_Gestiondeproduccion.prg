...
define class Mock_gestiondeproduccion as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Gestión de orden de producción"                                                                                                                                                                                                          
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallegestioncurva() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallegestioncurva', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallegestiondescartes() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallegestiondescartes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallegestioninsumos() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallegestioninsumos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallegestioninsumosdescartes() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallegestioninsumosdescartes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalleprocesos() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleprocesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminardescartes( tcarticulo_pk as string, tccolorm_pk as string, tctallem_pk as string, tcinsumo_pk as string ) as void                                                                                                                        
		...
		lxParam2 = tccolorm_pk
		lxParam3 = tctallem_pk
		lxParam4 = tcinsumo_pk
		...
		return this.ObtenerResultado( 'Eliminardescartes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminarinsumos( tcarticulo_pk as string, tccolorm_pk as string, tctallem_pk as string ) as void                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eliminarinsumos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminarinsumosdescartes( tcarticulo_pk as string, tccolorm_pk as string, tctallem_pk as string, tcinsumo_pk as string ) as void                                                                                                                 
		...
		return this.ObtenerResultado( 'Eliminarinsumosdescartes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esmodoedicion() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Esmodoedicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoenviarmensajesinespera( tcmensaje as string) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Eventoenviarmensajesinespera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existensalidasmultiplesenelproceso( tcarticulo_pk as string, tccolorm_pk as string, tctallem_pk as string ) as boolean                                                                                                                           
		...
		return this.ObtenerResultado( 'Existensalidasmultiplesenelproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function gestioncurva_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'gestioncurva_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'gestioncurva_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Gestioncurva ) = 'O' or isnull( this.Gestioncurva ) )			this.Gestioncurva = this.crearobjeto( 'Din_DetalleGestiondeproduccionGestioncurva' )			this.Gestioncurva.inicializar()			this.enlazar( 'Gestioncurva.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Gestioncurva.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Gestioncurva, 'CambioSumarizado', this, 'CambiosDetalleGestioncurva', 1)			this.enlazar( 'Gestioncurva.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Gestioncurva.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Gestioncurva.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Gestioncurva
	EndFunc

	*-----------------------------------------------------------------------------------------
	function gestiondescartes_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'gestiondescartes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'gestiondescartes_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Gestiondescartes ) = 'O' or isnull( this.Gestiondescartes ) )			this.Gestiondescartes = this.crearobjeto( 'Din_DetalleGestiondeproduccionGestiondescartes' )			this.Gestiondescartes.inicializar()			this.enlazar( 'Gestiondescartes.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Gestiondescartes.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Gestiondescartes, 'CambioSumarizado', this, 'CambiosDetalleGestiondescartes', 1)			this.enlazar( 'Gestiondescartes.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Gestiondescartes.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Gestiondescartes.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Gestiondescartes
	EndFunc

	*-----------------------------------------------------------------------------------------
	function gestioninsumos_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'gestioninsumos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'gestioninsumos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Gestioninsumos ) = 'O' or isnull( this.Gestioninsumos ) )			this.Gestioninsumos = this.crearobjeto( 'Din_DetalleGestiondeproduccionGestioninsumos' )			this.Gestioninsumos.inicializar()			this.enlazar( 'Gestioninsumos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Gestioninsumos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Gestioninsumos, 'CambioSumarizado', this, 'CambiosDetalleGestioninsumos', 1)			this.enlazar( 'Gestioninsumos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Gestioninsumos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Gestioninsumos.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Gestioninsumos
	EndFunc

	*-----------------------------------------------------------------------------------------
	function gestioninsumosdescartes_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'gestioninsumosdescartes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'gestioninsumosdescartes_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Gestioninsumosdescartes ) = 'O' or isnull( this.Gestioninsumosdescartes ) )			this.Gestioninsumosdescartes = this.crearobjeto( 'Din_DetalleGestiondeproduccionGestioninsumosdescartes' )			this.Gestioninsumosdescartes.inicializar()			this.enlazar( 'Gestioninsumosdescartes.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Gestioninsumosdescartes.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Gestioninsumosdescartes, 'CambioSumarizado', this, 'CambiosDetalleGestioninsumosdescartes', 1)			this.enlazar( 'Gestioninsumosdescartes.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Gestioninsumosdescartes.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Gestioninsumosdescartes.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Gestioninsumosdescartes
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modelo_access() as variant                                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modelo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modelo_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Modelo ) = 'O' or isnull( this.Modelo ) )					this.Modelo = _Screen.zoo.instanciarentidad( 'Modelodeproduccion' )					this.Modelo.lEsSubEntidad = .t.					this.enlazar( 'Modelo.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Modelo.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Modelo.CODIGO # this.Modelo_PK						this.Modelo.CODIGO = this.Modelo_PK					endif				endif			endif		endif		return this.Modelo
	EndFunc

	*-----------------------------------------------------------------------------------------
	function modelo_pk_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modelo_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modelo_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Modelo_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 15, padr( lxVal, 15 ), lxVal )		this.Modelo_PK = lxVal		if this.Validar_Modelo( lxVal, lxValOld )			This.Setear_Modelo( lxVal )		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numerodeorden_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numerodeorden_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numerodeorden_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numerodeorden		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numerodeorden( lxVal )				this.ValidarDominio_Numericononegativo( lxVal )				this.Setear_Numerodeorden( lxVal )			EndIf		Else			This.Setear_Numerodeorden( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oad_access() as variant                                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oad_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oad_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oAD ) = 'O' or isnull( this.oAD ) )			this.oAD = this.crearobjeto( 'Din_EntidadGESTIONDEPRODUCCIONAD_' + alltrim( _screen.zoo.app.TipoDeBase ))			this.oAD.InyectarEntidad( this )			this.oAD.Inicializar()		endif		return this.oAD
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciaaccionesdelsistema( tncantidadgenerados as integer, tcnumeros as string, tcdescripcioncomprobante as string ) as string                                                                                                          
		...
		lnParametros = pcount()
		lxParam1 = tncantidadgenerados
		lxParam2 = tcnumeros
		lxParam3 = tcdescripcioncomprobante
		...
		return this.ObtenerResultado( 'Obtenersentenciaaccionesdelsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompgestiondeproduccion_access() as variant                                                                                                                                                                                                     
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocompgestiondeproduccion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocompgestiondeproduccion_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oCompGestiondeproduccion ) = 'O' or isnull( this.oCompGestiondeproduccion ) )			this.oCompGestiondeproduccion = _Screen.zoo.InstanciarComponente( 'ComponenteGestiondeproduccion' )		this.oCompGestiondeproduccion.Inicializar()		this.enlazar( 'oCompGestiondeproduccion.EventoObtenerLogueo', 'inyectarLogueo' )		this.enlazar( 'oCompGestiondeproduccion.EventoObtenerInformacion', 'inyectarInformacion' )		endif		return this.oCompGestiondeproduccion
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function proceso_access() as variant                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'proceso_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'proceso_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Proceso ) = 'O' or isnull( this.Proceso ) )					this.Proceso = _Screen.zoo.instanciarentidad( 'Procesoproduccion' )					this.Proceso.lEsSubEntidad = .t.					this.enlazar( 'Proceso.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Proceso.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Proceso.CODIGO # this.Proceso_PK						this.Proceso.CODIGO = this.Proceso_PK					endif				endif			endif		endif		return this.Proceso
	EndFunc

	*-----------------------------------------------------------------------------------------
	function proceso_pk_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'proceso_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'proceso_pk_assign', lcParametros )			endif		endif		this.lHaCambiado_Proceso_PK = ! ( alltrim( this.Proceso_PK ) == alltrim( txVal ) )		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesos_access() as variant                                                                                                                                                                                                                     
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'procesos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'procesos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Procesos ) = 'O' or isnull( this.Procesos ) )			this.Procesos = this.crearobjeto( 'Din_DetalleGestiondeproduccionProcesos' )			this.Procesos.inicializar()			this.enlazar( 'Procesos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Procesos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Procesos, 'CambioSumarizado', this, 'CambiosDetalleProcesos', 1)			this.enlazar( 'Procesos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Procesos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Procesos
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recalculardescartessegunitemactivosalida() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Recalculardescartessegunitemactivosalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recalcularinsumossegunitemactivosalida() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Recalcularinsumossegunitemactivosalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventariodestino( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_inventariodestino', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_inventariodestino', lcParametros )			endif		endif		this.Inventariodestino.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_inventarioorigen( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_inventarioorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_inventarioorigen', lcParametros )			endif		endif		this.Inventarioorigen.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_modelo( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_modelo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_modelo', lcParametros )			endif		endif		this.Modelo.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerodeorden( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numerodeorden', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numerodeorden', lcParametros )			endif		endif		this.Numerodeorden = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_taller( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_taller', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_taller', lcParametros )			endif		endif		this.Taller.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearfiltrobuscadorcolorencurva( tobusqueda as object ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearfiltrobuscadorcolorencurva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearfiltrobuscadorproceso( tobusqueda as object ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setearfiltrobuscadorproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearfiltrobuscadortalleencurva( tobusqueda as object ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearfiltrobuscadortalleencurva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventariodestino( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_inventariodestino', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_inventariodestino', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_inventarioorigen( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_inventarioorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_inventarioorigen', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerodeorden( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numerodeorden', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numerodeorden', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ordendeproduccion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ordendeproduccion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ordendeproduccion', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_proceso( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_proceso', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_proceso', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_taller( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GESTIONDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_taller', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_taller', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarinventariodestino() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarinventariodestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarinventarioorigen() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarinventarioorigen', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarmodelo() as boolean                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmodelo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarordendeproduccion() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarordendeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarproceso() as boolean                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartaller() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validartaller', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinventariodestino() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoinventariodestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinventarioorigen() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridoinventarioorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoordendeproduccion() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoordendeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoproceso() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotaller() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridotaller', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursordetalle( tcdetalle as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercursordetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function renumerarnroitemdeldetalle( tcnombredetalle as string ) as void                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Renumerarnroitemdeldetalle', lcParametros )
	EndFunc
