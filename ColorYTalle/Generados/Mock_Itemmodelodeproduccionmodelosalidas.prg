...
define class Mock_Itemmodelodeproduccionmodelosalidas as MockBase of MockBase.prg

	cClase = 'Itemmodelodeproduccionmodelosalidas'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosemielaborado() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridosemielaborado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosemielaboradodetalle() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridosemielaboradodetalle', lcParametros )
	EndFunc
