...
define class Mock_Mercaderiaentransitoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Mercaderiaentransitoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detmtrans( tctablatrabajo ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detmtrans', lcParametros )
	EndFunc
