...
define class Din_EntidadSENIAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxSeniaFmodifw, lxSeniaFectrans, lxSeniaFecimpo, lxSeniaFecexpo, lxSeniaFaltafw, lxSeniaBdmodifw, lxSeniaEsttrans, lxSeniaHoraimpo, lxSeniaVmodifw, lxSeniaValtafw, lxSeniaZadsfw, lxSeniaUmodifw, lxSeniaDescfw, lxSeniaSmodifw, lxSeniaUaltafw, lxSeniaBdaltafw, lxSeniaHoraexpo, lxSeniaHmodifw, lxSeniaHaltafw, lxSeniaSaltafw, lxSeniaCompa, lxSeniaComp, lxSeniaPreciosr, lxSeniaCondiva, lxSeniaPrunsinimp, lxSeniaPreciocisr, lxSeniaPrunconimp, lxSeniaPorciva, lxSeniaPreciosisr, lxSeniaMtoiva, lxSeniaTasaimpint, lxSeniaMtoimpint, lxSeniaAnulado, lxSeniaCodigo, lxSeniaFletraa, lxSeniaFletra, lxSeniaObs, lxSeniaFptovena, lxSeniaFptoven, lxSeniaFnumcompa, lxSeniaFnumcomp, lxSeniaCoriabrev, lxSeniaCafeabrev, lxSeniaFacttipo, lxSeniaFacttipoa, lxSeniaFechaa, lxSeniaFecha, lxSeniaCseriea, lxSeniaCserie, lxSeniaCversion, lxSeniaCversiona, lxSeniaCbdedata, lxSeniaCbasededat, lxSeniaCliente, lxSeniaFechavenci, lxSeniaFprecio, lxSeniaMoneda
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.SENIA ( "Fmodifw","Fectrans","Fecimpo","Fecexpo","Faltafw","Bdmodifw","Esttrans","Horaimpo","Vmodifw","Valtafw","Zadsfw","Umodifw","Descfw","Smodifw","Ualtafw","Bdaltafw","Horaexpo","Hmodifw","Haltafw","Saltafw","Compa","Comp","Preciosr","Condiva","Prunsinimp","Preciocisr","Prunconimp","Porciva","Preciosisr","Mtoiva","Tasaimpint","Mtoimpint","Anulado","Codigo","Fletraa","Fletra","Obs","Fptovena","Fptoven","Fnumcompa","Fnumcomp","Coriabrev","Cafeabrev","Facttipo","Facttipoa","Fechaa","Fecha","Cseriea","Cserie","Cversion","Cversiona","Cbdedata","Cbasededat","Cliente","Fechavenci","Fprecio","Moneda" ) values ( <<"'" + this.ConvertirDateSql( lxSeniaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeniaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeniaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeniaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeniaFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCompa ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaComp ) + "'" >>, <<lxSeniaPreciosr >>, <<lxSeniaCondiva >>, <<lxSeniaPrunsinimp >>, <<lxSeniaPreciocisr >>, <<lxSeniaPrunconimp >>, <<lxSeniaPorciva >>, <<lxSeniaPreciosisr >>, <<lxSeniaMtoiva >>, <<lxSeniaTasaimpint >>, <<lxSeniaMtoimpint >>, <<iif( lxSeniaAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxSeniaCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaFletraa ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaObs ) + "'" >>, <<lxSeniaFptovena >>, <<lxSeniaFptoven >>, <<lxSeniaFnumcompa >>, <<lxSeniaFnumcomp >>, <<"'" + this.FormatearTextoSql( lxSeniaCoriabrev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCafeabrev ) + "'" >>, <<lxSeniaFacttipo >>, <<lxSeniaFacttipoa >>, <<"'" + this.ConvertirDateSql( lxSeniaFechaa ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeniaFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCseriea ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCserie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCversion ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCversiona ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCbdedata ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCbasededat ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeniaCliente ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeniaFechavenci ) + "'" >>, <<lxSeniaFprecio >>, <<"'" + this.FormatearTextoSql( lxSeniaMoneda ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.ArticulosDetalle
				if this.oEntidad.ArticulosDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.SeniaDet("Prunsinimp","FPRUN","MNDESSI","PRECIOSISR","ACondIvaV","PRECIOCISR","PRECIOSR","APorcIvaV","prunconimp","MNDESCI","FmtoCFI","COMP","FCFITot","FporDTO1","FmtoDTO1","FporCFI","NroItem","tasaimpint","ProcStock","MotDescu","CODIGO","FART","MotDevol","FTXT","cColor","FCOLTXT","FTATXT","Talle","FCANT","FPRECIO","FCFI","MNTDES","FMONTO" ) values ( <<lxPreciosinimpuestos>>, <<lxPreciounitario>>, <<lxMontodescuentosinimpuestos>>, <<lxPreciosinimpuestossinredondear>>, <<lxArticulo_condicionivaventas>>, <<lxPrecioconimpuestossinredondear>>, <<lxPreciosinredondear>>, <<lxArticulo_porcentajeivaventas>>, <<lxPrecioconimpuestos>>, <<lxMontodescuentoconimpuestos>>, <<lxMontocfi>>, <<lxComportamiento>>, <<lxMontoporcentajedescuentoconimpuesto>>, <<lxPorcentajedto1>>, <<lxMontodto1>>, <<lxPorcentajecfi>>, <<lxNroitem>>, <<lxTasaimpuestointerno>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxCodigomotivodescuento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigomotivodevolucion_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalledetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>>, <<lxPrecio>>, <<lxDescuento>>, <<lxMontodescuento>>, <<lxMonto>> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.SENIA set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxSeniaFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxSeniaFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxSeniaFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxSeniaFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxSeniaFaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxSeniaBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxSeniaEsttrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxSeniaHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxSeniaVmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxSeniaValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxSeniaZadsfw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxSeniaUmodifw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxSeniaDescfw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxSeniaSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxSeniaUaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxSeniaBdaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxSeniaHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxSeniaHmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxSeniaHaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxSeniaSaltafw ) + "'">>,"Compa" = <<"'" + this.FormatearTextoSql( lxSeniaCompa ) + "'">>,"Comp" = <<"'" + this.FormatearTextoSql( lxSeniaComp ) + "'">>,"Preciosr" = <<lxSeniaPreciosr>>,"Condiva" = <<lxSeniaCondiva>>,"Prunsinimp" = <<lxSeniaPrunsinimp>>,"Preciocisr" = <<lxSeniaPreciocisr>>,"Prunconimp" = <<lxSeniaPrunconimp>>,"Porciva" = <<lxSeniaPorciva>>,"Preciosisr" = <<lxSeniaPreciosisr>>,"Mtoiva" = <<lxSeniaMtoiva>>,"Tasaimpint" = <<lxSeniaTasaimpint>>,"Mtoimpint" = <<lxSeniaMtoimpint>>,"Anulado" = <<iif( lxSeniaAnulado, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxSeniaCodigo ) + "'">>,"Fletraa" = <<"'" + this.FormatearTextoSql( lxSeniaFletraa ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxSeniaFletra ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxSeniaObs ) + "'">>,"Fptovena" = <<lxSeniaFptovena>>,"Fptoven" = <<lxSeniaFptoven>>,"Fnumcompa" = <<lxSeniaFnumcompa>>,"Fnumcomp" = <<lxSeniaFnumcomp>>,"Coriabrev" = <<"'" + this.FormatearTextoSql( lxSeniaCoriabrev ) + "'">>,"Cafeabrev" = <<"'" + this.FormatearTextoSql( lxSeniaCafeabrev ) + "'">>,"Facttipo" = <<lxSeniaFacttipo>>,"Facttipoa" = <<lxSeniaFacttipoa>>,"Fechaa" = <<"'" + this.ConvertirDateSql( lxSeniaFechaa ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxSeniaFecha ) + "'">>,"Cseriea" = <<"'" + this.FormatearTextoSql( lxSeniaCseriea ) + "'">>,"Cserie" = <<"'" + this.FormatearTextoSql( lxSeniaCserie ) + "'">>,"Cversion" = <<"'" + this.FormatearTextoSql( lxSeniaCversion ) + "'">>,"Cversiona" = <<"'" + this.FormatearTextoSql( lxSeniaCversiona ) + "'">>,"Cbdedata" = <<"'" + this.FormatearTextoSql( lxSeniaCbdedata ) + "'">>,"Cbasededat" = <<"'" + this.FormatearTextoSql( lxSeniaCbasededat ) + "'">>,"Cliente" = <<"'" + this.FormatearTextoSql( lxSeniaCliente ) + "'">>,"Fechavenci" = <<"'" + this.ConvertirDateSql( lxSeniaFechavenci ) + "'">>,"Fprecio" = <<lxSeniaFprecio>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxSeniaMoneda ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxSeniaCodigo ) + "'">> and  SENIA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Descfw" as "Descripcionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Compa" as "Comprobanteafectante", "Comp" as "Comprobanteorigen", "Preciosr" as "Preciosinredondear", "Condiva" as "Condicioniva", "Prunsinimp" as "Preciosinimpuestos", "Preciocisr" as "Precioconimpuestossinredondear", "Prunconimp" as "Precioconimpuestos", "Porciva" as "Porcentajeiva", "Preciosisr" as "Preciosinimpuestossinredondear", "Mtoiva" as "Montoiva", "Tasaimpint" as "Tasaimpuestointerno", "Mtoimpint" as "Montoimpuestointerno", "Anulado" as "Anulado", "Codigo" as "Codigo", "Fletraa" as "Letraafectante", "Fletra" as "Letraorigen", "Obs" as "Observacion", "Fptovena" as "Puntodeventaafectante", "Fptoven" as "Puntodeventaorigen", "Fnumcompa" as "Numeroafectante", "Fnumcomp" as "Numeroorigen", "Coriabrev" as "Tipocomprobanteorigenabreviado", "Cafeabrev" as "Tipocomprobanteafectanteabreviado", "Facttipo" as "Tipocomprobanteorigen", "Facttipoa" as "Tipocomprobanteafectante", "Fechaa" as "Fechaafectante", "Fecha" as "Fechaorigen", "Cseriea" as "Cserieafectante", "Cserie" as "Cserieorigen", "Cversion" as "Cversionorigen", "Cversiona" as "Cversionafectante", "Cbdedata" as "Cbasededatosafectante", "Cbasededat" as "Cbasededatosorigen", "Cliente" as "Cliente", "Fechavenci" as "Fechavencimiento", "Fprecio" as "Precio", "Moneda" as "Moneda" from ZooLogic.SENIA where "Codigo" = <<"'" + this.FormatearTextoSql( lxSeniaCodigo ) + "'">> and  SENIA.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Prunsinimp" as "Preciosinimpuestos", "Fprun" as "Preciounitario", "Mndessi" as "Montodescuentosinimpuestos", "Preciosisr" as "Preciosinimpuestossinredondear", "Acondivav" as "Articulo_condicionivaventas", "Preciocisr" as "Precioconimpuestossinredondear", "Preciosr" as "Preciosinredondear", "Aporcivav" as "Articulo_porcentajeivaventas", "Prunconimp" as "Precioconimpuestos", "Mndesci" as "Montodescuentoconimpuestos", "Fmtocfi" as "Montocfi", "Comp" as "Comportamiento", "Fcfitot" as "Montoporcentajedescuentoconimpuesto", "Fpordto1" as "Porcentajedto1", "Fmtodto1" as "Montodto1", "Fporcfi" as "Porcentajecfi", "Nroitem" as "Nroitem", "Tasaimpint" as "Tasaimpuestointerno", "Procstock" as "Noprocesarstock", "Motdescu" as "Codigomotivodescuento", "Codigo" as "Codigo", "Fart" as "Articulo", "Motdevol" as "Codigomotivodevolucion", "Ftxt" as "Articulodetalle", "Ccolor" as "Color", "Fcoltxt" as "Colordetalle", "Ftatxt" as "Talledetalle", "Talle" as "Talle", "Fcant" as "Cantidad", "Fprecio" as "Precio", "Fcfi" as "Descuento", "Mntdes" as "Montodescuento", "Fmonto" as "Monto" from ZooLogic.SeniaDet where CODIGO = <<"'" + this.FormatearTextoSql( c_SENIA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Bdmodifw,Esttrans,Horaimpo,Vmodifw,Valtafw,Zadsfw,U" + ;
"modifw,Descfw,Smodifw,Ualtafw,Bdaltafw,Horaexpo,Hmodifw,Haltafw,Saltafw,Compa,Comp,Preciosr,Condiva," + ;
"Prunsinimp,Preciocisr,Prunconimp,Porciva,Preciosisr,Mtoiva,Tasaimpint,Mtoimpint,Anulado,Codigo,Fletr" + ;
"aa,Fletra,Obs,Fptovena,Fptoven,Fnumcompa,Fnumcomp,Coriabrev,Cafeabrev,Facttipo,Facttipoa,Fechaa,Fech" + ;
"a,Cseriea,Cserie,Cversion,Cversiona,Cbdedata,Cbasededat,Cliente,Fechavenci,Fprecio,Moneda" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleArticulosDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Prunsinimp" as "Preciosinimpuestos", "Fprun" as "Preciounitario", "Mndessi" as "Montodescuentosinimpuestos", "Preciosisr" as "Preciosinimpuestossinredondear", "Acondivav" as "Articulo_condicionivaventas", "Preciocisr" as "Precioconimpuestossinredondear", "Preciosr" as "Preciosinredondear", "Aporcivav" as "Articulo_porcentajeivaventas", "Prunconimp" as "Precioconimpuestos", "Mndesci" as "Montodescuentoconimpuestos", "Fmtocfi" as "Montocfi", "Comp" as "Comportamiento", "Fcfitot" as "Montoporcentajedescuentoconimpuesto", "Fpordto1" as "Porcentajedto1", "Fmtodto1" as "Montodto1", "Fporcfi" as "Porcentajecfi", "Nroitem" as "Nroitem", "Tasaimpint" as "Tasaimpuestointerno", "Procstock" as "Noprocesarstock", "Motdescu" as "Codigomotivodescuento", "Codigo" as "Codigo", "Fart" as "Articulo", "Motdevol" as "Codigomotivodevolucion", "Ftxt" as "Articulodetalle", "Ccolor" as "Color", "Fcoltxt" as "Colordetalle", "Ftatxt" as "Talledetalle", "Talle" as "Talle", "Fcant" as "Cantidad", "Fprecio" as "Precio", "Fcfi" as "Descuento", "Mntdes" as "Montodescuento", "Fmonto" as "Monto"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.ArticulosDetalle
				if this.oEntidad.ArticulosDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxMonto = loItem.Monto
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.SeniaDet("Prunsinimp","FPRUN","MNDESSI","PRECIOSISR","ACondIvaV","PRECIOCISR","PRECIOSR","APorcIvaV","prunconimp","MNDESCI","FmtoCFI","COMP","FCFITot","FporDTO1","FmtoDTO1","FporCFI","NroItem","tasaimpint","ProcStock","MotDescu","CODIGO","FART","MotDevol","FTXT","cColor","FCOLTXT","FTATXT","Talle","FCANT","FPRECIO","FCFI","MNTDES","FMONTO" ) values ( <<lxPreciosinimpuestos>>, <<lxPreciounitario>>, <<lxMontodescuentosinimpuestos>>, <<lxPreciosinimpuestossinredondear>>, <<lxArticulo_condicionivaventas>>, <<lxPrecioconimpuestossinredondear>>, <<lxPreciosinredondear>>, <<lxArticulo_porcentajeivaventas>>, <<lxPrecioconimpuestos>>, <<lxMontodescuentoconimpuestos>>, <<lxMontocfi>>, <<lxComportamiento>>, <<lxMontoporcentajedescuentoconimpuesto>>, <<lxPorcentajedto1>>, <<lxMontodto1>>, <<lxPorcentajecfi>>, <<lxNroitem>>, <<lxTasaimpuestointerno>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxCodigomotivodescuento_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigomotivodevolucion_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalledetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>>, <<lxPrecio>>, <<lxDescuento>>, <<lxMontodescuento>>, <<lxMonto>> ) 
					endtext
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.SENIA set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, CompA = ] + "'" + this.FormatearTextoSql( &lcCursor..CompA ) + "'"+ [, Comp = ] + "'" + this.FormatearTextoSql( &lcCursor..Comp ) + "'"+ [, PRECIOSR = ] + transform( &lcCursor..PRECIOSR )+ [, CondIva = ] + transform( &lcCursor..CondIva )+ [, Prunsinimp = ] + transform( &lcCursor..Prunsinimp )+ [, PRECIOCISR = ] + transform( &lcCursor..PRECIOCISR )+ [, prunconimp = ] + transform( &lcCursor..prunconimp )+ [, PorcIva = ] + transform( &lcCursor..PorcIva )+ [, PRECIOSISR = ] + transform( &lcCursor..PRECIOSISR )+ [, MtoIva = ] + transform( &lcCursor..MtoIva )+ [, tasaimpint = ] + transform( &lcCursor..tasaimpint )+ [, mtoimpint = ] + transform( &lcCursor..mtoimpint )+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, FLETRAA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRAA ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, FPTOVENA = ] + transform( &lcCursor..FPTOVENA )+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FNUMCOMPA = ] + transform( &lcCursor..FNUMCOMPA )+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, COriAbrev = ] + "'" + this.FormatearTextoSql( &lcCursor..COriAbrev ) + "'"+ [, CAfeAbrev = ] + "'" + this.FormatearTextoSql( &lcCursor..CAfeAbrev ) + "'"+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, FACTTIPOA = ] + transform( &lcCursor..FACTTIPOA )+ [, FechaA = ] + "'" + this.ConvertirDateSql( &lcCursor..FechaA ) + "'"+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, CSERIEA = ] + "'" + this.FormatearTextoSql( &lcCursor..CSERIEA ) + "'"+ [, CSERIE = ] + "'" + this.FormatearTextoSql( &lcCursor..CSERIE ) + "'"+ [, CVERSION = ] + "'" + this.FormatearTextoSql( &lcCursor..CVERSION ) + "'"+ [, CVERSIONA = ] + "'" + this.FormatearTextoSql( &lcCursor..CVERSIONA ) + "'"+ [, cBDeDatA = ] + "'" + this.FormatearTextoSql( &lcCursor..cBDeDatA ) + "'"+ [, cBaseDeDat = ] + "'" + this.FormatearTextoSql( &lcCursor..cBaseDeDat ) + "'"+ [, Cliente = ] + "'" + this.FormatearTextoSql( &lcCursor..Cliente ) + "'"+ [, FechaVenci = ] + "'" + this.ConvertirDateSql( &lcCursor..FechaVenci ) + "'"+ [, FPRECIO = ] + transform( &lcCursor..FPRECIO )+ [, moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..moneda ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CompA ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Comp ) + "'" + ',' + transform( &lcCursor..PRECIOSR ) + ',' + transform( &lcCursor..CondIva ) + ',' + transform( &lcCursor..Prunsinimp ) + ',' + transform( &lcCursor..PRECIOCISR ) + ',' + transform( &lcCursor..prunconimp ) + ',' + transform( &lcCursor..PorcIva ) + ',' + transform( &lcCursor..PRECIOSISR ) + ',' + transform( &lcCursor..MtoIva ) + ',' + transform( &lcCursor..tasaimpint )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..mtoimpint ) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRAA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + ',' + transform( &lcCursor..FPTOVENA ) + ',' + transform( &lcCursor..FPTOVEN )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FNUMCOMPA ) + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..COriAbrev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CAfeAbrev ) + "'" + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..FACTTIPOA ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaA ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CSERIEA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CSERIE ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CVERSION ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CVERSIONA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cBDeDatA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cBaseDeDat ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cliente ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaVenci ) + "'" + ',' + transform( &lcCursor..FPRECIO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..moneda ) + "'"
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"Prunsinimp","FPRUN","MNDESSI","PRECIOSISR","ACondIvaV","PRECIOCISR","PRECIOSR","APorcIvaV","prunconimp","MNDESCI","FmtoCFI","COMP","FCFITot","FporDTO1","FmtoDTO1","FporCFI","NroItem","tasaimpint","ProcStock","MotDescu","CODIGO","FART","MotDevol","FTXT","cColor","FCOLTXT","FTATXT","Talle","FCANT","FPRECIO","FCFI","MNTDES","FMONTO"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.SeniaDet ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.Prunsinimp ) + ',' + transform( cDetallesExistentes.FPRUN      ) + ',' + transform( cDetallesExistentes.MNDESSI    ) + ',' + transform( cDetallesExistentes.PRECIOSISR ) + ',' + transform( cDetallesExistentes.ACondIvaV  ) + ',' + transform( cDetallesExistentes.PRECIOCISR ) + ',' + transform( cDetallesExistentes.PRECIOSR   ) + ',' + transform( cDetallesExistentes.APorcIvaV  ) + ',' + transform( cDetallesExistentes.prunconimp ) + ',' + transform( cDetallesExistentes.MNDESCI    ) + ',' + transform( cDetallesExistentes.FmtoCFI    ) + ',' + transform( cDetallesExistentes.COMP       ) + ',' + transform( cDetallesExistentes.FCFITot    ) + ',' + transform( cDetallesExistentes.FporDTO1   ) + ',' + transform( cDetallesExistentes.FmtoDTO1   ) + ',' + transform( cDetallesExistentes.FporCFI    ) + ',' + transform( cDetallesExistentes.NroItem    ) + ',' + transform( cDetallesExistentes.tasaimpint ) + ',' + Transform( iif( cDetallesExistentes.ProcStock , 1, 0 )) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.MotDescu   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.CODIGO     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.FART       ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.MotDevol   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.FTXT       ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.cColor     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.FCOLTXT    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.FTATXT     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Talle      ) + "'" + ',' + transform( cDetallesExistentes.FCANT      ) + ',' + transform( cDetallesExistentes.FPRECIO    ) + ',' + transform( cDetallesExistentes.FCFI       ) + ',' + transform( cDetallesExistentes.MNTDES     ) + ',' + transform( cDetallesExistentes.FMONTO     ) + ' )'  )
		select cDetallesExistentes
	EndScan
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.COMPA = isnull( d.COMPA, t.COMPA ),t.COMP = isnull( d.COMP, t.COMP ),t.PRECIOSR = isnull( d.PRECIOSR, t.PRECIOSR ),t.CONDIVA = isnull( d.CONDIVA, t.CONDIVA ),t.PRUNSINIMP = isnull( d.PRUNSINIMP, t.PRUNSINIMP ),t.PRECIOCISR = isnull( d.PRECIOCISR, t.PRECIOCISR ),t.PRUNCONIMP = isnull( d.PRUNCONIMP, t.PRUNCONIMP ),t.PORCIVA = isnull( d.PORCIVA, t.PORCIVA ),t.PRECIOSISR = isnull( d.PRECIOSISR, t.PRECIOSISR ),t.MTOIVA = isnull( d.MTOIVA, t.MTOIVA ),t.TASAIMPINT = isnull( d.TASAIMPINT, t.TASAIMPINT ),t.MTOIMPINT = isnull( d.MTOIMPINT, t.MTOIMPINT ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FLETRAA = isnull( d.FLETRAA, t.FLETRAA ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.OBS = isnull( d.OBS, t.OBS ),t.FPTOVENA = isnull( d.FPTOVENA, t.FPTOVENA ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FNUMCOMPA = isnull( d.FNUMCOMPA, t.FNUMCOMPA ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.CORIABREV = isnull( d.CORIABREV, t.CORIABREV ),t.CAFEABREV = isnull( d.CAFEABREV, t.CAFEABREV ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FACTTIPOA = isnull( d.FACTTIPOA, t.FACTTIPOA ),t.FECHAA = isnull( d.FECHAA, t.FECHAA ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.CSERIEA = isnull( d.CSERIEA, t.CSERIEA ),t.CSERIE = isnull( d.CSERIE, t.CSERIE ),t.CVERSION = isnull( d.CVERSION, t.CVERSION ),t.CVERSIONA = isnull( d.CVERSIONA, t.CVERSIONA ),t.CBDEDATA = isnull( d.CBDEDATA, t.CBDEDATA ),t.CBASEDEDAT = isnull( d.CBASEDEDAT, t.CBASEDEDAT ),t.CLIENTE = isnull( d.CLIENTE, t.CLIENTE ),t.FECHAVENCI = isnull( d.FECHAVENCI, t.FECHAVENCI ),t.FPRECIO = isnull( d.FPRECIO, t.FPRECIO ),t.MONEDA = isnull( d.MONEDA, t.MONEDA )
				...
				-- Fin Updates
				insert into ZooLogic.SENIA(Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Bdmodifw,Esttrans,Horaimpo,Vmodifw,Valtafw,Zadsfw,Umodifw,Descfw,Smodifw,Ualtafw,Bdaltafw,Horaexpo,Hmodifw,Haltafw,Saltafw,Compa,Comp,Preciosr,Condiva,Prunsinimp,Preciocisr,Prunconimp,Porciva,Preciosisr,Mtoiva,Tasaimpint,Mtoimpint,Anulado,Codigo,Fletraa,Fletra,Obs,Fptovena,Fptoven,Fnumcompa,Fnumcomp,Coriabrev,Cafeabrev,Facttipo,Facttipoa,Fechaa,Fecha,Cseriea,Cserie,Cversion,Cversiona,Cbdedata,Cbasededat,Cliente,Fechavenci,Fprecio,Moneda)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.UMODIFW,''),isnull( d.DESCFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.SALTAFW,''),isnull( d.COMPA,''),isnull( d.COMP,''),isnull( d.PRECIOSR,0),isnull( d.CONDIVA,0),isnull( d.PRUNSINIMP,0),isnull( d.PRECIOCISR,0),isnull( d.PRUNCONIMP,0),isnull( d.PORCIVA,0),isnull( d.PRECIOSISR,0),isnull( d.MTOIVA,0),isnull( d.TASAIMPINT,0),isnull( d.MTOIMPINT,0),isnull( d.ANULADO,0),isnull( d.CODIGO,''),isnull( d.FLETRAA,''),isnull( d.FLETRA,''),isnull( d.OBS,''),isnull( d.FPTOVENA,0),isnull( d.FPTOVEN,0),isnull( d.FNUMCOMPA,0),isnull( d.FNUMCOMP,0),isnull( d.CORIABREV,''),isnull( d.CAFEABREV,''),isnull( d.FACTTIPO,0),isnull( d.FACTTIPOA,0),isnull( d.FECHAA,''),isnull( d.FECHA,''),isnull( d.CSERIEA,''),isnull( d.CSERIE,''),isnull( d.CVERSION,''),isnull( d.CVERSIONA,''),isnull( d.CBDEDATA,''),isnull( d.CBASEDEDAT,''),isnull( d.CLIENTE,''),isnull( d.FECHAVENCI,''),isnull( d.FPRECIO,0),isnull( d.MONEDA,'')
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					...
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: TIPO ' + cast( d.FACTTIPO as Varchar(2) ) + ', LETRA ' + cast( d.FLETRA as Varchar(1) ) + ', PUNTO DE VENTA ' + cast( d.FPTOVEN as Varchar(4) ) + ', COMPROBANTE ' + cast( d.FNUMCOMP as Varchar(8) ) + '','La clave principal no es la esperada'
					from ZooLogic.SENIA t inner join deleted d 
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					<<loLogueo.EstadoSistema>>,'<<loLogueo.Aplicacion>>','<<loLogueo.Version>>',
					'<<loLogueo.Serie>>','<<loLogueo.Usuario>>','<<loLogueo.NombrePc>>',
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: TIPO ' + cast( d.FACTTIPO as Varchar(2) ) + ', LETRA ' + cast( d.FLETRA as Varchar(1) ) + ', PUNTO DE VENTA ' + cast( d.FPTOVEN as Varchar(4) ) + ', COMPROBANTE ' + cast( d.FNUMCOMP as Varchar(8) ) + '','La clave principal a importar ya existe'
					from ZooLogic.SENIA t inner join deleted d 
							 on t.Codigo = d.Codigo
						left join deleted h 
...
<VFPData xml:space="preserve">
	...
	<row entidad="SENIA                                   " atributo="FECHATRANSFERENCIA                      " tabla="SENIA          " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SENIA                                   " atributo="ESTADOTRANSFERENCIA                     " tabla="SENIA          " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SENIA                                   " atributo="PUNTODEVENTAAFECTANTE                   " tabla="SENIA          " campo="FPTOVENA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Punto de venta afectante                                                                                                                                        " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="PUNTODEVENTAORIGEN                      " tabla="SENIA          " campo="FPTOVEN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Punto de venta origen                                                                                                                                           " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="3" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="NUMEROAFECTANTE                         " tabla="SENIA          " campo="FNUMCOMPA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Numero comprobante afectante                                                                                                                                    " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="NUMEROORIGEN                            " tabla="SENIA          " campo="FNUMCOMP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Numero comprobante origen                                                                                                                                       " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="4" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="TIPOCOMPROBANTEORIGENABREVIADO          " tabla="SENIA          " campo="CORIABREV " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="4" etiqueta="Tipo comprobante origen abreviado                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="TIPOCOMPROBANTEAFECTANTEABREVIADO       " tabla="SENIA          " campo="CAFEABREV " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Tipo comprobante afectante abreviado                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="DESCRIPCIONTIPOCOMPROBANTEORIGEN        " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="80" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Descripción tipo comprobante origen                                                                                                                             " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="DESCRIPCIONTIPOCOMPROBANTEAFECTANTE     " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="80" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Descripción tipo comprobante afectante                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="TIPOCOMPROBANTEORIGEN                   " tabla="SENIA          " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="18" etiqueta="Tipo comprobante origen                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="TIPOCOMPROBANTEAFECTANTE                " tabla="SENIA          " campo="FACTTIPOA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Tipo comprobante afectante                                                                                                                                      " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="FECHAAFECTANTE                          " tabla="SENIA          " campo="FECHAA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Fecha afectante                                                                                                                                                 " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="FECHAORIGEN                             " tabla="SENIA          " campo="FECHA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="14" etiqueta="Fecha origen                                                                                                                                                    " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="CSERIEAFECTANTE                         " tabla="SENIA          " campo="CSERIEA   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Serie afectante                                                                                                                                                 " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="CSERIEORIGEN                            " tabla="SENIA          " campo="CSERIE    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Serie origen                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SENIA                                   " atributo="CBASEDEDATOSAFECTANTE                   " tabla="SENIA          " campo="CBDEDATA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="Base de datos afectante                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="CBASEDEDATOSORIGEN                      " tabla="SENIA          " campo="CBASEDEDAT" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Base de datos origen                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="CLIENTE                                 " tabla="SENIA          " campo="CLIENTE   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Cliente                                                                                                                                                         " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="12" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="FECHAVENCIMIENTO                        " tabla="SENIA          " campo="FECHAVENCI" claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Vencimiento                                                                                                                                                     " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="14" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SENIA                                   " atributo="PRECIO                                  " tabla="SENIA          " campo="FPRECIO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="428" etiqueta="Importe                                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="16" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="3" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On SENIA.CLIENTE = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
