...
define class Mock_Itemliquidaciondetallerliquidaciontallerproduccion as MockBase of MockBase.prg

	cClase = 'Itemliquidaciondetallerliquidaciontallerproduccion'
	...
	*-----------------------------------------------------------------------------------------
	function costo_assign( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Costo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerclaveparaitem() as string                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function resto_assign( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Resto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_costo( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_costo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_resto( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_resto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_costo( txval as variant ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_costo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_resto( txval as variant ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_resto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocosto() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridocosto', lcParametros )
	EndFunc
