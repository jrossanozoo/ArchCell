...
define class Mock_formula as MockBase of MockBase.prg
	...
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Fórmulas de modificación de precios"                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function cambiarsesiondedatos( tnsesiondedatos as integer ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Cambiarsesiondedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cotizacion( tdfecha as date, tcmoneda as string ) as double                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Cotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajenopuedecontinuar( tcmensaje as string ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Eventomensajenopuedecontinuar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function expresion_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FORMULA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'expresion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'expresion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Expresion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Expresion( lxVal )				this.Setear_Expresion( lxVal )			EndIf		Else			This.Setear_Expresion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function exprsql_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FORMULA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'exprsql_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'exprsql_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Exprsql		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Exprsql( lxVal )				this.Setear_Exprsql( lxVal )			EndIf		Else			This.Setear_Exprsql( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function factorivaarticulo( tctipoiva as string, tcidarticulo as string ) as double                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Factorivaarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigosdelistasdeprecios() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercodigosdelistasdeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigosderedondeos() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercodigosderedondeos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosentidadconmemo() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerdatosentidadconmemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerexpresionaevaluar() as string                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerexpresionaevaluar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermapeosdelistasdeprecios() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenermapeosdelistasdeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerparametrosdecotizaciones() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerparametrosdecotizaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function preciodelista( tnpreciodelista as double ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Preciodelista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function redondeo( tnmonto as double, tccodigoderedondeo as string ) as void                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Redondeo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function restaurarsesiondedatos() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Restaurarsesiondedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_expresion( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FORMULA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_expresion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_expresion', lcParametros )			endif		endif		this.Expresion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_exprsql( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FORMULA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_exprsql', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_exprsql', lcParametros )			endif		endif		this.Exprsql = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearvalorlgrabarprocesandocambiodepreciosparalistasrelacionadas( tlvalor ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setearvalorlgrabarprocesandocambiodepreciosparalistasrelacionadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_expresion( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FORMULA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_expresion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_expresion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_exprsql( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FORMULA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_exprsql', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_exprsql', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciadecotizaciones( toentidadquesolicitalavalidacion as entidad of entidad.prg ) as boolean                                                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = toentidadquesolicitalavalidacion
	...
	*-----------------------------------------------------------------------------------------
	function validarexpresion() as boolean                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarexpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoexpresion() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridoexpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function confirmardeseacontinuar() as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Confirmardeseacontinuar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearanalizadordefunciones() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Crearanalizadordefunciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function formulautilizadaenlista() as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Formulautilizadaenlista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercolecciondelistasrelacionadasconformulapk() as zoocoleccion of zoocoleccion.prg                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercolecciondelistasrelacionadasconformulapk', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerexpresionsincaracteresnovalidos( tcexpresion as string ) as string                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerexpresionsincaracteresnovalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reemplazarelementosvariablesdelaformula() as string                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Reemplazarelementosvariablesdelaformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearatributoexprsql() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearatributoexprsql', lcParametros )
	EndFunc
