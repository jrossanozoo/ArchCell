...
define class Mock_Detalleconceptoliquidaciontarjetaagrupublidetalle as MockBase of MockBase.prg

	cClase = 'Detalleconceptoliquidaciontarjetaagrupublidetalle'
