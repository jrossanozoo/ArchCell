...
define class Din_EntidadREMITOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg

	cNombreCursor = 'c_REMITO'
	colSentencias = null
	cArchivoLogPrueba = '' 
	cRutaTablas = ''
	nReintentos = 3
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFd2, lxComprobantevFecimpo, lxComprobantevFecexpo, lxComprobantevFmodifw, lxComprobantevVtocai, lxComprobantevFectrans, lxComprobantevDatosecomm, lxComprobantevFpodes2, lxComprobantevFpodes1, lxComprobantevFletra, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevHaltafw, lxComprobantevValtafw, lxComprobantevZadsfw, lxComprobantevVmodifw, lxComprobantevSmodifw, lxComprobantevFaltafw, lxComprobantevDespachos, lxComprobantevUaltafw, lxComprobantevUmodifw, lxComprobantevBdmodifw, lxComprobantevCbautoimp, lxComprobantevHoraimpo, lxComprobantevEsttrans, lxComprobantevSimbmon, lxComprobantevHoraexpo, lxComprobantevHmodifw, lxComprobantevBdaltafw, lxComprobantevDescfw, lxComprobantevSaltafw, lxComprobantevFhora, lxComprobantevOpecomm, lxComprobantevTotalcant, lxComprobantevFactsec, lxComprobantevSubtotsisi, lxComprobantevCondivalp, lxComprobantevSubtotcisi, lxComprobantevFsubton, lxComprobantevFsubtot, lxComprobantevFacttipo, lxComprobantevTimestamp, lxComprobantevCai, lxComprobantevSignomov, lxComprobantevFajxre, lxComprobantevMdcimpu, lxComprobantevDesmntosi3, lxComprobantevRecmntosi1, lxComprobantevRecmntosi, lxComprobantevRecmntosi2, lxComprobantevDesmntosi1, lxComprobantevDesmntosi, lxComprobantevSitfisccli, lxComprobantevDesmntosi2, lxComprobantevFcompfis, lxComprobantevOrigonline, lxComprobantevAnulado, lxComprobantevMonsis, lxComprobantevFobs, lxComprobantevFcuit, lxComprobantevMd1, lxComprobantevMd2, lxComprobantevFptoven, lxComprobantevFcliente, lxComprobantevFmtdes1, lxComprobantevFmtdes2, lxComprobantevCodigo, lxComprobantevFnumcomp, lxComprobantevFmtdes3, lxComprobantevFven, lxComprobantevTotdescsi, lxComprobantevTdci, lxComprobantevMoneda, lxComprobantevCodlista, lxComprobantevFfch, lxComprobantevTrci, lxComprobantevTotrecarsi, lxComprobantevFpago, lxComprobantevMotivo, lxComprobantevFtotal, lxComprobantevCotiz, lxComprobantevFtransp, lxComprobantevDirentr, lxComprobantevFpodes, lxComprobantevRecmnto2, lxComprobantevEntregapos, lxComprobantevFdescu, lxComprobantevMerconsign, lxComprobantevDeuda, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevRecmnto, lxComprobantevRecpor, lxComprobantevMr, lxComprobantevMr1, lxComprobantevMr2, lxComprobantevRecmnto1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecar, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevIvasis
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fd2","Fecimpo","Fecexpo","Fmodifw","Vtocai","Fectrans","Datosecomm","Fpodes2","Fpodes1","Fletra","Fperson","Fturno","Haltafw","Valtafw","Zadsfw","Vmodifw","Smodifw","Faltafw","Despachos","Ualtafw","Umodifw","Bdmodifw","Cbautoimp","Horaimpo","Esttrans","Simbmon","Horaexpo","Hmodifw","Bdaltafw","Descfw","Saltafw","Fhora","Opecomm","Totalcant","Factsec","Subtotsisi","Condivalp","Subtotcisi","Fsubton","Fsubtot","Facttipo","Timestamp","Cai","Signomov","Fajxre","Mdcimpu","Desmntosi3","Recmntosi1","Recmntosi","Recmntosi2","Desmntosi1","Desmntosi","Sitfisccli","Desmntosi2","Fcompfis","Origonline","Anulado","Monsis","Fobs","Fcuit","Md1","Md2","Fptoven","Fcliente","Fmtdes1","Fmtdes2","Codigo","Fnumcomp","Fmtdes3","Fven","Totdescsi","Tdci","Moneda","Codlista","Ffch","Trci","Totrecarsi","Fpago","Motivo","Ftotal","Cotiz","Ftransp","Direntr","Fpodes","Recmnto2","Entregapos","Fdescu","Merconsign","Deuda","Md3","Percepcion","Recmnto","Recpor","Mr","Mr1","Mr2","Recmnto1","Gravamen","Fimpuesto","Totrecar","Totdesc","Totimpue","Ivasis" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtocai ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'" >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevFpodes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCbautoimp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<lxComprobantevTotalcant >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevFsubton >>, <<lxComprobantevFsubtot >>, <<lxComprobantevFacttipo >>, <<lxComprobantevTimestamp >>, <<lxComprobantevCai >>, <<lxComprobantevSignomov >>, <<lxComprobantevFajxre >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevDesmntosi2 >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevOrigonline, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevMd1 >>, <<lxComprobantevMd2 >>, <<lxComprobantevFptoven >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFmtdes3 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<lxComprobantevTotdescsi >>, <<lxComprobantevTdci >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevTrci >>, <<lxComprobantevTotrecarsi >>, <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotivo ) + "'" >>, <<lxComprobantevFtotal >>, <<lxComprobantevCotiz >>, <<"'" + this.FormatearTextoSql( lxComprobantevFtransp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'" >>, <<lxComprobantevFpodes >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevEntregapos >>, <<lxComprobantevFdescu >>, <<iif( lxComprobantevMerconsign, 1, 0 ) >>, <<lxComprobantevDeuda >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecpor >>, <<lxComprobantevMr >>, <<lxComprobantevMr1 >>, <<lxComprobantevMr2 >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<lxComprobantevIvasis >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Vtocai" = <<"'" + this.ConvertirDateSql( lxComprobantevVtocai ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Datosecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'">>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Despachos" = <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Cbautoimp" = <<"'" + this.FormatearTextoSql( lxComprobantevCbautoimp ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Totalcant" = <<lxComprobantevTotalcant>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Fsubton" = <<lxComprobantevFsubton>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Timestamp" = <<lxComprobantevTimestamp>>,"Cai" = <<lxComprobantevCai>>,"Signomov" = <<lxComprobantevSignomov>>,"Fajxre" = <<lxComprobantevFajxre>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Origonline" = <<iif( lxComprobantevOrigonline, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Md2" = <<lxComprobantevMd2>>,"Fptoven" = <<lxComprobantevFptoven>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Tdci" = <<lxComprobantevTdci>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Trci" = <<lxComprobantevTrci>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Fpago" = <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'">>,"Motivo" = <<"'" + this.FormatearTextoSql( lxComprobantevMotivo ) + "'">>,"Ftotal" = <<lxComprobantevFtotal>>,"Cotiz" = <<lxComprobantevCotiz>>,"Ftransp" = <<"'" + this.FormatearTextoSql( lxComprobantevFtransp ) + "'">>,"Direntr" = <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'">>,"Fpodes" = <<lxComprobantevFpodes>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Entregapos" = <<lxComprobantevEntregapos>>,"Fdescu" = <<lxComprobantevFdescu>>,"Merconsign" = <<iif( lxComprobantevMerconsign, 1, 0 )>>,"Deuda" = <<lxComprobantevDeuda>>,"Md3" = <<lxComprobantevMd3>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Recpor" = <<lxComprobantevRecpor>>,"Mr" = <<lxComprobantevMr>>,"Mr1" = <<lxComprobantevMr1>>,"Mr2" = <<lxComprobantevMr2>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Totrecar" = <<lxComprobantevTotrecar>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Ivasis" = <<lxComprobantevIvasis>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function HayDatos() as boolean
		local llhaydatos as boolean, lcXml as String
			 lcXml = this.oConexion.EjecutarSql( "select Top 1 CODIGO from ZooLogic.COMPROBANTEV where " + this.ConvertirFuncionesSql( " COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11" ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Base" as "Basedecalculo", "Codimp" as "Codigoimpuesto", "Codint" as "Codigointerno", "Tipoi" as "Tipoimpuesto", "Sirecs" as "Codseguridadsire", "Descri" as "Descripcion", "Regimenimp" as "Regimenimpositivo", "Sirecert" as "Certificadosire", "Minimoper" as "Minimo", "Minoimp" as "Minimonoimponible", "Montobase" as "Montobase", "Nroitem" as "Nroitem", "Porcen" as "Porcentaje", "Monto" as "Monto", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_REMITO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Vtocai" as "Fechavtocai", "Fectrans" as "Fechatransferencia", "Datosecomm" as "Dataecom", "Fpodes2" as "Porcentajedescuento2", "Fpodes1" as "Porcentajedescuento1", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Faltafw" as "Fechaaltafw", "Despachos" as "Despachos", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Cbautoimp" as "Codigobarraautoimpresor", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Simbmon" as "Simbolomonetariocomprobante", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Descfw" as "Descripcionfw", "Saltafw" as "Seriealtafw", "Fhora" as "Hora", "Opecomm" as "Nroopecommerce", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Cai" as "Cai", "Signomov" as "Signodemovimiento", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Sitfisccli" as "Situacionfiscal", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Ffch" as "Fecha", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftotal" as "Total", "Cotiz" as "Cotizacion", "Ftransp" as "Transportista", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Entregapos" as "Entregaposterior", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr1" as "Recargomonto1", "Mr2" as "Recargomonto2", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 And FACTTIPO = <<lxComprobanteVFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxComprobanteVFLETRA ) + "'">> and FPTOVEN = <<lxComprobanteVFPTOVEN>> and FNUMCOMP = <<lxComprobanteVFNUMCOMP>> and FACTSEC = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFACTSEC ) + "'">>
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			if reccount( 'c_REMITO' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	function VerificarExistenciaClavePrimaria( txVal as Variant ) as Boolean
		...
		lxComprobantevCodigo = txVal
			...
			text to lcSentencia textmerge noshow
				select count( * ) as CantidadDeRegistros from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Vtocai" as "Fechavtocai", "Fectrans" as "Fechatransferencia", "Datosecomm" as "Dataecom", "Fpodes2" as "Porcentajedescuento2", "Fpodes1" as "Porcentajedescuento1", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Faltafw" as "Fechaaltafw", "Despachos" as "Despachos", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Cbautoimp" as "Codigobarraautoimpresor", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Simbmon" as "Simbolomonetariocomprobante", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Descfw" as "Descripcionfw", "Saltafw" as "Seriealtafw", "Fhora" as "Hora", "Opecomm" as "Nroopecommerce", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Cai" as "Cai", "Signomov" as "Signodemovimiento", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Sitfisccli" as "Situacionfiscal", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Ffch" as "Fecha", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftotal" as "Total", "Cotiz" as "Cotizacion", "Ftransp" as "Transportista", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Entregapos" as "Entregaposterior", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr1" as "Recargomonto1", "Mr2" as "Recargomonto2", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 order by FAltaFW,HAltaFW,FNUMCOMP,CODIGO
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Vtocai" as "Fechavtocai", "Fectrans" as "Fechatransferencia", "Datosecomm" as "Dataecom", "Fpodes2" as "Porcentajedescuento2", "Fpodes1" as "Porcentajedescuento1", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Faltafw" as "Fechaaltafw", "Despachos" as "Despachos", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Cbautoimp" as "Codigobarraautoimpresor", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Simbmon" as "Simbolomonetariocomprobante", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Descfw" as "Descripcionfw", "Saltafw" as "Seriealtafw", "Fhora" as "Hora", "Opecomm" as "Nroopecommerce", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Cai" as "Cai", "Signomov" as "Signodemovimiento", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Sitfisccli" as "Situacionfiscal", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Ffch" as "Fecha", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftotal" as "Total", "Cotiz" as "Cotizacion", "Ftransp" as "Transportista", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Entregapos" as "Entregaposterior", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr1" as "Recargomonto1", "Mr2" as "Recargomonto2", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  funciones.dtos( FAltaFW ) + funciones.padr( HAltaFW, 8, ' ' ) + str( FNUMCOMP, 8, 0) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 order by FAltaFW,HAltaFW,FNUMCOMP,CODIGO
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fd2,Fecimpo,Fecexpo,Fmodifw,Vtocai,Fectrans,Datosecomm,Fpodes2,Fpodes1,Fletra,Fperson,Fturno" + ;
",Haltafw,Valtafw,Zadsfw,Vmodifw,Smodifw,Faltafw,Despachos,Ualtafw,Umodifw,Bdmodifw,Cbautoimp,Horaimp" + ;
"o,Esttrans,Simbmon,Horaexpo,Hmodifw,Bdaltafw,Descfw,Saltafw,Fhora,Opecomm,Totalcant,Factsec,Subtotsi" + ;
"si,Condivalp,Subtotcisi,Fsubton,Fsubtot,Facttipo,Timestamp,Cai,Signomov,Fajxre,Mdcimpu,Desmntosi3,Re" + ;
"cmntosi1,Recmntosi,Recmntosi2,Desmntosi1,Desmntosi,Sitfisccli,Desmntosi2,Fcompfis,Origonline,Anulado" + ;
",Monsis,Fobs,Fcuit,Md1,Md2,Fptoven,Fcliente,Fmtdes1,Fmtdes2,Codigo,Fnumcomp,Fmtdes3,Fven,Totdescsi,T" + ;
"dci,Moneda,Codlista,Ffch,Trci,Totrecarsi,Fpago,Motivo,Ftotal,Cotiz,Ftransp,Direntr,Fpodes,Recmnto2,E" + ;
"ntregapos,Fdescu,Merconsign,Deuda,Md3,Percepcion,Recmnto,Recpor,Mr,Mr1,Mr2,Recmnto1,Gravamen,Fimpues" + ;
"to,Totrecar,Totdesc,Totimpue,Ivasis" + ;
" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosEntidad( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		lcWhere = " Where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11"
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			lcFiltro = ["Codigo" = ] + lcValorClavePrimariaString  + [ and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11]
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerSentenciaActualizacionTimeStamp() As String
		...
		with this.oEntidad
			...
			lcRetorno = [update ZooLogic.COMPROBANTEV set TimeStamp = ] + transform( lnTimeStamp ) + lcUpdateRealTime + [ where CODIGO = ] + "'" + this.FormatearTextoSql( .Codigo ) + "'" + [ and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11] + goServicios.RealTime.ObtenerTagEstimulo( .cNombre )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerCantidadRegistros() as integer
		local lnCantReg as integer
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select count( * ) as Total from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerTimestampActual() as integer
		...
		lcCursor = sys(2015)
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select TimeStamp from ZooLogic.COMPROBANTEV where CODIGO = " + "'" + this.FormatearTextoSql( this.oEntidad.CODIGO ) + "'"+ " and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11" )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirCabecera( tlLoguear as Boolean ) As Void
		...
		lxValorClavePK = ''
		lcMensajeExtra = ''
		lcCursor = This.oEntidad.cPrefijoRecibir + 'REMITO'
		select( lcCursor )
		scan all
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, VtoCAI = ] + "'" + this.ConvertirDateSql( &lcCursor..VtoCAI ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, DatosEComm = ] + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'"+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, fTurno = ] + transform( &lcCursor..fTurno )+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, Despachos = ] + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, CBAutoImp = ] + "'" + this.FormatearTextoSql( &lcCursor..CBAutoImp ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, CAI = ] + transform( &lcCursor..CAI )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, OrigOnline = ] + Transform( iif( &lcCursor..OrigOnline, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, FPago = ] + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'"+ [, MOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, FTransp = ] + "'" + this.FormatearTextoSql( &lcCursor..FTransp ) + "'"+ [, DirEntr = ] + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'"+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, EntregaPos = ] + transform( &lcCursor..EntregaPos )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MerConsign = ] + Transform( iif( &lcCursor..MerConsign, 1, 0 ))+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, MR = ] + transform( &lcCursor..MR )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, IvaSis = ] + transform( &lcCursor..IvaSis ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FD2, FECIMPO, FECEXPO, FMODIFW, VtoCAI, FECTRANS, DatosEComm, FPODES2, FPODES1, FLETRA, FPerson, fTurno, HAltaFW, VALTAFW, ZADSFW, VMODIFW, SMODIFW, FAltaFW, Despachos, UALTAFW, UMODIFW, BDMODIFW, CBAutoImp, HORAIMPO, ESTTRANS, SimbMon, HORAEXPO, HMODIFW, BDALTAFW, DescFW, SALTAFW, FHORA, OPEcomm, TotalCant, FACTSEC, SubTotSISI, CondivaLp, SubTotCISI, fSubToN, FSubTOT, FACTTIPO, TIMESTAMP, CAI, signomov, FAjXRe, MDCIMPU, DesMntoSI3, RecMntoSI1, RecMntoSI, RecMntoSI2, DesMntoSI1, DesMntoSI, SitFiscCli, DesMntoSI2, FCOMPFIS, OrigOnline, Anulado, MonSis, FObs, fCuit, MD1, MD2, FPTOVEN, FCLIENTE, FMTDES1, FMTDES2, CODIGO, FNUMCOMP, FMTDES3, FVEN, totdescSI, TDCI, Moneda, CodLista, FFCH, TRCI, totrecarSI, FPago, MOTIVO, FTotal, Cotiz, FTransp, DirEntr, FPODES, RecMnto2, EntregaPos, fDescu, MerConsign, Deuda, MD3, percepcion, RecMnto, RecPor, MR, MR1, MR2, RecMnto1, gravamen, fImpuesto, totrecar, totdesc, totimpue, IvaSis
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..VtoCAI ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..FPODES1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..fTurno ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBAutoImp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + transform( &lcCursor..TotalCant ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..SubTotSISI )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..CAI ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..MDCIMPU )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..OrigOnline, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..FPTOVEN ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..FMTDES3 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + transform( &lcCursor..totdescSI ) + ',' + transform( &lcCursor..TDCI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'" + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..Cotiz )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FTransp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'" + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..EntregaPos ) + ',' + transform( &lcCursor..fDescu ) + ',' + Transform( iif( &lcCursor..MerConsign, 1, 0 )) + ',' + transform( &lcCursor..Deuda ) + ',' + transform( &lcCursor..MD3 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..RecPor ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..totdesc )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..totimpue ) + ',' + transform( &lcCursor..IvaSis )
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirComponentes() As Void
		this.oEntidad.FacturaDetalle.oItem.oCompPrecios.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS',this.oEntidad.cPrefijoRecibir + 'REMITO')
		this.oEntidad.KitsDetalle.oItem.oCompPrecios.Recibir( this.oEntidad, 'KitsDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMKITS',this.oEntidad.cPrefijoRecibir + 'REMITO')
		this.oEntidad.KitsDetalle.oItem.oCompStock.Recibir( this.oEntidad, 'KitsDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMKITS',this.oEntidad.cPrefijoRecibir + 'REMITO')
		this.oEntidad.FacturaDetalle.oItem.oCompStock.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS',this.oEntidad.cPrefijoRecibir + 'REMITO')
		this.oEntidad.FacturaDetalle.oItem.oCompGiftcard.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS',this.oEntidad.cPrefijoRecibir + 'REMITO')
		this.oEntidad.oCompEnBaseA.Recibir( this.oEntidad, 'FacturaDetalle', this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS', this.oEntidad.cPrefijoRecibir + 'REMITO')
	...
	*--------------------------------------------------------------------------------------------------------
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			Case  lcAlias == lcPrefijo + 'REMITO'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'REMITO_DATOSECOMM'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'REMITO_ZADSFW'
				llRetorno = .T.
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		lcCursor = This.oEntidad.cPrefijoImportar + 'REMITO'
		select( lcCursor )
		llRetorno = .T.
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad REMITO. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FD2 = isnull( d.FD2, t.FD2 ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.VTOCAI = isnull( d.VTOCAI, t.VTOCAI ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.DATOSECOMM = isnull( d.DATOSECOMM, t.DATOSECOMM ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.DESPACHOS = isnull( d.DESPACHOS, t.DESPACHOS ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CBAUTOIMP = isnull( d.CBAUTOIMP, t.CBAUTOIMP ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CAI = isnull( d.CAI, t.CAI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.ORIGONLINE = isnull( d.ORIGONLINE, t.ORIGONLINE ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.MD1 = isnull( d.MD1, t.MD1 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.FPAGO = isnull( d.FPAGO, t.FPAGO ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FTRANSP = isnull( d.FTRANSP, t.FTRANSP ),t.DIRENTR = isnull( d.DIRENTR, t.DIRENTR ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MERCONSIGN = isnull( d.MERCONSIGN, t.MERCONSIGN ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.MR = isnull( d.MR, t.MR ),t.MR1 = isnull( d.MR1, t.MR1 ),t.MR2 = isnull( d.MR2, t.MR2 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.IVASIS = isnull( d.IVASIS, t.IVASIS )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fd2,Fecimpo,Fecexpo,Fmodifw,Vtocai,Fectrans,Datosecomm,Fpodes2,Fpodes1,Fletra,Fperson,Fturno,Haltafw,Valtafw,Zadsfw,Vmodifw,Smodifw,Faltafw,Despachos,Ualtafw,Umodifw,Bdmodifw,Cbautoimp,Horaimpo,Esttrans,Simbmon,Horaexpo,Hmodifw,Bdaltafw,Descfw,Saltafw,Fhora,Opecomm,Totalcant,Factsec,Subtotsisi,Condivalp,Subtotcisi,Fsubton,Fsubtot,Facttipo,Timestamp,Cai,Signomov,Fajxre,Mdcimpu,Desmntosi3,Recmntosi1,Recmntosi,Recmntosi2,Desmntosi1,Desmntosi,Sitfisccli,Desmntosi2,Fcompfis,Origonline,Anulado,Monsis,Fobs,Fcuit,Md1,Md2,Fptoven,Fcliente,Fmtdes1,Fmtdes2,Codigo,Fnumcomp,Fmtdes3,Fven,Totdescsi,Tdci,Moneda,Codlista,Ffch,Trci,Totrecarsi,Fpago,Motivo,Ftotal,Cotiz,Ftransp,Direntr,Fpodes,Recmnto2,Entregapos,Fdescu,Merconsign,Deuda,Md3,Percepcion,Recmnto,Recpor,Mr,Mr1,Mr2,Recmnto1,Gravamen,Fimpuesto,Totrecar,Totdesc,Totimpue,Ivasis)
					Select isnull( d.FD2,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.VTOCAI,''),isnull( d.FECTRANS,''),isnull( d.DATOSECOMM,''),isnull( d.FPODES2,0),isnull( d.FPODES1,0),isnull( d.FLETRA,''),isnull( d.FPERSON,''),isnull( d.FTURNO,0),convert( char(8), getdate(), 108 ),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.SMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.DESPACHOS,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.CBAUTOIMP,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.SIMBMON,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.DESCFW,''),isnull( d.SALTAFW,''),isnull( d.FHORA,''),isnull( d.OPECOMM,''),isnull( d.TOTALCANT,0),isnull( d.FACTSEC,''),isnull( d.SUBTOTSISI,0),isnull( d.CONDIVALP,0),isnull( d.SUBTOTCISI,0),isnull( d.FSUBTON,0),isnull( d.FSUBTOT,0),isnull( d.FACTTIPO,0),isnull( d.TIMESTAMP,0),isnull( d.CAI,0),isnull( d.SIGNOMOV,0),isnull( d.FAJXRE,0),isnull( d.MDCIMPU,0),isnull( d.DESMNTOSI3,0),isnull( d.RECMNTOSI1,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTOSI2,0),isnull( d.DESMNTOSI1,0),isnull( d.DESMNTOSI,0),isnull( d.SITFISCCLI,0),isnull( d.DESMNTOSI2,0),isnull( d.FCOMPFIS,0),isnull( d.ORIGONLINE,0),isnull( d.ANULADO,0),isnull( d.MONSIS,''),isnull( d.FOBS,''),isnull( d.FCUIT,''),isnull( d.MD1,0),isnull( d.MD2,0),isnull( d.FPTOVEN,0),isnull( d.FCLIENTE,''),isnull( d.FMTDES1,0),isnull( d.FMTDES2,0),isnull( d.CODIGO,''),isnull( d.FNUMCOMP,0),isnull( d.FMTDES3,0),isnull( d.FVEN,''),isnull( d.TOTDESCSI,0),isnull( d.TDCI,0),isnull( d.MONEDA,''),isnull( d.CODLISTA,''),isnull( d.FFCH,''),isnull( d.TRCI,0),isnull( d.TOTRECARSI,0),isnull( d.FPAGO,''),isnull( d.MOTIVO,''),isnull( d.FTOTAL,0),isnull( d.COTIZ,0),isnull( d.FTRANSP,''),isnull( d.DIRENTR,''),isnull( d.FPODES,0),isnull( d.RECMNTO2,0),isnull( d.ENTREGAPOS,0),isnull( d.FDESCU,0),isnull( d.MERCONSIGN,0),isnull( d.DEUDA,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.RECMNTO,0),isnull( d.RECPOR,0),isnull( d.MR,0),isnull( d.MR1,0),isnull( d.MR2,0),isnull( d.RECMNTO1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECAR,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.IVASIS,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_REMITO' ) < 1
				...
				Try
					...
					.Fechamodificacion = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fechamodificacion, ctod( '  /  /    ' ) ) )
					.Fechaimpo = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fechaimpo, ctod( '  /  /    ' ) ) )
					.Fechaexpo = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fechaexpo, ctod( '  /  /    ' ) ) )
					.Fechamodificacionfw = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fechamodificacionfw, ctod( '  /  /    ' ) ) )
					.Fechavtocai = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fechavtocai, ctod( '  /  /    ' ) ) )
					.Fechatransferencia = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fechatransferencia, ctod( '  /  /    ' ) ) )
					lcValor = This.ObtenerMemo( 'c_Dataecom')
					.Dataecom = lcValor 
					.Porcentajedescuento2 = nvl( c_REMITO.Porcentajedescuento2, 0 )
					.Porcentajedescuento1 = nvl( c_REMITO.Porcentajedescuento1, 0 )
					.Letra = nvl( c_REMITO.Letra, [] )
					.Cliente_PK =  nvl( c_REMITO.Cliente, [] )
					.Turno = nvl( c_REMITO.Turno, 0 )
					...
					.Compafec.Cargar()
					.Horaaltafw = nvl( c_REMITO.Horaaltafw, [] )
					.Versionaltafw = nvl( c_REMITO.Versionaltafw, [] )
					lcValor = This.ObtenerMemo( 'c_Zadsfw')
					.Zadsfw = lcValor 
					.Versionmodificacionfw = nvl( c_REMITO.Versionmodificacionfw, [] )
					.Seriemodificacionfw = nvl( c_REMITO.Seriemodificacionfw, [] )
					.Fechaaltafw = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fechaaltafw, ctod( '  /  /    ' ) ) )
					.Despachos = nvl( c_REMITO.Despachos, [] )
					.Usuarioaltafw = nvl( c_REMITO.Usuarioaltafw, [] )
					.Usuariomodificacionfw = nvl( c_REMITO.Usuariomodificacionfw, [] )
					.Basededatosmodificacionfw = nvl( c_REMITO.Basededatosmodificacionfw, [] )
					.Codigobarraautoimpresor = nvl( c_REMITO.Codigobarraautoimpresor, [] )
					.Horaimpo = nvl( c_REMITO.Horaimpo, [] )
					.Estadotransferencia = nvl( c_REMITO.Estadotransferencia, [] )
					.Simbolomonetariocomprobante = nvl( c_REMITO.Simbolomonetariocomprobante, [] )
					.Horaexpo = nvl( c_REMITO.Horaexpo, [] )
					.Horamodificacionfw = nvl( c_REMITO.Horamodificacionfw, [] )
					.Basededatosaltafw = nvl( c_REMITO.Basededatosaltafw, [] )
					.Descripcionfw = nvl( c_REMITO.Descripcionfw, [] )
					.Seriealtafw = nvl( c_REMITO.Seriealtafw, [] )
					.Hora = nvl( c_REMITO.Hora, [] )
					.Nroopecommerce = nvl( c_REMITO.Nroopecommerce, [] )
					.Totalcantidad = nvl( c_REMITO.Totalcantidad, 0 )
					.Secuencia = nvl( c_REMITO.Secuencia, [] )
					.Subtotalsinimpuestossobreitems = nvl( c_REMITO.Subtotalsinimpuestossobreitems, 0 )
					.Condicioniva = nvl( c_REMITO.Condicioniva, 0 )
					.Subtotalconimpuestossobreitems = nvl( c_REMITO.Subtotalconimpuestossobreitems, 0 )
					.Subtotalneto = nvl( c_REMITO.Subtotalneto, 0 )
					.Subtotalbruto = nvl( c_REMITO.Subtotalbruto, 0 )
					.Tipocomprobante = nvl( c_REMITO.Tipocomprobante, 0 )
					.Timestamp = nvl( c_REMITO.Timestamp, 0 )
					.Cai = nvl( c_REMITO.Cai, 0 )
					.Signodemovimiento = nvl( c_REMITO.Signodemovimiento, 0 )
					.Ajustesporredondeos = nvl( c_REMITO.Ajustesporredondeos, 0 )
					.Montodescuentoconimpuestos = nvl( c_REMITO.Montodescuentoconimpuestos, 0 )
					.Montodescuentosinimpuestos3 = nvl( c_REMITO.Montodescuentosinimpuestos3, 0 )
					.Recargomontosinimpuestos1 = nvl( c_REMITO.Recargomontosinimpuestos1, 0 )
					.Recargomontosinimpuestos = nvl( c_REMITO.Recargomontosinimpuestos, 0 )
					.Recargomontosinimpuestos2 = nvl( c_REMITO.Recargomontosinimpuestos2, 0 )
					.Montodescuentosinimpuestos1 = nvl( c_REMITO.Montodescuentosinimpuestos1, 0 )
					.Montodescuentosinimpuestos = nvl( c_REMITO.Montodescuentosinimpuestos, 0 )
					.Situacionfiscal_PK =  nvl( c_REMITO.Situacionfiscal, 0 )
					.Montodescuentosinimpuestos2 = nvl( c_REMITO.Montodescuentosinimpuestos2, 0 )
					.Comprobantefiscal = nvl( c_REMITO.Comprobantefiscal, .F. )
					.Basadoencomprobanteonline = nvl( c_REMITO.Basadoencomprobanteonline, .F. )
					.Anulado = nvl( c_REMITO.Anulado, .F. )
					.Impuestoscomprobante.Limpiar()
					.Impuestoscomprobante.SetearEsNavegacion( .lProcesando )
					.Impuestoscomprobante.Cargar()
					.Monedasistema_PK =  nvl( c_REMITO.Monedasistema, [] )
					.Obs = nvl( c_REMITO.Obs, [] )
					.Cuit = nvl( c_REMITO.Cuit, [] )
					.Montodescuento1 = nvl( c_REMITO.Montodescuento1, 0 )
					.Montodescuento2 = nvl( c_REMITO.Montodescuento2, 0 )
					.Puntodeventa = nvl( c_REMITO.Puntodeventa, 0 )
					.Clientedescripcion = nvl( c_REMITO.Clientedescripcion, [] )
					.Montodescuentoconimpuestos1 = nvl( c_REMITO.Montodescuentoconimpuestos1, 0 )
					.Montodescuentoconimpuestos2 = nvl( c_REMITO.Montodescuentoconimpuestos2, 0 )
					.Codigo = nvl( c_REMITO.Codigo, [] )
					.Numero = nvl( c_REMITO.Numero, 0 )
					.Montodescuentoconimpuestos3 = nvl( c_REMITO.Montodescuentoconimpuestos3, 0 )
					.Vendedor_PK =  nvl( c_REMITO.Vendedor, [] )
					.Totaldescuentossinimpuestos = nvl( c_REMITO.Totaldescuentossinimpuestos, 0 )
					.Totaldescuentosconimpuestos = nvl( c_REMITO.Totaldescuentosconimpuestos, 0 )
					.Monedacomprobante_PK =  nvl( c_REMITO.Monedacomprobante, [] )
					.Listadeprecios_PK =  nvl( c_REMITO.Listadeprecios, [] )
					.Kitsdetalle.Limpiar()
					.Kitsdetalle.SetearEsNavegacion( .lProcesando )
					.Kitsdetalle.Cargar()
					.Fecha = GoLibrerias.ObtenerFechaFormateada( nvl( c_REMITO.Fecha, ctod( '  /  /    ' ) ) )
					.Totalrecargosconimpuestos = nvl( c_REMITO.Totalrecargosconimpuestos, 0 )
					.Totalrecargossinimpuestos = nvl( c_REMITO.Totalrecargossinimpuestos, 0 )
					.Forpago_PK =  nvl( c_REMITO.Forpago, [] )
					.Motivo_PK =  nvl( c_REMITO.Motivo, [] )
					.Total = nvl( c_REMITO.Total, 0 )
					.Cotizacion = nvl( c_REMITO.Cotizacion, 0 )
					.Transportista_PK =  nvl( c_REMITO.Transportista, [] )
					.Direccionentrega = nvl( c_REMITO.Direccionentrega, [] )
					.Porcentajedescuento = nvl( c_REMITO.Porcentajedescuento, 0 )
					.Recargomontoconimpuestos2 = nvl( c_REMITO.Recargomontoconimpuestos2, 0 )
					.Entregaposterior = nvl( c_REMITO.Entregaposterior, 0 )
					.Descuento = nvl( c_REMITO.Descuento, 0 )
					.Mercaderiaconsignacion = nvl( c_REMITO.Mercaderiaconsignacion, .F. )
					.Deuda = nvl( c_REMITO.Deuda, 0 )
					.Montodescuento3 = nvl( c_REMITO.Montodescuento3, 0 )
					.Percepciones = nvl( c_REMITO.Percepciones, 0 )
					.Recargomontoconimpuestos = nvl( c_REMITO.Recargomontoconimpuestos, 0 )
					.Recargoporcentaje = nvl( c_REMITO.Recargoporcentaje, 0 )
					.Recargomonto = nvl( c_REMITO.Recargomonto, 0 )
					.Recargomonto1 = nvl( c_REMITO.Recargomonto1, 0 )
					.Recargomonto2 = nvl( c_REMITO.Recargomonto2, 0 )
					.Recargomontoconimpuestos1 = nvl( c_REMITO.Recargomontoconimpuestos1, 0 )
					.Gravamenes = nvl( c_REMITO.Gravamenes, 0 )
					.Impuestos = nvl( c_REMITO.Impuestos, 0 )
					.Totalrecargos = nvl( c_REMITO.Totalrecargos, 0 )
					.Totaldescuentos = nvl( c_REMITO.Totaldescuentos, 0 )
					.Totalimpuestos = nvl( c_REMITO.Totalimpuestos, 0 )
					.Ivadelsistema = nvl( c_REMITO.Ivadelsistema, 0 )
				Catch To loError
					goServicios.Errores.LevantarExcepcion( loError )
				Finally
					.lCargando = .f.
				...
				SELECT nro,totalRegistros,CODIGO as Id
				    ...
				    CODIGO from (
							select * 
								...
								Where   COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11
									and <<tcFiltro>>
							 ) a
					 ) b
...
define class ObjetoBusqueda as custom
	Tabla = 'COMPROBANTEV'
	Filtro = " COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11"
	oEntidad = null
	cEstructura = ''
	cEstructuraDetalle = ''
	cEstructuraSinDetalle = ''
	listadecampos = ''
	Indice = " COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11"
	AnchoCampo = 13
	Caracteres = 13
	nrodecolumnas = 0
	signopregunta = .T.
...
<VFPData xml:space="preserve">
	...
	<row entidad="REMITO                                  " atributo="FECHAVTOCAI                             " tabla="COMPROBANTEV   " campo="VTOCAI    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="PORCENTAJEDESCUENTO2                    " tabla="COMPROBANTEV   " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje de descuento 2                                                                                                                                                                                                                                 " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="DESPACHOS                               " tabla="COMPROBANTEV   " campo="DESPACHOS " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Despachos                                                                                                                                                                                                                                                 " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="CODIGOBARRAAUTOIMPRESOR                 " tabla="COMPROBANTEV   " campo="CBAUTOIMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="TOTALCANTIDAD                           " tabla="COMPROBANTEV   " campo="TOTALCANT " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="16" etiqueta="Total Cantidad                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="TIPOCOMPROBANTE                         " tabla="COMPROBANTEV   " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=11                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="14" etiqueta="Tipo de comprobante                                                                                                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="CAI                                     " tabla="COMPROBANTEV   " campo="CAI       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="14" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="410" etiqueta="Moneda                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="FECHA                                   " tabla="COMPROBANTEV   " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="10" etiqueta="Fecha                                                                                                                                                                                                                                                     " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="FORPAGO                                 " tabla="COMPROBANTEV   " campo="FPAGO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CONDICIONDEPAGO                         " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Condición de pago                                                                                                                                                                                                                                         " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="MOTIVO                                  " tabla="COMPROBANTEV   " campo="MOTIVO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MOTIVO                                  " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Motivo                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="COTIZACION                              " tabla="COMPROBANTEV   " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="420" etiqueta="Cotización                                                                                                                                                                                                                                                " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="TRANSPORTISTA                           " tabla="COMPROBANTEV   " campo="FTRANSP   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Transportista                                                                                                                                                                                                                                             " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="DIRECCIONENTREGA                        " tabla="COMPROBANTEV   " campo="DIRENTR   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="Dirección de entrega                                                                                                                                                                                                                                      " dominio="COMBODIRECCIONESENTREGA       " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="ENTREGAPOSTERIORVIRTUAL                 " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="428" etiqueta="Tipo de entrega                                                                                                                                                                                                                                           " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="15" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="DEUDA                                   " tabla="COMPROBANTEV   " campo="DEUDA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Saldo de cta.cte.                                                                                                                                                                                                                                         " dominio="FECHASALDO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="25" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="MONTODESCUENTO3                         " tabla="COMPROBANTEV   " campo="MD3       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="Monto de descuento                                                                                                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="RECARGOMONTO                            " tabla="COMPROBANTEV   " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="436" etiqueta="Recargo % monto                                                                                                                                                                                                                                           " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="42" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="RECARGOMONTO2                           " tabla="COMPROBANTEV   " campo="MR2       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="438" etiqueta="Recargo monto                                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="45" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONDICIONDEPAGO                         " atributo="DESCRIPCION                             " tabla="CONDPAGO       " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="417" etiqueta="Detalle Con.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CONDPAGO On COMPROBANTEV.FPAGO = CONDPAGO.CLCOD And  CONDPAGO.CLCOD != ''                                                                                                                                                                          " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="MOTIVO                                  " atributo="DESCRIPCION                             " tabla="MOTIVO         " campo="MOTDES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="419" etiqueta="Detalle Mot.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join MOTIVO On COMPROBANTEV.MOTIVO = MOTIVO.MOTCOD And  MOTIVO.MOTCOD != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="NOMBRE                                  " tabla="TRA            " campo="TRNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="423" etiqueta="Detalle Tra.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join TRA On COMPROBANTEV.FTRANSP = TRA.TRCOD And  TRA.TRCOD != ''                                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
