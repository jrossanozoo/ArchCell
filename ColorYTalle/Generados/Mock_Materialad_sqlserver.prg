...
define class Mock_Materialad_sqlserver as MockBase of MockBase.prg

	cClase = 'Materialad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupub003( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupub003', lcParametros )
	EndFunc
