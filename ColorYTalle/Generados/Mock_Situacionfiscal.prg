...
define class Mock_situacionfiscal as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function esresponsableexento() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Esresponsableexento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esresponsableinscripto() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Esresponsableinscripto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esresponsablemonotributo() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Esresponsablemonotributo', lcParametros )
	EndFunc
