...
define class Mock_minimoreposicion as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Modificación de mínimo y máximo de stock"                                                                                                                                                                                                
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleminrepo() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleminrepo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function minrepo_access() as variant                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MINIMOREPOSICION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'minrepo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'minrepo_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Minrepo ) = 'O' or isnull( this.Minrepo ) )			this.Minrepo = this.crearobjeto( 'DetalleMinimoreposicionMinrepo' )			this.Minrepo.inicializar()			this.Minrepo.lPermitirDetalleVacio = .F.			this.enlazar( 'Minrepo.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Minrepo.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Minrepo, 'CambioSumarizado', this, 'CambiosDetalleMinrepo', 1)			this.enlazar( 'Minrepo.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Minrepo.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Minrepo.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Minrepo
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwvigencia() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwvigencia', lcParametros )
	EndFunc
