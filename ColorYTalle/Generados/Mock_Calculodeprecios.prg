...
define class Mock_calculodeprecios as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function actualizarprecios() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Actualizarprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallemodprecios() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cambiosdetallemodprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarsentenciasdeeliminacionporentidad() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ejecutarsentenciasdeeliminacionporentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esaccionformula( toitem as object ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Esaccionformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocapturarmemoria() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Eventocapturarmemoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocomienzocalculodeprecios() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Eventocomienzocalculodeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocomienzoserializar_e_importar() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Eventocomienzoserializar_e_importar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoconfirmarsinlistas() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Eventoconfirmarsinlistas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventofinserializar_e_importar() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Eventofinserializar_e_importar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoguardarmemoria() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Eventoguardarmemoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoimportandoetapaserializar_e_importar( tnetapa as integer, tntotal as integer ) as void                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Eventoimportandoetapaserializar_e_importar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechabase_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechabase_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechabase_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechabase		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechabase( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Fechabase( lxVal )			EndIf		Else			This.Setear_Fechabase( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaproceso_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaproceso_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaproceso_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaproceso		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaproceso( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Fechaproceso( lxVal )			EndIf		Else			This.Setear_Fechaproceso( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechavigencia_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechavigencia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechavigencia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechavigencia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechavigencia( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Fechavigencia( lxVal )			EndIf		Else			This.Setear_Fechavigencia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitarcontrolesfiltroscombinacion( tlhabilitar as boolean ) as void                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Habilitarcontrolesfiltroscombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function importarsintransaccion_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'importarsintransaccion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'importarsintransaccion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Importarsintransaccion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Importarsintransaccion( lxVal )				this.Setear_Importarsintransaccion( lxVal )			EndIf		Else			This.Setear_Importarsintransaccion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistadepreciosdelitem( tnitem as integer ) as string                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerlistadepreciosdelitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistadepreciosparaconsulta( tnitem as integer, tclistadeprecios as string ) as string                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerlistadepreciosparaconsulta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistascalculadas() as object                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerlistascalculadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstring( tcselect as string ) as string                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerstring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertimestampa() as integer                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenertimestampa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertodaslaslistasdeprecios() as object                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertodaslaslistasdeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function olistadeprecios_access() as object                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'olistadeprecios_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'olistadeprecios_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oListaDePrecios) # "O"			this.oListaDePrecios = _screen.Zoo.InstanciarEntidad( "ListaDePrecios" )		endif		return this.oListaDePrecios
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oredondeo_access() as object                                                                                                                                                                                                                     
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oredondeo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oredondeo_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oRedondeo ) # "O"			this.oRedondeo = _screen.Zoo.InstanciarEntidad( "RedondeoDePrecios" )		endif		return this.oRedondeo
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function quitarlistasrepetidas( lccursor as string ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Quitarlistasrepetidas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechabase( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechabase', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechabase', lcParametros )			endif		endif		this.Fechabase = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaproceso( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaproceso', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaproceso', lcParametros )			endif		endif		this.Fechaproceso = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechavigencia( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechavigencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechavigencia', lcParametros )			endif		endif		this.Fechavigencia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_importarsintransaccion( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_importarsintransaccion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_importarsintransaccion', lcParametros )			endif		endif		this.Importarsintransaccion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_preciokitpackxparticipante( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_preciokitpackxparticipante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_preciokitpackxparticipante', lcParametros )			endif		endif		this.Preciokitpackxparticipante = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearvaloresfiltroscombinacion() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearvaloresfiltroscombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function usacombinacion_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'usacombinacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'usacombinacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Usacombinacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Usacombinacion( lxVal )				this.Setear_Usacombinacion( lxVal )			EndIf		Else			This.Setear_Usacombinacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechabase( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechabase', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechabase', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaproceso( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaproceso', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaproceso', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechavigencia( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechavigencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechavigencia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_importarsintransaccion( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_importarsintransaccion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_importarsintransaccion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_preciokitpackxparticipante( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_preciokitpackxparticipante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_preciokitpackxparticipante', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_usacombinacion( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usacombinacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usacombinacion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciadecotizaciones() as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validarexistenciadecotizaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciadelistasdeprecios() as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validarexistenciadelistasdeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciaderedondeos() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarexistenciaderedondeos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechabase() as boolean                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarfechabase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechavigencia() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarfechavigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaritemsdetipodeaccionformula() as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validaritemsdetipodeaccionformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarporcentajes() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validarporcentajes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarpreciodirecto() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarpreciodirecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechabase() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofechabase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechavigencia() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridofechavigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechabase() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechabase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechavigencia() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechavigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwimportarsintransaccion() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridofwimportarsintransaccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwpreciokitpackxparticipante() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwpreciokitpackxparticipante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwusacombinacion() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridofwusacombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoimportarsintransaccion() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridoimportarsintransaccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopreciokitpackxparticipante() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridopreciokitpackxparticipante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousacombinacion() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridousacombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verconfirmacion() as boolean                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Verconfirmacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarlistasdeformulas( tclistadeprecios as string, toentformula as object ) as string                                                                                                                                                
		...
		return this.ObtenerResultado( 'Agregarlistasdeformulas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarmapeodefuncionpreciodelista( tomapeo as object, tcelementoaevaluar as string, toformula as object  ) as void                                                                                                                    
		...
		return this.ObtenerResultado( 'Agregarmapeodefuncionpreciodelista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarnuevocampoparaprecio( tccursorprecioarticulo as string, tcnuevocampo as string ) as void                                                                                                                                        
		...
		lnParametros = pcount()
		lxParam1 = tccursorprecioarticulo
		lxParam2 = tcnuevocampo
		...
		return this.ObtenerResultado( 'Agregarnuevocampoparaprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarpreciosdelistasincluidasenlaformula( tccursorprecioarticulo as string, toitem as object ) as void                                                                                                                               
		...
		return this.ObtenerResultado( 'Agregarpreciosdelistasincluidasenlaformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function aplicaractualizaciones( tccursor as string, tnitem as integer ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Aplicaractualizaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function aplicarredondeo( tccursor as string, tclistaprecio as string ) as void                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Aplicarredondeo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function bindeareventohacambiado() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Bindeareventohacambiado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function completarcampoparaprecio( tccursorprecioarticulo as string, tcnuevocampo as string, tclistadeprecios as string, toitem as object ) as void                                                                                             
		...
		return this.ObtenerResultado( 'Completarcampoparaprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function completarlistas() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Completarlistas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function consultartriggersrecursivosenbasededatos() as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Consultartriggersrecursivosenbasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminarcampostemporales( tccursor as string ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eliminarcampostemporales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existendependenciasparacalcularrecursivamente() as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Existendependenciasparacalcularrecursivamente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function importarpreciodearticulo( tcxml as string ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Importarpreciodearticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function modificafuncionprecioparastocksincombinacion( tcfuncionprecio as string ) as string                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Modificafuncionprecioparastocksincombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposdecombinacionconcatenados() as string                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercamposdecombinacionconcatenados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerconsultaprecios( tnitem as integer ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerconsultaprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursorpreciosdearticulo( tnitem as integer, tclistadeprecios as string ) as string                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercursorpreciosdearticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursorpreciosdearticulosegunparticipantes( tnitem as integer, tclistadeprecios as string ) as string                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercursorpreciosdearticulosegunparticipantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursorretorno( tcconsulta as string, tctablas as string, tcwherelp as string ) as string                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercursorretorno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursorstock( tccursorprecioarticulovacio as string ) as string                                                                                                                                                                  
		...
		lnParametros = pcount()
		lxParam1 = tccursorprecioarticulovacio
		...
		return this.ObtenerResultado( 'Obtenercursorstock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursorstockarticulo( tccursorprecioarticulovacio as string  ) as string                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenercursorstockarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursorstockarticulocombinacion( tccursorprecioarticulovacio as string  ) as string                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercursorstockarticulocombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdatosdeentidadesparanet() as object                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerdatosdeentidadesparanet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerformula( toitem as object ) as string                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerformuladefinidaporelusuario( toitem as object ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerformuladefinidaporelusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemdelista( tclista as string ) as object                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obteneritemdelista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermensajealoguearporerroralaplicarlaformula( tccursor as string, toerror as zooexception of zooexception.prg, tclistadeprecios as string ) as string                                                                              
		...
		return this.ObtenerResultado( 'Obtenermensajealoguearporerroralaplicarlaformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerselectcombparaunirconprecioar() as string                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerselectcombparaunirconprecioar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerselectkitsypacks( tcselect as string, tcfuncionprecio as string, tcatributoscombinacion as string, tclistadeprecios as string ) as string                                                                                       
		...
		lnParametros = pcount()
		lxParam1 = tcselect
		lxParam2 = tcfuncionprecio
		lxParam3 = tcatributoscombinacion
		lxParam4 = tclistadeprecios
		...
		return this.ObtenerResultado( 'Obtenerselectkitsypacks', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerselectkitsypacksparaformula( tclistadeprecios as string ) as string                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerselectkitsypacksparaformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerselectpiekitsypacks( tcconsulta as string, tccampo as string, tcatributoscombinacion as string ) as string                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerselectpiekitsypacks', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerselectprecio( tclistadeprecios as string, tclistas as string ) as string                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerselectprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function pasarlistasastring( tolistas ) as string                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Pasarlistasastring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarcambiodepreciosparalista( tclistadepreciospk as string ) as boolean                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Procesarcambiodepreciosparalista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarcambiodepreciosparalistasrelacionadas() as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Procesarcambiodepreciosparalistasrelacionadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesaritemdemodificaciondeprecios( tcatributo as string, toitem as object ) as void                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Procesaritemdemodificaciondeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarrespuesta( lorespuesta as object ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Procesarrespuesta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function serializar_e_importar( tccursor as string ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Serializar_e_importar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function unircursores( tnitem, tccursorprecioarticulo, tccursorstock ) as void                                                                                                                                                                  
		...
		lnParametros = pcount()
		lxParam1 = tnitem
		lxParam2 = tccursorprecioarticulo
		lxParam3 = tccursorstock
		...
		return this.ObtenerResultado( 'Unircursores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validaringresofiltroscombinacion() as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validaringresofiltroscombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validartriggersrecursivoshabilitados() as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validartriggersrecursivoshabilitados', lcParametros )
	EndFunc
