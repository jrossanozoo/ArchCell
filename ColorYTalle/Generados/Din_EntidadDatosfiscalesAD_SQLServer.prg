	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.DATOSFISCALES ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Horaexpo","Horaimpo","Haltafw","Hmodifw","Vmodifw","Saltafw","Umodifw","Valtafw","Ualtafw","Bdmodifw","Smodifw","Esttrans","Zadsfw","Bdaltafw","Tipagrupub","Timestamp","Bloqreg","Codigo","Obs","Nroiibbobl","Expoenop","Descripcio","Autojur","Afip366814","Dasiprib","Autoperr","Reintegro","Montomin","Jurisdsiem","Retsiprib","Separaiibb","Persiprib" ) values ( <<"'" + this.ConvertirDateSql( lxDatosfiscalesFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDatosfiscalesFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDatosfiscalesFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDatosfiscalesFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDatosfiscalesFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesBdaltafw ) + "'" >>, <<lxDatosfiscalesTipagrupub >>, <<lxDatosfiscalesTimestamp >>, <<iif( lxDatosfiscalesBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesObs ) + "'" >>, <<iif( lxDatosfiscalesNroiibbobl, 1, 0 ) >>, <<iif( lxDatosfiscalesExpoenop, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesDescripcio ) + "'" >>, <<iif( lxDatosfiscalesAutojur, 1, 0 ) >>, <<iif( lxDatosfiscalesAfip366814, 1, 0 ) >>, <<iif( lxDatosfiscalesDasiprib, 1, 0 ) >>, <<iif( lxDatosfiscalesAutoperr, 1, 0 ) >>, <<iif( lxDatosfiscalesReintegro, 1, 0 ) >>, <<lxDatosfiscalesMontomin >>, <<"'" + this.FormatearTextoSql( lxDatosfiscalesJurisdsiem ) + "'" >>, <<lxDatosfiscalesRetsiprib >>, <<iif( lxDatosfiscalesSeparaiibb, 1, 0 ) >>, <<lxDatosfiscalesPersiprib >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubDFI("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.DATOSFISCALES set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDatosfiscalesFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxDatosfiscalesFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxDatosfiscalesFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxDatosfiscalesFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxDatosfiscalesFaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesVmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesSaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesUmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesUaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesBdmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesSmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesEsttrans ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesZadsfw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesBdaltafw ) + "'">>,"Tipagrupub" = <<lxDatosfiscalesTipagrupub>>,"Timestamp" = <<lxDatosfiscalesTimestamp>>,"Bloqreg" = <<iif( lxDatosfiscalesBloqreg, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesCodigo ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesObs ) + "'">>,"Nroiibbobl" = <<iif( lxDatosfiscalesNroiibbobl, 1, 0 )>>,"Expoenop" = <<iif( lxDatosfiscalesExpoenop, 1, 0 )>>,"Descripcio" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesDescripcio ) + "'">>,"Autojur" = <<iif( lxDatosfiscalesAutojur, 1, 0 )>>,"Afip366814" = <<iif( lxDatosfiscalesAfip366814, 1, 0 )>>,"Dasiprib" = <<iif( lxDatosfiscalesDasiprib, 1, 0 )>>,"Autoperr" = <<iif( lxDatosfiscalesAutoperr, 1, 0 )>>,"Reintegro" = <<iif( lxDatosfiscalesReintegro, 1, 0 )>>,"Montomin" = <<lxDatosfiscalesMontomin>>,"Jurisdsiem" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesJurisdsiem ) + "'">>,"Retsiprib" = <<lxDatosfiscalesRetsiprib>>,"Separaiibb" = <<iif( lxDatosfiscalesSeparaiibb, 1, 0 )>>,"Persiprib" = <<lxDatosfiscalesPersiprib>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesCodigo ) + "'">> and  DATOSFISCALES.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
		...
		this.ComprobarTransaccion()
			...
			this.oConexion.EjecutarSql( 'delete from ZooLogic.AgruPubDFI where "Codigo" = ' + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Bdaltafw" as "Basededatosaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Codigo" as "Codigo", "Obs" as "Obser", "Nroiibbobl" as "Nroobligatorio", "Expoenop" as "Exportacionesautomaticasenop", "Descripcio" as "Descripcion", "Autojur" as "Autocompletarjurisdic", "Afip366814" as "Datosadicionalescomprobantesa", "Dasiprib" as "Datosadicionalessiprib", "Autoperr" as "Autocompletarpercriesgo", "Reintegro" as "Reintegro", "Montomin" as "Montominimo", "Jurisdsiem" as "Retpercsiempresegunjurisdiccion", "Retsiprib" as "Artincisoretiene", "Separaiibb" as "Generacompiibbseparados", "Persiprib" as "Artincisopercibe" from ZooLogic.DATOSFISCALES where "Codigo" = <<"'" + this.FormatearTextoSql( lxDatosfiscalesCodigo ) + "'">> and  DATOSFISCALES.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrup" as "Agrupamiento", "Agrupdes" as "Agrupamientodetalle" from ZooLogic.AgruPubDFI where Codigo = <<"'" + this.FormatearTextoSql( c_DATOSFISCALES.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Horaexpo,Horaimpo,Haltafw,Hmodifw,Vmodifw,Saltafw,U" + ;
"modifw,Valtafw,Ualtafw,Bdmodifw,Smodifw,Esttrans,Zadsfw,Bdaltafw,Tipagrupub,Timestamp,Bloqreg,Codigo" + ;
",Obs,Nroiibbobl,Expoenop,Descripcio,Autojur,Afip366814,Dasiprib,Autoperr,Reintegro,Montomin,Jurisdsi" + ;
"em,Retsiprib,Separaiibb,Persiprib" + ;
" from ZooLogic.DATOSFISCALES where  DATOSFISCALES.CODIGO != '' and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAgruPubliDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		Local lcAtributos As String, lcWhere As String
		lcWhere = " Where  AGRUPUBDFI.CODIGO != ''"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
		...
		return this.ObtenerDatos( lcAtributos, tcHaving, tcOrder, tcFunc, lcWhere, 'AgruPubDFI', 'AgruPubliDetalle', tnTope )
	Endfunc
		...
		With this
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAgrupamientodetalle = loItem.Agrupamientodetalle
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubDFI("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			loColeccion.Agregar([delete from ZooLogic.AgruPubDFI where "Codigo" = ] + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'")
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.DATOSFISCALES set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, obs = ] + "'" + this.FormatearTextoSql( &lcCursor..obs ) + "'"+ [, Nroiibbobl = ] + Transform( iif( &lcCursor..Nroiibbobl, 1, 0 ))+ [, ExpoEnOP = ] + Transform( iif( &lcCursor..ExpoEnOP, 1, 0 ))+ [, Descripcio = ] + "'" + this.FormatearTextoSql( &lcCursor..Descripcio ) + "'"+ [, Autojur = ] + Transform( iif( &lcCursor..Autojur, 1, 0 ))+ [, AFIP366814 = ] + Transform( iif( &lcCursor..AFIP366814, 1, 0 ))+ [, DASiprib = ] + Transform( iif( &lcCursor..DASiprib, 1, 0 ))+ [, Autoperr = ] + Transform( iif( &lcCursor..Autoperr, 1, 0 ))+ [, Reintegro = ] + Transform( iif( &lcCursor..Reintegro, 1, 0 ))+ [, MontoMin = ] + transform( &lcCursor..MontoMin )+ [, JurisdSiem = ] + "'" + this.FormatearTextoSql( &lcCursor..JurisdSiem ) + "'"+ [, RetSIPRIB = ] + transform( &lcCursor..RetSIPRIB )+ [, SeparaIIBB = ] + Transform( iif( &lcCursor..SeparaIIBB, 1, 0 ))+ [, PerSIPRIB = ] + transform( &lcCursor..PerSIPRIB ) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + transform( &lcCursor..tipagrupub ) + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..obs ) + "'" + ',' + Transform( iif( &lcCursor..Nroiibbobl, 1, 0 )) + ',' + Transform( iif( &lcCursor..ExpoEnOP, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descripcio ) + "'" + ',' + Transform( iif( &lcCursor..Autojur, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..AFIP366814, 1, 0 )) + ',' + Transform( iif( &lcCursor..DASiprib, 1, 0 )) + ',' + Transform( iif( &lcCursor..Autoperr, 1, 0 )) + ',' + Transform( iif( &lcCursor..Reintegro, 1, 0 )) + ',' + transform( &lcCursor..MontoMin ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..JurisdSiem ) + "'" + ',' + transform( &lcCursor..RetSIPRIB ) + ',' + Transform( iif( &lcCursor..SeparaIIBB, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..PerSIPRIB )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirDetalles() As Void
		...
		If lcCantRegistros > 0
			...
			this.oConexion.EjecutarSql( [Delete From ZooLogic.AgruPubDFI Where Codigo] + lcIn  )
			endfor
			if llEjecutaEnTransaccion
				this.oConexion.EjecutarSQL( 'COMMIT TRANSACTION' )
			endif
	...
	lcDetalle = This.oEntidad.cPrefijoRecibir + 'ITEMAGRUPAPUBLICDFI'
	Select * From &lcDetalle into cursor cDetallesExistentes ;
	...
	Scan All
		...
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.AgruPubDFI ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Agrup      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AgrupDes   ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'ITEMDATOSFISCALES'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'ITEMAGRUPAPUBLICDFI'
				llRetorno = .T.
		EndCase
		Return llRetorno
	EndFunc
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.OBS = isnull( d.OBS, t.OBS ),t.NROIIBBOBL = isnull( d.NROIIBBOBL, t.NROIIBBOBL ),t.EXPOENOP = isnull( d.EXPOENOP, t.EXPOENOP ),t.DESCRIPCIO = isnull( d.DESCRIPCIO, t.DESCRIPCIO ),t.AUTOJUR = isnull( d.AUTOJUR, t.AUTOJUR ),t.AFIP366814 = isnull( d.AFIP366814, t.AFIP366814 ),t.DASIPRIB = isnull( d.DASIPRIB, t.DASIPRIB ),t.AUTOPERR = isnull( d.AUTOPERR, t.AUTOPERR ),t.REINTEGRO = isnull( d.REINTEGRO, t.REINTEGRO ),t.MONTOMIN = isnull( d.MONTOMIN, t.MONTOMIN ),t.JURISDSIEM = isnull( d.JURISDSIEM, t.JURISDSIEM ),t.RETSIPRIB = isnull( d.RETSIPRIB, t.RETSIPRIB ),t.SEPARAIIBB = isnull( d.SEPARAIIBB, t.SEPARAIIBB ),t.PERSIPRIB = isnull( d.PERSIPRIB, t.PERSIPRIB )
					from ZooLogic.DATOSFISCALES t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.DATOSFISCALES(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Horaexpo,Horaimpo,Haltafw,Hmodifw,Vmodifw,Saltafw,Umodifw,Valtafw,Ualtafw,Bdmodifw,Smodifw,Esttrans,Zadsfw,Bdaltafw,Tipagrupub,Timestamp,Bloqreg,Codigo,Obs,Nroiibbobl,Expoenop,Descripcio,Autojur,Afip366814,Dasiprib,Autoperr,Reintegro,Montomin,Jurisdsiem,Retsiprib,Separaiibb,Persiprib)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.SMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.ZADSFW,''),isnull( d.BDALTAFW,''),isnull( d.TIPAGRUPUB,0),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.CODIGO,''),isnull( d.OBS,''),isnull( d.NROIIBBOBL,0),isnull( d.EXPOENOP,0),isnull( d.DESCRIPCIO,''),isnull( d.AUTOJUR,0),isnull( d.AFIP366814,0),isnull( d.DASIPRIB,0),isnull( d.AUTOPERR,0),isnull( d.REINTEGRO,0),isnull( d.MONTOMIN,0),isnull( d.JURISDSIEM,''),isnull( d.RETSIPRIB,0),isnull( d.SEPARAIIBB,0),isnull( d.PERSIPRIB,0)
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_AgruPubDFI( tcTablaTrabajo ) as String

		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_DATOSFISCALES_AgruPubDFI
ON ZooLogic.TablaTrabajo_DATOSFISCALES_AgruPubDFI
AFTER DELETE
As
Begin
Update t Set 
...
from ZooLogic.AgruPubDFI t inner join deleted d 
 on t.CODIGO = d.CODIGO
-- Fin Updates
insert into ZooLogic.AgruPubDFI
( 
"NROITEM",
"CODIGO",
"AGRUP",
...
d.AGRUP,
d.AGRUPDES
From deleted d left join ZooLogic.AgruPubDFI pk 
 on d.CODIGO = pk.CODIGO
Where pk.CODIGO Is Null 
-- Fin Inserts
End
		...
		with this.oEntidad
			...
			if reccount( 'c_DATOSFISCALES' ) < 1
				...
				Try
					...
					.Tipoagrupamientopublicaciones = nvl( c_DATOSFISCALES.Tipoagrupamientopublicaciones, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="DATOSFISCALES                           " atributo="FECHATRANSFERENCIA                      " tabla="DATOSFISCALES  " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DATOSFISCALES                           " atributo="ESTADOTRANSFERENCIA                     " tabla="DATOSFISCALES  " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DATOSFISCALES                           " atributo="TIPOAGRUPAMIENTOPUBLICACIONES           " tabla="DATOSFISCALES  " campo="TIPAGRUPUB" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DATOSFISCALES                           " atributo="AGRUPUBLIDETALLE                        " tabla="AGRUPUBDFI     " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Agrupamientos                                                                                                                                                   " dominio="DETALLEITEMAGRUPAPUBLICDFI    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
