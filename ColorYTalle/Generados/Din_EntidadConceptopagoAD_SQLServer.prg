...
define class Din_EntidadCONCEPTOPAGOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxConcepagoFecexpo, lxConcepagoFmodifw, lxConcepagoFecimpo, lxConcepagoFaltafw, lxConcepagoFectrans, lxConcepagoSmodifw, lxConcepagoSaltafw, lxConcepagoUaltafw, lxConcepagoValtafw, lxConcepagoUmodifw, lxConcepagoZadsfw, lxConcepagoVmodifw, lxConcepagoHmodifw, lxConcepagoHoraimpo, lxConcepagoBdmodifw, lxConcepagoHoraexpo, lxConcepagoEsttrans, lxConcepagoBdaltafw, lxConcepagoHaltafw, lxConcepagoTimestamp, lxConcepagoCodigo, lxConcepagoDescrip, lxConcepagoClasif, lxConcepagoCobs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CONCEPAGO ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaimpo","Bdmodifw","Horaexpo","Esttrans","Bdaltafw","Haltafw","Timestamp","Codigo","Descrip","Clasif","Cobs" ) values ( <<"'" + this.ConvertirDateSql( lxConcepagoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcepagoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcepagoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcepagoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcepagoFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoHaltafw ) + "'" >>, <<lxConcepagoTimestamp >>, <<"'" + this.FormatearTextoSql( lxConcepagoCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoClasif ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcepagoCobs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CONCEPAGO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxConcepagoFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxConcepagoFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxConcepagoFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxConcepagoFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxConcepagoFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxConcepagoSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxConcepagoUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxConcepagoValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxConcepagoZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxConcepagoHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxConcepagoHoraexpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxConcepagoEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxConcepagoBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxConcepagoHaltafw ) + "'">>,"Timestamp" = <<lxConcepagoTimestamp>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxConcepagoCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxConcepagoDescrip ) + "'">>,"Clasif" = <<"'" + this.FormatearTextoSql( lxConcepagoClasif ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxConcepagoCobs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxConcepagoCodigo ) + "'">> and  CONCEPAGO.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion", "Cobs" as "Observ" from ZooLogic.CONCEPAGO where "Codigo" = <<"'" + this.FormatearTextoSql( lxConcepagoCodigo ) + "'">> and  CONCEPAGO.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion", "Cobs" as "Observ" from ZooLogic.CONCEPAGO where  CONCEPAGO.CODIGO != '' order by Codigo
			endtext
			use in select('c_CONCEPTOPAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CONCEPTOPAGO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion", "Cobs" as "Observ" from ZooLogic.CONCEPAGO where  funciones.padr( Codigo, 15, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CONCEPAGO.CODIGO != '' order by Codigo
			endtext
			use in select('c_CONCEPTOPAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CONCEPTOPAGO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion", "Cobs" as "Observ" from ZooLogic.CONCEPAGO where  funciones.padr( Codigo, 15, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CONCEPAGO.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_CONCEPTOPAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CONCEPTOPAGO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion", "Cobs" as "Observ" from ZooLogic.CONCEPAGO where  CONCEPAGO.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_CONCEPTOPAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CONCEPTOPAGO', set( 'Datasession' ) )
			Endwith
...
"ifw,Hmodifw,Horaimpo,Bdmodifw,Horaexpo,Esttrans,Bdaltafw,Haltafw,Timestamp,Codigo,Descrip,Clasif,Cob" + ;
"s" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion", "Cobs" as "Observ"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.CONCEPAGO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxConcepagoFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxConcepagoFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxConcepagoFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxConcepagoFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxConcepagoFectrans ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxConcepagoSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxConcepagoUaltafw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxConcepagoValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxConcepagoZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoVmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoHmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxConcepagoHoraimpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxConcepagoBdmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxConcepagoHoraexpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxConcepagoEsttrans ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxConcepagoBdaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxConcepagoHaltafw ) + "'">>, "Timestamp" = <<lxConcepagoTimestamp>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxConcepagoCodigo ) + "'">>, "Descrip" = <<"'" + this.FormatearTextoSql( lxConcepagoDescrip ) + "'">>, "Clasif" = <<"'" + this.FormatearTextoSql( lxConcepagoClasif ) + "'">>, "Cobs" = <<"'" + this.FormatearTextoSql( lxConcepagoCobs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'CONCEPAGO' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CONCEPAGO set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, Clasif = ] + "'" + this.FormatearTextoSql( &lcCursor..Clasif ) + "'"+ [, CObs = ] + "'" + this.FormatearTextoSql( &lcCursor..CObs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAIMPO, BDMODIFW, HORAEXPO, ESTTRANS, BDALTAFW, HALTAFW, TIMESTAMP, Codigo, Descrip, Clasif, CObs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad CONCEPTOPAGO. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.CLASIF = isnull( d.CLASIF, t.CLASIF ),t.COBS = isnull( d.COBS, t.COBS )
					from ZooLogic.CONCEPAGO t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.CONCEPAGO(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaimpo,Bdmodifw,Horaexpo,Esttrans,Bdaltafw,Haltafw,Timestamp,Codigo,Descrip,Clasif,Cobs)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.TIMESTAMP,0),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.CLASIF,''),isnull( d.COBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CONCEPTOPAGO                            " atributo="DESCRIPCION                             " tabla="CONCEPAGO      " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="4" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CONCEPTOPAGO                            " atributo="CLASIFICACION                           " tabla="CONCEPAGO      " campo="CLASIF    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLASIFICACIONCONCEPTOPAGO               " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="6" etiqueta="Clasificación                                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
