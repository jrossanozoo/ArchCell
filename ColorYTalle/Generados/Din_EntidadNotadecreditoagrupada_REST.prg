...
define class Din_EntidadNotadecreditoagrupada_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadecreditoagrupada"
	cClaseResponse = this.cNamespaceDTOs + ".NotadecreditoagrupadaResponse"
	cClaseModelo = "NotadecreditoagrupadaModelo"
	cEntidad = "Notadecreditoagrupada"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoagrupadaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoagrupadaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoagrupadaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoagrupadaModelo"
		endcase
		return lcRetorno
