...
define class Din_EntidadFacturaelectronicaexportacion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Facturaelectronicaexportacion"
	cClaseResponse = this.cNamespaceDTOs + ".FacturaelectronicaexportacionResponse"
	cClaseModelo = "FacturaelectronicaexportacionModelo"
	cEntidad = "Facturaelectronicaexportacion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicaexportacionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicaexportacionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicaexportacionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicaexportacionModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloDateTimeEnEntidad( toModeloEnRequest, "Fechavencimientopago", toEntidad, "Fechavencimientopago" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoDateTime( toModeloResponse, "FechaVencimientoPago", toEntidad.FechaVencimientoPago)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Fechavencimientopago", "FFCHVTOPAG")
