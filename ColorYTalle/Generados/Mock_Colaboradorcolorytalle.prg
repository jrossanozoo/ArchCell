...
define class Mock_COLABORADORCOLORYTALLE as MockBase of MockBase.prg

	cClase = 'COLABORADORCOLORYTALLE'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercolores( toarticulo as string ) as string                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercolores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertalles( toarticulo as string ) as string                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenertalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocurvadetalles_access() as variant                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Ocurvadetalles_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function opaletadecolores_access() as variant                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Opaletadecolores_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcolorytalle( toobjeto as object ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Verificarcolorytalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcolorytalleparavariosart( toobjeto as object ) as integer                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Verificarcolorytalleparavariosart', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcolorytallepermitiendocolorytallevacios( toobjeto as object ) as void                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Verificarcolorytallepermitiendocolorytallevacios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function buscarenherenciadellamadas( lccadenadebusqueda as string ) as boolean                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Buscarenherenciadellamadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardescripciones( toobjeto as object )                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cargardescripciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function herenciadellamadas() as string                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Herenciadellamadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoloresdepaleta( tcpaletadecolores as string  ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercoloresdepaleta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenertallesdecurva( tccurvadetalles as string  ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertallesdecurva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarcolorcorrecto( toobjeto as object ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificarcolorcorrecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarcolorcorrectogrupo( toobjeto as object ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Verificarcolorcorrectogrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificartallecorrecto( toobjeto as object ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificartallecorrecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificartallecorrectogrupo( toobjeto as object ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Verificartallecorrectogrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function vienedecambiodefila() as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Vienedecambiodefila', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function vienedecodigodebarras() as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Vienedecodigodebarras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function vienedeprepantalla() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Vienedeprepantalla', lcParametros )
	EndFunc
