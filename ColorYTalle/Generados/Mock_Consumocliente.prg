...
define class Mock_consumocliente as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Consumo de cliente"                                                                                                                                                                                                                      
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'CONSUMOCLIENTE'                                                                                                                                                                                                                                
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function existeconsumosexedentes( tccodigo as string, tdfechadesde as datetime, tdfechahasta as datetime ) as void                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tccodigo
		lxParam2 = tdfechadesde
		lxParam3 = tdfechahasta
		...
		return this.ObtenerResultado( 'Existeconsumosexedentes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function existencomprobantesasociadosallimitedeconsumo( tclimiteconsumo ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tclimiteconsumo
		...
		return this.ObtenerResultado( 'Existencomprobantesasociadosallimitedeconsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermontoconsumido( tccodigo as string, tccomprobanteactual as string ) as number                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccodigo
		lxParam2 = tccomprobanteactual
		...
		return this.ObtenerResultado( 'Obtenermontoconsumido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_signo( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONSUMOCLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_signo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_signo', lcParametros )			endif		endif		this.Signo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_signo( txval as variant ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONSUMOCLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_signo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_signo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
