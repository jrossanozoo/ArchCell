...
define class Mock_cajaestado as MockBase of MockBase.prg
	...
	FechaAltaFW = {}                                                                                                                                                                                                                                          
	FechaModificacionFW = {}                                                                                                                                                                                                                                  
	FechaUltimaApertura = ctod( '  /  /    ' )                                                                                                                                                                                                                
	Fechaprocesando = ctod( '  /  /    ' )                                                                                                                                                                                                                    
	HORAALTAFW = ""                                                                                                                                                                                                                                           
	HORAEXPO = ""                                                                                                                                                                                                                                             
	HORAIMPO = ""                                                                                                                                                                                                                                             
	HORAMODIFICACIONFW = ""                                                                                                                                                                                                                                   
	...
	SeguridadMetodoAbrirCaja = "1182"                                                                                                                                                                                                                         
	SeguridadMetodoAbrirCaja = "138"                                                                                                                                                                                                                          
	SeguridadMetodoCerrarCaja = "1181"                                                                                                                                                                                                                        
	SeguridadMetodoCerrarCaja = "40"                                                                                                                                                                                                                          
	SeguridadMetodoEstadoCaja = "1038"                                                                                                                                                                                                                        
	SeguridadMetodoEstadoCaja = "38"                                                                                                                                                                                                                          
	TIMESTAMP = 0                                                                                                                                                                                                                                             
	USUARIOALTAFW = ""                                                                                                                                                                                                                                        
	USUARIOMODIFICACIONFW = ""                                                                                                                                                                                                                                
	UsaVendedorArqueoEnCierre = .F.                                                                                                                                                                                                                           
	UsuarioProcesando = ""                                                                                                                                                                                                                                    
	VERSIONALTAFW = ""                                                                                                                                                                                                                                        
	...
	lHabilitarUsaVendedorArqueoEnCierre = .T.                                                                                                                                                                                                                 
	...
	*-----------------------------------------------------------------------------------------
	function arqueoalcierre_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'arqueoalcierre_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'arqueoalcierre_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Arqueoalcierre		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Arqueoalcierre( lxVal )				this.Setear_Arqueoalcierre( lxVal )			EndIf		Else			This.Setear_Arqueoalcierre( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignarnumerodecajaaestados( tnnumerodecaja as integer ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Asignarnumerodecajaaestados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descripcionestado_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descripcionestado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descripcionestado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Descripcionestado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Descripcionestado( lxVal )				this.Setear_Descripcionestado( lxVal )			EndIf		Else			This.Setear_Descripcionestado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estaabierta( tncaja as integer  ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Estaabierta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaprocesando_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaprocesando_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaprocesando_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaprocesando		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaprocesando( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Fechaprocesando( lxVal )			EndIf		Else			This.Setear_Fechaprocesando( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaultimaapertura_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaultimaapertura_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaultimaapertura_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaultimaapertura		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaultimaapertura( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Fechaultimaapertura( lxVal )			EndIf		Else			This.Setear_Fechaultimaapertura( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaraccionabrir() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Habilitaraccionabrir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaraccioncerrar() as boolean                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Habilitaraccioncerrar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaraccionestado() as boolean                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Habilitaraccionestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function horaultimaapertura_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'horaultimaapertura_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'horaultimaapertura_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Horaultimaapertura		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Horaultimaapertura( lxVal )				this.Setear_Horaultimaapertura( lxVal )			EndIf		Else			This.Setear_Horaultimaapertura( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function id_assign( txval as variant ) as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'id_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'id_assign', lcParametros )			endif		endif		local llConsulta as Boolean, llNuevo as boolean, llEdicion as boolean		with this			llEdicion = .EsEdicion()			if .lLimpiando or .lCargando				.Id = .TransformarAlAsignar( txVal )			else				if llEdicion				else					llNuevo = .EsNuevo()					.Id = .TransformarAlAsignar( txVal )					if empty( txVal ) and !llNuevo						.Limpiar()					else						llConsulta = .oAD.ConsultarPorClavePrimaria()						do case							case !llNuevo and llConsulta								.Cargar()							case !llNuevo and !llConsulta								.Limpiar()								goServicios.Errores.LevantarExcepcionTexto( 'El dato buscado ' + alltrim( transform( txVal ) ) + ' de la entidad ' + upper( this.cDescripcion ) + ' no existe.', 9001 )							case llNuevo and llConsulta								.Id = 0								goServicios.Errores.LevantarExcepcion( 'El código ' + alltrim( transform( txVal ) ) + ' ya existe.' )						endcase					endif				endif			endif		endwith
	EndFunc

	*-----------------------------------------------------------------------------------------
	function idcajaauditoria_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idcajaauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idcajaauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Idcajaauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Idcajaauditoria( lxVal )				this.Setear_Idcajaauditoria( lxVal )			EndIf		Else			This.Setear_Idcajaauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocultartotalmoneda_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocultartotalmoneda_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocultartotalmoneda_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ocultartotalmoneda		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ocultartotalmoneda( lxVal )				this.Setear_Ocultartotalmoneda( lxVal )			EndIf		Else			This.Setear_Ocultartotalmoneda( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pedirseguridadabrircaja() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Pedirseguridadabrircaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pedirseguridadcerrarcaja() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Pedirseguridadcerrarcaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pedirseguridadestadocaja() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Pedirseguridadestadocaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_arqueoalcierre( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_arqueoalcierre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_arqueoalcierre', lcParametros )			endif		endif		dodefault( txVal )		this.UsaVendedorArqueoEnCierre = iif( txVal, this.UsaVendedorArqueoEnCierre, .f. )		this.HabilitarControles()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descripcionestado( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_descripcionestado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_descripcionestado', lcParametros )			endif		endif		this.Descripcionestado = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaprocesando( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaprocesando', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaprocesando', lcParametros )			endif		endif		this.Fechaprocesando = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaultimaapertura( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaultimaapertura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaultimaapertura', lcParametros )			endif		endif		this.Fechaultimaapertura = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_horaultimaapertura( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_horaultimaapertura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_horaultimaapertura', lcParametros )			endif		endif		this.Horaultimaapertura = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_idcajaauditoria( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_idcajaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_idcajaauditoria', lcParametros )			endif		endif		this.Idcajaauditoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ocultartotalmoneda( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ocultartotalmoneda', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ocultartotalmoneda', lcParametros )			endif		endif		this.Ocultartotalmoneda = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_usavendedorarqueoencierre( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_usavendedorarqueoencierre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_usavendedorarqueoencierre', lcParametros )			endif		endif		this.Usavendedorarqueoencierre = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_usuarioprocesando( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_usuarioprocesando', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_usuarioprocesando', lcParametros )			endif		endif		this.Usuarioprocesando = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function usavendedorarqueoencierre_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'usavendedorarqueoencierre_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'usavendedorarqueoencierre_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Usavendedorarqueoencierre		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Usavendedorarqueoencierre( lxVal )				if ( this.lHabilitarUsavendedorarqueoencierre or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Usavendedorarqueoencierre( lxVal )				else					this.Usavendedorarqueoencierre = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Caja - Atributo: Usavendedorarqueoencierre)" )				endif			EndIf		Else			This.Setear_Usavendedorarqueoencierre( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function usuarioprocesando_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'usuarioprocesando_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'usuarioprocesando_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Usuarioprocesando		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Usuarioprocesando( lxVal )				this.Setear_Usuarioprocesando( lxVal )			EndIf		Else			This.Setear_Usuarioprocesando( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_arqueoalcierre( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_arqueoalcierre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_arqueoalcierre', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descripcionestado( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descripcionestado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descripcionestado', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaprocesando( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaprocesando', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaprocesando', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaultimaapertura( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaultimaapertura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaultimaapertura', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_horaultimaapertura( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_horaultimaapertura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_horaultimaapertura', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_idcajaauditoria( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idcajaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idcajaauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ocultartotalmoneda( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ocultartotalmoneda', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ocultartotalmoneda', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_usavendedorarqueoencierre( txval as variant ) as boolean                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usavendedorarqueoencierre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usavendedorarqueoencierre', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_usuarioprocesando( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAESTADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usuarioprocesando', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usuarioprocesando', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoarqueoalcierre() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoarqueoalcierre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwestado() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoocultartotalmoneda() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoocultartotalmoneda', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridousavendedorarqueoencierre() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridousavendedorarqueoencierre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearcaja( tnnumerodecaja as integer ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Crearcaja', lcParametros )
	EndFunc
