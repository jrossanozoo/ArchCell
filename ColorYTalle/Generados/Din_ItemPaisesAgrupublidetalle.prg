...
define class Din_ItemPAISESAgrupublidetalle as ItemAgruPubliDetalle of ItemAgruPubliDetalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'PAISES', 'Agrupublidetalle')
