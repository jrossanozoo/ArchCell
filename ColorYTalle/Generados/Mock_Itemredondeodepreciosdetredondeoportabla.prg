...
define class Mock_Itemredondeodepreciosdetredondeoportabla as MockBase of MockBase.prg

	cClase = 'Itemredondeodepreciosdetredondeoportabla'
	...
	*-----------------------------------------------------------------------------------------
	function redondearen_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Redondearen_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_redondearen( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_redondearen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_redondearen( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_redondearen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoredondearen() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoredondearen', lcParametros )
	EndFunc
