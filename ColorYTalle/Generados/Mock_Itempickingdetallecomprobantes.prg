...
define class Mock_Itempickingdetallecomprobantes as MockBase of MockBase.prg

	cClase = 'Itempickingdetallecomprobantes'
	...
	*-----------------------------------------------------------------------------------------
	function codigocompafe_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Codigocompafe_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iddecaja_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Iddecaja_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function origendestinodetalle_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Origendestinodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigocompafe( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_codigocompafe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iddecaja( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_iddecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_origendestinodetalle( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_origendestinodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_timestampcomprobante( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_timestampcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function timestampcomprobante_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Timestampcomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigocompafe( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_codigocompafe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iddecaja( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_iddecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_origendestinodetalle( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_origendestinodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_timestampcomprobante( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_timestampcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoiddecaja() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoiddecaja', lcParametros )
	EndFunc
