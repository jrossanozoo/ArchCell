...
define class Mock_seniapendiente as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleseniaspendientes() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleseniaspendientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarseniasseleccionadas( tcaccion as string ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function detalleseniaspendientes_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SENIAPENDIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalleseniaspendientes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalleseniaspendientes_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalleseniaspendientes ) = 'O' or isnull( this.Detalleseniaspendientes ) )			this.Detalleseniaspendientes = this.crearobjeto( 'DetalleSeniapendienteDetalleseniaspendientes' )			this.Detalleseniaspendientes.inicializar()			this.enlazar( 'Detalleseniaspendientes.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalleseniaspendientes.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalleseniaspendientes, 'CambioSumarizado', this, 'CambiosDetalleDetalleseniaspendientes', 1)			this.enlazar( 'Detalleseniaspendientes.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalleseniaspendientes.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detalleseniaspendientes
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambioelsumadodeimporte() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocambioelsumadodeimporte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sumarizarseguncorresponda( tcatributo as string, toitem as object ) as void                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Sumarizarseguncorresponda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarseniaspendientes() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarseniaspendientes', lcParametros )
	EndFunc
