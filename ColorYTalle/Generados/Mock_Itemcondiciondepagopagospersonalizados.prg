...
define class Mock_Itemcondiciondepagopagospersonalizados as MockBase of MockBase.prg

	cClase = 'Itemcondiciondepagopagospersonalizados'
	...
	*-----------------------------------------------------------------------------------------
	function asignardescripciondetipodepago() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Asignardescripciondetipodepago', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function diasapartirdefechacomprobante_assign( txval as variant ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Diasapartirdefechacomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajedelcomprobante_assign( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Porcentajedelcomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_diasapartirdefechacomprobante( txval as variant ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_diasapartirdefechacomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porcentajedelcomprobante( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_porcentajedelcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipovalordescripcion( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_tipovalordescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipovalordescripcion_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Tipovalordescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_diasapartirdefechacomprobante( txval as variant ) as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_diasapartirdefechacomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajedelcomprobante( txval as variant ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_porcentajedelcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipovalordescripcion( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_tipovalordescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valordetalle_despuesdeasignar() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valordetalle_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodiasapartirdefechacomprobante() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridodiasapartirdefechacomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoporcentajedelcomprobante() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoporcentajedelcomprobante', lcParametros )
	EndFunc
