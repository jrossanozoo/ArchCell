...
define class Din_EntidadADT_DESCUENTOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAdt_descuentosFecimpo, lxAdt_descuentosFectrans, lxAdt_descuentosFmodifw, lxAdt_descuentosFecexpo, lxAdt_descuentosFaltafw, lxAdt_descuentosAdt_fecha, lxAdt_descuentosHmodifw, lxAdt_descuentosHoraexpo, lxAdt_descuentosHoraimpo, lxAdt_descuentosSaltafw, lxAdt_descuentosHaltafw, lxAdt_descuentosUaltafw, lxAdt_descuentosVmodifw, lxAdt_descuentosZadsfw, lxAdt_descuentosValtafw, lxAdt_descuentosSmodifw, lxAdt_descuentosUmodifw, lxAdt_descuentosAdt_serie, lxAdt_descuentosAdt_hora, lxAdt_descuentosAdt_vers, lxAdt_descuentosAdt_comp, lxAdt_descuentosAdt_adn, lxAdt_descuentosAdt_ent, lxAdt_descuentosBdaltafw, lxAdt_descuentosEsttrans, lxAdt_descuentosAdt_usr, lxAdt_descuentosBdmodifw, lxAdt_descuentosAdt_ext, lxAdt_descuentosInactivofw, lxAdt_descuentosAdt_cod, lxAdt_descuentosCodigo
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ADT_DESCUENTOS ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Adt_fecha","Hmodifw","Horaexpo","Horaimpo","Saltafw","Haltafw","Ualtafw","Vmodifw","Zadsfw","Valtafw","Smodifw","Umodifw","Adt_serie","Adt_hora","Adt_vers","Adt_comp","Adt_adn","Adt_ent","Bdaltafw","Esttrans","Adt_usr","Bdmodifw","Adt_ext","Inactivofw","Adt_cod","Codigo" ) values ( <<"'" + this.ConvertirDateSql( lxAdt_descuentosFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_descuentosFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_descuentosFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_descuentosFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_descuentosFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_descuentosAdt_fecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_serie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_hora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_vers ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_comp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_adn ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_ent ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_usr ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosBdmodifw ) + "'" >>, <<iif( lxAdt_descuentosAdt_ext, 1, 0 ) >>, <<iif( lxAdt_descuentosInactivofw, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_cod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_descuentosCodigo ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ADT_DESCUENTOS set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxAdt_descuentosFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAdt_descuentosFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAdt_descuentosFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxAdt_descuentosFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAdt_descuentosFaltafw ) + "'">>,"Adt_fecha" = <<"'" + this.ConvertirDateSql( lxAdt_descuentosAdt_fecha ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosSaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosHaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosUaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosValtafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosUmodifw ) + "'">>,"Adt_serie" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_serie ) + "'">>,"Adt_hora" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_hora ) + "'">>,"Adt_vers" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_vers ) + "'">>,"Adt_comp" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_comp ) + "'">>,"Adt_adn" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_adn ) + "'">>,"Adt_ent" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_ent ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosEsttrans ) + "'">>,"Adt_usr" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_usr ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosBdmodifw ) + "'">>,"Adt_ext" = <<iif( lxAdt_descuentosAdt_ext, 1, 0 )>>,"Inactivofw" = <<iif( lxAdt_descuentosInactivofw, 1, 0 )>>,"Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_cod ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosCodigo ) + "'">> where "Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_cod ) + "'">> and  ADT_DESCUENTOS.ADT_COD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Adt_fecha" as "Adt_fecha", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Adt_serie" as "Adt_serie", "Adt_hora" as "Adt_hora", "Adt_vers" as "Adt_vers", "Adt_comp" as "Adt_comp", "Adt_adn" as "Adt_adn", "Adt_ent" as "Adt_ent", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Adt_usr" as "Adt_usr", "Bdmodifw" as "Basededatosmodificacionfw", "Adt_ext" as "Adt_ext", "Inactivofw" as "Inactivofw", "Adt_cod" as "Adt_cod", "Codigo" as "Codigo" from ZooLogic.ADT_DESCUENTOS where "Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_descuentosAdt_cod ) + "'">> and  ADT_DESCUENTOS.ADT_COD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Adt_fecha" as "Adt_fecha", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Adt_serie" as "Adt_serie", "Adt_hora" as "Adt_hora", "Adt_vers" as "Adt_vers", "Adt_comp" as "Adt_comp", "Adt_adn" as "Adt_adn", "Adt_ent" as "Adt_ent", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Adt_usr" as "Adt_usr", "Bdmodifw" as "Basededatosmodificacionfw", "Adt_ext" as "Adt_ext", "Inactivofw" as "Inactivofw", "Adt_cod" as "Adt_cod", "Codigo" as "Codigo" from ZooLogic.ADT_DESCUENTOS where  ADT_DESCUENTOS.ADT_COD != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_ADT_DESCUENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ADT_DESCUENTO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Adt_fecha" as "Adt_fecha", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Adt_serie" as "Adt_serie", "Adt_hora" as "Adt_hora", "Adt_vers" as "Adt_vers", "Adt_comp" as "Adt_comp", "Adt_adn" as "Adt_adn", "Adt_ent" as "Adt_ent", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Adt_usr" as "Adt_usr", "Bdmodifw" as "Basededatosmodificacionfw", "Adt_ext" as "Adt_ext", "Inactivofw" as "Inactivofw", "Adt_cod" as "Adt_cod", "Codigo" as "Codigo" from ZooLogic.ADT_DESCUENTOS where  funciones.dtos( FALTAFW ) + funciones.padr( HALTAFW, 8, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ADT_DESCUENTOS.ADT_COD != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_ADT_DESCUENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ADT_DESCUENTO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Adt_fecha,Hmodifw,Horaexpo,Horaimpo,Saltafw,Haltafw" + ;
",Ualtafw,Vmodifw,Zadsfw,Valtafw,Smodifw,Umodifw,Adt_serie,Adt_hora,Adt_vers,Adt_comp,Adt_adn,Adt_ent" + ;
",Bdaltafw,Esttrans,Adt_usr,Bdmodifw,Adt_ext,Inactivofw,Adt_cod,Codigo" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Adt_fecha" as "Adt_fecha", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Adt_serie" as "Adt_serie", "Adt_hora" as "Adt_hora", "Adt_vers" as "Adt_vers", "Adt_comp" as "Adt_comp", "Adt_adn" as "Adt_adn", "Adt_ent" as "Adt_ent", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Adt_usr" as "Adt_usr", "Bdmodifw" as "Basededatosmodificacionfw", "Adt_ext" as "Adt_ext", "Inactivofw" as "Inactivofw", "Adt_cod" as "Adt_cod", "Codigo" as "Codigo"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.ADT_DESCUENTOS set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, ADT_Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..ADT_Fecha ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ADT_Serie = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Serie ) + "'"+ [, ADT_Hora = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Hora ) + "'"+ [, ADT_Vers = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Vers ) + "'"+ [, ADT_Comp = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Comp ) + "'"+ [, ADT_ADN = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_ADN ) + "'"+ [, ADT_Ent = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Ent ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, ADT_Usr = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Usr ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ADT_Ext = ] + Transform( iif( &lcCursor..ADT_Ext, 1, 0 ))+ [, InactivoFW = ] + Transform( iif( &lcCursor..InactivoFW, 1, 0 ))+ [, ADT_Cod = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Cod ) + "'"+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" + [ Where ADT_Cod = ] + "'" + this.FormatearTextoSql( &lcCursor..ADT_Cod ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, ADT_Fecha, HMODIFW, HORAEXPO, HORAIMPO, SALTAFW, HALTAFW, UALTAFW, VMODIFW, ZADSFW, VALTAFW, SMODIFW, UMODIFW, ADT_Serie, ADT_Hora, ADT_Vers, ADT_Comp, ADT_ADN, ADT_Ent, BDALTAFW, ESTTRANS, ADT_Usr, BDMODIFW, ADT_Ext, InactivoFW, ADT_Cod, codigo
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..ADT_Fecha ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Serie ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Hora ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Vers ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Comp ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_ADN ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Ent ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Usr ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + Transform( iif( &lcCursor..ADT_Ext, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..InactivoFW, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Cod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.ADT_FECHA = isnull( d.ADT_FECHA, t.ADT_FECHA ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ADT_SERIE = isnull( d.ADT_SERIE, t.ADT_SERIE ),t.ADT_HORA = isnull( d.ADT_HORA, t.ADT_HORA ),t.ADT_VERS = isnull( d.ADT_VERS, t.ADT_VERS ),t.ADT_COMP = isnull( d.ADT_COMP, t.ADT_COMP ),t.ADT_ADN = isnull( d.ADT_ADN, t.ADT_ADN ),t.ADT_ENT = isnull( d.ADT_ENT, t.ADT_ENT ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ADT_USR = isnull( d.ADT_USR, t.ADT_USR ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ADT_EXT = isnull( d.ADT_EXT, t.ADT_EXT ),t.INACTIVOFW = isnull( d.INACTIVOFW, t.INACTIVOFW ),t.ADT_COD = isnull( d.ADT_COD, t.ADT_COD ),t.CODIGO = isnull( d.CODIGO, t.CODIGO )
					from ZooLogic.ADT_DESCUENTOS t inner join deleted d 
							 on t.ADT_Cod = d.ADT_Cod
				-- Fin Updates
				insert into ZooLogic.ADT_DESCUENTOS(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Adt_fecha,Hmodifw,Horaexpo,Horaimpo,Saltafw,Haltafw,Ualtafw,Vmodifw,Zadsfw,Valtafw,Smodifw,Umodifw,Adt_serie,Adt_hora,Adt_vers,Adt_comp,Adt_adn,Adt_ent,Bdaltafw,Esttrans,Adt_usr,Bdmodifw,Adt_ext,Inactivofw,Adt_cod,Codigo)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.ADT_FECHA,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.ADT_SERIE,''),isnull( d.ADT_HORA,''),isnull( d.ADT_VERS,''),isnull( d.ADT_COMP,''),isnull( d.ADT_ADN,''),isnull( d.ADT_ENT,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.ADT_USR,''),isnull( d.BDMODIFW,''),isnull( d.ADT_EXT,0),isnull( d.INACTIVOFW,0),isnull( d.ADT_COD,''),isnull( d.CODIGO,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="ADT_DESCUENTO                           " atributo="FECHATRANSFERENCIA                      " tabla="ADT_DESCUENTOS " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_DESCUENTO                           " atributo="ADT_SERIE                               " tabla="ADT_DESCUENTOS " campo="ADT_SERIE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Serie                                                                                                                                                           " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ADT_DESCUENTO                           " atributo="ADT_HORA                                " tabla="ADT_DESCUENTOS " campo="ADT_HORA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Hora                                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_DESCUENTO                           " atributo="ADT_ENT                                 " tabla="ADT_DESCUENTOS " campo="ADT_ENT   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Entidad                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_DESCUENTO                           " atributo="ESTADOTRANSFERENCIA                     " tabla="ADT_DESCUENTOS " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCUENTO                               " atributo="DESCRIPCION                             " tabla="DESCUENTOS     " campo="DES       " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="419" etiqueta="Detalle Des.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DESCUENTOS On ADT_DESCUENTOS.CODIGO = DESCUENTOS.codigo And  DESCUENTOS.CODIGO != ''                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
