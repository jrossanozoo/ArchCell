...
define class Din_EntidadConceptoentidadfinanciera_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Conceptoentidadfinanciera"
	cClaseResponse = this.cNamespaceDTOs + ".ConceptoentidadfinancieraResponse"
	cClaseModelo = "ConceptoentidadfinancieraModelo"
	cEntidad = "Conceptoentidadfinanciera"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptoentidadfinancieraModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptoentidadfinancieraListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptoentidadfinancieraListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptoentidadfinancieraModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Concepto", toEntidad, "Concepto" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "Concepto", toEntidad.Concepto)
