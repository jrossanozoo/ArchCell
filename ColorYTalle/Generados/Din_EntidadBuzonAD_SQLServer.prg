...
define class Din_EntidadBUZONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxHostFecimpo, lxHostFecexpo, lxHostFmodifw, lxHostFaltafw, lxHostFectrans, lxHostSaltafw, lxHostUaltafw, lxHostSmodifw, lxHostHoraimpo, lxHostUmodifw, lxHostBdmodifw, lxHostHoraexpo, lxHostHaltafw, lxHostValtafw, lxHostBdaltafw, lxHostEsttrans, lxHostVmodifw, lxHostHmodifw, lxHostZadsfw, lxHostTimestamp, lxHostObs, lxHostHoscod, lxHostHunid, lxHostHpath, lxHostHserie, lxHostBdatos, lxHostHsucori, lxHostHpath1, lxHostHpath2, lxHostCliente, lxHostComport, lxHostProveedor, lxHostHpath3, lxHostHdiscove, lxHostHcompkit, lxHostHtranstk, lxHostHtranart, lxHostHdatestk, lxHostHtipoconx, lxHostHcodfiltr, lxHostHeslince, lxHostOrigfran, lxHostCliefran, lxHostProvfran
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into PUESTO.HOST ( "Fecimpo","Fecexpo","Fmodifw","Faltafw","Fectrans","Saltafw","Ualtafw","Smodifw","Horaimpo","Umodifw","Bdmodifw","Horaexpo","Haltafw","Valtafw","Bdaltafw","Esttrans","Vmodifw","Hmodifw","Zadsfw","Timestamp","Obs","Hoscod","Hunid","Hpath","Hserie","Bdatos","Hsucori","Hpath1","Hpath2","Cliente","Comport","Proveedor","Hpath3","Hdiscove","Hcompkit","Htranstk","Htranart","Hdatestk","Htipoconx","Hcodfiltr","Heslince","Origfran","Cliefran","Provfran" ) values ( <<"'" + this.ConvertirDateSql( lxHostFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxHostFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxHostFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxHostFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxHostFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostZadsfw ) + "'" >>, <<lxHostTimestamp >>, <<"'" + this.FormatearTextoSql( lxHostObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHoscod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHunid ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHpath ) + "'" >>, <<lxHostHserie >>, <<"'" + this.FormatearTextoSql( lxHostBdatos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHsucori ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHpath1 ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHpath2 ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostCliente ) + "'" >>, <<lxHostComport >>, <<"'" + this.FormatearTextoSql( lxHostProveedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostHpath3 ) + "'" >>, <<lxHostHdiscove >>, <<lxHostHcompkit >>, <<lxHostHtranstk >>, <<lxHostHtranart >>, <<"'" + this.ConvertirDateSql( lxHostHdatestk ) + "'" >>, <<lxHostHtipoconx >>, <<"'" + this.FormatearTextoSql( lxHostHcodfiltr ) + "'" >>, <<iif( lxHostHeslince, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxHostOrigfran ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostCliefran ) + "'" >>, <<"'" + this.FormatearTextoSql( lxHostProvfran ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update PUESTO.HOST set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxHostFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxHostFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxHostFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxHostFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxHostFectrans ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxHostSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxHostUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxHostSmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxHostHoraimpo ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxHostUmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxHostBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxHostHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxHostHaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxHostValtafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxHostBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxHostEsttrans ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxHostVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxHostHmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxHostZadsfw ) + "'">>,"Timestamp" = <<lxHostTimestamp>>,"Obs" = <<"'" + this.FormatearTextoSql( lxHostObs ) + "'">>,"Hoscod" = <<"'" + this.FormatearTextoSql( lxHostHoscod ) + "'">>,"Hunid" = <<"'" + this.FormatearTextoSql( lxHostHunid ) + "'">>,"Hpath" = <<"'" + this.FormatearTextoSql( lxHostHpath ) + "'">>,"Hserie" = <<lxHostHserie>>,"Bdatos" = <<"'" + this.FormatearTextoSql( lxHostBdatos ) + "'">>,"Hsucori" = <<"'" + this.FormatearTextoSql( lxHostHsucori ) + "'">>,"Hpath1" = <<"'" + this.FormatearTextoSql( lxHostHpath1 ) + "'">>,"Hpath2" = <<"'" + this.FormatearTextoSql( lxHostHpath2 ) + "'">>,"Cliente" = <<"'" + this.FormatearTextoSql( lxHostCliente ) + "'">>,"Comport" = <<lxHostComport>>,"Proveedor" = <<"'" + this.FormatearTextoSql( lxHostProveedor ) + "'">>,"Hpath3" = <<"'" + this.FormatearTextoSql( lxHostHpath3 ) + "'">>,"Hdiscove" = <<lxHostHdiscove>>,"Hcompkit" = <<lxHostHcompkit>>,"Htranstk" = <<lxHostHtranstk>>,"Htranart" = <<lxHostHtranart>>,"Hdatestk" = <<"'" + this.ConvertirDateSql( lxHostHdatestk ) + "'">>,"Htipoconx" = <<lxHostHtipoconx>>,"Hcodfiltr" = <<"'" + this.FormatearTextoSql( lxHostHcodfiltr ) + "'">>,"Heslince" = <<iif( lxHostHeslince, 1, 0 )>>,"Origfran" = <<"'" + this.FormatearTextoSql( lxHostOrigfran ) + "'">>,"Cliefran" = <<"'" + this.FormatearTextoSql( lxHostCliefran ) + "'">>,"Provfran" = <<"'" + this.FormatearTextoSql( lxHostProvfran ) + "'">> where "Hoscod" = <<"'" + this.FormatearTextoSql( lxHostHoscod ) + "'">> and  HOST.HOSCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fecexpo,Fmodifw,Faltafw,Fectrans,Saltafw,Ualtafw,Smodifw,Horaimpo,Umodifw,Bdmodifw,H" + ;
"oraexpo,Haltafw,Valtafw,Bdaltafw,Esttrans,Vmodifw,Hmodifw,Zadsfw,Timestamp,Obs,Hoscod,Hunid,Hpath,Hs" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE PUESTO.HOST set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, HOSCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..HOSCOD ) + "'"+ [, HUNID = ] + "'" + this.FormatearTextoSql( &lcCursor..HUNID ) + "'"+ [, HPATH = ] + "'" + this.FormatearTextoSql( &lcCursor..HPATH ) + "'"+ [, HSERIE = ] + transform( &lcCursor..HSERIE )+ [, BDATOS = ] + "'" + this.FormatearTextoSql( &lcCursor..BDATOS ) + "'"+ [, HSUCORI = ] + "'" + this.FormatearTextoSql( &lcCursor..HSUCORI ) + "'"+ [, HPATH1 = ] + "'" + this.FormatearTextoSql( &lcCursor..HPATH1 ) + "'"+ [, HPATH2 = ] + "'" + this.FormatearTextoSql( &lcCursor..HPATH2 ) + "'"+ [, CLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..CLIENTE ) + "'"+ [, COMPORT = ] + transform( &lcCursor..COMPORT )+ [, PROVEEDOR = ] + "'" + this.FormatearTextoSql( &lcCursor..PROVEEDOR ) + "'"+ [, HPATH3 = ] + "'" + this.FormatearTextoSql( &lcCursor..HPATH3 ) + "'"+ [, HDISCOVE = ] + transform( &lcCursor..HDISCOVE )+ [, HCOMPKIT = ] + transform( &lcCursor..HCOMPKIT )+ [, HTRANSTK = ] + transform( &lcCursor..HTRANSTK )+ [, HTRANART = ] + transform( &lcCursor..HTRANART )+ [, HDATESTK = ] + "'" + this.ConvertirDateSql( &lcCursor..HDATESTK ) + "'"+ [, HTIPOCONX = ] + transform( &lcCursor..HTIPOCONX )+ [, HCODFILTR = ] + "'" + this.FormatearTextoSql( &lcCursor..HCODFILTR ) + "'"+ [, HESLINCE = ] + Transform( iif( &lcCursor..HESLINCE, 1, 0 ))+ [, ORIGFRAN = ] + "'" + this.FormatearTextoSql( &lcCursor..ORIGFRAN ) + "'"+ [, CLIEFRAN = ] + "'" + this.FormatearTextoSql( &lcCursor..CLIEFRAN ) + "'"+ [, PROVFRAN = ] + "'" + this.FormatearTextoSql( &lcCursor..PROVFRAN ) + "'" + [ Where HOSCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..HOSCOD ) + "'" )
...
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
"cliefran" char( 10 )  null, 
"provfran" char( 10 )  null )
		endtext
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.OBS = isnull( d.OBS, t.OBS ),t.HOSCOD = isnull( d.HOSCOD, t.HOSCOD ),t.HUNID = isnull( d.HUNID, t.HUNID ),t.HPATH = isnull( d.HPATH, t.HPATH ),t.HSERIE = isnull( d.HSERIE, t.HSERIE ),t.BDATOS = isnull( d.BDATOS, t.BDATOS ),t.HSUCORI = isnull( d.HSUCORI, t.HSUCORI ),t.HPATH1 = isnull( d.HPATH1, t.HPATH1 ),t.HPATH2 = isnull( d.HPATH2, t.HPATH2 ),t.CLIENTE = isnull( d.CLIENTE, t.CLIENTE ),t.COMPORT = isnull( d.COMPORT, t.COMPORT ),t.PROVEEDOR = isnull( d.PROVEEDOR, t.PROVEEDOR ),t.HPATH3 = isnull( d.HPATH3, t.HPATH3 ),t.HDISCOVE = isnull( d.HDISCOVE, t.HDISCOVE ),t.HCOMPKIT = isnull( d.HCOMPKIT, t.HCOMPKIT ),t.HTRANSTK = isnull( d.HTRANSTK, t.HTRANSTK ),t.HTRANART = isnull( d.HTRANART, t.HTRANART ),t.HDATESTK = isnull( d.HDATESTK, t.HDATESTK ),t.HTIPOCONX = isnull( d.HTIPOCONX, t.HTIPOCONX ),t.HCODFILTR = isnull( d.HCODFILTR, t.HCODFILTR ),t.HESLINCE = isnull( d.HESLINCE, t.HESLINCE ),t.ORIGFRAN = isnull( d.ORIGFRAN, t.ORIGFRAN ),t.CLIEFRAN = isnull( d.CLIEFRAN, t.CLIEFRAN ),t.PROVFRAN = isnull( d.PROVFRAN, t.PROVFRAN )
					from PUESTO.HOST t inner join deleted d 
							 on t.HOSCOD = d.HOSCOD
				-- Fin Updates
				insert into PUESTO.HOST(Fecimpo,Fecexpo,Fmodifw,Faltafw,Fectrans,Saltafw,Ualtafw,Smodifw,Horaimpo,Umodifw,Bdmodifw,Horaexpo,Haltafw,Valtafw,Bdaltafw,Esttrans,Vmodifw,Hmodifw,Zadsfw,Timestamp,Obs,Hoscod,Hunid,Hpath,Hserie,Bdatos,Hsucori,Hpath1,Hpath2,Cliente,Comport,Proveedor,Hpath3,Hdiscove,Hcompkit,Htranstk,Htranart,Hdatestk,Htipoconx,Hcodfiltr,Heslince,Origfran,Cliefran,Provfran)
					Select isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.UMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.VALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.ZADSFW,''),isnull( d.TIMESTAMP,0),isnull( d.OBS,''),isnull( d.HOSCOD,''),isnull( d.HUNID,''),isnull( d.HPATH,''),isnull( d.HSERIE,0),isnull( d.BDATOS,''),isnull( d.HSUCORI,''),isnull( d.HPATH1,''),isnull( d.HPATH2,''),isnull( d.CLIENTE,''),isnull( d.COMPORT,0),isnull( d.PROVEEDOR,''),isnull( d.HPATH3,''),isnull( d.HDISCOVE,0),isnull( d.HCOMPKIT,0),isnull( d.HTRANSTK,0),isnull( d.HTRANART,0),isnull( d.HDATESTK,''),isnull( d.HTIPOCONX,0),isnull( d.HCODFILTR,''),isnull( d.HESLINCE,0),isnull( d.ORIGFRAN,''),isnull( d.CLIEFRAN,''),isnull( d.PROVFRAN,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="BUZON                                   " atributo="DIRECTORIO                              " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="402" etiqueta="Carpeta estructura directorios                                                                                                                                  " dominio="DIRECTORIO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="BUZON                                   " atributo="BASEDEDATOS                             " tabla="HOST           " campo="BDATOS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="6" etiqueta="Base de datos destino                                                                                                                                           " dominio="COMBOSUCURSALESCONVACIO       " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="BUZON                                   " atributo="ORIGENDEDATOS                           " tabla="HOST           " campo="HSUCORI   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ORIGENDEDATOS                           " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Destino                                                                                                                                                         " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="BUZON                                   " atributo="ESBUZONLINCE                            " tabla="HOST           " campo="HESLINCE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Destino Lince Indumentaria                                                                                                                                      " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="BUZON                                   " atributo="ORIGENFRANQUICIA                        " tabla="HOST           " campo="ORIGFRAN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ORIGENDEDATOS                           " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Origen                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="BUZON                                   " atributo="CLIENTEFRANQUICIA                       " tabla="HOST           " campo="CLIEFRAN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Cliente origen                                                                                                                                                  " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="BUZON                                   " atributo="PROVEEDORFRANQUICIA                     " tabla="HOST           " campo="PROVFRAN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Proveedor origen                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="40" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ORIGENDEDATOS                           " atributo="DESCRIPCION                             " tabla="ORDAT          " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="405" etiqueta="Detalle Des.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ORDAT On HOST.HSUCORI = ORDAT.CODIGO And  ORDAT.CODIGO != ''                                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="407" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On HOST.CLIENTE = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PROVEEDOR                               " atributo="NOMBRE                                  " tabla="PROV           " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="411" etiqueta="Detalle Pro.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join PROV On HOST.PROVEEDOR = PROV.CLCOD And  PROV.CLCOD != ''                                                                                                                                                                                          " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ORIGENDEDATOS                           " atributo="DESCRIPCION                             " tabla="ORDAT          " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="415" etiqueta="Detalle Ori.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ORDAT On HOST.ORIGFRAN = ORDAT.CODIGO And  ORDAT.CODIGO != ''                                                                                                                                                                                      " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="417" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On HOST.CLIEFRAN = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PROVEEDOR                               " atributo="NOMBRE                                  " tabla="PROV           " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="419" etiqueta="Detalle Pro.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join PROV On HOST.PROVFRAN = PROV.CLCOD And  PROV.CLCOD != ''                                                                                                                                                                                           " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
