...
define class Mock_Itemposautorizadoresicarddetalle as MockBase of MockBase.prg

	cClase = 'Itemposautorizadoresicarddetalle'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumeroequivalencia() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridonumeroequivalencia', lcParametros )
	EndFunc
