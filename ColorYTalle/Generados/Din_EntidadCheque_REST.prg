...
define class Din_EntidadCheque_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Cheque"
	cClaseResponse = this.cNamespaceDTOs + ".ChequeResponse"
	cClaseModelo = "ChequeModelo"
	cEntidad = "Cheque"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ChequeModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ChequeListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ChequeListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ChequeModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Nombrelibrador", toEntidad, "Nombrelibrador" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Telefonolibrador", toEntidad, "Telefonolibrador" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Codigotributariolibradorrut", toEntidad, "Codigotributariolibradorrut" )
			this.SetearAtributoModeloDateTimeEnEntidad( toModeloEnRequest, "Fechaendoso", toEntidad, "Fechaendoso" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Entidadfinancieraendoso", toEntidad, "Entidadfinancieraendoso_PK" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Autorizacionalfa", toEntidad, "Autorizacionalfa" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Cuentaendoso", toEntidad, "Cuentaendoso" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Leyendaendoso", toEntidad, "Leyendaendoso" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Paguesea", toEntidad, "Paguesea" )
		endwith
	endfunc
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "NombreLibrador", toEntidad.NombreLibrador)
			this.SetearAtributoString( toModeloResponse, "TelefonoLibrador", toEntidad.TelefonoLibrador)
			this.SetearAtributoString( toModeloResponse, "CodigoTributarioLibradorRUT", toEntidad.CodigoTributarioLibradorRUT)
			this.SetearAtributoDateTime( toModeloResponse, "FechaEndoso", toEntidad.FechaEndoso)
			this.SetearAtributoString( toModeloResponse, "EntidadFinancieraEndoso", toEntidad.EntidadFinancieraEndoso_PK)
			this.SetearAtributoString( toModeloResponse, "AutorizacionAlfa", toEntidad.AutorizacionAlfa)
			this.SetearAtributoString( toModeloResponse, "CuentaEndoso", toEntidad.CuentaEndoso)
			this.SetearAtributoString( toModeloResponse, "LeyendaEndoso", toEntidad.LeyendaEndoso)
			this.SetearAtributoString( toModeloResponse, "PagueseA", toEntidad.PagueseA)
		endwith
	endfunc
	...
	protected function CargarColeccionModeloHistorialDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .HistorialDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemChequehistorial" )
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Codigotributariolibrador", "CCOTRIBGIR")
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Nombrelibrador", "CGIRADOR")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Telefonolibrador", "CTELGIR")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Codigotributariolibradorrut", "CCOTRIBRUT")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Fechaendoso", "CFECEND")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Entidadfinancieraendoso", "CENTFINEND")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Autorizacionalfa", "CAUTOALFA")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Cuentaendoso", "CCTAENDOSO")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Leyendaendoso", "CLEYENDOSO")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Paguesea", "CPAGUESEA")
		return lcFiltro 
	endfunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerBusquedaSegunModeloRequest( toRequest as Object ) as String
		...
		if !isnull( lcExpresionBusqueda )
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ccotribgir LIKE '%" + lcExpresionBusqueda + "%'"
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Cgirador LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ctelgir LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ccotribrut LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Centfinend LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Cautoalfa LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Cctaendoso LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Cleyendoso LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Cpaguesea LIKE '%" + lcExpresionBusqueda + "%'"
		endif
