...
define class Din_EntidadTiinventarioacontdetalle_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Tiinventarioacontdetalle"
	cClaseResponse = this.cNamespaceDTOs + ".TiinventarioacontdetalleResponse"
	cClaseModelo = "TiinventarioacontdetalleModelo"
	cEntidad = "Tiinventarioacontdetalle"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventarioacontdetalleModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventarioacontdetalleListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventarioacontdetalleListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventarioacontdetalleModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributo( toModeloResponse, "Codigo", toEntidad.Codigo)
