...
define class Din_ItemNOTADEDEBITOELECTRONICAKitsdetalle as ItemKits of ItemKits.prg
		...
		if This.CargaManual()
			if this.Validar_Talledetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Talledetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de débito electrónica de venta - Atributo: Talledetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Talledetalle( lxVal ) 
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoColor() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "NOTADEDEBITOELECTRONICA", "Kitsdetalle", "Color" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
