...
define class Mock_edicionimpuestoivacompras as MockBase of MockBase.prg
	...
	cClase = 'edicionimpuestoivacompras'
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleimpuestoivac() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleimpuestoivac', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detalleimpuestoivac_access() as variant                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'EDICIONIMPUESTOIVACOMPRAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalleimpuestoivac_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalleimpuestoivac_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalleimpuestoivac ) = 'O' or isnull( this.Detalleimpuestoivac ) )			this.Detalleimpuestoivac = this.crearobjeto( 'Din_DetalleEdicionimpuestoivacomprasDetalleimpuestoivac' )			this.Detalleimpuestoivac.inicializar()			this.enlazar( 'Detalleimpuestoivac.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalleimpuestoivac.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalleimpuestoivac, 'CambioSumarizado', this, 'CambiosDetalleDetalleimpuestoivac', 1)			this.enlazar( 'Detalleimpuestoivac.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalleimpuestoivac.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detalleimpuestoivac
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarcomponentefiscal( tocomponente as componentefiscal of componentefiscal.prg ) as void                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocomponente
	...
	*-----------------------------------------------------------------------------------------
	function inyectardetalle( todetalle as zoocoleccion) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function nuevo( todetalle as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function antesdecancelar as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Antesdecancelar As Boolean', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function confirmahabilitarimpuestosmanuales() as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Confirmahabilitarimpuestosmanuales', lcParametros )
	EndFunc
