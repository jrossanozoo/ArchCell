...
define class Din_EntidadCAEAINFORMAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCaeainfFectrans, lxCaeainfFmodifw, lxCaeainfFaltafw, lxCaeainfFecexpo, lxCaeainfFecimpo, lxCaeainfHaltafw, lxCaeainfHoraexpo, lxCaeainfSaltafw, lxCaeainfHoraimpo, lxCaeainfVmodifw, lxCaeainfZadsfw, lxCaeainfValtafw, lxCaeainfUmodifw, lxCaeainfSmodifw, lxCaeainfUaltafw, lxCaeainfHmodifw, lxCaeainfEsttrans, lxCaeainfBdaltafw, lxCaeainfBdmodifw, lxCaeainfTimestamp, lxCaeainfCaea, lxCaeainfResultado2, lxCaeainfObsafip, lxCaeainfFechaproc2, lxCaeainfNumint, lxCaeainfVigenciad, lxCaeainfFecha, lxCaeainfVigenciah, lxCaeainfFechatope, lxCaeainfPtovta, lxCaeainfPeriodo, lxCaeainfQuincena, lxCaeainfCodigo
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CAEAINF ( "Fectrans","Fmodifw","Faltafw","Fecexpo","Fecimpo","Haltafw","Horaexpo","Saltafw","Horaimpo","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Esttrans","Bdaltafw","Bdmodifw","Timestamp","Caea","Resultado2","Obsafip","Fechaproc2","Numint","Vigenciad","Fecha","Vigenciah","Fechatope","Ptovta","Periodo","Quincena","Codigo" ) values ( <<"'" + this.ConvertirDateSql( lxCaeainfFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfBdmodifw ) + "'" >>, <<lxCaeainfTimestamp >>, <<lxCaeainfCaea >>, <<"'" + this.FormatearTextoSql( lxCaeainfResultado2 ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeainfObsafip ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfFechaproc2 ) + "'" >>, <<lxCaeainfNumint >>, <<"'" + this.ConvertirDateSql( lxCaeainfVigenciad ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfFecha ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfVigenciah ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeainfFechatope ) + "'" >>, <<lxCaeainfPtovta >>, <<"'" + this.FormatearTextoSql( lxCaeainfPeriodo ) + "'" >>, <<lxCaeainfQuincena >>, <<"'" + this.FormatearTextoSql( lxCaeainfCodigo ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CAEAINF set "Fectrans" = <<"'" + this.ConvertirDateSql( lxCaeainfFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCaeainfFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCaeainfFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCaeainfFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCaeainfFecimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCaeainfHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCaeainfHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCaeainfSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCaeainfHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCaeainfVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCaeainfZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCaeainfValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCaeainfUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCaeainfSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCaeainfUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCaeainfHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCaeainfEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCaeainfBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCaeainfBdmodifw ) + "'">>,"Timestamp" = <<lxCaeainfTimestamp>>,"Caea" = <<lxCaeainfCaea>>,"Resultado2" = <<"'" + this.FormatearTextoSql( lxCaeainfResultado2 ) + "'">>,"Obsafip" = <<"'" + this.FormatearTextoSql( lxCaeainfObsafip ) + "'">>,"Fechaproc2" = <<"'" + this.ConvertirDateSql( lxCaeainfFechaproc2 ) + "'">>,"Numint" = <<lxCaeainfNumint>>,"Vigenciad" = <<"'" + this.ConvertirDateSql( lxCaeainfVigenciad ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxCaeainfFecha ) + "'">>,"Vigenciah" = <<"'" + this.ConvertirDateSql( lxCaeainfVigenciah ) + "'">>,"Fechatope" = <<"'" + this.ConvertirDateSql( lxCaeainfFechatope ) + "'">>,"Ptovta" = <<lxCaeainfPtovta>>,"Periodo" = <<"'" + this.FormatearTextoSql( lxCaeainfPeriodo ) + "'">>,"Quincena" = <<lxCaeainfQuincena>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCaeainfCodigo ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCaeainfCodigo ) + "'">> and  CAEAINF.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fmodifw,Faltafw,Fecexpo,Fecimpo,Haltafw,Horaexpo,Saltafw,Horaimpo,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdaltafw,Bdmodifw,Timestamp,Caea,Resultado2,Obsafip,F" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FMODIFW, FALTAFW, FECEXPO, FECIMPO, HALTAFW, HORAEXPO, SALTAFW, HORAIMPO, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, ESTTRANS, BDALTAFW, BDMODIFW, TIMESTAMP, CAEA, Resultado2, ObsAfip, FechaProc2, NumInt, VigenciaD, FECHA, VigenciaH, FechaTope, PtoVta, Periodo, Quincena, Codigo
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..CAEA )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CAEA = isnull( d.CAEA, t.CAEA ),t.RESULTADO2 = isnull( d.RESULTADO2, t.RESULTADO2 ),t.OBSAFIP = isnull( d.OBSAFIP, t.OBSAFIP ),t.FECHAPROC2 = isnull( d.FECHAPROC2, t.FECHAPROC2 ),t.NUMINT = isnull( d.NUMINT, t.NUMINT ),t.VIGENCIAD = isnull( d.VIGENCIAD, t.VIGENCIAD ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.VIGENCIAH = isnull( d.VIGENCIAH, t.VIGENCIAH ),t.FECHATOPE = isnull( d.FECHATOPE, t.FECHATOPE ),t.PTOVTA = isnull( d.PTOVTA, t.PTOVTA ),t.PERIODO = isnull( d.PERIODO, t.PERIODO ),t.QUINCENA = isnull( d.QUINCENA, t.QUINCENA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO )
					from ZooLogic.CAEAINF t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.CAEAINF(Fectrans,Fmodifw,Faltafw,Fecexpo,Fecimpo,Haltafw,Horaexpo,Saltafw,Horaimpo,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdaltafw,Bdmodifw,Timestamp,Caea,Resultado2,Obsafip,Fechaproc2,Numint,Vigenciad,Fecha,Vigenciah,Fechatope,Ptovta,Periodo,Quincena,Codigo)
					Select isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.CAEA,0),isnull( d.RESULTADO2,''),isnull( d.OBSAFIP,''),isnull( d.FECHAPROC2,''),isnull( d.NUMINT,0),isnull( d.VIGENCIAD,''),isnull( d.FECHA,''),isnull( d.VIGENCIAH,''),isnull( d.FECHATOPE,''),isnull( d.PTOVTA,0),isnull( d.PERIODO,''),isnull( d.QUINCENA,0),isnull( d.CODIGO,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CAEAINFORMA                             " atributo="FECHATRANSFERENCIA                      " tabla="CAEAINF        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAEAINFORMA                             " atributo="ESTADOTRANSFERENCIA                     " tabla="CAEAINF        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
