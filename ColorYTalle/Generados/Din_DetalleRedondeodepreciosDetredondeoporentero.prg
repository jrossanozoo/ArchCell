		...
		for lni = 1 to this.Count
			...
			if vartype( this.Item[lni].DESDE) = 'N'
				...
				if lnLargoEntero <= 15
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo DESDE del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:15), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].HASTA) = 'N'
				...
				if lnLargoEntero <= 15
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo HASTA del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:15), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].TERMINACION) = 'N'
				...
				if lnLargoEntero <= 15
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo TERMINACION del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:15), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
