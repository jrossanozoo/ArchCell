...
define class Din_EntidadPuntosdeventa_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Puntosdeventa"
	cClaseResponse = this.cNamespaceDTOs + ".PuntosdeventaResponse"
	cClaseModelo = "PuntosdeventaModelo"
	cEntidad = "Puntosdeventa"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "PuntosdeventaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "PuntosdeventaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "PuntosdeventaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "PuntosdeventaModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Puntodeventasugerido", toEntidad, "Puntodeventasugerido" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Bocadeexpendio", toEntidad, "Bocadeexpendio" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributo( toModeloResponse, "PuntoDeVentaSugerido", toEntidad.PuntoDeVentaSugerido)
			this.SetearAtributoInteger( toModeloResponse, "BocaDeExpendio", toEntidad.BocaDeExpendio)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Puntodeventa", "PTO")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Puntodeventasugerido", "PVSUG")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Bocadeexpendio", "BOCAEXP")
