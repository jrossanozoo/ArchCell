...
define class Din_EntidadRemito_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Remito"
	cClaseResponse = this.cNamespaceDTOs + ".RemitoResponse"
	cClaseModelo = "RemitoModelo"
	cEntidad = "Remito"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "RemitoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "RemitoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "RemitoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "RemitoModelo"
		endcase
		return lcRetorno
