...
define class Din_EntidadEntidadadicional2_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Entidadadicional2"
	cClaseResponse = this.cNamespaceDTOs + ".Entidadadicional2Response"
	cClaseModelo = "Entidadadicional2Modelo"
	cEntidad = "Entidadadicional2"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional2Modelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional2ListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional2ListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional2Modelo"
		endcase
		return lcRetorno
