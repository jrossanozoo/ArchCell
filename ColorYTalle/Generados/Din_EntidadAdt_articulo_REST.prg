...
define class Din_EntidadAdt_articulo_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Adt_articulo"
	cClaseResponse = this.cNamespaceDTOs + ".Adt_articuloResponse"
	cClaseModelo = "Adt_articuloModelo"
	cEntidad = "Adt_articulo"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_articuloModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_articuloListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_articuloListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_articuloModelo"
		endcase
		return lcRetorno
