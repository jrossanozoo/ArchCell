...
define class Mock_Itemtallerprocesos as MockBase of MockBase.prg

	cClase = 'Itemtallerprocesos'
	...
	*-----------------------------------------------------------------------------------------
	function inventarioentrada_access() as variant                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Inventarioentrada_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventarioentrada_pk_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Inventarioentrada_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariosalida_access() as variant                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Inventariosalida_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariosalida_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Inventariosalida_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesodescripcion_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Procesodescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventarioentrada( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_inventarioentrada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventariosalida( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_inventariosalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_procesodescripcion( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_procesodescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventarioentrada( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_inventarioentrada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventariosalida( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_inventariosalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_procesodescripcion( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_procesodescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinventarioentrada() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoinventarioentrada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinventariosalida() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridoinventariosalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprocesodescripcion() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridoprocesodescripcion', lcParametros )
	EndFunc
