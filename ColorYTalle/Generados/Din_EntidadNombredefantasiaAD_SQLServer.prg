...
define class Din_EntidadNOMBREDEFANTASIAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxNomfantFecexpo, lxNomfantFmodifw, lxNomfantFecimpo, lxNomfantFaltafw, lxNomfantFectrans, lxNomfantSmodifw, lxNomfantSaltafw, lxNomfantUaltafw, lxNomfantValtafw, lxNomfantUmodifw, lxNomfantZadsfw, lxNomfantVmodifw, lxNomfantHmodifw, lxNomfantHoraexpo, lxNomfantHoraimpo, lxNomfantBdmodifw, lxNomfantHaltafw, lxNomfantEsttrans, lxNomfantBdaltafw, lxNomfantNfobs, lxNomfantNfcod, lxNomfantNfnomf
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.NOMFANT ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaexpo","Horaimpo","Bdmodifw","Haltafw","Esttrans","Bdaltafw","Nfobs","Nfcod","Nfnomf" ) values ( <<"'" + this.ConvertirDateSql( lxNomfantFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNomfantFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNomfantFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNomfantFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNomfantFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantNfobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantNfcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNomfantNfnomf ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.NOMFANT set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxNomfantFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxNomfantFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxNomfantFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxNomfantFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxNomfantFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxNomfantSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxNomfantSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxNomfantUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxNomfantValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxNomfantUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxNomfantZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxNomfantVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxNomfantHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxNomfantHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxNomfantHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxNomfantBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxNomfantHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxNomfantEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxNomfantBdaltafw ) + "'">>,"Nfobs" = <<"'" + this.FormatearTextoSql( lxNomfantNfobs ) + "'">>,"Nfcod" = <<"'" + this.FormatearTextoSql( lxNomfantNfcod ) + "'">>,"Nfnomf" = <<"'" + this.FormatearTextoSql( lxNomfantNfnomf ) + "'">> where "Nfcod" = <<"'" + this.FormatearTextoSql( lxNomfantNfcod ) + "'">> and  NOMFANT.NFCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Nfobs" as "Observacion", "Nfcod" as "Codigo", "Nfnomf" as "Nombrefantasia" from ZooLogic.NOMFANT where  NOMFANT.NFCOD != '' order by NFCOD
			endtext
			use in select('c_NOMBREDEFANTASIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMBREDEFANTASIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Nfobs" as "Observacion", "Nfcod" as "Codigo", "Nfnomf" as "Nombrefantasia" from ZooLogic.NOMFANT where  funciones.padr( NFCOD, 50, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NOMFANT.NFCOD != '' order by NFCOD
			endtext
			use in select('c_NOMBREDEFANTASIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMBREDEFANTASIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Nfobs" as "Observacion", "Nfcod" as "Codigo", "Nfnomf" as "Nombrefantasia" from ZooLogic.NOMFANT where  funciones.padr( NFCOD, 50, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NOMFANT.NFCOD != '' order by NFCOD desc
			endtext
			use in select('c_NOMBREDEFANTASIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMBREDEFANTASIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Nfobs" as "Observacion", "Nfcod" as "Codigo", "Nfnomf" as "Nombrefantasia" from ZooLogic.NOMFANT where  NOMFANT.NFCOD != '' order by NFCOD desc
			endtext
			use in select('c_NOMBREDEFANTASIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMBREDEFANTASIA', set( 'Datasession' ) )
			local lcSentencia as string
...
"ifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Haltafw,Esttrans,Bdaltafw,Nfobs,Nfcod,Nfnomf" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Nfobs" as "Observacion", "Nfcod" as "Codigo", "Nfnomf" as "Nombrefantasia"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.NOMFANT set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, NFOBS = ] + "'" + this.FormatearTextoSql( &lcCursor..NFOBS ) + "'"+ [, NFCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..NFCOD ) + "'"+ [, NFNOMF = ] + "'" + this.FormatearTextoSql( &lcCursor..NFNOMF ) + "'" + [ Where NFCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..NFCOD ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAEXPO, HORAIMPO, BDMODIFW, HALTAFW, ESTTRANS, BDALTAFW, NFOBS, NFCOD, NFNOMF
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..NFOBS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..NFCOD ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function CrearCursorMemo( tcCursorACrear as String, tcTablaConMemo as String ) as Void
		create cursor &tcCursorACrear ( NFCOD C (50) , Orden N(16), texto C(80))
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function ObtenerIdentificadorParaLoguear( tcCursor as String ) As String
		...
		lcRetorno = lcRetorno + ' - Nombre: ' + transform( &tcCursor..NFCOD      )
		Return lcRetorno
	endfunc
	*--------------------------------------------------------------------------------------------------------
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.NFOBS = isnull( d.NFOBS, t.NFOBS ),t.NFCOD = isnull( d.NFCOD, t.NFCOD ),t.NFNOMF = isnull( d.NFNOMF, t.NFNOMF )
					from ZooLogic.NOMFANT t inner join deleted d 
							 on t.NFCOD = d.NFCOD
				-- Fin Updates
				insert into ZooLogic.NOMFANT(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Haltafw,Esttrans,Bdaltafw,Nfobs,Nfcod,Nfnomf)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.NFOBS,''),isnull( d.NFCOD,''),isnull( d.NFNOMF,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOMBREDEFANTASIA                        " atributo="FECHATRANSFERENCIA                      " tabla="NOMFANT        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOMBREDEFANTASIA                        " atributo="ESTADOTRANSFERENCIA                     " tabla="NOMFANT        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOMBREDEFANTASIA                        " atributo="CODIGO                                  " tabla="NOMFANT        " campo="NFCOD     " claveprimaria="true" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="1" etiqueta="Nombre                                                                                                                                                          " dominio="CODIGOSINMUESTRARELACION      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOMBREDEFANTASIA                        " atributo="NOMBREFANTASIA                          " tabla="NOMFANT        " campo="NFNOMF    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="NombreF                                                                                                                                                         " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
