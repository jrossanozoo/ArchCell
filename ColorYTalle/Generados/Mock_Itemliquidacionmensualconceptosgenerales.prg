...
define class Mock_Itemliquidacionmensualconceptosgenerales as MockBase of MockBase.prg

	cClase = 'Itemliquidacionmensualconceptosgenerales'
	...
	*-----------------------------------------------------------------------------------------
	function setear_subdiarioiva( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_subdiarioiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function subdiarioiva_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Subdiarioiva_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_subdiarioiva( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_subdiarioiva', lcParametros )
	EndFunc
