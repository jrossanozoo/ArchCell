...
define class Mock_liquidaciondetaller as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambioitem() as void                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cambioitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallegestiondeproduccion() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Cambiosdetallegestiondeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleliquidaciontalleradicionales() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cambiosdetalleliquidaciontalleradicionales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleliquidaciontallerdescarte() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cambiosdetalleliquidaciontallerdescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleliquidaciontallerinsumos() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Cambiosdetalleliquidaciontallerinsumos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleliquidaciontallerproduccion() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cambiosdetalleliquidaciontallerproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajesinespera( tcmensaje as string ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Eventomensajesinespera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntaractualizardetalles() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Eventopreguntaractualizardetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function gestiondesde_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'gestiondesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'gestiondesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Gestiondesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Gestiondesde( lxVal )				this.Setear_Gestiondesde( lxVal )			EndIf		Else			This.Setear_Gestiondesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function gestionhasta_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'gestionhasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'gestionhasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Gestionhasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Gestionhasta( lxVal )				this.Setear_Gestionhasta( lxVal )			EndIf		Else			This.Setear_Gestionhasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ordendesde_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ordendesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ordendesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ordendesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ordendesde( lxVal )				this.Setear_Ordendesde( lxVal )			EndIf		Else			This.Setear_Ordendesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ordenhasta_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ordenhasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ordenhasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ordenhasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ordenhasta( lxVal )				this.Setear_Ordenhasta( lxVal )			EndIf		Else			This.Setear_Ordenhasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_gestiondesde( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_gestiondesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_gestiondesde', lcParametros )			endif		endif		dodefault( txVal )		this.TrasladarFiltros()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_gestionhasta( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_gestionhasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_gestionhasta', lcParametros )			endif		endif		dodefault( txVal )		this.TrasladarFiltros()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ordendesde( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ordendesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ordendesde', lcParametros )			endif		endif		dodefault( txVal )		this.TrasladarFiltros()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_ordenhasta( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ordenhasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ordenhasta', lcParametros )			endif		endif		dodefault( txVal )		this.TrasladarFiltros()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_procesodesde( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_procesodesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_procesodesde', lcParametros )			endif		endif		dodefault( txVal )		this.TrasladarFiltros()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_procesohasta( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_procesohasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_procesohasta', lcParametros )			endif		endif		dodefault( txVal )		this.TrasladarFiltros()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function trasladarfiltros()                                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Trasladarfiltros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_gestiondesde( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_gestiondesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_gestiondesde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_gestionhasta( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_gestionhasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_gestionhasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ordendesde( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ordendesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ordendesde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_ordenhasta( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ordenhasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ordenhasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_procesodesde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_procesodesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_procesodesde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_procesohasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDETALLER' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_procesohasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_procesohasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarprocesodesde() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarprocesodesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarprocesohasta() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarprocesohasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocomprobante() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcomprobante() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridofwcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwgestiondesde() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwgestiondesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwgestionhasta() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwgestionhasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwordendesde() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwordendesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwordenhasta() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwordenhasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwprocesohasta() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwprocesohasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridogestiondesde() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridogestiondesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridogestionhasta() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridogestionhasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoordendesde() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridoordendesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoordenhasta() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridoordenhasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprocesodesde() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoprocesodesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprocesohasta() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoprocesohasta', lcParametros )
	EndFunc
