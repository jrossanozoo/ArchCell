...
define class Mock_Itemgestionchcustodiadetallechcustodia as MockBase of MockBase.prg

	cClase = 'Itemgestionchcustodiadetallechcustodia'
	...
	*-----------------------------------------------------------------------------------------
	function cuitlibrador_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cuitlibrador_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function entidadfinancieradescripcion_assign( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Entidadfinancieradescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechapago_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Fechapago_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idcheque_access() as variant                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Idcheque_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idcheque_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Idcheque_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cuitlibrador( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_cuitlibrador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_entidadfinancieradescripcion( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_entidadfinancieradescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechapago( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_fechapago', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idcheque( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_idcheque', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cuitlibrador( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_cuitlibrador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_entidadfinancieradescripcion( txval as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_entidadfinancieradescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechapago( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_fechapago', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idcheque( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_idcheque', lcParametros )
	EndFunc
