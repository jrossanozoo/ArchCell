...
define class Mock_COLORYTALLE_SERVICIOPERSONALIZACIONDEENTIDADES as MockBase of MockBase.prg

	cClase = 'COLORYTALLE_SERVICIOPERSONALIZACIONDEENTIDADES'

	
	cCurSorAtributosConSaltoDeCampo = ""                                                                                                                                                                                                                      
	cCursorAtributosForaneos = ""                                                                                                                                                                                                                             
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	lEsExe = .f.                                                                                                                                                                                                                                              
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionatributosinvisibles( tcentidad as string ) as object                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercoleccionatributosinvisibles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccioncomportamientodeetiquetaspersonalizadas( tcentidad as string ) as object                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenercoleccioncomportamientodeetiquetaspersonalizadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionetiquetaspersonalizadas() as object                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercoleccionetiquetaspersonalizadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdenominacioncortadeentidad( tcentidad as string ) as string                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerdenominacioncortadeentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdenominacionpluraldeentidad( tcentidad as string ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerdenominacionpluraldeentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdenominacionsingulardeentidad( tcentidad as string ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerdenominacionsingulardeentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerentidadesaocultar() as object                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerentidadesaocultar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolcomportamientoentidadespersonalizadas_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Ocolcomportamientoentidadespersonalizadas_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function refrescarpersonalizaciones() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Refrescarpersonalizaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomportamientodeentidad( tcentidad as string ) as object                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercomportamientodeentidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursoratributosconsaltodecampo() as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercursoratributosconsaltodecampo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obteneritemdeatributoforaneo( tcclaveforanea as string, tcdetalle as string, tcentidad as string ) as object                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obteneritemdeatributoforaneo', lcParametros )
	EndFunc
