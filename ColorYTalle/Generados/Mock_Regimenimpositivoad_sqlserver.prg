...
define class Mock_Regimenimpositivoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Regimenimpositivoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubreg( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubreg', lcParametros )
	EndFunc
