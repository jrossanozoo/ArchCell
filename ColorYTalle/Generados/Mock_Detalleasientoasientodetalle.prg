...
define class Mock_Detalleasientoasientodetalle as MockBase of MockBase.prg

	cClase = 'Detalleasientoasientodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_debe() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eventocambiosum_debe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_haber() as boolean                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Eventocambiosum_haber', lcParametros )
	EndFunc
