...
define class Din_EntidadTicketnotadedebito_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Ticketnotadedebito"
	cClaseResponse = this.cNamespaceDTOs + ".TicketnotadedebitoResponse"
	cClaseModelo = "TicketnotadedebitoModelo"
	cEntidad = "Ticketnotadedebito"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadedebitoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadedebitoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadedebitoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadedebitoModelo"
		endcase
		return lcRetorno
