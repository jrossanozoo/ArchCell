...
define class Mock_Detallefacturaelectronicadecreditoimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Detallefacturaelectronicadecreditoimpuestosdetalle'
