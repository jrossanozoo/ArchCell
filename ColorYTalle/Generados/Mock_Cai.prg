...
define class Mock_cai as MockBase of MockBase.prg
	...
	cContexto = ""                                                                                                                                                                                                                                            
	cCuit = ""                                                                                                                                                                                                                                                
	cDescripcion =  "Códigos de autorización de impresión - CAI"                                                                                                                                                                                              
	...
	*-----------------------------------------------------------------------------------------
	    function ocodigobarra_access() as object                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CAI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocodigobarra_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocodigobarra_access', lcParametros )			endif		endifif !this.ldestroy and ( !vartype( this.oCodigoBarra ) = 'O' or isnull( this.oCodigoBarra ) )this.oCodigoBarra = this.crearobjeto( 'CodigoDeBarrasComprobante' )endifreturn this.oCodigoBarra
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function caidetalle_access() as variant                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CAI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'caidetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'caidetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Caidetalle ) = 'O' or isnull( this.Caidetalle ) )			this.Caidetalle = this.crearobjeto( 'Din_DetalleCaiCaidetalle' )			this.Caidetalle.inicializar()			this.enlazar( 'Caidetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Caidetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Caidetalle, 'CambioSumarizado', this, 'CambiosDetalleCaidetalle', 1)			this.enlazar( 'Caidetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Caidetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Caidetalle
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallecaidetalle() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallecaidetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatoscai( tccodigo as string, tdfecha as date, tnnumero as integer ) as object                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenerdatoscai', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarfechasvencimientocai() as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechasvencimientocai', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarobligatorioscai() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarobligatorioscai', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarrangosnumeroscai() as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarrangosnumeroscai', lcParametros )
	EndFunc
