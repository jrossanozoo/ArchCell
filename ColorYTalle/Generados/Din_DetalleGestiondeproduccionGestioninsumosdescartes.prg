...
define class Din_DetalleGESTIONDEPRODUCCIONGestioninsumosdescartes as DetalleBaseproduccion of DetalleBaseproduccion.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemGESTIONDEPRODUCCIONGestioninsumosdescartes' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Gestioninsumosdescartes
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Gestioninsumosdescartes.Codigo
			loItem.Comportamiento = c_Gestioninsumosdescartes.Comportamiento
			loItem.IdItemInsumo = c_Gestioninsumosdescartes.IdItemInsumo
			loItem.NROITEM = c_Gestioninsumosdescartes.NROITEM
			loItem.Articulo_PK = c_Gestioninsumosdescartes.Articulo
			loItem.ArticuloDetalle = c_Gestioninsumosdescartes.ArticuloDetalle
			loItem.ColorM_PK = c_Gestioninsumosdescartes.ColorM
			loItem.ColorMDetalle = c_Gestioninsumosdescartes.ColorMDetalle
			loItem.TalleM_PK = c_Gestioninsumosdescartes.TalleM
			loItem.TalleMDetalle = c_Gestioninsumosdescartes.TalleMDetalle
			loItem.Insumo_PK = c_Gestioninsumosdescartes.Insumo
			loItem.InsumoDetalle = c_Gestioninsumosdescartes.InsumoDetalle
			loItem.Color_PK = c_Gestioninsumosdescartes.Color
			loItem.ColorDetalle = c_Gestioninsumosdescartes.ColorDetalle
			loItem.Talle_PK = c_Gestioninsumosdescartes.Talle
			loItem.TalleDetalle = c_Gestioninsumosdescartes.TalleDetalle
			loItem.Partida = c_Gestioninsumosdescartes.Partida
			loItem.Cantidad = c_Gestioninsumosdescartes.Cantidad
			loItem.NroItem = lnI 
