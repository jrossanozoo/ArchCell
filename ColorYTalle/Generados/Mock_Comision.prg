...
define class Mock_comision as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cargarconformacioncomision() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cargarconformacioncomision', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function conformacion1_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'conformacion1_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'conformacion1_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Conformacion1		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Conformacion1( lxVal )				this.Setear_Conformacion1( lxVal )			EndIf		Else			This.Setear_Conformacion1( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function conformacion2_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'conformacion2_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'conformacion2_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Conformacion2		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Conformacion2( lxVal )				this.Setear_Conformacion2( lxVal )			EndIf		Else			This.Setear_Conformacion2( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montofijo_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'montofijo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'montofijo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Montofijo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Montofijo( lxVal )				this.Setear_Montofijo( lxVal )			EndIf		Else			This.Setear_Montofijo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_conformacion1( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_conformacion1', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_conformacion1', lcParametros )			endif		endif		this.Conformacion1 = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_conformacion2( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_conformacion2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_conformacion2', lcParametros )			endif		endif		this.Conformacion2 = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_categoria_desde( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_categoria_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_categoria_desde', lcParametros )			endif		endif		this.F_cliente_categoria_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_categoria_hasta( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_categoria_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_categoria_hasta', lcParametros )			endif		endif		this.F_cliente_categoria_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_clasificacion_desde( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_clasificacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_clasificacion_desde', lcParametros )			endif		endif		this.F_cliente_clasificacion_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_clasificacion_hasta( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_clasificacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_clasificacion_hasta', lcParametros )			endif		endif		this.F_cliente_clasificacion_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_nfantasia_desde( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_nfantasia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_nfantasia_desde', lcParametros )			endif		endif		this.F_cliente_nfantasia_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_nfantasia_hasta( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_nfantasia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_nfantasia_hasta', lcParametros )			endif		endif		this.F_cliente_nfantasia_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_tipo_desde( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_tipo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_tipo_desde', lcParametros )			endif		endif		this.F_cliente_tipo_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_tipo_hasta( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_tipo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_tipo_hasta', lcParametros )			endif		endif		this.F_cliente_tipo_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_listadeprecio_codigo_desde( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_listadeprecio_codigo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_listadeprecio_codigo_desde', lcParametros )			endif		endif		this.F_listadeprecio_codigo_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_listadeprecio_codigo_hasta( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_listadeprecio_codigo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_listadeprecio_codigo_hasta', lcParametros )			endif		endif		this.F_listadeprecio_codigo_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_codigo_desde( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_codigo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_codigo_desde', lcParametros )			endif		endif		this.F_sucursal_codigo_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_codigo_hasta( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_codigo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_codigo_hasta', lcParametros )			endif		endif		this.F_sucursal_codigo_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_linea_desde( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_linea_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_linea_desde', lcParametros )			endif		endif		this.F_sucursal_linea_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_linea_hasta( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_linea_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_linea_hasta', lcParametros )			endif		endif		this.F_sucursal_linea_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_segmentacion_desde( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_segmentacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_segmentacion_desde', lcParametros )			endif		endif		this.F_sucursal_segmentacion_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_segmentacion_hasta( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_segmentacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_segmentacion_hasta', lcParametros )			endif		endif		this.F_sucursal_segmentacion_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_tipo_desde( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_tipo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_tipo_desde', lcParametros )			endif		endif		this.F_sucursal_tipo_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_tipo_hasta( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_tipo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_tipo_hasta', lcParametros )			endif		endif		this.F_sucursal_tipo_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechavigenciadesde( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechavigenciadesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechavigenciadesde', lcParametros )			endif		endif		this.Fechavigenciadesde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_fechavigenciahasta( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechavigenciahasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechavigenciahasta', lcParametros )			endif		endif		this.Fechavigenciahasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montofijo( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_montofijo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_montofijo', lcParametros )			endif		endif		this.Montofijo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_conformacion1( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_conformacion1', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_conformacion1', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_conformacion2( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_conformacion2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_conformacion2', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_categoria_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_categoria_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_categoria_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_categoria_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_categoria_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_categoria_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_clasificacion_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_clasificacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_clasificacion_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_clasificacion_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_clasificacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_clasificacion_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_nfantasia_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_nfantasia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_nfantasia_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_nfantasia_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_nfantasia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_nfantasia_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_tipo_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_tipo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_tipo_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_tipo_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_tipo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_tipo_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_listadeprecio_codigo_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_listadeprecio_codigo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_listadeprecio_codigo_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_listadeprecio_codigo_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_listadeprecio_codigo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_listadeprecio_codigo_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_codigo_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_codigo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_codigo_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_codigo_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_codigo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_codigo_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_linea_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_linea_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_linea_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_linea_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_linea_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_linea_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_segmentacion_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_segmentacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_segmentacion_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_segmentacion_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_segmentacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_segmentacion_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_tipo_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_tipo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_tipo_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_tipo_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_tipo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_tipo_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montofijo( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_montofijo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_montofijo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcomision() as boolean                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validarcomision', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_categoria_desde() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarf_cliente_categoria_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_categoria_hasta() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarf_cliente_categoria_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_clasificacion_desde() as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarf_cliente_clasificacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_clasificacion_hasta() as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarf_cliente_clasificacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_nfantasia_desde() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarf_cliente_nfantasia_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_nfantasia_hasta() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarf_cliente_nfantasia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_tipo_desde() as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarf_cliente_tipo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_tipo_hasta() as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarf_cliente_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_listadeprecio_codigo_desde() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarf_listadeprecio_codigo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_listadeprecio_codigo_hasta() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarf_listadeprecio_codigo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_codigo_desde() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarf_sucursal_codigo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_codigo_hasta() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarf_sucursal_codigo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_linea_desde() as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarf_sucursal_linea_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_linea_hasta() as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarf_sucursal_linea_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_segmentacion_desde() as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarf_sucursal_segmentacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_segmentacion_hasta() as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarf_sucursal_segmentacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_tipo_desde() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarf_sucursal_tipo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_tipo_hasta() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarf_sucursal_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechavigenciadesde() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validarfechavigenciadesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechavigenciahasta() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validarfechavigenciahasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_categoria_desde() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_categoria_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_categoria_hasta() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_categoria_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_clasificacion_desde() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_clasificacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_clasificacion_hasta() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_clasificacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_nfantasia_desde() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_nfantasia_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_nfantasia_hasta() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_nfantasia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_tipo_desde() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_tipo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_tipo_hasta() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_listadeprecio_codigo_desde() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_listadeprecio_codigo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_listadeprecio_codigo_hasta() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_listadeprecio_codigo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_codigo_desde() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_codigo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_codigo_hasta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_codigo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_linea_desde() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_linea_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_linea_hasta() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_linea_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_segmentacion_desde() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_segmentacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_segmentacion_hasta() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_segmentacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_tipo_desde() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_tipo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_tipo_hasta() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechavigenciadesde() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofechavigenciadesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechavigenciahasta() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofechavigenciahasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_cliente_categoria_hasta() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_cliente_categoria_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_cliente_clasificacion_hasta() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_cliente_clasificacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_cliente_nfantasia_hasta() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_cliente_nfantasia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_cliente_tipo_hasta() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_cliente_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_listadeprecio_codigo_hasta() as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_listadeprecio_codigo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_sucursal_codigo_hasta() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_sucursal_codigo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_sucursal_linea_hasta() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_sucursal_linea_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_sucursal_segmentacion_hasta() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_sucursal_segmentacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_sucursal_tipo_hasta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_sucursal_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechavigenciadesde() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechavigenciadesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechavigenciahasta() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechavigenciahasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomontofijo() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridomontofijo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercadena( tccadena as string, tccantidadmaxima as string, tcdelimitador as string ) as string                                                                                                                                     
		...
		lnParametros = pcount()
		lxParam1 = tccadena
		lxParam2 = tccantidadmaxima
		lxParam3 = tcdelimitador
		...
		return this.ObtenerResultado( 'Obtenercadena', lcParametros )
	EndFunc
