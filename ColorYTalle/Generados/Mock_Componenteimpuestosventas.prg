...
define class Mock_COMPONENTEIMPUESTOSVENTAS as MockBase of MockBase.prg

	cClase = 'COMPONENTEIMPUESTOSVENTAS'
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Obtenercoeficientefinanciero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calcular( toitem as itemarticulosventa of itemarticulosventa.prg, todetalleimpuestos as object ) as void                                                                                                                                         
		...
		return this.ObtenerResultado( 'Calcular', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calcularimpuestoenbaseagravamen( todetalle as detalle of detalle.prg, tocolimpuestos as zoocoleccion of zoocoleccion.prg ) as void                                                                                                               
		...
		return this.ObtenerResultado( 'Calcularimpuestoenbaseagravamen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardetalleimpuestosaccioncancelatoria() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cargardetalleimpuestosaccioncancelatoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigocliente_assign( txvalor as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Codigocliente_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debecalculariibbcabaseguncorrespondepornormativaagip( toimpuesto as object ) as boolean                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Debecalculariibbcabaseguncorrespondepornormativaagip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debecalculariibbgba( toimpuesto as object ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Debecalculariibbgba', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debecalculariibbtucuman( toimpuesto as object ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Debecalculariibbtucuman', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esagentedepercepcion() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Esagentedepercepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esagentedepercepcionseguntipodeimpuesto( tctipoimpuesto as string ) as boolean                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Esagentedepercepcionseguntipodeimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoadvertirquenosecalcularanpercepcionesdeiibb( toresolucion as collection ) as void                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventoadvertirquenosecalcularanpercepcionesdeiibb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocargardetalleimpuestosdesdefactura() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Eventocargardetalleimpuestosdesdefactura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocargarporcentajedescuentorecargo() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventocargarporcentajedescuentorecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoseteardatosadicionalesparacalculodeimpuestos( tcjurisdiccion as string ) as void                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Eventoseteardatosadicionalesparacalculodeimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function jurisdiccionexcluido( toimpuestos as object, tccondicion ) as boolean                                                                                                                                                                            
		...
		lnParametros = pcount()
		lxParam1 = toimpuestos
		lxParam2 = tccondicion
		...
		return this.ObtenerResultado( 'Jurisdiccionexcluido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbasedecalculo( toitemimpuesto, tocomprobante ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerbasedecalculo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermontobasecomprobante( tcbasedecalculo, todetalle ) as float                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenermontobasecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermontosimpuestosiva( tocolmontosimpuestos, todetalle as object, tocolimpuestos as object, toimpuesto as object, tcclaveitemencoleccion as string ) as collection                                                                           
		...
		lnParametros = pcount()
		lxParam1 = tocolmontosimpuestos
		lxParam2 = todetalle
		lxParam3 = tocolimpuestos
		lxParam4 = toimpuesto
		lxParam5 = tcclaveitemencoleccion
		...
		return this.ObtenerResultado( 'Obtenermontosimpuestosiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerporcentajesdeimpuestos( toitem as din_facturaitemfacturadetalle of din_facturaitemfacturadetalle.prg ) as float                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerporcentajesdeimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocliente_access() as variant                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Ocliente_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oentidaddatosfiscales_access() as object                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Oentidaddatosfiscales_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oimpuesto_access() as variant                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Oimpuesto_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recalcularimpuestosporcambiodeneto( tntotalneto as integer, todetalle as detalle of detalle.prg, tncoeficientenetogravadoiva as number, tncoeficienteparaaplicaciondepercepcionesiva as number ) as void                                         
		...
		lxParam2 = todetalle
		lxParam3 = tncoeficientenetogravadoiva
		lxParam4 = tncoeficienteparaaplicaciondepercepcionesiva
	...
	*-----------------------------------------------------------------------------------------
	function restaurarcoleccionimpuestoscomprobante() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Restaurarcoleccionimpuestoscomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sacarjurisdiccionesexcluidas() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Sacarjurisdiccionesexcluidas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sacarpercepcionesconporcentajeencero() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Sacarpercepcionesconporcentajeencero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nsituacionfiscalcliente( txvalor ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_nsituacionfiscalcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcoleccionimpuestos() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarcoleccionimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarimpuestodeclienteencoleccionseguntipo( tctipoimpuesto as string, tccodigoimpuesto as string ) as void                                                                                                                        
		...
		return this.ObtenerResultado( 'Actualizarimpuestodeclienteencoleccionseguntipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarimpuestoacoleccion( toitemimpuesto as object ) as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Agregarimpuestoacoleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarimpuestoacoleccionbase( toitemimpuesto as object ) as void                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Agregarimpuestoacoleccionbase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregaritemacolecciondeimpuestosporarticulo( toitem, tckey ) as void                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Agregaritemacolecciondeimpuestosporarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregaritemimpuestosporarticulo( tnitemarticulo as integer ) as object                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Agregaritemimpuestosporarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregartipoimpuestosegunsituacionfiscal() as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Agregartipoimpuestosegunsituacionfiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregartipoimpuestoseguntipoconvenio( toitemimpuesto as object ) as boolean                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Agregartipoimpuestoseguntipoconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function aplicar() as boolean                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Aplicar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function aplicarpercepcion() as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Aplicarpercepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardetalleimpuestos() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Cargardetalleimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardetalleimpuestosbase() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Cargardetalleimpuestosbase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardetalleimpuestoscomprobante() as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cargardetalleimpuestoscomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function darformatoresolucion( tcdescripcion as string, tnporcentaje as integer ) as string                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Darformatoresolucion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debecalcularpercepcionennotasdecreditodecaba( toitemimpuesto as object ) as boolean                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Debecalcularpercepcionennotasdecreditodecaba', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function impuestoscliente()                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Impuestoscliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemimpuestosporarticulo( tnitemarticulo as integer ) as object                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obteneritemimpuestosporarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarimpuestos( tccampo as string, tlsuma as boolean ) as integer                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Procesarimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function quitarimpuestodecoleccionseguntipo( tctipoimpuesto as string ) as void                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Quitarimpuestodecoleccionseguntipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function restaurarporcentajesiibb() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Restaurarporcentajesiibb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function sacarpercepcioneslocalesdelcliente( tocliente as object ) as void                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Sacarpercepcioneslocalesdelcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearenimpuestosdelacoleccionsidebencalcular() as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setearenimpuestosdelacoleccionsidebencalcular', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearmontoimpuesto( tcclaveitemencoleccion as string, tnmonto as number, tnmontobase as number ) as void                                                                                                                              
		...
		lnParametros = pcount()
		lxParam1 = tcclaveitemencoleccion
		lxParam2 = tnmonto
		lxParam3 = tnmontobase
		...
		return this.ObtenerResultado( 'Setearmontoimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearporcentajesdepercepcionesdeiibbdelcliente( tocliente as object ) as void                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setearporcentajesdepercepcionesdeiibbdelcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearporcentajesdepercepcionesdeiibbtasacerodelcliente( tocliente as object ) as void                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearporcentajesdepercepcionesdeiibbtasacerodelcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearrestodepercepcionesdelcliente( tocliente as object ) as void                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setearrestodepercepcionesdelcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function vaciar() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Vaciar', lcParametros )
	EndFunc
