...
define class Din_EntidadREPORTEAUDITORIACIERREZAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRepaudizFecimpo, lxRepaudizFectrans, lxRepaudizFmodifw, lxRepaudizFaltafw, lxRepaudizFecexpo, lxRepaudizNumero, lxRepaudizHoraexpo, lxRepaudizHaltafw, lxRepaudizHmodifw, lxRepaudizUaltafw, lxRepaudizSaltafw, lxRepaudizSmodifw, lxRepaudizHoraimpo, lxRepaudizValtafw, lxRepaudizBdaltafw, lxRepaudizZadsfw, lxRepaudizBdmodifw, lxRepaudizVmodifw, lxRepaudizUmodifw, lxRepaudizEsttrans, lxRepaudizCodint, lxRepaudizTipoaudi, lxRepaudizFecdesde, lxRepaudizFechasta, lxRepaudizNrodesde, lxRepaudizNrohasta, lxRepaudizResumida, lxRepaudizObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.REPAUDIZ ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Numero","Horaexpo","Haltafw","Hmodifw","Ualtafw","Saltafw","Smodifw","Horaimpo","Valtafw","Bdaltafw","Zadsfw","Bdmodifw","Vmodifw","Umodifw","Esttrans","Codint","Tipoaudi","Fecdesde","Fechasta","Nrodesde","Nrohasta","Resumida","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxRepaudizFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepaudizFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepaudizFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepaudizFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepaudizFecexpo ) + "'" >>, <<lxRepaudizNumero >>, <<"'" + this.FormatearTextoSql( lxRepaudizHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepaudizCodint ) + "'" >>, <<lxRepaudizTipoaudi >>, <<"'" + this.ConvertirDateSql( lxRepaudizFecdesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepaudizFechasta ) + "'" >>, <<lxRepaudizNrodesde >>, <<lxRepaudizNrohasta >>, <<iif( lxRepaudizResumida, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxRepaudizObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.REPAUDIZ set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxRepaudizFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRepaudizFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxRepaudizFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRepaudizFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxRepaudizFecexpo ) + "'">>,"Numero" = <<lxRepaudizNumero>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRepaudizHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRepaudizHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRepaudizHmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRepaudizUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRepaudizSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRepaudizSmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRepaudizHoraimpo ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRepaudizValtafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRepaudizBdaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRepaudizZadsfw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRepaudizBdmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRepaudizVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRepaudizUmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRepaudizEsttrans ) + "'">>,"Codint" = <<"'" + this.FormatearTextoSql( lxRepaudizCodint ) + "'">>,"Tipoaudi" = <<lxRepaudizTipoaudi>>,"Fecdesde" = <<"'" + this.ConvertirDateSql( lxRepaudizFecdesde ) + "'">>,"Fechasta" = <<"'" + this.ConvertirDateSql( lxRepaudizFechasta ) + "'">>,"Nrodesde" = <<lxRepaudizNrodesde>>,"Nrohasta" = <<lxRepaudizNrohasta>>,"Resumida" = <<iif( lxRepaudizResumida, 1, 0 )>>,"Obs" = <<"'" + this.FormatearTextoSql( lxRepaudizObs ) + "'">> where "Codint" = <<"'" + this.FormatearTextoSql( lxRepaudizCodint ) + "'">> and  REPAUDIZ.CODINT != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Numero" as "Numero", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Codint" as "Codint", "Tipoaudi" as "Tipoauditoria", "Fecdesde" as "Fechadesde", "Fechasta" as "Fechahasta", "Nrodesde" as "Numerodesde", "Nrohasta" as "Numerohasta", "Resumida" as "Resumida", "Obs" as "Observacion" from ZooLogic.REPAUDIZ where "Codint" = <<"'" + this.FormatearTextoSql( lxRepaudizCodint ) + "'">> and  REPAUDIZ.CODINT != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Numero,Horaexpo,Haltafw,Hmodifw,Ualtafw,Saltafw,Smo" + ;
"difw,Horaimpo,Valtafw,Bdaltafw,Zadsfw,Bdmodifw,Vmodifw,Umodifw,Esttrans,Codint,Tipoaudi,Fecdesde,Fec" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, Numero, HORAEXPO, HALTAFW, HMODIFW, UALTAFW, SALTAFW, SMODIFW, HORAIMPO, VALTAFW, BDALTAFW, ZADSFW, BDMODIFW, VMODIFW, UMODIFW, ESTTRANS, CodInt, TipoAudi, FecDesde, FecHasta, NroDesde, NroHasta, Resumida, Obs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodInt ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODINT = isnull( d.CODINT, t.CODINT ),t.TIPOAUDI = isnull( d.TIPOAUDI, t.TIPOAUDI ),t.FECDESDE = isnull( d.FECDESDE, t.FECDESDE ),t.FECHASTA = isnull( d.FECHASTA, t.FECHASTA ),t.NRODESDE = isnull( d.NRODESDE, t.NRODESDE ),t.NROHASTA = isnull( d.NROHASTA, t.NROHASTA ),t.RESUMIDA = isnull( d.RESUMIDA, t.RESUMIDA ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.REPAUDIZ t inner join deleted d 
							 on t.CodInt = d.CodInt
							 and  t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.REPAUDIZ(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Numero,Horaexpo,Haltafw,Hmodifw,Ualtafw,Saltafw,Smodifw,Horaimpo,Valtafw,Bdaltafw,Zadsfw,Bdmodifw,Vmodifw,Umodifw,Esttrans,Codint,Tipoaudi,Fecdesde,Fechasta,Nrodesde,Nrohasta,Resumida,Obs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.NUMERO,0),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.ZADSFW,''),isnull( d.BDMODIFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.CODINT,''),isnull( d.TIPOAUDI,0),isnull( d.FECDESDE,''),isnull( d.FECHASTA,''),isnull( d.NRODESDE,0),isnull( d.NROHASTA,0),isnull( d.RESUMIDA,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="REPORTEAUDITORIACIERREZ                 " atributo="FECHATRANSFERENCIA                      " tabla="REPAUDIZ       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REPORTEAUDITORIACIERREZ                 " atributo="ESTADOTRANSFERENCIA                     " tabla="REPAUDIZ       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
