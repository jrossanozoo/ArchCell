...
define class Mock_COLORYTALLE_COLABORADORPRODUCCION as MockBase of MockBase.prg

	cClase = 'COLORYTALLE_COLABORADORPRODUCCION'
	...
	*-----------------------------------------------------------------------------------------
	function curvadeproduccionvalida( tccurva as string, tccolor as string, tctalle as string) as boolean                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Curvadeproduccionvalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escomodinenvarianteprincipal( tcvariante as string ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Escomodinenvarianteprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigodearticulodeinsumo( tccodigo as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercodigodearticulodeinsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenergestiondeproduccion( tcgestion as string ) as object                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenergestiondeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinsumosdecurvadeproduccion( tomodelo as object, tcvarianteprincipal as string, tcvariantesecundaria as string ) as collection                                                                                                             
		...
		lnParametros = pcount()
		lxParam1 = tomodelo
		lxParam2 = tcvarianteprincipal
		lxParam3 = tcvariantesecundaria
		...
		return this.ObtenerResultado( 'Obtenerinsumosdecurvadeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersalidasdecurvadeproduccion( tomodelo as object, tcvarianteprincipal as string, tcvariantesecundaria as string ) as collection                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenersalidasdecurvadeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolor_access() as variant                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Ocolor_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oinsumo_access() as variant                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Oinsumo_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oliquiaux_access() as variant                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Oliquiaux_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcolorseguncurvaenitem() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarcolorseguncurvaenitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartalleseguncurvaenitem() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validartalleseguncurvaenitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarcurvaengestion( togestion as object, tccodigo as string ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cargarcurvaengestion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardescartesengestion( togestion as object, tccodigo as string ) as void                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cargardescartesengestion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarinsumosdescartesengestion( togestion as object, tccodigo as string ) as void                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cargarinsumosdescartesengestion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarinsumosenmodelo( tomodelo as object, tccodigo as string ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cargarinsumosenmodelo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarinsumosproductosengestion( togestion as object, tccodigo as string ) as void                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cargarinsumosproductosengestion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarmaquinariaenmodelo( tomodelo as object, tccodigo as string ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cargarmaquinariaenmodelo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarprocesosenmodelo( tomodelo as object, tccodigo as string ) as void                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cargarprocesosenmodelo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarsalidasenmodelo( tomodelo as object, tccodigo as string ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cargarsalidasenmodelo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercurvadetalles( tccurva as string ) as collection                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercurvadetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerinsumosdecurvadeproduccionenproceso( tomodelo as object, tcproceso as string, tcvarianteprincipal as string, tcvariantesecundaria as string ) as collection                                                                     
		...
		lxParam1 = tomodelo
		lxParam2 = tcproceso
		lxParam3 = tcvarianteprincipal
		lxParam4 = tcvariantesecundaria
		...
		return this.ObtenerResultado( 'Obtenerinsumosdecurvadeproduccionenproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerpaletadecolores( tcpaleta as string ) as collection                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerpaletadecolores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersalidasdecurvadeproduccionenproceso( tomodelo as object, tcproceso as string, tcvarianteprincipal as string, tcvariantesecundaria as string ) as collection                                                                     
		...
		return this.ObtenerResultado( 'Obtenersalidasdecurvadeproduccionenproceso', lcParametros )
	EndFunc
