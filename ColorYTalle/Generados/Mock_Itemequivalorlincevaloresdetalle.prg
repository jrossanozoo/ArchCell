...
define class Mock_Itemequivalorlincevaloresdetalle as MockBase of MockBase.prg

	cClase = 'Itemequivalorlincevaloresdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function cuotas_despuesdeasignar() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cuotas_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descripción_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Descripción_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descripción( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_descripción', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tarjetamadre( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_tarjetamadre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valorlince( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_valorlince', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valororganic( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_valororganic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tarjetamadre_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Tarjetamadre_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tarjetamadre_despuesdeasignar() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Tarjetamadre_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipovalor_despuesdeasignar() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Tipovalor_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descripción( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_descripción', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tarjetamadre( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_tarjetamadre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valorlince( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_valorlince', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valororganic( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_valororganic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorlince_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorlince_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valororganic_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valororganic_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodescripción() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridodescripción', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotarjetamadre() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridotarjetamadre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipovalor() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridotipovalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovalorlince() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridovalorlince', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovalororganic() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridovalororganic', lcParametros )
	EndFunc
