...
define class Mock_movimientostockainvent as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function estipomovimientoentrada() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Estipomovimientoentrada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estipomovimientosalida() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Estipomovimientosalida', lcParametros )
	EndFunc
