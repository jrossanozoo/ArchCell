...
define class Din_EntidadImpdirliq_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Impdirliq"
	cClaseResponse = this.cNamespaceDTOs + ".ImpdirliqResponse"
	cClaseModelo = "ImpdirliqModelo"
	cEntidad = "Impdirliq"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdirliqModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdirliqListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdirliqListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdirliqModelo"
		endcase
		return lcRetorno
