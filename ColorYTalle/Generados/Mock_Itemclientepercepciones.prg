...
define class Mock_Itemclientepercepciones as MockBase of MockBase.prg

	cClase = 'Itemclientepercepciones'
	...
	*-----------------------------------------------------------------------------------------
	function codigopadroniibb_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Codigopadroniibb_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function excluido_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Excluido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function jurisdiccion_pk_despuesdeasignar() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Jurisdiccion_pk_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigopadroniibb( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_codigopadroniibb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_excluido( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_excluido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigopadroniibb( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_codigopadroniibb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_excluido( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_excluido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigopadroniibb() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridocodigopadroniibb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoexcluido() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoexcluido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaexpiracion() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofechaexpiracion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcodigopadroniibb() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofwcodigopadroniibb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridojurisdicciondetalle() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridojurisdicciondetalle', lcParametros )
	EndFunc
