...
define class Din_EntidadNotadecreditoelectronicadecredito_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadecreditoelectronicadecredito"
	cClaseResponse = this.cNamespaceDTOs + ".NotadecreditoelectronicadecreditoResponse"
	cClaseModelo = "NotadecreditoelectronicadecreditoModelo"
	cEntidad = "Notadecreditoelectronicadecredito"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicadecreditoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicadecreditoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicadecreditoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicadecreditoModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Entregaposteriorvirtual", toEntidad, "Entregaposteriorvirtual" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "EntregaPosteriorVirtual", toEntidad.EntregaPosteriorVirtual)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Nroopecommerce", "OPECOMM")
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Tipocpterelacionado", "TIPOCRELA")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Letracpterelacionado", "LETRARELA")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Puntodeventacpterelacionado", "PUNTORELA")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Numerocpterelacionado", "NUMERORELA")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Fechacpterelacionado", "FECCRELA")
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerBusquedaSegunModeloRequest( toRequest as Object ) as String
		...
		if !isnull( lcExpresionBusqueda )
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Opecomm LIKE '%" + lcExpresionBusqueda + "%'"
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Letrarela LIKE '%" + lcExpresionBusqueda + "%'"
