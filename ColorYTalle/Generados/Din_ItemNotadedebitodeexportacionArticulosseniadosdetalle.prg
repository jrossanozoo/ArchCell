...
define class Din_ItemNOTADEDEBITODEEXPORTACIONArticulosseniadosdetalle as ItemCOLORYTALLE_ARTICULOSSENIADOS of ItemCOLORYTALLE_ARTICULOSSENIADOS.prg
		...
		if This.CargaManual()
			if this.Validar_Talledetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Talledetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de débito de exportación de venta - Atributo: Talledetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Talledetalle( lxVal ) 
