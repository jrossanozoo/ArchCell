...
define class Din_EntidadModificaciondecostosdeproduccion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Modificaciondecostosdeproduccion"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleModCostos( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.ModCostos.oItem, "Talle_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Talledetalle", toEntidad.ModCostos.oItem, "TalleDetalle" )
	...
	protected function CargarColeccionModeloModCostos( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .ModCostos.Count
				...
				this.SetearAtributoString( loItem, "Talle", .ModCostos.Item(lnI).Talle_PK)
				this.SetearAtributoString( loItem, "TalleDetalle", .ModCostos.Item(lnI).TalleDetalle)
