...
*!* -->		#INCLUDE VALORES.H
*!*		#INCLUDE VALORES.H   <--
define class Mock_ENT_COMPROBANTEELECTRONICO as MockBase of MockBase.prg

	cClase = 'ENT_COMPROBANTEELECTRONICO'
	...
	*!*Percepcion = null                                                                                                                                                                                                                                      
	...
	cEvento = ""                                                                                                                                                                                                                                              
	cFechaVencimientoCertificadoDigital = ""                                                                                                                                                                                                                  
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cHoraDescuentos = ""                                                                                                                                                                                                                                      
	...
	lCargandoRecargo = .f.                                                                                                                                                                                                                                    
	lCargoPromocion = .F.                                                                                                                                                                                                                                     
	lCertificadoDigitalAVencer = .f.                                                                                                                                                                                                                          
	lCertificadoDigitalValido = .t.                                                                                                                                                                                                                           
	...
	lComprobanteExportacion = .f.                                                                                                                                                                                                                             
	lConfirmaAnulacion = .F.                                                                                                                                                                                                                                  
	lConfirmarImpresion = 0                                                                                                                                                                                                                                   
	lContingenciaCpteRelacionado = .f.                                                                                                                                                                                                                        
	...
	lHayCompAnterioresFaltantesOAnulados = .f.                                                                                                                                                                                                                
	...
	lProcesando = .F.                                                                                                                                                                                                                                         
	lProcesandoCAEPorLote = .f.                                                                                                                                                                                                                               
	lProcesandoComprobantesPreviosSinCAE = .f.                                                                                                                                                                                                                
	lProcesarAnteriores = .t.                                                                                                                                                                                                                                 
	...
	nCertificadoDigitalAVencerDiasRestantes = 0                                                                                                                                                                                                               
	nCodigoCAEA = 0                                                                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function actualizarcomprobantecondatosdgiobtenidos() as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarcomprobantecondatosdgiobtenidos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function actualizarcomprobanteconnrodgiuruguay( tcserie as string, tnnumero as integer ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarcomprobanteconnrodgiuruguay', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizardatospornopedircae() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizardatospornopedircae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function autorizarcomprobanteelectronico() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Autorizarcomprobanteelectronico', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function autorizarcomprobanteelectronicogeneradoencontingenciauruguay() as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Autorizarcomprobanteelectronicogeneradoencontingenciauruguay', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function autorizarcomprobanteelectronicouruguay() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Autorizarcomprobanteelectronicouruguay', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarcolecciondeerrores() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcolecciondeerrores', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarcomprobante( tntipo as integer, tcletra as string, tnpuntodeventa as integer, tnnumero as integer ) as boolean                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Cargarcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function certificadodigitalvalido() as boolean                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Certificadodigitalvalido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function enviapdfpersonalizadopormail() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function estasinafectacion( tni as integer ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Estasinafectacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estipocomprobantehabilitadouruguay() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estipocomprobantehabilitadouruguay', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoadvertirinformacionfaltanteenmonedaextranjera() as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoadvertirinformacionfaltanteenmonedaextranjera', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventoadvertirinformacionnoautorizadomipyme() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoadvertirinformacionnoautorizadomipyme', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoadvertirporanterioresfaltantesoanulados( tcletra as string, tnpuntodeventa as integer, tnnrocomp as integer ) as void                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Eventoadvertirporanterioresfaltantesoanulados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajecomprobantesincaenoenviaemail() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventomensajecomprobantesincaenoenviaemail', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventomensajecomprobantesinqrnoimprime() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventomensajecomprobantesinqrnoimprime', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajepedircaecomprobantesgeneradosencontingencia( tntotreg as integer, tnprocesados as integer, tnconcae as integer ) as void                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tntotreg
		lxParam2 = tnprocesados
		lxParam3 = tnconcae
		...
		return this.ObtenerResultado( 'Eventomensajepedircaecomprobantesgeneradosencontingencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomostrarmensajeobtenercaeparapodergenerarpdfs( tcmensaje as string ) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventomostrarmensajeobtenercaeparapodergenerarpdfs', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomostrarmensajesobtencioncae( tcobservaciones as string ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcobservaciones
		...
		return this.ObtenerResultado( 'Eventomostrarmensajesobtencioncae', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventomostrarmensajevalidaciondatosdgi() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventomostrarmensajevalidaciondatosdgi', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopedirdatosdgicpterelacionado() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopedirdatosdgicpterelacionado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarobtenercae() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntarobtenercae', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventopreguntarobtenercaeuruguay() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntarobtenercaeuruguay', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventopreguntarprocesaranteriores( tcmensaje as string) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventopreguntarprocesaranteriores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarpdfparacomprobanteelectronico() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarpdfparacomprobanteelectronico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function loguearpedidosdecaerechazados() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Loguearpedidosdecaerechazados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercaecomprobanteprevio() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercaecomprobanteprevio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercaeuruguay() as void                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercaeuruguay', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigocomprobanteparapdf() as string                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigocomprobanteparapdf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionimpuestosdetallados() as collection                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercoleccionimpuestosdetallados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdgicpterelacionado( tntipocpterelacionado as integer, lcletracpterelacionado as string, lnpuntodeventacpterelacionado as integer, lnnumerocpterelacionado as integer ) as boolean                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tntipocpterelacionado
		lxParam2 = lcletracpterelacionado
		lxParam3 = lnpuntodeventacpterelacionado
		lxParam4 = lnnumerocpterelacionado
		...
		return this.ObtenerResultado( 'Obtenerdatosdgicpterelacionado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernrodesde( torespuesta as object ) as integer                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = torespuesta
		...
		return this.ObtenerResultado( 'Obtenernrodesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciacomprobcontingencia( tccampotipo as string, tccampoletra as string, tccampopuntodeventa as string, tccamponumero as string ) as string                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tccampotipo
		lxParam2 = tccampoletra
		lxParam3 = tccampopuntodeventa
		lxParam4 = tccamponumero
		...
		return this.ObtenerResultado( 'Obtenersentenciacomprobcontingencia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenersentenciadatosdgicpterelacionado( tntipocpterelacionado as integer, lcletracpterelacionado as string, lnpuntodeventacpterelacionado as integer, lnnumerocpterelacionado as integer ) as string                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Obtenersentenciadatosdgicpterelacionado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciaupdatedatosdgi() as string                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciaupdatedatosdgi', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertipoautorizado() as string                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertipoautorizado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenertipocomporiginal( tntipocpterelacionado as integer ) as integer                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertipocomporiginal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerupdateobs( tcobs as string ) as string                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerupdateobs', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pedircaecomprobantesgeneradosencontingencia() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Pedircaecomprobantesgeneradosencontingencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pedirverificarpedidodecae() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Pedirverificarpedidodecae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesarcomprobanteprevio( tntipo as integer, tcletra as string, tnpuntodeventa as integer, tnnrodesde as integer, tnnrohasta as integer) as void                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5
		...
		return this.ObtenerResultado( 'Procesarcomprobanteprevio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesarcomprobantespreviossincae( torespuesta as object ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Procesarcomprobantespreviossincae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearatributosdgicpterelacionado()as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearatributosdgicpterelacionado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setearatributosvirtualescaeuruguay() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearatributosvirtualescaeuruguay', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setearatributosvirtualesimagenqr(tcquienes) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearatributosvirtualesimagenqr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearcantidaddeitemsdetalleuruguay() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearcantidaddeitemsdetalleuruguay', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienecomprobantesafectadossincae( ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienecomprobantesafectadossincae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienedisenoyenviamail() as bolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienedisenoyenviamail', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validadatosdgicomprelacionado() as boolean                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validadatosdgicomprelacionado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerupdatecuit() as string                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerupdatecuit', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerupdaterut() as string                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerupdaterut', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocae_access() as object                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocae_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ofuncionesdefe_access() as object                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ofuncionesdefe_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oqr_access() as object                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oqr_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recargarcomprobante() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Recargarcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearatributosvirtualescae() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearatributosvirtualescae', lcParametros )
	EndFunc
