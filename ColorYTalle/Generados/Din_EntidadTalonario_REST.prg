...
define class Din_EntidadTalonario_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Talonario"
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Delegarnumeracion", "NUMPROP")
