...
define class Mock_selecciondisenoimpresion as MockBase of MockBase.prg
	...
	cClase = 'selecciondisenoimpresion'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Selección de diseño de salida"                                                                                                                                                                                                           
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'SELECCIONDISENOIMPRESION'                                                                                                                                                                                                                      
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	cRespuesta = ""                                                                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function diseno_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDISENOIMPRESION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'diseno_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'diseno_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Diseno		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Diseno( lxVal )				this.Setear_Diseno( lxVal )			EndIf		Else			This.Setear_Diseno( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiodiseno(txvalor) as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventocambiodiseno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function precioconvigenciadesde_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDISENOIMPRESION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'precioconvigenciadesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'precioconvigenciadesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Precioconvigenciadesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Precioconvigenciadesde( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Precioconvigenciadesde( lxVal )			EndIf		Else			This.Setear_Precioconvigenciadesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_precioconvigenciadesde( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDISENOIMPRESION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_precioconvigenciadesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_precioconvigenciadesde', lcParametros )			endif		endif		this.Precioconvigenciadesde = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_diseno( txval as variant ) as boolean                                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function validar_precioconvigenciadesde( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDISENOIMPRESION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_precioconvigenciadesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_precioconvigenciadesde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwprecioconvigenciadesde() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwprecioconvigenciadesde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoprecioconvigenciadesde() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoprecioconvigenciadesde', lcParametros )
	EndFunc
