...
define class Mock_cancelaciondecompra as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cComprobante = ""                                                                                                                                                                                                                                         
	cComprobante = "CANCELACIONDECOMPRA"                                                                                                                                                                                                                      
	cContexto = ""                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function nuevosegunajustedesituaciondeestados( tocolitemsparacancelar as zoocoleccion of zoocoleccion.prg,  tocoldevolucionesgeneradas as zoocoleccion of zoocoleccion.prg,  tocolaboradorcomprobantescancelacion as object , tonumeroajuste as number )  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tocolitemsparacancelar
		lxParam2 = tocoldevolucionesgeneradas
		lxParam3 = tocolaboradorcomprobantescancelacion
		lxParam4 = tonumeroajuste
		...
		return this.ObtenerResultado( 'Nuevosegunajustedesituaciondeestados', lcParametros )
	EndFunc
