...
define class Din_EntidadSELECCIONDISENOIMPORTACIONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxSeldisimpoFecexpo, lxSeldisimpoFmodifw, lxSeldisimpoFecimpo, lxSeldisimpoFaltafw, lxSeldisimpoFectrans, lxSeldisimpoUaltafw, lxSeldisimpoSmodifw, lxSeldisimpoUmodifw, lxSeldisimpoSaltafw, lxSeldisimpoVmodifw, lxSeldisimpoZadsfw, lxSeldisimpoValtafw, lxSeldisimpoHoraimpo, lxSeldisimpoHmodifw, lxSeldisimpoBdaltafw, lxSeldisimpoEsttrans, lxSeldisimpoBdmodifw, lxSeldisimpoHaltafw, lxSeldisimpoHoraexpo, lxSeldisimpoTimestamp, lxSeldisimpoCcod
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.SELDISIMPO ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Ualtafw","Smodifw","Umodifw","Saltafw","Vmodifw","Zadsfw","Valtafw","Horaimpo","Hmodifw","Bdaltafw","Esttrans","Bdmodifw","Haltafw","Horaexpo","Timestamp","Ccod" ) values ( <<"'" + this.ConvertirDateSql( lxSeldisimpoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeldisimpoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeldisimpoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeldisimpoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxSeldisimpoFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoHoraexpo ) + "'" >>, <<lxSeldisimpoTimestamp >>, <<"'" + this.FormatearTextoSql( lxSeldisimpoCcod ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.SELDISIMPO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxSeldisimpoFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxSeldisimpoFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxSeldisimpoFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxSeldisimpoFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxSeldisimpoFectrans ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoValtafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxSeldisimpoHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxSeldisimpoEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxSeldisimpoHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxSeldisimpoHoraexpo ) + "'">>,"Timestamp" = <<lxSeldisimpoTimestamp>>,"Ccod" = <<"'" + this.FormatearTextoSql( lxSeldisimpoCcod ) + "'">> where "Ccod" = <<"'" + this.FormatearTextoSql( lxSeldisimpoCcod ) + "'">> and  SELDISIMPO.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Timestamp" as "Timestamp", "Ccod" as "Codigo" from ZooLogic.SELDISIMPO where  SELDISIMPO.CCOD != '' order by cCod
			endtext
			use in select('c_SELECCIONDISENOIMPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SELECCIONDISENOIMPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Timestamp" as "Timestamp", "Ccod" as "Codigo" from ZooLogic.SELDISIMPO where  funciones.padr( cCod, 1, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  SELDISIMPO.CCOD != '' order by cCod
			endtext
			use in select('c_SELECCIONDISENOIMPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SELECCIONDISENOIMPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Timestamp" as "Timestamp", "Ccod" as "Codigo" from ZooLogic.SELDISIMPO where  funciones.padr( cCod, 1, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  SELDISIMPO.CCOD != '' order by cCod desc
			endtext
			use in select('c_SELECCIONDISENOIMPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SELECCIONDISENOIMPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Timestamp" as "Timestamp", "Ccod" as "Codigo" from ZooLogic.SELDISIMPO where  SELDISIMPO.CCOD != '' order by cCod desc
			endtext
			use in select('c_SELECCIONDISENOIMPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SELECCIONDISENOIMPORTACION', set( 'Datasession' ) )
			Endwith
...
"afw,Horaimpo,Hmodifw,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Horaexpo,Timestamp,Ccod" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Timestamp" as "Timestamp", "Ccod" as "Codigo"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, UALTAFW, SMODIFW, UMODIFW, SALTAFW, VMODIFW, ZADSFW, VALTAFW, HORAIMPO, HMODIFW, BDALTAFW, ESTTRANS, BDMODIFW, HALTAFW, HORAEXPO, TIMESTAMP, cCod
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad SELECCIONDISENOIMPORTACION. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CCOD = isnull( d.CCOD, t.CCOD )
					from ZooLogic.SELDISIMPO t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ZooLogic.SELDISIMPO(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Ualtafw,Smodifw,Umodifw,Saltafw,Vmodifw,Zadsfw,Valtafw,Horaimpo,Hmodifw,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Horaexpo,Timestamp,Ccod)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.TIMESTAMP,0),isnull( d.CCOD,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="FECHAEXPO                               " tabla="SELDISIMPO     " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="FECHAMODIFICACIONFW                     " tabla="SELDISIMPO     " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="FECHAIMPO                               " tabla="SELDISIMPO     " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="FECHATRANSFERENCIA                      " tabla="SELDISIMPO     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="OBSERVACION                             " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Observación                                                                                                                                                     " dominio="OBSERVACION1R                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="SERIEMODIFICACIONFW                     " tabla="SELDISIMPO     " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="VERSIONMODIFICACIONFW                   " tabla="SELDISIMPO     " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="VERSIONALTAFW                           " tabla="SELDISIMPO     " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="ESTADOTRANSFERENCIA                     " tabla="SELDISIMPO     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="HORAEXPO                                " tabla="SELDISIMPO     " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SELECCIONDISENOIMPORTACION              " atributo="DISENO                                  " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="45" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Diseños                                                                                                                                                         " dominio="COMBO                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
