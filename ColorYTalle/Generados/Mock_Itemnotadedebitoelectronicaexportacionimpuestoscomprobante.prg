...
define class Mock_Itemnotadedebitoelectronicaexportacionimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemnotadedebitoelectronicaexportacionimpuestoscomprobante'
