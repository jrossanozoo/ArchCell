...
define class Mock_Unidaddemedidaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Unidaddemedidaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubudm( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubudm', lcParametros )
	EndFunc
