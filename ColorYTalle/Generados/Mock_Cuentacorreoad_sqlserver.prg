...
define class Mock_Cuentacorreoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Cuentacorreoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubsmt( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubsmt', lcParametros )
	EndFunc
