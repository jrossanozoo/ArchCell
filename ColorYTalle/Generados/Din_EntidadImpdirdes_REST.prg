...
define class Din_EntidadImpdirdes_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Impdirdes"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_destino_desde", toEntidad, "F_destino_desde_PK" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_destino_hasta", toEntidad, "F_destino_hasta_PK" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "f_Destino_Desde", toEntidad.f_Destino_Desde_PK)
			this.SetearAtributoString( toModeloResponse, "f_Destino_Hasta", toEntidad.f_Destino_Hasta_PK)
