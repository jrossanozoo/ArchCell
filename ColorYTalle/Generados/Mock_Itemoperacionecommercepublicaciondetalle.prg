...
define class Mock_Itemoperacionecommercepublicaciondetalle as MockBase of MockBase.prg

	cClase = 'Itemoperacionecommercepublicaciondetalle'
	...
	*-----------------------------------------------------------------------------------------
	function codigoherrcancelacion_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Codigoherrcancelacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechacancelacion_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Fechacancelacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idpublicacion_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Idpublicacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nrooperacioncancelacion_assign( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Nrooperacioncancelacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoherrcancelacion( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_codigoherrcancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechacancelacion( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_fechacancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idpublicacion( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_idpublicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nrooperacioncancelacion( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_nrooperacioncancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoherrcancelacion( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_codigoherrcancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechacancelacion( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_fechacancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idpublicacion( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_idpublicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nrooperacioncancelacion( txval as variant ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_nrooperacioncancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoidpublicacion() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoidpublicacion', lcParametros )
	EndFunc
