...
define class Mock_ajustechequerechazado as MockBase of MockBase.prg
	...
	cClase = 'ajustechequerechazado'

	
	AgruPubliDetalle = null                                                                                                                                                                                                                                   
	ArticuloRecargo = null                                                                                                                                                                                                                                    
	ArticuloRecargo_PK = ""                                                                                                                                                                                                                                   
	BASEDEDATOSALTAFW = ""                                                                                                                                                                                                                                    
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Ajustes de cheques de terceros rechazados"                                                                                                                                                                                               
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'AJUSTECHEQUERECHAZADO'                                                                                                                                                                                                                         
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lHabilitarArticuloRecargo_PK = .T.                                                                                                                                                                                                                        
	lHabilitarImporteRecargo = .T.                                                                                                                                                                                                                            
	lHabilitarMotivoAjuste_PK = .T.                                                                                                                                                                                                                           
	lHabilitarPorcentajeRecargo = .T.                                                                                                                                                                                                                         
	lHabilitarTipoComprobante = .T.                                                                                                                                                                                                                           
	lHabilitarTipoRecargo = .T.                                                                                                                                                                                                                               
	lHabilitarValorRecargo_PK = .T.                                                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function articulorecargo_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'articulorecargo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'articulorecargo_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Articulorecargo ) = 'O' or isnull( this.Articulorecargo ) )					this.Articulorecargo = _Screen.zoo.instanciarentidad( 'Articulo' )					this.Articulorecargo.lEsSubEntidad = .t.					this.enlazar( 'Articulorecargo.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Articulorecargo.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Articulorecargo.CODIGO # this.Articulorecargo_PK						this.Articulorecargo.CODIGO = this.Articulorecargo_PK					endif				endif			endif		endif		return this.Articulorecargo
	EndFunc

	*-----------------------------------------------------------------------------------------
	function articulorecargo_pk_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'articulorecargo_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'articulorecargo_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Articulorecargo_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Articulorecargo.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Articulorecargo )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 15, padr( lxVal, 15 ), lxVal )		this.Articulorecargo_PK = lxVal		if this.Validar_Articulorecargo( lxVal, lxValOld )			if ( this.lHabilitarArticulorecargo_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Articulorecargo( lxVal )			else				this.Articulorecargo_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Ajustes de cheques de terceros rechazados - Atributo: Articulorecargo)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoseteatcolordelcontrolsegunatributo( tcatributo as string, tlactivar as boolean ) as void                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventoseteatcolordelcontrolsegunatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function importerecargo_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'importerecargo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'importerecargo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Importerecargo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Importerecargo( lxVal )				if ( this.lHabilitarImporterecargo or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Importerecargo( lxVal )				else					this.Importerecargo = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Ajustes de cheques de terceros rechazados - Atributo: Importerecargo)" )				endif			EndIf		Else			This.Setear_Importerecargo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function motivoajuste_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'motivoajuste_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'motivoajuste_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Motivoajuste ) = 'O' or isnull( this.Motivoajuste ) )					this.Motivoajuste = _Screen.zoo.instanciarentidad( 'Motivo' )					this.Motivoajuste.lEsSubEntidad = .t.					this.enlazar( 'Motivoajuste.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Motivoajuste.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Motivoajuste.CODIGO # this.Motivoajuste_PK						this.Motivoajuste.CODIGO = this.Motivoajuste_PK					endif				endif			endif		endif		return this.Motivoajuste
	EndFunc

	*-----------------------------------------------------------------------------------------
	function motivoajuste_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'motivoajuste_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'motivoajuste_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Motivoajuste_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 3, padr( lxVal, 3 ), lxVal )		this.Motivoajuste_PK = lxVal		if this.Validar_Motivoajuste( lxVal, lxValOld )			if ( this.lHabilitarMotivoajuste_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Motivoajuste( lxVal )			else				this.Motivoajuste_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Ajustes de cheques de terceros rechazados - Atributo: Motivoajuste)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajerecargo_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'porcentajerecargo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'porcentajerecargo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Porcentajerecargo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Porcentajerecargo( lxVal )				if ( this.lHabilitarPorcentajerecargo or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Porcentajerecargo( lxVal )				else					this.Porcentajerecargo = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Ajustes de cheques de terceros rechazados - Atributo: Porcentajerecargo)" )				endif			EndIf		Else			This.Setear_Porcentajerecargo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetear_realizaajuste() as void                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'procesardespuesdesetear_realizaajuste', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'procesardespuesdesetear_realizaajuste', lcParametros )			endif		endif		this.HabilitarDeshabilitarAtributosAjusteCtaCte()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetear_realizarecargo() as void                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'procesardespuesdesetear_realizarecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'procesardespuesdesetear_realizarecargo', lcParametros )			endif		endif		this.HabilitarDeshabilitarAtributosAjustePorRecargo()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetear_tiporecargo() as void                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'procesardespuesdesetear_tiporecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'procesardespuesdesetear_tiporecargo', lcParametros )			endif		endif		this.HabilitarDeshabilitarAtributosTipoDeRecargo()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function realizaajuste_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'realizaajuste_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'realizaajuste_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Realizaajuste		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Realizaajuste( lxVal )				this.Setear_Realizaajuste( lxVal )				 This.Realizaajuste_DespuesDeAsignar()			EndIf		Else			This.Setear_Realizaajuste( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function realizaajuste_despuesdeasignar() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Realizaajuste_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function realizarecargo_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'realizarecargo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'realizarecargo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Realizarecargo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Realizarecargo( lxVal )				this.Setear_Realizarecargo( lxVal )				 This.Realizarecargo_DespuesDeAsignar()			EndIf		Else			This.Setear_Realizarecargo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function realizarecargo_despuesdeasignar() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Realizarecargo_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_articulorecargo( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_articulorecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_articulorecargo', lcParametros )			endif		endif		this.Articulorecargo.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_importerecargo( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_importerecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_importerecargo', lcParametros )			endif		endif		this.Importerecargo = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_motivoajuste( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_motivoajuste', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_motivoajuste', lcParametros )			endif		endif		this.Motivoajuste.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_realizaajuste( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_realizaajuste', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_realizaajuste', lcParametros )			endif		endif		this.Realizaajuste = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_realizarecargo( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_realizarecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_realizarecargo', lcParametros )			endif		endif		this.Realizarecargo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tiporecargo( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tiporecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tiporecargo', lcParametros )			endif		endif		this.Tiporecargo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valorrecargo( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_valorrecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_valorrecargo', lcParametros )			endif		endif		this.Valorrecargo.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipocomprobante_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tipocomprobante_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tipocomprobante_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tipocomprobante		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tipocomprobante( lxVal )				if ( this.lHabilitarTipocomprobante or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Tipocomprobante( lxVal )				else					this.Tipocomprobante = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Ajustes de cheques de terceros rechazados - Atributo: Tipocomprobante)" )				endif			EndIf		Else			This.Setear_Tipocomprobante( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function tiporecargo_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tiporecargo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tiporecargo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tiporecargo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tiporecargo( lxVal )				if ( this.lHabilitarTiporecargo or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Tiporecargo( lxVal )					 This.Tiporecargo_DespuesDeAsignar()				else					this.Tiporecargo = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Ajustes de cheques de terceros rechazados - Atributo: Tiporecargo)" )				endif			EndIf		Else			This.Setear_Tiporecargo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function tiporecargo_despuesdeasignar() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tiporecargo_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_articulorecargo( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_articulorecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_articulorecargo', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_importerecargo( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_importerecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_importerecargo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_motivoajuste( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_motivoajuste', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_motivoajuste', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajerecargo( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_porcentajerecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_porcentajerecargo', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		llRetorno = llRetorno and this.ValidarMaximoPorcentajeRecago( txVal )		return llRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_realizaajuste( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_realizaajuste', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_realizaajuste', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_realizarecargo( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_realizarecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_realizarecargo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tiporecargo( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tiporecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tiporecargo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valorrecargo( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_valorrecargo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_valorrecargo', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validararticulorecargo() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validararticulorecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmotivoajuste() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmotivoajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartipodecomprobante() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validartipodecomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarvalorrecargo() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarvalorrecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorrecargo_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'valorrecargo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'valorrecargo_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Valorrecargo ) = 'O' or isnull( this.Valorrecargo ) )					this.Valorrecargo = _Screen.zoo.instanciarentidad( 'Valor' )					this.Valorrecargo.lEsSubEntidad = .t.					this.enlazar( 'Valorrecargo.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Valorrecargo.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Valorrecargo.CODIGO # this.Valorrecargo_PK						this.Valorrecargo.CODIGO = this.Valorrecargo_PK					endif				endif			endif		endif		return this.Valorrecargo
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorrecargo_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECHEQUERECHAZADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'valorrecargo_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'valorrecargo_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Valorrecargo_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Valorrecargo_PK = lxVal		if this.Validar_Valorrecargo( lxVal, lxValOld )			if ( this.lHabilitarValorrecargo_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Valorrecargo( lxVal )			else				this.Valorrecargo_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Ajustes de cheques de terceros rechazados - Atributo: Valorrecargo)" )			endif		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoarticulorecargo() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoarticulorecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwrealizaajuste() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwrealizaajuste', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwrealizarecargo() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwrealizarecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoimporterecargo() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoimporterecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridomotivoajuste() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomotivoajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoporcentajerecargo() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoporcentajerecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridorealizaajuste() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridorealizaajuste', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridorealizarecargo() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridorealizarecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotiporecargo() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotiporecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridovalorrecargo() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridovalorrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitardeshabilitaratributosajustectacte() as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitaratributosajustectacte', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function habilitardeshabilitaratributosajusteporrecargo() as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitaratributosajusteporrecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function habilitardeshabilitaratributostipoderecargo() as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitaratributostipoderecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarelarticulopararecargo as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarelarticulopararecargo As Boolean', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarelvalorpararecargo as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarelvalorpararecargo As Boolean', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarmaximoporcentajerecago( txval as variant ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarmaximoporcentajerecago', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarobligatoriedadenatributos() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarobligatoriedadenatributos', lcParametros )
	EndFunc
