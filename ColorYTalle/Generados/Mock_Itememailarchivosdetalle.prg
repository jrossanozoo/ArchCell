...
define class Mock_Itememailarchivosdetalle as MockBase of MockBase.prg

	cClase = 'Itememailarchivosdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function archivo_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Archivo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_archivo( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_archivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_archivo( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_archivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoarchivo() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoarchivo', lcParametros )
	EndFunc
