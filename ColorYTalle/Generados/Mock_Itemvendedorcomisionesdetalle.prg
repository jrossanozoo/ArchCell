...
define class Mock_Itemvendedorcomisionesdetalle as MockBase of MockBase.prg

	cClase = 'Itemvendedorcomisionesdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function comision_access() as variant                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Comision_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function comision_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Comision_pk_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function comisiondetalle_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Comisiondetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function horamodificacion_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Horamodificacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_comisiondetalle( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_comisiondetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_horamodificacion( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_horamodificacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_comisiondetalle( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validar_comisiondetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_horamodificacion( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_horamodificacion', lcParametros )
	EndFunc
