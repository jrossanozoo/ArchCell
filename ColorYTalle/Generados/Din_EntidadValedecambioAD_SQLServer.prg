...
define class Din_EntidadVALEDECAMBIOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxValcambioFecexpo, lxValcambioFaltafw, lxValcambioFecimpo, lxValcambioFectrans, lxValcambioFmodifw, lxValcambioCfecha, lxValcambioEsttrans, lxValcambioBdaltafw, lxValcambioBdmodifw, lxValcambioChora, lxValcambioArticulo, lxValcambioCserie, lxValcambioHoraexpo, lxValcambioHaltafw, lxValcambioValtafw, lxValcambioZadsfw, lxValcambioVmodifw, lxValcambioUmodifw, lxValcambioSmodifw, lxValcambioUaltafw, lxValcambioHoraimpo, lxValcambioSaltafw, lxValcambioHmodifw, lxValcambioCcodcompd, lxValcambioCcodcomp, lxValcambioCcliented, lxValcambioCseried, lxValcambioCcliente, lxValcambioCtipc, lxValcambioSaldo, lxValcambioCtipcd, lxValcambioCobss, lxValcambioCfechavenc, lxValcambioCcompdes, lxValcambioCcompori, lxValcambioCusuario, lxValcambioCletd, lxValcambioCusuariod, lxValcambioClet, lxValcambioCcod, lxValcambioCfchdest, lxValcambioCfchorig, lxValcambioCbddest, lxValcambioCbdorig, lxValcambioCptovta, lxValcambioCptovtad, lxValcambioPtoventa, lxValcambioCnum, lxValcambioNumero, lxValcambioCnumd, lxValcambioCmonto, lxValcambioTipo, lxValcambioReutiliza, lxValcambioValor, lxValcambioEmail, lxValcambioMoneda, lxValcambioCsigno, lxValcambioCsignod
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.VALCAMBIO ( "Fecexpo","Faltafw","Fecimpo","Fectrans","Fmodifw","Cfecha","Esttrans","Bdaltafw","Bdmodifw","Chora","Articulo","Cserie","Horaexpo","Haltafw","Valtafw","Zadsfw","Vmodifw","Umodifw","Smodifw","Ualtafw","Horaimpo","Saltafw","Hmodifw","Ccodcompd","Ccodcomp","Ccliented","Cseried","Ccliente","Ctipc","Saldo","Ctipcd","Cobss","Cfechavenc","Ccompdes","Ccompori","Cusuario","Cletd","Cusuariod","Clet","Ccod","Cfchdest","Cfchorig","Cbddest","Cbdorig","Cptovta","Cptovtad","Ptoventa","Cnum","Numero","Cnumd","Cmonto","Tipo","Reutiliza","Valor","Email","Moneda","Csigno","Csignod" ) values ( <<"'" + this.ConvertirDateSql( lxValcambioFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioCfecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioChora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioArticulo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCserie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCcodcompd ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCcodcomp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCcliented ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCseried ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCcliente ) + "'" >>, <<lxValcambioCtipc >>, <<lxValcambioSaldo >>, <<lxValcambioCtipcd >>, <<"'" + this.FormatearTextoSql( lxValcambioCobss ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioCfechavenc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCcompdes ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCcompori ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCusuario ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCletd ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCusuariod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioClet ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCcod ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioCfchdest ) + "'" >>, <<"'" + this.ConvertirDateSql( lxValcambioCfchorig ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCbddest ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioCbdorig ) + "'" >>, <<lxValcambioCptovta >>, <<lxValcambioCptovtad >>, <<lxValcambioPtoventa >>, <<lxValcambioCnum >>, <<lxValcambioNumero >>, <<lxValcambioCnumd >>, <<lxValcambioCmonto >>, <<"'" + this.FormatearTextoSql( lxValcambioTipo ) + "'" >>, <<iif( lxValcambioReutiliza, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxValcambioValor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioEmail ) + "'" >>, <<"'" + this.FormatearTextoSql( lxValcambioMoneda ) + "'" >>, <<lxValcambioCsigno >>, <<lxValcambioCsignod >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.VALCAMBIO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxValcambioFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxValcambioFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxValcambioFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxValcambioFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxValcambioFmodifw ) + "'">>,"Cfecha" = <<"'" + this.ConvertirDateSql( lxValcambioCfecha ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxValcambioEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxValcambioBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxValcambioBdmodifw ) + "'">>,"Chora" = <<"'" + this.FormatearTextoSql( lxValcambioChora ) + "'">>,"Articulo" = <<"'" + this.FormatearTextoSql( lxValcambioArticulo ) + "'">>,"Cserie" = <<"'" + this.FormatearTextoSql( lxValcambioCserie ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxValcambioHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxValcambioHaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxValcambioValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxValcambioZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxValcambioVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxValcambioUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxValcambioSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxValcambioUaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxValcambioHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxValcambioSaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxValcambioHmodifw ) + "'">>,"Ccodcompd" = <<"'" + this.FormatearTextoSql( lxValcambioCcodcompd ) + "'">>,"Ccodcomp" = <<"'" + this.FormatearTextoSql( lxValcambioCcodcomp ) + "'">>,"Ccliented" = <<"'" + this.FormatearTextoSql( lxValcambioCcliented ) + "'">>,"Cseried" = <<"'" + this.FormatearTextoSql( lxValcambioCseried ) + "'">>,"Ccliente" = <<"'" + this.FormatearTextoSql( lxValcambioCcliente ) + "'">>,"Ctipc" = <<lxValcambioCtipc>>,"Saldo" = <<lxValcambioSaldo>>,"Ctipcd" = <<lxValcambioCtipcd>>,"Cobss" = <<"'" + this.FormatearTextoSql( lxValcambioCobss ) + "'">>,"Cfechavenc" = <<"'" + this.ConvertirDateSql( lxValcambioCfechavenc ) + "'">>,"Ccompdes" = <<"'" + this.FormatearTextoSql( lxValcambioCcompdes ) + "'">>,"Ccompori" = <<"'" + this.FormatearTextoSql( lxValcambioCcompori ) + "'">>,"Cusuario" = <<"'" + this.FormatearTextoSql( lxValcambioCusuario ) + "'">>,"Cletd" = <<"'" + this.FormatearTextoSql( lxValcambioCletd ) + "'">>,"Cusuariod" = <<"'" + this.FormatearTextoSql( lxValcambioCusuariod ) + "'">>,"Clet" = <<"'" + this.FormatearTextoSql( lxValcambioClet ) + "'">>,"Ccod" = <<"'" + this.FormatearTextoSql( lxValcambioCcod ) + "'">>,"Cfchdest" = <<"'" + this.ConvertirDateSql( lxValcambioCfchdest ) + "'">>,"Cfchorig" = <<"'" + this.ConvertirDateSql( lxValcambioCfchorig ) + "'">>,"Cbddest" = <<"'" + this.FormatearTextoSql( lxValcambioCbddest ) + "'">>,"Cbdorig" = <<"'" + this.FormatearTextoSql( lxValcambioCbdorig ) + "'">>,"Cptovta" = <<lxValcambioCptovta>>,"Cptovtad" = <<lxValcambioCptovtad>>,"Ptoventa" = <<lxValcambioPtoventa>>,"Cnum" = <<lxValcambioCnum>>,"Numero" = <<lxValcambioNumero>>,"Cnumd" = <<lxValcambioCnumd>>,"Cmonto" = <<lxValcambioCmonto>>,"Tipo" = <<"'" + this.FormatearTextoSql( lxValcambioTipo ) + "'">>,"Reutiliza" = <<iif( lxValcambioReutiliza, 1, 0 )>>,"Valor" = <<"'" + this.FormatearTextoSql( lxValcambioValor ) + "'">>,"Email" = <<"'" + this.FormatearTextoSql( lxValcambioEmail ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxValcambioMoneda ) + "'">>,"Csigno" = <<lxValcambioCsigno>>,"Csignod" = <<lxValcambioCsignod>> where "Ccod" = <<"'" + this.FormatearTextoSql( lxValcambioCcod ) + "'">> and  VALCAMBIO.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Cfecha" as "Fecha", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Chora" as "Hora", "Articulo" as "Articulo", "Cserie" as "Serieorigen", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Ccodcompd" as "Codigocomprobantedestino", "Ccodcomp" as "Codigocomprobanteorigen", "Ccliented" as "Clientedestino", "Cseried" as "Seriedestino", "Ccliente" as "Clienteorigen", "Ctipc" as "Tipodecomprobanteorigen", "Saldo" as "Saldo", "Ctipcd" as "Tipodecomprobantedestino", "Cobss" as "Obs", "Cfechavenc" as "Fechavencimiento", "Ccompdes" as "Comprobantedestino", "Ccompori" as "Comprobanteorigen", "Cusuario" as "Usuarioorigen", "Cletd" as "Letradestino", "Cusuariod" as "Usuariodestino", "Clet" as "Letraorigen", "Ccod" as "Codigo", "Cfchdest" as "Fechadestino", "Cfchorig" as "Fechaorigen", "Cbddest" as "Bddestino", "Cbdorig" as "Bdorigen", "Cptovta" as "Puntodeventaorigen", "Cptovtad" as "Puntodeventadestino", "Ptoventa" as "Puntodeventa", "Cnum" as "Numeroorigen", "Numero" as "Numero", "Cnumd" as "Numerodestino", "Cmonto" as "Monto", "Tipo" as "Tipo", "Reutiliza" as "Reutilizable", "Valor" as "Valor", "Email" as "Email", "Moneda" as "Simbolomonetario", "Csigno" as "Signodemovimientoorigen", "Csignod" as "Signodemovimientodestino" from ZooLogic.VALCAMBIO where "Ccod" = <<"'" + this.FormatearTextoSql( lxValcambioCcod ) + "'">> and  VALCAMBIO.CCOD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Cfecha" as "Fecha", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Chora" as "Hora", "Articulo" as "Articulo", "Cserie" as "Serieorigen", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Ccodcompd" as "Codigocomprobantedestino", "Ccodcomp" as "Codigocomprobanteorigen", "Ccliented" as "Clientedestino", "Cseried" as "Seriedestino", "Ccliente" as "Clienteorigen", "Ctipc" as "Tipodecomprobanteorigen", "Saldo" as "Saldo", "Ctipcd" as "Tipodecomprobantedestino", "Cobss" as "Obs", "Cfechavenc" as "Fechavencimiento", "Ccompdes" as "Comprobantedestino", "Ccompori" as "Comprobanteorigen", "Cusuario" as "Usuarioorigen", "Cletd" as "Letradestino", "Cusuariod" as "Usuariodestino", "Clet" as "Letraorigen", "Ccod" as "Codigo", "Cfchdest" as "Fechadestino", "Cfchorig" as "Fechaorigen", "Cbddest" as "Bddestino", "Cbdorig" as "Bdorigen", "Cptovta" as "Puntodeventaorigen", "Cptovtad" as "Puntodeventadestino", "Ptoventa" as "Puntodeventa", "Cnum" as "Numeroorigen", "Numero" as "Numero", "Cnumd" as "Numerodestino", "Cmonto" as "Monto", "Tipo" as "Tipo", "Reutiliza" as "Reutilizable", "Valor" as "Valor", "Email" as "Email", "Moneda" as "Simbolomonetario", "Csigno" as "Signodemovimientoorigen", "Csignod" as "Signodemovimientodestino" from ZooLogic.VALCAMBIO where  VALCAMBIO.CCOD != '' order by CCOD
			endtext
			use in select('c_VALEDECAMBIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_VALEDECAMBIO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Cfecha" as "Fecha", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Chora" as "Hora", "Articulo" as "Articulo", "Cserie" as "Serieorigen", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Ccodcompd" as "Codigocomprobantedestino", "Ccodcomp" as "Codigocomprobanteorigen", "Ccliented" as "Clientedestino", "Cseried" as "Seriedestino", "Ccliente" as "Clienteorigen", "Ctipc" as "Tipodecomprobanteorigen", "Saldo" as "Saldo", "Ctipcd" as "Tipodecomprobantedestino", "Cobss" as "Obs", "Cfechavenc" as "Fechavencimiento", "Ccompdes" as "Comprobantedestino", "Ccompori" as "Comprobanteorigen", "Cusuario" as "Usuarioorigen", "Cletd" as "Letradestino", "Cusuariod" as "Usuariodestino", "Clet" as "Letraorigen", "Ccod" as "Codigo", "Cfchdest" as "Fechadestino", "Cfchorig" as "Fechaorigen", "Cbddest" as "Bddestino", "Cbdorig" as "Bdorigen", "Cptovta" as "Puntodeventaorigen", "Cptovtad" as "Puntodeventadestino", "Ptoventa" as "Puntodeventa", "Cnum" as "Numeroorigen", "Numero" as "Numero", "Cnumd" as "Numerodestino", "Cmonto" as "Monto", "Tipo" as "Tipo", "Reutiliza" as "Reutilizable", "Valor" as "Valor", "Email" as "Email", "Moneda" as "Simbolomonetario", "Csigno" as "Signodemovimientoorigen", "Csignod" as "Signodemovimientodestino" from ZooLogic.VALCAMBIO where  funciones.padr( CCOD, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  VALCAMBIO.CCOD != '' order by CCOD
			endtext
			use in select('c_VALEDECAMBIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_VALEDECAMBIO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Cfecha" as "Fecha", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Chora" as "Hora", "Articulo" as "Articulo", "Cserie" as "Serieorigen", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Ccodcompd" as "Codigocomprobantedestino", "Ccodcomp" as "Codigocomprobanteorigen", "Ccliented" as "Clientedestino", "Cseried" as "Seriedestino", "Ccliente" as "Clienteorigen", "Ctipc" as "Tipodecomprobanteorigen", "Saldo" as "Saldo", "Ctipcd" as "Tipodecomprobantedestino", "Cobss" as "Obs", "Cfechavenc" as "Fechavencimiento", "Ccompdes" as "Comprobantedestino", "Ccompori" as "Comprobanteorigen", "Cusuario" as "Usuarioorigen", "Cletd" as "Letradestino", "Cusuariod" as "Usuariodestino", "Clet" as "Letraorigen", "Ccod" as "Codigo", "Cfchdest" as "Fechadestino", "Cfchorig" as "Fechaorigen", "Cbddest" as "Bddestino", "Cbdorig" as "Bdorigen", "Cptovta" as "Puntodeventaorigen", "Cptovtad" as "Puntodeventadestino", "Ptoventa" as "Puntodeventa", "Cnum" as "Numeroorigen", "Numero" as "Numero", "Cnumd" as "Numerodestino", "Cmonto" as "Monto", "Tipo" as "Tipo", "Reutiliza" as "Reutilizable", "Valor" as "Valor", "Email" as "Email", "Moneda" as "Simbolomonetario", "Csigno" as "Signodemovimientoorigen", "Csignod" as "Signodemovimientodestino" from ZooLogic.VALCAMBIO where  funciones.padr( CCOD, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  VALCAMBIO.CCOD != '' order by CCOD desc
			endtext
			use in select('c_VALEDECAMBIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_VALEDECAMBIO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Cfecha" as "Fecha", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Chora" as "Hora", "Articulo" as "Articulo", "Cserie" as "Serieorigen", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Ccodcompd" as "Codigocomprobantedestino", "Ccodcomp" as "Codigocomprobanteorigen", "Ccliented" as "Clientedestino", "Cseried" as "Seriedestino", "Ccliente" as "Clienteorigen", "Ctipc" as "Tipodecomprobanteorigen", "Saldo" as "Saldo", "Ctipcd" as "Tipodecomprobantedestino", "Cobss" as "Obs", "Cfechavenc" as "Fechavencimiento", "Ccompdes" as "Comprobantedestino", "Ccompori" as "Comprobanteorigen", "Cusuario" as "Usuarioorigen", "Cletd" as "Letradestino", "Cusuariod" as "Usuariodestino", "Clet" as "Letraorigen", "Ccod" as "Codigo", "Cfchdest" as "Fechadestino", "Cfchorig" as "Fechaorigen", "Cbddest" as "Bddestino", "Cbdorig" as "Bdorigen", "Cptovta" as "Puntodeventaorigen", "Cptovtad" as "Puntodeventadestino", "Ptoventa" as "Puntodeventa", "Cnum" as "Numeroorigen", "Numero" as "Numero", "Cnumd" as "Numerodestino", "Cmonto" as "Monto", "Tipo" as "Tipo", "Reutiliza" as "Reutilizable", "Valor" as "Valor", "Email" as "Email", "Moneda" as "Simbolomonetario", "Csigno" as "Signodemovimientoorigen", "Csignod" as "Signodemovimientodestino" from ZooLogic.VALCAMBIO where  VALCAMBIO.CCOD != '' order by CCOD desc
			endtext
			use in select('c_VALEDECAMBIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_VALEDECAMBIO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Faltafw,Fecimpo,Fectrans,Fmodifw,Cfecha,Esttrans,Bdaltafw,Bdmodifw,Chora,Articulo,Cs" + ;
"erie,Horaexpo,Haltafw,Valtafw,Zadsfw,Vmodifw,Umodifw,Smodifw,Ualtafw,Horaimpo,Saltafw,Hmodifw,Ccodco" + ;
"mpd,Ccodcomp,Ccliented,Cseried,Ccliente,Ctipc,Saldo,Ctipcd,Cobss,Cfechavenc,Ccompdes,Ccompori,Cusuar" + ;
"io,Cletd,Cusuariod,Clet,Ccod,Cfchdest,Cfchorig,Cbddest,Cbdorig,Cptovta,Cptovtad,Ptoventa,Cnum,Numero" + ;
",Cnumd,Cmonto,Tipo,Reutiliza,Valor,Email,Moneda,Csigno,Csignod" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Cfecha" as "Fecha", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Chora" as "Hora", "Articulo" as "Articulo", "Cserie" as "Serieorigen", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Ccodcompd" as "Codigocomprobantedestino", "Ccodcomp" as "Codigocomprobanteorigen", "Ccliented" as "Clientedestino", "Cseried" as "Seriedestino", "Ccliente" as "Clienteorigen", "Ctipc" as "Tipodecomprobanteorigen", "Saldo" as "Saldo", "Ctipcd" as "Tipodecomprobantedestino", "Cobss" as "Obs", "Cfechavenc" as "Fechavencimiento", "Ccompdes" as "Comprobantedestino", "Ccompori" as "Comprobanteorigen", "Cusuario" as "Usuarioorigen", "Cletd" as "Letradestino", "Cusuariod" as "Usuariodestino", "Clet" as "Letraorigen", "Ccod" as "Codigo", "Cfchdest" as "Fechadestino", "Cfchorig" as "Fechaorigen", "Cbddest" as "Bddestino", "Cbdorig" as "Bdorigen", "Cptovta" as "Puntodeventaorigen", "Cptovtad" as "Puntodeventadestino", "Ptoventa" as "Puntodeventa", "Cnum" as "Numeroorigen", "Numero" as "Numero", "Cnumd" as "Numerodestino", "Cmonto" as "Monto", "Tipo" as "Tipo", "Reutiliza" as "Reutilizable", "Valor" as "Valor", "Email" as "Email", "Moneda" as "Simbolomonetario", "Csigno" as "Signodemovimientoorigen", "Csignod" as "Signodemovimientodestino"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.VALCAMBIO set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, CFECHA = ] + "'" + this.ConvertirDateSql( &lcCursor..CFECHA ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, CHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..CHORA ) + "'"+ [, Articulo = ] + "'" + this.FormatearTextoSql( &lcCursor..Articulo ) + "'"+ [, CSERIE = ] + "'" + this.FormatearTextoSql( &lcCursor..CSERIE ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, cCodCompd = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodCompd ) + "'"+ [, cCodComp = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodComp ) + "'"+ [, cClienteD = ] + "'" + this.FormatearTextoSql( &lcCursor..cClienteD ) + "'"+ [, CSERIED = ] + "'" + this.FormatearTextoSql( &lcCursor..CSERIED ) + "'"+ [, cCliente = ] + "'" + this.FormatearTextoSql( &lcCursor..cCliente ) + "'"+ [, cTipC = ] + transform( &lcCursor..cTipC )+ [, Saldo = ] + transform( &lcCursor..Saldo )+ [, cTipCd = ] + transform( &lcCursor..cTipCd )+ [, COBSS = ] + "'" + this.FormatearTextoSql( &lcCursor..COBSS ) + "'"+ [, CFECHAVENC = ] + "'" + this.ConvertirDateSql( &lcCursor..CFECHAVENC ) + "'"+ [, CCOMPDES = ] + "'" + this.FormatearTextoSql( &lcCursor..CCOMPDES ) + "'"+ [, CCOMPORI = ] + "'" + this.FormatearTextoSql( &lcCursor..CCOMPORI ) + "'"+ [, CUSUARIO = ] + "'" + this.FormatearTextoSql( &lcCursor..CUSUARIO ) + "'"+ [, cletd = ] + "'" + this.FormatearTextoSql( &lcCursor..cletd ) + "'"+ [, CUSUARIOD = ] + "'" + this.FormatearTextoSql( &lcCursor..CUSUARIOD ) + "'"+ [, clet = ] + "'" + this.FormatearTextoSql( &lcCursor..clet ) + "'"+ [, CCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..CCOD ) + "'"+ [, CFCHDEST = ] + "'" + this.ConvertirDateSql( &lcCursor..CFCHDEST ) + "'"+ [, CFCHORIG = ] + "'" + this.ConvertirDateSql( &lcCursor..CFCHORIG ) + "'"+ [, CBDDEST = ] + "'" + this.FormatearTextoSql( &lcCursor..CBDDEST ) + "'"+ [, CBDORIG = ] + "'" + this.FormatearTextoSql( &lcCursor..CBDORIG ) + "'"+ [, cptovta = ] + transform( &lcCursor..cptovta )+ [, cptovtad = ] + transform( &lcCursor..cptovtad )+ [, ptoventa = ] + transform( &lcCursor..ptoventa )+ [, cnum = ] + transform( &lcCursor..cnum )+ [, numero = ] + transform( &lcCursor..numero )+ [, cnumd = ] + transform( &lcCursor..cnumd )+ [, CMONTO = ] + transform( &lcCursor..CMONTO )+ [, Tipo = ] + "'" + this.FormatearTextoSql( &lcCursor..Tipo ) + "'"+ [, Reutiliza = ] + Transform( iif( &lcCursor..Reutiliza, 1, 0 ))+ [, Valor = ] + "'" + this.FormatearTextoSql( &lcCursor..Valor ) + "'"+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, MONEDA = ] + "'" + this.FormatearTextoSql( &lcCursor..MONEDA ) + "'"+ [, cSigno = ] + transform( &lcCursor..cSigno )+ [, cSignod = ] + transform( &lcCursor..cSignod ) + [ Where CCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..CCOD ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FALTAFW, FECIMPO, FECTRANS, FMODIFW, CFECHA, ESTTRANS, BDALTAFW, BDMODIFW, CHORA, Articulo, CSERIE, HORAEXPO, HALTAFW, VALTAFW, ZADSFW, VMODIFW, UMODIFW, SMODIFW, UALTAFW, HORAIMPO, SALTAFW, HMODIFW, cCodCompd, cCodComp, cClienteD, CSERIED, cCliente, cTipC, Saldo, cTipCd, COBSS, CFECHAVENC, CCOMPDES, CCOMPORI, CUSUARIO, cletd, CUSUARIOD, clet, CCOD, CFCHDEST, CFCHORIG, CBDDEST, CBDORIG, cptovta, cptovtad, ptoventa, cnum, numero, cnumd, CMONTO, Tipo, Reutiliza, Valor, Email, MONEDA, cSigno, cSignod
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..CFECHA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Articulo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CSERIE ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCodCompd ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCodComp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cClienteD ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CSERIED ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCliente ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..cTipC ) + ',' + transform( &lcCursor..Saldo ) + ',' + transform( &lcCursor..cTipCd ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..COBSS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..CFECHAVENC ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CCOMPDES ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CCOMPORI ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CUSUARIO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cletd ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CUSUARIOD ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..clet ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CCOD ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..CFCHDEST ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..CFCHORIG ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBDDEST ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBDORIG ) + "'" + ',' + transform( &lcCursor..cptovta ) + ',' + transform( &lcCursor..cptovtad ) + ',' + transform( &lcCursor..ptoventa ) + ',' + transform( &lcCursor..cnum ) + ',' + transform( &lcCursor..numero ) + ',' + transform( &lcCursor..cnumd ) + ',' + transform( &lcCursor..CMONTO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Tipo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..Reutiliza, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Valor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MONEDA ) + "'" + ',' + transform( &lcCursor..cSigno ) + ',' + transform( &lcCursor..cSignod )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.CFECHA = isnull( d.CFECHA, t.CFECHA ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CHORA = isnull( d.CHORA, t.CHORA ),t.ARTICULO = isnull( d.ARTICULO, t.ARTICULO ),t.CSERIE = isnull( d.CSERIE, t.CSERIE ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.CCODCOMPD = isnull( d.CCODCOMPD, t.CCODCOMPD ),t.CCODCOMP = isnull( d.CCODCOMP, t.CCODCOMP ),t.CCLIENTED = isnull( d.CCLIENTED, t.CCLIENTED ),t.CSERIED = isnull( d.CSERIED, t.CSERIED ),t.CCLIENTE = isnull( d.CCLIENTE, t.CCLIENTE ),t.CTIPC = isnull( d.CTIPC, t.CTIPC ),t.SALDO = isnull( d.SALDO, t.SALDO ),t.CTIPCD = isnull( d.CTIPCD, t.CTIPCD ),t.COBSS = isnull( d.COBSS, t.COBSS ),t.CFECHAVENC = isnull( d.CFECHAVENC, t.CFECHAVENC ),t.CCOMPDES = isnull( d.CCOMPDES, t.CCOMPDES ),t.CCOMPORI = isnull( d.CCOMPORI, t.CCOMPORI ),t.CUSUARIO = isnull( d.CUSUARIO, t.CUSUARIO ),t.CLETD = isnull( d.CLETD, t.CLETD ),t.CUSUARIOD = isnull( d.CUSUARIOD, t.CUSUARIOD ),t.CLET = isnull( d.CLET, t.CLET ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.CFCHDEST = isnull( d.CFCHDEST, t.CFCHDEST ),t.CFCHORIG = isnull( d.CFCHORIG, t.CFCHORIG ),t.CBDDEST = isnull( d.CBDDEST, t.CBDDEST ),t.CBDORIG = isnull( d.CBDORIG, t.CBDORIG ),t.CPTOVTA = isnull( d.CPTOVTA, t.CPTOVTA ),t.CPTOVTAD = isnull( d.CPTOVTAD, t.CPTOVTAD ),t.PTOVENTA = isnull( d.PTOVENTA, t.PTOVENTA ),t.CNUM = isnull( d.CNUM, t.CNUM ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.CNUMD = isnull( d.CNUMD, t.CNUMD ),t.CMONTO = isnull( d.CMONTO, t.CMONTO ),t.TIPO = isnull( d.TIPO, t.TIPO ),t.REUTILIZA = isnull( d.REUTILIZA, t.REUTILIZA ),t.VALOR = isnull( d.VALOR, t.VALOR ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.CSIGNO = isnull( d.CSIGNO, t.CSIGNO ),t.CSIGNOD = isnull( d.CSIGNOD, t.CSIGNOD )
					from ZooLogic.VALCAMBIO t inner join deleted d 
							 on t.CCOD = d.CCOD
				-- Fin Updates
				insert into ZooLogic.VALCAMBIO(Fecexpo,Faltafw,Fecimpo,Fectrans,Fmodifw,Cfecha,Esttrans,Bdaltafw,Bdmodifw,Chora,Articulo,Cserie,Horaexpo,Haltafw,Valtafw,Zadsfw,Vmodifw,Umodifw,Smodifw,Ualtafw,Horaimpo,Saltafw,Hmodifw,Ccodcompd,Ccodcomp,Ccliented,Cseried,Ccliente,Ctipc,Saldo,Ctipcd,Cobss,Cfechavenc,Ccompdes,Ccompori,Cusuario,Cletd,Cusuariod,Clet,Ccod,Cfchdest,Cfchorig,Cbddest,Cbdorig,Cptovta,Cptovtad,Ptoventa,Cnum,Numero,Cnumd,Cmonto,Tipo,Reutiliza,Valor,Email,Moneda,Csigno,Csignod)
					Select isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.CFECHA,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.CHORA,''),isnull( d.ARTICULO,''),isnull( d.CSERIE,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),isnull( d.HMODIFW,''),isnull( d.CCODCOMPD,''),isnull( d.CCODCOMP,''),isnull( d.CCLIENTED,''),isnull( d.CSERIED,''),isnull( d.CCLIENTE,''),isnull( d.CTIPC,0),isnull( d.SALDO,0),isnull( d.CTIPCD,0),isnull( d.COBSS,''),isnull( d.CFECHAVENC,''),isnull( d.CCOMPDES,''),isnull( d.CCOMPORI,''),isnull( d.CUSUARIO,''),isnull( d.CLETD,''),isnull( d.CUSUARIOD,''),isnull( d.CLET,''),isnull( d.CCOD,''),isnull( d.CFCHDEST,''),isnull( d.CFCHORIG,''),isnull( d.CBDDEST,''),isnull( d.CBDORIG,''),isnull( d.CPTOVTA,0),isnull( d.CPTOVTAD,0),isnull( d.PTOVENTA,0),isnull( d.CNUM,0),isnull( d.NUMERO,0),isnull( d.CNUMD,0),isnull( d.CMONTO,0),isnull( d.TIPO,''),isnull( d.REUTILIZA,0),isnull( d.VALOR,''),isnull( d.EMAIL,''),isnull( d.MONEDA,''),isnull( d.CSIGNO,0),isnull( d.CSIGNOD,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="VALEDECAMBIO                            " atributo="FECHATRANSFERENCIA                      " tabla="VALCAMBIO      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALEDECAMBIO                            " atributo="ESTADOTRANSFERENCIA                     " tabla="VALCAMBIO      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALEDECAMBIO                            " atributo="SERIEORIGEN                             " tabla="VALCAMBIO      " campo="CSERIE    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="=_screen.zoo.app.cSerie                                                                                                                                                                                                                                       " obligatorio="true" admitebusqueda="9" etiqueta="Serie origen                                                                                                                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALEDECAMBIO                            " atributo="TIPODECOMPROBANTEORIGEN                 " tabla="VALCAMBIO      " campo="CTIPC     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Tipo comprobante origen                                                                                                                                                                                                                                   " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="SALDO                                   " tabla="VALCAMBIO      " campo="SALDO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Saldo                                                                                                                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALEDECAMBIO                            " atributo="COMPROBANTEDESTINO                      " tabla="VALCAMBIO      " campo="CCOMPDES  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Comprobante destino                                                                                                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="COMPROBANTEORIGEN                       " tabla="VALCAMBIO      " campo="CCOMPORI  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="3" etiqueta="Comprobante origen                                                                                                                                                                                                                                        " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="USUARIOORIGEN                           " tabla="VALCAMBIO      " campo="CUSUARIO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="=goServicios.Seguridad.cUsuarioLogueado                                                                                                                                                                                                                       " obligatorio="true" admitebusqueda="10" etiqueta="Usuario origen                                                                                                                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALEDECAMBIO                            " atributo="CODIGO                                  " tabla="VALCAMBIO      " campo="CCOD      " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="1" etiqueta="Número vale de cambio                                                                                                                                                                                                                                     " dominio="CODIGOVALEDECAMBIO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="XXXX-XXXX-XXXX-XXXX-XXXX " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="FECHADESTINO                            " tabla="VALCAMBIO      " campo="CFCHDEST  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="23" etiqueta="Fecha destino                                                                                                                                                                                                                                             " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="FECHAORIGEN                             " tabla="VALCAMBIO      " campo="CFCHORIG  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=golibrerias.obtenerfecha()                                                                                                                                                                                                                                   " obligatorio="true" admitebusqueda="13" etiqueta="Fecha origen                                                                                                                                                                                                                                              " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="BDDESTINO                               " tabla="VALCAMBIO      " campo="CBDDEST   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="24" etiqueta="Base de datos destino                                                                                                                                                                                                                                     " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="BDORIGEN                                " tabla="VALCAMBIO      " campo="CBDORIG   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="=_screen.zoo.app.cSucursalActiva                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="14" etiqueta="Base de datos origen                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="PUNTODEVENTAORIGEN                      " tabla="VALCAMBIO      " campo="CPTOVTA   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Punto de venta origen                                                                                                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="2" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALEDECAMBIO                            " atributo="NUMEROORIGEN                            " tabla="VALCAMBIO      " campo="CNUM      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Número comprobante                                                                                                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="3" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALEDECAMBIO                            " atributo="NUMERO                                  " tabla="VALCAMBIO      " campo="NUMERO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="3" etiqueta="Número interno                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALEDECAMBIO                            " atributo="SIMBOLOMONETARIO                        " tabla="VALCAMBIO      " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="=goServicios.Parametros.Felino.Generales.MonedaSistema                                                                                                                                                                                                        " obligatorio="false" admitebusqueda="0" etiqueta="Moneda                                                                                                                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="20" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
