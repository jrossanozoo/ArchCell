...
define class Din_EntidadAdt_estadocontroladorfiscal_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Adt_estadocontroladorfiscal"
	cClaseResponse = this.cNamespaceDTOs + ".Adt_estadocontroladorfiscalResponse"
	cClaseModelo = "Adt_estadocontroladorfiscalModelo"
	cEntidad = "Adt_estadocontroladorfiscal"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_estadocontroladorfiscalModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_estadocontroladorfiscalListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_estadocontroladorfiscalListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_estadocontroladorfiscalModelo"
		endcase
		return lcRetorno
