...
define class Mock_cierreejercicio as MockBase of MockBase.prg
	...
	cClase = 'cierreejercicio'

	
	AsientoAjustePorInflacion = .F.                                                                                                                                                                                                                           
	BASEDEDATOSALTAFW = ""                                                                                                                                                                                                                                    
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Cierre de ejercicio"                                                                                                                                                                                                                     
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'CIERREEJERCICIO'                                                                                                                                                                                                                               
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lHabilitarCuentaBancaria_PK = .F.                                                                                                                                                                                                                         
	lHabilitarCuentaBancaria_PK = .T.                                                                                                                                                                                                                         
	lHabilitarIndice_PK = .F.                                                                                                                                                                                                                                 
	lHabilitarIndice_PK = .T.                                                                                                                                                                                                                                 
	lHabilitarPatrimonial = .T.                                                                                                                                                                                                                               
	lHabilitarPatrimonial = .f.                                                                                                                                                                                                                               
	lHabilitarPlanDeCuentas_PK = .T.                                                                                                                                                                                                                          
	lHabilitarResultado = .T.                                                                                                                                                                                                                                 
	lHabilitarResultado = .f.                                                                                                                                                                                                                                 
	...
	oColaboradorAsiento = null                                                                                                                                                                                                                                
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oCompAsientos = null                                                                                                                                                                                                                                      
	oCompCostoMercaderiaVendida = null                                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function asientoajusteporinflacion_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'asientoajusteporinflacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'asientoajusteporinflacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Asientoajusteporinflacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Asientoajusteporinflacion( lxVal )				this.Setear_Asientoajusteporinflacion( lxVal )				 This.Asientoajusteporinflacion_DespuesDeAsignar()			EndIf		Else			This.Setear_Asientoajusteporinflacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function asientoajusteporinflacion_despuesdeasignar() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Asientoajusteporinflacion_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesdesetearasientoajusteporinflacion() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdesetearasientoajusteporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escuentacontablevalidaparaajustarporinflacion() as booelan                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Escuentacontablevalidaparaajustarporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existeasientodeaperturaasociadoalejercicio() as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existeasientodeaperturaasociadoalejercicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function indice_access() as variant                                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'indice_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'indice_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Indice ) = 'O' or isnull( this.Indice ) )					this.Indice = _Screen.zoo.instanciarentidad( 'Indicesinflacion' )					this.Indice.lEsSubEntidad = .t.					this.enlazar( 'Indice.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Indice.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Indice.CODIGO # this.Indice_PK						this.Indice.CODIGO = this.Indice_PK					endif				endif			endif		endif		return this.Indice
	EndFunc

	*-----------------------------------------------------------------------------------------
	function indice_pk_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'indice_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'indice_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Indice_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.Indice_PK = lxVal		if this.Validar_Indice( lxVal, lxValOld )			if ( this.lHabilitarIndice_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Indice( lxVal )			else				this.Indice_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Cierre de ejercicio - Atributo: Indice)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernumeroultimoejercicio() as integer                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenernumeroultimoejercicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerultimorefundicion() as number                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerultimorefundicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompcostomercaderiavendida_access() as variant                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocompcostomercaderiavendida_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocompcostomercaderiavendida_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oCompCostomercaderiavendida ) = 'O' or isnull( this.oCompCostomercaderiavendida ) )			this.oCompCostomercaderiavendida = _Screen.zoo.InstanciarComponente( 'ComponenteCostomercaderiavendida' )		this.oCompCostomercaderiavendida.Inicializar()		this.enlazar( 'oCompCostomercaderiavendida.EventoObtenerLogueo', 'inyectarLogueo' )		this.enlazar( 'oCompCostomercaderiavendida.EventoObtenerInformacion', 'inyectarInformacion' )		endif		return this.oCompCostomercaderiavendida
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function patrimonial_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'patrimonial_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'patrimonial_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Patrimonial		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Patrimonial( lxVal )				if ( this.lHabilitarPatrimonial or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Patrimonial( lxVal )				else					this.Patrimonial = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Cierre de ejercicio - Atributo: Patrimonial)" )				endif			EndIf		Else			This.Setear_Patrimonial( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function resultado_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'resultado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'resultado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Resultado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Resultado( lxVal )				if ( this.lHabilitarResultado or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Resultado( lxVal )				else					this.Resultado = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Cierre de ejercicio - Atributo: Resultado)" )				endif			EndIf		Else			This.Setear_Resultado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_asientoajusteporinflacion( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_asientoajusteporinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_asientoajusteporinflacion', lcParametros )			endif		endif		this.Asientoajusteporinflacion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_indice( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_indice', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_indice', lcParametros )			endif		endif		this.Indice.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_patrimonial( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_patrimonial', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_patrimonial', lcParametros )			endif		endif		this.Patrimonial = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_resultado( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_resultado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_resultado', lcParametros )			endif		endif		this.Resultado = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tiposdeasientosincluidos( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tiposdeasientosincluidos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tiposdeasientosincluidos', lcParametros )			endif		endif		this.Tiposdeasientosincluidos = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tiposdeasientosincluidos_assign( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tiposdeasientosincluidos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tiposdeasientosincluidos_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tiposdeasientosincluidos		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tiposdeasientosincluidos( lxVal )				this.Setear_Tiposdeasientosincluidos( lxVal )			EndIf		Else			This.Setear_Tiposdeasientosincluidos( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_asientoajusteporinflacion( txval as variant ) as boolean                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_asientoajusteporinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_asientoajusteporinflacion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_indice( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_indice', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_indice', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tiposdeasientosincluidos( txval as variant ) as boolean                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tiposdeasientosincluidos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tiposdeasientosincluidos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaratributosdeajusteporinflacion() as booelan                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaratributosdeajusteporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcargadecuentacontable() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcargadecuentacontable', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarcargadecuentacontable2( txval ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarcargadecuentacontable2', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarcargadeindice() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcargadeindice', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarindice() as boolean                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarindice', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoasientoajusteporinflacion() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoasientoajusteporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwejercicio() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwejercicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoindice() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoindice', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopatrimonial() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridopatrimonial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoresultado() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoresultado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridotiposdeasientosincluidos() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotiposdeasientosincluidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerasientosgenerados() as object                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerasientosgenerados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerejercicio()                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerejercicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validar_ejercicio( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ejercicio', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ejercicio', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if !empty(txVal)			this.Fecha = this.ejercicio.FechaHasta		endif			return llRetorno	
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validar_patrimonial( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_patrimonial', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_patrimonial', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if txVal or this.Resultado			this.lHabilitarPlanDeCuentas_PK = .T.			if empty(this.PlanDeCuentas_PK)				this.PlanDeCuentas_PK = this.ObtenerUltimoRefundicion()			endif		else			this.lHabilitarPlanDeCuentas_PK = .F.		endif			return llRetorno	
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validar_resultado( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CIERREEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_resultado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_resultado', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if txVal or this.Patrimonial			this.lHabilitarPlanDeCuentas_PK = .T.			if empty(this.PlanDeCuentas_PK)				this.PlanDeCuentas_PK = this.ObtenerUltimoRefundicion()			endif		else			this.lHabilitarPlanDeCuentas_PK = .F.		endif			return llRetorno	
	EndFunc
