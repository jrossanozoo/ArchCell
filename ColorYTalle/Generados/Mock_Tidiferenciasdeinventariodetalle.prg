...
define class Mock_tidiferenciasdeinventariodetalle as MockBase of MockBase.prg
	...
	cClase = 'tidiferenciasdeinventariodetalle'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Detalle de diferencia de inventarios"                                                                                                                                                                                                    
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'TIDIFERENCIASDEINVENTARIODETALLE'                                                                                                                                                                                                              
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function actualizarestadorechazado() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarestadorechazado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estarechazado() as boolean                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estarechazado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idcabecera_access() as variant                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idcabecera_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idcabecera_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Idcabecera ) = 'O' or isnull( this.Idcabecera ) )					this.Idcabecera = _Screen.zoo.instanciarentidad( 'Tidiferenciasdeinventario' )					this.Idcabecera.lEsSubEntidad = .t.					this.enlazar( 'Idcabecera.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Idcabecera.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Idcabecera.CODIGO # this.Idcabecera_PK						this.Idcabecera.CODIGO = this.Idcabecera_PK					endif				endif			endif		endif		return this.Idcabecera
	EndFunc

	*-----------------------------------------------------------------------------------------
	function idcabecera_pk_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idcabecera_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idcabecera_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Idcabecera_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		this.Idcabecera_PK = lxVal		if this.Validar_Idcabecera( lxVal, lxValOld )			This.Setear_Idcabecera( lxVal )		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorcolorytalle_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorcolorytalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorcolorytalle_access', lcParametros )			endif		endif		if this.ldestroy		else			if !vartype( this.oColaboradorColoryTalle) = 'O' or isnull( this.oColaboradorColoryTalle)				this.oColaboradorColoryTalle= _Screen.zoo.CrearObjeto( 'ColaboradorColoryTalle' )				this.enlazar(".oColaboradorColoryTalle.EventoInformarArticuloConColorOTalleFueraDePaletaOCurva","EventoInformarArticuloConColorOTalleFueraDePaletaOCurva")					endif		endif		return this.oColaboradorColoryTalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function rechazado_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rechazado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rechazado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Rechazado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Rechazado( lxVal )				this.Setear_Rechazado( lxVal )			EndIf		Else			This.Setear_Rechazado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idcabecera( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_idcabecera', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_idcabecera', lcParametros )			endif		endif		this.Idcabecera.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_rechazado( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rechazado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rechazado', lcParametros )			endif		endif		this.Rechazado = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearestadorechazado( tlestadorechazo as boolean ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tlestadorechazo
		...
		return this.ObtenerResultado( 'Setearestadorechazado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idcabecera( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idcabecera', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idcabecera', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_rechazado( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIODETALLE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rechazado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rechazado', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaridcabecera() as boolean                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaridcabecera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwrechazado() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwrechazado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoidcabecera() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoidcabecera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorechazado() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridorechazado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarunicidad() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
