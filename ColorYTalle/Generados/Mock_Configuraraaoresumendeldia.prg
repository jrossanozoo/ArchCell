...
define class Mock_CONFIGURARAAORESUMENDELDIA as MockBase of MockBase.prg

	cClase = 'CONFIGURARAAORESUMENDELDIA'
	...
	*-----------------------------------------------------------------------------------------
	function automatizaralcerrarlacaja( toconjuntodedestinos as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toconjuntodedestinos
		...
		return this.ObtenerResultado( 'Automatizaralcerrarlacaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function configurar( toinfo as zooinformacion of zooinformacion.prg, tlforzar as boolean ) as zooinformacion of zooinformacion.prg                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Configurar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function init( toparametros as object )                                                                                                                                                                                                                   
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function consultaralusuariosideseaautomatizarelenviodelresumendeldia( tccadenadebuzones as string ) as boolean                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tccadenadebuzones
		...
		return this.ObtenerResultado( 'Consultaralusuariosideseaautomatizarelenviodelresumendeldia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function consultarsivuelveapreguntar() as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Consultarsivuelveapreguntar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function despuesdeconfiguraraao() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdeconfiguraraao', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercadenadebuzones( toconjuntodedestinos as zoocoleccion of zoocoleccion.prg ) as string                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercadenadebuzones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function restaurarconfiguracion() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Restaurarconfiguracion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearobjetoparametros( toparametros as object ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearobjetoparametros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificar() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Verificar', lcParametros )
	EndFunc
