	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PAISES ( "Fecexpo","Fectrans","Fecimpo","Fmodifw","Faltafw","Smodifw","Saltafw","Ualtafw","Vmodifw","Zadsfw","Valtafw","Hmodifw","Umodifw","Haltafw","Bdmodifw","Horaimpo","Bdaltafw","Esttrans","Horaexpo","Timestamp","Tipagrupub","Pcod","Pdes","Pobs","Paaf" ) values ( <<"'" + this.ConvertirDateSql( lxPaisesFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPaisesFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPaisesFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPaisesFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPaisesFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesHoraexpo ) + "'" >>, <<lxPaisesTimestamp >>, <<lxPaisesTipagrupub >>, <<"'" + this.FormatearTextoSql( lxPaisesPcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesPdes ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPaisesPobs ) + "'" >>, <<lxPaisesPaaf >> )
			endtext
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubPAI("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.PAISES set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxPaisesFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxPaisesFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxPaisesFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxPaisesFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxPaisesFaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxPaisesSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxPaisesSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxPaisesUaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxPaisesVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxPaisesZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxPaisesValtafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxPaisesHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxPaisesUmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxPaisesHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPaisesBdmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxPaisesHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPaisesBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxPaisesEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxPaisesHoraexpo ) + "'">>,"Timestamp" = <<lxPaisesTimestamp>>,"Tipagrupub" = <<lxPaisesTipagrupub>>,"Pcod" = <<"'" + this.FormatearTextoSql( lxPaisesPcod ) + "'">>,"Pdes" = <<"'" + this.FormatearTextoSql( lxPaisesPdes ) + "'">>,"Pobs" = <<"'" + this.FormatearTextoSql( lxPaisesPobs ) + "'">>,"Paaf" = <<lxPaisesPaaf>> where "Pcod" = <<"'" + this.FormatearTextoSql( lxPaisesPcod ) + "'">> and  PAISES.PCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
			this.ComprobarResultadoDeEjecucionDelUpdate()
		this.ComprobarTransaccion()
			this.oConexion.EjecutarSql( 'delete from ZooLogic.AgruPubPAI where "Codigo" = ' + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Timestamp" as "Timestamp", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Pcod" as "Codigo", "Pdes" as "Descripcion", "Pobs" as "Observacion", "Paaf" as "Equivalenciaafip" from ZooLogic.PAISES where "Pcod" = <<"'" + this.FormatearTextoSql( lxPaisesPcod ) + "'">> and  PAISES.PCOD != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrup" as "Agrupamiento", "Agrupdes" as "Agrupamientodetalle" from ZooLogic.AgruPubPAI where Codigo = <<"'" + this.FormatearTextoSql( c_PAISES.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Fmodifw,Faltafw,Smodifw,Saltafw,Ualtafw,Vmodifw,Zadsfw,Valtafw,Hmod" + ;
"ifw,Umodifw,Haltafw,Bdmodifw,Horaimpo,Bdaltafw,Esttrans,Horaexpo,Timestamp,Tipagrupub,Pcod,Pdes,Pobs" + ;
",Paaf" + ;
" from ZooLogic.PAISES where  PAISES.PCOD != '' and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAgruPubliDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		Local lcAtributos As String, lcWhere As String
		lcWhere = " Where  AGRUPUBPAI.CODIGO != ''"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
		...
		return this.ObtenerDatos( lcAtributos, tcHaving, tcOrder, tcFunc, lcWhere, 'AgruPubPAI', 'AgruPubliDetalle', tnTope )
	Endfunc
		...
		With this
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAgrupamientodetalle = loItem.Agrupamientodetalle
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubPAI("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.PAISES set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxPaisesFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxPaisesFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxPaisesFecimpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxPaisesFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxPaisesFaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxPaisesSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxPaisesSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxPaisesUaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxPaisesVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxPaisesZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxPaisesValtafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxPaisesHmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxPaisesUmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxPaisesHaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPaisesBdmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxPaisesHoraimpo ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPaisesBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxPaisesEsttrans ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxPaisesHoraexpo ) + "'">>, "Timestamp" = <<lxPaisesTimestamp>>, "Tipagrupub" = <<lxPaisesTipagrupub>>, "Pcod" = <<"'" + this.FormatearTextoSql( lxPaisesPcod ) + "'">>, "Pdes" = <<"'" + this.FormatearTextoSql( lxPaisesPdes ) + "'">>, "Pobs" = <<"'" + this.FormatearTextoSql( lxPaisesPobs ) + "'">>, "Paaf" = <<lxPaisesPaaf>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'PAISES' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			loColeccion.Agregar([delete from ZooLogic.AgruPubPAI where "Codigo" = ] + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'")
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.PAISES set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, pcod = ] + "'" + this.FormatearTextoSql( &lcCursor..pcod ) + "'"+ [, pdes = ] + "'" + this.FormatearTextoSql( &lcCursor..pdes ) + "'"+ [, pobs = ] + "'" + this.FormatearTextoSql( &lcCursor..pobs ) + "'"+ [, paaf = ] + transform( &lcCursor..paaf ) + [ Where pcod = ] + "'" + this.FormatearTextoSql( &lcCursor..pcod ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FMODIFW, FALTAFW, SMODIFW, SALTAFW, UALTAFW, VMODIFW, ZADSFW, VALTAFW, HMODIFW, UMODIFW, HALTAFW, BDMODIFW, HORAIMPO, BDALTAFW, ESTTRANS, HORAEXPO, TIMESTAMP, tipagrupub, pcod, pdes, pobs, paaf
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..tipagrupub )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..pcod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..pdes ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..pobs ) + "'" + ',' + transform( &lcCursor..paaf )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirDetalles() As Void
		...
		If lcCantRegistros > 0
			lcIn = This.ObtenerInSqlServer( lcCursor, 'pcod','C')
			lnFragmento = goRegistry.nucleo.cantidadDeElementosEnSentenciaInSQL
			loIn = this.ObtenerColeccionInSqlServer( lcCursor,'','pcod')
			...
			this.oConexion.EjecutarSql( [Delete From ZooLogic.AgruPubPAI Where Codigo] + lcIn  )
			endfor
			if llEjecutaEnTransaccion
				this.oConexion.EjecutarSQL( 'COMMIT TRANSACTION' )
			endif
	...
	lcDetalle = This.oEntidad.cPrefijoRecibir + 'ITEMAGRUPAPUBLICPAI'
	Select * From &lcDetalle into cursor cDetallesExistentes ;
		where Codigo in ( select pcod from &lcCursor )
	select cDetallesExistentes
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","Codigo","Agrup","AgrupDes"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.AgruPubPAI ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Agrup      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AgrupDes   ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'PAISES_POBS'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'ITEMAGRUPAPUBLICPAI'
				llRetorno = .T.
		EndCase
		Return llRetorno
	EndFunc
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.PCOD = isnull( d.PCOD, t.PCOD ),t.PDES = isnull( d.PDES, t.PDES ),t.POBS = isnull( d.POBS, t.POBS ),t.PAAF = isnull( d.PAAF, t.PAAF )
					from ZooLogic.PAISES t inner join deleted d 
							 on t.pcod = d.pcod
				-- Fin Updates
				insert into ZooLogic.PAISES(Fecexpo,Fectrans,Fecimpo,Fmodifw,Faltafw,Smodifw,Saltafw,Ualtafw,Vmodifw,Zadsfw,Valtafw,Hmodifw,Umodifw,Haltafw,Bdmodifw,Horaimpo,Bdaltafw,Esttrans,Horaexpo,Timestamp,Tipagrupub,Pcod,Pdes,Pobs,Paaf)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.TIMESTAMP,0),isnull( d.TIPAGRUPUB,0),isnull( d.PCOD,''),isnull( d.PDES,''),isnull( d.POBS,''),isnull( d.PAAF,0)
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_AgruPubPAI( tcTablaTrabajo ) as String

		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_PAISES_AgruPubPAI
ON ZooLogic.TablaTrabajo_PAISES_AgruPubPAI
AFTER DELETE
As
Begin
Update t Set 
...
from ZooLogic.AgruPubPAI t inner join deleted d 
 on t.CODIGO = d.CODIGO
-- Fin Updates
insert into ZooLogic.AgruPubPAI
( 
"NROITEM",
"CODIGO",
"AGRUP",
...
d.AGRUP,
d.AGRUPDES
From deleted d left join ZooLogic.AgruPubPAI pk 
		...
		with this.oEntidad
			...
			if reccount( 'c_PAISES' ) < 1
				...
				Try
					...
					.Tipoagrupamientopublicaciones = nvl( c_PAISES.Tipoagrupamientopublicaciones, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="PAISES                                  " atributo="FECHATRANSFERENCIA                      " tabla="PAISES         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAISES                                  " atributo="ESTADOTRANSFERENCIA                     " tabla="PAISES         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAISES                                  " atributo="TIPOAGRUPAMIENTOPUBLICACIONES           " tabla="PAISES         " campo="TIPAGRUPUB" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAISES                                  " atributo="AGRUPUBLIDETALLE                        " tabla="AGRUPUBPAI     " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Agrupamientos                                                                                                                                                   " dominio="DETALLEITEMAGRUPAPUBLICPAI    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
