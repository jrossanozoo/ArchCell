...
define class Din_EntidadCOMPORTAMIENTOCODIGOSUGERIDOENTIDADAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComcodsuFecimpo, lxComcodsuFectrans, lxComcodsuFmodifw, lxComcodsuFecexpo, lxComcodsuFaltafw, lxComcodsuUaltafw, lxComcodsuValtafw, lxComcodsuUmodifw, lxComcodsuHaltafw, lxComcodsuHoraexpo, lxComcodsuSaltafw, lxComcodsuHoraimpo, lxComcodsuHmodifw, lxComcodsuVmodifw, lxComcodsuEsttrans, lxComcodsuZadsfw, lxComcodsuSmodifw, lxComcodsuBdmodifw, lxComcodsuBdaltafw, lxComcodsuBloqreg, lxComcodsuDesentidad, lxComcodsuEntidad, lxComcodsuAnchodispo, lxComcodsuSugerir, lxComcodsuIdglobal, lxComcodsuAnchosuger, lxComcodsuPrefijobd, lxComcodsuPrefijo, lxComcodsuVistaprev, lxComcodsuBusqextend, lxComcodsuSalta, lxComcodsuObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.COMCODSU ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Ualtafw","Valtafw","Umodifw","Haltafw","Horaexpo","Saltafw","Horaimpo","Hmodifw","Vmodifw","Esttrans","Zadsfw","Smodifw","Bdmodifw","Bdaltafw","Bloqreg","Desentidad","Entidad","Anchodispo","Sugerir","Idglobal","Anchosuger","Prefijobd","Prefijo","Vistaprev","Busqextend","Salta","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxComcodsuFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComcodsuFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComcodsuFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComcodsuFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComcodsuFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuBdaltafw ) + "'" >>, <<iif( lxComcodsuBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComcodsuDesentidad ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuEntidad ) + "'" >>, <<lxComcodsuAnchodispo >>, <<iif( lxComcodsuSugerir, 1, 0 ) >>, <<iif( lxComcodsuIdglobal, 1, 0 ) >>, <<lxComcodsuAnchosuger >>, <<iif( lxComcodsuPrefijobd, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComcodsuPrefijo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComcodsuVistaprev ) + "'" >>, <<iif( lxComcodsuBusqextend, 1, 0 ) >>, <<iif( lxComcodsuSalta, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComcodsuObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Desentidad" as "Descripciondelaentidad", "Entidad" as "Entidad", "Anchodispo" as "Anchodisponible", "Sugerir" as "Sugerir", "Idglobal" as "Idglobal", "Anchosuger" as "Anchoasugerir", "Prefijobd" as "Usarprefijobasededatos", "Prefijo" as "Prefijoentidad", "Vistaprev" as "Vistaprevia", "Busqextend" as "Busquedaextendida", "Salta" as "Salta", "Obs" as "Observacion" from ORGANIZACION.COMCODSU where "Entidad" = <<"'" + this.FormatearTextoSql( lxComcodsuEntidad ) + "'">> and  COMCODSU.ENTIDAD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Ualtafw,Valtafw,Umodifw,Haltafw,Horaexpo,Saltafw,Ho" + ;
"raimpo,Hmodifw,Vmodifw,Esttrans,Zadsfw,Smodifw,Bdmodifw,Bdaltafw,Bloqreg,Desentidad,Entidad,Anchodis" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, UALTAFW, VALTAFW, UMODIFW, HALTAFW, HORAEXPO, SALTAFW, HORAIMPO, HMODIFW, VMODIFW, ESTTRANS, ZADSFW, SMODIFW, BDMODIFW, BDALTAFW, BLOQREG, DesEntidad, Entidad, AnchoDispo, Sugerir, IdGlobal, AnchoSuger, PrefijoBD, Prefijo, vistaprev, BusqExtend, Salta, Obs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DesEntidad ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.DESENTIDAD = isnull( d.DESENTIDAD, t.DESENTIDAD ),t.ENTIDAD = isnull( d.ENTIDAD, t.ENTIDAD ),t.ANCHODISPO = isnull( d.ANCHODISPO, t.ANCHODISPO ),t.SUGERIR = isnull( d.SUGERIR, t.SUGERIR ),t.IDGLOBAL = isnull( d.IDGLOBAL, t.IDGLOBAL ),t.ANCHOSUGER = isnull( d.ANCHOSUGER, t.ANCHOSUGER ),t.PREFIJOBD = isnull( d.PREFIJOBD, t.PREFIJOBD ),t.PREFIJO = isnull( d.PREFIJO, t.PREFIJO ),t.VISTAPREV = isnull( d.VISTAPREV, t.VISTAPREV ),t.BUSQEXTEND = isnull( d.BUSQEXTEND, t.BUSQEXTEND ),t.SALTA = isnull( d.SALTA, t.SALTA ),t.OBS = isnull( d.OBS, t.OBS )
					from ORGANIZACION.COMCODSU t inner join deleted d 
							 on t.Entidad = d.Entidad
							 and  t.Entidad = d.Entidad
				-- Fin Updates
				insert into ORGANIZACION.COMCODSU(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Ualtafw,Valtafw,Umodifw,Haltafw,Horaexpo,Saltafw,Horaimpo,Hmodifw,Vmodifw,Esttrans,Zadsfw,Smodifw,Bdmodifw,Bdaltafw,Bloqreg,Desentidad,Entidad,Anchodispo,Sugerir,Idglobal,Anchosuger,Prefijobd,Prefijo,Vistaprev,Busqextend,Salta,Obs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.ZADSFW,''),isnull( d.SMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.BLOQREG,0),isnull( d.DESENTIDAD,''),isnull( d.ENTIDAD,''),isnull( d.ANCHODISPO,0),isnull( d.SUGERIR,0),isnull( d.IDGLOBAL,0),isnull( d.ANCHOSUGER,0),isnull( d.PREFIJOBD,0),isnull( d.PREFIJO,''),isnull( d.VISTAPREV,''),isnull( d.BUSQEXTEND,0),isnull( d.SALTA,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="COMPORTAMIENTOCODIGOSUGERIDOENTIDAD     " atributo="FECHATRANSFERENCIA                      " tabla="COMCODSU       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPORTAMIENTOCODIGOSUGERIDOENTIDAD     " atributo="ESTADOTRANSFERENCIA                     " tabla="COMCODSU       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPORTAMIENTOCODIGOSUGERIDOENTIDAD     " atributo="DESCRIPCIONDELAENTIDAD                  " tabla="COMCODSU       " campo="DESENTIDAD" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="1" etiqueta="Entidad descripción                                                                                                                                             " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
