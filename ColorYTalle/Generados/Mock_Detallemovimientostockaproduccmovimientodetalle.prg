...
define class Mock_Detallemovimientostockaproduccmovimientodetalle as MockBase of MockBase.prg

	cClase = 'Detallemovimientostockaproduccmovimientodetalle'

	
	Sum_Cantidad = 0                                                                                                                                                                                                                                          
	Sum_Cantidadinsumo = 0                                                                                                                                                                                                                                    
	...
	cNombreVisual = 'Detalle de Insumos'                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_cantidadinsumo() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocambiosum_cantidadinsumo', lcParametros )
	EndFunc
