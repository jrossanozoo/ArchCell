...
define class Mock_Categoriadearticuload_sqlserver as MockBase of MockBase.prg

	cClase = 'Categoriadearticuload_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubsgr( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubsgr', lcParametros )
	EndFunc
