...
define class Din_EntidadAjustecccliente_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Ajustecccliente"
	cClaseResponse = this.cNamespaceDTOs + ".AjusteccclienteResponse"
	cClaseModelo = "AjusteccclienteModelo"
	cEntidad = "Ajustecccliente"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "AjusteccclienteModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AjusteccclienteListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AjusteccclienteListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "AjusteccclienteModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleAjusteDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Cliente", toEntidad.AjusteDetalle.oItem, "Cliente_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Clientedetalle", toEntidad.AjusteDetalle.oItem, "ClienteDetalle" )
	...
	protected function CargarColeccionModeloAjusteDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .AjusteDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemAjustecccliente" )
				this.SetearAtributoString( loItem, "Cliente", .AjusteDetalle.Item(lnI).Cliente_PK)
				this.SetearAtributoString( loItem, "ClienteDetalle", .AjusteDetalle.Item(lnI).ClienteDetalle)
