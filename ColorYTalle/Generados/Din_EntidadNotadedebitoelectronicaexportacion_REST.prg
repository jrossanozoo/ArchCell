...
define class Din_EntidadNotadedebitoelectronicaexportacion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadedebitoelectronicaexportacion"
	cClaseResponse = this.cNamespaceDTOs + ".NotadedebitoelectronicaexportacionResponse"
	cClaseModelo = "NotadedebitoelectronicaexportacionModelo"
	cEntidad = "Notadedebitoelectronicaexportacion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaexportacionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaexportacionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaexportacionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaexportacionModelo"
		endcase
		return lcRetorno
