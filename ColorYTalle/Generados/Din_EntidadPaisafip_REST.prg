...
define class Din_EntidadPaisafip_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Paisafip"
	cClaseResponse = this.cNamespaceDTOs + ".PaisafipResponse"
	cClaseModelo = "PaisafipModelo"
	cEntidad = "Paisafip"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "PaisafipModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "PaisafipListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "PaisafipListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "PaisafipModelo"
		endcase
		return lcRetorno
