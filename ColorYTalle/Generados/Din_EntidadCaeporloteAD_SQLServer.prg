...
define class Din_EntidadCAEPORLOTEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCaeplFectrans, lxCaeplFecimpo, lxCaeplFmodifw, lxCaeplFecexpo, lxCaeplCodigo, lxCaeplHoraimpo, lxCaeplHaltafw, lxCaeplHoraexpo, lxCaeplSaltafw, lxCaeplVmodifw, lxCaeplZadsfw, lxCaeplValtafw, lxCaeplUmodifw, lxCaeplSmodifw, lxCaeplUaltafw, lxCaeplHmodifw, lxCaeplEsttrans, lxCaeplBdmodifw, lxCaeplBdaltafw, lxCaeplTimestamp, lxCaeplFaltafw, lxCaeplComprob, lxCaeplLetra, lxCaeplPtovta, lxCaeplNumdesde, lxCaeplNumhasta, lxCaeplSerie, lxCaeplVrsn, lxCaeplDb, lxCaeplUsuario, lxCaeplMobs, lxCaeplDetalle
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CAEPL ( "Fectrans","Fecimpo","Fmodifw","Fecexpo","Codigo","Horaimpo","Haltafw","Horaexpo","Saltafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Esttrans","Bdmodifw","Bdaltafw","Timestamp","Faltafw","Comprob","Letra","Ptovta","Numdesde","Numhasta","Serie","Vrsn","Db","Usuario","Mobs","Detalle" ) values ( <<"'" + this.ConvertirDateSql( lxCaeplFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeplFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeplFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeplFecexpo ) + "'" >>, <<lxCaeplCodigo >>, <<"'" + this.FormatearTextoSql( lxCaeplHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplBdaltafw ) + "'" >>, <<lxCaeplTimestamp >>, <<"'" + this.ConvertirDateSql( lxCaeplFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplComprob ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplLetra ) + "'" >>, <<lxCaeplPtovta >>, <<lxCaeplNumdesde >>, <<lxCaeplNumhasta >>, <<"'" + this.FormatearTextoSql( lxCaeplSerie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplVrsn ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplDb ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplUsuario ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplMobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeplDetalle ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CAEPL set "Fectrans" = <<"'" + this.ConvertirDateSql( lxCaeplFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCaeplFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCaeplFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCaeplFecexpo ) + "'">>,"Codigo" = <<lxCaeplCodigo>>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCaeplHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCaeplHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCaeplHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCaeplSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCaeplVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCaeplZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCaeplValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCaeplUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCaeplSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCaeplUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCaeplHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCaeplEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCaeplBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCaeplBdaltafw ) + "'">>,"Timestamp" = <<lxCaeplTimestamp>>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCaeplFaltafw ) + "'">>,"Comprob" = <<"'" + this.FormatearTextoSql( lxCaeplComprob ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxCaeplLetra ) + "'">>,"Ptovta" = <<lxCaeplPtovta>>,"Numdesde" = <<lxCaeplNumdesde>>,"Numhasta" = <<lxCaeplNumhasta>>,"Serie" = <<"'" + this.FormatearTextoSql( lxCaeplSerie ) + "'">>,"Vrsn" = <<"'" + this.FormatearTextoSql( lxCaeplVrsn ) + "'">>,"Db" = <<"'" + this.FormatearTextoSql( lxCaeplDb ) + "'">>,"Usuario" = <<"'" + this.FormatearTextoSql( lxCaeplUsuario ) + "'">>,"Mobs" = <<"'" + this.FormatearTextoSql( lxCaeplMobs ) + "'">>,"Detalle" = <<"'" + this.FormatearTextoSql( lxCaeplDetalle ) + "'">> where "Codigo" = <<lxCaeplCodigo>> and  CAEPL.CODIGO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
...
"tafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdmodifw,Bdaltafw,Timestamp,Faltafw,Comprob,Letra,Ptov" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FECIMPO, FMODIFW, FECEXPO, CODIGO, HORAIMPO, HALTAFW, HORAEXPO, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, ESTTRANS, BDMODIFW, BDALTAFW, TIMESTAMP, FAltaFW, Comprob, Letra, ptovta, NumDesde, NumHasta, serie, vrsn, db, usuario, MObs, detalle
				EndText
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.COMPROB = isnull( d.COMPROB, t.COMPROB ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.PTOVTA = isnull( d.PTOVTA, t.PTOVTA ),t.NUMDESDE = isnull( d.NUMDESDE, t.NUMDESDE ),t.NUMHASTA = isnull( d.NUMHASTA, t.NUMHASTA ),t.SERIE = isnull( d.SERIE, t.SERIE ),t.VRSN = isnull( d.VRSN, t.VRSN ),t.DB = isnull( d.DB, t.DB ),t.USUARIO = isnull( d.USUARIO, t.USUARIO ),t.MOBS = isnull( d.MOBS, t.MOBS ),t.DETALLE = isnull( d.DETALLE, t.DETALLE )
					from ZooLogic.CAEPL t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.CAEPL(Fectrans,Fecimpo,Fmodifw,Fecexpo,Codigo,Horaimpo,Haltafw,Horaexpo,Saltafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdmodifw,Bdaltafw,Timestamp,Faltafw,Comprob,Letra,Ptovta,Numdesde,Numhasta,Serie,Vrsn,Db,Usuario,Mobs,Detalle)
					Select isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),isnull( d.CODIGO,0),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.TIMESTAMP,0),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.COMPROB,''),isnull( d.LETRA,''),isnull( d.PTOVTA,0),isnull( d.NUMDESDE,0),isnull( d.NUMHASTA,0),isnull( d.SERIE,''),isnull( d.VRSN,''),isnull( d.DB,''),isnull( d.USUARIO,''),isnull( d.MOBS,''),isnull( d.DETALLE,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CAEPORLOTE                              " atributo="FECHATRANSFERENCIA                      " tabla="CAEPL          " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAEPORLOTE                              " atributo="ESTADOTRANSFERENCIA                     " tabla="CAEPL          " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAEPORLOTE                              " atributo="NUMERODESDE                             " tabla="CAEPL          " campo="NUMDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="9" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="6" etiqueta="Número desde                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAEPORLOTE                              " atributo="NUMEROHASTA                             " tabla="CAEPL          " campo="NUMHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="9" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="7" etiqueta="Número hasta                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAEPORLOTE                              " atributo="SERIE                                   " tabla="CAEPL          " campo="SERIE     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="=_screen.zoo.app.cSerie                                                                                                                                                                                                                                       " obligatorio="false" admitebusqueda="0" etiqueta="Serie                                                                                                                                                           " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="11" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAEPORLOTE                              " atributo="VERSION                                 " tabla="CAEPL          " campo="VRSN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="=_screen.zoo.app.ObtenerVersion()                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="0" etiqueta="Versión                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="12" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAEPORLOTE                              " atributo="DB                                      " tabla="CAEPL          " campo="DB        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="=_screen.zoo.app.cSucursalActiva                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Sucursal                                                                                                                                                        " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="13" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAEPORLOTE                              " atributo="OBS                                     " tabla="CAEPL          " campo="MOBS      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Comentarios AFIP                                                                                                                                                " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAEPORLOTE                              " atributo="DETALLE                                 " tabla="CAEPL          " campo="DETALLE   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="201" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="25" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
