	...
	*-----------------------------------------------------------------------------------------
	function Init( t1, t2, t3, t4 ) As Boolean
		...
		if llRetorno
			...
			this.oComprobantes.Agregar( "1, 2, 3, 4, 5, 6, 11, 13, 27, 28, 29, 33, 35, 36, 47, 48, 49, 51, 52, 53, 54, 55, 56", "VENTASFISCAL" )
			...
			this.oComprobantes.Agregar( "8, 9, 10", "COMPRASFISCALCONVALORES" )
			this.oComprobantes.Agregar( "-1, 8, 9, 10", "COMPRASFISCALSUBDIARIOIVACOMPRAS" )
			...
			this.oComprobantes.Agregar( "47, 48, 49", "VENTASTEXPORTACIONCONVALOR" )
			this.oComprobantes.Agregar( "1, 3, 4", "VENTASMANUALESLESCONVALOR" )
		endif
	...
	*-----------------------------------------------------------------------------------------
	function GenerarXmlComprobantes()
		...
		insert into &lcNombreCursor values( -1 , 'Todos', '')
				...
				insert into &lcNombreCursor values( 40, 'Remito De Compra', 'REMITODECOMPRA')
				insert into &lcNombreCursor values( 41, 'Cancelación De Compra', 'CANCELACIONDECOMPRA')
				insert into &lcNombreCursor values( 42, 'Requerimiento De Compra', 'REQUERIMIENTODECOMPRA')
				insert into &lcNombreCursor values( 43, 'Ajuste De Cuenta Corriente De Clientes', 'AJUSTECCCLIENTE')
				insert into &lcNombreCursor values( 44, 'Ajuste De Cuenta Corriente De Proveedores', 'AJUSTECCPROVEEDOR')
