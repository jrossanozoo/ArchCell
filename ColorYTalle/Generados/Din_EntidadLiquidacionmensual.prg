...
define class Din_EntidadLIQUIDACIONMENSUAL as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionDetalles() as Boolean
		...
		llRetorno = This.ValidarUnDetalle( this.Conceptosgenerales, 'Conceptos generales' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.Conceptosdiarios, 'Conceptos diarios' ) and llRetorno
