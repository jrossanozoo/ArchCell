...
define class Din_ItemORIGENDEDATOSAgrupublidetalle as ItemAgruPubliDetalle of ItemAgruPubliDetalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'ORIGENDEDATOS', 'Agrupublidetalle')
