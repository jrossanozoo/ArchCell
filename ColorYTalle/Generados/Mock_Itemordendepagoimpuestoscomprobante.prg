...
define class Mock_Itemordendepagoimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemordendepagoimpuestoscomprobante'
	...
	*-----------------------------------------------------------------------------------------
	function acumuladocomprobante_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Acumuladocomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function acumuladopagos_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Acumuladopagos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function acumuladoretenciones_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Acumuladoretenciones_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function certificadosire_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Certificadosire_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigocdr_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Codigocdr_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codimp_access() as variant                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Codimp_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codimp_pk_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Codimp_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codimpdetalle_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Codimpdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codseguridadsire_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Codseguridadsire_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escalamontofijo_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Escalamontofijo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escalaporcentaje_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Escalaporcentaje_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escalasobreexcedente_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Escalasobreexcedente_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esrg1575ar_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Esrg1575ar_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esrg2616ar_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Esrg2616ar_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function jurisdicciondescripcion_assign( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Jurisdicciondescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function minimonoimp_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Minimonoimp_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function minimonoimponible_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Minimonoimponible_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montobase_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Montobase_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompretenciones_access() as variant                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Ocompretenciones_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajeconvenio_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Porcentajeconvenio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function regimenimpositivo_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Regimenimpositivo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function regimenimpositivodescripcion_assign( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Regimenimpositivodescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_acumuladocomprobante( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_acumuladocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_acumuladopagos( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_acumuladopagos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_acumuladoretenciones( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_acumuladoretenciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_certificadosire( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_certificadosire', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigocdr( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_codigocdr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codimp( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_codimp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codimpdetalle( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_codimpdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codseguridadsire( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_codseguridadsire', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_escalamontofijo( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_escalamontofijo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_escalaporcentaje( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_escalaporcentaje', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_escalasobreexcedente( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_escalasobreexcedente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_esrg1575ar( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_esrg1575ar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_esrg2616ar( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_esrg2616ar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_jurisdicciondescripcion( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_jurisdicciondescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_minimonoimp( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_minimonoimp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_minimonoimponible( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_minimonoimponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montobase( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_montobase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porcentajeconvenio( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_porcentajeconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_regimenimpositivodescripcion( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_regimenimpositivodescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipoimpuestocdr( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_tipoimpuestocdr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tooltip( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_tooltip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipoimpuestocdr_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Tipoimpuestocdr_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tooltip_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Tooltip_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_acumuladocomprobante( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_acumuladocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_acumuladopagos( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_acumuladopagos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_acumuladoretenciones( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_acumuladoretenciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_certificadosire( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_certificadosire', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigocdr( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_codigocdr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codimp( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_codimp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codimpdetalle( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_codimpdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codseguridadsire( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_codseguridadsire', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_escalamontofijo( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_escalamontofijo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_escalaporcentaje( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_escalaporcentaje', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_escalasobreexcedente( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_escalasobreexcedente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_esrg1575ar( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_esrg1575ar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_esrg2616ar( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_esrg2616ar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_jurisdicciondescripcion( txval as variant ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_jurisdicciondescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_minimonoimp( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_minimonoimp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_minimonoimponible( txval as variant ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_minimonoimponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montobase( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_montobase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajeconvenio( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_porcentajeconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_regimenimpositivodescripcion( txval as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_regimenimpositivodescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipoimpuestocdr( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_tipoimpuestocdr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tooltip( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_tooltip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodimp() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridocodimp', lcParametros )
	EndFunc
