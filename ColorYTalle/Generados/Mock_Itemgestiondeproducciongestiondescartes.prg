...
define class Mock_Itemgestiondeproducciongestiondescartes as MockBase of MockBase.prg

	cClase = 'Itemgestiondeproducciongestiondescartes'
	...
	*-----------------------------------------------------------------------------------------
	function cantdescarte_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cantdescarte_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function colorm_access() as variant                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Colorm_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function colorm_pk_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Colorm_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function colormdetalle_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Colormdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iditeminsumo_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Iditeminsumo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariodest_access() as variant                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Inventariodest_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariodest_pk_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Inventariodest_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariodestdetalle_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Inventariodestdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function motdescarte_access() as variant                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Motdescarte_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function motdescarte_pk_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Motdescarte_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function motdescartedetalle_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Motdescartedetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantdescarte( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_cantdescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_colorm( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_colorm', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_colormdetalle( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_colormdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iditeminsumo( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_iditeminsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventariodest( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_inventariodest', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventariodestdetalle( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_inventariodestdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_motdescarte( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_motdescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_motdescartedetalle( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_motdescartedetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tallem( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_tallem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tallemdetalle( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_tallemdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tallem_access() as variant                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Tallem_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tallem_pk_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Tallem_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tallemdetalle_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Tallemdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantdescarte( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_cantdescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_colorm( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_colorm', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_colormdetalle( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_colormdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iditeminsumo( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_iditeminsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventariodest( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_inventariodest', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventariodestdetalle( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_inventariodestdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_motdescarte( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_motdescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_motdescartedetalle( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_motdescartedetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tallem( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_tallem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tallemdetalle( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_tallemdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantdescarte() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridocantdescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwiditeminsumo() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwiditeminsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoiditeminsumo() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoiditeminsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinsumodetalle() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoinsumodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinventariodest() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridoinventariodest', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomotdescarte() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridomotdescarte', lcParametros )
	EndFunc
