...
define class Mock_senia as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallearticulosdetalle() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cambiosdetallearticulosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cancelarsinbuscarycargar() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cancelarsinbuscarycargar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cbasededatosorigen_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cbasededatosorigen_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cbasededatosorigen_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cbasededatosorigen		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cbasededatosorigen( lxVal )				this.Setear_Cbasededatosorigen( lxVal )			EndIf		Else			This.Setear_Cbasededatosorigen( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function copiardetalle( todetalleorigen as detalle of detalle.prg, todetalledestino as detalle of detalle.prg ) as void                                                                                                                                   
		...
		lnParametros = pcount()
		lxParam1 = todetalleorigen
		lxParam2 = todetalledestino
		...
		return this.ObtenerResultado( 'Copiardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cserieorigen_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cserieorigen_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cserieorigen_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cserieorigen		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cserieorigen( lxVal )				this.Setear_Cserieorigen( lxVal )			EndIf		Else			This.Setear_Cserieorigen( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estacancelada() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Estacancelada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitararticulosdetalle_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitararticulosdetalle_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitararticulosdetalle_assign', lcParametros )			endif		endif		this.lHabilitarArticulosDetalle = txVal		this.ArticulosDetalle.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerabreviaturadecomprobantedeventas( tntipocomprobante as integer ) as string                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerabreviaturadecomprobantedeventas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercopiadeitemarticuloaseniado( toitemorigen as object, toitemdestino as object, tlquitarprefijopkaitemorigen as boolean, tlitemarticulosseniados as boolean ) as object                                                                     
		...
		lnParametros = pcount()
		lxParam1 = toitemorigen
		lxParam2 = toitemdestino
		lxParam3 = tlquitarprefijopkaitemorigen
		lxParam4 = tlitemarticulosseniados
		...
		return this.ObtenerResultado( 'Obtenercopiadeitemarticuloaseniado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cbasededatosorigen( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cbasededatosorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cbasededatosorigen', lcParametros )			endif		endif		this.Cbasededatosorigen = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cserieorigen( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cserieorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cserieorigen', lcParametros )			endif		endif		this.Cserieorigen = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipocomprobanteorigenabreviado( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tipocomprobanteorigenabreviado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tipocomprobanteorigenabreviado', lcParametros )			endif		endif		this.Tipocomprobanteorigenabreviado = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipocomprobanteorigenabreviado_assign( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tipocomprobanteorigenabreviado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tipocomprobanteorigenabreviado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tipocomprobanteorigenabreviado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tipocomprobanteorigenabreviado( lxVal )				this.Setear_Tipocomprobanteorigenabreviado( lxVal )			EndIf		Else			This.Setear_Tipocomprobanteorigenabreviado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cbasededatosorigen( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cbasededatosorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cbasededatosorigen', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cserieorigen( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cserieorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cserieorigen', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tasaimpuestointerno( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tasaimpuestointerno', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tasaimpuestointerno', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_tipocomprobanteafectante( txval as variant ) as boolean                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipocomprobanteafectante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipocomprobanteafectante', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_tipocomprobanteafectanteabreviado( txval as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipocomprobanteafectanteabreviado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipocomprobanteafectanteabreviado', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipocomprobanteorigenabreviado( txval as variant ) as boolean                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SENIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipocomprobanteorigenabreviado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipocomprobanteorigenabreviado', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
