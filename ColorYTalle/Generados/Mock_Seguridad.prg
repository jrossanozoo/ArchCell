...
#INCLUDE DEFMODOS.H
define class Mock_SEGURIDAD as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Verificarvencimientodeacceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	 function pediraccesoentidad( tcentidad as string, tcmetodo as string, tlsinpantalla as boolean, tcdescripcionentidad as string, tcusuariorautorizante as string ) as boolean                                                                             
		...
		lxParam1 = tcentidad
		lxParam2 = tcmetodo
		lxParam3 = tlsinpantalla
		lxParam4 = tcdescripcionentidad
		lxParam5 = tcusuariorautorizante
		...
		return this.ObtenerResultado( 'Pediraccesoentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarintentosdelogueofallidos( tcidusuario as string ) as integer                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Actualizarintentosdelogueofallidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregarbasededatos( tcusuario as string, tcbasededatos as string ) as void                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Agregarbasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function alternarmododeseguridad() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Alternarmododeseguridad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function armarcaptionvengode( tcid as string ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Armarcaptionvengode', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function armarsenteciainsert( tctipo as string, tcentidad as string, tcmetodo as string, tcestado as string, tcserie as string, tcnodopadre as string, tcnodohijo as string, tcnombrepc as string, tcusuariopc as string, tttime as string ) as string    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		lxParam4 = tcestado
		lxParam5 = tcserie
		lxParam6 = tcnodopadre
		lxParam7 = tcnodohijo
		lxParam8 = tcnombrepc
		lxParam9 = tcusuariopc
		lxParam10 = tttime
		...
		return this.ObtenerResultado( 'Armarsenteciainsert', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function blanquearclave( tcidusuario ) as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Blanquearclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function bloquearusuario( tcidusuario as string ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Bloquearusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calltrim_access() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Calltrim_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiarbasededatos( tcbasededatos as string ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cambiarbasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cdatetime_access() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Cdatetime_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cerrarventanas() as boolean                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Cerrarventanas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function clongitudmaximausuario_access() as int                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Clongitudmaximausuario_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function clongitudmaximausuario_assign( txvalue )                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Clongitudmaximausuario_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearcoleccionhabilitamenu() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Crearcoleccionhabilitamenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cschemafunciones_access() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cschemafunciones_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cschemaseguridad_access() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cschemaseguridad_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cusuariologueado_access() as string                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cusuariologueado_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cusuariologueado_assign( txvalue )                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cusuariologueado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cval_access() as void                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cval_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desbloquearusuario( tcidusuario as string ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Desbloquearusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desbloqueoautomatico( tcusuario, tcclave ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Desbloqueoautomatico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function dibujaritemenarbol( tcid as string ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Dibujaritemenarbol', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esperfiladministrador( tcidusuario ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Esperfiladministrador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function establoqueado( tcidusuario as string ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Establoqueado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function evaluarsilabaserecibepaquetesdeusuariossinpermisos( tcbasededatos as string) as boolean                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Evaluarsilabaserecibepaquetesdeusuariossinpermisos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function grabarmodificacionclave( tcidusuario as string , tcclaveold as string , tcclave as string ) as void                                                                                                                                              
		...
		return this.ObtenerResultado( 'Grabarmodificacionclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaaccesomenu( tcid as string ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Habilitaaccesomenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitarparamodificar( tcid as string ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Habilitarparamodificar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function informarbasedemo() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Informarbasedemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function informarsiesbddemo() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Informarsiesbddemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lanzarpantalla( tcpantalla as string, tlsinconfirmaciones as boolean ) as void                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Lanzarpantalla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiarcursorporperfil() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Limpiarcursorporperfil', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiarcursorporusuario() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Limpiarcursorporusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenarcursorporperfil() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Llenarcursorporperfil', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenarcursorporusuario() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Llenarcursorporusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function logout( tcusuario as string ) as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Logout', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function loguearaccesos( tctipo as string, tcmetodo as string, tcnodopadre as string, tcnodohijo as string, tcdescripcionentidad as string ) as void                                                                                                      
		...
		lxParam1 = tctipo
		lxParam2 = tcmetodo
		lxParam3 = tcnodopadre
		lxParam4 = tcnodohijo
		lxParam5 = tcdescripcionentidad
		...
		return this.ObtenerResultado( 'Loguearaccesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbasequeelusuariologueadopuedeacceder() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerbasequeelusuariologueadopuedeacceder', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbasesquerecibenpaquetessinpermiso() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerbasesquerecibenpaquetessinpermiso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerestadodelsistema() as integer                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerestadodelsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerestadodeseguridad() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerestadodeseguridad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerestadoinicialdeseguridad() as integer                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerestadoinicialdeseguridad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneridusuario( tcusuario as string ) as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obteneridusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerintentosdelogueofallidos( tcidusuario as string ) as integer                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerintentosdelogueofallidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermodo( tcid as string ) as string                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenermodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombrepc() as string                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenernombrepc', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombreusuariopc() as string                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenernombreusuariopc', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerperfiles( tcusuario as string ) as object                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerperfiles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerserie() as string                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerserie', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertiempodesbloqueo( tcidusuario as string ) as string                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertiempodesbloqueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerultimousuariologueado() as string                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerultimousuariologueado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerultimousuariologueadoparalogin() as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerultimousuariologueadoparalogin', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerusuarioactivedir( tcusuario as string ) as string                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerusuarioactivedir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerusuariodesdeemail( tcemail as string ) as string                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerusuariodesdeemail', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaccesosusuario_access() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ocolaccesosusuario_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pediraccesolistado( tclistado as string ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Pediraccesolistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pediraccesomenu( tcid as string, tlnopedirclave as boolean, tcusuariorautorizante as string ) as boolean                                                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = tcid
		lxParam2 = tlnopedirclave
		lxParam3 = tcusuariorautorizante
		...
		return this.ObtenerResultado( 'Pediraccesomenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pediraccesotransferencia( tctransferencia as string ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Pediraccesotransferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pedirclave( tcid as string, tlnopedirclave as boolean, tcusuariorautorizante as string ) as boolean                                                                                                                                              
		...
		return this.ObtenerResultado( 'Pedirclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function refrescarmenuybarradelformularioprincipal() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Refrescarmenuybarradelformularioprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function regenerartxtusuarios( tcusuariologueado ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Regenerartxtusuarios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearultimousuariologueadoparalogin( tcusuario as string ) as void                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setearultimousuariologueadoparalogin', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function solicitarclave( toacceso as object, tlnopedirclave as boolean ) as boolean                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Solicitarclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tiemporestante( tttiempoactual as datetime, tttiempofinal as datetime ) as void                                                                                                                                                                  
		...
		lnParametros = pcount()
		lxParam1 = tttiempoactual
		lxParam2 = tttiempofinal
		...
		return this.ObtenerResultado( 'Tiemporestante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tieneperfil( tcusuario as string ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Tieneperfil', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function usuariotieneconfiguradousuarioactivedir() as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Usuariotieneconfiguradousuarioactivedir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validacionescontraactivedirectory( tcusuarioad as string, tlvalidaclave as boolean, tcclave as string ) as boolean                                                                                                                               
		...
		lnParametros = pcount()
		lxParam1 = tcusuarioad
		lxParam2 = tlvalidaclave
		lxParam3 = tcclave
		...
		return this.ObtenerResultado( 'Validacionescontraactivedirectory', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcambioclave( tcclaveold as string, tcclavenew as string ) as boolean                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarcambioclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarclave( tlvalidaclave as boolean, tcclave as string, tcusuario as string, tcalias as string ) as boolean                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validarclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarusuarioyclave( tcusuario as string, tcclave as string, tlvalidaclave as boolean ) as boolean                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarusuarioyclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarusuarioyclavehasheada( tcusuario as string, tcclavehasheada as string, tcsecret as string, tcalternativa as string, tlrequerirdoblehash as boolean ) as void                                                                              
		...
		lnParametros = pcount()
		lxParam1 = tcusuario
		lxParam2 = tcclavehasheada
		lxParam3 = tcsecret
		lxParam4 = tcalternativa
		lxParam5 = tlrequerirdoblehash
		...
		return this.ObtenerResultado( 'Validarusuarioyclavehasheada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarversionbd( tcbasededatos as string ) as string                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarversionbd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificaraccesoitempadre( tcid as string ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Verificaraccesoitempadre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarsiesiyd() as boolean                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Verificarsiesiyd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function abrirsistema() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Abrirsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcantidadbloqueos( tcidusuario as string, tnintentos as integer )  as void                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Actualizarcantidadbloqueos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarmenuesdeshabilitadosencoleccionaccesos() as void                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Actualizarmenuesdeshabilitadosencoleccionaccesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarnodobasededatos() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Actualizarnodobasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarcolecciondeoperaciones() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Cargarcolecciondeoperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cerrarsistema() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cerrarsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function continuarconlogout( tcpantalla as string, tllogout as boolean ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Continuarconlogout', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function determinaracceso( tcid as string, tnmodo as integer, tlnopedirclave as boolean, tcusuariorautorizante as string ) as boolean                                                                                                           
		...
		lxParam1 = tcid
		lxParam2 = tnmodo
		lxParam3 = tlnopedirclave
		lxParam4 = tcusuariorautorizante
		...
		return this.ObtenerResultado( 'Determinaracceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function elsistemaestaabierto() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Elsistemaestaabierto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function elusuariodebevalidarseguridad() as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Elusuariodebevalidarseguridad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esadministrador( tcidusuario as string ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Esadministrador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esusuarionocreadoenorganic( tcusuario as string ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Esusuarionocreadoenorganic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existecampoentabla( tcalias as string, tccampo as string ) as void                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Existecampoentabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitaracceso( tcalias as string, tlaccesousuario as boolean ) as void                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Habilitaracceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitaroperacionesreservadas() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Habilitaroperacionesreservadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function loguearaccesosentidad( tcentidad as string, tcmetodo as string, tcdescripcionentidad as string ) as void                                                                                                                               
		...
		return this.ObtenerResultado( 'Loguearaccesosentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function loguearaccesosmenu( tcid as string ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Loguearaccesosmenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneraccesos( tccondicionadicional as string ) as void                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obteneraccesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerantiguarutadatosusuarioorganic() as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerantiguarutadatosusuarioorganic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercantidaddebloqueos( tcidusuario as string ) as integer                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercantidaddebloqueos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdependenciadeseguridad( tcid as string ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerdependenciadeseguridad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerfechadelbloqueo( tcidusuario as string ) as datetime                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerfechadelbloqueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerintentosdelogueo( tcidusuario as string ) as integer                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerintentosdelogueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemsegundclave( tcclave as string ) as itemacceso of din_estructuraadn.prg                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obteneritemsegundclave', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermainusersdeznube() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenermainusersdeznube', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerminutosdesbloqueo( tcidusuario as string ) as integer                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerminutosdesbloqueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerpass( tcusuario as string ) as string                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerpass', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerrutadatosusuarioorganic() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerrutadatosusuarioorganic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneryagregaraccesosporperfil( tccondicionadicional as string ) as void                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obteneryagregaraccesosporperfil', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneryagregaraccesosporusuario( tccondicionadicional as string ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obteneryagregaraccesosporusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocultarformprincipal() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Ocultarformprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function pedirlogueo( tcusuario as string, tcpantalla as string ) as string                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Pedirlogueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function permitiracceso( toacceso as object, tlnopedirclave as boolean ) as boolean                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Permitiracceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function persistirintentosdelogueofallidos( tcidusuario as string, tnintentos ) as void                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Persistirintentosdelogueofallidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function restaurarformprincipal() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Restaurarformprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function testearclavehasheadalowercase( tchashorigen as string, tcpassalmacenado as string, tcsecret as string, tcalternativa as string, tlforzardoble as boolean ) as void                                                                     
		...
		lnParametros = pcount()
		lxParam1 = tchashorigen
		lxParam2 = tcpassalmacenado
		lxParam3 = tcsecret
		lxParam4 = tcalternativa
		lxParam5 = tlforzardoble
		...
		return this.ObtenerResultado( 'Testearclavehasheadalowercase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function testearclavehasheadamismocase( tchashorigen as string, tcpassalmacenado as string, tcsecret as string, tcalternativa as string, tlforzardoble as boolean ) as void                                                                     
		...
		return this.ObtenerResultado( 'Testearclavehasheadamismocase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function testearclavehasheadauppercase( tchashorigen as string, tcpassalmacenado as string, tcsecret as string, tcalternativa as string, tlforzardoble as boolean ) as void                                                                     
		...
		return this.ObtenerResultado( 'Testearclavehasheadauppercase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function tieneaccesorecursivo( tcid as string ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Tieneaccesorecursivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificaraccesousuario( tcid as string, tcidusuario as string ) as boolean                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Verificaraccesousuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarexistenciaperfiladm() as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Verificarexistenciaperfiladm', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarexistenciausuario( tcusuario as string ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Verificarexistenciausuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarperfilusuario( tcidperfil as string, tcidusuario as string ) as boolean                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Verificarperfilusuario', lcParametros )
	EndFunc
