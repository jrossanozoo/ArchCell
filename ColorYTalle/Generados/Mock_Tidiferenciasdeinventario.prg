...
define class Mock_tidiferenciasdeinventario as MockBase of MockBase.prg
	...
	cClase = 'tidiferenciasdeinventario'
	...
	HORAIMPO = ""                                                                                                                                                                                                                                             
	HORAMODIFICACIONFW = ""                                                                                                                                                                                                                                   
	IDInventarioAControlar = null                                                                                                                                                                                                                             
	IDInventarioAControlar_PK = 0                                                                                                                                                                                                                             
	IDInventarioFisico = null                                                                                                                                                                                                                                 
	IDInventarioFisico_PK = 0                                                                                                                                                                                                                                 
	InventariosFisicosDetalle = null                                                                                                                                                                                                                          
	MSFecha = ctod( '  /  /    ' )                                                                                                                                                                                                                            
	MSMotivo = null                                                                                                                                                                                                                                           
	MSMotivo_PK = ""                                                                                                                                                                                                                                          
	MSOrigenDestino = null                                                                                                                                                                                                                                    
	MSOrigenDestino_PK = ""                                                                                                                                                                                                                                   
	Modo = 0                                                                                                                                                                                                                                                  
	MovimientoGenerado = ""                                                                                                                                                                                                                                   
	Obs = ""                                                                                                                                                                                                                                                  
	...
	cCombinacion = ""                                                                                                                                                                                                                                         
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Diferencia de inventarios"                                                                                                                                                                                                               
	...
	lBuscandoCodigo = .f.                                                                                                                                                                                                                                     
	lCargando = .f.                                                                                                                                                                                                                                           
	lConfirmaGenerarMovimientoDeStock = .T.                                                                                                                                                                                                                   
	...
	lGenerarMovStockNegativos = .F.                                                                                                                                                                                                                           
	lHabilitaEnviarAlGrabar = .f.                                                                                                                                                                                                                             
	lHabilitarFecha = .T.                                                                                                                                                                                                                                     
	lHabilitarIDInventarioAControlar_PK = .T.                                                                                                                                                                                                                 
	lHabilitarIDInventarioFisico_PK = .T.                                                                                                                                                                                                                     
	lHabilitarModo = .T.                                                                                                                                                                                                                                      
	lHabilitarMovimientoGenerado = .T.                                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function actualizarnumeracion() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarnumeracion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicardatosdetalle( tcalias ) as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Aplicardatosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleinventariosfisicosdetalle() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleinventariosfisicosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ccombinacion_access() as string                                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ccombinacion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ccombinacion_access', lcParametros )			endif		endif		if this.ldestroy		else			if empty( This.cCombinacion )				This.cCombinacion = this.ObtenerStringAtributosCombinacion()			endif		EndIf		return This.cCombinacion
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function creartalonariodetallesinoexiste() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Creartalonariodetallesinoexiste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocomenzoprocesogenerarmovimientosdestock() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocomenzoprocesogenerarmovimientosdestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntagenerarmovimientosstocknegativos( toinformacion as zooinformacion of zooinformacion.prg ) as void                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventopreguntagenerarmovimientosstocknegativos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntasigeneramovimientodestock() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntasigeneramovimientodestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoverificasipuedegenerarmovimientodestock() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoverificasipuedegenerarmovimientodestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idinventarioacontrolar_access() as variant                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idinventarioacontrolar_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idinventarioacontrolar_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Idinventarioacontrolar ) = 'O' or isnull( this.Idinventarioacontrolar ) )					this.Idinventarioacontrolar = _Screen.zoo.instanciarentidad( 'Tiinventarioacont' )					this.Idinventarioacontrolar.lEsSubEntidad = .t.					this.enlazar( 'Idinventarioacontrolar.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Idinventarioacontrolar.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Idinventarioacontrolar.CODIGO # this.Idinventarioacontrolar_PK						this.Idinventarioacontrolar.CODIGO = this.Idinventarioacontrolar_PK					endif				endif			endif		endif		return this.Idinventarioacontrolar
	EndFunc

	*-----------------------------------------------------------------------------------------
	function idinventarioacontrolar_pk_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idinventarioacontrolar_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idinventarioacontrolar_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Idinventarioacontrolar_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		this.Idinventarioacontrolar_PK = lxVal		if this.Validar_Idinventarioacontrolar( lxVal, lxValOld )			if ( this.lHabilitarIdinventarioacontrolar_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Idinventarioacontrolar( lxVal )			else				this.Idinventarioacontrolar_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Diferencia de inventarios - Atributo: Idinventarioacontrolar)" )			endif		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function idinventariofisico_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idinventariofisico_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idinventariofisico_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Idinventariofisico ) = 'O' or isnull( this.Idinventariofisico ) )					this.Idinventariofisico = _Screen.zoo.instanciarentidad( 'Tiinventariofisico' )					this.Idinventariofisico.lEsSubEntidad = .t.					this.enlazar( 'Idinventariofisico.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Idinventariofisico.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Idinventariofisico.CODIGO # this.Idinventariofisico_PK						this.Idinventariofisico.CODIGO = this.Idinventariofisico_PK					endif				endif			endif		endif		return this.Idinventariofisico
	EndFunc

	*-----------------------------------------------------------------------------------------
	function idinventariofisico_pk_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idinventariofisico_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idinventariofisico_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Idinventariofisico_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		this.Idinventariofisico_PK = lxVal		if this.Validar_Idinventariofisico( lxVal, lxValOld )			if ( this.lHabilitarIdinventariofisico_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Idinventariofisico( lxVal )			else				this.Idinventariofisico_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Diferencia de inventarios - Atributo: Idinventariofisico)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariosfisicosdetalle_access() as variant                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'inventariosfisicosdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'inventariosfisicosdetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Inventariosfisicosdetalle ) = 'O' or isnull( this.Inventariosfisicosdetalle ) )			this.Inventariosfisicosdetalle = this.crearobjeto( 'Din_DetalleTidiferenciasdeinventarioInventariosfisicosdetalle' )			this.Inventariosfisicosdetalle.inicializar()			this.Inventariosfisicosdetalle.lPermitirDetalleVacio = .F.			this.enlazar( 'Inventariosfisicosdetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Inventariosfisicosdetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Inventariosfisicosdetalle, 'CambioSumarizado', this, 'CambiosDetalleInventariosfisicosdetalle', 1)			this.enlazar( 'Inventariosfisicosdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Inventariosfisicosdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Inventariosfisicosdetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modo_assign( txval as variant ) as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Modo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Modo( lxVal )				if ( this.lHabilitarModo or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Modo( lxVal )				else					this.Modo = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Diferencia de inventarios - Atributo: Modo)" )				endif			EndIf		Else			This.Setear_Modo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function movimientogenerado_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'movimientogenerado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'movimientogenerado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Movimientogenerado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Movimientogenerado( lxVal )				if ( this.lHabilitarMovimientogenerado or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Movimientogenerado( lxVal )				else					this.Movimientogenerado = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Diferencia de inventarios - Atributo: Movimientogenerado)" )				endif			EndIf		Else			This.Setear_Movimientogenerado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function msfecha_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'msfecha_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'msfecha_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Msfecha		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Msfecha( lxVal )				this.ValidarDominio_Fechacomprobante( lxVal )				this.Setear_Msfecha( lxVal )			EndIf		Else			This.Setear_Msfecha( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function msmotivo_access() as variant                                                                                                                                                                                                                     
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'msmotivo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'msmotivo_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Msmotivo ) = 'O' or isnull( this.Msmotivo ) )					this.Msmotivo = _Screen.zoo.instanciarentidad( 'Motivo' )					this.Msmotivo.lEsSubEntidad = .t.					this.enlazar( 'Msmotivo.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Msmotivo.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Msmotivo.CODIGO # this.Msmotivo_PK						this.Msmotivo.CODIGO = this.Msmotivo_PK					endif				endif			endif		endif		return this.Msmotivo
	EndFunc

	*-----------------------------------------------------------------------------------------
	function msmotivo_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'msmotivo_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'msmotivo_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Msmotivo_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 3, padr( lxVal, 3 ), lxVal )		this.Msmotivo_PK = lxVal		if this.Validar_Msmotivo( lxVal, lxValOld )			This.Setear_Msmotivo( lxVal )		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function msorigendestino_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'msorigendestino_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'msorigendestino_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Msorigendestino ) = 'O' or isnull( this.Msorigendestino ) )					this.Msorigendestino = _Screen.zoo.instanciarentidad( 'Origendedatos' )					this.Msorigendestino.lEsSubEntidad = .t.					this.enlazar( 'Msorigendestino.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Msorigendestino.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Msorigendestino.CODIGO # this.Msorigendestino_PK						this.Msorigendestino.CODIGO = this.Msorigendestino_PK					endif				endif			endif		endif		return this.Msorigendestino
	EndFunc

	*-----------------------------------------------------------------------------------------
	function msorigendestino_pk_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'msorigendestino_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'msorigendestino_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Msorigendestino_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 8, padr( lxVal, 8 ), lxVal )		this.Msorigendestino_PK = lxVal		if this.Validar_Msorigendestino( lxVal, lxValOld )			This.Setear_Msorigendestino( lxVal )		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocodigodebarras_access() as void                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocodigodebarras_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocodigodebarras_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oCodigoDeBarras ) != 'O'			this.oCodigoDeBarras = _screen.zoo.crearobjeto( "CodigoDeBarras" )			local loEquivalencia as Object			loEquivalencia = _screen.zoo.instanciarentidad( "Equivalencia" )			this.oCodigoDeBarras.InyectarEntidad( loEquivalencia )		endif		return this.oCodigoDeBarras
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocombinacion_access() as object                                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocombinacion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocombinacion_access', lcParametros )			endif		endif		if this.ldestroy		else			if IsNull( This.oCombinacion )				This.oCombinacion = this.oCompStock.oStockCombinacion.oAtributosCC			endif		Endif			return This.oCombinacion
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompstock_access() as variant                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocompstock_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocompstock_access', lcParametros )			endif		endif		if this.ldestroy		else			if !vartype( this.oCompStock ) = 'O' or isnull( this.oCompStock )				this.oCompStock = _Screen.zoo.instanciarComponente( 'ComponenteStock' )			endif		endif		return this.oCompStock
	EndFunc

	*-----------------------------------------------------------------------------------------
	function odifinv_access() as variant                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'odifinv_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'odifinv_access', lcParametros )			endif		endif		if this.ldestroy		else			if !vartype( this.oDifInv ) = 'O' or isnull( this.oDifInv )				this.oDifInv = _Screen.zoo.instanciarentidad( 'TIDiferenciasDeInventario' )			endif		endif		return this.oDifInv
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oinvdetalle_access() as variant                                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oinvdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oinvdetalle_access', lcParametros )			endif		endif		if this.ldestroy		else			if !vartype( this.oInvDetalle ) = 'O' or isnull( this.oInvDetalle )				this.oInvDetalle = _Screen.zoo.instanciarentidad( 'tiDiferenciasDeInventarioDetalle' )			endif		endif		return this.oInvDetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function opasajedestock_access() as object                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'opasajedestock_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'opasajedestock_access', lcParametros )			endif		endif		if this.ldestroy		else			if IsNull( This.oPasajeDeStock )				This.oPasajeDeStock = _Screen.zoo.instanciarentidad( 'PasajeDeStock' )			endif		Endif			return This.oPasajeDeStock
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idinventarioacontrolar( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_idinventarioacontrolar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_idinventarioacontrolar', lcParametros )			endif		endif		this.Idinventarioacontrolar.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_idinventariofisico( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_idinventariofisico', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_idinventariofisico', lcParametros )			endif		endif		this.Idinventariofisico.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_msfecha( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_msfecha', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_msfecha', lcParametros )			endif		endif		this.Msfecha = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_msmotivo( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_msmotivo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_msmotivo', lcParametros )			endif		endif		this.Msmotivo.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_msorigendestino( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_msorigendestino', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_msorigendestino', lcParametros )			endif		endif		this.Msorigendestino.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idinventarioacontrolar( txval as variant, txvalold as variant ) as boolean                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idinventarioacontrolar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idinventarioacontrolar', lcParametros )			endif		endif		local llRetorno as Boolean, lnNroPasaje as Integer		llRetorno = dodefault( txVal, txValOld )				if llRetorno			lnNroPasaje = this.oPasajeDeStock.YaSeUtilizoInventarioAControlar( txVal )			this.oPasajeDeStock.release()			if lnNroPasaje > 0				llRetorno = .f.				goServicios.Errores.LevantarExcepcion( "Inventario a controlar ya utilizado en el Pasaje de Stock Nº " + alltrim( transform( lnNroPasaje ) ) + "." )			endif						endif				return llRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_idinventariofisico( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idinventariofisico', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idinventariofisico', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_msfecha( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_msfecha', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_msfecha', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_msmotivo( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_msmotivo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_msmotivo', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_msorigendestino( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIDIFERENCIASDEINVENTARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_msorigendestino', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_msorigendestino', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaridinventarioacontrolar() as boolean                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaridinventarioacontrolar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validaridinventariofisico() as boolean                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaridinventariofisico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmsfecha() as boolean                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmsfecha', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarmsmotivo() as boolean                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmsmotivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarmsorigendestino() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmsorigendestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarqueexistanlosarticulosycombinacion() as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarqueexistanlosarticulosycombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorastringmotoractual( txvalor ) as string                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Valorastringmotoractual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwmsfecha() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwmsfecha', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoidinventarioacontrolar() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoidinventarioacontrolar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomovimientogenerado() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomovimientogenerado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridomsfecha() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomsfecha', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridomsmotivo() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomsmotivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridomsorigendestino() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomsorigendestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarentidadconmovstock() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function aplicardatoscombinacion( tcalias as string ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function consultarinexistencia( tostoreprocedure as object, tcentidad as string, tccodigo as string, tnsession as integer ) as boolean                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tostoreprocedure
		lxParam2 = tcentidad
		lxParam3 = tccodigo
		lxParam4 = tnsession
		...
		return this.ObtenerResultado( '', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearcabeceramovimientodestock( tntipo as integer, tocopiador as object ) as void                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	protected function deshabilitaratributosalmofificar() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Deshabilitaratributosalmofificar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esatributopk( tcatributo as string) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esatributopk', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function guardarrangomovimientosgenerados() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function infoitem( toitem as object ) as string                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Infoitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursor( tctipocursor ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tctipocursor
		...
		return this.ObtenerResultado( 'Obtenercursor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursoragrupadoporarticulo() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercursoragrupadoporarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerstringatributoscombinacion() as string                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerstringatributoscombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function resguardarerror( toexcepcion) as exception                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toexcepcion
		...
		return this.ObtenerResultado( 'Resguardarerror', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarporcombinacion() as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarporcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificarstocknegativo() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarstocknegativo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificasipuedegenerarmovimientodestock() as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificasipuedegenerarmovimientodestock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificasipuedegenerarstocknegativo() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificasipuedegenerarstocknegativo', lcParametros )
	EndFunc
