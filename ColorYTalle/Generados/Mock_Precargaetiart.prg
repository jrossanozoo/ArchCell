...
define class Mock_precargaetiart as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Pre-carga de combinaciones para impresión de etiquetas"                                                                                                                                                                                  
	...
	f_Articulo_FechaExpo_Desde = ctod( '  /  /    ' )                                                                                                                                                                                                         
	f_Articulo_FechaExpo_Hasta = ctod( '  /  /    ' )                                                                                                                                                                                                         
	f_Articulo_FechaImpo_Desde = ctod( '  /  /    ' )                                                                                                                                                                                                         
	f_Articulo_FechaImpo_Hasta = ctod( '  /  /    ' )                                                                                                                                                                                                         
	f_Articulo_FechaModificacionFw_Desde = ctod( '  /  /    ' )                                                                                                                                                                                               
	f_Articulo_FechaModificacionFw_Hasta = ctod( '  /  /    ' )                                                                                                                                                                                               
	f_Articulo_FechaTransferencia_Desde = ctod( '  /  /    ' )                                                                                                                                                                                                
	f_Articulo_FechaTransferencia_Hasta = ctod( '  /  /    ' )                                                                                                                                                                                                
	...
	oColaboradorPrecargaEtiquetas = null                                                                                                                                                                                                                      
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oComportamientoCodigoSugerido = null                                                                                                                                                                                                                      
	oControlBasesDeDatos = null                                                                                                                                                                                                                               
	oEntidadAgrupamientos = null                                                                                                                                                                                                                              
	oEntidadImpresion = null                                                                                                                                                                                                                                  
	oExtension = null                                                                                                                                                                                                                                         
	oGestorDeMail = null                                                                                                                                                                                                                                      
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function agrupamientodebases_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'agrupamientodebases_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'agrupamientodebases_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Agrupamientodebases		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Agrupamientodebases( lxVal )				if ( this.lHabilitarAgrupamientodebases or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Agrupamientodebases( lxVal )				else					this.Agrupamientodebases = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: Agrupamientodebases)" )				endif			EndIf		Else			This.Setear_Agrupamientodebases( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignarcodigoabuscador( tncodigo as integer ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Asignarcodigoabuscador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cantidadporarticulo_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cantidadporarticulo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cantidadporarticulo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cantidadporarticulo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cantidadporarticulo( lxVal )				if ( this.lHabilitarCantidadporarticulo or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Cantidadporarticulo( lxVal )				else					this.Cantidadporarticulo = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: Cantidadporarticulo)" )				endif			EndIf		Else			This.Setear_Cantidadporarticulo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesdeasignacion_modocargaminimos() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdeasignacion_modocargaminimos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiodemodalidad() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocambiodemodalidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_articulo_fechaaltafw_desde_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechaaltafw_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechaaltafw_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechaaltafw_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechaaltafw_desde( lxVal )				this.Setear_F_articulo_fechaaltafw_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_fechaaltafw_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechaaltafw_hasta_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechaaltafw_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechaaltafw_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechaaltafw_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechaaltafw_hasta( lxVal )				this.Setear_F_articulo_fechaaltafw_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_fechaaltafw_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechaexpo_desde_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechaexpo_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechaexpo_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechaexpo_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechaexpo_desde( lxVal )				this.Setear_F_articulo_fechaexpo_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_fechaexpo_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechaexpo_hasta_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechaexpo_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechaexpo_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechaexpo_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechaexpo_hasta( lxVal )				this.Setear_F_articulo_fechaexpo_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_fechaexpo_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechaimpo_desde_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechaimpo_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechaimpo_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechaimpo_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechaimpo_desde( lxVal )				this.Setear_F_articulo_fechaimpo_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_fechaimpo_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechaimpo_hasta_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechaimpo_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechaimpo_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechaimpo_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechaimpo_hasta( lxVal )				this.Setear_F_articulo_fechaimpo_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_fechaimpo_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechamodificacionfw_desde_assign( txval as variant ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechamodificacionfw_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechamodificacionfw_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechamodificacionfw_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechamodificacionfw_desde( lxVal )				this.Setear_F_articulo_fechamodificacionfw_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_fechamodificacionfw_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechamodificacionfw_hasta_assign( txval as variant ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechamodificacionfw_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechamodificacionfw_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechamodificacionfw_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechamodificacionfw_hasta( lxVal )				this.Setear_F_articulo_fechamodificacionfw_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_fechamodificacionfw_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechatransferencia_desde_assign( txval as variant ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechatransferencia_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechatransferencia_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechatransferencia_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechatransferencia_desde( lxVal )				this.Setear_F_articulo_fechatransferencia_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_fechatransferencia_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_fechatransferencia_hasta_assign( txval as variant ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_fechatransferencia_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_fechatransferencia_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_fechatransferencia_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_fechatransferencia_hasta( lxVal )				this.Setear_F_articulo_fechatransferencia_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_fechatransferencia_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_preciodirecto_desde_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_preciodirecto_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_preciodirecto_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_preciodirecto_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_preciodirecto_desde( lxVal )				if ( this.lHabilitarF_preciodirecto_desde or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_F_preciodirecto_desde( lxVal )				else					this.F_preciodirecto_desde = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: F_preciodirecto_desde)" )				endif			EndIf		Else			This.Setear_F_preciodirecto_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_preciodirecto_hasta_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_preciodirecto_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_preciodirecto_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_preciodirecto_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_preciodirecto_hasta( lxVal )				if ( this.lHabilitarF_preciodirecto_hasta or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_F_preciodirecto_hasta( lxVal )				else					this.F_preciodirecto_hasta = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: F_preciodirecto_hasta)" )				endif			EndIf		Else			This.Setear_F_preciodirecto_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_timestampalta_desde_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_timestampalta_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_timestampalta_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_timestampalta_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_timestampalta_desde( lxVal )				this.Setear_F_timestampalta_desde( lxVal )			EndIf		Else			This.Setear_F_timestampalta_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_timestampalta_hasta_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_timestampalta_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_timestampalta_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_timestampalta_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_timestampalta_hasta( lxVal )				this.Setear_F_timestampalta_hasta( lxVal )			EndIf		Else			This.Setear_F_timestampalta_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function impresionetiquetakitpack_assign( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'impresionetiquetakitpack_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'impresionetiquetakitpack_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Impresionetiquetakitpack		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Impresionetiquetakitpack( lxVal )				if ( this.lHabilitarImpresionetiquetakitpack or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Impresionetiquetakitpack( lxVal )				else					this.Impresionetiquetakitpack = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: Impresionetiquetakitpack)" )				endif			EndIf		Else			This.Setear_Impresionetiquetakitpack( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function incluircombinacionesconstock_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'incluircombinacionesconstock_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'incluircombinacionesconstock_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Incluircombinacionesconstock		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Incluircombinacionesconstock( lxVal )				if ( this.lHabilitarIncluircombinacionesconstock or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Incluircombinacionesconstock( lxVal )				else					this.Incluircombinacionesconstock = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: Incluircombinacionesconstock)" )				endif			EndIf		Else			This.Setear_Incluircombinacionesconstock( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modocargaminimos_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modocargaminimos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modocargaminimos_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Modocargaminimos		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Modocargaminimos( lxVal )				if ( this.lHabilitarModocargaminimos or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Modocargaminimos( lxVal )					 This.Modocargaminimos_DespuesDeAsignar()				else					this.Modocargaminimos = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: Modocargaminimos)" )				endif			EndIf		Else			This.Setear_Modocargaminimos( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbasesdedatos() as string                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerbasesdedatos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercadenadefiltros() as string                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercadenadefiltros', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercadenadefiltrosmovimientodestock() as string                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercadenadefiltrosmovimientodestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesarcombinaciones() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesarcombinaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_agrupamientodebases( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_agrupamientodebases', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_agrupamientodebases', lcParametros )			endif		endif		this.Agrupamientodebases = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_articulo_comportamiento( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_articulo_comportamiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_articulo_comportamiento', lcParametros )			endif		endif		this.Articulo_comportamiento = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_articulodecorte( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_articulodecorte', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_articulodecorte', lcParametros )			endif		endif		this.Articulodecorte.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_calculodeprecios( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_calculodeprecios', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_calculodeprecios', lcParametros )			endif		endif		this.Calculodeprecios.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_cantidadporarticulo( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cantidadporarticulo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cantidadporarticulo', lcParametros )			endif		endif		this.Cantidadporarticulo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_comportamiento_desde( txval as variant ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_comportamiento_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_comportamiento_desde', lcParametros )			endif		endif		this.F_articulo_comportamiento_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_comportamiento_hasta( txval as variant ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_comportamiento_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_comportamiento_hasta', lcParametros )			endif		endif		this.F_articulo_comportamiento_hasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechaaltafw_desde( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechaaltafw_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechaaltafw_desde', lcParametros )			endif		endif		this.F_articulo_fechaaltafw_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechaaltafw_hasta( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechaaltafw_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechaaltafw_hasta', lcParametros )			endif		endif		this.F_articulo_fechaaltafw_hasta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechaexpo_desde( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechaexpo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechaexpo_desde', lcParametros )			endif		endif		this.F_articulo_fechaexpo_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechaexpo_hasta( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechaexpo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechaexpo_hasta', lcParametros )			endif		endif		this.F_articulo_fechaexpo_hasta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechaimpo_desde( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechaimpo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechaimpo_desde', lcParametros )			endif		endif		this.F_articulo_fechaimpo_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechaimpo_hasta( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechaimpo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechaimpo_hasta', lcParametros )			endif		endif		this.F_articulo_fechaimpo_hasta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechamodificacionfw_desde( txval as variant ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechamodificacionfw_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechamodificacionfw_desde', lcParametros )			endif		endif		this.F_articulo_fechamodificacionfw_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechamodificacionfw_hasta( txval as variant ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechamodificacionfw_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechamodificacionfw_hasta', lcParametros )			endif		endif		this.F_articulo_fechamodificacionfw_hasta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechatransferencia_desde( txval as variant ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechatransferencia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechatransferencia_desde', lcParametros )			endif		endif		this.F_articulo_fechatransferencia_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_fechatransferencia_hasta( txval as variant ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_fechatransferencia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_fechatransferencia_hasta', lcParametros )			endif		endif		this.F_articulo_fechatransferencia_hasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_marca_desde( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_marca_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_marca_desde', lcParametros )			endif		endif		this.F_articulo_marca_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_marca_hasta( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_marca_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_marca_hasta', lcParametros )			endif		endif		this.F_articulo_marca_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_nomenclador_desde( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_nomenclador_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_nomenclador_desde', lcParametros )			endif		endif		this.F_articulo_nomenclador_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_nomenclador_hasta( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_nomenclador_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_nomenclador_hasta', lcParametros )			endif		endif		this.F_articulo_nomenclador_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_unidaddemedida_desde( txval as variant ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_unidaddemedida_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_unidaddemedida_desde', lcParametros )			endif		endif		this.F_articulo_unidaddemedida_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_unidaddemedida_hasta( txval as variant ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_unidaddemedida_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_unidaddemedida_hasta', lcParametros )			endif		endif		this.F_articulo_unidaddemedida_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_usuarioaltafw( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_usuarioaltafw', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_usuarioaltafw', lcParametros )			endif		endif		this.F_articulo_usuarioaltafw = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_usuariomodificacionfw( txval as variant ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_usuariomodificacionfw', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_usuariomodificacionfw', lcParametros )			endif		endif		this.F_articulo_usuariomodificacionfw = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_preciodirecto_desde( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_preciodirecto_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_preciodirecto_desde', lcParametros )			endif		endif		this.F_preciodirecto_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_preciodirecto_hasta( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_preciodirecto_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_preciodirecto_hasta', lcParametros )			endif		endif		this.F_preciodirecto_hasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_timestampalta_desde( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_timestampalta_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_timestampalta_desde', lcParametros )			endif		endif		this.F_timestampalta_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_timestampalta_hasta( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_timestampalta_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_timestampalta_hasta', lcParametros )			endif		endif		this.F_timestampalta_hasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_impresionetiquetakitpack( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_impresionetiquetakitpack', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_impresionetiquetakitpack', lcParametros )			endif		endif		this.Impresionetiquetakitpack = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_incluircombinacionesconstock( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_incluircombinacionesconstock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_incluircombinacionesconstock', lcParametros )			endif		endif		this.Incluircombinacionesconstock = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_modificaciondeprecios( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_modificaciondeprecios', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_modificaciondeprecios', lcParametros )			endif		endif		this.Modificaciondeprecios.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_modocargaminimos( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_modocargaminimos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_modocargaminimos', lcParametros )			endif		endif		this.Modocargaminimos = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_movimientodestock( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_movimientodestock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_movimientodestock', lcParametros )			endif		endif		this.Movimientodestock.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_solopreciosactualizados( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_solopreciosactualizados', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_solopreciosactualizados', lcParametros )			endif		endif		this.Solopreciosactualizados = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_sugerenciacantidades( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_sugerenciacantidades', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_sugerenciacantidades', lcParametros )			endif		endif		this.Sugerenciacantidades = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function solopreciosactualizados_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'solopreciosactualizados_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'solopreciosactualizados_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Solopreciosactualizados		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Solopreciosactualizados( lxVal )				if ( this.lHabilitarSolopreciosactualizados or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Solopreciosactualizados( lxVal )				else					this.Solopreciosactualizados = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: Solopreciosactualizados)" )				endif			EndIf		Else			This.Setear_Solopreciosactualizados( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sugerenciacantidades_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'sugerenciacantidades_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'sugerenciacantidades_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Sugerenciacantidades		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Sugerenciacantidades( lxVal )				if ( this.lHabilitarSugerenciacantidades or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Sugerenciacantidades( lxVal )				else					this.Sugerenciacantidades = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Pre-carga de combinaciones para impresión de etiquetas - Atributo: Sugerenciacantidades)" )				endif			EndIf		Else			This.Setear_Sugerenciacantidades( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_agrupamientodebases( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_agrupamientodebases', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_agrupamientodebases', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_articulo_comportamiento( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_articulo_comportamiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_articulo_comportamiento', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_articulodecorte( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_articulodecorte', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_articulodecorte', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_calculodeprecios( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_calculodeprecios', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_calculodeprecios', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_cantidadporarticulo( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cantidadporarticulo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cantidadporarticulo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_comportamiento_desde( txval as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_comportamiento_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_comportamiento_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_comportamiento_hasta( txval as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_comportamiento_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_comportamiento_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechaaltafw_desde( txval as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechaaltafw_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechaaltafw_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechaaltafw_hasta( txval as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechaaltafw_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechaaltafw_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechaexpo_desde( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechaexpo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechaexpo_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechaexpo_hasta( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechaexpo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechaexpo_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechaimpo_desde( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechaimpo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechaimpo_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechaimpo_hasta( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechaimpo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechaimpo_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechamodificacionfw_desde( txval as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechamodificacionfw_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechamodificacionfw_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechamodificacionfw_hasta( txval as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechamodificacionfw_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechamodificacionfw_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechatransferencia_desde( txval as variant ) as boolean                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechatransferencia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechatransferencia_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_fechatransferencia_hasta( txval as variant ) as boolean                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_fechatransferencia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_fechatransferencia_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_marca_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_marca_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_marca_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_marca_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_marca_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_marca_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_nomenclador_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_nomenclador_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_nomenclador_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_nomenclador_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_nomenclador_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_nomenclador_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_unidaddemedida_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_unidaddemedida_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_unidaddemedida_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_unidaddemedida_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_unidaddemedida_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_unidaddemedida_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_usuarioaltafw( txval as variant ) as boolean                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_usuarioaltafw', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_usuarioaltafw', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_usuariomodificacionfw( txval as variant ) as boolean                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_usuariomodificacionfw', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_usuariomodificacionfw', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_preciodirecto_desde( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_preciodirecto_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_preciodirecto_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_preciodirecto_hasta( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_preciodirecto_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_preciodirecto_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_timestampalta_desde( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_timestampalta_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_timestampalta_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_timestampalta_hasta( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_timestampalta_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_timestampalta_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_impresionetiquetakitpack( txval as variant ) as boolean                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_impresionetiquetakitpack', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_impresionetiquetakitpack', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_incluircombinacionesconstock( txval as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_incluircombinacionesconstock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_incluircombinacionesconstock', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_modificaciondeprecios( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_modificaciondeprecios', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_modificaciondeprecios', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_modocargaminimos( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_modocargaminimos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_modocargaminimos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_movimientodestock( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_movimientodestock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_movimientodestock', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_solopreciosactualizados( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_solopreciosactualizados', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_solopreciosactualizados', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_sugerenciacantidades( txval as variant ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_sugerenciacantidades', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_sugerenciacantidades', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validararticulodecorte() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validararticulodecorte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcalculodeprecios() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarcalculodeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_marca_desde() as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarf_articulo_marca_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_marca_hasta() as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarf_articulo_marca_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_nomenclador_desde() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarf_articulo_nomenclador_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_nomenclador_hasta() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarf_articulo_nomenclador_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_unidaddemedida_desde() as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarf_articulo_unidaddemedida_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_unidaddemedida_hasta() as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarf_articulo_unidaddemedida_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmodificaciondeprecios() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarmodificaciondeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmovimientodestock() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarmovimientodestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoagrupamientodebases() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridoagrupamientodebases', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoarticulo_comportamiento() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoarticulo_comportamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoarticulodecorte() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoarticulodecorte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocalculodeprecios() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridocalculodeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidadporarticulo() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridocantidadporarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_comportamiento_desde() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_comportamiento_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_comportamiento_hasta() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_comportamiento_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechaaltafw_desde() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechaaltafw_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechaaltafw_hasta() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechaaltafw_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechaexpo_desde() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechaexpo_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechaexpo_hasta() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechaexpo_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechaimpo_desde() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechaimpo_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechaimpo_hasta() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechaimpo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechamodificacionfw_desde() as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechamodificacionfw_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechamodificacionfw_hasta() as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechamodificacionfw_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechatransferencia_desde() as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechatransferencia_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_fechatransferencia_hasta() as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_fechatransferencia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_marca_desde() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_marca_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_marca_hasta() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_marca_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_nomenclador_desde() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_nomenclador_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_nomenclador_hasta() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_nomenclador_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_unidaddemedida_desde() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_unidaddemedida_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_unidaddemedida_hasta() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_unidaddemedida_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_usuarioaltafw() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_usuarioaltafw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_usuariomodificacionfw() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_usuariomodificacionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_preciodirecto_desde() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_preciodirecto_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_preciodirecto_hasta() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_preciodirecto_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_timestampalta_desde() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_timestampalta_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_timestampalta_hasta() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_timestampalta_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwarticulodecorte() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwarticulodecorte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_comportamiento_desde() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_comportamiento_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_comportamiento_hasta() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_comportamiento_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_fechaaltafw_hasta() as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_fechaaltafw_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_fechaexpo_hasta() as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_fechaexpo_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_fechaimpo_hasta() as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_fechaimpo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_fechamodificacionfw_hasta() as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_fechamodificacionfw_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_fechatransferencia_hasta() as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_fechatransferencia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_marca_hasta() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_marca_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_nomenclador_hasta() as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_nomenclador_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_unidaddemedida_hasta() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_unidaddemedida_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_preciodirecto_hasta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_preciodirecto_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_timestampalta_hasta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_timestampalta_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwimpresionetiquetakitpack() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridofwimpresionetiquetakitpack', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwincluircombinacionesconstock() as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwincluircombinacionesconstock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwmodocargaminimos() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofwmodocargaminimos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwsolopreciosactualizados() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwsolopreciosactualizados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoimpresionetiquetakitpack() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoimpresionetiquetakitpack', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoincluircombinacionesconstock() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoincluircombinacionesconstock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomodificaciondeprecios() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridomodificaciondeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomodocargaminimos() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridomodocargaminimos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomovimientodestock() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridomovimientodestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosolopreciosactualizados() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridosolopreciosactualizados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosugerenciacantidades() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridosugerenciacantidades', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llenardetallemodificaciondeprecios( todetalle as object, tcxml as string ) as void                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenardetallemodificaciondeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerbasesdedatosparaagrupamiento( tcagrupamiento as string ) as string                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcagrupamiento
		...
		return this.ObtenerResultado( 'Obtenerbasesdedatosparaagrupamiento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerbuscadoractivo() as string                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerbuscadoractivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocolaboradorprecargaetiquetas_access as void                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorprecargaetiquetas_access as void', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorprecargaetiquetas_access as void', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oColaboradorPrecargaEtiquetas ) = 'O' or isnull( this.oColaboradorPrecargaEtiquetas ) )			this.oColaboradorPrecargaEtiquetas = this.crearobjeto( 'ColaboradorPrecargaEtiquetas' )			this.oColaboradorPrecargaEtiquetas.InyectarEntidad( this )		endif		return this.oColaboradorPrecargaEtiquetas	
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oentidadagrupamientos_access as void                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PRECARGAETIART' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadagrupamientos_access as void', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadagrupamientos_access as void', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oEntidadAgrupamientos  ) = 'O' or isnull( this.oEntidadAgrupamientos  ) )			this.oEntidadAgrupamientos = _screen.zoo.instanciarentidad( "agrupamiento" )		endif		return this.oEntidadAgrupamientos  	
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function origenseleccionadoesagrupamiento() as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Origenseleccionadoesagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearfiltroscomportamiento( ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearfiltroscomportamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarbd() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarbd', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarbuscadores() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarbuscadores', lcParametros )
	EndFunc
