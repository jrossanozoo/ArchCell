		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.Consumos
				if this.oEntidad.Consumos.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxConsumodetalle = loItem.Consumodetalle
					lxValor = loItem.Valor
					lxUnidadmedida = loItem.Unidadmedida
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.MAQDETCONS("NROITEM","CodCons","Consumo","Detalle","Valor","Unidad" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxConsumo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxConsumodetalle ) + "'">>, <<lxValor>>, <<"'" + this.FormatearTextoSql( lxUnidadmedida ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codcons" as "Codigo", "Consumo" as "Consumo", "Detalle" as "Consumodetalle", "Valor" as "Valor", "Unidad" as "Unidadmedida" from ZooLogic.MAQDETCONS where CodCons = <<"'" + this.FormatearTextoSql( c_MAQUINARIA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Obs" as "Obs", "Marca" as "Marca", "Tipifica1" as "Tipificación1", "Codigo" as "Codigo", "Unidad" as "Unidaddetiempo", "Cantidadp" as "Cantidadproducida", "Modelo" as "Modelo", "Descrip" as "Descripcion", "Tipifica2" as "Tipificación2", "Desperd" as "Desperdicio", "Serie" as "Serie", "Tipo" as "Tipomaquinaria" from ZooLogic.MAQUINARIA where  funciones.padr( Codigo, 15, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  MAQUINARIA.CODIGO != '' order by Codigo
			endtext
			use in select('c_MAQUINARIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_MAQUINARIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Obs" as "Obs", "Marca" as "Marca", "Tipifica1" as "Tipificación1", "Codigo" as "Codigo", "Unidad" as "Unidaddetiempo", "Cantidadp" as "Cantidadproducida", "Modelo" as "Modelo", "Descrip" as "Descripcion", "Tipifica2" as "Tipificación2", "Desperd" as "Desperdicio", "Serie" as "Serie", "Tipo" as "Tipomaquinaria" from ZooLogic.MAQUINARIA where  funciones.padr( Codigo, 15, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  MAQUINARIA.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_MAQUINARIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_MAQUINARIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleConsumos( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codcons" as "Codigo", "Consumo" as "Consumo", "Detalle" as "Consumodetalle", "Valor" as "Valor", "Unidad" as "Unidadmedida"
				endtext
			Else
	...
	Function ObtenerCamposSelectDetalleConsumos( tcCampos As String ) As String
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			...
			Do Case
				...
				Case lcAtributo == 'CONSUMODETALLE'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'DETALLE AS CONSUMODETALLE'
	...
	Function ObtenerCampoDetalleConsumos( tcAtributo As String ) As String
		...
		Do Case
			...
			Case upper( alltrim( tcAtributo ) ) == 'CONSUMO'
				lcCampo = 'CONSUMO'
			Case upper( alltrim( tcAtributo ) ) == 'CONSUMODETALLE'
				lcCampo = 'DETALLE'
		...
		With this
			...
			for each loItem in this.oEntidad.Consumos
				if this.oEntidad.Consumos.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxUnidadmedida = loItem.Unidadmedida
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.MAQDETCONS("NROITEM","CodCons","Consumo","Detalle","Valor","Unidad" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxConsumo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxConsumodetalle ) + "'">>, <<lxValor>>, <<"'" + this.FormatearTextoSql( lxUnidadmedida ) + "'">> ) 
					endtext
...
"marca" char( 60 )  null, 
"tipifica1" char( 15 )  null, 
"codigo" char( 15 )  null, 
"unidad" numeric( 2, 0 )  null, 
"cantidadp" numeric( 7, 2 )  null, 
"modelo" char( 60 )  null, 
"descrip" char( 100 )  null, 
"tipifica2" char( 15 )  null, 
"desperd" numeric( 7, 2 )  null, 
"serie" char( 60 )  null, 
...
<VFPData xml:space="preserve">
	...
	<row entidad="MAQUINARIA                              " atributo="FECHATRANSFERENCIA                      " tabla="MAQUINARIA     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MAQUINARIA                              " atributo="ESTADOTRANSFERENCIA                     " tabla="MAQUINARIA     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MAQUINARIA                              " atributo="CONSUMOS                                " tabla="MAQDETCONS     " campo="CODCONS   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Consumos                                                                                                                                                        " dominio="DETALLEITEMMAQUINARIACONSUMO  " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="0" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MAQUINARIA                              " atributo="TIPIFICACIÓN1                           " tabla="MAQUINARIA     " campo="TIPIFICA1 " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPIFICACIONPRODUCCION1                 " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="14" etiqueta="Tipificación 1                                                                                                                                                  " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MAQUINARIA                              " atributo="UNIDADDETIEMPO                          " tabla="MAQUINARIA     " campo="UNIDAD    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Unidad de tiempo                                                                                                                                                " dominio="COMBOSERVICIOPRODUCCION       " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="MAQUINARIA                              " atributo="CANTIDADPRODUCIDA                       " tabla="MAQUINARIA     " campo="CANTIDADP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="7" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Cantidad producida                                                                                                                                              " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MAQUINARIA                              " atributo="TIPIFICACIÓN2                           " tabla="MAQUINARIA     " campo="TIPIFICA2 " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPIFICACIONPRODUCCION2                 " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="16" etiqueta="Tipificación 2                                                                                                                                                  " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="MAQUINARIA                              " atributo="DESPERDICIO                             " tabla="MAQUINARIA     " campo="DESPERD   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="7" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Desperdicio                                                                                                                                                     " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MAQUINARIA                              " atributo="TIPOMAQUINARIA                          " tabla="MAQUINARIA     " campo="TIPO      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=1                                                                                                                                                                                                                                                            " obligatorio="false" admitebusqueda="6" etiqueta="Tipo                                                                                                                                                            " dominio="COMBOSERVICIOPRODUCCION       " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
