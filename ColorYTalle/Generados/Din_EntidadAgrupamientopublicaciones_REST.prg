...
define class Din_EntidadAgrupamientopublicaciones_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Agrupamientopublicaciones"
	cClaseResponse = this.cNamespaceDTOs + ".AgrupamientopublicacionesResponse"
	cClaseModelo = "AgrupamientopublicacionesModelo"
	cEntidad = "Agrupamientopublicaciones"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientopublicacionesModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientopublicacionesListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientopublicacionesListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientopublicacionesModelo"
		endcase
		return lcRetorno
