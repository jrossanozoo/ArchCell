...
define class Din_EntidadFACTURAELECTRONICADECREDITOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFd2, lxComprobantevFectrans, lxComprobantevFecimpo, lxComprobantevFmodifw, lxComprobantevFecexpo, lxComprobantevInformnube, lxComprobantevFcuit, lxComprobantevDatosecomm, lxComprobantevIdcaja, lxComprobantevFperson, lxComprobantevDespachos, lxComprobantevHaltafw, lxComprobantevIdajuste, lxComprobantevFaltafw, lxComprobantevBdaltafw, lxComprobantevFhora, lxComprobantevValtafw, lxComprobantevZadsfw, lxComprobantevSaltafw, lxComprobantevOpecomm, lxComprobantevSmodifw, lxComprobantevUmodifw, lxComprobantevSimbmon, lxComprobantevUaltafw, lxComprobantevEsttrans, lxComprobantevBdmodifw, lxComprobantevHoraexpo, lxComprobantevHoraimpo, lxComprobantevHmodifw, lxComprobantevDescfw, lxComprobantevVmodifw, lxComprobantevTimestamp, lxComprobantevFactsec, lxComprobantevTotalcant, lxComprobantevFajxre, lxComprobantevMdcimpu, lxComprobantevRecmntosi1, lxComprobantevRecmntosi, lxComprobantevSubtotsisi, lxComprobantevFsubtot, lxComprobantevSitfisccli, lxComprobantevFsubton, lxComprobantevSignomov, lxComprobantevFacttipo, lxComprobantevSubtotcisi, lxComprobantevCondivalp, lxComprobantevRecmntosi2, lxComprobantevFpodes2, lxComprobantevDesmntosi, lxComprobantevDesmntosi1, lxComprobantevDesmntosi2, lxComprobantevDesmntosi3, lxComprobantevAnulado, lxComprobantevDesaut, lxComprobantevFcompfis, lxComprobantevIdvuelto, lxComprobantevMonsis, lxComprobantevMotdescdev, lxComprobantevFobs, lxComprobantevFpodes1, lxComprobantevFcliente, lxComprobantevFturno, lxComprobantevIdsenia, lxComprobantevFmtdes2, lxComprobantevCodigo, lxComprobantevSenia, lxComprobantevMd1, lxComprobantevFmtdes1, lxComprobantevReceptor, lxComprobantevFven, lxComprobantevMoneda, lxComprobantevCodlista, lxComprobantevFletra, lxComprobantevEmail, lxComprobantevVtosenia, lxComprobantevTrci, lxComprobantevTotrecarsi, lxComprobantevFptoven, lxComprobantevFnumcomp, lxComprobantevFtotal, lxComprobantevTdci, lxComprobantevTotdescsi, lxComprobantevDirentr, lxComprobantevFfch, lxComprobantevFmtdes3, lxComprobantevDeuda, lxComprobantevCotiz, lxComprobantevFpodes, lxComprobantevRecmnto2, lxComprobantevFvuelto, lxComprobantevEntregapos, lxComprobantevFfchvtopag, lxComprobantevOpctrasmis, lxComprobantevFdescu, lxComprobantevMerconsign, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevRecmnto, lxComprobantevRecpor, lxComprobantevMr, lxComprobantevMr2, lxComprobantevMd2, lxComprobantevMr1, lxComprobantevRecmnto1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecarci, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevCancelar, lxComprobantevIvasis
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fd2","Fectrans","Fecimpo","Fmodifw","Fecexpo","Informnube","Fcuit","Datosecomm","Idcaja","Fperson","Despachos","Haltafw","Idajuste","Faltafw","Bdaltafw","Fhora","Valtafw","Zadsfw","Saltafw","Opecomm","Smodifw","Umodifw","Simbmon","Ualtafw","Esttrans","Bdmodifw","Horaexpo","Horaimpo","Hmodifw","Descfw","Vmodifw","Timestamp","Factsec","Totalcant","Fajxre","Mdcimpu","Recmntosi1","Recmntosi","Subtotsisi","Fsubtot","Sitfisccli","Fsubton","Signomov","Facttipo","Subtotcisi","Condivalp","Recmntosi2","Fpodes2","Desmntosi","Desmntosi1","Desmntosi2","Desmntosi3","Anulado","Desaut","Fcompfis","Idvuelto","Monsis","Motdescdev","Fobs","Fpodes1","Fcliente","Fturno","Idsenia","Fmtdes2","Codigo","Senia","Md1","Fmtdes1","Receptor","Fven","Moneda","Codlista","Fletra","Email","Vtosenia","Trci","Totrecarsi","Fptoven","Fnumcomp","Ftotal","Tdci","Totdescsi","Direntr","Ffch","Fmtdes3","Deuda","Cotiz","Fpodes","Recmnto2","Fvuelto","Entregapos","Ffchvtopag","Opctrasmis","Fdescu","Merconsign","Md3","Percepcion","Recmnto","Recpor","Mr","Mr2","Md2","Mr1","Recmnto1","Gravamen","Fimpuesto","Totrecarci","Totdesc","Totimpue","Cancelar","Ivasis" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'" >>, <<lxComprobantevIdcaja >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<lxComprobantevTimestamp >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevTotalcant >>, <<lxComprobantevFajxre >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevFsubtot >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevFsubton >>, <<lxComprobantevSignomov >>, <<lxComprobantevFacttipo >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevCondivalp >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevDesmntosi3 >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevDesaut, 1, 0 ) >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<lxComprobantevFpodes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFturno >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'" >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSenia ) + "'" >>, <<lxComprobantevMd1 >>, <<lxComprobantevFmtdes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'" >>, <<lxComprobantevTrci >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevFptoven >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFtotal >>, <<lxComprobantevTdci >>, <<lxComprobantevTotdescsi >>, <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevFmtdes3 >>, <<lxComprobantevDeuda >>, <<lxComprobantevCotiz >>, <<lxComprobantevFpodes >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevFvuelto >>, <<lxComprobantevEntregapos >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfchvtopag ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpctrasmis ) + "'" >>, <<lxComprobantevFdescu >>, <<iif( lxComprobantevMerconsign, 1, 0 ) >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecpor >>, <<lxComprobantevMr >>, <<lxComprobantevMr2 >>, <<lxComprobantevMd2 >>, <<lxComprobantevMr1 >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecarci >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<iif( lxComprobantevCancelar, 1, 0 ) >>, <<lxComprobantevIvasis >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Informnube" = <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Datosecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'">>,"Idcaja" = <<lxComprobantevIdcaja>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Despachos" = <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Idajuste" = <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Timestamp" = <<lxComprobantevTimestamp>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Totalcant" = <<lxComprobantevTotalcant>>,"Fajxre" = <<lxComprobantevFajxre>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Fsubton" = <<lxComprobantevFsubton>>,"Signomov" = <<lxComprobantevSignomov>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Desaut" = <<iif( lxComprobantevDesaut, 1, 0 )>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Motdescdev" = <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Idsenia" = <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'">>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Senia" = <<"'" + this.FormatearTextoSql( lxComprobantevSenia ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Receptor" = <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Email" = <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'">>,"Vtosenia" = <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'">>,"Trci" = <<lxComprobantevTrci>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Fptoven" = <<lxComprobantevFptoven>>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Ftotal" = <<lxComprobantevFtotal>>,"Tdci" = <<lxComprobantevTdci>>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Direntr" = <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Deuda" = <<lxComprobantevDeuda>>,"Cotiz" = <<lxComprobantevCotiz>>,"Fpodes" = <<lxComprobantevFpodes>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Fvuelto" = <<lxComprobantevFvuelto>>,"Entregapos" = <<lxComprobantevEntregapos>>,"Ffchvtopag" = <<"'" + this.ConvertirDateSql( lxComprobantevFfchvtopag ) + "'">>,"Opctrasmis" = <<"'" + this.FormatearTextoSql( lxComprobantevOpctrasmis ) + "'">>,"Fdescu" = <<lxComprobantevFdescu>>,"Merconsign" = <<iif( lxComprobantevMerconsign, 1, 0 )>>,"Md3" = <<lxComprobantevMd3>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Recpor" = <<lxComprobantevRecpor>>,"Mr" = <<lxComprobantevMr>>,"Mr2" = <<lxComprobantevMr2>>,"Md2" = <<lxComprobantevMd2>>,"Mr1" = <<lxComprobantevMr1>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Totrecarci" = <<lxComprobantevTotrecarci>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Cancelar" = <<iif( lxComprobantevCancelar, 1, 0 )>>,"Ivasis" = <<lxComprobantevIvasis>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 54 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fperson" as "Cliente", "Despachos" as "Despachos", "Haltafw" as "Horaaltafw", "Idajuste" as "Codigoajuste", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Opecomm" as "Nroopecommerce", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Timestamp" as "Timestamp", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Recmntosi2" as "Recargomontosinimpuestos2", "Fpodes2" as "Porcentajedescuento2", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Fletra" as "Letra", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 54
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Base" as "Basedecalculo", "Codimp" as "Codigoimpuesto", "Codint" as "Codigointerno", "Tipoi" as "Tipoimpuesto", "Sirecs" as "Codseguridadsire", "Descri" as "Descripcion", "Regimenimp" as "Regimenimpositivo", "Sirecert" as "Certificadosire", "Minimoper" as "Minimo", "Minoimp" as "Minimonoimponible", "Montobase" as "Montobase", "Nroitem" as "Nroitem", "Porcen" as "Porcentaje", "Monto" as "Monto", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_FACTURAELECTRONICADECREDITO.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Idvalor" as "Iditemvalor", "Atrcabever" as "Atributocabecera", "Idpromo" as "Iditempromo", "Idarti" as "Iditemarticulo", "Nroitem" as "Nroitem", "Monto" as "Montobeneficio", "Codigo" as "Codigo" from ZooLogic.ProArtDet where CODIGO = <<"'" + this.FormatearTextoSql( c_FACTURAELECTRONICADECREDITO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fperson" as "Cliente", "Despachos" as "Despachos", "Haltafw" as "Horaaltafw", "Idajuste" as "Codigoajuste", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Opecomm" as "Nroopecommerce", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Timestamp" as "Timestamp", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Recmntosi2" as "Recargomontosinimpuestos2", "Fpodes2" as "Porcentajedescuento2", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Fletra" as "Letra", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 54 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_FACTURAELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FACTURAELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fperson" as "Cliente", "Despachos" as "Despachos", "Haltafw" as "Horaaltafw", "Idajuste" as "Codigoajuste", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Opecomm" as "Nroopecommerce", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Timestamp" as "Timestamp", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Recmntosi2" as "Recargomontosinimpuestos2", "Fpodes2" as "Porcentajedescuento2", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Fletra" as "Letra", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 54 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_FACTURAELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FACTURAELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fperson" as "Cliente", "Despachos" as "Despachos", "Haltafw" as "Horaaltafw", "Idajuste" as "Codigoajuste", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Opecomm" as "Nroopecommerce", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Timestamp" as "Timestamp", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Recmntosi2" as "Recargomontosinimpuestos2", "Fpodes2" as "Porcentajedescuento2", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Fletra" as "Letra", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 54 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_FACTURAELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FACTURAELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fperson" as "Cliente", "Despachos" as "Despachos", "Haltafw" as "Horaaltafw", "Idajuste" as "Codigoajuste", "Faltafw" as "Fechaaltafw", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Opecomm" as "Nroopecommerce", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Timestamp" as "Timestamp", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Recmntosi2" as "Recargomontosinimpuestos2", "Fpodes2" as "Porcentajedescuento2", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Fletra" as "Letra", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 54 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_FACTURAELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FACTURAELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fd2,Fectrans,Fecimpo,Fmodifw,Fecexpo,Informnube,Fcuit,Datosecomm,Idcaja,Fperson,Despachos,Ha" + ;
"ltafw,Idajuste,Faltafw,Bdaltafw,Fhora,Valtafw,Zadsfw,Saltafw,Opecomm,Smodifw,Umodifw,Simbmon,Ualtafw" + ;
",Esttrans,Bdmodifw,Horaexpo,Horaimpo,Hmodifw,Descfw,Vmodifw,Timestamp,Factsec,Totalcant,Fajxre,Mdcim" + ;
"pu,Recmntosi1,Recmntosi,Subtotsisi,Fsubtot,Sitfisccli,Fsubton,Signomov,Facttipo,Subtotcisi,Condivalp" + ;
",Recmntosi2,Fpodes2,Desmntosi,Desmntosi1,Desmntosi2,Desmntosi3,Anulado,Desaut,Fcompfis,Idvuelto,Mons" + ;
"is,Motdescdev,Fobs,Fpodes1,Fcliente,Fturno,Idsenia,Fmtdes2,Codigo,Senia,Md1,Fmtdes1,Receptor,Fven,Mo" + ;
"neda,Codlista,Fletra,Email,Vtosenia,Trci,Totrecarsi,Fptoven,Fnumcomp,Ftotal,Tdci,Totdescsi,Direntr,F" + ;
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, InformNube = ] + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, DatosEComm = ] + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, Despachos = ] + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'"+ [, idAjuste = ] + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, DESAUT = ] + Transform( iif( &lcCursor..DESAUT, 1, 0 ))+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, MotDescDev = ] + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, IDSenia = ] + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'"+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, Senia = ] + "'" + this.FormatearTextoSql( &lcCursor..Senia ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, Receptor = ] + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, vtosenia = ] + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'"+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, DirEntr = ] + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, EntregaPos = ] + transform( &lcCursor..EntregaPos )+ [, FFCHVTOPAG = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCHVTOPAG ) + "'"+ [, OpcTrasmis = ] + "'" + this.FormatearTextoSql( &lcCursor..OpcTrasmis ) + "'"+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MerConsign = ] + Transform( iif( &lcCursor..MerConsign, 1, 0 ))+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, MR = ] + transform( &lcCursor..MR )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecarCI = ] + transform( &lcCursor..totrecarCI )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, Cancelar = ] + Transform( iif( &lcCursor..Cancelar, 1, 0 ))+ [, IvaSis = ] + transform( &lcCursor..IvaSis ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FD2, FECTRANS, FECIMPO, FMODIFW, FECEXPO, InformNube, fCuit, DatosEComm, IdCaja, FPerson, Despachos, HAltaFW, idAjuste, FAltaFW, BDALTAFW, FHORA, VALTAFW, ZADSFW, SALTAFW, OPEcomm, SMODIFW, UMODIFW, SimbMon, UALTAFW, ESTTRANS, BDMODIFW, HORAEXPO, HORAIMPO, HMODIFW, DescFW, VMODIFW, TIMESTAMP, FACTSEC, TotalCant, FAjXRe, MDCIMPU, RecMntoSI1, RecMntoSI, SubTotSISI, FSubTOT, SitFiscCli, fSubToN, signomov, FACTTIPO, SubTotCISI, CondivaLp, RecMntoSI2, FPODES2, DesMntoSI, DesMntoSI1, DesMntoSI2, DesMntoSI3, Anulado, DESAUT, FCOMPFIS, idVuelto, MonSis, MotDescDev, FObs, FPODES1, FCLIENTE, FTurno, IDSenia, FMTDES2, CODIGO, Senia, MD1, FMTDES1, Receptor, FVEN, Moneda, CodLista, FLETRA, Email, vtosenia, TRCI, totrecarSI, FPTOVEN, FNUMCOMP, FTotal, TDCI, totdescSI, DirEntr, FFCH, FMTDES3, Deuda, Cotiz, FPODES, RecMnto2, FVuelto, EntregaPos, FFCHVTOPAG, OpcTrasmis, fDescu, MerConsign, MD3, percepcion, RecMnto, RecPor, MR, MR2, MD2, MR1, RecMnto1, gravamen, fImpuesto, totrecarCI, totdesc, totimpue, Cancelar, IvaSis
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'" + ',' + transform( &lcCursor..IdCaja ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..TotalCant ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..MDCIMPU )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..CondivaLp )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..DESAUT, 1, 0 )) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + transform( &lcCursor..FPODES1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..FTurno )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'" + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Senia ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + transform( &lcCursor..FMTDES1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'" + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totrecarSI )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPTOVEN ) + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..TDCI ) + ',' + transform( &lcCursor..totdescSI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..FMTDES3 ) + ',' + transform( &lcCursor..Deuda )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..Cotiz ) + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..EntregaPos ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCHVTOPAG ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OpcTrasmis ) + "'" + ',' + transform( &lcCursor..fDescu ) + ',' + Transform( iif( &lcCursor..MerConsign, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..MD3 ) + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..RecPor ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..totrecarCI ) + ',' + transform( &lcCursor..totdesc ) + ',' + transform( &lcCursor..totimpue ) + ',' + Transform( iif( &lcCursor..Cancelar, 1, 0 )) + ',' + transform( &lcCursor..IvaSis )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FD2 = isnull( d.FD2, t.FD2 ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.INFORMNUBE = isnull( d.INFORMNUBE, t.INFORMNUBE ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.DATOSECOMM = isnull( d.DATOSECOMM, t.DATOSECOMM ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.DESPACHOS = isnull( d.DESPACHOS, t.DESPACHOS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.DESAUT = isnull( d.DESAUT, t.DESAUT ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.IDSENIA = isnull( d.IDSENIA, t.IDSENIA ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.SENIA = isnull( d.SENIA, t.SENIA ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.RECEPTOR = isnull( d.RECEPTOR, t.RECEPTOR ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.VTOSENIA = isnull( d.VTOSENIA, t.VTOSENIA ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.DIRENTR = isnull( d.DIRENTR, t.DIRENTR ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.FFCHVTOPAG = isnull( d.FFCHVTOPAG, t.FFCHVTOPAG ),t.OPCTRASMIS = isnull( d.OPCTRASMIS, t.OPCTRASMIS ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MERCONSIGN = isnull( d.MERCONSIGN, t.MERCONSIGN ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.MR = isnull( d.MR, t.MR ),t.MR2 = isnull( d.MR2, t.MR2 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECARCI = isnull( d.TOTRECARCI, t.TOTRECARCI ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.CANCELAR = isnull( d.CANCELAR, t.CANCELAR ),t.IVASIS = isnull( d.IVASIS, t.IVASIS )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fd2,Fectrans,Fecimpo,Fmodifw,Fecexpo,Informnube,Fcuit,Datosecomm,Idcaja,Fperson,Despachos,Haltafw,Idajuste,Faltafw,Bdaltafw,Fhora,Valtafw,Zadsfw,Saltafw,Opecomm,Smodifw,Umodifw,Simbmon,Ualtafw,Esttrans,Bdmodifw,Horaexpo,Horaimpo,Hmodifw,Descfw,Vmodifw,Timestamp,Factsec,Totalcant,Fajxre,Mdcimpu,Recmntosi1,Recmntosi,Subtotsisi,Fsubtot,Sitfisccli,Fsubton,Signomov,Facttipo,Subtotcisi,Condivalp,Recmntosi2,Fpodes2,Desmntosi,Desmntosi1,Desmntosi2,Desmntosi3,Anulado,Desaut,Fcompfis,Idvuelto,Monsis,Motdescdev,Fobs,Fpodes1,Fcliente,Fturno,Idsenia,Fmtdes2,Codigo,Senia,Md1,Fmtdes1,Receptor,Fven,Moneda,Codlista,Fletra,Email,Vtosenia,Trci,Totrecarsi,Fptoven,Fnumcomp,Ftotal,Tdci,Totdescsi,Direntr,Ffch,Fmtdes3,Deuda,Cotiz,Fpodes,Recmnto2,Fvuelto,Entregapos,Ffchvtopag,Opctrasmis,Fdescu,Merconsign,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Recmnto1,Gravamen,Fimpuesto,Totrecarci,Totdesc,Totimpue,Cancelar,Ivasis)
					Select isnull( d.FD2,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),isnull( d.INFORMNUBE,''),isnull( d.FCUIT,''),isnull( d.DATOSECOMM,''),isnull( d.IDCAJA,0),isnull( d.FPERSON,''),isnull( d.DESPACHOS,''),convert( char(8), getdate(), 108 ),isnull( d.IDAJUSTE,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.BDALTAFW,''),isnull( d.FHORA,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.SALTAFW,''),isnull( d.OPECOMM,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.SIMBMON,''),isnull( d.UALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.DESCFW,''),isnull( d.VMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.FACTSEC,''),isnull( d.TOTALCANT,0),isnull( d.FAJXRE,0),isnull( d.MDCIMPU,0),isnull( d.RECMNTOSI1,0),isnull( d.RECMNTOSI,0),isnull( d.SUBTOTSISI,0),isnull( d.FSUBTOT,0),isnull( d.SITFISCCLI,0),isnull( d.FSUBTON,0),isnull( d.SIGNOMOV,0),isnull( d.FACTTIPO,0),isnull( d.SUBTOTCISI,0),isnull( d.CONDIVALP,0),isnull( d.RECMNTOSI2,0),isnull( d.FPODES2,0),isnull( d.DESMNTOSI,0),isnull( d.DESMNTOSI1,0),isnull( d.DESMNTOSI2,0),isnull( d.DESMNTOSI3,0),isnull( d.ANULADO,0),isnull( d.DESAUT,0),isnull( d.FCOMPFIS,0),isnull( d.IDVUELTO,''),isnull( d.MONSIS,''),isnull( d.MOTDESCDEV,''),isnull( d.FOBS,''),isnull( d.FPODES1,0),isnull( d.FCLIENTE,''),isnull( d.FTURNO,0),isnull( d.IDSENIA,''),isnull( d.FMTDES2,0),isnull( d.CODIGO,''),isnull( d.SENIA,''),isnull( d.MD1,0),isnull( d.FMTDES1,0),isnull( d.RECEPTOR,''),isnull( d.FVEN,''),isnull( d.MONEDA,''),isnull( d.CODLISTA,''),isnull( d.FLETRA,''),isnull( d.EMAIL,''),isnull( d.VTOSENIA,''),isnull( d.TRCI,0),isnull( d.TOTRECARSI,0),isnull( d.FPTOVEN,0),isnull( d.FNUMCOMP,0),isnull( d.FTOTAL,0),isnull( d.TDCI,0),isnull( d.TOTDESCSI,0),isnull( d.DIRENTR,''),isnull( d.FFCH,''),isnull( d.FMTDES3,0),isnull( d.DEUDA,0),isnull( d.COTIZ,0),isnull( d.FPODES,0),isnull( d.RECMNTO2,0),isnull( d.FVUELTO,0),isnull( d.ENTREGAPOS,0),isnull( d.FFCHVTOPAG,''),isnull( d.OPCTRASMIS,''),isnull( d.FDESCU,0),isnull( d.MERCONSIGN,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.RECMNTO,0),isnull( d.RECPOR,0),isnull( d.MR,0),isnull( d.MR2,0),isnull( d.MD2,0),isnull( d.MR1,0),isnull( d.RECMNTO1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECARCI,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.CANCELAR,0),isnull( d.IVASIS,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_FACTURAELECTRONICADECREDITO' ) < 1
				...
				Try
					...
					.Obs = nvl( c_FACTURAELECTRONICADECREDITO.Obs, [] )
					.Kitsdetalle.Limpiar()
...
<VFPData xml:space="preserve">
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="FECHATRANSFERENCIA                      " tabla="COMPROBANTEV   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="NROOPECOMMERCE                          " tabla="COMPROBANTEV   " campo="OPECOMM   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Nro. op. ecommerce                                                                                                                                                                                                                                        " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPROBANTEV   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="COMPROBANTEV   " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                                                                                                                     " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="VUELTO                                  " tabla="COMPROBANTEV   " campo="FVUELTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vuelto persistido                                                                                                                                                                                                                                         " dominio="VUELTO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="10" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="DESCUENTO                               " tabla="COMPROBANTEV   " campo="FDESCU    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="Monto % descuento                                                                                                                                                                                                                                         " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="1" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="IMPUESTOS                               " tabla="COMPROBANTEV   " campo="FIMPUESTO " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="456" etiqueta="I.V.A.                                                                                                                                                                                                                                                    " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECARCI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos total                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuentos                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="28" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FACTURAELECTRONICADECREDITO             " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="458" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
