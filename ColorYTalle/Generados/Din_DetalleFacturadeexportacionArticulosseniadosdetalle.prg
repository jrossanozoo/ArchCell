...
define class Din_DetalleFACTURADEEXPORTACIONArticulosseniadosdetalle as DetalleColorytalle_articulosseniados of DetalleColorytalle_articulosseniados.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemFACTURADEEXPORTACIONArticulosseniadosdetalle' )
