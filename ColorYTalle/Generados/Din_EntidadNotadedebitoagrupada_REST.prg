...
define class Din_EntidadNotadedebitoagrupada_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadedebitoagrupada"
	cClaseResponse = this.cNamespaceDTOs + ".NotadedebitoagrupadaResponse"
	cClaseModelo = "NotadedebitoagrupadaModelo"
	cEntidad = "Notadedebitoagrupada"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoagrupadaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoagrupadaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoagrupadaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoagrupadaModelo"
		endcase
		return lcRetorno
