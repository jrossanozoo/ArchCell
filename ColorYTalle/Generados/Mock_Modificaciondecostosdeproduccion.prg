...
define class Mock_modificaciondecostosdeproduccion as MockBase of MockBase.prg
	...
	cClase = 'modificaciondecostosdeproduccion'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Modificación de costos de producción"                                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallemodcostos() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallemodcostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modcostos_access() as variant                                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MODIFICACIONDECOSTOSDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modcostos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modcostos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Modcostos ) = 'O' or isnull( this.Modcostos ) )			this.Modcostos = this.crearobjeto( 'DetalleModificaciondecostosdeproduccionModcostos' )			this.Modcostos.inicializar()			this.Modcostos.lPermitirDetalleVacio = .F.			this.enlazar( 'Modcostos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Modcostos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Modcostos, 'CambioSumarizado', this, 'CambiosDetalleModcostos', 1)			this.enlazar( 'Modcostos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Modcostos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Modcostos
	EndFunc
