...
define class Mock_Itemmovimientostockainventmovimientodetalle as MockBase of MockBase.prg

	cClase = 'Itemmovimientostockainventmovimientodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function inventariodestinodetalle_assign( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Inventariodestinodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventariodestinodetalle( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_inventariodestinodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventariodestinodetalle( txval as variant ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_inventariodestinodetalle', lcParametros )
	EndFunc
