...
define class Din_EntidadPersonalizaciondeentidades_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Personalizaciondeentidades"
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Denominacionplural", "DENPLU")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Denominacionsingular", "DENSIN")
