...
define class Mock_Itemlistadospersonalizadosordenamientosdetalle as MockBase of MockBase.prg

	cClase = 'Itemlistadospersonalizadosordenamientosdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function sentido_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Sentido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_sentido( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_sentido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_sentido( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_sentido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosentido() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridosentido', lcParametros )
	EndFunc
