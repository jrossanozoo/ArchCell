...
define class Din_EntidadAPERTURAEJERCICIOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAperejerFecexpo, lxAperejerFectrans, lxAperejerFecimpo, lxAperejerFaltafw, lxAperejerFmodifw, lxAperejerSmodifw, lxAperejerSaltafw, lxAperejerUaltafw, lxAperejerUmodifw, lxAperejerZadsfw, lxAperejerVmodifw, lxAperejerHmodifw, lxAperejerValtafw, lxAperejerHaltafw, lxAperejerHoraimpo, lxAperejerBdmodifw, lxAperejerBdaltafw, lxAperejerEsttrans, lxAperejerHoraexpo, lxAperejerObs, lxAperejerNumero, lxAperejerDescr, lxAperejerAsiento, lxAperejerEjercicio, lxAperejerFechaaper
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.APEREJER ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Smodifw","Saltafw","Ualtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Valtafw","Haltafw","Horaimpo","Bdmodifw","Bdaltafw","Esttrans","Horaexpo","Obs","Numero","Descr","Asiento","Ejercicio","Fechaaper" ) values ( <<"'" + this.ConvertirDateSql( lxAperejerFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAperejerFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAperejerFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAperejerFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAperejerFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerObs ) + "'" >>, <<lxAperejerNumero >>, <<"'" + this.FormatearTextoSql( lxAperejerDescr ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAperejerAsiento ) + "'" >>, <<lxAperejerEjercicio >>, <<"'" + this.ConvertirDateSql( lxAperejerFechaaper ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.APEREJER set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAperejerFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAperejerFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAperejerFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAperejerFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAperejerFmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAperejerSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAperejerSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAperejerUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAperejerUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAperejerZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAperejerVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAperejerHmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAperejerValtafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAperejerHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAperejerHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAperejerBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAperejerBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAperejerEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAperejerHoraexpo ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxAperejerObs ) + "'">>,"Numero" = <<lxAperejerNumero>>,"Descr" = <<"'" + this.FormatearTextoSql( lxAperejerDescr ) + "'">>,"Asiento" = <<"'" + this.FormatearTextoSql( lxAperejerAsiento ) + "'">>,"Ejercicio" = <<lxAperejerEjercicio>>,"Fechaaper" = <<"'" + this.ConvertirDateSql( lxAperejerFechaaper ) + "'">> where "Numero" = <<lxAperejerNumero>> and  APEREJER.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Obs" as "Observacion", "Numero" as "Numero", "Descr" as "Descripcion", "Asiento" as "Asiento", "Ejercicio" as "Ejercicio", "Fechaaper" as "Fechaapertura" from ZooLogic.APEREJER where "Numero" = <<lxAperejerNumero>> and  APEREJER.NUMERO != 0
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Obs" as "Observacion", "Numero" as "Numero", "Descr" as "Descripcion", "Asiento" as "Asiento", "Ejercicio" as "Ejercicio", "Fechaaper" as "Fechaapertura" from ZooLogic.APEREJER where  APEREJER.NUMERO != 0 order by Numero
			endtext
			use in select('c_APERTURAEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_APERTURAEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Obs" as "Observacion", "Numero" as "Numero", "Descr" as "Descripcion", "Asiento" as "Asiento", "Ejercicio" as "Ejercicio", "Fechaaper" as "Fechaapertura" from ZooLogic.APEREJER where  str( Numero, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  APEREJER.NUMERO != 0 order by Numero
			endtext
			use in select('c_APERTURAEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_APERTURAEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Obs" as "Observacion", "Numero" as "Numero", "Descr" as "Descripcion", "Asiento" as "Asiento", "Ejercicio" as "Ejercicio", "Fechaaper" as "Fechaapertura" from ZooLogic.APEREJER where  str( Numero, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  APEREJER.NUMERO != 0 order by Numero desc
			endtext
			use in select('c_APERTURAEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_APERTURAEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Obs" as "Observacion", "Numero" as "Numero", "Descr" as "Descripcion", "Asiento" as "Asiento", "Ejercicio" as "Ejercicio", "Fechaaper" as "Fechaapertura" from ZooLogic.APEREJER where  APEREJER.NUMERO != 0 order by Numero desc
			endtext
			use in select('c_APERTURAEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_APERTURAEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Smodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Vmodifw,Hmod" + ;
"ifw,Valtafw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Obs,Numero,Descr,Asiento,Ejercicio," + ;
"Fechaaper" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Obs" as "Observacion", "Numero" as "Numero", "Descr" as "Descripcion", "Asiento" as "Asiento", "Ejercicio" as "Ejercicio", "Fechaaper" as "Fechaapertura"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.APEREJER set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, Descr = ] + "'" + this.FormatearTextoSql( &lcCursor..Descr ) + "'"+ [, Asiento = ] + "'" + this.FormatearTextoSql( &lcCursor..Asiento ) + "'"+ [, Ejercicio = ] + transform( &lcCursor..Ejercicio )+ [, FechaAper = ] + "'" + this.ConvertirDateSql( &lcCursor..FechaAper ) + "'" + [ Where Numero = ] + transform( &lcCursor..Numero ) )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, SMODIFW, SALTAFW, UALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, VALTAFW, HALTAFW, HORAIMPO, BDMODIFW, BDALTAFW, ESTTRANS, HORAEXPO, Obs, Numero, Descr, Asiento, Ejercicio, FechaAper
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + ',' + transform( &lcCursor..Numero )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descr ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Asiento ) + "'" + ',' + transform( &lcCursor..Ejercicio ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaAper ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.OBS = isnull( d.OBS, t.OBS ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.DESCR = isnull( d.DESCR, t.DESCR ),t.ASIENTO = isnull( d.ASIENTO, t.ASIENTO ),t.EJERCICIO = isnull( d.EJERCICIO, t.EJERCICIO ),t.FECHAAPER = isnull( d.FECHAAPER, t.FECHAAPER )
					from ZooLogic.APEREJER t inner join deleted d 
							 on t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.APEREJER(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Smodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Valtafw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Obs,Numero,Descr,Asiento,Ejercicio,Fechaaper)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.VALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.OBS,''),isnull( d.NUMERO,0),isnull( d.DESCR,''),isnull( d.ASIENTO,''),isnull( d.EJERCICIO,0),isnull( d.FECHAAPER,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="APERTURAEJERCICIO                       " atributo="FECHATRANSFERENCIA                      " tabla="APEREJER       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="APERTURAEJERCICIO                       " atributo="ESTADOTRANSFERENCIA                     " tabla="APEREJER       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ASIENTO                                 " atributo="NUMERO                                  " tabla="ASIENTO        " campo="NUMERO    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="7" etiqueta="Detalle Asi.                                                                                                                                                    " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ASIENTO On APEREJER.ASIENTO = ASIENTO.ACOD And  ASIENTO.ACOD != ''                                                                                                                                                                                 " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
