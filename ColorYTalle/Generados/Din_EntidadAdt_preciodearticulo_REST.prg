...
define class Din_EntidadAdt_preciodearticulo_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Adt_preciodearticulo"
	cClaseResponse = this.cNamespaceDTOs + ".Adt_preciodearticuloResponse"
	cClaseModelo = "Adt_preciodearticuloModelo"
	cEntidad = "Adt_preciodearticulo"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_preciodearticuloModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_preciodearticuloListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_preciodearticuloListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_preciodearticuloModelo"
		endcase
		return lcRetorno
