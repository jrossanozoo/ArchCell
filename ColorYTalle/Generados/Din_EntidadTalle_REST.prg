...
define class Din_EntidadTalle_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Talle"
	cClaseResponse = this.cNamespaceDTOs + ".TalleResponse"
	cClaseModelo = "TalleModelo"
	cEntidad = "Talle"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TalleModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TalleListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TalleListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TalleModelo"
		endcase
		return lcRetorno
