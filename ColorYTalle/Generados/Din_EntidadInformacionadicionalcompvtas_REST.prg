...
define class Din_EntidadInformacionadicionalcompvtas_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Informacionadicionalcompvtas"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleComprobantes( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Tipocomprobante", toEntidad.Comprobantes.oItem, "TipoComprobante" )
			this.SetearAtributoModeloEnEntidad( loItem, "Tipocompcaracter", toEntidad.Comprobantes.oItem, "TipoCompCaracter" )
			this.SetearAtributoModeloEnEntidad( loItem, "Letra", toEntidad.Comprobantes.oItem, "Letra" )
			this.SetearAtributoModeloEnEntidad( loItem, "Puntodeventa", toEntidad.Comprobantes.oItem, "PuntoDeVenta" )
			this.SetearAtributoModeloEnEntidad( loItem, "Numero", toEntidad.Comprobantes.oItem, "Numero" )
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Afecta", toEntidad.Comprobantes.oItem, "Afecta" )
			this.SetearAtributoModeloEnEntidad( loItem, "Interviniente", toEntidad.Comprobantes.oItem, "Interviniente" )
			this.SetearAtributoModeloEnEntidad( loItem, "Entidadcomprobante", toEntidad.Comprobantes.oItem, "EntidadComprobante" )
	...
	protected function CargarColeccionModeloComprobantes( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .Comprobantes.Count
				...
				this.SetearAtributoInteger( loItem, "TipoComprobante", .Comprobantes.Item(lnI).TipoComprobante)
				this.SetearAtributoString( loItem, "TipoCompCaracter", .Comprobantes.Item(lnI).TipoCompCaracter)
				this.SetearAtributoString( loItem, "Letra", .Comprobantes.Item(lnI).Letra)
				this.SetearAtributoInteger( loItem, "PuntoDeVenta", .Comprobantes.Item(lnI).PuntoDeVenta)
				this.SetearAtributoInteger( loItem, "Numero", .Comprobantes.Item(lnI).Numero)
				...
				this.SetearAtributoString( loItem, "Afecta", .Comprobantes.Item(lnI).Afecta)
				this.SetearAtributoString( loItem, "Interviniente", .Comprobantes.Item(lnI).Interviniente)
				this.SetearAtributoString( loItem, "EntidadComprobante", .Comprobantes.Item(lnI).EntidadComprobante)
