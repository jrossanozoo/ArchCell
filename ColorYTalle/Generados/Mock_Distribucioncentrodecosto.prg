...
define class Mock_distribucioncentrodecosto as MockBase of MockBase.prg
	...
	cClase = 'distribucioncentrodecosto'
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallecentrodecosto() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallecentrodecosto', lcParametros )
	EndFunc
