...
define class Mock_Familiaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Familiaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubfml( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubfml', lcParametros )
	EndFunc
