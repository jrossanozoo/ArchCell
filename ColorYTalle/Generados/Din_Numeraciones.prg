	...
	*-----------------------------------------------------------------------------------------
	function SetearEntidad( toEntidad as object )
		...
		Do Case
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'APERTURAEJERCICIO'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [APERTURAEJERCICIO]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [APERTURAEJERCICIO.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['APERTURAEJERCICIO']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'ASOCIACIONARTICULOSOPERACIONESAFIP'
				...
				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['ASOCIAARTIOPERAFIP']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'CANCELACIONDECOMPRA'
				...
				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['41'+#letra@+#PuntoDeVenta@]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'COMPROBANTEDERETENCIONRECIBIDO'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [COMPROBANTEDERETENCIONRECIBIDO]
				loItem.cAtributo = [NUMEROINTERNO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [COMPROBANTEDERETENCIONRECIBIDO.NUMEROINTERNO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['CRR']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'COTIZACIONPRODUCCION'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [COTIZACIONPRODUCCION]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [COTIZACIONPRODUCCION.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["COTIZACIONPRODUCCION"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'DISENOTRANSFORMACIONLINCE'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [DISENOTRANSFORMACIONLINCE]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [DISENOTRANSFORMACIONLINCE.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['DISENOTRANSFORMACIONLINCE']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'ENVIODECUENTACORRIENTEPORMAIL'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [ENVIODECUENTACORRIENTEPORMAIL]
				loItem.cAtributo = [CODIGO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [ENVIODECUENTACORRIENTEPORMAIL.CODIGO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['ENVIODECCPORMAIL']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )

			Case upper(alltrim( toEntidad.cNombre)) == 'ENVIODEMENSAJERIA'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [ENVIODEMENSAJERIA]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [ENVIODEMENSAJERIA.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['ENVIODEMENSAJERIA']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'FINALDEPRODUCCION'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [FINALDEPRODUCCION]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [FINALDEPRODUCCION.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["FINALDEPRODUCCION"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'GESTIONDEPRODUCCION'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [GESTIONDEPRODUCCION]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [GESTIONDEPRODUCCION.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["GESTIONDEPRODUCCION"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )

			Case upper(alltrim( toEntidad.cNombre)) == 'HERRAMIENTAAGRUPADORADEPACKS'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [HERRAMIENTAAGRUPADORADEPACKS]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [HERRAMIENTAAGRUPADORADEPACKS.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['HERAGRUPADORADEPACKS']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .F.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'IMPDIRCUE'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [IMPDIRCUE]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [IMPDIRCUE.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['IMPDIRCUE']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'IMPDIRMOT'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [IMPDIRMOT]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [IMPDIRMOT.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['IMPDIRMOT']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'LIQUIDACIONDETALLER'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [LIQUIDACIONDETALLER]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [LIQUIDACIONDETALLER.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["LIQUIDACIONDETALLER"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'MAILPORLOTE'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [MAILPORLOTE]
				loItem.cAtributo = [CODIGO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [MAILPORLOTE.CODIGO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['MAILPORLOTE']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'MODIFICACIONDECOSTOSDEPRODUCCION'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [MODIFICACIONDECOSTOSDEPRODUCCION]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [MODIFICACIONDECOSTOSDEPRODUCCION.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["MODIFICACIONDECOSTOSDEPRODUCCION"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'MOVIMIENTOSTOCKAINVENT'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [MOVIMIENTOSTOCKAINVENT]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [MOVIMIENTOSTOCKAINVENT.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["MOVIMIENTOSTOCKAINVENT"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )

			Case upper(alltrim( toEntidad.cNombre)) == 'MOVIMIENTOSTOCKAPRODUCC'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [MOVIMIENTOSTOCKAPRODUCC]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [MOVIMIENTOSTOCKAPRODUCC.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["MOVIMIENTOSTOCKAPRODUCC"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )

			Case upper(alltrim( toEntidad.cNombre)) == 'MOVIMIENTOSTOCKDESDEPRODUCC'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [MOVIMIENTOSTOCKDESDEPRODUCC]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [MOVIMIENTOSTOCKDESDEPRODUCC.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["MOVIMIENTOSTOCKDESDEPRODUCC"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'OBJETIVOSVENTA'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [OBJETIVOSVENTA]
				loItem.cAtributo = [CODIGO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [OBJETIVOSVENTA.CODIGO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['OBJVENTAS']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .F.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'ORDENDEPRODUCCION'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [ORDENDEPRODUCCION]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [ORDENDEPRODUCCION.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['OPP']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'PEDIDODECOMPRA'
				...
				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['PCO']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'PRESUPUESTODECOMPRA'
				...
				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['PDC']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .F.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'REMITODECOMPRA'
				...
				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['RDC']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'RENUMERAASIENTOS'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [RENUMERAASIENTOS]
				loItem.cAtributo = [CODIGO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [RENUMERAASIENTOS.CODIGO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ["RENUMERAASIENTOS"]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .F.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'TIDIFERENCIASDEINVENTARIODETALLE'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [TIDiferenciasDeInventarioDetalle]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [TIDIFERENCIASDEINVENTARIODETALLE.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['TIDiferenciasDeInventarioDetalle']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'VALEDECAMBIO'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [VALEDECAMBIO]
				loItem.cAtributo = [NUMERO]
				loItem.lNumeracionPrincipal = .F.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [VALEDECAMBIO.NUMERO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['VALC'+#PuntoDeVenta@]
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
			...
			Case upper(alltrim( toEntidad.cNombre)) == 'ZUDESCARGALAN'
				loItem = this.ObtenerItemEntidad()
				loItem.cEntidad = [ZUDESCARGALAN]
				loItem.cAtributo = [CODIGO]
				loItem.lNumeracionPrincipal = .T.
				loItem.oColTalonarios = newobject( 'zooColeccion', 'zooColeccion.prg' )
				this.oColEntidades.agregar( loItem, [ZUDESCARGALAN.CODIGO] )

				loItemTalonario = this.ObtenerItemTalonario()
				loItemTalonario.cTalonario = ['DESCARGALAN']
				loItemTalonario.cCondicion = []
				loItemTalonario.cServicio = []
				loItemTalonario.lPuedeReservar = .T.
				loItem.oColTalonarios.agregar( loItemTalonario )
	...
	function ObtenerAtributo( tcEntidad as String )
		...
		Do Case
			...
			Case upper(alltrim( tcEntidad)) == 'AJUSTEDESTOCK'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'APERTURAEJERCICIO'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'CONTABILIZACION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'COTIZACIONPRODUCCION'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'DEVOLUCION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'DISENOTRANSFORMACIONLINCE'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'ENTREGADEMERCADERIAS'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'ENVIODECUENTACORRIENTEPORMAIL'
				lcAtributo = 'CODIGO'
			Case upper(alltrim( tcEntidad)) == 'ENVIODEMENSAJERIA'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'FACTURAELECTRONICAEXPORTACION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'FINALDEPRODUCCION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'GESTIONCHCUSTODIA'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'GESTIONDEPRODUCCION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'HERRAMIENTAAGRUPADORADEPACKS'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'IMPDIRCON'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'IMPDIRCUE'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'IMPDIRLIQ'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'IMPDIRMOT'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'LIMITECONSUMO'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'LIQUIDACIONDETALLER'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'LIQUIDACIONMENSUAL'
				lcAtributo = 'NUMINT'
			Case upper(alltrim( tcEntidad)) == 'LISTADEPRECIOSCALCULADA'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MAILPORLOTE'
				lcAtributo = 'CODIGO'
			Case upper(alltrim( tcEntidad)) == 'MERCADERIAENTRANSITO'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MINIMOREPOSICION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MODIFICACIONDECOSTOSDEPRODUCCION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MODIFICACIONPRECIOS'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MOVIMIENTODESTOCK'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MOVIMIENTOSTOCKAINVENT'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MOVIMIENTOSTOCKAPRODUCC'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'MOVIMIENTOSTOCKDESDEPRODUCC'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'NOTADEDEBITOELECTRONICAEXPORTACION'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'OBJETIVOSVENTA'
				lcAtributo = 'CODIGO'
			Case upper(alltrim( tcEntidad)) == 'ORDENDEPAGO'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'ORDENDEPRODUCCION'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'REMITOELECTRONICO'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'RENUMERAASIENTOS'
				lcAtributo = 'CODIGO'
			...
			Case upper(alltrim( tcEntidad)) == 'TIDIFERENCIASDEINVENTARIO'
				lcAtributo = 'CODIGO'
			Case upper(alltrim( tcEntidad)) == 'TIDIFERENCIASDEINVENTARIODETALLE'
				lcAtributo = 'NUMERO'
			...
			Case upper(alltrim( tcEntidad)) == 'TRATAMIENTOCOMPROBANTES'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'VALEDECAMBIO'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'VALORESENTRANSITO'
				lcAtributo = 'NUMERO'
			Case upper(alltrim( tcEntidad)) == 'ZUDESCARGALAN'
				lcAtributo = 'CODIGO'
			otherwise
				lcAtributo = ''
		EndCase
