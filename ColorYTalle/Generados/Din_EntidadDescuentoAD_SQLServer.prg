	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.DESCUENTOS ( "Fecimpo","Fmodifw","Fectrans","Fecexpo","Faltafw","Saltafw","Smodifw","Ualtafw","Horaimpo","Haltafw","Esttrans","Horaexpo","Hmodifw","Umodifw","Bdaltafw","Valtafw","Descfw","Bdmodifw","Vmodifw","Zadsfw","Tipagrupub","Timestamp","Inactivofw","Codigo","Des","Func","Mondes","Intera","Monhas","Orden","Monto","Porcdes","Fecdes","Montomax","Fechas","Porcmax","Hordes","Horhas","Cantdes","Canthas","Perfdesde","Perfhasta","Listdesde","Listhasta","Venddesde","Vendhasta","Clasvdesde","Dialu","Clasvhasta","Diama","Diami","Diaju","Clascdesde","Diavi","Claschasta","Diasa","Tipocdesde","Diado","Tipochasta","Catecdesde","Catechasta","Tobs" ) values ( <<"'" + this.ConvertirDateSql( lxDescuentosFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescuentosFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescuentosFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescuentosFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescuentosFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosZadsfw ) + "'" >>, <<lxDescuentosTipagrupub >>, <<lxDescuentosTimestamp >>, <<iif( lxDescuentosInactivofw, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDescuentosCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosDes ) + "'" >>, <<lxDescuentosFunc >>, <<lxDescuentosMondes >>, <<lxDescuentosIntera >>, <<lxDescuentosMonhas >>, <<lxDescuentosOrden >>, <<lxDescuentosMonto >>, <<lxDescuentosPorcdes >>, <<"'" + this.ConvertirDateSql( lxDescuentosFecdes ) + "'" >>, <<lxDescuentosMontomax >>, <<"'" + this.ConvertirDateSql( lxDescuentosFechas ) + "'" >>, <<lxDescuentosPorcmax >>, <<"'" + this.FormatearTextoSql( lxDescuentosHordes ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosHorhas ) + "'" >>, <<lxDescuentosCantdes >>, <<lxDescuentosCanthas >>, <<"'" + this.FormatearTextoSql( lxDescuentosPerfdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosPerfhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosListdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosListhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosVenddesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosVendhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosClasvdesde ) + "'" >>, <<iif( lxDescuentosDialu, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDescuentosClasvhasta ) + "'" >>, <<iif( lxDescuentosDiama, 1, 0 ) >>, <<iif( lxDescuentosDiami, 1, 0 ) >>, <<iif( lxDescuentosDiaju, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDescuentosClascdesde ) + "'" >>, <<iif( lxDescuentosDiavi, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDescuentosClaschasta ) + "'" >>, <<iif( lxDescuentosDiasa, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDescuentosTipocdesde ) + "'" >>, <<iif( lxDescuentosDiado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDescuentosTipochasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosCatecdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosCatechasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescuentosTobs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.DESCUENTOS set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDescuentosFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxDescuentosFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxDescuentosFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxDescuentosFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxDescuentosFaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxDescuentosSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxDescuentosUaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxDescuentosHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxDescuentosHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxDescuentosEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxDescuentosHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosUmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDescuentosBdaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxDescuentosValtafw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxDescuentosDescfw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosBdmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxDescuentosZadsfw ) + "'">>,"Tipagrupub" = <<lxDescuentosTipagrupub>>,"Timestamp" = <<lxDescuentosTimestamp>>,"Inactivofw" = <<iif( lxDescuentosInactivofw, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxDescuentosCodigo ) + "'">>,"Des" = <<"'" + this.FormatearTextoSql( lxDescuentosDes ) + "'">>,"Func" = <<lxDescuentosFunc>>,"Mondes" = <<lxDescuentosMondes>>,"Intera" = <<lxDescuentosIntera>>,"Monhas" = <<lxDescuentosMonhas>>,"Orden" = <<lxDescuentosOrden>>,"Monto" = <<lxDescuentosMonto>>,"Porcdes" = <<lxDescuentosPorcdes>>,"Fecdes" = <<"'" + this.ConvertirDateSql( lxDescuentosFecdes ) + "'">>,"Montomax" = <<lxDescuentosMontomax>>,"Fechas" = <<"'" + this.ConvertirDateSql( lxDescuentosFechas ) + "'">>,"Porcmax" = <<lxDescuentosPorcmax>>,"Hordes" = <<"'" + this.FormatearTextoSql( lxDescuentosHordes ) + "'">>,"Horhas" = <<"'" + this.FormatearTextoSql( lxDescuentosHorhas ) + "'">>,"Cantdes" = <<lxDescuentosCantdes>>,"Canthas" = <<lxDescuentosCanthas>>,"Perfdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosPerfdesde ) + "'">>,"Perfhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosPerfhasta ) + "'">>,"Listdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosListdesde ) + "'">>,"Listhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosListhasta ) + "'">>,"Venddesde" = <<"'" + this.FormatearTextoSql( lxDescuentosVenddesde ) + "'">>,"Vendhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosVendhasta ) + "'">>,"Clasvdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosClasvdesde ) + "'">>,"Dialu" = <<iif( lxDescuentosDialu, 1, 0 )>>,"Clasvhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosClasvhasta ) + "'">>,"Diama" = <<iif( lxDescuentosDiama, 1, 0 )>>,"Diami" = <<iif( lxDescuentosDiami, 1, 0 )>>,"Diaju" = <<iif( lxDescuentosDiaju, 1, 0 )>>,"Clascdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosClascdesde ) + "'">>,"Diavi" = <<iif( lxDescuentosDiavi, 1, 0 )>>,"Claschasta" = <<"'" + this.FormatearTextoSql( lxDescuentosClaschasta ) + "'">>,"Diasa" = <<iif( lxDescuentosDiasa, 1, 0 )>>,"Tipocdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosTipocdesde ) + "'">>,"Diado" = <<iif( lxDescuentosDiado, 1, 0 )>>,"Tipochasta" = <<"'" + this.FormatearTextoSql( lxDescuentosTipochasta ) + "'">>,"Catecdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosCatecdesde ) + "'">>,"Catechasta" = <<"'" + this.FormatearTextoSql( lxDescuentosCatechasta ) + "'">>,"Tobs" = <<"'" + this.FormatearTextoSql( lxDescuentosTobs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxDescuentosCodigo ) + "'">> and  DESCUENTOS.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Inactivofw" as "Inactivofw", "Codigo" as "Codigo", "Des" as "Descripcion", "Func" as "Modofuncionamiento", "Mondes" as "Montodesde", "Intera" as "Interaccion", "Monhas" as "Montohasta", "Orden" as "Orden", "Monto" as "Monto", "Porcdes" as "Porcentaje", "Fecdes" as "Fechadesde", "Montomax" as "Montomax", "Fechas" as "Fechahasta", "Porcmax" as "Porcentajemax", "Hordes" as "Horadesde", "Horhas" as "Horahasta", "Cantdes" as "Cantidaddesde", "Canthas" as "Cantidadhasta", "Perfdesde" as "Perfildesde", "Perfhasta" as "Perfilhasta", "Listdesde" as "Listadesde", "Listhasta" as "Listahasta", "Venddesde" as "Venddesde", "Vendhasta" as "Vendhasta", "Clasvdesde" as "Vendedor_clasificacionvdesde", "Dialu" as "Dialu", "Clasvhasta" as "Vendedor_clasificacionvhasta", "Diama" as "Diama", "Diami" as "Diami", "Diaju" as "Diaju", "Clascdesde" as "Cliente_clasificacioncdesde", "Diavi" as "Diavi", "Claschasta" as "Cliente_clasificacionchasta", "Diasa" as "Diasa", "Tipocdesde" as "Cliente_tipocdesde", "Diado" as "Diado", "Tipochasta" as "Cliente_tipochasta", "Catecdesde" as "Cliente_categoriacdesde", "Catechasta" as "Cliente_categoriachasta", "Tobs" as "Obs" from ZooLogic.DESCUENTOS where "Codigo" = <<"'" + this.FormatearTextoSql( lxDescuentosCodigo ) + "'">> and  DESCUENTOS.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Inactivofw" as "Inactivofw", "Codigo" as "Codigo", "Des" as "Descripcion", "Func" as "Modofuncionamiento", "Mondes" as "Montodesde", "Intera" as "Interaccion", "Monhas" as "Montohasta", "Orden" as "Orden", "Monto" as "Monto", "Porcdes" as "Porcentaje", "Fecdes" as "Fechadesde", "Montomax" as "Montomax", "Fechas" as "Fechahasta", "Porcmax" as "Porcentajemax", "Hordes" as "Horadesde", "Horhas" as "Horahasta", "Cantdes" as "Cantidaddesde", "Canthas" as "Cantidadhasta", "Perfdesde" as "Perfildesde", "Perfhasta" as "Perfilhasta", "Listdesde" as "Listadesde", "Listhasta" as "Listahasta", "Venddesde" as "Venddesde", "Vendhasta" as "Vendhasta", "Clasvdesde" as "Vendedor_clasificacionvdesde", "Dialu" as "Dialu", "Clasvhasta" as "Vendedor_clasificacionvhasta", "Diama" as "Diama", "Diami" as "Diami", "Diaju" as "Diaju", "Clascdesde" as "Cliente_clasificacioncdesde", "Diavi" as "Diavi", "Claschasta" as "Cliente_clasificacionchasta", "Diasa" as "Diasa", "Tipocdesde" as "Cliente_tipocdesde", "Diado" as "Diado", "Tipochasta" as "Cliente_tipochasta", "Catecdesde" as "Cliente_categoriacdesde", "Catechasta" as "Cliente_categoriachasta", "Tobs" as "Obs" from ZooLogic.DESCUENTOS where  DESCUENTOS.CODIGO != '' order by codigo
			endtext
			use in select('c_DESCUENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCUENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Inactivofw" as "Inactivofw", "Codigo" as "Codigo", "Des" as "Descripcion", "Func" as "Modofuncionamiento", "Mondes" as "Montodesde", "Intera" as "Interaccion", "Monhas" as "Montohasta", "Orden" as "Orden", "Monto" as "Monto", "Porcdes" as "Porcentaje", "Fecdes" as "Fechadesde", "Montomax" as "Montomax", "Fechas" as "Fechahasta", "Porcmax" as "Porcentajemax", "Hordes" as "Horadesde", "Horhas" as "Horahasta", "Cantdes" as "Cantidaddesde", "Canthas" as "Cantidadhasta", "Perfdesde" as "Perfildesde", "Perfhasta" as "Perfilhasta", "Listdesde" as "Listadesde", "Listhasta" as "Listahasta", "Venddesde" as "Venddesde", "Vendhasta" as "Vendhasta", "Clasvdesde" as "Vendedor_clasificacionvdesde", "Dialu" as "Dialu", "Clasvhasta" as "Vendedor_clasificacionvhasta", "Diama" as "Diama", "Diami" as "Diami", "Diaju" as "Diaju", "Clascdesde" as "Cliente_clasificacioncdesde", "Diavi" as "Diavi", "Claschasta" as "Cliente_clasificacionchasta", "Diasa" as "Diasa", "Tipocdesde" as "Cliente_tipocdesde", "Diado" as "Diado", "Tipochasta" as "Cliente_tipochasta", "Catecdesde" as "Cliente_categoriacdesde", "Catechasta" as "Cliente_categoriachasta", "Tobs" as "Obs" from ZooLogic.DESCUENTOS where  funciones.padr( codigo, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  DESCUENTOS.CODIGO != '' order by codigo
			endtext
			use in select('c_DESCUENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCUENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Inactivofw" as "Inactivofw", "Codigo" as "Codigo", "Des" as "Descripcion", "Func" as "Modofuncionamiento", "Mondes" as "Montodesde", "Intera" as "Interaccion", "Monhas" as "Montohasta", "Orden" as "Orden", "Monto" as "Monto", "Porcdes" as "Porcentaje", "Fecdes" as "Fechadesde", "Montomax" as "Montomax", "Fechas" as "Fechahasta", "Porcmax" as "Porcentajemax", "Hordes" as "Horadesde", "Horhas" as "Horahasta", "Cantdes" as "Cantidaddesde", "Canthas" as "Cantidadhasta", "Perfdesde" as "Perfildesde", "Perfhasta" as "Perfilhasta", "Listdesde" as "Listadesde", "Listhasta" as "Listahasta", "Venddesde" as "Venddesde", "Vendhasta" as "Vendhasta", "Clasvdesde" as "Vendedor_clasificacionvdesde", "Dialu" as "Dialu", "Clasvhasta" as "Vendedor_clasificacionvhasta", "Diama" as "Diama", "Diami" as "Diami", "Diaju" as "Diaju", "Clascdesde" as "Cliente_clasificacioncdesde", "Diavi" as "Diavi", "Claschasta" as "Cliente_clasificacionchasta", "Diasa" as "Diasa", "Tipocdesde" as "Cliente_tipocdesde", "Diado" as "Diado", "Tipochasta" as "Cliente_tipochasta", "Catecdesde" as "Cliente_categoriacdesde", "Catechasta" as "Cliente_categoriachasta", "Tobs" as "Obs" from ZooLogic.DESCUENTOS where  funciones.padr( codigo, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  DESCUENTOS.CODIGO != '' order by codigo desc
			endtext
			use in select('c_DESCUENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCUENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Inactivofw" as "Inactivofw", "Codigo" as "Codigo", "Des" as "Descripcion", "Func" as "Modofuncionamiento", "Mondes" as "Montodesde", "Intera" as "Interaccion", "Monhas" as "Montohasta", "Orden" as "Orden", "Monto" as "Monto", "Porcdes" as "Porcentaje", "Fecdes" as "Fechadesde", "Montomax" as "Montomax", "Fechas" as "Fechahasta", "Porcmax" as "Porcentajemax", "Hordes" as "Horadesde", "Horhas" as "Horahasta", "Cantdes" as "Cantidaddesde", "Canthas" as "Cantidadhasta", "Perfdesde" as "Perfildesde", "Perfhasta" as "Perfilhasta", "Listdesde" as "Listadesde", "Listhasta" as "Listahasta", "Venddesde" as "Venddesde", "Vendhasta" as "Vendhasta", "Clasvdesde" as "Vendedor_clasificacionvdesde", "Dialu" as "Dialu", "Clasvhasta" as "Vendedor_clasificacionvhasta", "Diama" as "Diama", "Diami" as "Diami", "Diaju" as "Diaju", "Clascdesde" as "Cliente_clasificacioncdesde", "Diavi" as "Diavi", "Claschasta" as "Cliente_clasificacionchasta", "Diasa" as "Diasa", "Tipocdesde" as "Cliente_tipocdesde", "Diado" as "Diado", "Tipochasta" as "Cliente_tipochasta", "Catecdesde" as "Cliente_categoriacdesde", "Catechasta" as "Cliente_categoriachasta", "Tobs" as "Obs" from ZooLogic.DESCUENTOS where  DESCUENTOS.CODIGO != '' order by codigo desc
			endtext
			use in select('c_DESCUENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCUENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fmodifw,Fectrans,Fecexpo,Faltafw,Saltafw,Smodifw,Ualtafw,Horaimpo,Haltafw,Esttrans,H" + ;
"oraexpo,Hmodifw,Umodifw,Bdaltafw,Valtafw,Descfw,Bdmodifw,Vmodifw,Zadsfw,Tipagrupub,Timestamp,Inactiv" + ;
"ofw,Codigo,Des,Func,Mondes,Intera,Monhas,Orden,Monto,Porcdes,Fecdes,Montomax,Fechas,Porcmax,Hordes,H" + ;
"orhas,Cantdes,Canthas,Perfdesde,Perfhasta,Listdesde,Listhasta,Venddesde,Vendhasta,Clasvdesde,Dialu,C" + ;
"lasvhasta,Diama,Diami,Diaju,Clascdesde,Diavi,Claschasta,Diasa,Tipocdesde,Diado,Tipochasta,Catecdesde" + ;
",Catechasta,Tobs" + ;
	...
	Function ObtenerCamposSelectEntidad( tcCampos As String ) As String
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			...
			Do Case
				...
				Case lcAtributo == 'VENDEDOR_CLASIFICACIONVDESDE'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'CLASVDESDE AS VENDEDOR_CLASIFICACIONVDESDE'
				Case lcAtributo == 'DIALU'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'DIALU AS DIALU'
				Case lcAtributo == 'VENDEDOR_CLASIFICACIONVHASTA'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'CLASVHASTA AS VENDEDOR_CLASIFICACIONVHASTA'
	...
	Function ObtenerCampoEntidad( tcAtributo As String ) As String
		...
		Do Case
			...
			Case upper( alltrim( tcAtributo ) ) == 'VENDHASTA'
				lcCampo = 'VENDHASTA'
			Case upper( alltrim( tcAtributo ) ) == 'VENDEDOR_CLASIFICACIONVDESDE'
				lcCampo = 'CLASVDESDE'
			Case upper( alltrim( tcAtributo ) ) == 'DIALU'
				lcCampo = 'DIALU'
			Case upper( alltrim( tcAtributo ) ) == 'VENDEDOR_CLASIFICACIONVHASTA'
				lcCampo = 'CLASVHASTA'
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.DESCUENTOS set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDescuentosFecimpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxDescuentosFmodifw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxDescuentosFectrans ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxDescuentosFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxDescuentosFaltafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxDescuentosSaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosSmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxDescuentosUaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxDescuentosHoraimpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxDescuentosHaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxDescuentosEsttrans ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxDescuentosHoraexpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosHmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosUmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDescuentosBdaltafw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxDescuentosValtafw ) + "'">>, "Descfw" = <<"'" + this.FormatearTextoSql( lxDescuentosDescfw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosBdmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxDescuentosVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxDescuentosZadsfw ) + "'">>, "Tipagrupub" = <<lxDescuentosTipagrupub>>, "Timestamp" = <<lxDescuentosTimestamp>>, "Inactivofw" = <<iif( lxDescuentosInactivofw, 1, 0 )>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxDescuentosCodigo ) + "'">>, "Des" = <<"'" + this.FormatearTextoSql( lxDescuentosDes ) + "'">>, "Func" = <<lxDescuentosFunc>>, "Mondes" = <<lxDescuentosMondes>>, "Intera" = <<lxDescuentosIntera>>, "Monhas" = <<lxDescuentosMonhas>>, "Orden" = <<lxDescuentosOrden>>, "Monto" = <<lxDescuentosMonto>>, "Porcdes" = <<lxDescuentosPorcdes>>, "Fecdes" = <<"'" + this.ConvertirDateSql( lxDescuentosFecdes ) + "'">>, "Montomax" = <<lxDescuentosMontomax>>, "Fechas" = <<"'" + this.ConvertirDateSql( lxDescuentosFechas ) + "'">>, "Porcmax" = <<lxDescuentosPorcmax>>, "Hordes" = <<"'" + this.FormatearTextoSql( lxDescuentosHordes ) + "'">>, "Horhas" = <<"'" + this.FormatearTextoSql( lxDescuentosHorhas ) + "'">>, "Cantdes" = <<lxDescuentosCantdes>>, "Canthas" = <<lxDescuentosCanthas>>, "Perfdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosPerfdesde ) + "'">>, "Perfhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosPerfhasta ) + "'">>, "Listdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosListdesde ) + "'">>, "Listhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosListhasta ) + "'">>, "Venddesde" = <<"'" + this.FormatearTextoSql( lxDescuentosVenddesde ) + "'">>, "Vendhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosVendhasta ) + "'">>, "Clasvdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosClasvdesde ) + "'">>, "Dialu" = <<iif( lxDescuentosDialu, 1, 0 )>>, "Clasvhasta" = <<"'" + this.FormatearTextoSql( lxDescuentosClasvhasta ) + "'">>, "Diama" = <<iif( lxDescuentosDiama, 1, 0 )>>, "Diami" = <<iif( lxDescuentosDiami, 1, 0 )>>, "Diaju" = <<iif( lxDescuentosDiaju, 1, 0 )>>, "Clascdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosClascdesde ) + "'">>, "Diavi" = <<iif( lxDescuentosDiavi, 1, 0 )>>, "Claschasta" = <<"'" + this.FormatearTextoSql( lxDescuentosClaschasta ) + "'">>, "Diasa" = <<iif( lxDescuentosDiasa, 1, 0 )>>, "Tipocdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosTipocdesde ) + "'">>, "Diado" = <<iif( lxDescuentosDiado, 1, 0 )>>, "Tipochasta" = <<"'" + this.FormatearTextoSql( lxDescuentosTipochasta ) + "'">>, "Catecdesde" = <<"'" + this.FormatearTextoSql( lxDescuentosCatecdesde ) + "'">>, "Catechasta" = <<"'" + this.FormatearTextoSql( lxDescuentosCatechasta ) + "'">>, "Tobs" = <<"'" + this.FormatearTextoSql( lxDescuentosTobs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'DESCUENTOS' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		If llInsertarAuditoria
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.DESCUENTOS set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, InactivoFW = ] + Transform( iif( &lcCursor..InactivoFW, 1, 0 ))+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"+ [, Des = ] + "'" + this.FormatearTextoSql( &lcCursor..Des ) + "'"+ [, func = ] + transform( &lcCursor..func )+ [, mondes = ] + transform( &lcCursor..mondes )+ [, intera = ] + transform( &lcCursor..intera )+ [, monhas = ] + transform( &lcCursor..monhas )+ [, orden = ] + transform( &lcCursor..orden )+ [, monto = ] + transform( &lcCursor..monto )+ [, Porcdes = ] + transform( &lcCursor..Porcdes )+ [, fecdes = ] + "'" + this.ConvertirDateSql( &lcCursor..fecdes ) + "'"+ [, montomax = ] + transform( &lcCursor..montomax )+ [, fechas = ] + "'" + this.ConvertirDateSql( &lcCursor..fechas ) + "'"+ [, Porcmax = ] + transform( &lcCursor..Porcmax )+ [, hordes = ] + "'" + this.FormatearTextoSql( &lcCursor..hordes ) + "'"+ [, horhas = ] + "'" + this.FormatearTextoSql( &lcCursor..horhas ) + "'"+ [, cantdes = ] + transform( &lcCursor..cantdes )+ [, canthas = ] + transform( &lcCursor..canthas )+ [, perfdesde = ] + "'" + this.FormatearTextoSql( &lcCursor..perfdesde ) + "'"+ [, perfhasta = ] + "'" + this.FormatearTextoSql( &lcCursor..perfhasta ) + "'"+ [, ListDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..ListDesde ) + "'"+ [, ListHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..ListHasta ) + "'"+ [, VendDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..VendDesde ) + "'"+ [, VendHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..VendHasta ) + "'"+ [, ClasvDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..ClasvDesde ) + "'"+ [, DiaLu = ] + Transform( iif( &lcCursor..DiaLu, 1, 0 ))+ [, ClasvHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..ClasvHasta ) + "'"+ [, DiaMa = ] + Transform( iif( &lcCursor..DiaMa, 1, 0 ))+ [, DiaMi = ] + Transform( iif( &lcCursor..DiaMi, 1, 0 ))+ [, DiaJu = ] + Transform( iif( &lcCursor..DiaJu, 1, 0 ))+ [, ClascDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..ClascDesde ) + "'"+ [, DiaVi = ] + Transform( iif( &lcCursor..DiaVi, 1, 0 ))+ [, ClascHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..ClascHasta ) + "'"+ [, DiaSa = ] + Transform( iif( &lcCursor..DiaSa, 1, 0 ))+ [, TipocDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..TipocDesde ) + "'"+ [, DiaDo = ] + Transform( iif( &lcCursor..DiaDo, 1, 0 ))+ [, TipocHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..TipocHasta ) + "'"+ [, CatecDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..CatecDesde ) + "'"+ [, CatecHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..CatecHasta ) + "'"+ [, TObs = ] + "'" + this.FormatearTextoSql( &lcCursor..TObs ) + "'" + [ Where codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FMODIFW, FECTRANS, FECEXPO, FALTAFW, SALTAFW, SMODIFW, UALTAFW, HORAIMPO, HALTAFW, ESTTRANS, HORAEXPO, HMODIFW, UMODIFW, BDALTAFW, VALTAFW, DescFW, BDMODIFW, VMODIFW, ZADSFW, tipagrupub, TIMESTAMP, InactivoFW, codigo, Des, func, mondes, intera, monhas, orden, monto, Porcdes, fecdes, montomax, fechas, Porcmax, hordes, horhas, cantdes, canthas, perfdesde, perfhasta, ListDesde, ListHasta, VendDesde, VendHasta, ClasvDesde, DiaLu, ClasvHasta, DiaMa, DiaMi, DiaJu, ClascDesde, DiaVi, ClascHasta, DiaSa, TipocDesde, DiaDo, TipocHasta, CatecDesde, CatecHasta, TObs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + transform( &lcCursor..tipagrupub )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..InactivoFW, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Des ) + "'" + ',' + transform( &lcCursor..func ) + ',' + transform( &lcCursor..mondes ) + ',' + transform( &lcCursor..intera ) + ',' + transform( &lcCursor..monhas ) + ',' + transform( &lcCursor..orden )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..monto ) + ',' + transform( &lcCursor..Porcdes ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..fecdes ) + "'" + ',' + transform( &lcCursor..montomax ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..fechas ) + "'" + ',' + transform( &lcCursor..Porcmax ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..hordes ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..horhas ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..cantdes ) + ',' + transform( &lcCursor..canthas ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..perfdesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..perfhasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ListDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ListHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VendDesde ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VendHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClasvDesde ) + "'" + ',' + Transform( iif( &lcCursor..DiaLu, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClasvHasta ) + "'" + ',' + Transform( iif( &lcCursor..DiaMa, 1, 0 )) + ',' + Transform( iif( &lcCursor..DiaMi, 1, 0 )) + ',' + Transform( iif( &lcCursor..DiaJu, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClascDesde ) + "'" + ',' + Transform( iif( &lcCursor..DiaVi, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClascHasta ) + "'" + ',' + Transform( iif( &lcCursor..DiaSa, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..TipocDesde ) + "'" + ',' + Transform( iif( &lcCursor..DiaDo, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..TipocHasta ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CatecDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CatecHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TObs ) + "'"
...
"mondes" numeric( 15, 2 )  null, 
"intera" numeric( 1, 0 )  null, 
"monhas" numeric( 15, 2 )  null, 
...
"venddesde" char( 10 )  null, 
"vendhasta" char( 10 )  null, 
"clasvdesde" char( 10 )  null, 
"dialu" bit  null, 
"clasvhasta" char( 10 )  null, 
"diama" bit  null, 
"diami" bit  null, 
"diaju" bit  null, 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function CargarTablaDeTrabajo( toConexion as Object ) as void
		...
		with loManejador
			...
			.AgregarMapeo('clasvdesde','clasvdesde')
			.AgregarMapeo('dialu','dialu')
			.AgregarMapeo('clasvhasta','clasvhasta')
	...
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			Begin
				...
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.INACTIVOFW = isnull( d.INACTIVOFW, t.INACTIVOFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DES = isnull( d.DES, t.DES ),t.FUNC = isnull( d.FUNC, t.FUNC ),t.MONDES = isnull( d.MONDES, t.MONDES ),t.INTERA = isnull( d.INTERA, t.INTERA ),t.MONHAS = isnull( d.MONHAS, t.MONHAS ),t.ORDEN = isnull( d.ORDEN, t.ORDEN ),t.MONTO = isnull( d.MONTO, t.MONTO ),t.PORCDES = isnull( d.PORCDES, t.PORCDES ),t.FECDES = isnull( d.FECDES, t.FECDES ),t.MONTOMAX = isnull( d.MONTOMAX, t.MONTOMAX ),t.FECHAS = isnull( d.FECHAS, t.FECHAS ),t.PORCMAX = isnull( d.PORCMAX, t.PORCMAX ),t.HORDES = isnull( d.HORDES, t.HORDES ),t.HORHAS = isnull( d.HORHAS, t.HORHAS ),t.CANTDES = isnull( d.CANTDES, t.CANTDES ),t.CANTHAS = isnull( d.CANTHAS, t.CANTHAS ),t.PERFDESDE = isnull( d.PERFDESDE, t.PERFDESDE ),t.PERFHASTA = isnull( d.PERFHASTA, t.PERFHASTA ),t.LISTDESDE = isnull( d.LISTDESDE, t.LISTDESDE ),t.LISTHASTA = isnull( d.LISTHASTA, t.LISTHASTA ),t.VENDDESDE = isnull( d.VENDDESDE, t.VENDDESDE ),t.VENDHASTA = isnull( d.VENDHASTA, t.VENDHASTA ),t.CLASVDESDE = isnull( d.CLASVDESDE, t.CLASVDESDE ),t.DIALU = isnull( d.DIALU, t.DIALU ),t.CLASVHASTA = isnull( d.CLASVHASTA, t.CLASVHASTA ),t.DIAMA = isnull( d.DIAMA, t.DIAMA ),t.DIAMI = isnull( d.DIAMI, t.DIAMI ),t.DIAJU = isnull( d.DIAJU, t.DIAJU ),t.CLASCDESDE = isnull( d.CLASCDESDE, t.CLASCDESDE ),t.DIAVI = isnull( d.DIAVI, t.DIAVI ),t.CLASCHASTA = isnull( d.CLASCHASTA, t.CLASCHASTA ),t.DIASA = isnull( d.DIASA, t.DIASA ),t.TIPOCDESDE = isnull( d.TIPOCDESDE, t.TIPOCDESDE ),t.DIADO = isnull( d.DIADO, t.DIADO ),t.TIPOCHASTA = isnull( d.TIPOCHASTA, t.TIPOCHASTA ),t.CATECDESDE = isnull( d.CATECDESDE, t.CATECDESDE ),t.CATECHASTA = isnull( d.CATECHASTA, t.CATECHASTA ),t.TOBS = isnull( d.TOBS, t.TOBS )
					from ZooLogic.DESCUENTOS t inner join deleted d 
							 on t.codigo = d.codigo
				-- Fin Updates
				insert into ZooLogic.ADT_DESCUENTOS ( "ADT_Cod","ADT_Fecha","ADT_Hora","ADT_Serie","ADT_Usr","ADT_Ent","ADT_Comp","ADT_ADN","ADT_Vers","ADT_Ext","codigo","Inactivofw" ) 
				...
				insert into ZooLogic.DESCUENTOS(Fecimpo,Fmodifw,Fectrans,Fecexpo,Faltafw,Saltafw,Smodifw,Ualtafw,Horaimpo,Haltafw,Esttrans,Horaexpo,Hmodifw,Umodifw,Bdaltafw,Valtafw,Descfw,Bdmodifw,Vmodifw,Zadsfw,Tipagrupub,Timestamp,Inactivofw,Codigo,Des,Func,Mondes,Intera,Monhas,Orden,Monto,Porcdes,Fecdes,Montomax,Fechas,Porcmax,Hordes,Horhas,Cantdes,Canthas,Perfdesde,Perfhasta,Listdesde,Listhasta,Venddesde,Vendhasta,Clasvdesde,Dialu,Clasvhasta,Diama,Diami,Diaju,Clascdesde,Diavi,Claschasta,Diasa,Tipocdesde,Diado,Tipochasta,Catecdesde,Catechasta,Tobs)
					Select isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.VALTAFW,''),isnull( d.DESCFW,''),isnull( d.BDMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.TIPAGRUPUB,0),isnull( d.TIMESTAMP,0),isnull( d.INACTIVOFW,0),isnull( d.CODIGO,''),isnull( d.DES,''),isnull( d.FUNC,0),isnull( d.MONDES,0),isnull( d.INTERA,0),isnull( d.MONHAS,0),isnull( d.ORDEN,0),isnull( d.MONTO,0),isnull( d.PORCDES,0),isnull( d.FECDES,''),isnull( d.MONTOMAX,0),isnull( d.FECHAS,''),isnull( d.PORCMAX,0),isnull( d.HORDES,''),isnull( d.HORHAS,''),isnull( d.CANTDES,0),isnull( d.CANTHAS,0),isnull( d.PERFDESDE,''),isnull( d.PERFHASTA,''),isnull( d.LISTDESDE,''),isnull( d.LISTHASTA,''),isnull( d.VENDDESDE,''),isnull( d.VENDHASTA,''),isnull( d.CLASVDESDE,''),isnull( d.DIALU,0),isnull( d.CLASVHASTA,''),isnull( d.DIAMA,0),isnull( d.DIAMI,0),isnull( d.DIAJU,0),isnull( d.CLASCDESDE,''),isnull( d.DIAVI,0),isnull( d.CLASCHASTA,''),isnull( d.DIASA,0),isnull( d.TIPOCDESDE,''),isnull( d.DIADO,0),isnull( d.TIPOCHASTA,''),isnull( d.CATECDESDE,''),isnull( d.CATECHASTA,''),isnull( d.TOBS,'')
						From deleted d left join ZooLogic.DESCUENTOS pk 
							 on d.codigo = pk.codigo
						Where pk.codigo Is Null 
				-- Fin Inserts
		...
		with this.oEntidad
			...
			if reccount( 'c_DESCUENTO' ) < 1
				...
				Try
					...
					.Vendedor_clasificacionvdesde_PK =  nvl( c_DESCUENTO.Vendedor_clasificacionvdesde, [] )
					.Dialu = nvl( c_DESCUENTO.Dialu, .F. )
					.Vendedor_clasificacionvhasta_PK =  nvl( c_DESCUENTO.Vendedor_clasificacionvhasta, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="DESCUENTO                               " atributo="FECHATRANSFERENCIA                      " tabla="DESCUENTOS     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCUENTO                               " atributo="ESTADOTRANSFERENCIA                     " tabla="DESCUENTOS     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCUENTO                               " atributo="DESCRIPCION                             " tabla="DESCUENTOS     " campo="DES       " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="MODOFUNCIONAMIENTO                      " tabla="DESCUENTOS     " campo="FUNC      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="1                                                                                                                                                                                                                                                             " obligatorio="true" admitebusqueda="404" etiqueta="Modo funcionamiento                                                                                                                                             " dominio="COMBO                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="MONTODESDE                              " tabla="DESCUENTOS     " campo="MONDES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="0                                                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="406" etiqueta="Monto desde                                                                                                                                                     " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="12" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCUENTO                               " atributo="MONTOHASTA                              " tabla="DESCUENTOS     " campo="MONHAS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="999999999999.99                                                                                                                                                                                                                                               " obligatorio="false" admitebusqueda="408" etiqueta="Monto hasta                                                                                                                                                     " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="12" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="ORDEN                                   " tabla="DESCUENTOS     " campo="ORDEN     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Importancia                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="MONTO                                   " tabla="DESCUENTOS     " campo="MONTO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Monto sugerido                                                                                                                                                  " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="PORCENTAJE                              " tabla="DESCUENTOS     " campo="PORCDES   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="7" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Porcentaje sugerido                                                                                                                                             " dominio="NUMERICOCONSIGNO              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="ESPACIOBLANCO                           " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Vacío                                                                                                                                                           " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="FECHADESDE                              " tabla="DESCUENTOS     " campo="FECDES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Fecha desde                                                                                                                                                     " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="14" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="MONTOMAX                                " tabla="DESCUENTOS     " campo="MONTOMAX  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Monto máximo                                                                                                                                                    " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="FECHAHASTA                              " tabla="DESCUENTOS     " campo="FECHAS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Fecha hasta                                                                                                                                                     " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="14" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="PORCENTAJEMAX                           " tabla="DESCUENTOS     " campo="PORCMAX   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="7" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="Porcentaje máximo                                                                                                                                               " dominio="NUMERICOCONSIGNO              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="HORADESDE                               " tabla="DESCUENTOS     " campo="HORDES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="00:00                                                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="426" etiqueta="Hora desde                                                                                                                                                      " dominio="EtiquetaHoraDesdeHasta        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="15" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="HORAHASTA                               " tabla="DESCUENTOS     " campo="HORHAS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="23:59                                                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="428" etiqueta="Hora hasta                                                                                                                                                      " dominio="EtiquetaHoraDesdeHasta        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="15" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="CANTIDADDESDE                           " tabla="DESCUENTOS     " campo="CANTDES   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="0" valorsugerido="0                                                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="430" etiqueta="Cantidad Desde                                                                                                                                                  " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="13" orden="11" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="CANTIDADHASTA                           " tabla="DESCUENTOS     " campo="CANTHAS   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="0" valorsugerido="9999999999                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="432" etiqueta="Cantidad Hasta                                                                                                                                                  " dominio="EtiquetaNumericoDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="13" orden="12" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="PERFILDESDE                             " tabla="DESCUENTOS     " campo="PERFDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="434" etiqueta="Perfil desde                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="20" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="PERFILHASTA                             " tabla="DESCUENTOS     " campo="PERFHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="=Replicate( &quot;Z&quot;,30)                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="436" etiqueta="Perfil hasta                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="20" orden="21" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="LISTADESDE                              " tabla="DESCUENTOS     " campo="LISTDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="LISTADEPRECIOS                          " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="438" etiqueta="Lista desde                                                                                                                                                     " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="21" orden="22" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="LISTAHASTA                              " tabla="DESCUENTOS     " campo="LISTHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="LISTADEPRECIOS                          " tipodato="C         " longitud="6" decimales="0" valorsugerido="=Replicate( &quot;Z&quot;,6)                                                                                                                                                                                                                                            " obligatorio="false" admitebusqueda="440" etiqueta="Lista Hasta                                                                                                                                                     " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="21" orden="23" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="VENDDESDE                               " tabla="DESCUENTOS     " campo="VENDDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="Vendedor desde                                                                                                                                                  " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="22" orden="24" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="VENDHASTA                               " tabla="DESCUENTOS     " campo="VENDHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="=Replicate( &quot;Z&quot;,10)                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="444" etiqueta="Vendedor hasta                                                                                                                                                  " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="22" orden="25" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCUENTO                               " atributo="VENDEDOR_CLASIFICACIONVDESDE            " tabla="DESCUENTOS     " campo="CLASVDESDE" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLASIFICACIONVENDEDOR                   " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="446" etiqueta="Clasificación vendedor desde                                                                                                                                    " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="23" orden="26" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VENDEDOR                                " atributo="NOMBRE                                  " tabla="VEN            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="443" etiqueta="Detalle Ven.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join VEN On DESCUENTOS.VENDDESDE = VEN.CLCOD And  VEN.CLCOD != ''                                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLASIFICACIONVENDEDOR                   " atributo="DESCRIPCION                             " tabla="CLASVEND       " campo="CLADES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="447" etiqueta="Detalle Cla.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLASVEND On DESCUENTOS.CLASVDESDE = CLASVEND.CLACOD And  CLASVEND.CLACOD != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLASIFICACIONVENDEDOR                   " atributo="DESCRIPCION                             " tabla="CLASVEND       " campo="CLADES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="451" etiqueta="Detalle Cla.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLASVEND On DESCUENTOS.CLASVHASTA = CLASVEND.CLACOD And  CLASVEND.CLACOD != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLASIFICACIONCLIENTE                    " atributo="DESCRIPCION                             " tabla="CLASIF         " campo="CLADES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="459" etiqueta="Detalle Cla.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLASIF On DESCUENTOS.CLASCDESDE = CLASIF.CLACOD And  CLASIF.CLACOD != ''                                                                                                                                                                           " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLASIFICACIONCLIENTE                    " atributo="DESCRIPCION                             " tabla="CLASIF         " campo="CLADES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="463" etiqueta="Detalle Cla.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLASIF On DESCUENTOS.CLASCHASTA = CLASIF.CLACOD And  CLASIF.CLACOD != ''                                                                                                                                                                           " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOCLIENTE                             " atributo="DESCRIPCION                             " tabla="TIPOCLI        " campo="TCDES     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="467" etiqueta="Detalle Tip.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join TIPOCLI On DESCUENTOS.TIPOCDESDE = TIPOCLI.TCCOD And  TIPOCLI.TCCOD != ''                                                                                                                                                                          " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOCLIENTE                             " atributo="DESCRIPCION                             " tabla="TIPOCLI        " campo="TCDES     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="471" etiqueta="Detalle Tip.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join TIPOCLI On DESCUENTOS.TIPOCHASTA = TIPOCLI.TCCOD And  TIPOCLI.TCCOD != ''                                                                                                                                                                          " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CATEGORIACLIENTE                        " atributo="DESCRIPCION                             " tabla="CATCLI         " campo="CGDES     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="475" etiqueta="Detalle Cat.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CATCLI On DESCUENTOS.CATECHASTA = CATCLI.CGCod And  CATCLI.CGCOD != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
