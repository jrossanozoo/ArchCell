...
define class Mock_Itemconciliacionesdetallemovimientos as MockBase of MockBase.prg

	cClase = 'Itemconciliacionesdetallemovimientos'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomovimiento() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridomovimiento', lcParametros )
	EndFunc
