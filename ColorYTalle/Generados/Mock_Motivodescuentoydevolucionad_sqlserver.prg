...
define class Mock_Motivodescuentoydevolucionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Motivodescuentoydevolucionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubmdd( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubmdd', lcParametros )
	EndFunc
