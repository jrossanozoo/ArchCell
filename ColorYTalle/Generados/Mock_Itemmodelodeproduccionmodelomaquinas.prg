...
define class Mock_Itemmodelodeproduccionmodelomaquinas as MockBase of MockBase.prg

	cClase = 'Itemmodelodeproduccionmodelomaquinas'
	...
	*-----------------------------------------------------------------------------------------
	function maquina_access() as variant                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Maquina_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function maquina_pk_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Maquina_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function maquinadetalle_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Maquinadetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_maquina( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_maquina', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_maquinadetalle( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_maquinadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tiempo( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_tiempo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tiempo_assign( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Tiempo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_maquina( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_maquina', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_maquinadetalle( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_maquinadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tiempo( txval as variant ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_tiempo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomaquina() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridomaquina', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomaquinadetalle() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridomaquinadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotiempo() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridotiempo', lcParametros )
	EndFunc
