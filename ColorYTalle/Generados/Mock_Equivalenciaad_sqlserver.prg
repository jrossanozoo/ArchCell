...
define class Mock_Equivalenciaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Equivalenciaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubcba( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubcba', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validacionbasicaobligatoriofkarticulo( toconexion, lcexpresionmensaje, lcwhere, lccamposlogueo, lcvalueslogueocomunes ) as void                                                                                                                  
		...
		lnParametros = pcount()
		lxParam1 = toconexion
		lxParam2 = lcexpresionmensaje
		lxParam3 = lcwhere
		lxParam4 = lccamposlogueo
		lxParam5 = lcvalueslogueocomunes
		...
		return this.ObtenerResultado( 'Validacionbasicaobligatoriofkarticulo', lcParametros )
	EndFunc
