...
define class Mock_Itemprocesarncpendientepromobancocuponespendientes as MockBase of MockBase.prg

	cClase = 'Itemprocesarncpendientepromobancocuponespendientes'
	...
	*-----------------------------------------------------------------------------------------
	function idajuste_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Idajuste_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seleccion_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Seleccion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idajuste( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_idajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_seleccion( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_seleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idajuste( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_idajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_seleccion( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_seleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoseleccion() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridoseleccion', lcParametros )
	EndFunc
