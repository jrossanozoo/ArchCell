...
define class Mock_Itemcomprobantederetencionessusscomprobantesdetalle as MockBase of MockBase.prg

	cClase = 'Itemcomprobantederetencionessusscomprobantesdetalle'
