...
define class Mock_Detallemercaderiaentransitomovimientodetalle as MockBase of MockBase.prg

	cClase = 'Detallemercaderiaentransitomovimientodetalle'
	...
	cCopiadorDeDetalle = "CopiadorDeDetallesArticulosMovStock"                                                                                                                                                                                                
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Artículos'                                                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function eventoverificarcontexto() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoverificarcontexto', lcParametros )
	EndFunc
