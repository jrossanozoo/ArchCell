...
define class Mock_Ajustechequerechazadoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Ajustechequerechazadoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubajr( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubajr', lcParametros )
	EndFunc
