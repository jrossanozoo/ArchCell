...
define class Mock_Itemagrupalistadospersonalizadosreferencias as MockBase of MockBase.prg

	cClase = 'Itemagrupalistadospersonalizadosreferencias'
	...
	*-----------------------------------------------------------------------------------------
	function accesodirecto_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Accesodirecto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function atributofecha_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Atributofecha_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nombredelaccesodirecto_assign( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Nombredelaccesodirecto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nombrelistado_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Nombrelistado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nombrepersonalizacion_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Nombrepersonalizacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ordenvisual_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Ordenvisual_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function personalizacion_access() as variant                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Personalizacion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function personalizacion_pk_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Personalizacion_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_accesodirecto( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_accesodirecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_atributofecha( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_atributofecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idlistado( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_idlistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nombredelaccesodirecto( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_nombredelaccesodirecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nombrelistado( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_nombrelistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nombrepersonalizacion( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_nombrepersonalizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ordenvisual( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_ordenvisual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_personalizacion( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_personalizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_accesodirecto( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_accesodirecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_atributofecha( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_atributofecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idlistado( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_idlistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nombredelaccesodirecto( txval as variant ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_nombredelaccesodirecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nombrelistado( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_nombrelistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nombrepersonalizacion( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_nombrepersonalizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ordenvisual( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_ordenvisual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_personalizacion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_personalizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoaccesodirecto() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoaccesodirecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoatributofecha() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoatributofecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwactivado() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridofwactivado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoordenvisual() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoordenvisual', lcParametros )
	EndFunc
