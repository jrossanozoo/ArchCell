...
define class Mock_Itemordendeproduccionordencurva as MockBase of MockBase.prg

	cClase = 'Itemordendeproduccionordencurva'
	...
	*-----------------------------------------------------------------------------------------
	function producto_access() as variant                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Producto_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function producto_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Producto_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function productodetalle_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Productodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_producto( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_producto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_productodetalle( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_productodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_producto( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_producto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_productodetalle( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_productodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoproducto() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoproducto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoproductodetalle() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoproductodetalle', lcParametros )
	EndFunc
