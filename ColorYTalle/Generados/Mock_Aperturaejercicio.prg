...
define class Mock_aperturaejercicio as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Apertura de ejercicio"                                                                                                                                                                                                                   
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'APERTURAEJERCICIO'                                                                                                                                                                                                                             
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lWHModificar = .f.                                                                                                                                                                                                                                        
	oAD = null                                                                                                                                                                                                                                                
	oAsiento = null && Se utiliza para dar de alta el nuevo asiento de clase Apertura de ejercicio                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function cargarfechaejercicio( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cargarfechaejercicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaapertura_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'APERTURAEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaapertura_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaapertura_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaapertura		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaapertura( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Fechaapertura( lxVal )			EndIf		Else			This.Setear_Fechaapertura( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciaparaeliminarelasientodeapertura() as zoocoleccion                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciaparaeliminarelasientodeapertura', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenersentenciasasientodeapertura() as object                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciasasientodeapertura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_asiento( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'APERTURAEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_asiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_asiento', lcParametros )			endif		endif		this.Asiento.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaapertura( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'APERTURAEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaapertura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaapertura', lcParametros )			endif		endif		this.Fechaapertura = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_asiento( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'APERTURAEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_asiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_asiento', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaapertura( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'APERTURAEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaapertura', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaapertura', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarasiento() as boolean                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarasiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechaapertura() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechaapertura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoasiento() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoasiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarreferenciadelasientodeaperturacreado( tnnumeroasiento as integer, tcid as string) as string                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tnnumeroasiento
		lxParam2 = tcid
		...
		return this.ObtenerResultado( 'Agregarreferenciadelasientodeaperturacreado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function elejerciciotieneasientodeaperturanoreversado() as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Elejerciciotieneasientodeaperturanoreversado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function haycuentasquenosondetipopatrimonialeimputables() as boolean                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function oasiento_access() as object                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'APERTURAEJERCICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oasiento_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oasiento_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oAsiento ) # "O"			this.oAsiento = _Screen.zoo.InstanciarEntidad( "Asiento" )		endif		return this.oAsiento
	EndFunc
