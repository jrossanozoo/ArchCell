...
define class Din_DetalleCOTIZACIONPRODUCCIONCotizacionordenadicionales as DetalleProduccioncolorytalle of DetalleProduccioncolorytalle.Prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Cotizacionordenadicionales' ) > 0 and reccount( 'c_Cotizacionordenadicionales' ) > 0
					sum Cantidad, Monto;
						 to ;
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'ItemCOTIZACIONPRODUCCIONCotizacionordenadicionales' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Cotizacionordenadicionales
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Cotizacionordenadicionales.Codigo
			loItem.Comportamiento = c_Cotizacionordenadicionales.Comportamiento
			loItem.IdItemArticulo = c_Cotizacionordenadicionales.IdItemArticulo
			loItem.NROITEM = c_Cotizacionordenadicionales.NROITEM
			loItem.Articulo_PK = c_Cotizacionordenadicionales.Articulo
			loItem.ArticuloDetalle = c_Cotizacionordenadicionales.ArticuloDetalle
			loItem.Color_PK = c_Cotizacionordenadicionales.Color
			loItem.ColorDetalle = c_Cotizacionordenadicionales.ColorDetalle
			loItem.Talle_PK = c_Cotizacionordenadicionales.Talle
			loItem.TalleDetalle = c_Cotizacionordenadicionales.TalleDetalle
			loItem.Cantidad = c_Cotizacionordenadicionales.Cantidad
			loItem.Costo = c_Cotizacionordenadicionales.Costo
			loItem.Monto = c_Cotizacionordenadicionales.Monto
			loItem.NroItem = lnI 
