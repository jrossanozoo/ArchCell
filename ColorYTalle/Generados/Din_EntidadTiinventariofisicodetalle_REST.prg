...
define class Din_EntidadTiinventariofisicodetalle_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Tiinventariofisicodetalle"
	cClaseResponse = this.cNamespaceDTOs + ".TiinventariofisicodetalleResponse"
	cClaseModelo = "TiinventariofisicodetalleModelo"
	cEntidad = "Tiinventariofisicodetalle"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicodetalleModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicodetalleListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicodetalleListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TiinventariofisicodetalleModelo"
		endcase
		return lcRetorno
