...
define class Mock_seleccionoperacionecommerce as MockBase of MockBase.prg
	...
	Item_Articulo_Familia_Desde = null                                                                                                                                                                                                                        
	Item_Articulo_Familia_Desde_PK = ""                                                                                                                                                                                                                       
	Item_Articulo_Familia_Hasta = null                                                                                                                                                                                                                        
	Item_Articulo_Familia_Hasta_PK = ""                                                                                                                                                                                                                       
	...
	Item_Articulo_Linea_Desde = null                                                                                                                                                                                                                          
	Item_Articulo_Linea_Desde_PK = ""                                                                                                                                                                                                                         
	Item_Articulo_Linea_Hasta = null                                                                                                                                                                                                                          
	Item_Articulo_Linea_Hasta_PK = ""                                                                                                                                                                                                                         
	...
	Item_Articulo_Temporada_Desde = null                                                                                                                                                                                                                      
	Item_Articulo_Temporada_Desde_PK = ""                                                                                                                                                                                                                     
	Item_Articulo_Temporada_Hasta = null                                                                                                                                                                                                                      
	Item_Articulo_Temporada_Hasta_PK = ""                                                                                                                                                                                                                     
	...
	Item_Talle_Desde = null                                                                                                                                                                                                                                   
	Item_Talle_Desde_PK = ""                                                                                                                                                                                                                                  
	Item_Talle_Hasta = null                                                                                                                                                                                                                                   
	Item_Talle_Hasta_PK = ""                                                                                                                                                                                                                                  
	Observacion = ""                                                                                                                                                                                                                                          
	Plataforma = null                                                                                                                                                                                                                                         
	Plataforma_PK = ""                                                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function item_articulo_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_desde_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_desde.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_desde )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 15, padr( lxVal, 15 ), lxVal )		this.Item_articulo_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_familia_desde_access() as variant                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_familia_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_familia_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_articulo_familia_desde ) = 'O' or isnull( this.Item_articulo_familia_desde ) )					this.Item_articulo_familia_desde = _Screen.zoo.instanciarentidad( 'Familia' )					this.Item_articulo_familia_desde.lEsSubEntidad = .t.					this.enlazar( 'Item_articulo_familia_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_articulo_familia_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_articulo_familia_desde.CODIGO # this.Item_articulo_familia_desde_PK						this.Item_articulo_familia_desde.CODIGO = this.Item_articulo_familia_desde_PK					endif				endif			endif		endif		return this.Item_articulo_familia_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_familia_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_familia_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_familia_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_familia_desde_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_familia_desde.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_familia_desde )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.Item_articulo_familia_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_familia_hasta_access() as variant                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_familia_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_familia_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_articulo_familia_hasta ) = 'O' or isnull( this.Item_articulo_familia_hasta ) )					this.Item_articulo_familia_hasta = _Screen.zoo.instanciarentidad( 'Familia' )					this.Item_articulo_familia_hasta.lEsSubEntidad = .t.					this.enlazar( 'Item_articulo_familia_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_articulo_familia_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_articulo_familia_hasta.CODIGO # this.Item_articulo_familia_hasta_PK						this.Item_articulo_familia_hasta.CODIGO = this.Item_articulo_familia_hasta_PK					endif				endif			endif		endif		return this.Item_articulo_familia_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_familia_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_familia_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_familia_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_familia_hasta_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_familia_hasta.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_familia_hasta )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.Item_articulo_familia_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function item_articulo_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_hasta_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_hasta.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_hasta )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 15, padr( lxVal, 15 ), lxVal )		this.Item_articulo_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_linea_desde_access() as variant                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_linea_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_linea_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_articulo_linea_desde ) = 'O' or isnull( this.Item_articulo_linea_desde ) )					this.Item_articulo_linea_desde = _Screen.zoo.instanciarentidad( 'Linea' )					this.Item_articulo_linea_desde.lEsSubEntidad = .t.					this.enlazar( 'Item_articulo_linea_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_articulo_linea_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_articulo_linea_desde.CODIGO # this.Item_articulo_linea_desde_PK						this.Item_articulo_linea_desde.CODIGO = this.Item_articulo_linea_desde_PK					endif				endif			endif		endif		return this.Item_articulo_linea_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_linea_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_linea_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_linea_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_linea_desde_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_linea_desde.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_linea_desde )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.Item_articulo_linea_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_linea_hasta_access() as variant                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_linea_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_linea_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_articulo_linea_hasta ) = 'O' or isnull( this.Item_articulo_linea_hasta ) )					this.Item_articulo_linea_hasta = _Screen.zoo.instanciarentidad( 'Linea' )					this.Item_articulo_linea_hasta.lEsSubEntidad = .t.					this.enlazar( 'Item_articulo_linea_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_articulo_linea_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_articulo_linea_hasta.CODIGO # this.Item_articulo_linea_hasta_PK						this.Item_articulo_linea_hasta.CODIGO = this.Item_articulo_linea_hasta_PK					endif				endif			endif		endif		return this.Item_articulo_linea_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_linea_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_linea_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_linea_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_linea_hasta_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_linea_hasta.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_linea_hasta )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.Item_articulo_linea_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function item_articulo_temporada_desde_access() as variant                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_temporada_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_temporada_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_articulo_temporada_desde ) = 'O' or isnull( this.Item_articulo_temporada_desde ) )					this.Item_articulo_temporada_desde = _Screen.zoo.instanciarentidad( 'Temporada' )					this.Item_articulo_temporada_desde.lEsSubEntidad = .t.					this.enlazar( 'Item_articulo_temporada_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_articulo_temporada_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_articulo_temporada_desde.CODIGO # this.Item_articulo_temporada_desde_PK						this.Item_articulo_temporada_desde.CODIGO = this.Item_articulo_temporada_desde_PK					endif				endif			endif		endif		return this.Item_articulo_temporada_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_temporada_desde_pk_assign( txval as variant ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_temporada_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_temporada_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_temporada_desde_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_temporada_desde.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_temporada_desde )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Item_articulo_temporada_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_temporada_hasta_access() as variant                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_temporada_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_temporada_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_articulo_temporada_hasta ) = 'O' or isnull( this.Item_articulo_temporada_hasta ) )					this.Item_articulo_temporada_hasta = _Screen.zoo.instanciarentidad( 'Temporada' )					this.Item_articulo_temporada_hasta.lEsSubEntidad = .t.					this.enlazar( 'Item_articulo_temporada_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_articulo_temporada_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_articulo_temporada_hasta.CODIGO # this.Item_articulo_temporada_hasta_PK						this.Item_articulo_temporada_hasta.CODIGO = this.Item_articulo_temporada_hasta_PK					endif				endif			endif		endif		return this.Item_articulo_temporada_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_articulo_temporada_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_articulo_temporada_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_articulo_temporada_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_articulo_temporada_hasta_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_articulo_temporada_hasta.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_articulo_temporada_hasta )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Item_articulo_temporada_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function item_talle_desde_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_talle_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_talle_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_talle_desde ) = 'O' or isnull( this.Item_talle_desde ) )					this.Item_talle_desde = _Screen.zoo.instanciarentidad( 'Talle' )					this.Item_talle_desde.lEsSubEntidad = .t.					this.enlazar( 'Item_talle_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_talle_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_talle_desde.CODIGO # this.Item_talle_desde_PK						this.Item_talle_desde.CODIGO = this.Item_talle_desde_PK					endif				endif			endif		endif		return this.Item_talle_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_talle_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_talle_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_talle_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_talle_desde_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_talle_desde.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_talle_desde )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Item_talle_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_talle_hasta_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_talle_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_talle_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Item_talle_hasta ) = 'O' or isnull( this.Item_talle_hasta ) )					this.Item_talle_hasta = _Screen.zoo.instanciarentidad( 'Talle' )					this.Item_talle_hasta.lEsSubEntidad = .t.					this.enlazar( 'Item_talle_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Item_talle_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Item_talle_hasta.CODIGO # this.Item_talle_hasta_PK						this.Item_talle_hasta.CODIGO = this.Item_talle_hasta_PK					endif				endif			endif		endif		return this.Item_talle_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function item_talle_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'item_talle_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'item_talle_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Item_talle_hasta_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Item_talle_hasta.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Item_talle_hasta )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Item_talle_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_item_articulo_familia_desde( txval as variant ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_articulo_familia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_articulo_familia_desde', lcParametros )			endif		endif		this.Item_articulo_familia_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_item_articulo_familia_hasta( txval as variant ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_articulo_familia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_articulo_familia_hasta', lcParametros )			endif		endif		this.Item_articulo_familia_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_item_articulo_linea_desde( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_articulo_linea_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_articulo_linea_desde', lcParametros )			endif		endif		this.Item_articulo_linea_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_item_articulo_linea_hasta( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_articulo_linea_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_articulo_linea_hasta', lcParametros )			endif		endif		this.Item_articulo_linea_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_item_articulo_temporada_desde( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_articulo_temporada_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_articulo_temporada_desde', lcParametros )			endif		endif		this.Item_articulo_temporada_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_item_articulo_temporada_hasta( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_articulo_temporada_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_articulo_temporada_hasta', lcParametros )			endif		endif		this.Item_articulo_temporada_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_item_talle_desde( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_talle_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_talle_desde', lcParametros )			endif		endif		this.Item_talle_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_item_talle_hasta( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_item_talle_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_item_talle_hasta', lcParametros )			endif		endif		this.Item_talle_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_familia_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_familia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_familia_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_familia_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_familia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_familia_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_linea_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_linea_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_linea_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_linea_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_linea_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_linea_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_proveedor_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_proveedor_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_proveedor_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.Item_articulo_proveedor_desde.oDesactivador.ValidarEstadoActivacion( txVal, txValOld, this.lnuevo, this.ledicion)
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_proveedor_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_proveedor_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_proveedor_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.Item_articulo_proveedor_hasta.oDesactivador.ValidarEstadoActivacion( txVal, txValOld, this.lnuevo, this.ledicion)
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_temporada_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_temporada_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_temporada_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_item_articulo_temporada_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_articulo_temporada_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_articulo_temporada_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_item_talle_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_talle_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_talle_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_item_talle_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONOPERACIONECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_item_talle_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_item_talle_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaritem_articulo_familia_desde() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_articulo_familia_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validaritem_articulo_familia_hasta() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_articulo_familia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaritem_articulo_linea_desde() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_articulo_linea_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validaritem_articulo_linea_hasta() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_articulo_linea_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaritem_articulo_temporada_desde() as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_articulo_temporada_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validaritem_articulo_temporada_hasta() as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_articulo_temporada_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaritem_talle_desde() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_talle_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validaritem_talle_hasta() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritem_talle_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwitem_articulo_familia_hasta() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwitem_articulo_familia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwitem_articulo_linea_hasta() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwitem_articulo_linea_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwitem_articulo_temporada_hasta() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwitem_articulo_temporada_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwitem_talle_hasta() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwitem_talle_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_articulo_familia_desde() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_articulo_familia_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_articulo_familia_hasta() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_articulo_familia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_articulo_linea_desde() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_articulo_linea_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_articulo_linea_hasta() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_articulo_linea_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_articulo_temporada_desde() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_articulo_temporada_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_articulo_temporada_hasta() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_articulo_temporada_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_talle_desde() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_talle_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoitem_talle_hasta() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoitem_talle_hasta', lcParametros )
	EndFunc
