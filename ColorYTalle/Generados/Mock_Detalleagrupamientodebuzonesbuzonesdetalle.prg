...
define class Mock_Detalleagrupamientodebuzonesbuzonesdetalle as MockBase of MockBase.prg

	cClase = 'Detalleagrupamientodebuzonesbuzonesdetalle'
	...
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Buzonesdetalle'                                                                                                                                                                                                                              
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'La columna Buzón no admite valores repetidos.'                                                                                                                                                                                   
	cNombre = 'Buzonesdetalle'                                                                                                                                                                                                                                
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Buzones'                                                                                                                                                                                                                                 
	datasession = 1                                                                                                                                                                                                                                           
