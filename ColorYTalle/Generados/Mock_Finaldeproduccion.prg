...
define class Mock_finaldeproduccion as MockBase of MockBase.prg
	...
	cComprobante = ""                                                                                                                                                                                                                                         
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Finalización de producción"                                                                                                                                                                                                              
	...
	*-----------------------------------------------------------------------------------------
	function obtenerorigendestinoparabaseactiva() as string                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerorigendestinoparabaseactiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompfinaldeproduccion_access() as variant                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'FINALDEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocompfinaldeproduccion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocompfinaldeproduccion_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oCompFinaldeproduccion ) = 'O' or isnull( this.oCompFinaldeproduccion ) )			this.oCompFinaldeproduccion = _Screen.zoo.InstanciarComponente( 'ComponenteFinaldeproduccion' )		this.oCompFinaldeproduccion.Inicializar()		this.enlazar( 'oCompFinaldeproduccion.EventoObtenerLogueo', 'inyectarLogueo' )		this.enlazar( 'oCompFinaldeproduccion.EventoObtenerInformacion', 'inyectarInformacion' )		endif		return this.oCompFinaldeproduccion
	EndFunc
