...
define class Mock_Itemoperadoradetarjetaclasesdetarjetadetalle as MockBase of MockBase.prg

	cClase = 'Itemoperadoradetarjetaclasesdetarjetadetalle'
	...
	*-----------------------------------------------------------------------------------------
	function clasedetarjetadetalle_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Clasedetarjetadetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_clasedetarjetadetalle( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_clasedetarjetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_clasedetarjetadetalle( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_clasedetarjetadetalle', lcParametros )
	EndFunc
