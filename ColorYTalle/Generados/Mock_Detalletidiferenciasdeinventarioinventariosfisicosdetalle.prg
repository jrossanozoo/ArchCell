...
define class Mock_Detalletidiferenciasdeinventarioinventariosfisicosdetalle as MockBase of MockBase.prg

	cClase = 'Detalletidiferenciasdeinventarioinventariosfisicosdetalle'
	...
	cNombre = 'Inventariosfisicosdetalle'                                                                                                                                                                                                                     
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Inventarios físicos'                                                                                                                                                                                                                     
	datasession = 1                                                                                                                                                                                                                                           
