...
define class Mock_Tipodedireccionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Tipodedireccionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubtdd( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubtdd', lcParametros )
	EndFunc
