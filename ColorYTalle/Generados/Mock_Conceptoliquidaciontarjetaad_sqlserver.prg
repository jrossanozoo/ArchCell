...
define class Mock_Conceptoliquidaciontarjetaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Conceptoliquidaciontarjetaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubclt( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubclt', lcParametros )
	EndFunc
