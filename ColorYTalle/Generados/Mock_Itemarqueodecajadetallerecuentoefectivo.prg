...
define class Mock_Itemarqueodecajadetallerecuentoefectivo as MockBase of MockBase.prg

	cClase = 'Itemarqueodecajadetallerecuentoefectivo'
	...
	*-----------------------------------------------------------------------------------------
	function monedadenom_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Monedadenom_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_monedadenom( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_monedadenom', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valordenom( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_valordenom', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_monedadenom( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_monedadenom', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valordenom( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_valordenom', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valordenom_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valordenom_assign', lcParametros )
	EndFunc
