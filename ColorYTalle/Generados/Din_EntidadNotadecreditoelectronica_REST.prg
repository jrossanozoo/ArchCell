...
define class Din_EntidadNotadecreditoelectronica_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadecreditoelectronica"
	cClaseResponse = this.cNamespaceDTOs + ".NotadecreditoelectronicaResponse"
	cClaseModelo = "NotadecreditoelectronicaModelo"
	cEntidad = "Notadecreditoelectronica"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaModelo"
		endcase
		return lcRetorno
