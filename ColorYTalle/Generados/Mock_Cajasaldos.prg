...
define class Mock_cajasaldos as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Saldos de caja"                                                                                                                                                                                                                          
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cMensajeSaldoNegativo = "No hay disponibilidad de saldos en la caja."                                                                                                                                                                                     
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'CAJASALDOS'                                                                                                                                                                                                                                    
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lEstoyActualizandoSaldosPorAperturaDeCaja = .f.                                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function actualizarsaldosporaperturadecaja( tncaja as integer, toauditoria as object ) as void                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tncaja
		lxParam2 = toauditoria
		...
		return this.ObtenerResultado( 'Actualizarsaldosporaperturadecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buscarcajayvalor( tncaja as integer, tcvalor as string, tccomprobante as string ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Buscarcajayvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function disparadornoseencontromoneda() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Disparadornoseencontromoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function noverificasaldos() as boolean                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Noverificasaldos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercursortotales ( tncaja ) as string                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercursortotales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersaldos( tncaja as integer ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersaldos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenersaldovalor( tncaja as integer, tcvalor as string ) as float                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenersaldovalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersigno( tlinvertirsigno as boolean ) as integer                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tlinvertirsigno
	...
	*-----------------------------------------------------------------------------------------
	function obtenertotalcajasaldos( tncaja ) as float                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertotalcajasaldos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cajaestado( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJASALDOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cajaestado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cajaestado', lcParametros )			endif		endif		this.Cajaestado.ID = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cajaestado( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJASALDOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cajaestado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cajaestado', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardetallevalorescontrasaldosdecaja( todetallevalores as zoocoleccion of zoocoleccion.prg, tlinvertirsigno as boolean, tnsignomovimiento as integer ) as boolean                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = todetallevalores
		lxParam2 = tlinvertirsigno
		lxParam3 = tnsignomovimiento
		...
		return this.ObtenerResultado( 'Validardetallevalorescontrasaldosdecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocajaestado() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridocajaestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcoleccionordenada( tocoleccion as zoocoleccion of zoocoleccion.prg,  tocolrecorrer as zoocoleccion of zoocoleccion.prg, tlinvertirsigno as boolean, tnsignomovimiento as integer ) as void                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tocoleccion
		lxParam2 = tocolrecorrer
		lxParam3 = tlinvertirsigno
		lxParam4 = tnsignomovimiento
		...
		return this.ObtenerResultado( 'Actualizarcoleccionordenada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debeprocesarelvalor( tntipodevalor as integer ) as boolean                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tntipodevalor
		...
		return this.ObtenerResultado( 'Debeprocesarelvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminarcaja( tncaja as integer ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eliminarcaja', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function eliminarregistroinconsistente() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eliminarregistroinconsistente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function nuevoregistroencajasaldos( tncaja as integer, tcvalor as string, tccomprobante as string ) as void                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Nuevoregistroencajasaldos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccionordenada( tocoleccion as zoocoleccion of zoocoleccion.prg, tnsignomovimiento as integer ) as zoocoleccion of zoocoleccion.prg                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tocoleccion
		lxParam2 = tnsignomovimiento
		...
		return this.ObtenerResultado( 'Obtenercoleccionordenada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reasignarclaveprimaria( tncaja as integer , tcvalor as string, tccomprobante as string)                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Reasignarclaveprimaria', lcParametros )
	EndFunc
