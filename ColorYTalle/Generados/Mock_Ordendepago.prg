...
define class Mock_ordendepago as MockBase of MockBase.prg
	...
	Vuelto = 0                                                                                                                                                                                                                                                
	ZADSFW = ""                                                                                                                                                                                                                                               
	cAnotacionPagoACuenta = ''                                                                                                                                                                                                                                
	cAtributoAAuditar = ""                                                                                                                                                                                                                                    
	cAtributoPK = ""                                                                                                                                                                                                                                          
	cAtributoValorAInsertar = "Valor"                                                                                                                                                                                                                         
	cAtributoVendedor = ''                                                                                                                                                                                                                                    
	cCaracteres = ""                                                                                                                                                                                                                                          
	cCodigoDeValorSugeridoParaVuelto = ""                                                                                                                                                                                                                     
	cCodigoVueltoAnterior = ""                                                                                                                                                                                                                                
	cComprobante = ""                                                                                                                                                                                                                                         
	cComprobante = "ORDENDEPAGO"                                                                                                                                                                                                                              
	cContexto = ""                                                                                                                                                                                                                                            
	...
	cDetalleComprobante = "OrdenDePagoDetalle"                                                                                                                                                                                                                
	...
	lCambioTipoComprobanteRG1361 = .f.                                                                                                                                                                                                                        
	...
	lDebeProcesarRetenciones = .f.                                                                                                                                                                                                                            
	lDebeRenumerarAlEnviarABaseDeDatos = .F.                                                                                                                                                                                                                  
	lDebeRetenerPorComprobantesM = .f.                                                                                                                                                                                                                        
	lDebeValidarValoresPermitidosParaAgentesDeRetencion = .f.                                                                                                                                                                                                 
	lDebeValidarValoresPermitidosParaAgentesDeRetencion = .t.                                                                                                                                                                                                 
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	...
	lSolicitaDatosTransacBancariaEnOP = .T.                                                                                                                                                                                                                   
	lSoloAfectaCaja = .f.                                                                                                                                                                                                                                     
	lSugiereRemito = .f.                                                                                                                                                                                                                                      
	...
	lTienePermisoParaCambiarImpuesto = .F.                                                                                                                                                                                                                    
	lTieneVendedorComoClaveForanea = .f.                                                                                                                                                                                                                      
	lUsoBuscador = .f.                                                                                                                                                                                                                                        
	lUtilizaCentroDeCosto = .f.                                                                                                                                                                                                                               
	...
	nPorcentajeIVALiquidacionA = 0.00                                                                                                                                                                                                                         
	...
	oColaboradorCargarChequesDeTercerosAInsertar = null                                                                                                                                                                                                       
	...
	oColeccionOriginalRetenciones = null                                                                                                                                                                                                                      
	oColeccionOriginalRetencionesPorJurisdiccion = null                                                                                                                                                                                                       
	oColeccionOriginalValores = null                                                                                                                                                                                                                          
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oComponente = null                                                                                                                                                                                                                                        
	oComponenteCuentaCorriente = null                                                                                                                                                                                                                         
	oComponenteFiscal = null                                                                                                                                                                                                                                  
	oComportamientoCodigoSugerido = null                                                                                                                                                                                                                      
	oConjuntoDeSeniasPendientes = null                                                                                                                                                                                                                        
	oDatosFiscales = null                                                                                                                                                                                                                                     
	oDatosTipoComprobante = null                                                                                                                                                                                                                              
	...
	*-----------------------------------------------------------------------------------------
	function actualizarendetallenumeroordendepagoenitemspagoacuenta( txnumero as integer ) as void                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Actualizarendetallenumeroordendepagoenitemspagoacuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarinfoadicional() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarinfoadicional', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicarcondiciondepago( tccodicion as string ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function calculardeuda()                                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Calculardeuda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calculartotal() as void                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecompafec2() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cambiosdetallecompafec2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleordendepagodetalle() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Cambiosdetalleordendepagodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarcoleccionoriginalretenciones() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcoleccionoriginalretenciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarcoleccionoriginalretencionesporjurisdiccion() as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcoleccionoriginalretencionesporjurisdiccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function correspondehabilitarcentrodecostos() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Correspondehabilitarcentrodecostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debeactuarcomoagentederetencion() as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Debeactuarcomoagentederetencion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function debeactuarcomoagentederetencionparaelcomprobanteactual() as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debeactuarcomoagentederetencionparaelcomprobanteactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debepedirtipodecomprobantedecompra() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debepedirtipodecomprobantedecompra', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function deberetenerrg1575() as boolean                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Deberetenerrg1575', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debevalidarvalorespermitidosparaagentesderetencion() as boolean                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debevalidarvalorespermitidosparaagentesderetencion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function deshabilitarconciliarmonto() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Deshabilitarconciliarmonto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function despuesdeactualizarimpuestosmanuales() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdeactualizarimpuestosmanuales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesdesetearproveedor_monedacomprobante( tcproveedor as string, tcmoneda as string ) as void                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Despuesdesetearproveedor_monedacomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function deuda_assign( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'deuda_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'deuda_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Deuda		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Deuda( lxVal )				this.Setear_Deuda( lxVal )			EndIf		Else			This.Setear_Deuda( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutaraccionesautomatizadasdecomprobantesderetencion() as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ejecutaraccionesautomatizadasdecomprobantesderetencion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function entregarchequepropiodecartera( toitem as object ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Entregarchequepropiodecartera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esagentederetencion() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Esagentederetencion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esliquidaciona() as void                                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esliquidaciona', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estapagandocomprobantem() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estapagandocomprobantem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function esunaretencionydebeserlo( toimpuesto as object ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esunaretencionydebeserlo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function evaluarseteotipodecomprobantedecompra( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Evaluarseteotipodecomprobantedecompra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoalcanzocantidadmaximadeitems( toinformacion as zooinformacion of zooinformacion.prg ) as void                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventoalcanzocantidadmaximadeitems', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosendetalledeimpuestos() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocambiosendetalledeimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventodefinirtipodecomprobantedecompra( txval as variant ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventodefinirtipodecomprobantedecompra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoobtenerdatosdelcupon( topublicador as object, toargumentos as object ) as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntaragregarpagoacuenta( tnrespuestasugerida as integer, tnmonto as float ) as void                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventopreguntaragregarpagoacuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarimprimirticketparacambio() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntarimprimirticketparacambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorefrescarimpuestosdetalle() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorefrescarimpuestosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoselecciondechquesdetercerosainsertar( topublicador as object, toargumentos as object ) as void                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventoselecciondechquesdetercerosainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoverificarexistenciagrupo( toarticulo as entidad of entidad.prg ) as boolean                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eventoverificarexistenciagrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitacentrodecosto() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitacentrodecosto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function hacambiadovaloresdetalle( tcatributo as string, toitem as object ) as void                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Hacambiadovaloresdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function haypagosparcialesdecomprobantes() as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Haypagosparcialesdecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function imprimircomprobantesderetenciones() as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Imprimircomprobantesderetenciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function impuestosmanuales_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'impuestosmanuales_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'impuestosmanuales_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Impuestosmanuales		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Impuestosmanuales( lxVal )				this.Setear_Impuestosmanuales( lxVal )			EndIf		Else			This.Setear_Impuestosmanuales( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitarordendepagodetalle_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitarordendepagodetalle_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitarordendepagodetalle_assign', lcParametros )			endif		endif		this.lHabilitarOrdenDePagoDetalle = txVal		this.OrdenDePagoDetalle.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiardetalleordendepago() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Limpiardetalleordendepago', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiarimpuestocomprobante() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Limpiarimpuestocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numerocdr_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numerocdr_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numerocdr_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numerocdr		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numerocdr( lxVal )				this.Setear_Numerocdr( lxVal )			EndIf		Else			This.Setear_Numerocdr( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneranotaciondeajuste( tcguidajuste as string, tccodpro as string ) as string                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcguidajuste
		lxParam2 = tccodpro
		...
		return this.ObtenerResultado( 'Obteneranotaciondeajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerchequesdetercerosainsertar( tcxmlchequesdetercerospendientes as string ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcxmlchequesdetercerospendientes
		...
		return this.ObtenerResultado( 'Obtenerchequesdetercerosainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigopagoafectante() as string                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigopagoafectante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdelcupon( tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripcionretencionesparatooltip( tccodigoimpuesto as string ) as string                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerdescripcionretencionesparatooltip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerpendientes( tcproveedor as string, tcmoneda as string ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerpendientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorcargarchequesdetercerosainsertar_access() as object                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorcargarchequesdetercerosainsertar_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorcargarchequesdetercerosainsertar_access', lcParametros )			endif		endif		if !this.lDestroy and ( type( "this.oColaboradorCargarChequesDeTercerosAInsertar" ) <> "O" or isnull( this.oColaboradorCargarChequesDeTercerosAInsertar ) )			this.oColaboradorCargarChequesDeTercerosAInsertar = _screen.zoo.app.CrearObjeto( "ColaboradorCargarChequesDeTercerosAInsertar" )		endif		return this.oColaboradorCargarChequesDeTercerosAInsertar
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function odatostipocomprobante_access() as variant                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'odatostipocomprobante_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'odatostipocomprobante_access', lcParametros )			endif		endif		if this.ldestroy		else			if !vartype( this.oDatosTipoComprobante ) = 'O' or isnull( this.oDatosTipoComprobante )				this.oDatosTipoComprobante = newobject("DatosTipoComprobante")			endif		endif		return this.oDatosTipoComprobante
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function olibradordecheque_access() as variant                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'olibradordecheque_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'olibradordecheque_access', lcParametros )			endif		endif		if this.ldestroy		else			if !vartype( this.oLibradorDeCheque ) = 'O' or isnull( this.oLibradorDeCheque )				this.oLibradorDeCheque = this.Proveedor			endif		endif		return this.oLibradorDeCheque
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function permiteeditarimpuestos() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Permiteeditarimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesarcomponenteretenciones() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesarcomponenteretenciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function proveedordescripcion_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'proveedordescripcion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'proveedordescripcion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Proveedordescripcion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Proveedordescripcion( lxVal )				this.Setear_Proveedordescripcion( lxVal )			EndIf		Else			This.Setear_Proveedordescripcion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puntodeventacdr_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'puntodeventacdr_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'puntodeventacdr_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Puntodeventacdr		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Puntodeventacdr( lxVal )				this.Setear_Puntodeventacdr( lxVal )			EndIf		Else			This.Setear_Puntodeventacdr( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_deuda( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_deuda', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_deuda', lcParametros )			endif		endif		this.Deuda = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fecha( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fecha', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fecha', lcParametros )			endif		endif		local llCambioDeFecha as Boolean		llCambioDeFecha = (	this.Fecha # txVal )		dodefault( txVal )		if llCambioDeFecha			this.SetearFechaDePagoACuenta( txVal )			if !this.lEstaEnProceso and this.lDebeProcesarRetenciones				this.oColaboradorRetenciones.ActualizarConfiguracionRetenciones()				This.ImpuestosComprobante.oItem.oCompRetenciones.ActualizarEsquema( this.oColaboradorRetenciones )				This.ProcesarComponenteRetenciones()			endif		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_monedacomprobante( txval as string ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_monedacomprobante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_monedacomprobante', lcParametros )			endif		endif		dodefault( txVal )		if empty(this.cValorPagoACuenta) and !empty(txVal)			this.SetearValorDeTipoCtaCteSegunMoneda( txVal )		endif		This.DespuesDeSetearProveedor_MonedaComprobante( This.Proveedor_pk, txVal )		this.SetearValorDeTipoCtaCteSegunMoneda( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montoconciliar( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_montoconciliar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_montoconciliar', lcParametros )			endif		endif		this.SetearValorDeTipoCtaCteSegunMoneda( this.MonedaComprobante_PK )		dodefault( txVal )		if !empty( txVal )			this.Conciliar( txVal )		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numero(  txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numero', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numero', lcParametros )			endif		endif		local llCambioNumeroOrdenDePago as Boolean		llCambioNumeroOrdenDePago = ( this.Numero # txVal )		dodefault( txVal )		if llCambioNumeroOrdenDePago and this.lNuevo			this.ActualizarEnDetalleNumeroOrdenDePagoEnItemsPagoACuenta( txVal )		endif		
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_numerocdr( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numerocdr', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numerocdr', lcParametros )			endif		endif		this.Numerocdr = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_proveedor( txval as string ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_proveedor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_proveedor', lcParametros )			endif		endif		local lHuboCambio as Boolean		lHuboCambio = this.lCambioProveedor		dodefault( txVal )		with this			if .CargaManual() and lHuboCambio				.DespuesDeSetearProveedor_MonedaComprobante( txVal, This.MonedaComprobante_pk )				.lDebeProcesarRetenciones = .DebeProcesarRetenciones()				if .lDebeProcesarRetenciones					.ValidarFechaConRetenciones( txval, .Fecha )					.BindearEventosAgenteRetenciones()				else					.desBindearEventosAgenteRetenciones()				endif				.ImpuestosComprobante.oItem.oCompRetenciones.ActualizarEsquema( this.oColaboradorRetenciones )			endif		endwith
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_proveedordescripcion( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_proveedordescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_proveedordescripcion', lcParametros )			endif		endif		this.Proveedordescripcion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_puntodeventacdr( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_puntodeventacdr', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_puntodeventacdr', lcParametros )			endif		endif		this.Puntodeventacdr = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_usuario( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_usuario', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_usuario', lcParametros )			endif		endif		this.Usuario = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearfechaendetalledevalores() as voi                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function setearsideberetenerporcomprobantesm() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearsideberetenerporcomprobantesm', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function soportasenias() as void                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function soportatipodecomprobantedecompra() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Soportatipodecomprobantedecompra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sugerirremito() as void                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Sugerirremito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienepagoctacte() as boolean                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienepagoctacte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienevalorestipocuentabancaria() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienevalorestipocuentabancaria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function usuario_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'usuario_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'usuario_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Usuario		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Usuario( lxVal )				this.Setear_Usuario( lxVal )			EndIf		Else			This.Setear_Usuario( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_deuda( txval as variant ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_deuda', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_deuda', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_impuestosmanuales( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_impuestosmanuales', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_impuestosmanuales', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_letra( txval as variant ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_letra', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_letra', lcParametros )			endif		endif		&&No se valida la letra, pq siempre es "X"		return .T.
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montoconciliar( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_montoconciliar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_montoconciliar', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_montodescuentoconimpuestos3( txval as variant ) as boolean                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_montodescuentoconimpuestos3', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_montodescuentoconimpuestos3', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = .t.		if this.TieneImpuestosManuales() and this.Montodescuentoconimpuestos3 # txVal			llRetorno = this.ConfirmaHabilitarImpuestosAutomaticos()		endif		llRetorno = llRetorno and dodefault( txVal )		Return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerocdr( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numerocdr', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numerocdr', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_proveedordescripcion( txval as variant ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_proveedordescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_proveedordescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_puntodeventacdr( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_puntodeventacdr', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_puntodeventacdr', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_usuario( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usuario', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usuario', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcantidaddeitemsendetalle() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcantidaddeitemsendetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarpagoseguncomprobantes( txval as variant,  toinformacion as object ) as void                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = txval
		lxParam2 = toinformacion
		...
		return this.ObtenerResultado( 'Validarpagoseguncomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarsignodemovimiento() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarsignodemovimiento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarsolounaasignaciondecentrodecostos() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function validartipodecomprobantedecompra() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validartipodecomprobantedecompra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvalorespermitidosparaagentederetencion() as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarvalorespermitidosparaagentederetencion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorpermitidoparacomprobante( tnvalor as integer ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocotizacion() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridocotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwmonedacomprobante() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwmonedacomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwusuario() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomontoconciliar() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridomontoconciliar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoproveedordescripcion() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridoproveedordescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousuario() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridousuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarsihayretencionescargadas() as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarsihayretencionescargadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizardetalleactual() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizardetalleactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarinformacionadicionalporpagoautomatico() as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarinformacionadicionalporpagoautomatico', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function actualizarpendientes( tccursor as string ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Actualizarpendientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarpagoacuenta( tnmontoaconciliar as float ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tnmontoaconciliar
		...
		return this.ObtenerResultado( 'Agregarpagoacuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function bindeareventosagenteretenciones as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Bindeareventosagenteretenciones As Void', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function conciliar( tnmontoaconciliar as float ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Conciliar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function confirmahabilitarimpuestosautomaticos() as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Confirmahabilitarimpuestosautomaticos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debeprocesarretenciones() as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debeprocesarretenciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function desbindeareventosagenteretenciones as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Desbindeareventosagenteretenciones As Void', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function estipodevalorcheque( tntipovalor as integer ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Estipodevalorcheque', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eventocambiosum_montoordendepagodetalle() as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocambiosum_montoordendepagodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function haycomprobantesdeiibbseparados() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Haycomprobantesdeiibbseparados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function hubocambiosenarticulos( tcatributo as string, toobject as object ) as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Hubocambiosenarticulos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function imprimircomprobantesderetencionesdesdeelcolaborador( tldespuesdegrabar as boolean ) as boolean                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tldespuesdegrabar
		...
		return this.ObtenerResultado( 'Imprimircomprobantesderetencionesdesdeelcolaborador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function laletraexistedentrodelconjuntovalidodeletrasfiscales( tcletra as string ) as void                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Laletraexistedentrodelconjuntovalidodeletrasfiscales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function limpiarcoleccionoriginalretenciones() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Limpiarcoleccionoriginalretenciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function limpiarcoleccionoriginalretencionesporjurisdiccion() as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Limpiarcoleccionoriginalretencionesporjurisdiccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercodigodecomprobantederetenciones( tccodigoimpuesto as string ) as string                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercodigodecomprobantederetenciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomponentecheques( toitem as object, tntipo as integer ) as object                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomponentechequesdeterceros( toitem as object ) as object                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercomponentechequesdeterceros', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercomponentechequespropios( toitem as object ) as object                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemimpuestocomprobante( tccodigoimpuesto as string ) as object                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obteneritemimpuestocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocomponentecuentacorriente_access() as variant                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ORDENDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocomponentecuentacorriente_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocomponentecuentacorriente_access', lcParametros )			endif		endif		if this.lDestroy		else			if ( vartype( this.oComponenteCuentaCorriente ) != "O" or isnull( this.oComponenteCuentaCorriente ) )				this.oComponenteCuentaCorriente = _Screen.zoo.CrearObjeto( "componenteCuentaCorrienteOrdenDePagoCompras", "componenteCuentaCorrienteOrdenDePagoCompras.prg" )			endif		endif		return this.oComponenteCuentaCorriente
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarpagoacuenta( tnmontoaconciliar as float ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Procesarpagoacuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function prorratearimpuestosmanualesenitems() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Prorratearimpuestosmanualesenitems', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearfechadepagoacuenta( tdfechaacuenta as date ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tdfechaacuenta
		...
		return this.ObtenerResultado( 'Setearfechadepagoacuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearvalordetipoctactesegunmoneda( tcmoneda as string )                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearvalordetipoctactesegunmoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function tienedetalledearticulos() as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienedetalledearticulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function tieneitemconprecio() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tieneitemconprecio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function tienemodulodecontabilidadhabilitado() as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienemodulodecontabilidadhabilitado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcentrosdecostosrequerido() as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcentrosdecostosrequerido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcomprobantesapagar() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcomprobantesapagar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarfechaconretenciones( tcproveedor as string, tdfecha as date, tnnumero as integer ) as boolean                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Validarfechaconretenciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarletraencomprobante() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarletraencomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarletrasegunsituacionfiscaldelproveedor( tcletra as string ) as boolean                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarletrasegunsituacionfiscaldelproveedor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function vencimientoduplicadoencuentacorriente( tccodigocomprobante as string ) as boolean                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Vencimientoduplicadoencuentacorriente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarduplicadoencuentacorriente( tcwherecomprobante as string ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcwherecomprobante
		...
		return this.ObtenerResultado( 'Verificarduplicadoencuentacorriente', lcParametros )
	EndFunc
