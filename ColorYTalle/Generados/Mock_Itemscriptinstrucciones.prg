...
define class Mock_Itemscriptinstrucciones as MockBase of MockBase.prg

	cClase = 'Itemscriptinstrucciones'
	...
	*-----------------------------------------------------------------------------------------
	function instruccion_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Instruccion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_instruccion( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_instruccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_instruccion( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_instruccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinstruccion() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoinstruccion', lcParametros )
	EndFunc
