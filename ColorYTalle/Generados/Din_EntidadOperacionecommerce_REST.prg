...
define class Din_EntidadOperacionecommerce_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Operacionecommerce"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Datosretiro", toEntidad, "Datosretiro" )
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetallePublicacionDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.PublicacionDetalle.oItem, "Talle_PK" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "DatosRetiro", toEntidad.DatosRetiro)
	...
	protected function CargarColeccionModeloPublicacionDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .PublicacionDetalle.Count
				...
				this.SetearAtributoString( loItem, "Talle", .PublicacionDetalle.Item(lnI).Talle_PK)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Datosretiro", "RETIRO")
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerBusquedaSegunModeloRequest( toRequest as Object ) as String
		...
		if !isnull( lcExpresionBusqueda )
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Retiro LIKE '%" + lcExpresionBusqueda + "%'"
