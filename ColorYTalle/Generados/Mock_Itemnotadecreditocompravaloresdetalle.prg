...
define class Mock_Itemnotadecreditocompravaloresdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditocompravaloresdetalle'
	...
	*-----------------------------------------------------------------------------------------
	protected function escuponconautorizacionpos() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function tienefechadevencimiento() as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienefechadevencimiento', lcParametros )
	EndFunc
