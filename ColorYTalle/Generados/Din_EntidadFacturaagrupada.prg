...
define class Din_EntidadFACTURAAGRUPADA as Ent_ComprobanteAgrupado of Ent_ComprobanteAgrupado.prg
	...
	PromocionesDetalle = null
	PromoArticulosDetalle = null
	IdVuelto_PK = []
	IdVuelto = null
	...
	*--------------------------------------------------------------------------------------------------------
	function oAD_Access() as variant
		if !this.ldestroy and ( !vartype( this.oAD ) = 'O' or isnull( this.oAD ) )
			this.oAD = this.crearobjeto( 'Din_EntidadFACTURAAGRUPADAAD_' + alltrim( _screen.zoo.app.TipoDeBase ))
	...
	*--------------------------------------------------------------------------------------------------------
	function Facturadetalle_Access() as variant
		if !this.ldestroy and ( !vartype( this.Facturadetalle ) = 'O' or isnull( this.Facturadetalle ) )
			this.Facturadetalle = this.crearobjeto( 'Din_DetalleFacturaagrupadaFacturadetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	function Compafec_Access() as variant
		if !this.ldestroy and ( !vartype( this.Compafec ) = 'O' or isnull( this.Compafec ) )
			this.Compafec = this.crearobjeto( 'Din_DetalleFacturaagrupadaCompafec' )
	...
	*--------------------------------------------------------------------------------------------------------
	function Promocionesdetalle_Access() as variant
		if !this.ldestroy and ( !vartype( this.Promocionesdetalle ) = 'O' or isnull( this.Promocionesdetalle ) )
			this.Promocionesdetalle = this.crearobjeto( 'Din_DetalleFacturaagrupadaPromocionesdetalle' )
			this.Promocionesdetalle.inicializar()
			this.enlazar( 'Promocionesdetalle.EventoObtenerLogueo', 'inyectarLogueo' )
			this.enlazar( 'Promocionesdetalle.EventoObtenerInformacion', 'inyectarInformacion' )
			bindevent( this.Promocionesdetalle, 'CambioSumarizado', this, 'CambiosDetallePromocionesdetalle', 1) 
			this.enlazar( 'Promocionesdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno') 
			this.enlazar( 'Promocionesdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno') 
			this.Promocionesdetalle.lVerificarLimitesEnDisenoImpresion = .t.
		endif
		return this.Promocionesdetalle
	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Promoarticulosdetalle_Access() as variant
		if !this.ldestroy and ( !vartype( this.Promoarticulosdetalle ) = 'O' or isnull( this.Promoarticulosdetalle ) )
			this.Promoarticulosdetalle = this.crearobjeto( 'Din_DetalleFacturaagrupadaPromoarticulosdetalle' )
			this.Promoarticulosdetalle.inicializar()
			this.enlazar( 'Promoarticulosdetalle.EventoObtenerLogueo', 'inyectarLogueo' )
			this.enlazar( 'Promoarticulosdetalle.EventoObtenerInformacion', 'inyectarInformacion' )
			bindevent( this.Promoarticulosdetalle, 'CambioSumarizado', this, 'CambiosDetallePromoarticulosdetalle', 1) 
			this.enlazar( 'Promoarticulosdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno') 
			this.enlazar( 'Promoarticulosdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno') 
		endif
		return this.Promoarticulosdetalle
	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Kitsdetalle_Access() as variant
		if !this.ldestroy and ( !vartype( this.Kitsdetalle ) = 'O' or isnull( this.Kitsdetalle ) )
			this.Kitsdetalle = this.crearobjeto( 'Din_DetalleFacturaagrupadaKitsdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	function Impuestosdetalle_Access() as variant
		if !this.ldestroy and ( !vartype( this.Impuestosdetalle ) = 'O' or isnull( this.Impuestosdetalle ) )
			this.Impuestosdetalle = this.crearobjeto( 'Din_DetalleFacturaagrupadaImpuestosdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	function Impuestoscomprobante_Access() as variant
		if !this.ldestroy and ( !vartype( this.Impuestoscomprobante ) = 'O' or isnull( this.Impuestoscomprobante ) )
			this.Impuestoscomprobante = this.crearobjeto( 'Din_DetalleFacturaagrupadaImpuestoscomprobante' )
	...
	*--------------------------------------------------------------------------------------------------------
	function Articulosseniadosdetalle_Access() as variant
		if !this.ldestroy and ( !vartype( this.Articulosseniadosdetalle ) = 'O' or isnull( this.Articulosseniadosdetalle ) )
			this.Articulosseniadosdetalle = this.crearobjeto( 'Din_DetalleFacturaagrupadaArticulosseniadosdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	function Valoresdetalle_Access() as variant
		if !this.ldestroy and ( !vartype( this.Valoresdetalle ) = 'O' or isnull( this.Valoresdetalle ) )
			this.Valoresdetalle = this.crearobjeto( 'Din_DetalleFacturaagrupadaValoresdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	function SetearEstadoNuevoEnItems() as Void
		...
		this.PromocionesDetalle.oItem.lNuevo = this.lNuevo
		this.PromoArticulosDetalle.oItem.lNuevo = this.lNuevo
	...
	*--------------------------------------------------------------------------------------------------------
	function SetearEstadoEdicionEnItems() as Void
		...
		this.PromocionesDetalle.oItem.lEdicion = this.lEdicion
		this.PromoArticulosDetalle.oItem.lEdicion = this.lEdicion
	...
	*--------------------------------------------------------------------------------------------------------
	function CambiosDetallePromocionesdetalle() as void
		dodefault()
	endfunc

	*--------------------------------------------------------------------------------------------------------
	function CambiosDetallePromoarticulosdetalle() as void
		dodefault()
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local lnLargoDecimal as integer, lnLargoEntero as Integer, lnLargoDecimal as integer, llRetorno as boolean 
		...
		if ( vartype( this.Despachos) = 'C' )
			if len( alltrim( this.DESPACHOS ) ) > 254
				This.AgregarInformacion( 'La longitud del valor del atributo DESPACHOS es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DESPACHOS no es el correcto.')
			llRetorno = .F.
		Endif
		...
		if ( vartype( this.DireccionEntrega) = 'C' )
			if len( alltrim( this.DIRECCIONENTREGA ) ) > 250
				This.AgregarInformacion( 'La longitud del valor del atributo DIRECCIONENTREGA es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DIRECCIONENTREGA no es el correcto.')
			llRetorno = .F.
		Endif
		...
		if ( vartype( this.OpcionTransmisionMipyme) = 'C' )
			if len( alltrim( this.OPCIONTRANSMISIONMIPYME ) ) > 5
				This.AgregarInformacion( 'La longitud del valor del atributo OPCIONTRANSMISIONMIPYME es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo OPCIONTRANSMISIONMIPYME no es el correcto.')
			llRetorno = .F.
		Endif
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionBasica() as boolean
		...
		With This
			...
			llRetorno = .ValidarSenia() and llRetorno
			...
			llRetorno = .ValidarEntregaposterior() and llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionDetalles() as Boolean
		...
		llRetorno = This.ValidarUnDetalle( this.PromocionesDetalle, 'Promociones' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.PromoArticulosDetalle, 'PromoArticulosDetalle' ) and llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarEntregaPosterior() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.EntregaPosterior )
			this.AgregarInformacion( 'Debe cargar el campo Tipo de entrega', 9005, 'EntregaPosterior' )
			llRetorno = .F.
		endif
		return llRetorno
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarSenia() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Senia_PK )
		else
			If this.Senia.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Senia_PK ))+ ' de la entidad ' +  upper( this.Senia.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function obtenerAtributosObligatorios() as ZooColeccion
		...
		loAtributosObligatorios.add( 'ENTREGAPOSTERIOR' )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><CAI><WEBHOOK><VENTAS><CONVALORES><FISCAL><PROMO><NOLISTAGENERICO><PICKING><INTERVINIENTE><VALIDACENTRALIZADOR><VALORCIERRE><DESCUENTOAUTOMATICO><ACTUALIZAEMAILCLIENTE><MIPYME:54><AGRUPACOMPROBANTES:1;2;27><MIPYMEORIGINAL:27><CF>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as Void
		...
		this.oProveedorAtributosAnulacion = newobject( "din_entidadFACTURAAGRUPADAAtributosAnulacion", "din_entidadFACTURAAGRUPADAAtributosAnulacion.prg" )
		...
		this.oColeccionVSFW.agregar('.ValorSugeridoFWOpciontransmisionmipyme()','Opciontransmisionmipyme')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWIvadelsistema()','Ivadelsistema')
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'FACTURAAGRUPADA', '')
		...
		this.lWHIngresar = goServicios.WebHook.TieneQueMandar( 'FACTURAAGRUPADA', 'INGRESAR' )
		this.lWHModificar = goServicios.WebHook.TieneQueMandar( 'FACTURAAGRUPADA', 'MODIFICAR' )
		this.lWHEliminar = goServicios.WebHook.TieneQueMandar( 'FACTURAAGRUPADA', 'ELIMINAR' )
	endfunc
	...
	function Caja_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Caja( lxVal, lxValOld )
			if ( this.lHabilitarCaja_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura - Atributo: Caja)" )
			endif 
		endif
		dodefault( lxVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Sucursal_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Sucursal( lxVal, lxValOld )
			...
			If lxValOld != lxVal
				this.EventoCambioParticipantePromocion()
			endif
		endif
		dodefault( lxVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Senia_PK_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Senia_PK
		local lxVal as Variant
		local loSugerido as Object
		...
		if this.Validar_Senia( lxVal, lxValOld )
			This.Setear_Senia( lxVal )
		endif
		dodefault( lxVal )
	...
	function Monedacomprobante_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Monedacomprobante( lxVal, lxValOld )
			if ( this.lHabilitarMonedacomprobante_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura - Atributo: Monedacomprobante)" )
			endif 
			If lxValOld != lxVal
				this.EventoCambioParticipantePromocion()
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Senia( txVal as variant ) as void

		this.Senia.CODIGO = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Sucursal( txVal as variant, txValOld as variant ) as Boolean
		...
		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.ValidarAtributoParticipanteDePromo( 'Sucursal_Pk', txVal, txValOld )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Cliente( txVal as variant, txValOld as variant ) as Boolean
		...
		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.ValidarAtributoParticipanteDePromo( 'Cliente_Pk', txVal, txValOld ) and This.Cliente.oDesactivador.ValidarEstadoActivacion( txVal, txValOld, this.lnuevo, this.ledicion) 

	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Validar_Senia( txVal as variant, txValOld as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Monedacomprobante( txVal as variant, txValOld as variant ) as Boolean
		...
		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.ValidarAtributoParticipanteDePromo( 'Monedacomprobante_Pk', txVal, txValOld )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Listadeprecios( txVal as variant, txValOld as variant ) as Boolean
		...
		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.ValidarAtributoParticipanteDePromo( 'Listadeprecios_Pk', txVal, txValOld )
	...
	*--------------------------------------------------------------------------------------------------------
	function Despachos_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Despachos
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Despachos( lxVal )
				this.Setear_Despachos( lxVal )
			EndIf
		Else
			This.Setear_Despachos( lxVal ) 
		EndIf
		...
		if This.CargaManual()
			if this.Validar_Tipocomprobante( lxVal )
				if ( this.lHabilitarTipocomprobante or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura - Atributo: Tipocomprobante)" )
				endif 
			EndIf
		Else
			This.Setear_Tipocomprobante( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Fechavtosenia( lxVal )
				if ( this.lHabilitarFechavtosenia or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura - Atributo: Fechavtosenia)" )
				endif 
			EndIf
		Else
			This.Setear_Fechavtosenia( lxVal ) 
	...
	*--------------------------------------------------------------------------------------------------------
	function Direccionentrega_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Direccionentrega
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Direccionentrega( lxVal )
				this.Setear_Direccionentrega( lxVal )
			EndIf
		Else
			This.Setear_Direccionentrega( lxVal ) 
		EndIf
		...
		if This.CargaManual()
			if this.Validar_Fecha( lxVal )
				...
				this.Setear_Fecha( lxVal )
					If this.ValidarSiCambioElValorDelAtributo( 'Fecha', lxValOld, lxVal )
						this.EventoCambioParticipantePromocion()
					EndIf
			EndIf
		Else
			This.Setear_Fecha( lxVal ) 
			If this.ValidarSiCambioElValorDelAtributo( 'Fecha', lxValOld, lxVal )
				This.ValidarAtributoSecundarioParticipanteDePromo( 'Fecha', lxVal, lxValOld )
				this.EventoCambioParticipantePromocion()
			endif
		EndIf
		dodefault( lxVal )
		...
		if This.CargaManual()
			if this.Validar_Porcentajedescuento( lxVal )
				this.Setear_Porcentajedescuento( lxVal )
					If this.ValidarSiCambioElValorDelAtributo( 'Porcentajedescuento', lxValOld, lxVal )
						this.EventoCambioParticipantePromocion()
					EndIf
			EndIf
		Else
			This.Setear_Porcentajedescuento( lxVal ) 
			If this.ValidarSiCambioElValorDelAtributo( 'Porcentajedescuento', lxValOld, lxVal )
				This.ValidarAtributoSecundarioParticipanteDePromo( 'Porcentajedescuento', lxVal, lxValOld )
				this.EventoCambioParticipantePromocion()
			endif
		EndIf
		dodefault( lxVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Opciontransmisionmipyme_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Opciontransmisionmipyme
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Opciontransmisionmipyme( lxVal )
				this.Setear_Opciontransmisionmipyme( lxVal )
			EndIf
		Else
			This.Setear_Opciontransmisionmipyme( lxVal ) 
		EndIf
		...
		if This.CargaManual()
			if this.Validar_Montodescuento3( lxVal )
				this.Setear_Montodescuento3( lxVal )
					If this.ValidarSiCambioElValorDelAtributo( 'Montodescuento3', lxValOld, lxVal )
						this.EventoCambioParticipantePromocion()
					EndIf
			EndIf
		Else
			This.Setear_Montodescuento3( lxVal ) 
			If this.ValidarSiCambioElValorDelAtributo( 'Montodescuento3', lxValOld, lxVal )
				This.ValidarAtributoSecundarioParticipanteDePromo( 'Montodescuento3', lxVal, lxValOld )
				this.EventoCambioParticipantePromocion()
			endif
		EndIf
		dodefault( lxVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Despachos( txVal as variant ) as void

		this.Despachos = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Direccionentrega( txVal as variant ) as void

		this.Direccionentrega = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Opciontransmisionmipyme( txVal as variant ) as void

		this.Opciontransmisionmipyme = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Despachos( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Direccionentrega( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Fecha( txVal as variant ) as Boolean
		...
		Return dodefault( txVal )  and This.ValidarAtributoParticipanteDePromo( 'Fecha', txVal, this.Fecha )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Porcentajedescuento( txVal as variant ) as Boolean
		...
		Return dodefault( txVal )  and This.ValidarAtributoParticipanteDePromo( 'Porcentajedescuento', txVal, this.Porcentajedescuento )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Opciontransmisionmipyme( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Montodescuento3( txVal as variant ) as Boolean
		...
		Return dodefault( txVal )  and This.ValidarAtributoParticipanteDePromo( 'Montodescuento3', txVal, this.Montodescuento3 )
	...
	*--------------------------------------------------------------------------------------------------------
	function Senia_Access() as variant
		if this.ldestroy
		else
			if This.lInstanciarSubEntidadaDemanda
				if ( !vartype( this.Senia ) = 'O' or isnull( this.Senia ) )
					this.Senia = _Screen.zoo.instanciarentidad( 'Senia' )
					this.Senia.lEsSubEntidad = .t.
					this.enlazar( 'Senia.EventoObtenerLogueo', 'inyectarLogueo' )
					this.enlazar( 'Senia.EventoObtenerInformacion', 'inyectarInformacion' )
				endif
				if !this.lBuscandoCodigo
					if this.Senia.CODIGO # this.Senia_PK
						this.Senia.CODIGO = this.Senia_PK
					endif
				endif
			endif
		endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoTipocomprobante() as void
		...
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Tipocomprobante" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWTipocomprobante() as void
		with this
			.Tipocomprobante = this.ObtenerSugeridoTipoComprobante("FACTURA")
		endwith
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWSucursal() as void
		with this
			try
				.Sucursal_PK = goParametros.Nucleo.Sucursal
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoObs() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Obs" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoCliente() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Cliente" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
			...
			Catch to loError
				...
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					...
					loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Cliente para la entidad Factura." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
					goServicios.Errores.LevantarExcepcion( loEx )
				endif
			endtry 
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoClientedescripcion() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Clientedescripcion" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoVendedor() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Vendedor" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoLetra() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Letra" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoListadeprecios() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Listadeprecios" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoPuntodeventa() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Puntodeventa" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoEmail() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Email" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Email para la entidad Factura." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoNumero() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Numero" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Número para la entidad Factura." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es numérico." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFecha() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Fecha" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Fecha para la entidad Factura." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es fecha." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoPorcentajedescuento() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Porcentajedescuento" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoEntregaposterior() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Entregaposterior" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Tipo de entrega para la entidad Factura." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es numérico." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFechavencimientomipyme() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Fechavencimientomipyme" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						This.EventoEstaSeteandoValorSugerido( 'Fechavencimientomipyme' )
						.Fechavencimientomipyme = lvValorSugeridoDefinidoPorElUsuario
					catch to loError
						loEx = newobject("zooexception", "zooexception.prg" )
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoOpciontransmisionmipyme() as void
		local lcExpresionValorSugeridoDefinidoPorElUsuario as String, lvValorSugeridoDefinidoPorElUsuario as Variant, loError as Object, loEx as Object, loExTipoDato as Object
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Opciontransmisionmipyme" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						This.EventoEstaSeteandoValorSugerido( 'Opciontransmisionmipyme' )
						.Opciontransmisionmipyme = lvValorSugeridoDefinidoPorElUsuario
					catch to loError
						loEx = newobject("zooexception", "zooexception.prg" )
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Opción de transmisión para la entidad Factura." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			else
				.ValorSugeridoFWOpciontransmisionmipyme()
			endif
		endwith
	endfunc

	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWOpciontransmisionmipyme() as void
		with this
			.Opciontransmisionmipyme = iif(inlist(goparametros.felino.gestiondeventas.facturacionelectronica.opciondetransmisionparacomprobantesdecreditomipyme,2,4),"SCA","ADC")
		endwith
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoMontodescuento3() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Montodescuento3" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoRecargoporcentaje() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Recargoporcentaje" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo % Recargo para la entidad Factura." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es numérico." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoRecargomonto2() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAAGRUPADA", "", "Recargomonto2" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	function SetearTipoComprobanteMiPyME( tlOriginal as Boolean ) as Integer
		...
		if tlOriginal
			this.TipoComprobante = 27
		else
			this.TipoComprobante = 54
		endif
	...
	*--------------------------------------------------------------------------------------------------------
	...
	do case
		...
		case this.Tipocomprobante = 2
			this.cComprobante = "TICKETFACTURA"
			this.lImprimeNumeroDeDespachoDeArticulos = .T.
			this.lPermiteComprobanteAsociado = .f.
			this.lEsComprobanteConEntregaPosterior = .T.
			...
			if vartype( this.oComponenteFiscal ) != "O" or ( vartype( this.oComponenteFiscal ) == "O" and lower(right(this.oComponenteFiscal.class,9)) == "argentina" )
			this.oComponenteFiscal = _screen.Zoo.CrearObjeto( "ComponenteFiscalTicketChile", "ComponenteFiscalTicketChile.prg", this.cComprobante )
			endif
			endif
		...
		case this.Tipocomprobante = 27
			this.cComprobante = "FACTURAELECTRONICA"
			this.lImprimeNumeroDeDespachoDeArticulos = .T.
			this.lPermiteComprobanteAsociado = .f.
			this.lEsComprobanteConEntregaPosterior = .T.
			this.lAnularConUsuarioRestringido = .f.
	...
	*--------------------------------------------------------------------------------------------------------
	...
	do case
		case this.Tipocomprobante = 1
			...
			llRetorno = DoDefault()
			If llRetorno And This.EsNuevo()
			This.ImprimirOrdenDeCompra()
			Endif
			
		case this.Tipocomprobante = 2
			local llRetorno as Boolean, llImprimeTicket as Boolean
			
			llRetorno = dodefault()
			If llRetorno and this.EsNuevo() and !this.llFalloAlImprimir
			if this.nPais = 1
			llRetorno = this.ImprimirTicketParaCambio()
			else
			if goParametros.Felino.ControladoresFiscales.ComprobanteParaCambios.HabilitarImpresionEnFacturaFiscal > 1
			this.oComponenteFiscal.ImprimeTicketParaCambio = .t.
								
			if goParametros.Felino.ControladoresFiscales.ComprobanteParaCambios.HabilitarImpresionEnFacturaFiscal > 2
			this.oComponenteFiscal.EventoPreguntarImprimirticketParaCambio()
			endif	
			
			if this.oComponenteFiscal.ImprimeTicketParaCambio
			llRetorno = this.ImprimirTicketParaCambio()
			endif
			endif					
			endif
			
			if this.ColaboradorImpresionTicketAdicional.DeboImprimirTicketAdicional( this.oMensaje )
			loDatosImpresion = this.ArmardorObjetoImpresionTicketAdicional.Armar( this )
			llRetorno = this.oComponenteFiscal.ImprimirTicketAdicional( loDatosImpresion  )
			endif
						
			endif
					
		case this.Tipocomprobante = 27
			Local loError as Object, lcNCGeneradaConCAE as String, llRetorno as Boolean
			lcNcGeneradaConCAE = ""
			llRetorno = .t.
			try
			dodefault()
			if this.lGeneraNotaDeCreditoPorDevolucion and !empty(this.CAE)
			this.PedirCaeNotaDeCreditoPorDevolucion()
			lcNCGeneradaConCAE = this.ObtenerInfoNotaDeCreditoGenerada()
			If Empty( lcNCGeneradaConCAE )
			this.EventoInformarNotaDeCreditoSinCAE()
			else
			this.oColaboradorComprobantesElectronicos.EjecutarAccionesNCDespuesDeGrabar()
			Endif
			endif
			Catch To loError
			if this.lGeneraNotaDeCreditoPorDevolucion
			If this.oColaboradorComprobantesElectronicos.ComprobanteGeneradoOK()
			lcNcGeneradaConCAE = this.ObtenerInfoNotaDeCreditoGenerada()
			If Empty( lcNcGeneradaConCAE )
			if empty( this.CAE )
			this.EliminarNCPorErrorEnFactura()
			else
			this.EventoInformarNotaDeCreditoSinCAE()
			endif
			Endi
	...
	*--------------------------------------------------------------------------------------------------------
	 function cDespachos_Access() as variant
	
	do case
		case this.Tipocomprobante = 1
			if !this.ldestroy and vartype( this.cDespachos ) = 'C'
		...
		case this.Tipocomprobante = 27
			...
			Endif
		otherwise
			This.cDespachos = dodefault()
	EndCase
	return This.cDespachos
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasCuponNuevoOPreexistente( toColSentencias as zoocoleccion,  toCupon as entidad,  toItemValor as Object ) as Void
	...
	do case
		case this.Tipocomprobante = 1
			...
			this.SalvarInconsistenciaDeTipoDeValorCeroSinGuid( toItemValor )
			
		otherwise
			dodefault(toColSentencias ,toCupon ,toItemValor)
	EndCase
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	...
	do case
		case this.Tipocomprobante = 2
			* Esto es un parche contra el Bug Nº 953 y Bug Nº 699 de ZL.
			* Creemos que el origen del bug es la velocidad de la PC.
			* El cliente Tiene mas hardware del que tenemos en I+D para poder reproducirlo
			dodefault()
			if goParametros.felino.geneRALES.habilitarCompatibilidadDeMemoriaParaFacturaFiscal
			inkey( 2 )
			endif
			* Esto es un parche contra el Bug Nº 953 y Bug Nº 699 de ZL		
		otherwise
	...
	*--------------------------------------------------------------------------------------------------------
	...
	do case
		case this.Tipocomprobante = 2
			local llRetorno as Boolean, lnHabilitaImpresion as Integer
			...
			if llRetorno and this.EsNuevo() and goParametros.Felino.ControladoresFiscales.ImprimirChequesDespuesDeGrabar > 1 and ;
			this.nControladoraFiscal = 30
	...
	*--------------------------------------------------------------------------------------------------------
	 function ArmardorObjetoImpresionTicketAdicional_Access() as variant
	
	do case
		case this.Tipocomprobante = 2
			if !this.ldestroy and ( !vartype( this.ArmardorObjetoImpresionTicketAdicional ) = 'O' or isnull( this.ArmardorObjetoImpresionTicketAdicional ) )
			this.ArmardorObjetoImpresionTicketAdicional = _screen.zoo.crearobjeto( 'ArmardorObjetoImpresionTicketAdicional' )
			endif	
		otherwise
			this.ArmardorObjetoImpresionTicketAdicional = dodefault()
	EndCase
	return this.ArmardorObjetoImpresionTicketAdicional
	endfunc

	*--------------------------------------------------------------------------------------------------------
	 function ColaboradorImpresionTicketAdicional_Access() as variant
	
	do case
		case this.Tipocomprobante = 2
			if !this.ldestroy and ( !vartype( this.ColaboradorImpresionTicketAdicional) = 'O' or isnull( this.ColaboradorImpresionTicketAdicional) )
			this.ColaboradorImpresionTicketAdicional= _screen.zoo.crearobjeto( 'ColaboradorImpresionTicketAdicional' )
			endif	
		otherwise
			this.ColaboradorImpresionTicketAdicional = dodefault()
	EndCase
	return this.ColaboradorImpresionTicketAdicional
	endfunc

	*--------------------------------------------------------------------------------------------------------
	 function ValidarClienteYControladora() as Void
	
	do case
		case this.Tipocomprobante = 2
			
			if (goParametros.Felino.ControladoresFiscales.Codigo > 0 and ;
			vartype( goControladorFiscal ) = 'O' and !isnull( goControladorFiscal ) and ;
			gocontroladorfiscal.ocaracteristicas.cmodelo = "P-272F" and ;
			!empty( this.cliente_pk ) and this.cliente.situacionfiscal_pk = 1 and ;
			GOPARAMETROS.FELINO.DATOSGENERALES.SITUACIONFISCAL = 1 ) &&and ( this.EsNuevo() or this.EsEdicion() )
			
			lcMensaje = "No se puede realizar un Ticket-Factura 'A' en el controlador fiscal HASAR SMH/PT-272F."
			goServicios.Errores.LevantarExcepcion( lcMensaje )
			endif	
		otherwise
			dodefault()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	do case
		case this.Tipocomprobante = 27
			...
			llRetorno = dodefault()
			try
			llRetorno = llRetorno and this.VerificarGeneracionDeNCPorDevolucion()
			catch to loError
			llRetorno = .f.
			goServicios.Errores.LevantarExcepcion( loError )
			endtry
	...
	*--------------------------------------------------------------------------------------------------------
	...
	do case
		case this.Tipocomprobante = 27
			...
			if pemstatus(goparametros,"colorytalle",5)
			llRet = goparametros.colorytalle.facturaelectronica.ENVIOAUTOMATICODEEMAILALFINALIZARLAIMPORTACION
			endif
		otherwise
			llRet = dodefault()
	EndCase
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AgregarParametrosInicializar()
		this.AddProperty( 'nPais', 0)
		this.AddProperty( 'nControladoraFiscal', 0)
		this.AddProperty( 'ArmardorObjetoImpresionTicketAdicional', null)
		this.AddProperty( 'ColaboradorImpresionTicketAdicional', null)
