	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.OPECOM ( "Fmodifw","Fectrans","Fecimpo","Fecexpo","Faltafw","Valtafw","Esttrans","Vmodifw","Bdmodifw","Bdaltafw","Haltafw","Umodifw","Smodifw","Hmodifw","Horaimpo","Ualtafw","Saltafw","Horaexpo","Idenvio","Idcomp","Logistic","Cant","Ecommerce","Codigo","Fecha","Hora","Penproc","Mlfulle","Packid","Storeorder","Podesc","Numero","Pagado","Fpago","Urlecomm","Mondesc","Cliecom","Mondes2","Cliedragon","Porrec","Envio","Monrec","Telenvio","Pago","Monrec2","Zadsfw","Retiro","Optotal","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxOpecomFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpecomFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpecomFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpecomFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpecomFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomIdenvio ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomIdcomp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomLogistic ) + "'" >>, <<lxOpecomCant >>, <<"'" + this.FormatearTextoSql( lxOpecomEcommerce ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomCodigo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpecomFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomHora ) + "'" >>, <<iif( lxOpecomPenproc, 1, 0 ) >>, <<iif( lxOpecomMlfulle, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxOpecomPackid ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomStoreorder ) + "'" >>, <<lxOpecomPodesc >>, <<"'" + this.FormatearTextoSql( lxOpecomNumero ) + "'" >>, <<iif( lxOpecomPagado, 1, 0 ) >>, <<"'" + this.ConvertirDateSql( lxOpecomFpago ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomUrlecomm ) + "'" >>, <<lxOpecomMondesc >>, <<"'" + this.FormatearTextoSql( lxOpecomCliecom ) + "'" >>, <<lxOpecomMondes2 >>, <<"'" + this.FormatearTextoSql( lxOpecomCliedragon ) + "'" >>, <<lxOpecomPorrec >>, <<"'" + this.FormatearTextoSql( lxOpecomEnvio ) + "'" >>, <<lxOpecomMonrec >>, <<"'" + this.FormatearTextoSql( lxOpecomTelenvio ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomPago ) + "'" >>, <<lxOpecomMonrec2 >>, <<"'" + this.FormatearTextoSql( lxOpecomZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpecomRetiro ) + "'" >>, <<lxOpecomOptotal >>, <<"'" + this.FormatearTextoSql( lxOpecomObs ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.PublicacionDetalle
				if this.oEntidad.PublicacionDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.OPECOMDET("IDPUB","STOREORDER","NumOpe","NumOpeCan","NROITEM","CodHerrCan","COMP","CODIGO","DESCRI","OPART","ARTDET","OPCOLOR","COLDET","OPTALLE","CANT","PRECIO","PORDESC","MONDESC","MONTO","FecCan" ) values ( <<"'" + this.FormatearTextoSql( lxIdpublicacion ) + "'">>, <<"'" + this.FormatearTextoSql( lxStoreorderid ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerooperacion ) + "'">>, <<"'" + this.FormatearTextoSql( lxNrooperacioncancelacion ) + "'">>, <<lxNroitem>>, <<lxCodigoherrcancelacion>>, <<lxComportamiento>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxDescripcion ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>>, <<lxPrecio>>, <<lxDescuento>>, <<lxMontodescuento>>, <<lxMonto>>, <<"'" + this.ConvertirDateSql( lxFechacancelacion ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.OPECOM set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxOpecomFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxOpecomFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxOpecomFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxOpecomFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxOpecomFaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxOpecomValtafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxOpecomEsttrans ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxOpecomVmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxOpecomBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxOpecomBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxOpecomHaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxOpecomUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxOpecomSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxOpecomHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxOpecomHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxOpecomUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxOpecomSaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxOpecomHoraexpo ) + "'">>,"Idenvio" = <<"'" + this.FormatearTextoSql( lxOpecomIdenvio ) + "'">>,"Idcomp" = <<"'" + this.FormatearTextoSql( lxOpecomIdcomp ) + "'">>,"Logistic" = <<"'" + this.FormatearTextoSql( lxOpecomLogistic ) + "'">>,"Cant" = <<lxOpecomCant>>,"Ecommerce" = <<"'" + this.FormatearTextoSql( lxOpecomEcommerce ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxOpecomCodigo ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxOpecomFecha ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxOpecomHora ) + "'">>,"Penproc" = <<iif( lxOpecomPenproc, 1, 0 )>>,"Mlfulle" = <<iif( lxOpecomMlfulle, 1, 0 )>>,"Packid" = <<"'" + this.FormatearTextoSql( lxOpecomPackid ) + "'">>,"Storeorder" = <<"'" + this.FormatearTextoSql( lxOpecomStoreorder ) + "'">>,"Podesc" = <<lxOpecomPodesc>>,"Numero" = <<"'" + this.FormatearTextoSql( lxOpecomNumero ) + "'">>,"Pagado" = <<iif( lxOpecomPagado, 1, 0 )>>,"Fpago" = <<"'" + this.ConvertirDateSql( lxOpecomFpago ) + "'">>,"Urlecomm" = <<"'" + this.FormatearTextoSql( lxOpecomUrlecomm ) + "'">>,"Mondesc" = <<lxOpecomMondesc>>,"Cliecom" = <<"'" + this.FormatearTextoSql( lxOpecomCliecom ) + "'">>,"Mondes2" = <<lxOpecomMondes2>>,"Cliedragon" = <<"'" + this.FormatearTextoSql( lxOpecomCliedragon ) + "'">>,"Porrec" = <<lxOpecomPorrec>>,"Envio" = <<"'" + this.FormatearTextoSql( lxOpecomEnvio ) + "'">>,"Monrec" = <<lxOpecomMonrec>>,"Telenvio" = <<"'" + this.FormatearTextoSql( lxOpecomTelenvio ) + "'">>,"Pago" = <<"'" + this.FormatearTextoSql( lxOpecomPago ) + "'">>,"Monrec2" = <<lxOpecomMonrec2>>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxOpecomZadsfw ) + "'">>,"Retiro" = <<"'" + this.FormatearTextoSql( lxOpecomRetiro ) + "'">>,"Optotal" = <<lxOpecomOptotal>>,"Obs" = <<"'" + this.FormatearTextoSql( lxOpecomObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxOpecomCodigo ) + "'">> and  OPECOM.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Vmodifw" as "Versionmodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Idenvio" as "Envioid", "Idcomp" as "Comprobanteid", "Logistic" as "Logistictype", "Cant" as "Cantidadtotal", "Ecommerce" as "Ecommerce", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Penproc" as "Pendientedeprocesar", "Mlfulle" as "Mlfullenvios", "Packid" as "Packid", "Storeorder" as "Storeorderid", "Podesc" as "Descuentoporcentaje", "Numero" as "Numero", "Pagado" as "Pagado", "Fpago" as "Fechadepago", "Urlecomm" as "Linkoperacionecommerce", "Mondesc" as "Descuentomonto", "Cliecom" as "Clienteecom", "Mondes2" as "Descuentomonto2", "Cliedragon" as "Clientedragon", "Porrec" as "Recargoporcentaje", "Envio" as "Datosenvio", "Monrec" as "Recargomonto", "Telenvio" as "Telefonoenvio", "Pago" as "Datospago", "Monrec2" as "Recargomonto2", "Zadsfw" as "Zadsfw", "Retiro" as "Datosretiro", "Optotal" as "Total", "Obs" as "Obs" from ZooLogic.OPECOM where "Codigo" = <<"'" + this.FormatearTextoSql( lxOpecomCodigo ) + "'">> and  OPECOM.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Idpub" as "Idpublicacion", "Storeorder" as "Storeorderid", "Numope" as "Numerooperacion", "Numopecan" as "Nrooperacioncancelacion", "Nroitem" as "Nroitem", "Codherrcan" as "Codigoherrcancelacion", "Comp" as "Comportamiento", "Codigo" as "Codigo", "Descri" as "Descripcion", "Opart" as "Articulo", "Artdet" as "Articulodetalle", "Opcolor" as "Color", "Coldet" as "Colordetalle", "Optalle" as "Talle", "Cant" as "Cantidad", "Precio" as "Precio", "Pordesc" as "Descuento", "Mondesc" as "Montodescuento", "Monto" as "Monto", "Feccan" as "Fechacancelacion" from ZooLogic.OPECOMDET where CODIGO = <<"'" + this.FormatearTextoSql( c_OPERACIONECOMMERCE.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Vmodifw" as "Versionmodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Idenvio" as "Envioid", "Idcomp" as "Comprobanteid", "Logistic" as "Logistictype", "Cant" as "Cantidadtotal", "Ecommerce" as "Ecommerce", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Penproc" as "Pendientedeprocesar", "Mlfulle" as "Mlfullenvios", "Packid" as "Packid", "Storeorder" as "Storeorderid", "Podesc" as "Descuentoporcentaje", "Numero" as "Numero", "Pagado" as "Pagado", "Fpago" as "Fechadepago", "Urlecomm" as "Linkoperacionecommerce", "Mondesc" as "Descuentomonto", "Cliecom" as "Clienteecom", "Mondes2" as "Descuentomonto2", "Cliedragon" as "Clientedragon", "Porrec" as "Recargoporcentaje", "Envio" as "Datosenvio", "Monrec" as "Recargomonto", "Telenvio" as "Telefonoenvio", "Pago" as "Datospago", "Monrec2" as "Recargomonto2", "Zadsfw" as "Zadsfw", "Retiro" as "Datosretiro", "Optotal" as "Total", "Obs" as "Obs" from ZooLogic.OPECOM where  OPECOM.CODIGO != '' And NUMERO = <<"'" + this.FormatearTextoSql( lxOPECOMNUMERO ) + "'">> and ECOMMERCE = <<"'" + this.FormatearTextoSql( lxOPECOMECOMMERCE ) + "'">>
			endtext
			use in select('c_OPERACIONECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_OPERACIONECOMMERCE', set( 'Datasession' ) )
			if reccount( 'c_OPERACIONECOMMERCE' ) = 0
	...
	Function Primero() As Boolean
		...
		try
			With This.oEntidad
				...
				lcOrden =   iif( empty( .Fecha ), dtos( evaluate( goRegistry.Nucleo.FechaEnBlancoParaSqlServer ) ), dtos( .Fecha ) ) + .Hora + .Codigo
			local lcSentencia as string

			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Vmodifw" as "Versionmodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Idenvio" as "Envioid", "Idcomp" as "Comprobanteid", "Logistic" as "Logistictype", "Cant" as "Cantidadtotal", "Ecommerce" as "Ecommerce", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Penproc" as "Pendientedeprocesar", "Mlfulle" as "Mlfullenvios", "Packid" as "Packid", "Storeorder" as "Storeorderid", "Podesc" as "Descuentoporcentaje", "Numero" as "Numero", "Pagado" as "Pagado", "Fpago" as "Fechadepago", "Urlecomm" as "Linkoperacionecommerce", "Mondesc" as "Descuentomonto", "Cliecom" as "Clienteecom", "Mondes2" as "Descuentomonto2", "Cliedragon" as "Clientedragon", "Porrec" as "Recargoporcentaje", "Envio" as "Datosenvio", "Monrec" as "Recargomonto", "Telenvio" as "Telefonoenvio", "Pago" as "Datospago", "Monrec2" as "Recargomonto2", "Zadsfw" as "Zadsfw", "Retiro" as "Datosretiro", "Optotal" as "Total", "Obs" as "Obs" from ZooLogic.OPECOM where  OPECOM.CODIGO != '' order by FECHA,HORA,CODIGO
			endtext
			use in select('c_OPERACIONECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_OPERACIONECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Vmodifw" as "Versionmodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Idenvio" as "Envioid", "Idcomp" as "Comprobanteid", "Logistic" as "Logistictype", "Cant" as "Cantidadtotal", "Ecommerce" as "Ecommerce", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Penproc" as "Pendientedeprocesar", "Mlfulle" as "Mlfullenvios", "Packid" as "Packid", "Storeorder" as "Storeorderid", "Podesc" as "Descuentoporcentaje", "Numero" as "Numero", "Pagado" as "Pagado", "Fpago" as "Fechadepago", "Urlecomm" as "Linkoperacionecommerce", "Mondesc" as "Descuentomonto", "Cliecom" as "Clienteecom", "Mondes2" as "Descuentomonto2", "Cliedragon" as "Clientedragon", "Porrec" as "Recargoporcentaje", "Envio" as "Datosenvio", "Monrec" as "Recargomonto", "Telenvio" as "Telefonoenvio", "Pago" as "Datospago", "Monrec2" as "Recargomonto2", "Zadsfw" as "Zadsfw", "Retiro" as "Datosretiro", "Optotal" as "Total", "Obs" as "Obs" from ZooLogic.OPECOM where  funciones.dtos( FECHA ) + funciones.padr( HORA, 5, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  OPECOM.CODIGO != '' order by FECHA,HORA,CODIGO
			endtext
			use in select('c_OPERACIONECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_OPERACIONECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Vmodifw" as "Versionmodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Idenvio" as "Envioid", "Idcomp" as "Comprobanteid", "Logistic" as "Logistictype", "Cant" as "Cantidadtotal", "Ecommerce" as "Ecommerce", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Penproc" as "Pendientedeprocesar", "Mlfulle" as "Mlfullenvios", "Packid" as "Packid", "Storeorder" as "Storeorderid", "Podesc" as "Descuentoporcentaje", "Numero" as "Numero", "Pagado" as "Pagado", "Fpago" as "Fechadepago", "Urlecomm" as "Linkoperacionecommerce", "Mondesc" as "Descuentomonto", "Cliecom" as "Clienteecom", "Mondes2" as "Descuentomonto2", "Cliedragon" as "Clientedragon", "Porrec" as "Recargoporcentaje", "Envio" as "Datosenvio", "Monrec" as "Recargomonto", "Telenvio" as "Telefonoenvio", "Pago" as "Datospago", "Monrec2" as "Recargomonto2", "Zadsfw" as "Zadsfw", "Retiro" as "Datosretiro", "Optotal" as "Total", "Obs" as "Obs" from ZooLogic.OPECOM where  funciones.dtos( FECHA ) + funciones.padr( HORA, 5, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  OPECOM.CODIGO != '' order by FECHA desc,HORA desc,CODIGO desc
			endtext
			use in select('c_OPERACIONECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_OPERACIONECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Vmodifw" as "Versionmodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Idenvio" as "Envioid", "Idcomp" as "Comprobanteid", "Logistic" as "Logistictype", "Cant" as "Cantidadtotal", "Ecommerce" as "Ecommerce", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Penproc" as "Pendientedeprocesar", "Mlfulle" as "Mlfullenvios", "Packid" as "Packid", "Storeorder" as "Storeorderid", "Podesc" as "Descuentoporcentaje", "Numero" as "Numero", "Pagado" as "Pagado", "Fpago" as "Fechadepago", "Urlecomm" as "Linkoperacionecommerce", "Mondesc" as "Descuentomonto", "Cliecom" as "Clienteecom", "Mondes2" as "Descuentomonto2", "Cliedragon" as "Clientedragon", "Porrec" as "Recargoporcentaje", "Envio" as "Datosenvio", "Monrec" as "Recargomonto", "Telenvio" as "Telefonoenvio", "Pago" as "Datospago", "Monrec2" as "Recargomonto2", "Zadsfw" as "Zadsfw", "Retiro" as "Datosretiro", "Optotal" as "Total", "Obs" as "Obs" from ZooLogic.OPECOM where  OPECOM.CODIGO != '' order by FECHA desc,HORA desc,CODIGO desc
			endtext
			use in select('c_OPERACIONECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_OPERACIONECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Valtafw,Esttrans,Vmodifw,Bdmodifw,Bdaltafw,Haltafw," + ;
"Umodifw,Smodifw,Hmodifw,Horaimpo,Ualtafw,Saltafw,Horaexpo,Idenvio,Idcomp,Logistic,Cant,Ecommerce,Cod" + ;
"igo,Fecha,Hora,Penproc,Mlfulle,Packid,Storeorder,Podesc,Numero,Pagado,Fpago,Urlecomm,Mondesc,Cliecom" + ;
",Mondes2,Cliedragon,Porrec,Envio,Monrec,Telenvio,Pago,Monrec2,Zadsfw,Retiro,Optotal,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Vmodifw" as "Versionmodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Idenvio" as "Envioid", "Idcomp" as "Comprobanteid", "Logistic" as "Logistictype", "Cant" as "Cantidadtotal", "Ecommerce" as "Ecommerce", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Penproc" as "Pendientedeprocesar", "Mlfulle" as "Mlfullenvios", "Packid" as "Packid", "Storeorder" as "Storeorderid", "Podesc" as "Descuentoporcentaje", "Numero" as "Numero", "Pagado" as "Pagado", "Fpago" as "Fechadepago", "Urlecomm" as "Linkoperacionecommerce", "Mondesc" as "Descuentomonto", "Cliecom" as "Clienteecom", "Mondes2" as "Descuentomonto2", "Cliedragon" as "Clientedragon", "Porrec" as "Recargoporcentaje", "Envio" as "Datosenvio", "Monrec" as "Recargomonto", "Telenvio" as "Telefonoenvio", "Pago" as "Datospago", "Monrec2" as "Recargomonto2", "Zadsfw" as "Zadsfw", "Retiro" as "Datosretiro", "Optotal" as "Total", "Obs" as "Obs"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetallePublicacionDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Idpub" as "Idpublicacion", "Storeorder" as "Storeorderid", "Numope" as "Numerooperacion", "Numopecan" as "Nrooperacioncancelacion", "Nroitem" as "Nroitem", "Codherrcan" as "Codigoherrcancelacion", "Comp" as "Comportamiento", "Codigo" as "Codigo", "Descri" as "Descripcion", "Opart" as "Articulo", "Artdet" as "Articulodetalle", "Opcolor" as "Color", "Coldet" as "Colordetalle", "Optalle" as "Talle", "Cant" as "Cantidad", "Precio" as "Precio", "Pordesc" as "Descuento", "Mondesc" as "Montodescuento", "Monto" as "Monto", "Feccan" as "Fechacancelacion"
				endtext
			Else
	...
	Function ObtenerCamposSelectEntidad( tcCampos As String ) As String
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			...
			Do Case
				...
				Case lcAtributo == 'DATOSRETIRO'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'RETIRO AS DATOSRETIRO'
	...
	Function ObtenerCampoEntidad( tcAtributo As String ) As String
		...
		Do Case
			...
			Case upper( alltrim( tcAtributo ) ) == 'ZADSFW'
				lcCampo = 'ZADSFW'
			Case upper( alltrim( tcAtributo ) ) == 'DATOSRETIRO'
				lcCampo = 'RETIRO'
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.OPECOM set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxOpecomFmodifw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxOpecomFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxOpecomFecimpo ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxOpecomFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxOpecomFaltafw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxOpecomValtafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxOpecomEsttrans ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxOpecomVmodifw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxOpecomBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxOpecomBdaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxOpecomHaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxOpecomUmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxOpecomSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxOpecomHmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxOpecomHoraimpo ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxOpecomUaltafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxOpecomSaltafw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxOpecomHoraexpo ) + "'">>, "Idenvio" = <<"'" + this.FormatearTextoSql( lxOpecomIdenvio ) + "'">>, "Idcomp" = <<"'" + this.FormatearTextoSql( lxOpecomIdcomp ) + "'">>, "Logistic" = <<"'" + this.FormatearTextoSql( lxOpecomLogistic ) + "'">>, "Cant" = <<lxOpecomCant>>, "Ecommerce" = <<"'" + this.FormatearTextoSql( lxOpecomEcommerce ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxOpecomCodigo ) + "'">>, "Fecha" = <<"'" + this.ConvertirDateSql( lxOpecomFecha ) + "'">>, "Hora" = <<"'" + this.FormatearTextoSql( lxOpecomHora ) + "'">>, "Penproc" = <<iif( lxOpecomPenproc, 1, 0 )>>, "Mlfulle" = <<iif( lxOpecomMlfulle, 1, 0 )>>, "Packid" = <<"'" + this.FormatearTextoSql( lxOpecomPackid ) + "'">>, "Storeorder" = <<"'" + this.FormatearTextoSql( lxOpecomStoreorder ) + "'">>, "Podesc" = <<lxOpecomPodesc>>, "Numero" = <<"'" + this.FormatearTextoSql( lxOpecomNumero ) + "'">>, "Pagado" = <<iif( lxOpecomPagado, 1, 0 )>>, "Fpago" = <<"'" + this.ConvertirDateSql( lxOpecomFpago ) + "'">>, "Urlecomm" = <<"'" + this.FormatearTextoSql( lxOpecomUrlecomm ) + "'">>, "Mondesc" = <<lxOpecomMondesc>>, "Cliecom" = <<"'" + this.FormatearTextoSql( lxOpecomCliecom ) + "'">>, "Mondes2" = <<lxOpecomMondes2>>, "Cliedragon" = <<"'" + this.FormatearTextoSql( lxOpecomCliedragon ) + "'">>, "Porrec" = <<lxOpecomPorrec>>, "Envio" = <<"'" + this.FormatearTextoSql( lxOpecomEnvio ) + "'">>, "Monrec" = <<lxOpecomMonrec>>, "Telenvio" = <<"'" + this.FormatearTextoSql( lxOpecomTelenvio ) + "'">>, "Pago" = <<"'" + this.FormatearTextoSql( lxOpecomPago ) + "'">>, "Monrec2" = <<lxOpecomMonrec2>>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxOpecomZadsfw ) + "'">>, "Retiro" = <<"'" + this.FormatearTextoSql( lxOpecomRetiro ) + "'">>, "Optotal" = <<lxOpecomOptotal>>, "Obs" = <<"'" + this.FormatearTextoSql( lxOpecomObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'OPECOM' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.CODIGO or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.OPECOM set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, IdEnvio = ] + "'" + this.FormatearTextoSql( &lcCursor..IdEnvio ) + "'"+ [, IDCOMP = ] + "'" + this.FormatearTextoSql( &lcCursor..IDCOMP ) + "'"+ [, Logistic = ] + "'" + this.FormatearTextoSql( &lcCursor..Logistic ) + "'"+ [, CANT = ] + transform( &lcCursor..CANT )+ [, ECOMMERCE = ] + "'" + this.FormatearTextoSql( &lcCursor..ECOMMERCE ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, FECHA = ] + "'" + this.ConvertirDateSql( &lcCursor..FECHA ) + "'"+ [, HORA = ] + "'" + this.FormatearTextoSql( &lcCursor..HORA ) + "'"+ [, PenProc = ] + Transform( iif( &lcCursor..PenProc, 1, 0 ))+ [, MLFULLE = ] + Transform( iif( &lcCursor..MLFULLE, 1, 0 ))+ [, PACKID = ] + "'" + this.FormatearTextoSql( &lcCursor..PACKID ) + "'"+ [, STOREORDER = ] + "'" + this.FormatearTextoSql( &lcCursor..STOREORDER ) + "'"+ [, PODESC = ] + transform( &lcCursor..PODESC )+ [, NUMERO = ] + "'" + this.FormatearTextoSql( &lcCursor..NUMERO ) + "'"+ [, PAGADO = ] + Transform( iif( &lcCursor..PAGADO, 1, 0 ))+ [, FPAGO = ] + "'" + this.ConvertirDateSql( &lcCursor..FPAGO ) + "'"+ [, UrlEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..UrlEcomm ) + "'"+ [, MONDESC = ] + transform( &lcCursor..MONDESC )+ [, CLIECOM = ] + "'" + this.FormatearTextoSql( &lcCursor..CLIECOM ) + "'"+ [, MONDES2 = ] + transform( &lcCursor..MONDES2 )+ [, CLIEDRAGON = ] + "'" + this.FormatearTextoSql( &lcCursor..CLIEDRAGON ) + "'"+ [, PORREC = ] + transform( &lcCursor..PORREC )+ [, ENVIO = ] + "'" + this.FormatearTextoSql( &lcCursor..ENVIO ) + "'"+ [, MONREC = ] + transform( &lcCursor..MONREC )+ [, TELENVIO = ] + "'" + this.FormatearTextoSql( &lcCursor..TELENVIO ) + "'"+ [, PAGO = ] + "'" + this.FormatearTextoSql( &lcCursor..PAGO ) + "'"+ [, MONREC2 = ] + transform( &lcCursor..MONREC2 )+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, RETIRO = ] + "'" + this.FormatearTextoSql( &lcCursor..RETIRO ) + "'"+ [, OPTOTAL = ] + transform( &lcCursor..OPTOTAL )+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FMODIFW, FECTRANS, FECIMPO, FECEXPO, FALTAFW, VALTAFW, ESTTRANS, VMODIFW, BDMODIFW, BDALTAFW, HALTAFW, UMODIFW, SMODIFW, HMODIFW, HORAIMPO, UALTAFW, SALTAFW, HORAEXPO, IdEnvio, IDCOMP, Logistic, CANT, ECOMMERCE, CODIGO, FECHA, HORA, PenProc, MLFULLE, PACKID, STOREORDER, PODESC, NUMERO, PAGADO, FPAGO, UrlEcomm, MONDESC, CLIECOM, MONDES2, CLIEDRAGON, PORREC, ENVIO, MONREC, TELENVIO, PAGO, MONREC2, ZADSFW, RETIRO, OPTOTAL, OBS
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdEnvio ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..IDCOMP ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Logistic ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..CANT ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ECOMMERCE ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECHA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORA ) + "'" + ',' + Transform( iif( &lcCursor..PenProc, 1, 0 )) + ',' + Transform( iif( &lcCursor..MLFULLE, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..PACKID ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..STOREORDER ) + "'" + ',' + transform( &lcCursor..PODESC ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..NUMERO ) + "'" + ',' + Transform( iif( &lcCursor..PAGADO, 1, 0 )) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FPAGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UrlEcomm ) + "'" + ',' + transform( &lcCursor..MONDESC ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CLIECOM ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..MONDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CLIEDRAGON ) + "'" + ',' + transform( &lcCursor..PORREC ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ENVIO ) + "'" + ',' + transform( &lcCursor..MONREC ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..TELENVIO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..PAGO ) + "'" + ',' + transform( &lcCursor..MONREC2 )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..RETIRO ) + "'" + ',' + transform( &lcCursor..OPTOTAL ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"IDPUB","STOREORDER","NumOpe","NumOpeCan","NROITEM","CodHerrCan","COMP","CODIGO","DESCRI","OPART","ARTDET","OPCOLOR","COLDET","OPTALLE","CANT","PRECIO","PORDESC","MONDESC","MONTO","FecCan"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.OPECOMDET ( ] + lcCamposInsert + [ ) values ( ] +  "'" + this.FormatearTextoSql( cDetallesExistentes.IDPUB      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.STOREORDER ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NumOpe     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NumOpeCan  ) + "'" + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + transform( cDetallesExistentes.CodHerrCan ) + ',' + transform( cDetallesExistentes.COMP       ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.CODIGO     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.DESCRI     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPART      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ARTDET     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPCOLOR    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.COLDET     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPTALLE    ) + "'" + ',' + transform( cDetallesExistentes.CANT       ) + ',' + transform( cDetallesExistentes.PRECIO     ) + ',' + transform( cDetallesExistentes.PORDESC    ) + ',' + transform( cDetallesExistentes.MONDESC    ) + ',' + transform( cDetallesExistentes.MONTO      ) + ',' + "'" + this.ConvertirDateSql( cDetallesExistentes.FecCan     ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.IDENVIO = isnull( d.IDENVIO, t.IDENVIO ),t.IDCOMP = isnull( d.IDCOMP, t.IDCOMP ),t.LOGISTIC = isnull( d.LOGISTIC, t.LOGISTIC ),t.CANT = isnull( d.CANT, t.CANT ),t.ECOMMERCE = isnull( d.ECOMMERCE, t.ECOMMERCE ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.HORA = isnull( d.HORA, t.HORA ),t.PENPROC = isnull( d.PENPROC, t.PENPROC ),t.MLFULLE = isnull( d.MLFULLE, t.MLFULLE ),t.PACKID = isnull( d.PACKID, t.PACKID ),t.STOREORDER = isnull( d.STOREORDER, t.STOREORDER ),t.PODESC = isnull( d.PODESC, t.PODESC ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.PAGADO = isnull( d.PAGADO, t.PAGADO ),t.FPAGO = isnull( d.FPAGO, t.FPAGO ),t.URLECOMM = isnull( d.URLECOMM, t.URLECOMM ),t.MONDESC = isnull( d.MONDESC, t.MONDESC ),t.CLIECOM = isnull( d.CLIECOM, t.CLIECOM ),t.MONDES2 = isnull( d.MONDES2, t.MONDES2 ),t.CLIEDRAGON = isnull( d.CLIEDRAGON, t.CLIEDRAGON ),t.PORREC = isnull( d.PORREC, t.PORREC ),t.ENVIO = isnull( d.ENVIO, t.ENVIO ),t.MONREC = isnull( d.MONREC, t.MONREC ),t.TELENVIO = isnull( d.TELENVIO, t.TELENVIO ),t.PAGO = isnull( d.PAGO, t.PAGO ),t.MONREC2 = isnull( d.MONREC2, t.MONREC2 ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.RETIRO = isnull( d.RETIRO, t.RETIRO ),t.OPTOTAL = isnull( d.OPTOTAL, t.OPTOTAL ),t.OBS = isnull( d.OBS, t.OBS )
				...
				-- Fin Updates
				insert into ZooLogic.OPECOM(Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Valtafw,Esttrans,Vmodifw,Bdmodifw,Bdaltafw,Haltafw,Umodifw,Smodifw,Hmodifw,Horaimpo,Ualtafw,Saltafw,Horaexpo,Idenvio,Idcomp,Logistic,Cant,Ecommerce,Codigo,Fecha,Hora,Penproc,Mlfulle,Packid,Storeorder,Podesc,Numero,Pagado,Fpago,Urlecomm,Mondesc,Cliecom,Mondes2,Cliedragon,Porrec,Envio,Monrec,Telenvio,Pago,Monrec2,Zadsfw,Retiro,Optotal,Obs)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.VALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.VMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.IDENVIO,''),isnull( d.IDCOMP,''),isnull( d.LOGISTIC,''),isnull( d.CANT,0),isnull( d.ECOMMERCE,''),isnull( d.CODIGO,''),isnull( d.FECHA,''),isnull( d.HORA,''),isnull( d.PENPROC,0),isnull( d.MLFULLE,0),isnull( d.PACKID,''),isnull( d.STOREORDER,''),isnull( d.PODESC,0),isnull( d.NUMERO,''),isnull( d.PAGADO,0),isnull( d.FPAGO,''),isnull( d.URLECOMM,''),isnull( d.MONDESC,0),isnull( d.CLIECOM,''),isnull( d.MONDES2,0),isnull( d.CLIEDRAGON,''),isnull( d.PORREC,0),isnull( d.ENVIO,''),isnull( d.MONREC,0),isnull( d.TELENVIO,''),isnull( d.PAGO,''),isnull( d.MONREC2,0),isnull( d.ZADSFW,''),isnull( d.RETIRO,''),isnull( d.OPTOTAL,0),isnull( d.OBS,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_OPERACIONECOMMERCE' ) < 1
				...
				Try
					...
					.Zadsfw = lcValor 
					.Datosretiro = nvl( c_OPERACIONECOMMERCE.Datosretiro, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="OPERACIONECOMMERCE                      " atributo="FECHATRANSFERENCIA                      " tabla="OPECOM         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERACIONECOMMERCE                      " atributo="ESTADOTRANSFERENCIA                     " tabla="OPECOM         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERACIONECOMMERCE                      " atributo="FECHADEPAGO                             " tabla="OPECOM         " campo="FPAGO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Fecha de pago                                                                                                                                                   " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="16" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="LINKOPERACIONECOMMERCE                  " tabla="OPECOM         " campo="URLECOMM  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="200" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Enlace a la operación                                                                                                                                           " dominio="WEB                           " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="17" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="DESCUENTOMONTO                          " tabla="OPECOM         " campo="MONDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="12" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Monto % descuento                                                                                                                                               " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="2" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="CLIENTEECOM                             " tabla="OPECOM         " campo="CLIECOM   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTEECOMMERCE                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="4" etiqueta="Cliente ecommerce                                                                                                                                               " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="true" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="DESCUENTOMONTO2                         " tabla="OPECOM         " campo="MONDES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="12" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Monto de descuento                                                                                                                                              " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERACIONECOMMERCE                      " atributo="RECARGOPORCENTAJE                       " tabla="OPECOM         " campo="PORREC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="5" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Recargo porcentaje                                                                                                                                              " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="4" orden="40" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="DATOSENVIO                              " tabla="OPECOM         " campo="ENVIO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Datos de envío                                                                                                                                                  " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="40" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="RECARGOMONTO                            " tabla="OPECOM         " campo="MONREC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="12" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Recargo % monto                                                                                                                                                 " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="4" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="TELEFONOENVIO                           " tabla="OPECOM         " campo="TELENVIO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Teléfono de envío                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="DATOSPAGO                               " tabla="OPECOM         " campo="PAGO      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Datos de pago                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="RECARGOMONTO2                           " tabla="OPECOM         " campo="MONREC2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="12" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="Recargo monto                                                                                                                                                   " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="5" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="ZADSFW                                  " tabla="OPECOM         " campo="ZADSFW    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Acciones del sistema                                                                                                                                            " dominio="OBSERVACION4R                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="8" orden="70" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="OPERACIONECOMMERCE                      " atributo="DATOSRETIRO                             " tabla="OPECOM         " campo="RETIRO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Datos de retiro                                                                                                                                                 " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="70" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERACIONECOMMERCE                      " atributo="OBS                                     " tabla="OPECOM         " campo="OBS       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="428" etiqueta="Observación                                                                                                                                                     " dominio="OBSERVACION4R                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="9" orden="90" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLIENTEECOMMERCE                        " atributo="NOMBRE                                  " tabla="CLIECOM        " campo="NOMBRE    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="5" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLIENTEECOMMERCE                        " atributo="CLIENTEECOMMERCE                        " tabla="CLIECOM        " campo="CLIENECOM " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="429" etiqueta="Cliente ecommerce (Clientes ecommerce)                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
	<row entidad="CLIENTEECOMMERCE                        " atributo="CUENTAECOMMERCE                         " tabla="CLIECOM        " campo="CUENTA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ECOMMERCE                               " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="430" etiqueta="Plataforma (Clientes ecommerce)                                                                                                                                 " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="2" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
	<row entidad="CLIENTEECOMMERCE                        " atributo="CLIENTEDRAGON                           " tabla="CLIECOM        " campo="CLIEDRAGON" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="431" etiqueta="Cliente Dragonfish (Clientes ecommerce)                                                                                                                         " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
	<row entidad="CLIENTEECOMMERCE                        " atributo="APELLIDO                                " tabla="CLIECOM        " campo="APELLIDO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="Apellido (Clientes ecommerce)                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
	<row entidad="CLIENTEECOMMERCE                        " atributo="MAIL                                    " tabla="CLIECOM        " campo="EMAIL     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="433" etiqueta="Mail (Clientes ecommerce)                                                                                                                                       " dominio="MAIL                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
	<row entidad="CLIENTEECOMMERCE                        " atributo="TELEFONO                                " tabla="CLIECOM        " campo="TELEFONO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="434" etiqueta="Teléfono (Clientes ecommerce)                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
	<row entidad="CLIENTEECOMMERCE                        " atributo="TIPODOC                                 " tabla="CLIECOM        " campo="TIPODOC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="435" etiqueta="Tipo de documento (Clientes ecommerce)                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
	<row entidad="CLIENTEECOMMERCE                        " atributo="NRODOC                                  " tabla="CLIECOM        " campo="NRODOC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="436" etiqueta="Número de documento (Clientes ecommerce)                                                                                                                        " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLIECOM On OPECOM.CLIECOM = CLIECOM.numero And  CLIECOM.NUMERO != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="true"/>
</VFPData>
...
<VFPData xml:space="preserve">
	...
	<row entidad="ITEMPUBLICACIONECOM                     " atributo="ARTICULO                                " tabla="OPECOMDET      " campo="OPART     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="203" etiqueta="DetalleOperaciónDetalle, Artículo                                                                                                                               " dominio="CODIGO                        " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join OPECOMDET On OPECOM.CODIGO = OPECOMDET.CODIGO And  OPECOM.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMPUBLICACIONECOM                     " atributo="ARTICULODETALLE                         " tabla="OPECOMDET      " campo="ARTDET    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="204" etiqueta="DetalleOperaciónDetalle, Desc.                                                                                                                                  " dominio="DESCRIPCION                   " detalle="false" tipo="I" atributoforaneo="Articulo.Descripcion                                                                                                                                                                                                                                          " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join OPECOMDET On OPECOM.CODIGO = OPECOMDET.CODIGO And  OPECOM.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMPUBLICACIONECOM                     " atributo="COLOR                                   " tabla="OPECOMDET      " campo="OPCOLOR   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="205" etiqueta="DetalleOperaciónDetalle, Color                                                                                                                                  " dominio="CODIGO                        " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join OPECOMDET On OPECOM.CODIGO = OPECOMDET.CODIGO And  OPECOM.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ITEMPUBLICACIONECOM                     " atributo="MONTODESCUENTO                          " tabla="OPECOMDET      " campo="MONDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="12" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="211" etiqueta="DetalleOperaciónDetalle, Monto de descuento                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join OPECOMDET On OPECOM.CODIGO = OPECOMDET.CODIGO And  OPECOM.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="11" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMPUBLICACIONECOM                     " atributo="MONTO                                   " tabla="OPECOMDET      " campo="MONTO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="212" etiqueta="DetalleOperaciónDetalle, Monto                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join OPECOMDET On OPECOM.CODIGO = OPECOMDET.CODIGO And  OPECOM.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="12" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
