...
define class Din_EntidadCodigodeservicio_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Codigodeservicio"
	cClaseResponse = this.cNamespaceDTOs + ".CodigodeservicioResponse"
	cClaseModelo = "CodigodeservicioModelo"
	cEntidad = "Codigodeservicio"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "CodigodeservicioModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CodigodeservicioListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CodigodeservicioListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "CodigodeservicioModelo"
		endcase
		return lcRetorno
