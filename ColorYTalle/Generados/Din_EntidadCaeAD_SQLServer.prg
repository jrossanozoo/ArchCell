...
define class Din_EntidadCAEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCaeFecimpo, lxCaeFectrans, lxCaeFmodifw, lxCaeFecexpo, lxCaeFaltafw, lxCaeFechavto, lxCaeHoraimpo, lxCaeHmodifw, lxCaeHoraexpo, lxCaeSaltafw, lxCaeHaltafw, lxCaeUaltafw, lxCaeSmodifw, lxCaeVmodifw, lxCaeZadsfw, lxCaeValtafw, lxCaeNumero, lxCaeUmodifw, lxCaeCodbarra, lxCaeInco, lxCaeDgiserie, lxCaeBdmodifw, lxCaeBdaltafw, lxCaeEsttrans, lxCaeResultado, lxCaeDginumero, lxCaeTimestamp, lxCaeCodigocaea, lxCaeCaeainf, lxCaeCodigo, lxCaeMone, lxCaeObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CAE ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Fechavto","Horaimpo","Hmodifw","Horaexpo","Saltafw","Haltafw","Ualtafw","Smodifw","Vmodifw","Zadsfw","Valtafw","Numero","Umodifw","Codbarra","Inco","Dgiserie","Bdmodifw","Bdaltafw","Esttrans","Resultado","Dginumero","Timestamp","Codigocaea","Caeainf","Codigo","Mone","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxCaeFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCaeFechavto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeNumero ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeCodbarra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeInco ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeDgiserie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeResultado ) + "'" >>, <<lxCaeDginumero >>, <<lxCaeTimestamp >>, <<lxCaeCodigocaea >>, <<iif( lxCaeCaeainf, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxCaeCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeMone ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCaeObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CAE set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCaeFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCaeFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCaeFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCaeFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCaeFaltafw ) + "'">>,"Fechavto" = <<"'" + this.ConvertirDateSql( lxCaeFechavto ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCaeHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCaeHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCaeHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCaeSaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCaeHaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCaeUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCaeSmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCaeVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCaeZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCaeValtafw ) + "'">>,"Numero" = <<"'" + this.FormatearTextoSql( lxCaeNumero ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCaeUmodifw ) + "'">>,"Codbarra" = <<"'" + this.FormatearTextoSql( lxCaeCodbarra ) + "'">>,"Inco" = <<"'" + this.FormatearTextoSql( lxCaeInco ) + "'">>,"Dgiserie" = <<"'" + this.FormatearTextoSql( lxCaeDgiserie ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCaeBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCaeBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCaeEsttrans ) + "'">>,"Resultado" = <<"'" + this.FormatearTextoSql( lxCaeResultado ) + "'">>,"Dginumero" = <<lxCaeDginumero>>,"Timestamp" = <<lxCaeTimestamp>>,"Codigocaea" = <<lxCaeCodigocaea>>,"Caeainf" = <<iif( lxCaeCaeainf, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCaeCodigo ) + "'">>,"Mone" = <<"'" + this.FormatearTextoSql( lxCaeMone ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxCaeObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCaeCodigo ) + "'">> and  CAE.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fechavto" as "Fechavencimiento", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Numero" as "Numero", "Umodifw" as "Usuariomodificacionfw", "Codbarra" as "Codigobarracae", "Inco" as "Incoterms", "Dgiserie" as "Dgiserie", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Resultado" as "Resultado", "Dginumero" as "Dginumero", "Timestamp" as "Timestamp", "Codigocaea" as "Codigocaea", "Caeainf" as "Caeainformado", "Codigo" as "Codigo", "Mone" as "Moneda", "Obs" as "Observaciones" from ZooLogic.CAE where "Codigo" = <<"'" + this.FormatearTextoSql( lxCaeCodigo ) + "'">> and  CAE.CODIGO != ''
			endtext
			use in select('c_CAE')
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fechavto" as "Fechavencimiento", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Numero" as "Numero", "Umodifw" as "Usuariomodificacionfw", "Codbarra" as "Codigobarracae", "Inco" as "Incoterms", "Dgiserie" as "Dgiserie", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Resultado" as "Resultado", "Dginumero" as "Dginumero", "Timestamp" as "Timestamp", "Codigocaea" as "Codigocaea", "Caeainf" as "Caeainformado", "Codigo" as "Codigo", "Mone" as "Moneda", "Obs" as "Observaciones" from ZooLogic.CAE where  CAE.CODIGO != '' order by CODIGO
			endtext
			use in select('c_CAE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fechavto" as "Fechavencimiento", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Numero" as "Numero", "Umodifw" as "Usuariomodificacionfw", "Codbarra" as "Codigobarracae", "Inco" as "Incoterms", "Dgiserie" as "Dgiserie", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Resultado" as "Resultado", "Dginumero" as "Dginumero", "Timestamp" as "Timestamp", "Codigocaea" as "Codigocaea", "Caeainf" as "Caeainformado", "Codigo" as "Codigo", "Mone" as "Moneda", "Obs" as "Observaciones" from ZooLogic.CAE where  funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CAE.CODIGO != '' order by CODIGO
			endtext
			use in select('c_CAE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fechavto" as "Fechavencimiento", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Numero" as "Numero", "Umodifw" as "Usuariomodificacionfw", "Codbarra" as "Codigobarracae", "Inco" as "Incoterms", "Dgiserie" as "Dgiserie", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Resultado" as "Resultado", "Dginumero" as "Dginumero", "Timestamp" as "Timestamp", "Codigocaea" as "Codigocaea", "Caeainf" as "Caeainformado", "Codigo" as "Codigo", "Mone" as "Moneda", "Obs" as "Observaciones" from ZooLogic.CAE where  funciones.padr( CODIGO, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CAE.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_CAE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fechavto" as "Fechavencimiento", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Numero" as "Numero", "Umodifw" as "Usuariomodificacionfw", "Codbarra" as "Codigobarracae", "Inco" as "Incoterms", "Dgiserie" as "Dgiserie", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Resultado" as "Resultado", "Dginumero" as "Dginumero", "Timestamp" as "Timestamp", "Codigocaea" as "Codigocaea", "Caeainf" as "Caeainformado", "Codigo" as "Codigo", "Mone" as "Moneda", "Obs" as "Observaciones" from ZooLogic.CAE where  CAE.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_CAE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Fechavto,Horaimpo,Hmodifw,Horaexpo,Saltafw,Haltafw," + ;
"Ualtafw,Smodifw,Vmodifw,Zadsfw,Valtafw,Numero,Umodifw,Codbarra,Inco,Dgiserie,Bdmodifw,Bdaltafw,Esttr" + ;
"ans,Resultado,Dginumero,Timestamp,Codigocaea,Caeainf,Codigo,Mone,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fechavto" as "Fechavencimiento", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Numero" as "Numero", "Umodifw" as "Usuariomodificacionfw", "Codbarra" as "Codigobarracae", "Inco" as "Incoterms", "Dgiserie" as "Dgiserie", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Resultado" as "Resultado", "Dginumero" as "Dginumero", "Timestamp" as "Timestamp", "Codigocaea" as "Codigocaea", "Caeainf" as "Caeainformado", "Codigo" as "Codigo", "Mone" as "Moneda", "Obs" as "Observaciones"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.CAE set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCaeFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxCaeFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxCaeFmodifw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCaeFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxCaeFaltafw ) + "'">>, "Fechavto" = <<"'" + this.ConvertirDateSql( lxCaeFechavto ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxCaeHoraimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxCaeHmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxCaeHoraexpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxCaeSaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxCaeHaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxCaeUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxCaeSmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxCaeVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxCaeZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxCaeValtafw ) + "'">>, "Numero" = <<"'" + this.FormatearTextoSql( lxCaeNumero ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxCaeUmodifw ) + "'">>, "Codbarra" = <<"'" + this.FormatearTextoSql( lxCaeCodbarra ) + "'">>, "Inco" = <<"'" + this.FormatearTextoSql( lxCaeInco ) + "'">>, "Dgiserie" = <<"'" + this.FormatearTextoSql( lxCaeDgiserie ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCaeBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCaeBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxCaeEsttrans ) + "'">>, "Resultado" = <<"'" + this.FormatearTextoSql( lxCaeResultado ) + "'">>, "Dginumero" = <<lxCaeDginumero>>, "Timestamp" = <<lxCaeTimestamp>>, "Codigocaea" = <<lxCaeCodigocaea>>, "Caeainf" = <<iif( lxCaeCaeainf, 1, 0 )>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxCaeCodigo ) + "'">>, "Mone" = <<"'" + this.FormatearTextoSql( lxCaeMone ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxCaeObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'CAE' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CAE set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FechaVTO = ] + "'" + this.ConvertirDateSql( &lcCursor..FechaVTO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, Numero = ] + "'" + this.FormatearTextoSql( &lcCursor..Numero ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, CodBarra = ] + "'" + this.FormatearTextoSql( &lcCursor..CodBarra ) + "'"+ [, Inco = ] + "'" + this.FormatearTextoSql( &lcCursor..Inco ) + "'"+ [, DGISerie = ] + "'" + this.FormatearTextoSql( &lcCursor..DGISerie ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Resultado = ] + "'" + this.FormatearTextoSql( &lcCursor..Resultado ) + "'"+ [, DGINumero = ] + transform( &lcCursor..DGINumero )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, CodigoCAEA = ] + transform( &lcCursor..CodigoCAEA )+ [, CAEAInf = ] + Transform( iif( &lcCursor..CAEAInf, 1, 0 ))+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, Mone = ] + "'" + this.FormatearTextoSql( &lcCursor..Mone ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, FechaVTO, HORAIMPO, HMODIFW, HORAEXPO, SALTAFW, HALTAFW, UALTAFW, SMODIFW, VMODIFW, ZADSFW, VALTAFW, Numero, UMODIFW, CodBarra, Inco, DGISerie, BDMODIFW, BDALTAFW, ESTTRANS, Resultado, DGINumero, TIMESTAMP, CodigoCAEA, CAEAInf, CODIGO, Mone, Obs
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaVTO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Numero ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodBarra ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Inco ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DGISerie ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Resultado ) + "'" + ',' + transform( &lcCursor..DGINumero ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..CodigoCAEA ) + ',' + Transform( iif( &lcCursor..CAEAInf, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Mone ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECHAVTO = isnull( d.FECHAVTO, t.FECHAVTO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.CODBARRA = isnull( d.CODBARRA, t.CODBARRA ),t.INCO = isnull( d.INCO, t.INCO ),t.DGISERIE = isnull( d.DGISERIE, t.DGISERIE ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.RESULTADO = isnull( d.RESULTADO, t.RESULTADO ),t.DGINUMERO = isnull( d.DGINUMERO, t.DGINUMERO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CODIGOCAEA = isnull( d.CODIGOCAEA, t.CODIGOCAEA ),t.CAEAINF = isnull( d.CAEAINF, t.CAEAINF ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MONE = isnull( d.MONE, t.MONE ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.CAE t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.CAE(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Fechavto,Horaimpo,Hmodifw,Horaexpo,Saltafw,Haltafw,Ualtafw,Smodifw,Vmodifw,Zadsfw,Valtafw,Numero,Umodifw,Codbarra,Inco,Dgiserie,Bdmodifw,Bdaltafw,Esttrans,Resultado,Dginumero,Timestamp,Codigocaea,Caeainf,Codigo,Mone,Obs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECHAVTO,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.NUMERO,''),isnull( d.UMODIFW,''),isnull( d.CODBARRA,''),isnull( d.INCO,''),isnull( d.DGISERIE,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.RESULTADO,''),isnull( d.DGINUMERO,0),isnull( d.TIMESTAMP,0),isnull( d.CODIGOCAEA,0),isnull( d.CAEAINF,0),isnull( d.CODIGO,''),isnull( d.MONE,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CAE                                     " atributo="FECHATRANSFERENCIA                      " tabla="CAE            " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAE                                     " atributo="INCOTERMS                               " tabla="CAE            " campo="INCO      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="INCOTERMS                               " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Incoterms                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAE                                     " atributo="ESTADOTRANSFERENCIA                     " tabla="CAE            " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAE                                     " atributo="RESULTADO                               " tabla="CAE            " campo="RESULTADO " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="402" etiqueta="Resultado                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAE                                     " atributo="CODIGOCAEA                              " tabla="CAE            " campo="CODIGOCAEA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Número CAEA                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAE                                     " atributo="CAEAINFORMADO                           " tabla="CAE            " campo="CAEAINF   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="CAEA infomado                                                                                                                                                   " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
