...
define class Mock_condiciondepago as MockBase of MockBase.prg
	...
	lWHIngresar = .f.                                                                                                                                                                                                                                         
	lWHModificar = .f.                                                                                                                                                                                                                                        
	nDiferenciaPorcentajeDeComprobante = 0                                                                                                                                                                                                                    
	oAD = null                                                                                                                                                                                                                                                
	...
	*-----------------------------------------------------------------------------------------
	function asignarporcentajedecomprobantesugerido() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Asignarporcentajedecomprobantesugerido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calculardiferenciaporcentajedelcomprobante() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Calculardiferenciaporcentajedelcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallepagospersonalizados() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Cambiosdetallepagospersonalizados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirfecha( tcfecha as string ) as date                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Convertirfecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventovalidarconfiguraciondefrecuencia( tosender as object, toargumentos as object ) as void                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventovalidarconfiguraciondefrecuencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitarpagospersonalizados_assign( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitarpagospersonalizados_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitarpagospersonalizados_assign', lcParametros )			endif		endif		this.lHabilitarPagosPersonalizados = txVal		this.PagosPersonalizados.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercolecciondepagospersonalizados( toitem as object ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercolecciondepagospersonalizados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerconfiguraciondecontrolnet() as string                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerconfiguraciondecontrolnet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_anticipo( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_anticipo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_anticipo', lcParametros )			endif		endif		this.Anticipo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidaddepagos( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cantidaddepagos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cantidaddepagos', lcParametros )			endif		endif		this.Cantidaddepagos = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_codigovaloranticipo( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_codigovaloranticipo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_codigovaloranticipo', lcParametros )			endif		endif		this.Codigovaloranticipo.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_cuentacorriente( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cuentacorriente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cuentacorriente', lcParametros )			endif		endif		this.Cuentacorriente.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechadevencimiento( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechadevencimiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechadevencimiento', lcParametros )			endif		endif		this.Fechadevencimiento = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_frecuencia( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_frecuencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_frecuencia', lcParametros )			endif		endif		this.Frecuencia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodepagos( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tipodepagos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tipodepagos', lcParametros )			endif		endif		this.Tipodepagos = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seteardescripciontipodevalor( toitem as object ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Seteardescripciontipodevalor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function seteardescripciontipodevalorendetalleaplanado() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Seteardescripciontipodevalorendetalleaplanado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function seteardescripciontipodevalorenitemactivo() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Seteardescripciontipodevalorenitemactivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodepagos_despuesdeasignar() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Tipodepagos_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_anticipo( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_anticipo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_anticipo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidaddepagos( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cantidaddepagos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cantidaddepagos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_codigovaloranticipo( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_codigovaloranticipo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_codigovaloranticipo', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_cuentacorriente( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cuentacorriente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cuentacorriente', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault()		if llRetorno			if !empty( this.Cuentacorriente_pk )  and !this.Cuentacorriente.Tipo = 6				this.Cuentacorriente_pk = ""				goServicios.Errores.LevantarExcepcion( "No puede utilizar este tipo de valor." )			endif		endif		Return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descuento( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descuento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descuento', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if llRetorno and !empty( this.Recargo ) and !empty( txVal )			this.Descuento = 0			goServicios.Errores.LevantarExcepcion( "No se pueden definir Recargos y Descuentos simultaneamente en una misma condición de pago." )				endif				Return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechadevencimiento( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechadevencimiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechadevencimiento', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_frecuencia( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_frecuencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_frecuencia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodepagos( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipodepagos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipodepagos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcantidaddepagos() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarcantidaddepagos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcodigovaloranticipo() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validarcodigovaloranticipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcuentacorriente() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarcuentacorriente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoanticipo() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoanticipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidaddepagos() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridocantidaddepagos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigovaloranticipo() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridocodigovaloranticipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocuentacorriente() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridocuentacorriente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechadevencimiento() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofechadevencimiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofrecuencia() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridofrecuencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechadevencimiento() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechadevencimiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwtipodepagos() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridofwtipodepagos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorecargo() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridorecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipodepagos() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridotipodepagos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarfiltrobusqueda( toobjetobusqueda as object ) as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitarcontrolesseguntipo( ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarcontrolesseguntipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function oenttipodevalor_access() as object                                                                                                                                                                                                     
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oenttipodevalor_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oenttipodevalor_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oEntTipoDeValor ) = 'O' or isnull( this.oEntTipoDeValor ) )			this.oEntTipoDeValor = _screen.zoo.crearobjeto( "din_tipodevalores" )		endif		return this.oEntTipoDeValor
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oentvalor_access() as object                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CONDICIONDEPAGO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentvalor_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentvalor_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oEntValor ) = 'O' or isnull( this.oEntValor ) )			this.oEntValor = _screen.zoo.instanciarentidad( "valor" )		endif		return this.oEntValor
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarconfiguraciondefrecuencia() as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarconfiguraciondefrecuencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarpagospersonalizados() as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarpagospersonalizados', lcParametros )
	EndFunc
