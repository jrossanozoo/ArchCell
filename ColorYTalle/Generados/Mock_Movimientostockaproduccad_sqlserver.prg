...
define class Mock_Movimientostockaproduccad_sqlserver as MockBase of MockBase.prg

	cClase = 'Movimientostockaproduccad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detmstockaprod( tctablatrabajo ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detmstockaprod', lcParametros )
	EndFunc
