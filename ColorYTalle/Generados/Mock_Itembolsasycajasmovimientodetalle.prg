...
define class Mock_Itembolsasycajasmovimientodetalle as MockBase of MockBase.prg

	cClase = 'Itembolsasycajasmovimientodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function eventoinformararticuloconcolorotallefueradepaletaocurva( toinfo ) as void                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
