...
define class Mock_Itemfacturaelectronicadecreditopromocionesdetalle as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicadecreditopromocionesdetalle'
	...
	idPromocion = ''                                                                                                                                                                                                                                          
	idValor = ''                                                                                                                                                                                                                                              
	lAgregandoPromocionBancaria = .f.                                                                                                                                                                                                                         
	lAplicandoPromocionAutomatica = .f.                                                                                                                                                                                                                       
	lBuscandoCodigo = .f.                                                                                                                                                                                                                                     
	lCargando = .f.                                                                                                                                                                                                                                           
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function beneficio_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Beneficio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesdeactualizar() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdeactualizar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estaagregandopromocionbancaria() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estaagregandopromocionbancaria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function estaaplicandopromocionbancariaautomatica() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estaaplicandopromocionbancariaautomatica', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function estaquitandopromocionbancaria() as boolean                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estaquitandopromocionbancaria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idartsafec_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Idartsafec_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iditempromocion_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Iditempromocion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function promocion_access() as variant                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Promocion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function promocion_pk_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Promocion_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function promociondetalle_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Promociondetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function promociontipo_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Promociontipo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_beneficio( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_beneficio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idartsafec( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_idartsafec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iditempromocion( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_iditempromocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_promocion( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_promocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_promociondetalle( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_promociondetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_promociontipo( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_promociontipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_beneficio( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_beneficio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idartsafec( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validar_idartsafec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iditempromocion( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_iditempromocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_promocion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_promocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_promociondetalle( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_promociondetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_promociontipo( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_promociontipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwiditempromocion() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridofwiditempromocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoiditempromocion() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoiditempromocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopromocion() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridopromocion', lcParametros )
	EndFunc
