...
define class Din_EntidadFacturaelectronicadecredito_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Facturaelectronicadecredito"
	cClaseResponse = this.cNamespaceDTOs + ".FacturaelectronicadecreditoResponse"
	cClaseModelo = "FacturaelectronicadecreditoModelo"
	cEntidad = "Facturaelectronicadecredito"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicadecreditoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicadecreditoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicadecreditoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaelectronicadecreditoModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetallePromocionesDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Idartsafec", toEntidad.PromocionesDetalle.oItem, "Idartsafec" )
	...
	protected function CargarColeccionModeloPromocionesDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .PromocionesDetalle.Count
				...
				this.SetearAtributo( loItem, "Idartsafec", .PromocionesDetalle.Item(lnI).Idartsafec)
