...
define class Mock_seleccionordendeservicio as MockBase of MockBase.prg
	...
	cClase = 'seleccionordendeservicio'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Seleccion de órdenes de servicio"                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleordenes() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleordenes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detalleordenes_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalleordenes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalleordenes_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalleordenes ) = 'O' or isnull( this.Detalleordenes ) )			this.Detalleordenes = this.crearobjeto( 'Din_DetalleSeleccionordendeservicioDetalleordenes' )			this.Detalleordenes.inicializar()			this.enlazar( 'Detalleordenes.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalleordenes.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalleordenes, 'CambioSumarizado', this, 'CambiosDetalleDetalleordenes', 1)			this.enlazar( 'Detalleordenes.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalleordenes.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detalleordenes
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarremito( toentidad ) as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Inyectarremito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitardetalleordenes_assign( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONORDENDESERVICIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetalleordenes_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetalleordenes_assign', lcParametros )			endif		endif		this.lHabilitarDetalleOrdenes = txVal		this.DetalleOrdenes.habilitarItems( txVal )
	EndFunc
