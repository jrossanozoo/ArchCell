...
define class Din_EntidadNotadedebitoelectronicadecredito_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadedebitoelectronicadecredito"
	cClaseResponse = this.cNamespaceDTOs + ".NotadedebitoelectronicadecreditoResponse"
	cClaseModelo = "NotadedebitoelectronicadecreditoModelo"
	cEntidad = "Notadedebitoelectronicadecredito"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicadecreditoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicadecreditoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicadecreditoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicadecreditoModelo"
		endcase
		return lcRetorno
