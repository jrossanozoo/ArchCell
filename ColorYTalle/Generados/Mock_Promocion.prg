...
define class Mock_promocion as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function ccursor_access() as string                                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PROMOCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ccursor_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ccursor_access', lcParametros )			endif		endif		if !this.ldestroy and empty( this.cCursor )			loPromociones = this.crearobjeto( 'Din_ObjetoPromociones' )			this.cCursor = loPromociones.ObtenerCursorPromociones()		endif		return this.cCursor		
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function configuracion_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PROMOCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'configuracion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'configuracion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Configuracion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Configuracion( lxVal )				this.Setear_Configuracion( lxVal )				 This.Configuracion_DespuesDeAsignar()			EndIf		Else			This.Setear_Configuracion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function configuracion_despuesdeasignar() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Configuracion_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esnegado( tnindice as number , tnnegados as collection ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Esnegado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventovalidarconfiguraciondepromocion( tosender as object, toargumentos as object ) as void                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventovalidarconfiguraciondepromocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existenpromocionesbancariasconcuotassinrecargovigentes( tdfecha as date ) as boolean                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Existenpromocionesbancariasconcuotassinrecargovigentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function haynegacion( tcrelacion as string ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Haynegacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributomuestrarelacion( tcentidad as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obteneratributomuestrarelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigosdepromocionesautomaticas( tdfecha as date) as zoocoleccion of zoocoleccion.prg                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercodigosdepromocionesautomaticas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercodigosdepromocionesbancarias() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigosdepromocionesbancarias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercursorxmlunasolapromocion( tccursor as string, tcpromocion as string ) as void                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccursor
		lxParam2 = tcpromocion
		...
		return this.ObtenerResultado( 'Obtenercursorxmlunasolapromocion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistadepromociones( tlsolopromocionesautomaticas as boolean, tdfecha as date ) as object                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tlsolopromocionesautomaticas
		lxParam2 = tdfecha
		...
		return this.ObtenerResultado( 'Obtenerlistadepromociones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerlistadepromocionesbancarias() as object                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerlistadepromocionesbancarias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerlistadepromocionespormediodepago() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerlistadepromocionespormediodepago', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernegados( tcrelacion as string, tncantidad as number ) as collection                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenernegados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerunasolapromocion( tcpromocion as string ) as object                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcpromocion
		...
		return this.ObtenerResultado( 'Obtenerunasolapromocion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenervalormuestrarelacion( tcparticipante as string, tcatributo as string, tcvalor as string, tnfactor as string, tlnegado as boolean  ) as string                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = tcparticipante
		lxParam2 = tcatributo
		lxParam3 = tcvalor
		lxParam4 = tnfactor
		lxParam5 = tlnegado
		...
		return this.ObtenerResultado( 'Obtenervalormuestrarelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerxmldatosdeparticipantes( tosender as object, toargumentos as object ) as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerxmldatosdeparticipantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oentidades_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PROMOCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidades_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidades_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oEntidades ) # "O"			this.oEntidades = _screen.Zoo.CrearObjeto( "ZooColeccion" )		endif		return this.oEntidades
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadesquenodebenlevantardatos_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PROMOCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadesquenodebenlevantardatos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadesquenodebenlevantardatos_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oEntidadesQueNoDebenLevantarDatos ) # "O"			this.oEntidadesQueNoDebenLevantarDatos = _screen.Zoo.CrearObjeto( "ZooColeccion" )			this.oEntidadesQueNoDebenLevantarDatos.Agregar( "CUPON", "CUPON" )		endif		return this.oEntidadesQueNoDebenLevantarDatos
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_configuracion( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PROMOCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_configuracion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_configuracion', lcParametros )			endif		endif		this.Configuracion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearvalormuestrarelaciondereglas( tosender as object, toargumentos as object )                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Setearvalormuestrarelaciondereglas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_configuracion( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PROMOCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_configuracion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_configuracion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoconfiguracion() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoconfiguracion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearxmldocument( tcxml ) as object                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Crearxmldocument', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function debeobtenerdatosdelaentidad( tcentidad as string ) as boolean                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Debeobtenerdatosdelaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneratributosaseleccionar( toargumentos as object ) as string                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obteneratributosaseleccionar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerclaveforanea( tcparticipante as string, tcatributo as string ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerclaveforanea', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercomparador( tnfactor as integer, tlnegado as boolean ) as string                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenercomparador', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursorxmlpromociones( tccursor as object ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercursorxmlpromociones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursorxmlpromocionesbancarias( tccursor as object ) as void                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercursorxmlpromocionesbancarias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursorxmlpromocionesconmediodepago( tccursor as object ) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercursorxmlpromocionesconmediodepago', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursorxmlsolopromocionesautomaticas( tccursor as object, tdfecha as date ) as void                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenercursorxmlsolopromocionesautomaticas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerentidad( tcentidad as string ) as object                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerentidaddeparticipante( toargumentos as object ) as object                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerentidaddeparticipante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneretiquetaatributo( toentidad as entidad of entidad.prg, tcatributo as string) as string                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obteneretiquetaatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerfechavigenciadesdeeninformacioncontrol( tcinformacioncontrol as string ) as date                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcinformacioncontrol
		...
		return this.ObtenerResultado( 'Obtenerfechavigenciadesdeeninformacioncontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerfechavigenciahastaeninformacioncontrol( tcinformacioncontrol as string ) as date                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerfechavigenciahastaeninformacioncontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerhoravigenciadesdeeninformacioncontrol( tcinformacioncontrol as string ) as date                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerhoravigenciadesdeeninformacioncontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerhoravigenciahastaeninformacioncontrol( tcinformacioncontrol as string ) as date                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerhoravigenciahastaeninformacioncontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerinformacioncontrolenxml( toxmldocument as object ) as string                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toxmldocument
		...
		return this.ObtenerResultado( 'Obtenerinformacioncontrolenxml', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenernombreparticipante( tcparticipante as string ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenernombreparticipante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertipoeninformacioncontrol( tcinformacioncontrol as string ) as integer                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertipoeninformacioncontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenervalordeatributoencadena( tccadena as string, tcatributo as string,  tcdelimitadoratributo as string, tcdelimitadorvalor as string ) as string                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		lxParam1 = tccadena
		lxParam2 = tcatributo
		lxParam3 = tcdelimitadoratributo
		lxParam4 = tcdelimitadorvalor
		...
		return this.ObtenerResultado( 'Obtenervalordeatributoencadena', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerwhereparadatosdeparticipantes( toargumentos as object ) as boolean                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerwhereparadatosdeparticipantes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oestructura_access() as void                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PROMOCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oestructura_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oestructura_access', lcParametros )			endif		endif		local loManagerEstructuraADN as Object, lcXmlEntidades as String				if !this.lDestroy and ( type( "this.oEstructura" ) <> 'O' or isnull( this.oEstructura ) )			loManagerEstructuraADN = _screen.Zoo.CrearObjeto( "ZooLogicSA.Core.ADN.Mapeador.MapeadorEstructura" )			lcXmlEntidades = filetostr( addbs( _screen.Zoo.cRutaInicial ) + "Generados\Din_Entidades.xml" )			this.oEstructura = loManagerEstructuraAdn.Mapear( lcXmlEntidades )		endif		return this.oEstructura
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearatributosdevigenciaytipo() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearatributosdevigenciaytipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarconfiguraciondepromocion() as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarconfiguraciondepromocion', lcParametros )
	EndFunc
