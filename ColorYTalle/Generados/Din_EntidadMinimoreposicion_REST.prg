...
define class Din_EntidadMinimoreposicion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Minimoreposicion"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleMinRepo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.MinRepo.oItem, "Talle_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Talledetalle", toEntidad.MinRepo.oItem, "TalleDetalle" )
	...
	protected function CargarColeccionModeloMinRepo( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .MinRepo.Count
				...
				this.SetearAtributoString( loItem, "Talle", .MinRepo.Item(lnI).Talle_PK)
				this.SetearAtributoString( loItem, "TalleDetalle", .MinRepo.Item(lnI).TalleDetalle)
				this.SetearAtributoDecimal( loItem, "CantidadActual", .MinRepo.Item(lnI).CantidadActual)
