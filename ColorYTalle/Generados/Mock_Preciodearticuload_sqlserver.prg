...
define class Mock_Preciodearticuload_sqlserver as MockBase of MockBase.prg

	cClase = 'Preciodearticuload_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeletetransferencia( tctablatrabajo ) as string                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenertriggerdeletetransferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validacionbasicaobligatoriofkfechavigencia( toconexion, lcexpresionmensaje, lcwhere, lccamposlogueo, lcvalueslogueocomunes ) as void                                                                                                             
		...
		return this.ObtenerResultado( 'Validacionbasicaobligatoriofkfechavigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validacionbasicaobligatoriofklistadeprecio( toconexion, lcexpresionmensaje, lcwhere, lccamposlogueo, lcvalueslogueocomunes ) as void                                                                                                             
		...
		return this.ObtenerResultado( 'Validacionbasicaobligatoriofklistadeprecio', lcParametros )
	EndFunc
