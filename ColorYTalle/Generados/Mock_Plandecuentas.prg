...
define class Mock_plandecuentas as MockBase of MockBase.prg
	...
	cClase = 'plandecuentas'

	
	AjustaPorInflacion = .F.                                                                                                                                                                                                                                  
	Apodo = ""                                                                                                                                                                                                                                                
	BASEDEDATOSALTAFW = ""                                                                                                                                                                                                                                    
	...
	Codigo = ""                                                                                                                                                                                                                                               
	Cuenta = ""                                                                                                                                                                                                                                               
	CuentaAjustePorInflacion = null                                                                                                                                                                                                                           
	CuentaAjustePorInflacion_PK = ""                                                                                                                                                                                                                          
	DeRefundicion = 0                                                                                                                                                                                                                                         
	Descripcion = ""                                                                                                                                                                                                                                          
	ESTADOTRANSFERENCIA = ""                                                                                                                                                                                                                                  
	EsDeRefundicion = .F.                                                                                                                                                                                                                                     
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Plan de cuentas"                                                                                                                                                                                                                         
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'PLANDECUENTAS'                                                                                                                                                                                                                                 
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lHabilitarApodo = .T.                                                                                                                                                                                                                                     
	lHabilitarCuenta = .T.                                                                                                                                                                                                                                    
	lHabilitarCuentaAjustePorInflacion_PK = .F.                                                                                                                                                                                                               
	lHabilitarCuentaAjustePorInflacion_PK = .T.                                                                                                                                                                                                               
	lHabilitarDeRefundicion = .T.                                                                                                                                                                                                                             
	lHabilitarEsDeRefundicion = .T.                                                                                                                                                                                                                           
	lHabilitarIndicesInflacion_PK = .T.                                                                                                                                                                                                                       
	lHabilitarIndicesInflacion_PK =.F.                                                                                                                                                                                                                        
	lHabilitarMayor_PK = .T.                                                                                                                                                                                                                                  
	lHabilitarRequiereCDC = .T.                                                                                                                                                                                                                               
	lHabilitarTipo = .T.                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function actualizaratributosajusteporinflacion() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizaratributosajusteporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ajustaporinflacion_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ajustaporinflacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ajustaporinflacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ajustaporinflacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ajustaporinflacion( lxVal )				this.Setear_Ajustaporinflacion( lxVal )				 This.Ajustaporinflacion_DespuesDeAsignar()			EndIf		Else			This.Setear_Ajustaporinflacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ajustaporinflacion_despuesdeasignar() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ajustaporinflacion_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function apodo_assign( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'apodo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'apodo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Apodo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Apodo( lxVal )				if ( this.lHabilitarApodo or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Apodo( lxVal )				else					this.Apodo = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Apodo)" )				endif			EndIf		Else			This.Setear_Apodo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cuenta_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cuenta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cuenta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cuenta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cuenta( lxVal )				if ( this.lHabilitarCuenta or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Cuenta( lxVal )				else					this.Cuenta = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Cuenta)" )				endif			EndIf		Else			This.Setear_Cuenta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cuentaajusteporinflacion_access() as variant                                                                                                                                                                                                     
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cuentaajusteporinflacion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cuentaajusteporinflacion_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Cuentaajusteporinflacion ) = 'O' or isnull( this.Cuentaajusteporinflacion ) )					this.Cuentaajusteporinflacion = _Screen.zoo.instanciarentidad( 'Plandecuentas' )					this.Cuentaajusteporinflacion.lEsSubEntidad = .t.					this.enlazar( 'Cuentaajusteporinflacion.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Cuentaajusteporinflacion.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Cuentaajusteporinflacion.CODIGO # this.Cuentaajusteporinflacion_PK						this.Cuentaajusteporinflacion.CODIGO = this.Cuentaajusteporinflacion_PK					endif				endif			endif		endif		return this.Cuentaajusteporinflacion
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cuentaajusteporinflacion_pk_assign( txval as variant ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cuentaajusteporinflacion_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cuentaajusteporinflacion_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cuentaajusteporinflacion_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 30, padr( lxVal, 30 ), lxVal )		this.Cuentaajusteporinflacion_PK = lxVal		if this.Validar_Cuentaajusteporinflacion( lxVal, lxValOld )			if ( this.lHabilitarCuentaajusteporinflacion_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Cuentaajusteporinflacion( lxVal )			else				this.Cuentaajusteporinflacion_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Cuentaajusteporinflacion)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function derefundicion_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'derefundicion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'derefundicion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Derefundicion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Derefundicion( lxVal )				if ( this.lHabilitarDerefundicion or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Derefundicion( lxVal )				else					this.Derefundicion = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Derefundicion)" )				endif			EndIf		Else			This.Setear_Derefundicion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesdesetearajustaporinflacion() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdesetearajustaporinflacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function despuesdesetearesimputable() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdesetearesimputable', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function despuesdesetearmayor() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdesetearmayor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function despuesdeseteartipo() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdeseteartipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escuentaderefundicionpatrimonial() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Escuentaderefundicionpatrimonial', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function escuentaimputable() as boolean                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Escuentaimputable', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function esderefundicion_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'esderefundicion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'esderefundicion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Esderefundicion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Esderefundicion( lxVal )				if ( this.lHabilitarEsderefundicion or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Esderefundicion( lxVal )				else					this.Esderefundicion = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Esderefundicion)" )				endif			EndIf		Else			This.Setear_Esderefundicion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esimputable_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'esimputable_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'esimputable_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Esimputable		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Esimputable( lxVal )				this.Setear_Esimputable( lxVal )				 This.Esimputable_DespuesDeAsignar()			EndIf		Else			This.Setear_Esimputable( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function esimputable_despuesdeasignar() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esimputable_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function guardarestadoultimacuentamayor()                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Guardarestadoultimacuentamayor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function indicesinflacion_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'indicesinflacion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'indicesinflacion_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Indicesinflacion ) = 'O' or isnull( this.Indicesinflacion ) )					this.Indicesinflacion = _Screen.zoo.instanciarentidad( 'Indicesinflacion' )					this.Indicesinflacion.lEsSubEntidad = .t.					this.enlazar( 'Indicesinflacion.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Indicesinflacion.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Indicesinflacion.CODIGO # this.Indicesinflacion_PK						this.Indicesinflacion.CODIGO = this.Indicesinflacion_PK					endif				endif			endif		endif		return this.Indicesinflacion
	EndFunc

	*-----------------------------------------------------------------------------------------
	function indicesinflacion_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'indicesinflacion_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'indicesinflacion_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Indicesinflacion_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.Indicesinflacion_PK = lxVal		if this.Validar_Indicesinflacion( lxVal, lxValOld )			if ( this.lHabilitarIndicesinflacion_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Indicesinflacion( lxVal )			else				this.Indicesinflacion_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Indicesinflacion)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lacuentaesmayordeotra() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Lacuentaesmayordeotra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function listadecuentas_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'listadecuentas_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'listadecuentas_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Listadecuentas		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Listadecuentas( lxVal )				this.Setear_Listadecuentas( lxVal )			EndIf		Else			This.Setear_Listadecuentas( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mayor_access() as variant                                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'mayor_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'mayor_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Mayor ) = 'O' or isnull( this.Mayor ) )					this.Mayor = _Screen.zoo.instanciarentidad( 'Plandecuentas' )					this.Mayor.lEsSubEntidad = .t.					this.enlazar( 'Mayor.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Mayor.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Mayor.CODIGO # this.Mayor_PK						this.Mayor.CODIGO = this.Mayor_PK					endif				endif			endif		endif		return this.Mayor
	EndFunc

	*-----------------------------------------------------------------------------------------
	function mayor_pk_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'mayor_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'mayor_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Mayor_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 30, padr( lxVal, 30 ), lxVal )		this.Mayor_PK = lxVal		if this.Validar_Mayor( lxVal, lxValOld )			if ( this.lHabilitarMayor_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Mayor( lxVal )				This.Mayor_PK_DespuesDeAsignar()			else				this.Mayor_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Mayor)" )			endif		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function mayor_pk_despuesdeasignar() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Mayor_pk_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermensajeerrorcuentaimputable( tlvalidandomayor as boolean ) as string                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tlvalidandomayor
		...
		return this.ObtenerResultado( 'Obtenermensajeerrorcuentaimputable', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function requierecdc_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'requierecdc_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'requierecdc_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Requierecdc		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Requierecdc( lxVal )				if ( this.lHabilitarRequierecdc or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Requierecdc( lxVal )				else					this.Requierecdc = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Plan de cuentas - Atributo: Requierecdc)" )				endif			EndIf		Else			This.Setear_Requierecdc( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function requierecentrodecosto() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Requierecentrodecosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ajustaporinflacion( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ajustaporinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ajustaporinflacion', lcParametros )			endif		endif		this.Ajustaporinflacion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_apodo( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_apodo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_apodo', lcParametros )			endif		endif		this.Apodo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cuenta( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cuenta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cuenta', lcParametros )			endif		endif		dodefault( txVal )		if !empty(txVal)			this.Codigo = alltrim(this.Mayor_PK) + alltrim(txVal)		endif
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_cuentaajusteporinflacion( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cuentaajusteporinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cuentaajusteporinflacion', lcParametros )			endif		endif		this.Cuentaajusteporinflacion.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_derefundicion( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_derefundicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_derefundicion', lcParametros )			endif		endif		this.Derefundicion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_esderefundicion( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_esderefundicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_esderefundicion', lcParametros )			endif		endif		this.Esderefundicion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_esimputable( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_esimputable', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_esimputable', lcParametros )			endif		endif		this.Esimputable = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_indicesinflacion( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_indicesinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_indicesinflacion', lcParametros )			endif		endif		this.Indicesinflacion.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_listadecuentas( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_listadecuentas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_listadecuentas', lcParametros )			endif		endif		this.Listadecuentas = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_mayor( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_mayor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_mayor', lcParametros )			endif		endif		dodefault( txVal )		if !empty(txval) and This.EsNuevo() and This.Mayor.EsCuentaImputable()			goServicios.Mensajes.Advertir( This.ObtenerMensajeErrorCuentaImputable( .T. ) )			This.Mayor_Pk = ""		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_requierecdc( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_requierecdc', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_requierecdc', lcParametros )			endif		endif		this.Requierecdc = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearcuentamayorconultimacuentamayor() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearcuentamayorconultimacuentamayor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ajustaporinflacion( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ajustaporinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ajustaporinflacion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_apodo( txval as variant ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_apodo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_apodo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cuentaajusteporinflacion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cuentaajusteporinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cuentaajusteporinflacion', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_derefundicion( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_derefundicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_derefundicion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_esderefundicion( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_esderefundicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_esderefundicion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_esimputable( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_esimputable', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_esimputable', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if llRetorno and txVal == .T. and This.LaCuentaEsMayorDeOtra()			llRetorno = .F.			goServicios.Mensajes.Advertir( This.ObtenerMensajeErrorCuentaImputable( .F. ) )		endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_indicesinflacion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_indicesinflacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_indicesinflacion', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_listadecuentas( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_listadecuentas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_listadecuentas', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_mayor( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_mayor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_mayor', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_requierecdc( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'PLANDECUENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_requierecdc', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_requierecdc', lcParametros )			endif		endif		local llRetorno as Boolean, lcAsientosTipoConProblemas as String		llRetorno = dodefault( txVal )				if llRetorno and txVal == .T.			lcAsientosTipoConProblemas = This.ObtenerAsientosTipoConCuentasParaDiferenciaPorRedondeoQuePermitanCentrosDeCostos( this.Codigo )			if !empty( lcAsientosTipoConProblemas )				llRetorno = .F.				goServicios.Mensajes.Advertir( "No se puede setear esta cuenta contable para que discrimine por centro de costos porque ya está siendo utilizada en al menos un asiento tipo en el concepto de diferencia por redondeo [";											 + lcAsientosTipoConProblemas + "]" )			endif		endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcuentaajusteporinflacion() as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcuentaajusteporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarindicesinflacion() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarindicesinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmayor() as boolean                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmayor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoajustaporinflacion() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoajustaporinflacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridocuentaajusteporinflacion() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridocuentaajusteporinflacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoderefundicion() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoderefundicion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwderefundicion() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwderefundicion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoindicesinflacion() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoindicesinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizartipoderefundicion() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizartipoderefundicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function darsiguientecuenta(nombrecursor as string) as string                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = nombrecursor
		...
		return this.ObtenerResultado( 'Darsiguientecuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function lacuentapuedeserimputable(nombrecursor as string) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Lacuentapuedeserimputable', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerasientostipoconcuentasparadiferenciaporredondeoquepermitancentrosdecostos( tccuentacontable as string ) as string                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tccuentacontable
		...
		return this.ObtenerResultado( 'Obtenerasientostipoconcuentasparadiferenciaporredondeoquepermitancentrosdecostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearestadoderefundicion() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearestadoderefundicion', lcParametros )
	EndFunc
