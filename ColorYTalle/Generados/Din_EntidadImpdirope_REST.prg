...
define class Din_EntidadImpdirope_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Impdirope"
	cClaseResponse = this.cNamespaceDTOs + ".ImpdiropeResponse"
	cClaseModelo = "ImpdiropeModelo"
	cEntidad = "Impdirope"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdiropeModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdiropeListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdiropeListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdiropeModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_operadora_desde", toEntidad, "F_operadora_desde_PK" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_operadora_hasta", toEntidad, "F_operadora_hasta_PK" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "f_Operadora_Desde", toEntidad.f_Operadora_Desde_PK)
			this.SetearAtributoString( toModeloResponse, "f_Operadora_Hasta", toEntidad.f_Operadora_Hasta_PK)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "F_operadora_desde", "OPEDESDE")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "F_operadora_hasta", "OPEHASTA")
