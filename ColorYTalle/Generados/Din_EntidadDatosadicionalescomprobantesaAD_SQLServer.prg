...
define class Din_EntidadDATOSADICIONALESCOMPROBANTESAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAfip3668Fecexpo, lxAfip3668Fectrans, lxAfip3668Fecimpo, lxAfip3668Faltafw, lxAfip3668Fmodifw, lxAfip3668Saltafw, lxAfip3668Smodifw, lxAfip3668Umodifw, lxAfip3668Ualtafw, lxAfip3668Zadsfw, lxAfip3668Valtafw, lxAfip3668Vmodifw, lxAfip3668Hmodifw, lxAfip3668Haltafw, lxAfip3668Horaimpo, lxAfip3668Esttrans, lxAfip3668Bdmodifw, lxAfip3668Horaexpo, lxAfip3668Bdaltafw, lxAfip3668Codigo, lxAfip3668Suscribe, lxAfip3668Tipodoc, lxAfip3668Nrodoc, lxAfip3668Motivo, lxAfip3668Codcomp
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.AFIP3668 ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Saltafw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Hmodifw","Haltafw","Horaimpo","Esttrans","Bdmodifw","Horaexpo","Bdaltafw","Codigo","Suscribe","Tipodoc","Nrodoc","Motivo","Codcomp" ) values ( <<"'" + this.ConvertirDateSql( lxAfip3668Fecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip3668Fectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip3668Fecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip3668Faltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip3668Fmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Saltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Smodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Umodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Ualtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Zadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Valtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Vmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Hmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Haltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Horaimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Esttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Bdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Horaexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Bdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Codigo ) + "'" >>, <<lxAfip3668Suscribe >>, <<"'" + this.FormatearTextoSql( lxAfip3668Tipodoc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip3668Nrodoc ) + "'" >>, <<lxAfip3668Motivo >>, <<"'" + this.FormatearTextoSql( lxAfip3668Codcomp ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.AFIP3668 set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAfip3668Fecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAfip3668Fectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAfip3668Fecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAfip3668Faltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAfip3668Fmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAfip3668Saltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAfip3668Smodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAfip3668Umodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAfip3668Ualtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAfip3668Zadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAfip3668Valtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAfip3668Vmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAfip3668Hmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAfip3668Haltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAfip3668Horaimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAfip3668Esttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAfip3668Bdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAfip3668Horaexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAfip3668Bdaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAfip3668Codigo ) + "'">>,"Suscribe" = <<lxAfip3668Suscribe>>,"Tipodoc" = <<"'" + this.FormatearTextoSql( lxAfip3668Tipodoc ) + "'">>,"Nrodoc" = <<"'" + this.FormatearTextoSql( lxAfip3668Nrodoc ) + "'">>,"Motivo" = <<lxAfip3668Motivo>>,"Codcomp" = <<"'" + this.FormatearTextoSql( lxAfip3668Codcomp ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxAfip3668Codigo ) + "'">> and  AFIP3668.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Saltafw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmod" + ;
"ifw,Hmodifw,Haltafw,Horaimpo,Esttrans,Bdmodifw,Horaexpo,Bdaltafw,Codigo,Suscribe,Tipodoc,Nrodoc,Moti" + ;
"vo,Codcomp" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.AFIP3668 set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Suscribe = ] + transform( &lcCursor..Suscribe )+ [, Tipodoc = ] + "'" + this.FormatearTextoSql( &lcCursor..Tipodoc ) + "'"+ [, NroDoc = ] + "'" + this.FormatearTextoSql( &lcCursor..NroDoc ) + "'"+ [, Motivo = ] + transform( &lcCursor..Motivo )+ [, CodComp = ] + "'" + this.FormatearTextoSql( &lcCursor..CodComp ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, SALTAFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HMODIFW, HALTAFW, HORAIMPO, ESTTRANS, BDMODIFW, HORAEXPO, BDALTAFW, Codigo, Suscribe, Tipodoc, NroDoc, Motivo, CodComp
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + transform( &lcCursor..Suscribe )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.SUSCRIBE = isnull( d.SUSCRIBE, t.SUSCRIBE ),t.TIPODOC = isnull( d.TIPODOC, t.TIPODOC ),t.NRODOC = isnull( d.NRODOC, t.NRODOC ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.CODCOMP = isnull( d.CODCOMP, t.CODCOMP )
					from ZooLogic.AFIP3668 t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.AFIP3668(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Saltafw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Esttrans,Bdmodifw,Horaexpo,Bdaltafw,Codigo,Suscribe,Tipodoc,Nrodoc,Motivo,Codcomp)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.BDALTAFW,''),isnull( d.CODIGO,''),isnull( d.SUSCRIBE,0),isnull( d.TIPODOC,''),isnull( d.NRODOC,''),isnull( d.MOTIVO,0),isnull( d.CODCOMP,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="DATOSADICIONALESCOMPROBANTESA           " atributo="FECHATRANSFERENCIA                      " tabla="AFIP3668       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DATOSADICIONALESCOMPROBANTESA           " atributo="ESTADOTRANSFERENCIA                     " tabla="AFIP3668       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DATOSADICIONALESCOMPROBANTESA           " atributo="TIPODOCUMENTO                           " tabla="AFIP3668       " campo="TIPODOC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="4" etiqueta="Tipo documento                                                                                                                                                                                                                                            " dominio="DOCUMENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DATOSADICIONALESCOMPROBANTESA           " atributo="NRODOCUMENTO                            " tabla="AFIP3668       " campo="NRODOC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Número documento                                                                                                                                                                                                                                          " dominio="DOCUMENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
