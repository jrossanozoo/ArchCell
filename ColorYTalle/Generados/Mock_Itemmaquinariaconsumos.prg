...
define class Mock_Itemmaquinariaconsumos as MockBase of MockBase.prg

	cClase = 'Itemmaquinariaconsumos'
	...
	*-----------------------------------------------------------------------------------------
	function consumo_access() as variant                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Consumo_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function consumo_pk_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Consumo_pk_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function consumodetalle_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Consumodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_consumo( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_consumo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_consumodetalle( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_consumodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_unidadmedida( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_unidadmedida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function unidadmedida_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Unidadmedida_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_consumo( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_consumo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_consumodetalle( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validar_consumodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_unidadmedida( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_unidadmedida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoconsumo() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoconsumo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoconsumodetalle() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoconsumodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridounidadmedida() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridounidadmedida', lcParametros )
	EndFunc
