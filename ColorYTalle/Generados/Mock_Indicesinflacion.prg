...
define class Mock_indicesinflacion as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Indices de inflacion"                                                                                                                                                                                                                    
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'INDICESINFLACION'                                                                                                                                                                                                                              
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleindices() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleindices', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function elindicetienedatoscargados( toindice as object ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Elindicetienedatoscargados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hayfechasdevigenciacargadas() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Hayfechasdevigenciacargadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function indices_access() as variant                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'INDICESINFLACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'indices_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'indices_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Indices ) = 'O' or isnull( this.Indices ) )			this.Indices = this.crearobjeto( 'Din_DetalleIndicesinflacionIndices' )			this.Indices.inicializar()			this.enlazar( 'Indices.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Indices.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Indices, 'CambioSumarizado', this, 'CambiosDetalleIndices', 1)			this.enlazar( 'Indices.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Indices.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Indices
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardatosdelindice() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validardatosdelindice', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechadeindicedentrodevigencia( tnmes as integer, tnaño as integer ) as void                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validarfechadeindicedentrodevigencia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarindicesdentrodevigencia() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarindicesdentrodevigencia', lcParametros )
	EndFunc
