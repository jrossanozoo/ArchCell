...
define class Din_EntidadAjustedeestados_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Ajustedeestados"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleStockAfectado( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.StockAfectado.oItem, "Talle_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Talledetalle", toEntidad.StockAfectado.oItem, "TalleDetalle" )
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleStockAfectadoAuditoriaComb( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.StockAfectadoAuditoriaComb.oItem, "Talle_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Talledetalle", toEntidad.StockAfectadoAuditoriaComb.oItem, "TalleDetalle" )
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleComprobantesModificados( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.ComprobantesModificados.oItem, "Talle_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Talledetalle", toEntidad.ComprobantesModificados.oItem, "TalleDetalle" )
	...
	protected function CargarColeccionModeloStockAfectado( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .StockAfectado.Count
				...
				this.SetearAtributoString( loItem, "Talle", .StockAfectado.Item(lnI).Talle_PK)
				this.SetearAtributoString( loItem, "TalleDetalle", .StockAfectado.Item(lnI).TalleDetalle)
	...
	protected function CargarColeccionModeloStockAfectadoAuditoriaComb( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .StockAfectadoAuditoriaComb.Count
				...
				this.SetearAtributoString( loItem, "Talle", .StockAfectadoAuditoriaComb.Item(lnI).Talle_PK)
				this.SetearAtributoString( loItem, "TalleDetalle", .StockAfectadoAuditoriaComb.Item(lnI).TalleDetalle)
	...
	protected function CargarColeccionModeloComprobantesModificados( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .ComprobantesModificados.Count
				...
				this.SetearAtributoString( loItem, "Talle", .ComprobantesModificados.Item(lnI).Talle_PK)
				this.SetearAtributoString( loItem, "TalleDetalle", .ComprobantesModificados.Item(lnI).TalleDetalle)
