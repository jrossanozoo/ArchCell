...
define class Din_DetallePREPARACIONDEMERCADERIAKitsdetalle as DetalleKits of DetalleKits.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemPREPARACIONDEMERCADERIAKitsdetalle' )
