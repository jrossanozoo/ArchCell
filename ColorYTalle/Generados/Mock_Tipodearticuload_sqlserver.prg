...
define class Mock_Tipodearticuload_sqlserver as MockBase of MockBase.prg

	cClase = 'Tipodearticuload_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupub206( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupub206', lcParametros )
	EndFunc
