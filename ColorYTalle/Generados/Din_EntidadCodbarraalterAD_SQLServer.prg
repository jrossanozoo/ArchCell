...
define class Din_EntidadCODBARRAALTERAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCodbaralterFecexpo, lxCodbaralterFectrans, lxCodbaralterFecimpo, lxCodbaralterFaltafw, lxCodbaralterFmodifw, lxCodbaralterSaltafw, lxCodbaralterHoraimpo, lxCodbaralterHmodifw, lxCodbaralterSmodifw, lxCodbaralterUmodifw, lxCodbaralterUaltafw, lxCodbaralterZadsfw, lxCodbaralterValtafw, lxCodbaralterVmodifw, lxCodbaralterHoraexpo, lxCodbaralterHaltafw, lxCodbaralterBdmodifw, lxCodbaralterBdaltafw, lxCodbaralterEsttrans, lxCodbaralterTimestamp, lxCodbaralterCtrluni, lxCodbaralterCodigo, lxCodbaralterObs, lxCodbaralterCoddesc, lxCodbaralterHabilitado, lxCodbaralterUsasecuen
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CODBARALTER ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Saltafw","Horaimpo","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Horaexpo","Haltafw","Bdmodifw","Bdaltafw","Esttrans","Timestamp","Ctrluni","Codigo","Obs","Coddesc","Habilitado","Usasecuen" ) values ( <<"'" + this.ConvertirDateSql( lxCodbaralterFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCodbaralterFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCodbaralterFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCodbaralterFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCodbaralterFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterEsttrans ) + "'" >>, <<lxCodbaralterTimestamp >>, <<lxCodbaralterCtrluni >>, <<"'" + this.FormatearTextoSql( lxCodbaralterCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCodbaralterCoddesc ) + "'" >>, <<iif( lxCodbaralterHabilitado, 1, 0 ) >>, <<iif( lxCodbaralterUsasecuen, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CODBARALTER set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCodbaralterFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCodbaralterFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCodbaralterFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCodbaralterFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCodbaralterFmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCodbaralterSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCodbaralterHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCodbaralterHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCodbaralterSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCodbaralterUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCodbaralterUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCodbaralterZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCodbaralterValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCodbaralterVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCodbaralterHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCodbaralterHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCodbaralterBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCodbaralterBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCodbaralterEsttrans ) + "'">>,"Timestamp" = <<lxCodbaralterTimestamp>>,"Ctrluni" = <<lxCodbaralterCtrluni>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCodbaralterCodigo ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxCodbaralterObs ) + "'">>,"Coddesc" = <<"'" + this.FormatearTextoSql( lxCodbaralterCoddesc ) + "'">>,"Habilitado" = <<iif( lxCodbaralterHabilitado, 1, 0 )>>,"Usasecuen" = <<iif( lxCodbaralterUsasecuen, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCodbaralterCodigo ) + "'">> and  CODBARALTER.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
...
"dsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Timestamp,Ctrluni,Codigo,Obs,Coddes" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CODBARALTER set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, CtrlUni = ] + transform( &lcCursor..CtrlUni )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, CodDesc = ] + "'" + this.FormatearTextoSql( &lcCursor..CodDesc ) + "'"+ [, Habilitado = ] + Transform( iif( &lcCursor..Habilitado, 1, 0 ))+ [, UsaSecuen = ] + Transform( iif( &lcCursor..UsaSecuen, 1, 0 )) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, SALTAFW, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HORAEXPO, HALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, TIMESTAMP, CtrlUni, Codigo, Obs, CodDesc, Habilitado, UsaSecuen
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..CtrlUni )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CTRLUNI = isnull( d.CTRLUNI, t.CTRLUNI ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.OBS = isnull( d.OBS, t.OBS ),t.CODDESC = isnull( d.CODDESC, t.CODDESC ),t.HABILITADO = isnull( d.HABILITADO, t.HABILITADO ),t.USASECUEN = isnull( d.USASECUEN, t.USASECUEN )
					from ZooLogic.CODBARALTER t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.CODBARALTER(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Timestamp,Ctrluni,Codigo,Obs,Coddesc,Habilitado,Usasecuen)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.TIMESTAMP,0),isnull( d.CTRLUNI,0),isnull( d.CODIGO,''),isnull( d.OBS,''),isnull( d.CODDESC,''),isnull( d.HABILITADO,0),isnull( d.USASECUEN,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="CODBARRAALTER                           " atributo="FECHATRANSFERENCIA                      " tabla="CODBARALTER    " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CODBARRAALTER                           " atributo="ESTADOTRANSFERENCIA                     " tabla="CODBARALTER    " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
