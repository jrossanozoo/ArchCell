...
define class Din_EntidadINTERACCIONDEORDENAtributosAnulacion as custom
	*----------------------------------------------
	function ObtenerAtributosAnulacion() as zoocoleccion OF zoocoleccion.prg
		...
		loItem = newobject( "ItemAtributoAnulacion", "ItemAtributoAnulacion.prg" )
		loItem.cAtributo = "ARTICULODESCRIPCION"
		loItem.cValorDefault = ""
		loItem.xValor = ""
		loItem.cCampo = "DescArt"
		...
		loItem.cValorDefault = ""
		loItem.xValor = ""
		loItem.cCampo = "cColor"
		loItem.nLongitud = 6
		loItem.nDecimales = 0
		loRetorno.Add( loItem, upper( loItem.cAtributo ) )
		
		loItem = newobject( "ItemAtributoAnulacion", "ItemAtributoAnulacion.prg" )
		loItem.cAtributo = "COLORDESCRIPCION"
		loItem.cValorDefault = ""
		loItem.xValor = ""
		loItem.cCampo = "DesCol"
		loItem.nLongitud = 50
		loItem.nDecimales = 0
		loRetorno.Add( loItem, upper( loItem.cAtributo ) )
		...
		loItem = newobject( "ItemAtributoAnulacion", "ItemAtributoAnulacion.prg" )
		loItem.cAtributo = "TALLEDESCRIPCION"
		loItem.cValorDefault = ""
		loItem.xValor = ""
		loItem.cCampo = "DescTalle"
		loItem.nLongitud = 50
		loItem.nDecimales = 0
		loRetorno.Add( loItem, upper( loItem.cAtributo ) )
		
		loItem = newobject( "ItemAtributoAnulacion", "ItemAtributoAnulacion.prg" )
		loItem.cAtributo = "TIPODESCUENTO"
		loItem.cValorDefault = ""
		loItem.xValor = ""
		loItem.cCampo = "TipoDesc"
		loItem.nLongitud = 10
		loItem.nDecimales = 0
		loRetorno.Add( loItem, upper( loItem.cAtributo ) )
