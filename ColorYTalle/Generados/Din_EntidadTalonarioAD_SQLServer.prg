	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.NUMERACIONES ( "Fectrans","Faltafw","Fmodifw","Fecimpo","Fecexpo","Haltafw","Horaexpo","Horaimpo","Saltafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Esttrans","Formula","Bdaltafw","Bdmodifw","Timestamp","Asigna","Talonario","Pobs","Entidad","Servicio","Numero","Atributo","Letra","Maximo","Ptoven","Numprop","Talorela","Resernro" ) values ( <<"'" + this.ConvertirDateSql( lxNumeracionesFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesFormula ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesBdmodifw ) + "'" >>, <<lxNumeracionesTimestamp >>, <<lxNumeracionesAsigna >>, <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesPobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesEntidad ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesServicio ) + "'" >>, <<lxNumeracionesNumero >>, <<"'" + this.FormatearTextoSql( lxNumeracionesAtributo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesLetra ) + "'" >>, <<lxNumeracionesMaximo >>, <<lxNumeracionesPtoven >>, <<iif( lxNumeracionesNumprop, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxNumeracionesTalorela ) + "'" >>, <<iif( lxNumeracionesResernro, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.NUMERACIONES set "Fectrans" = <<"'" + this.ConvertirDateSql( lxNumeracionesFectrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxNumeracionesFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxNumeracionesFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxNumeracionesFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxNumeracionesFecexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxNumeracionesHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxNumeracionesHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxNumeracionesZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxNumeracionesEsttrans ) + "'">>,"Formula" = <<"'" + this.FormatearTextoSql( lxNumeracionesFormula ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesBdmodifw ) + "'">>,"Timestamp" = <<lxNumeracionesTimestamp>>,"Asigna" = <<lxNumeracionesAsigna>>,"Talonario" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'">>,"Pobs" = <<"'" + this.FormatearTextoSql( lxNumeracionesPobs ) + "'">>,"Entidad" = <<"'" + this.FormatearTextoSql( lxNumeracionesEntidad ) + "'">>,"Servicio" = <<"'" + this.FormatearTextoSql( lxNumeracionesServicio ) + "'">>,"Numero" = <<lxNumeracionesNumero>>,"Atributo" = <<"'" + this.FormatearTextoSql( lxNumeracionesAtributo ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxNumeracionesLetra ) + "'">>,"Maximo" = <<lxNumeracionesMaximo>>,"Ptoven" = <<lxNumeracionesPtoven>>,"Numprop" = <<iif( lxNumeracionesNumprop, 1, 0 )>>,"Talorela" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalorela ) + "'">>,"Resernro" = <<iif( lxNumeracionesResernro, 1, 0 )>> where "Talonario" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'">> and  NUMERACIONES.TALONARIO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Formula" as "Formula", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Asigna" as "Asignacion", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Servicio" as "Servicio", "Numero" as "Numero", "Atributo" as "Atributo", "Letra" as "Letra", "Maximo" as "Maximonumero", "Ptoven" as "Puntodeventa", "Numprop" as "Delegarnumeracion", "Talorela" as "Talonariorela", "Resernro" as "Reservarnumero" from ZooLogic.NUMERACIONES where "Talonario" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'">> and  NUMERACIONES.TALONARIO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Formula" as "Formula", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Asigna" as "Asignacion", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Servicio" as "Servicio", "Numero" as "Numero", "Atributo" as "Atributo", "Letra" as "Letra", "Maximo" as "Maximonumero", "Ptoven" as "Puntodeventa", "Numprop" as "Delegarnumeracion", "Talorela" as "Talonariorela", "Resernro" as "Reservarnumero" from ZooLogic.NUMERACIONES where  NUMERACIONES.TALONARIO != '' order by Talonario
			endtext
			use in select('c_TALONARIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALONARIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Formula" as "Formula", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Asigna" as "Asignacion", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Servicio" as "Servicio", "Numero" as "Numero", "Atributo" as "Atributo", "Letra" as "Letra", "Maximo" as "Maximonumero", "Ptoven" as "Puntodeventa", "Numprop" as "Delegarnumeracion", "Talorela" as "Talonariorela", "Resernro" as "Reservarnumero" from ZooLogic.NUMERACIONES where  funciones.padr( Talonario, 35, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NUMERACIONES.TALONARIO != '' order by Talonario
			endtext
			use in select('c_TALONARIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALONARIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Formula" as "Formula", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Asigna" as "Asignacion", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Servicio" as "Servicio", "Numero" as "Numero", "Atributo" as "Atributo", "Letra" as "Letra", "Maximo" as "Maximonumero", "Ptoven" as "Puntodeventa", "Numprop" as "Delegarnumeracion", "Talorela" as "Talonariorela", "Resernro" as "Reservarnumero" from ZooLogic.NUMERACIONES where  funciones.padr( Talonario, 35, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NUMERACIONES.TALONARIO != '' order by Talonario desc
			endtext
			use in select('c_TALONARIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALONARIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Formula" as "Formula", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Asigna" as "Asignacion", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Servicio" as "Servicio", "Numero" as "Numero", "Atributo" as "Atributo", "Letra" as "Letra", "Maximo" as "Maximonumero", "Ptoven" as "Puntodeventa", "Numprop" as "Delegarnumeracion", "Talorela" as "Talonariorela", "Resernro" as "Reservarnumero" from ZooLogic.NUMERACIONES where  NUMERACIONES.TALONARIO != '' order by Talonario desc
			endtext
			use in select('c_TALONARIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALONARIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Faltafw,Fmodifw,Fecimpo,Fecexpo,Haltafw,Horaexpo,Horaimpo,Saltafw,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Formula,Bdaltafw,Bdmodifw,Timestamp,Asigna,Talonario," + ;
"Pobs,Entidad,Servicio,Numero,Atributo,Letra,Maximo,Ptoven,Numprop,Talorela,Resernro" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Formula" as "Formula", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Asigna" as "Asignacion", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Servicio" as "Servicio", "Numero" as "Numero", "Atributo" as "Atributo", "Letra" as "Letra", "Maximo" as "Maximonumero", "Ptoven" as "Puntodeventa", "Numprop" as "Delegarnumeracion", "Talorela" as "Talonariorela", "Resernro" as "Reservarnumero"
				endtext
			Else
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			...
			Do Case
				...
				Case lcAtributo == 'DELEGARNUMERACION'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'NUMPROP AS DELEGARNUMERACION'
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.NUMERACIONES set "Fectrans" = <<"'" + this.ConvertirDateSql( lxNumeracionesFectrans ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxNumeracionesFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxNumeracionesFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxNumeracionesFecimpo ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxNumeracionesFecexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesHaltafw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxNumeracionesHoraexpo ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxNumeracionesHoraimpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesSaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxNumeracionesZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesUmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesSmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesUaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesHmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxNumeracionesEsttrans ) + "'">>, "Formula" = <<"'" + this.FormatearTextoSql( lxNumeracionesFormula ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesBdmodifw ) + "'">>, "Timestamp" = <<lxNumeracionesTimestamp>>, "Asigna" = <<lxNumeracionesAsigna>>, "Talonario" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'">>, "Pobs" = <<"'" + this.FormatearTextoSql( lxNumeracionesPobs ) + "'">>, "Entidad" = <<"'" + this.FormatearTextoSql( lxNumeracionesEntidad ) + "'">>, "Servicio" = <<"'" + this.FormatearTextoSql( lxNumeracionesServicio ) + "'">>, "Numero" = <<lxNumeracionesNumero>>, "Atributo" = <<"'" + this.FormatearTextoSql( lxNumeracionesAtributo ) + "'">>, "Letra" = <<"'" + this.FormatearTextoSql( lxNumeracionesLetra ) + "'">>, "Maximo" = <<lxNumeracionesMaximo>>, "Ptoven" = <<lxNumeracionesPtoven>>, "Numprop" = <<iif( lxNumeracionesNumprop, 1, 0 )>>, "Talorela" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalorela ) + "'">>, "Resernro" = <<iif( lxNumeracionesResernro, 1, 0 )>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'NUMERACIONES' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.NUMERACIONES set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, formula = ] + "'" + this.FormatearTextoSql( &lcCursor..formula ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Asigna = ] + transform( &lcCursor..Asigna )+ [, Talonario = ] + "'" + this.FormatearTextoSql( &lcCursor..Talonario ) + "'"+ [, pobs = ] + "'" + this.FormatearTextoSql( &lcCursor..pobs ) + "'"+ [, Entidad = ] + "'" + this.FormatearTextoSql( &lcCursor..Entidad ) + "'"+ [, servicio = ] + "'" + this.FormatearTextoSql( &lcCursor..servicio ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, atributo = ] + "'" + this.FormatearTextoSql( &lcCursor..atributo ) + "'"+ [, Letra = ] + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'"+ [, maximo = ] + transform( &lcCursor..maximo )+ [, PtoVen = ] + transform( &lcCursor..PtoVen )+ [, numprop = ] + Transform( iif( &lcCursor..numprop, 1, 0 ))+ [, talorela = ] + "'" + this.FormatearTextoSql( &lcCursor..talorela ) + "'"+ [, ReserNro = ] + Transform( iif( &lcCursor..ReserNro, 1, 0 )) + [ Where Talonario = ] + "'" + this.FormatearTextoSql( &lcCursor..Talonario ) + "'" )
				...
				Text to lcCampos noShow
					 FECTRANS, FALTAFW, FMODIFW, FECIMPO, FECEXPO, HALTAFW, HORAEXPO, HORAIMPO, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, ESTTRANS, formula, BDALTAFW, BDMODIFW, TIMESTAMP, Asigna, Talonario, pobs, Entidad, servicio, Numero, atributo, Letra, maximo, PtoVen, numprop, talorela, ReserNro
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..formula ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..Asigna ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Talonario ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..pobs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Entidad ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..servicio ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..atributo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'" + ',' + transform( &lcCursor..maximo ) + ',' + transform( &lcCursor..PtoVen ) + ',' + Transform( iif( &lcCursor..numprop, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..talorela ) + "'" + ',' + Transform( iif( &lcCursor..ReserNro, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.FORMULA = isnull( d.FORMULA, t.FORMULA ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.ASIGNA = isnull( d.ASIGNA, t.ASIGNA ),t.TALONARIO = isnull( d.TALONARIO, t.TALONARIO ),t.POBS = isnull( d.POBS, t.POBS ),t.ENTIDAD = isnull( d.ENTIDAD, t.ENTIDAD ),t.SERVICIO = isnull( d.SERVICIO, t.SERVICIO ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.ATRIBUTO = isnull( d.ATRIBUTO, t.ATRIBUTO ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.MAXIMO = isnull( d.MAXIMO, t.MAXIMO ),t.PTOVEN = isnull( d.PTOVEN, t.PTOVEN ),t.NUMPROP = isnull( d.NUMPROP, t.NUMPROP ),t.TALORELA = isnull( d.TALORELA, t.TALORELA ),t.RESERNRO = isnull( d.RESERNRO, t.RESERNRO )
					from ZooLogic.NUMERACIONES t inner join deleted d 
							 on t.Talonario = d.Talonario
				-- Fin Updates
				insert into ZooLogic.NUMERACIONES(Fectrans,Faltafw,Fmodifw,Fecimpo,Fecexpo,Haltafw,Horaexpo,Horaimpo,Saltafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Formula,Bdaltafw,Bdmodifw,Timestamp,Asigna,Talonario,Pobs,Entidad,Servicio,Numero,Atributo,Letra,Maximo,Ptoven,Numprop,Talorela,Resernro)
					Select isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.FORMULA,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.ASIGNA,0),isnull( d.TALONARIO,''),isnull( d.POBS,''),isnull( d.ENTIDAD,''),isnull( d.SERVICIO,''),isnull( d.NUMERO,0),isnull( d.ATRIBUTO,''),isnull( d.LETRA,''),isnull( d.MAXIMO,0),isnull( d.PTOVEN,0),isnull( d.NUMPROP,0),isnull( d.TALORELA,''),isnull( d.RESERNRO,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="TALONARIO                               " atributo="FECHATRANSFERENCIA                      " tabla="NUMERACIONES   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TALONARIO                               " atributo="ESTADOTRANSFERENCIA                     " tabla="NUMERACIONES   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TALONARIO                               " atributo="ENTIDAD                                 " tabla="NUMERACIONES   " campo="ENTIDAD   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="150" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Entidad                                                                                                                                                         " dominio="COMBORELANUMERACIONES         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TALONARIO                               " atributo="DELEGARNUMERACION                       " tabla="NUMERACIONES   " campo="NUMPROP   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="201" etiqueta="Delegar numeración                                                                                                                                              " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
