...
define class Mock_Itemdisenoimpresionareas as MockBase of MockBase.prg

	cClase = 'Itemdisenoimpresionareas'
	...
	*-----------------------------------------------------------------------------------------
	function esdet_assign( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Esdet_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_esdet( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_esdet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_x( txval as variant ) as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_x', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_y( txval as variant ) as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_y', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_esdet( txval as variant ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_esdet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_x( txval as variant ) as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_x', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_y( txval as variant ) as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_y', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridox() as void                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridox', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoy() as void                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoy', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function x_assign( txval as variant ) as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'X_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function y_assign( txval as variant ) as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Y_assign', lcParametros )
	EndFunc
