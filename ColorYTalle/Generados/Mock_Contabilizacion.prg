...
define class Mock_contabilizacion as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function contabilizacostomercaderiavendida_assign( txval as variant ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONTABILIZACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'contabilizacostomercaderiavendida_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'contabilizacostomercaderiavendida_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Contabilizacostomercaderiavendida		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Contabilizacostomercaderiavendida( lxVal )				this.Setear_Contabilizacostomercaderiavendida( lxVal )			EndIf		Else			This.Setear_Contabilizacostomercaderiavendida( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_contabilizacostomercaderiavendida( txval as variant ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONTABILIZACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_contabilizacostomercaderiavendida', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_contabilizacostomercaderiavendida', lcParametros )			endif		endif		this.Contabilizacostomercaderiavendida = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_contabilizacostomercaderiavendida( txval as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONTABILIZACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_contabilizacostomercaderiavendida', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_contabilizacostomercaderiavendida', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocontabilizacostomercaderiavendida() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridocontabilizacostomercaderiavendida', lcParametros )
	EndFunc
