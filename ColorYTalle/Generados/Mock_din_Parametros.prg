...
define class Parametros_Colorytalle as custom
	...
	Controlarelingresodecoloresytallesasociadosapaletasycurvas = 1
	Modocomercial = 1

	function init() as void
		with this
			.Interfases = newobject( "COLORYTALLE_Interfases") 
			.CodigosDeBarra = newobject( "COLORYTALLE_CodigosDeBarra") 
			.EHost = newobject( "COLORYTALLE_EHost") 
			.GestionDeVentas = newobject( "COLORYTALLE_GestionDeVentas") 
			.Menues = newobject( "COLORYTALLE_Menues") 
			.Retencionesypercepciones = newobject( "COLORYTALLE_Retencionesypercepciones") 
			.Altas = newobject( "COLORYTALLE_Altas") 
			.ControladoresFiscales = newobject( "COLORYTALLE_ControladoresFiscales") 
			.Transferencias = newobject( "COLORYTALLE_Transferencias") 
			.MovimientoDeStock = newobject( "COLORYTALLE_MovimientoDeStock") 
			.Fondos = newobject( "COLORYTALLE_Fondos") 
			.FacturaElectronica = newobject( "COLORYTALLE_FacturaElectronica") 
		endwith
	endfunc
...
define class COLORYTALLE_Interfases as custom
	...
	function init() as void
		with this
			.Complekit = newobject( "COLORYTALLE_Complekit") 
			.Discovery = newobject( "COLORYTALLE_Discovery") 
			.BasModulares = newobject( "COLORYTALLE_BasModulares") 
			.Plataforma = newobject( "COLORYTALLE_Plataforma") 
			.Nordelta = newobject( "COLORYTALLE_Nordelta") 
			.Abadia2005 = newobject( "COLORYTALLE_Abadia2005") 
			.Cordoba = newobject( "COLORYTALLE_Cordoba") 
			.Afip = newobject( "COLORYTALLE_Afip") 
			.EFlexware = newobject( "COLORYTALLE_EFlexware") 
			.PuntaShopping = newobject( "COLORYTALLE_PuntaShopping") 
			.DynamicsGp = newobject( "COLORYTALLE_DynamicsGp") 
			.Bsa = newobject( "COLORYTALLE_Bsa") 
			.SujetosVinculados = newobject( "COLORYTALLE_SujetosVinculados") 
			.IibbRioNegro = newobject( "COLORYTALLE_IibbRioNegro") 
			.Nk = newobject( "COLORYTALLE_Nk") 
			.Sap = newobject( "COLORYTALLE_Sap") 
			.Fiserv = newobject( "COLORYTALLE_Fiserv") 
		endwith
	endfunc
...
define class COLORYTALLE_Complekit as custom

	nNodo = 3
	lAccess = .f.
	lDestroy = .f.

	Generararchivoentransferenciadearticulosymovimientosdemercaderia = 1
...
define class COLORYTALLE_Discovery as custom
...
define class COLORYTALLE_BasModulares as custom

	nNodo = 6
	lAccess = .f.
	lDestroy = .f.

	Habilitarlainterfase = 1
...
define class COLORYTALLE_Plataforma as custom

	nNodo = 7
	lAccess = .f.
	lDestroy = .f.

	Habilitarinterfaseplataforma = 1
...
define class COLORYTALLE_Nordelta as custom

	nNodo = 10
	lAccess = .f.
	lDestroy = .f.

	Habilitarinterfase = 1
...
define class COLORYTALLE_Abadia2005 as custom
...
define class COLORYTALLE_Cordoba as custom
...
define class COLORYTALLE_Afip as custom
	...
	Pedirdatospararg1547enventasycompras = 1
	Utilizarduplicadoselectronicos = 1
	Habilitaexportacionalsistemaarciba = 1
	Habilitaexportacionalsistemaarba = 1

	function init() as void
		with this
			.RG372615Sire = newobject( "COLORYTALLE_RG372615Sire") 
			.RG373115Sicore = newobject( "COLORYTALLE_RG373115Sicore") 
		endwith
	endfunc
...
define class COLORYTALLE_RG372615Sire as custom
	...
	function init() as void
		with this
			.ComprobanteDeCaja = newobject( "COLORYTALLE_ComprobanteDeCaja") 
		endwith
	endfunc
...
define class COLORYTALLE_ComprobanteDeCaja as custom
...
define class COLORYTALLE_RG373115Sicore as custom
...
define class COLORYTALLE_EFlexware as custom
	...
	function init() as void
		with this
			.Generales = newobject( "COLORYTALLE_Generales") 
			.Ventas = newobject( "COLORYTALLE_Ventas") 
			.Finanzas = newobject( "COLORYTALLE_Finanzas") 
			.Articulo = newobject( "COLORYTALLE_Articulo") 
		endwith
	endfunc
...
define class COLORYTALLE_Generales as custom
	...
	Tipodecliente = ''
	Actualizastock = .F.
	Codigodecausadeemision = ''
	Permitepasariddebasededatosenblanco = .T.
	Permitepasarcodigodeaperturacontableenblanco = .T.
...
define class COLORYTALLE_Ventas as custom

	nNodo = 34
	lAccess = .f.
	lDestroy = .f.

	Noexportarclientesencomprobantesb = .F.
	Tipodecambio = 'UNI'
	Codigodecondiciondeventa = '1'
	Separadescuentosyrecargos = .F.
	Invertirsignoendescuentosyrecargos = .F.
	Grupoencabecera = ''
	Vendedordefault = 'VEND'
	Exportarvaloresencero = .F.
	Condiciondeventacompencero = '2'
	Codigoclientecompencero = '999999'
	Exportarvaciocodigoclasifadic1 = .F.
	Exportarvaciodescripcionadicional1 = .F.
	Detallesucursalcaja = 2
	Exportarrecfincomoconcep = .F.
	Conceptopararecargo = ''
...
define class COLORYTALLE_Finanzas as custom

	nNodo = 35
	lAccess = .f.
	lDestroy = .f.

	Codigodemovimientopredeterminadoparavuelto = 'VUELTO'
	Codigodemonedapredeterminadoparacajachica = ''
	Canjedecuponesentrada = 'CANJE1'
	Canjedecuponessalida = 'CANJE2'
	Comprobantesdecajaentrada = 'COBMEN'
	Comprobantesdecajasalida = 'PAGMEN'
	Codigodeprovincia = ''
	Exportarsoloefectivo = .F.
	Detallesucursalcaja = 1
...
define class COLORYTALLE_Articulo as custom

	nNodo = 36
	lAccess = .f.
	lDestroy = .f.

	Incluircodigodearticuloequivalencia = 1
	Proveedor = 'LINCE'
	Tipodecodigoparaasignarleelprefijo = 1
	Tipodeitemenlaexportacion = 1
	Incluiralcodigo = 1
	Cantidadenunidaddemedida1 = .T.
	Cantidadenunidaddemedida2 = .F.
	Codigoparaconceptoagrupado = 'VENTAS'
	Enviarcomounidaddemedida1 = ''
	Enviarcomounidaddemedida2 = ''
...
define class COLORYTALLE_PuntaShopping as custom
	...
	Habilitar = .F.
	Seriedelcomprobante = '0'
	Rubropordefecto = 'SIN-RUBRO'
	Archivoderetorno = 'RESULT.TXT'
	Ejecutable = 'CLIVENTA.EXE'
	Espera = 5
...
define class COLORYTALLE_DynamicsGp as custom
...
define class COLORYTALLE_Bsa as custom
	...
	Recibir = 'TER.RCV'
	Ejecutar = 'TER.COM'
	Cantidaddetransaccionespendientesdeenvio = 15
	Tiempodeesperaderespuestasegundos = 3
...
define class COLORYTALLE_SujetosVinculados as custom

	nNodo = 42
	lAccess = .f.
	lDestroy = .f.

	Archivodeexportacion = 'SUJVINC.txt'
...
define class COLORYTALLE_IibbRioNegro as custom
...
define class COLORYTALLE_Nk as custom
...
define class COLORYTALLE_Sap as custom

	nNodo = 124
	lAccess = .f.
	lDestroy = .f.

	Habilitarequivalenciaserroresinterfazsap = .F.
...
define class COLORYTALLE_Fiserv as custom

	nNodo = 125
	lAccess = .f.
	lDestroy = .f.

	Habilitarenviodeventasfiserv = .F.
	Empresa = ''
	Terminal = ''
	Direccionip = ''
	Puerto = ''
...
define class COLORYTALLE_CodigosDeBarra as custom
...
define class COLORYTALLE_EHost as custom

	nNodo = 8
	lAccess = .f.
	lDestroy = .f.

	Recepciondedatosaltransmitir = 1
...
define class COLORYTALLE_GestionDeVentas as custom
	...
	Minorista = null
	Mayorista = null
	MovimientosDeMercaderia = null
	ComercioExterior = null

	Incorporaelstockdepedidosdecompraaldisponible = .F.
	Habilitastockseniado = .F.
	Incorporarcontroldestockenfacturasconentregaposterior = .F.
	Habilitastockseniadoenpantalladeprecarga = .F.
	Habilitacolumnastockdisponibleycomprometido = .F.
	Habilitacolumnastockdisponibleypendiente = .F.
	Controlstockdisponiblefacturacion = 1
	Controlstockdisponibleremitos = 1
	Controlstockdisponiblepedidos = 1
	Controldestockdisponibleenmovimientosdestock = 1
	Controldestockdisponiblemedianteminimosdestockenpedidosdeventa = 1

	function init() as void
		with this
			.Minorista = newobject( "COLORYTALLE_Minorista") 
			.Mayorista = newobject( "COLORYTALLE_Mayorista") 
			.MovimientosDeMercaderia = newobject( "COLORYTALLE_MovimientosDeMercaderia") 
			.ComercioExterior = newobject( "COLORYTALLE_ComercioExterior") 
		endwith
	endfunc
...
define class COLORYTALLE_Minorista as custom

	nNodo = 15
	lAccess = .f.
	lDestroy = .f.

	Utilizacurvadetallesenfacturas = 1
...
define class COLORYTALLE_Mayorista as custom
	...
	Utilizacurvadetallesendevoluciones = 1
	Utilizacurvadetallesenanulaciones = 1

	function init() as void
		with this
			.Pedidos = newobject( "COLORYTALLE_Pedidos") 
			.Remitos = newobject( "COLORYTALLE_Remitos") 
		endwith
	endfunc
...
define class COLORYTALLE_Pedidos as custom

	nNodo = 18
	lAccess = .f.
	lDestroy = .f.

	Utilizacurvadetallesenpedidos = 1
...
define class COLORYTALLE_Remitos as custom

	nNodo = 19
	lAccess = .f.
	lDestroy = .f.

	Utilizacurvadetallesenremitos = 1
...
define class COLORYTALLE_MovimientosDeMercaderia as custom

	nNodo = 20
	lAccess = .f.
	lDestroy = .f.

	Utilizacurvadetallesenmovimientosdemercaderia = 1
	Habilitamodificaciondeestadoderecepcion = 1
...
define class COLORYTALLE_ComercioExterior as custom
...
define class COLORYTALLE_Menues as custom
...
define class COLORYTALLE_Retencionesypercepciones as custom

	nNodo = 22
	lAccess = .f.
	lDestroy = .f.

	Utilizaretenciondeivaencompras = .F.
	Utilizaretenciondegananciasencompras = .F.
	Utilizaretenciondeingresosbrutosencompras = .F.
	Utilizapercepcionesdeingresosbrutosenventas = .F.
	Utilizaretenciondeivaenventas = .F.
	Utilizaretenciondegananciasenventas = .F.
	Utilizaretenciondeingresosbrutosenventas = .F.
	Utilizaretenciondeseguridadsocialenventas = .F.
...
define class COLORYTALLE_Altas as custom
	...
	function init() as void
		with this
			.Clientes = newobject( "COLORYTALLE_Clientes") 
			.Grupos = newobject( "COLORYTALLE_Grupos") 
			.Articulos = newobject( "COLORYTALLE_Articulos") 
		endwith
	endfunc
...
define class COLORYTALLE_Clientes as custom

	nNodo = 24
	lAccess = .f.
	lDestroy = .f.

	Rangocodigosdeclientes = .F.
...
define class COLORYTALLE_Grupos as custom

	nNodo = 25
	lAccess = .f.
	lDestroy = .f.

	Habilitarrubrocreditofiscal = .F.
...
define class COLORYTALLE_Articulos as custom

	nNodo = 26
	lAccess = .f.
	lDestroy = .f.

	Permitircargaautomaticadearticulosconcaracteradicional = .F.
	Sugerirdatosdelacargaanterior = .F.
	Permitirutilizaropciondevolucion = .T.
	Deshabilitardetalledecombinacionesdecolorytalle = .T.
...
define class COLORYTALLE_ControladoresFiscales as custom
...
define class COLORYTALLE_Transferencias as custom

	nNodo = 30
	lAccess = .f.
	lDestroy = .f.

	TransferenciasLince = null

	function init() as void
		with this
			.TransferenciasLince = newobject( "COLORYTALLE_TransferenciasLince") 
		endwith
	endfunc
...
define class COLORYTALLE_TransferenciasLince as custom

	nNodo = 31
	lAccess = .f.
	lDestroy = .f.

	Listadeprecios1 = 'LISTA1'
	Listadeprecios2 = 'LISTA2'
	Listadeprecios3 = 'LISTA3'
	Listadeprecios4 = 'LISTA4'
	Listadeprecios5 = ''
	Listadepreciosdecompras = 'LISTA0'
	Actualizararticulosalrecibir = .T.
	Recibirmovimientodestockcomo = 'Mercadería en tránsito'
	Codigoderedondeoautilizarenlarecepciondeprecios = ''
	Bocadeexpendioparacomprobantes = 0
	Bocadeexpendioparacomprobantesfiscalestalonario0 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario1 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario2 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario3 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario4 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario5 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario6 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario7 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario8 = 0
	Bocadeexpendioparacomprobantesfiscalestalonario9 = 0
	Temporadaparalaestacionverano = '1'
	Temporadaparalaestacionotono = '2'
	Temporadaparalaestacioninvierno = '3'
	Temporadaparalaestacionprimavera = '4'
...
define class COLORYTALLE_MovimientoDeStock as custom

	nNodo = 38
	lAccess = .f.
	lDestroy = .f.

	Comandoexternoaejecutarendisenodemovimientodestock = ''
...
define class COLORYTALLE_Fondos as custom
...
define class COLORYTALLE_FacturaElectronica as custom

	nNodo = 126
	lAccess = .f.
	lDestroy = .f.

	Envioautomaticodeemailalfinalizarlaimportacion = .F.
