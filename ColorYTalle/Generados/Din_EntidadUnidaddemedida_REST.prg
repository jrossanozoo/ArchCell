...
define class Din_EntidadUnidaddemedida_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Unidaddemedida"
	cClaseResponse = this.cNamespaceDTOs + ".UnidaddemedidaResponse"
	cClaseModelo = "UnidaddemedidaModelo"
	cEntidad = "Unidaddemedida"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "UnidaddemedidaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "UnidaddemedidaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "UnidaddemedidaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "UnidaddemedidaModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Equivalenciaarba", toEntidad, "Equivalenciaarba_PK" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoInteger( toModeloResponse, "EquivalenciaAfip", toEntidad.EquivalenciaAfip_PK)
			this.SetearAtributoString( toModeloResponse, "EquivalenciaArba", toEntidad.EquivalenciaArba_PK)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Equivalenciaafip", "AFIP")
