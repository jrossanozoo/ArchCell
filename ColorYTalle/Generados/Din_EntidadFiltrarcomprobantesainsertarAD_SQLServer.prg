...
define class Din_EntidadFILTRARCOMPROBANTESAINSERTARAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCompainsFectrans, lxCompainsFaltafw, lxCompainsFmodifw, lxCompainsFecexpo, lxCompainsFecimpo, lxCompainsHaltafw, lxCompainsHoraexpo, lxCompainsHoraimpo, lxCompainsSaltafw, lxCompainsVmodifw, lxCompainsZadsfw, lxCompainsValtafw, lxCompainsUmodifw, lxCompainsSmodifw, lxCompainsUaltafw, lxCompainsHmodifw, lxCompainsBdmodifw, lxCompainsEsttrans, lxCompainsBdaltafw, lxCompainsCodigo, lxCompainsDescrip, lxCompainsCliedesde, lxCompainsCliehasta, lxCompainsFecomdesde, lxCompainsFecomhasta, lxCompainsVendesde, lxCompainsVenhasta, lxCompainsNumdesde, lxCompainsNumhasta, lxCompainsMotidesde, lxCompainsMotihasta, lxCompainsTrandesde, lxCompainsTranhasta, lxCompainsObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPAINS ( "Fectrans","Faltafw","Fmodifw","Fecexpo","Fecimpo","Haltafw","Horaexpo","Horaimpo","Saltafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Bdmodifw","Esttrans","Bdaltafw","Codigo","Descrip","Cliedesde","Cliehasta","Fecomdesde","Fecomhasta","Vendesde","Venhasta","Numdesde","Numhasta","Motidesde","Motihasta","Trandesde","Tranhasta","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxCompainsFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompainsFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompainsFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompainsFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompainsFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsCliedesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsCliehasta ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompainsFecomdesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompainsFecomhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsVendesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsVenhasta ) + "'" >>, <<lxCompainsNumdesde >>, <<lxCompainsNumhasta >>, <<"'" + this.FormatearTextoSql( lxCompainsMotidesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsMotihasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsTrandesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsTranhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompainsObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPAINS set "Fectrans" = <<"'" + this.ConvertirDateSql( lxCompainsFectrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCompainsFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCompainsFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCompainsFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCompainsFecimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCompainsHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCompainsHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCompainsHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCompainsSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCompainsVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCompainsZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCompainsValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCompainsUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCompainsSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCompainsUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCompainsHmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCompainsBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCompainsEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCompainsBdaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCompainsCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxCompainsDescrip ) + "'">>,"Cliedesde" = <<"'" + this.FormatearTextoSql( lxCompainsCliedesde ) + "'">>,"Cliehasta" = <<"'" + this.FormatearTextoSql( lxCompainsCliehasta ) + "'">>,"Fecomdesde" = <<"'" + this.ConvertirDateSql( lxCompainsFecomdesde ) + "'">>,"Fecomhasta" = <<"'" + this.ConvertirDateSql( lxCompainsFecomhasta ) + "'">>,"Vendesde" = <<"'" + this.FormatearTextoSql( lxCompainsVendesde ) + "'">>,"Venhasta" = <<"'" + this.FormatearTextoSql( lxCompainsVenhasta ) + "'">>,"Numdesde" = <<lxCompainsNumdesde>>,"Numhasta" = <<lxCompainsNumhasta>>,"Motidesde" = <<"'" + this.FormatearTextoSql( lxCompainsMotidesde ) + "'">>,"Motihasta" = <<"'" + this.FormatearTextoSql( lxCompainsMotihasta ) + "'">>,"Trandesde" = <<"'" + this.FormatearTextoSql( lxCompainsTrandesde ) + "'">>,"Tranhasta" = <<"'" + this.FormatearTextoSql( lxCompainsTranhasta ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxCompainsObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCompainsCodigo ) + "'">> and  COMPAINS.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
...
"ltafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Bdmodifw,Esttrans,Bdaltafw,Codigo,Descrip,Cliedesde,Cliehasta," + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FALTAFW, FMODIFW, FECEXPO, FECIMPO, HALTAFW, HORAEXPO, HORAIMPO, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, BDMODIFW, ESTTRANS, BDALTAFW, Codigo, Descrip, ClieDesde, ClieHasta, FeComDesde, FeComHasta, VenDesde, VenHasta, NumDesde, NumHasta, MotiDesde, MotiHasta, TranDesde, TranHasta, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.CLIEDESDE = isnull( d.CLIEDESDE, t.CLIEDESDE ),t.CLIEHASTA = isnull( d.CLIEHASTA, t.CLIEHASTA ),t.FECOMDESDE = isnull( d.FECOMDESDE, t.FECOMDESDE ),t.FECOMHASTA = isnull( d.FECOMHASTA, t.FECOMHASTA ),t.VENDESDE = isnull( d.VENDESDE, t.VENDESDE ),t.VENHASTA = isnull( d.VENHASTA, t.VENHASTA ),t.NUMDESDE = isnull( d.NUMDESDE, t.NUMDESDE ),t.NUMHASTA = isnull( d.NUMHASTA, t.NUMHASTA ),t.MOTIDESDE = isnull( d.MOTIDESDE, t.MOTIDESDE ),t.MOTIHASTA = isnull( d.MOTIHASTA, t.MOTIHASTA ),t.TRANDESDE = isnull( d.TRANDESDE, t.TRANDESDE ),t.TRANHASTA = isnull( d.TRANHASTA, t.TRANHASTA ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.COMPAINS t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.COMPAINS(Fectrans,Faltafw,Fmodifw,Fecexpo,Fecimpo,Haltafw,Horaexpo,Horaimpo,Saltafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Bdmodifw,Esttrans,Bdaltafw,Codigo,Descrip,Cliedesde,Cliehasta,Fecomdesde,Fecomhasta,Vendesde,Venhasta,Numdesde,Numhasta,Motidesde,Motihasta,Trandesde,Tranhasta,Obs)
					Select isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.CLIEDESDE,''),isnull( d.CLIEHASTA,''),isnull( d.FECOMDESDE,''),isnull( d.FECOMHASTA,''),isnull( d.VENDESDE,''),isnull( d.VENHASTA,''),isnull( d.NUMDESDE,0),isnull( d.NUMHASTA,0),isnull( d.MOTIDESDE,''),isnull( d.MOTIHASTA,''),isnull( d.TRANDESDE,''),isnull( d.TRANHASTA,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="FILTRARCOMPROBANTESAINSERTAR            " atributo="FECHATRANSFERENCIA                      " tabla="COMPAINS       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FILTRARCOMPROBANTESAINSERTAR            " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPAINS       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FILTRARCOMPROBANTESAINSERTAR            " atributo="VENDEDORHASTA                           " tabla="COMPAINS       " campo="VENHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="410" etiqueta="Vendedor hasta                                                                                                                                                  " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="6" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FILTRARCOMPROBANTESAINSERTAR            " atributo="TRANSPORTISTADESDE                      " tabla="COMPAINS       " campo="TRANDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Transportista desde                                                                                                                                             " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="8" orden="85" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESAINSERTAR            " atributo="TRANSPORTISTAHASTA                      " tabla="COMPAINS       " campo="TRANHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="15" decimales="0" valorsugerido="ZZZZZZZZZZZZZZZ                                                                                                                                                                                                                                               " obligatorio="false" admitebusqueda="0" etiqueta="Transportista hasta                                                                                                                                             " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="8" orden="90" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
