...
define class Mock_reglastransferencias as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Reglas de paquetes de datos"                                                                                                                                                                                                             
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'REGLASTRANSFERENCIAS'                                                                                                                                                                                                                          
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	oColEntidadesConMotivo = null                                                                                                                                                                                                                             
	oColEntidadesConOrigenDestino = null                                                                                                                                                                                                                      
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function habilitada_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'habilitada_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'habilitada_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Habilitada		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Habilitada( lxVal )				this.Setear_Habilitada( lxVal )			EndIf		Else			This.Setear_Habilitada( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombrecampomotivo( tctransferenciaorigen ) as string                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tctransferenciaorigen
		...
		return this.ObtenerResultado( 'Obtenernombrecampomotivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenernombrecampoorigendestino( tctransferenciaorigen ) as string                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenernombrecampoorigendestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombreentidadtransferencia() as string                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenernombreentidadtransferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolentidadesconmotivo_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolentidadesconmotivo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolentidadesconmotivo_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oColEntidadesConMotivo ) = 'O' or isnull( this.oColEntidadesConMotivo )  )			this.oColEntidadesConMotivo = goServicios.Estructura.ObtenerColeccionEntidadesConMotivo()		endif		return this.oColEntidadesConMotivo
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocolentidadesconorigendestino_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolentidadesconorigendestino_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolentidadesconorigendestino_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oColEntidadesConOrigenDestino ) = 'O' or isnull( this.oColEntidadesConOrigenDestino )  )			this.oColEntidadesConOrigenDestino = goServicios.Estructura.ObtenerColeccionEntidadesConOrigenDestino()		endif		return this.oColEntidadesConOrigenDestino
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function origen_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'origen_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'origen_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Origen		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Origen( lxVal )				this.Setear_Origen( lxVal )			EndIf		Else			This.Setear_Origen( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_habilitada( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_habilitada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_habilitada', lcParametros )			endif		endif		this.Habilitada = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_origen( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_origen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_origen', lcParametros )			endif		endif		this.Origen = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_transferencia( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_transferencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_transferencia', lcParametros )			endif		endif		this.Transferencia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearestadodemotivoyorigendestino() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearestadodemotivoyorigendestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function transferencia_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'transferencia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'transferencia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Transferencia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Transferencia( lxVal )				this.Setear_Transferencia( lxVal )				 This.Transferencia_DespuesDeAsignar()			EndIf		Else			This.Setear_Transferencia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function transferencia_despuesdeasignar() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Transferencia_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_habilitada( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_habilitada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_habilitada', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_origen( txval as variant ) as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_origen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_origen', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_transferencia( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REGLASTRANSFERENCIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_transferencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_transferencia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartransferencia() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validartransferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohabilitada() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridohabilitada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoorigen() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridoorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotransferencia() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotransferencia', lcParametros )
	EndFunc
