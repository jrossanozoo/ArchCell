...
define class Din_EntidadTipodeorden_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Tipodeorden"
	cClaseResponse = this.cNamespaceDTOs + ".TipodeordenResponse"
	cClaseModelo = "TipodeordenModelo"
	cEntidad = "Tipodeorden"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TipodeordenModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TipodeordenListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TipodeordenListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TipodeordenModelo"
		endcase
		return lcRetorno
