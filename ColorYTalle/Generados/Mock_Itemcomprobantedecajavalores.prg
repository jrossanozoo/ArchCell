...
define class Mock_Itemcomprobantedecajavalores as MockBase of MockBase.prg

	cClase = 'Itemcomprobantedecajavalores'
	...
	*-----------------------------------------------------------------------------------------
	function cajavalor_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cajavalor_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cajavalor( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_cajavalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cajavalor( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_cajavalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovalordetalle() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridovalordetalle', lcParametros )
	EndFunc
