...
define class Mock_Itemfavoritolistadoslistadosdetalle as MockBase of MockBase.prg

	cClase = 'Itemfavoritolistadoslistadosdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function numerolistado_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Numerolistado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerolistado( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_numerolistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerolistado( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_numerolistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumerolistado() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridonumerolistado', lcParametros )
	EndFunc
