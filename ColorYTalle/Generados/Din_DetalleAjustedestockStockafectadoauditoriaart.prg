...
define class Din_DetalleAJUSTEDESTOCKStockafectadoauditoriaart as DetalleAjustearticulos of DetalleAjustearticulos.Prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Stockafectadoauditoriaart' ) > 0 and reccount( 'c_Stockafectadoauditoriaart' ) > 0
					sum Cantidad;
						 to ;
						 lnSum_Cantidad
				endif
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemAJUSTEDESTOCKStockafectadoauditoriaart' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Stockafectadoauditoriaart
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.codigo = c_Stockafectadoauditoriaart.codigo
			loItem.NROITEM = c_Stockafectadoauditoriaart.NROITEM
			loItem.Articulo_PK = c_Stockafectadoauditoriaart.Articulo
			loItem.ArticuloDetalle = c_Stockafectadoauditoriaart.ArticuloDetalle
			loItem.StockAct = c_Stockafectadoauditoriaart.StockAct
			loItem.StockProy = c_Stockafectadoauditoriaart.StockProy
			loItem.Cantidad = c_Stockafectadoauditoriaart.Cantidad
			loItem.NroItem = lnI 
