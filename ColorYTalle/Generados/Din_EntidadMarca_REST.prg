...
define class Din_EntidadMarca_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Marca"
	cClaseResponse = this.cNamespaceDTOs + ".MarcaResponse"
	cClaseModelo = "MarcaModelo"
	cEntidad = "Marca"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "MarcaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MarcaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MarcaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "MarcaModelo"
		endcase
		return lcRetorno
