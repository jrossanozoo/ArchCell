...
define class Mock_Itemcancelaciondeseniasseniascancdetalle as MockBase of MockBase.prg

	cClase = 'Itemcancelaciondeseniasseniascancdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function fechaalta_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Fechaalta_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechavto_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Fechavto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seleccionada_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Seleccionada_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaalta( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_fechaalta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechavto( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_fechavto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_seleccionada( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_seleccionada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaalta( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_fechaalta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechavto( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_fechavto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_seleccionada( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_seleccionada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoseleccionada() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoseleccionada', lcParametros )
	EndFunc
