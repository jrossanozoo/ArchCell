...
define class Din_EntidadNotadedebitodeexportacion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadedebitodeexportacion"
	cClaseResponse = this.cNamespaceDTOs + ".NotadedebitodeexportacionResponse"
	cClaseModelo = "NotadedebitodeexportacionModelo"
	cEntidad = "Notadedebitodeexportacion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitodeexportacionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitodeexportacionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitodeexportacionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitodeexportacionModelo"
		endcase
		return lcRetorno
