...
define class Mock_cotizacionproduccion as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecotizacionordenadicionales() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cambiosdetallecotizacionordenadicionales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecotizacionordendescarte() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cambiosdetallecotizacionordendescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecotizacionordeninsumos() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Cambiosdetallecotizacionordeninsumos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecotizacionordenproduccion() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cambiosdetallecotizacionordenproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearliquidacion() as boolean                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Crearliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descartes_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descartes_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descartes_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Descartes		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Descartes( lxVal )				this.Setear_Descartes( lxVal )			EndIf		Else			This.Setear_Descartes( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventodespuesdeactualizardetalle() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Eventodespuesdeactualizardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventofinalizarproceso() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventofinalizarproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoiniciarproceso( tcmensaje as string ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eventoiniciarproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntaractualizarcostos() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Eventopreguntaractualizarcostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntaractualizardetalle() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Eventopreguntaractualizardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generar_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'generar_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'generar_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Generar		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Generar( lxVal )				this.Setear_Generar( lxVal )			EndIf		Else			This.Setear_Generar( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function insumos_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'insumos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'insumos_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Insumos		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Insumos( lxVal )				this.Setear_Insumos( lxVal )			EndIf		Else			This.Setear_Insumos( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenardesdeliquidacionprecargada() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Llenardesdeliquidacionprecargada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenarliquidaciondesdecotizacion() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Llenarliquidaciondesdecotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function observ_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'observ_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'observ_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Observ		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Observ( lxVal )				this.Setear_Observ( lxVal )			EndIf		Else			This.Setear_Observ( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descartes( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_descartes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_descartes', lcParametros )			endif		endif		this.Descartes = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_insumos( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_insumos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_insumos', lcParametros )			endif		endif		this.Insumos = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_listadecosto( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_listadecosto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_listadecosto', lcParametros )			endif		endif		dodefault( txVal )		this.Moneda_PK = this.ListaDeCosto.Moneda_PK		if this.cListaCotizada # txVal			this.RecalculoDeCostos()		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_observ( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_observ', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_observ', lcParametros )			endif		endif		this.Observ = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descartes( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descartes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descartes', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_insumos( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_insumos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_insumos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_observ( txval as variant ) as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COTIZACIONPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_observ', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_observ', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validargestiondeproduccion() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validargestiondeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarlistadecosto() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarlistadecosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodescartes() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridodescartes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwdescartes() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridofwdescartes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwgenerar() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwgenerar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwinsumos() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwinsumos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridogenerar() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridogenerar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridogestiondeproduccion() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridogestiondeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinsumos() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoinsumos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoletracomprobante() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridoletracomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridolistadecosto() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridolistadecosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumerocomprobante() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridonumerocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoobserv() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridoobserv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopuntodeventacomprobante() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridopuntodeventacomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debeinlcuirdescartesenliquidacion( totaller as object, tcproceso as string ) as boolean                                                                                                                                                
		...
		return this.ObtenerResultado( 'Debeinlcuirdescartesenliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debeinlcuirinsumosenliquidacion( totaller as object, tcproceso as string ) as boolean                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Debeinlcuirinsumosenliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llenardetalledesdecoleccion(todetalle as object, tocoleccion as object) as void                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Llenardetalledesdecoleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerarticuloparainsumosdedescarte( tcinsumo as string ) as string                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerarticuloparainsumosdedescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerarticuloparainsumosdeproduccion( tcinsumo as string ) as string                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerarticuloparainsumosdeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerarticuloparaliquidaciondedescarte( toproceso as object ) as string                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerarticuloparaliquidaciondedescarte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerarticuloparaliquidaciondeproduccion( toproceso as object ) as string                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerarticuloparaliquidaciondeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerlistadecostos( totaller as object ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerlistadecostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recalculodecostos() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Recalculodecostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recorreryagregaritem( tccoleorigen as object, tccoledestino as object, tcarticulo ) as void                                                                                                                                            
		...
		lnParametros = pcount()
		lxParam1 = tccoleorigen
		lxParam2 = tccoledestino
		lxParam3 = tcarticulo
		...
		return this.ObtenerResultado( 'Recorreryagregaritem', lcParametros )
	EndFunc
