...
define class Mock_Itemconveniomultilateralimpuestosconvenio as MockBase of MockBase.prg

	cClase = 'Itemconveniomultilateralimpuestosconvenio'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwporcentaje() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwporcentaje', lcParametros )
	EndFunc
