...
define class Din_EntidadAdt_descuento_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Adt_descuento"
	cClaseResponse = this.cNamespaceDTOs + ".Adt_descuentoResponse"
	cClaseModelo = "Adt_descuentoModelo"
	cEntidad = "Adt_descuento"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_descuentoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_descuentoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_descuentoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_descuentoModelo"
		endcase
		return lcRetorno
