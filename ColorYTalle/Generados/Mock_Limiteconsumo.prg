...
define class Mock_limiteconsumo as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Límites de consumos"                                                                                                                                                                                                                     
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'LIMITECONSUMO'                                                                                                                                                                                                                                 
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function enviarmensajevalidacionentrefechas( tcmensaje as string ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Enviarmensajevalidacionentrefechas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existecomprobantesexcedentes() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existecomprobantesexcedentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montoutilizado_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIMITECONSUMO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'montoutilizado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'montoutilizado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Montoutilizado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Montoutilizado( lxVal )				this.Setear_Montoutilizado( lxVal )			EndIf		Else			This.Setear_Montoutilizado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigolimiteconsumovigente( tccliente as string, tdfecha as date ) as string                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenercodigolimiteconsumovigente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermontoconsumido() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function oconsumocliente_access() as object                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'LIMITECONSUMO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oconsumocliente_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oconsumocliente_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oConsumoCliente ) = 'O' or isnull( this.oConsumoCliente ) )			this.oConsumoCliente = _Screen.Zoo.InstanciarEntidad( 'ConsumoCliente' )		endif				return this.oConsumoCliente
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sepuedeutilizarlimitedeconsumo( tccliente as string, tdfecha as date, tnmontoautilizar as number ) as boolean                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Sepuedeutilizarlimitedeconsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montoutilizado( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIMITECONSUMO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_montoutilizado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_montoutilizado', lcParametros )			endif		endif		this.Montoutilizado = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montoutilizado( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIMITECONSUMO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_montoutilizado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_montoutilizado', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcambiodemonto() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcambiodemonto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcomprobantesentrefechas() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcomprobantesentrefechas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarconsumosentrefechas() as boolean                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarconsumosentrefechas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarrangofechas() as boolean                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarrangofechas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existencomprobantesasociadosallimitedeconsumo() as boolean                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
