...
define class Mock_Detalleordendepagoordendepagodetalle as MockBase of MockBase.prg

	cClase = 'Detalleordendepagoordendepagodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_cuentaparaimpresion() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventocambiosum_cuentaparaimpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_saldoaux() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Eventocambiosum_saldoaux', lcParametros )
	EndFunc
