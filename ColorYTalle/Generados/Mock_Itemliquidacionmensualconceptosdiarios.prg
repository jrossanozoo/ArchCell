...
define class Mock_Itemliquidacionmensualconceptosdiarios as MockBase of MockBase.prg

	cClase = 'Itemliquidacionmensualconceptosdiarios'
	...
	*-----------------------------------------------------------------------------------------
	function liquidacion_access() as variant                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Liquidacion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function liquidacion_pk_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Liquidacion_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_liquidacion( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_liquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_liquidacion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_liquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoliquidacion() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoliquidacion', lcParametros )
	EndFunc
