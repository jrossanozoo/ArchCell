...
define class Din_EntidadDESPACHODEIMPORTACIONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxDespimpFectrans, lxDespimpFaltafw, lxDespimpFmodifw, lxDespimpFecimpo, lxDespimpFecexpo, lxDespimpHoraimpo, lxDespimpHoraexpo, lxDespimpHaltafw, lxDespimpSaltafw, lxDespimpVmodifw, lxDespimpZadsfw, lxDespimpValtafw, lxDespimpUmodifw, lxDespimpSmodifw, lxDespimpUaltafw, lxDespimpHmodifw, lxDespimpEsttrans, lxDespimpBdaltafw, lxDespimpBdmodifw, lxDespimpTimestamp, lxDespimpDespacho, lxDespimpIncoterms, lxDespimpFechaing, lxDespimpMoneda, lxDespimpOficializ, lxDespimpCantuni, lxDespimpArribo, lxDespimpFob, lxDespimpFlete, lxDespimpSeguro, lxDespimpObs, lxDespimpFtotal
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.DESPIMP ( "Fectrans","Faltafw","Fmodifw","Fecimpo","Fecexpo","Horaimpo","Horaexpo","Haltafw","Saltafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Esttrans","Bdaltafw","Bdmodifw","Timestamp","Despacho","Incoterms","Fechaing","Moneda","Oficializ","Cantuni","Arribo","Fob","Flete","Seguro","Obs","Ftotal" ) values ( <<"'" + this.ConvertirDateSql( lxDespimpFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDespimpFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDespimpFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDespimpFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDespimpFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpBdmodifw ) + "'" >>, <<lxDespimpTimestamp >>, <<"'" + this.FormatearTextoSql( lxDespimpDespacho ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpIncoterms ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDespimpFechaing ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpMoneda ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDespimpOficializ ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDespimpCantuni ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDespimpArribo ) + "'" >>, <<lxDespimpFob >>, <<lxDespimpFlete >>, <<lxDespimpSeguro >>, <<"'" + this.FormatearTextoSql( lxDespimpObs ) + "'" >>, <<lxDespimpFtotal >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.DESPIMP set "Fectrans" = <<"'" + this.ConvertirDateSql( lxDespimpFectrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxDespimpFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxDespimpFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxDespimpFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxDespimpFecexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxDespimpHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxDespimpHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxDespimpHaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxDespimpSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxDespimpVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxDespimpZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxDespimpValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxDespimpUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxDespimpSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxDespimpUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxDespimpHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxDespimpEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDespimpBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDespimpBdmodifw ) + "'">>,"Timestamp" = <<lxDespimpTimestamp>>,"Despacho" = <<"'" + this.FormatearTextoSql( lxDespimpDespacho ) + "'">>,"Incoterms" = <<"'" + this.FormatearTextoSql( lxDespimpIncoterms ) + "'">>,"Fechaing" = <<"'" + this.ConvertirDateSql( lxDespimpFechaing ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxDespimpMoneda ) + "'">>,"Oficializ" = <<"'" + this.ConvertirDateSql( lxDespimpOficializ ) + "'">>,"Cantuni" = <<"'" + this.FormatearTextoSql( lxDespimpCantuni ) + "'">>,"Arribo" = <<"'" + this.ConvertirDateSql( lxDespimpArribo ) + "'">>,"Fob" = <<lxDespimpFob>>,"Flete" = <<lxDespimpFlete>>,"Seguro" = <<lxDespimpSeguro>>,"Obs" = <<"'" + this.FormatearTextoSql( lxDespimpObs ) + "'">>,"Ftotal" = <<lxDespimpFtotal>> where "Despacho" = <<"'" + this.FormatearTextoSql( lxDespimpDespacho ) + "'">> and  DESPIMP.DESPACHO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Faltafw,Fmodifw,Fecimpo,Fecexpo,Horaimpo,Horaexpo,Haltafw,Saltafw,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdaltafw,Bdmodifw,Timestamp,Despacho,Incoterms,Fechai" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FALTAFW, FMODIFW, FECIMPO, FECEXPO, HORAIMPO, HORAEXPO, HALTAFW, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, ESTTRANS, BDALTAFW, BDMODIFW, TIMESTAMP, Despacho, Incoterms, FechaIng, Moneda, Oficializ, CantUni, Arribo, Fob, Flete, Seguro, Obs, FTotal
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Despacho ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.DESPACHO = isnull( d.DESPACHO, t.DESPACHO ),t.INCOTERMS = isnull( d.INCOTERMS, t.INCOTERMS ),t.FECHAING = isnull( d.FECHAING, t.FECHAING ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.OFICIALIZ = isnull( d.OFICIALIZ, t.OFICIALIZ ),t.CANTUNI = isnull( d.CANTUNI, t.CANTUNI ),t.ARRIBO = isnull( d.ARRIBO, t.ARRIBO ),t.FOB = isnull( d.FOB, t.FOB ),t.FLETE = isnull( d.FLETE, t.FLETE ),t.SEGURO = isnull( d.SEGURO, t.SEGURO ),t.OBS = isnull( d.OBS, t.OBS ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL )
					from ZooLogic.DESPIMP t inner join deleted d 
							 on t.Despacho = d.Despacho
				-- Fin Updates
				insert into ZooLogic.DESPIMP(Fectrans,Faltafw,Fmodifw,Fecimpo,Fecexpo,Horaimpo,Horaexpo,Haltafw,Saltafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdaltafw,Bdmodifw,Timestamp,Despacho,Incoterms,Fechaing,Moneda,Oficializ,Cantuni,Arribo,Fob,Flete,Seguro,Obs,Ftotal)
					Select isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.DESPACHO,''),isnull( d.INCOTERMS,''),isnull( d.FECHAING,''),isnull( d.MONEDA,''),isnull( d.OFICIALIZ,''),isnull( d.CANTUNI,''),isnull( d.ARRIBO,''),isnull( d.FOB,0),isnull( d.FLETE,0),isnull( d.SEGURO,0),isnull( d.OBS,''),isnull( d.FTOTAL,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="DESPACHODEIMPORTACION                   " atributo="FECHATRANSFERENCIA                      " tabla="DESPIMP        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESPACHODEIMPORTACION                   " atributo="ESTADOTRANSFERENCIA                     " tabla="DESPIMP        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
...
<VFPData xml:space="preserve">
	...
	<row entidad="ITEMARTICULOSDESPACHO                   " atributo="ARTICULO                                " tabla="DESPIMPDET     " campo="CODART    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="201" etiqueta="DetalleArtículos, Artículo                                                                                                                                      " dominio="CLAVECONLECTURACB             " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DESPIMPDET On DESPIMP.Despacho = DESPIMPDET.Codigo And  DESPIMP.DESPACHO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMARTICULOSDESPACHO                   " atributo="ARTICULODETALLE                         " tabla="DESPIMPDET     " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="202" etiqueta="DetalleArtículos, Artículo descripción                                                                                                                          " dominio="DESCRIPCION                   " detalle="false" tipo="I" atributoforaneo="Articulo.Descripcion                                                                                                                                                                                                                                          " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DESPIMPDET On DESPIMP.Despacho = DESPIMPDET.Codigo And  DESPIMP.DESPACHO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
