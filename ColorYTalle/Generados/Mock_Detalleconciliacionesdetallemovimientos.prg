...
define class Mock_Detalleconciliacionesdetallemovimientos as MockBase of MockBase.prg

	cClase = 'Detalleconciliacionesdetallemovimientos'
	...
	cMensajeErrorUnicidad = 'La columna Movimiento no admite valores repetidos.'                                                                                                                                                                              
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_importe() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Eventocambiosum_importe', lcParametros )
	EndFunc
