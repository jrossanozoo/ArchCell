...
define class Din_DetalleNOTADECREDITOELECTRONICADECREDITOArticulosseniadosdetalle as DetalleColorytalle_articulosseniados of DetalleColorytalle_articulosseniados.Prg
	...
	Sum_Neto = 0
	Sum_Tienerestriccion = 0

	nCantidadItems = 999
	cNombre = 'Articulosseniadosdetalle'
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.TipoDeItem = this.Item[ tnItem ].TipoDeItem
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'TipoDeItem', .TipoDeItem )
				...
				.Stock = this.Item[ tnItem ].Stock
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'Stock', .Stock )
			
				.CodigoGTIN = this.Item[ tnItem ].CodigoGTIN
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'CodigoGTIN', .CodigoGTIN )
				...
				.MontoImpuestoInterno = this.Item[ tnItem ].MontoImpuestoInterno
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'MontoImpuestoInterno', .MontoImpuestoInterno )
			
				.RestringirDescuentos = this.Item[ tnItem ].RestringirDescuentos
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'RestringirDescuentos', .RestringirDescuentos )
			
				.Afe_Codigo = this.Item[ tnItem ].Afe_Codigo
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'Afe_Codigo', .Afe_Codigo )
			
				.TieneRestriccion = this.Item[ tnItem ].TieneRestriccion
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'TieneRestriccion', .TieneRestriccion )
			
				.MontoProrrateoRecargoFinancieroSinImp = this.Item[ tnItem ].MontoProrrateoRecargoFinancieroSinImp
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'MontoProrrateoRecargoFinancieroSinImp', .MontoProrrateoRecargoFinancieroSinImp )
			
				.MontoProrrateoDescuentoFinancieroSinImp = this.Item[ tnItem ].MontoProrrateoDescuentoFinancieroSinImp
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'MontoProrrateoDescuentoFinancieroSinImp', .MontoProrrateoDescuentoFinancieroSinImp )
				...
				.CodigoAutorizacionDJCP = this.Item[ tnItem ].CodigoAutorizacionDJCP
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'CodigoAutorizacionDJCP', .CodigoAutorizacionDJCP )
			
				.OrdenDeServicio = this.Item[ tnItem ].OrdenDeServicio
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'OrdenDeServicio', .OrdenDeServicio )
				...
				.IdKit = this.Item[ tnItem ].IdKit
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'IdKit', .IdKit )
			
				.EsLibre = this.Item[ tnItem ].EsLibre
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'EsLibre', .EsLibre )
			
				.afe_SaldoLiquidacion = this.Item[ tnItem ].afe_SaldoLiquidacion
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'afe_SaldoLiquidacion', .afe_SaldoLiquidacion )
			
				.NumeroGiftCard_PK = this.Item[ tnItem ].NumeroGiftCard_PK
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'NumeroGiftCard_PK', .NumeroGiftCard_PK )
				...
				.afe_codigo_Aux = this.Item[ tnItem ].afe_codigo_Aux
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'afe_codigo_Aux', .afe_codigo_Aux )
			
				.iditemarticulos_Aux = this.Item[ tnItem ].iditemarticulos_Aux
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'iditemarticulos_Aux', .iditemarticulos_Aux )
				...
				.MontoProrrateoImpuestoInterno = this.Item[ tnItem ].MontoProrrateoImpuestoInterno
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'MontoProrrateoImpuestoInterno', .MontoProrrateoImpuestoInterno )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.TipoDeItem = this.oItem.TipoDeItem
			...
			.Stock = this.oItem.Stock
			.CodigoGTIN = this.oItem.CodigoGTIN
			.FUEAUTORIZADODEVOLUCION = this.oItem.FUEAUTORIZADODEVOLUCION
			.TasaImpuestoInterno = this.oItem.TasaImpuestoInterno
			.MontoImpuestoInterno = this.oItem.MontoImpuestoInterno
			.RestringirDescuentos = this.oItem.RestringirDescuentos
			.Afe_Codigo = this.oItem.Afe_Codigo
			.TieneRestriccion = this.oItem.TieneRestriccion
			.MontoProrrateoRecargoFinancieroSinImp = this.oItem.MontoProrrateoRecargoFinancieroSinImp
			.MontoProrrateoDescuentoFinancieroSinImp = this.oItem.MontoProrrateoDescuentoFinancieroSinImp
			...
			.CodigoAutorizacionDJCP = this.oItem.CodigoAutorizacionDJCP
			.OrdenDeServicio = this.oItem.OrdenDeServicio
			.Comportamiento = this.oItem.Comportamiento
			.IdKit = this.oItem.IdKit
			.EsLibre = this.oItem.EsLibre
			.afe_SaldoLiquidacion = this.oItem.afe_SaldoLiquidacion
			.NumeroGiftCard_PK = this.oItem.NumeroGiftCard_PK
			.PercepcionIvaRG5329 = this.oItem.PercepcionIvaRG5329
			.afe_codigo_Aux = this.oItem.afe_codigo_Aux
			.iditemarticulos_Aux = this.oItem.iditemarticulos_Aux
			...
			.MontoProrrateoImpuestoInterno = this.oItem.MontoProrrateoImpuestoInterno
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].TipoDeItem = .oItem.TipoDeItem
			...
			.Item[ lnItem ].Stock = .oItem.Stock
			.Item[ lnItem ].CodigoGTIN = .oItem.CodigoGTIN
			...
			.Item[ lnItem ].MontoImpuestoInterno = .oItem.MontoImpuestoInterno
			.Item[ lnItem ].RestringirDescuentos = .oItem.RestringirDescuentos
			.Item[ lnItem ].Afe_Codigo = .oItem.Afe_Codigo
			.Item[ lnItem ].TieneRestriccion = .oItem.TieneRestriccion
			.Item[ lnItem ].MontoProrrateoRecargoFinancieroSinImp = .oItem.MontoProrrateoRecargoFinancieroSinImp
			.Item[ lnItem ].MontoProrrateoDescuentoFinancieroSinImp = .oItem.MontoProrrateoDescuentoFinancieroSinImp
			...
			.Item[ lnItem ].CodigoAutorizacionDJCP = .oItem.CodigoAutorizacionDJCP
			.Item[ lnItem ].OrdenDeServicio = .oItem.OrdenDeServicio
			.Item[ lnItem ].Comportamiento = .oItem.Comportamiento
			.Item[ lnItem ].IdKit = .oItem.IdKit
			.Item[ lnItem ].EsLibre = .oItem.EsLibre
			.Item[ lnItem ].afe_SaldoLiquidacion = .oItem.afe_SaldoLiquidacion
			.Item[ lnItem ].NumeroGiftCard_PK = .oItem.NumeroGiftCard_PK
			.Item[ lnItem ].PercepcionIvaRG5329 = .oItem.PercepcionIvaRG5329
			.Item[ lnItem ].afe_codigo_Aux = .oItem.afe_codigo_Aux
			.Item[ lnItem ].iditemarticulos_Aux = .oItem.iditemarticulos_Aux
			...
			.Item[ lnItem ].MontoProrrateoImpuestoInterno = .oItem.MontoProrrateoImpuestoInterno
	...
	*--------------------------------------------------------------------------------------------------------
	function Sumarizar() as boolean
		local lnItem as integer, loItem as Object, lnSum_Afe_saldo as Number, lnSum_Ajusteporredondeoconimpuestos as Number, lnSum_Ajusteporredondeosinimpuestos as Number, lnSum_Bruto as Number, lnSum_Cantidad as Number, lnSum_Impuestos as Number, lnSum_Monto as Number, lnSum_Montodescuento as Number, lnSum_Montoporcentajedescuentoconimpuesto as Number, lnSum_Neto as Number, lnSum_Tienerestriccion as Number
		...
		with this
			...
			lnSum_Neto = 0
			lnSum_Tienerestriccion = 0
			if this.lEsNavegacion
				if select( 'c_Articulosseniadosdetalle' ) > 0 and reccount( 'c_Articulosseniadosdetalle' ) > 0
					sum Afe_saldo, Ajusteporredondeoconimpuestos, Ajusteporredondeosinimpuestos, Bruto, Cantidad, Monto, Montodescuento, Montoporcentajedescuentoconimpuesto, Neto, Tienerestriccion;
						 to ;
						 lnSum_Afe_saldo, lnSum_Ajusteporredondeoconimpuestos, lnSum_Ajusteporredondeosinimpuestos, lnSum_Bruto, lnSum_Cantidad, lnSum_Monto, lnSum_Montodescuento, lnSum_Montoporcentajedescuentoconimpuesto, lnSum_Neto, lnSum_Tienerestriccion
				endif
					...
					if .oItem.NroItem = lnItem
						...
						with loItem 
							if !empty(.ARTICULO_PK)
								...
								lnSum_Tienerestriccion = lnSum_Tienerestriccion + .Tienerestriccion
							endif
						endwith
					endif
				endfor
			...
			if .Sum_Tienerestriccion != lnSum_Tienerestriccion
				.Sum_Tienerestriccion = lnSum_Tienerestriccion
				.EventoCambioSum_Tienerestriccion()
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	function EventoCambioSum_Tienerestriccion() as boolean
		** Evento que se dispara cuando cambia el sumarizado
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function Acumular( tlForzar as Boolean, tcAtributo as String, tnValor as Decimal, tnValorAnt as Decimal ) as Void
		...
		case tcAtributo == 'Tienerestriccion'
			this.Sum_Tienerestriccion = this.Sum_Tienerestriccion - tnValorAnt + tnValor
			this.EventoCambioSum_Tienerestriccion()
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemNOTADECREDITOELECTRONICADECREDITOArticulosseniadosdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Articulosseniadosdetalle
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Articulo_PK = c_Articulosseniadosdetalle.Articulo
			loItem.Codigo = c_Articulosseniadosdetalle.Codigo
			loItem.MontoPorcentajeDescuentoConImpuesto = c_Articulosseniadosdetalle.MontoPorcentajeDescuentoConImpuesto
			loItem.Kit = c_Articulosseniadosdetalle.Kit
			loItem.MontoCFI = c_Articulosseniadosdetalle.MontoCFI
			loItem.MontoDTO1 = c_Articulosseniadosdetalle.MontoDTO1
			loItem.MontoIVA = c_Articulosseniadosdetalle.MontoIVA
			loItem.Neto = c_Articulosseniadosdetalle.Neto
			loItem.NroItem = c_Articulosseniadosdetalle.NroItem
			loItem.Oferta = c_Articulosseniadosdetalle.Oferta
			loItem.PorcentajeCFI = c_Articulosseniadosdetalle.PorcentajeCFI
			loItem.PorcentajeDTO1 = c_Articulosseniadosdetalle.PorcentajeDTO1
			loItem.PorcentajeIVA = c_Articulosseniadosdetalle.PorcentajeIVA
			loItem.PrecioConImpuestos = c_Articulosseniadosdetalle.PrecioConImpuestos
			loItem.PrecioSinImpuestos = c_Articulosseniadosdetalle.PrecioSinImpuestos
			loItem.PrecioUnitario = c_Articulosseniadosdetalle.PrecioUnitario
			loItem.TipoListaDePrecio = c_Articulosseniadosdetalle.TipoListaDePrecio
			loItem.Unidad_PK = c_Articulosseniadosdetalle.Unidad
			loItem.idItem = c_Articulosseniadosdetalle.idItem
			loItem.idOrigen = c_Articulosseniadosdetalle.idOrigen
			loItem.Afe_NroItem = c_Articulosseniadosdetalle.Afe_NroItem
			loItem.Afe_TipoComprobante = c_Articulosseniadosdetalle.Afe_TipoComprobante
			loItem.Afe_Letra = c_Articulosseniadosdetalle.Afe_Letra
			loItem.Afe_PuntoDeVenta = c_Articulosseniadosdetalle.Afe_PuntoDeVenta
			loItem.Afe_Numero = c_Articulosseniadosdetalle.Afe_Numero
			loItem.Afe_Cantidad = c_Articulosseniadosdetalle.Afe_Cantidad
			loItem.Afe_Saldo = c_Articulosseniadosdetalle.Afe_Saldo
			loItem.Articulo_CondicionIvaVentas = c_Articulosseniadosdetalle.Articulo_CondicionIvaVentas
			loItem.Articulo_PorcentajeIvaVentas = c_Articulosseniadosdetalle.Articulo_PorcentajeIvaVentas
			loItem.NoProcesarStock = c_Articulosseniadosdetalle.NoProcesarStock
			loItem.Afe_timeStamp = c_Articulosseniadosdetalle.Afe_timeStamp
			loItem.MontoProrrateoRecargoConImpuestos = c_Articulosseniadosdetalle.MontoProrrateoRecargoConImpuestos
			loItem.MontoProrrateoTotal = c_Articulosseniadosdetalle.MontoProrrateoTotal
			loItem.MontoProrrateoPercepciones = c_Articulosseniadosdetalle.MontoProrrateoPercepciones
			loItem.MontoProrrateoDescuentoConImpuestos = c_Articulosseniadosdetalle.MontoProrrateoDescuentoConImpuestos
			loItem.MontoProrrateoRecargoSinImpuestos = c_Articulosseniadosdetalle.MontoProrrateoRecargoSinImpuestos
			loItem.MontoProrrateoDescuentoSinImpuestos = c_Articulosseniadosdetalle.MontoProrrateoDescuentoSinImpuestos
			loItem.MontoPorcentajeDescuentoSinImpuesto = c_Articulosseniadosdetalle.MontoPorcentajeDescuentoSinImpuesto
			loItem.MontoDescuentoConImpuestos = c_Articulosseniadosdetalle.MontoDescuentoConImpuestos
			loItem.MontoDescuentoSinImpuestos = c_Articulosseniadosdetalle.MontoDescuentoSinImpuestos
			loItem.PrecioSinImpuestosSinRedondear = c_Articulosseniadosdetalle.PrecioSinImpuestosSinRedondear
			loItem.PrecioConImpuestosSinRedondear = c_Articulosseniadosdetalle.PrecioConImpuestosSinRedondear
			loItem.PrecioSinRedondear = c_Articulosseniadosdetalle.PrecioSinRedondear
			loItem.UsarPrecioDeLista = c_Articulosseniadosdetalle.UsarPrecioDeLista
			loItem.Bruto = c_Articulosseniadosdetalle.Bruto
			loItem.AjustePorRedondeoConImpuestos = c_Articulosseniadosdetalle.AjustePorRedondeoConImpuestos
			loItem.AjustePorRedondeoSinImpuestos = c_Articulosseniadosdetalle.AjustePorRedondeoSinImpuestos
			loItem.IdItemArticulos = c_Articulosseniadosdetalle.IdItemArticulos
			loItem.CodigoGTIN = c_Articulosseniadosdetalle.CodigoGTIN
			loItem.TasaImpuestoInterno = c_Articulosseniadosdetalle.TasaImpuestoInterno
			loItem.MontoImpuestoInterno = c_Articulosseniadosdetalle.MontoImpuestoInterno
			loItem.RestringirDescuentos = c_Articulosseniadosdetalle.RestringirDescuentos
			loItem.Afe_Codigo = c_Articulosseniadosdetalle.Afe_Codigo
			loItem.TieneRestriccion = c_Articulosseniadosdetalle.TieneRestriccion
			loItem.CodigoMotivoDevolucion_PK = c_Articulosseniadosdetalle.CodigoMotivoDevolucion
			loItem.CodigoMotivoDescuento_PK = c_Articulosseniadosdetalle.CodigoMotivoDescuento
			loItem.CodigoAutorizacionDJCP = c_Articulosseniadosdetalle.CodigoAutorizacionDJCP
			loItem.Comportamiento = c_Articulosseniadosdetalle.Comportamiento
			loItem.IdKit = c_Articulosseniadosdetalle.IdKit
			loItem.afe_SaldoLiquidacion = c_Articulosseniadosdetalle.afe_SaldoLiquidacion
			loItem.NumeroGiftCard_PK = c_Articulosseniadosdetalle.NumeroGiftCard
			loItem.PercepcionIvaRG5329 = c_Articulosseniadosdetalle.PercepcionIvaRG5329
			loItem.Equivalencia_PK = c_Articulosseniadosdetalle.Equivalencia
			loItem.ArticuloDetalle = c_Articulosseniadosdetalle.ArticuloDetalle
			loItem.Color_PK = c_Articulosseniadosdetalle.Color
			loItem.ColorDetalle = c_Articulosseniadosdetalle.ColorDetalle
			loItem.MontoProrrateoIVA = c_Articulosseniadosdetalle.MontoProrrateoIVA
			loItem.MontoProrrateoImpuestoInterno = c_Articulosseniadosdetalle.MontoProrrateoImpuestoInterno
			loItem.Talle_PK = c_Articulosseniadosdetalle.Talle
			loItem.TalleDetalle = c_Articulosseniadosdetalle.TalleDetalle
			loItem.Cantidad = c_Articulosseniadosdetalle.Cantidad
			loItem.Precio = c_Articulosseniadosdetalle.Precio
			loItem.Descuento = c_Articulosseniadosdetalle.Descuento
			loItem.MontoDescuento = c_Articulosseniadosdetalle.MontoDescuento
			loItem.Monto = c_Articulosseniadosdetalle.Monto
			loItem.NroItem = lnI 
		...
		for lni = 1 to this.Count
			...
			if vartype( this.Item[lni].OFERTA) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo OFERTA del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].AFE_CANTIDAD) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo AFE_CANTIDAD del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].AFE_SALDO) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo AFE_SALDO del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].AFE_TIMESTAMP) = 'N'
				...
				if lnLargoEntero <= 15
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo AFE_TIMESTAMP del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:15), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].MONTOPRORRATEORECARGOCONIMPUESTOS) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEORECARGOCONIMPUESTOS del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].MONTOPRORRATEOTOTAL) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEOTOTAL del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].MONTOPRORRATEOPERCEPCIONES) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEOPERCEPCIONES del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].MONTOPRORRATEODESCUENTOCONIMPUESTOS) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEODESCUENTOCONIMPUESTOS del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].MONTOPRORRATEORECARGOSINIMPUESTOS) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEORECARGOSINIMPUESTOS del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].MONTOPRORRATEODESCUENTOSINIMPUESTOS) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEODESCUENTOSINIMPUESTOS del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].CODIGOGTIN) = 'C'
				if len( alltrim( this.Item[lni].CODIGOGTIN )) <= 13
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud del valor del atributo CODIGOGTIN del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform( len( alltrim( this.Item[lni].CODIGOGTIN ))) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo CODIGOGTIN del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			...
			if vartype( this.Item[lni].MONTOIMPUESTOINTERNO) = 'N'
				lnLargoEntero = len( transform( int( this.Item[lni].MONTOIMPUESTOINTERNO ) ) ) 
				lnValorDelDecimal = this.Item[lni].MONTOIMPUESTOINTERNO - int( this.Item[lni].MONTOIMPUESTOINTERNO )
				lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
				if lnLargoEntero <= 11
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOIMPUESTOINTERNO del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:11), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo MONTOIMPUESTOINTERNO del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			
			if vartype( this.Item[lni].RESTRINGIRDESCUENTOS) = 'L'
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo RESTRINGIRDESCUENTOS del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			...
			if vartype( this.Item[lni].TIENERESTRICCION) = 'N'
				lnLargoEntero = len( transform( int( this.Item[lni].TIENERESTRICCION ) ) ) 
				lnValorDelDecimal = this.Item[lni].TIENERESTRICCION - int( this.Item[lni].TIENERESTRICCION )
				lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
				if lnLargoEntero <= 1
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo TIENERESTRICCION del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:1), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo TIENERESTRICCION del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			...
			if vartype( this.Item[lni].CODIGOAUTORIZACIONDJCP) = 'C'
				if len( alltrim( this.Item[lni].CODIGOAUTORIZACIONDJCP )) <= 150
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud del valor del atributo CODIGOAUTORIZACIONDJCP del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform( len( alltrim( this.Item[lni].CODIGOAUTORIZACIONDJCP ))) + ' Máxima:150), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo CODIGOAUTORIZACIONDJCP del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			...
			if vartype( this.Item[lni].IDKIT) = 'C'
				if len( alltrim( this.Item[lni].IDKIT )) <= 38
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud del valor del atributo IDKIT del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform( len( alltrim( this.Item[lni].IDKIT ))) + ' Máxima:38), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo IDKIT del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			
			if vartype( this.Item[lni].AFE_SALDOLIQUIDACION) = 'N'
				lnLargoEntero = len( transform( int( this.Item[lni].AFE_SALDOLIQUIDACION ) ) ) 
				lnValorDelDecimal = this.Item[lni].AFE_SALDOLIQUIDACION - int( this.Item[lni].AFE_SALDOLIQUIDACION )
				lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
				if lnLargoEntero <= 13
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo AFE_SALDOLIQUIDACION del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo AFE_SALDOLIQUIDACION del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			
			if vartype( this.Item[lni].NUMEROGIFTCARD_PK) = 'C'
				if len( alltrim( this.Item[lni].NUMEROGIFTCARD_PK )) <= 38
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud del valor del atributo NUMEROGIFTCARD del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform( len( alltrim( this.Item[lni].NUMEROGIFTCARD_PK ))) + ' Máxima:38), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo NUMEROGIFTCARD del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
			...
			if vartype( this.Item[lni].MONTOPRORRATEOIVA) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEOIVA del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].MONTOPRORRATEOIMPUESTOINTERNO) = 'N'
				lnLargoEntero = len( transform( int( this.Item[lni].MONTOPRORRATEOIMPUESTOINTERNO ) ) ) 
				lnValorDelDecimal = this.Item[lni].MONTOPRORRATEOIMPUESTOINTERNO - int( this.Item[lni].MONTOPRORRATEOIMPUESTOINTERNO )
				lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
				if lnLargoEntero <= 13
				else
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo MONTOPRORRATEOIMPUESTOINTERNO del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
				this.AgregarInformacion( 'El tipo de dato para el atributo MONTOPRORRATEOIMPUESTOINTERNO del item ' + transform( lni ) + ' no es el correcto, en el detalle ' + this.cEtiqueta + '.')
			Endif
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Tipodeitem = toItemOrigen.Tipodeitem
		...
		toItemDestino.Stock = toItemOrigen.Stock
		toItemDestino.Codigogtin = toItemOrigen.Codigogtin
		...
		toItemDestino.Montoimpuestointerno = toItemOrigen.Montoimpuestointerno
		toItemDestino.Restringirdescuentos = toItemOrigen.Restringirdescuentos
		toItemDestino.Afe_codigo = toItemOrigen.Afe_codigo
		toItemDestino.Tienerestriccion = toItemOrigen.Tienerestriccion
		toItemDestino.Montoprorrateorecargofinancierosinimp = toItemOrigen.Montoprorrateorecargofinancierosinimp
		toItemDestino.Montoprorrateodescuentofinancierosinimp = toItemOrigen.Montoprorrateodescuentofinancierosinimp
		...
		toItemDestino.Codigoautorizaciondjcp = toItemOrigen.Codigoautorizaciondjcp
		toItemDestino.Ordendeservicio = toItemOrigen.Ordendeservicio
		toItemDestino.Comportamiento = toItemOrigen.Comportamiento
		toItemDestino.Idkit = toItemOrigen.Idkit
		toItemDestino.Eslibre = toItemOrigen.Eslibre
		toItemDestino.Afe_saldoliquidacion = toItemOrigen.Afe_saldoliquidacion
		toItemDestino.Numerogiftcard_PK = toItemOrigen.Numerogiftcard_PK
		toItemDestino.Percepcionivarg5329 = toItemOrigen.Percepcionivarg5329
		toItemDestino.Afe_codigo_aux = toItemOrigen.Afe_codigo_aux
		toItemDestino.Iditemarticulos_aux = toItemOrigen.Iditemarticulos_aux
		...
		toItemDestino.Montoprorrateoimpuestointerno = toItemOrigen.Montoprorrateoimpuestointerno
