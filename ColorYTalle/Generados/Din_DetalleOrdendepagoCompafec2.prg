...
define class Din_DetalleORDENDEPAGOCompafec2 as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemORDENDEPAGOCompafec2' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		scan for &lcFiltro
			...
			loItem.Codigo = c_Compafec2.Codigo
			loItem.TipoComprobante = c_Compafec2.TipoComprobante
			loItem.NROITEM = c_Compafec2.NROITEM
			loItem.TipoCompCaracter = c_Compafec2.TipoCompCaracter
			loItem.Letra = c_Compafec2.Letra
			loItem.PuntoDeVenta = c_Compafec2.PuntoDeVenta
			loItem.Numero = c_Compafec2.Numero
			loItem.Fecha = goLibrerias.ObtenerFechaFormateada( c_Compafec2.Fecha )
			loItem.Total = c_Compafec2.Total
			loItem.Vendedor = c_Compafec2.Vendedor
			loItem.Tipo = c_Compafec2.Tipo
			loItem.Afecta = c_Compafec2.Afecta
			loItem.Interviniente = c_Compafec2.Interviniente
			loItem.NombreEntidad = c_Compafec2.NombreEntidad
			loItem.CodigoEntidad = c_Compafec2.CodigoEntidad
			loItem.Origen = c_Compafec2.Origen
			loItem.NroItem = lnI 
