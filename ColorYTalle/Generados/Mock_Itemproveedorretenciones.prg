...
define class Mock_Itemproveedorretenciones as MockBase of MockBase.prg

	cClase = 'Itemproveedorretenciones'
	...
	*-----------------------------------------------------------------------------------------
	function sedeextrajuris_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Sedeextrajuris_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_sedeextrajuris( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_sedeextrajuris', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_sedeextrajuris( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_sedeextrajuris', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosedeextrajuris() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridosedeextrajuris', lcParametros )
	EndFunc
