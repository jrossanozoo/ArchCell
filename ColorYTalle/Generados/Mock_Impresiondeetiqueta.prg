...
define class Mock_impresiondeetiqueta as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Impresión de etiquetas"                                                                                                                                                                                                                  
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleetiquetadetalle() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleetiquetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function etiquetadetalle_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPRESIONDEETIQUETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'etiquetadetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'etiquetadetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Etiquetadetalle ) = 'O' or isnull( this.Etiquetadetalle ) )			this.Etiquetadetalle = this.crearobjeto( 'Din_DetalleImpresiondeetiquetaEtiquetadetalle' )			this.Etiquetadetalle.inicializar()			this.enlazar( 'Etiquetadetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Etiquetadetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Etiquetadetalle, 'CambioSumarizado', this, 'CambiosDetalleEtiquetadetalle', 1)			this.enlazar( 'Etiquetadetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Etiquetadetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Etiquetadetalle.lVerificarLimitesEnDisenoImpresion = .t.				this.Etiquetadetalle.lHabilitaInsertarDetalle = .t.		endif		return this.Etiquetadetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajeetiquetasinqr() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventomensajeetiquetasinqr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdetallecombinaciones() as detalle of detalle.prg                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerdetallecombinaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolrutaarchivoqr_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPRESIONDEETIQUETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolrutaarchivoqr_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolrutaarchivoqr_access', lcParametros )			endif		endif		if !this.ldestroy and !vartype( this.oColRutaArchivoQR ) = 'O'			this.oColRutaArchivoQR = _Screen.zoo.CrearObjeto( "ZooColeccion" )		endif		return this.oColRutaArchivoQR
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	hidden function antesdeactualizaritemcontrolado as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Antesdeactualizaritemcontrolado As Void', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarrutaencoleccionrutasqr( tcrutaqr as string ) as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregarrutaencoleccionrutasqr', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function buscarcombinacionenlinkqr( tcarticulo as string, tccolor as string, tctalle as string ) as boolean                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Buscarcombinacionenlinkqr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function extraerexistenciaendisenosalida( lcdatos as string, lnlink as integer ) as boolean                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Extraerexistenciaendisenosalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarimagenparalistado( tclinqqr as string ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Generarimagenparalistado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerqrvacioparalistado() as string                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerqrvacioparalistado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oentidadlinkqr_access() as object                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPRESIONDEETIQUETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadlinkqr_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadlinkqr_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oEntidadLinkQR ) # "O"			this.oEntidadLinkQR = _Screen.zoo.InstanciarEntidad( "LinkQrEnEtiqueta" )		endif		return this.oEntidadLinkQR
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oqr_access() as object                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPRESIONDEETIQUETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oqr_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oqr_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oQR ) = 'O' or isnull( this.oQR ))			this.oQR = _Screen.zoo.Crearobjeto( "ZooLogicSA.CodigoQR.CrearQR" )		endif		return this.oQR
	EndFunc
