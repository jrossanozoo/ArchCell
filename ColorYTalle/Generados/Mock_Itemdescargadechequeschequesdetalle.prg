...
define class Mock_Itemdescargadechequeschequesdetalle as MockBase of MockBase.prg

	cClase = 'Itemdescargadechequeschequesdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function agregarchequedelacartera( tcguid as string ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function obtenercotizacionporvalor() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function obtenerguiddelchequesegunnrointerno( ) as string                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function ocompdescargadecheques_access() as variant                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Ocompdescargadecheques_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valor_pk( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_valor_pk', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valor_pk( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_valor_pk', lcParametros )
	EndFunc
