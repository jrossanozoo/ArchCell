...
define class Din_EntidadMotivodescarte_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Motivodescarte"
	cClaseResponse = this.cNamespaceDTOs + ".MotivodescarteResponse"
	cClaseModelo = "MotivodescarteModelo"
	cEntidad = "Motivodescarte"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescarteModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescarteListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescarteListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescarteModelo"
		endcase
		return lcRetorno
