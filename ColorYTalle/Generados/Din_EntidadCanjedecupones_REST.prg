...
define class Din_EntidadCanjedecupones_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Canjedecupones"
	cClaseResponse = this.cNamespaceDTOs + ".CanjedecuponesResponse"
	cClaseModelo = "CanjedecuponesModelo"
	cEntidad = "Canjedecupones"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "CanjedecuponesModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CanjedecuponesListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CanjedecuponesListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "CanjedecuponesModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearDetalleValoresaent( toEntidad, toModeloEnRequest )
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleValoresAEnt( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		loDetalle = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest, "ValoresAEnt" )
		lnCantidad = _Screen.DotNetBridge.ObtenerValorPropiedad( loDetalle, "Count" )
		for lnI = 1 to lnCantidad 
			loItem = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest,"ValoresAEnt[" + transform( lnI -1 ) + "]" )
			lnNroItem = _Screen.DotNetBridge.ObtenerValorPropiedad( loItem ,"NroItem" )
			if isnull( lnNroItem )
				toEntidad.ValoresAEnt.LimpiarItem()
			else
				try
					toEntidad.ValoresAEnt.CargarItem( lnNroItem )
				Catch To loError
					toEntidad.ValoresAEnt.LimpiarItem()
				endtry 
			endif
			this.SetearAtributoModeloEnEntidad( loItem, "Valor", toEntidad.ValoresAEnt.oItem, "Valor_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Valordetalle", toEntidad.ValoresAEnt.oItem, "ValorDetalle" )
			this.SetearAtributoModeloDateTimeEnEntidad( loItem, "Fecha", toEntidad.ValoresAEnt.oItem, "Fecha" )
			this.SetearAtributoModeloEnEntidad( loItem, "Numerointerno", toEntidad.ValoresAEnt.oItem, "NumeroInterno" )
			this.SetearAtributoModeloEnEntidad( loItem, "Comprobanteorigen", toEntidad.ValoresAEnt.oItem, "ComprobanteOrigen" )
			this.SetearAtributoModeloEnEntidad( loItem, "Monto", toEntidad.ValoresAEnt.oItem, "Monto" )
			this.SetearAtributoModeloEnEntidad( loItem, "Pesosalcambio", toEntidad.ValoresAEnt.oItem, "PesosAlCambio" )
			toEntidad.ValoresAEnt.Actualizar()
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleValoresDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Pesosalcambio", toEntidad.ValoresDetalle.oItem, "PesosAlCambio" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.CargarColeccionModeloValoresAEnt( toModeloResponse, toEntidad )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarColeccionModeloValoresAEnt( toModeloResponse as Object, toEntidad as Object ) as Void
		local lnI as Integer, loColeccionModelo as Object
		loColeccionModelo = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloResponse, "ValoresAEnt" ) 
		with toEntidad
			for lnI = 1 to .ValoresAEnt.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemValoresaent" )
				this.SetearAtributoString( loItem, "Codigo", .ValoresAEnt.Item(lnI).Codigo)
				this.SetearAtributoString( loItem, "Valor", .ValoresAEnt.Item(lnI).Valor_PK)
				this.SetearAtributoString( loItem, "ValorDetalle", .ValoresAEnt.Item(lnI).ValorDetalle)
				this.SetearAtributoDatetime( loItem, "Fecha", .ValoresAEnt.Item(lnI).Fecha)
				this.SetearAtributoString( loItem, "NumeroInterno", .ValoresAEnt.Item(lnI).NumeroInterno)
				this.SetearAtributoString( loItem, "ComprobanteOrigen", .ValoresAEnt.Item(lnI).ComprobanteOrigen)
				this.SetearAtributoDecimal( loItem, "Monto", .ValoresAEnt.Item(lnI).Monto)
				this.SetearAtributoDecimal( loItem, "PesosAlCambio", .ValoresAEnt.Item(lnI).PesosAlCambio)
				this.SetearDatosExtraDelItem( loItem, toEntidad, lnI )
				this.SetearAtributoInteger( loItem, "NroItem", .ValoresAEnt.Item(lnI).NroItem )
	...
	protected function CargarColeccionModeloValoresDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .ValoresDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemCanjecupones" )
				...
				this.SetearAtributoDecimal( loItem, "PesosAlCambio", .ValoresDetalle.Item(lnI).PesosAlCambio)
