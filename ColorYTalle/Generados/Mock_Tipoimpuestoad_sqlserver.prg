...
define class Mock_Tipoimpuestoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Tipoimpuestoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubtim( tctablatrabajo ) as string                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubtim', lcParametros )
	EndFunc
