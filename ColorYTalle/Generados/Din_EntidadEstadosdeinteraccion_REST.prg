...
define class Din_EntidadEstadosdeinteraccion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Estadosdeinteraccion"
	cClaseResponse = this.cNamespaceDTOs + ".EstadosdeinteraccionResponse"
	cClaseModelo = "EstadosdeinteraccionModelo"
	cEntidad = "Estadosdeinteraccion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "EstadosdeinteraccionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "EstadosdeinteraccionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "EstadosdeinteraccionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "EstadosdeinteraccionModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Reglaestado", toEntidad, "Reglaestado" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Reglafacturacion", toEntidad, "Reglafacturacion" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoInteger( toModeloResponse, "ReglaEstado", toEntidad.ReglaEstado)
			this.SetearAtributoInteger( toModeloResponse, "ReglaFacturacion", toEntidad.ReglaFacturacion)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Reglaestado", "REGLAEST")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Reglafacturacion", "REGLAFAC")
