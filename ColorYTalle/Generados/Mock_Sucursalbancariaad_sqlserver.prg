...
define class Mock_Sucursalbancariaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Sucursalbancariaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupub131( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupub131', lcParametros )
	EndFunc
