...
define class Mock_transportista as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Transportistas"                                                                                                                                                                                                                          
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'TRANSPORTISTA'                                                                                                                                                                                                                                 
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallevehiculodetalle() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallevehiculodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomessenger() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomessenger', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function vehiculodetalle_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRANSPORTISTA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'vehiculodetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'vehiculodetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Vehiculodetalle ) = 'O' or isnull( this.Vehiculodetalle ) )			this.Vehiculodetalle = this.crearobjeto( 'Din_DetalleTransportistaVehiculodetalle' )			this.Vehiculodetalle.inicializar()			this.enlazar( 'Vehiculodetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Vehiculodetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Vehiculodetalle, 'CambioSumarizado', this, 'CambiosDetalleVehiculodetalle', 1)			this.enlazar( 'Vehiculodetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Vehiculodetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Vehiculodetalle.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Vehiculodetalle
	EndFunc
