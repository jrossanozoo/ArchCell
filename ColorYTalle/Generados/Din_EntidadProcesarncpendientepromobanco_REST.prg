...
define class Din_EntidadProcesarncpendientepromobanco_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Procesarncpendientepromobanco"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleCuponesPendientes( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Comprobanteorigen", toEntidad.CuponesPendientes.oItem, "ComprobanteOrigen" )
			this.SetearAtributoModeloDateTimeEnEntidad( loItem, "Fecha", toEntidad.CuponesPendientes.oItem, "Fecha" )
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Seleccion", toEntidad.CuponesPendientes.oItem, "Seleccion" )
	...
	protected function CargarColeccionModeloCuponesPendientes( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .CuponesPendientes.Count
				...
				this.SetearAtributoString( loItem, "ComprobanteOrigen", .CuponesPendientes.Item(lnI).ComprobanteOrigen)
				this.SetearAtributoDatetime( loItem, "Fecha", .CuponesPendientes.Item(lnI).Fecha)
				...
				this.SetearAtributo( loItem, "Seleccion", .CuponesPendientes.Item(lnI).Seleccion)
