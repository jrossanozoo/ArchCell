...
define class Mock_Itemcurvadeproducciondetalle as MockBase of MockBase.prg

	cClase = 'Itemcurvadeproducciondetalle'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotalledetalle() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotalledetalle', lcParametros )
	EndFunc
