...
define class Din_EntidadMOVIMIENTODECAJAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxMovcajaFectrans, lxMovcajaFechacompr, lxMovcajaFaltafw, lxMovcajaFmodifw, lxMovcajaFecimpo, lxMovcajaFecexpo, lxMovcajaFecha, lxMovcajaIdmovi, lxMovcajaHoraexpo, lxMovcajaHaltafw, lxMovcajaSmodifw, lxMovcajaHoraimpo, lxMovcajaVmodifw, lxMovcajaZadsfw, lxMovcajaValtafw, lxMovcajaUmodifw, lxMovcajaSaltafw, lxMovcajaUaltafw, lxMovcajaHmodifw, lxMovcajaItemvalor, lxMovcajaEsttrans, lxMovcajaAccion, lxMovcajaTarea, lxMovcajaFactsec, lxMovcajaBdaltafw, lxMovcajaBdmodifw, lxMovcajaTimestamp, lxMovcajaPtovta, lxMovcajaNumcomp, lxMovcajaTipovalor, lxMovcajaIdvendedor, lxMovcajaTurno, lxMovcajaIdcajaaudi, lxMovcajaFechacaja, lxMovcajaHora, lxMovcajaIdvalor, lxMovcajaIdcaja, lxMovcajaTipocomp, lxMovcajaMonto, lxMovcajaDescrip, lxMovcajaCotiz
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.MOVCAJA ( "Fectrans","Fechacompr","Faltafw","Fmodifw","Fecimpo","Fecexpo","Fecha","Idmovi","Horaexpo","Haltafw","Smodifw","Horaimpo","Vmodifw","Zadsfw","Valtafw","Umodifw","Saltafw","Ualtafw","Hmodifw","Itemvalor","Esttrans","Accion","Tarea","Factsec","Bdaltafw","Bdmodifw","Timestamp","Ptovta","Numcomp","Tipovalor","Idvendedor","Turno","Idcajaaudi","Fechacaja","Hora","Idvalor","Idcaja","Tipocomp","Monto","Descrip","Cotiz" ) values ( <<"'" + this.ConvertirDateSql( lxMovcajaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMovcajaFechacompr ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMovcajaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMovcajaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMovcajaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMovcajaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMovcajaFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaIdmovi ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaItemvalor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaAccion ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaTarea ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaFactsec ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaBdmodifw ) + "'" >>, <<lxMovcajaTimestamp >>, <<lxMovcajaPtovta >>, <<lxMovcajaNumcomp >>, <<lxMovcajaTipovalor >>, <<"'" + this.FormatearTextoSql( lxMovcajaIdvendedor ) + "'" >>, <<lxMovcajaTurno >>, <<lxMovcajaIdcajaaudi >>, <<"'" + this.ConvertirDateSql( lxMovcajaFechacaja ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaHora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMovcajaIdvalor ) + "'" >>, <<lxMovcajaIdcaja >>, <<"'" + this.FormatearTextoSql( lxMovcajaTipocomp ) + "'" >>, <<lxMovcajaMonto >>, <<"'" + this.FormatearTextoSql( lxMovcajaDescrip ) + "'" >>, <<lxMovcajaCotiz >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.MOVCAJA set "Fectrans" = <<"'" + this.ConvertirDateSql( lxMovcajaFectrans ) + "'">>,"Fechacompr" = <<"'" + this.ConvertirDateSql( lxMovcajaFechacompr ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxMovcajaFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxMovcajaFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxMovcajaFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxMovcajaFecexpo ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxMovcajaFecha ) + "'">>,"Idmovi" = <<"'" + this.FormatearTextoSql( lxMovcajaIdmovi ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxMovcajaHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxMovcajaHaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxMovcajaSmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxMovcajaHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxMovcajaVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxMovcajaZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxMovcajaValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxMovcajaUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxMovcajaSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxMovcajaUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxMovcajaHmodifw ) + "'">>,"Itemvalor" = <<"'" + this.FormatearTextoSql( lxMovcajaItemvalor ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxMovcajaEsttrans ) + "'">>,"Accion" = <<"'" + this.FormatearTextoSql( lxMovcajaAccion ) + "'">>,"Tarea" = <<"'" + this.FormatearTextoSql( lxMovcajaTarea ) + "'">>,"Factsec" = <<"'" + this.FormatearTextoSql( lxMovcajaFactsec ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxMovcajaBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxMovcajaBdmodifw ) + "'">>,"Timestamp" = <<lxMovcajaTimestamp>>,"Ptovta" = <<lxMovcajaPtovta>>,"Numcomp" = <<lxMovcajaNumcomp>>,"Tipovalor" = <<lxMovcajaTipovalor>>,"Idvendedor" = <<"'" + this.FormatearTextoSql( lxMovcajaIdvendedor ) + "'">>,"Turno" = <<lxMovcajaTurno>>,"Idcajaaudi" = <<lxMovcajaIdcajaaudi>>,"Fechacaja" = <<"'" + this.ConvertirDateSql( lxMovcajaFechacaja ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxMovcajaHora ) + "'">>,"Idvalor" = <<"'" + this.FormatearTextoSql( lxMovcajaIdvalor ) + "'">>,"Idcaja" = <<lxMovcajaIdcaja>>,"Tipocomp" = <<"'" + this.FormatearTextoSql( lxMovcajaTipocomp ) + "'">>,"Monto" = <<lxMovcajaMonto>>,"Descrip" = <<"'" + this.FormatearTextoSql( lxMovcajaDescrip ) + "'">>,"Cotiz" = <<lxMovcajaCotiz>> where "Idmovi" = <<"'" + this.FormatearTextoSql( lxMovcajaIdmovi ) + "'">> and  MOVCAJA.IDMOVI != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Fechacompr" as "Fechacomprobante", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fecha" as "Fecha", "Idmovi" as "Id", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Itemvalor" as "Itemvalor", "Esttrans" as "Estadotransferencia", "Accion" as "Accion", "Tarea" as "Tarea", "Factsec" as "Secuencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Ptovta" as "Puntodeventa", "Numcomp" as "Numerocomprobante", "Tipovalor" as "Tipovalor", "Idvendedor" as "Vendedor", "Turno" as "Turno", "Idcajaaudi" as "Cajaauditoria", "Fechacaja" as "Fechacaja", "Hora" as "Hora", "Idvalor" as "Valor", "Idcaja" as "Cajaestado", "Tipocomp" as "Tipocomprobante", "Monto" as "Monto", "Descrip" as "Descripcion", "Cotiz" as "Cotizacion" from ZooLogic.MOVCAJA where "Idmovi" = <<"'" + this.FormatearTextoSql( lxMovcajaIdmovi ) + "'">> and  MOVCAJA.IDMOVI != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fechacompr,Faltafw,Fmodifw,Fecimpo,Fecexpo,Fecha,Idmovi,Horaexpo,Haltafw,Smodifw,Ho" + ;
"raimpo,Vmodifw,Zadsfw,Valtafw,Umodifw,Saltafw,Ualtafw,Hmodifw,Itemvalor,Esttrans,Accion,Tarea,Factse" + ;
"c,Bdaltafw,Bdmodifw,Timestamp,Ptovta,Numcomp,Tipovalor,Idvendedor,Turno,Idcajaaudi,Fechacaja,Hora,Id" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.MOVCAJA set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FechaCompr = ] + "'" + this.ConvertirDateSql( &lcCursor..FechaCompr ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, IdMovi = ] + "'" + this.FormatearTextoSql( &lcCursor..IdMovi ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ItemValor = ] + "'" + this.FormatearTextoSql( &lcCursor..ItemValor ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Accion = ] + "'" + this.FormatearTextoSql( &lcCursor..Accion ) + "'"+ [, Tarea = ] + "'" + this.FormatearTextoSql( &lcCursor..Tarea ) + "'"+ [, FactSec = ] + "'" + this.FormatearTextoSql( &lcCursor..FactSec ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, PtoVta = ] + transform( &lcCursor..PtoVta )+ [, NumComp = ] + transform( &lcCursor..NumComp )+ [, TipoValor = ] + transform( &lcCursor..TipoValor )+ [, IdVendedor = ] + "'" + this.FormatearTextoSql( &lcCursor..IdVendedor ) + "'"+ [, Turno = ] + transform( &lcCursor..Turno )+ [, IdCajaAudi = ] + transform( &lcCursor..IdCajaAudi )+ [, FechaCaja = ] + "'" + this.ConvertirDateSql( &lcCursor..FechaCaja ) + "'"+ [, Hora = ] + "'" + this.FormatearTextoSql( &lcCursor..Hora ) + "'"+ [, idValor = ] + "'" + this.FormatearTextoSql( &lcCursor..idValor ) + "'"+ [, IDCaja = ] + transform( &lcCursor..IDCaja )+ [, TipoComp = ] + "'" + this.FormatearTextoSql( &lcCursor..TipoComp ) + "'"+ [, Monto = ] + transform( &lcCursor..Monto )+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, Cotiz = ] + transform( &lcCursor..Cotiz ) + [ Where IdMovi = ] + "'" + this.FormatearTextoSql( &lcCursor..IdMovi ) + "'" )
				...
				Text to lcCampos noShow
					 FECTRANS, FechaCompr, FALTAFW, FMODIFW, FECIMPO, FECEXPO, Fecha, IdMovi, HORAEXPO, HALTAFW, SMODIFW, HORAIMPO, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SALTAFW, UALTAFW, HMODIFW, ItemValor, ESTTRANS, Accion, Tarea, FactSec, BDALTAFW, BDMODIFW, TIMESTAMP, PtoVta, NumComp, TipoValor, IdVendedor, Turno, IdCajaAudi, FechaCaja, Hora, idValor, IDCaja, TipoComp, Monto, Descrip, Cotiz
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaCompr ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdMovi ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ItemValor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Accion ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Tarea ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FactSec ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..PtoVta )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..NumComp ) + ',' + transform( &lcCursor..TipoValor ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdVendedor ) + "'" + ',' + transform( &lcCursor..Turno ) + ',' + transform( &lcCursor..IdCajaAudi ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaCaja ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Hora ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idValor ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECHACOMPR = isnull( d.FECHACOMPR, t.FECHACOMPR ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.IDMOVI = isnull( d.IDMOVI, t.IDMOVI ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ITEMVALOR = isnull( d.ITEMVALOR, t.ITEMVALOR ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ACCION = isnull( d.ACCION, t.ACCION ),t.TAREA = isnull( d.TAREA, t.TAREA ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.PTOVTA = isnull( d.PTOVTA, t.PTOVTA ),t.NUMCOMP = isnull( d.NUMCOMP, t.NUMCOMP ),t.TIPOVALOR = isnull( d.TIPOVALOR, t.TIPOVALOR ),t.IDVENDEDOR = isnull( d.IDVENDEDOR, t.IDVENDEDOR ),t.TURNO = isnull( d.TURNO, t.TURNO ),t.IDCAJAAUDI = isnull( d.IDCAJAAUDI, t.IDCAJAAUDI ),t.FECHACAJA = isnull( d.FECHACAJA, t.FECHACAJA ),t.HORA = isnull( d.HORA, t.HORA ),t.IDVALOR = isnull( d.IDVALOR, t.IDVALOR ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.MONTO = isnull( d.MONTO, t.MONTO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.COTIZ = isnull( d.COTIZ, t.COTIZ )
					from ZooLogic.MOVCAJA t inner join deleted d 
							 on t.IdMovi = d.IdMovi
				-- Fin Updates
				insert into ZooLogic.MOVCAJA(Fectrans,Fechacompr,Faltafw,Fmodifw,Fecimpo,Fecexpo,Fecha,Idmovi,Horaexpo,Haltafw,Smodifw,Horaimpo,Vmodifw,Zadsfw,Valtafw,Umodifw,Saltafw,Ualtafw,Hmodifw,Itemvalor,Esttrans,Accion,Tarea,Factsec,Bdaltafw,Bdmodifw,Timestamp,Ptovta,Numcomp,Tipovalor,Idvendedor,Turno,Idcajaaudi,Fechacaja,Hora,Idvalor,Idcaja,Tipocomp,Monto,Descrip,Cotiz)
					Select isnull( d.FECTRANS,''),isnull( d.FECHACOMPR,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.FECHA,''),isnull( d.IDMOVI,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.SMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ITEMVALOR,''),isnull( d.ESTTRANS,''),isnull( d.ACCION,''),isnull( d.TAREA,''),isnull( d.FACTSEC,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.PTOVTA,0),isnull( d.NUMCOMP,0),isnull( d.TIPOVALOR,0),isnull( d.IDVENDEDOR,''),isnull( d.TURNO,0),isnull( d.IDCAJAAUDI,0),isnull( d.FECHACAJA,''),isnull( d.HORA,''),isnull( d.IDVALOR,''),isnull( d.IDCAJA,0),isnull( d.TIPOCOMP,''),isnull( d.MONTO,0),isnull( d.DESCRIP,''),isnull( d.COTIZ,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="MOVIMIENTODECAJA                        " atributo="FECHATRANSFERENCIA                      " tabla="MOVCAJA        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOVIMIENTODECAJA                        " atributo="ESTADOTRANSFERENCIA                     " tabla="MOVCAJA        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="MOVIMIENTODECAJA                        " atributo="ACCION                                  " tabla="MOVCAJA        " campo="ACCION    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Acción                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOVIMIENTODECAJA                        " atributo="NUMEROCOMPROBANTE                       " tabla="MOVCAJA        " campo="NUMCOMP   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="9" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Número de comprobante                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOVIMIENTODECAJA                        " atributo="VENDEDOR                                " tabla="MOVCAJA        " campo="IDVENDEDOR" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="6" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOVIMIENTODECAJA                        " atributo="TIPOCOMPROBANTE                         " tabla="MOVCAJA        " campo="TIPOCOMP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="410" etiqueta="Tipo de comprobante                                                                                                                                             " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="MOVIMIENTODECAJA                        " atributo="MONTO                                   " tabla="MOVCAJA        " campo="MONTO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Monto                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOVIMIENTODECAJA                        " atributo="COTIZACION                              " tabla="MOVCAJA        " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="416" etiqueta="Cotización                                                                                                                                                      " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="12" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVAL           " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="407" etiqueta="Detalle Val.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVAL On MOVCAJA.IDVALOR = XVAL.CLCOD And  XVAL.CLCOD != ''                                                                                                                                                                                         " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
