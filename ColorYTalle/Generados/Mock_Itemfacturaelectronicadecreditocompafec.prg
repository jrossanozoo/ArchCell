...
define class Mock_Itemfacturaelectronicadecreditocompafec as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicadecreditocompafec'
	...
	*-----------------------------------------------------------------------------------------
	function afecta_assign( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Afecta_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigoentidad_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Codigoentidad_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function interviniente_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Interviniente_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nombreentidad_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Nombreentidad_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_afecta( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_afecta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoentidad( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_codigoentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_interviniente( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_interviniente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nombreentidad( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_nombreentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipocompcaracter( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_tipocompcaracter', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipocompcaracter_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Tipocompcaracter_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_afecta( txval as variant ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_afecta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoentidad( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_codigoentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_interviniente( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_interviniente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nombreentidad( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_nombreentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipocompcaracter( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_tipocompcaracter', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridointerviniente() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridointerviniente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipocompcaracter() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridotipocompcaracter', lcParametros )
	EndFunc
