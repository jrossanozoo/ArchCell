...
define class Din_EntidadTicketnotadecredito_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Ticketnotadecredito"
	cClaseResponse = this.cNamespaceDTOs + ".TicketnotadecreditoResponse"
	cClaseModelo = "TicketnotadecreditoModelo"
	cEntidad = "Ticketnotadecredito"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadecreditoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadecreditoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadecreditoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TicketnotadecreditoModelo"
		endcase
		return lcRetorno
