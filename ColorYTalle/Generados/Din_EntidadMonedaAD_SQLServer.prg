	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.MONEDA ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Valtafw","Haltafw","Horaexpo","Saltafw","Horaimpo","Ualtafw","Smodifw","Hmodifw","Zadsfw","Vmodifw","Bdaltafw","Bdmodifw","Esttrans","Umodifw","Tipagrupub","Timestamp","Codigo","Mobs","Descrip","Simbolo","Eafip","Edgi","Tolpos","Mcotafip","Coblig","Tolneg" ) values ( <<"'" + this.ConvertirDateSql( lxMonedaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMonedaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMonedaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMonedaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMonedaFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaUmodifw ) + "'" >>, <<lxMonedaTipagrupub >>, <<lxMonedaTimestamp >>, <<"'" + this.FormatearTextoSql( lxMonedaCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaMobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaSimbolo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaEafip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMonedaEdgi ) + "'" >>, <<lxMonedaTolpos >>, <<"'" + this.FormatearTextoSql( lxMonedaMcotafip ) + "'" >>, <<iif( lxMonedaCoblig, 1, 0 ) >>, <<lxMonedaTolneg >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.Cotizaciones
				if this.oEntidad.Cotizaciones.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.COTIZA("NROITEM","Codigo","Fecha","Hora","Cotiz" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<"'" + this.FormatearTextoSql( lxHora ) + "'">>, <<lxCotizacion>> ) 
					endtext
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubMON("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.MONEDA set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxMonedaFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxMonedaFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxMonedaFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxMonedaFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxMonedaFecexpo ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxMonedaValtafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxMonedaHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxMonedaHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxMonedaSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxMonedaHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxMonedaUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxMonedaSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxMonedaHmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxMonedaZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxMonedaVmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxMonedaBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxMonedaBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxMonedaEsttrans ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxMonedaUmodifw ) + "'">>,"Tipagrupub" = <<lxMonedaTipagrupub>>,"Timestamp" = <<lxMonedaTimestamp>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxMonedaCodigo ) + "'">>,"Mobs" = <<"'" + this.FormatearTextoSql( lxMonedaMobs ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxMonedaDescrip ) + "'">>,"Simbolo" = <<"'" + this.FormatearTextoSql( lxMonedaSimbolo ) + "'">>,"Eafip" = <<"'" + this.FormatearTextoSql( lxMonedaEafip ) + "'">>,"Edgi" = <<"'" + this.FormatearTextoSql( lxMonedaEdgi ) + "'">>,"Tolpos" = <<lxMonedaTolpos>>,"Mcotafip" = <<"'" + this.FormatearTextoSql( lxMonedaMcotafip ) + "'">>,"Coblig" = <<iif( lxMonedaCoblig, 1, 0 )>>,"Tolneg" = <<lxMonedaTolneg>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxMonedaCodigo ) + "'">> and  MONEDA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
			this.ComprobarResultadoDeEjecucionDelUpdate()
		this.ComprobarTransaccion()
			this.oConexion.EjecutarSql( 'delete from ZooLogic.COTIZA where "Codigo" = ' + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'" )
			this.oConexion.EjecutarSql( 'delete from ZooLogic.AgruPubMON where "Codigo" = ' + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Umodifw" as "Usuariomodificacionfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Mobs" as "Observacion", "Descrip" as "Descripcion", "Simbolo" as "Simbolo", "Eafip" as "Equivalenciaafip", "Edgi" as "Equivalenciadgi", "Tolpos" as "Toleranciapositiva", "Mcotafip" as "Monedacotizacionafip", "Coblig" as "Cargaobligatoria", "Tolneg" as "Tolerancianegativa" from ZooLogic.MONEDA where "Codigo" = <<"'" + this.FormatearTextoSql( lxMonedaCodigo ) + "'">> and  MONEDA.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Cotiz" as "Cotizacion" from ZooLogic.COTIZA where Codigo = <<"'" + this.FormatearTextoSql( c_MONEDA.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrup" as "Agrupamiento", "Agrupdes" as "Agrupamientodetalle" from ZooLogic.AgruPubMON where Codigo = <<"'" + this.FormatearTextoSql( c_MONEDA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Umodifw" as "Usuariomodificacionfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Mobs" as "Observacion", "Descrip" as "Descripcion", "Simbolo" as "Simbolo", "Eafip" as "Equivalenciaafip", "Edgi" as "Equivalenciadgi", "Tolpos" as "Toleranciapositiva", "Mcotafip" as "Monedacotizacionafip", "Coblig" as "Cargaobligatoria", "Tolneg" as "Tolerancianegativa" from ZooLogic.MONEDA where  MONEDA.CODIGO != '' order by Codigo
			endtext
			use in select('c_MONEDA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_MONEDA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Umodifw" as "Usuariomodificacionfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Mobs" as "Observacion", "Descrip" as "Descripcion", "Simbolo" as "Simbolo", "Eafip" as "Equivalenciaafip", "Edgi" as "Equivalenciadgi", "Tolpos" as "Toleranciapositiva", "Mcotafip" as "Monedacotizacionafip", "Coblig" as "Cargaobligatoria", "Tolneg" as "Tolerancianegativa" from ZooLogic.MONEDA where  funciones.padr( Codigo, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  MONEDA.CODIGO != '' order by Codigo
			endtext
			use in select('c_MONEDA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_MONEDA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Umodifw" as "Usuariomodificacionfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Mobs" as "Observacion", "Descrip" as "Descripcion", "Simbolo" as "Simbolo", "Eafip" as "Equivalenciaafip", "Edgi" as "Equivalenciadgi", "Tolpos" as "Toleranciapositiva", "Mcotafip" as "Monedacotizacionafip", "Coblig" as "Cargaobligatoria", "Tolneg" as "Tolerancianegativa" from ZooLogic.MONEDA where  funciones.padr( Codigo, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  MONEDA.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_MONEDA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_MONEDA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Valtafw,Haltafw,Horaexpo,Saltafw,Horaimpo,Ualtafw,S" + ;
"modifw,Hmodifw,Zadsfw,Vmodifw,Bdaltafw,Bdmodifw,Esttrans,Umodifw,Tipagrupub,Timestamp,Codigo,Mobs,De" + ;
"scrip,Simbolo,Eafip,Edgi,Tolpos,Mcotafip,Coblig,Tolneg" + ;
" from ZooLogic.MONEDA where  MONEDA.CODIGO != '' and " + lcFiltro )
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Umodifw" as "Usuariomodificacionfw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Codigo" as "Codigo", "Mobs" as "Observacion", "Descrip" as "Descripcion", "Simbolo" as "Simbolo", "Eafip" as "Equivalenciaafip", "Edgi" as "Equivalenciadgi", "Tolpos" as "Toleranciapositiva", "Mcotafip" as "Monedacotizacionafip", "Coblig" as "Cargaobligatoria", "Tolneg" as "Tolerancianegativa"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleCotizaciones( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Fecha" as "Fecha", "Hora" as "Hora", "Cotiz" as "Cotizacion"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAgruPubliDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		Local lcAtributos As String, lcWhere As String
		lcWhere = " Where  AGRUPUBMON.CODIGO != ''"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
		...
		return this.ObtenerDatos( lcAtributos, tcHaving, tcOrder, tcFunc, lcWhere, 'AgruPubMON', 'AgruPubliDetalle', tnTope )
	Endfunc
		...
		With this
			...
			for each loItem in this.oEntidad.Cotizaciones
				if this.oEntidad.Cotizaciones.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCotizacion = loItem.Cotizacion
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.COTIZA("NROITEM","Codigo","Fecha","Hora","Cotiz" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<"'" + this.FormatearTextoSql( lxHora ) + "'">>, <<lxCotizacion>> ) 
					endtext
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAgrupamientodetalle = loItem.Agrupamientodetalle
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubMON("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			loColeccion.Agregar([delete from ZooLogic.AgruPubMON where "Codigo" = ] + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'")
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.MONEDA set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, MObs = ] + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, Simbolo = ] + "'" + this.FormatearTextoSql( &lcCursor..Simbolo ) + "'"+ [, Eafip = ] + "'" + this.FormatearTextoSql( &lcCursor..Eafip ) + "'"+ [, Edgi = ] + "'" + this.FormatearTextoSql( &lcCursor..Edgi ) + "'"+ [, TolPos = ] + transform( &lcCursor..TolPos )+ [, MCotAfip = ] + "'" + this.FormatearTextoSql( &lcCursor..MCotAfip ) + "'"+ [, COblig = ] + Transform( iif( &lcCursor..COblig, 1, 0 ))+ [, TolNeg = ] + transform( &lcCursor..TolNeg ) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, VALTAFW, HALTAFW, HORAEXPO, SALTAFW, HORAIMPO, UALTAFW, SMODIFW, HMODIFW, ZADSFW, VMODIFW, BDALTAFW, BDMODIFW, ESTTRANS, UMODIFW, tipagrupub, TIMESTAMP, Codigo, MObs, Descrip, Simbolo, Eafip, Edgi, TolPos, MCotAfip, COblig, TolNeg
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + transform( &lcCursor..tipagrupub ) + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Simbolo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Eafip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Edgi ) + "'" + ',' + transform( &lcCursor..TolPos )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..MCotAfip ) + "'" + ',' + Transform( iif( &lcCursor..COblig, 1, 0 )) + ',' + transform( &lcCursor..TolNeg )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirDetalles() As Void
		...
		If lcCantRegistros > 0
			...
			this.oConexion.EjecutarSql( [Delete From ZooLogic.AgruPubMON Where Codigo] + lcIn  )
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","Codigo","Fecha","Hora","Cotiz"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.COTIZA ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.ConvertirDateSql( cDetallesExistentes.Fecha      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Hora       ) + "'" + ',' + transform( cDetallesExistentes.Cotiz      ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	lcDetalle = This.oEntidad.cPrefijoRecibir + 'ITEMAGRUPAPUBLICMON'
	Select * From &lcDetalle into cursor cDetallesExistentes ;
		where Codigo in ( select Codigo from &lcCursor )
	select cDetallesExistentes
	Scan All
		...
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.AgruPubMON ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Agrup      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AgrupDes   ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'ITEMMONEDA'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'ITEMAGRUPAPUBLICMON'
				llRetorno = .T.
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MOBS = isnull( d.MOBS, t.MOBS ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.SIMBOLO = isnull( d.SIMBOLO, t.SIMBOLO ),t.EAFIP = isnull( d.EAFIP, t.EAFIP ),t.EDGI = isnull( d.EDGI, t.EDGI ),t.TOLPOS = isnull( d.TOLPOS, t.TOLPOS ),t.MCOTAFIP = isnull( d.MCOTAFIP, t.MCOTAFIP ),t.COBLIG = isnull( d.COBLIG, t.COBLIG ),t.TOLNEG = isnull( d.TOLNEG, t.TOLNEG )
					from ZooLogic.MONEDA t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.MONEDA(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Valtafw,Haltafw,Horaexpo,Saltafw,Horaimpo,Ualtafw,Smodifw,Hmodifw,Zadsfw,Vmodifw,Bdaltafw,Bdmodifw,Esttrans,Umodifw,Tipagrupub,Timestamp,Codigo,Mobs,Descrip,Simbolo,Eafip,Edgi,Tolpos,Mcotafip,Coblig,Tolneg)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.VALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.UMODIFW,''),isnull( d.TIPAGRUPUB,0),isnull( d.TIMESTAMP,0),isnull( d.CODIGO,''),isnull( d.MOBS,''),isnull( d.DESCRIP,''),isnull( d.SIMBOLO,''),isnull( d.EAFIP,''),isnull( d.EDGI,''),isnull( d.TOLPOS,0),isnull( d.MCOTAFIP,''),isnull( d.COBLIG,0),isnull( d.TOLNEG,0)
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_AgruPubMON( tcTablaTrabajo ) as String

		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_MONEDA_AgruPubMON
ON ZooLogic.TablaTrabajo_MONEDA_AgruPubMON
AFTER DELETE
As
Begin
Update t Set 
...
from ZooLogic.AgruPubMON t inner join deleted d 
 on t.CODIGO = d.CODIGO
-- Fin Updates
insert into ZooLogic.AgruPubMON
( 
"NROITEM",
"CODIGO",
"AGRUP",
...
d.AGRUP,
d.AGRUPDES
From deleted d left join ZooLogic.AgruPubMON pk 
 on d.CODIGO = pk.CODIGO
Where pk.CODIGO Is Null 
-- Fin Inserts
End
		...
		with this.oEntidad
			...
			if reccount( 'c_MONEDA' ) < 1
				...
				Try
					...
					.Tipoagrupamientopublicaciones = nvl( c_MONEDA.Tipoagrupamientopublicaciones, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="MONEDA                                  " atributo="FECHATRANSFERENCIA                      " tabla="MONEDA         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MONEDA                                  " atributo="ESTADOTRANSFERENCIA                     " tabla="MONEDA         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MONEDA                                  " atributo="TIPOAGRUPAMIENTOPUBLICACIONES           " tabla="MONEDA         " campo="TIPAGRUPUB" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MONEDA                                  " atributo="AGRUPUBLIDETALLE                        " tabla="AGRUPUBMON     " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Agrupamientos                                                                                                                                                   " dominio="DETALLEITEMAGRUPAPUBLICMON    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="MONEDA                                  " atributo="SIMBOLO                                 " tabla="MONEDA         " campo="SIMBOLO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Símbolo                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
