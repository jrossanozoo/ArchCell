...
define class Din_EntidadCOMPROBANTEDECAJA as Ent_ComprobanteDeFondos of Ent_ComprobanteDeFondos.prg
	...
	cDescripcion =  [Comprobantes de caja]
	lEntidadEditable =  .t.
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<TRANSMODOSEGURODB><NOIMPO><FRMMODAL><CODIGOSUGERIDO><INFOADICIONAL><WEBHOOK>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as Void
		...
		this.lWHIngresar = goServicios.WebHook.TieneQueMandar( 'COMPROBANTEDECAJA', 'INGRESAR' )
		this.lWHModificar = goServicios.WebHook.TieneQueMandar( 'COMPROBANTEDECAJA', 'MODIFICAR' )
		this.lWHEliminar = goServicios.WebHook.TieneQueMandar( 'COMPROBANTEDECAJA', 'ELIMINAR' )
	endfunc
	...
	function Cajaorigen_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Cajaorigen( lxVal, lxValOld )
			if ( this.lHabilitarCajaorigen_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comprobantes de caja - Atributo: Cajaorigen)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Cajadestino_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Cajadestino( lxVal, lxValOld )
			if ( this.lHabilitarCajadestino_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comprobantes de caja - Atributo: Cajadestino)" )
			endif 
		endif
		dodefault( lxVal )
		...
		if This.CargaManual()
			if this.Validar_Tipo( lxVal )
				if ( this.lHabilitarTipo or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					this.Tipo = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comprobantes de caja - Atributo: Tipo)" )
				endif 
			EndIf
		Else
			This.Setear_Tipo( lxVal ) 
