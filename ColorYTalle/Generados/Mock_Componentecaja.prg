...
define class Mock_COMPONENTECAJA as MockBase of MockBase.prg

	cClase = 'COMPONENTECAJA'
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Eventocerrarloteslapos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	 function actualizarmovimientodecaja( tcvalor as string, tncaja as integer, tfmonto as float, tfcotizacion as float, tcdescripcion as string, tntipovalor as integer, tcitemvalor as string ) as zoocoleccion of zoocoleccion.prg                         
		...
		lxParam2 = tncaja
		lxParam3 = tfmonto
		lxParam4 = tfcotizacion
		lxParam5 = tcdescripcion
		lxParam6 = tntipovalor
		lxParam7 = tcitemvalor
		...
		return this.ObtenerResultado( 'Actualizarmovimientodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function  eventoadvertirfalloengenerancparaajustesdecupon( tcmensaje as string )  as void                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventoadvertirfalloengenerancparaajustesdecupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function abrir( tncaja as integer ) as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Abrir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarsaldos( tcvalor as string, tncaja as integer, tfmonto as float )  as zoocoleccion of zoocoleccion.prg                                                                                                                                  
		...
		return this.ObtenerResultado( 'Actualizarsaldos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarsegunfondofijo( toitem as object, tnmontofondofijo as integer ) as boolean                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Actualizarsegunfondofijo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregarregistrofaltantedecajaauditoria( tnidcajaaudi as integer, tncaja as integer ) as void                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Agregarregistrofaltantedecajaauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignarnumeroaestadosdecaja() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Asignarnumeroaestadosdecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignarvaloraldetalle( toitemdetalle as object, toitemsaldo as object) as boolean                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Asignarvaloraldetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardatosobligatorioscomprobantedecaja( toentidad as object, tocamposobligatorios as object ) as void                                                                                                                                          
		...
		return this.ObtenerResultado( 'Cargardatosobligatorioscomprobantedecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardetallevalores( toentidad as object) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cargardetallevalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cerrar( tncaja as integer ) as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Cerrar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debeprocesarvuelto() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Debeprocesarvuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function deberealizaraperturaautomaticadecaja() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Deberealizaraperturaautomaticadecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function deshabilitargeneraranulados() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Deshabilitargeneraranulados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoantesdecerrarcaja( tncaja ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Eventoantesdecerrarcaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoavisarfaltaparametrosfondofijo() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Eventoavisarfaltaparametrosfondofijo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoavisarobligatoriosincompletos() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Eventoavisarobligatoriosincompletos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocancelarpedidosapagarencaja() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Eventocancelarpedidosapagarencaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocancelarseniasvencidas() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Eventocancelarseniasvencidas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoexistencomprobantesenelhueco( tccomprobantes as string, tohueco as object ) as void                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Eventoexistencomprobantesenelhueco', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventogenerancparaajustesdecupon( tncaja as integer ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Eventogenerancparaajustesdecupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventogenerarreciboaplicandocuponeshuerfanos() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Eventogenerarreciboaplicandocuponeshuerfanos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoinformarcomprobantescaea() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Eventoinformarcomprobantescaea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomostrarmensajegenerandoanulados() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Eventomostrarmensajegenerandoanulados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoobtenercaea() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Eventoobtenercaea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntargenerarreciboaplicandocuponeshuerfanos( tncaja as integer ) as void                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Eventopreguntargenerarreciboaplicandocuponeshuerfanos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarsillenahuecos( tohuecos ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventopreguntarsillenahuecos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoprocesarformulariocomprobantedecaja( ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Eventoprocesarformulariocomprobantedecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoquitarmensajegenerandoanulados() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Eventoquitarmensajegenerandoanulados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorevisarcomprobantesdecontingenciauruguaysincae() as void                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Eventorevisarcomprobantesdecontingenciauruguaysincae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventovalidarcuponespointpendientes( tncaja as integer ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventovalidarcuponespointpendientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarcomprobantedecaja( tncaja as integer ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Generarcomprobantedecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function grabarcanjedecupon( todetalleaent as object, tlanular as boolean ) as zoocoleccion of zoocoleccion.prg                                                                                                                                           
		...
		return this.ObtenerResultado( 'Grabarcanjedecupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitargeneraranulados() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Habilitargeneraranulados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inicializalyagenerocontracomprobante() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Inicializalyagenerocontracomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarcontrolconcurrencia( toentidad as entidad of entidad.prg ) as void                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Inyectarcontrolconcurrencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiarsaldosvaloresnoprocesablesencierredecaja( tncaja as integer ) as void                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Limpiarsaldosvaloresnoprocesablesencierredecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionsaldovalores( tncaja as integer ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercoleccionsaldovalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerconfiguraciondealiviodecaja( tcbase as string, tncaja as integer  ) as collection                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerconfiguraciondealiviodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripciondecaja( tnidcaja as integer ) as string                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerdescripciondecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripciontipocomprobante( tctipocomprobante as string ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerdescripciontipocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfechadeaperturaanterior( tnnrocaja as integer, tncantdias as integer ) as object                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerfechadeaperturaanterior', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfechadeultimaapertura( tnnrocaja as integer ) as object                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerfechadeultimaapertura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernumerodecajaactiva() as integer                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenernumerodecajaactiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernumerodecajaausarenvalores() as integer                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenernumerodecajaausarenvalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertodosloscomponentes() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenertodosloscomponentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerultimafechaapertura() as date                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerultimafechaapertura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerultimafechacierre() as date                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerultimafechacierre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenervalorescamposobligatorios() as object                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenervalorescamposobligatorios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocomprobantesygruposcaja_access() as variant                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Ocomprobantesygruposcaja_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocontrolcomprobantesfaltantes_access() as variant                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Ocontrolcomprobantesfaltantes_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocontrolconcurrencia_access() as object                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Ocontrolconcurrencia_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omovimientoscaja_access() as variant                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Omovimientoscaja_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reasignarcotizacion( tccursordetalle as string ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Reasignarcotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sedebevisualizarencaja( toitem as object ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Sedebevisualizarencaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seteardatoscomprobante( tncomprobante, tdfecha, tcletra, tnnumerocomprobante, tnpuntodeventa, tcsecuencia as string ) as void                                                                                                                    
		...
		lxParam2 = tdfecha
		lxParam3 = tcletra
		lxParam4 = tnnumerocomprobante
		lxParam5 = tnpuntodeventa
		lxParam6 = tcsecuencia
		...
		return this.ObtenerResultado( 'Seteardatoscomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seteardatosdelaqueodecaja( todatos as object ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Seteardatosdelaqueodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearnumerodecajaactivasegunvalorenparametros() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setearnumerodecajaactivasegunvalorenparametros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validacionadicional( toentidad ) as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validacionadicional', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarsaldodeunvalor( tcvalor as string, tncaja as integer, tnmonto as float ) as boolean                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarsaldodeunvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvuelto( tccodigodevalorparavuelto as string, toentidad as object, tnvuelto as float, tnsignodemovimiento as integer, tlinvertirsigno as boolean ) as boolean                                                                              
		...
		lnParametros = pcount()
		lxParam1 = tccodigodevalorparavuelto
		lxParam2 = toentidad
		lxParam3 = tnvuelto
		lxParam4 = tnsignodemovimiento
		lxParam5 = tlinvertirsigno
		...
		return this.ObtenerResultado( 'Validarvuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcodigoconcepto() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificarcodigoconcepto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcodigoorigen() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Verificarcodigoorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcodigovendedor() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificarcodigovendedor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarleyendafondoinsuficiente( tnmontofijoacumulado as integer ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Agregarleyendafondoinsuficiente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarvueltocursordetalle( toentidad as object, tcatributodetalle as string, tccursordetalle as string , tccursorcabecera as string ) as void                                                                                         
		...
		return this.ObtenerResultado( 'Agregarvueltocursordetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function armarcoleccion( tocolmovimientos, tocolsaldos) as zoocoleccion of zoocoleccion.prg                                                                                                                                                     
		...
		lnParametros = pcount()
		lxParam1 = tocolmovimientos
		lxParam2 = tocolsaldos
		...
		return this.ObtenerResultado( 'Armarcoleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarconceptos( toentidad as object, tccodigoconcepto as string ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cargarconceptos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarorigendestino( toentidad as object, tccodigoorigen as string  ) as void                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Cargarorigendestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarvendedor( toentidad as object, tccodigovendedor as string  ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cargarvendedor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function consultardispositivopoint() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Consultardispositivopoint', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearobjetosentencia( txvalor as variant, tncaja as integer, tnmonto as float, tncotiza as float, tcdetalle as string, tntipovalor as integer, tcitemvalor as string ) as object                                                       
		...
		return this.ObtenerResultado( 'Crearobjetosentencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function enviarresumendeldia() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Enviarresumendeldia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existentodoslosvaloresdelacaja() as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Existentodoslosvaloresdelacaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarauditoriadecaja( tncaja as integer ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Generarauditoriadecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarcontracomprobantedecaja( tocoleccion as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                              
		...
		return this.ObtenerResultado( 'Generarcontracomprobantedecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarestadodecaja() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Generarestadodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarestadodecajapersonalizado( tncaja as integer ) as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Generarestadodecajapersonalizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposselectmovimientodecaja() as string                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercamposselectmovimientodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccionsaldosymovimientosdecaja( tocoleccionsaldos as zoocoleccion of zoocoleccion.prg ) as zoocoleccion of zoocoleccion.prg                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercoleccionsaldosymovimientosdecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdatosdevalorquegeneroelcupon( todetalleaent as object, tlanular as boolean ) as zoocoleccion of zoocoleccion.prg                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerdatosdevalorquegeneroelcupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerestadoconcepto() as string                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerestadoconcepto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemvalor( toitem as object ) as string                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obteneritemvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerobjetosentenciavalor( toitem as object, tlesanterior as boolean ) as object                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerobjetosentenciavalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerobjetosentenciavuelto( tnvuelto as float, tlesanterior as boolean ) as object                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerobjetosentenciavuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersignodeldetalle( tnsigno as integer ) as integer                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenersignodeldetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function prepararxmlmovimientos( toentidad  as object, tccursordetalle as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                          
		...
		return this.ObtenerResultado( 'Prepararxmlmovimientos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarentidadcomprobantedecaja() as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Procesarentidadcomprobantedecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarvalorescajayauditoria( tccursordetalle as string ) as void                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Procesarvalorescajayauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reasignartipocajacursordetalle( tccursordetalle as string ) as void                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Reasignartipocajacursordetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarexistenciadesaldos() as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Verificarexistenciadesaldos', lcParametros )
	EndFunc
