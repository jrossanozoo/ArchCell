...
define class Mock_COLORYTALLE_COMPONENTESTOCK as MockBase of MockBase.prg

	cClase = 'COLORYTALLE_COMPONENTESTOCK'
	...
	*-----------------------------------------------------------------------------------------
	function itemcontrolastockdisponiblealgrabar() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Itemcontrolastockdisponiblealgrabar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lvalidarcolorytalle_access() as boolean                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Lvalidarcolorytalle_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcolorytalle() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcolorytalle', lcParametros )
	EndFunc
