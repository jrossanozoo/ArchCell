...
define class Din_EntidadADT_STOCKARTICULOSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAdt_artFectrans, lxAdt_artFecexpo, lxAdt_artFmodifw, lxAdt_artFecimpo, lxAdt_artAdt_fecha, lxAdt_artFaltafw, lxAdt_artHaltafw, lxAdt_artHoraexpo, lxAdt_artHoraimpo, lxAdt_artSaltafw, lxAdt_artVmodifw, lxAdt_artZadsfw, lxAdt_artValtafw, lxAdt_artUmodifw, lxAdt_artSmodifw, lxAdt_artUaltafw, lxAdt_artHmodifw, lxAdt_artEsttrans, lxAdt_artAdt_adn, lxAdt_artAdt_vers, lxAdt_artAdt_comp, lxAdt_artAdt_serie, lxAdt_artAdt_ent, lxAdt_artAdt_hora, lxAdt_artAdt_usr, lxAdt_artBdmodifw, lxAdt_artBdaltafw, lxAdt_artCorig, lxAdt_artAcant, lxAdt_artAdt_ext, lxAdt_artAdt_cod, lxAdt_artArtcod
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ADT_ART ( "Fectrans","Fecexpo","Fmodifw","Fecimpo","Adt_fecha","Faltafw","Haltafw","Horaexpo","Horaimpo","Saltafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Esttrans","Adt_adn","Adt_vers","Adt_comp","Adt_serie","Adt_ent","Adt_hora","Adt_usr","Bdmodifw","Bdaltafw","Corig","Acant","Adt_ext","Adt_cod","Artcod" ) values ( <<"'" + this.ConvertirDateSql( lxAdt_artFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_artFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_artFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_artFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_artAdt_fecha ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_artFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_adn ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_vers ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_comp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_serie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_ent ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_hora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_usr ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artBdaltafw ) + "'" >>, <<lxAdt_artCorig >>, <<lxAdt_artAcant >>, <<iif( lxAdt_artAdt_ext, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAdt_artAdt_cod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_artArtcod ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ADT_ART set "Fectrans" = <<"'" + this.ConvertirDateSql( lxAdt_artFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxAdt_artFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAdt_artFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAdt_artFecimpo ) + "'">>,"Adt_fecha" = <<"'" + this.ConvertirDateSql( lxAdt_artAdt_fecha ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAdt_artFaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAdt_artHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAdt_artHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAdt_artHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAdt_artSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_artVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAdt_artZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAdt_artValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAdt_artUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAdt_artSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAdt_artUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_artHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAdt_artEsttrans ) + "'">>,"Adt_adn" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_adn ) + "'">>,"Adt_vers" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_vers ) + "'">>,"Adt_comp" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_comp ) + "'">>,"Adt_serie" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_serie ) + "'">>,"Adt_ent" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_ent ) + "'">>,"Adt_hora" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_hora ) + "'">>,"Adt_usr" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_usr ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_artBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAdt_artBdaltafw ) + "'">>,"Corig" = <<lxAdt_artCorig>>,"Acant" = <<lxAdt_artAcant>>,"Adt_ext" = <<iif( lxAdt_artAdt_ext, 1, 0 )>>,"Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_cod ) + "'">>,"Artcod" = <<"'" + this.FormatearTextoSql( lxAdt_artArtcod ) + "'">> where "Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_artAdt_cod ) + "'">> and  ADT_ART.ADT_COD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Adt_fecha" as "Adt_fecha", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Adt_adn" as "Adt_adn", "Adt_vers" as "Adt_vers", "Adt_comp" as "Adt_comp", "Adt_serie" as "Adt_serie", "Adt_ent" as "Adt_ent", "Adt_hora" as "Adt_hora", "Adt_usr" as "Adt_usr", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Corig" as "Cantidadoriginal", "Acant" as "Cantidad", "Adt_ext" as "Adt_ext", "Adt_cod" as "Adt_cod", "Artcod" as "Codigo" from ZooLogic.ADT_ART where  ADT_ART.ADT_COD != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_ADT_STOCKARTICULOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ADT_STOCKARTICULOS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Adt_fecha" as "Adt_fecha", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Adt_adn" as "Adt_adn", "Adt_vers" as "Adt_vers", "Adt_comp" as "Adt_comp", "Adt_serie" as "Adt_serie", "Adt_ent" as "Adt_ent", "Adt_hora" as "Adt_hora", "Adt_usr" as "Adt_usr", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Corig" as "Cantidadoriginal", "Acant" as "Cantidad", "Adt_ext" as "Adt_ext", "Adt_cod" as "Adt_cod", "Artcod" as "Codigo" from ZooLogic.ADT_ART where  funciones.dtos( FALTAFW ) + funciones.padr( HALTAFW, 8, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ADT_ART.ADT_COD != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_ADT_STOCKARTICULOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ADT_STOCKARTICULOS', set( 'Datasession' ) )
			Endwith
...
",Adt_hora,Adt_usr,Bdmodifw,Bdaltafw,Corig,Acant,Adt_ext,Adt_cod,Artcod" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Adt_fecha" as "Adt_fecha", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Adt_adn" as "Adt_adn", "Adt_vers" as "Adt_vers", "Adt_comp" as "Adt_comp", "Adt_serie" as "Adt_serie", "Adt_ent" as "Adt_ent", "Adt_hora" as "Adt_hora", "Adt_usr" as "Adt_usr", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Corig" as "Cantidadoriginal", "Acant" as "Cantidad", "Adt_ext" as "Adt_ext", "Adt_cod" as "Adt_cod", "Artcod" as "Codigo"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FECEXPO, FMODIFW, FECIMPO, ADT_Fecha, FALTAFW, HALTAFW, HORAEXPO, HORAIMPO, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, ESTTRANS, ADT_ADN, ADT_Vers, ADT_Comp, ADT_Serie, ADT_Ent, ADT_Hora, ADT_Usr, BDMODIFW, BDALTAFW, CORIG, ACANT, ADT_Ext, ADT_Cod, ARTCOD
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Serie ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Ent ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Hora ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Usr ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + transform( &lcCursor..CORIG )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..ACANT ) + ',' + Transform( iif( &lcCursor..ADT_Ext, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Cod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ARTCOD ) + "'"
...
<VFPData xml:space="preserve">
	...
	<row entidad="ADT_STOCKARTICULOS                      " atributo="FECHATRANSFERENCIA                      " tabla="ADT_ART        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_STOCKARTICULOS                      " atributo="ESTADOTRANSFERENCIA                     " tabla="ADT_ART        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ADT_STOCKARTICULOS                      " atributo="ADT_ADN                                 " tabla="ADT_ART        " campo="ADT_ADN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="ADN                                                                                                                                                             " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_STOCKARTICULOS                      " atributo="ADT_COMP                                " tabla="ADT_ART        " campo="ADT_COMP  " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Descripción                                                                                                                                                     " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_STOCKARTICULOS                      " atributo="ADT_HORA                                " tabla="ADT_ART        " campo="ADT_HORA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Hora                                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_STOCKARTICULOS                      " atributo="CANTIDADORIGINAL                        " tabla="ADT_ART        " campo="CORIG     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Stock original                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ADT_STOCKARTICULOS                      " atributo="CANTIDAD                                " tabla="ADT_ART        " campo="ACANT     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Cant. en stock                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_STOCKARTICULOS                      " atributo="CODIGO                                  " tabla="ADT_ART        " campo="ARTCOD    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="Stockarticulos                          " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Stock de artículos                                                                                                                                              " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
