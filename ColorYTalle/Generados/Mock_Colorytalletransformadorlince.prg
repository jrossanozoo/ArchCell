...
define class Mock_COLORYTALLETRANSFORMADORLINCE as MockBase of MockBase.prg

	cClase = 'COLORYTALLETRANSFORMADORLINCE'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	llComprobanteAlternativo = .F.                                                                                                                                                                                                                            
	oIdentificador = null                                                                                                                                                                                                                                     
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	oTransformadores = null                                                                                                                                                                                                                                   
	oValidador = null                                                                                                                                                                                                                                         
	...
	*-----------------------------------------------------------------------------------------
	function esunarchivodelince( toarchivo as object ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esunarchivodelince', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function init( toidentificador as object, tovalidador as object, totransformadores as collection )                                                                                                                                                        
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modificosiesremitomayoristacomocompras( tlretorno as boolean, tcprefijo as string) as void                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Modificosiesremitomayoristacomocompras', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerentidadescabecera( toarchivo as object ) as object                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerentidadescabecera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function transformar( tcruta as string, toarchivo as object ) as collection                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Transformar', lcParametros )
	EndFunc
