...
define class Mock_Detallebolsasycajasmovimientodetalle as MockBase of MockBase.prg

	cClase = 'Detallebolsasycajasmovimientodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function completardatoscomplementariosdeprepantalla( toitemaux as object ) as void                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
