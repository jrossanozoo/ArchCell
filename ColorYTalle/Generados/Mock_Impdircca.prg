...
define class Mock_impdircca as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Imputación de artículo a centro de costos en compras"                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function setear_distribucionporcentrodecosto( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCCA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_distribucionporcentrodecosto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_distribucionporcentrodecosto', lcParametros )			endif		endif		this.Distribucionporcentrodecosto.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_distribucionporcentrodecosto( txval as variant, txvalold as variant ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCCA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_distribucionporcentrodecosto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_distribucionporcentrodecosto', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcentrodecosto() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarcentrodecosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardistribucionporcentrodecosto() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validardistribucionporcentrodecosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocentrodecosto() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridocentrodecosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodistribucionporcentrodecosto() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridodistribucionporcentrodecosto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarnopuedenquedarlosdosvacios() as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarnopuedenquedarlosdosvacios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarsolounaasignaciondecentrodecostos() as boolean                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarsolounaasignaciondecentrodecostos', lcParametros )
	EndFunc
