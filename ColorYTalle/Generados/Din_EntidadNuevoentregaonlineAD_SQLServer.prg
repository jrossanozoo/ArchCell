...
define class Din_EntidadNUEVOENTREGAONLINEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxEntonlineFecexpo, lxEntonlineFmodifw, lxEntonlineFecimpo, lxEntonlineFaltafw, lxEntonlineFectrans, lxEntonlineSmodifw, lxEntonlineSaltafw, lxEntonlineUaltafw, lxEntonlineValtafw, lxEntonlineUmodifw, lxEntonlineZadsfw, lxEntonlineVmodifw, lxEntonlineHmodifw, lxEntonlineHoraexpo, lxEntonlineHoraimpo, lxEntonlineBdmodifw, lxEntonlineEsttrans, lxEntonlineBdaltafw, lxEntonlineHaltafw, lxEntonlineCodigo, lxEntonlineFperson, lxEntonlineAutocomp
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ENTONLINE ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaexpo","Horaimpo","Bdmodifw","Esttrans","Bdaltafw","Haltafw","Codigo","Fperson","Autocomp" ) values ( <<"'" + this.ConvertirDateSql( lxEntonlineFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntonlineFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntonlineFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntonlineFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntonlineFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntonlineFperson ) + "'" >>, <<iif( lxEntonlineAutocomp, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ENTONLINE set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEntonlineFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEntonlineFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxEntonlineFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEntonlineFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEntonlineFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEntonlineSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEntonlineUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEntonlineValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEntonlineZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEntonlineHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEntonlineHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEntonlineEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEntonlineBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEntonlineHaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxEntonlineCodigo ) + "'">>,"Fperson" = <<"'" + this.FormatearTextoSql( lxEntonlineFperson ) + "'">>,"Autocomp" = <<iif( lxEntonlineAutocomp, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxEntonlineCodigo ) + "'">> and  ENTONLINE.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
...
"ifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Esttrans,Bdaltafw,Haltafw,Codigo,Fperson,Autocomp" + ;
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.ENTONLINE set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEntonlineFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxEntonlineFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEntonlineFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxEntonlineFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxEntonlineFectrans ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxEntonlineSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxEntonlineUaltafw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxEntonlineValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxEntonlineZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineVmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineHmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxEntonlineHoraexpo ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxEntonlineHoraimpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEntonlineBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxEntonlineEsttrans ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEntonlineBdaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxEntonlineHaltafw ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxEntonlineCodigo ) + "'">>, "Fperson" = <<"'" + this.FormatearTextoSql( lxEntonlineFperson ) + "'">>, "Autocomp" = <<iif( lxEntonlineAutocomp, 1, 0 )>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'ENTONLINE' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.ENTONLINE set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, autocomp = ] + Transform( iif( &lcCursor..autocomp, 1, 0 )) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAEXPO, HORAIMPO, BDMODIFW, ESTTRANS, BDALTAFW, HALTAFW, Codigo, FPerson, autocomp
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad NUEVOENTREGAONLINE. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.AUTOCOMP = isnull( d.AUTOCOMP, t.AUTOCOMP )
					from ZooLogic.ENTONLINE t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.ENTONLINE(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Esttrans,Bdaltafw,Haltafw,Codigo,Fperson,Autocomp)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.CODIGO,''),isnull( d.FPERSON,''),isnull( d.AUTOCOMP,0)
