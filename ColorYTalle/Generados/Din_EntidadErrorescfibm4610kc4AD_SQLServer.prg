...
define class Din_EntidadERRORESCFIBM4610KC4AD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxIbm4610kc4Fecexpo, lxIbm4610kc4Fectrans, lxIbm4610kc4Fmodifw, lxIbm4610kc4Faltafw, lxIbm4610kc4Fecimpo, lxIbm4610kc4Cdeti, lxIbm4610kc4Cdet, lxIbm4610kc4Cobsi, lxIbm4610kc4Cobs, lxIbm4610kc4Cresp, lxIbm4610kc4Crespi, lxIbm4610kc4Smodifw, lxIbm4610kc4Umodifw, lxIbm4610kc4Ualtafw, lxIbm4610kc4Zadsfw, lxIbm4610kc4Valtafw, lxIbm4610kc4Vmodifw, lxIbm4610kc4Saltafw, lxIbm4610kc4Haltafw, lxIbm4610kc4Hmodifw, lxIbm4610kc4Horaimpo, lxIbm4610kc4Esttrans, lxIbm4610kc4Bdaltafw, lxIbm4610kc4Bdmodifw, lxIbm4610kc4Horaexpo, lxIbm4610kc4Bloqreg, lxIbm4610kc4Cexcep, lxIbm4610kc4Ccod
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.IBM4610KC4 ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Cdeti","Cdet","Cobsi","Cobs","Cresp","Crespi","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Saltafw","Haltafw","Hmodifw","Horaimpo","Esttrans","Bdaltafw","Bdmodifw","Horaexpo","Bloqreg","Cexcep","Ccod" ) values ( <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxIbm4610kc4Faltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cdeti ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cdet ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cobsi ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cresp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Crespi ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Smodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Umodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ualtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Zadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Valtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Vmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Saltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Haltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Hmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Horaimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Esttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Bdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Bdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Horaexpo ) + "'" >>, <<iif( lxIbm4610kc4Bloqreg, 1, 0 ) >>, <<iif( lxIbm4610kc4Cexcep, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ccod ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.IBM4610KC4 set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Faltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fecimpo ) + "'">>,"Cdeti" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cdeti ) + "'">>,"Cdet" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cdet ) + "'">>,"Cobsi" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cobsi ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cobs ) + "'">>,"Cresp" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cresp ) + "'">>,"Crespi" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Crespi ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Smodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Umodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ualtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Zadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Valtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Vmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Saltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Haltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Hmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Horaimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Esttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Bdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Bdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Horaexpo ) + "'">>,"Bloqreg" = <<iif( lxIbm4610kc4Bloqreg, 1, 0 )>>,"Cexcep" = <<iif( lxIbm4610kc4Cexcep, 1, 0 )>>,"Ccod" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ccod ) + "'">> where "Ccod" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ccod ) + "'">> and  IBM4610KC4.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Cdeti" as "Detalleeningles", "Cdet" as "Detalle", "Cobsi" as "Observacioneningles", "Cobs" as "Observacion", "Cresp" as "Respuesta", "Crespi" as "Respuestaeningles", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bloqreg" as "Bloquearregistro", "Cexcep" as "Lanzaexcepcion", "Ccod" as "Codigo" from ZooLogic.IBM4610KC4 where "Ccod" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ccod ) + "'">> and  IBM4610KC4.CCOD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Cdeti" as "Detalleeningles", "Cdet" as "Detalle", "Cobsi" as "Observacioneningles", "Cobs" as "Observacion", "Cresp" as "Respuesta", "Crespi" as "Respuestaeningles", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bloqreg" as "Bloquearregistro", "Cexcep" as "Lanzaexcepcion", "Ccod" as "Codigo" from ZooLogic.IBM4610KC4 where  IBM4610KC4.CCOD != '' order by cCod
			endtext
			use in select('c_ERRORESCFIBM4610KC4')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ERRORESCFIBM4610KC4', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Cdeti" as "Detalleeningles", "Cdet" as "Detalle", "Cobsi" as "Observacioneningles", "Cobs" as "Observacion", "Cresp" as "Respuesta", "Crespi" as "Respuestaeningles", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bloqreg" as "Bloquearregistro", "Cexcep" as "Lanzaexcepcion", "Ccod" as "Codigo" from ZooLogic.IBM4610KC4 where  funciones.padr( cCod, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IBM4610KC4.CCOD != '' order by cCod
			endtext
			use in select('c_ERRORESCFIBM4610KC4')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ERRORESCFIBM4610KC4', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Cdeti" as "Detalleeningles", "Cdet" as "Detalle", "Cobsi" as "Observacioneningles", "Cobs" as "Observacion", "Cresp" as "Respuesta", "Crespi" as "Respuestaeningles", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bloqreg" as "Bloquearregistro", "Cexcep" as "Lanzaexcepcion", "Ccod" as "Codigo" from ZooLogic.IBM4610KC4 where  IBM4610KC4.CCOD != '' order by cCod desc
			endtext
			use in select('c_ERRORESCFIBM4610KC4')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ERRORESCFIBM4610KC4', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Cdeti,Cdet,Cobsi,Cobs,Cresp,Crespi,Smodifw,Umodifw," + ;
"Ualtafw,Zadsfw,Valtafw,Vmodifw,Saltafw,Haltafw,Hmodifw,Horaimpo,Esttrans,Bdaltafw,Bdmodifw,Horaexpo," + ;
"Bloqreg,Cexcep,Ccod" + ;
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.IBM4610KC4 set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Faltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxIbm4610kc4Fecimpo ) + "'">>, "Cdeti" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cdeti ) + "'">>, "Cdet" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cdet ) + "'">>, "Cobsi" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cobsi ) + "'">>, "Cobs" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cobs ) + "'">>, "Cresp" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Cresp ) + "'">>, "Crespi" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Crespi ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Smodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Umodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ualtafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Zadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Valtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Vmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Saltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Haltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Hmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Horaimpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Esttrans ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Bdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Bdmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Horaexpo ) + "'">>, "Bloqreg" = <<iif( lxIbm4610kc4Bloqreg, 1, 0 )>>, "Cexcep" = <<iif( lxIbm4610kc4Cexcep, 1, 0 )>>, "Ccod" = <<"'" + this.FormatearTextoSql( lxIbm4610kc4Ccod ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'IBM4610KC4' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.IBM4610KC4 set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, cDetI = ] + "'" + this.FormatearTextoSql( &lcCursor..cDetI ) + "'"+ [, cDet = ] + "'" + this.FormatearTextoSql( &lcCursor..cDet ) + "'"+ [, cObsI = ] + "'" + this.FormatearTextoSql( &lcCursor..cObsI ) + "'"+ [, cObs = ] + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"+ [, cResp = ] + "'" + this.FormatearTextoSql( &lcCursor..cResp ) + "'"+ [, cRespI = ] + "'" + this.FormatearTextoSql( &lcCursor..cRespI ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, cExcep = ] + Transform( iif( &lcCursor..cExcep, 1, 0 ))+ [, cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" + [ Where cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, cDetI, cDet, cObsI, cObs, cResp, cRespI, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, SALTAFW, HALTAFW, HMODIFW, HORAIMPO, ESTTRANS, BDALTAFW, BDMODIFW, HORAEXPO, BLOQREG, cExcep, cCod
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDetI ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDet ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cObsI ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cResp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cRespI ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + Transform( iif( &lcCursor..cExcep, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.CDETI = isnull( d.CDETI, t.CDETI ),t.CDET = isnull( d.CDET, t.CDET ),t.COBSI = isnull( d.COBSI, t.COBSI ),t.COBS = isnull( d.COBS, t.COBS ),t.CRESP = isnull( d.CRESP, t.CRESP ),t.CRESPI = isnull( d.CRESPI, t.CRESPI ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.CEXCEP = isnull( d.CEXCEP, t.CEXCEP ),t.CCOD = isnull( d.CCOD, t.CCOD )
					from ZooLogic.IBM4610KC4 t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ZooLogic.IBM4610KC4(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Cdeti,Cdet,Cobsi,Cobs,Cresp,Crespi,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Saltafw,Haltafw,Hmodifw,Horaimpo,Esttrans,Bdaltafw,Bdmodifw,Horaexpo,Bloqreg,Cexcep,Ccod)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.CDETI,''),isnull( d.CDET,''),isnull( d.COBSI,''),isnull( d.COBS,''),isnull( d.CRESP,''),isnull( d.CRESPI,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.SALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.BLOQREG,0),isnull( d.CEXCEP,0),isnull( d.CCOD,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="ERRORESCFIBM4610KC4                     " atributo="FECHATRANSFERENCIA                      " tabla="IBM4610KC4     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ERRORESCFIBM4610KC4                     " atributo="ESTADOTRANSFERENCIA                     " tabla="IBM4610KC4     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
