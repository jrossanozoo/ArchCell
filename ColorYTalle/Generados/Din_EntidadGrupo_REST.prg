...
define class Din_EntidadGrupo_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Grupo"
	cClaseResponse = this.cNamespaceDTOs + ".GrupoResponse"
	cClaseModelo = "GrupoModelo"
	cEntidad = "Grupo"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "GrupoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "GrupoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "GrupoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "GrupoModelo"
		endcase
		return lcRetorno
