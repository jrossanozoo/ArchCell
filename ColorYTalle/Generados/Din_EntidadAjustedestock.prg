...
define class Din_EntidadAJUSTEDESTOCK as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionDetalles() as Boolean
		...
		llRetorno = dodefault()
		llRetorno = This.ValidarUnDetalle( this.stockafectado, 'Detalle combinaciones' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.StockAfectadoArticulo, 'StockAfectadoArticulo' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.StockAfectadoAuditoriaComb, 'Detalle auditoría' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.StockAfectadoAuditoriaArt, 'StockAfectadoAuditoriaArt' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.stockafectadoEnTransito, 'Detalle en tránsito' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.StockAfectadoAuditoriaEnTransito, 'Detalle auditoría en tránsito' ) and llRetorno
		return llRetorno
	endfunc
