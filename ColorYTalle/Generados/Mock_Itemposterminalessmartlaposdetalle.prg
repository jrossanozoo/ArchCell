...
define class Mock_Itemposterminalessmartlaposdetalle as MockBase of MockBase.prg

	cClase = 'Itemposterminalessmartlaposdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function setear_terminal( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_terminal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function terminal_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Terminal_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_terminal( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_terminal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoterminal() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoterminal', lcParametros )
	EndFunc
