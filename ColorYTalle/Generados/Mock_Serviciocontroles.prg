...
define class Mock_SERVICIOCONTROLES as MockBase of MockBase.prg

	cClase = 'SERVICIOCONTROLES'
	...
	*-----------------------------------------------------------------------------------------
	function agregarevento( toformulario as form, tocontrol as object, tcorigen as string, tcmetodoorigen as string , tcmetododestino as string, tnflag as boolean ) as void                                                                                  
		...
		lxParam2 = tocontrol
		lxParam3 = tcorigen
		lxParam4 = tcmetodoorigen
		lxParam5 = tcmetododestino
		lxParam6 = tnflag
	...
	*-----------------------------------------------------------------------------------------
	function agregareventogenerico( tocontrol as object, tcobjetoorigen as string, tcmetodoorigen as string, tcobjetodestino as string, tcmetododestino as string, tnflag as boolean ) as void                                                                
		...
		lnParametros = pcount()
		lxParam1 = tocontrol
		lxParam2 = tcobjetoorigen
		lxParam3 = tcmetodoorigen
		lxParam4 = tcobjetodestino
		lxParam5 = tcmetododestino
		lxParam6 = tnflag
		...
		return this.ObtenerResultado( 'Agregareventogenerico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buscar( toform as form, tocontrol as object, tcsigno as string,  tcstring as string, tlclavecandidata as boolean ) as boolean                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function escontroldentrodegrilla( tocontrol as object ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Escontroldentrodegrilla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function establecerobligatoriedaddecontrol( tocontrol as object ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Establecerobligatoriedaddecontrol', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function establecerobligatoriedadsinodecontrol( tocontrol as object, tlvalor as boolean ) as void                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Establecerobligatoriedadsinodecontrol', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esuncontenedorseteable( loctrl as object ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Esuncontenedorseteable', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esuncontrolseteable( toctrl as object ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Esuncontrolseteable', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esuncontrolseteableinternamente( toctrl as object ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Esuncontrolseteableinternamente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esvalorvacio( txvalor as variant , tcmascara as string ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Esvalorvacio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarcontrolesordenados( tocontrol as object ) as collection                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Generarcontrolesordenados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidaddeitemsdedetallepordefecto() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercantidaddeitemsdedetallepordefecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripcionsubgrupo( tocontrol as object ) as string                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerdescripcionsubgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripcionultimalinea() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerdescripcionultimalinea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneretiquetacorta( tocontrol as object ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obteneretiquetacorta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneretiquetalarga( tocontrol as object ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obteneretiquetalarga', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneretiquetaseguncolumna( tocontrol as object ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obteneretiquetaseguncolumna', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfoco( tocontrol as object, toform as object ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerfoco', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerformulario( tcolbusqueda as collection, tcsigno as string, tcstring as string,  tocontrol as object, tlclavecandidata as boolean, toentidadprincipal as object ) as object                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6
	...
	*-----------------------------------------------------------------------------------------
	function obtenericonodefaultdelosformularios() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenericonodefaultdelosformularios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermododecomportamiento( tcmodo as string ) as integer                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenermododecomportamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerporcentajevisualdedetallepordefecto() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerporcentajevisualdedetallepordefecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertiposubgrupo( tocontrol as object ) as integer                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenertiposubgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function odominios_access() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Odominios_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function resolverretornoparagrilla( tocontrol as object, tnretorno as integer ) as integer                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Resolverretornoparagrilla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sepuedeacomodar( tocontrol as object ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Sepuedeacomodar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sepuedeajustar( tocontrol as object ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Sepuedeajustar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sepuedeordenar( tocontrol as object ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Sepuedeordenar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearclosableformularioprincipalprincipal( tlhabilitado as boolean ) as boolean                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearclosableformularioprincipalprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearcoloresencontrol( tocontrol as object ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setearcoloresencontrol', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearmascara( tocontrol as object, tcaccion as string ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearmascara', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienesaltocampo( tocontrol as object ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Tienesaltocampo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcaracteresespeciales( tnkey as integer ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarcaracteresespeciales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function armarmacrosustitucionhoock( tocontrol as object, tcobjetodelhocck as string, tcnombrefuncion as string ) as string                                                                                                                     
		...
		return this.ObtenerResultado( 'Armarmacrosustitucionhoock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function armarnombrehoock( tocontrol as object, tcobjetodelhocck as string, tcnombrefuncion as string ) as string                                                                                                                               
		...
		return this.ObtenerResultado( 'Armarnombrehoock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ejecutarhoock( tocontrol as object, toobjetohoock as object, tcnombrefuncion as string, tcparametros as string ) as variant                                                                                                            
		...
		lnParametros = pcount()
		lxParam1 = tocontrol
		lxParam2 = toobjetohoock
		lxParam3 = tcnombrefuncion
		lxParam4 = tcparametros
		...
		return this.ObtenerResultado( 'Ejecutarhoock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerfirmahoock( tocontrol as object, tcobjetodelhocck as string, tcnombrefuncion as string, tcparametros as string ) as string                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerfirmahoock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearvalorcontrolvisual( tocontrol as object ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setearvalorcontrolvisual', lcParametros )
	EndFunc
