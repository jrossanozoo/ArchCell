...
define class Mock_Movimientostockdesdeproduccad_sqlserver as MockBase of MockBase.prg

	cClase = 'Movimientostockdesdeproduccad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detmstockdesdpr( tctablatrabajo ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detmstockdesdpr', lcParametros )
	EndFunc
