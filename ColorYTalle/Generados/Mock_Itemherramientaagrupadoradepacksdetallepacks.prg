...
define class Mock_Itemherramientaagrupadoradepacksdetallepacks as MockBase of MockBase.prg

	cClase = 'Itemherramientaagrupadoradepacksdetallepacks'
	...
	*-----------------------------------------------------------------------------------------
	function eventobusquedadepacks( tobusqueda as object ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventobusquedadepacks', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetearpacks() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesardespuesdesetearpacks', lcParametros )
	EndFunc
