...
define class Din_ItemORDENDEPRODUCCIONOrdensalidas as ItemBaseProduccion of ItemBaseProduccion.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'ORDENDEPRODUCCION', 'Ordensalidas')
	...
	function Proceso_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Proceso( lxVal, lxValOld )
			if ( this.lHabilitarProceso_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Orden de producción - Atributo: Proceso)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Semielaborado_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Semielaborado( lxVal, lxValOld )
			...
			If lxValOld != lxVal or empty( this.Semielaboradodetalle ) 
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Orden de producción - Atributo: Semielaborado)" )
			endif 
		endif
		dodefault( lxVal )
		...
		if This.CargaManual()
			if this.Validar_Semielaboradodetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Semielaboradodetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Orden de producción - Atributo: Semielaboradodetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Semielaboradodetalle( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Cantidad( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Cantidad', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Orden de producción - Atributo: Cantidad)" )
				endif 
			EndIf
		Else
			This.Setear_Cantidad( lxVal ) 
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoProceso() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "ORDENDEPRODUCCION", "Ordensalidas", "Proceso" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoSemielaborado() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "ORDENDEPRODUCCION", "Ordensalidas", "Semielaborado" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoSemielaboradodetalle() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "ORDENDEPRODUCCION", "Ordensalidas", "Semielaboradodetalle" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoCantidad() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "ORDENDEPRODUCCION", "Ordensalidas", "Cantidad" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	function habilitar( tlHabilitar as boolean ) as void
		this.lHabilitarCodigoOrden = tlHabilitar
