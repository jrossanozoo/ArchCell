...
define class Din_EntidadMovimientostockainvent_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Movimientostockainvent"
	cClaseResponse = this.cNamespaceDTOs + ".MovimientostockainventResponse"
	cClaseModelo = "MovimientostockainventModelo"
	cEntidad = "Movimientostockainvent"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "MovimientostockainventModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MovimientostockainventListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MovimientostockainventListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "MovimientostockainventModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleMovimientoDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Inventariodestino", toEntidad.MovimientoDetalle.oItem, "InventarioDestino_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Inventariodestinodetalle", toEntidad.MovimientoDetalle.oItem, "InventarioDestinoDetalle" )
	...
	protected function CargarColeccionModeloMovimientoDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .MovimientoDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemMstockainv" )
				...
				this.SetearAtributoString( loItem, "InventarioDestino", .MovimientoDetalle.Item(lnI).InventarioDestino_PK)
				this.SetearAtributoString( loItem, "InventarioDestinoDetalle", .MovimientoDetalle.Item(lnI).InventarioDestinoDetalle)
