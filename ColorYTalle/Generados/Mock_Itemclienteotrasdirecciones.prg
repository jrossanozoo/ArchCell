...
define class Mock_Itemclienteotrasdirecciones as MockBase of MockBase.prg

	cClase = 'Itemclienteotrasdirecciones'
	...
	*-----------------------------------------------------------------------------------------
	function notas_assign( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Notas_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function paisdetalle_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Paisdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function provinciadetalle_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Provinciadetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_notas( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_notas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_paisdetalle( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_paisdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_provinciadetalle( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_provinciadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodireccion( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_tipodireccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodireccion_access() as variant                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Tipodireccion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodireccion_pk_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Tipodireccion_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_notas( txval as variant ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_notas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_paisdetalle( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_paisdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_provinciadetalle( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_provinciadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodireccion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_tipodireccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonotas() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridonotas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipodireccion() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridotipodireccion', lcParametros )
	EndFunc
