...
define class Mock_modelodeproduccion as MockBase of MockBase.prg
	...
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Modelo de producción"                                                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallemodeloinsumos() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallemodeloinsumos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallemodelomaquinas() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallemodelomaquinas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallemodeloprocesos() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallemodeloprocesos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallemodelosalidas() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallemodelosalidas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modeloinsumos_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MODELODEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modeloinsumos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modeloinsumos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Modeloinsumos ) = 'O' or isnull( this.Modeloinsumos ) )			this.Modeloinsumos = this.crearobjeto( 'DetalleModelodeproduccionModeloinsumos' )			this.Modeloinsumos.inicializar()			this.enlazar( 'Modeloinsumos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Modeloinsumos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Modeloinsumos, 'CambioSumarizado', this, 'CambiosDetalleModeloinsumos', 1)			this.enlazar( 'Modeloinsumos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Modeloinsumos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Modeloinsumos.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Modeloinsumos
	EndFunc

	*-----------------------------------------------------------------------------------------
	function modelomaquinas_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MODELODEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modelomaquinas_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modelomaquinas_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Modelomaquinas ) = 'O' or isnull( this.Modelomaquinas ) )			this.Modelomaquinas = this.crearobjeto( 'Din_DetalleModelodeproduccionModelomaquinas' )			this.Modelomaquinas.inicializar()			this.enlazar( 'Modelomaquinas.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Modelomaquinas.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Modelomaquinas, 'CambioSumarizado', this, 'CambiosDetalleModelomaquinas', 1)			this.enlazar( 'Modelomaquinas.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Modelomaquinas.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Modelomaquinas.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Modelomaquinas
	EndFunc

	*-----------------------------------------------------------------------------------------
	function modeloprocesos_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MODELODEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modeloprocesos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modeloprocesos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Modeloprocesos ) = 'O' or isnull( this.Modeloprocesos ) )			this.Modeloprocesos = this.crearobjeto( 'DetalleModelodeproduccionModeloprocesos' )			this.Modeloprocesos.inicializar()			this.enlazar( 'Modeloprocesos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Modeloprocesos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Modeloprocesos, 'CambioSumarizado', this, 'CambiosDetalleModeloprocesos', 1)			this.enlazar( 'Modeloprocesos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Modeloprocesos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Modeloprocesos.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Modeloprocesos
	EndFunc

	*-----------------------------------------------------------------------------------------
	function modelosalidas_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MODELODEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'modelosalidas_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'modelosalidas_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Modelosalidas ) = 'O' or isnull( this.Modelosalidas ) )			this.Modelosalidas = this.crearobjeto( 'DetalleModelodeproduccionModelosalidas' )			this.Modelosalidas.inicializar()			this.enlazar( 'Modelosalidas.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Modelosalidas.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Modelosalidas, 'CambioSumarizado', this, 'CambiosDetalleModelosalidas', 1)			this.enlazar( 'Modelosalidas.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Modelosalidas.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Modelosalidas.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Modelosalidas
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercolecciondecombinacionesfueradecurva( tccurva as string, todetalle as detalle of detalle.prg, tccolor as string, tctalle as string) as collection                                                                                         
		...
		return this.ObtenerResultado( 'Obtenercolecciondecombinacionesfueradecurva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function refrescargrillassegunproceso( tcproceso as string ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Refrescargrillassegunproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_familia( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MODELODEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_familia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_familia', lcParametros )			endif		endif		this.Familia.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_familia( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MODELODEPRODUCCION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_familia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_familia', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfamilia() as boolean                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarfamilia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarprocesoenitems( tcproceso as string ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validarprocesoenitems', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarprocesoenmodelo( tcproceso as string ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarprocesoenmodelo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reordenardetalleinsumos() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Reordenardetalleinsumos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reordenardetallemaquinarias() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Reordenardetallemaquinarias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reordenardetalleprocesos() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Reordenardetalleprocesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reordenardetallesalidas() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Reordenardetallesalidas', lcParametros )
	EndFunc
