...
define class Mock_cuponeshuerfanos as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Cupones huérfanos"                                                                                                                                                                                                                       
	...
	*-----------------------------------------------------------------------------------------
	function agregarcuponalagrilla( toitem as object ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregarcuponalagrilla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecupones() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallecupones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cupones_access() as variant                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CUPONESHUERFANOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cupones_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cupones_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Cupones ) = 'O' or isnull( this.Cupones ) )			this.Cupones = this.crearobjeto( 'Din_DetalleCuponeshuerfanosCupones' )			this.Cupones.inicializar()			this.enlazar( 'Cupones.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Cupones.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Cupones, 'CambioSumarizado', this, 'CambiosDetalleCupones', 1)			this.enlazar( 'Cupones.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Cupones.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Cupones
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventodetalledecuponescambio() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventodetalledecuponescambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarcuponeshuerfanos( tocuponeshuerfanos as object ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocuponeshuerfanos
		...
		return this.ObtenerResultado( 'Inyectarcuponeshuerfanos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidaddecuponeshuerfanos() as integer                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercantidaddecuponeshuerfanos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercantidaddecuponeshuerfanosendispositivopos( tcpos as string ) as integer                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercantidaddecuponeshuerfanosendispositivopos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercantidaddecuponeshuerfanosporcaja( tncaja as integer ) as integer                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercantidaddecuponeshuerfanosporcaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercolecciondeafectados() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercolecciondeafectados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercuponeshuerfanos() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function obtenercuponeshuerfanosporcaja( tncaja as integer ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinformaciondecuponesaplicados() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerinformaciondecuponesaplicados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolafectados_access() as void                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CUPONESHUERFANOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolafectados_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolafectados_access', lcParametros )			endif		endif		if !this.lDestroy and ( vartype( this.oColAfectados ) != "O" or isnull( this.oColAfectados) )			this.oColAfectados = _screen.zoo.CrearObjeto( "ZooColeccion" )		endif		return this.oColAfectados
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oentidadcupon_access() as void                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CUPONESHUERFANOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadcupon_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadcupon_access', lcParametros )			endif		endif		if !this.lDestroy and ( vartype( this.oEntidadCupon ) != "O" or isnull( this.oEntidadCupon ) )			this.oEntidadCupon = _screen.zoo.instanciarentidad( "Cupon" )		endif		return this.oEntidadCupon
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oinformacionafectado_access() as void                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CUPONESHUERFANOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oinformacionafectado_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oinformacionafectado_access', lcParametros )			endif		endif		if !this.lDestroy and ( vartype( this.oInformacionAfectado ) != "O" or isnull( this.oInformacionAfectado) )			this.oInformacionAfectado = _screen.zoo.CrearObjeto( "ZooColeccion" )		endif		return this.oInformacionAfectado
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function quitarcuponhuerfano( tcguidcupon as string ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Quitarcuponhuerfano', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function restaurarcuponesincluidos() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Restaurarcuponesincluidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarquenosehayanaplicadoloscuponeshuerfanos( tocuponeshuerfanosaplicados as object ) as boolean                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocuponeshuerfanosaplicados
		...
		return this.ObtenerResultado( 'Validarquenosehayanaplicadoloscuponeshuerfanos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarsielcuponsiguehuerfano( tccodigo as string ) as boolean                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarinformaciondecuponafectado( tocupon as object )as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregarinformaciondecuponafectado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function aplicarcuponalcomprobante( toitem as object ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Aplicarcuponalcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function mapear( toitem as object ) as object                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Mapear', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemcupon as custom                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obteneritemcupon As Custom', lcParametros )
	EndFunc
