...
define class Mock_Entidadfinancieraad_sqlserver as MockBase of MockBase.prg

	cClase = 'Entidadfinancieraad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubenf( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubenf', lcParametros )
	EndFunc
