...
define class Mock_agrupalistadospersonalizados as MockBase of MockBase.prg
	...
	cClase = 'agrupalistadospersonalizados'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Agrupamiento de listados personalizados"                                                                                                                                                                                                 
	...
	*-----------------------------------------------------------------------------------------
	function actualizarestado() as boolean                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallereferencias() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallereferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function referencias_access() as variant                                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AGRUPALISTADOSPERSONALIZADOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'referencias_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'referencias_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Referencias ) = 'O' or isnull( this.Referencias ) )			this.Referencias = this.crearobjeto( 'Din_DetalleAgrupalistadospersonalizadosReferencias' )			this.Referencias.inicializar()			this.enlazar( 'Referencias.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Referencias.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Referencias, 'CambioSumarizado', this, 'CambiosDetalleReferencias', 1)			this.enlazar( 'Referencias.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Referencias.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Referencias
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigo( txval as variant ) as boolean                                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function verificarexistenciadeaccesodirecto( tctipodetalle as string, tnfilaactiva as integer ) as boolean                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tctipodetalle
		lxParam2 = tnfilaactiva
		...
		return this.ObtenerResultado( 'Verificarexistenciadeaccesodirecto', lcParametros )
	EndFunc
