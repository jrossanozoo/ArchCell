...
define class Mock_Minimoreposicionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Minimoreposicionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleminrepo( tcatributo as string ) as string                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercampodetalleminrepo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleminrepo( tccampos as string ) as string                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleminrepo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleminrepo( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleminrepo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubmin( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubmin', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_minrepodet( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_minrepodet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleminrepo( tccampos as string ) as string                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleminrepo', lcParametros )
	EndFunc
