...
define class Mock_Detalleconfiguracionarticuloecommercedimensionesecom as MockBase of MockBase.prg

	cClase = 'Detalleconfiguracionarticuloecommercedimensionesecom'
	...
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Dimensiones ecommerce por variante'                                                                                                                                                                                                          
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'La columna  no admite valores repetidos.'                                                                                                                                                                                        
	cNombre = 'Dimensionesecom'                                                                                                                                                                                                                               
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Dimensiones ecommerce por variante'                                                                                                                                                                                                      
	datasession = 1                                                                                                                                                                                                                                           
