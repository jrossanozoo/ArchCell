...
define class Din_EntidadNotadecredito_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadecredito"
	cClaseResponse = this.cNamespaceDTOs + ".NotadecreditoResponse"
	cClaseModelo = "NotadecreditoModelo"
	cEntidad = "Notadecredito"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoModelo"
		endcase
		return lcRetorno
