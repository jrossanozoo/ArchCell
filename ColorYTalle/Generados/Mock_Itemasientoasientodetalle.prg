...
define class Mock_Itemasientoasientodetalle as MockBase of MockBase.prg

	cClase = 'Itemasientoasientodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function cuentaalaqueajusta_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cuentaalaqueajusta_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debe_assign( txval as variant ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Debe_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debe_despuesdeasignar() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Debe_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechadelajuste_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Fechadelajuste_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function haber_assign( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Haber_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function haber_despuesdeasignar() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Haber_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plandecuentasdetalle_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Plandecuentasdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function requierecc_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Requierecc_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cuentaalaqueajusta( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_cuentaalaqueajusta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_debe( txval as variant ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_debe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechadelajuste( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_fechadelajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_haber( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_haber', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_plandecuentasdetalle( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_plandecuentasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_requierecc( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_requierecc', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cuentaalaqueajusta( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_cuentaalaqueajusta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_debe( txval as variant ) as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_debe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechadelajuste( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_fechadelajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_haber( txval as variant ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_haber', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_plandecuentasdetalle( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_plandecuentasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_requierecc( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_requierecc', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodebe() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridodebe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohaber() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridohaber', lcParametros )
	EndFunc
