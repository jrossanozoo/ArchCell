...
define class Mock_COMPONENTEFISCALTICKETARGENTINA as MockBase of MockBase.prg

	cClase = 'COMPONENTEFISCALTICKETARGENTINA'

	
	ArticulosAImprimir = null                                                                                                                                                                                                                                 
	DatosImpresion = null                                                                                                                                                                                                                                     
	FechaDeComprobante = {}                                                                                                                                                                                                                                   
	ImprimeTicketParaCambio = .f.                                                                                                                                                                                                                             
	ImprimeTicketTestigo = .f.                                                                                                                                                                                                                                
	ImprimeTipoComprobanteDeCambio = .f.                                                                                                                                                                                                                      
	cEstadoInicializado = ""                                                                                                                                                                                                                                  
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	...
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	lEsComprobanteDeCambio = .f.                                                                                                                                                                                                                              
	lEsComprobanteElectronico = .F.                                                                                                                                                                                                                           
	lEsComprobanteTestigo = .f.                                                                                                                                                                                                                               
	lEsExe = .f.                                                                                                                                                                                                                                              
	lEsUruguay = .f.                                                                                                                                                                                                                                          
	lEstaRecalculandoImpuestosAntesDeGrabar = .F.                                                                                                                                                                                                             
	lExisteControlador = .F.                                                                                                                                                                                                                                  
	lExportacion = .f.                                                                                                                                                                                                                                        
	lForzarImpresionDeComprobanteParaCambio = .f.                                                                                                                                                                                                             
	lImprimir = .F.                                                                                                                                                                                                                                           
	lInicializado = .f.                                                                                                                                                                                                                                       
	lIvaLiberado = .f.                                                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function agregaracolecciondeimpuestos( tocomprobante as object ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Agregaracolecciondeimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicardescuentofinanciero( tnmontobasedeldescuento as float, todetalleimpuestos as object ) as void                                                                                                                                             
		...
		lnParametros = pcount()
		lxParam1 = tnmontobasedeldescuento
		lxParam2 = todetalleimpuestos
	...
	*-----------------------------------------------------------------------------------------
	function aplicardescuentoglobal( tnporcentaje as float, todetalleimpuestos as object ) as void                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Aplicardescuentoglobal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicardescuentoglobal2( tnporcentaje as float, todetalleimpuestos as object ) as void                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Aplicardescuentoglobal2', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicardescuentoglobal4( tnporcentaje as float, todetalleimpuestos as object ) as void                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Aplicardescuentoglobal4', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicarrecargofinanciero( tnmontobasedelrecargo as float, todetalleimpuestos as object ) as void                                                                                                                                                 
		...
		lnParametros = pcount()
		lxParam1 = tnmontobasedelrecargo
		lxParam2 = todetalleimpuestos
	...
	*-----------------------------------------------------------------------------------------
	function aplicarrecargoglobal( tnporcentaje as float, todetalleimpuestos as object ) as void                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Aplicarrecargoglobal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicarrecargoglobal3( tnporcentaje as float, todetalleimpuestos as object ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Aplicarrecargoglobal3', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function bloquearcf() as void                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Bloquearcf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calcularimportesinimpuestos( tnimporte as integer, tnporcentajeivaoriginal as integer, tntasaefectivaimpuestointerno as integer ) as void                                                                                                        
		...
		lnParametros = pcount()
		lxParam1 = tnimporte
		lxParam2 = tnporcentajeivaoriginal
		lxParam3 = tntasaefectivaimpuestointerno
		...
		return this.ObtenerResultado( 'Calcularimportesinimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calcularimpuestosdesdeitem( toitem ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Calcularimpuestosdesdeitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarimpuestos() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Cargarimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarpercepciones() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarpercepciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarpropiedadesdelsistema() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarpropiedadesdelsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function chequearcorrectainicializacion() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Chequearcorrectainicializacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminaritemsinimpuesto( todetalleimpuestos as object ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Eliminaritemsinimpuesto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function emitiranulado( toobjetoimpresion as object ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toobjetoimpresion
	...
	*-----------------------------------------------------------------------------------------
	function establecersiaplicaimpuestosinternosencolaborador() as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Establecersiaplicaimpuestosinternosencolaborador', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function evaluarimpresiondeunarticuloporcomprobante() as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Evaluarimpresiondeunarticuloporcomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function evaluarimpresionticketparacambio() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Evaluarimpresionticketparacambio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function evaluarimpresiontickettestigo() as boolean                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Evaluarimpresiontickettestigo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function evaluarordenarticuloparacambios( tnlinea as integer ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Evaluarordenarticuloparacambios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function evaluarsicorrespondeaplicarley19640() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Evaluarsicorrespondeaplicarley19640', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiototalimpuesto() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eventocambiototalimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarimprimirtickettestigo() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntarimprimirtickettestigo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventopreguntartipoimpresioncomprobantedecambio() as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntartipoimpresioncomprobantedecambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventosetearcalculando( tlvalor as boolean ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Eventosetearcalculando', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existecontrolador() as boolean                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Existecontrolador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarcabecera( todatosimpresion as object ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Generarcabecera', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarpie( todatosimpresion as object ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Generarpie', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hayarticulosgravadoscondiferentesporcentajesdeiva() as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Hayarticulosgravadoscondiferentesporcentajesdeiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function imprimir( todatosimpresion as object ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function imprimirticketadicional(todatosimpresion as object) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function imprimirticketparacambio( todatosimpresion as object ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function imprimirtickettestigo( todatosimpresion as object ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Imprimirtickettestigo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciapropiedades() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Iniciapropiedades', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarimpuestoscomprobante( todetalle as detalle of detalle.prg ) as void                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Inyectarimpuestoscomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarimpuestosdetalle( toimpuestodetalle as detalle of detalle.prg ) as void                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Inyectarimpuestosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiarcoleccionarticulossinprecios( todetallesinprecio as detalle of detalle.prg ) as zoocoleccion of zoocoleccion.prg                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = todetallesinprecio
		...
		return this.ObtenerResultado( 'Limpiarcoleccionarticulossinprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mensajecomprobantesfaltantes() as string                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Mensajecomprobantesfaltantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerimporteimpuestointerno( tnimporte as integer, tntasaefectivaimpuestointerno as integer ) as double                                                                                                                                        
		...
		lnParametros = pcount()
		lxParam1 = tnimporte
		lxParam2 = tntasaefectivaimpuestointerno
		...
		return this.ObtenerResultado( 'Obtenerimporteimpuestointerno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerivapercepcion( tnpercepcioniva as double ) as double                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tnpercepcioniva
		...
		return this.ObtenerResultado( 'Obtenerivapercepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlimitetotaldeuncomprobantesinpersonalizar() as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerlimitetotaldeuncomprobantesinpersonalizar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermontolimitecomprobante() as integer                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenermontolimitecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerparametrodenumeracion() as string                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerparametrodenumeracion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerporcentajeivaseguntipoiva( tntipoiva as integer, tnporcentajeivagravado as integer, toitem as object ) as integer                                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = tntipoiva
		lxParam2 = tnporcentajeivagravado
		lxParam3 = toitem
		...
		return this.ObtenerResultado( 'Obtenerporcentajeivaseguntipoiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerporcentajesumarizadoiibb() as integer                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerporcentajesumarizadoiibb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerpreciosinimpuestos( toitem as object, tnprecio as decimal ) as decimal                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerpreciosinimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerpuntodeventa( tcletra, tctipocomprobante, tcfuncionalidades ) as integer                                                                                                                                                                  
		...
		lnParametros = pcount()
		lxParam1 = tcletra
		lxParam2 = tctipocomprobante
		lxParam3 = tcfuncionalidades
	...
	*-----------------------------------------------------------------------------------------
	function obtenertextoconporcentajesdeivadelcomprobante( tnporcentajedelimpuesto as number ) as string                                                                                                                                                     
		...
		lnParametros = pcount()
		lxParam1 = tnporcentajedelimpuesto
		...
		return this.ObtenerResultado( 'Obtenertextoconporcentajesdeivadelcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function opuntosdeventa_access() as variant                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Opuntosdeventa_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function permitemodificarsituacionfiscaldelcliente( tnsituacionfiscalcomprobante, tnsituacionfiscalcliente ) as boolean                                                                                                                                   
		...
		lnParametros = pcount()
		lxParam1 = tnsituacionfiscalcomprobante
		lxParam2 = tnsituacionfiscalcliente
	...
	*-----------------------------------------------------------------------------------------
	function preprocesar() as boolean                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Preprocesar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function preprocesaritem( tcatributo as string, toitem as object ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Preprocesaritem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function recalcularimpuestos( todetallecomprobante as detalle of detalle.prg,  todetalleimpuestos as detalle of detalle.prg ) as void                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = todetallecomprobante
		lxParam2 = todetalleimpuestos
		...
		return this.ObtenerResultado( 'Recalcularimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recalcularmontoscondescuentosyrecargos( todetalleimpuestos as object ) as void                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Recalcularmontoscondescuentosyrecargos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function reimprimircomprobantes() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Reimprimircomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function renumerarnroitemdetalleimpuestos( todetalleimpuestos as object ) as void                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Renumerarnroitemdetalleimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearcodigocliente( tccodigo as string ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setearcodigocliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearfechadecomprobante( tdfecha as date ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setearfechadecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearparametropuntodeventa( tnpuntodeventa as integer ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearparametropuntodeventa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearsituacionfiscalcliente( tnsituacionfiscalcliente as number ) as void                                                                                                                                                                       
		...
		lnParametros = pcount()
		lxParam1 = tnsituacionfiscalcliente
		...
		return this.ObtenerResultado( 'Setearsituacionfiscalcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seteartipoconveniocliente( tntipoconvenio as integer )                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Seteartipoconveniocliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcantidaddepercepciones( tncantidad as integer ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarcantidaddepercepciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarclienteparacomprobantefiscal( tocliente as object, tntotalcomprobante as number ) as boolean                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarclienteparacomprobantefiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechacomprobantefiscal( tdfecha as date ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarfechacomprobantefiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaritemsdetallearticulos( todetalle as din_detallefacturafacturadetalle of din_detallefacturafacturadetalle.prg ) as boolean                                                                                                                 
		...
		return this.ObtenerResultado( 'Validaritemsdetallearticulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarsituacionfiscalcliente( tnsitfiscal as integer ) as boolean                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validarsituacionfiscalcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartotalcomprobantepersonalizado( tntotal as float, tcsimbolomonetariocomprobante as string ) as boolean                                                                                                                                     
		...
		lnParametros = pcount()
		lxParam1 = tntotal
		lxParam2 = tcsimbolomonetariocomprobante
		...
		return this.ObtenerResultado( 'Validartotalcomprobantepersonalizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartotalcomprobantesinpersonalizar( tntotal as float, tcsimbolomonetariocomprobante as string, tlsolohayvalorestarjetaopagoelectronico as boolean ) as boolean                                                                               
		...
		lxParam1 = tntotal
		lxParam2 = tcsimbolomonetariocomprobante
		lxParam3 = tlsolohayvalorestarjetaopagoelectronico
	...
	*-----------------------------------------------------------------------------------------
	function verificarestadocf() as boolean                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarestadocf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarsituacionfiscaldeclientecoherenteconletra( tnsituacionfiscalcliente as integer, tcletra as string ) as boolean                                                                                                                          
		...
		return this.ObtenerResultado( 'Verificarsituacionfiscaldeclientecoherenteconletra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregaritemencolecciondeimpuestos( tnnroitem as integer, tnporcentajeiva as float, tnimporteiva as float, tnimporte as float, tnimpuestointerno as float, tnpercepcionivarg5329 as integer ) as void                                   
		...
		lnParametros = pcount()
		lxParam1 = tnnroitem
		lxParam2 = tnporcentajeiva
		lxParam3 = tnimporteiva
		lxParam4 = tnimporte
		lxParam5 = tnimpuestointerno
		lxParam6 = tnpercepcionivarg5329
		...
		return this.ObtenerResultado( 'Agregaritemencolecciondeimpuestos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function agregarlineaadicionalparaitemsenia( tolineasadicionales as zoocoleccion of zoocoleccion.prg ) as zoocoleccion of zoocoleccion.prg                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tolineasadicionales
		...
		return this.ObtenerResultado( 'Agregarlineaadicionalparaitemsenia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function asignarmontointernoenitem( toitem as din_facturaitemfacturadetalle of din_facturaitemfacturadetalle.prg ) as void                                                                                                                      
		...
		return this.ObtenerResultado( 'Asignarmontointernoenitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function asignarmontosdeimpuestos( toitem as object ) as void                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Asignarmontosdeimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function calculaimpuestosinternos() as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Calculaimpuestosinternos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function calcularimpuestos( toitem as object, todetalleimpuestos as object ) as void                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Calcularimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function calculariva() as float                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Calculariva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function calcularivaoriginal() as float                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Calcularivaoriginal', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargararticulos( todatosimpresion as object ) void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cargararticulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esarticulogravado( toitem as object ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Esarticulogravado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function escargamanualdeprecio( toitem as object ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Escargamanualdeprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function limpiarcoleccion( todetalle as collection, tcatributo as string ) as void                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Limpiarcoleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoeficientenetogravadoiva() as number                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercoeficientenetogravadoiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoeficienteparaaplicaciondepercepcionesiva() as number                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercoeficienteparaaplicaciondepercepcionesiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomponenteimpuestos() as object                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercomponenteimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercondiciondeivadelarticulo( toitem as object ) as integer                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercondiciondeivadelarticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerdescripcionjurisdiccion( tccodigojurisdiccion as integer ) as string                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tccodigojurisdiccion
		...
		return this.ObtenerResultado( 'Obtenerdescripcionjurisdiccion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obteneritemdepercepcion() as object                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obteneritemdepercepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermontoimpuestointerno( toitem as din_facturaitemfacturadetalle of din_facturaitemfacturadetalle.prg ) as double                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenermontoimpuestointerno', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerparametrodehabilitaciondeimpresion() as integer                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerparametrodehabilitaciondeimpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerporcentajedeivadelarticulo( toitem as object ) as number                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerporcentajedeivadelarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerporcentajeiva( toitem as object ) as float                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerporcentajeiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerprecio( toitem as object ) as number                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerpreciodeitemrelacionadoasenia( toitem as object ) as number                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerpreciodeitemrelacionadoasenia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenertasaefectiva( toitem as din_facturaitemfacturadetalle of din_facturaitemfacturadetalle.prg  ) as float                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertasaefectiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function restarimpuestos() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Restarimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearimportesinimpuestos( toitem as object ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setearimportesinimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearmontolimitecomprobante() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearmontolimitecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearmontosimpuestos() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearmontosimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearparametropuntodeventaelectronicaexportacion( tnpuntodeventa as integer ) as void                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearparametropuntodeventaelectronicaexportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearparametropuntodeventaelectronicanacional( tnpuntodeventa as integer ) as void                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setearparametropuntodeventaelectronicanacional', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearparametropuntodeventaelectronicauruguay( tnpuntodeventa as integer ) as void                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setearparametropuntodeventaelectronicauruguay', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearparametropuntodeventalocal( tnpuntodeventa as integer ) as void                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setearparametropuntodeventalocal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearporcentajedeimpuestos( toitem as object ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setearporcentajedeimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearporcentajeiva( toitem as object ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearporcentajeiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearprecio( toitem as object ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setearprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearprecios( toitem as object ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setearprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function seteartasaefectiva(toitem as din_facturaitemfacturadetalle of din_facturaitemfacturadetalle.prg) as void                                                                                                                               
		...
		return this.ObtenerResultado( 'Seteartasaefectiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function totalimpuestos() as double                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Totalimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function vaciarcolecciondeimpuestos() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Vaciarcolecciondeimpuestos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarcontroladorpaginacompleta() as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcontroladorpaginacompleta', lcParametros )
	EndFunc
