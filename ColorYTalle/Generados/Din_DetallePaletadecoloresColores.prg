...
define class Din_DetallePALETADECOLORESColores as detalle of detalle.prg


	cAtributosUnicidad = 'Color_PK'
	nCantidadItems = 999
	cNombre = 'Colores'
	cEtiqueta = 'Colores'
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemPALETADECOLORESColores' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		scan for &lcFiltro
			...
			loItem.Codigo = c_Colores.Codigo
			loItem.NROITEM = c_Colores.NROITEM
			loItem.Color_PK = c_Colores.Color
			loItem.ColorDetalle = c_Colores.ColorDetalle
			loItem.OrdenVisual = c_Colores.OrdenVisual
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarExistenciaCamposFijosItemPlano( tnItem as integer ) as Boolean
		...
		if  empty( this.item[ tnItem ].Color_PK ) 
			llRetorno = .F.
		endif 
		return llRetorno
