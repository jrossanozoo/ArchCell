...
define class Din_EntidadMotivodescuentoydevolucion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Motivodescuentoydevolucion"
	cClaseResponse = this.cNamespaceDTOs + ".MotivodescuentoydevolucionResponse"
	cClaseModelo = "MotivodescuentoydevolucionModelo"
	cEntidad = "Motivodescuentoydevolucion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescuentoydevolucionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescuentoydevolucionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescuentoydevolucionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "MotivodescuentoydevolucionModelo"
		endcase
		return lcRetorno
