...
define class Mock_Detalleajustedeestadosstockafectadoauditoriacomb as MockBase of MockBase.prg

	cClase = 'Detalleajustedeestadosstockafectadoauditoriacomb'
	...
	*-----------------------------------------------------------------------------------------
	function cargardetalle( tocombinaciones as object, toatributoscombinacion as object ) as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tocombinaciones
		lxParam2 = toatributoscombinacion
		...
		return this.ObtenerResultado( 'Cargardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripcion( tccampos as string, tctabla as string, tccampocodigo as string, tccodigo as string ) as string                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
	...
	*-----------------------------------------------------------------------------------------
	function omodificaciondetalle_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Omodificaciondetalle_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function asignarcombinacionalitem( tocombinaciones as object, toatributoscombinacion as object , tnnroitem as integer, toitemdetalle as object ) as void                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Asignarcombinacionalitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existeatributoenitem( toitemdetalle as object, tcatributo as string ) as boolean                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Existeatributoenitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdetallemodificacion( toitem as object ) as string                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerdetallemodificacion', lcParametros )
	EndFunc
