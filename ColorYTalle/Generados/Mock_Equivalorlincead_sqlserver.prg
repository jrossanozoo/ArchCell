...
define class Mock_Equivalorlincead_sqlserver as MockBase of MockBase.prg

	cClase = 'Equivalorlincead_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detequilince( tctablatrabajo ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detequilince', lcParametros )
	EndFunc
