...
define class Mock_Comisionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Comisionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubcom( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubcom', lcParametros )
	EndFunc
