...
define class Mock_selecciondespacho as MockBase of MockBase.prg
	...
	Codigo = ""                                                                                                                                                                                                                                               
	DetalleArticulosDespachos = null                                                                                                                                                                                                                          
	ESTADOTRANSFERENCIA = ""                                                                                                                                                                                                                                  
	FECHAALTAFW = ctod( '  /  /    ' )                                                                                                                                                                                                                        
	FECHAEXPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	FECHAIMPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Selección de despacho de importación"                                                                                                                                                                                                    
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'SELECCIONDESPACHO'                                                                                                                                                                                                                             
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lHabilitarDetalleArticulosDespachos = .T.                                                                                                                                                                                                                 
	...
	*-----------------------------------------------------------------------------------------
	function armarcadena() as string                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Armarcadena', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallearticulosdespachos() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallearticulosdespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detallearticulosdespachos_access() as variant                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDESPACHO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallearticulosdespachos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallearticulosdespachos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallearticulosdespachos ) = 'O' or isnull( this.Detallearticulosdespachos ) )			this.Detallearticulosdespachos = this.crearobjeto( 'Din_DetalleSelecciondespachoDetallearticulosdespachos' )			this.Detallearticulosdespachos.inicializar()			this.enlazar( 'Detallearticulosdespachos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallearticulosdespachos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallearticulosdespachos, 'CambioSumarizado', this, 'CambiosDetalleDetallearticulosdespachos', 1)			this.enlazar( 'Detallearticulosdespachos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallearticulosdespachos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detallearticulosdespachos
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoasignardespachos( tcdespachos as string ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcdespachos
		...
		return this.ObtenerResultado( 'Eventoasignardespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohayarticulosparaasignardespachos( tlvalor as boolean ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventohayarticulosparaasignardespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarsitruncadespachos( tcdespachos as string ) as integer                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventopreguntarsitruncadespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lanzarselectordedespachos() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Lanzarselectordedespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitardetallearticulosdespachos_assign( txval as variant ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDESPACHO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetallearticulosdespachos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetallearticulosdespachos_assign', lcParametros )			endif		endif		this.lHabilitarDetalleArticulosDespachos = txVal		this.DetalleArticulosDespachos.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenarcadenadespachos() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Llenarcadenadespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function relleno_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDESPACHO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'relleno_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'relleno_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Relleno		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Relleno( lxVal )				this.Setear_Relleno( lxVal )			EndIf		Else			This.Setear_Relleno( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_relleno( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDESPACHO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_relleno', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_relleno', lcParametros )			endif		endif		this.Relleno = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_relleno( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SELECCIONDESPACHO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_relleno', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_relleno', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarantesdecontinuar() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarantesdecontinuar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregararticulo( toitem as itemarticuloimportado of ent_despachodeimportacion.prg ) as void                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregararticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargararticuloscondespacho() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargararticuloscondespacho', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function truncardespachos( tcdespachos ) as string                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Truncardespachos', lcParametros )
	EndFunc
