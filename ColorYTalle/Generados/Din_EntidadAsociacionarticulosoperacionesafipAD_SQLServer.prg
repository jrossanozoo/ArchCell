	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Aonum" as "Numero", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Aoint" as "Codint", "Aoart" as "Articulo", "Aoven" as "Operacionventa", "Aocom" as "Operacioncompra", "Aoobs" as "Obs" from ORGANIZACION.ARTIOPER where  funciones.padr( AOART, 15, ' ' ) + funciones.padr( AOVEN, 2, ' ' ) + funciones.padr( AOCOM, 2, ' ' ) + funciones.padr( AOINT, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ARTIOPER.AOINT != '' order by AOART,AOVEN,AOCOM,AOINT
			endtext
			use in select('c_ASOCIACIONARTICULOSOPERACIONESAFIP')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ASOCIACIONARTICULOSOPERACIONESAFIP', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Aonum" as "Numero", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Aoint" as "Codint", "Aoart" as "Articulo", "Aoven" as "Operacionventa", "Aocom" as "Operacioncompra", "Aoobs" as "Obs" from ORGANIZACION.ARTIOPER where  funciones.padr( AOART, 15, ' ' ) + funciones.padr( AOVEN, 2, ' ' ) + funciones.padr( AOCOM, 2, ' ' ) + funciones.padr( AOINT, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ARTIOPER.AOINT != '' order by AOART desc,AOVEN desc,AOCOM desc,AOINT desc
			endtext
			use in select('c_ASOCIACIONARTICULOSOPERACIONESAFIP')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ASOCIACIONARTICULOSOPERACIONESAFIP', set( 'Datasession' ) )
			Endwith
...
<VFPData xml:space="preserve">
	...
	<row entidad="ASOCIACIONARTICULOSOPERACIONESAFIP      " atributo="FECHATRANSFERENCIA                      " tabla="ARTIOPER       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ASOCIACIONARTICULOSOPERACIONESAFIP      " atributo="ESTADOTRANSFERENCIA                     " tabla="ARTIOPER       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ASOCIACIONARTICULOSOPERACIONESAFIP      " atributo="ARTICULO                                " tabla="ARTIOPER       " campo="AOART     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="4" etiqueta="Artículo                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
