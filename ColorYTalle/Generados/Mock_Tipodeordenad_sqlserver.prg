...
define class Mock_Tipodeordenad_sqlserver as MockBase of MockBase.prg

	cClase = 'Tipodeordenad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubtdo( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubtdo', lcParametros )
	EndFunc
