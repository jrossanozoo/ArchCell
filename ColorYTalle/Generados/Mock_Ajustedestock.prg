...
define class Mock_ajustedestock as MockBase of MockBase.prg
	...
	cAtributoVendedor = ''                                                                                                                                                                                                                                    
	cCampoArticulo = ""                                                                                                                                                                                                                                       
	cCampoCantidadArticulo = ""                                                                                                                                                                                                                               
	cCampoCantidadCombincacion = ""                                                                                                                                                                                                                           
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	...
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	cTablaAuditoriaStockArticulos = ""                                                                                                                                                                                                                        
	cTablaAuditoriaStockCombinacion = ""                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallestockafectadoarticulo() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Cambiosdetallestockafectadoarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallestockafectadoauditoriaart() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cambiosdetallestockafectadoauditoriaart', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallestockafectadoauditoriaentransito() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cambiosdetallestockafectadoauditoriaentransito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallestockafectadoentransito() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cambiosdetallestockafectadoentransito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardetalles( tofiltros as object ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function eventofechainvalida()                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Eventofechainvalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomostrarmensajealrepararcombinaciones( tcmensaje as string ) as void                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventomostrarmensajealrepararcombinaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdetallestock() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerdetallestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfiltrofechas() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfiltrofechas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarstock( tnsigno as integer ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarstockentransito( tnsigno as integer ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Ajustarstockentransito', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function completarcamposcombinacion( tccursor as string ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposatributoscombinacion(  tccursorcombinacion as string, tlconcatenar as boolean ) as string                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccursorcombinacion
		lxParam2 = tlconcatenar
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposcombinacion(  tccursorcombinacion as string ) as string                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposcombinacionconalias(  tccursorcombinacion as string ) as string                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercamposcombinacionconalias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomparacionatributoscombinacion(  tccursorcombinacion as string, tccursorstockseguncomprobantes as string ) as string                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccursorcombinacion
		lxParam2 = tccursorstockseguncomprobantes
		...
		return this.ObtenerResultado( 'Obtenercomparacionatributoscombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursorstockentidad( tccursor as string, tcentidad as string, tlinformarcantidadregistros as boolean ) as void                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		lxParam1 = tccursor
		lxParam2 = tcentidad
		lxParam3 = tlinformarcantidadregistros
		...
		return this.ObtenerResultado( 'Obtenercursorstockentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerstocksegunseguimiento( tccursor as string, tofiltros as object ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerstocksegunseguimiento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function procesarauditoriacombinaciones( tccursorstockseguncomprobantes as string ) as void                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tccursorstockseguncomprobantes
		...
		return this.ObtenerResultado( 'Procesarauditoriacombinaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function procesarauditoriaentransitocombinaciones( tccursorstockseguncomprobantes as string ) as void                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Procesarauditoriaentransitocombinaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function procesarcombinaciones( tccursorcombinacion as string, tccursorstockseguncomprobantes as string ) as void                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	protected function procesardatos( tccursorcombinacion as string, tccursorstockseguncomprobantes as string ) as void                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Procesardatos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function procesarentransitocombinaciones( tccursorcombinacion as string, tccursorstockseguncomprobantes as string ) as void                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Procesarentransitocombinaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function repararinconsistenciasencombinaciones() as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Repararinconsistenciasencombinaciones', lcParametros )
	EndFunc
