...
define class Mock_Itemnotadedebitoelectronicadecreditoimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadedebitoelectronicadecreditoimpuestosdetalle'
