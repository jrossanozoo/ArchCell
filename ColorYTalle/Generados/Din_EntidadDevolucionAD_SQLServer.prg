	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Informnube","Fd2","Fecexpo","Fecimpo","Fectrans","Fmodifw","Datosecomm","Fpodes1","Mr","Fpodes2","Recpor","Fletra","Fperson","Fturno","Cotiz","Descfw","Fhora","Horaimpo","Horaexpo","Haltafw","Faltafw","Hmodifw","Bdaltafw","Zadsfw","Vmodifw","Umodifw","Smodifw","Simbmon","Saltafw","Bdmodifw","Esttrans","Valtafw","Ualtafw","Timestamp","Mr2","Factsec","Totalcant","Recmnto1","Fsubton","Recmnto2","Recmntosi1","Recmntosi","Recmnto","Condivalp","Facttipo","Subtotcisi","Subtotsisi","Recmntosi2","Desmntosi","Mdcimpu","Fajxre","Sitfisccli","Signomov","Desmntosi3","Desmntosi2","Fsubtot","Desmntosi1","Fcompfis","Origonline","Desauto","Anulado","Monsis","Moneda","Fobs","Fcuit","Md2","Md1","Fptoven","Fcliente","Fmtdes2","Fmtdes1","Codigo","Fnumcomp","Fmtdes3","Fven","Totdescsi","Tdci","Codlista","Motivo","Ffch","Remito","Ftotal","Fpodes","Fdescu","Md3","Mr1","Percepcion","Gravamen","Fimpuesto","Trci","Totrecarsi","Totrecar","Totdesc","Totimpue","Ivasis" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'" >>, <<lxComprobantevFpodes1 >>, <<lxComprobantevMr >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevRecpor >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<lxComprobantevCotiz >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<lxComprobantevTimestamp >>, <<lxComprobantevMr2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevTotalcant >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevFsubton >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmnto >>, <<lxComprobantevCondivalp >>, <<lxComprobantevFacttipo >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevFajxre >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevSignomov >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevFsubtot >>, <<lxComprobantevDesmntosi1 >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevOrigonline, 1, 0 ) >>, <<iif( lxComprobantevDesauto, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevMd2 >>, <<lxComprobantevMd1 >>, <<lxComprobantevFptoven >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFmtdes2 >>, <<lxComprobantevFmtdes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFmtdes3 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<lxComprobantevTotdescsi >>, <<lxComprobantevTdci >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotivo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevRemito ) + "'" >>, <<lxComprobantevFtotal >>, <<lxComprobantevFpodes >>, <<lxComprobantevFdescu >>, <<lxComprobantevMd3 >>, <<lxComprobantevMr1 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTrci >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<lxComprobantevIvasis >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Informnube" = <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Datosecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'">>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Mr" = <<lxComprobantevMr>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Recpor" = <<lxComprobantevRecpor>>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Cotiz" = <<lxComprobantevCotiz>>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Timestamp" = <<lxComprobantevTimestamp>>,"Mr2" = <<lxComprobantevMr2>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Totalcant" = <<lxComprobantevTotalcant>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Fsubton" = <<lxComprobantevFsubton>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Fajxre" = <<lxComprobantevFajxre>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Signomov" = <<lxComprobantevSignomov>>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Origonline" = <<iif( lxComprobantevOrigonline, 1, 0 )>>,"Desauto" = <<iif( lxComprobantevDesauto, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Md2" = <<lxComprobantevMd2>>,"Md1" = <<lxComprobantevMd1>>,"Fptoven" = <<lxComprobantevFptoven>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Tdci" = <<lxComprobantevTdci>>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Motivo" = <<"'" + this.FormatearTextoSql( lxComprobantevMotivo ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Remito" = <<"'" + this.FormatearTextoSql( lxComprobantevRemito ) + "'">>,"Ftotal" = <<lxComprobantevFtotal>>,"Fpodes" = <<lxComprobantevFpodes>>,"Fdescu" = <<lxComprobantevFdescu>>,"Md3" = <<lxComprobantevMd3>>,"Mr1" = <<lxComprobantevMr1>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Trci" = <<lxComprobantevTrci>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Totrecar" = <<lxComprobantevTotrecar>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Ivasis" = <<lxComprobantevIvasis>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 12 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Informnube" as "Fueinformadoalanube", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Fpodes2" as "Porcentajedescuento2", "Recpor" as "Recargoporcentaje", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Descfw" as "Descripcionfw", "Fhora" as "Hora", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Faltafw" as "Fechaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Recmnto1" as "Recargomontoconimpuestos1", "Fsubton" as "Subtotalneto", "Recmnto2" as "Recargomontoconimpuestos2", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto" as "Recargomontoconimpuestos", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Sitfisccli" as "Situacionfiscal", "Signomov" as "Signodemovimiento", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md2" as "Montodescuento2", "Md1" as "Montodescuento1", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Codlista" as "Listadeprecios", "Motivo" as "Motivo", "Ffch" as "Fecha", "Remito" as "Remito", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 12
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Base" as "Basedecalculo", "Codimp" as "Codigoimpuesto", "Codint" as "Codigointerno", "Tipoi" as "Tipoimpuesto", "Sirecs" as "Codseguridadsire", "Descri" as "Descripcion", "Regimenimp" as "Regimenimpositivo", "Sirecert" as "Certificadosire", "Minimoper" as "Minimo", "Minoimp" as "Minimonoimponible", "Montobase" as "Montobase", "Nroitem" as "Nroitem", "Porcen" as "Porcentaje", "Monto" as "Monto", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_DEVOLUCION.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Informnube" as "Fueinformadoalanube", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Fpodes2" as "Porcentajedescuento2", "Recpor" as "Recargoporcentaje", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Descfw" as "Descripcionfw", "Fhora" as "Hora", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Faltafw" as "Fechaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Recmnto1" as "Recargomontoconimpuestos1", "Fsubton" as "Subtotalneto", "Recmnto2" as "Recargomontoconimpuestos2", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto" as "Recargomontoconimpuestos", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Sitfisccli" as "Situacionfiscal", "Signomov" as "Signodemovimiento", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md2" as "Montodescuento2", "Md1" as "Montodescuento1", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Codlista" as "Listadeprecios", "Motivo" as "Motivo", "Ffch" as "Fecha", "Remito" as "Remito", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 12 And FACTTIPO = <<lxComprobanteVFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxComprobanteVFLETRA ) + "'">> and FPTOVEN = <<lxComprobanteVFPTOVEN>> and FNUMCOMP = <<lxComprobanteVFNUMCOMP>> and FACTSEC = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFACTSEC ) + "'">>
			endtext
			use in select('c_DEVOLUCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DEVOLUCION', set( 'Datasession' ) )
			if reccount( 'c_DEVOLUCION' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Informnube" as "Fueinformadoalanube", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Fpodes2" as "Porcentajedescuento2", "Recpor" as "Recargoporcentaje", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Descfw" as "Descripcionfw", "Fhora" as "Hora", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Faltafw" as "Fechaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Recmnto1" as "Recargomontoconimpuestos1", "Fsubton" as "Subtotalneto", "Recmnto2" as "Recargomontoconimpuestos2", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto" as "Recargomontoconimpuestos", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Sitfisccli" as "Situacionfiscal", "Signomov" as "Signodemovimiento", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md2" as "Montodescuento2", "Md1" as "Montodescuento1", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Codlista" as "Listadeprecios", "Motivo" as "Motivo", "Ffch" as "Fecha", "Remito" as "Remito", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 12 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_DEVOLUCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DEVOLUCION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Informnube" as "Fueinformadoalanube", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Fpodes2" as "Porcentajedescuento2", "Recpor" as "Recargoporcentaje", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Descfw" as "Descripcionfw", "Fhora" as "Hora", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Faltafw" as "Fechaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Recmnto1" as "Recargomontoconimpuestos1", "Fsubton" as "Subtotalneto", "Recmnto2" as "Recargomontoconimpuestos2", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto" as "Recargomontoconimpuestos", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Sitfisccli" as "Situacionfiscal", "Signomov" as "Signodemovimiento", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md2" as "Montodescuento2", "Md1" as "Montodescuento1", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Codlista" as "Listadeprecios", "Motivo" as "Motivo", "Ffch" as "Fecha", "Remito" as "Remito", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  funciones.dtos( FAltaFW ) + funciones.padr( HAltaFW, 8, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 12 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_DEVOLUCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DEVOLUCION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Informnube,Fd2,Fecexpo,Fecimpo,Fectrans,Fmodifw,Datosecomm,Fpodes1,Mr,Fpodes2,Recpor,Fletra," + ;
"Fperson,Fturno,Cotiz,Descfw,Fhora,Horaimpo,Horaexpo,Haltafw,Faltafw,Hmodifw,Bdaltafw,Zadsfw,Vmodifw," + ;
"Umodifw,Smodifw,Simbmon,Saltafw,Bdmodifw,Esttrans,Valtafw,Ualtafw,Timestamp,Mr2,Factsec,Totalcant,Re" + ;
"cmnto1,Fsubton,Recmnto2,Recmntosi1,Recmntosi,Recmnto,Condivalp,Facttipo,Subtotcisi,Subtotsisi,Recmnt" + ;
"osi2,Desmntosi,Mdcimpu,Fajxre,Sitfisccli,Signomov,Desmntosi3,Desmntosi2,Fsubtot,Desmntosi1,Fcompfis," + ;
"Origonline,Desauto,Anulado,Monsis,Moneda,Fobs,Fcuit,Md2,Md1,Fptoven,Fcliente,Fmtdes2,Fmtdes1,Codigo," + ;
"Fnumcomp,Fmtdes3,Fven,Totdescsi,Tdci,Codlista,Motivo,Ffch,Remito,Ftotal,Fpodes,Fdescu,Md3,Mr1,Percep" + ;
"cion,Gravamen,Fimpuesto,Trci,Totrecarsi,Totrecar,Totdesc,Totimpue,Ivasis" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Informnube" as "Fueinformadoalanube", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Fpodes2" as "Porcentajedescuento2", "Recpor" as "Recargoporcentaje", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Descfw" as "Descripcionfw", "Fhora" as "Hora", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Faltafw" as "Fechaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Recmnto1" as "Recargomontoconimpuestos1", "Fsubton" as "Subtotalneto", "Recmnto2" as "Recargomontoconimpuestos2", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto" as "Recargomontoconimpuestos", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Sitfisccli" as "Situacionfiscal", "Signomov" as "Signodemovimiento", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Desauto" as "Descuentoautomatico", "Anulado" as "Anulado", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md2" as "Montodescuento2", "Md1" as "Montodescuento1", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Codlista" as "Listadeprecios", "Motivo" as "Motivo", "Ffch" as "Fecha", "Remito" as "Remito", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema"
				endtext
			Else
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  InformNube = ] + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, DatosEComm = ] + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'"+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, MR = ] + transform( &lcCursor..MR )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, fTurno = ] + transform( &lcCursor..fTurno )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, OrigOnline = ] + Transform( iif( &lcCursor..OrigOnline, 1, 0 ))+ [, DesAuto = ] + Transform( iif( &lcCursor..DesAuto, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, MOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, REMITO = ] + "'" + this.FormatearTextoSql( &lcCursor..REMITO ) + "'"+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, IvaSis = ] + transform( &lcCursor..IvaSis ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 InformNube, FD2, FECEXPO, FECIMPO, FECTRANS, FMODIFW, DatosEComm, FPODES1, MR, FPODES2, RecPor, FLETRA, FPerson, fTurno, Cotiz, DescFW, FHORA, HORAIMPO, HORAEXPO, HAltaFW, FAltaFW, HMODIFW, BDALTAFW, ZADSFW, VMODIFW, UMODIFW, SMODIFW, SimbMon, SALTAFW, BDMODIFW, ESTTRANS, VALTAFW, UALTAFW, TIMESTAMP, MR2, FACTSEC, TotalCant, RecMnto1, fSubToN, RecMnto2, RecMntoSI1, RecMntoSI, RecMnto, CondivaLp, FACTTIPO, SubTotCISI, SubTotSISI, RecMntoSI2, DesMntoSI, MDCIMPU, FAjXRe, SitFiscCli, signomov, DesMntoSI3, DesMntoSI2, FSubTOT, DesMntoSI1, FCOMPFIS, OrigOnline, DesAuto, Anulado, MonSis, Moneda, FObs, fCuit, MD2, MD1, FPTOVEN, FCLIENTE, FMTDES2, FMTDES1, CODIGO, FNUMCOMP, FMTDES3, FVEN, totdescSI, TDCI, CodLista, MOTIVO, FFCH, REMITO, FTotal, FPODES, fDescu, MD3, MR1, percepcion, gravamen, fImpuesto, TRCI, totrecarSI, totrecar, totdesc, totimpue, IvaSis
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPODES1 ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..RecPor ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..fTurno ) + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..MR2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..TotalCant ) + ',' + transform( &lcCursor..RecMnto1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..RecMntoSI2 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..MDCIMPU ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..OrigOnline, 1, 0 )) + ',' + Transform( iif( &lcCursor..DesAuto, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..MD1 ) + ',' + transform( &lcCursor..FPTOVEN ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..FMTDES2 ) + ',' + transform( &lcCursor..FMTDES1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..FMTDES3 )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + transform( &lcCursor..totdescSI ) + ',' + transform( &lcCursor..TDCI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..REMITO ) + "'" + ',' + transform( &lcCursor..FTotal )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..fDescu ) + ',' + transform( &lcCursor..MD3 ) + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..totdesc )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.INFORMNUBE = isnull( d.INFORMNUBE, t.INFORMNUBE ),t.FD2 = isnull( d.FD2, t.FD2 ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.DATOSECOMM = isnull( d.DATOSECOMM, t.DATOSECOMM ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.MR = isnull( d.MR, t.MR ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.MR2 = isnull( d.MR2, t.MR2 ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.ORIGONLINE = isnull( d.ORIGONLINE, t.ORIGONLINE ),t.DESAUTO = isnull( d.DESAUTO, t.DESAUTO ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.MD2 = isnull( d.MD2, t.MD2 ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.REMITO = isnull( d.REMITO, t.REMITO ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MD3 = isnull( d.MD3, t.MD3 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.IVASIS = isnull( d.IVASIS, t.IVASIS )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Informnube,Fd2,Fecexpo,Fecimpo,Fectrans,Fmodifw,Datosecomm,Fpodes1,Mr,Fpodes2,Recpor,Fletra,Fperson,Fturno,Cotiz,Descfw,Fhora,Horaimpo,Horaexpo,Haltafw,Faltafw,Hmodifw,Bdaltafw,Zadsfw,Vmodifw,Umodifw,Smodifw,Simbmon,Saltafw,Bdmodifw,Esttrans,Valtafw,Ualtafw,Timestamp,Mr2,Factsec,Totalcant,Recmnto1,Fsubton,Recmnto2,Recmntosi1,Recmntosi,Recmnto,Condivalp,Facttipo,Subtotcisi,Subtotsisi,Recmntosi2,Desmntosi,Mdcimpu,Fajxre,Sitfisccli,Signomov,Desmntosi3,Desmntosi2,Fsubtot,Desmntosi1,Fcompfis,Origonline,Desauto,Anulado,Monsis,Moneda,Fobs,Fcuit,Md2,Md1,Fptoven,Fcliente,Fmtdes2,Fmtdes1,Codigo,Fnumcomp,Fmtdes3,Fven,Totdescsi,Tdci,Codlista,Motivo,Ffch,Remito,Ftotal,Fpodes,Fdescu,Md3,Mr1,Percepcion,Gravamen,Fimpuesto,Trci,Totrecarsi,Totrecar,Totdesc,Totimpue,Ivasis)
					Select isnull( d.INFORMNUBE,''),isnull( d.FD2,''),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.DATOSECOMM,''),isnull( d.FPODES1,0),isnull( d.MR,0),isnull( d.FPODES2,0),isnull( d.RECPOR,0),isnull( d.FLETRA,''),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.COTIZ,0),isnull( d.DESCFW,''),isnull( d.FHORA,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.HMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.SIMBMON,''),isnull( d.SALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.TIMESTAMP,0),isnull( d.MR2,0),isnull( d.FACTSEC,''),isnull( d.TOTALCANT,0),isnull( d.RECMNTO1,0),isnull( d.FSUBTON,0),isnull( d.RECMNTO2,0),isnull( d.RECMNTOSI1,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTO,0),isnull( d.CONDIVALP,0),isnull( d.FACTTIPO,0),isnull( d.SUBTOTCISI,0),isnull( d.SUBTOTSISI,0),isnull( d.RECMNTOSI2,0),isnull( d.DESMNTOSI,0),isnull( d.MDCIMPU,0),isnull( d.FAJXRE,0),isnull( d.SITFISCCLI,0),isnull( d.SIGNOMOV,0),isnull( d.DESMNTOSI3,0),isnull( d.DESMNTOSI2,0),isnull( d.FSUBTOT,0),isnull( d.DESMNTOSI1,0),isnull( d.FCOMPFIS,0),isnull( d.ORIGONLINE,0),isnull( d.DESAUTO,0),isnull( d.ANULADO,0),isnull( d.MONSIS,''),isnull( d.MONEDA,''),isnull( d.FOBS,''),isnull( d.FCUIT,''),isnull( d.MD2,0),isnull( d.MD1,0),isnull( d.FPTOVEN,0),isnull( d.FCLIENTE,''),isnull( d.FMTDES2,0),isnull( d.FMTDES1,0),isnull( d.CODIGO,''),isnull( d.FNUMCOMP,0),isnull( d.FMTDES3,0),isnull( d.FVEN,''),isnull( d.TOTDESCSI,0),isnull( d.TDCI,0),isnull( d.CODLISTA,''),isnull( d.MOTIVO,''),isnull( d.FFCH,''),isnull( d.REMITO,''),isnull( d.FTOTAL,0),isnull( d.FPODES,0),isnull( d.FDESCU,0),isnull( d.MD3,0),isnull( d.MR1,0),isnull( d.PERCEPCION,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TRCI,0),isnull( d.TOTRECARSI,0),isnull( d.TOTRECAR,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.IVASIS,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="DEVOLUCION                              " atributo="FECHATRANSFERENCIA                      " tabla="COMPROBANTEV   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="PORCENTAJEDESCUENTO1                    " tabla="COMPROBANTEV   " campo="FPODES1   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje de descuento 1                                                                                                                                                                                                                                 " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="RECARGOMONTO                            " tabla="COMPROBANTEV   " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargo monto                                                                                                                                                                                                                                             " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="PORCENTAJEDESCUENTO2                    " tabla="COMPROBANTEV   " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje de descuento 2                                                                                                                                                                                                                                 " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="RECARGOPORCENTAJE                       " tabla="COMPROBANTEV   " campo="RECPOR    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargo porcentaje                                                                                                                                                                                                                                        " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="HORAALTAFW                              " tabla="COMPROBANTEV   " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="=goservicios.librerias.obtenerHora()                                                                                                                                                                                                                          " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                                                                                                                 " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPROBANTEV   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="TOTALCANTIDAD                           " tabla="COMPROBANTEV   " campo="TOTALCANT " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="14" etiqueta="Total Cantidad                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="RECARGOMONTOCONIMPUESTOS2               " tabla="COMPROBANTEV   " campo="RECMNTO2  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargo monto con impuestos 2                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="RECARGOMONTOCONIMPUESTOS                " tabla="COMPROBANTEV   " campo="RECMNTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargo monto con impuestos                                                                                                                                                                                                                               " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="TIPOCOMPROBANTE                         " tabla="COMPROBANTEV   " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=12                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="16" etiqueta="Tipo de comprobante                                                                                                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="COMPROBANTEV   " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="MONTODESCUENTOCONIMPUESTOS              " tabla="COMPROBANTEV   " campo="MDCIMPU   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto descuento con impuestos                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="SITUACIONFISCAL                         " tabla="COMPROBANTEV   " campo="SITFISCCLI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SITUACIONFISCAL                         " tipodato="N         " longitud="2" decimales="0" valorsugerido="=3                                                                                                                                                                                                                                                            " obligatorio="false" admitebusqueda="0" etiqueta="Situación fiscal                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="SUBTOTALBRUTO                           " tabla="COMPROBANTEV   " campo="FSUBTOT   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Subtotal bruto                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="MONEDASISTEMA                           " tabla="COMPROBANTEV   " campo="MONSIS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Moneda Sistema                                                                                                                                                                                                                                            " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Moneda Comprobante                                                                                                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="MONTODESCUENTOCONIMPUESTOS2             " tabla="COMPROBANTEV   " campo="FMTDES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto cescuento con impuestos 2                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="1" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="TOTALDESCUENTOSCONIMPUESTOS             " tabla="COMPROBANTEV   " campo="TDCI      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuentos con impuestos                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="25" orden="3" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="MOTIVO                                  " tabla="COMPROBANTEV   " campo="MOTIVO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MOTIVO                                  " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Motivo                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="REMITO                                  " tabla="COMPROBANTEV   " campo="REMITO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="18" etiqueta="Remito                                                                                                                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="A 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                                                                                                                     " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="2" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="PORCENTAJEDESCUENTO                     " tabla="COMPROBANTEV   " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Porcentaje descuento                                                                                                                                                                                                                                      " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="DESCUENTO                               " tabla="COMPROBANTEV   " campo="FDESCU    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="% Des.                                                                                                                                                                                                                                                    " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="MONTODESCUENTO3                         " tabla="COMPROBANTEV   " campo="MD3       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Monto de descuento                                                                                                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="RECARGOMONTO1                           " tabla="COMPROBANTEV   " campo="MR1       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="17" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Rec. monto 1                                                                                                                                                                                                                                              " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="40" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="RECARGOMONTO1VISUAL                     " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Recargo monto 1                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="40" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="IMPUESTOS                               " tabla="COMPROBANTEV   " campo="FIMPUESTO " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="I.V.A.                                                                                                                                                                                                                                                    " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="TOTALRECARGOSCONIMPUESTOS               " tabla="COMPROBANTEV   " campo="TRCI      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total recargo con impuestos                                                                                                                                                                                                                               " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DEVOLUCION                              " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECAR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total recargo                                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuentos                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="28" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DEVOLUCION                              " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOTIVO                                  " atributo="DESCRIPCION                             " tabla="MOTIVO         " campo="MOTDES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="413" etiqueta="Detalle Mot.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join MOTIVO On COMPROBANTEV.MOTIVO = MOTIVO.MOTCOD And  MOTIVO.MOTCOD != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
