...
define class Mock_Curvadeproduccionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Curvadeproduccionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_crvproddet( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_crvproddet', lcParametros )
	EndFunc
