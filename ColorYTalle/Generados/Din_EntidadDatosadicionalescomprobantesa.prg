...
define class Din_EntidadDATOSADICIONALESCOMPROBANTESA as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarTipoDocumento() as boolean
		...
		if empty( this.TipoDocumento )
			this.AgregarInformacion( 'Debe cargar el campo Tipo documento', 9005, 'TipoDocumento' )
			llRetorno = .F.
		endif
		return llRetorno
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarNroDocumento() as boolean
		...
		if empty( this.NroDocumento )
			this.AgregarInformacion( 'Debe cargar el campo Número documento', 9005, 'NroDocumento' )
			llRetorno = .F.
		endif
		return llRetorno
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<NOIMPO><NOEXPO><SINTOOLBAR><NOREST>'
	Endfunc
