...
define class Mock_Modificaciondecostosdeproduccionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Modificaciondecostosdeproduccionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetallemodcostos( tcatributo as string ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercampodetallemodcostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetallemodcostos( tccampos as string ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetallemodcostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetallemodcostos( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerdatosdetallemodcostos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_modcostprod( tctablatrabajo ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_modcostprod', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetallemodcostos( tccampos as string ) as string                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Parsearcamposdetallemodcostos', lcParametros )
	EndFunc
