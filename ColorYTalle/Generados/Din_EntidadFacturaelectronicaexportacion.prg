...
define class Din_EntidadFACTURAELECTRONICAEXPORTACION as Ent_ComprobanteElectronicoExportacion of Ent_ComprobanteElectronicoExportacion.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><VENTAS><WEBHOOK><CONVALORES><FISCAL><CE><NOLISTAGENERICO><PICKING><INTERVINIENTE><VALIDACENTRALIZADOR><VALORCIERRE><DESCUENTOAUTOMATICO><ACTUALIZAEMAILCLIENTE><LISTARMODIFICACION>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as Void
		...
		this.lWHIngresar = goServicios.WebHook.TieneQueMandar( 'FACTURAELECTRONICAEXPORTACION', 'INGRESAR' )
		this.lWHModificar = goServicios.WebHook.TieneQueMandar( 'FACTURAELECTRONICAEXPORTACION', 'MODIFICAR' )
		this.lWHEliminar = goServicios.WebHook.TieneQueMandar( 'FACTURAELECTRONICAEXPORTACION', 'ELIMINAR' )
	endfunc
		...
		with this
			...
			Catch to loError
				...
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					...
					loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Cliente para la entidad Factura electrónica exportación de venta." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
