...
define class Mock_Paisesad_sqlserver as MockBase of MockBase.prg

	cClase = 'Paisesad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubpai( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubpai', lcParametros )
	EndFunc
