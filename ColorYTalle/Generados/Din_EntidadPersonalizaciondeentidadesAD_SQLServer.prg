	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.PERENT ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Saltafw","Horaimpo","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Horaexpo","Haltafw","Bdaltafw","Bdmodifw","Esttrans","Denplu","Ocultar","Codigo","Densin","Ent","Dencor","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxPerentFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerentFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerentFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerentFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerentFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentDenplu ) + "'" >>, <<iif( lxPerentOcultar, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxPerentCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentDensin ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentEnt ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentDencor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerentObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.PERENT set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxPerentFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxPerentFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxPerentFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxPerentFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxPerentFecimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxPerentSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxPerentHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxPerentHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxPerentSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxPerentUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxPerentUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxPerentZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxPerentValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxPerentVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxPerentHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxPerentHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPerentBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPerentBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxPerentEsttrans ) + "'">>,"Denplu" = <<"'" + this.FormatearTextoSql( lxPerentDenplu ) + "'">>,"Ocultar" = <<iif( lxPerentOcultar, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxPerentCodigo ) + "'">>,"Densin" = <<"'" + this.FormatearTextoSql( lxPerentDensin ) + "'">>,"Ent" = <<"'" + this.FormatearTextoSql( lxPerentEnt ) + "'">>,"Dencor" = <<"'" + this.FormatearTextoSql( lxPerentDencor ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxPerentObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxPerentCodigo ) + "'">> and  PERENT.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
...
"dsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdaltafw,Bdmodifw,Esttrans,Denplu,Ocultar,Codigo,Densin,Ent,De" + ;
"ncor,Obs" + ;
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			...
			Do Case
				...
				Case lcAtributo == 'DENOMINACIONPLURAL'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'DENPLU AS DENOMINACIONPLURAL'
				...
				Case lcAtributo == 'DENOMINACIONSINGULAR'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'DENSIN AS DENOMINACIONSINGULAR'
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.PERENT set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxPerentFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxPerentFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxPerentFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxPerentFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxPerentFecimpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxPerentSaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxPerentHoraimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxPerentHmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxPerentSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxPerentUmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxPerentUaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxPerentZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxPerentValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxPerentVmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxPerentHoraexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxPerentHaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPerentBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPerentBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxPerentEsttrans ) + "'">>, "Denplu" = <<"'" + this.FormatearTextoSql( lxPerentDenplu ) + "'">>, "Ocultar" = <<iif( lxPerentOcultar, 1, 0 )>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxPerentCodigo ) + "'">>, "Densin" = <<"'" + this.FormatearTextoSql( lxPerentDensin ) + "'">>, "Ent" = <<"'" + this.FormatearTextoSql( lxPerentEnt ) + "'">>, "Dencor" = <<"'" + this.FormatearTextoSql( lxPerentDencor ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxPerentObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'PERENT' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.PERENT set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, DenPlu = ] + "'" + this.FormatearTextoSql( &lcCursor..DenPlu ) + "'"+ [, Ocultar = ] + Transform( iif( &lcCursor..Ocultar, 1, 0 ))+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, DenSin = ] + "'" + this.FormatearTextoSql( &lcCursor..DenSin ) + "'"+ [, Ent = ] + "'" + this.FormatearTextoSql( &lcCursor..Ent ) + "'"+ [, DenCor = ] + "'" + this.FormatearTextoSql( &lcCursor..DenCor ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, SALTAFW, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HORAEXPO, HALTAFW, BDALTAFW, BDMODIFW, ESTTRANS, DenPlu, Ocultar, Codigo, DenSin, Ent, DenCor, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DenPlu ) + "'" + ',' + Transform( iif( &lcCursor..Ocultar, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.DENPLU = isnull( d.DENPLU, t.DENPLU ),t.OCULTAR = isnull( d.OCULTAR, t.OCULTAR ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DENSIN = isnull( d.DENSIN, t.DENSIN ),t.ENT = isnull( d.ENT, t.ENT ),t.DENCOR = isnull( d.DENCOR, t.DENCOR ),t.OBS = isnull( d.OBS, t.OBS )
					from ORGANIZACION.PERENT t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ORGANIZACION.PERENT(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdaltafw,Bdmodifw,Esttrans,Denplu,Ocultar,Codigo,Densin,Ent,Dencor,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.DENPLU,''),isnull( d.OCULTAR,0),isnull( d.CODIGO,''),isnull( d.DENSIN,''),isnull( d.ENT,''),isnull( d.DENCOR,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="PERSONALIZACIONDEENTIDADES              " atributo="FECHATRANSFERENCIA                      " tabla="PERENT         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PERSONALIZACIONDEENTIDADES              " atributo="ESTADOTRANSFERENCIA                     " tabla="PERENT         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PERSONALIZACIONDEENTIDADES              " atributo="DENOMINACIONPLURAL                      " tabla="PERENT         " campo="DENPLU    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="1" etiqueta="Plural                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PERSONALIZACIONDEENTIDADES              " atributo="DENOMINACIONSINGULAR                    " tabla="PERENT         " campo="DENSIN    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="1" etiqueta="Singular                                                                                                                                                        " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
