...
define class Din_DetalleTIQUETDECAMBIODetallecomprobante as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemTIQUETDECAMBIODetallecomprobante' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Detallecomprobante
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Detallecomprobante.Codigo
			loItem.Articulo_PK = c_Detallecomprobante.Articulo
			loItem.ArticuloDetalle = c_Detallecomprobante.ArticuloDetalle
			loItem.Color_PK = c_Detallecomprobante.Color
			loItem.ColorDetalle = c_Detallecomprobante.ColorDetalle
			loItem.Talle_PK = c_Detallecomprobante.Talle
			loItem.TalleDetalle = c_Detallecomprobante.TalleDetalle
			loItem.Cantidad = c_Detallecomprobante.Cantidad
			loItem.Comportamiento = c_Detallecomprobante.Comportamiento
			loItem.NroItem = c_Detallecomprobante.NroItem
			loItem.NroItem = lnI 
