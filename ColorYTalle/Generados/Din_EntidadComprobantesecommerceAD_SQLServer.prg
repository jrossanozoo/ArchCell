...
define class Din_EntidadCOMPROBANTESECOMMERCEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCompecomFecexpo, lxCompecomFectrans, lxCompecomFecimpo, lxCompecomFaltafw, lxCompecomFmodifw, lxCompecomNumero, lxCompecomSaltafw, lxCompecomSmodifw, lxCompecomUmodifw, lxCompecomUaltafw, lxCompecomZadsfw, lxCompecomValtafw, lxCompecomVmodifw, lxCompecomHmodifw, lxCompecomHaltafw, lxCompecomHoraimpo, lxCompecomHoraexpo, lxCompecomBdaltafw, lxCompecomBdmodifw, lxCompecomEsttrans, lxCompecomPendiente, lxCompecomEcommerce, lxCompecomFecha, lxCompecomObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPECOM ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Numero","Saltafw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Hmodifw","Haltafw","Horaimpo","Horaexpo","Bdaltafw","Bdmodifw","Esttrans","Pendiente","Ecommerce","Fecha","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxCompecomFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompecomFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompecomFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompecomFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompecomFmodifw ) + "'" >>, <<lxCompecomNumero >>, <<"'" + this.FormatearTextoSql( lxCompecomSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomEsttrans ) + "'" >>, <<iif( lxCompecomPendiente, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxCompecomEcommerce ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompecomFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompecomObs ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.DetalleOperaciones
				if this.oEntidad.DetalleOperaciones.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ECCOMPDET("NROITEM","NUMERO","OPENUM","CANT","MONTO","CLIEDSC","CLIENTE","CLIDRAGON","ENVIO","FULLENVIOS","CANCELADA","TIPOCOMP","NOMBRE","PAGADO","OPECOD","PLATA","BUZON","BDATOS","NROCOMP","USAOTRABD","ORIGENST","NROCOMPAFE" ) values ( <<lxNroitem>>, <<transform( lxValorClavePrimaria )>>, <<"'" + this.FormatearTextoSql( lxNumerooperacion ) + "'">>, <<lxCantidad>>, <<lxMonto>>, <<"'" + this.FormatearTextoSql( lxClientedescripcion ) + "'">>, <<"'" + this.FormatearTextoSql( lxCliente_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxClientedragon_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEnvio ) + "'">>, <<iif( lxFullenvios, 1, 0 )>>, <<iif( lxCancelada, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxTipocomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxClientenombre ) + "'">>, <<iif( lxPagado, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxOperacion_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxPlataforma ) + "'">>, <<"'" + this.FormatearTextoSql( lxBuzon ) + "'">>, <<"'" + this.FormatearTextoSql( lxBasededatos ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerocomprobante ) + "'">>, <<iif( lxUtilizastockotrabase, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxBdorigenstock ) + "'">>, <<"'" + this.FormatearTextoSql( lxComprobanteafectado ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPECOM set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCompecomFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCompecomFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCompecomFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCompecomFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCompecomFmodifw ) + "'">>,"Numero" = <<lxCompecomNumero>>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCompecomSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCompecomSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCompecomUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCompecomUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCompecomZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCompecomValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCompecomVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCompecomHmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCompecomHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCompecomHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCompecomHoraexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCompecomBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCompecomBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCompecomEsttrans ) + "'">>,"Pendiente" = <<iif( lxCompecomPendiente, 1, 0 )>>,"Ecommerce" = <<"'" + this.FormatearTextoSql( lxCompecomEcommerce ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxCompecomFecha ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxCompecomObs ) + "'">> where "Numero" = <<lxCompecomNumero>> and  COMPECOM.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Numero" as "Numero", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Pendiente" as "Operacionespendientes", "Ecommerce" as "Ecommerce", "Fecha" as "Fecha", "Obs" as "Observacion" from ZooLogic.COMPECOM where "Numero" = <<lxCompecomNumero>> and  COMPECOM.NUMERO != 0
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Numero,Saltafw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valta" + ;
"fw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Horaexpo,Bdaltafw,Bdmodifw,Esttrans,Pendiente,Ecommerce,Fecha,Ob" + ;
"s" + ;
		...
		With this
			...
			for each loItem in this.oEntidad.DetalleOperaciones
				if this.oEntidad.DetalleOperaciones.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxComprobanteafectado = loItem.Comprobanteafectado
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ECCOMPDET("NROITEM","NUMERO","OPENUM","CANT","MONTO","CLIEDSC","CLIENTE","CLIDRAGON","ENVIO","FULLENVIOS","CANCELADA","TIPOCOMP","NOMBRE","PAGADO","OPECOD","PLATA","BUZON","BDATOS","NROCOMP","USAOTRABD","ORIGENST","NROCOMPAFE" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxNumerooperacion ) + "'">>, <<lxCantidad>>, <<lxMonto>>, <<"'" + this.FormatearTextoSql( lxClientedescripcion ) + "'">>, <<"'" + this.FormatearTextoSql( lxCliente_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxClientedragon_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEnvio ) + "'">>, <<iif( lxFullenvios, 1, 0 )>>, <<iif( lxCancelada, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxTipocomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxClientenombre ) + "'">>, <<iif( lxPagado, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxOperacion_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxPlataforma ) + "'">>, <<"'" + this.FormatearTextoSql( lxBuzon ) + "'">>, <<"'" + this.FormatearTextoSql( lxBasededatos ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerocomprobante ) + "'">>, <<iif( lxUtilizastockotrabase, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxBdorigenstock ) + "'">>, <<"'" + this.FormatearTextoSql( lxComprobanteafectado ) + "'">> ) 
					endtext
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPECOM set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, NUMERO = ] + transform( &lcCursor..NUMERO )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, PENDIENTE = ] + Transform( iif( &lcCursor..PENDIENTE, 1, 0 ))+ [, ECOMMERCE = ] + "'" + this.FormatearTextoSql( &lcCursor..ECOMMERCE ) + "'"+ [, FECHA = ] + "'" + this.ConvertirDateSql( &lcCursor..FECHA ) + "'"+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'" + [ Where NUMERO = ] + transform( &lcCursor..NUMERO ) )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, NUMERO, SALTAFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HMODIFW, HALTAFW, HORAIMPO, HORAEXPO, BDALTAFW, BDMODIFW, ESTTRANS, PENDIENTE, ECOMMERCE, FECHA, OBS
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + transform( &lcCursor..NUMERO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + Transform( iif( &lcCursor..PENDIENTE, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.PENDIENTE = isnull( d.PENDIENTE, t.PENDIENTE ),t.ECOMMERCE = isnull( d.ECOMMERCE, t.ECOMMERCE ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.COMPECOM t inner join deleted d 
							 on t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.COMPECOM(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Numero,Saltafw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Horaexpo,Bdaltafw,Bdmodifw,Esttrans,Pendiente,Ecommerce,Fecha,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.NUMERO,0),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.PENDIENTE,0),isnull( d.ECOMMERCE,''),isnull( d.FECHA,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="COMPROBANTESECOMMERCE                   " atributo="FECHATRANSFERENCIA                      " tabla="COMPECOM       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPROBANTESECOMMERCE                   " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPECOM       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
