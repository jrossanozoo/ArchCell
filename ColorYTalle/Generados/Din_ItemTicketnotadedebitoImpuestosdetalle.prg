...
define class Din_ItemTICKETNOTADEDEBITOImpuestosdetalle as ItemIMPUESTOS of ItemIMPUESTOS.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'TICKETNOTADEDEBITO', 'Impuestosdetalle')
