...
define class Din_EntidadAgrupamientoporcompania_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Agrupamientoporcompania"
	cClaseResponse = this.cNamespaceDTOs + ".AgrupamientoporcompaniaResponse"
	cClaseModelo = "AgrupamientoporcompaniaModelo"
	cEntidad = "Agrupamientoporcompania"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientoporcompaniaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientoporcompaniaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientoporcompaniaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "AgrupamientoporcompaniaModelo"
		endcase
		return lcRetorno
	...
	protected function CargarColeccionModeloAgrupamientoDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .AgrupamientoDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemAgrupamientoporcomp" )
	...
	protected function CargarColeccionModeloBaseDeDatosDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .BaseDeDatosDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemBasededatosporcomp" )
