...
define class Mock_favoritolistados as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallelistadosdetalle() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Cambiosdetallelistadosdetalle', lcParametros )
	EndFunc
