...
define class Din_EntidadDISENOIMPRESIONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxDisimpFecimpo, lxDisimpFaltafw, lxDisimpFecexpo, lxDisimpFmodifw, lxDisimpFectrans, lxDisimpHmodifw, lxDisimpHoraexpo, lxDisimpBdaltafw, lxDisimpHaltafw, lxDisimpEsttrans, lxDisimpHoraimpo, lxDisimpSaltafw, lxDisimpZadsfw, lxDisimpVmodifw, lxDisimpUmodifw, lxDisimpValtafw, lxDisimpBdmodifw, lxDisimpSmodifw, lxDisimpUaltafw, lxDisimpTimestamp, lxDisimpBloqreg, lxDisimpLconfirma, lxDisimpCobs, lxDisimpNlimite, lxDisimpCentidad, lxDisimpNcantcol, lxDisimpLhabimpre, lxDisimpLhabpdf, lxDisimpNmarsup, lxDisimpCcod, lxDisimpNadvierte, lxDisimpNsegundos, lxDisimpImpauto, lxDisimpLpdfauto, lxDisimpNmarizq, lxDisimpCestilo, lxDisimpCseries, lxDisimpCdes, lxDisimpNconfpdf, lxDisimpNmarinf, lxDisimpCrutapdf, lxDisimpNsugiere, lxDisimpNmarder, lxDisimpNoptsal, lxDisimpCcondici, lxDisimpCpuerto, lxDisimpNcantcop, lxDisimpLdefault
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.DISIMP ( "Fecimpo","Faltafw","Fecexpo","Fmodifw","Fectrans","Hmodifw","Horaexpo","Bdaltafw","Haltafw","Esttrans","Horaimpo","Saltafw","Zadsfw","Vmodifw","Umodifw","Valtafw","Bdmodifw","Smodifw","Ualtafw","Timestamp","Bloqreg","Lconfirma","Cobs","Nlimite","Centidad","Ncantcol","Lhabimpre","Lhabpdf","Nmarsup","Ccod","Nadvierte","Nsegundos","Impauto","Lpdfauto","Nmarizq","Cestilo","Cseries","Cdes","Nconfpdf","Nmarinf","Crutapdf","Nsugiere","Nmarder","Noptsal","Ccondici","Cpuerto","Ncantcop","Ldefault" ) values ( <<"'" + this.ConvertirDateSql( lxDisimpFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpUaltafw ) + "'" >>, <<lxDisimpTimestamp >>, <<iif( lxDisimpBloqreg, 1, 0 ) >>, <<iif( lxDisimpLconfirma, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisimpCobs ) + "'" >>, <<lxDisimpNlimite >>, <<"'" + this.FormatearTextoSql( lxDisimpCentidad ) + "'" >>, <<lxDisimpNcantcol >>, <<iif( lxDisimpLhabimpre, 1, 0 ) >>, <<iif( lxDisimpLhabpdf, 1, 0 ) >>, <<lxDisimpNmarsup >>, <<"'" + this.FormatearTextoSql( lxDisimpCcod ) + "'" >>, <<lxDisimpNadvierte >>, <<lxDisimpNsegundos >>, <<iif( lxDisimpImpauto, 1, 0 ) >>, <<iif( lxDisimpLpdfauto, 1, 0 ) >>, <<lxDisimpNmarizq >>, <<"'" + this.FormatearTextoSql( lxDisimpCestilo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpCseries ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpCdes ) + "'" >>, <<lxDisimpNconfpdf >>, <<lxDisimpNmarinf >>, <<"'" + this.FormatearTextoSql( lxDisimpCrutapdf ) + "'" >>, <<lxDisimpNsugiere >>, <<lxDisimpNmarder >>, <<lxDisimpNoptsal >>, <<"'" + this.FormatearTextoSql( lxDisimpCcondici ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpCpuerto ) + "'" >>, <<lxDisimpNcantcop >>, <<iif( lxDisimpLdefault, 1, 0 ) >> )
			endtext
			...
			for each loItem in this.oEntidad.Areas
				if this.oEntidad.Areas.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DisAreas("NROITEM","BLOQREG","iCod","cArea","cTipo","cPosY","cPosX","cAncho","cAlto","cEstilo","cDetalle","cCondicion" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArea ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipo_PK ) + "'">>, <<lxY>>, <<lxX>>, <<lxAncho>>, <<lxAlto>>, <<"'" + this.FormatearTextoSql( lxEstilo_PK ) + "'">>, <<iif( lxEsdet, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxCondicion ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.DISIMP set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDisimpFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxDisimpFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxDisimpFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxDisimpFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxDisimpFectrans ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxDisimpHoraexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDisimpBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxDisimpHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxDisimpEsttrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxDisimpHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxDisimpSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxDisimpZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxDisimpUmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxDisimpValtafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpBdmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxDisimpSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxDisimpUaltafw ) + "'">>,"Timestamp" = <<lxDisimpTimestamp>>,"Bloqreg" = <<iif( lxDisimpBloqreg, 1, 0 )>>,"Lconfirma" = <<iif( lxDisimpLconfirma, 1, 0 )>>,"Cobs" = <<"'" + this.FormatearTextoSql( lxDisimpCobs ) + "'">>,"Nlimite" = <<lxDisimpNlimite>>,"Centidad" = <<"'" + this.FormatearTextoSql( lxDisimpCentidad ) + "'">>,"Ncantcol" = <<lxDisimpNcantcol>>,"Lhabimpre" = <<iif( lxDisimpLhabimpre, 1, 0 )>>,"Lhabpdf" = <<iif( lxDisimpLhabpdf, 1, 0 )>>,"Nmarsup" = <<lxDisimpNmarsup>>,"Ccod" = <<"'" + this.FormatearTextoSql( lxDisimpCcod ) + "'">>,"Nadvierte" = <<lxDisimpNadvierte>>,"Nsegundos" = <<lxDisimpNsegundos>>,"Impauto" = <<iif( lxDisimpImpauto, 1, 0 )>>,"Lpdfauto" = <<iif( lxDisimpLpdfauto, 1, 0 )>>,"Nmarizq" = <<lxDisimpNmarizq>>,"Cestilo" = <<"'" + this.FormatearTextoSql( lxDisimpCestilo ) + "'">>,"Cseries" = <<"'" + this.FormatearTextoSql( lxDisimpCseries ) + "'">>,"Cdes" = <<"'" + this.FormatearTextoSql( lxDisimpCdes ) + "'">>,"Nconfpdf" = <<lxDisimpNconfpdf>>,"Nmarinf" = <<lxDisimpNmarinf>>,"Crutapdf" = <<"'" + this.FormatearTextoSql( lxDisimpCrutapdf ) + "'">>,"Nsugiere" = <<lxDisimpNsugiere>>,"Nmarder" = <<lxDisimpNmarder>>,"Noptsal" = <<lxDisimpNoptsal>>,"Ccondici" = <<"'" + this.FormatearTextoSql( lxDisimpCcondici ) + "'">>,"Cpuerto" = <<"'" + this.FormatearTextoSql( lxDisimpCpuerto ) + "'">>,"Ncantcop" = <<lxDisimpNcantcop>>,"Ldefault" = <<iif( lxDisimpLdefault, 1, 0 )>> where "Ccod" = <<"'" + this.FormatearTextoSql( lxDisimpCcod ) + "'">> and  DISIMP.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Lconfirma" as "Solicitarconfirmacion", "Cobs" as "Observacion", "Nlimite" as "Aplicalimite", "Centidad" as "Entidad", "Ncantcol" as "Columnas", "Lhabimpre" as "Habilitasalidaaimpresora", "Lhabpdf" as "Habilitasalidaapdf", "Nmarsup" as "Margensup", "Ccod" as "Codigo", "Nadvierte" as "Advierte", "Nsegundos" as "Segundos", "Impauto" as "Impresionautomatica", "Lpdfauto" as "Pdfautomatico", "Nmarizq" as "Margenizq", "Cestilo" as "Estilo", "Cseries" as "Series", "Cdes" as "Descripcion", "Nconfpdf" as "Confirmapdf", "Nmarinf" as "Margeninf", "Crutapdf" as "Rutapdf", "Nsugiere" as "Sugiere", "Nmarder" as "Margender", "Noptsal" as "Opciondesalida", "Ccondici" as "Condicion", "Cpuerto" as "Puerto", "Ncantcop" as "Cantidadcopias", "Ldefault" as "Defaultimpresion" from ZooLogic.DISIMP where "Ccod" = <<"'" + this.FormatearTextoSql( lxDisimpCcod ) + "'">> and  DISIMP.CCOD != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Icod" as "Codigo", "Carea" as "Area", "Ctipo" as "Tipo", "Cposy" as "Y", "Cposx" as "X", "Cancho" as "Ancho", "Calto" as "Alto", "Cestilo" as "Estilo", "Cdetalle" as "Esdet", "Ccondicion" as "Condicion" from ZooLogic.DisAreas where iCod = <<"'" + this.FormatearTextoSql( c_DISENOIMPRESION.CODIGO ) + "'">> Order by y,x
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Lconfirma" as "Solicitarconfirmacion", "Cobs" as "Observacion", "Nlimite" as "Aplicalimite", "Centidad" as "Entidad", "Ncantcol" as "Columnas", "Lhabimpre" as "Habilitasalidaaimpresora", "Lhabpdf" as "Habilitasalidaapdf", "Nmarsup" as "Margensup", "Ccod" as "Codigo", "Nadvierte" as "Advierte", "Nsegundos" as "Segundos", "Impauto" as "Impresionautomatica", "Lpdfauto" as "Pdfautomatico", "Nmarizq" as "Margenizq", "Cestilo" as "Estilo", "Cseries" as "Series", "Cdes" as "Descripcion", "Nconfpdf" as "Confirmapdf", "Nmarinf" as "Margeninf", "Crutapdf" as "Rutapdf", "Nsugiere" as "Sugiere", "Nmarder" as "Margender", "Noptsal" as "Opciondesalida", "Ccondici" as "Condicion", "Cpuerto" as "Puerto", "Ncantcop" as "Cantidadcopias", "Ldefault" as "Defaultimpresion" from ZooLogic.DISIMP where  DISIMP.CCOD != '' order by cDes,cEntidad,cCod
			endtext
			use in select('c_DISENOIMPRESION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DISENOIMPRESION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Lconfirma" as "Solicitarconfirmacion", "Cobs" as "Observacion", "Nlimite" as "Aplicalimite", "Centidad" as "Entidad", "Ncantcol" as "Columnas", "Lhabimpre" as "Habilitasalidaaimpresora", "Lhabpdf" as "Habilitasalidaapdf", "Nmarsup" as "Margensup", "Ccod" as "Codigo", "Nadvierte" as "Advierte", "Nsegundos" as "Segundos", "Impauto" as "Impresionautomatica", "Lpdfauto" as "Pdfautomatico", "Nmarizq" as "Margenizq", "Cestilo" as "Estilo", "Cseries" as "Series", "Cdes" as "Descripcion", "Nconfpdf" as "Confirmapdf", "Nmarinf" as "Margeninf", "Crutapdf" as "Rutapdf", "Nsugiere" as "Sugiere", "Nmarder" as "Margender", "Noptsal" as "Opciondesalida", "Ccondici" as "Condicion", "Cpuerto" as "Puerto", "Ncantcop" as "Cantidadcopias", "Ldefault" as "Defaultimpresion" from ZooLogic.DISIMP where  funciones.padr( cDes, 100, ' ' ) + funciones.padr( cEntidad, 40, ' ' ) + funciones.padr( cCod, 40, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  DISIMP.CCOD != '' order by cDes,cEntidad,cCod
			endtext
			use in select('c_DISENOIMPRESION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DISENOIMPRESION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Lconfirma" as "Solicitarconfirmacion", "Cobs" as "Observacion", "Nlimite" as "Aplicalimite", "Centidad" as "Entidad", "Ncantcol" as "Columnas", "Lhabimpre" as "Habilitasalidaaimpresora", "Lhabpdf" as "Habilitasalidaapdf", "Nmarsup" as "Margensup", "Ccod" as "Codigo", "Nadvierte" as "Advierte", "Nsegundos" as "Segundos", "Impauto" as "Impresionautomatica", "Lpdfauto" as "Pdfautomatico", "Nmarizq" as "Margenizq", "Cestilo" as "Estilo", "Cseries" as "Series", "Cdes" as "Descripcion", "Nconfpdf" as "Confirmapdf", "Nmarinf" as "Margeninf", "Crutapdf" as "Rutapdf", "Nsugiere" as "Sugiere", "Nmarder" as "Margender", "Noptsal" as "Opciondesalida", "Ccondici" as "Condicion", "Cpuerto" as "Puerto", "Ncantcop" as "Cantidadcopias", "Ldefault" as "Defaultimpresion" from ZooLogic.DISIMP where  DISIMP.CCOD != '' order by cDes desc,cEntidad desc,cCod desc
			endtext
			use in select('c_DISENOIMPRESION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DISENOIMPRESION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Faltafw,Fecexpo,Fmodifw,Fectrans,Hmodifw,Horaexpo,Bdaltafw,Haltafw,Esttrans,Horaimpo" + ;
",Saltafw,Zadsfw,Vmodifw,Umodifw,Valtafw,Bdmodifw,Smodifw,Ualtafw,Timestamp,Bloqreg,Lconfirma,Cobs,Nl" + ;
"imite,Centidad,Ncantcol,Lhabimpre,Lhabpdf,Nmarsup,Ccod,Nadvierte,Nsegundos,Impauto,Lpdfauto,Nmarizq," + ;
"Cestilo,Cseries,Cdes,Nconfpdf,Nmarinf,Crutapdf,Nsugiere,Nmarder,Noptsal,Ccondici,Cpuerto,Ncantcop,Ld" + ;
"efault" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAreas( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Icod" as "Codigo", "Carea" as "Area", "Ctipo" as "Tipo", "Cposy" as "Y", "Cposx" as "X", "Cancho" as "Ancho", "Calto" as "Alto", "Cestilo" as "Estilo", "Cdetalle" as "Esdet", "Ccondicion" as "Condicion"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.Areas
				if this.oEntidad.Areas.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCondicion = loItem.Condicion
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DisAreas("NROITEM","BLOQREG","iCod","cArea","cTipo","cPosY","cPosX","cAncho","cAlto","cEstilo","cDetalle","cCondicion" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArea ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipo_PK ) + "'">>, <<lxY>>, <<lxX>>, <<lxAncho>>, <<lxAlto>>, <<"'" + this.FormatearTextoSql( lxEstilo_PK ) + "'">>, <<iif( lxEsdet, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxCondicion ) + "'">> ) 
					endtext
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.DISIMP set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDisimpFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxDisimpFaltafw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxDisimpFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxDisimpFmodifw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxDisimpFectrans ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpHmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxDisimpHoraexpo ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDisimpBdaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxDisimpHaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxDisimpEsttrans ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxDisimpHoraimpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxDisimpSaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxDisimpZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpVmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxDisimpUmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxDisimpValtafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpBdmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxDisimpSmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxDisimpUaltafw ) + "'">>, "Timestamp" = <<lxDisimpTimestamp>>, "Bloqreg" = <<iif( lxDisimpBloqreg, 1, 0 )>>, "Lconfirma" = <<iif( lxDisimpLconfirma, 1, 0 )>>, "Cobs" = <<"'" + this.FormatearTextoSql( lxDisimpCobs ) + "'">>, "Nlimite" = <<lxDisimpNlimite>>, "Centidad" = <<"'" + this.FormatearTextoSql( lxDisimpCentidad ) + "'">>, "Ncantcol" = <<lxDisimpNcantcol>>, "Lhabimpre" = <<iif( lxDisimpLhabimpre, 1, 0 )>>, "Lhabpdf" = <<iif( lxDisimpLhabpdf, 1, 0 )>>, "Nmarsup" = <<lxDisimpNmarsup>>, "Ccod" = <<"'" + this.FormatearTextoSql( lxDisimpCcod ) + "'">>, "Nadvierte" = <<lxDisimpNadvierte>>, "Nsegundos" = <<lxDisimpNsegundos>>, "Impauto" = <<iif( lxDisimpImpauto, 1, 0 )>>, "Lpdfauto" = <<iif( lxDisimpLpdfauto, 1, 0 )>>, "Nmarizq" = <<lxDisimpNmarizq>>, "Cestilo" = <<"'" + this.FormatearTextoSql( lxDisimpCestilo ) + "'">>, "Cseries" = <<"'" + this.FormatearTextoSql( lxDisimpCseries ) + "'">>, "Cdes" = <<"'" + this.FormatearTextoSql( lxDisimpCdes ) + "'">>, "Nconfpdf" = <<lxDisimpNconfpdf>>, "Nmarinf" = <<lxDisimpNmarinf>>, "Crutapdf" = <<"'" + this.FormatearTextoSql( lxDisimpCrutapdf ) + "'">>, "Nsugiere" = <<lxDisimpNsugiere>>, "Nmarder" = <<lxDisimpNmarder>>, "Noptsal" = <<lxDisimpNoptsal>>, "Ccondici" = <<"'" + this.FormatearTextoSql( lxDisimpCcondici ) + "'">>, "Cpuerto" = <<"'" + this.FormatearTextoSql( lxDisimpCpuerto ) + "'">>, "Ncantcop" = <<lxDisimpNcantcop>>, "Ldefault" = <<iif( lxDisimpLdefault, 1, 0 )>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'DISIMP' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					if !Evaluate( lcCursor + ".BloqReg" )
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.DISIMP set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, lConfirma = ] + Transform( iif( &lcCursor..lConfirma, 1, 0 ))+ [, cObs = ] + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"+ [, nLimite = ] + transform( &lcCursor..nLimite )+ [, cEntidad = ] + "'" + this.FormatearTextoSql( &lcCursor..cEntidad ) + "'"+ [, nCantCol = ] + transform( &lcCursor..nCantCol )+ [, lHabImpre = ] + Transform( iif( &lcCursor..lHabImpre, 1, 0 ))+ [, lHabPdf = ] + Transform( iif( &lcCursor..lHabPdf, 1, 0 ))+ [, nMarSup = ] + transform( &lcCursor..nMarSup )+ [, cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"+ [, nAdvierte = ] + transform( &lcCursor..nAdvierte )+ [, nSegundos = ] + transform( &lcCursor..nSegundos )+ [, impauto = ] + Transform( iif( &lcCursor..impauto, 1, 0 ))+ [, lPdfAuto = ] + Transform( iif( &lcCursor..lPdfAuto, 1, 0 ))+ [, nMarIzq = ] + transform( &lcCursor..nMarIzq )+ [, cEstilo = ] + "'" + this.FormatearTextoSql( &lcCursor..cEstilo ) + "'"+ [, cSeries = ] + "'" + this.FormatearTextoSql( &lcCursor..cSeries ) + "'"+ [, cDes = ] + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'"+ [, nConfPdf = ] + transform( &lcCursor..nConfPdf )+ [, nMarInf = ] + transform( &lcCursor..nMarInf )+ [, cRutaPdf = ] + "'" + this.FormatearTextoSql( &lcCursor..cRutaPdf ) + "'"+ [, nSugiere = ] + transform( &lcCursor..nSugiere )+ [, nMarDer = ] + transform( &lcCursor..nMarDer )+ [, nOptSal = ] + transform( &lcCursor..nOptSal )+ [, cCondici = ] + "'" + this.FormatearTextoSql( &lcCursor..cCondici ) + "'"+ [, cPuerto = ] + "'" + this.FormatearTextoSql( &lcCursor..cPuerto ) + "'"+ [, nCantCop = ] + transform( &lcCursor..nCantCop )+ [, lDefault = ] + Transform( iif( &lcCursor..lDefault, 1, 0 )) + [ Where cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" )
						lcMensajeExtra = ""
					else
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.DISIMP set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, lConfirma = ] + Transform( iif( &lcCursor..lConfirma, 1, 0 ))+ [, cObs = ] + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"+ [, nLimite = ] + transform( &lcCursor..nLimite )+ [, nCantCol = ] + transform( &lcCursor..nCantCol )+ [, lHabImpre = ] + Transform( iif( &lcCursor..lHabImpre, 1, 0 ))+ [, lHabPdf = ] + Transform( iif( &lcCursor..lHabPdf, 1, 0 ))+ [, nMarSup = ] + transform( &lcCursor..nMarSup )+ [, nAdvierte = ] + transform( &lcCursor..nAdvierte )+ [, nSegundos = ] + transform( &lcCursor..nSegundos )+ [, impauto = ] + Transform( iif( &lcCursor..impauto, 1, 0 ))+ [, lPdfAuto = ] + Transform( iif( &lcCursor..lPdfAuto, 1, 0 ))+ [, nMarIzq = ] + transform( &lcCursor..nMarIzq )+ [, cSeries = ] + "'" + this.FormatearTextoSql( &lcCursor..cSeries ) + "'"+ [, cDes = ] + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'"+ [, nConfPdf = ] + transform( &lcCursor..nConfPdf )+ [, nMarInf = ] + transform( &lcCursor..nMarInf )+ [, cRutaPdf = ] + "'" + this.FormatearTextoSql( &lcCursor..cRutaPdf ) + "'"+ [, nSugiere = ] + transform( &lcCursor..nSugiere )+ [, nMarDer = ] + transform( &lcCursor..nMarDer )+ [, nOptSal = ] + transform( &lcCursor..nOptSal )+ [, cPuerto = ] + "'" + this.FormatearTextoSql( &lcCursor..cPuerto ) + "'"+ [, nCantCop = ] + transform( &lcCursor..nCantCop )+ [, lDefault = ] + Transform( iif( &lcCursor..lDefault, 1, 0 )) + [ Where cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FALTAFW, FECEXPO, FMODIFW, FECTRANS, HMODIFW, HORAEXPO, BDALTAFW, HALTAFW, ESTTRANS, HORAIMPO, SALTAFW, ZADSFW, VMODIFW, UMODIFW, VALTAFW, BDMODIFW, SMODIFW, UALTAFW, TIMESTAMP, BLOQREG, lConfirma, cObs, nLimite, cEntidad, nCantCol, lHabImpre, lHabPdf, nMarSup, cCod, nAdvierte, nSegundos, impauto, lPdfAuto, nMarIzq, cEstilo, cSeries, cDes, nConfPdf, nMarInf, cRutaPdf, nSugiere, nMarDer, nOptSal, cCondici, cPuerto, nCantCop, lDefault
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" + ',' + transform( &lcCursor..nAdvierte ) + ',' + transform( &lcCursor..nSegundos ) + ',' + Transform( iif( &lcCursor..impauto, 1, 0 )) + ',' + Transform( iif( &lcCursor..lPdfAuto, 1, 0 )) + ',' + transform( &lcCursor..nMarIzq ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cEstilo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cSeries ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'" + ',' + transform( &lcCursor..nConfPdf ) + ',' + transform( &lcCursor..nMarInf ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cRutaPdf ) + "'" + ',' + transform( &lcCursor..nSugiere ) + ',' + transform( &lcCursor..nMarDer ) + ',' + transform( &lcCursor..nOptSal ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCondici ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cPuerto ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..nCantCop ) + ',' + Transform( iif( &lcCursor..lDefault, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.LCONFIRMA = isnull( d.LCONFIRMA, t.LCONFIRMA ),t.COBS = isnull( d.COBS, t.COBS ),t.NLIMITE = isnull( d.NLIMITE, t.NLIMITE ),t.CENTIDAD = isnull( d.CENTIDAD, t.CENTIDAD ),t.NCANTCOL = isnull( d.NCANTCOL, t.NCANTCOL ),t.LHABIMPRE = isnull( d.LHABIMPRE, t.LHABIMPRE ),t.LHABPDF = isnull( d.LHABPDF, t.LHABPDF ),t.NMARSUP = isnull( d.NMARSUP, t.NMARSUP ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.NADVIERTE = isnull( d.NADVIERTE, t.NADVIERTE ),t.NSEGUNDOS = isnull( d.NSEGUNDOS, t.NSEGUNDOS ),t.IMPAUTO = isnull( d.IMPAUTO, t.IMPAUTO ),t.LPDFAUTO = isnull( d.LPDFAUTO, t.LPDFAUTO ),t.NMARIZQ = isnull( d.NMARIZQ, t.NMARIZQ ),t.CESTILO = isnull( d.CESTILO, t.CESTILO ),t.CSERIES = isnull( d.CSERIES, t.CSERIES ),t.CDES = isnull( d.CDES, t.CDES ),t.NCONFPDF = isnull( d.NCONFPDF, t.NCONFPDF ),t.NMARINF = isnull( d.NMARINF, t.NMARINF ),t.CRUTAPDF = isnull( d.CRUTAPDF, t.CRUTAPDF ),t.NSUGIERE = isnull( d.NSUGIERE, t.NSUGIERE ),t.NMARDER = isnull( d.NMARDER, t.NMARDER ),t.NOPTSAL = isnull( d.NOPTSAL, t.NOPTSAL ),t.CCONDICI = isnull( d.CCONDICI, t.CCONDICI ),t.CPUERTO = isnull( d.CPUERTO, t.CPUERTO ),t.NCANTCOP = isnull( d.NCANTCOP, t.NCANTCOP ),t.LDEFAULT = isnull( d.LDEFAULT, t.LDEFAULT )
					from ZooLogic.DISIMP t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ZooLogic.DISIMP(Fecimpo,Faltafw,Fecexpo,Fmodifw,Fectrans,Hmodifw,Horaexpo,Bdaltafw,Haltafw,Esttrans,Horaimpo,Saltafw,Zadsfw,Vmodifw,Umodifw,Valtafw,Bdmodifw,Smodifw,Ualtafw,Timestamp,Bloqreg,Lconfirma,Cobs,Nlimite,Centidad,Ncantcol,Lhabimpre,Lhabpdf,Nmarsup,Ccod,Nadvierte,Nsegundos,Impauto,Lpdfauto,Nmarizq,Cestilo,Cseries,Cdes,Nconfpdf,Nmarinf,Crutapdf,Nsugiere,Nmarder,Noptsal,Ccondici,Cpuerto,Ncantcop,Ldefault)
					Select isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.LCONFIRMA,0),isnull( d.COBS,''),isnull( d.NLIMITE,0),isnull( d.CENTIDAD,''),isnull( d.NCANTCOL,0),isnull( d.LHABIMPRE,0),isnull( d.LHABPDF,0),isnull( d.NMARSUP,0),isnull( d.CCOD,''),isnull( d.NADVIERTE,0),isnull( d.NSEGUNDOS,0),isnull( d.IMPAUTO,0),isnull( d.LPDFAUTO,0),isnull( d.NMARIZQ,0),isnull( d.CESTILO,''),isnull( d.CSERIES,''),isnull( d.CDES,''),isnull( d.NCONFPDF,0),isnull( d.NMARINF,0),isnull( d.CRUTAPDF,''),isnull( d.NSUGIERE,0),isnull( d.NMARDER,0),isnull( d.NOPTSAL,0),isnull( d.CCONDICI,''),isnull( d.CPUERTO,''),isnull( d.NCANTCOP,0),isnull( d.LDEFAULT,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="DISENOIMPRESION                         " atributo="FECHATRANSFERENCIA                      " tabla="DISIMP         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOIMPRESION                         " atributo="ESTADOTRANSFERENCIA                     " tabla="DISIMP         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
