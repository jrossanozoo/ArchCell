...
define class Mock_Criteriosvaloresad_sqlserver as MockBase of MockBase.prg

	cClase = 'Criteriosvaloresad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubcav( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubcav', lcParametros )
	EndFunc
