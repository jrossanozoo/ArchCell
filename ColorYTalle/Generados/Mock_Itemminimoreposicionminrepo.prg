...
define class Mock_Itemminimoreposicionminrepo as MockBase of MockBase.prg

	cClase = 'Itemminimoreposicionminrepo'
	...
	*-----------------------------------------------------------------------------------------
	function cantidadactual_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cantidadactual_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function maxactual_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Maxactual_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function maxnuevo_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Maxnuevo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidadactual( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_cantidadactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_maxactual( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_maxactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_maxnuevo( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_maxnuevo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidadactual( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_cantidadactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_maxactual( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_maxactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_maxnuevo( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_maxnuevo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomaxnuevo() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridomaxnuevo', lcParametros )
	EndFunc
