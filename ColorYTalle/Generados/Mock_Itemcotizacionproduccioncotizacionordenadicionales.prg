...
define class Mock_Itemcotizacionproduccioncotizacionordenadicionales as MockBase of MockBase.prg

	cClase = 'Itemcotizacionproduccioncotizacionordenadicionales'
	...
	*-----------------------------------------------------------------------------------------
	function iditemarticulo_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Iditemarticulo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iditemarticulo( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_iditemarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iditemarticulo( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_iditemarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwiditemarticulo() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridofwiditemarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoiditemarticulo() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridoiditemarticulo', lcParametros )
	EndFunc
