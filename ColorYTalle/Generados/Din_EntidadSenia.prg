...
define class Din_EntidadSENIA as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function _Buscar() As void
		...
		if empty( This.&lcAtributo )
			...
			lcMensaje = 'El dato buscado TIPO ' + transform( This.TipoComprobanteOrigen ) + ', LETRA ' + transform( This.LetraOrigen ) + ', PUNTO DE VENTA ' + transform( This.PuntoDeVentaOrigen ) + ', COMPROBANTE ' + transform( This.NumeroOrigen ) + ' de la entidad ' + upper( this.cDescripcion ) + ' no existe.'
		else
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<NOSALTODECAMPO><ANULABLE><NOEXPO><VENTAS>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
