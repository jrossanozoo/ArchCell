...
define class Mock_Itemagrupamientoporcompaniabasededatosdetalle as MockBase of MockBase.prg

	cClase = 'Itemagrupamientoporcompaniabasededatosdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function basededatosdetalle_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Basededatosdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_basededatosdetalle( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_basededatosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_basededatosdetalle( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_basededatosdetalle', lcParametros )
	EndFunc
