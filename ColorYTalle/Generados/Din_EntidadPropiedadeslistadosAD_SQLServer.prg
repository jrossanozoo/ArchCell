	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PROPLIST ( "Fecexpo","Fmodifw","Fecimpo","Fectrans","Faltafw","Bdaltafw","Bdmodifw","Esttrans","Hmodifw","Haltafw","Zadsfw","Vmodifw","Valtafw","Umodifw","Saltafw","Horaimpo","Smodifw","Horaexpo","Ualtafw","Codigo","Nombre","Etiqueta","Longitud","Decimales","Calculo","Mceros","Pcrecer","Orepetido","Lvertical","Wimagen","Mimagen","Himagen","Criteinit","Diasatras","Vnidesde","Vnihasta","Vcidesde","Vcihasta","Vibooleano","Visinobool","Slectura","Noinformar","Nomostrar","Titulo","Imagen","Fechaimpre","Horaimpre","Obs","Cestilo","Mderecho","Mizquierdo","Mcabe","Mpie","Orien","Ddetalle","Colorsombr" ) values ( <<"'" + this.ConvertirDateSql( lxProplistFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProplistFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProplistFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProplistFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProplistFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistNombre ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistEtiqueta ) + "'" >>, <<lxProplistLongitud >>, <<lxProplistDecimales >>, <<"'" + this.FormatearTextoSql( lxProplistCalculo ) + "'" >>, <<iif( lxProplistMceros, 1, 0 ) >>, <<iif( lxProplistPcrecer, 1, 0 ) >>, <<iif( lxProplistOrepetido, 1, 0 ) >>, <<iif( lxProplistLvertical, 1, 0 ) >>, <<lxProplistWimagen >>, <<iif( lxProplistMimagen, 1, 0 ) >>, <<lxProplistHimagen >>, <<lxProplistCriteinit >>, <<lxProplistDiasatras >>, <<lxProplistVnidesde >>, <<lxProplistVnihasta >>, <<"'" + this.FormatearTextoSql( lxProplistVcidesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistVcihasta ) + "'" >>, <<lxProplistVibooleano >>, <<lxProplistVisinobool >>, <<iif( lxProplistSlectura, 1, 0 ) >>, <<iif( lxProplistNoinformar, 1, 0 ) >>, <<iif( lxProplistNomostrar, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxProplistTitulo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistImagen ) + "'" >>, <<iif( lxProplistFechaimpre, 1, 0 ) >>, <<iif( lxProplistHoraimpre, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxProplistObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProplistCestilo ) + "'" >>, <<lxProplistMderecho >>, <<lxProplistMizquierdo >>, <<lxProplistMcabe >>, <<lxProplistMpie >>, <<lxProplistOrien >>, <<iif( lxProplistDdetalle, 1, 0 ) >>, <<lxProplistColorsombr >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fmodifw,Fecimpo,Fectrans,Faltafw,Bdaltafw,Bdmodifw,Esttrans,Hmodifw,Haltafw,Zadsfw,V" + ;
"modifw,Valtafw,Umodifw,Saltafw,Horaimpo,Smodifw,Horaexpo,Ualtafw,Codigo,Nombre,Etiqueta,Longitud,Dec" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FECTRANS, FALTAFW, BDALTAFW, BDMODIFW, ESTTRANS, HMODIFW, HALTAFW, ZADSFW, VMODIFW, VALTAFW, UMODIFW, SALTAFW, HORAIMPO, SMODIFW, HORAEXPO, UALTAFW, Codigo, Nombre, Etiqueta, Longitud, Decimales, Calculo, Mceros, PCrecer, ORepetido, LVertical, WImagen, MImagen, HImagen, CriteInit, DiasAtras, VNIDesde, VNIHasta, VCIDesde, VCIHasta, VIBooleano, VISiNoBool, SLectura, NoInformar, NoMostrar, titulo, Imagen, fechaimpre, horaimpre, OBS, cEstilo, MDerecho, MIzquierdo, MCabe, Mpie, Orien, DDetalle, ColorSombr
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Nombre ) + "'"
...
<VFPData xml:space="preserve">
	...
	<row entidad="PROPIEDADESLISTADOS                     " atributo="FECHATRANSFERENCIA                      " tabla="PROPLIST       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PROPIEDADESLISTADOS                     " atributo="ESTADOTRANSFERENCIA                     " tabla="PROPLIST       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
