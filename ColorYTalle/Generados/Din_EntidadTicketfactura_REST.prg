...
define class Din_EntidadTicketfactura_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Ticketfactura"
	cClaseResponse = this.cNamespaceDTOs + ".TicketfacturaResponse"
	cClaseModelo = "TicketfacturaModelo"
	cEntidad = "Ticketfactura"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketfacturaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketfacturaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TicketfacturaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TicketfacturaModelo"
		endcase
		return lcRetorno
