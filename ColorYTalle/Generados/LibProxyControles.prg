...
*------------------------------------------------------------------------------------------------------------
Define Class BOTONERAProxy as botonera of Botonera.prg
...
*------------------------------------------------------------------------------------------------------------
Define Class CAMPONUMERICOCONSIGNOProxy as camponumericoconsigno of Camponumericoconsigno.prg
	...
	*------------------------------------------------------------------------------------------------------------
	Function Class_Access() as String 
		Return 'CAMPONUMERICOCONSIGNO'
	EndFunc
	*------------------------------------------------------------------------------------------------------------
	Function ClassLibrary_Access() as String 
		Return 'camponumericoconsigno.fxp'
	EndFunc
...
*------------------------------------------------------------------------------------------------------------
Define Class NUMEROCOMPROBANTEProxy as numerocomprobante of Numerocomprobante.prg
