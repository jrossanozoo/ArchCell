...
define class Mock_Gestionvendedorad_sqlserver as MockBase of MockBase.prg

	cClase = 'Gestionvendedorad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubgdv( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubgdv', lcParametros )
	EndFunc
