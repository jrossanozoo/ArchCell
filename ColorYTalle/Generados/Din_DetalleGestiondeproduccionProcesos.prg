...
define class Din_DetalleGESTIONDEPRODUCCIONProcesos as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemGESTIONDEPRODUCCIONProcesos' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		scan for &lcFiltro
			...
			loItem.ProcesoDetalle = c_Procesos.ProcesoDetalle
			loItem.Orden = c_Procesos.Orden
			loItem.Taller_PK = c_Procesos.Taller
