...
define class Din_EntidadTIPOAREAEXPORTACIONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTareaexpFecexpo, lxTareaexpFectrans, lxTareaexpFecimpo, lxTareaexpFaltafw, lxTareaexpFmodifw, lxTareaexpSaltafw, lxTareaexpHoraimpo, lxTareaexpHmodifw, lxTareaexpSmodifw, lxTareaexpUmodifw, lxTareaexpUaltafw, lxTareaexpZadsfw, lxTareaexpValtafw, lxTareaexpVmodifw, lxTareaexpHoraexpo, lxTareaexpHaltafw, lxTareaexpEsttrans, lxTareaexpBdmodifw, lxTareaexpBdaltafw, lxTareaexpBloqreg, lxTareaexpCcod, lxTareaexpCdes, lxTareaexpLcabecera, lxTareaexpLdetalle, lxTareaexpLtitulo, lxTareaexpLmulti, lxTareaexpLpie
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.TAREAEXP ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Saltafw","Horaimpo","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Horaexpo","Haltafw","Esttrans","Bdmodifw","Bdaltafw","Bloqreg","Ccod","Cdes","Lcabecera","Ldetalle","Ltitulo","Lmulti","Lpie" ) values ( <<"'" + this.ConvertirDateSql( lxTareaexpFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaexpFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaexpFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaexpFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaexpFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpBdaltafw ) + "'" >>, <<iif( lxTareaexpBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxTareaexpCcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaexpCdes ) + "'" >>, <<iif( lxTareaexpLcabecera, 1, 0 ) >>, <<iif( lxTareaexpLdetalle, 1, 0 ) >>, <<iif( lxTareaexpLtitulo, 1, 0 ) >>, <<iif( lxTareaexpLmulti, 1, 0 ) >>, <<iif( lxTareaexpLpie, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.TAREAEXP set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTareaexpFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTareaexpFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTareaexpFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTareaexpFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTareaexpFmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTareaexpSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTareaexpHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTareaexpUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTareaexpZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTareaexpValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTareaexpHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTareaexpHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTareaexpEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTareaexpBdaltafw ) + "'">>,"Bloqreg" = <<iif( lxTareaexpBloqreg, 1, 0 )>>,"Ccod" = <<"'" + this.FormatearTextoSql( lxTareaexpCcod ) + "'">>,"Cdes" = <<"'" + this.FormatearTextoSql( lxTareaexpCdes ) + "'">>,"Lcabecera" = <<iif( lxTareaexpLcabecera, 1, 0 )>>,"Ldetalle" = <<iif( lxTareaexpLdetalle, 1, 0 )>>,"Ltitulo" = <<iif( lxTareaexpLtitulo, 1, 0 )>>,"Lmulti" = <<iif( lxTareaexpLmulti, 1, 0 )>>,"Lpie" = <<iif( lxTareaexpLpie, 1, 0 )>> where "Ccod" = <<"'" + this.FormatearTextoSql( lxTareaexpCcod ) + "'">> and  TAREAEXP.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Lcabecera" as "Cabecera", "Ldetalle" as "Detalle", "Ltitulo" as "Titulo", "Lmulti" as "Multilinea", "Lpie" as "Piedepagina" from ORGANIZACION.TAREAEXP where "Ccod" = <<"'" + this.FormatearTextoSql( lxTareaexpCcod ) + "'">> and  TAREAEXP.CCOD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Lcabecera" as "Cabecera", "Ldetalle" as "Detalle", "Ltitulo" as "Titulo", "Lmulti" as "Multilinea", "Lpie" as "Piedepagina" from ORGANIZACION.TAREAEXP where  TAREAEXP.CCOD != '' order by cCod
			endtext
			use in select('c_TIPOAREAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOAREAEXPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Lcabecera" as "Cabecera", "Ldetalle" as "Detalle", "Ltitulo" as "Titulo", "Lmulti" as "Multilinea", "Lpie" as "Piedepagina" from ORGANIZACION.TAREAEXP where  funciones.padr( cCod, 3, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TAREAEXP.CCOD != '' order by cCod
			endtext
			use in select('c_TIPOAREAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOAREAEXPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Lcabecera" as "Cabecera", "Ldetalle" as "Detalle", "Ltitulo" as "Titulo", "Lmulti" as "Multilinea", "Lpie" as "Piedepagina" from ORGANIZACION.TAREAEXP where  funciones.padr( cCod, 3, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TAREAEXP.CCOD != '' order by cCod desc
			endtext
			use in select('c_TIPOAREAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOAREAEXPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Lcabecera" as "Cabecera", "Ldetalle" as "Detalle", "Ltitulo" as "Titulo", "Lmulti" as "Multilinea", "Lpie" as "Piedepagina" from ORGANIZACION.TAREAEXP where  TAREAEXP.CCOD != '' order by cCod desc
			endtext
			use in select('c_TIPOAREAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOAREAEXPORTACION', set( 'Datasession' ) )
			Endwith
...
"dsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Esttrans,Bdmodifw,Bdaltafw,Bloqreg,Ccod,Cdes,Lcabecera,Ldetall" + ;
"e,Ltitulo,Lmulti,Lpie" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Lcabecera" as "Cabecera", "Ldetalle" as "Detalle", "Ltitulo" as "Titulo", "Lmulti" as "Multilinea", "Lpie" as "Piedepagina"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.TAREAEXP set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTareaexpFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxTareaexpFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTareaexpFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxTareaexpFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTareaexpFmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxTareaexpSaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxTareaexpHoraimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpHmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpUmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxTareaexpUaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxTareaexpZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxTareaexpValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpVmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxTareaexpHoraexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxTareaexpHaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxTareaexpEsttrans ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTareaexpBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTareaexpBdaltafw ) + "'">>, "Bloqreg" = <<iif( lxTareaexpBloqreg, 1, 0 )>>, "Ccod" = <<"'" + this.FormatearTextoSql( lxTareaexpCcod ) + "'">>, "Cdes" = <<"'" + this.FormatearTextoSql( lxTareaexpCdes ) + "'">>, "Lcabecera" = <<iif( lxTareaexpLcabecera, 1, 0 )>>, "Ldetalle" = <<iif( lxTareaexpLdetalle, 1, 0 )>>, "Ltitulo" = <<iif( lxTareaexpLtitulo, 1, 0 )>>, "Lmulti" = <<iif( lxTareaexpLmulti, 1, 0 )>>, "Lpie" = <<iif( lxTareaexpLpie, 1, 0 )>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'TAREAEXP' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.TAREAEXP set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"+ [, cDes = ] + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'"+ [, lCabecera = ] + Transform( iif( &lcCursor..lCabecera, 1, 0 ))+ [, lDetalle = ] + Transform( iif( &lcCursor..lDetalle, 1, 0 ))+ [, lTitulo = ] + Transform( iif( &lcCursor..lTitulo, 1, 0 ))+ [, lMulti = ] + Transform( iif( &lcCursor..lMulti, 1, 0 ))+ [, lPie = ] + Transform( iif( &lcCursor..lPie, 1, 0 )) + [ Where cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, SALTAFW, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HORAEXPO, HALTAFW, ESTTRANS, BDMODIFW, BDALTAFW, BLOQREG, cCod, cDes, lCabecera, lDetalle, lTitulo, lMulti, lPie
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'" + ',' + Transform( iif( &lcCursor..lCabecera, 1, 0 )) + ',' + Transform( iif( &lcCursor..lDetalle, 1, 0 )) + ',' + Transform( iif( &lcCursor..lTitulo, 1, 0 )) + ',' + Transform( iif( &lcCursor..lMulti, 1, 0 )) + ',' + Transform( iif( &lcCursor..lPie, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.CDES = isnull( d.CDES, t.CDES ),t.LCABECERA = isnull( d.LCABECERA, t.LCABECERA ),t.LDETALLE = isnull( d.LDETALLE, t.LDETALLE ),t.LTITULO = isnull( d.LTITULO, t.LTITULO ),t.LMULTI = isnull( d.LMULTI, t.LMULTI ),t.LPIE = isnull( d.LPIE, t.LPIE )
					from ORGANIZACION.TAREAEXP t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ORGANIZACION.TAREAEXP(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Esttrans,Bdmodifw,Bdaltafw,Bloqreg,Ccod,Cdes,Lcabecera,Ldetalle,Ltitulo,Lmulti,Lpie)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.BLOQREG,0),isnull( d.CCOD,''),isnull( d.CDES,''),isnull( d.LCABECERA,0),isnull( d.LDETALLE,0),isnull( d.LTITULO,0),isnull( d.LMULTI,0),isnull( d.LPIE,0)
