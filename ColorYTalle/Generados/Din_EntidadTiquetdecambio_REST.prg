...
define class Din_EntidadTiquetdecambio_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Tiquetdecambio"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleDetalleComprobante( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.DetalleComprobante.oItem, "Talle_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Talledetalle", toEntidad.DetalleComprobante.oItem, "TalleDetalle" )
	...
	protected function CargarColeccionModeloDetalleComprobante( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .DetalleComprobante.Count
				...
				this.SetearAtributoString( loItem, "Talle", .DetalleComprobante.Item(lnI).Talle_PK)
				this.SetearAtributoString( loItem, "TalleDetalle", .DetalleComprobante.Item(lnI).TalleDetalle)
