...
define class Mock_Itemajustedeestadoscomprobantesmodificados as MockBase of MockBase.prg

	cClase = 'Itemajustedeestadoscomprobantesmodificados'
	...
	*-----------------------------------------------------------------------------------------
	function detallemodificacion_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Detallemodificacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_detallemodificacion( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_detallemodificacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_stockact( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_stockact', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_stockproy( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_stockproy', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function stockact_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Stockact_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function stockproy_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Stockproy_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_detallemodificacion( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validar_detallemodificacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_stockact( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_stockact', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_stockproy( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_stockproy', lcParametros )
	EndFunc
