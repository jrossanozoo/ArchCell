...
define class Mock_Itemdisenoimpoatributos as MockBase of MockBase.prg

	cClase = 'Itemdisenoimpoatributos'
	...
	*-----------------------------------------------------------------------------------------
	function area_assign( txval as variant ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Area_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function area_despuesdeasignar() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Area_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function condicion_access() as variant                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Condicion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function condicion_pk_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Condicion_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formato_access() as variant                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Formato_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formato_pk_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Formato_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_area( txval as variant ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_area', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_formato( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_formato', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_subarea( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_subarea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodetalle( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_tipodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function subarea_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Subarea_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodetalle_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Tipodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_area( txval as variant ) as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_area', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_formato( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_formato', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_subarea( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_subarea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodetalle( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_tipodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoarea() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridoarea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoatributo() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoformato() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoformato', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwtipodetalle() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridofwtipodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipodetalle() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridotipodetalle', lcParametros )
	EndFunc
