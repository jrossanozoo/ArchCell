...
define class Din_EntidadFamilia_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Familia"
	cClaseResponse = this.cNamespaceDTOs + ".FamiliaResponse"
	cClaseModelo = "FamiliaModelo"
	cEntidad = "Familia"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "FamiliaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FamiliaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FamiliaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "FamiliaModelo"
		endcase
		return lcRetorno
