...
define class Mock_Itemcomprobantederetencionesgananciasimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Itemcomprobantederetencionesgananciasimpuestosdetalle'
	...
	cAtributoPK = ""                                                                                                                                                                                                                                          
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cNombre = 'COMPROBANTEDERETENCIONESGANANCIAS'                                                                                                                                                                                                             
	datasession = 1                                                                                                                                                                                                                                           
	esRG1575AR = .F.                                                                                                                                                                                                                                          
	esRG2616AR = .F.                                                                                                                                                                                                                                          
	lBuscandoCodigo = .f.                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function acumuladocomprobantes_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Acumuladocomprobantes_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montocomprobanteorigen_assign( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Montocomprobanteorigen_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajedebase_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Porcentajedebase_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajedeconvenio_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Porcentajedeconvenio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_acumuladocomprobantes( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_acumuladocomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montocomprobanteorigen( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_montocomprobanteorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porcentajedebase( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_porcentajedebase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porcentajedeconvenio( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_porcentajedeconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_acumuladocomprobantes( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_acumuladocomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montocomprobanteorigen( txval as variant ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_montocomprobanteorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajedebase( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_porcentajedebase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajedeconvenio( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_porcentajedeconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridojurisdicciondescripcion() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridojurisdicciondescripcion', lcParametros )
	EndFunc
