...
define class Din_EntidadNotadedebitoelectronica_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadedebitoelectronica"
	cClaseResponse = this.cNamespaceDTOs + ".NotadedebitoelectronicaResponse"
	cClaseModelo = "NotadedebitoelectronicaModelo"
	cEntidad = "Notadedebitoelectronica"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadedebitoelectronicaModelo"
		endcase
		return lcRetorno
