...
define class Mock_Clasificacionarticuload_sqlserver as MockBase of MockBase.prg

	cClase = 'Clasificacionarticuload_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupub205( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupub205', lcParametros )
	EndFunc
