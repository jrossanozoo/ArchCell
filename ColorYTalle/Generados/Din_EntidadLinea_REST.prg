...
define class Din_EntidadLinea_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Linea"
	cClaseResponse = this.cNamespaceDTOs + ".LineaResponse"
	cClaseModelo = "LineaModelo"
	cEntidad = "Linea"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "LineaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "LineaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "LineaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "LineaModelo"
		endcase
		return lcRetorno
