...
define class Mock_Itemnotadecreditoelectronicadecreditoimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditoelectronicadecreditoimpuestoscomprobante'
