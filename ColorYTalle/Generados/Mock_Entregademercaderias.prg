...
define class Mock_entregademercaderias as MockBase of MockBase.prg
	...
	ZADSFW = ""                                                                                                                                                                                                                                               
	cAtributoAAuditar = ""                                                                                                                                                                                                                                    
	cAtributoComprobantAInsertar = "Remito"                                                                                                                                                                                                                   
	cAtributoPK = ""                                                                                                                                                                                                                                          
	cAtributoVendedor = ''                                                                                                                                                                                                                                    
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Entrega de mercaderías"                                                                                                                                                                                                                  
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cDetalleComprobante = "RemitoDetalle"                                                                                                                                                                                                                     
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'ENTREGADEMERCADERIAS'                                                                                                                                                                                                                          
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	cTipoComprobanteOrigen = "Remito"                                                                                                                                                                                                                         
	...
	oColaboradorCargarComprobantesAInsertar = null                                                                                                                                                                                                            
	oColaboradorEntregaDeMercaderias = null                                                                                                                                                                                                                   
	oColeccionRemitos = null                                                                                                                                                                                                                                  
	oColeccionRemitosOld = null                                                                                                                                                                                                                               
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oCompEntregaDeMercaderias = null                                                                                                                                                                                                                          
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleremitodetalle() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleremitodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoselecciondecomprobantesainsertar( topublicador as object, toargumentos as object ) as void                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventoselecciondecomprobantesainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarentidadendetalle( toentidad ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function obtenercomprobantesainsertar( tcxmlcomprobantespendientes as string ) as void                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcxmlcomprobantespendientes
		...
		return this.ObtenerResultado( 'Obtenercomprobantesainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorcargarcomprobantesainsertar_access() as object                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ENTREGADEMERCADERIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorcargarcomprobantesainsertar_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorcargarcomprobantesainsertar_access', lcParametros )			endif		endif		if !this.lDestroy and ( type( "this.oColaboradorCargarComprobantesAInsertar" ) <> "O" or isnull( this.oColaboradorCargarComprobantesAInsertar ) )			this.oColaboradorCargarComprobantesAInsertar = _screen.zoo.app.CrearObjeto( "ColaboradorCargarComprobantesAInsertar" )		endif		return this.oColaboradorCargarComprobantesAInsertar
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompentregademercaderias_access() as variant                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ENTREGADEMERCADERIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocompentregademercaderias_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocompentregademercaderias_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oCompEntregademercaderias ) = 'O' or isnull( this.oCompEntregademercaderias ) )			this.oCompEntregademercaderias = _Screen.zoo.InstanciarComponente( 'ComponenteEntregademercaderias' )		this.oCompEntregademercaderias.Inicializar()		this.enlazar( 'oCompEntregademercaderias.EventoObtenerLogueo', 'inyectarLogueo' )		this.enlazar( 'oCompEntregademercaderias.EventoObtenerInformacion', 'inyectarInformacion' )		endif		return this.oCompEntregademercaderias
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function remitodetalle_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ENTREGADEMERCADERIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'remitodetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'remitodetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Remitodetalle ) = 'O' or isnull( this.Remitodetalle ) )			this.Remitodetalle = this.crearobjeto( 'Din_DetalleEntregademercaderiasRemitodetalle' )			this.Remitodetalle.inicializar()			this.enlazar( 'Remitodetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Remitodetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Remitodetalle, 'CambioSumarizado', this, 'CambiosDetalleRemitodetalle', 1)			this.enlazar( 'Remitodetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Remitodetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Remitodetalle.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Remitodetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocolaboradorentregademercaderias_access() as object                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ENTREGADEMERCADERIAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorentregademercaderias_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorentregademercaderias_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oColaboradorCompletarDesdeVentas ) # "O"			this.ooColaboradorEntregaDeMercaderias = _Screen.zoo.crearobjeto( "ColaboradorEntregaDeMercaderias " )		endif		return this.oColaboradorEntregaDeMercaderias
	EndFunc
