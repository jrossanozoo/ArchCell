...
define class Din_ItemAJUSTECHEQUERECHAZADOAgrupublidetalle as ItemAgruPubliDetalle of ItemAgruPubliDetalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'AJUSTECHEQUERECHAZADO', 'Agrupublidetalle')
