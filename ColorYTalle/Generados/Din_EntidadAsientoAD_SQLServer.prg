...
define class Din_EntidadASIENTOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAsientoFmodifw, lxAsientoFecimpo, lxAsientoFaltafw, lxAsientoFectrans, lxAsientoFecexpo, lxAsientoCotiz, lxAsientoRevpor, lxAsientoBdaltafw, lxAsientoEsttrans, lxAsientoHaltafw, lxAsientoBdmodifw, lxAsientoHoraimpo, lxAsientoReversaa, lxAsientoZadsfw, lxAsientoVmodifw, lxAsientoValtafw, lxAsientoUaltafw, lxAsientoUmodifw, lxAsientoHmodifw, lxAsientoSmodifw, lxAsientoSaltafw, lxAsientoHoraexpo, lxAsientoNumaper, lxAsientoAcod, lxAsientoObs, lxAsientoFuente, lxAsientoEjercicio, lxAsientoContabiliz, lxAsientoCierreej, lxAsientoRsocial, lxAsientoNumero, lxAsientoFecha, lxAsientoTipoasient, lxAsientoClase, lxAsientoReferen, lxAsientoCcosto, lxAsientoMoneda
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ASIENTO ( "Fmodifw","Fecimpo","Faltafw","Fectrans","Fecexpo","Cotiz","Revpor","Bdaltafw","Esttrans","Haltafw","Bdmodifw","Horaimpo","Reversaa","Zadsfw","Vmodifw","Valtafw","Ualtafw","Umodifw","Hmodifw","Smodifw","Saltafw","Horaexpo","Numaper","Acod","Obs","Fuente","Ejercicio","Contabiliz","Cierreej","Rsocial","Numero","Fecha","Tipoasient","Clase","Referen","Ccosto","Moneda" ) values ( <<"'" + this.ConvertirDateSql( lxAsientoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAsientoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAsientoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAsientoFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAsientoFecexpo ) + "'" >>, <<lxAsientoCotiz >>, <<"'" + this.FormatearTextoSql( lxAsientoRevpor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoReversaa ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoHoraexpo ) + "'" >>, <<lxAsientoNumaper >>, <<"'" + this.FormatearTextoSql( lxAsientoAcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoFuente ) + "'" >>, <<lxAsientoEjercicio >>, <<lxAsientoContabiliz >>, <<lxAsientoCierreej >>, <<"'" + this.FormatearTextoSql( lxAsientoRsocial ) + "'" >>, <<lxAsientoNumero >>, <<"'" + this.ConvertirDateSql( lxAsientoFecha ) + "'" >>, <<lxAsientoTipoasient >>, <<lxAsientoClase >>, <<"'" + this.FormatearTextoSql( lxAsientoReferen ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoCcosto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAsientoMoneda ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.AsientoDetalle
				if this.oEntidad.AsientoDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxFechadelajuste = loItem.Fechadelajuste
					lxCuentaalaqueajusta = loItem.Cuentaalaqueajusta
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ASIENTODET("FechaAju","CAjustada","NROITEM","CODIGO","PCUENTA","PCUENTAD","Leyenda","CODCCOS","DEBE","HABER","SALDO" ) values ( <<"'" + this.ConvertirDateSql( lxFechadelajuste ) + "'">>, <<"'" + this.FormatearTextoSql( lxCuentaalaqueajusta ) + "'">>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxPlandecuentas_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxPlandecuentasdetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxLeyenda ) + "'">>, <<"'" + this.FormatearTextoSql( lxCentrodecosto_PK ) + "'">>, <<lxDebe>>, <<lxHaber>>, <<lxSaldo>> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ASIENTO set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxAsientoFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAsientoFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAsientoFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAsientoFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxAsientoFecexpo ) + "'">>,"Cotiz" = <<lxAsientoCotiz>>,"Revpor" = <<"'" + this.FormatearTextoSql( lxAsientoRevpor ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAsientoBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAsientoEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAsientoHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAsientoBdmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAsientoHoraimpo ) + "'">>,"Reversaa" = <<"'" + this.FormatearTextoSql( lxAsientoReversaa ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAsientoZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAsientoVmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAsientoValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAsientoUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAsientoUmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAsientoHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAsientoSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAsientoSaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAsientoHoraexpo ) + "'">>,"Numaper" = <<lxAsientoNumaper>>,"Acod" = <<"'" + this.FormatearTextoSql( lxAsientoAcod ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxAsientoObs ) + "'">>,"Fuente" = <<"'" + this.FormatearTextoSql( lxAsientoFuente ) + "'">>,"Ejercicio" = <<lxAsientoEjercicio>>,"Contabiliz" = <<lxAsientoContabiliz>>,"Cierreej" = <<lxAsientoCierreej>>,"Rsocial" = <<"'" + this.FormatearTextoSql( lxAsientoRsocial ) + "'">>,"Numero" = <<lxAsientoNumero>>,"Fecha" = <<"'" + this.ConvertirDateSql( lxAsientoFecha ) + "'">>,"Tipoasient" = <<lxAsientoTipoasient>>,"Clase" = <<lxAsientoClase>>,"Referen" = <<"'" + this.FormatearTextoSql( lxAsientoReferen ) + "'">>,"Ccosto" = <<"'" + this.FormatearTextoSql( lxAsientoCcosto ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxAsientoMoneda ) + "'">> where "Acod" = <<"'" + this.FormatearTextoSql( lxAsientoAcod ) + "'">> and  ASIENTO.ACOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Cotiz" as "Cotizacion", "Revpor" as "Reversadopor", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Reversaa" as "Reversaa", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Numaper" as "Numeroapertura", "Acod" as "Codigo", "Obs" as "Observacion", "Fuente" as "Fuente", "Ejercicio" as "Ejercicio", "Contabiliz" as "Contabilizacion", "Cierreej" as "Cierreejercicio", "Rsocial" as "Razonsocial", "Numero" as "Numero", "Fecha" as "Fecha", "Tipoasient" as "Tipo", "Clase" as "Clase", "Referen" as "Referencia", "Ccosto" as "Centrodecosto", "Moneda" as "Monedacomprobante" from ZooLogic.ASIENTO where "Acod" = <<"'" + this.FormatearTextoSql( lxAsientoAcod ) + "'">> and  ASIENTO.ACOD != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Fechaaju" as "Fechadelajuste", "Cajustada" as "Cuentaalaqueajusta", "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Pcuenta" as "Plandecuentas", "Pcuentad" as "Plandecuentasdetalle", "Leyenda" as "Leyenda", "Codccos" as "Centrodecosto", "Debe" as "Debe", "Haber" as "Haber", "Saldo" as "Saldo" from ZooLogic.ASIENTODET where CODIGO = <<"'" + this.FormatearTextoSql( c_ASIENTO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fecimpo,Faltafw,Fectrans,Fecexpo,Cotiz,Revpor,Bdaltafw,Esttrans,Haltafw,Bdmodifw,Hor" + ;
"aimpo,Reversaa,Zadsfw,Vmodifw,Valtafw,Ualtafw,Umodifw,Hmodifw,Smodifw,Saltafw,Horaexpo,Numaper,Acod," + ;
...
" from ZooLogic.ASIENTO where  ASIENTO.ACOD != '' and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAsientoDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fechaaju" as "Fechadelajuste", "Cajustada" as "Cuentaalaqueajusta", "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Pcuenta" as "Plandecuentas", "Pcuentad" as "Plandecuentasdetalle", "Leyenda" as "Leyenda", "Codccos" as "Centrodecosto", "Debe" as "Debe", "Haber" as "Haber", "Saldo" as "Saldo"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerCamposSelectDetalleAsientoDetalle( tcCampos As String ) As String
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			lcAtributo = upper( alltrim( getwordnum( tcCampos, i, ',' ) ) )
			Do Case
				Case lcAtributo == 'FECHADELAJUSTE'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'FECHAAJU AS FECHADELAJUSTE'
				Case lcAtributo == 'CUENTAALAQUEAJUSTA'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'CAJUSTADA AS CUENTAALAQUEAJUSTA'
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerCampoDetalleAsientoDetalle( tcAtributo As String ) As String
		...
		lcCampo = ''
		Do Case
			Case upper( alltrim( tcAtributo ) ) == 'FECHADELAJUSTE'
				lcCampo = 'FECHAAJU'
			Case upper( alltrim( tcAtributo ) ) == 'CUENTAALAQUEAJUSTA'
				lcCampo = 'CAJUSTADA'
		...
		With this
			...
			for each loItem in this.oEntidad.AsientoDetalle
				if this.oEntidad.AsientoDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxSaldo = loItem.Saldo
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ASIENTODET("FechaAju","CAjustada","NROITEM","CODIGO","PCUENTA","PCUENTAD","Leyenda","CODCCOS","DEBE","HABER","SALDO" ) values ( <<"'" + this.ConvertirDateSql( lxFechadelajuste ) + "'">>, <<"'" + this.FormatearTextoSql( lxCuentaalaqueajusta ) + "'">>, <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxPlandecuentas_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxPlandecuentasdetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxLeyenda ) + "'">>, <<"'" + this.FormatearTextoSql( lxCentrodecosto_PK ) + "'">>, <<lxDebe>>, <<lxHaber>>, <<lxSaldo>> ) 
					endtext
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.ACOD or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.ASIENTO set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, RevPor = ] + "'" + this.FormatearTextoSql( &lcCursor..RevPor ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ReversaA = ] + "'" + this.FormatearTextoSql( &lcCursor..ReversaA ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, NumAper = ] + transform( &lcCursor..NumAper )+ [, ACOD = ] + "'" + this.FormatearTextoSql( &lcCursor..ACOD ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Fuente = ] + "'" + this.FormatearTextoSql( &lcCursor..Fuente ) + "'"+ [, Ejercicio = ] + transform( &lcCursor..Ejercicio )+ [, Contabiliz = ] + transform( &lcCursor..Contabiliz )+ [, CierreEj = ] + transform( &lcCursor..CierreEj )+ [, RSOCIAL = ] + "'" + this.FormatearTextoSql( &lcCursor..RSOCIAL ) + "'"+ [, NUMERO = ] + transform( &lcCursor..NUMERO )+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, TipoAsient = ] + transform( &lcCursor..TipoAsient )+ [, Clase = ] + transform( &lcCursor..Clase )+ [, REFEREN = ] + "'" + this.FormatearTextoSql( &lcCursor..REFEREN ) + "'"+ [, CCOSTO = ] + "'" + this.FormatearTextoSql( &lcCursor..CCOSTO ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + [ Where ACOD = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FMODIFW, FECIMPO, FALTAFW, FECTRANS, FECEXPO, Cotiz, RevPor, BDALTAFW, ESTTRANS, HALTAFW, BDMODIFW, HORAIMPO, ReversaA, ZADSFW, VMODIFW, VALTAFW, UALTAFW, UMODIFW, HMODIFW, SMODIFW, SALTAFW, HORAEXPO, NumAper, ACOD, Obs, Fuente, Ejercicio, Contabiliz, CierreEj, RSOCIAL, NUMERO, Fecha, TipoAsient, Clase, REFEREN, CCOSTO, Moneda
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..RevPor ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ReversaA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + transform( &lcCursor..NumAper ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ACOD ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Fuente ) + "'" + ',' + transform( &lcCursor..Ejercicio ) + ',' + transform( &lcCursor..Contabiliz ) + ',' + transform( &lcCursor..CierreEj )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..RSOCIAL ) + "'" + ',' + transform( &lcCursor..NUMERO ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'" + ',' + transform( &lcCursor..TipoAsient ) + ',' + transform( &lcCursor..Clase ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..REFEREN ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CCOSTO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"FechaAju","CAjustada","NROITEM","CODIGO","PCUENTA","PCUENTAD","Leyenda","CODCCOS","DEBE","HABER","SALDO"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.ASIENTODET ( ] + lcCamposInsert + [ ) values ( ] +  "'" + this.ConvertirDateSql( cDetallesExistentes.FechaAju   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.CAjustada  ) + "'" + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.CODIGO     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.PCUENTA    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.PCUENTAD   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Leyenda    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.CODCCOS    ) + "'" + ',' + transform( cDetallesExistentes.DEBE       ) + ',' + transform( cDetallesExistentes.HABER      ) + ',' + transform( cDetallesExistentes.SALDO      ) + ' )'  )
		select cDetallesExistentes
	EndScan
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.REVPOR = isnull( d.REVPOR, t.REVPOR ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.REVERSAA = isnull( d.REVERSAA, t.REVERSAA ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.NUMAPER = isnull( d.NUMAPER, t.NUMAPER ),t.ACOD = isnull( d.ACOD, t.ACOD ),t.OBS = isnull( d.OBS, t.OBS ),t.FUENTE = isnull( d.FUENTE, t.FUENTE ),t.EJERCICIO = isnull( d.EJERCICIO, t.EJERCICIO ),t.CONTABILIZ = isnull( d.CONTABILIZ, t.CONTABILIZ ),t.CIERREEJ = isnull( d.CIERREEJ, t.CIERREEJ ),t.RSOCIAL = isnull( d.RSOCIAL, t.RSOCIAL ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.TIPOASIENT = isnull( d.TIPOASIENT, t.TIPOASIENT ),t.CLASE = isnull( d.CLASE, t.CLASE ),t.REFEREN = isnull( d.REFEREN, t.REFEREN ),t.CCOSTO = isnull( d.CCOSTO, t.CCOSTO ),t.MONEDA = isnull( d.MONEDA, t.MONEDA )
					from ZooLogic.ASIENTO t inner join deleted d 
							 on t.ACOD = d.ACOD
							 and  t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.ASIENTO(Fmodifw,Fecimpo,Faltafw,Fectrans,Fecexpo,Cotiz,Revpor,Bdaltafw,Esttrans,Haltafw,Bdmodifw,Horaimpo,Reversaa,Zadsfw,Vmodifw,Valtafw,Ualtafw,Umodifw,Hmodifw,Smodifw,Saltafw,Horaexpo,Numaper,Acod,Obs,Fuente,Ejercicio,Contabiliz,Cierreej,Rsocial,Numero,Fecha,Tipoasient,Clase,Referen,Ccosto,Moneda)
					Select isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),isnull( d.COTIZ,0),isnull( d.REVPOR,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.REVERSAA,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.NUMAPER,0),isnull( d.ACOD,''),isnull( d.OBS,''),isnull( d.FUENTE,''),isnull( d.EJERCICIO,0),isnull( d.CONTABILIZ,0),isnull( d.CIERREEJ,0),isnull( d.RSOCIAL,''),isnull( d.NUMERO,0),isnull( d.FECHA,''),isnull( d.TIPOASIENT,0),isnull( d.CLASE,0),isnull( d.REFEREN,''),isnull( d.CCOSTO,''),isnull( d.MONEDA,'')
...
Begin
Update t Set 
t.FECHAAJU = isnull( d.FECHAAJU, t.FECHAAJU ),
t.CAJUSTADA = isnull( d.CAJUSTADA, t.CAJUSTADA ),
...
<VFPData xml:space="preserve">
	...
	<row entidad="ASIENTO                                 " atributo="FECHATRANSFERENCIA                      " tabla="ASIENTO        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ASIENTO                                 " atributo="ESTADOTRANSFERENCIA                     " tabla="ASIENTO        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ASIENTO                                 " atributo="NUMERO                                  " tabla="ASIENTO        " campo="NUMERO    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="2" etiqueta="Asiento número                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ASIENTO                                 " atributo="FECHA                                   " tabla="ASIENTO        " campo="FECHA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="4" etiqueta="Fecha                                                                                                                                                           " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ASIENTO                                 " atributo="CENTRODECOSTO                           " tabla="ASIENTO        " campo="CCOSTO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CENTRODECOSTO                           " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Centro de costos antigua                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="60" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ASIENTO                                 " atributo="CENTRODECOSTOVIRTUAL                    " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CENTRODECOSTO                           " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Centro de costos                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ASIENTO                                 " atributo="ASIENTODETALLE                          " tabla="ASIENTODET     " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Cuentas                                                                                                                                                         " dominio="DETALLEITEMASIENTO            " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="100" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
