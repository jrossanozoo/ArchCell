...
define class Din_EntidadImpdirccc_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Impdirccc"
	cClaseResponse = this.cNamespaceDTOs + ".ImpdircccResponse"
	cClaseModelo = "ImpdircccModelo"
	cEntidad = "Impdirccc"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdircccModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdircccListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdircccListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ImpdircccModelo"
		endcase
		return lcRetorno
