...
define class Din_EntidadCOMPROBANTEPAGO as ENTCOLORYTALLE_COMPROBANTEDECOMPRASCONVALORES of ENTCOLORYTALLE_COMPROBANTEDECOMPRASCONVALORES.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarNumero() as boolean
		...
		if empty( this.Numero )
			this.AgregarInformacion( 'Debe cargar el campo Número comprobante', 9005, 'Numero' )
			llRetorno = .F.
		endif
		return llRetorno
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><CONVALORES><COMPRAS><VALORCIERRE><LISTARMODIFICACION>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
