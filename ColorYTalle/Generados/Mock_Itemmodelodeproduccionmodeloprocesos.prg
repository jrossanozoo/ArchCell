...
define class Mock_Itemmodelodeproduccionmodeloprocesos as MockBase of MockBase.prg

	cClase = 'Itemmodelodeproduccionmodeloprocesos'
	...
	*-----------------------------------------------------------------------------------------
	function cantidaddesalida_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cantidaddesalida_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidaddesalida( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_cantidaddesalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidaddesalida( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_cantidaddesalida', lcParametros )
	EndFunc
