...
define class Mock_Tallerad_sqlserver as MockBase of MockBase.prg

	cClase = 'Tallerad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_tallerproc( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_tallerproc', lcParametros )
	EndFunc
