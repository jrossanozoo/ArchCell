...
define class Mock_Saltodecampoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Saltodecampoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubsdc( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubsdc', lcParametros )
	EndFunc
