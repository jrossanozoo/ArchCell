...
define class Din_EntidadACCIONESAUTOMATICASAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAccautFecexpo, lxAccautFectrans, lxAccautFmodifw, lxAccautFaltafw, lxAccautFecimpo, lxAccautSaltafw, lxAccautHoraimpo, lxAccautHmodifw, lxAccautSmodifw, lxAccautUmodifw, lxAccautUaltafw, lxAccautZadsfw, lxAccautValtafw, lxAccautVmodifw, lxAccautHoraexpo, lxAccautHaltafw, lxAccautBdmodifw, lxAccautBdaltafw, lxAccautEsttrans, lxAccautNuevodg, lxAccautCodigo, lxAccautEntidad, lxAccautValocier, lxAccautRestpick, lxAccautObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ACCAUT ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Saltafw","Horaimpo","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Horaexpo","Haltafw","Bdmodifw","Bdaltafw","Esttrans","Nuevodg","Codigo","Entidad","Valocier","Restpick","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxAccautFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAccautFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAccautFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAccautFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAccautFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautEsttrans ) + "'" >>, <<iif( lxAccautNuevodg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAccautCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautEntidad ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAccautValocier ) + "'" >>, <<iif( lxAccautRestpick, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAccautObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ACCAUT set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAccautFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAccautFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAccautFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAccautFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAccautFecimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAccautSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAccautHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAccautHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAccautSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAccautUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAccautUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAccautZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAccautValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAccautVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAccautHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAccautHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAccautBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAccautBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAccautEsttrans ) + "'">>,"Nuevodg" = <<iif( lxAccautNuevodg, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAccautCodigo ) + "'">>,"Entidad" = <<"'" + this.FormatearTextoSql( lxAccautEntidad ) + "'">>,"Valocier" = <<"'" + this.FormatearTextoSql( lxAccautValocier ) + "'">>,"Restpick" = <<iif( lxAccautRestpick, 1, 0 )>>,"Obs" = <<"'" + this.FormatearTextoSql( lxAccautObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxAccautCodigo ) + "'">> and  ACCAUT.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Nuevodg" as "Nuevodespuesdegrabar", "Codigo" as "Codigo", "Entidad" as "Entidad", "Valocier" as "Valordecierre", "Restpick" as "Restringirpicking", "Obs" as "Observacion" from ZooLogic.ACCAUT where  ACCAUT.CODIGO != '' And Entidad = <<"'" + this.FormatearTextoSql( lxACCAUTEntidad ) + "'">>
			endtext
			use in select('c_ACCIONESAUTOMATICAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ACCIONESAUTOMATICAS', set( 'Datasession' ) )
			if reccount( 'c_ACCIONESAUTOMATICAS' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Nuevodg" as "Nuevodespuesdegrabar", "Codigo" as "Codigo", "Entidad" as "Entidad", "Valocier" as "Valordecierre", "Restpick" as "Restringirpicking", "Obs" as "Observacion" from ZooLogic.ACCAUT where  ACCAUT.CODIGO != '' order by Entidad
			endtext
			use in select('c_ACCIONESAUTOMATICAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ACCIONESAUTOMATICAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Nuevodg" as "Nuevodespuesdegrabar", "Codigo" as "Codigo", "Entidad" as "Entidad", "Valocier" as "Valordecierre", "Restpick" as "Restringirpicking", "Obs" as "Observacion" from ZooLogic.ACCAUT where  funciones.padr( Entidad, 40, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ACCAUT.CODIGO != '' order by Entidad
			endtext
			use in select('c_ACCIONESAUTOMATICAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ACCIONESAUTOMATICAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Nuevodg" as "Nuevodespuesdegrabar", "Codigo" as "Codigo", "Entidad" as "Entidad", "Valocier" as "Valordecierre", "Restpick" as "Restringirpicking", "Obs" as "Observacion" from ZooLogic.ACCAUT where  funciones.padr( Entidad, 40, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ACCAUT.CODIGO != '' order by Entidad desc
			endtext
			use in select('c_ACCIONESAUTOMATICAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ACCIONESAUTOMATICAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Nuevodg" as "Nuevodespuesdegrabar", "Codigo" as "Codigo", "Entidad" as "Entidad", "Valocier" as "Valordecierre", "Restpick" as "Restringirpicking", "Obs" as "Observacion" from ZooLogic.ACCAUT where  ACCAUT.CODIGO != '' order by Entidad desc
			endtext
			use in select('c_ACCIONESAUTOMATICAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ACCIONESAUTOMATICAS', set( 'Datasession' ) )
			local lcSentencia as string
...
"dsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Nuevodg,Codigo,Entidad,Valocier,Res" + ;
"tpick,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Nuevodg" as "Nuevodespuesdegrabar", "Codigo" as "Codigo", "Entidad" as "Entidad", "Valocier" as "Valordecierre", "Restpick" as "Restringirpicking", "Obs" as "Observacion"
				endtext
			Else
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.ACCAUT set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, NuevoDG = ] + Transform( iif( &lcCursor..NuevoDG, 1, 0 ))+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Entidad = ] + "'" + this.FormatearTextoSql( &lcCursor..Entidad ) + "'"+ [, ValoCier = ] + "'" + this.FormatearTextoSql( &lcCursor..ValoCier ) + "'"+ [, RestPick = ] + Transform( iif( &lcCursor..RestPick, 1, 0 ))+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, SALTAFW, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HORAEXPO, HALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, NuevoDG, Codigo, Entidad, ValoCier, RestPick, Obs
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + Transform( iif( &lcCursor..NuevoDG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.NUEVODG = isnull( d.NUEVODG, t.NUEVODG ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.ENTIDAD = isnull( d.ENTIDAD, t.ENTIDAD ),t.VALOCIER = isnull( d.VALOCIER, t.VALOCIER ),t.RESTPICK = isnull( d.RESTPICK, t.RESTPICK ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.ACCAUT t inner join deleted d 
							 on t.Codigo = d.Codigo
							 and  t.Entidad = d.Entidad
				-- Fin Updates
				insert into ZooLogic.ACCAUT(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Nuevodg,Codigo,Entidad,Valocier,Restpick,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.NUEVODG,0),isnull( d.CODIGO,''),isnull( d.ENTIDAD,''),isnull( d.VALOCIER,''),isnull( d.RESTPICK,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="ACCIONESAUTOMATICAS                     " atributo="FECHATRANSFERENCIA                      " tabla="ACCAUT         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ACCIONESAUTOMATICAS                     " atributo="ESTADOTRANSFERENCIA                     " tabla="ACCAUT         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVAL           " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="3" etiqueta="Detalle Val.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVAL On ACCAUT.VALOCIER = XVAL.CLCOD And  XVAL.CLCOD != ''                                                                                                                                                                                         " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
