...
define class Din_EntidadJurisdiccion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Jurisdiccion"
	cClaseResponse = this.cNamespaceDTOs + ".JurisdiccionResponse"
	cClaseModelo = "JurisdiccionModelo"
	cEntidad = "Jurisdiccion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "JurisdiccionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "JurisdiccionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "JurisdiccionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "JurisdiccionModelo"
		endcase
		return lcRetorno
