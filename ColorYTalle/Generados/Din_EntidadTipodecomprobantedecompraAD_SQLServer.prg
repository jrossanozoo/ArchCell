...
define class Din_EntidadTIPODECOMPROBANTEDECOMPRAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTipocompcomFmodifw, lxTipocompcomFectrans, lxTipocompcomFecimpo, lxTipocompcomFaltafw, lxTipocompcomFecexpo, lxTipocompcomHoraexpo, lxTipocompcomHaltafw, lxTipocompcomHoraimpo, lxTipocompcomHmodifw, lxTipocompcomVmodifw, lxTipocompcomZadsfw, lxTipocompcomValtafw, lxTipocompcomUaltafw, lxTipocompcomUmodifw, lxTipocompcomSaltafw, lxTipocompcomSmodifw, lxTipocompcomEsttrans, lxTipocompcomBdmodifw, lxTipocompcomCodigocor, lxTipocompcomBdaltafw, lxTipocompcomCodigo, lxTipocompcomTipocompor, lxTipocompcomCodope, lxTipocompcomPorliquia, lxTipocompcomIvaliquia, lxTipocompcomDespacho, lxTipocompcomAnodespa, lxTipocompcomCodaduana, lxTipocompcomTipodestin, lxTipocompcomNrodespa, lxTipocompcomDigverif
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TIPOCOMPCOM ( "Fmodifw","Fectrans","Fecimpo","Faltafw","Fecexpo","Horaexpo","Haltafw","Horaimpo","Hmodifw","Vmodifw","Zadsfw","Valtafw","Ualtafw","Umodifw","Saltafw","Smodifw","Esttrans","Bdmodifw","Codigocor","Bdaltafw","Codigo","Tipocompor","Codope","Porliquia","Ivaliquia","Despacho","Anodespa","Codaduana","Tipodestin","Nrodespa","Digverif" ) values ( <<"'" + this.ConvertirDateSql( lxTipocompcomFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipocompcomFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipocompcomFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipocompcomFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipocompcomFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomCodigocor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomCodigo ) + "'" >>, <<lxTipocompcomTipocompor >>, <<"'" + this.FormatearTextoSql( lxTipocompcomCodope ) + "'" >>, <<lxTipocompcomPorliquia >>, <<lxTipocompcomIvaliquia >>, <<"'" + this.FormatearTextoSql( lxTipocompcomDespacho ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomAnodespa ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomCodaduana ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomTipodestin ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomNrodespa ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipocompcomDigverif ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TIPOCOMPCOM set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTipocompcomFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTipocompcomFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTipocompcomFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTipocompcomFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxTipocompcomFecexpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTipocompcomHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTipocompcomHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTipocompcomHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTipocompcomHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTipocompcomVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTipocompcomZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTipocompcomValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTipocompcomUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTipocompcomUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTipocompcomSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTipocompcomSmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTipocompcomEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTipocompcomBdmodifw ) + "'">>,"Codigocor" = <<"'" + this.FormatearTextoSql( lxTipocompcomCodigocor ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTipocompcomBdaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxTipocompcomCodigo ) + "'">>,"Tipocompor" = <<lxTipocompcomTipocompor>>,"Codope" = <<"'" + this.FormatearTextoSql( lxTipocompcomCodope ) + "'">>,"Porliquia" = <<lxTipocompcomPorliquia>>,"Ivaliquia" = <<lxTipocompcomIvaliquia>>,"Despacho" = <<"'" + this.FormatearTextoSql( lxTipocompcomDespacho ) + "'">>,"Anodespa" = <<"'" + this.FormatearTextoSql( lxTipocompcomAnodespa ) + "'">>,"Codaduana" = <<"'" + this.FormatearTextoSql( lxTipocompcomCodaduana ) + "'">>,"Tipodestin" = <<"'" + this.FormatearTextoSql( lxTipocompcomTipodestin ) + "'">>,"Nrodespa" = <<"'" + this.FormatearTextoSql( lxTipocompcomNrodespa ) + "'">>,"Digverif" = <<"'" + this.FormatearTextoSql( lxTipocompcomDigverif ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxTipocompcomCodigo ) + "'">> and  TIPOCOMPCOM.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecimpo,Faltafw,Fecexpo,Horaexpo,Haltafw,Horaimpo,Hmodifw,Vmodifw,Zadsfw,Va" + ;
"ltafw,Ualtafw,Umodifw,Saltafw,Smodifw,Esttrans,Bdmodifw,Codigocor,Bdaltafw,Codigo,Tipocompor,Codope," + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FMODIFW, FECTRANS, FECIMPO, FALTAFW, FECEXPO, HORAEXPO, HALTAFW, HORAIMPO, HMODIFW, VMODIFW, ZADSFW, VALTAFW, UALTAFW, UMODIFW, SALTAFW, SMODIFW, ESTTRANS, BDMODIFW, CodigoCOr, BDALTAFW, Codigo, TipoCompOr, CodOpe, PorLiquiA, IvaLiquiA, Despacho, AnoDespa, CodAduana, TipoDestin, NroDespa, DigVerif
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodigoCOr ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CODIGOCOR = isnull( d.CODIGOCOR, t.CODIGOCOR ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.TIPOCOMPOR = isnull( d.TIPOCOMPOR, t.TIPOCOMPOR ),t.CODOPE = isnull( d.CODOPE, t.CODOPE ),t.PORLIQUIA = isnull( d.PORLIQUIA, t.PORLIQUIA ),t.IVALIQUIA = isnull( d.IVALIQUIA, t.IVALIQUIA ),t.DESPACHO = isnull( d.DESPACHO, t.DESPACHO ),t.ANODESPA = isnull( d.ANODESPA, t.ANODESPA ),t.CODADUANA = isnull( d.CODADUANA, t.CODADUANA ),t.TIPODESTIN = isnull( d.TIPODESTIN, t.TIPODESTIN ),t.NRODESPA = isnull( d.NRODESPA, t.NRODESPA ),t.DIGVERIF = isnull( d.DIGVERIF, t.DIGVERIF )
					from ZooLogic.TIPOCOMPCOM t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.TIPOCOMPCOM(Fmodifw,Fectrans,Fecimpo,Faltafw,Fecexpo,Horaexpo,Haltafw,Horaimpo,Hmodifw,Vmodifw,Zadsfw,Valtafw,Ualtafw,Umodifw,Saltafw,Smodifw,Esttrans,Bdmodifw,Codigocor,Bdaltafw,Codigo,Tipocompor,Codope,Porliquia,Ivaliquia,Despacho,Anodespa,Codaduana,Tipodestin,Nrodespa,Digverif)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.CODIGOCOR,''),isnull( d.BDALTAFW,''),isnull( d.CODIGO,''),isnull( d.TIPOCOMPOR,0),isnull( d.CODOPE,''),isnull( d.PORLIQUIA,0),isnull( d.IVALIQUIA,0),isnull( d.DESPACHO,''),isnull( d.ANODESPA,''),isnull( d.CODADUANA,''),isnull( d.TIPODESTIN,''),isnull( d.NRODESPA,''),isnull( d.DIGVERIF,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIPODECOMPROBANTEDECOMPRA               " atributo="FECHATRANSFERENCIA                      " tabla="TIPOCOMPCOM    " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPODECOMPROBANTEDECOMPRA               " atributo="ESTADOTRANSFERENCIA                     " tabla="TIPOCOMPCOM    " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
