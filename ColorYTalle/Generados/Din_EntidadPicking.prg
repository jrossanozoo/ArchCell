...
define class Din_EntidadPICKING as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function SetearEstadoNuevoEnItems() as Void
		...
		this.DetalleDiferencias.oItem.lNuevo = this.lNuevo
		this.DetalleControlado.oItem.lNuevo = this.lNuevo
		this.DetalleCoincidencias.oItem.lNuevo = this.lNuevo
		this.DetalleDiferenciasOriginal.oItem.lNuevo = this.lNuevo
		this.DetallePreparacionMercaderia.oItem.lNuevo = this.lNuevo
	...
	*--------------------------------------------------------------------------------------------------------
	function SetearEstadoEdicionEnItems() as Void
		...
		this.DetalleDiferencias.oItem.lEdicion = this.lEdicion
		this.DetalleControlado.oItem.lEdicion = this.lEdicion
		this.DetalleCoincidencias.oItem.lEdicion = this.lEdicion
		this.DetalleDiferenciasOriginal.oItem.lEdicion = this.lEdicion
		this.DetallePreparacionMercaderia.oItem.lEdicion = this.lEdicion
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local lnLargoDecimal as integer, lnLargoEntero as Integer, lnLargoDecimal as integer, llRetorno as boolean 
		...
		if ( vartype( this.EsPreparacionDeMercaderia) = 'L' )
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo ESPREPARACIONDEMERCADERIA no es el correcto.')
			llRetorno = .F.
		Endif
		...
		if ( vartype( this.TipoComprobanteOrigen) = 'C' )
			if len( alltrim( this.TIPOCOMPROBANTEORIGEN ) ) > 40
				This.AgregarInformacion( 'La longitud del valor del atributo TIPOCOMPROBANTEORIGEN es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionDetalles() as Boolean
		...
		llRetorno = This.ValidarUnDetalle( this.DetalleDiferencias, 'Diferencias encontradas' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.DetalleControlado, 'Artículos controlados' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.DetalleCoincidencias, 'Coincidencias encontradas' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.DetalleDiferenciasOriginal, 'Diferencias originales encontradas' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.DetallePreparacionMercaderia, 'Unidades en preparación' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.DetalleComprobantes, 'Comprobantes a controlar' ) and llRetorno
		return llRetorno
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<NOIMPO><NOEXPO><RELAENTIDAD><WEBHOOK>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as Void
		...
		this.oColeccionVSFW.agregar('.ValorSugeridoFWTipocomprobanteorigen()','Tipocomprobanteorigen')
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'PICKING', '')
		...
		this.lWHIngresar = goServicios.WebHook.TieneQueMandar( 'PICKING', 'INGRESAR' )
		this.lWHModificar = goServicios.WebHook.TieneQueMandar( 'PICKING', 'MODIFICAR' )
		this.lWHEliminar = goServicios.WebHook.TieneQueMandar( 'PICKING', 'ELIMINAR' )
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoObs() as void
		...
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "PICKING", "", "Obs" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoTipocomprobanteorigen() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "PICKING", "", "Tipocomprobanteorigen" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						This.EventoEstaSeteandoValorSugerido( 'Tipocomprobanteorigen' )
						.Tipocomprobanteorigen = lvValorSugeridoDefinidoPorElUsuario
					catch to loError
						loEx = newobject("zooexception", "zooexception.prg" )
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
				...
				.ValorSugeridoFWTipocomprobanteorigen()
			endif
		endwith
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWTipocomprobanteorigen() as void
		with this
			.Tipocomprobanteorigen = alltrim(goParametros.Felino.Picking.ComprobanteDefaultParaNuevoPicking)
		endwith
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoVendedor() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "PICKING", "", "Vendedor" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoCliente() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "PICKING", "", "Cliente" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
			...
			Catch to loError
				...
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					...
					loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Cliente para la entidad Picking." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
					goServicios.Errores.LevantarExcepcion( loEx )
				endif
			endtry 
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoClientedescripcion() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "PICKING", "", "Clientedescripcion" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerNombreDetallesConPrePantalla() as ZooColeccion of ZooColeccion.prg
		...
		loRetorno.Agregar("DetalleControlado")
		return loRetorno
	endfunc
