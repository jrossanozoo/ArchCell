...
define class Mock_Itemredondeodepreciosdetredondeoporcentavo as MockBase of MockBase.prg

	cClase = 'Itemredondeodepreciosdetredondeoporcentavo'
	...
	*-----------------------------------------------------------------------------------------
	function desdeprecio_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Desdeprecio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hastaprecio_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Hastaprecio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_desdeprecio( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_desdeprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_hastaprecio( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_hastaprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_terminacion( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_terminacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_terminacioncaracter( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_terminacioncaracter', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function terminacion_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Terminacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function terminacioncaracter_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Terminacioncaracter_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_desdeprecio( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_desdeprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_hastaprecio( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_hastaprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_terminacion( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_terminacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_terminacioncaracter( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_terminacioncaracter', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodesdeprecio() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridodesdeprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohastaprecio() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridohastaprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoterminacioncaracter() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridoterminacioncaracter', lcParametros )
	EndFunc
