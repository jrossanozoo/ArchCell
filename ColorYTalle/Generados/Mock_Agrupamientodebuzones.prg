...
define class Mock_agrupamientodebuzones as MockBase of MockBase.prg
	...
	cClase = 'agrupamientodebuzones'

	
	AgrupamientoBuzonesDetalle = null                                                                                                                                                                                                                         
	BASEDEDATOSALTAFW = ""                                                                                                                                                                                                                                    
	...
	cCursorAgrup = ""                                                                                                                                                                                                                                         
	cCursorBase = ""                                                                                                                                                                                                                                          
	cDescripcion =  "Agrupamientos de buzones"                                                                                                                                                                                                                
	...
	*-----------------------------------------------------------------------------------------
	function agrupamientobuzonesdetalle_access() as variant                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AGRUPAMIENTODEBUZONES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'agrupamientobuzonesdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'agrupamientobuzonesdetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Agrupamientobuzonesdetalle ) = 'O' or isnull( this.Agrupamientobuzonesdetalle ) )			this.Agrupamientobuzonesdetalle = this.crearobjeto( 'Din_DetalleAgrupamientodebuzonesAgrupamientobuzonesdetalle' )			this.Agrupamientobuzonesdetalle.inicializar()			this.enlazar( 'Agrupamientobuzonesdetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Agrupamientobuzonesdetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Agrupamientobuzonesdetalle, 'CambioSumarizado', this, 'CambiosDetalleAgrupamientobuzonesdetalle', 1)			this.enlazar( 'Agrupamientobuzonesdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Agrupamientobuzonesdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Agrupamientobuzonesdetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignaratributoforaneo( tcatributo as string, toitem as object ) as void                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Asignaratributoforaneo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buzonesdetalle_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AGRUPAMIENTODEBUZONES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'buzonesdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'buzonesdetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Buzonesdetalle ) = 'O' or isnull( this.Buzonesdetalle ) )			this.Buzonesdetalle = this.crearobjeto( 'Din_DetalleAgrupamientodebuzonesBuzonesdetalle' )			this.Buzonesdetalle.inicializar()			this.enlazar( 'Buzonesdetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Buzonesdetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Buzonesdetalle, 'CambioSumarizado', this, 'CambiosDetalleBuzonesdetalle', 1)			this.enlazar( 'Buzonesdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Buzonesdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Buzonesdetalle
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalleagrupamientobuzonesdetalle() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleagrupamientobuzonesdetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallebuzonesdetalle() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallebuzonesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbuzonesdeunagrupamiento ( tcagrupamiento as string ) as object                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerbuzonesdeunagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercontenidodeunagrupamiento( tcagrupamiento ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercontenidodeunagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarconsistenciaalborrar() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarconsistenciaalborrar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizaragrupamientobuzonesdetalle() as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizaragrupamientobuzonesdetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function actualizarbuzonesdetalle() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarbuzonesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function armarvalidacion( tccursor as string, tctipo as string ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Armarvalidacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargaratributosentidad() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargaratributosentidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargarcoleccionagrupamientoseleccionado() as zoocoleccion of zoocoleccion.prg                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcoleccionagrupamientoseleccionado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargarcoleccionbuzonseleccionada() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcoleccionbuzonseleccionada', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargarcursor( tccodigo as string, tccodigopadre as string, tccursor as string ) as viod                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tccodigo
		lxParam2 = tccodigopadre
		lxParam3 = tccursor
		...
		return this.ObtenerResultado( 'Cargarcursor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function contaritemencoleccion( tocoleccion as object ) as integer                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Contaritemencoleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminarenagrupamientos( tccodigo as string )                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eliminarenagrupamientos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llenaragrupamientobuzonesdetalle() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Llenaragrupamientobuzonesdetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarbuzonesdetalle() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Llenarbuzonesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recorreragrupamientos( tccodigo as string ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Recorreragrupamientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function recorrerbuzonesdetalle( toagrupamientos as object ) as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toagrupamientos
		...
		return this.ObtenerResultado( 'Recorrerbuzonesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarexistenciaagrupamiento() as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarexistenciaagrupamiento', lcParametros )
	EndFunc
