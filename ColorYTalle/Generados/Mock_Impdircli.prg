...
define class Mock_impdircli as MockBase of MockBase.prg
	...
	f_Pais_Hasta = null                                                                                                                                                                                                                                       
	f_Pais_Hasta_PK = ""                                                                                                                                                                                                                                      
	f_Provincia_Desde = null                                                                                                                                                                                                                                  
	f_Provincia_Desde_PK = ""                                                                                                                                                                                                                                 
	f_Provincia_Hasta = null                                                                                                                                                                                                                                  
	f_Provincia_Hasta_PK = ""                                                                                                                                                                                                                                 
	...
	f_Tipo_Hasta = null                                                                                                                                                                                                                                       
	f_Tipo_Hasta_PK = ""                                                                                                                                                                                                                                      
	f_Vendedor_Desde = null                                                                                                                                                                                                                                   
	f_Vendedor_Desde_PK = ""                                                                                                                                                                                                                                  
	f_Vendedor_Hasta = null                                                                                                                                                                                                                                   
	f_Vendedor_Hasta_PK = ""                                                                                                                                                                                                                                  
	f_idglobal_Desde = ""                                                                                                                                                                                                                                     
	f_idglobal_Hasta = ""                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function f_categoria_desde_access() as variant                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_categoria_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_categoria_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_categoria_desde ) = 'O' or isnull( this.F_categoria_desde ) )					this.F_categoria_desde = _Screen.zoo.instanciarentidad( 'Categoriacliente' )					this.F_categoria_desde.lEsSubEntidad = .t.					this.enlazar( 'F_categoria_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_categoria_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_categoria_desde.CODIGO # this.F_categoria_desde_PK						this.F_categoria_desde.CODIGO = this.F_categoria_desde_PK					endif				endif			endif		endif		return this.F_categoria_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_categoria_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_categoria_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_categoria_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_categoria_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_categoria_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_categoria_hasta_access() as variant                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_categoria_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_categoria_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_categoria_hasta ) = 'O' or isnull( this.F_categoria_hasta ) )					this.F_categoria_hasta = _Screen.zoo.instanciarentidad( 'Categoriacliente' )					this.F_categoria_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_categoria_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_categoria_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_categoria_hasta.CODIGO # this.F_categoria_hasta_PK						this.F_categoria_hasta.CODIGO = this.F_categoria_hasta_PK					endif				endif			endif		endif		return this.F_categoria_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_categoria_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_categoria_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_categoria_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_categoria_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_categoria_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_clasificacion_desde_access() as variant                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_clasificacion_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_clasificacion_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_clasificacion_desde ) = 'O' or isnull( this.F_clasificacion_desde ) )					this.F_clasificacion_desde = _Screen.zoo.instanciarentidad( 'Clasificacioncliente' )					this.F_clasificacion_desde.lEsSubEntidad = .t.					this.enlazar( 'F_clasificacion_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_clasificacion_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_clasificacion_desde.CODIGO # this.F_clasificacion_desde_PK						this.F_clasificacion_desde.CODIGO = this.F_clasificacion_desde_PK					endif				endif			endif		endif		return this.F_clasificacion_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_clasificacion_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_clasificacion_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_clasificacion_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_clasificacion_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_clasificacion_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_clasificacion_hasta_access() as variant                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_clasificacion_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_clasificacion_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_clasificacion_hasta ) = 'O' or isnull( this.F_clasificacion_hasta ) )					this.F_clasificacion_hasta = _Screen.zoo.instanciarentidad( 'Clasificacioncliente' )					this.F_clasificacion_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_clasificacion_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_clasificacion_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_clasificacion_hasta.CODIGO # this.F_clasificacion_hasta_PK						this.F_clasificacion_hasta.CODIGO = this.F_clasificacion_hasta_PK					endif				endif			endif		endif		return this.F_clasificacion_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_clasificacion_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_clasificacion_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_clasificacion_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_clasificacion_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_clasificacion_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_cliente_desde_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_cliente_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_cliente_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_cliente_desde ) = 'O' or isnull( this.F_cliente_desde ) )					this.F_cliente_desde = _Screen.zoo.instanciarentidad( 'Cliente' )					this.F_cliente_desde.lEsSubEntidad = .t.					this.enlazar( 'F_cliente_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_cliente_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_cliente_desde.CODIGO # this.F_cliente_desde_PK						this.F_cliente_desde.CODIGO = this.F_cliente_desde_PK					endif				endif			endif		endif		return this.F_cliente_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_cliente_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_cliente_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_cliente_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_cliente_desde_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.F_cliente_desde.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.F_cliente_desde )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_cliente_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_cliente_hasta_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_cliente_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_cliente_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_cliente_hasta ) = 'O' or isnull( this.F_cliente_hasta ) )					this.F_cliente_hasta = _Screen.zoo.instanciarentidad( 'Cliente' )					this.F_cliente_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_cliente_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_cliente_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_cliente_hasta.CODIGO # this.F_cliente_hasta_PK						this.F_cliente_hasta.CODIGO = this.F_cliente_hasta_PK					endif				endif			endif		endif		return this.F_cliente_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_cliente_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_cliente_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_cliente_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_cliente_hasta_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.F_cliente_hasta.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.F_cliente_hasta )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_cliente_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_idglobal_desde_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_idglobal_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_idglobal_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_idglobal_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_idglobal_desde( lxVal )				this.Setear_F_idglobal_desde( lxVal )			EndIf		Else			This.Setear_F_idglobal_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_idglobal_hasta_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_idglobal_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_idglobal_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_idglobal_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_idglobal_hasta( lxVal )				this.Setear_F_idglobal_hasta( lxVal )			EndIf		Else			This.Setear_F_idglobal_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_lista_desde_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_lista_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_lista_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_lista_desde ) = 'O' or isnull( this.F_lista_desde ) )					this.F_lista_desde = _Screen.zoo.instanciarentidad( 'Listadeprecios' )					this.F_lista_desde.lEsSubEntidad = .t.					this.enlazar( 'F_lista_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_lista_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_lista_desde.CODIGO # this.F_lista_desde_PK						this.F_lista_desde.CODIGO = this.F_lista_desde_PK					endif				endif			endif		endif		return this.F_lista_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_lista_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_lista_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_lista_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_lista_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 6, padr( lxVal, 6 ), lxVal )		this.F_lista_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_lista_hasta_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_lista_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_lista_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_lista_hasta ) = 'O' or isnull( this.F_lista_hasta ) )					this.F_lista_hasta = _Screen.zoo.instanciarentidad( 'Listadeprecios' )					this.F_lista_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_lista_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_lista_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_lista_hasta.CODIGO # this.F_lista_hasta_PK						this.F_lista_hasta.CODIGO = this.F_lista_hasta_PK					endif				endif			endif		endif		return this.F_lista_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_lista_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_lista_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_lista_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_lista_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 6, padr( lxVal, 6 ), lxVal )		this.F_lista_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_pais_desde_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_pais_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_pais_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_pais_desde ) = 'O' or isnull( this.F_pais_desde ) )					this.F_pais_desde = _Screen.zoo.instanciarentidad( 'Paises' )					this.F_pais_desde.lEsSubEntidad = .t.					this.enlazar( 'F_pais_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_pais_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_pais_desde.CODIGO # this.F_pais_desde_PK						this.F_pais_desde.CODIGO = this.F_pais_desde_PK					endif				endif			endif		endif		return this.F_pais_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_pais_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_pais_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_pais_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_pais_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 3, padr( lxVal, 3 ), lxVal )		this.F_pais_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_pais_hasta_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_pais_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_pais_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_pais_hasta ) = 'O' or isnull( this.F_pais_hasta ) )					this.F_pais_hasta = _Screen.zoo.instanciarentidad( 'Paises' )					this.F_pais_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_pais_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_pais_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_pais_hasta.CODIGO # this.F_pais_hasta_PK						this.F_pais_hasta.CODIGO = this.F_pais_hasta_PK					endif				endif			endif		endif		return this.F_pais_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_pais_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_pais_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_pais_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_pais_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 3, padr( lxVal, 3 ), lxVal )		this.F_pais_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_provincia_desde_access() as variant                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_provincia_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_provincia_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_provincia_desde ) = 'O' or isnull( this.F_provincia_desde ) )					this.F_provincia_desde = _Screen.zoo.instanciarentidad( 'Provincia' )					this.F_provincia_desde.lEsSubEntidad = .t.					this.enlazar( 'F_provincia_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_provincia_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_provincia_desde.CODIGO # this.F_provincia_desde_PK						this.F_provincia_desde.CODIGO = this.F_provincia_desde_PK					endif				endif			endif		endif		return this.F_provincia_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_provincia_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_provincia_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_provincia_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_provincia_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 2, padr( lxVal, 2 ), lxVal )		this.F_provincia_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_provincia_hasta_access() as variant                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_provincia_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_provincia_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_provincia_hasta ) = 'O' or isnull( this.F_provincia_hasta ) )					this.F_provincia_hasta = _Screen.zoo.instanciarentidad( 'Provincia' )					this.F_provincia_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_provincia_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_provincia_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_provincia_hasta.CODIGO # this.F_provincia_hasta_PK						this.F_provincia_hasta.CODIGO = this.F_provincia_hasta_PK					endif				endif			endif		endif		return this.F_provincia_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_provincia_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_provincia_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_provincia_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_provincia_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 2, padr( lxVal, 2 ), lxVal )		this.F_provincia_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_desde_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_sucursal_desde ) = 'O' or isnull( this.F_sucursal_desde ) )					this.F_sucursal_desde = _Screen.zoo.instanciarentidad( 'Sucursal' )					this.F_sucursal_desde.lEsSubEntidad = .t.					this.enlazar( 'F_sucursal_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_sucursal_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_sucursal_desde.CODIGO # this.F_sucursal_desde_PK						this.F_sucursal_desde.CODIGO = this.F_sucursal_desde_PK					endif				endif			endif		endif		return this.F_sucursal_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_sucursal_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_hasta_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_sucursal_hasta ) = 'O' or isnull( this.F_sucursal_hasta ) )					this.F_sucursal_hasta = _Screen.zoo.instanciarentidad( 'Sucursal' )					this.F_sucursal_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_sucursal_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_sucursal_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_sucursal_hasta.CODIGO # this.F_sucursal_hasta_PK						this.F_sucursal_hasta.CODIGO = this.F_sucursal_hasta_PK					endif				endif			endif		endif		return this.F_sucursal_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_sucursal_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tipo_desde_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tipo_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tipo_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_tipo_desde ) = 'O' or isnull( this.F_tipo_desde ) )					this.F_tipo_desde = _Screen.zoo.instanciarentidad( 'Tipocliente' )					this.F_tipo_desde.lEsSubEntidad = .t.					this.enlazar( 'F_tipo_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_tipo_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_tipo_desde.CODIGO # this.F_tipo_desde_PK						this.F_tipo_desde.CODIGO = this.F_tipo_desde_PK					endif				endif			endif		endif		return this.F_tipo_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tipo_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tipo_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tipo_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_tipo_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_tipo_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tipo_hasta_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tipo_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tipo_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_tipo_hasta ) = 'O' or isnull( this.F_tipo_hasta ) )					this.F_tipo_hasta = _Screen.zoo.instanciarentidad( 'Tipocliente' )					this.F_tipo_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_tipo_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_tipo_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_tipo_hasta.CODIGO # this.F_tipo_hasta_PK						this.F_tipo_hasta.CODIGO = this.F_tipo_hasta_PK					endif				endif			endif		endif		return this.F_tipo_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tipo_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tipo_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tipo_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_tipo_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_tipo_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tiposucursal_desde_access() as variant                                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tiposucursal_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tiposucursal_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_tiposucursal_desde ) = 'O' or isnull( this.F_tiposucursal_desde ) )					this.F_tiposucursal_desde = _Screen.zoo.instanciarentidad( 'Tiposucursal' )					this.F_tiposucursal_desde.lEsSubEntidad = .t.					this.enlazar( 'F_tiposucursal_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_tiposucursal_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_tiposucursal_desde.CODIGO # this.F_tiposucursal_desde_PK						this.F_tiposucursal_desde.CODIGO = this.F_tiposucursal_desde_PK					endif				endif			endif		endif		return this.F_tiposucursal_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tiposucursal_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tiposucursal_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tiposucursal_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_tiposucursal_desde_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_tiposucursal_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tiposucursal_hasta_access() as variant                                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tiposucursal_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tiposucursal_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_tiposucursal_hasta ) = 'O' or isnull( this.F_tiposucursal_hasta ) )					this.F_tiposucursal_hasta = _Screen.zoo.instanciarentidad( 'Tiposucursal' )					this.F_tiposucursal_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_tiposucursal_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_tiposucursal_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_tiposucursal_hasta.CODIGO # this.F_tiposucursal_hasta_PK						this.F_tiposucursal_hasta.CODIGO = this.F_tiposucursal_hasta_PK					endif				endif			endif		endif		return this.F_tiposucursal_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_tiposucursal_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_tiposucursal_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_tiposucursal_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_tiposucursal_hasta_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_tiposucursal_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_vendedor_desde_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_vendedor_desde_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_vendedor_desde_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_vendedor_desde ) = 'O' or isnull( this.F_vendedor_desde ) )					this.F_vendedor_desde = _Screen.zoo.instanciarentidad( 'Vendedor' )					this.F_vendedor_desde.lEsSubEntidad = .t.					this.enlazar( 'F_vendedor_desde.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_vendedor_desde.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_vendedor_desde.CODIGO # this.F_vendedor_desde_PK						this.F_vendedor_desde.CODIGO = this.F_vendedor_desde_PK					endif				endif			endif		endif		return this.F_vendedor_desde
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_vendedor_desde_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_vendedor_desde_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_vendedor_desde_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_vendedor_desde_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.F_vendedor_desde.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.F_vendedor_desde )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_vendedor_desde_PK = lxVal		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_vendedor_hasta_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_vendedor_hasta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_vendedor_hasta_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.F_vendedor_hasta ) = 'O' or isnull( this.F_vendedor_hasta ) )					this.F_vendedor_hasta = _Screen.zoo.instanciarentidad( 'Vendedor' )					this.F_vendedor_hasta.lEsSubEntidad = .t.					this.enlazar( 'F_vendedor_hasta.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'F_vendedor_hasta.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.F_vendedor_hasta.CODIGO # this.F_vendedor_hasta_PK						this.F_vendedor_hasta.CODIGO = this.F_vendedor_hasta_PK					endif				endif			endif		endif		return this.F_vendedor_hasta
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_vendedor_hasta_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_vendedor_hasta_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_vendedor_hasta_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_vendedor_hasta_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.F_vendedor_hasta.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.F_vendedor_hasta )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.F_vendedor_hasta_PK = lxVal		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function importancia_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'importancia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'importancia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Importancia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Importancia( lxVal )				this.ValidarDominio_Numericononegativo( lxVal )				this.Setear_Importancia( lxVal )			EndIf		Else			This.Setear_Importancia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_categoria_desde( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_categoria_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_categoria_desde', lcParametros )			endif		endif		this.F_categoria_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_categoria_hasta( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_categoria_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_categoria_hasta', lcParametros )			endif		endif		this.F_categoria_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_clasificacion_desde( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_clasificacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_clasificacion_desde', lcParametros )			endif		endif		this.F_clasificacion_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_clasificacion_hasta( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_clasificacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_clasificacion_hasta', lcParametros )			endif		endif		this.F_clasificacion_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_desde( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_desde', lcParametros )			endif		endif		this.F_cliente_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_cliente_hasta( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_cliente_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_cliente_hasta', lcParametros )			endif		endif		this.F_cliente_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_idglobal_desde( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_idglobal_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_idglobal_desde', lcParametros )			endif		endif		this.F_idglobal_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_idglobal_hasta( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_idglobal_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_idglobal_hasta', lcParametros )			endif		endif		this.F_idglobal_hasta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_lista_desde( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_lista_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_lista_desde', lcParametros )			endif		endif		this.F_lista_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_lista_hasta( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_lista_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_lista_hasta', lcParametros )			endif		endif		this.F_lista_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_pais_desde( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_pais_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_pais_desde', lcParametros )			endif		endif		this.F_pais_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_pais_hasta( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_pais_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_pais_hasta', lcParametros )			endif		endif		this.F_pais_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_provincia_desde( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_provincia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_provincia_desde', lcParametros )			endif		endif		this.F_provincia_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_provincia_hasta( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_provincia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_provincia_hasta', lcParametros )			endif		endif		this.F_provincia_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_desde( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_desde', lcParametros )			endif		endif		this.F_sucursal_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_sucursal_hasta( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_sucursal_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_sucursal_hasta', lcParametros )			endif		endif		this.F_sucursal_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_tipo_desde( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_tipo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_tipo_desde', lcParametros )			endif		endif		this.F_tipo_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_tipo_hasta( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_tipo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_tipo_hasta', lcParametros )			endif		endif		this.F_tipo_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_tiposucursal_desde( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_tiposucursal_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_tiposucursal_desde', lcParametros )			endif		endif		this.F_tiposucursal_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_tiposucursal_hasta( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_tiposucursal_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_tiposucursal_hasta', lcParametros )			endif		endif		this.F_tiposucursal_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_vendedor_desde( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_vendedor_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_vendedor_desde', lcParametros )			endif		endif		this.F_vendedor_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_vendedor_hasta( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_vendedor_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_vendedor_hasta', lcParametros )			endif		endif		this.F_vendedor_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_importancia( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_importancia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_importancia', lcParametros )			endif		endif		this.Importancia = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_imputacion( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_imputacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_imputacion', lcParametros )			endif		endif		this.Imputacion.NUMERO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_plandecuentas( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_plandecuentas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_plandecuentas', lcParametros )			endif		endif		this.Plandecuentas.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function situacionfiscal_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'situacionfiscal_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'situacionfiscal_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Situacionfiscal		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Situacionfiscal( lxVal )				this.Setear_Situacionfiscal( lxVal )			EndIf		Else			This.Setear_Situacionfiscal( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_categoria_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_categoria_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_categoria_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_categoria_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_categoria_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_categoria_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_clasificacion_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_clasificacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_clasificacion_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_clasificacion_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_clasificacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_clasificacion_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.F_cliente_desde.oDesactivador.ValidarEstadoActivacion( txVal, txValOld, this.lnuevo, this.ledicion)
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_cliente_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_cliente_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_cliente_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.F_cliente_hasta.oDesactivador.ValidarEstadoActivacion( txVal, txValOld, this.lnuevo, this.ledicion)
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_idglobal_desde( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_idglobal_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_idglobal_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_idglobal_hasta( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_idglobal_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_idglobal_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_lista_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_lista_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_lista_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_lista_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_lista_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_lista_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_pais_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_pais_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_pais_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_pais_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_pais_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_pais_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_provincia_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_provincia_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_provincia_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_provincia_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_provincia_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_provincia_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_sucursal_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_sucursal_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_tipo_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_tipo_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_tipo_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_tipo_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_tipo_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_tipo_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_tiposucursal_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_tiposucursal_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_tiposucursal_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_tiposucursal_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_tiposucursal_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_tiposucursal_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_vendedor_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_vendedor_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_vendedor_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.F_vendedor_desde.oDesactivador.ValidarEstadoActivacion( txVal, txValOld, this.lnuevo, this.ledicion)
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_vendedor_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_vendedor_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_vendedor_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld ) and This.F_vendedor_hasta.oDesactivador.ValidarEstadoActivacion( txVal, txValOld, this.lnuevo, this.ledicion)
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_importancia( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_importancia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_importancia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_imputacion( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_imputacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_imputacion', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_plandecuentas( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_plandecuentas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_plandecuentas', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_categoria_desde() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarf_categoria_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_categoria_hasta() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarf_categoria_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_clasificacion_desde() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarf_clasificacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_clasificacion_hasta() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarf_clasificacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_desde() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarf_cliente_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_cliente_hasta() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarf_cliente_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_lista_desde() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_lista_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_lista_hasta() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_lista_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_pais_desde() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_pais_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_pais_hasta() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_pais_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_provincia_desde() as boolean                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_provincia_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_provincia_hasta() as boolean                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_provincia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_desde() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarf_sucursal_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_sucursal_hasta() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarf_sucursal_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_tipo_desde() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarf_tipo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_tipo_hasta() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarf_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_tiposucursal_desde() as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarf_tiposucursal_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_tiposucursal_hasta() as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarf_tiposucursal_hasta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_vendedor_desde() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_vendedor_desde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarf_vendedor_hasta() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarf_vendedor_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarimportancia() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validarimportancia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarimputacion() as boolean                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validarimputacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarplandecuentas() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarplandecuentas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_categoria_desde() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridof_categoria_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_categoria_hasta() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridof_categoria_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_clasificacion_desde() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_clasificacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_clasificacion_hasta() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_clasificacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_desde() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_cliente_hasta() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridof_cliente_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_idglobal_desde() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridof_idglobal_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_idglobal_hasta() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridof_idglobal_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_lista_desde() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridof_lista_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_lista_hasta() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridof_lista_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_pais_desde() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_pais_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_pais_hasta() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_pais_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_provincia_desde() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridof_provincia_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_provincia_hasta() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridof_provincia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_desde() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_sucursal_hasta() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridof_sucursal_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_tipo_desde() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_tipo_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_tipo_hasta() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridof_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_tiposucursal_desde() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridof_tiposucursal_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_tiposucursal_hasta() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridof_tiposucursal_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_vendedor_desde() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridof_vendedor_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_vendedor_hasta() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridof_vendedor_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_categoria_hasta() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_categoria_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_clasificacion_hasta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_clasificacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_cliente_hasta() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_cliente_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_idglobal_hasta() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_idglobal_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_lista_hasta() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_lista_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_pais_hasta() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_pais_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_provincia_hasta() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_provincia_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_sucursal_hasta() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_sucursal_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_tipo_hasta() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_tipo_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_tiposucursal_hasta() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_tiposucursal_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_vendedor_hasta() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_vendedor_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoimportancia() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoimportancia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoimputacion() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridoimputacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoplandecuentas() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoplandecuentas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarprioridadrepetida( txval as string ) as boolean                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarprioridadrepetida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarunicidaddeimportancia( txval as variant ) as boolean                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarunicidaddeimportancia', lcParametros )
	EndFunc
