...
define class Mock_Detalleliquidacionmensualconceptosdiarios as MockBase of MockBase.prg

	cClase = 'Detalleliquidacionmensualconceptosdiarios'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_descuento() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Eventocambiosum_descuento', lcParametros )
	EndFunc
