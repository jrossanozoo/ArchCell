...
define class Mock_Itempostarjetasdetalle as MockBase of MockBase.prg

	cClase = 'Itempostarjetasdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function operadoradetarjeta_access() as variant                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Operadoradetarjeta_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function operadoradetarjeta_pk_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Operadoradetarjeta_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function operadoradetarjetadetalle_assign( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Operadoradetarjetadetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_operadoradetarjeta( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_operadoradetarjeta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_operadoradetarjetadetalle( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_operadoradetarjetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_operadoradetarjeta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_operadoradetarjeta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_operadoradetarjetadetalle( txval as variant ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_operadoradetarjetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridooperadoradetarjeta() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridooperadoradetarjeta', lcParametros )
	EndFunc
