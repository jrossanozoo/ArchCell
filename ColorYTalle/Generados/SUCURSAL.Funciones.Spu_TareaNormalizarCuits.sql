...
CREATE PROCEDURE [Funciones].[Spu_TareaNormalizarCuits]
	...
	begin
		...
		BEGIN
			...
			EXEC [Funciones].[Spu_NormalizarCuits] @Esquema = N'ZooLogic', @Tabla = N'CLI', @Campo = N'CLCUIT'
			EXEC [Funciones].[Spu_NormalizarCuits] @Esquema = N'ZooLogic', @Tabla = N'CORRE', @Campo = N'CLCUIT'
