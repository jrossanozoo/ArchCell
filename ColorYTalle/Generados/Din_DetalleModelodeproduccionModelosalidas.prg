...
define class Din_DetalleMODELODEPRODUCCIONModelosalidas as DetalleProduccioncolorytalle of DetalleProduccioncolorytalle.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'ItemMODELODEPRODUCCIONModelosalidas' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Modelosalidas
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Modelosalidas.Codigo
			loItem.NROITEM = c_Modelosalidas.NROITEM
			loItem.Proceso_PK = c_Modelosalidas.Proceso
			loItem.ColorM_PK = c_Modelosalidas.ColorM
			loItem.ColorMDetalle = c_Modelosalidas.ColorMDetalle
			loItem.TalleM_PK = c_Modelosalidas.TalleM
			loItem.TalleMDetalle = c_Modelosalidas.TalleMDetalle
			loItem.Semielaborado_PK = c_Modelosalidas.Semielaborado
			loItem.SemielaboradoDetalle = c_Modelosalidas.SemielaboradoDetalle
			loItem.Color_PK = c_Modelosalidas.Color
			loItem.ColorDetalle = c_Modelosalidas.ColorDetalle
			loItem.Talle_PK = c_Modelosalidas.Talle
			loItem.TalleDetalle = c_Modelosalidas.TalleDetalle
			loItem.Cantidad = c_Modelosalidas.Cantidad
			loItem.NroItem = lnI 
