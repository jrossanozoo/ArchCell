...
define class Din_EntidadConciliaciones_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Conciliaciones"
	cClaseResponse = this.cNamespaceDTOs + ".ConciliacionesResponse"
	cClaseModelo = "ConciliacionesModelo"
	cEntidad = "Conciliaciones"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ConciliacionesModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConciliacionesListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConciliacionesListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ConciliacionesModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleDetalleMovimientos( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Concepto", toEntidad.DetalleMovimientos.oItem, "Concepto_PK" )
	...
	protected function CargarColeccionModeloDetalleMovimientos( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .DetalleMovimientos.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemMovbancarios" )
				...
				this.SetearAtributoString( loItem, "Concepto", .DetalleMovimientos.Item(lnI).Concepto_PK)
	...
	protected function CargarColeccionModeloDetalleRegistros( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .DetalleRegistros.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemRegconciliables" )
