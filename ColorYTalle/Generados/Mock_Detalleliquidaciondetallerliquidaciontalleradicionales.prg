...
define class Mock_Detalleliquidaciondetallerliquidaciontalleradicionales as MockBase of MockBase.prg

	cClase = 'Detalleliquidaciondetallerliquidaciontalleradicionales'
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerclaveparaitem( toitem as object ) as string                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerclaveparaitem', lcParametros )
	EndFunc
