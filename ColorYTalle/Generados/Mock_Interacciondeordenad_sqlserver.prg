...
define class Mock_Interacciondeordenad_sqlserver as MockBase of MockBase.prg

	cClase = 'Interacciondeordenad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubino( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubino', lcParametros )
	EndFunc
