...
define class Din_EntidadCLASIFICACIONCLIENTEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxClasifFecexpo, lxClasifFmodifw, lxClasifFecimpo, lxClasifFaltafw, lxClasifFectrans, lxClasifSmodifw, lxClasifHmodifw, lxClasifSaltafw, lxClasifUaltafw, lxClasifUmodifw, lxClasifZadsfw, lxClasifValtafw, lxClasifVmodifw, lxClasifHoraimpo, lxClasifHoraexpo, lxClasifBdmodifw, lxClasifHaltafw, lxClasifEsttrans, lxClasifBdaltafw, lxClasifTimestamp, lxClasifClacod, lxClasifClades, lxClasifClarlim, lxClasifClarsmc, lxClasifObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CLASIF ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Hmodifw","Saltafw","Ualtafw","Umodifw","Zadsfw","Valtafw","Vmodifw","Horaimpo","Horaexpo","Bdmodifw","Haltafw","Esttrans","Bdaltafw","Timestamp","Clacod","Clades","Clarlim","Clarsmc","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxClasifFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxClasifFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxClasifFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxClasifFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxClasifFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifBdaltafw ) + "'" >>, <<lxClasifTimestamp >>, <<"'" + this.FormatearTextoSql( lxClasifClacod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxClasifClades ) + "'" >>, <<iif( lxClasifClarlim, 1, 0 ) >>, <<iif( lxClasifClarsmc, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxClasifObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CLASIF set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxClasifFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxClasifFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxClasifFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxClasifFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxClasifFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxClasifSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxClasifHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxClasifSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxClasifUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxClasifUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxClasifZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxClasifValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxClasifVmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxClasifHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxClasifHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxClasifBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxClasifHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxClasifEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxClasifBdaltafw ) + "'">>,"Timestamp" = <<lxClasifTimestamp>>,"Clacod" = <<"'" + this.FormatearTextoSql( lxClasifClacod ) + "'">>,"Clades" = <<"'" + this.FormatearTextoSql( lxClasifClades ) + "'">>,"Clarlim" = <<iif( lxClasifClarlim, 1, 0 )>>,"Clarsmc" = <<iif( lxClasifClarsmc, 1, 0 )>>,"Obs" = <<"'" + this.FormatearTextoSql( lxClasifObs ) + "'">> where "Clacod" = <<"'" + this.FormatearTextoSql( lxClasifClacod ) + "'">> and  CLASIF.CLACOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Timestamp" as "Timestamp", "Clacod" as "Codigo", "Clades" as "Descripcion", "Clarlim" as "Requierelimitedeconsumo", "Clarsmc" as "Requiereseguridadmodifcliente", "Obs" as "Obs" from ZooLogic.CLASIF where  CLASIF.CLACOD != '' order by CLACOD
			endtext
			use in select('c_CLASIFICACIONCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CLASIFICACIONCLIENTE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Timestamp" as "Timestamp", "Clacod" as "Codigo", "Clades" as "Descripcion", "Clarlim" as "Requierelimitedeconsumo", "Clarsmc" as "Requiereseguridadmodifcliente", "Obs" as "Obs" from ZooLogic.CLASIF where  funciones.padr( CLACOD, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CLASIF.CLACOD != '' order by CLACOD
			endtext
			use in select('c_CLASIFICACIONCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CLASIFICACIONCLIENTE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Timestamp" as "Timestamp", "Clacod" as "Codigo", "Clades" as "Descripcion", "Clarlim" as "Requierelimitedeconsumo", "Clarsmc" as "Requiereseguridadmodifcliente", "Obs" as "Obs" from ZooLogic.CLASIF where  funciones.padr( CLACOD, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CLASIF.CLACOD != '' order by CLACOD desc
			endtext
			use in select('c_CLASIFICACIONCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CLASIFICACIONCLIENTE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Timestamp" as "Timestamp", "Clacod" as "Codigo", "Clades" as "Descripcion", "Clarlim" as "Requierelimitedeconsumo", "Clarsmc" as "Requiereseguridadmodifcliente", "Obs" as "Obs" from ZooLogic.CLASIF where  CLASIF.CLACOD != '' order by CLACOD desc
			endtext
			use in select('c_CLASIFICACIONCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CLASIFICACIONCLIENTE', set( 'Datasession' ) )
			Endwith
...
"afw,Vmodifw,Horaimpo,Horaexpo,Bdmodifw,Haltafw,Esttrans,Bdaltafw,Timestamp,Clacod,Clades,Clarlim,Cla" + ;
"rsmc,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Timestamp" as "Timestamp", "Clacod" as "Codigo", "Clades" as "Descripcion", "Clarlim" as "Requierelimitedeconsumo", "Clarsmc" as "Requiereseguridadmodifcliente", "Obs" as "Obs"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CLASIF set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, CLACOD = ] + "'" + this.FormatearTextoSql( &lcCursor..CLACOD ) + "'"+ [, CLADES = ] + "'" + this.FormatearTextoSql( &lcCursor..CLADES ) + "'"+ [, CLARLIM = ] + Transform( iif( &lcCursor..CLARLIM, 1, 0 ))+ [, CLARSMC = ] + Transform( iif( &lcCursor..CLARSMC, 1, 0 ))+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'" + [ Where CLACOD = ] + "'" + this.FormatearTextoSql( &lcCursor..CLACOD ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, HMODIFW, SALTAFW, UALTAFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HORAIMPO, HORAEXPO, BDMODIFW, HALTAFW, ESTTRANS, BDALTAFW, TIMESTAMP, CLACOD, CLADES, CLARLIM, CLARSMC, OBS
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CLACOD ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CLACOD = isnull( d.CLACOD, t.CLACOD ),t.CLADES = isnull( d.CLADES, t.CLADES ),t.CLARLIM = isnull( d.CLARLIM, t.CLARLIM ),t.CLARSMC = isnull( d.CLARSMC, t.CLARSMC ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.CLASIF t inner join deleted d 
							 on t.CLACOD = d.CLACOD
				-- Fin Updates
				insert into ZooLogic.CLASIF(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Valtafw,Vmodifw,Horaimpo,Horaexpo,Bdmodifw,Haltafw,Esttrans,Bdaltafw,Timestamp,Clacod,Clades,Clarlim,Clarsmc,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.TIMESTAMP,0),isnull( d.CLACOD,''),isnull( d.CLADES,''),isnull( d.CLARLIM,0),isnull( d.CLARSMC,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CLASIFICACIONCLIENTE                    " atributo="FECHATRANSFERENCIA                      " tabla="CLASIF         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLASIFICACIONCLIENTE                    " atributo="ESTADOTRANSFERENCIA                     " tabla="CLASIF         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
