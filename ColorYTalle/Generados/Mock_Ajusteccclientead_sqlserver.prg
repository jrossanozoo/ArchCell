...
define class Mock_Ajusteccclientead_sqlserver as MockBase of MockBase.prg

	cClase = 'Ajusteccclientead_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detajucccli( tctablatrabajo ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detajucccli', lcParametros )
	EndFunc
