	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.EXPOAGRUP ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Saltafw","Horaimpo","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Horaexpo","Haltafw","Bdmodifw","Bdaltafw","Esttrans","Timestamp","Bloqreg","Clasehook","Cobs","Categoria","Codigo","Favorito","Cdes","Filtrafec" ) values ( <<"'" + this.ConvertirDateSql( lxExpoagrupFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxExpoagrupFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxExpoagrupFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxExpoagrupFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxExpoagrupFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupEsttrans ) + "'" >>, <<lxExpoagrupTimestamp >>, <<iif( lxExpoagrupBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxExpoagrupClasehook ) + "'" >>, <<"'" + this.FormatearTextoSql( lxExpoagrupCobs ) + "'" >>, <<lxExpoagrupCategoria >>, <<"'" + this.FormatearTextoSql( lxExpoagrupCodigo ) + "'" >>, <<iif( lxExpoagrupFavorito, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxExpoagrupCdes ) + "'" >>, <<iif( lxExpoagrupFiltrafec, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.EXPOAGRUP set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxExpoagrupFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxExpoagrupFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxExpoagrupFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxExpoagrupFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxExpoagrupFmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxExpoagrupHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxExpoagrupZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxExpoagrupHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxExpoagrupEsttrans ) + "'">>,"Timestamp" = <<lxExpoagrupTimestamp>>,"Bloqreg" = <<iif( lxExpoagrupBloqreg, 1, 0 )>>,"Clasehook" = <<"'" + this.FormatearTextoSql( lxExpoagrupClasehook ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxExpoagrupCobs ) + "'">>,"Categoria" = <<lxExpoagrupCategoria>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxExpoagrupCodigo ) + "'">>,"Favorito" = <<iif( lxExpoagrupFavorito, 1, 0 )>>,"Cdes" = <<"'" + this.FormatearTextoSql( lxExpoagrupCdes ) + "'">>,"Filtrafec" = <<iif( lxExpoagrupFiltrafec, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxExpoagrupCodigo ) + "'">> and  EXPOAGRUP.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Categoria" as "Categoria", "Codigo" as "Codigo", "Favorito" as "Favorito", "Cdes" as "Descripcion", "Filtrafec" as "Filtrafecha" from ORGANIZACION.EXPOAGRUP where "Codigo" = <<"'" + this.FormatearTextoSql( lxExpoagrupCodigo ) + "'">> and  EXPOAGRUP.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Categoria" as "Categoria", "Codigo" as "Codigo", "Favorito" as "Favorito", "Cdes" as "Descripcion", "Filtrafec" as "Filtrafecha" from ORGANIZACION.EXPOAGRUP where  EXPOAGRUP.CODIGO != '' And clasehook = <<"'" + this.FormatearTextoSql( lxExpoAgrupclasehook ) + "'">>
			endtext
			use in select('c_EXPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EXPOAGRUPADAS', set( 'Datasession' ) )
			if reccount( 'c_EXPOAGRUPADAS' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Categoria" as "Categoria", "Codigo" as "Codigo", "Favorito" as "Favorito", "Cdes" as "Descripcion", "Filtrafec" as "Filtrafecha" from ORGANIZACION.EXPOAGRUP where  EXPOAGRUP.CODIGO != '' order by clasehook
			endtext
			use in select('c_EXPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EXPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Categoria" as "Categoria", "Codigo" as "Codigo", "Favorito" as "Favorito", "Cdes" as "Descripcion", "Filtrafec" as "Filtrafecha" from ORGANIZACION.EXPOAGRUP where  funciones.padr( clasehook, 100, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  EXPOAGRUP.CODIGO != '' order by clasehook
			endtext
			use in select('c_EXPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EXPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Categoria" as "Categoria", "Codigo" as "Codigo", "Favorito" as "Favorito", "Cdes" as "Descripcion", "Filtrafec" as "Filtrafecha" from ORGANIZACION.EXPOAGRUP where  funciones.padr( clasehook, 100, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  EXPOAGRUP.CODIGO != '' order by clasehook desc
			endtext
			use in select('c_EXPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EXPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Categoria" as "Categoria", "Codigo" as "Codigo", "Favorito" as "Favorito", "Cdes" as "Descripcion", "Filtrafec" as "Filtrafecha" from ORGANIZACION.EXPOAGRUP where  EXPOAGRUP.CODIGO != '' order by clasehook desc
			endtext
			use in select('c_EXPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EXPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Za" + ;
"dsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Timestamp,Bloqreg,Clasehook,Cobs,Ca" + ;
"tegoria,Codigo,Favorito,Cdes,Filtrafec" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Categoria" as "Categoria", "Codigo" as "Codigo", "Favorito" as "Favorito", "Cdes" as "Descripcion", "Filtrafec" as "Filtrafecha"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.EXPOAGRUP set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxExpoagrupFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxExpoagrupFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxExpoagrupFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxExpoagrupFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxExpoagrupFmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupSaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxExpoagrupHoraimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupHmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupUmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupUaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxExpoagrupZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupVmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxExpoagrupHoraexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupHaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxExpoagrupBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxExpoagrupBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxExpoagrupEsttrans ) + "'">>, "Timestamp" = <<lxExpoagrupTimestamp>>, "Bloqreg" = <<iif( lxExpoagrupBloqreg, 1, 0 )>>, "Clasehook" = <<"'" + this.FormatearTextoSql( lxExpoagrupClasehook ) + "'">>, "Cobs" = <<"'" + this.FormatearTextoSql( lxExpoagrupCobs ) + "'">>, "Categoria" = <<lxExpoagrupCategoria>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxExpoagrupCodigo ) + "'">>, "Favorito" = <<iif( lxExpoagrupFavorito, 1, 0 )>>, "Cdes" = <<"'" + this.FormatearTextoSql( lxExpoagrupCdes ) + "'">>, "Filtrafec" = <<iif( lxExpoagrupFiltrafec, 1, 0 )>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'EXPOAGRUP' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.EXPOAGRUP set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, clasehook = ] + "'" + this.FormatearTextoSql( &lcCursor..clasehook ) + "'"+ [, cObs = ] + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"+ [, categoria = ] + transform( &lcCursor..categoria )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, favorito = ] + Transform( iif( &lcCursor..favorito, 1, 0 ))+ [, cDes = ] + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'"+ [, filtrafec = ] + Transform( iif( &lcCursor..filtrafec, 1, 0 )) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, SALTAFW, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HORAEXPO, HALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, TIMESTAMP, BLOQREG, clasehook, cObs, categoria, Codigo, favorito, cDes, filtrafec
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..clasehook ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'" + ',' + transform( &lcCursor..categoria ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + Transform( iif( &lcCursor..favorito, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'" + ',' + Transform( iif( &lcCursor..filtrafec, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.CLASEHOOK = isnull( d.CLASEHOOK, t.CLASEHOOK ),t.COBS = isnull( d.COBS, t.COBS ),t.CATEGORIA = isnull( d.CATEGORIA, t.CATEGORIA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FAVORITO = isnull( d.FAVORITO, t.FAVORITO ),t.CDES = isnull( d.CDES, t.CDES ),t.FILTRAFEC = isnull( d.FILTRAFEC, t.FILTRAFEC )
					from ORGANIZACION.EXPOAGRUP t inner join deleted d 
							 on t.Codigo = d.Codigo
							 and  t.clasehook = d.clasehook
				-- Fin Updates
				insert into ORGANIZACION.EXPOAGRUP(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Timestamp,Bloqreg,Clasehook,Cobs,Categoria,Codigo,Favorito,Cdes,Filtrafec)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.CLASEHOOK,''),isnull( d.COBS,''),isnull( d.CATEGORIA,0),isnull( d.CODIGO,''),isnull( d.FAVORITO,0),isnull( d.CDES,''),isnull( d.FILTRAFEC,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_EXPOAGRUPADAS' ) < 1
				...
				Try
					...
					.Descripcion = nvl( c_EXPOAGRUPADAS.Descripcion, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="EXPOAGRUPADAS                           " atributo="FECHATRANSFERENCIA                      " tabla="EXPOAGRUP      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EXPOAGRUPADAS                           " atributo="ESTADOTRANSFERENCIA                     " tabla="EXPOAGRUP      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EXPOAGRUPADAS                           " atributo="OBS                                     " tabla="EXPOAGRUP      " campo="COBS      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EXPOAGRUPADAS                           " atributo="CATEGORIA                               " tabla="EXPOAGRUP      " campo="CATEGORIA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="201" etiqueta="Categoría                                                                                                                                                       " dominio="COMBOXML                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EXPOAGRUPADAS                           " atributo="DESCRIPCION                             " tabla="EXPOAGRUP      " campo="CDES      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="1" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
