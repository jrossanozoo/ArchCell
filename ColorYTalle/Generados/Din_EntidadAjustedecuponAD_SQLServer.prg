...
define class Din_EntidadAJUSTEDECUPONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAjucuponFectrans, lxAjucuponFaltafw, lxAjucuponFmodifw, lxAjucuponFecexpo, lxAjucuponFecimpo, lxAjucuponHaltafw, lxAjucuponHoraexpo, lxAjucuponHoraimpo, lxAjucuponSaltafw, lxAjucuponVmodifw, lxAjucuponZadsfw, lxAjucuponValtafw, lxAjucuponUmodifw, lxAjucuponSmodifw, lxAjucuponUaltafw, lxAjucuponHmodifw, lxAjucuponEsttrans, lxAjucuponIdfactura, lxAjucuponLetra, lxAjucuponIdnc, lxAjucuponIdvendedor, lxAjucuponIdcliente, lxAjucuponBdaltafw, lxAjucuponIdcupon, lxAjucuponBdmodifw, lxAjucuponNctipo, lxAjucuponPventa, lxAjucuponIdcaja, lxAjucuponNumero, lxAjucuponMonto, lxAjucuponCodigo
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.AJUCUPON ( "Fectrans","Faltafw","Fmodifw","Fecexpo","Fecimpo","Haltafw","Horaexpo","Horaimpo","Saltafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Esttrans","Idfactura","Letra","Idnc","Idvendedor","Idcliente","Bdaltafw","Idcupon","Bdmodifw","Nctipo","Pventa","Idcaja","Numero","Monto","Codigo" ) values ( <<"'" + this.ConvertirDateSql( lxAjucuponFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucuponFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucuponFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucuponFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucuponFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponIdfactura ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponLetra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponIdnc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponIdvendedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponIdcliente ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponIdcupon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucuponBdmodifw ) + "'" >>, <<lxAjucuponNctipo >>, <<lxAjucuponPventa >>, <<lxAjucuponIdcaja >>, <<lxAjucuponNumero >>, <<lxAjucuponMonto >>, <<"'" + this.FormatearTextoSql( lxAjucuponCodigo ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.AJUCUPON set "Fectrans" = <<"'" + this.ConvertirDateSql( lxAjucuponFectrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAjucuponFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAjucuponFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxAjucuponFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAjucuponFecimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAjucuponHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAjucuponHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAjucuponHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAjucuponSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAjucuponZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAjucuponValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAjucuponUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAjucuponEsttrans ) + "'">>,"Idfactura" = <<"'" + this.FormatearTextoSql( lxAjucuponIdfactura ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxAjucuponLetra ) + "'">>,"Idnc" = <<"'" + this.FormatearTextoSql( lxAjucuponIdnc ) + "'">>,"Idvendedor" = <<"'" + this.FormatearTextoSql( lxAjucuponIdvendedor ) + "'">>,"Idcliente" = <<"'" + this.FormatearTextoSql( lxAjucuponIdcliente ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAjucuponBdaltafw ) + "'">>,"Idcupon" = <<"'" + this.FormatearTextoSql( lxAjucuponIdcupon ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponBdmodifw ) + "'">>,"Nctipo" = <<lxAjucuponNctipo>>,"Pventa" = <<lxAjucuponPventa>>,"Idcaja" = <<lxAjucuponIdcaja>>,"Numero" = <<lxAjucuponNumero>>,"Monto" = <<lxAjucuponMonto>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAjucuponCodigo ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxAjucuponCodigo ) + "'">> and  AJUCUPON.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Idfactura" as "Idfactura", "Letra" as "Letrafactura", "Idnc" as "Notadecredito", "Idvendedor" as "Vendedor", "Idcliente" as "Idcliente", "Bdaltafw" as "Basededatosaltafw", "Idcupon" as "Idcupon", "Bdmodifw" as "Basededatosmodificacionfw", "Nctipo" as "Tiponotadecredito", "Pventa" as "Puntodeventafactura", "Idcaja" as "Caja", "Numero" as "Numerofactura", "Monto" as "Montoajuste", "Codigo" as "Codigo" from ZooLogic.AJUCUPON where "Codigo" = <<"'" + this.FormatearTextoSql( lxAjucuponCodigo ) + "'">> and  AJUCUPON.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Idfactura" as "Idfactura", "Letra" as "Letrafactura", "Idnc" as "Notadecredito", "Idvendedor" as "Vendedor", "Idcliente" as "Idcliente", "Bdaltafw" as "Basededatosaltafw", "Idcupon" as "Idcupon", "Bdmodifw" as "Basededatosmodificacionfw", "Nctipo" as "Tiponotadecredito", "Pventa" as "Puntodeventafactura", "Idcaja" as "Caja", "Numero" as "Numerofactura", "Monto" as "Montoajuste", "Codigo" as "Codigo" from ZooLogic.AJUCUPON where  AJUCUPON.CODIGO != '' And IdCupon = <<"'" + this.FormatearTextoSql( lxAjuCuponIdCupon ) + "'">>
			endtext
			use in select('c_AJUSTEDECUPON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDECUPON', set( 'Datasession' ) )
			if reccount( 'c_AJUSTEDECUPON' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Idfactura" as "Idfactura", "Letra" as "Letrafactura", "Idnc" as "Notadecredito", "Idvendedor" as "Vendedor", "Idcliente" as "Idcliente", "Bdaltafw" as "Basededatosaltafw", "Idcupon" as "Idcupon", "Bdmodifw" as "Basededatosmodificacionfw", "Nctipo" as "Tiponotadecredito", "Pventa" as "Puntodeventafactura", "Idcaja" as "Caja", "Numero" as "Numerofactura", "Monto" as "Montoajuste", "Codigo" as "Codigo" from ZooLogic.AJUCUPON where  AJUCUPON.CODIGO != '' order by IdCupon
			endtext
			use in select('c_AJUSTEDECUPON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDECUPON', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Idfactura" as "Idfactura", "Letra" as "Letrafactura", "Idnc" as "Notadecredito", "Idvendedor" as "Vendedor", "Idcliente" as "Idcliente", "Bdaltafw" as "Basededatosaltafw", "Idcupon" as "Idcupon", "Bdmodifw" as "Basededatosmodificacionfw", "Nctipo" as "Tiponotadecredito", "Pventa" as "Puntodeventafactura", "Idcaja" as "Caja", "Numero" as "Numerofactura", "Monto" as "Montoajuste", "Codigo" as "Codigo" from ZooLogic.AJUCUPON where  funciones.padr( IdCupon, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUCUPON.CODIGO != '' order by IdCupon
			endtext
			use in select('c_AJUSTEDECUPON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDECUPON', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Idfactura" as "Idfactura", "Letra" as "Letrafactura", "Idnc" as "Notadecredito", "Idvendedor" as "Vendedor", "Idcliente" as "Idcliente", "Bdaltafw" as "Basededatosaltafw", "Idcupon" as "Idcupon", "Bdmodifw" as "Basededatosmodificacionfw", "Nctipo" as "Tiponotadecredito", "Pventa" as "Puntodeventafactura", "Idcaja" as "Caja", "Numero" as "Numerofactura", "Monto" as "Montoajuste", "Codigo" as "Codigo" from ZooLogic.AJUCUPON where  funciones.padr( IdCupon, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUCUPON.CODIGO != '' order by IdCupon desc
			endtext
			use in select('c_AJUSTEDECUPON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDECUPON', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Idfactura" as "Idfactura", "Letra" as "Letrafactura", "Idnc" as "Notadecredito", "Idvendedor" as "Vendedor", "Idcliente" as "Idcliente", "Bdaltafw" as "Basededatosaltafw", "Idcupon" as "Idcupon", "Bdmodifw" as "Basededatosmodificacionfw", "Nctipo" as "Tiponotadecredito", "Pventa" as "Puntodeventafactura", "Idcaja" as "Caja", "Numero" as "Numerofactura", "Monto" as "Montoajuste", "Codigo" as "Codigo" from ZooLogic.AJUCUPON where  AJUCUPON.CODIGO != '' order by IdCupon desc
			endtext
			use in select('c_AJUSTEDECUPON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDECUPON', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Faltafw,Fmodifw,Fecexpo,Fecimpo,Haltafw,Horaexpo,Horaimpo,Saltafw,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Idfactura,Letra,Idnc,Idvendedor,Idcliente,Bdaltafw,Id" + ;
"cupon,Bdmodifw,Nctipo,Pventa,Idcaja,Numero,Monto,Codigo" + ;
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.AJUCUPON set "Fectrans" = <<"'" + this.ConvertirDateSql( lxAjucuponFectrans ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxAjucuponFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxAjucuponFmodifw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAjucuponFecexpo ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxAjucuponFecimpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxAjucuponHaltafw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxAjucuponHoraexpo ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxAjucuponHoraimpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxAjucuponSaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxAjucuponZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxAjucuponValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponUmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponSmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxAjucuponUaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponHmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxAjucuponEsttrans ) + "'">>, "Idfactura" = <<"'" + this.FormatearTextoSql( lxAjucuponIdfactura ) + "'">>, "Letra" = <<"'" + this.FormatearTextoSql( lxAjucuponLetra ) + "'">>, "Idnc" = <<"'" + this.FormatearTextoSql( lxAjucuponIdnc ) + "'">>, "Idvendedor" = <<"'" + this.FormatearTextoSql( lxAjucuponIdvendedor ) + "'">>, "Idcliente" = <<"'" + this.FormatearTextoSql( lxAjucuponIdcliente ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAjucuponBdaltafw ) + "'">>, "Idcupon" = <<"'" + this.FormatearTextoSql( lxAjucuponIdcupon ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAjucuponBdmodifw ) + "'">>, "Nctipo" = <<lxAjucuponNctipo>>, "Pventa" = <<lxAjucuponPventa>>, "Idcaja" = <<lxAjucuponIdcaja>>, "Numero" = <<lxAjucuponNumero>>, "Monto" = <<lxAjucuponMonto>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxAjucuponCodigo ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'AJUCUPON' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.AJUCUPON set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, IdFactura = ] + "'" + this.FormatearTextoSql( &lcCursor..IdFactura ) + "'"+ [, Letra = ] + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'"+ [, IdNC = ] + "'" + this.FormatearTextoSql( &lcCursor..IdNC ) + "'"+ [, idVendedor = ] + "'" + this.FormatearTextoSql( &lcCursor..idVendedor ) + "'"+ [, IdCliente = ] + "'" + this.FormatearTextoSql( &lcCursor..IdCliente ) + "'"+ [, IdCupon = ] + "'" + this.FormatearTextoSql( &lcCursor..IdCupon ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, NCTIPO = ] + transform( &lcCursor..NCTIPO )+ [, PVenta = ] + transform( &lcCursor..PVenta )+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, Numero = ] + transform( &lcCursor..Numero )+ [, Monto = ] + transform( &lcCursor..Monto )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECTRANS, FALTAFW, FMODIFW, FECEXPO, FECIMPO, HALTAFW, HORAEXPO, HORAIMPO, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, ESTTRANS, IdFactura, Letra, IdNC, idVendedor, IdCliente, BDALTAFW, IdCupon, BDMODIFW, NCTIPO, PVenta, IdCaja, Numero, Monto, Codigo
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdFactura ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdNC ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVendedor ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdCliente ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdCupon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..NCTIPO ) + ',' + transform( &lcCursor..PVenta ) + ',' + transform( &lcCursor..IdCaja ) + ',' + transform( &lcCursor..Numero )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..Monto ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.IDFACTURA = isnull( d.IDFACTURA, t.IDFACTURA ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.IDNC = isnull( d.IDNC, t.IDNC ),t.IDVENDEDOR = isnull( d.IDVENDEDOR, t.IDVENDEDOR ),t.IDCLIENTE = isnull( d.IDCLIENTE, t.IDCLIENTE ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.IDCUPON = isnull( d.IDCUPON, t.IDCUPON ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.NCTIPO = isnull( d.NCTIPO, t.NCTIPO ),t.PVENTA = isnull( d.PVENTA, t.PVENTA ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.MONTO = isnull( d.MONTO, t.MONTO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO )
					from ZooLogic.AJUCUPON t inner join deleted d 
							 on t.Codigo = d.Codigo
							 and  t.IdCupon = d.IdCupon
				-- Fin Updates
				insert into ZooLogic.AJUCUPON(Fectrans,Faltafw,Fmodifw,Fecexpo,Fecimpo,Haltafw,Horaexpo,Horaimpo,Saltafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Idfactura,Letra,Idnc,Idvendedor,Idcliente,Bdaltafw,Idcupon,Bdmodifw,Nctipo,Pventa,Idcaja,Numero,Monto,Codigo)
					Select isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.IDFACTURA,''),isnull( d.LETRA,''),isnull( d.IDNC,''),isnull( d.IDVENDEDOR,''),isnull( d.IDCLIENTE,''),isnull( d.BDALTAFW,''),isnull( d.IDCUPON,''),isnull( d.BDMODIFW,''),isnull( d.NCTIPO,0),isnull( d.PVENTA,0),isnull( d.IDCAJA,0),isnull( d.NUMERO,0),isnull( d.MONTO,0),isnull( d.CODIGO,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="AJUSTEDECUPON                           " atributo="FECHATRANSFERENCIA                      " tabla="AJUCUPON       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTEDECUPON                           " atributo="ESTADOTRANSFERENCIA                     " tabla="AJUCUPON       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTEDECUPON                           " atributo="IDCLIENTE                               " tabla="AJUCUPON       " campo="IDCLIENTE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Id de Cliente                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
