...
define class Mock_movimientodecaja as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function fechacaja_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechacaja_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechacaja_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechacaja		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechacaja( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Fechacaja( lxVal )			EndIf		Else			This.Setear_Fechacaja( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function itemvalor_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'itemvalor_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'itemvalor_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Itemvalor		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Itemvalor( lxVal )				this.Setear_Itemvalor( lxVal )			EndIf		Else			This.Setear_Itemvalor( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercierredetallado( tncaja as integer, tnidauditoria as integer, tcfiltro as string ) as collection                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercierredetallado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechacaja( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechacaja', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechacaja', lcParametros )			endif		endif		this.Fechacaja = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_itemvalor( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_itemvalor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_itemvalor', lcParametros )			endif		endif		this.Itemvalor = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tarea( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tarea', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tarea', lcParametros )			endif		endif		this.Tarea = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tarea_assign( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tarea_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tarea_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tarea		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tarea( lxVal )				this.Setear_Tarea( lxVal )			EndIf		Else			This.Setear_Tarea( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechacaja( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechacaja', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechacaja', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_itemvalor( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_itemvalor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_itemvalor', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tarea( txval as variant ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tarea', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tarea', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcajaauditoria() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarcajaauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocajaauditoria() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridocajaauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechacaja() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofechacaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwturno() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwturno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoturno() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridoturno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerestadodecheque( tcitemvalor as string ) as string                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerestadodecheque', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenernumerointernocheque( tcitemvalor as string ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenernumerointernocheque', lcParametros )
	EndFunc
