...
define class Din_EntidadWEBHOOKAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxWhookFecexpo, lxWhookFmodifw, lxWhookFecimpo, lxWhookFaltafw, lxWhookFectrans, lxWhookSmodifw, lxWhookHmodifw, lxWhookSaltafw, lxWhookUaltafw, lxWhookUmodifw, lxWhookZadsfw, lxWhookValtafw, lxWhookVmodifw, lxWhookHoraexpo, lxWhookHoraimpo, lxWhookBdaltafw, lxWhookEsttrans, lxWhookHaltafw, lxWhookBdmodifw, lxWhookTimestamp, lxWhookTipagrupub, lxWhookBasedatos, lxWhookCodigo, lxWhookUrl, lxWhookDescri, lxWhookObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.WHOOK ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Hmodifw","Saltafw","Ualtafw","Umodifw","Zadsfw","Valtafw","Vmodifw","Horaexpo","Horaimpo","Bdaltafw","Esttrans","Haltafw","Bdmodifw","Timestamp","Tipagrupub","Basedatos","Codigo","Url","Descri","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxWhookFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxWhookFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxWhookFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxWhookFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxWhookFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookBdmodifw ) + "'" >>, <<lxWhookTimestamp >>, <<lxWhookTipagrupub >>, <<"'" + this.FormatearTextoSql( lxWhookBasedatos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookUrl ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookDescri ) + "'" >>, <<"'" + this.FormatearTextoSql( lxWhookObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.WHOOK set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxWhookFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxWhookFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxWhookFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxWhookFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxWhookFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxWhookSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxWhookHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxWhookSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxWhookUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxWhookUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxWhookZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxWhookValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxWhookVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxWhookHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxWhookHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxWhookBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxWhookEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxWhookHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxWhookBdmodifw ) + "'">>,"Timestamp" = <<lxWhookTimestamp>>,"Tipagrupub" = <<lxWhookTipagrupub>>,"Basedatos" = <<"'" + this.FormatearTextoSql( lxWhookBasedatos ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxWhookCodigo ) + "'">>,"Url" = <<"'" + this.FormatearTextoSql( lxWhookUrl ) + "'">>,"Descri" = <<"'" + this.FormatearTextoSql( lxWhookDescri ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxWhookObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxWhookCodigo ) + "'">> and  WHOOK.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Basedatos" as "Basededatos", "Codigo" as "Codigo", "Url" as "Url", "Descri" as "Descripcion", "Obs" as "Observaciones" from ORGANIZACION.WHOOK where "Codigo" = <<"'" + this.FormatearTextoSql( lxWhookCodigo ) + "'">> and  WHOOK.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Basedatos" as "Basededatos", "Codigo" as "Codigo", "Url" as "Url", "Descri" as "Descripcion", "Obs" as "Observaciones" from ORGANIZACION.WHOOK where  WHOOK.CODIGO != '' order by Codigo
			endtext
			use in select('c_WEBHOOK')
			this.oConexion.EjecutarSql( lcSentencia, 'c_WEBHOOK', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Basedatos" as "Basededatos", "Codigo" as "Codigo", "Url" as "Url", "Descri" as "Descripcion", "Obs" as "Observaciones" from ORGANIZACION.WHOOK where  funciones.padr( Codigo, 40, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  WHOOK.CODIGO != '' order by Codigo
			endtext
			use in select('c_WEBHOOK')
			this.oConexion.EjecutarSql( lcSentencia, 'c_WEBHOOK', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Basedatos" as "Basededatos", "Codigo" as "Codigo", "Url" as "Url", "Descri" as "Descripcion", "Obs" as "Observaciones" from ORGANIZACION.WHOOK where  funciones.padr( Codigo, 40, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  WHOOK.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_WEBHOOK')
			this.oConexion.EjecutarSql( lcSentencia, 'c_WEBHOOK', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Basedatos" as "Basededatos", "Codigo" as "Codigo", "Url" as "Url", "Descri" as "Descripcion", "Obs" as "Observaciones" from ORGANIZACION.WHOOK where  WHOOK.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_WEBHOOK')
			this.oConexion.EjecutarSql( lcSentencia, 'c_WEBHOOK', set( 'Datasession' ) )
			local lcSentencia as string
...
"afw,Vmodifw,Horaexpo,Horaimpo,Bdaltafw,Esttrans,Haltafw,Bdmodifw,Timestamp,Tipagrupub,Basedatos,Codi" + ;
"go,Url,Descri,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Basedatos" as "Basededatos", "Codigo" as "Codigo", "Url" as "Url", "Descri" as "Descripcion", "Obs" as "Observaciones"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.WHOOK set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxWhookFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxWhookFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxWhookFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxWhookFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxWhookFectrans ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxWhookSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxWhookHmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxWhookSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxWhookUaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxWhookUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxWhookZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxWhookValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxWhookVmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxWhookHoraexpo ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxWhookHoraimpo ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxWhookBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxWhookEsttrans ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxWhookHaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxWhookBdmodifw ) + "'">>, "Timestamp" = <<lxWhookTimestamp>>, "Tipagrupub" = <<lxWhookTipagrupub>>, "Basedatos" = <<"'" + this.FormatearTextoSql( lxWhookBasedatos ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxWhookCodigo ) + "'">>, "Url" = <<"'" + this.FormatearTextoSql( lxWhookUrl ) + "'">>, "Descri" = <<"'" + this.FormatearTextoSql( lxWhookDescri ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxWhookObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'WHOOK' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, HMODIFW, SALTAFW, UALTAFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HORAEXPO, HORAIMPO, BDALTAFW, ESTTRANS, HALTAFW, BDMODIFW, TIMESTAMP, tipagrupub, BaseDatos, Codigo, URL, DESCRI, OBS
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..tipagrupub )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BaseDatos ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..URL ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DESCRI ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.BASEDATOS = isnull( d.BASEDATOS, t.BASEDATOS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.URL = isnull( d.URL, t.URL ),t.DESCRI = isnull( d.DESCRI, t.DESCRI ),t.OBS = isnull( d.OBS, t.OBS )
					from ORGANIZACION.WHOOK t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ORGANIZACION.WHOOK(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Valtafw,Vmodifw,Horaexpo,Horaimpo,Bdaltafw,Esttrans,Haltafw,Bdmodifw,Timestamp,Tipagrupub,Basedatos,Codigo,Url,Descri,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.TIPAGRUPUB,0),isnull( d.BASEDATOS,''),isnull( d.CODIGO,''),isnull( d.URL,''),isnull( d.DESCRI,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="WEBHOOK                                 " atributo="FECHATRANSFERENCIA                      " tabla="WHOOK          " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="WEBHOOK                                 " atributo="ESTADOTRANSFERENCIA                     " tabla="WHOOK          " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
