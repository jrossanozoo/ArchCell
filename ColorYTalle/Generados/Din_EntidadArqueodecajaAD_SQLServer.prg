...
define class Din_EntidadARQUEODECAJAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxArqcajaFmodifw, lxArqcajaFectrans, lxArqcajaFecimpo, lxArqcajaFecexpo, lxArqcajaHoraexpo, lxArqcajaUaltafw, lxArqcajaHmodifw, lxArqcajaHoraimpo, lxArqcajaSaltafw, lxArqcajaValtafw, lxArqcajaUmodifw, lxArqcajaVmodifw, lxArqcajaZadsfw, lxArqcajaBdmodifw, lxArqcajaBdaltafw, lxArqcajaSmodifw, lxArqcajaEsttrans, lxArqcajaFaltafw, lxArqcajaNumero, lxArqcajaCaja, lxArqcajaHaltafw, lxArqcajaVendedor, lxArqcajaCodigo, lxArqcajaAobs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ARQCAJA ( "Fmodifw","Fectrans","Fecimpo","Fecexpo","Horaexpo","Ualtafw","Hmodifw","Horaimpo","Saltafw","Valtafw","Umodifw","Vmodifw","Zadsfw","Bdmodifw","Bdaltafw","Smodifw","Esttrans","Faltafw","Numero","Caja","Haltafw","Vendedor","Codigo","Aobs" ) values ( <<"'" + this.ConvertirDateSql( lxArqcajaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArqcajaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArqcajaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArqcajaFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaEsttrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArqcajaFaltafw ) + "'" >>, <<lxArqcajaNumero >>, <<lxArqcajaCaja >>, <<"'" + this.FormatearTextoSql( lxArqcajaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaVendedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArqcajaAobs ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DetalleTotalPorGrupo
				if this.oEntidad.DetalleTotalPorGrupo.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ARQTOTDET("Agrupa","NROITEM","Codigo","AgrupaDet","TotGrupo","Arqueado","DifGrupo","ArqEfec","ArqOtros" ) values ( <<"'" + this.FormatearTextoSql( lxAgrupa ) + "'">>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupadesc ) + "'">>, <<lxTotalgrupo>>, <<lxArqueado>>, <<lxDifgrupo>>, <<lxArqueadoefec>>, <<lxArqueadootros>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ARQCAJA set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxArqcajaFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxArqcajaFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxArqcajaFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxArqcajaFecexpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxArqcajaHoraexpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxArqcajaUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxArqcajaHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxArqcajaHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxArqcajaSaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxArqcajaValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxArqcajaUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxArqcajaVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxArqcajaZadsfw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxArqcajaBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxArqcajaBdaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxArqcajaSmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxArqcajaEsttrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxArqcajaFaltafw ) + "'">>,"Numero" = <<lxArqcajaNumero>>,"Caja" = <<lxArqcajaCaja>>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxArqcajaHaltafw ) + "'">>,"Vendedor" = <<"'" + this.FormatearTextoSql( lxArqcajaVendedor ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxArqcajaCodigo ) + "'">>,"Aobs" = <<"'" + this.FormatearTextoSql( lxArqcajaAobs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxArqcajaCodigo ) + "'">> and  ARQCAJA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Faltafw" as "Fechaaltafw", "Numero" as "Numero", "Caja" as "Caja", "Haltafw" as "Horaaltafw", "Vendedor" as "Vendedor", "Codigo" as "Codigo", "Aobs" as "Observacion" from ZooLogic.ARQCAJA where "Codigo" = <<"'" + this.FormatearTextoSql( lxArqcajaCodigo ) + "'">> and  ARQCAJA.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Agrupa" as "Agrupa", "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrupadet" as "Agrupadesc", "Totgrupo" as "Totalgrupo", "Arqueado" as "Arqueado", "Difgrupo" as "Difgrupo", "Arqefec" as "Arqueadoefec", "Arqotros" as "Arqueadootros" from ZooLogic.ARQTOTDET where Codigo = <<"'" + this.FormatearTextoSql( c_ARQUEODECAJA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Faltafw" as "Fechaaltafw", "Numero" as "Numero", "Caja" as "Caja", "Haltafw" as "Horaaltafw", "Vendedor" as "Vendedor", "Codigo" as "Codigo", "Aobs" as "Observacion" from ZooLogic.ARQCAJA where  ARQCAJA.CODIGO != '' And Numero = <<lxARQCAJANumero>>
			endtext
			use in select('c_ARQUEODECAJA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ARQUEODECAJA', set( 'Datasession' ) )
			if reccount( 'c_ARQUEODECAJA' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Faltafw" as "Fechaaltafw", "Numero" as "Numero", "Caja" as "Caja", "Haltafw" as "Horaaltafw", "Vendedor" as "Vendedor", "Codigo" as "Codigo", "Aobs" as "Observacion" from ZooLogic.ARQCAJA where  ARQCAJA.CODIGO != '' order by Numero,Codigo
			endtext
			use in select('c_ARQUEODECAJA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ARQUEODECAJA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Faltafw" as "Fechaaltafw", "Numero" as "Numero", "Caja" as "Caja", "Haltafw" as "Horaaltafw", "Vendedor" as "Vendedor", "Codigo" as "Codigo", "Aobs" as "Observacion" from ZooLogic.ARQCAJA where  str( Numero, 10, 0) + funciones.padr( Codigo, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ARQCAJA.CODIGO != '' order by Numero,Codigo
			endtext
			use in select('c_ARQUEODECAJA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ARQUEODECAJA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Faltafw" as "Fechaaltafw", "Numero" as "Numero", "Caja" as "Caja", "Haltafw" as "Horaaltafw", "Vendedor" as "Vendedor", "Codigo" as "Codigo", "Aobs" as "Observacion" from ZooLogic.ARQCAJA where  str( Numero, 10, 0) + funciones.padr( Codigo, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ARQCAJA.CODIGO != '' order by Numero desc,Codigo desc
			endtext
			use in select('c_ARQUEODECAJA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ARQUEODECAJA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Faltafw" as "Fechaaltafw", "Numero" as "Numero", "Caja" as "Caja", "Haltafw" as "Horaaltafw", "Vendedor" as "Vendedor", "Codigo" as "Codigo", "Aobs" as "Observacion" from ZooLogic.ARQCAJA where  ARQCAJA.CODIGO != '' order by Numero desc,Codigo desc
			endtext
			use in select('c_ARQUEODECAJA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ARQUEODECAJA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecimpo,Fecexpo,Horaexpo,Ualtafw,Hmodifw,Horaimpo,Saltafw,Valtafw,Umodifw,V" + ;
"modifw,Zadsfw,Bdmodifw,Bdaltafw,Smodifw,Esttrans,Faltafw,Numero,Caja,Haltafw,Vendedor,Codigo,Aobs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Faltafw" as "Fechaaltafw", "Numero" as "Numero", "Caja" as "Caja", "Haltafw" as "Horaaltafw", "Vendedor" as "Vendedor", "Codigo" as "Codigo", "Aobs" as "Observacion"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleTotalPorGrupo( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Agrupa" as "Agrupa", "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrupadet" as "Agrupadesc", "Totgrupo" as "Totalgrupo", "Arqueado" as "Arqueado", "Difgrupo" as "Difgrupo", "Arqefec" as "Arqueadoefec", "Arqotros" as "Arqueadootros"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.DetalleTotalPorGrupo
				if this.oEntidad.DetalleTotalPorGrupo.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxArqueadootros = loItem.Arqueadootros
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ARQTOTDET("Agrupa","NROITEM","Codigo","AgrupaDet","TotGrupo","Arqueado","DifGrupo","ArqEfec","ArqOtros" ) values ( <<"'" + this.FormatearTextoSql( lxAgrupa ) + "'">>, <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAgrupadesc ) + "'">>, <<lxTotalgrupo>>, <<lxArqueado>>, <<lxDifgrupo>>, <<lxArqueadoefec>>, <<lxArqueadootros>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.ARQCAJA set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, Caja = ] + transform( &lcCursor..Caja )+ [, Vendedor = ] + "'" + this.FormatearTextoSql( &lcCursor..Vendedor ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, AObs = ] + "'" + this.FormatearTextoSql( &lcCursor..AObs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FMODIFW, FECTRANS, FECIMPO, FECEXPO, HORAEXPO, UALTAFW, HMODIFW, HORAIMPO, SALTAFW, VALTAFW, UMODIFW, VMODIFW, ZADSFW, BDMODIFW, BDALTAFW, SMODIFW, ESTTRANS, FAltaFW, Numero, Caja, HAltaFW, Vendedor, Codigo, AObs
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + transform( &lcCursor..Caja ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"Agrupa","NROITEM","Codigo","AgrupaDet","TotGrupo","Arqueado","DifGrupo","ArqEfec","ArqOtros"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.ARQTOTDET ( ] + lcCamposInsert + [ ) values ( ] +  "'" + this.FormatearTextoSql( cDetallesExistentes.Agrupa     ) + "'" + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AgrupaDet  ) + "'" + ',' + transform( cDetallesExistentes.TotGrupo   ) + ',' + transform( cDetallesExistentes.Arqueado   ) + ',' + transform( cDetallesExistentes.DifGrupo   ) + ',' + transform( cDetallesExistentes.ArqEfec    ) + ',' + transform( cDetallesExistentes.ArqOtros   ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.CAJA = isnull( d.CAJA, t.CAJA ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VENDEDOR = isnull( d.VENDEDOR, t.VENDEDOR ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.AOBS = isnull( d.AOBS, t.AOBS )
					from ZooLogic.ARQCAJA t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.ARQCAJA(Fmodifw,Fectrans,Fecimpo,Fecexpo,Horaexpo,Ualtafw,Hmodifw,Horaimpo,Saltafw,Valtafw,Umodifw,Vmodifw,Zadsfw,Bdmodifw,Bdaltafw,Smodifw,Esttrans,Faltafw,Numero,Caja,Haltafw,Vendedor,Codigo,Aobs)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.HORAEXPO,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.SMODIFW,''),isnull( d.ESTTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.NUMERO,0),isnull( d.CAJA,0),convert( char(8), getdate(), 108 ),isnull( d.VENDEDOR,''),isnull( d.CODIGO,''),isnull( d.AOBS,'')
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_CompAfe( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_ARQCAJA_CompAfe
ON ZooLogic.TablaTrabajo_ARQCAJA_CompAfe
AFTER DELETE
As
Begin
Update t Set 
...
<VFPData xml:space="preserve">
	...
	<row entidad="ARQUEODECAJA                            " atributo="FECHATRANSFERENCIA                      " tabla="ARQCAJA        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ARQUEODECAJA                            " atributo="COMPAFEC                                " tabla="COMPAFE        " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="DETALLEITEMCOMPROBANTE        " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ARQUEODECAJA                            " atributo="ESTADOTRANSFERENCIA                     " tabla="ARQCAJA        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ARQUEODECAJA                            " atributo="VENDEDOR                                " tabla="ARQCAJA        " campo="VENDEDOR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
