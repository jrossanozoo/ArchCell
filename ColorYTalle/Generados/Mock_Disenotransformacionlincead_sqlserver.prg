...
define class Mock_Disenotransformacionlincead_sqlserver as MockBase of MockBase.prg

	cClase = 'Disenotransformacionlincead_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_dislinceatri( tctablatrabajo ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_dislinceatri', lcParametros )
	EndFunc
