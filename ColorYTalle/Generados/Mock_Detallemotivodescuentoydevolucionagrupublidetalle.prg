...
define class Mock_Detallemotivodescuentoydevolucionagrupublidetalle as MockBase of MockBase.prg

	cClase = 'Detallemotivodescuentoydevolucionagrupublidetalle'
	...
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Agrupamientos'                                                                                                                                                                                                                               
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'La columna Código agrupamiento no admite valores repetidos.'                                                                                                                                                                     
	cNombre = 'Agrupublidetalle'                                                                                                                                                                                                                              
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Agrupamientos asociados'                                                                                                                                                                                                                 
	datasession = 1                                                                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function eventoactualizardetalle() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoactualizardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarunicidad( toitem as object ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarunicidad', lcParametros )
	EndFunc
