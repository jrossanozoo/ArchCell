...
define class Mock_paletadecolores as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecolores() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cambiosdetallecolores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function colorvalido( tccolor as string ) as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Colorvalido', lcParametros )
	EndFunc
