...
define class Din_EntidadCTACTECOMPRAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	cExpresionCCPorCampos = [dtos( #tabla#.fechaven ) + str( #tabla#.TipoComp, 2, 0) + #tabla#.letra + str( #tabla#.ptovta, 4, 0) + str( #tabla#.numero, 8, 0) + #tabla#.Valor + #tabla#.Provee]
	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CCCOMPRA ( "Fectrans","Fmodifw","Fecimpo","Fecexpo","Faltafw","Bdmodifw","Haltafw","Bdaltafw","Horaexpo","Horaimpo","Valtafw","Umodifw","Vmodifw","Ualtafw","Zadsfw","Smodifw","Hmodifw","Esttrans","Codcomp","Saltafw","Montoiva","Compcc","Montocon","Montosin","Montogra","Codigo","Moneda","Provee","Letra","Ptovta","Numero","Totalcc","Fechaven","Fechaemi","Tipocomp","Saldocc","Fecha","Comprob","Anotacion","Ptovtaext","Valor","Signo" ) values ( <<"'" + this.ConvertirDateSql( lxCccompraFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCccompraFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCccompraFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCccompraFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCccompraFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraCodcomp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraSaltafw ) + "'" >>, <<lxCccompraMontoiva >>, <<lxCccompraCompcc >>, <<lxCccompraMontocon >>, <<lxCccompraMontosin >>, <<lxCccompraMontogra >>, <<"'" + this.FormatearTextoSql( lxCccompraCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraProvee ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraLetra ) + "'" >>, <<lxCccompraPtovta >>, <<lxCccompraNumero >>, <<lxCccompraTotalcc >>, <<"'" + this.ConvertirDateSql( lxCccompraFechaven ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCccompraFechaemi ) + "'" >>, <<lxCccompraTipocomp >>, <<lxCccompraSaldocc >>, <<"'" + this.ConvertirDateSql( lxCccompraFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraComprob ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCccompraAnotacion ) + "'" >>, <<lxCccompraPtovtaext >>, <<"'" + this.FormatearTextoSql( lxCccompraValor ) + "'" >>, <<lxCccompraSigno >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CCCOMPRA set "Fectrans" = <<"'" + this.ConvertirDateSql( lxCccompraFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCccompraFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCccompraFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCccompraFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCccompraFaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCccompraBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCccompraHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCccompraBdaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCccompraHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCccompraHoraimpo ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCccompraValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCccompraUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCccompraVmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCccompraUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCccompraZadsfw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCccompraSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCccompraHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCccompraEsttrans ) + "'">>,"Codcomp" = <<"'" + this.FormatearTextoSql( lxCccompraCodcomp ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCccompraSaltafw ) + "'">>,"Montoiva" = <<lxCccompraMontoiva>>,"Compcc" = "Compcc" + <<lxCccompraCompcc>>,"Montocon" = <<lxCccompraMontocon>>,"Montosin" = <<lxCccompraMontosin>>,"Montogra" = <<lxCccompraMontogra>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCccompraCodigo ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxCccompraMoneda ) + "'">>,"Provee" = <<"'" + this.FormatearTextoSql( lxCccompraProvee ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxCccompraLetra ) + "'">>,"Ptovta" = <<lxCccompraPtovta>>,"Numero" = <<lxCccompraNumero>>,"Totalcc" = <<lxCccompraTotalcc>>,"Fechaven" = <<"'" + this.ConvertirDateSql( lxCccompraFechaven ) + "'">>,"Fechaemi" = <<"'" + this.ConvertirDateSql( lxCccompraFechaemi ) + "'">>,"Tipocomp" = <<lxCccompraTipocomp>>,"Saldocc" = "Saldocc" + <<lxCccompraSaldocc>>,"Fecha" = <<"'" + this.ConvertirDateSql( lxCccompraFecha ) + "'">>,"Comprob" = <<"'" + this.FormatearTextoSql( lxCccompraComprob ) + "'">>,"Anotacion" = <<"'" + this.FormatearTextoSql( lxCccompraAnotacion ) + "'">>,"Ptovtaext" = <<lxCccompraPtovtaext>>,"Valor" = <<"'" + this.FormatearTextoSql( lxCccompraValor ) + "'">>,"Signo" = <<lxCccompraSigno>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCccompraCodigo ) + "'">> and  CCCOMPRA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		llRetorno = .t.
		with this.oEntidad
			Local lxccComprafechaven As Variant, lxccCompraTipoComp As Variant, lxccCompraletra As Variant, lxccCompraptovta As Variant, lxccCompranumero As Variant, lxccCompraValor As Variant, lxccCompraProvee As Variant
			lxccComprafechaven = .FechaVencimiento
			lxccCompraTipoComp = .TipoDeComprobante
			lxccCompraletra = .Letra
			lxccCompraptovta = .PuntoDeVenta
			...
			lxccCompraProvee = .Proveedor_Pk
			local lcSentencia as string

			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Codcomp" as "Codigocomprobante", "Saltafw" as "Seriealtafw", "Montoiva" as "Montocomprobanteiva", "Compcc" as "Comprometidocc", "Montocon" as "Montocomprobanteconimpuesto", "Montosin" as "Montocomprobantesinimpuesto", "Montogra" as "Montocomprobantegravado", "Codigo" as "Codigo", "Moneda" as "Moneda", "Provee" as "Proveedor", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Fechaven" as "Fechavencimiento", "Fechaemi" as "Fechaemision", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Ptovtaext" as "Puntodeventaextendido", "Valor" as "Valor", "Signo" as "Signodemovimiento" from ZooLogic.CCCOMPRA where  CCCOMPRA.CODIGO != '' And fechaven = <<"'" + this.ConvertirDateSql( lxccComprafechaven ) + "'">> and TipoComp = <<lxccCompraTipoComp>> and letra = <<"'" + this.FormatearTextoSql( lxccCompraletra ) + "'">> and ptovta = <<lxccCompraptovta>> and numero = <<lxccCompranumero>> and Valor = <<"'" + this.FormatearTextoSql( lxccCompraValor ) + "'">> and Provee = <<"'" + this.FormatearTextoSql( lxccCompraProvee ) + "'">>
			endtext
			use in select('c_CTACTECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CTACTECOMPRA', set( 'Datasession' ) )
			if reccount( 'c_CTACTECOMPRA' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Codcomp" as "Codigocomprobante", "Saltafw" as "Seriealtafw", "Montoiva" as "Montocomprobanteiva", "Compcc" as "Comprometidocc", "Montocon" as "Montocomprobanteconimpuesto", "Montosin" as "Montocomprobantesinimpuesto", "Montogra" as "Montocomprobantegravado", "Codigo" as "Codigo", "Moneda" as "Moneda", "Provee" as "Proveedor", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Fechaven" as "Fechavencimiento", "Fechaemi" as "Fechaemision", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Ptovtaext" as "Puntodeventaextendido", "Valor" as "Valor", "Signo" as "Signodemovimiento" from ZooLogic.CCCOMPRA where  CCCOMPRA.CODIGO != '' order by fechaven,TipoComp,letra,ptovta,numero,Valor,Provee
			endtext
			use in select('c_CTACTECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CTACTECOMPRA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Codcomp" as "Codigocomprobante", "Saltafw" as "Seriealtafw", "Montoiva" as "Montocomprobanteiva", "Compcc" as "Comprometidocc", "Montocon" as "Montocomprobanteconimpuesto", "Montosin" as "Montocomprobantesinimpuesto", "Montogra" as "Montocomprobantegravado", "Codigo" as "Codigo", "Moneda" as "Moneda", "Provee" as "Proveedor", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Fechaven" as "Fechavencimiento", "Fechaemi" as "Fechaemision", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Ptovtaext" as "Puntodeventaextendido", "Valor" as "Valor", "Signo" as "Signodemovimiento" from ZooLogic.CCCOMPRA where  funciones.dtos( fechaven ) + str( TipoComp, 2, 0) + funciones.padr( letra, 1, ' ' ) + str( ptovta, 4, 0) + str( numero, 8, 0) + funciones.padr( Valor, 5, ' ' ) + funciones.padr( Provee, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CCCOMPRA.CODIGO != '' order by fechaven,TipoComp,letra,ptovta,numero,Valor,Provee
			endtext
			use in select('c_CTACTECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CTACTECOMPRA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Codcomp" as "Codigocomprobante", "Saltafw" as "Seriealtafw", "Montoiva" as "Montocomprobanteiva", "Compcc" as "Comprometidocc", "Montocon" as "Montocomprobanteconimpuesto", "Montosin" as "Montocomprobantesinimpuesto", "Montogra" as "Montocomprobantegravado", "Codigo" as "Codigo", "Moneda" as "Moneda", "Provee" as "Proveedor", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Fechaven" as "Fechavencimiento", "Fechaemi" as "Fechaemision", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Ptovtaext" as "Puntodeventaextendido", "Valor" as "Valor", "Signo" as "Signodemovimiento" from ZooLogic.CCCOMPRA where  funciones.dtos( fechaven ) + str( TipoComp, 2, 0) + funciones.padr( letra, 1, ' ' ) + str( ptovta, 4, 0) + str( numero, 8, 0) + funciones.padr( Valor, 5, ' ' ) + funciones.padr( Provee, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CCCOMPRA.CODIGO != '' order by fechaven desc,TipoComp desc,letra desc,ptovta desc,numero desc,Valor desc,Provee desc
			endtext
			use in select('c_CTACTECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CTACTECOMPRA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Codcomp" as "Codigocomprobante", "Saltafw" as "Seriealtafw", "Montoiva" as "Montocomprobanteiva", "Compcc" as "Comprometidocc", "Montocon" as "Montocomprobanteconimpuesto", "Montosin" as "Montocomprobantesinimpuesto", "Montogra" as "Montocomprobantegravado", "Codigo" as "Codigo", "Moneda" as "Moneda", "Provee" as "Proveedor", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Fechaven" as "Fechavencimiento", "Fechaemi" as "Fechaemision", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Ptovtaext" as "Puntodeventaextendido", "Valor" as "Valor", "Signo" as "Signodemovimiento" from ZooLogic.CCCOMPRA where  CCCOMPRA.CODIGO != '' order by fechaven desc,TipoComp desc,letra desc,ptovta desc,numero desc,Valor desc,Provee desc
			endtext
			use in select('c_CTACTECOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CTACTECOMPRA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fmodifw,Fecimpo,Fecexpo,Faltafw,Bdmodifw,Haltafw,Bdaltafw,Horaexpo,Horaimpo,Valtafw" + ;
",Umodifw,Vmodifw,Ualtafw,Zadsfw,Smodifw,Hmodifw,Esttrans,Codcomp,Saltafw,Montoiva,Compcc,Montocon,Mo" + ;
"ntosin,Montogra,Codigo,Moneda,Provee,Letra,Ptovta,Numero,Totalcc,Fechaven,Fechaemi,Tipocomp,Saldocc," + ;
...
" from ZooLogic.CCCOMPRA where  CCCOMPRA.CODIGO != '' and " + lcFiltro )
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			...
			Do Case
				...
				Case lcAtributo == 'PROVEEDOR'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'PROVEE AS PROVEEDOR'
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirCabecera( tlLoguear as Boolean ) As Void
		local lcCursor as String, ldFecha as Date, lcHora as string, lcValorABuscar As String, lxValorClavePK As variant, lxValorClavePrimaria As variant, lcIdentificadorParaLoguear as string, lxccCompraProvee as variant, lxccCompraletra as variant, lxccCompraptovta as variant, lxccCompranumero as variant, lxccComprafechaven as variant, lxccCompraTipoComp as variant, lxccCompraValor as variant, lcMensajeExtra as String
		lcValorABuscar = ''
		lxValorClavePK = ''
		lcMensajeExtra = ''
		...
		scan all
			...
			this.oConexion.EjecutarSql( [Select * From ZooLogic.CCCOMPRA Where  fechaven = ] + "'" + this.ConvertirDateSql( &lcCursor..fechaven   ) + "'" + [ and TipoComp = ] + transform( &lcCursor..TipoComp   ) + [ and letra = ] + "'" + this.FormatearTextoSql( &lcCursor..letra      ) + "'" + [ and ptovta = ] + transform( &lcCursor..ptovta     ) + [ and numero = ] + transform( &lcCursor..numero     ) + [ and Valor = ] + "'" + this.FormatearTextoSql( &lcCursor..Valor      ) + "'" + [ and Provee = ] + "'" + this.FormatearTextoSql( &lcCursor..Provee     ) + "'", 'curSeek', this.datasessionid )
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.CCCOMPRA set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, CodComp = ] + "'" + this.FormatearTextoSql( &lcCursor..CodComp ) + "'"+ [, MontoIVA = ] + transform( &lcCursor..MontoIVA )+ [, ComPCC = ZooLogic.CCCOMPRA.ComPCC + ] + transform( &lcCursor..ComPCC )+ [, MontoCon = ] + transform( &lcCursor..MontoCon )+ [, MontoSin = ] + transform( &lcCursor..MontoSin )+ [, MontoGra = ] + transform( &lcCursor..MontoGra )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, Provee = ] + "'" + this.FormatearTextoSql( &lcCursor..Provee ) + "'"+ [, letra = ] + "'" + this.FormatearTextoSql( &lcCursor..letra ) + "'"+ [, ptovta = ] + transform( &lcCursor..ptovta )+ [, numero = ] + transform( &lcCursor..numero )+ [, TotalCC = ] + transform( &lcCursor..TotalCC )+ [, fechaven = ] + "'" + this.ConvertirDateSql( &lcCursor..fechaven ) + "'"+ [, fechaemi = ] + "'" + this.ConvertirDateSql( &lcCursor..fechaemi ) + "'"+ [, TipoComp = ] + transform( &lcCursor..TipoComp )+ [, SaldoCC = ZooLogic.CCCOMPRA.SaldoCC + ] + transform( &lcCursor..SaldoCC )+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, Comprob = ] + "'" + this.FormatearTextoSql( &lcCursor..Comprob ) + "'"+ [, anotacion = ] + "'" + this.FormatearTextoSql( &lcCursor..anotacion ) + "'"+ [, ptovtaext = ] + transform( &lcCursor..ptovtaext )+ [, Valor = ] + "'" + this.FormatearTextoSql( &lcCursor..Valor ) + "'"+ [, Signo = ] + transform( &lcCursor..Signo ) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECTRANS, FMODIFW, FECIMPO, FECEXPO, FALTAFW, BDMODIFW, HALTAFW, BDALTAFW, HORAEXPO, HORAIMPO, VALTAFW, UMODIFW, VMODIFW, UALTAFW, ZADSFW, SMODIFW, HMODIFW, ESTTRANS, CodComp, SALTAFW, MontoIVA, ComPCC, MontoCon, MontoSin, MontoGra, Codigo, Moneda, Provee, letra, ptovta, numero, TotalCC, fechaven, fechaemi, TipoComp, SaldoCC, Fecha, Comprob, anotacion, ptovtaext, Valor, Signo
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodComp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + transform( &lcCursor..MontoIVA )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..ComPCC ) + ',' + transform( &lcCursor..MontoCon ) + ',' + transform( &lcCursor..MontoSin ) + ',' + transform( &lcCursor..MontoGra ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Provee ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..letra ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function ObtenerIdentificadorParaLoguear( tcCursor as String ) As String
		...
		lcRetorno = lcRetorno + ' - Proveedor: ' + transform( &tcCursor..Provee     )
		Return lcRetorno
	endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		llCondicion = isnull( lxVar ) or isnull( &lcCursor..fechaven ) or isnull( &lcCursor..TipoComp ) or isnull( &lcCursor..letra ) or isnull( &lcCursor..ptovta ) or isnull( &lcCursor..numero ) or isnull( &lcCursor..Valor ) or isnull( &lcCursor..Provee )
		if llCondicion
	...
	*--------------------------------------------------------------------------------------------------------
	protected function EliminarDuplicaciones() as boolean
		...
		select max( _Rec ) as Maximo,dtos( fechaven ) + str( TipoComp, 2, 0) + letra + str( ptovta, 4, 0) + str( numero, 8, 0) + Valor + Provee as Clave from CurConRecno into cursor RepMax Group by Clave having count( * ) > 1
		Index on Clave tag Clave
		delete for seek( dtos( fechaven ) + str( TipoComp, 2, 0) + letra + str( ptovta, 4, 0) + str( numero, 8, 0) + Valor + Provee, 'RepMax', 'Clave' ) and recno( lcCursor ) != RepMax.Maximo in &lcCursor
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODCOMP = isnull( d.CODCOMP, t.CODCOMP ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.MONTOIVA = isnull( d.MONTOIVA, t.MONTOIVA ),t.COMPCC = isnull( d.COMPCC, t.COMPCC ),t.MONTOCON = isnull( d.MONTOCON, t.MONTOCON ),t.MONTOSIN = isnull( d.MONTOSIN, t.MONTOSIN ),t.MONTOGRA = isnull( d.MONTOGRA, t.MONTOGRA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.PROVEE = isnull( d.PROVEE, t.PROVEE ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.PTOVTA = isnull( d.PTOVTA, t.PTOVTA ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.TOTALCC = isnull( d.TOTALCC, t.TOTALCC ),t.FECHAVEN = isnull( d.FECHAVEN, t.FECHAVEN ),t.FECHAEMI = isnull( d.FECHAEMI, t.FECHAEMI ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.SALDOCC = isnull( d.SALDOCC, t.SALDOCC ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.COMPROB = isnull( d.COMPROB, t.COMPROB ),t.ANOTACION = isnull( d.ANOTACION, t.ANOTACION ),t.PTOVTAEXT = isnull( d.PTOVTAEXT, t.PTOVTAEXT ),t.VALOR = isnull( d.VALOR, t.VALOR ),t.SIGNO = isnull( d.SIGNO, t.SIGNO )
					from ZooLogic.CCCOMPRA t inner join deleted d 
							 ...
							 and  t.Valor = d.Valor
							 and  t.Provee = d.Provee
				-- Fin Updates
				insert into ZooLogic.CCCOMPRA(Fectrans,Fmodifw,Fecimpo,Fecexpo,Faltafw,Bdmodifw,Haltafw,Bdaltafw,Horaexpo,Horaimpo,Valtafw,Umodifw,Vmodifw,Ualtafw,Zadsfw,Smodifw,Hmodifw,Esttrans,Codcomp,Saltafw,Montoiva,Compcc,Montocon,Montosin,Montogra,Codigo,Moneda,Provee,Letra,Ptovta,Numero,Totalcc,Fechaven,Fechaemi,Tipocomp,Saldocc,Fecha,Comprob,Anotacion,Ptovtaext,Valor,Signo)
					Select isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.CODCOMP,''),isnull( d.SALTAFW,''),isnull( d.MONTOIVA,0),isnull( d.COMPCC,0),isnull( d.MONTOCON,0),isnull( d.MONTOSIN,0),isnull( d.MONTOGRA,0),isnull( d.CODIGO,''),isnull( d.MONEDA,''),isnull( d.PROVEE,''),isnull( d.LETRA,''),isnull( d.PTOVTA,0),isnull( d.NUMERO,0),isnull( d.TOTALCC,0),isnull( d.FECHAVEN,''),isnull( d.FECHAEMI,''),isnull( d.TIPOCOMP,0),isnull( d.SALDOCC,0),isnull( d.FECHA,''),isnull( d.COMPROB,''),isnull( d.ANOTACION,''),isnull( d.PTOVTAEXT,0),isnull( d.VALOR,''),isnull( d.SIGNO,0)
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					<<loLogueo.EstadoSistema>>,'<<loLogueo.Aplicacion>>','<<loLogueo.Version>>',
					'<<loLogueo.Serie>>','<<loLogueo.Usuario>>','<<loLogueo.NombrePc>>',
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: FECHA DE VENCIMIENTO ' + cast( d.fechaven as Varchar(8) ) + ', TIPO DE COMPROBANTE ' + cast( d.TipoComp as Varchar(2) ) + ', LETRA ' + cast( d.letra as Varchar(1) ) + ', PUNTO DE VENTA ' + cast( d.ptovta as Varchar(4) ) + ', NÚMERO ' + cast( d.numero as Varchar(8) ) + ', VALOR ' + cast( d.Valor as Varchar(5) ) + ', PROVEEDOR ' + cast( d.Provee as Varchar(10) ) + '','La clave principal a importar ya existe'
					from ZooLogic.CCCOMPRA t inner join deleted d 
							 on t.Codigo = d.Codigo
						left join deleted h 
...
<VFPData xml:space="preserve">
	...
	<row entidad="CTACTECOMPRA                            " atributo="FECHATRANSFERENCIA                      " tabla="CCCOMPRA       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTECOMPRA                            " atributo="ESTADOTRANSFERENCIA                     " tabla="CCCOMPRA       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTECOMPRA                            " atributo="PROVEEDOR                               " tabla="CCCOMPRA       " campo="PROVEE    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="400" etiqueta="Proveedor                                                                                                                                                       " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="7" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTECOMPRA                            " atributo="TOTALCC                                 " tabla="CCCOMPRA       " campo="TOTALCC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Total                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CTACTECOMPRA                            " atributo="FECHAVENCIMIENTO                        " tabla="CCCOMPRA       " campo="FECHAVEN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Fecha de vencimiento                                                                                                                                            " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTECOMPRA                            " atributo="TIPODECOMPROBANTE                       " tabla="CCCOMPRA       " campo="TIPOCOMP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="10" etiqueta="Tipo de comprobante                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="2" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CTACTECOMPRA                            " atributo="SALDOCC                                 " tabla="CCCOMPRA       " campo="SALDOCC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Saldo                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
