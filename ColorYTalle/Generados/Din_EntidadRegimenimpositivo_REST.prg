...
define class Din_EntidadRegimenimpositivo_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Regimenimpositivo"
	cClaseResponse = this.cNamespaceDTOs + ".RegimenimpositivoResponse"
	cClaseModelo = "RegimenimpositivoModelo"
	cEntidad = "Regimenimpositivo"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "RegimenimpositivoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "RegimenimpositivoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "RegimenimpositivoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "RegimenimpositivoModelo"
		endcase
		return lcRetorno
