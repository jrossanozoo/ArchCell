...
define class Din_EntidadTRATAMIENTOCOMPROBANTESAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTratcompFmodifw, lxTratcompFectrans, lxTratcompFaltafw, lxTratcompFecimpo, lxTratcompFecexpo, lxTratcompNumero, lxTratcompHaltafw, lxTratcompVmodifw, lxTratcompValtafw, lxTratcompZadsfw, lxTratcompHoraimpo, lxTratcompHoraexpo, lxTratcompSmodifw, lxTratcompUaltafw, lxTratcompSaltafw, lxTratcompUmodifw, lxTratcompHmodifw, lxTratcompBdmodifw, lxTratcompEsttrans, lxTratcompBdaltafw, lxTratcompCodint, lxTratcompTipocomp, lxTratcompAccion, lxTratcompFecha, lxTratcompHora, lxTratcompUsuario, lxTratcompSerie, lxTratcompLetdesde, lxTratcompPtodesde, lxTratcompNumdesde, lxTratcompNumhasta, lxTratcompFactsec, lxTratcompFfch, lxTratcompObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TRATCOMP ( "Fmodifw","Fectrans","Faltafw","Fecimpo","Fecexpo","Numero","Haltafw","Vmodifw","Valtafw","Zadsfw","Horaimpo","Horaexpo","Smodifw","Ualtafw","Saltafw","Umodifw","Hmodifw","Bdmodifw","Esttrans","Bdaltafw","Codint","Tipocomp","Accion","Fecha","Hora","Usuario","Serie","Letdesde","Ptodesde","Numdesde","Numhasta","Factsec","Ffch","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxTratcompFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTratcompFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTratcompFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTratcompFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTratcompFecexpo ) + "'" >>, <<lxTratcompNumero >>, <<"'" + this.FormatearTextoSql( lxTratcompHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompCodint ) + "'" >>, <<lxTratcompTipocomp >>, <<lxTratcompAccion >>, <<"'" + this.ConvertirDateSql( lxTratcompFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompHora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompUsuario ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompSerie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompLetdesde ) + "'" >>, <<lxTratcompPtodesde >>, <<lxTratcompNumdesde >>, <<lxTratcompNumhasta >>, <<"'" + this.FormatearTextoSql( lxTratcompFactsec ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTratcompFfch ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTratcompObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TRATCOMP set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTratcompFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTratcompFectrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTratcompFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTratcompFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxTratcompFecexpo ) + "'">>,"Numero" = <<lxTratcompNumero>>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTratcompHaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTratcompVmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTratcompValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTratcompZadsfw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTratcompHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTratcompHoraexpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTratcompSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTratcompUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTratcompSaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTratcompUmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTratcompHmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTratcompBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTratcompEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTratcompBdaltafw ) + "'">>,"Codint" = <<"'" + this.FormatearTextoSql( lxTratcompCodint ) + "'">>,"Tipocomp" = <<lxTratcompTipocomp>>,"Accion" = <<lxTratcompAccion>>,"Fecha" = <<"'" + this.ConvertirDateSql( lxTratcompFecha ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxTratcompHora ) + "'">>,"Usuario" = <<"'" + this.FormatearTextoSql( lxTratcompUsuario ) + "'">>,"Serie" = <<"'" + this.FormatearTextoSql( lxTratcompSerie ) + "'">>,"Letdesde" = <<"'" + this.FormatearTextoSql( lxTratcompLetdesde ) + "'">>,"Ptodesde" = <<lxTratcompPtodesde>>,"Numdesde" = <<lxTratcompNumdesde>>,"Numhasta" = <<lxTratcompNumhasta>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxTratcompFactsec ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxTratcompFfch ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxTratcompObs ) + "'">> where "Codint" = <<"'" + this.FormatearTextoSql( lxTratcompCodint ) + "'">> and  TRATCOMP.CODINT != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Faltafw,Fecimpo,Fecexpo,Numero,Haltafw,Vmodifw,Valtafw,Zadsfw,Horaimpo,Hora" + ;
"expo,Smodifw,Ualtafw,Saltafw,Umodifw,Hmodifw,Bdmodifw,Esttrans,Bdaltafw,Codint,Tipocomp,Accion,Fecha" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FMODIFW, FECTRANS, FALTAFW, FECIMPO, FECEXPO, Numero, HALTAFW, VMODIFW, VALTAFW, ZADSFW, HORAIMPO, HORAEXPO, SMODIFW, UALTAFW, SALTAFW, UMODIFW, HMODIFW, BDMODIFW, ESTTRANS, BDALTAFW, CodInt, TipoComp, Accion, fecha, hora, Usuario, serie, LetDesde, PtoDesde, NumDesde, NumHasta, factsec, ffch, Obs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodInt ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CODINT = isnull( d.CODINT, t.CODINT ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.ACCION = isnull( d.ACCION, t.ACCION ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.HORA = isnull( d.HORA, t.HORA ),t.USUARIO = isnull( d.USUARIO, t.USUARIO ),t.SERIE = isnull( d.SERIE, t.SERIE ),t.LETDESDE = isnull( d.LETDESDE, t.LETDESDE ),t.PTODESDE = isnull( d.PTODESDE, t.PTODESDE ),t.NUMDESDE = isnull( d.NUMDESDE, t.NUMDESDE ),t.NUMHASTA = isnull( d.NUMHASTA, t.NUMHASTA ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.TRATCOMP t inner join deleted d 
							 on t.CodInt = d.CodInt
							 and  t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.TRATCOMP(Fmodifw,Fectrans,Faltafw,Fecimpo,Fecexpo,Numero,Haltafw,Vmodifw,Valtafw,Zadsfw,Horaimpo,Horaexpo,Smodifw,Ualtafw,Saltafw,Umodifw,Hmodifw,Bdmodifw,Esttrans,Bdaltafw,Codint,Tipocomp,Accion,Fecha,Hora,Usuario,Serie,Letdesde,Ptodesde,Numdesde,Numhasta,Factsec,Ffch,Obs)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.NUMERO,0),convert( char(8), getdate(), 108 ),isnull( d.VMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.HMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.CODINT,''),isnull( d.TIPOCOMP,0),isnull( d.ACCION,0),isnull( d.FECHA,''),isnull( d.HORA,''),isnull( d.USUARIO,''),isnull( d.SERIE,''),isnull( d.LETDESDE,''),isnull( d.PTODESDE,0),isnull( d.NUMDESDE,0),isnull( d.NUMHASTA,0),isnull( d.FACTSEC,''),isnull( d.FFCH,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="TRATAMIENTOCOMPROBANTES                 " atributo="FECHATRANSFERENCIA                      " tabla="TRATCOMP       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRATAMIENTOCOMPROBANTES                 " atributo="ESTADOTRANSFERENCIA                     " tabla="TRATCOMP       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRATAMIENTOCOMPROBANTES                 " atributo="USUARIO                                 " tabla="TRATCOMP       " campo="USUARIO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="35" decimales="0" valorsugerido="=goServicios.Seguridad.cUsuarioLogueado                                                                                                                                                                                                                       " obligatorio="false" admitebusqueda="202" etiqueta="Usuario                                                                                                                                                         " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="15" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRATAMIENTOCOMPROBANTES                 " atributo="FECHACOMPROBANTE                        " tabla="TRATCOMP       " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="208" etiqueta="Fecha comprobante                                                                                                                                               " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="25" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRATAMIENTOCOMPROBANTES                 " atributo="OBSERVACION                             " tabla="TRATCOMP       " campo="OBS       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="209" etiqueta="Observación                                                                                                                                                     " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
