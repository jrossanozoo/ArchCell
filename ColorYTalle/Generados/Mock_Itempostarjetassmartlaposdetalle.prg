...
define class Mock_Itempostarjetassmartlaposdetalle as MockBase of MockBase.prg

	cClase = 'Itempostarjetassmartlaposdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function codigoequivalencia_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Codigoequivalencia_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoequivalencia( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_codigoequivalencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoequivalencia( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_codigoequivalencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigoequivalencia() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridocodigoequivalencia', lcParametros )
	EndFunc
