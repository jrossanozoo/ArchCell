...
define class Din_EntidadCAJAAUDITORIAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCajaaudiFecexpo, lxCajaaudiFectrans, lxCajaaudiFmodifw, lxCajaaudiFaltafw, lxCajaaudiFecimpo, lxCajaaudiFecha, lxCajaaudiCodigo, lxCajaaudiNumcaja, lxCajaaudiSaltafw, lxCajaaudiSmodifw, lxCajaaudiUmodifw, lxCajaaudiVmodifw, lxCajaaudiZadsfw, lxCajaaudiValtafw, lxCajaaudiUaltafw, lxCajaaudiHmodifw, lxCajaaudiHaltafw, lxCajaaudiHoraimpo, lxCajaaudiBdaltafw, lxCajaaudiUser, lxCajaaudiBdmodifw, lxCajaaudiEsttrans, lxCajaaudiHoraexpo, lxCajaaudiHora, lxCajaaudiTarea, lxCajaaudiMontotot, lxCajaaudiTimestamp
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CAJAAUDI ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Fecha","Codigo","Numcaja","Saltafw","Smodifw","Umodifw","Vmodifw","Zadsfw","Valtafw","Ualtafw","Hmodifw","Haltafw","Horaimpo","Bdaltafw","User","Bdmodifw","Esttrans","Horaexpo","Hora","Tarea","Montotot","Timestamp" ) values ( <<"'" + this.ConvertirDateSql( lxCajaaudiFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaaudiFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaaudiFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaaudiFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaaudiFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaaudiFecha ) + "'" >>, <<lxCajaaudiCodigo >>, <<lxCajaaudiNumcaja >>, <<"'" + this.FormatearTextoSql( lxCajaaudiSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiUser ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiHora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaaudiTarea ) + "'" >>, <<lxCajaaudiMontotot >>, <<lxCajaaudiTimestamp >> )
			endtext
			...
			for each loItem in this.oEntidad.DetalleValoresAuditoria
				if this.oEntidad.DetalleValoresAuditoria.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DETAUDI("NROITEM","Codigo","Valor","Monto" ) values ( <<lxNroitem>>, <<transform( lxValorClavePrimaria )>>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, <<lxMonto>> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CAJAAUDI set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCajaaudiFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCajaaudiFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCajaaudiFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCajaaudiFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCajaaudiFecimpo ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxCajaaudiFecha ) + "'">>,"Codigo" = <<lxCajaaudiCodigo>>,"Numcaja" = <<lxCajaaudiNumcaja>>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCajaaudiZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiHmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCajaaudiHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiBdaltafw ) + "'">>,"User" = <<"'" + this.FormatearTextoSql( lxCajaaudiUser ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCajaaudiEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCajaaudiHoraexpo ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxCajaaudiHora ) + "'">>,"Tarea" = <<"'" + this.FormatearTextoSql( lxCajaaudiTarea ) + "'">>,"Montotot" = <<lxCajaaudiMontotot>>,"Timestamp" = <<lxCajaaudiTimestamp>> where "Codigo" = <<lxCajaaudiCodigo>> and  CAJAAUDI.CODIGO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fecha" as "Fecha", "Codigo" as "Id", "Numcaja" as "Cajaestado", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "User" as "Usuario", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Hora" as "Hora", "Tarea" as "Tarea", "Montotot" as "Montototal", "Timestamp" as "Timestamp" from ZooLogic.CAJAAUDI where "Codigo" = <<lxCajaaudiCodigo>> and  CAJAAUDI.CODIGO != 0
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Idcajaauditoria", "Valor" as "Valor", "Monto" as "Monto" from ZooLogic.DETAUDI where Codigo = <<transform( c_CAJAAUDITORIA.ID )>> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Fecha,Codigo,Numcaja,Saltafw,Smodifw,Umodifw,Vmodif" + ;
"w,Zadsfw,Valtafw,Ualtafw,Hmodifw,Haltafw,Horaimpo,Bdaltafw,User,Bdmodifw,Esttrans,Horaexpo,Hora,Tare" + ;
"a,Montotot,Timestamp" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fecha" as "Fecha", "Codigo" as "Id", "Numcaja" as "Cajaestado", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "User" as "Usuario", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Hora" as "Hora", "Tarea" as "Tarea", "Montotot" as "Montototal", "Timestamp" as "Timestamp"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleValoresAuditoria( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Idcajaauditoria", "Valor" as "Valor", "Monto" as "Monto"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.DetalleValoresAuditoria
				if this.oEntidad.DetalleValoresAuditoria.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxMonto = loItem.Monto
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DETAUDI("NROITEM","Codigo","Valor","Monto" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, <<lxMonto>> ) 
					endtext
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.CAJAAUDI set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCajaaudiFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxCajaaudiFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxCajaaudiFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxCajaaudiFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCajaaudiFecimpo ) + "'">>, "Fecha" = <<"'" + this.ConvertirDateSql( lxCajaaudiFecha ) + "'">>, "Codigo" = <<lxCajaaudiCodigo>>, "Numcaja" = <<lxCajaaudiNumcaja>>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiSaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiUmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxCajaaudiZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiValtafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiUaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiHmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiHaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxCajaaudiHoraimpo ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCajaaudiBdaltafw ) + "'">>, "User" = <<"'" + this.FormatearTextoSql( lxCajaaudiUser ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCajaaudiBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxCajaaudiEsttrans ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxCajaaudiHoraexpo ) + "'">>, "Hora" = <<"'" + this.FormatearTextoSql( lxCajaaudiHora ) + "'">>, "Tarea" = <<"'" + this.FormatearTextoSql( lxCajaaudiTarea ) + "'">>, "Montotot" = <<lxCajaaudiMontotot>>, "Timestamp" = <<lxCajaaudiTimestamp>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'CAJAAUDI' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CAJAAUDI set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, Codigo = ] + transform( &lcCursor..Codigo )+ [, NumCaja = ] + transform( &lcCursor..NumCaja )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, USER = ] + "'" + this.FormatearTextoSql( &lcCursor..USER ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Hora = ] + "'" + this.FormatearTextoSql( &lcCursor..Hora ) + "'"+ [, Tarea = ] + "'" + this.FormatearTextoSql( &lcCursor..Tarea ) + "'"+ [, MontoTot = ] + transform( &lcCursor..MontoTot )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP ) + [ Where Codigo = ] + transform( &lcCursor..Codigo ) )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, Fecha, Codigo, NumCaja, SALTAFW, SMODIFW, UMODIFW, VMODIFW, ZADSFW, VALTAFW, UALTAFW, HMODIFW, HALTAFW, HORAIMPO, BDALTAFW, USER, BDMODIFW, ESTTRANS, HORAEXPO, Hora, Tarea, MontoTot, TIMESTAMP
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..NumCaja ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..USER ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Hora ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Tarea ) + "'" + ',' + transform( &lcCursor..MontoTot ) + ',' + transform( &lcCursor..TIMESTAMP )
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","Codigo","Valor","Monto"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.DETAUDI ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + transform( cDetallesExistentes.Codigo     ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Valor      ) + "'" + ',' + transform( cDetallesExistentes.Monto      ) + ' )'  )
		select cDetallesExistentes
	EndScan
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.NUMCAJA = isnull( d.NUMCAJA, t.NUMCAJA ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.USER = isnull( d.USER, t.USER ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORA = isnull( d.HORA, t.HORA ),t.TAREA = isnull( d.TAREA, t.TAREA ),t.MONTOTOT = isnull( d.MONTOTOT, t.MONTOTOT ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP )
					from ZooLogic.CAJAAUDI t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.CAJAAUDI(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Fecha,Codigo,Numcaja,Saltafw,Smodifw,Umodifw,Vmodifw,Zadsfw,Valtafw,Ualtafw,Hmodifw,Haltafw,Horaimpo,Bdaltafw,User,Bdmodifw,Esttrans,Horaexpo,Hora,Tarea,Montotot,Timestamp)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FECHA,''),isnull( d.CODIGO,0),isnull( d.NUMCAJA,0),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.USER,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.HORA,''),isnull( d.TAREA,''),isnull( d.MONTOTOT,0),isnull( d.TIMESTAMP,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="CAJAAUDITORIA                           " atributo="FECHATRANSFERENCIA                      " tabla="CAJAAUDI       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAJAAUDITORIA                           " atributo="FECHA                                   " tabla="CAJAAUDI       " campo="FECHA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=golibrerias.obtenerfecha()                                                                                                                                                                                                                                   " obligatorio="true" admitebusqueda="4" etiqueta="                                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAJAAUDITORIA                           " atributo="ESTADOTRANSFERENCIA                     " tabla="CAJAAUDI       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAJAAUDITORIA                           " atributo="TAREA                                   " tabla="CAJAAUDI       " campo="TAREA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="APERTURA                                                                                                                                                                                                                                                      " obligatorio="false" admitebusqueda="404" etiqueta="Tarea                                                                                                                                                           " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAJAAUDITORIA                           " atributo="MONTOTOTAL                              " tabla="CAJAAUDI       " campo="MONTOTOT  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="0.00                                                                                                                                                                                                                                                          " obligatorio="false" admitebusqueda="406" etiqueta="Monto                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
