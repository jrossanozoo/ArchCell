...
define class Din_EntidadIMPDIRCONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxImpdirconFectrans, lxImpdirconFecexpo, lxImpdirconFmodifw, lxImpdirconFecimpo, lxImpdirconFaltafw, lxImpdirconHoraexpo, lxImpdirconHoraimpo, lxImpdirconHaltafw, lxImpdirconSmodifw, lxImpdirconVmodifw, lxImpdirconZadsfw, lxImpdirconValtafw, lxImpdirconUmodifw, lxImpdirconSaltafw, lxImpdirconUaltafw, lxImpdirconHmodifw, lxImpdirconEsttrans, lxImpdirconBdaltafw, lxImpdirconBdmodifw, lxImpdirconObs, lxImpdirconNumero, lxImpdirconDescripcio, lxImpdirconCondesde, lxImpdirconConhasta, lxImpdirconCladesde, lxImpdirconClahasta, lxImpdirconSucdesde, lxImpdirconSuchasta, lxImpdirconTsucdesde, lxImpdirconTsuchasta, lxImpdirconBase, lxImpdirconPcuenta, lxImpdirconImportanci
				lxImpdirconFectrans =  .Fechatransferencia			lxImpdirconFecexpo =  .Fechaexpo			lxImpdirconFmodifw =  .Fechamodificacionfw			lxImpdirconFecimpo =  .Fechaimpo			lxImpdirconFaltafw =  .Fechaaltafw			lxImpdirconHoraexpo =  .Horaexpo			lxImpdirconHoraimpo =  .Horaimpo			lxImpdirconHaltafw =  .Horaaltafw			lxImpdirconSmodifw =  .Seriemodificacionfw			lxImpdirconVmodifw =  .Versionmodificacionfw			lxImpdirconZadsfw =  .Zadsfw			lxImpdirconValtafw =  .Versionaltafw			lxImpdirconUmodifw =  .Usuariomodificacionfw			lxImpdirconSaltafw =  .Seriealtafw			lxImpdirconUaltafw =  .Usuarioaltafw			lxImpdirconHmodifw =  .Horamodificacionfw			lxImpdirconEsttrans =  .Estadotransferencia			lxImpdirconBdaltafw =  .Basededatosaltafw			lxImpdirconBdmodifw =  .Basededatosmodificacionfw			lxImpdirconObs =  .Observacion			lxImpdirconNumero =  .Numero			lxImpdirconDescripcio =  .Descripcion			lxImpdirconCondesde =  upper( .f_Concepto_Desde_PK ) 			lxImpdirconConhasta =  upper( .f_Concepto_Hasta_PK ) 			lxImpdirconCladesde =  upper( .f_Clasificacion_Desde_PK ) 			lxImpdirconClahasta =  upper( .f_Clasificacion_Hasta_PK ) 			lxImpdirconSucdesde =  upper( .f_Sucursal_Desde_PK ) 			lxImpdirconSuchasta =  upper( .f_Sucursal_Hasta_PK ) 			lxImpdirconTsucdesde =  upper( .f_TipoSucursal_Desde_PK ) 			lxImpdirconTsuchasta =  upper( .f_TipoSucursal_Hasta_PK ) 			lxImpdirconBase =  .Basededatos			lxImpdirconPcuenta =  upper( .PlanDeCuentas_PK ) 			lxImpdirconImportanci =  .Importancia
		endwith
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.IMPDIRCON ( "Fectrans","Fecexpo","Fmodifw","Fecimpo","Faltafw","Horaexpo","Horaimpo","Haltafw","Smodifw","Vmodifw","Zadsfw","Valtafw","Umodifw","Saltafw","Ualtafw","Hmodifw","Esttrans","Bdaltafw","Bdmodifw","Obs","Numero","Descripcio","Condesde","Conhasta","Cladesde","Clahasta","Sucdesde","Suchasta","Tsucdesde","Tsuchasta","Base","Pcuenta","Importanci" ) values ( <<"'" + this.ConvertirDateSql( lxImpdirconFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirconFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirconFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirconFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirconFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconObs ) + "'" >>, <<lxImpdirconNumero >>, <<"'" + this.FormatearTextoSql( lxImpdirconDescripcio ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconCondesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconConhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconCladesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconClahasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconSucdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconSuchasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconTsucdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconTsuchasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconBase ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirconPcuenta ) + "'" >>, <<lxImpdirconImportanci >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.IMPDIRCON set "Fectrans" = <<"'" + this.ConvertirDateSql( lxImpdirconFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxImpdirconFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxImpdirconFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxImpdirconFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxImpdirconFaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxImpdirconHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxImpdirconHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxImpdirconHaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxImpdirconSmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxImpdirconVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxImpdirconZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxImpdirconValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxImpdirconUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxImpdirconSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxImpdirconUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxImpdirconHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxImpdirconEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxImpdirconBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxImpdirconBdmodifw ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxImpdirconObs ) + "'">>,"Numero" = <<lxImpdirconNumero>>,"Descripcio" = <<"'" + this.FormatearTextoSql( lxImpdirconDescripcio ) + "'">>,"Condesde" = <<"'" + this.FormatearTextoSql( lxImpdirconCondesde ) + "'">>,"Conhasta" = <<"'" + this.FormatearTextoSql( lxImpdirconConhasta ) + "'">>,"Cladesde" = <<"'" + this.FormatearTextoSql( lxImpdirconCladesde ) + "'">>,"Clahasta" = <<"'" + this.FormatearTextoSql( lxImpdirconClahasta ) + "'">>,"Sucdesde" = <<"'" + this.FormatearTextoSql( lxImpdirconSucdesde ) + "'">>,"Suchasta" = <<"'" + this.FormatearTextoSql( lxImpdirconSuchasta ) + "'">>,"Tsucdesde" = <<"'" + this.FormatearTextoSql( lxImpdirconTsucdesde ) + "'">>,"Tsuchasta" = <<"'" + this.FormatearTextoSql( lxImpdirconTsuchasta ) + "'">>,"Base" = <<"'" + this.FormatearTextoSql( lxImpdirconBase ) + "'">>,"Pcuenta" = <<"'" + this.FormatearTextoSql( lxImpdirconPcuenta ) + "'">>,"Importanci" = <<lxImpdirconImportanci>> where "Numero" = <<lxImpdirconNumero>> and  IMPDIRCON.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Sucdesde" as "F_sucursal_desde", "Suchasta" as "F_sucursal_hasta", "Tsucdesde" as "F_tiposucursal_desde", "Tsuchasta" as "F_tiposucursal_hasta", "Base" as "Basededatos", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCON where  IMPDIRCON.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_IMPDIRCON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCON', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Sucdesde" as "F_sucursal_desde", "Suchasta" as "F_sucursal_hasta", "Tsucdesde" as "F_tiposucursal_desde", "Tsuchasta" as "F_tiposucursal_hasta", "Base" as "Basededatos", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCON where  str( NUMERO, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPDIRCON.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_IMPDIRCON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCON', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Sucdesde" as "F_sucursal_desde", "Suchasta" as "F_sucursal_hasta", "Tsucdesde" as "F_tiposucursal_desde", "Tsuchasta" as "F_tiposucursal_hasta", "Base" as "Basededatos", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCON where  str( NUMERO, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPDIRCON.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_IMPDIRCON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCON', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Sucdesde" as "F_sucursal_desde", "Suchasta" as "F_sucursal_hasta", "Tsucdesde" as "F_tiposucursal_desde", "Tsuchasta" as "F_tiposucursal_hasta", "Base" as "Basededatos", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCON where  IMPDIRCON.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_IMPDIRCON')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCON', set( 'Datasession' ) )
			Endwith
...
"ltafw,Umodifw,Saltafw,Ualtafw,Hmodifw,Esttrans,Bdaltafw,Bdmodifw,Obs,Numero,Descripcio,Condesde,Conh" + ;
"asta,Cladesde,Clahasta,Sucdesde,Suchasta,Tsucdesde,Tsuchasta,Base,Pcuenta,Importanci" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Sucdesde" as "F_sucursal_desde", "Suchasta" as "F_sucursal_hasta", "Tsucdesde" as "F_tiposucursal_desde", "Tsuchasta" as "F_tiposucursal_hasta", "Base" as "Basededatos", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FECEXPO, FMODIFW, FECIMPO, FALTAFW, HORAEXPO, HORAIMPO, HALTAFW, SMODIFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SALTAFW, UALTAFW, HMODIFW, ESTTRANS, BDALTAFW, BDMODIFW, OBS, NUMERO, Descripcio, ConDesde, ConHasta, ClaDesde, ClaHasta, SucDesde, SucHasta, TSucDesde, TSucHasta, Base, PCUENTA, Importanci
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descripcio ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClaDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClaHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SucDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SucHasta ) + "'"
		...
		with this.oEntidad
			...
			if reccount( 'c_IMPDIRCON' ) < 1
				...
				Try
					...
					.F_concepto_desde_PK =  nvl( c_IMPDIRCON.F_concepto_desde, [] )
					.F_concepto_hasta_PK =  nvl( c_IMPDIRCON.F_concepto_hasta, [] )
					.F_clasificacion_desde_PK =  nvl( c_IMPDIRCON.F_clasificacion_desde, [] )
					.F_clasificacion_hasta_PK =  nvl( c_IMPDIRCON.F_clasificacion_hasta, [] )
					.F_sucursal_desde_PK =  nvl( c_IMPDIRCON.F_sucursal_desde, [] )
					.F_sucursal_hasta_PK =  nvl( c_IMPDIRCON.F_sucursal_hasta, [] )
					.F_tiposucursal_desde_PK =  nvl( c_IMPDIRCON.F_tiposucursal_desde, [] )
					.F_tiposucursal_hasta_PK =  nvl( c_IMPDIRCON.F_tiposucursal_hasta, [] )
					.Basededatos = nvl( c_IMPDIRCON.Basededatos, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="IMPDIRCON                               " atributo="FECHATRANSFERENCIA                      " tabla="IMPDIRCON      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCON                               " atributo="ESTADOTRANSFERENCIA                     " tabla="IMPDIRCON      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCON                               " atributo="F_CLASIFICACION_HASTA                   " tabla="IMPDIRCON      " campo="CLAHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLASIFICACIONCONCEPTOPAGO               " tipodato="C         " longitud="15" decimales="0" valorsugerido="ZZZZZZZZZZZZZZZ                                                                                                                                                                                                                                               " obligatorio="false" admitebusqueda="408" etiqueta="Clasificación hasta                                                                                                                                                                                                                                       " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCON                               " atributo="F_SUCURSAL_DESDE                        " tabla="IMPDIRCON      " campo="SUCDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SUCURSAL                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Sucursal desde                                                                                                                                                                                                                                            " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCON                               " atributo="F_SUCURSAL_HASTA                        " tabla="IMPDIRCON      " campo="SUCHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SUCURSAL                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="412" etiqueta="Sucursal hasta                                                                                                                                                                                                                                            " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCON                               " atributo="F_TIPOSUCURSAL_DESDE                    " tabla="IMPDIRCON      " campo="TSUCDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPOSUCURSAL                            " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Tipo sucursal desde                                                                                                                                                                                                                                       " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="6" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCON                               " atributo="F_TIPOSUCURSAL_HASTA                    " tabla="IMPDIRCON      " campo="TSUCHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPOSUCURSAL                            " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="416" etiqueta="Tipo sucursal hasta                                                                                                                                                                                                                                       " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="6" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCON                               " atributo="BASEDEDATOS                             " tabla="IMPDIRCON      " campo="BASE      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="21" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Base                                                                                                                                                                                                                                                      " dominio="COMBOSUCYAGRUCONVACIO         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="7" orden="11" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCON                               " atributo="PLANDECUENTAS                           " tabla="IMPDIRCON      " campo="PCUENTA   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PLANDECUENTAS                           " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="420" etiqueta="Cuenta                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; plancuenta.CTAIMPUT = .t. &quot;                                                                                                                                                                           " grupo="0" subgrupo="1" orden="46" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONCEPTOPAGO                            " atributo="DESCRIPCION                             " tabla="CONCEPAGO      " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="403" etiqueta="Detalle Con.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CONCEPAGO On IMPDIRCON.CONDESDE = CONCEPAGO.Codigo And  CONCEPAGO.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CONCEPTOPAGO                            " atributo="DESCRIPCION                             " tabla="CONCEPAGO      " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="405" etiqueta="Detalle Con.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CONCEPAGO On IMPDIRCON.CONHASTA = CONCEPAGO.Codigo And  CONCEPAGO.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLASIFICACIONCONCEPTOPAGO               " atributo="DESCRIPCION                             " tabla="CLASCONCEPAGO  " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="407" etiqueta="Detalle Cla.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLASCONCEPAGO On IMPDIRCON.CLADESDE = CLASCONCEPAGO.Codigo And  CLASCONCEPAGO.CODIGO != ''                                                                                                                                                         " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLASIFICACIONCONCEPTOPAGO               " atributo="DESCRIPCION                             " tabla="CLASCONCEPAGO  " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="409" etiqueta="Detalle Cla.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLASCONCEPAGO On IMPDIRCON.CLAHASTA = CLASCONCEPAGO.Codigo And  CLASCONCEPAGO.CODIGO != ''                                                                                                                                                         " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SUCURSAL                                " atributo="DESCRIPCION                             " tabla="SUC            " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="411" etiqueta="Detalle Suc.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join SUC On IMPDIRCON.SUCDESDE = SUC.codigo And  SUC.CODIGO != ''                                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="SUCURSAL                                " atributo="DESCRIPCION                             " tabla="SUC            " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="413" etiqueta="Detalle Suc.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join SUC On IMPDIRCON.SUCHASTA = SUC.codigo And  SUC.CODIGO != ''                                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOSUCURSAL                            " atributo="DESCRIPCION                             " tabla="TSUCUR         " campo="TDES      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="415" etiqueta="Detalle Tip.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join TSUCUR On IMPDIRCON.TSUCDESDE = TSUCUR.TCOD And  TSUCUR.TCOD != ''                                                                                                                                                                                 " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOSUCURSAL                            " atributo="DESCRIPCION                             " tabla="TSUCUR         " campo="TDES      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="417" etiqueta="Detalle Tip.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join TSUCUR On IMPDIRCON.TSUCHASTA = TSUCUR.TCOD And  TSUCUR.TCOD != ''                                                                                                                                                                                 " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="DESCRIPCION                             " tabla="PLANCUENTA     " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="421" etiqueta="Detalle Cue.                                                                                                                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join PLANCUENTA On IMPDIRCON.PCUENTA = PLANCUENTA.ctacodigo And  PLANCUENTA.CTACODIGO != ''                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
