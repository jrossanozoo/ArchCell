...
define class Mock_COLABORADORVALIDACIONCONTROLDESTOCKDIPONIBLE as MockBase of MockBase.prg

	cClase = 'COLABORADORVALIDACIONCONTROLDESTOCKDIPONIBLE'
	...
	*-----------------------------------------------------------------------------------------
	function debevalidarstockdisponible( toitem as object, tlitemcontroladisponibilidad as boolean ) as boolean                                                                                                                                               
		...
		lnParametros = pcount()
		lxParam1 = toitem
		lxParam2 = tlitemcontroladisponibilidad
	...
	*-----------------------------------------------------------------------------------------
	function incorporaelstockseniadoaldisponible() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function ocomponentestock_access() as variant                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Ocomponentestock_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function formarmensajecomb( toitemstock as object, tndisponibilidadactual as integer ) as string                                                                                                                                                
		...
		lxParam2 = tndisponibilidadactual
	...
	*-----------------------------------------------------------------------------------------
	protected function procesastock( toitem as object ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Procesastock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function seteardatosencomponentestock( toentidad as object, todetalle as object ) as void                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Seteardatosencomponentestock', lcParametros )
	EndFunc
