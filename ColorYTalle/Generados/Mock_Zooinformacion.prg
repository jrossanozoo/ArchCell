...
define class Mock_ZOOINFORMACION as MockBase of MockBase.prg

	cClase = 'ZOOINFORMACION'
	...
	*-----------------------------------------------------------------------------------------
	function existemensaje( tcmensaje as string ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Existemensaje', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function serializarinformacion() as string                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Serializarinformacion', lcParametros )
	EndFunc
