...
define class Mock_Detalleminimoreposicionminrepo as MockBase of MockBase.prg

	cClase = 'Detalleminimoreposicionminrepo'
	...
	cCopiadorDeDetalle = "CopiadorDeDetallesMinimoReposicion"                                                                                                                                                                                                 
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Combinaciones'                                                                                                                                                                                                                               
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'Las columnas Artículo + Color + Talle no admiten valores repetidos.'                                                                                                                                                             
	cNombre = 'Minrepo'                                                                                                                                                                                                                                       
	...
	*-----------------------------------------------------------------------------------------
	function validarmaximosyminimos() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmaximosyminimos', lcParametros )
	EndFunc
