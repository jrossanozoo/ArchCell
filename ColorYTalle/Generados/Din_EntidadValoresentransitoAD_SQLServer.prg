...
define class Din_EntidadVALORESENTRANSITOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxVtransFectrans, lxVtransFmodifw, lxVtransFaltafw, lxVtransFecexpo, lxVtransFecimpo, lxVtransCotiz, lxVtransHoraexpo, lxVtransHaltafw, lxVtransSmodifw, lxVtransHoraimpo, lxVtransVmodifw, lxVtransDescfw, lxVtransValtafw, lxVtransUmodifw, lxVtransSaltafw, lxVtransUaltafw, lxVtransHmodifw, lxVtransEsttrans, lxVtransEstadoacc, lxVtransBdmodifw, lxVtransVendedor, lxVtransBdaltafw, lxVtransTimestamp, lxVtransMoneda, lxVtransCodigo, lxVtransMobs, lxVtransCajaorig, lxVtransZadsfw, lxVtransNumero, lxVtransOrigdest, lxVtransFecha, lxVtransConcepto, lxVtransTipo, lxVtransDescvend
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.VTRANS ( "Fectrans","Fmodifw","Faltafw","Fecexpo","Fecimpo","Cotiz","Horaexpo","Haltafw","Smodifw","Horaimpo","Vmodifw","Descfw","Valtafw","Umodifw","Saltafw","Ualtafw","Hmodifw","Esttrans","Estadoacc","Bdmodifw","Vendedor","Bdaltafw","Timestamp","Moneda","Codigo","Mobs","Cajaorig","Zadsfw","Numero","Origdest","Fecha","Concepto","Tipo","Descvend" ) values ( <<"'" + this.ConvertirDateSql( lxVtransFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxVtransFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxVtransFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxVtransFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxVtransFecimpo ) + "'" >>, <<lxVtransCotiz >>, <<"'" + this.FormatearTextoSql( lxVtransHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransEstadoacc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransVendedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransBdaltafw ) + "'" >>, <<lxVtransTimestamp >>, <<"'" + this.FormatearTextoSql( lxVtransMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransMobs ) + "'" >>, <<lxVtransCajaorig >>, <<"'" + this.FormatearTextoSql( lxVtransZadsfw ) + "'" >>, <<lxVtransNumero >>, <<"'" + this.FormatearTextoSql( lxVtransOrigdest ) + "'" >>, <<"'" + this.ConvertirDateSql( lxVtransFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxVtransConcepto ) + "'" >>, <<lxVtransTipo >>, <<"'" + this.FormatearTextoSql( lxVtransDescvend ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.Valores
				if this.oEntidad.Valores.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.VTRANSDET("CodDetVal","Cotiza","Tipo","NROITEM","NroChProp","NroCheque","CodVal","Descrip","NroInterno","FechaEmi","FechaPago","Estado","monto" ) values ( <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<lxCotiza>>, <<lxTipo>>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxCodigochequepropio_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigocheque_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerointerno ) + "'">>, <<"'" + this.ConvertirDateSql( lxFechaemision ) + "'">>, <<"'" + this.ConvertirDateSql( lxFechapago ) + "'">>, <<"'" + this.FormatearTextoSql( lxEstadoenorigen ) + "'">>, <<lxMonto>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.VTRANS set "Fectrans" = <<"'" + this.ConvertirDateSql( lxVtransFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxVtransFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxVtransFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxVtransFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxVtransFecimpo ) + "'">>,"Cotiz" = <<lxVtransCotiz>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxVtransHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxVtransHaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxVtransSmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxVtransHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxVtransVmodifw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxVtransDescfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxVtransValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxVtransUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxVtransSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxVtransUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxVtransHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxVtransEsttrans ) + "'">>,"Estadoacc" = <<"'" + this.FormatearTextoSql( lxVtransEstadoacc ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxVtransBdmodifw ) + "'">>,"Vendedor" = <<"'" + this.FormatearTextoSql( lxVtransVendedor ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxVtransBdaltafw ) + "'">>,"Timestamp" = <<lxVtransTimestamp>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxVtransMoneda ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxVtransCodigo ) + "'">>,"Mobs" = <<"'" + this.FormatearTextoSql( lxVtransMobs ) + "'">>,"Cajaorig" = <<lxVtransCajaorig>>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxVtransZadsfw ) + "'">>,"Numero" = <<lxVtransNumero>>,"Origdest" = <<"'" + this.FormatearTextoSql( lxVtransOrigdest ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxVtransFecha ) + "'">>,"Concepto" = <<"'" + this.FormatearTextoSql( lxVtransConcepto ) + "'">>,"Tipo" = <<lxVtransTipo>>,"Descvend" = <<"'" + this.FormatearTextoSql( lxVtransDescvend ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxVtransCodigo ) + "'">> and  VTRANS.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fmodifw,Faltafw,Fecexpo,Fecimpo,Cotiz,Horaexpo,Haltafw,Smodifw,Horaimpo,Vmodifw,Des" + ;
"cfw,Valtafw,Umodifw,Saltafw,Ualtafw,Hmodifw,Esttrans,Estadoacc,Bdmodifw,Vendedor,Bdaltafw,Timestamp," + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleValores( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Coddetval" as "Codigo", "Cotiza" as "Cotiza", "Tipo" as "Tipo", "Nroitem" as "Nroitem", "Nrochprop" as "Codigochequepropio", "Nrocheque" as "Codigocheque", "Codval" as "Valor", "Descrip" as "Valordetalle", "Nrointerno" as "Numerointerno", "Fechaemi" as "Fechaemision", "Fechapago" as "Fechapago", "Estado" as "Estadoenorigen", "Monto" as "Monto"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.Valores
				if this.oEntidad.Valores.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxMonto = loItem.Monto
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.VTRANSDET("CodDetVal","Cotiza","Tipo","NROITEM","NroChProp","NroCheque","CodVal","Descrip","NroInterno","FechaEmi","FechaPago","Estado","monto" ) values ( << lcValorClavePrimariaString >>, <<lxCotiza>>, <<lxTipo>>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxCodigochequepropio_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigocheque_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerointerno ) + "'">>, <<"'" + this.ConvertirDateSql( lxFechaemision ) + "'">>, <<"'" + this.ConvertirDateSql( lxFechapago ) + "'">>, <<"'" + this.FormatearTextoSql( lxEstadoenorigen ) + "'">>, <<lxMonto>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.VTRANS set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, EstadoAcc = ] + "'" + this.FormatearTextoSql( &lcCursor..EstadoAcc ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, Vendedor = ] + "'" + this.FormatearTextoSql( &lcCursor..Vendedor ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, MObs = ] + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'"+ [, CajaOrig = ] + transform( &lcCursor..CajaOrig )+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, OrigDest = ] + "'" + this.FormatearTextoSql( &lcCursor..OrigDest ) + "'"+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, Concepto = ] + "'" + this.FormatearTextoSql( &lcCursor..Concepto ) + "'"+ [, Tipo = ] + transform( &lcCursor..Tipo )+ [, DescVend = ] + "'" + this.FormatearTextoSql( &lcCursor..DescVend ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECTRANS, FMODIFW, FALTAFW, FECEXPO, FECIMPO, Cotiz, HORAEXPO, HALTAFW, SMODIFW, HORAIMPO, VMODIFW, DescFW, VALTAFW, UMODIFW, SALTAFW, UALTAFW, HMODIFW, ESTTRANS, EstadoAcc, BDMODIFW, Vendedor, BDALTAFW, TIMESTAMP, Moneda, Codigo, MObs, CajaOrig, ZADSFW, Numero, OrigDest, Fecha, Concepto, Tipo, DescVend
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..EstadoAcc ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Vendedor ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'" + ',' + transform( &lcCursor..CajaOrig ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ESTADOACC = isnull( d.ESTADOACC, t.ESTADOACC ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VENDEDOR = isnull( d.VENDEDOR, t.VENDEDOR ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MOBS = isnull( d.MOBS, t.MOBS ),t.CAJAORIG = isnull( d.CAJAORIG, t.CAJAORIG ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.ORIGDEST = isnull( d.ORIGDEST, t.ORIGDEST ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.CONCEPTO = isnull( d.CONCEPTO, t.CONCEPTO ),t.TIPO = isnull( d.TIPO, t.TIPO ),t.DESCVEND = isnull( d.DESCVEND, t.DESCVEND )
					from ZooLogic.VTRANS t inner join deleted d 
							 on t.Codigo = d.Codigo
							 and  t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.VTRANS(Fectrans,Fmodifw,Faltafw,Fecexpo,Fecimpo,Cotiz,Horaexpo,Haltafw,Smodifw,Horaimpo,Vmodifw,Descfw,Valtafw,Umodifw,Saltafw,Ualtafw,Hmodifw,Esttrans,Estadoacc,Bdmodifw,Vendedor,Bdaltafw,Timestamp,Moneda,Codigo,Mobs,Cajaorig,Zadsfw,Numero,Origdest,Fecha,Concepto,Tipo,Descvend)
					Select isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),isnull( d.COTIZ,0),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.SMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.DESCFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.ESTADOACC,''),isnull( d.BDMODIFW,''),isnull( d.VENDEDOR,''),isnull( d.BDALTAFW,''),isnull( d.TIMESTAMP,0),isnull( d.MONEDA,''),isnull( d.CODIGO,''),isnull( d.MOBS,''),isnull( d.CAJAORIG,0),isnull( d.ZADSFW,''),isnull( d.NUMERO,0),isnull( d.ORIGDEST,''),isnull( d.FECHA,''),isnull( d.CONCEPTO,''),isnull( d.TIPO,0),isnull( d.DESCVEND,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="VALORESENTRANSITO                       " atributo="FECHATRANSFERENCIA                      " tabla="VTRANS         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALORESENTRANSITO                       " atributo="ESTADOTRANSFERENCIA                     " tabla="VTRANS         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
