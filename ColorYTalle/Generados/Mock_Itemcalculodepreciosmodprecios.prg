...
define class Mock_Itemcalculodepreciosmodprecios as MockBase of MockBase.prg

	cClase = 'Itemcalculodepreciosmodprecios'
	...
	*-----------------------------------------------------------------------------------------
	function esaccionformula() as boolean                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function esaccionpreciodirecto() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esaccionpreciodirecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lprecio_access() as variant                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Lprecio_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lprecio_pk_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Lprecio_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lprecioa_access() as variant                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Lprecioa_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lprecioa_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Lprecioa_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lpreciodetalle_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Lpreciodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_lprecio( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_lprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_lprecioa( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_lprecioa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_lpreciodetalle( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_lpreciodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_lprecio( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_lprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_lprecioa( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_lprecioa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_lpreciodetalle( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_lpreciodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarlistadeprecios( txval as variant, tolista as object ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridolprecio() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridolprecio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridolprecioa() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridolprecioa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridolpreciodetalle() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridolpreciodetalle', lcParametros )
	EndFunc
