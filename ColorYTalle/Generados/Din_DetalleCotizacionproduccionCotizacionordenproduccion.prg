...
define class Din_DetalleCOTIZACIONPRODUCCIONCotizacionordenproduccion as DetalleProduccioncolorytalle of DetalleProduccioncolorytalle.Prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Cotizacionordenproduccion' ) > 0 and reccount( 'c_Cotizacionordenproduccion' ) > 0
					sum Cantidad, Monto;
						 to ;
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'ItemCOTIZACIONPRODUCCIONCotizacionordenproduccion' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Cotizacionordenproduccion
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Cotizacionordenproduccion.Codigo
			loItem.Comportamiento = c_Cotizacionordenproduccion.Comportamiento
			loItem.IdItemInsumo = c_Cotizacionordenproduccion.IdItemInsumo
			loItem.NROITEM = c_Cotizacionordenproduccion.NROITEM
			loItem.Semielaborado_PK = c_Cotizacionordenproduccion.Semielaborado
			loItem.SemielaboradoDetalle = c_Cotizacionordenproduccion.SemielaboradoDetalle
			loItem.Color_PK = c_Cotizacionordenproduccion.Color
			loItem.ColorDetalle = c_Cotizacionordenproduccion.ColorDetalle
			loItem.Talle_PK = c_Cotizacionordenproduccion.Talle
			loItem.TalleDetalle = c_Cotizacionordenproduccion.TalleDetalle
			loItem.Cantidad = c_Cotizacionordenproduccion.Cantidad
			loItem.Articulo_PK = c_Cotizacionordenproduccion.Articulo
			loItem.ArticuloDetalle = c_Cotizacionordenproduccion.ArticuloDetalle
			loItem.Costo = c_Cotizacionordenproduccion.Costo
			loItem.Monto = c_Cotizacionordenproduccion.Monto
			loItem.NroItem = lnI 
