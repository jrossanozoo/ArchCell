...
define class Mock_Detallemovimientostockdesdeproduccmovimientodetalle as MockBase of MockBase.prg

	cClase = 'Detallemovimientostockdesdeproduccmovimientodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_cantidadstockdf() as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Eventocambiosum_cantidadstockdf', lcParametros )
	EndFunc
