...
define class Mock_Detallecuponespendientescupones as MockBase of MockBase.prg

	cClase = 'Detallecuponespendientescupones'
	...
	*-----------------------------------------------------------------------------------------
	function estaincluido( tnitem as integer ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Estaincluido', lcParametros )
	EndFunc
