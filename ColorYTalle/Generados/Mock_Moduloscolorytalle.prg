...
define class Mock_MODULOSCOLORYTALLE as MockBase of MockBase.prg

	cClase = 'MODULOSCOLORYTALLE'
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Existemodulosegunalias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Obtenernombremodulosegunalias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Tienemodulohabilitadosegunalias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarmodulosdemo() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Actualizarmodulosdemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function entidadhabilitada( tcentidad as string ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Entidadhabilitada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esproductomodularizado() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Esproductomodularizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estahabilitadopedidodecompra() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Estahabilitadopedidodecompra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existebuzondecasacentral() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Existebuzondecasacentral', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existemodulo( tcletramodulo as string ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Existemodulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modulohabilitado( tcmodulo as string ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Modulohabilitado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerletradelmoduloseguncodigodemoduloenzl( tccodigodemodulo as string ) as string                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerletradelmoduloseguncodigodemoduloenzl', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermodulos() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenermodulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oentidadesmodulos_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Oentidadesmodulos_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oexcepciones_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Oexcepciones_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function regmodact( tccodigo as string ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Regmodact', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarmodulosaas() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Verificarmodulosaas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function deshabilitarmodulo( tcmodulo as string ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Deshabilitarmodulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function entidadtienemenu( tcentidad as string ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Entidadtienemenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitarmodulo( tcmodulo as string ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Habilitarmodulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llenarcoleccion() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Llenarcoleccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llenarequivalencias() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Llenarequivalencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function modulonombre( tcmodulo as string ) as string                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Modulonombre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerletradeunmodulosegunalias( tcalias as string ) as character                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerletradeunmodulosegunalias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermodulo( tnid as integer, tcnombre as string, tcdescripcion as string, tcletra as string, tccodmoduzl as string ) as itemmodulo                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenermodulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearmodulo( tcmodulo as string, tlestado as boolean ) as void                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearmodulo', lcParametros )
	EndFunc
