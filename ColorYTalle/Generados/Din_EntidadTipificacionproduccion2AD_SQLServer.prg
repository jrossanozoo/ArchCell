...
define class Din_EntidadTIPIFICACIONPRODUCCION2AD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTipoprod2Fecexpo, lxTipoprod2Fmodifw, lxTipoprod2Fecimpo, lxTipoprod2Faltafw, lxTipoprod2Fectrans, lxTipoprod2Smodifw, lxTipoprod2Saltafw, lxTipoprod2Ualtafw, lxTipoprod2Valtafw, lxTipoprod2Umodifw, lxTipoprod2Zadsfw, lxTipoprod2Vmodifw, lxTipoprod2Hmodifw, lxTipoprod2Horaimpo, lxTipoprod2Esttrans, lxTipoprod2Bdmodifw, lxTipoprod2Haltafw, lxTipoprod2Horaexpo, lxTipoprod2Bdaltafw, lxTipoprod2Codcons, lxTipoprod2Cobs, lxTipoprod2Descrip
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TIPOPROD2 ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaimpo","Esttrans","Bdmodifw","Haltafw","Horaexpo","Bdaltafw","Codcons","Cobs","Descrip" ) values ( <<"'" + this.ConvertirDateSql( lxTipoprod2Fecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipoprod2Fmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipoprod2Fecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipoprod2Faltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipoprod2Fectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Smodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Saltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Ualtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Valtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Umodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Zadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Vmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Hmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Horaimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Esttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Bdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Haltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Horaexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Bdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Codcons ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Cobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipoprod2Descrip ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TIPOPROD2 set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTipoprod2Fecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTipoprod2Fmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTipoprod2Fecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTipoprod2Faltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTipoprod2Fectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Smodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Saltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Ualtafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Valtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Umodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Zadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Vmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Hmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTipoprod2Horaimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTipoprod2Esttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Bdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Haltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTipoprod2Horaexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTipoprod2Bdaltafw ) + "'">>,"Codcons" = <<"'" + this.FormatearTextoSql( lxTipoprod2Codcons ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxTipoprod2Cobs ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxTipoprod2Descrip ) + "'">> where "Codcons" = <<"'" + this.FormatearTextoSql( lxTipoprod2Codcons ) + "'">> and  TIPOPROD2.CODCONS != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Codcons" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion" from ZooLogic.TIPOPROD2 where  TIPOPROD2.CODCONS != '' order by CodCons
			endtext
			use in select('c_TIPIFICACIONPRODUCCION2')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPIFICACIONPRODUCCION2', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Codcons" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion" from ZooLogic.TIPOPROD2 where  funciones.padr( CodCons, 15, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIPOPROD2.CODCONS != '' order by CodCons
			endtext
			use in select('c_TIPIFICACIONPRODUCCION2')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPIFICACIONPRODUCCION2', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Codcons" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion" from ZooLogic.TIPOPROD2 where  funciones.padr( CodCons, 15, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIPOPROD2.CODCONS != '' order by CodCons desc
			endtext
			use in select('c_TIPIFICACIONPRODUCCION2')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPIFICACIONPRODUCCION2', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Codcons" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion" from ZooLogic.TIPOPROD2 where  TIPOPROD2.CODCONS != '' order by CodCons desc
			endtext
			use in select('c_TIPIFICACIONPRODUCCION2')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPIFICACIONPRODUCCION2', set( 'Datasession' ) )
			Endwith
	...
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			Begin
				...
				-- Fin Updates
				insert into ZooLogic.TIPOPROD2(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaimpo,Esttrans,Bdmodifw,Haltafw,Horaexpo,Bdaltafw,Codcons,Cobs,Descrip)
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIPIFICACIONPRODUCCION2                 " atributo="FECHATRANSFERENCIA                      " tabla="TIPOPROD2      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPIFICACIONPRODUCCION2                 " atributo="ESTADOTRANSFERENCIA                     " tabla="TIPOPROD2      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
