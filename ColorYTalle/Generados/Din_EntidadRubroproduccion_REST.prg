...
define class Din_EntidadRubroproduccion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Rubroproduccion"
	cClaseResponse = this.cNamespaceDTOs + ".RubroproduccionResponse"
	cClaseModelo = "RubroproduccionModelo"
	cEntidad = "Rubroproduccion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "RubroproduccionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "RubroproduccionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "RubroproduccionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "RubroproduccionModelo"
		endcase
		return lcRetorno
