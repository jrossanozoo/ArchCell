...
define class Din_EntidadCANCELACIONDESENIASAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCanseniaFectrans, lxCanseniaFecexpo, lxCanseniaFmodifw, lxCanseniaFecimpo, lxCanseniaHoraimpo, lxCanseniaHoraexpo, lxCanseniaHmodifw, lxCanseniaUmodifw, lxCanseniaSaltafw, lxCanseniaZadsfw, lxCanseniaDescfw, lxCanseniaValtafw, lxCanseniaVmodifw, lxCanseniaSmodifw, lxCanseniaUaltafw, lxCanseniaBdmodifw, lxCanseniaEsttrans, lxCanseniaFaltafw, lxCanseniaHaltafw, lxCanseniaBdaltafw, lxCanseniaFacttipo, lxCanseniaTimestamp, lxCanseniaCliente, lxCanseniaNumero, lxCanseniaCliedesde, lxCanseniaFfch, lxCanseniaCliehasta, lxCanseniaVigencia, lxCanseniaCodigo, lxCanseniaLetra, lxCanseniaPtoventa, lxCanseniaObs, lxCanseniaAnulado
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CANSENIA ( "Fectrans","Fecexpo","Fmodifw","Fecimpo","Horaimpo","Horaexpo","Hmodifw","Umodifw","Saltafw","Zadsfw","Descfw","Valtafw","Vmodifw","Smodifw","Ualtafw","Bdmodifw","Esttrans","Faltafw","Haltafw","Bdaltafw","Facttipo","Timestamp","Cliente","Numero","Cliedesde","Ffch","Cliehasta","Vigencia","Codigo","Letra","Ptoventa","Obs","Anulado" ) values ( <<"'" + this.ConvertirDateSql( lxCanseniaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCanseniaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCanseniaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCanseniaFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaEsttrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCanseniaFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaBdaltafw ) + "'" >>, <<lxCanseniaFacttipo >>, <<lxCanseniaTimestamp >>, <<"'" + this.FormatearTextoSql( lxCanseniaCliente ) + "'" >>, <<lxCanseniaNumero >>, <<"'" + this.FormatearTextoSql( lxCanseniaCliedesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCanseniaFfch ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaCliehasta ) + "'" >>, <<lxCanseniaVigencia >>, <<"'" + this.FormatearTextoSql( lxCanseniaCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCanseniaLetra ) + "'" >>, <<lxCanseniaPtoventa >>, <<"'" + this.FormatearTextoSql( lxCanseniaObs ) + "'" >>, <<iif( lxCanseniaAnulado, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CANSENIA set "Fectrans" = <<"'" + this.ConvertirDateSql( lxCanseniaFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCanseniaFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCanseniaFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCanseniaFecimpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCanseniaHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCanseniaHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCanseniaHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCanseniaUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCanseniaSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCanseniaZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxCanseniaDescfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCanseniaValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCanseniaVmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCanseniaSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCanseniaUaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCanseniaBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCanseniaEsttrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCanseniaFaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCanseniaHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCanseniaBdaltafw ) + "'">>,"Facttipo" = <<lxCanseniaFacttipo>>,"Timestamp" = <<lxCanseniaTimestamp>>,"Cliente" = <<"'" + this.FormatearTextoSql( lxCanseniaCliente ) + "'">>,"Numero" = <<lxCanseniaNumero>>,"Cliedesde" = <<"'" + this.FormatearTextoSql( lxCanseniaCliedesde ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxCanseniaFfch ) + "'">>,"Cliehasta" = <<"'" + this.FormatearTextoSql( lxCanseniaCliehasta ) + "'">>,"Vigencia" = <<lxCanseniaVigencia>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCanseniaCodigo ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxCanseniaLetra ) + "'">>,"Ptoventa" = <<lxCanseniaPtoventa>>,"Obs" = <<"'" + this.FormatearTextoSql( lxCanseniaObs ) + "'">>,"Anulado" = <<iif( lxCanseniaAnulado, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCanseniaCodigo ) + "'">> and  CANSENIA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fecexpo,Fmodifw,Fecimpo,Horaimpo,Horaexpo,Hmodifw,Umodifw,Saltafw,Zadsfw,Descfw,Val" + ;
"tafw,Vmodifw,Smodifw,Ualtafw,Bdmodifw,Esttrans,Faltafw,Haltafw,Bdaltafw,Facttipo,Timestamp,Cliente,N" + ;
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.CANSENIA set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Cliente = ] + "'" + this.FormatearTextoSql( &lcCursor..Cliente ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, Cliedesde = ] + "'" + this.FormatearTextoSql( &lcCursor..Cliedesde ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, Cliehasta = ] + "'" + this.FormatearTextoSql( &lcCursor..Cliehasta ) + "'"+ [, vigencia = ] + transform( &lcCursor..vigencia )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Letra = ] + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'"+ [, PtoVenta = ] + transform( &lcCursor..PtoVenta )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 )) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECTRANS, FECEXPO, FMODIFW, FECIMPO, HORAIMPO, HORAEXPO, HMODIFW, UMODIFW, SALTAFW, ZADSFW, DescFW, VALTAFW, VMODIFW, SMODIFW, UALTAFW, BDMODIFW, ESTTRANS, FAltaFW, HAltaFW, BDALTAFW, FACTTIPO, TIMESTAMP, Cliente, Numero, Cliedesde, FFCH, Cliehasta, vigencia, Codigo, Letra, PtoVenta, Obs, Anulado
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + transform( &lcCursor..FACTTIPO )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cliente ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cliedesde ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cliehasta ) + "'" + ',' + transform( &lcCursor..vigencia ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'" + ',' + transform( &lcCursor..PtoVenta ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.CLIENTE = isnull( d.CLIENTE, t.CLIENTE ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.CLIEDESDE = isnull( d.CLIEDESDE, t.CLIEDESDE ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.CLIEHASTA = isnull( d.CLIEHASTA, t.CLIEHASTA ),t.VIGENCIA = isnull( d.VIGENCIA, t.VIGENCIA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.PTOVENTA = isnull( d.PTOVENTA, t.PTOVENTA ),t.OBS = isnull( d.OBS, t.OBS ),t.ANULADO = isnull( d.ANULADO, t.ANULADO )
				...
				-- Fin Updates
				insert into ZooLogic.CANSENIA(Fectrans,Fecexpo,Fmodifw,Fecimpo,Horaimpo,Horaexpo,Hmodifw,Umodifw,Saltafw,Zadsfw,Descfw,Valtafw,Vmodifw,Smodifw,Ualtafw,Bdmodifw,Esttrans,Faltafw,Haltafw,Bdaltafw,Facttipo,Timestamp,Cliente,Numero,Cliedesde,Ffch,Cliehasta,Vigencia,Codigo,Letra,Ptoventa,Obs,Anulado)
					Select isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.FACTTIPO,0),isnull( d.TIMESTAMP,0),isnull( d.CLIENTE,''),isnull( d.NUMERO,0),isnull( d.CLIEDESDE,''),isnull( d.FFCH,''),isnull( d.CLIEHASTA,''),isnull( d.VIGENCIA,0),isnull( d.CODIGO,''),isnull( d.LETRA,''),isnull( d.PTOVENTA,0),isnull( d.OBS,''),isnull( d.ANULADO,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="CANCELACIONDESENIAS                     " atributo="FECHATRANSFERENCIA                      " tabla="CANSENIA       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDESENIAS                     " atributo="ESTADOTRANSFERENCIA                     " tabla="CANSENIA       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDESENIAS                     " atributo="HORAALTAFW                              " tabla="CANSENIA       " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="=goservicios.librerias.obtenerHora()                                                                                                                                                                                                                          " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDESENIAS                     " atributo="CLIENTEDESDE                            " tabla="CANSENIA       " campo="CLIEDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Cliente desde                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CANCELACIONDESENIAS                     " atributo="CLIENTEHASTA                            " tabla="CANSENIA       " campo="CLIEHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="8" etiqueta="Cliente hasta                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
