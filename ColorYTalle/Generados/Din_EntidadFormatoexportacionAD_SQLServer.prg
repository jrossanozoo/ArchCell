...
define class Din_EntidadFORMATOEXPORTACIONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxFormatosFmodifw, lxFormatosFectrans, lxFormatosFecimpo, lxFormatosFecexpo, lxFormatosFaltafw, lxFormatosHaltafw, lxFormatosEsttrans, lxFormatosHoraexpo, lxFormatosHmodifw, lxFormatosHoraimpo, lxFormatosVmodifw, lxFormatosZadsfw, lxFormatosValtafw, lxFormatosUaltafw, lxFormatosUmodifw, lxFormatosSaltafw, lxFormatosSmodifw, lxFormatosBdmodifw, lxFormatosBdaltafw, lxFormatosBloqreg, lxFormatosCobs, lxFormatosCodigo, lxFormatosDescrip, lxFormatosAlineacion, lxFormatosCapitaliz, lxFormatosCompizq, lxFormatosCompder, lxFormatosTruncar, lxFormatosCantdeci, lxFormatosSepdec, lxFormatosSecmiles, lxFormatosInicial, lxFormatosLltrim, lxFormatosLrtrim, lxFormatosComillas, lxFormatosComienza, lxFormatosFormfecha, lxFormatosOtroform
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.FORMATOS ( "Fmodifw","Fectrans","Fecimpo","Fecexpo","Faltafw","Haltafw","Esttrans","Horaexpo","Hmodifw","Horaimpo","Vmodifw","Zadsfw","Valtafw","Ualtafw","Umodifw","Saltafw","Smodifw","Bdmodifw","Bdaltafw","Bloqreg","Cobs","Codigo","Descrip","Alineacion","Capitaliz","Compizq","Compder","Truncar","Cantdeci","Sepdec","Secmiles","Inicial","Lltrim","Lrtrim","Comillas","Comienza","Formfecha","Otroform" ) values ( <<"'" + this.ConvertirDateSql( lxFormatosFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFormatosFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFormatosFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFormatosFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFormatosFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosBdaltafw ) + "'" >>, <<iif( lxFormatosBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxFormatosCobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosAlineacion ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosCapitaliz ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosCompizq ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosCompder ) + "'" >>, <<iif( lxFormatosTruncar, 1, 0 ) >>, <<lxFormatosCantdeci >>, <<"'" + this.FormatearTextoSql( lxFormatosSepdec ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosSecmiles ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosInicial ) + "'" >>, <<iif( lxFormatosLltrim, 1, 0 ) >>, <<iif( lxFormatosLrtrim, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxFormatosComillas ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosComienza ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosFormfecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFormatosOtroform ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.FORMATOS set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxFormatosFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxFormatosFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxFormatosFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxFormatosFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxFormatosFaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxFormatosHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxFormatosEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxFormatosHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxFormatosHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxFormatosHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxFormatosVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxFormatosZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxFormatosValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxFormatosUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxFormatosUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxFormatosSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxFormatosSmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxFormatosBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxFormatosBdaltafw ) + "'">>,"Bloqreg" = <<iif( lxFormatosBloqreg, 1, 0 )>>,"Cobs" = <<"'" + this.FormatearTextoSql( lxFormatosCobs ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxFormatosCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxFormatosDescrip ) + "'">>,"Alineacion" = <<"'" + this.FormatearTextoSql( lxFormatosAlineacion ) + "'">>,"Capitaliz" = <<"'" + this.FormatearTextoSql( lxFormatosCapitaliz ) + "'">>,"Compizq" = <<"'" + this.FormatearTextoSql( lxFormatosCompizq ) + "'">>,"Compder" = <<"'" + this.FormatearTextoSql( lxFormatosCompder ) + "'">>,"Truncar" = <<iif( lxFormatosTruncar, 1, 0 )>>,"Cantdeci" = <<lxFormatosCantdeci>>,"Sepdec" = <<"'" + this.FormatearTextoSql( lxFormatosSepdec ) + "'">>,"Secmiles" = <<"'" + this.FormatearTextoSql( lxFormatosSecmiles ) + "'">>,"Inicial" = <<"'" + this.FormatearTextoSql( lxFormatosInicial ) + "'">>,"Lltrim" = <<iif( lxFormatosLltrim, 1, 0 )>>,"Lrtrim" = <<iif( lxFormatosLrtrim, 1, 0 )>>,"Comillas" = <<"'" + this.FormatearTextoSql( lxFormatosComillas ) + "'">>,"Comienza" = <<"'" + this.FormatearTextoSql( lxFormatosComienza ) + "'">>,"Formfecha" = <<"'" + this.FormatearTextoSql( lxFormatosFormfecha ) + "'">>,"Otroform" = <<"'" + this.FormatearTextoSql( lxFormatosOtroform ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxFormatosCodigo ) + "'">> and  FORMATOS.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Haltafw,Esttrans,Horaexpo,Hmodifw,Horaimpo,Vmodifw," + ;
"Zadsfw,Valtafw,Ualtafw,Umodifw,Saltafw,Smodifw,Bdmodifw,Bdaltafw,Bloqreg,Cobs,Codigo,Descrip,Alineac" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.FORMATOS set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, cObs = ] + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"+ [, descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'"+ [, alineacion = ] + "'" + this.FormatearTextoSql( &lcCursor..alineacion ) + "'"+ [, capitaliz = ] + "'" + this.FormatearTextoSql( &lcCursor..capitaliz ) + "'"+ [, compizq = ] + "'" + this.FormatearTextoSql( &lcCursor..compizq ) + "'"+ [, compder = ] + "'" + this.FormatearTextoSql( &lcCursor..compder ) + "'"+ [, Truncar = ] + Transform( iif( &lcCursor..Truncar, 1, 0 ))+ [, CantDeci = ] + transform( &lcCursor..CantDeci )+ [, sepdec = ] + "'" + this.FormatearTextoSql( &lcCursor..sepdec ) + "'"+ [, secmiles = ] + "'" + this.FormatearTextoSql( &lcCursor..secmiles ) + "'"+ [, inicial = ] + "'" + this.FormatearTextoSql( &lcCursor..inicial ) + "'"+ [, lltrim = ] + Transform( iif( &lcCursor..lltrim, 1, 0 ))+ [, lrtrim = ] + Transform( iif( &lcCursor..lrtrim, 1, 0 ))+ [, comillas = ] + "'" + this.FormatearTextoSql( &lcCursor..comillas ) + "'"+ [, comienza = ] + "'" + this.FormatearTextoSql( &lcCursor..comienza ) + "'"+ [, formfecha = ] + "'" + this.FormatearTextoSql( &lcCursor..formfecha ) + "'"+ [, otroform = ] + "'" + this.FormatearTextoSql( &lcCursor..otroform ) + "'" + [ Where codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" )
...
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.COBS = isnull( d.COBS, t.COBS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.ALINEACION = isnull( d.ALINEACION, t.ALINEACION ),t.CAPITALIZ = isnull( d.CAPITALIZ, t.CAPITALIZ ),t.COMPIZQ = isnull( d.COMPIZQ, t.COMPIZQ ),t.COMPDER = isnull( d.COMPDER, t.COMPDER ),t.TRUNCAR = isnull( d.TRUNCAR, t.TRUNCAR ),t.CANTDECI = isnull( d.CANTDECI, t.CANTDECI ),t.SEPDEC = isnull( d.SEPDEC, t.SEPDEC ),t.SECMILES = isnull( d.SECMILES, t.SECMILES ),t.INICIAL = isnull( d.INICIAL, t.INICIAL ),t.LLTRIM = isnull( d.LLTRIM, t.LLTRIM ),t.LRTRIM = isnull( d.LRTRIM, t.LRTRIM ),t.COMILLAS = isnull( d.COMILLAS, t.COMILLAS ),t.COMIENZA = isnull( d.COMIENZA, t.COMIENZA ),t.FORMFECHA = isnull( d.FORMFECHA, t.FORMFECHA ),t.OTROFORM = isnull( d.OTROFORM, t.OTROFORM )
					from ORGANIZACION.FORMATOS t inner join deleted d 
							 on t.codigo = d.codigo
				-- Fin Updates
				insert into ORGANIZACION.FORMATOS(Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Haltafw,Esttrans,Horaexpo,Hmodifw,Horaimpo,Vmodifw,Zadsfw,Valtafw,Ualtafw,Umodifw,Saltafw,Smodifw,Bdmodifw,Bdaltafw,Bloqreg,Cobs,Codigo,Descrip,Alineacion,Capitaliz,Compizq,Compder,Truncar,Cantdeci,Sepdec,Secmiles,Inicial,Lltrim,Lrtrim,Comillas,Comienza,Formfecha,Otroform)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.BLOQREG,0),isnull( d.COBS,''),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.ALINEACION,''),isnull( d.CAPITALIZ,''),isnull( d.COMPIZQ,''),isnull( d.COMPDER,''),isnull( d.TRUNCAR,0),isnull( d.CANTDECI,0),isnull( d.SEPDEC,''),isnull( d.SECMILES,''),isnull( d.INICIAL,''),isnull( d.LLTRIM,0),isnull( d.LRTRIM,0),isnull( d.COMILLAS,''),isnull( d.COMIENZA,''),isnull( d.FORMFECHA,''),isnull( d.OTROFORM,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="FORMATOEXPORTACION                      " atributo="FECHATRANSFERENCIA                      " tabla="FORMATOS       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FORMATOEXPORTACION                      " atributo="ESTADOTRANSFERENCIA                     " tabla="FORMATOS       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FORMATOEXPORTACION                      " atributo="OBS                                     " tabla="FORMATOS       " campo="COBS      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FORMATOEXPORTACION                      " atributo="SIMBOLOINICIAL                          " tabla="FORMATOS       " campo="INICIAL   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="209" etiqueta="Símbolo inicial                                                                                                                                                 " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="70" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
