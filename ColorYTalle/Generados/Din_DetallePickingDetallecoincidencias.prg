...
define class Din_DetallePICKINGDetallecoincidencias as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemPICKINGDetallecoincidencias' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Detallecoincidencias
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Detallecoincidencias.Codigo
			loItem.Articulo_PK = c_Detallecoincidencias.Articulo
			loItem.Equivalencia_PK = c_Detallecoincidencias.Equivalencia
			loItem.NROITEM = c_Detallecoincidencias.NROITEM
			loItem.Color_PK = c_Detallecoincidencias.Color
			loItem.Talle_PK = c_Detallecoincidencias.Talle
			loItem.Cantidad = c_Detallecoincidencias.Cantidad
			loItem.NroItem = lnI 
