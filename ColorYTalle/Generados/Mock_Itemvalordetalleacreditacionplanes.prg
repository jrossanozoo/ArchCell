...
define class Mock_Itemvalordetalleacreditacionplanes as MockBase of MockBase.prg

	cClase = 'Itemvalordetalleacreditacionplanes'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidaddedias() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridocantidaddedias', lcParametros )
	EndFunc
