...
define class Mock_Expoagrupadasad_sqlserver as MockBase of MockBase.prg

	cClase = 'Expoagrupadasad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_expoagrupitem( tctablatrabajo ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_expoagrupitem', lcParametros )
	EndFunc
