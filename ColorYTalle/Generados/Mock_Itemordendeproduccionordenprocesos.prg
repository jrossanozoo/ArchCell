...
define class Mock_Itemordendeproduccionordenprocesos as MockBase of MockBase.prg

	cClase = 'Itemordendeproduccionordenprocesos'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprocesodetalle() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridoprocesodetalle', lcParametros )
	EndFunc
