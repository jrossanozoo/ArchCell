		...
		for lni = 1 to this.Count
			...
			if vartype( this.Item[lni].PRECIO) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo PRECIO del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
			...
			if vartype( this.Item[lni].RESULTADO) = 'N'
				...
				if lnLargoEntero <= 13
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo RESULTADO del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:13), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
