...
define class Mock_Conveniomultilateralad_sqlserver as MockBase of MockBase.prg

	cClase = 'Conveniomultilateralad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleimpuestosconvenio( tcatributo as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercampodetalleimpuestosconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleimpuestosconvenio( tccampos as string ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleimpuestosconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleimpuestosconvenio( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleimpuestosconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detconvenio( tctablatrabajo ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detconvenio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleimpuestosconvenio( tccampos as string ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleimpuestosconvenio', lcParametros )
	EndFunc
