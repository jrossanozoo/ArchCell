...
define class Din_EntidadFacturaagrupada_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Facturaagrupada"
	cClaseResponse = this.cNamespaceDTOs + ".FacturaagrupadaResponse"
	cClaseModelo = "FacturaagrupadaModelo"
	cEntidad = "Facturaagrupada"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaagrupadaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaagrupadaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaagrupadaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "FacturaagrupadaModelo"
		endcase
		return lcRetorno
