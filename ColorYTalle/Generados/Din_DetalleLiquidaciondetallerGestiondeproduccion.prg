...
define class Din_DetalleLIQUIDACIONDETALLERGestiondeproduccion as detalle of detalle.prg
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.EntidadComprobante = this.Item[ tnItem ].EntidadComprobante
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'EntidadComprobante', .EntidadComprobante )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.EntidadComprobante = this.oItem.EntidadComprobante
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].EntidadComprobante = .oItem.EntidadComprobante
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemLIQUIDACIONDETALLERGestiondeproduccion' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Gestiondeproduccion
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Gestiondeproduccion.Codigo
			loItem.TipoComprobante = c_Gestiondeproduccion.TipoComprobante
			loItem.NROITEM = c_Gestiondeproduccion.NROITEM
			loItem.TipoCompCaracter = c_Gestiondeproduccion.TipoCompCaracter
			loItem.Letra = c_Gestiondeproduccion.Letra
			loItem.PuntoDeVenta = c_Gestiondeproduccion.PuntoDeVenta
			loItem.Numero = c_Gestiondeproduccion.Numero
			loItem.Fecha = goLibrerias.ObtenerFechaFormateada( c_Gestiondeproduccion.Fecha )
			loItem.Total = c_Gestiondeproduccion.Total
			loItem.Vendedor = c_Gestiondeproduccion.Vendedor
			loItem.Tipo = c_Gestiondeproduccion.Tipo
			loItem.Afecta = c_Gestiondeproduccion.Afecta
			loItem.Interviniente = c_Gestiondeproduccion.Interviniente
			loItem.NombreEntidad = c_Gestiondeproduccion.NombreEntidad
			loItem.CodigoEntidad = c_Gestiondeproduccion.CodigoEntidad
			loItem.Origen = c_Gestiondeproduccion.Origen
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Entidadcomprobante = toItemOrigen.Entidadcomprobante
