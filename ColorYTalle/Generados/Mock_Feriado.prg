...
define class Mock_feriado as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function actualizarfechascargadas() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Actualizarfechascargadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallefechas() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallefechas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detallefechas_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'FERIADO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallefechas_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallefechas_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallefechas ) = 'O' or isnull( this.Detallefechas ) )			this.Detallefechas = this.crearobjeto( 'Din_DetalleFeriadoDetallefechas' )			this.Detallefechas.inicializar()			this.enlazar( 'Detallefechas.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallefechas.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallefechas, 'CambioSumarizado', this, 'CambiosDetalleDetallefechas', 1)			this.enlazar( 'Detallefechas.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallefechas.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detallefechas.lVerificarLimitesEnDisenoImpresion = .t.				this.Detallefechas.lHabilitaInsertarDetalle = .t.		endif		return this.Detallefechas
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambioanio( tnanio as integer ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Eventocambioanio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiodetalle() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Eventocambiodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existeferiado( tdfecha as date ) as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Existeferiado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esexcepcioncodigoyaexiste( txval as variant, toerror as exception ) as boolean                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Esexcepcioncodigoyaexiste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenernuevoanio() as integer                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenernuevoanio', lcParametros )
	EndFunc
