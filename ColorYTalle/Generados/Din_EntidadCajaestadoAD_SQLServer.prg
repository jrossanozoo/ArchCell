...
define class Din_EntidadCAJAESTADOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCajaestaFectrans, lxCajaestaFaltafw, lxCajaestaFecexpo, lxCajaestaFmodifw, lxCajaestaFecimpo, lxCajaestaHoraexpo, lxCajaestaHaltafw, lxCajaestaHmodifw, lxCajaestaHoraimpo, lxCajaestaVmodifw, lxCajaestaZadsfw, lxCajaestaValtafw, lxCajaestaUmodifw, lxCajaestaSmodifw, lxCajaestaUaltafw, lxCajaestaSaltafw, lxCajaestaEsttrans, lxCajaestaBdmodifw, lxCajaestaBdaltafw, lxCajaestaTimestamp, lxCajaestaObs, lxCajaestaNumcaja, lxCajaestaDescrip, lxCajaestaFecha, lxCajaestaIdcajaaud, lxCajaestaEstado, lxCajaestaIdusuariop, lxCajaestaFechap, lxCajaestaArqueo, lxCajaestaUsavend, lxCajaestaTotmoneda
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CAJAESTA ( "Fectrans","Faltafw","Fecexpo","Fmodifw","Fecimpo","Horaexpo","Haltafw","Hmodifw","Horaimpo","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Saltafw","Esttrans","Bdmodifw","Bdaltafw","Timestamp","Obs","Numcaja","Descrip","Fecha","Idcajaaud","Estado","Idusuariop","Fechap","Arqueo","Usavend","Totmoneda" ) values ( <<"'" + this.ConvertirDateSql( lxCajaestaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaestaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaestaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaestaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaestaFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaBdaltafw ) + "'" >>, <<lxCajaestaTimestamp >>, <<"'" + this.FormatearTextoSql( lxCajaestaObs ) + "'" >>, <<lxCajaestaNumcaja >>, <<"'" + this.FormatearTextoSql( lxCajaestaDescrip ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaestaFecha ) + "'" >>, <<lxCajaestaIdcajaaud >>, <<"'" + this.FormatearTextoSql( lxCajaestaEstado ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCajaestaIdusuariop ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCajaestaFechap ) + "'" >>, <<iif( lxCajaestaArqueo, 1, 0 ) >>, <<iif( lxCajaestaUsavend, 1, 0 ) >>, <<iif( lxCajaestaTotmoneda, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CAJAESTA set "Fectrans" = <<"'" + this.ConvertirDateSql( lxCajaestaFectrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCajaestaFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCajaestaFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCajaestaFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCajaestaFecimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCajaestaHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCajaestaHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCajaestaHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCajaestaHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCajaestaVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCajaestaZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCajaestaValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCajaestaUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCajaestaSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCajaestaUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCajaestaSaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCajaestaEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCajaestaBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCajaestaBdaltafw ) + "'">>,"Timestamp" = <<lxCajaestaTimestamp>>,"Obs" = <<"'" + this.FormatearTextoSql( lxCajaestaObs ) + "'">>,"Numcaja" = <<lxCajaestaNumcaja>>,"Descrip" = <<"'" + this.FormatearTextoSql( lxCajaestaDescrip ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxCajaestaFecha ) + "'">>,"Idcajaaud" = <<lxCajaestaIdcajaaud>>,"Estado" = <<"'" + this.FormatearTextoSql( lxCajaestaEstado ) + "'">>,"Idusuariop" = <<"'" + this.FormatearTextoSql( lxCajaestaIdusuariop ) + "'">>,"Fechap" = <<"'" + this.ConvertirDateSql( lxCajaestaFechap ) + "'">>,"Arqueo" = <<iif( lxCajaestaArqueo, 1, 0 )>>,"Usavend" = <<iif( lxCajaestaUsavend, 1, 0 )>>,"Totmoneda" = <<iif( lxCajaestaTotmoneda, 1, 0 )>> where "Numcaja" = <<lxCajaestaNumcaja>> and  CAJAESTA.NUMCAJA != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Faltafw,Fecexpo,Fmodifw,Fecimpo,Horaexpo,Haltafw,Hmodifw,Horaimpo,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Smodifw,Ualtafw,Saltafw,Esttrans,Bdmodifw,Bdaltafw,Timestamp,Obs,Numcaja,Descrip,Fecha" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FALTAFW, FECEXPO, FMODIFW, FECIMPO, HORAEXPO, HALTAFW, HMODIFW, HORAIMPO, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, SALTAFW, ESTTRANS, BDMODIFW, BDALTAFW, TIMESTAMP, Obs, NumCaja, Descrip, Fecha, Estado, idUsuarioP, Fechap, Arqueo, UsaVend, TotMoneda
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.OBS = isnull( d.OBS, t.OBS ),t.NUMCAJA = isnull( d.NUMCAJA, t.NUMCAJA ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.IDCAJAAUD = isnull( d.IDCAJAAUD, t.IDCAJAAUD ),t.ESTADO = isnull( d.ESTADO, t.ESTADO ),t.IDUSUARIOP = isnull( d.IDUSUARIOP, t.IDUSUARIOP ),t.FECHAP = isnull( d.FECHAP, t.FECHAP ),t.ARQUEO = isnull( d.ARQUEO, t.ARQUEO ),t.USAVEND = isnull( d.USAVEND, t.USAVEND ),t.TOTMONEDA = isnull( d.TOTMONEDA, t.TOTMONEDA )
					from ZooLogic.CAJAESTA t inner join deleted d 
							 on t.NumCaja = d.NumCaja
				-- Fin Updates
				insert into ZooLogic.CAJAESTA(Fectrans,Faltafw,Fecexpo,Fmodifw,Fecimpo,Horaexpo,Haltafw,Hmodifw,Horaimpo,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Saltafw,Esttrans,Bdmodifw,Bdaltafw,Timestamp,Obs,Numcaja,Descrip,Fecha,Idcajaaud,Estado,Idusuariop,Fechap,Arqueo,Usavend,Totmoneda)
					Select isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.TIMESTAMP,0),isnull( d.OBS,''),isnull( d.NUMCAJA,0),isnull( d.DESCRIP,''),isnull( d.FECHA,''),isnull( d.IDCAJAAUD,0),isnull( d.ESTADO,''),isnull( d.IDUSUARIOP,''),isnull( d.FECHAP,''),isnull( d.ARQUEO,0),isnull( d.USAVEND,0),isnull( d.TOTMONEDA,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="CAJAESTADO                              " atributo="DESCRIPCIONESTADO                       " tabla="CAJAESTA       " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="201" etiqueta="Estado descripción                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAJAESTADO                              " atributo="FECHAPROCESANDO                         " tabla="CAJAESTA       " campo="FECHAP    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha                                                                                                                                                           " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="8" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
