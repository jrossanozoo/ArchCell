...
define class Din_DetalleCOTIZACIONPRODUCCIONCotizacionordendescarte as DetalleProduccioncolorytalle of DetalleProduccioncolorytalle.Prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Cotizacionordendescarte' ) > 0 and reccount( 'c_Cotizacionordendescarte' ) > 0
					sum Cantidad, Monto;
						 to ;
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'ItemCOTIZACIONPRODUCCIONCotizacionordendescarte' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Cotizacionordendescarte
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Cotizacionordendescarte.Codigo
			loItem.Comportamiento = c_Cotizacionordendescarte.Comportamiento
			loItem.IdItemInsumo = c_Cotizacionordendescarte.IdItemInsumo
			loItem.NROITEM = c_Cotizacionordendescarte.NROITEM
			loItem.Semielaborado_PK = c_Cotizacionordendescarte.Semielaborado
			loItem.SemielaboradoDetalle = c_Cotizacionordendescarte.SemielaboradoDetalle
			loItem.Color_PK = c_Cotizacionordendescarte.Color
			loItem.ColorDetalle = c_Cotizacionordendescarte.ColorDetalle
			loItem.Talle_PK = c_Cotizacionordendescarte.Talle
			loItem.TalleDetalle = c_Cotizacionordendescarte.TalleDetalle
			loItem.Cantidad = c_Cotizacionordendescarte.Cantidad
			loItem.Articulo_PK = c_Cotizacionordendescarte.Articulo
			loItem.ArticuloDetalle = c_Cotizacionordendescarte.ArticuloDetalle
			loItem.Costo = c_Cotizacionordendescarte.Costo
			loItem.Monto = c_Cotizacionordendescarte.Monto
			loItem.NroItem = lnI 
