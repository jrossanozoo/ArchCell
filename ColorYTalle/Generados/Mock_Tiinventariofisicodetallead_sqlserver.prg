...
define class Mock_Tiinventariofisicodetallead_sqlserver as MockBase of MockBase.prg

	cClase = 'Tiinventariofisicodetallead_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function validacionbasicaobligatoriofkidcabecera( toconexion, lcexpresionmensaje, lcwhere, lccamposlogueo, lcvalueslogueocomunes ) as void                                                                                                                
		...
		return this.ObtenerResultado( 'Validacionbasicaobligatoriofkidcabecera', lcParametros )
	EndFunc
