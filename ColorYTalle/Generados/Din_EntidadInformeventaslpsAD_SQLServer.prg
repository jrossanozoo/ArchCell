...
define class Din_EntidadINFORMEVENTASLPSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxInfovtaslpsFecexpo, lxInfovtaslpsFectrans, lxInfovtaslpsFecimpo, lxInfovtaslpsFaltafw, lxInfovtaslpsFmodifw, lxInfovtaslpsFecinfo, lxInfovtaslpsSaltafw, lxInfovtaslpsHmodifw, lxInfovtaslpsSmodifw, lxInfovtaslpsUmodifw, lxInfovtaslpsUaltafw, lxInfovtaslpsZadsfw, lxInfovtaslpsValtafw, lxInfovtaslpsVmodifw, lxInfovtaslpsHoraimpo, lxInfovtaslpsHoraexpo, lxInfovtaslpsMensaje, lxInfovtaslpsEsttrans, lxInfovtaslpsBdaltafw, lxInfovtaslpsHorainfo, lxInfovtaslpsHaltafw, lxInfovtaslpsBdmodifw, lxInfovtaslpsTimestamp, lxInfovtaslpsEstado, lxInfovtaslpsIndentif, lxInfovtaslpsCodigo
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.INFOVTASLPS ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Fecinfo","Saltafw","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Horaimpo","Horaexpo","Mensaje","Esttrans","Bdaltafw","Horainfo","Haltafw","Bdmodifw","Timestamp","Estado","Indentif","Codigo" ) values ( <<"'" + this.ConvertirDateSql( lxInfovtaslpsFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInfovtaslpsFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInfovtaslpsFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInfovtaslpsFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInfovtaslpsFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxInfovtaslpsFecinfo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsMensaje ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsHorainfo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsBdmodifw ) + "'" >>, <<lxInfovtaslpsTimestamp >>, <<lxInfovtaslpsEstado >>, <<lxInfovtaslpsIndentif >>, <<"'" + this.FormatearTextoSql( lxInfovtaslpsCodigo ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.INFOVTASLPS set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxInfovtaslpsFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxInfovtaslpsFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxInfovtaslpsFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxInfovtaslpsFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxInfovtaslpsFmodifw ) + "'">>,"Fecinfo" = <<"'" + this.ConvertirDateSql( lxInfovtaslpsFecinfo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsSaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsVmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsHoraexpo ) + "'">>,"Mensaje" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsMensaje ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsBdaltafw ) + "'">>,"Horainfo" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsHorainfo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsBdmodifw ) + "'">>,"Timestamp" = <<lxInfovtaslpsTimestamp>>,"Estado" = <<lxInfovtaslpsEstado>>,"Indentif" = <<lxInfovtaslpsIndentif>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsCodigo ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsCodigo ) + "'">> and  INFOVTASLPS.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecinfo" as "Fechainforme", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Mensaje" as "Mensaje", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horainfo" as "Horainforme", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Estado" as "Estado", "Indentif" as "Identificador", "Codigo" as "Codigo" from ZooLogic.INFOVTASLPS where "Codigo" = <<"'" + this.FormatearTextoSql( lxInfovtaslpsCodigo ) + "'">> and  INFOVTASLPS.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecinfo" as "Fechainforme", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Mensaje" as "Mensaje", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horainfo" as "Horainforme", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Estado" as "Estado", "Indentif" as "Identificador", "Codigo" as "Codigo" from ZooLogic.INFOVTASLPS where  INFOVTASLPS.CODIGO != '' order by CODIGO
			endtext
			use in select('c_INFORMEVENTASLPS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_INFORMEVENTASLPS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecinfo" as "Fechainforme", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Mensaje" as "Mensaje", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horainfo" as "Horainforme", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Estado" as "Estado", "Indentif" as "Identificador", "Codigo" as "Codigo" from ZooLogic.INFOVTASLPS where  funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  INFOVTASLPS.CODIGO != '' order by CODIGO
			endtext
			use in select('c_INFORMEVENTASLPS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_INFORMEVENTASLPS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecinfo" as "Fechainforme", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Mensaje" as "Mensaje", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horainfo" as "Horainforme", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Estado" as "Estado", "Indentif" as "Identificador", "Codigo" as "Codigo" from ZooLogic.INFOVTASLPS where  funciones.padr( CODIGO, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  INFOVTASLPS.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_INFORMEVENTASLPS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_INFORMEVENTASLPS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecinfo" as "Fechainforme", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Mensaje" as "Mensaje", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horainfo" as "Horainforme", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Estado" as "Estado", "Indentif" as "Identificador", "Codigo" as "Codigo" from ZooLogic.INFOVTASLPS where  INFOVTASLPS.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_INFORMEVENTASLPS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_INFORMEVENTASLPS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Fecinfo,Saltafw,Hmodifw,Smodifw,Umodifw,Ualtafw,Zad" + ;
"sfw,Valtafw,Vmodifw,Horaimpo,Horaexpo,Mensaje,Esttrans,Bdaltafw,Horainfo,Haltafw,Bdmodifw,Timestamp," + ;
"Estado,Indentif,Codigo" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecinfo" as "Fechainforme", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Mensaje" as "Mensaje", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horainfo" as "Horainforme", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timestamp" as "Timestamp", "Estado" as "Estado", "Indentif" as "Identificador", "Codigo" as "Codigo"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.INFOVTASLPS set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECINFO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECINFO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, MENSAJE = ] + "'" + this.FormatearTextoSql( &lcCursor..MENSAJE ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAINFO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAINFO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, ESTADO = ] + transform( &lcCursor..ESTADO )+ [, INDENTIF = ] + transform( &lcCursor..INDENTIF )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, FECINFO, SALTAFW, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HORAIMPO, HORAEXPO, MENSAJE, ESTTRANS, BDALTAFW, HORAINFO, HALTAFW, BDMODIFW, TIMESTAMP, ESTADO, INDENTIF, CODIGO
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECINFO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MENSAJE ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAINFO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..ESTADO ) + ',' + transform( &lcCursor..INDENTIF ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECINFO = isnull( d.FECINFO, t.FECINFO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.MENSAJE = isnull( d.MENSAJE, t.MENSAJE ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAINFO = isnull( d.HORAINFO, t.HORAINFO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.ESTADO = isnull( d.ESTADO, t.ESTADO ),t.INDENTIF = isnull( d.INDENTIF, t.INDENTIF ),t.CODIGO = isnull( d.CODIGO, t.CODIGO )
					from ZooLogic.INFOVTASLPS t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.INFOVTASLPS(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Fecinfo,Saltafw,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Horaimpo,Horaexpo,Mensaje,Esttrans,Bdaltafw,Horainfo,Haltafw,Bdmodifw,Timestamp,Estado,Indentif,Codigo)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECINFO,''),isnull( d.SALTAFW,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.MENSAJE,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.HORAINFO,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.ESTADO,0),isnull( d.INDENTIF,0),isnull( d.CODIGO,'')
