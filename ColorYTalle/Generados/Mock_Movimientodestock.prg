...
define class Mock_movimientodestock as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cComprobante = ""                                                                                                                                                                                                                                         
	cComprobante = "MOVIMIENTODESTOCK"                                                                                                                                                                                                                        
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Movimiento de stock"                                                                                                                                                                                                                     
	...
	lEntidadEditable =  .t.                                                                                                                                                                                                                                   
	lEntidadEditable = .t.                                                                                                                                                                                                                                    
	lEntidadInstanciadaPorFormulario = .f.                                                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function esvalidoatributoobligatorio( tcatributo as string, tcdescatrib as string, tcdetalle as string ) as boolean                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
	...
	*-----------------------------------------------------------------------------------------
	function oempaquetador_access() as void                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODESTOCK' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oempaquetador_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oempaquetador_access', lcParametros )			endif		endif		if !this.ldestroy and !vartype( this.oEmpaquetador ) = 'O'			this.oEmpaquetador = _screen.zoo.crearObjeto( "EmpaquetarComprobanteDespuesDeGrabar" )		endif		return this.oEmpaquetador
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadbd_access() as void                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODESTOCK' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadbd_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadbd_access', lcParametros )			endif		endif		if !this.ldestroy and !vartype( this.oEntidadBD ) = 'O'			this.oEntidadBD = _Screen.zoo.instanciarEntidad( "BaseDeDatos" )		endif		return this.oEntidadBD
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadbuzon_access() as void                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MOVIMIENTODESTOCK' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadbuzon_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadbuzon_access', lcParametros )			endif		endif		if !this.ldestroy and !vartype( this.oEntidadBuzon ) = 'O'			this.oEntidadBuzon = _Screen.zoo.instanciarEntidad( "Buzon" )		endif		return this.oEntidadBuzon
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarantesdeanularforzadaparaproduccion() as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarantesdeanularforzadaparaproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcontextoparadetalle() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarcontextoparadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function deshabilitartipodemovimiento() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Deshabilitartipodemovimiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esmovimientodesalida() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esmovimientodesalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarsifuegeneradoporunaoperacionecommerce( tcestado as string ) as boolean                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarsifuegeneradoporunaoperacionecommerce', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarsifuegeneradoporunmovimientodeinsumosdeproduccion( tcestado as string ) as boolean                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarsifuegeneradoporunmovimientodeinsumosdeproduccion', lcParametros )
	EndFunc
