...
define class Mock_saltodecampo as MockBase of MockBase.prg
	...
	lEsExe = .f.                                                                                                                                                                                                                                              
	lEsSubEntidad = .f.                                                                                                                                                                                                                                       
	lEstaSeteandoAtributoDeDetalle = .f.                                                                                                                                                                                                                      
	...
	lIgnorarClaveprimariaEnRecepcionBD = .t.                                                                                                                                                                                                                  
	...
	lTieneValorSugeridoPorSistema = .f.                                                                                                                                                                                                                       
	lTieneVendedorComoClaveForanea = .f.                                                                                                                                                                                                                      
	lUsaAgrupamientoPublicaciones = .T.                                                                                                                                                                                                                       
	lValorSugeridoObligatorio = .f.                                                                                                                                                                                                                           
	lWHEliminar = .f.                                                                                                                                                                                                                                         
	lWHIngresar = .f.                                                                                                                                                                                                                                         
	lWHModificar = .f.                                                                                                                                                                                                                                        
	oAD = null                                                                                                                                                                                                                                                
	...
	*-----------------------------------------------------------------------------------------
	function completaratributosfaltantesporapi() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Completaratributosfaltantesporapi', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function entidaddescripcion_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'entidaddescripcion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'entidaddescripcion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Entidaddescripcion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Entidaddescripcion( lxVal )				this.Setear_Entidaddescripcion( lxVal )			EndIf		Else			This.Setear_Entidaddescripcion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventotienevalorsugeridoporsistema() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventotienevalorsugeridoporsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_atributo( txval ) as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_atributo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_atributo', lcParametros )			endif		endif		dodefault( txval )		this.VerificarCamposParaHabilitarArticulosPorPack()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_atributodescripcion( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_atributodescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_atributodescripcion', lcParametros )			endif		endif		this.Atributodescripcion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_atributovirtual( txval ) as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_atributovirtual', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_atributovirtual', lcParametros )			endif		endif		dodefault(txval)		if ( this.EsEdicion() or this.EsNuevo() ) and this.UsaEtiquetaDeFramework			if this.lHabilitarPersonalizacionEtiqueta				this.PersonalizacionEtiqueta = this.ObtenerEtiquetaParciada()			endif		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_entidad( txval  ) as void                                                                                                                                                                                                                 
	...
	*-----------------------------------------------------------------------------------------
	function setear_entidaddescripcion( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_entidaddescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_entidaddescripcion', lcParametros )			endif		endif		this.Entidaddescripcion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_mostrar( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_mostrar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_mostrar', lcParametros )			endif		endif		this.Mostrar = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_noobligatorioarticulospack( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_noobligatorioarticulospack', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_noobligatorioarticulospack', lcParametros )			endif		endif		this.Noobligatorioarticulospack = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_obligatorio( txval ) as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_obligatorio', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_obligatorio', lcParametros )			endif		endif		dodefault( txval )		this.VerificarCamposParaHabilitarArticulosPorPack()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_personalizacionetiqueta( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_personalizacionetiqueta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_personalizacionetiqueta', lcParametros )			endif		endif		this.Personalizacionetiqueta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_usaetiquetadeframework( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_usaetiquetadeframework', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_usaetiquetadeframework', lcParametros )			endif		endif		dodefault( txVal )		if txVal			this.lHabilitarPersonalizacionEtiqueta	= txVal			this.PersonalizacionEtiqueta 			= this.ObtenerEtiquetaParciada()		endif		this.lHabilitarPersonalizacionEtiqueta	= !txVal
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_usavalorsugeridodeframework( txval as variant ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_usavalorsugeridodeframework', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_usavalorsugeridodeframework', lcParametros )			endif		endif		dodefault( txVal )				if this.lHabilitarValorSugerido and txVal			this.ValorSugerido = ""		endif		this.lHabilitarValorSugerido = !this.UsaValorSugeridoDeFramework and !this.UsaValorSugeridoElementoAnterior		if txval			this.lHabilitarUsaValorSugeridoElementoAnterior = .t.			this.UsaValorSugeridoElementoAnterior = .f.		endif		this.lHabilitarUsaValorSugeridoElementoAnterior = this.lEstaSeteandoAtributoDeDetalle and !this.UsaValorSugeridoDeFramework
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_usavalorsugeridoelementoanterior( txval as variant ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_usavalorsugeridoelementoanterior', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_usavalorsugeridoelementoanterior', lcParametros )			endif		endif		dodefault( txVal )		if this.lHabilitarValorSugerido and txVal			this.ValorSugerido = ""		endif		this.lHabilitarValorSugerido = !this.UsaValorSugeridoElementoAnterior and !this.UsaValorSugeridoDeFramework		this.lHabilitarUsaValorSugeridoDeFramework = .t.		if txval and this.USAVALORSUGERIDODEFRAMEWORK			this.USAVALORSUGERIDODEFRAMEWORK = .f.		endif		this.lHabilitarUsaValorSugeridoDeFramework= !this.UsaValorSugeridoElementoAnterior
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valorsugerido( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_valorsugerido', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_valorsugerido', lcParametros )			endif		endif		this.Valorsugerido = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_atributodescripcion( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_atributodescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_atributodescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_atributovirtual( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_atributovirtual', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_atributovirtual', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_entidaddescripcion( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_entidaddescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_entidaddescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_mostrar( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_mostrar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_mostrar', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_noobligatorioarticulospack( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_noobligatorioarticulospack', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_noobligatorioarticulospack', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_obligatorio( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_obligatorio', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_obligatorio', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_personalizacionetiqueta( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_personalizacionetiqueta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_personalizacionetiqueta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_usaetiquetadeframework( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usaetiquetadeframework', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usaetiquetadeframework', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_usavalorsugeridodeframework( txval as variant ) as boolean                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usavalorsugeridodeframework', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usavalorsugeridodeframework', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_usavalorsugeridoelementoanterior( txval as variant ) as boolean                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usavalorsugeridoelementoanterior', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usavalorsugeridoelementoanterior', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valorsugerido( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SALTODECAMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_valorsugerido', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_valorsugerido', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaratributoaptoparapack( tcatributo as string ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validaratributoaptoparapack', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaratributodescripcion() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validaratributodescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaratributovirtual() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validaratributovirtual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarentidadaptaparapack( tcentidad as string ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarentidadaptaparapack', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarentidaddescripcion() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validarentidaddescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvalorsugerido() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoatributovirtual() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoatributovirtual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwmostrar() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwmostrar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwusaetiquetadeframework() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridofwusaetiquetadeframework', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwusavalorsugeridodeframework() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridofwusavalorsugeridodeframework', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomostrar() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridomostrar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonoobligatorioarticulospack() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridonoobligatorioarticulospack', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoobligatorio() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoobligatorio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopersonalizacionetiqueta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridopersonalizacionetiqueta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousaetiquetadeframework() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridousaetiquetadeframework', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousavalorsugeridodeframework() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridousavalorsugeridodeframework', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousavalorsugeridoelementoanterior() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridousavalorsugeridoelementoanterior', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovalorsugerido() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridovalorsugerido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function verificarcamposparahabilitararticulosporpack() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarcamposparahabilitararticulosporpack', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarvalorsugeridotipodocumento() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarvalorsugeridotipodocumento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitaratributos( tlhabilitar as boolean ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneretiquetaparciada() as string                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obteneretiquetaparciada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcomportamientodelainterfazvisual() as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcomportamientodelainterfazvisual', lcParametros )
	EndFunc
