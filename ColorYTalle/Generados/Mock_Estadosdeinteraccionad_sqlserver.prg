...
define class Mock_Estadosdeinteraccionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Estadosdeinteraccionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubedi( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubedi', lcParametros )
	EndFunc
