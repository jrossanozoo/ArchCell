...
define class Mock_gtin as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Códigos RG 2904/10"                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function atributosusados_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'atributosusados_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'atributosusados_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Atributosusados		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Atributosusados( lxVal )				this.Setear_Atributosusados( lxVal )			EndIf		Else			This.Setear_Atributosusados( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetrangos() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetrangos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detrangos_access() as variant                                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detrangos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detrangos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detrangos ) = 'O' or isnull( this.Detrangos ) )			this.Detrangos = this.crearobjeto( 'Din_DetalleGtinDetrangos' )			this.Detrangos.inicializar()			this.enlazar( 'Detrangos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detrangos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detrangos, 'CambioSumarizado', this, 'CambiosDetalleDetrangos', 1)			this.enlazar( 'Detrangos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detrangos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detrangos.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detrangos
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenarclaveforanea( tcatributo as string ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Llenarclaveforanea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributoclaveforanea() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obteneratributoclaveforanea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributoenitemfacturacion() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obteneratributoenitemfacturacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributosusados() as string                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obteneratributosusados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercolecciondatos() as object                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercolecciondatos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercondiciones() as string                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercondiciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plantilla_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'plantilla_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'plantilla_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Plantilla		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Plantilla( lxVal )				this.Setear_Plantilla( lxVal )			EndIf		Else			This.Setear_Plantilla( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_atributosusados( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_atributosusados', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_atributosusados', lcParametros )			endif		endif		this.Atributosusados = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_plantilla( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_plantilla', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_plantilla', lcParametros )			endif		endif		this.Plantilla = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_atributosusados( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_atributosusados', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_atributosusados', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_plantilla( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_plantilla', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_plantilla', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificardesdehasta() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificardesdehasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercondicionporlinea( loitem as object ) as string                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercondicionporlinea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocoleccionatributoclave_access() as object                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'GTIN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocoleccionatributoclave_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocoleccionatributoclave_access', lcParametros )			endif		endif		local loCargador as CargadorAtributosFiltroGtin of CargadorAtributosFiltroGtin.prg		if !this.ldestroy and ( !vartype( this.oColeccionAtributoClave ) = 'O' or isnull( this.oColeccionAtributoClave ) )			loCargador = _Screen.Zoo.CrearObjeto( "Din_ObjetoGtin")			this.oColeccionAtributoClave = loCargador.ObtenerAtributoClaveForanea()		endif		return this.oColeccionAtributoClave
	EndFunc
