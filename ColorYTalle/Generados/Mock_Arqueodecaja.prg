...
define class Mock_arqueodecaja as MockBase of MockBase.prg
	...
	Codigo = ""                                                                                                                                                                                                                                               
	DetalleOtros = null                                                                                                                                                                                                                                       
	DetalleRecuentoEfectivo = null                                                                                                                                                                                                                            
	DetalleTotalPorGrupo = null                                                                                                                                                                                                                               
	ESTADOTRANSFERENCIA = ""                                                                                                                                                                                                                                  
	FECHAEXPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	FECHAIMPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	...
	lGeneraComprobanteDeCaja = null                                                                                                                                                                                                                           
	lHabilitaEnviarAlGrabar = .f.                                                                                                                                                                                                                             
	lHabilitarCaja_PK = .T.                                                                                                                                                                                                                                   
	lHabilitarDetalleOtros = .T.                                                                                                                                                                                                                              
	lHabilitarDetalleRecuentoEfectivo = .T.                                                                                                                                                                                                                   
	lHabilitarDetalleTotalPorGrupo = .T.                                                                                                                                                                                                                      
	...
	oColeccionGrupos = null                                                                                                                                                                                                                                   
	oColeccionGruposCierreConjunto = null                                                                                                                                                                                                                     
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	  protected function ogrupovalor_access() as object                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ogrupovalor_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ogrupovalor_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oGrupoValor ) # "O"			this.oGrupoValor = _Screen.zoo.instanciarEntidad( "GrupoValor" )		endif		return this.oGrupoValor
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregargrupovalor( tcgrupovalor, tcdescripcion, tnarqueoefectivo, tnarqueootros ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tcgrupovalor
		lxParam2 = tcdescripcion
		lxParam3 = tnarqueoefectivo
		lxParam4 = tnarqueootros
		...
		return this.ObtenerResultado( 'Agregargrupovalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregaritemdenominacion( tocopiador, toitemaux ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Agregaritemdenominacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregartotalagrupo( tcgrupovalor, tnarqueoefectivo, tnarqueootros ) as void                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tcgrupovalor
		lxParam2 = tnarqueoefectivo
		lxParam3 = tnarqueootros
		...
		return this.ObtenerResultado( 'Agregartotalagrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calculardiferenciasarqueo() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Calculardiferenciasarqueo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function calculardiferenciasarqueoefectivo() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Calculardiferenciasarqueoefectivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function calculardiferenciasarqueootros() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Calculardiferenciasarqueootros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleotros() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleotros', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallerecuentoefectivo() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallerecuentoefectivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalletotalporgrupo() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalletotalporgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function completarcolecciongrupos( tncaja as integer ) as object                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Completarcolecciongrupos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function completarcolecciongruposcierreconjunto( tncaja as integer, tocolecciongrupo as object ) as void                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tncaja
		lxParam2 = tocolecciongrupo
		...
		return this.ObtenerResultado( 'Completarcolecciongruposcierreconjunto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function completarcolecciongruposdecajasacumuludas( tocolecciongrupos as object ) as object                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocolecciongrupos
		...
		return this.ObtenerResultado( 'Completarcolecciongruposdecajasacumuludas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function completardenominaciones() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Completardenominaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function completardetallegruposvalores( tncaja as integer ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Completardetallegruposvalores', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function completarmonedas() as void                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Completarmonedas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearconceptodiferenciaarqueo() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Crearconceptodiferenciaarqueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detalleotros_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalleotros_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalleotros_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalleotros ) = 'O' or isnull( this.Detalleotros ) )			this.Detalleotros = this.crearobjeto( 'DetalleArqueodecajaDetalleotros' )			this.Detalleotros.inicializar()			this.enlazar( 'Detalleotros.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalleotros.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalleotros, 'CambioSumarizado', this, 'CambiosDetalleDetalleotros', 1)			this.enlazar( 'Detalleotros.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalleotros.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detalleotros.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detalleotros
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detallerecuentoefectivo_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallerecuentoefectivo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallerecuentoefectivo_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallerecuentoefectivo ) = 'O' or isnull( this.Detallerecuentoefectivo ) )			this.Detallerecuentoefectivo = this.crearobjeto( 'Din_DetalleArqueodecajaDetallerecuentoefectivo' )			this.Detallerecuentoefectivo.inicializar()			this.enlazar( 'Detallerecuentoefectivo.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallerecuentoefectivo.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallerecuentoefectivo, 'CambioSumarizado', this, 'CambiosDetalleDetallerecuentoefectivo', 1)			this.enlazar( 'Detallerecuentoefectivo.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallerecuentoefectivo.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detallerecuentoefectivo.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detallerecuentoefectivo
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detalletotalporgrupo_access() as variant                                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalletotalporgrupo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalletotalporgrupo_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalletotalporgrupo ) = 'O' or isnull( this.Detalletotalporgrupo ) )			this.Detalletotalporgrupo = this.crearobjeto( 'Din_DetalleArqueodecajaDetalletotalporgrupo' )			this.Detalletotalporgrupo.inicializar()			this.enlazar( 'Detalletotalporgrupo.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalletotalporgrupo.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalletotalporgrupo, 'CambioSumarizado', this, 'CambiosDetalleDetalletotalporgrupo', 1)			this.enlazar( 'Detalletotalporgrupo.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalletotalporgrupo.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detalletotalporgrupo.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detalletotalporgrupo
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoformatearcampos() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoformatearcampos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomostrarocultartotalydiferencia( tloculto ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventomostrarocultartotalydiferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorefrescardetallearqueoefectivo() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorefrescardetallearqueoefectivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventorefrescardetallearqueogrupovalores() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorefrescardetallearqueogrupovalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existegrupoendetalle( tcgrupo ) as integer                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Existegrupoendetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarcomprobantedecajaautomatico() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarcomprobantedecajaautomatico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarsentenciascomprobantedecaja() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarsentenciascomprobantedecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function haydiferencias() as boolean                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Haydiferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitardetalleotros_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetalleotros_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetalleotros_assign', lcParametros )			endif		endif		this.lHabilitarDetalleOtros = txVal		this.DetalleOtros.habilitarItems( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function lhabilitardetallerecuentoefectivo_assign( txval as variant ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetallerecuentoefectivo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetallerecuentoefectivo_assign', lcParametros )			endif		endif		this.lHabilitarDetalleRecuentoEfectivo = txVal		this.DetalleRecuentoEfectivo.habilitarItems( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function lhabilitardetalletotalporgrupo_assign( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetalletotalporgrupo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetalletotalporgrupo_assign', lcParametros )			endif		endif		this.lHabilitarDetalleTotalPorGrupo = txVal		this.DetalleTotalPorGrupo.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiararqueos() as void                                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Limpiararqueos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenardatosdetodaslasbd( tobdsacerrar ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tobdsacerrar
		...
		return this.ObtenerResultado( 'Llenardatosdetodaslasbd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercursorcolecciongrupos( tncaja as integer ) as string                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercursorcolecciongrupos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenergruposvaloresdemoneda( tcmoneda ) as object                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenergruposvaloresdemoneda', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenergrupovalorsegunmoneda( tcmoneda ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenergrupovalorsegunmoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerorigendestino( tcbase ) as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerorigendestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertipodecomprobanteagenerar() as integer                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertipodecomprobanteagenerar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenertoleranciasgrupo( togrupo as object, tntoleranciapositiva as integer, tntolerancianegativa as integer ) as void                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = togrupo
		lxParam2 = tntoleranciapositiva
		lxParam3 = tntolerancianegativa
		...
		return this.ObtenerResultado( 'Obtenertoleranciasgrupo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenertoleranciasmoneda( tcmoneda as string, tntoleranciapositiva as integer, tntolerancianegativa as integer  ) as void                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenertoleranciasmoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenervalordegrupo( tcgrupo ) as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenervalordegrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function revisardiferenciasconcurrencia( tocoleccion as object, tocoleccionactual as object ) as boolean                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tocoleccion
		lxParam2 = tocoleccionactual
		...
		return this.ObtenerResultado( 'Revisardiferenciasconcurrencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_caja( txval ) as void                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_caja', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_caja', lcParametros )			endif		endif		if this.lHabilitarCaja_pk			dodefault( txVal )			if !empty( txVal )				if this.Caja.Estado = "C"					goServicios.Errores.LevantarExcepcion( "Solo es posible hacer un arqueo de una caja abierta." )				else							this.lHabilitarCaja_pk = .F.					this.lHabilitarDetalleTotalPorGrupo = .T.					this.lHabilitarDetalleRecuentoEfectivo = .T.					this.lHabilitarDetalleOtros = .T.					this.CompletarDenominaciones()					this.CompletarDetalleGruposValores( this.Caja.Id )					this.EventoMostrarOcultarTotalyDiferencia( this.Caja.OcultarTotalMoneda )										if this.lCierreConjunto						this.oColeccionGruposCierreConjunto = this.CompletarColeccionGruposDeCajasAcumuludas( this.oColeccionGruposCierreConjunto )					else						this.oColeccionGrupos = this.CompletarColeccionGrupos( this.Caja.Id )					endif				endif			endif		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function vereficarporcambiosenlostotales( tocolecciongruposactual as object ) as boolean                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocolecciongruposactual
		...
		return this.ObtenerResultado( 'Vereficarporcambiosenlostotales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursortotalesxgrupos( tccursor as string, tccursorvaloresygrupos as string, tccursorgrupovalores as string,  tocolgruposcomprobantes as zoocoleccion of zoocoleccion.prg, tcgrupos as string ) as string                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = tccursor
		lxParam2 = tccursorvaloresygrupos
		lxParam3 = tccursorgrupovalores
		lxParam4 = tocolgruposcomprobantes
		lxParam5 = tcgrupos
		...
		return this.ObtenerResultado( 'Obtenercursortotalesxgrupos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocolecciongrupos_access() as object                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolecciongrupos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolecciongrupos_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oColeccionGrupos ) # "O"			this.oColeccionGrupos = _screen.zoo.CrearObjeto( "ZooColeccion" )		endif		return this.oColeccionGrupos
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ocolecciongruposcierreconjunto_access() as object                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolecciongruposcierreconjunto_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolecciongruposcierreconjunto_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oColeccionGruposCierreConjunto ) # "O"			this.oColeccionGruposCierreConjunto = _screen.zoo.CrearObjeto( "ZooColeccion" )		endif		return this.oColeccionGruposCierreConjunto
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ocomprobantedecaja_access() as object                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ARQUEODECAJA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocomprobantedecaja_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocomprobantedecaja_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oComprobanteDeCaja ) # "O"			this.oComprobanteDeCaja = _Screen.zoo.instanciarEntidad( "ComprobanteDeCaja " )		endif		return this.oComprobanteDeCaja
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function omoneda_access() as object                                                                                                                                                                                                             
