...
define class Mock_interacciondeorden as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Interacción de orden de servicio"                                                                                                                                                                                                        
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'INTERACCIONDEORDEN'                                                                                                                                                                                                                            
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lGenerandoSentencias = .f.                                                                                                                                                                                                                                
	lHabilitaEnviarAlGrabar = .f.                                                                                                                                                                                                                             
	lHabilitarOrden_PK = .T.                                                                                                                                                                                                                                  
	lHabilitarTipoDescuento = .T.                                                                                                                                                                                                                             
	lHabilitarValor = .T.                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function articulo_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'articulo_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'articulo_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Articulo_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Articulo.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Articulo )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 15, padr( lxVal, 15 ), lxVal )		this.Articulo_PK = lxVal		if this.Validar_Articulo( lxVal, lxValOld )			This.Setear_Articulo( lxVal )			If lxValOld != lxVal or empty( this.Articulodescripcion )				this.Articulodescripcion = This.Articulo.Descripcion			endif		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function articulodescripcion_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'articulodescripcion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'articulodescripcion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Articulodescripcion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Articulodescripcion( lxVal )				this.Setear_Articulodescripcion( lxVal )			EndIf		Else			This.Setear_Articulodescripcion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function color_pk_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'color_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'color_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Color_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Color.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Color )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 6, padr( lxVal, 6 ), lxVal )		this.Color_PK = lxVal		if this.Validar_Color( lxVal, lxValOld )			This.Setear_Color( lxVal )			If lxValOld != lxVal or empty( this.Colordescripcion )				this.Colordescripcion = This.Color.Descripcion			endif		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function colordescripcion_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'colordescripcion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'colordescripcion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Colordescripcion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Colordescripcion( lxVal )				this.Setear_Colordescripcion( lxVal )			EndIf		Else			This.Setear_Colordescripcion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciaestadosconreglaestado() as string                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciaestadosconreglaestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerultimoestado( tcorden ) as string                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerultimoestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_articulodescripcion( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_articulodescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_articulodescripcion', lcParametros )			endif		endif		this.Articulodescripcion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_colordescripcion( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_colordescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_colordescripcion', lcParametros )			endif		endif		this.Colordescripcion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_estado( txval ) as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_estado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_estado', lcParametros )			endif		endif		with this			if inlist( alltrim( upper( txVal ) ), "FACTURAAUTOMATICO", "REMITOAUTOMATICO", "CERRADAAUTOMATICO" ) and !this.lGenerandoSentencias				goServicios.Errores.LevantarExcepcion( "No es posible seleccionar un estado automático." )			else				dodefault( txVal )					if .Estado.ReglaFacturacion = 5					.lHabilitarTipoDescuento = .T.					.lHabilitarValor = .T.				else					.lHabilitarTipoDescuento = .T.					.lHabilitarValor = .T.					.TipoDescuento = ""					.Valor = 0					.lHabilitarTipoDescuento = .f.					.lHabilitarValor = .f.				endif			ENDIF		endwith
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_talledescripcion( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_talledescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_talledescripcion', lcParametros )			endif		endif		this.Talledescripcion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodescuento( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tipodescuento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tipodescuento', lcParametros )			endif		endif		this.Tipodescuento = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valor( txval ) as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_valor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_valor', lcParametros )			endif		endif		if upper( alltrim( this.TipoDescuento ) ) = "PORCENTAJE" and txVal > 100			goServicios.Errores.LevantarExcepcion( "No es posible asignar un porcentaje de descuento mayor a 100." )		else			dodefault( txVal )			endif			
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function talle_pk_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'talle_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'talle_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Talle_PK		local lxVal as Variant		local loSugerido as Object				if txVal = lxValOld or empty( txVal )			lxVal = txVal		else			this.lBuscandoCodigo = .t.			if !this.lEsSubEntidad and ( this.EsNuevo() or this.EsEdicion() )				lxVal = This.Talle.oComportamientoCodigoSugerido.ObtenerPKaAsignar( txVal, This.Talle )			else				lxVal = txVal			endif			this.lBuscandoCodigo = .f.		endif		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Talle_PK = lxVal		if this.Validar_Talle( lxVal, lxValOld )			This.Setear_Talle( lxVal )			If lxValOld != lxVal or empty( this.Talledescripcion )				this.Talledescripcion = This.Talle.Descripcion			endif		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function talledescripcion_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'talledescripcion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'talledescripcion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Talledescripcion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Talledescripcion( lxVal )				this.Setear_Talledescripcion( lxVal )			EndIf		Else			This.Setear_Talledescripcion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodescuento_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tipodescuento_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tipodescuento_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tipodescuento		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tipodescuento( lxVal )				if ( this.lHabilitarTipodescuento or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Tipodescuento( lxVal )				else					this.Tipodescuento = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Interacción de orden de servicio - Atributo: Tipodescuento)" )				endif			EndIf		Else			This.Setear_Tipodescuento( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_articulodescripcion( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_articulodescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_articulodescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_colordescripcion( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_colordescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_colordescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_estado( txval, txvalold ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_estado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_estado', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal, txValOld )		if llRetorno			llRetorno = this.ValidarTiposDeOrden( this.Orden, this.Estado )		endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_orden( txval, txvalold ) as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_orden', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_orden', lcParametros )			endif		endif		local llRetorno		llRetorno = dodefault( txVal, txValOld )		if llRetorno			llRetorno = llRetorno and this.ValidarOrdenCerrada( this.Orden )			llRetorno = llRetorno and this.ValidarTiposDeOrden( this.Orden, this.Estado )		endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_talledescripcion( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_talledescripcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_talledescripcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodescuento( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INTERACCIONDEORDEN' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipodescuento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipodescuento', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarhora() as boolean                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarhora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarorden() as boolean                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarorden', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarordencerrada( toorden ) as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarordencerrada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartiposdeorden( toorden, toestado ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validartiposdeorden', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvendedordescripcion() as boolean                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoestado() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipodescuento() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotipodescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificardescuento() as boolean                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificardescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarfechainteraccion() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarfechainteraccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarnuevoestado() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarnuevoestado', lcParametros )
	EndFunc
