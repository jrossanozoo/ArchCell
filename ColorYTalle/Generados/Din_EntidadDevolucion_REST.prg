...
define class Din_EntidadDevolucion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Devolucion"
	cClaseResponse = this.cNamespaceDTOs + ".DevolucionResponse"
	cClaseModelo = "DevolucionModelo"
	cEntidad = "Devolucion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "DevolucionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "DevolucionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "DevolucionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "DevolucionModelo"
		endcase
		return lcRetorno
