...
define class Mock_COMPONENTECAJERO as MockBase of MockBase.prg

	cClase = 'COMPONENTECAJERO'
	...
	*-----------------------------------------------------------------------------------------
	function agregarnuevocuponhuerfanoalconjuntodecupones( toitem as object ) as void                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Agregarnuevocuponhuerfanoalconjuntodecupones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardatosdelvalor( toitem as object, todetalle as object  ) as void                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cargardatosdelvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function copiarvaloresanteriores( tcaccion as string ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Copiarvaloresanteriores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercuponparaanulacion( toitem as object ) as object                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercuponparaanulacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerguidchequesegunnrointerno( tntipovalor as integer, tnnumerointerno as integer ) as string                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerguidchequesegunnrointerno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompajustedecupones_access()                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Ocompajustedecupones_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompchequesdeterceros_access()                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Ocompchequesdeterceros_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompchequespropios_access()                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Ocompchequespropios_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompcuentabancariavalores_access()                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ocompcuentabancariavalores_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompcuentacorrientevalores_access()                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Ocompcuentacorrientevalores_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocomptarjetadecredito_access()                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Ocomptarjetadecredito_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompvalesdecambio_access()                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Ocompvalesdecambio_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompvalores_access()                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Ocompvalores_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omovimientodecaja_access()                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Omovimientodecaja_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificaryeliminarretiroenefectivo( toitem as object ) as void                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Verificaryeliminarretiroenefectivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarysetearretiroenefectivo( tcatributo as string, toitem as object ) as void                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Verificarysetearretiroenefectivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarysetearretiroenefectivoenentidad( toitem as object ) as void                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Verificarysetearretiroenefectivoenentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercolecciondecomponentesagrupados() as zoocoleccion of zoocoleccion.prg                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercolecciondecomponentesagrupados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomponentesaforzarvotacionanular() as zoocoleccion of zoocoleccion.prg                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercomponentesaforzarvotacionanular', lcParametros )
	EndFunc
