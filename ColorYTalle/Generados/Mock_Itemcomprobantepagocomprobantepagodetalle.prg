...
define class Mock_Itemcomprobantepagocomprobantepagodetalle as MockBase of MockBase.prg

	cClase = 'Itemcomprobantepagocomprobantepagodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoconceptodetalle() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoconceptodetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridodistribucioncentrodecosto() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodistribucioncentrodecosto', lcParametros )
	EndFunc
