...
define class Mock_Selechequeainsertarad_sqlserver as MockBase of MockBase.prg

	cClase = 'Selechequeainsertarad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalledetallechequesainsertar( tcatributo as string ) as string                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercampodetalledetallechequesainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalledetallechequesainsertar( tccampos as string ) as string                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalledetallechequesainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalledetallechequesainsertar( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalledetallechequesainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalledetallechequesainsertar( tccampos as string ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Parsearcamposdetalledetallechequesainsertar', lcParametros )
	EndFunc
