	...
	function Registro_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Registro( lxVal, lxValOld )
			if ( this.lHabilitarRegistro_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones bancarias - Atributo: Registro)" )
			endif 
		endif
		...
		if This.CargaManual()
			if this.Validar_Fechadeoperacion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Fechadeoperacion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones bancarias - Atributo: Fechadeoperacion)" )
				endif 
			EndIf
		Else
			This.Setear_Fechadeoperacion( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Comprobante( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Comprobante', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones bancarias - Atributo: Comprobante)" )
				endif 
			EndIf
		Else
			This.Setear_Comprobante( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipovalor( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Tipovalor', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones bancarias - Atributo: Tipovalor)" )
				endif 
			EndIf
		Else
			This.Setear_Tipovalor( lxVal ) 
