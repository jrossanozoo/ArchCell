...
define class Din_EntidadAGRUPAMIENTOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAgrupamientoFecexpo, lxAgrupamientoFmodifw, lxAgrupamientoFecimpo, lxAgrupamientoFaltafw, lxAgrupamientoFectrans, lxAgrupamientoSmodifw, lxAgrupamientoSaltafw, lxAgrupamientoUaltafw, lxAgrupamientoZadsfw, lxAgrupamientoUmodifw, lxAgrupamientoValtafw, lxAgrupamientoHmodifw, lxAgrupamientoVmodifw, lxAgrupamientoHoraexpo, lxAgrupamientoEsttrans, lxAgrupamientoBdmodifw, lxAgrupamientoHoraimpo, lxAgrupamientoBdaltafw, lxAgrupamientoHaltafw, lxAgrupamientoTimestamp, lxAgrupamientoObs, lxAgrupamientoCodigo, lxAgrupamientoDescrip
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into PUESTO.AGRUPAMIENTO ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Saltafw","Ualtafw","Zadsfw","Umodifw","Valtafw","Hmodifw","Vmodifw","Horaexpo","Esttrans","Bdmodifw","Horaimpo","Bdaltafw","Haltafw","Timestamp","Obs","Codigo","Descrip" ) values ( <<"'" + this.ConvertirDateSql( lxAgrupamientoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrupamientoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrupamientoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrupamientoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrupamientoFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoHaltafw ) + "'" >>, <<lxAgrupamientoTimestamp >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrupamientoDescrip ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update PUESTO.AGRUPAMIENTO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAgrupamientoFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAgrupamientoFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAgrupamientoFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAgrupamientoFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAgrupamientoFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoZadsfw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoUmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoValtafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAgrupamientoHoraexpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAgrupamientoEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoBdmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAgrupamientoHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAgrupamientoHaltafw ) + "'">>,"Timestamp" = <<lxAgrupamientoTimestamp>>,"Obs" = <<"'" + this.FormatearTextoSql( lxAgrupamientoObs ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAgrupamientoCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxAgrupamientoDescrip ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxAgrupamientoCodigo ) + "'">> and  AGRUPAMIENTO.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion" from PUESTO.AGRUPAMIENTO where "Codigo" = <<"'" + this.FormatearTextoSql( lxAgrupamientoCodigo ) + "'">> and  AGRUPAMIENTO.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion" from PUESTO.AGRUPAMIENTO where  AGRUPAMIENTO.CODIGO != '' order by Codigo
			endtext
			use in select('c_AGRUPAMIENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AGRUPAMIENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion" from PUESTO.AGRUPAMIENTO where  funciones.padr( Codigo, 21, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AGRUPAMIENTO.CODIGO != '' order by Codigo
			endtext
			use in select('c_AGRUPAMIENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AGRUPAMIENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion" from PUESTO.AGRUPAMIENTO where  funciones.padr( Codigo, 21, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AGRUPAMIENTO.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_AGRUPAMIENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AGRUPAMIENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion" from PUESTO.AGRUPAMIENTO where  AGRUPAMIENTO.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_AGRUPAMIENTO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AGRUPAMIENTO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Zadsfw,Umodifw,Valtafw,Hmod" + ;
"ifw,Vmodifw,Horaexpo,Esttrans,Bdmodifw,Horaimpo,Bdaltafw,Haltafw,Timestamp,Obs,Codigo,Descrip" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE PUESTO.AGRUPAMIENTO set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, SALTAFW, UALTAFW, ZADSFW, UMODIFW, VALTAFW, HMODIFW, VMODIFW, HORAEXPO, ESTTRANS, BDMODIFW, HORAIMPO, BDALTAFW, HALTAFW, TIMESTAMP, Obs, Codigo, Descrip
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.OBS = isnull( d.OBS, t.OBS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP )
					from PUESTO.AGRUPAMIENTO t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into PUESTO.AGRUPAMIENTO(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Zadsfw,Umodifw,Valtafw,Hmodifw,Vmodifw,Horaexpo,Esttrans,Bdmodifw,Horaimpo,Bdaltafw,Haltafw,Timestamp,Obs,Codigo,Descrip)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.TIMESTAMP,0),isnull( d.OBS,''),isnull( d.CODIGO,''),isnull( d.DESCRIP,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="AGRUPAMIENTO                            " atributo="FECHATRANSFERENCIA                      " tabla="AGRUPAMIENTO   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AGRUPAMIENTO                            " atributo="ESTADOTRANSFERENCIA                     " tabla="AGRUPAMIENTO   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AGRUPAMIENTO                            " atributo="CODIGO                                  " tabla="AGRUPAMIENTO   " campo="CODIGO    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="21" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="1" etiqueta="Código agrupamiento                                                                                                                                                                                                                                       " dominio="CODIGOCONALTASCENTRALIZADAS   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="AGRUPAMIENTO                            " atributo="DESCRIPCION                             " tabla="AGRUPAMIENTO   " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="201" etiqueta="Descripción                                                                                                                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="AGRUPAMIENTO                            " atributo="AGRUPAMIENTODETALLE                     " tabla="AGRUPAG        " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="21" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="202" etiqueta="Agrupamiento                                                                                                                                                                                                                                              " dominio="DETALLEITEMAGRUPAMIENTO       " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="AGRUPAMIENTO                            " atributo="BASEDEDATOSDETALLE                      " tabla="AGRUPBD        " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="21" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="203" etiqueta="Bases de datos                                                                                                                                                                                                                                            " dominio="DETALLEITEMBASEDEDATOS        " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="4" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
