...
define class Mock_COLABORADORLISTADEPRECIOSAELIMINAR as MockBase of MockBase.prg

	cClase = 'COLABORADORLISTADEPRECIOSAELIMINAR'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	oEntidadAsignaciones = null                                                                                                                                                                                                                               
	oEntidadFormulas = null                                                                                                                                                                                                                                   
	oEntidadPrecios = null                                                                                                                                                                                                                                    
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function asignacionesdeformulasparalalista( tccodigolista as string ) as string                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Asignacionesdeformulasparalalista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cantidadregistrospreciosparalalista( tccodigolista as string ) as integer                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cantidadregistrospreciosparalalista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminarprecios( tccodigolista as string ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eliminarprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formulasparalalista( tccodigolista as string ) as string                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Formulasparalalista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oentidadasignaciones_access() as object                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oentidadasignaciones_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadformulas_access() as object                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oentidadformulas_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadprecios_access() as object                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oentidadprecios_access', lcParametros )
	EndFunc
