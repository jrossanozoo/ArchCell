...
define class Mock_Itemfacturaelectronicadecreditopromoarticulosdetalle as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicadecreditopromoarticulosdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function atributocabecera_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Atributocabecera_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iditempromo_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Iditempromo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iditemvalor_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Iditemvalor_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montobeneficio_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Montobeneficio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_atributocabecera( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_atributocabecera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iditempromo( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_iditempromo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iditemvalor( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_iditemvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montobeneficio( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_montobeneficio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_atributocabecera( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_atributocabecera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iditempromo( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_iditempromo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iditemvalor( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_iditemvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montobeneficio( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_montobeneficio', lcParametros )
	EndFunc
