...
define class Mock_ctacte as MockBase of MockBase.prg
	...
	lAnular = .f.                                                                                                                                                                                                                                             
	lBuscandoCodigo = .f.                                                                                                                                                                                                                                     
	lCambioClienteCentralizadoDuplicado = .f.                                                                                                                                                                                                                 
	lCargando = .f.                                                                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function estaafectado( tcletra as string, tnptovta as integer, tnnumero as integer, tntipocomp as string, tcsecuencia as string, tcbasededatosaltafw as string ) as boolean                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		lxParam3 = tnnumero
		lxParam4 = tntipocomp
		lxParam5 = tcsecuencia
		lxParam6 = tcbasededatosaltafw
	...
	*-----------------------------------------------------------------------------------------
	function obteneridglobaldelcliente( tccliente as string ) as string                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obteneridglobaldelcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerimportesaldodelcliente( tocliente as string, tomoneda as string ) as string                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerimportesaldodelcliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oentidadmoneda_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CTACTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadmoneda_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadmoneda_access', lcParametros )			endif		endif		if !this.ldestroy			if !vartype( this.oEntidadMoneda ) = 'O'				this.oEntidadMoneda = _Screen.zoo.instanciarentidad( 'Moneda' )				this.enlazar( 'oEntidadMoneda.eventoObtenerLogueo', 'inyectarLogueo' )			endif		endif		return this.oEntidadMoneda
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadvalor_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CTACTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadvalor_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadvalor_access', lcParametros )			endif		endif		if !this.ldestroy			if !vartype( this.oEntidadValor ) = 'O'				this.oEntidadValor = _Screen.zoo.instanciarentidad( 'Valor' )				this.enlazar( 'oEntidadValor.eventoObtenerLogueo', 'inyectarLogueo' )			endif		endif		return this.oEntidadValor
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosecuencia() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridosecuencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercondicionwhereparacliente( tccliente as string ) as string                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercondicionwhereparacliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersaldodelcliente( tccliente as string ) as string                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersaldodelcliente', lcParametros )
	EndFunc
