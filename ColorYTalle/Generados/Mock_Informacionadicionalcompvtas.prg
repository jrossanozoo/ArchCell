...
define class Mock_informacionadicionalcompvtas as MockBase of MockBase.prg
	...
	cClase = 'informacionadicionalcompvtas'
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecomprobantes() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cambiosdetallecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nroopecommerce_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INFORMACIONADICIONALCOMPVTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'nroopecommerce_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'nroopecommerce_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Nroopecommerce		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Nroopecommerce( lxVal )				this.Setear_Nroopecommerce( lxVal )			EndIf		Else			This.Setear_Nroopecommerce( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function referenciavirtual_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INFORMACIONADICIONALCOMPVTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'referenciavirtual_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'referenciavirtual_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Referenciavirtual		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Referenciavirtual( lxVal )				this.Setear_Referenciavirtual( lxVal )			EndIf		Else			This.Setear_Referenciavirtual( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nroopecommerce( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INFORMACIONADICIONALCOMPVTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_nroopecommerce', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_nroopecommerce', lcParametros )			endif		endif		this.Nroopecommerce = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_referenciavirtual( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INFORMACIONADICIONALCOMPVTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_referenciavirtual', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_referenciavirtual', lcParametros )			endif		endif		this.Referenciavirtual = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nroopecommerce( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INFORMACIONADICIONALCOMPVTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_nroopecommerce', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_nroopecommerce', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_referenciavirtual( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'INFORMACIONADICIONALCOMPVTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_referenciavirtual', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_referenciavirtual', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridobasededatosmodificacionfw() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridobasededatosmodificacionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoestadotransferencia() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridoestadotransferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaexpo() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofechaexpo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaimpo() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofechaimpo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechamodificacionfw() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofechamodificacionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechatransferencia() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofechatransferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohoraexpo() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridohoraexpo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohoraimpo() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridohoraimpo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohoramodificacionfw() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridohoramodificacionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonroopecommerce() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridonroopecommerce', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoreferenciavirtual() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoreferenciavirtual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoseriealtafw() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoseriealtafw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoseriemodificacionfw() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridoseriemodificacionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousuarioaltafw() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridousuarioaltafw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousuariomodificacionfw() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridousuariomodificacionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoversionaltafw() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoversionaltafw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoversionmodificacionfw() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridoversionmodificacionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function lanzarexcepcion( tctipo as string ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Lanzarexcepcion', lcParametros )
	EndFunc
