...
define class Mock_listadeprecios as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function coeficiente_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'coeficiente_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'coeficiente_assign', lcParametros )			endif		endif		dodefault( txVal )		this.EventoHabilitarDeshabilitarMonedaParaCotizacion()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventodeshabilitarcontrolprecioscalculadosalusarlos() as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Eventodeshabilitarcontrolprecioscalculadosalusarlos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitarcontrolprecioscalculadosalusarlos() as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Eventohabilitarcontrolprecioscalculadosalusarlos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitardeshabilitarcoeficiente() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventohabilitardeshabilitarcoeficiente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitardeshabilitarmonedaparacotizacion() as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Eventohabilitardeshabilitarmonedaparacotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitardeshabilitarparametrosprecios( txval as variant ) as void                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Eventohabilitardeshabilitarparametrosprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntaractualizarlistasdepreciosconordenamientoencero() as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventopreguntaractualizarlistasdepreciosconordenamientoencero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaconsultas_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'habilitaconsultas_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'habilitaconsultas_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Habilitaconsultas		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Habilitaconsultas( lxVal )				this.Setear_Habilitaconsultas( lxVal )			EndIf		Else			This.Setear_Habilitaconsultas( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistasdeprecios() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerlistasdeprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistasdeprecioscalculadasalmomento() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerlistasdeprecioscalculadasalmomento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistasdepreciosconvisibilidad( tcentidad as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerlistasdepreciosconvisibilidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerprimeraposiciondeordenamientolibre() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerprimeraposiciondeordenamientolibre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function operador_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'operador_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'operador_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Operador		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Operador( lxVal )				this.Setear_Operador( lxVal )			EndIf		Else			This.Setear_Operador( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ordenconsulta_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ordenconsulta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ordenconsulta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ordenconsulta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ordenconsulta( lxVal )				this.Setear_Ordenconsulta( lxVal )			EndIf		Else			This.Setear_Ordenconsulta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function precioscalculadosalusarlos_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'precioscalculadosalusarlos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'precioscalculadosalusarlos_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Precioscalculadosalusarlos		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Precioscalculadosalusarlos( lxVal )				this.Setear_Precioscalculadosalusarlos( lxVal )			EndIf		Else			This.Setear_Precioscalculadosalusarlos( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_coeficiente( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_coeficiente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_coeficiente', lcParametros )			endif		endif		this.Coeficiente = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_habilitaconsultas( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_habilitaconsultas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_habilitaconsultas', lcParametros )			endif		endif		this.Habilitaconsultas = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_listapbase( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_listapbase', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_listapbase', lcParametros )			endif		endif		this.Listapbase.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_monedaparacotiz( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_monedaparacotiz', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_monedaparacotiz', lcParametros )			endif		endif		this.Monedaparacotiz.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_nivelvisibilidad( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_nivelvisibilidad', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_nivelvisibilidad', lcParametros )			endif		endif		this.Nivelvisibilidad = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_operador( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_operador', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_operador', lcParametros )			endif		endif		this.Operador = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_ordenconsulta( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ordenconsulta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ordenconsulta', lcParametros )			endif		endif		this.Ordenconsulta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_precioscalculadosalusarlos( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_precioscalculadosalusarlos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_precioscalculadosalusarlos', lcParametros )			endif		endif		this.Precioscalculadosalusarlos = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tiporedondeo( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tiporedondeo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tiporedondeo', lcParametros )			endif		endif		this.Tiporedondeo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tiporedondeo_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tiporedondeo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tiporedondeo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tiporedondeo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tiporedondeo( lxVal )				this.Setear_Tiporedondeo( lxVal )			EndIf		Else			This.Setear_Tiporedondeo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_coeficiente( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_coeficiente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_coeficiente', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_habilitaconsultas( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_habilitaconsultas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_habilitaconsultas', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_monedaparacotiz( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_monedaparacotiz', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_monedaparacotiz', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_nivelvisibilidad( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_nivelvisibilidad', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_nivelvisibilidad', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_operador( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_operador', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_operador', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_ordenconsulta( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ordenconsulta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ordenconsulta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_precioscalculadosalusarlos( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_precioscalculadosalusarlos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_precioscalculadosalusarlos', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if this.lEdicion			this.AgregarInformacion( "No puede modificar el atributo." )			llRetorno = .f.		endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tiporedondeo( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LISTADEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tiporedondeo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tiporedondeo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcondicioniva() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarcondicioniva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarlistapbase() as boolean                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validarlistapbase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmonedacomocoeficiente( tccodigomoneda as string ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarmonedacomocoeficiente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmonedaparacotiz() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarmonedaparacotiz', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocoeficiente() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridocoeficiente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocondicioniva() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridocondicioniva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohabilitaconsultas() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridohabilitaconsultas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridolistapbase() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridolistapbase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomonedaparacotiz() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridomonedaparacotiz', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonivelvisibilidad() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridonivelvisibilidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridooperador() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridooperador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprecioscalculadosalusarlos() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridoprecioscalculadosalusarlos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotiporedondeo() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridotiporedondeo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function listautilizadaenformula() as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Listautilizadaenformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemauxparacolecciondelistasdeprecios as object                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obteneritemauxparacolecciondelistasdeprecios As Object', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarordendeconsultarepetido() as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarordendeconsultarepetido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarasignacionesdeformulas( tccodigolista as string ) as boolean                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Verificarasignacionesdeformulas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarformulas( tccodigolista as string ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificarformulas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarordendeconsultanorepetido() as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Verificarordendeconsultanorepetido', lcParametros )
	EndFunc
