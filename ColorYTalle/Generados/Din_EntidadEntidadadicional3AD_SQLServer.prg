...
define class Din_EntidadENTIDADADICIONAL3AD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxEntadic3Fecimpo, lxEntadic3Fectrans, lxEntadic3Fmodifw, lxEntadic3Fecexpo, lxEntadic3Faltafw, lxEntadic3Smodifw, lxEntadic3Saltafw, lxEntadic3Zadsfw, lxEntadic3Valtafw, lxEntadic3Vmodifw, lxEntadic3Hmodifw, lxEntadic3Umodifw, lxEntadic3Ualtafw, lxEntadic3Haltafw, lxEntadic3Horaimpo, lxEntadic3Bdaltafw, lxEntadic3Bdmodifw, lxEntadic3Esttrans, lxEntadic3Horaexpo, lxEntadic3Tipagrupub, lxEntadic3Cod, lxEntadic3Descri, lxEntadic3Obs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ENTADIC3 ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Smodifw","Saltafw","Zadsfw","Valtafw","Vmodifw","Hmodifw","Umodifw","Ualtafw","Haltafw","Horaimpo","Bdaltafw","Bdmodifw","Esttrans","Horaexpo","Tipagrupub","Cod","Descri","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxEntadic3Fecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic3Fectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic3Fmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic3Fecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic3Faltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Smodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Saltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Zadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Valtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Vmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Hmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Umodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Ualtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Haltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Horaimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Bdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Bdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Esttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Horaexpo ) + "'" >>, <<lxEntadic3Tipagrupub >>, <<"'" + this.FormatearTextoSql( lxEntadic3Cod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Descri ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic3Obs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ENTADIC3 set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEntadic3Fecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEntadic3Fectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEntadic3Fmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxEntadic3Fecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEntadic3Faltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Smodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Saltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEntadic3Zadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Valtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Vmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Hmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Umodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Ualtafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Haltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEntadic3Horaimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Bdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Bdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEntadic3Esttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEntadic3Horaexpo ) + "'">>,"Tipagrupub" = <<lxEntadic3Tipagrupub>>,"Cod" = <<"'" + this.FormatearTextoSql( lxEntadic3Cod ) + "'">>,"Descri" = <<"'" + this.FormatearTextoSql( lxEntadic3Descri ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxEntadic3Obs ) + "'">> where "Cod" = <<"'" + this.FormatearTextoSql( lxEntadic3Cod ) + "'">> and  ENTADIC3.COD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC3 where  ENTADIC3.COD != '' order by Cod
			endtext
			use in select('c_ENTIDADADICIONAL3')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL3', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC3 where  funciones.padr( Cod, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ENTADIC3.COD != '' order by Cod
			endtext
			use in select('c_ENTIDADADICIONAL3')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL3', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC3 where  funciones.padr( Cod, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ENTADIC3.COD != '' order by Cod desc
			endtext
			use in select('c_ENTIDADADICIONAL3')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL3', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC3 where  ENTADIC3.COD != '' order by Cod desc
			endtext
			use in select('c_ENTIDADADICIONAL3')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL3', set( 'Datasession' ) )
			local lcSentencia as string
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.ENTADIC3 set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEntadic3Fecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxEntadic3Fectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxEntadic3Fmodifw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEntadic3Fecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxEntadic3Faltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Smodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Saltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxEntadic3Zadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Valtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Vmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Hmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Umodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Ualtafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Haltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxEntadic3Horaimpo ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEntadic3Bdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic3Bdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxEntadic3Esttrans ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxEntadic3Horaexpo ) + "'">>, "Tipagrupub" = <<lxEntadic3Tipagrupub>>, "Cod" = <<"'" + this.FormatearTextoSql( lxEntadic3Cod ) + "'">>, "Descri" = <<"'" + this.FormatearTextoSql( lxEntadic3Descri ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxEntadic3Obs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'ENTADIC3' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad ENTIDADADICIONAL3. Hay un error en el diseño de importación.' )
			...
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.COD = isnull( d.COD, t.COD ),t.DESCRI = isnull( d.DESCRI, t.DESCRI ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.ENTADIC3 t inner join deleted d 
							 on t.Cod = d.Cod
				-- Fin Updates
				insert into ZooLogic.ENTADIC3(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Smodifw,Saltafw,Zadsfw,Valtafw,Vmodifw,Hmodifw,Umodifw,Ualtafw,Haltafw,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Horaexpo,Tipagrupub,Cod,Descri,Obs)
...
<VFPData xml:space="preserve">
	...
	<row entidad="ENTIDADADICIONAL3                       " atributo="FECHAIMPO                               " tabla="ENTADIC3       " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL3                       " atributo="FECHATRANSFERENCIA                      " tabla="ENTADIC3       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL3                       " atributo="FECHAMODIFICACIONFW                     " tabla="ENTADIC3       " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL3                       " atributo="FECHAEXPO                               " tabla="ENTADIC3       " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL3                       " atributo="SERIEMODIFICACIONFW                     " tabla="ENTADIC3       " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL3                       " atributo="VERSIONALTAFW                           " tabla="ENTADIC3       " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL3                       " atributo="VERSIONMODIFICACIONFW                   " tabla="ENTADIC3       " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL3                       " atributo="ESTADOTRANSFERENCIA                     " tabla="ENTADIC3       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL3                       " atributo="HORAEXPO                                " tabla="ENTADIC3       " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL3                       " atributo="DESCRI                                  " tabla="ENTADIC3       " campo="DESCRI    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
