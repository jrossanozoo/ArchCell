...
define class Mock_Codigodeservicioad_sqlserver as MockBase of MockBase.prg

	cClase = 'Codigodeservicioad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubcos( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubcos', lcParametros )
	EndFunc
