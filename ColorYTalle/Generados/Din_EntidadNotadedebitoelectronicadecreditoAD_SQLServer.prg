...
define class Din_EntidadNOTADEDEBITOELECTRONICADECREDITOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFecexpo, lxComprobantevFecimpo, lxComprobantevFmodifw, lxComprobantevFectrans, lxComprobantevFd2, lxComprobantevIdcaja, lxComprobantevFpodes1, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevIdajuste, lxComprobantevHoraexpo, lxComprobantevFaltafw, lxComprobantevZadsfw, lxComprobantevHaltafw, lxComprobantevValtafw, lxComprobantevSaltafw, lxComprobantevSimbmon, lxComprobantevHmodifw, lxComprobantevVmodifw, lxComprobantevBdaltafw, lxComprobantevHoraimpo, lxComprobantevOpecomm, lxComprobantevBdmodifw, lxComprobantevFhora, lxComprobantevDescfw, lxComprobantevUmodifw, lxComprobantevUaltafw, lxComprobantevSmodifw, lxComprobantevEsttrans, lxComprobantevMdcimpu, lxComprobantevTotalcant, lxComprobantevFactsec, lxComprobantevSubtotsisi, lxComprobantevFajxre, lxComprobantevSubtotcisi, lxComprobantevSignomov, lxComprobantevCondivalp, lxComprobantevSitfisccli, lxComprobantevFsubtot, lxComprobantevFsubton, lxComprobantevTimestamp, lxComprobantevFacttipo, lxComprobantevFpodes2, lxComprobantevDesmntosi2, lxComprobantevDesmntosi3, lxComprobantevRecmntosi, lxComprobantevDesmntosi1, lxComprobantevDesmntosi, lxComprobantevRecmntosi1, lxComprobantevRecmntosi2, lxComprobantevFcompfis, lxComprobantevDesaut, lxComprobantevAnulado, lxComprobantevNoper, lxComprobantevMotdescdev, lxComprobantevIdvuelto, lxComprobantevMonsis, lxComprobantevFobs, lxComprobantevFcuit, lxComprobantevMd1, lxComprobantevFcliente, lxComprobantevFmtdes1, lxComprobantevFmtdes2, lxComprobantevCodigo, lxComprobantevReceptor, lxComprobantevFven, lxComprobantevTdci, lxComprobantevTotdescsi, lxComprobantevMoneda, lxComprobantevFletra, lxComprobantevCodlista, lxComprobantevEmail, lxComprobantevFptoven, lxComprobantevTrci, lxComprobantevTotrecarsi, lxComprobantevFvuelto, lxComprobantevFnumcomp, lxComprobantevFtotal, lxComprobantevFfch, lxComprobantevFmtdes3, lxComprobantevDeuda, lxComprobantevCotiz, lxComprobantevFpodes, lxComprobantevRecmnto2, lxComprobantevFdescu, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevRecmnto, lxComprobantevRecpor, lxComprobantevMr, lxComprobantevMr2, lxComprobantevMd2, lxComprobantevMr1, lxComprobantevRecmnto1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecar, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevIvasis, lxComprobantevTipocrela, lxComprobantevLetrarela, lxComprobantevPuntorela, lxComprobantevNumerorela, lxComprobantevFeccrela
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fecexpo","Fecimpo","Fmodifw","Fectrans","Fd2","Idcaja","Fpodes1","Fperson","Fturno","Idajuste","Horaexpo","Faltafw","Zadsfw","Haltafw","Valtafw","Saltafw","Simbmon","Hmodifw","Vmodifw","Bdaltafw","Horaimpo","Opecomm","Bdmodifw","Fhora","Descfw","Umodifw","Ualtafw","Smodifw","Esttrans","Mdcimpu","Totalcant","Factsec","Subtotsisi","Fajxre","Subtotcisi","Signomov","Condivalp","Sitfisccli","Fsubtot","Fsubton","Timestamp","Facttipo","Fpodes2","Desmntosi2","Desmntosi3","Recmntosi","Desmntosi1","Desmntosi","Recmntosi1","Recmntosi2","Fcompfis","Desaut","Anulado","Noper","Motdescdev","Idvuelto","Monsis","Fobs","Fcuit","Md1","Fcliente","Fmtdes1","Fmtdes2","Codigo","Receptor","Fven","Tdci","Totdescsi","Moneda","Fletra","Codlista","Email","Fptoven","Trci","Totrecarsi","Fvuelto","Fnumcomp","Ftotal","Ffch","Fmtdes3","Deuda","Cotiz","Fpodes","Recmnto2","Fdescu","Md3","Percepcion","Recmnto","Recpor","Mr","Mr2","Md2","Mr1","Recmnto1","Gravamen","Fimpuesto","Totrecar","Totdesc","Totimpue","Ivasis","Tipocrela","Letrarela","Puntorela","Numerorela","Feccrela" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<lxComprobantevIdcaja >>, <<lxComprobantevFpodes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevTotalcant >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevFajxre >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevSignomov >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevFsubtot >>, <<lxComprobantevFsubton >>, <<lxComprobantevTimestamp >>, <<lxComprobantevFacttipo >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevRecmntosi2 >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevDesaut, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevNoper, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevMd1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<lxComprobantevTdci >>, <<lxComprobantevTotdescsi >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<lxComprobantevFptoven >>, <<lxComprobantevTrci >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevFvuelto >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFtotal >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevFmtdes3 >>, <<lxComprobantevDeuda >>, <<lxComprobantevCotiz >>, <<lxComprobantevFpodes >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevFdescu >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecpor >>, <<lxComprobantevMr >>, <<lxComprobantevMr2 >>, <<lxComprobantevMd2 >>, <<lxComprobantevMr1 >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<lxComprobantevIvasis >>, <<lxComprobantevTipocrela >>, <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'" >>, <<lxComprobantevPuntorela >>, <<lxComprobantevNumerorela >>, <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fd2" as "Fechamodificacion", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idajuste" as "Codigoajuste", "Horaexpo" as "Horaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Opecomm" as "Nroopecommerce", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fajxre" as "Ajustesporredondeos", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Timestamp" as "Timestamp", "Facttipo" as "Tipocomprobante", "Fpodes2" as "Porcentajedescuento2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi" as "Recargomontosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Noper" as "Nocalculapercepcion", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Base" as "Basedecalculo", "Codimp" as "Codigoimpuesto", "Codint" as "Codigointerno", "Tipoi" as "Tipoimpuesto", "Sirecs" as "Codseguridadsire", "Descri" as "Descripcion", "Regimenimp" as "Regimenimpositivo", "Sirecert" as "Certificadosire", "Minimoper" as "Minimo", "Minoimp" as "Minimonoimponible", "Montobase" as "Montobase", "Nroitem" as "Nroitem", "Porcen" as "Porcentaje", "Monto" as "Monto", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_NOTADEDEBITOELECTRONICADECREDITO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fd2" as "Fechamodificacion", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idajuste" as "Codigoajuste", "Horaexpo" as "Horaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Opecomm" as "Nroopecommerce", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fajxre" as "Ajustesporredondeos", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Timestamp" as "Timestamp", "Facttipo" as "Tipocomprobante", "Fpodes2" as "Porcentajedescuento2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi" as "Recargomontosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Noper" as "Nocalculapercepcion", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_NOTADEDEBITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fd2" as "Fechamodificacion", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idajuste" as "Codigoajuste", "Horaexpo" as "Horaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Opecomm" as "Nroopecommerce", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fajxre" as "Ajustesporredondeos", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Timestamp" as "Timestamp", "Facttipo" as "Tipocomprobante", "Fpodes2" as "Porcentajedescuento2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi" as "Recargomontosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Noper" as "Nocalculapercepcion", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_NOTADEDEBITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fd2" as "Fechamodificacion", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idajuste" as "Codigoajuste", "Horaexpo" as "Horaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Opecomm" as "Nroopecommerce", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fajxre" as "Ajustesporredondeos", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Timestamp" as "Timestamp", "Facttipo" as "Tipocomprobante", "Fpodes2" as "Porcentajedescuento2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi" as "Recargomontosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Noper" as "Nocalculapercepcion", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_NOTADEDEBITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fd2" as "Fechamodificacion", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idajuste" as "Codigoajuste", "Horaexpo" as "Horaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Opecomm" as "Nroopecommerce", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fajxre" as "Ajustesporredondeos", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Timestamp" as "Timestamp", "Facttipo" as "Tipocomprobante", "Fpodes2" as "Porcentajedescuento2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi" as "Recargomontosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Noper" as "Nocalculapercepcion", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_NOTADEDEBITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fecimpo,Fmodifw,Fectrans,Fd2,Idcaja,Fpodes1,Fperson,Fturno,Idajuste,Horaexpo,Faltafw" + ;
",Zadsfw,Haltafw,Valtafw,Saltafw,Simbmon,Hmodifw,Vmodifw,Bdaltafw,Horaimpo,Opecomm,Bdmodifw,Fhora,Des" + ;
"cfw,Umodifw,Ualtafw,Smodifw,Esttrans,Mdcimpu,Totalcant,Factsec,Subtotsisi,Fajxre,Subtotcisi,Signomov" + ;
",Condivalp,Sitfisccli,Fsubtot,Fsubton,Timestamp,Facttipo,Fpodes2,Desmntosi2,Desmntosi3,Recmntosi,Des" + ;
"mntosi1,Desmntosi,Recmntosi1,Recmntosi2,Fcompfis,Desaut,Anulado,Noper,Motdescdev,Idvuelto,Monsis,Fob" + ;
"s,Fcuit,Md1,Fcliente,Fmtdes1,Fmtdes2,Codigo,Receptor,Fven,Tdci,Totdescsi,Moneda,Fletra,Codlista,Emai" + ;
"l,Fptoven,Trci,Totrecarsi,Fvuelto,Fnumcomp,Ftotal,Ffch,Fmtdes3,Deuda,Cotiz,Fpodes,Recmnto2,Fdescu,Md" + ;
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, idAjuste = ] + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, DESAUT = ] + Transform( iif( &lcCursor..DESAUT, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, noper = ] + Transform( iif( &lcCursor..noper, 1, 0 ))+ [, MotDescDev = ] + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'"+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, Receptor = ] + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, MR = ] + transform( &lcCursor..MR )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, IvaSis = ] + transform( &lcCursor..IvaSis )+ [, TipoCRela = ] + transform( &lcCursor..TipoCRela )+ [, letraRela = ] + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'"+ [, puntoRela = ] + transform( &lcCursor..puntoRela )+ [, numeroRela = ] + transform( &lcCursor..numeroRela )+ [, FecCRela = ] + "'" + this.ConvertirDateSql( &lcCursor..FecCRela ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECIMPO, FMODIFW, FECTRANS, FD2, IdCaja, FPODES1, FPerson, FTurno, idAjuste, HORAEXPO, FAltaFW, ZADSFW, HAltaFW, VALTAFW, SALTAFW, SimbMon, HMODIFW, VMODIFW, BDALTAFW, HORAIMPO, OPEcomm, BDMODIFW, FHORA, DescFW, UMODIFW, UALTAFW, SMODIFW, ESTTRANS, MDCIMPU, TotalCant, FACTSEC, SubTotSISI, FAjXRe, SubTotCISI, signomov, CondivaLp, SitFiscCli, FSubTOT, fSubToN, TIMESTAMP, FACTTIPO, FPODES2, DesMntoSI2, DesMntoSI3, RecMntoSI, DesMntoSI1, DesMntoSI, RecMntoSI1, RecMntoSI2, FCOMPFIS, DESAUT, Anulado, noper, MotDescDev, idVuelto, MonSis, FObs, fCuit, MD1, FCLIENTE, FMTDES1, FMTDES2, CODIGO, Receptor, FVEN, TDCI, totdescSI, Moneda, FLETRA, CodLista, Email, FPTOVEN, TRCI, totrecarSI, FVuelto, FNUMCOMP, FTotal, FFCH, FMTDES3, Deuda, Cotiz, FPODES, RecMnto2, fDescu, MD3, percepcion, RecMnto, RecPor, MR, MR2, MD2, MR1, RecMnto1, gravamen, fImpuesto, totrecar, totdesc, totimpue, IvaSis, TipoCRela, letraRela, puntoRela, numeroRela, FecCRela
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'" + ',' + transform( &lcCursor..IdCaja ) + ',' + transform( &lcCursor..FPODES1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FTurno ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..MDCIMPU ) + ',' + transform( &lcCursor..TotalCant ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..FSubTOT )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..RecMntoSI1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..DESAUT, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..noper, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..FTotal ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..FMTDES3 ) + ',' + transform( &lcCursor..Deuda ) + ',' + transform( &lcCursor..Cotiz ) + ',' + transform( &lcCursor..FPODES )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FD2 = isnull( d.FD2, t.FD2 ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.DESAUT = isnull( d.DESAUT, t.DESAUT ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.NOPER = isnull( d.NOPER, t.NOPER ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.RECEPTOR = isnull( d.RECEPTOR, t.RECEPTOR ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.MR = isnull( d.MR, t.MR ),t.MR2 = isnull( d.MR2, t.MR2 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.IVASIS = isnull( d.IVASIS, t.IVASIS ),t.TIPOCRELA = isnull( d.TIPOCRELA, t.TIPOCRELA ),t.LETRARELA = isnull( d.LETRARELA, t.LETRARELA ),t.PUNTORELA = isnull( d.PUNTORELA, t.PUNTORELA ),t.NUMERORELA = isnull( d.NUMERORELA, t.NUMERORELA ),t.FECCRELA = isnull( d.FECCRELA, t.FECCRELA )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fecexpo,Fecimpo,Fmodifw,Fectrans,Fd2,Idcaja,Fpodes1,Fperson,Fturno,Idajuste,Horaexpo,Faltafw,Zadsfw,Haltafw,Valtafw,Saltafw,Simbmon,Hmodifw,Vmodifw,Bdaltafw,Horaimpo,Opecomm,Bdmodifw,Fhora,Descfw,Umodifw,Ualtafw,Smodifw,Esttrans,Mdcimpu,Totalcant,Factsec,Subtotsisi,Fajxre,Subtotcisi,Signomov,Condivalp,Sitfisccli,Fsubtot,Fsubton,Timestamp,Facttipo,Fpodes2,Desmntosi2,Desmntosi3,Recmntosi,Desmntosi1,Desmntosi,Recmntosi1,Recmntosi2,Fcompfis,Desaut,Anulado,Noper,Motdescdev,Idvuelto,Monsis,Fobs,Fcuit,Md1,Fcliente,Fmtdes1,Fmtdes2,Codigo,Receptor,Fven,Tdci,Totdescsi,Moneda,Fletra,Codlista,Email,Fptoven,Trci,Totrecarsi,Fvuelto,Fnumcomp,Ftotal,Ffch,Fmtdes3,Deuda,Cotiz,Fpodes,Recmnto2,Fdescu,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Recmnto1,Gravamen,Fimpuesto,Totrecar,Totdesc,Totimpue,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela)
					Select isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FD2,''),isnull( d.IDCAJA,0),isnull( d.FPODES1,0),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.IDAJUSTE,''),isnull( d.HORAEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.ZADSFW,''),convert( char(8), getdate(), 108 ),isnull( d.VALTAFW,''),isnull( d.SALTAFW,''),isnull( d.SIMBMON,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.OPECOMM,''),isnull( d.BDMODIFW,''),isnull( d.FHORA,''),isnull( d.DESCFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.MDCIMPU,0),isnull( d.TOTALCANT,0),isnull( d.FACTSEC,''),isnull( d.SUBTOTSISI,0),isnull( d.FAJXRE,0),isnull( d.SUBTOTCISI,0),isnull( d.SIGNOMOV,0),isnull( d.CONDIVALP,0),isnull( d.SITFISCCLI,0),isnull( d.FSUBTOT,0),isnull( d.FSUBTON,0),isnull( d.TIMESTAMP,0),isnull( d.FACTTIPO,0),isnull( d.FPODES2,0),isnull( d.DESMNTOSI2,0),isnull( d.DESMNTOSI3,0),isnull( d.RECMNTOSI,0),isnull( d.DESMNTOSI1,0),isnull( d.DESMNTOSI,0),isnull( d.RECMNTOSI1,0),isnull( d.RECMNTOSI2,0),isnull( d.FCOMPFIS,0),isnull( d.DESAUT,0),isnull( d.ANULADO,0),isnull( d.NOPER,0),isnull( d.MOTDESCDEV,''),isnull( d.IDVUELTO,''),isnull( d.MONSIS,''),isnull( d.FOBS,''),isnull( d.FCUIT,''),isnull( d.MD1,0),isnull( d.FCLIENTE,''),isnull( d.FMTDES1,0),isnull( d.FMTDES2,0),isnull( d.CODIGO,''),isnull( d.RECEPTOR,''),isnull( d.FVEN,''),isnull( d.TDCI,0),isnull( d.TOTDESCSI,0),isnull( d.MONEDA,''),isnull( d.FLETRA,''),isnull( d.CODLISTA,''),isnull( d.EMAIL,''),isnull( d.FPTOVEN,0),isnull( d.TRCI,0),isnull( d.TOTRECARSI,0),isnull( d.FVUELTO,0),isnull( d.FNUMCOMP,0),isnull( d.FTOTAL,0),isnull( d.FFCH,''),isnull( d.FMTDES3,0),isnull( d.DEUDA,0),isnull( d.COTIZ,0),isnull( d.FPODES,0),isnull( d.RECMNTO2,0),isnull( d.FDESCU,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.RECMNTO,0),isnull( d.RECPOR,0),isnull( d.MR,0),isnull( d.MR2,0),isnull( d.MD2,0),isnull( d.MR1,0),isnull( d.RECMNTO1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECAR,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.IVASIS,0),isnull( d.TIPOCRELA,0),isnull( d.LETRARELA,''),isnull( d.PUNTORELA,0),isnull( d.NUMERORELA,0),isnull( d.FECCRELA,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_NOTADEDEBITOELECTRONICADECREDITO' ) < 1
				...
				Try
					...
					.Obs = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Obs, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="412" etiqueta="Moneda                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="448" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
