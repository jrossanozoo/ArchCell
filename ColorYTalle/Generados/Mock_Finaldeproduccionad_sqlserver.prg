...
define class Mock_Finaldeproduccionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Finaldeproduccionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detartfinalprod( tctablatrabajo ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detartfinalprod', lcParametros )
	EndFunc
