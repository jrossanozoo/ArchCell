...
define class Mock_notadecreditocompra as MockBase of MockBase.prg
	...
	cComprobante = ""                                                                                                                                                                                                                                         
	cComprobante = "NOTADECREDITOCOMPRA"                                                                                                                                                                                                                      
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Nota de crédito de compra"                                                                                                                                                                                                               
	...
	*-----------------------------------------------------------------------------------------
	function validarpuntodeventaextendido() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarpuntodeventaextendido', lcParametros )
	EndFunc
