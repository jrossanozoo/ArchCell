...
define class Mock_Grupovalorad_sqlserver as MockBase of MockBase.prg

	cClase = 'Grupovalorad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubgpv( tctablatrabajo ) as string                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubgpv', lcParametros )
	EndFunc
