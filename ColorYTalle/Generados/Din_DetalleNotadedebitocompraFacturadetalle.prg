...
define class Din_DetalleNOTADEDEBITOCOMPRAFacturadetalle as DetalleColorytalle_articuloscompra of DetalleColorytalle_articuloscompra.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemNOTADEDEBITOCOMPRAFacturadetalle' )
		...
		for lni = 1 to this.Count
			...
			if vartype( this.Item[lni].AFE_NUMERO) = 'N'
				...
				if lnLargoEntero <= 10
					...
					llRetorno = .F.
					this.AgregarInformacion( 'La longitud entera del valor del atributo AFE_NUMERO del item ' + transform( lni ) + ' es mayor a la permitida (Actual:' + transform(lnLargoEntero) + ' Máxima:10), en el detalle ' + this.cEtiqueta + '.' )
				Endif
			else
				llRetorno = .F.
