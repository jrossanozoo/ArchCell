...
define class Din_EntidadAdt_stockarticulos_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Adt_stockarticulos"
	cClaseResponse = this.cNamespaceDTOs + ".Adt_stockarticulosResponse"
	cClaseModelo = "Adt_stockarticulosModelo"
	cEntidad = "Adt_stockarticulos"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_stockarticulosModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_stockarticulosListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_stockarticulosListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_stockarticulosModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Codigo", "ARTCOD")
		return lcFiltro 
	endfunc
