...
define class Din_EntidadEntidadadicional1_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Entidadadicional1"
	cClaseResponse = this.cNamespaceDTOs + ".Entidadadicional1Response"
	cClaseModelo = "Entidadadicional1Modelo"
	cEntidad = "Entidadadicional1"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional1Modelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional1ListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional1ListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Entidadadicional1Modelo"
		endcase
		return lcRetorno
