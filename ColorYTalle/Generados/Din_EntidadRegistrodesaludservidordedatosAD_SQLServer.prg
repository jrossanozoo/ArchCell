...
define class Din_EntidadREGISTRODESALUDSERVIDORDEDATOSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRegsaludFecexpo, lxRegsaludFectrans, lxRegsaludFecimpo, lxRegsaludFaltafw, lxRegsaludFmodifw, lxRegsaludSmodifw, lxRegsaludHmodifw, lxRegsaludSaltafw, lxRegsaludUaltafw, lxRegsaludUmodifw, lxRegsaludZadsfw, lxRegsaludValtafw, lxRegsaludVmodifw, lxRegsaludHoraimpo, lxRegsaludHoraexpo, lxRegsaludBdmodifw, lxRegsaludBdaltafw, lxRegsaludEsttrans, lxRegsaludHaltafw, lxRegsaludCcodigo, lxRegsaludMomento, lxRegsaludDiagno, lxRegsaludAdvertt, lxRegsaludObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.REGSALUD ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Smodifw","Hmodifw","Saltafw","Ualtafw","Umodifw","Zadsfw","Valtafw","Vmodifw","Horaimpo","Horaexpo","Bdmodifw","Bdaltafw","Esttrans","Haltafw","Ccodigo","Momento","Diagno","Advertt","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxRegsaludFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegsaludFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegsaludFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegsaludFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegsaludFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludCcodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegsaludMomento ) + "'" >>, <<iif( lxRegsaludDiagno, 1, 0 ) >>, <<iif( lxRegsaludAdvertt, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxRegsaludObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.REGSALUD set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxRegsaludFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRegsaludFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxRegsaludFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRegsaludFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxRegsaludFmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRegsaludSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRegsaludUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRegsaludZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRegsaludValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludVmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRegsaludHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRegsaludHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRegsaludBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRegsaludEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRegsaludHaltafw ) + "'">>,"Ccodigo" = <<"'" + this.FormatearTextoSql( lxRegsaludCcodigo ) + "'">>,"Momento" = <<"'" + this.FormatearTextoSql( lxRegsaludMomento ) + "'">>,"Diagno" = <<iif( lxRegsaludDiagno, 1, 0 )>>,"Advertt" = <<iif( lxRegsaludAdvertt, 1, 0 )>>,"Obs" = <<"'" + this.FormatearTextoSql( lxRegsaludObs ) + "'">> where "Ccodigo" = <<"'" + this.FormatearTextoSql( lxRegsaludCcodigo ) + "'">> and  REGSALUD.CCODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Ccodigo" as "Codigo", "Momento" as "Momento", "Diagno" as "Diagnosticoprocesado", "Advertt" as "Advertenciamalapagado", "Obs" as "Observacion" from ORGANIZACION.REGSALUD where "Ccodigo" = <<"'" + this.FormatearTextoSql( lxRegsaludCcodigo ) + "'">> and  REGSALUD.CCODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Ccodigo" as "Codigo", "Momento" as "Momento", "Diagno" as "Diagnosticoprocesado", "Advertt" as "Advertenciamalapagado", "Obs" as "Observacion" from ORGANIZACION.REGSALUD where  REGSALUD.CCODIGO != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_REGISTRODESALUDSERVIDORDEDATOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REGISTRODESALUDSERVIDORDEDATOS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Ccodigo" as "Codigo", "Momento" as "Momento", "Diagno" as "Diagnosticoprocesado", "Advertt" as "Advertenciamalapagado", "Obs" as "Observacion" from ORGANIZACION.REGSALUD where  funciones.dtos( FALTAFW ) + funciones.padr( HALTAFW, 8, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  REGSALUD.CCODIGO != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_REGISTRODESALUDSERVIDORDEDATOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REGISTRODESALUDSERVIDORDEDATOS', set( 'Datasession' ) )
			Endwith
...
"afw,Vmodifw,Horaimpo,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Ccodigo,Momento,Diagno,Advertt,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Ccodigo" as "Codigo", "Momento" as "Momento", "Diagno" as "Diagnosticoprocesado", "Advertt" as "Advertenciamalapagado", "Obs" as "Observacion"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.REGSALUD set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxRegsaludFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxRegsaludFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxRegsaludFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxRegsaludFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxRegsaludFmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludHmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxRegsaludSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxRegsaludUaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxRegsaludZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxRegsaludValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludVmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxRegsaludHoraimpo ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxRegsaludHoraexpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRegsaludBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRegsaludBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxRegsaludEsttrans ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxRegsaludHaltafw ) + "'">>, "Ccodigo" = <<"'" + this.FormatearTextoSql( lxRegsaludCcodigo ) + "'">>, "Momento" = <<"'" + this.FormatearTextoSql( lxRegsaludMomento ) + "'">>, "Diagno" = <<iif( lxRegsaludDiagno, 1, 0 )>>, "Advertt" = <<iif( lxRegsaludAdvertt, 1, 0 )>>, "Obs" = <<"'" + this.FormatearTextoSql( lxRegsaludObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'REGSALUD' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.REGSALUD set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, cCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'"+ [, Momento = ] + "'" + this.FormatearTextoSql( &lcCursor..Momento ) + "'"+ [, diagno = ] + Transform( iif( &lcCursor..diagno, 1, 0 ))+ [, Advertt = ] + Transform( iif( &lcCursor..Advertt, 1, 0 ))+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where cCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, SMODIFW, HMODIFW, SALTAFW, UALTAFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HORAIMPO, HORAEXPO, BDMODIFW, BDALTAFW, ESTTRANS, HALTAFW, cCodigo, Momento, diagno, Advertt, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Momento ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.CCODIGO = isnull( d.CCODIGO, t.CCODIGO ),t.MOMENTO = isnull( d.MOMENTO, t.MOMENTO ),t.DIAGNO = isnull( d.DIAGNO, t.DIAGNO ),t.ADVERTT = isnull( d.ADVERTT, t.ADVERTT ),t.OBS = isnull( d.OBS, t.OBS )
					from ORGANIZACION.REGSALUD t inner join deleted d 
							 on t.cCodigo = d.cCodigo
				-- Fin Updates
				insert into ORGANIZACION.REGSALUD(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Valtafw,Vmodifw,Horaimpo,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Ccodigo,Momento,Diagno,Advertt,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.CCODIGO,''),isnull( d.MOMENTO,''),isnull( d.DIAGNO,0),isnull( d.ADVERTT,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="REGISTRODESALUDSERVIDORDEDATOS          " atributo="FECHATRANSFERENCIA                      " tabla="REGSALUD       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODESALUDSERVIDORDEDATOS          " atributo="ESTADOTRANSFERENCIA                     " tabla="REGSALUD       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
