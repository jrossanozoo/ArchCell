...
define class Mock_Itemaliviodecajadetallealivio as MockBase of MockBase.prg

	cClase = 'Itemaliviodecajadetallealivio'
	...
	*-----------------------------------------------------------------------------------------
	function cajadetalle_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Cajadetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montoadvertencia_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Montoadvertencia_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montomaximo_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Montomaximo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cajadetalle( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_cajadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montoadvertencia( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_montoadvertencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montomaximo( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_montomaximo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cajadetalle( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_cajadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montoadvertencia( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_montoadvertencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montomaximo( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_montomaximo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocajadetalle() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridocajadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomontoadvertencia() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridomontoadvertencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomontomaximo() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridomontomaximo', lcParametros )
	EndFunc
