...
define class Din_DetalleFACTURADEEXPORTACIONFacturadetalle as DetalleColorytalle_articulosventa of DetalleColorytalle_articulosventa.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemFACTURADEEXPORTACIONFacturadetalle' )
