...
define class Din_DetalleCHEQUESDISPONIBLESCheques as detalle of detalle.prg
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.CodigoCheque = this.Item[ tnItem ].CodigoCheque
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'CodigoCheque', .CodigoCheque )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.CodigoCheque = this.oItem.CodigoCheque
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].CodigoCheque = .oItem.CodigoCheque
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Cheques' ) > 0 and reccount( 'c_Cheques' ) > 0
				endif
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemCHEQUESDISPONIBLESCheques' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		scan for &lcFiltro
			...
			loItem.Codigo = c_Cheques.Codigo
			loItem.NROITEM = c_Cheques.NROITEM
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Codigocheque = toItemOrigen.Codigocheque
