...
define class Mock_Itemfechacancelaciondetallefechacancelacion as MockBase of MockBase.prg

	cClase = 'Itemfechacancelaciondetallefechacancelacion'
	...
	*-----------------------------------------------------------------------------------------
	function codigoopeecommerce_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Codigoopeecommerce_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numeroitemoriginal_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Numeroitemoriginal_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoopeecommerce( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_codigoopeecommerce', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numeroitemoriginal( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_numeroitemoriginal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoopeecommerce( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_codigoopeecommerce', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numeroitemoriginal( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_numeroitemoriginal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechacancelacion() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridofechacancelacion', lcParametros )
	EndFunc
