...
define class Mock_Clasificacionvendedorad_sqlserver as MockBase of MockBase.prg

	cClase = 'Clasificacionvendedorad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupub208( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupub208', lcParametros )
	EndFunc
