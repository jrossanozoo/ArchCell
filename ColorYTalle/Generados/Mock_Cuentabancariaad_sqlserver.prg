...
define class Mock_Cuentabancariaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Cuentabancariaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupub132( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupub132', lcParametros )
	EndFunc
