...
define class Mock_COLABORADORGESTIONVENDEDOR as MockBase of MockBase.prg

	cClase = 'COLABORADORGESTIONVENDEDOR'
	...
	*-----------------------------------------------------------------------------------------
	function validarvendedor( tccodigovendedor as string, toentidad as object) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccodigovendedor
		lxParam2 = toentidad
	...
	*-----------------------------------------------------------------------------------------
	protected function estahabilitadoenlasucursalobd(tcnombrecursor as string,tcfechacomprobante as string ) as boolean                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcnombrecursor
		lxParam2 = tcfechacomprobante
		...
		return this.ObtenerResultado( 'Estahabilitadoenlasucursalobd', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercursorvendedor(tccodigovendedor as string, tcsucursal as string, tcbasededatos as string ) as string                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenercursorvendedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ogestionvendedor_access() as object                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ogestionvendedor_access', lcParametros )
	EndFunc
