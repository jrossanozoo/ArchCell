...
define class Mock_accionesautomaticas as MockBase of MockBase.prg
	...
	cClase = 'accionesautomaticas'

	
	AccionesDetalle = null                                                                                                                                                                                                                                    
	BASEDEDATOSALTAFW = ""                                                                                                                                                                                                                                    
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Comportamiento de entidades"                                                                                                                                                                                                             
	cDescripcionEntidad = ""                                                                                                                                                                                                                                  
	...
	lHabilitarRestringirPicking = .T.                                                                                                                                                                                                                         
	lHabilitarValorDeCierre_PK = .T.                                                                                                                                                                                                                          
	...
	*-----------------------------------------------------------------------------------------
	function accionesdetalle_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'accionesdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'accionesdetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Accionesdetalle ) = 'O' or isnull( this.Accionesdetalle ) )			this.Accionesdetalle = this.crearobjeto( 'Din_DetalleAccionesautomaticasAccionesdetalle' )			this.Accionesdetalle.inicializar()			this.enlazar( 'Accionesdetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Accionesdetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Accionesdetalle, 'CambioSumarizado', this, 'CambiosDetalleAccionesdetalle', 1)			this.enlazar( 'Accionesdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Accionesdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Accionesdetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleaccionesdetalle() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleaccionesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearregistro( tcentidad as string ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Crearregistro', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existeregistroparalaentidad( tcentidad as string ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Existeregistroparalaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function exportar( toentidad as entidad of entidad.prg, tcexpresion as string ) as void                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Exportar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nuevodespuesdegrabar_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'nuevodespuesdegrabar_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'nuevodespuesdegrabar_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Nuevodespuesdegrabar		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Nuevodespuesdegrabar( lxVal )				this.Setear_Nuevodespuesdegrabar( lxVal )			EndIf		Else			This.Setear_Nuevodespuesdegrabar( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nuevodespuesdegrabarsegunentidad(tcentidad as string) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Nuevodespuesdegrabarsegunentidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oad_access() as variant                                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oad_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oad_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oAD ) = 'O' or isnull( this.oAD ) )			this.oAD = this.crearobjeto( 'Din_EntidadACCIONESAUTOMATICASAD_' + alltrim( _screen.zoo.app.TipoDeBase ))			this.oAD.InyectarEntidad( this )			this.oAD.Inicializar()		endif		return this.oAD
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parametrosegunentidad( tcentidad as string ) as string                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Parametrosegunentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function poseevalordecierreentidad( tcentidad as string ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Poseevalordecierreentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function realizarimpresion( toentidad as entidad of entidad.prg, tcexpresion as string ) as void                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Realizarimpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function restringirpicking_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'restringirpicking_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'restringirpicking_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Restringirpicking		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Restringirpicking( lxVal )				if ( this.lHabilitarRestringirpicking or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Restringirpicking( lxVal )				else					this.Restringirpicking = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comportamiento de entidades - Atributo: Restringirpicking)" )				endif			EndIf		Else			This.Setear_Restringirpicking( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nuevodespuesdegrabar( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_nuevodespuesdegrabar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_nuevodespuesdegrabar', lcParametros )			endif		endif		this.Nuevodespuesdegrabar = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_restringirpicking( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_restringirpicking', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_restringirpicking', lcParametros )			endif		endif		this.Restringirpicking = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valordecierre( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_valordecierre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_valordecierre', lcParametros )			endif		endif		this.Valordecierre.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearvalorsegunentidad( tcentidad as string ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setearvalorsegunentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nuevodespuesdegrabar( txval as variant ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_nuevodespuesdegrabar', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_nuevodespuesdegrabar', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_restringirpicking( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_restringirpicking', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_restringirpicking', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valordecierre( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_valordecierre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_valordecierre', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvalordecierre() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarvalordecierre', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valordecierre_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'valordecierre_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'valordecierre_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Valordecierre ) = 'O' or isnull( this.Valordecierre ) )					this.Valordecierre = _Screen.zoo.instanciarentidad( 'Valor' )					this.Valordecierre.lEsSubEntidad = .t.					this.enlazar( 'Valordecierre.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Valordecierre.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Valordecierre.CODIGO # this.Valordecierre_PK						this.Valordecierre.CODIGO = this.Valordecierre_PK					endif				endif			endif		endif		return this.Valordecierre
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valordecierre_pk_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ACCIONESAUTOMATICAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'valordecierre_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'valordecierre_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Valordecierre_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Valordecierre_PK = lxVal		if this.Validar_Valordecierre( lxVal, lxValOld )			if ( this.lHabilitarValordecierre_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Valordecierre( lxVal )			else				this.Valordecierre_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comportamiento de entidades - Atributo: Valordecierre)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonuevodespuesdegrabar() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridonuevodespuesdegrabar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorestringirpicking() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridorestringirpicking', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridovalordecierre() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridovalordecierre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcamposdetalle() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Verificarcamposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function realizarexportacion( tccodigodeexportacion as string, tcatributofiltro as string, tccodigodesde as string,  tccodigohasta as string, tcestado as string, tlacciontipoantes as boolean, tcentidad as string,   tcevento as string ) as v
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6, lxParam7, lxParam8

		lnParametros = pcount()
		lxParam1 = tccodigodeexportacion
		lxParam2 = tcatributofiltro
		lxParam3 = tccodigodesde
		lxParam4 = tccodigohasta
		lxParam5 = tcestado
		lxParam6 = tlacciontipoantes
		lxParam7 = tcentidad
		lxParam8 = tcevento
		...
		return this.ObtenerResultado( 'Realizarexportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarentidadconcomportamiento( txval as string ) as boolean                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validarentidadconcomportamiento', lcParametros )
	EndFunc
