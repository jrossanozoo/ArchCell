...
define class Mock_operadoradetarjeta as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Operadoras de tarjetas"                                                                                                                                                                                                                  
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleclasesdetarjetadetalle() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleclasesdetarjetadetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalleconceptos() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleconceptos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function clasesdetarjetadetalle_access() as variant                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'OPERADORADETARJETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'clasesdetarjetadetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'clasesdetarjetadetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Clasesdetarjetadetalle ) = 'O' or isnull( this.Clasesdetarjetadetalle ) )			this.Clasesdetarjetadetalle = this.crearobjeto( 'Din_DetalleOperadoradetarjetaClasesdetarjetadetalle' )			this.Clasesdetarjetadetalle.inicializar()			this.enlazar( 'Clasesdetarjetadetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Clasesdetarjetadetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Clasesdetarjetadetalle, 'CambioSumarizado', this, 'CambiosDetalleClasesdetarjetadetalle', 1)			this.enlazar( 'Clasesdetarjetadetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Clasesdetarjetadetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Clasesdetarjetadetalle.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Clasesdetarjetadetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function conceptos_access() as variant                                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'OPERADORADETARJETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'conceptos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'conceptos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Conceptos ) = 'O' or isnull( this.Conceptos ) )			this.Conceptos = this.crearobjeto( 'Din_DetalleOperadoradetarjetaConceptos' )			this.Conceptos.inicializar()			this.enlazar( 'Conceptos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Conceptos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Conceptos, 'CambioSumarizado', this, 'CambiosDetalleConceptos', 1)			this.enlazar( 'Conceptos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Conceptos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Conceptos.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Conceptos
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function entidadpagadora_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'OPERADORADETARJETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'entidadpagadora_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'entidadpagadora_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Entidadpagadora ) = 'O' or isnull( this.Entidadpagadora ) )					this.Entidadpagadora = _Screen.zoo.instanciarentidad( 'Entidadfinanciera' )					this.Entidadpagadora.lEsSubEntidad = .t.					this.enlazar( 'Entidadpagadora.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Entidadpagadora.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Entidadpagadora.CODIGO # this.Entidadpagadora_PK						this.Entidadpagadora.CODIGO = this.Entidadpagadora_PK					endif				endif			endif		endif		return this.Entidadpagadora
	EndFunc

	*-----------------------------------------------------------------------------------------
	function entidadpagadora_pk_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'OPERADORADETARJETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'entidadpagadora_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'entidadpagadora_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Entidadpagadora_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )		this.Entidadpagadora_PK = lxVal		if this.Validar_Entidadpagadora( lxVal, lxValOld )			This.Setear_Entidadpagadora( lxVal )		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_entidadpagadora( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'OPERADORADETARJETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_entidadpagadora', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_entidadpagadora', lcParametros )			endif		endif		this.Entidadpagadora.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_entidadpagadora( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'OPERADORADETARJETA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_entidadpagadora', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_entidadpagadora', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcargadeentidadfinanciera() as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcargadeentidadfinanciera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarentidadpagadora() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarentidadpagadora', lcParametros )
	EndFunc
