...
define class Din_ItemCRITERIOSVALORESAgrupublidetalle as ItemAgruPubliDetalle of ItemAgruPubliDetalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'CRITERIOSVALORES', 'Agrupublidetalle')
