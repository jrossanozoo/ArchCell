...
define class Din_EntidadFACTURAAGRUPADAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFecexpo, lxComprobantevFectrans, lxComprobantevFecimpo, lxComprobantevVtocai, lxComprobantevFd2, lxComprobantevFmodifw, lxComprobantevInformnube, lxComprobantevFcuit, lxComprobantevIdcaja, lxComprobantevOpecomm, lxComprobantevFaltafw, lxComprobantevHaltafw, lxComprobantevDespachos, lxComprobantevIdajuste, lxComprobantevEsttrans, lxComprobantevValtafw, lxComprobantevBdaltafw, lxComprobantevVmodifw, lxComprobantevFhora, lxComprobantevZadsfw, lxComprobantevDescfw, lxComprobantevCbautoimp, lxComprobantevSimbmon, lxComprobantevUmodifw, lxComprobantevHoraimpo, lxComprobantevHmodifw, lxComprobantevHoraexpo, lxComprobantevSmodifw, lxComprobantevBdmodifw, lxComprobantevSaltafw, lxComprobantevUaltafw, lxComprobantevCai, lxComprobantevTimestamp, lxComprobantevTotalcant, lxComprobantevFactsec, lxComprobantevMdcimpu, lxComprobantevFsubton, lxComprobantevRecmntosi2, lxComprobantevRecmntosi, lxComprobantevRecmntosi1, lxComprobantevFpodes2, lxComprobantevSubtotcisi, lxComprobantevSignomov, lxComprobantevCondivalp, lxComprobantevSubtotsisi, lxComprobantevSitfisccli, lxComprobantevFsubtot, lxComprobantevDesmntosi, lxComprobantevDesmntosi1, lxComprobantevFajxre, lxComprobantevDesmntosi2, lxComprobantevDesmntosi3, lxComprobantevFcompfis, lxComprobantevAnulado, lxComprobantevDesaut, lxComprobantevFacttipo, lxComprobantevIdvuelto, lxComprobantevMotdescdev, lxComprobantevMonsis, lxComprobantevFobs, lxComprobantevFpodes1, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevIdsenia, lxComprobantevFmtdes2, lxComprobantevCodigo, lxComprobantevSenia, lxComprobantevMd1, lxComprobantevFcliente, lxComprobantevFmtdes1, lxComprobantevReceptor, lxComprobantevFven, lxComprobantevMoneda, lxComprobantevFletra, lxComprobantevVtosenia, lxComprobantevTrci, lxComprobantevTotrecarsi, lxComprobantevCodlista, lxComprobantevFptoven, lxComprobantevEmail, lxComprobantevFnumcomp, lxComprobantevFtotal, lxComprobantevTdci, lxComprobantevTotdescsi, lxComprobantevDirentr, lxComprobantevFfch, lxComprobantevFmtdes3, lxComprobantevDeuda, lxComprobantevCotiz, lxComprobantevFpago, lxComprobantevFpodes, lxComprobantevRecmnto2, lxComprobantevFvuelto, lxComprobantevEntregapos, lxComprobantevFfchvtopag, lxComprobantevOpctrasmis, lxComprobantevFdescu, lxComprobantevMerconsign, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevRecmnto, lxComprobantevRecpor, lxComprobantevMr, lxComprobantevMr2, lxComprobantevMd2, lxComprobantevMr1, lxComprobantevRecmnto1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecarci, lxComprobantevTotdesc, lxComprobantevChequer, lxComprobantevTotimpue, lxComprobantevCancelar, lxComprobantevIvasis
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fecexpo","Fectrans","Fecimpo","Vtocai","Fd2","Fmodifw","Informnube","Fcuit","Idcaja","Opecomm","Faltafw","Haltafw","Despachos","Idajuste","Esttrans","Valtafw","Bdaltafw","Vmodifw","Fhora","Zadsfw","Descfw","Cbautoimp","Simbmon","Umodifw","Horaimpo","Hmodifw","Horaexpo","Smodifw","Bdmodifw","Saltafw","Ualtafw","Cai","Timestamp","Totalcant","Factsec","Mdcimpu","Fsubton","Recmntosi2","Recmntosi","Recmntosi1","Fpodes2","Subtotcisi","Signomov","Condivalp","Subtotsisi","Sitfisccli","Fsubtot","Desmntosi","Desmntosi1","Fajxre","Desmntosi2","Desmntosi3","Fcompfis","Anulado","Desaut","Facttipo","Idvuelto","Motdescdev","Monsis","Fobs","Fpodes1","Fperson","Fturno","Idsenia","Fmtdes2","Codigo","Senia","Md1","Fcliente","Fmtdes1","Receptor","Fven","Moneda","Fletra","Vtosenia","Trci","Totrecarsi","Codlista","Fptoven","Email","Fnumcomp","Ftotal","Tdci","Totdescsi","Direntr","Ffch","Fmtdes3","Deuda","Cotiz","Fpago","Fpodes","Recmnto2","Fvuelto","Entregapos","Ffchvtopag","Opctrasmis","Fdescu","Merconsign","Md3","Percepcion","Recmnto","Recpor","Mr","Mr2","Md2","Mr1","Recmnto1","Gravamen","Fimpuesto","Totrecarci","Totdesc","Chequer","Totimpue","Cancelar","Ivasis" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtocai ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevIdcaja >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCbautoimp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<lxComprobantevCai >>, <<lxComprobantevTimestamp >>, <<lxComprobantevTotalcant >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevFsubton >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevSignomov >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevFsubtot >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevFajxre >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevDesmntosi3 >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevDesaut, 1, 0 ) >>, <<lxComprobantevFacttipo >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<lxComprobantevFpodes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'" >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSenia ) + "'" >>, <<lxComprobantevMd1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFmtdes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'" >>, <<lxComprobantevTrci >>, <<lxComprobantevTotrecarsi >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<lxComprobantevFptoven >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFtotal >>, <<lxComprobantevTdci >>, <<lxComprobantevTotdescsi >>, <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevFmtdes3 >>, <<lxComprobantevDeuda >>, <<lxComprobantevCotiz >>, <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'" >>, <<lxComprobantevFpodes >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevFvuelto >>, <<lxComprobantevEntregapos >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfchvtopag ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpctrasmis ) + "'" >>, <<lxComprobantevFdescu >>, <<iif( lxComprobantevMerconsign, 1, 0 ) >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecpor >>, <<lxComprobantevMr >>, <<lxComprobantevMr2 >>, <<lxComprobantevMd2 >>, <<lxComprobantevMr1 >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecarci >>, <<lxComprobantevTotdesc >>, <<"'" + this.FormatearTextoSql( lxComprobantevChequer ) + "'" >>, <<lxComprobantevTotimpue >>, <<iif( lxComprobantevCancelar, 1, 0 ) >>, <<lxComprobantevIvasis >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Vtocai" = <<"'" + this.ConvertirDateSql( lxComprobantevVtocai ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Informnube" = <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Idcaja" = <<lxComprobantevIdcaja>>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Despachos" = <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'">>,"Idajuste" = <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Cbautoimp" = <<"'" + this.FormatearTextoSql( lxComprobantevCbautoimp ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Cai" = <<lxComprobantevCai>>,"Timestamp" = <<lxComprobantevTimestamp>>,"Totalcant" = <<lxComprobantevTotalcant>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Fsubton" = <<lxComprobantevFsubton>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Signomov" = <<lxComprobantevSignomov>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Fajxre" = <<lxComprobantevFajxre>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Desaut" = <<iif( lxComprobantevDesaut, 1, 0 )>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'">>,"Motdescdev" = <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Idsenia" = <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'">>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Senia" = <<"'" + this.FormatearTextoSql( lxComprobantevSenia ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Receptor" = <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Vtosenia" = <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'">>,"Trci" = <<lxComprobantevTrci>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Fptoven" = <<lxComprobantevFptoven>>,"Email" = <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'">>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Ftotal" = <<lxComprobantevFtotal>>,"Tdci" = <<lxComprobantevTdci>>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Direntr" = <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Deuda" = <<lxComprobantevDeuda>>,"Cotiz" = <<lxComprobantevCotiz>>,"Fpago" = <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'">>,"Fpodes" = <<lxComprobantevFpodes>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Fvuelto" = <<lxComprobantevFvuelto>>,"Entregapos" = <<lxComprobantevEntregapos>>,"Ffchvtopag" = <<"'" + this.ConvertirDateSql( lxComprobantevFfchvtopag ) + "'">>,"Opctrasmis" = <<"'" + this.FormatearTextoSql( lxComprobantevOpctrasmis ) + "'">>,"Fdescu" = <<lxComprobantevFdescu>>,"Merconsign" = <<iif( lxComprobantevMerconsign, 1, 0 )>>,"Md3" = <<lxComprobantevMd3>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Recpor" = <<lxComprobantevRecpor>>,"Mr" = <<lxComprobantevMr>>,"Mr2" = <<lxComprobantevMr2>>,"Md2" = <<lxComprobantevMd2>>,"Mr1" = <<lxComprobantevMr1>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Totrecarci" = <<lxComprobantevTotrecarci>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Chequer" = <<"'" + this.FormatearTextoSql( lxComprobantevChequer ) + "'">>,"Totimpue" = <<lxComprobantevTotimpue>>,"Cancelar" = <<iif( lxComprobantevCancelar, 1, 0 )>>,"Ivasis" = <<lxComprobantevIvasis>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 54 OR COMPROBANTEV.FACTTIPO = 1 OR COMPROBANTEV.FACTTIPO = 2 OR COMPROBANTEV.FACTTIPO = 27) << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Vtocai" as "Fechavtocai", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Opecomm" as "Nroopecommerce", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Despachos" as "Despachos", "Idajuste" as "Codigoajuste", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdaltafw" as "Basededatosaltafw", "Vmodifw" as "Versionmodificacionfw", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Cbautoimp" as "Codigobarraautoimpresor", "Simbmon" as "Simbolomonetariocomprobante", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Cai" as "Cai", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Fpodes2" as "Porcentajedescuento2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fajxre" as "Ajustesporredondeos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Facttipo" as "Tipocomprobante", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Codlista" as "Listadeprecios", "Fptoven" as "Puntodeventa", "Email" as "Email", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Chequer" as "Chequereintegro", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 54 OR COMPROBANTEV.FACTTIPO = 1 OR COMPROBANTEV.FACTTIPO = 2 OR COMPROBANTEV.FACTTIPO = 27)
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Idvalor" as "Iditemvalor", "Atrcabever" as "Atributocabecera", "Idpromo" as "Iditempromo", "Idarti" as "Iditemarticulo", "Nroitem" as "Nroitem", "Monto" as "Montobeneficio", "Codigo" as "Codigo" from ZooLogic.ProArtDet where CODIGO = <<"'" + this.FormatearTextoSql( c_FACTURAAGRUPADA.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Base" as "Basedecalculo", "Codimp" as "Codigoimpuesto", "Codint" as "Codigointerno", "Tipoi" as "Tipoimpuesto", "Sirecs" as "Codseguridadsire", "Descri" as "Descripcion", "Regimenimp" as "Regimenimpositivo", "Sirecert" as "Certificadosire", "Minimoper" as "Minimo", "Minoimp" as "Minimonoimponible", "Montobase" as "Montobase", "Nroitem" as "Nroitem", "Porcen" as "Porcentaje", "Monto" as "Monto", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_FACTURAAGRUPADA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Vtocai" as "Fechavtocai", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Opecomm" as "Nroopecommerce", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Despachos" as "Despachos", "Idajuste" as "Codigoajuste", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdaltafw" as "Basededatosaltafw", "Vmodifw" as "Versionmodificacionfw", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Cbautoimp" as "Codigobarraautoimpresor", "Simbmon" as "Simbolomonetariocomprobante", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Cai" as "Cai", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Fpodes2" as "Porcentajedescuento2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fajxre" as "Ajustesporredondeos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Facttipo" as "Tipocomprobante", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Codlista" as "Listadeprecios", "Fptoven" as "Puntodeventa", "Email" as "Email", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Chequer" as "Chequereintegro", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 54 OR COMPROBANTEV.FACTTIPO = 1 OR COMPROBANTEV.FACTTIPO = 2 OR COMPROBANTEV.FACTTIPO = 27) And FACTTIPO = <<lxCOMPROBANTEVFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFLETRA ) + "'">> and FPTOVEN = <<lxCOMPROBANTEVFPTOVEN>> and FNUMCOMP = <<lxCOMPROBANTEVFNUMCOMP>> and FACTSEC = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFACTSEC ) + "'">>
			endtext
			use in select('c_FACTURAAGRUPADA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FACTURAAGRUPADA', set( 'Datasession' ) )
			if reccount( 'c_FACTURAAGRUPADA' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Vtocai" as "Fechavtocai", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Informnube" as "Fueinformadoalanube", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Opecomm" as "Nroopecommerce", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Despachos" as "Despachos", "Idajuste" as "Codigoajuste", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Bdaltafw" as "Basededatosaltafw", "Vmodifw" as "Versionmodificacionfw", "Fhora" as "Hora", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Cbautoimp" as "Codigobarraautoimpresor", "Simbmon" as "Simbolomonetariocomprobante", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Cai" as "Cai", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Fpodes2" as "Porcentajedescuento2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Sitfisccli" as "Situacionfiscal", "Fsubtot" as "Subtotalbruto", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fajxre" as "Ajustesporredondeos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Facttipo" as "Tipocomprobante", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Senia" as "Senia", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fven" as "Vendedor", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Vtosenia" as "Fechavtosenia", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Codlista" as "Listadeprecios", "Fptoven" as "Puntodeventa", "Email" as "Email", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Direntr" as "Direccionentrega", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Entregapos" as "Entregaposterior", "Ffchvtopag" as "Fechavencimientomipyme", "Opctrasmis" as "Opciontransmisionmipyme", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Chequer" as "Chequereintegro", "Totimpue" as "Totalimpuestos", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  funciones.dtos( FAltaFW ) + funciones.padr( HAltaFW, 8, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 54 OR COMPROBANTEV.FACTTIPO = 1 OR COMPROBANTEV.FACTTIPO = 2 OR COMPROBANTEV.FACTTIPO = 27) order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_FACTURAAGRUPADA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FACTURAAGRUPADA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Vtocai,Fd2,Fmodifw,Informnube,Fcuit,Idcaja,Opecomm,Faltafw,Haltafw," + ;
"Despachos,Idajuste,Esttrans,Valtafw,Bdaltafw,Vmodifw,Fhora,Zadsfw,Descfw,Cbautoimp,Simbmon,Umodifw,H" + ;
"oraimpo,Hmodifw,Horaexpo,Smodifw,Bdmodifw,Saltafw,Ualtafw,Cai,Timestamp,Totalcant,Factsec,Mdcimpu,Fs" + ;
"ubton,Recmntosi2,Recmntosi,Recmntosi1,Fpodes2,Subtotcisi,Signomov,Condivalp,Subtotsisi,Sitfisccli,Fs" + ;
"ubtot,Desmntosi,Desmntosi1,Fajxre,Desmntosi2,Desmntosi3,Fcompfis,Anulado,Desaut,Facttipo,Idvuelto,Mo" + ;
"tdescdev,Monsis,Fobs,Fpodes1,Fperson,Fturno,Idsenia,Fmtdes2,Codigo,Senia,Md1,Fcliente,Fmtdes1,Recept" + ;
"or,Fven,Moneda,Fletra,Vtosenia,Trci,Totrecarsi,Codlista,Fptoven,Email,Fnumcomp,Ftotal,Tdci,Totdescsi" + ;
...
"otdesc,Chequer,Totimpue,Cancelar,Ivasis" + ;
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, VtoCAI = ] + "'" + this.ConvertirDateSql( &lcCursor..VtoCAI ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, InformNube = ] + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, Despachos = ] + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'"+ [, idAjuste = ] + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, CBAutoImp = ] + "'" + this.FormatearTextoSql( &lcCursor..CBAutoImp ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, CAI = ] + transform( &lcCursor..CAI )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, DESAUT = ] + Transform( iif( &lcCursor..DESAUT, 1, 0 ))+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, MotDescDev = ] + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, IDSenia = ] + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'"+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, Senia = ] + "'" + this.FormatearTextoSql( &lcCursor..Senia ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, Receptor = ] + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, vtosenia = ] + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'"+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, DirEntr = ] + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, FPago = ] + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'"+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, EntregaPos = ] + transform( &lcCursor..EntregaPos )+ [, FFCHVTOPAG = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCHVTOPAG ) + "'"+ [, OpcTrasmis = ] + "'" + this.FormatearTextoSql( &lcCursor..OpcTrasmis ) + "'"+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MerConsign = ] + Transform( iif( &lcCursor..MerConsign, 1, 0 ))+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, MR = ] + transform( &lcCursor..MR )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecarCI = ] + transform( &lcCursor..totrecarCI )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, ChequeR = ] + "'" + this.FormatearTextoSql( &lcCursor..ChequeR ) + "'"+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, Cancelar = ] + Transform( iif( &lcCursor..Cancelar, 1, 0 ))+ [, IvaSis = ] + transform( &lcCursor..IvaSis ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FECIMPO, VtoCAI, FD2, FMODIFW, InformNube, fCuit, IdCaja, OPEcomm, FAltaFW, HAltaFW, Despachos, idAjuste, ESTTRANS, VALTAFW, BDALTAFW, VMODIFW, FHORA, ZADSFW, DescFW, CBAutoImp, SimbMon, UMODIFW, HORAIMPO, HMODIFW, HORAEXPO, SMODIFW, BDMODIFW, SALTAFW, UALTAFW, CAI, TIMESTAMP, TotalCant, FACTSEC, MDCIMPU, fSubToN, RecMntoSI2, RecMntoSI, RecMntoSI1, FPODES2, SubTotCISI, signomov, CondivaLp, SubTotSISI, SitFiscCli, FSubTOT, DesMntoSI, DesMntoSI1, FAjXRe, DesMntoSI2, DesMntoSI3, FCOMPFIS, Anulado, DESAUT, FACTTIPO, idVuelto, MotDescDev, MonSis, FObs, FPODES1, FPerson, FTurno, IDSenia, FMTDES2, CODIGO, Senia, MD1, FCLIENTE, FMTDES1, Receptor, FVEN, Moneda, FLETRA, vtosenia, TRCI, totrecarSI, CodLista, FPTOVEN, Email, FNUMCOMP, FTotal, TDCI, totdescSI, DirEntr, FFCH, FMTDES3, Deuda, Cotiz, FPago, FPODES, RecMnto2, FVuelto, EntregaPos, FFCHVTOPAG, OpcTrasmis, fDescu, MerConsign, MD3, percepcion, RecMnto, RecPor, MR, MR2, MD2, MR1, RecMnto1, gravamen, fImpuesto, totrecarCI, totdesc, ChequeR, totimpue, Cancelar, IvaSis
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..VtoCAI ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..IdCaja ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBAutoImp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + transform( &lcCursor..CAI ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..TotalCant ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..MDCIMPU )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..SitFiscCli )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..DESAUT, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FACTTIPO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + transform( &lcCursor..FPODES1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FTurno ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'" + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Senia ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..FMTDES1 )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'" + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totrecarSI )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + transform( &lcCursor..FPTOVEN ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..TDCI ) + ',' + transform( &lcCursor..totdescSI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FMTDES3 ) + ',' + transform( &lcCursor..Deuda ) + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'" + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..EntregaPos ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCHVTOPAG ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..OpcTrasmis ) + "'" + ',' + transform( &lcCursor..fDescu ) + ',' + Transform( iif( &lcCursor..MerConsign, 1, 0 )) + ',' + transform( &lcCursor..MD3 ) + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..RecPor ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..MD2 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..totrecarCI ) + ',' + transform( &lcCursor..totdesc ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ChequeR ) + "'" + ',' + transform( &lcCursor..totimpue ) + ',' + Transform( iif( &lcCursor..Cancelar, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.VTOCAI = isnull( d.VTOCAI, t.VTOCAI ),t.FD2 = isnull( d.FD2, t.FD2 ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.INFORMNUBE = isnull( d.INFORMNUBE, t.INFORMNUBE ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.DESPACHOS = isnull( d.DESPACHOS, t.DESPACHOS ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.CBAUTOIMP = isnull( d.CBAUTOIMP, t.CBAUTOIMP ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.CAI = isnull( d.CAI, t.CAI ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.DESAUT = isnull( d.DESAUT, t.DESAUT ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.IDSENIA = isnull( d.IDSENIA, t.IDSENIA ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.SENIA = isnull( d.SENIA, t.SENIA ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.RECEPTOR = isnull( d.RECEPTOR, t.RECEPTOR ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.VTOSENIA = isnull( d.VTOSENIA, t.VTOSENIA ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.DIRENTR = isnull( d.DIRENTR, t.DIRENTR ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FPAGO = isnull( d.FPAGO, t.FPAGO ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.FFCHVTOPAG = isnull( d.FFCHVTOPAG, t.FFCHVTOPAG ),t.OPCTRASMIS = isnull( d.OPCTRASMIS, t.OPCTRASMIS ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MERCONSIGN = isnull( d.MERCONSIGN, t.MERCONSIGN ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.MR = isnull( d.MR, t.MR ),t.MR2 = isnull( d.MR2, t.MR2 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECARCI = isnull( d.TOTRECARCI, t.TOTRECARCI ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.CHEQUER = isnull( d.CHEQUER, t.CHEQUER ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.CANCELAR = isnull( d.CANCELAR, t.CANCELAR ),t.IVASIS = isnull( d.IVASIS, t.IVASIS )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fecexpo,Fectrans,Fecimpo,Vtocai,Fd2,Fmodifw,Informnube,Fcuit,Idcaja,Opecomm,Faltafw,Haltafw,Despachos,Idajuste,Esttrans,Valtafw,Bdaltafw,Vmodifw,Fhora,Zadsfw,Descfw,Cbautoimp,Simbmon,Umodifw,Horaimpo,Hmodifw,Horaexpo,Smodifw,Bdmodifw,Saltafw,Ualtafw,Cai,Timestamp,Totalcant,Factsec,Mdcimpu,Fsubton,Recmntosi2,Recmntosi,Recmntosi1,Fpodes2,Subtotcisi,Signomov,Condivalp,Subtotsisi,Sitfisccli,Fsubtot,Desmntosi,Desmntosi1,Fajxre,Desmntosi2,Desmntosi3,Fcompfis,Anulado,Desaut,Facttipo,Idvuelto,Motdescdev,Monsis,Fobs,Fpodes1,Fperson,Fturno,Idsenia,Fmtdes2,Codigo,Senia,Md1,Fcliente,Fmtdes1,Receptor,Fven,Moneda,Fletra,Vtosenia,Trci,Totrecarsi,Codlista,Fptoven,Email,Fnumcomp,Ftotal,Tdci,Totdescsi,Direntr,Ffch,Fmtdes3,Deuda,Cotiz,Fpago,Fpodes,Recmnto2,Fvuelto,Entregapos,Ffchvtopag,Opctrasmis,Fdescu,Merconsign,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Recmnto1,Gravamen,Fimpuesto,Totrecarci,Totdesc,Chequer,Totimpue,Cancelar,Ivasis)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.VTOCAI,''),isnull( d.FD2,''),isnull( d.FMODIFW,''),isnull( d.INFORMNUBE,''),isnull( d.FCUIT,''),isnull( d.IDCAJA,0),isnull( d.OPECOMM,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),convert( char(8), getdate(), 108 ),isnull( d.DESPACHOS,''),isnull( d.IDAJUSTE,''),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.VMODIFW,''),isnull( d.FHORA,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.CBAUTOIMP,''),isnull( d.SIMBMON,''),isnull( d.UMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.SMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.CAI,0),isnull( d.TIMESTAMP,0),isnull( d.TOTALCANT,0),isnull( d.FACTSEC,''),isnull( d.MDCIMPU,0),isnull( d.FSUBTON,0),isnull( d.RECMNTOSI2,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTOSI1,0),isnull( d.FPODES2,0),isnull( d.SUBTOTCISI,0),isnull( d.SIGNOMOV,0),isnull( d.CONDIVALP,0),isnull( d.SUBTOTSISI,0),isnull( d.SITFISCCLI,0),isnull( d.FSUBTOT,0),isnull( d.DESMNTOSI,0),isnull( d.DESMNTOSI1,0),isnull( d.FAJXRE,0),isnull( d.DESMNTOSI2,0),isnull( d.DESMNTOSI3,0),isnull( d.FCOMPFIS,0),isnull( d.ANULADO,0),isnull( d.DESAUT,0),isnull( d.FACTTIPO,0),isnull( d.IDVUELTO,''),isnull( d.MOTDESCDEV,''),isnull( d.MONSIS,''),isnull( d.FOBS,''),isnull( d.FPODES1,0),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.IDSENIA,''),isnull( d.FMTDES2,0),isnull( d.CODIGO,''),isnull( d.SENIA,''),isnull( d.MD1,0),isnull( d.FCLIENTE,''),isnull( d.FMTDES1,0),isnull( d.RECEPTOR,''),isnull( d.FVEN,''),isnull( d.MONEDA,''),isnull( d.FLETRA,''),isnull( d.VTOSENIA,''),isnull( d.TRCI,0),isnull( d.TOTRECARSI,0),isnull( d.CODLISTA,''),isnull( d.FPTOVEN,0),isnull( d.EMAIL,''),isnull( d.FNUMCOMP,0),isnull( d.FTOTAL,0),isnull( d.TDCI,0),isnull( d.TOTDESCSI,0),isnull( d.DIRENTR,''),isnull( d.FFCH,''),isnull( d.FMTDES3,0),isnull( d.DEUDA,0),isnull( d.COTIZ,0),isnull( d.FPAGO,''),isnull( d.FPODES,0),isnull( d.RECMNTO2,0),isnull( d.FVUELTO,0),isnull( d.ENTREGAPOS,0),isnull( d.FFCHVTOPAG,''),isnull( d.OPCTRASMIS,''),isnull( d.FDESCU,0),isnull( d.MERCONSIGN,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.RECMNTO,0),isnull( d.RECPOR,0),isnull( d.MR,0),isnull( d.MR2,0),isnull( d.MD2,0),isnull( d.MR1,0),isnull( d.RECMNTO1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECARCI,0),isnull( d.TOTDESC,0),isnull( d.CHEQUER,''),isnull( d.TOTIMPUE,0),isnull( d.CANCELAR,0),isnull( d.IVASIS,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="FECHATRANSFERENCIA                      " tabla="COMPROBANTEV   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="NROOPECOMMERCE                          " tabla="COMPROBANTEV   " campo="OPECOMM   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Nro. op. ecommerce                                                                                                                                                                                                                                        " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPROBANTEV   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="COMPROBANTEV   " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                                                                                                                     " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="VUELTO                                  " tabla="COMPROBANTEV   " campo="FVUELTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vuelto persistido                                                                                                                                                                                                                                         " dominio="VUELTO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="10" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECARCI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos total                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FACTURAAGRUPADA                         " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuentos                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="28" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FACTURAAGRUPADA                         " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="458" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
