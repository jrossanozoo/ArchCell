...
define class Mock_Itemmodificaciondecostosdeproduccionmodcostos as MockBase of MockBase.prg

	cClase = 'Itemmodificaciondecostosdeproduccionmodcostos'
	...
	*-----------------------------------------------------------------------------------------
	function costoactualizado_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Costoactualizado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function costodelista_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Costodelista_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompcostosproduccion_access() as variant                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Ocompcostosproduccion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesodetalle_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Procesodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function semielaborado_access() as variant                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Semielaborado_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function semielaborado_pk_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Semielaborado_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function semielaboradodetalle_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Semielaboradodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_costoactualizado( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_costoactualizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_costodelista( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_costodelista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_procesodetalle( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_procesodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_semielaborado( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_semielaborado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_semielaboradodetalle( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_semielaboradodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tallerdetalle( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_tallerdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tallerdetalle_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Tallerdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_costoactualizado( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_costoactualizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_costodelista( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_costodelista', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_procesodetalle( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_procesodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_semielaborado( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_semielaborado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_semielaboradodetalle( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_semielaboradodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tallerdetalle( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_tallerdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwdesdecantidad() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwdesdecantidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarfiltroseguncurvaeninsumo() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ajustarfiltroseguncurvaeninsumo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarfiltroseguncurvaenmodelo() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ajustarfiltroseguncurvaenmodelo', lcParametros )
	EndFunc
