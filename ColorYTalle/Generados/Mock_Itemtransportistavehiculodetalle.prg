...
define class Mock_Itemtransportistavehiculodetalle as MockBase of MockBase.prg

	cClase = 'Itemtransportistavehiculodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function dominio_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Dominio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_dominio( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_dominio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipovehiculo( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_tipovehiculo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipovehiculo_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Tipovehiculo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_dominio( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_dominio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipovehiculo( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_tipovehiculo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodominio() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridodominio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipovehiculo() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridotipovehiculo', lcParametros )
	EndFunc
