...
define class Mock_Detallerequerimientodecomprafacturadetalle as MockBase of MockBase.prg

	cClase = 'Detallerequerimientodecomprafacturadetalle'
	...
	cCopiadorDeDetalle = "CopiadorDeDetallesArticulosCompra"                                                                                                                                                                                                  
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Artículos'                                                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function completardatoscomplementariosdeprepantalla( toitemaux as itemauxiliar of din_detallefacturadecomprafacturadetalle.prg ) as void                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosub_monto() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocambiosub_monto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sum_monto_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Sum_monto_assign', lcParametros )
	EndFunc
