...
define class Din_EntidadCONVERSIONVALORESAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxConvervalFecexpo, lxConvervalFmodifw, lxConvervalFecimpo, lxConvervalFaltafw, lxConvervalFectrans, lxConvervalSmodifw, lxConvervalHmodifw, lxConvervalSaltafw, lxConvervalUaltafw, lxConvervalUmodifw, lxConvervalZadsfw, lxConvervalValtafw, lxConvervalVmodifw, lxConvervalHoraimpo, lxConvervalHoraexpo, lxConvervalBdaltafw, lxConvervalEsttrans, lxConvervalBdmodifw, lxConvervalHaltafw, lxConvervalTimestamp, lxConvervalBloqreg, lxConvervalCobs, lxConvervalCodigo, lxConvervalConversion, lxConvervalValorig, lxConvervalValdest, lxConvervalBasedatos
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.CONVERVAL ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Hmodifw","Saltafw","Ualtafw","Umodifw","Zadsfw","Valtafw","Vmodifw","Horaimpo","Horaexpo","Bdaltafw","Esttrans","Bdmodifw","Haltafw","Timestamp","Bloqreg","Cobs","Codigo","Conversion","Valorig","Valdest","Basedatos" ) values ( <<"'" + this.ConvertirDateSql( lxConvervalFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConvervalFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConvervalFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConvervalFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConvervalFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalHaltafw ) + "'" >>, <<lxConvervalTimestamp >>, <<iif( lxConvervalBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxConvervalCobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalConversion ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalValorig ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalValdest ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConvervalBasedatos ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.CONVERVAL set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxConvervalFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxConvervalFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxConvervalFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxConvervalFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxConvervalFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxConvervalSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxConvervalHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxConvervalSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxConvervalUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxConvervalUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxConvervalZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxConvervalValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxConvervalVmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxConvervalHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxConvervalHoraexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxConvervalBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxConvervalEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxConvervalBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxConvervalHaltafw ) + "'">>,"Timestamp" = <<lxConvervalTimestamp>>,"Bloqreg" = <<iif( lxConvervalBloqreg, 1, 0 )>>,"Cobs" = <<"'" + this.FormatearTextoSql( lxConvervalCobs ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxConvervalCodigo ) + "'">>,"Conversion" = <<"'" + this.FormatearTextoSql( lxConvervalConversion ) + "'">>,"Valorig" = <<"'" + this.FormatearTextoSql( lxConvervalValorig ) + "'">>,"Valdest" = <<"'" + this.FormatearTextoSql( lxConvervalValdest ) + "'">>,"Basedatos" = <<"'" + this.FormatearTextoSql( lxConvervalBasedatos ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxConvervalCodigo ) + "'">> and  CONVERVAL.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
...
"afw,Vmodifw,Horaimpo,Horaexpo,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Timestamp,Bloqreg,Cobs,Codigo,Conve" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, HMODIFW, SALTAFW, UALTAFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HORAIMPO, HORAEXPO, BDALTAFW, ESTTRANS, BDMODIFW, HALTAFW, TIMESTAMP, BLOQREG, cObs, codigo, Conversion, valOrig, valDest, basedatos
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))
	...
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			Begin
				...
				-- Fin Updates
				insert into ORGANIZACION.CONVERVAL(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Valtafw,Vmodifw,Horaimpo,Horaexpo,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Timestamp,Bloqreg,Cobs,Codigo,Conversion,Valorig,Valdest,Basedatos)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.COBS,''),isnull( d.CODIGO,''),isnull( d.CONVERSION,''),isnull( d.VALORIG,''),isnull( d.VALDEST,''),isnull( d.BASEDATOS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CONVERSIONVALORES                       " atributo="FECHATRANSFERENCIA                      " tabla="CONVERVAL      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONVERSIONVALORES                       " atributo="ESTADOTRANSFERENCIA                     " tabla="CONVERVAL      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONVERSIONVALORES                       " atributo="OBS                                     " tabla="CONVERVAL      " campo="COBS      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONVERSIONVALORES                       " atributo="BASEDEDATOS                             " tabla="CONVERVAL      " campo="BASEDATOS " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="23" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Base de datos para conversión                                                                                                                                   " dominio="COMBOSUCYAGRUCONVACIO         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="3" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
