...
define class Din_EntidadSELECCIONOPERACIONECOMMERCE as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Talle_Desde() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Talle_Desde_PK )
		else
			If this.Item_Talle_Desde.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Talle_Desde_PK ))+ ' de la entidad ' +  upper( this.Item_Talle_Desde.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Talle_Hasta() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Talle_Hasta_PK )
		else
			If this.Item_Talle_Hasta.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Talle_Hasta_PK ))+ ' de la entidad ' +  upper( this.Item_Talle_Hasta.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	function ValidarItem_Articulo_Proveedor_Desde() as boolean
		...
		if empty( this.Item_Articulo_Proveedor_Desde_PK )
			...
			If this.Item_Articulo_Proveedor_Desde.oAD.ConsultarPorClavePrimaria()
				This.Item_Articulo_Proveedor_Desde.oDesactivador.ValidarEstadoActivacion( this.Item_Articulo_Proveedor_Desde_PK , goLibrerias.Valorvacioseguntipo( vartype(this.Item_Articulo_Proveedor_Desde_PK ) ), this.lnuevo, this.ledicion )
			Else
	...
	function ValidarItem_Articulo_Proveedor_Hasta() as boolean
		...
		if empty( this.Item_Articulo_Proveedor_Hasta_PK )
			...
			If this.Item_Articulo_Proveedor_Hasta.oAD.ConsultarPorClavePrimaria()
				This.Item_Articulo_Proveedor_Hasta.oDesactivador.ValidarEstadoActivacion( this.Item_Articulo_Proveedor_Hasta_PK , goLibrerias.Valorvacioseguntipo( vartype(this.Item_Articulo_Proveedor_Hasta_PK ) ), this.lnuevo, this.ledicion )
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Articulo_Temporada_Desde() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Articulo_Temporada_Desde_PK )
		else
			If this.Item_Articulo_Temporada_Desde.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Articulo_Temporada_Desde_PK ))+ ' de la entidad ' +  upper( this.Item_Articulo_Temporada_Desde.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Articulo_Temporada_Hasta() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Articulo_Temporada_Hasta_PK )
		else
			If this.Item_Articulo_Temporada_Hasta.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Articulo_Temporada_Hasta_PK ))+ ' de la entidad ' +  upper( this.Item_Articulo_Temporada_Hasta.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Articulo_Familia_Desde() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Articulo_Familia_Desde_PK )
		else
			If this.Item_Articulo_Familia_Desde.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Articulo_Familia_Desde_PK ))+ ' de la entidad ' +  upper( this.Item_Articulo_Familia_Desde.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Articulo_Familia_Hasta() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Articulo_Familia_Hasta_PK )
		else
			If this.Item_Articulo_Familia_Hasta.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Articulo_Familia_Hasta_PK ))+ ' de la entidad ' +  upper( this.Item_Articulo_Familia_Hasta.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Articulo_Linea_Desde() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Articulo_Linea_Desde_PK )
		else
			If this.Item_Articulo_Linea_Desde.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Articulo_Linea_Desde_PK ))+ ' de la entidad ' +  upper( this.Item_Articulo_Linea_Desde.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarItem_Articulo_Linea_Hasta() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.Item_Articulo_Linea_Hasta_PK )
		else
			If this.Item_Articulo_Linea_Hasta.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.Item_Articulo_Linea_Hasta_PK ))+ ' de la entidad ' +  upper( this.Item_Articulo_Linea_Hasta.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as Void
		...
		this.oColeccionVSFW.agregar('.ValorSugeridoFWItem_talle_hasta()','Item_talle_hasta')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWItem_articulo_proveedor_hasta()','Item_articulo_proveedor_hasta')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWItem_articulo_temporada_hasta()','Item_articulo_temporada_hasta')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWItem_articulo_ano_hasta()','Item_articulo_ano_hasta')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWItem_articulo_familia_hasta()','Item_articulo_familia_hasta')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWItem_articulo_material_hasta()','Item_articulo_material_hasta')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWItem_articulo_linea_hasta()','Item_articulo_linea_hasta')
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_talle_desde() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_talle_desde" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_talle_desde_PK' )
						.Item_talle_desde_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_talle_desde.CODIGO = .Item_talle_desde_PK
					endif
				endif
			Catch to loError
				.Item_talle_desde_PK=[]
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_talle_hasta() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_talle_hasta" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_talle_hasta_PK' )
						.Item_talle_hasta_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_talle_hasta.CODIGO = .Item_talle_hasta_PK
					endif
				else
					.ValorSugeridoFWItem_talle_hasta()
				endif
			Catch to loError
				.Item_talle_hasta_PK=[]
				loEx = newobject("zooexception", "zooexception.prg" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_articulo_temporada_desde() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_articulo_temporada_desde" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_articulo_temporada_desde_PK' )
						.Item_articulo_temporada_desde_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_articulo_temporada_desde.CODIGO = .Item_articulo_temporada_desde_PK
					endif
				endif
			Catch to loError
				.Item_articulo_temporada_desde_PK=[]
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_articulo_temporada_hasta() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_articulo_temporada_hasta" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_articulo_temporada_hasta_PK' )
						.Item_articulo_temporada_hasta_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_articulo_temporada_hasta.CODIGO = .Item_articulo_temporada_hasta_PK
					endif
				else
					.ValorSugeridoFWItem_articulo_temporada_hasta()
				endif
			Catch to loError
				.Item_articulo_temporada_hasta_PK=[]
				loEx = newobject("zooexception", "zooexception.prg" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWItem_articulo_temporada_hasta() as void
		with this
			try
				.Item_articulo_temporada_hasta_PK = 'ZZZZZ'
			Catch to loError
				.Item_articulo_temporada_hasta_PK=[]
				loEx = newobject("zooexception", "zooexception.prg" )
				loEx.Grabar( loError )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_articulo_familia_desde() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_articulo_familia_desde" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_articulo_familia_desde_PK' )
						.Item_articulo_familia_desde_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_articulo_familia_desde.CODIGO = .Item_articulo_familia_desde_PK
					endif
				endif
			Catch to loError
				.Item_articulo_familia_desde_PK=[]
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_articulo_familia_hasta() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_articulo_familia_hasta" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_articulo_familia_hasta_PK' )
						.Item_articulo_familia_hasta_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_articulo_familia_hasta.CODIGO = .Item_articulo_familia_hasta_PK
					endif
				else
					.ValorSugeridoFWItem_articulo_familia_hasta()
				endif
			Catch to loError
				.Item_articulo_familia_hasta_PK=[]
				loEx = newobject("zooexception", "zooexception.prg" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWItem_articulo_familia_hasta() as void
		with this
			try
				.Item_articulo_familia_hasta_PK = 'ZZZZZZZZZZ'
			Catch to loError
				.Item_articulo_familia_hasta_PK=[]
				loEx = newobject("zooexception", "zooexception.prg" )
				loEx.Grabar( loError )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_articulo_linea_desde() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_articulo_linea_desde" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_articulo_linea_desde_PK' )
						.Item_articulo_linea_desde_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_articulo_linea_desde.CODIGO = .Item_articulo_linea_desde_PK
					endif
				endif
			Catch to loError
				.Item_articulo_linea_desde_PK=[]
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoItem_articulo_linea_hasta() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "SELECCIONOPERACIONECOMMERCE", "", "Item_articulo_linea_hasta" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
						...
						This.EventoEstaSeteandoValorSugerido( 'Item_articulo_linea_hasta_PK' )
						.Item_articulo_linea_hasta_PK = lvValorSugeridoDefinidoPorElUsuario
						.Item_articulo_linea_hasta.CODIGO = .Item_articulo_linea_hasta_PK
					endif
				else
					.ValorSugeridoFWItem_articulo_linea_hasta()
				endif
			Catch to loError
				.Item_articulo_linea_hasta_PK=[]
				loEx = newobject("zooexception", "zooexception.prg" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWItem_articulo_linea_hasta() as void
		with this
			try
				.Item_articulo_linea_hasta_PK = 'ZZZZZZZZZZ'
			Catch to loError
				.Item_articulo_linea_hasta_PK=[]
				loEx = newobject("zooexception", "zooexception.prg" )
				loEx.Grabar( loError )
