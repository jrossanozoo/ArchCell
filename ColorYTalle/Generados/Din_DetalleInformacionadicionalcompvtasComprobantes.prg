...
define class Din_DetalleINFORMACIONADICIONALCOMPVTASComprobantes as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemINFORMACIONADICIONALCOMPVTASComprobantes' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		scan for &lcFiltro
			...
			loItem.Codigo = c_Comprobantes.Codigo
			loItem.TipoComprobante = c_Comprobantes.TipoComprobante
			loItem.NROITEM = c_Comprobantes.NROITEM
			loItem.TipoCompCaracter = c_Comprobantes.TipoCompCaracter
			loItem.Letra = c_Comprobantes.Letra
			loItem.PuntoDeVenta = c_Comprobantes.PuntoDeVenta
			loItem.Numero = c_Comprobantes.Numero
			loItem.Fecha = goLibrerias.ObtenerFechaFormateada( c_Comprobantes.Fecha )
			loItem.Total = c_Comprobantes.Total
			loItem.Vendedor = c_Comprobantes.Vendedor
			loItem.Tipo = c_Comprobantes.Tipo
			loItem.Afecta = c_Comprobantes.Afecta
			loItem.Interviniente = c_Comprobantes.Interviniente
			loItem.NombreEntidad = c_Comprobantes.NombreEntidad
			loItem.CodigoEntidad = c_Comprobantes.CodigoEntidad
			loItem.Origen = c_Comprobantes.Origen
			loItem.NroItem = lnI 
