...
define class Din_EntidadAdt_proveedor_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Adt_proveedor"
	cClaseResponse = this.cNamespaceDTOs + ".Adt_proveedorResponse"
	cClaseModelo = "Adt_proveedorModelo"
	cEntidad = "Adt_proveedor"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_proveedorModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_proveedorListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_proveedorListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "Adt_proveedorModelo"
		endcase
		return lcRetorno
