...
define class Mock_procesarncpendientepromobanco as MockBase of MockBase.prg
	...
	cClase = 'procesarncpendientepromobanco'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Herramienta de generación de NC por promociones bancarias"                                                                                                                                                                               
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecuponespendientes() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallecuponespendientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cuponespendientes_access() as variant                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'PROCESARNCPENDIENTEPROMOBANCO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cuponespendientes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cuponespendientes_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Cuponespendientes ) = 'O' or isnull( this.Cuponespendientes ) )			this.Cuponespendientes = this.crearobjeto( 'Din_DetalleProcesarncpendientepromobancoCuponespendientes' )			this.Cuponespendientes.inicializar()			this.enlazar( 'Cuponespendientes.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Cuponespendientes.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Cuponespendientes, 'CambioSumarizado', this, 'CambiosDetalleCuponespendientes', 1)			this.enlazar( 'Cuponespendientes.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Cuponespendientes.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Cuponespendientes
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorefrescardetalle( tcgrilla as string ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function generarnotasdecredito() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarnotasdecredito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercuponespendientes() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcuponespendientes() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarcuponespendientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarinformacionalogdeoperaciones() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Agregarinformacionalogdeoperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersentencia() as string                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
