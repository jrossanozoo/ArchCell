	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.IMPOAGRUP ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Hmodifw","Saltafw","Ualtafw","Umodifw","Zadsfw","Valtafw","Vmodifw","Bdaltafw","Horaimpo","Esttrans","Bdmodifw","Horaexpo","Haltafw","Timestamp","Bloqreg","Clasehook","Cobs","Codigo","Cdes" ) values ( <<"'" + this.ConvertirDateSql( lxImpoagrupFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpoagrupFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpoagrupFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpoagrupFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpoagrupFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupHaltafw ) + "'" >>, <<lxImpoagrupTimestamp >>, <<iif( lxImpoagrupBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxImpoagrupClasehook ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupCobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpoagrupCdes ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.IMPOAGRUP set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxImpoagrupFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxImpoagrupFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxImpoagrupFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxImpoagrupFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxImpoagrupFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxImpoagrupZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupVmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupBdaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxImpoagrupHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxImpoagrupEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxImpoagrupHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupHaltafw ) + "'">>,"Timestamp" = <<lxImpoagrupTimestamp>>,"Bloqreg" = <<iif( lxImpoagrupBloqreg, 1, 0 )>>,"Clasehook" = <<"'" + this.FormatearTextoSql( lxImpoagrupClasehook ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxImpoagrupCobs ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxImpoagrupCodigo ) + "'">>,"Cdes" = <<"'" + this.FormatearTextoSql( lxImpoagrupCdes ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxImpoagrupCodigo ) + "'">> and  IMPOAGRUP.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Codigo" as "Codigo", "Cdes" as "Descripcion" from ORGANIZACION.IMPOAGRUP where  IMPOAGRUP.CODIGO != '' And clasehook = <<"'" + this.FormatearTextoSql( lxImpoAgrupclasehook ) + "'">>
			endtext
			use in select('c_IMPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPOAGRUPADAS', set( 'Datasession' ) )
			if reccount( 'c_IMPOAGRUPADAS' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Codigo" as "Codigo", "Cdes" as "Descripcion" from ORGANIZACION.IMPOAGRUP where  IMPOAGRUP.CODIGO != '' order by clasehook
			endtext
			use in select('c_IMPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Codigo" as "Codigo", "Cdes" as "Descripcion" from ORGANIZACION.IMPOAGRUP where  funciones.padr( clasehook, 100, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPOAGRUP.CODIGO != '' order by clasehook
			endtext
			use in select('c_IMPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Codigo" as "Codigo", "Cdes" as "Descripcion" from ORGANIZACION.IMPOAGRUP where  funciones.padr( clasehook, 100, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPOAGRUP.CODIGO != '' order by clasehook desc
			endtext
			use in select('c_IMPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Codigo" as "Codigo", "Cdes" as "Descripcion" from ORGANIZACION.IMPOAGRUP where  IMPOAGRUP.CODIGO != '' order by clasehook desc
			endtext
			use in select('c_IMPOAGRUPADAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPOAGRUPADAS', set( 'Datasession' ) )
			local lcSentencia as string
...
"afw,Vmodifw,Bdaltafw,Horaimpo,Esttrans,Bdmodifw,Horaexpo,Haltafw,Timestamp,Bloqreg,Clasehook,Cobs,Co" + ;
"digo,Cdes" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Clasehook" as "Clasehook", "Cobs" as "Obs", "Codigo" as "Codigo", "Cdes" as "Descripcion"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.IMPOAGRUP set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxImpoagrupFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxImpoagrupFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxImpoagrupFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxImpoagrupFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxImpoagrupFectrans ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupHmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupUaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxImpoagrupZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupVmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupBdaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxImpoagrupHoraimpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxImpoagrupEsttrans ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxImpoagrupBdmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxImpoagrupHoraexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxImpoagrupHaltafw ) + "'">>, "Timestamp" = <<lxImpoagrupTimestamp>>, "Bloqreg" = <<iif( lxImpoagrupBloqreg, 1, 0 )>>, "Clasehook" = <<"'" + this.FormatearTextoSql( lxImpoagrupClasehook ) + "'">>, "Cobs" = <<"'" + this.FormatearTextoSql( lxImpoagrupCobs ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxImpoagrupCodigo ) + "'">>, "Cdes" = <<"'" + this.FormatearTextoSql( lxImpoagrupCdes ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'IMPOAGRUP' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, HMODIFW, SALTAFW, UALTAFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, BDALTAFW, HORAIMPO, ESTTRANS, BDMODIFW, HORAEXPO, HALTAFW, TIMESTAMP, BLOQREG, clasehook, cObs, Codigo, cDes
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..clasehook ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.CLASEHOOK = isnull( d.CLASEHOOK, t.CLASEHOOK ),t.COBS = isnull( d.COBS, t.COBS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.CDES = isnull( d.CDES, t.CDES )
					from ORGANIZACION.IMPOAGRUP t inner join deleted d 
							 on t.Codigo = d.Codigo
							 and  t.clasehook = d.clasehook
				-- Fin Updates
				insert into ORGANIZACION.IMPOAGRUP(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Valtafw,Vmodifw,Bdaltafw,Horaimpo,Esttrans,Bdmodifw,Horaexpo,Haltafw,Timestamp,Bloqreg,Clasehook,Cobs,Codigo,Cdes)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.CLASEHOOK,''),isnull( d.COBS,''),isnull( d.CODIGO,''),isnull( d.CDES,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_IMPOAGRUPADAS' ) < 1
				...
				Try
					...
					.Descripcion = nvl( c_IMPOAGRUPADAS.Descripcion, [] )
					.Disenos.Limpiar()
...
<VFPData xml:space="preserve">
	...
	<row entidad="IMPOAGRUPADAS                           " atributo="FECHATRANSFERENCIA                      " tabla="IMPOAGRUP      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPOAGRUPADAS                           " atributo="ESTADOTRANSFERENCIA                     " tabla="IMPOAGRUP      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPOAGRUPADAS                           " atributo="OBS                                     " tabla="IMPOAGRUP      " campo="COBS      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPOAGRUPADAS                           " atributo="DESCRIPCION                             " tabla="IMPOAGRUP      " campo="CDES      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="1" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
