...
define class Din_EntidadREGISTROLIQUIDACIONCONSIGNACIONESAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRegconsignacionFmodifw, lxRegconsignacionFectrans, lxRegconsignacionFecimpo, lxRegconsignacionFecexpo, lxRegconsignacionFaltafw, lxRegconsignacionHaltafw, lxRegconsignacionEsttrans, lxRegconsignacionBdmodifw, lxRegconsignacionHoraexpo, lxRegconsignacionHoraimpo, lxRegconsignacionValtafw, lxRegconsignacionZadsfw, lxRegconsignacionVmodifw, lxRegconsignacionUmodifw, lxRegconsignacionUaltafw, lxRegconsignacionHmodifw, lxRegconsignacionSmodifw, lxRegconsignacionSaltafw, lxRegconsignacionBdaltafw, lxRegconsignacionCodigo, lxRegconsignacionBliquida, lxRegconsignacionBliquidada, lxRegconsignacionIditemliq, lxRegconsignacionFart, lxRegconsignacionCcolor, lxRegconsignacionTalle, lxRegconsignacionAfecant, lxRegconsignacionCantidad, lxRegconsignacionMovtipo, lxRegconsignacionMovdesc, lxRegconsignacionCompcodigo, lxRegconsignacionLiqdesc, lxRegconsignacionLiqcodigo, lxRegconsignacionLiqcant, lxRegconsignacionLiqiditem, lxRegconsignacionConsigcod, lxRegconsignacionConsigdesc, lxRegconsignacionRemafecod, lxRegconsignacionAnulado
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.REGCONSIGNACION ( "Fmodifw","Fectrans","Fecimpo","Fecexpo","Faltafw","Haltafw","Esttrans","Bdmodifw","Horaexpo","Horaimpo","Valtafw","Zadsfw","Vmodifw","Umodifw","Ualtafw","Hmodifw","Smodifw","Saltafw","Bdaltafw","Codigo","Bliquida","Bliquidada","Iditemliq","Fart","Ccolor","Talle","Afecant","Cantidad","Movtipo","Movdesc","Compcodigo","Liqdesc","Liqcodigo","Liqcant","Liqiditem","Consigcod","Consigdesc","Remafecod","Anulado" ) values ( <<"'" + this.ConvertirDateSql( lxRegconsignacionFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegconsignacionFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegconsignacionFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegconsignacionFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegconsignacionFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionBliquida ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionBliquidada ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionIditemliq ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionFart ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionCcolor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionTalle ) + "'" >>, <<lxRegconsignacionAfecant >>, <<lxRegconsignacionCantidad >>, <<lxRegconsignacionMovtipo >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionMovdesc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionCompcodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionLiqdesc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionLiqcodigo ) + "'" >>, <<lxRegconsignacionLiqcant >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionLiqiditem ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionConsigcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionConsigdesc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegconsignacionRemafecod ) + "'" >>, <<iif( lxRegconsignacionAnulado, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.REGCONSIGNACION set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxRegconsignacionFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRegconsignacionFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxRegconsignacionFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxRegconsignacionFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRegconsignacionFaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRegconsignacionEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRegconsignacionHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRegconsignacionHoraimpo ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionSaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRegconsignacionBdaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxRegconsignacionCodigo ) + "'">>,"Bliquida" = <<"'" + this.FormatearTextoSql( lxRegconsignacionBliquida ) + "'">>,"Bliquidada" = <<"'" + this.FormatearTextoSql( lxRegconsignacionBliquidada ) + "'">>,"Iditemliq" = <<"'" + this.FormatearTextoSql( lxRegconsignacionIditemliq ) + "'">>,"Fart" = <<"'" + this.FormatearTextoSql( lxRegconsignacionFart ) + "'">>,"Ccolor" = <<"'" + this.FormatearTextoSql( lxRegconsignacionCcolor ) + "'">>,"Talle" = <<"'" + this.FormatearTextoSql( lxRegconsignacionTalle ) + "'">>,"Afecant" = <<lxRegconsignacionAfecant>>,"Cantidad" = <<lxRegconsignacionCantidad>>,"Movtipo" = <<lxRegconsignacionMovtipo>>,"Movdesc" = <<"'" + this.FormatearTextoSql( lxRegconsignacionMovdesc ) + "'">>,"Compcodigo" = <<"'" + this.FormatearTextoSql( lxRegconsignacionCompcodigo ) + "'">>,"Liqdesc" = <<"'" + this.FormatearTextoSql( lxRegconsignacionLiqdesc ) + "'">>,"Liqcodigo" = <<"'" + this.FormatearTextoSql( lxRegconsignacionLiqcodigo ) + "'">>,"Liqcant" = <<lxRegconsignacionLiqcant>>,"Liqiditem" = <<"'" + this.FormatearTextoSql( lxRegconsignacionLiqiditem ) + "'">>,"Consigcod" = <<"'" + this.FormatearTextoSql( lxRegconsignacionConsigcod ) + "'">>,"Consigdesc" = <<"'" + this.FormatearTextoSql( lxRegconsignacionConsigdesc ) + "'">>,"Remafecod" = <<"'" + this.FormatearTextoSql( lxRegconsignacionRemafecod ) + "'">>,"Anulado" = <<iif( lxRegconsignacionAnulado, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxRegconsignacionCodigo ) + "'">> and  REGCONSIGNACION.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Haltafw,Esttrans,Bdmodifw,Horaexpo,Horaimpo,Valtafw" + ;
",Zadsfw,Vmodifw,Umodifw,Ualtafw,Hmodifw,Smodifw,Saltafw,Bdaltafw,Codigo,Bliquida,Bliquidada,Iditemli" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.REGCONSIGNACION set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, BLiquida = ] + "'" + this.FormatearTextoSql( &lcCursor..BLiquida ) + "'"+ [, BLiquidada = ] + "'" + this.FormatearTextoSql( &lcCursor..BLiquidada ) + "'"+ [, IdItemLiq = ] + "'" + this.FormatearTextoSql( &lcCursor..IdItemLiq ) + "'"+ [, FART = ] + "'" + this.FormatearTextoSql( &lcCursor..FART ) + "'"+ [, CCOLOR = ] + "'" + this.FormatearTextoSql( &lcCursor..CCOLOR ) + "'"+ [, TALLE = ] + "'" + this.FormatearTextoSql( &lcCursor..TALLE ) + "'"+ [, AfeCant = ] + transform( &lcCursor..AfeCant )+ [, Cantidad = ] + transform( &lcCursor..Cantidad )+ [, MovTipo = ] + transform( &lcCursor..MovTipo )+ [, MovDesc = ] + "'" + this.FormatearTextoSql( &lcCursor..MovDesc ) + "'"+ [, CompCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..CompCodigo ) + "'"+ [, LiqDesc = ] + "'" + this.FormatearTextoSql( &lcCursor..LiqDesc ) + "'"+ [, LiqCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..LiqCodigo ) + "'"+ [, LiqCant = ] + transform( &lcCursor..LiqCant )+ [, LiqIdItem = ] + "'" + this.FormatearTextoSql( &lcCursor..LiqIdItem ) + "'"+ [, ConsigCod = ] + "'" + this.FormatearTextoSql( &lcCursor..ConsigCod ) + "'"+ [, ConsigDesc = ] + "'" + this.FormatearTextoSql( &lcCursor..ConsigDesc ) + "'"+ [, RemAfeCod = ] + "'" + this.FormatearTextoSql( &lcCursor..RemAfeCod ) + "'"+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 )) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FMODIFW, FECTRANS, FECIMPO, FECEXPO, FALTAFW, HALTAFW, ESTTRANS, BDMODIFW, HORAEXPO, HORAIMPO, VALTAFW, ZADSFW, VMODIFW, UMODIFW, UALTAFW, HMODIFW, SMODIFW, SALTAFW, BDALTAFW, Codigo, BLiquida, BLiquidada, IdItemLiq, FART, CCOLOR, TALLE, AfeCant, Cantidad, MovTipo, MovDesc, CompCodigo, LiqDesc, LiqCodigo, LiqCant, LiqIdItem, ConsigCod, ConsigDesc, RemAfeCod, Anulado
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BLiquida ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.BLIQUIDA = isnull( d.BLIQUIDA, t.BLIQUIDA ),t.BLIQUIDADA = isnull( d.BLIQUIDADA, t.BLIQUIDADA ),t.IDITEMLIQ = isnull( d.IDITEMLIQ, t.IDITEMLIQ ),t.FART = isnull( d.FART, t.FART ),t.CCOLOR = isnull( d.CCOLOR, t.CCOLOR ),t.TALLE = isnull( d.TALLE, t.TALLE ),t.AFECANT = isnull( d.AFECANT, t.AFECANT ),t.CANTIDAD = isnull( d.CANTIDAD, t.CANTIDAD ),t.MOVTIPO = isnull( d.MOVTIPO, t.MOVTIPO ),t.MOVDESC = isnull( d.MOVDESC, t.MOVDESC ),t.COMPCODIGO = isnull( d.COMPCODIGO, t.COMPCODIGO ),t.LIQDESC = isnull( d.LIQDESC, t.LIQDESC ),t.LIQCODIGO = isnull( d.LIQCODIGO, t.LIQCODIGO ),t.LIQCANT = isnull( d.LIQCANT, t.LIQCANT ),t.LIQIDITEM = isnull( d.LIQIDITEM, t.LIQIDITEM ),t.CONSIGCOD = isnull( d.CONSIGCOD, t.CONSIGCOD ),t.CONSIGDESC = isnull( d.CONSIGDESC, t.CONSIGDESC ),t.REMAFECOD = isnull( d.REMAFECOD, t.REMAFECOD ),t.ANULADO = isnull( d.ANULADO, t.ANULADO )
					from ZooLogic.REGCONSIGNACION t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.REGCONSIGNACION(Fmodifw,Fectrans,Fecimpo,Fecexpo,Faltafw,Haltafw,Esttrans,Bdmodifw,Horaexpo,Horaimpo,Valtafw,Zadsfw,Vmodifw,Umodifw,Ualtafw,Hmodifw,Smodifw,Saltafw,Bdaltafw,Codigo,Bliquida,Bliquidada,Iditemliq,Fart,Ccolor,Talle,Afecant,Cantidad,Movtipo,Movdesc,Compcodigo,Liqdesc,Liqcodigo,Liqcant,Liqiditem,Consigcod,Consigdesc,Remafecod,Anulado)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.CODIGO,''),isnull( d.BLIQUIDA,''),isnull( d.BLIQUIDADA,''),isnull( d.IDITEMLIQ,''),isnull( d.FART,''),isnull( d.CCOLOR,''),isnull( d.TALLE,''),isnull( d.AFECANT,0),isnull( d.CANTIDAD,0),isnull( d.MOVTIPO,0),isnull( d.MOVDESC,''),isnull( d.COMPCODIGO,''),isnull( d.LIQDESC,''),isnull( d.LIQCODIGO,''),isnull( d.LIQCANT,0),isnull( d.LIQIDITEM,''),isnull( d.CONSIGCOD,''),isnull( d.CONSIGDESC,''),isnull( d.REMAFECOD,''),isnull( d.ANULADO,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="REGISTROLIQUIDACIONCONSIGNACIONES       " atributo="FECHATRANSFERENCIA                      " tabla="REGCONSIGNACION" campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTROLIQUIDACIONCONSIGNACIONES       " atributo="ESTADOTRANSFERENCIA                     " tabla="REGCONSIGNACION" campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
