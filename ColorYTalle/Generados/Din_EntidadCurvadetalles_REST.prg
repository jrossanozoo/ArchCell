...
define class Din_EntidadCurvadetalles_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Curvadetalles"
	cClaseResponse = this.cNamespaceDTOs + ".CurvadetallesResponse"
	cClaseModelo = "CurvadetallesModelo"
	cEntidad = "Curvadetalles"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "CurvadetallesModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CurvadetallesListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CurvadetallesListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "CurvadetallesModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearDetalleTalles( toEntidad, toModeloEnRequest )
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleTalles( toEntidad as Object, toModeloEnRequest as Object ) as Void
		local lnI as Integer, loItem as Object, lnCantidad as Integer, loDetalle as Object 
		local loError as Exception
		loDetalle = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest, "Talles" )
		lnCantidad = _Screen.DotNetBridge.ObtenerValorPropiedad( loDetalle, "Count" )
		for lnI = 1 to lnCantidad 
			loItem = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest,"Talles[" + transform( lnI -1 ) + "]" )
			lnNroItem = _Screen.DotNetBridge.ObtenerValorPropiedad( loItem ,"NroItem" )
			if isnull( lnNroItem )
				toEntidad.Talles.LimpiarItem()
			else
				try
					toEntidad.Talles.CargarItem( lnNroItem )
				Catch To loError
					toEntidad.Talles.LimpiarItem()
				endtry 
			endif
			this.SetearAtributoModeloEnEntidad( loItem, "Talle", toEntidad.Talles.oItem, "Talle_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Talledetalle", toEntidad.Talles.oItem, "TalleDetalle" )
			this.SetearAtributoModeloEnEntidad( loItem, "Ordenvisual", toEntidad.Talles.oItem, "OrdenVisual" )
			toEntidad.Talles.Actualizar()
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.CargarColeccionModeloTalles( toModeloResponse, toEntidad )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarColeccionModeloTalles( toModeloResponse as Object, toEntidad as Object ) as Void
		local lnI as Integer, loColeccionModelo as Object
		loColeccionModelo = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloResponse, "Talles" ) 
		with toEntidad
			for lnI = 1 to .Talles.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemTalles" )
				this.SetearAtributoString( loItem, "Codigo", .Talles.Item(lnI).Codigo)
				this.SetearAtributoString( loItem, "Talle", .Talles.Item(lnI).Talle_PK)
				this.SetearAtributoString( loItem, "TalleDetalle", .Talles.Item(lnI).TalleDetalle)
				this.SetearAtributoInteger( loItem, "OrdenVisual", .Talles.Item(lnI).OrdenVisual)
				this.SetearAtributoInteger( loItem, "NroItem", .Talles.Item(lnI).NroItem )
				_Screen.DotNetBridge.InvocarMetodo( loColeccionModelo, "Add", loItem) 
			endfor
		endwith
	endfunc
