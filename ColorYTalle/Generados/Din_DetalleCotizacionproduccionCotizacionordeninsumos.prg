...
define class Din_DetalleCOTIZACIONPRODUCCIONCotizacionordeninsumos as DetalleProduccioncolorytalle of DetalleProduccioncolorytalle.Prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Cotizacionordeninsumos' ) > 0 and reccount( 'c_Cotizacionordeninsumos' ) > 0
					sum Cantidad, Monto;
						 to ;
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'ItemCOTIZACIONPRODUCCIONCotizacionordeninsumos' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Cotizacionordeninsumos
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Cotizacionordeninsumos.Codigo
			loItem.Comportamiento = c_Cotizacionordeninsumos.Comportamiento
			loItem.IdItemInsumo = c_Cotizacionordeninsumos.IdItemInsumo
			loItem.NROITEM = c_Cotizacionordeninsumos.NROITEM
			loItem.Insumo_PK = c_Cotizacionordeninsumos.Insumo
			loItem.InsumoDetalle = c_Cotizacionordeninsumos.InsumoDetalle
			loItem.Color_PK = c_Cotizacionordeninsumos.Color
			loItem.ColorDetalle = c_Cotizacionordeninsumos.ColorDetalle
			loItem.Talle_PK = c_Cotizacionordeninsumos.Talle
			loItem.TalleDetalle = c_Cotizacionordeninsumos.TalleDetalle
			loItem.Cantidad = c_Cotizacionordeninsumos.Cantidad
			loItem.Articulo_PK = c_Cotizacionordeninsumos.Articulo
			loItem.ArticuloDetalle = c_Cotizacionordeninsumos.ArticuloDetalle
			loItem.Costo = c_Cotizacionordeninsumos.Costo
			loItem.Monto = c_Cotizacionordeninsumos.Monto
			loItem.NroItem = lnI 
