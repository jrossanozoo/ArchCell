	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.OPETAR ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Saltafw","Horaimpo","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Haltafw","Horaexpo","Bdmodifw","Bdaltafw","Esttrans","Timestamp","Tipagrupub","Codigo","Descrip","Proveedor","Ctabanc","Pagadora","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxOpetarFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpetarFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpetarFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpetarFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxOpetarFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarEsttrans ) + "'" >>, <<lxOpetarTimestamp >>, <<lxOpetarTipagrupub >>, <<"'" + this.FormatearTextoSql( lxOpetarCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarProveedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarCtabanc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarPagadora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxOpetarObs ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPub056("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.OPETAR set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxOpetarFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxOpetarFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxOpetarFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxOpetarFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxOpetarFmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxOpetarSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxOpetarHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxOpetarHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxOpetarSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxOpetarUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxOpetarUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxOpetarZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxOpetarValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxOpetarVmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxOpetarHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxOpetarHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxOpetarBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxOpetarBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxOpetarEsttrans ) + "'">>,"Timestamp" = <<lxOpetarTimestamp>>,"Tipagrupub" = <<lxOpetarTipagrupub>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxOpetarCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxOpetarDescrip ) + "'">>,"Proveedor" = <<"'" + this.FormatearTextoSql( lxOpetarProveedor ) + "'">>,"Ctabanc" = <<"'" + this.FormatearTextoSql( lxOpetarCtabanc ) + "'">>,"Pagadora" = <<"'" + this.FormatearTextoSql( lxOpetarPagadora ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxOpetarObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxOpetarCodigo ) + "'">> and  OPETAR.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
		...
		this.ComprobarTransaccion()
			...
			this.oConexion.EjecutarSql( 'delete from ZooLogic.AgruPub056 where "Codigo" = ' + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrup" as "Agrupamiento", "Agrupdes" as "Agrupamientodetalle" from ZooLogic.AgruPub056 where Codigo = <<"'" + this.FormatearTextoSql( c_OPERADORADETARJETA.CODIGO ) + "'">> Order by NroItem
			endtext
...
"dsfw,Valtafw,Vmodifw,Haltafw,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Timestamp,Tipagrupub,Codigo,Descrip" + ;
",Proveedor,Ctabanc,Pagadora,Obs" + ;
" from ZooLogic.OPETAR where  OPETAR.CODIGO != '' and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAgruPubliDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		Local lcAtributos As String, lcWhere As String
		lcWhere = " Where  AGRUPUB056.CODIGO != ''"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
		...
		return this.ObtenerDatos( lcAtributos, tcHaving, tcOrder, tcFunc, lcWhere, 'AgruPub056', 'AgruPubliDetalle', tnTope )
	Endfunc
		...
		With this
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAgrupamientodetalle = loItem.Agrupamientodetalle
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPub056("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			loColeccion.Agregar([delete from ZooLogic.AgruPub056 where "Codigo" = ] + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'")
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.OPETAR set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'"+ [, Proveedor = ] + "'" + this.FormatearTextoSql( &lcCursor..Proveedor ) + "'"+ [, CtaBanc = ] + "'" + this.FormatearTextoSql( &lcCursor..CtaBanc ) + "'"+ [, Pagadora = ] + "'" + this.FormatearTextoSql( &lcCursor..Pagadora ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, SALTAFW, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HALTAFW, HORAEXPO, BDMODIFW, BDALTAFW, ESTTRANS, TIMESTAMP, tipagrupub, Codigo, descrip, Proveedor, CtaBanc, Pagadora, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..tipagrupub )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Proveedor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CtaBanc ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Pagadora ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirDetalles() As Void
		...
		If lcCantRegistros > 0
			...
			this.oConexion.EjecutarSql( [Delete From ZooLogic.AgruPub056 Where Codigo] + lcIn  )
			endfor
			if llEjecutaEnTransaccion
				this.oConexion.EjecutarSQL( 'COMMIT TRANSACTION' )
			endif
	...
	EndScan
	Use in select( 'cDetallesExistentes' )
	lcDetalle = This.oEntidad.cPrefijoRecibir + 'ITEMAGRUPAPUBLIC056'
	Select * From &lcDetalle into cursor cDetallesExistentes ;
		where Codigo in ( select Codigo from &lcCursor )
	select cDetallesExistentes
	Scan All
		...
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.AgruPub056 ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Agrup      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AgrupDes   ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'ITEMCONCEPTOS'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'ITEMAGRUPAPUBLIC056'
				llRetorno = .T.
		EndCase
		Return llRetorno
	EndFunc
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.PROVEEDOR = isnull( d.PROVEEDOR, t.PROVEEDOR ),t.CTABANC = isnull( d.CTABANC, t.CTABANC ),t.PAGADORA = isnull( d.PAGADORA, t.PAGADORA ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.OPETAR t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.OPETAR(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Haltafw,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Timestamp,Tipagrupub,Codigo,Descrip,Proveedor,Ctabanc,Pagadora,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.TIMESTAMP,0),isnull( d.TIPAGRUPUB,0),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.PROVEEDOR,''),isnull( d.CTABANC,''),isnull( d.PAGADORA,''),isnull( d.OBS,'')
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_AgruPub056( tcTablaTrabajo ) as String

		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_OPETAR_AgruPub056
ON ZooLogic.TablaTrabajo_OPETAR_AgruPub056
AFTER DELETE
As
Begin
Update t Set 
...
from ZooLogic.AgruPub056 t inner join deleted d 
 on t.CODIGO = d.CODIGO
-- Fin Updates
insert into ZooLogic.AgruPub056
( 
"NROITEM",
"CODIGO",
"AGRUP",
...
d.AGRUP,
d.AGRUPDES
From deleted d left join ZooLogic.AgruPub056 pk 
 on d.CODIGO = pk.CODIGO
Where pk.CODIGO Is Null 
-- Fin Inserts
End
		...
		with this.oEntidad
			...
			if reccount( 'c_OPERADORADETARJETA' ) < 1
				...
				Try
					...
					.Tipoagrupamientopublicaciones = nvl( c_OPERADORADETARJETA.Tipoagrupamientopublicaciones, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="OPERADORADETARJETA                      " atributo="FECHATRANSFERENCIA                      " tabla="OPETAR         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERADORADETARJETA                      " atributo="ESTADOTRANSFERENCIA                     " tabla="OPETAR         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERADORADETARJETA                      " atributo="TIPOAGRUPAMIENTOPUBLICACIONES           " tabla="OPETAR         " campo="TIPAGRUPUB" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERADORADETARJETA                      " atributo="AGRUPUBLIDETALLE                        " tabla="AGRUPUB056     " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Agrupamientos                                                                                                                                                   " dominio="DETALLEITEMAGRUPAPUBLIC056    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="OPERADORADETARJETA                      " atributo="PROVEEDOR                               " tabla="OPETAR         " campo="PROVEEDOR " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Proveedor                                                                                                                                                       " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
