...
define class Mock_configuracionarticuloecommerce as MockBase of MockBase.prg
	...
	cClase = 'configuracionarticuloecommerce'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Categorías, etiquetas y dimensiones ecommerce"                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function advertircategoriarepetida() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Advertircategoriarepetida', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function advertiretiquetarepetida() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Advertiretiquetarepetida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecategoriasecom() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallecategoriasecom', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledimensionesecom() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledimensionesecom', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalleetiquetasecom() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleetiquetasecom', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarcategoriasyramas() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcategoriasyramas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function categoriasecom_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIGURACIONARTICULOECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'categoriasecom_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'categoriasecom_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Categoriasecom ) = 'O' or isnull( this.Categoriasecom ) )			this.Categoriasecom = this.crearobjeto( 'Din_DetalleConfiguracionarticuloecommerceCategoriasecom' )			this.Categoriasecom.inicializar()			this.enlazar( 'Categoriasecom.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Categoriasecom.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Categoriasecom, 'CambioSumarizado', this, 'CambiosDetalleCategoriasecom', 1)			this.enlazar( 'Categoriasecom.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Categoriasecom.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Categoriasecom
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function dimensionesecom_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIGURACIONARTICULOECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'dimensionesecom_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'dimensionesecom_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Dimensionesecom ) = 'O' or isnull( this.Dimensionesecom ) )			this.Dimensionesecom = this.crearobjeto( 'Din_DetalleConfiguracionarticuloecommerceDimensionesecom' )			this.Dimensionesecom.inicializar()			this.enlazar( 'Dimensionesecom.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Dimensionesecom.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Dimensionesecom, 'CambioSumarizado', this, 'CambiosDetalleDimensionesecom', 1)			this.enlazar( 'Dimensionesecom.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Dimensionesecom.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Dimensionesecom
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminardimensionessindatos() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eliminardimensionessindatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function etiquetasecom_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIGURACIONARTICULOECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'etiquetasecom_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'etiquetasecom_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Etiquetasecom ) = 'O' or isnull( this.Etiquetasecom ) )			this.Etiquetasecom = this.crearobjeto( 'Din_DetalleConfiguracionarticuloecommerceEtiquetasecom' )			this.Etiquetasecom.inicializar()			this.enlazar( 'Etiquetasecom.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Etiquetasecom.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Etiquetasecom, 'CambioSumarizado', this, 'CambiosDetalleEtiquetasecom', 1)			this.enlazar( 'Etiquetasecom.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Etiquetasecom.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Etiquetasecom
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccioncategoriasrepetidas() as object                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercoleccioncategoriasrepetidas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercoleccionetiquetasrepetidas() as object                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercoleccionetiquetasrepetidas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validararticuloexistente( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validararticuloexistente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcategoriarepetida() as boolean                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcategoriarepetida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaretiquetarepetida() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaretiquetarepetida', lcParametros )
	EndFunc
