...
define class Mock_herramientaconciliacion as MockBase of MockBase.prg
	...
	cClase = 'herramientaconciliacion'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Herramienta de conciliación bancaria"                                                                                                                                                                                                    
	...
	lHabilitarCuentaBancaria_PK = .T.                                                                                                                                                                                                                         
	lHabilitarDetalleMovimientos = .T.                                                                                                                                                                                                                        
	lHabilitarDetalleRegistros = .T.                                                                                                                                                                                                                          
	lHabilitarOrdenamiento = .T.                                                                                                                                                                                                                              
	...
	oColConciliaciones = null                                                                                                                                                                                                                                 
	oColeccionSentencias = null                                                                                                                                                                                                                               
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oCompConciliacionesCheques = null                                                                                                                                                                                                                         
	oComportamientoCodigoSugerido = null                                                                                                                                                                                                                      
	oConceptoEntidadFinanciera = null                                                                                                                                                                                                                         
	oConciliaciones = null                                                                                                                                                                                                                                    
	oCopiadorDeDetalles = null                                                                                                                                                                                                                                
	oCuentaBancariaAnterior = ""                                                                                                                                                                                                                              
	oExtension = null                                                                                                                                                                                                                                         
	oGestorDeMail = null                                                                                                                                                                                                                                      
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	oMensaje = null                                                                                                                                                                                                                                           
	oMovimientoBancario = null                                                                                                                                                                                                                                
	oNumeraciones =  null                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function borrarconciliacion() as void                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Borrarconciliacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calculardiferencia() as void                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Calculardiferencia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallemovimientos() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallemovimientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleregistros() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardetallesenconciliacion() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargardetallesenconciliacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarmovimientos() as void                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarmovimientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarmovimientosbancarios() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarmovimientosbancarios', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarregistrosconciliables() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarregistrosconciliables', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function conciliar() as void                                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function conciliarmovimientos() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Conciliarmovimientos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detallemovimientos_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallemovimientos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallemovimientos_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallemovimientos ) = 'O' or isnull( this.Detallemovimientos ) )			this.Detallemovimientos = this.crearobjeto( 'DetalleHerramientaconciliacionDetallemovimientos' )			this.Detallemovimientos.inicializar()			this.enlazar( 'Detallemovimientos.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallemovimientos.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallemovimientos, 'CambioSumarizado', this, 'CambiosDetalleDetallemovimientos', 1)			this.enlazar( 'Detallemovimientos.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallemovimientos.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detallemovimientos
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detalleregistros_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalleregistros_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalleregistros_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalleregistros ) = 'O' or isnull( this.Detalleregistros ) )			this.Detalleregistros = this.crearobjeto( 'DetalleHerramientaconciliacionDetalleregistros' )			this.Detalleregistros.inicializar()			this.enlazar( 'Detalleregistros.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalleregistros.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalleregistros, 'CambioSumarizado', this, 'CambiosDetalleDetalleregistros', 1)			this.enlazar( 'Detalleregistros.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalleregistros.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detalleregistros
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarsentencias() as void                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function eliminarmovimientosbancariosseleccionados() as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eliminarmovimientosbancariosseleccionados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorefrescardetallemovimientos() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorefrescardetallemovimientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventorefrescardetalleregistros() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorefrescardetalleregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitardetallemovimientos_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetallemovimientos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetallemovimientos_assign', lcParametros )			endif		endif		this.lHabilitarDetalleMovimientos = txVal		this.DetalleMovimientos.habilitarItems( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function lhabilitardetalleregistros_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetalleregistros_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetalleregistros_assign', lcParametros )			endif		endif		this.lHabilitarDetalleRegistros = txVal		this.DetalleRegistros.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiardetalles() as void                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Limpiardetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercursormovimientosbancarios() as string                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercursormovimientosbancarios', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercursorregistrosconciliables() as string                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercursorregistrosconciliables', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerdatosdelcomprobanteenelitem( totextbox as object, tcdetalle as string ) as string                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerdatosdelcomprobanteenelitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombrebase() as string                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenernombrebase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciaseliminarmovimientosbancarios( todetalle as object ) as void                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersentenciaseliminarmovimientosbancarios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolconciliaciones_access() as void                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolconciliaciones_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolconciliaciones_access', lcParametros )			endif		endif		if !this.lDestroy and ( vartype( this.oColConciliaciones ) != "O" or isnull( this.oColConciliaciones ) )			this.oColConciliaciones = _screen.zoo.CrearObjeto( "ZooColeccion" )		endif		Return this.oColConciliaciones
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocompconciliacionescheques_access() as variant                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocompconciliacionescheques_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocompconciliacionescheques_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oCompConciliacionescheques ) = 'O' or isnull( this.oCompConciliacionescheques ) )			this.oCompConciliacionescheques = _Screen.zoo.InstanciarComponente( 'ComponenteConciliacionescheques' )		this.oCompConciliacionescheques.Inicializar()		this.enlazar( 'oCompConciliacionescheques.EventoObtenerLogueo', 'inyectarLogueo' )		this.enlazar( 'oCompConciliacionescheques.EventoObtenerInformacion', 'inyectarInformacion' )		endif		return this.oCompConciliacionescheques
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oconceptoentidadfinanciera_access() as void                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oconceptoentidadfinanciera_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oconceptoentidadfinanciera_access', lcParametros )			endif		endif		if !this.ldestroy and vartype( this.oConceptoEntidadFinanciera ) != 'O'			this.oConceptoEntidadFinanciera = _Screen.zoo.instanciarEntidad( "ConceptoEntidadFinanciera" )		endif		return this.oConceptoEntidadFinanciera
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oconciliaciones_access() as void                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oconciliaciones_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oconciliaciones_access', lcParametros )			endif		endif		if !this.lDestroy and ( vartype( this.oConciliaciones ) != "O" or isnull( this.oConciliaciones ) )			this.oConciliaciones = _screen.zoo.InstanciarEntidad( "Conciliaciones" )		endif		Return this.oConciliaciones
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocopiadordedetalles_access() as void                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocopiadordedetalles_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocopiadordedetalles_access', lcParametros )			endif		endif		if !this.lDestroy and ( vartype( this.oCopiadorDeDetalles ) != "O" or isnull( this.oCopiadorDeDetalles ) )			this.oCopiadorDeDetalles = _screen.zoo.CrearObjeto( "CopiadorDeDetalles" )		endif		Return this.oCopiadorDeDetalles
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omovimientobancario_access() as variant                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'omovimientobancario_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'omovimientobancario_access', lcParametros )			endif		endif		if !this.ldestroy and ( type( "this.oMovimientoBancario" ) != 'O' or isnull( this.oMovimientoBancario) )			this.oMovimientoBancario= _Screen.Zoo.InstanciarEntidad( 'MovimientoBancario' )		endif		return this.oMovimientoBancario
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ordenamiento_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ordenamiento_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ordenamiento_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ordenamiento		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ordenamiento( lxVal )				if ( this.lHabilitarOrdenamiento or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Ordenamiento( lxVal )				else					this.Ordenamiento = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Herramienta de conciliación bancaria - Atributo: Ordenamiento)" )				endif			EndIf		Else			This.Setear_Ordenamiento( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ordenarcursor( tccursor as string, tntipo as integer ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Ordenarcursor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puedeeliminarmovimientosbancariosseleccionados() as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Puedeeliminarmovimientosbancariosseleccionados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seleccionarendetalle( tlseleccionar as boolean, todetalle as object ) as void                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tlseleccionar
		lxParam2 = todetalle
		...
		return this.ObtenerResultado( 'Seleccionarendetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function seleccionarmovimientos( tlseleccionar as boolean ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Seleccionarmovimientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function seleccionarregistros( tlseleccionar as boolean ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Seleccionarregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cuentabancaria( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cuentabancaria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cuentabancaria', lcParametros )			endif		endif		dodefault( txVal )		if empty( txval ) or this.oCuentaBancariaAnterior != this.CuentaBancaria_pk			this.LimpiarDetalles()		endif		this.lCambioCuentaBancaria = this.oCuentaBancariaAnterior != this.CuentaBancaria_pk		this.oCuentaBancariaAnterior = this.CuentaBancaria_pk
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechahasta( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechahasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechahasta', lcParametros )			endif		endif		this.dFechaHastaold = this.FechaHasta		dodefault( txVal )		if this.dFechaHastaold != this.FechaHasta or !this.lSeteoFechaHasta	or this.lCambioFechaDesde or this.lCambioCuentaBancaria			this.lCambioCuentaBancaria = .f.			this.lCambioFechaDesde = .f.			this.CargarMovimientos()		endif		if !empty( this.CuentaBancaria_pk )			this.lSeteoFechaHasta = .t.		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerocuenta( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numerocuenta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numerocuenta', lcParametros )			endif		endif		this.Numerocuenta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ordenamiento( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ordenamiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ordenamiento', lcParametros )			endif		endif		dodefault( txVal )		this.CargarRegistrosConciliables()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerocuenta( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numerocuenta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numerocuenta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ordenamiento( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'HERRAMIENTACONCILIACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ordenamiento', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ordenamiento', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwordenamiento() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwordenamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoordenamiento() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoordenamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarmovbancariosseleccionados( todetalle as object ) as boolean                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Verificarmovbancariosseleccionados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function verificarregconciliablesseleccionados( todetalle as object ) as boolean                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Verificarregconciliablesseleccionados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function armarsentenciaparaconsultaclienteproveedor( tcbasededatos as string, tcenttablaprincipal as string, tccodigocomprobante as string ) as string                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tcbasededatos
		lxParam2 = tcenttablaprincipal
		lxParam3 = tccodigocomprobante
		...
		return this.ObtenerResultado( 'Armarsentenciaparaconsultaclienteproveedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function comprobantehabilitadoparaconsultaclienteproveedor( tctipocomprobante as string ) as boolean                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Comprobantehabilitadoparaconsultaclienteproveedor', lcParametros )
	EndFunc
