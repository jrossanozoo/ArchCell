...
define class Mock_redondeodeprecios as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetprueba() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cambiosdetalledetprueba', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetredondeoporcentavo() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Cambiosdetalledetredondeoporcentavo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetredondeoporentero() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cambiosdetalledetredondeoporentero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetredondeoportabla() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Cambiosdetalledetredondeoportabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detprueba_access() as void                                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detprueba_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detprueba_access', lcParametros )			endif		endif		local loObject as Object		loObject = dodefault()		if vartype( this.detPrueba ) = "O"			this.DetPrueba.InyectarEntidad( this )		endif				Return loObject
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detredondeoporcentavo_access() as void                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detredondeoporcentavo_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detredondeoporcentavo_access', lcParametros )			endif		endif		local loObject as Object		loObject = dodefault()		if vartype( this.DetRedondeoPorCentavo ) = "O"			this.DetRedondeoPorCentavo.InyectarEntidadNet( this.oRedondeo )		endif				Return loObject	
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detredondeoporentero_access() as void                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detredondeoporentero_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detredondeoporentero_access', lcParametros )			endif		endif		local loObject as Object		loObject = dodefault()		if vartype( this.DetRedondeoPorEntero ) = "O"			this.DetRedondeoPorEntero.InyectarEntidadNet( this.oRedondeo )		endif		Return loObject	
	EndFunc

	*-----------------------------------------------------------------------------------------
	function detredondeoportabla_access() as void                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detredondeoportabla_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detredondeoportabla_access', lcParametros )			endif		endif		local loObject as Object		loObject = dodefault()		if vartype( this.DetRedondeoPorTabla ) = "O"			this.DetRedondeoPorTabla.InyectarEntidadNet( this.oRedondeo )		endif				Return loObject
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoactualizarpreview( tcatributo as string, toitem as object ) as void                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Eventoactualizarpreview', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreviewactualizado() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Eventopreviewactualizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaredondeartermcentavos_despuesdeasignar() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Habilitaredondeartermcentavos_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitaredondeartermenteros_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'habilitaredondeartermenteros_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'habilitaredondeartermenteros_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Habilitaredondeartermenteros		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Habilitaredondeartermenteros( lxVal )				this.Setear_Habilitaredondeartermenteros( lxVal )				 This.Habilitaredondeartermenteros_DespuesDeAsignar()			EndIf		Else			This.Setear_Habilitaredondeartermenteros( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaredondeartermenteros_despuesdeasignar() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Habilitaredondeartermenteros_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitaredonearprecios_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'habilitaredonearprecios_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'habilitaredonearprecios_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Habilitaredonearprecios		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Habilitaredonearprecios( lxVal )				this.Setear_Habilitaredonearprecios( lxVal )				 This.Habilitaredonearprecios_DespuesDeAsignar()			EndIf		Else			This.Setear_Habilitaredonearprecios( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitaredonearprecios_despuesdeasignar() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Habilitaredonearprecios_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitardetredondeoporcentavo_assign( txval as variant ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetredondeoporcentavo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetredondeoporcentavo_assign', lcParametros )			endif		endif		this.lHabilitarDetRedondeoPorCentavo = txVal		this.DetRedondeoPorCentavo.habilitarItems( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function lhabilitardetredondeoporentero_assign( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetredondeoporentero_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetredondeoporentero_assign', lcParametros )			endif		endif		this.lHabilitarDetRedondeoPorEntero = txVal		this.DetRedondeoPorEntero.habilitarItems( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function lhabilitardetredondeoportabla_assign( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetredondeoportabla_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetredondeoportabla_assign', lcParametros )			endif		endif		this.lHabilitarDetRedondeoPorTabla = txVal		this.DetRedondeoPorTabla.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlistaderedondeos() as object                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerlistaderedondeos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function redondeonormal_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'redondeonormal_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'redondeonormal_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Redondeonormal		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Redondeonormal( lxVal )				if ( this.lHabilitarRedondeonormal or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Redondeonormal( lxVal )					 This.Redondeonormal_DespuesDeAsignar()				else					this.Redondeonormal = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Redondeos - Atributo: Redondeonormal)" )				endif			EndIf		Else			This.Setear_Redondeonormal( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function redondeonormal_despuesdeasignar() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Redondeonormal_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function redondeoportabla_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'redondeoportabla_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'redondeoportabla_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Redondeoportabla		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Redondeoportabla( lxVal )				if ( this.lHabilitarRedondeoportabla or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Redondeoportabla( lxVal )					 This.Redondeoportabla_DespuesDeAsignar()				else					this.Redondeoportabla = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Redondeos - Atributo: Redondeoportabla)" )				endif			EndIf		Else			This.Setear_Redondeoportabla( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function redondeoportabla_despuesdeasignar() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Redondeoportabla_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_habilitaredondearnormal( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_habilitaredondearnormal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_habilitaredondearnormal', lcParametros )			endif		endif		dodefault( txVal )		this.oRedondeo.Habilitaredondearnormal = txVal
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_habilitaredondeartermcentavos( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_habilitaredondeartermcentavos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_habilitaredondeartermcentavos', lcParametros )			endif		endif		dodefault( txVal )		this.oRedondeo.Habilitaredondeartermcentavos = txVal		
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_habilitaredondeartermenteros( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_habilitaredondeartermenteros', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_habilitaredondeartermenteros', lcParametros )			endif		endif		dodefault( txVal )		This.oRedondeo.Habilitaredondeartermenteros = txVal
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_habilitaredonearprecios( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_habilitaredonearprecios', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_habilitaredonearprecios', lcParametros )			endif		endif		dodefault( txVal )		This.oRedondeo.Habilitaredonearprecios = txVal
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_redondeonormal( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_redondeonormal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_redondeonormal', lcParametros )			endif		endif		dodefault( txVal )		this.oRedondeo.Redondeonormal = cast( txVal as I )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_redondeoportabla( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_redondeoportabla', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_redondeoportabla', lcParametros )			endif		endif		dodefault( txVal )		this.oRedondeo.Redondeoportabla = cast( txVal as I )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_habilitaredondearnormal( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_habilitaredondearnormal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_habilitaredondearnormal', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_habilitaredondeartermcentavos( txval as variant ) as boolean                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_habilitaredondeartermcentavos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_habilitaredondeartermcentavos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_habilitaredondeartermenteros( txval as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_habilitaredondeartermenteros', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_habilitaredondeartermenteros', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_habilitaredonearprecios( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_habilitaredonearprecios', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_habilitaredonearprecios', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_redondeonormal( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_redondeonormal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_redondeonormal', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_redondeoportabla( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REDONDEODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_redondeoportabla', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_redondeoportabla', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwhabilitaredondearnormal() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwhabilitaredondearnormal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwhabilitaredondeartermcentavos() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwhabilitaredondeartermcentavos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwhabilitaredondeartermenteros() as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwhabilitaredondeartermenteros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwhabilitaredonearprecios() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwhabilitaredonearprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwredondeonormal() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridofwredondeonormal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwredondeoportabla() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofwredondeoportabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohabilitaredondearnormal() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridohabilitaredondearnormal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohabilitaredondeartermcentavos() as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridohabilitaredondeartermcentavos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohabilitaredondeartermenteros() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridohabilitaredondeartermenteros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridohabilitaredonearprecios() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridohabilitaredonearprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoredondeonormal() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridoredondeonormal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoredondeoportabla() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridoredondeoportabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarpreciospreview() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cargarpreciospreview', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitardetallecentavos() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Habilitardetallecentavos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitardetalleenteros() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Habilitardetalleenteros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitardetalleprecios() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Habilitardetalleprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitarredondeonormal() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Habilitarredondeonormal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerlistadepreciospreview() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerlistadepreciospreview', lcParametros )
	EndFunc
