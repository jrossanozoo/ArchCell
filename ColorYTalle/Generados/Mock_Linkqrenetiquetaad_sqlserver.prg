...
define class Mock_Linkqrenetiquetaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Linkqrenetiquetaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupublqr( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupublqr', lcParametros )
	EndFunc
