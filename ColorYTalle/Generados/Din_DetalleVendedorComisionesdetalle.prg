...
define class Din_DetalleVENDEDORComisionesdetalle as detalle of detalle.prg
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.ComisionDetalle = this.Item[ tnItem ].ComisionDetalle
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'ComisionDetalle', .ComisionDetalle )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.ComisionDetalle = this.oItem.ComisionDetalle
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].ComisionDetalle = .oItem.ComisionDetalle
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Comisiondetalle = toItemOrigen.Comisiondetalle
