...
define class Mock_descuento as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function setear_vendedor_clasificacionvdesde( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DESCUENTO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_vendedor_clasificacionvdesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_vendedor_clasificacionvdesde', lcParametros )			endif		endif		this.Vendedor_clasificacionvdesde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_vendedor_clasificacionvhasta( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DESCUENTO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_vendedor_clasificacionvhasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_vendedor_clasificacionvhasta', lcParametros )			endif		endif		this.Vendedor_clasificacionvhasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_vendedor_clasificacionvdesde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DESCUENTO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_vendedor_clasificacionvdesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_vendedor_clasificacionvdesde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_vendedor_clasificacionvhasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DESCUENTO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_vendedor_clasificacionvhasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_vendedor_clasificacionvhasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmodofuncionamiento() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validarmodofuncionamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvendedor_clasificacionvdesde() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarvendedor_clasificacionvdesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvendedor_clasificacionvhasta() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarvendedor_clasificacionvhasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwmontodesde() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwmontodesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwvendedor_clasificacionvhasta() as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwvendedor_clasificacionvhasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovendedor_clasificacionvdesde() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridovendedor_clasificacionvdesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovendedor_clasificacionvhasta() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridovendedor_clasificacionvhasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function estableceratributoshabilitadosypordefecto( tnval as integer, tnvalold as integer ) as void                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Estableceratributoshabilitadosypordefecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenervalorsugerido( tcpropiedad as string) as variant                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenervalorsugerido', lcParametros )
	EndFunc
