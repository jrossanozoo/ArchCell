...
define class Din_ItemMODIFICACIONDECOSTOSDEPRODUCCIONModcostos as ItemModificacionDeCostos of ItemModificacionDeCostos.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		this.oColeccionVSFW.agregar('.ValorSugeridoFWDesdecantidad()','Desdecantidad')
