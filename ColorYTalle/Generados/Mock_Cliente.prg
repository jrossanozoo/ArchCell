...
define class Mock_cliente as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecontacto() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Cambiosdetallecontacto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function caracteresrepetidos(tcdninovalido as string) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Caracteresrepetidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codrecomendante_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'codrecomendante_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'codrecomendante_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Codrecomendante		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Codrecomendante( lxVal )				this.Setear_Codrecomendante( lxVal )			EndIf		Else			This.Setear_Codrecomendante( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function completarnombre() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Completarnombre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function espasaporte( tctipodoc as string ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Espasaporte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitarsiprib() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Habilitardeshabilitarsiprib', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nombrerecomendante_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'nombrerecomendante_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'nombrerecomendante_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Nombrerecomendante		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Nombrerecomendante( lxVal )				this.Setear_Nombrerecomendante( lxVal )			EndIf		Else			This.Setear_Nombrerecomendante( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nrodocumento_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'nrodocumento_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'nrodocumento_assign', lcParametros )			endif		endif		local llEsLecturaDNI as Boolean, lnCantidad As Integer		local laLecturaDNI[1]		llEsLecturaDNI = .f.		This.lEsLecturaDNI = .f.		if goParametros.Nucleo.DatosGenerales.Pais = 1 and This.CargaManual() and at( "@", txVal, 7 ) > 0			lnCantidad = ALINES(laLecturaDNI, txVal, 0, "@")			if lnCantidad > 11 												&&   Formato Documento Anterior				This.NroDocumento	= alltrim( str( int( val( laLecturaDNI[2] ) ) ) )				This.Apellido 		= proper( alltrim( laLecturaDNI[5] ) )				This.Primernombre 	= proper( alltrim( laLecturaDNI[6] ) )				This.Sexo			= This.ObtenerSexo( alltrim( laLecturaDNI[9] ) )				This.FechaNacimiento= ctod( laLecturaDNI[8] )			else															&&   Formato Documento Vigente				This.Apellido 		= proper( alltrim( laLecturaDNI[2] ) )				This.Primernombre 	= proper( alltrim( laLecturaDNI[3] ) )				This.Sexo			= This.ObtenerSexo( alltrim( laLecturaDNI[4] ) )				This.NroDocumento	= alltrim( str( int( val( laLecturaDNI[5] ) ) ) )				This.FechaNacimiento= ctod( laLecturaDNI[7] )			endif			llEsLecturaDNI = .t.			This.lEsLecturaDNI = .T.		endif				if !llEsLecturaDNI			dodefault( txVal )		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersexo( tcinicialsexo as string ) as string                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenersexo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function segundonombre_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'segundonombre_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'segundonombre_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Segundonombre		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Segundonombre( lxVal )				this.Setear_Segundonombre( lxVal )			EndIf		Else			This.Setear_Segundonombre( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codrecomendante( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_codrecomendante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_codrecomendante', lcParametros )			endif		endif		this.Codrecomendante = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nombrerecomendante( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_nombrerecomendante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_nombrerecomendante', lcParametros )			endif		endif		this.Nombrerecomendante = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_recomendadopor( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_recomendadopor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_recomendadopor', lcParametros )			endif		endif		this.Recomendadopor.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_segundonombre( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_segundonombre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_segundonombre', lcParametros )			endif		endif		this.Segundonombre = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codrecomendante( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_codrecomendante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_codrecomendante', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nombrerecomendante( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_nombrerecomendante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_nombrerecomendante', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_recomendadopor( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_recomendadopor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_recomendadopor', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_segundonombre( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CLIENTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_segundonombre', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_segundonombre', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardni(tcdninovalido as string) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validardni', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarnombreconsumidorfinal() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarnombreconsumidorfinal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarrecomendadopor() as boolean                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validarrecomendadopor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoapellido() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoapellido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwtipodocumento() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwtipodocumento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprimernombre() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoprimernombre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorecomendadopor() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridorecomendadopor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosegundonombre() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridosegundonombre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosujetovinculado() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridosujetovinculado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearatributosrecomendante( txval as variant ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setearatributosrecomendante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearatributovirtualrecomendante() as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setearatributovirtualrecomendante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarrecomendacionrecursiva() as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarrecomendacionrecursiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarrecomendanteinactivo() as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validarrecomendanteinactivo', lcParametros )
	EndFunc
