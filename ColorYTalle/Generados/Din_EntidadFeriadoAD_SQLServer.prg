	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.FERIADO ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Zadsfw","Smodifw","Ualtafw","Vmodifw","Saltafw","Valtafw","Umodifw","Haltafw","Hmodifw","Horaimpo","Bdaltafw","Bdmodifw","Esttrans","Horaexpo","Tipagrupub","Anio","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxFeriadoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFeriadoFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFeriadoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFeriadoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxFeriadoFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxFeriadoHoraexpo ) + "'" >>, <<lxFeriadoTipagrupub >>, <<lxFeriadoAnio >>, <<"'" + this.FormatearTextoSql( lxFeriadoObs ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubFER("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, <<transform( lxValorClavePrimaria )>>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.FERIADO set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxFeriadoFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxFeriadoFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxFeriadoFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxFeriadoFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxFeriadoFaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxFeriadoZadsfw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxFeriadoUaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoVmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxFeriadoSaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxFeriadoValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoUmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxFeriadoHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxFeriadoHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxFeriadoBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxFeriadoEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxFeriadoHoraexpo ) + "'">>,"Tipagrupub" = <<lxFeriadoTipagrupub>>,"Anio" = <<lxFeriadoAnio>>,"Obs" = <<"'" + this.FormatearTextoSql( lxFeriadoObs ) + "'">> where "Anio" = <<lxFeriadoAnio>> and  FERIADO.ANIO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
			this.ComprobarResultadoDeEjecucionDelUpdate()
		this.ComprobarTransaccion()
			this.oConexion.EjecutarSql( 'delete from ZooLogic.AgruPubFER where "Codigo" = ' + transform( .oEntidad.ANIO ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Anio" as "Anio", "Obs" as "Observaciones" from ZooLogic.FERIADO where "Anio" = <<lxFeriadoAnio>> and  FERIADO.ANIO != 0
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrup" as "Agrupamiento", "Agrupdes" as "Agrupamientodetalle" from ZooLogic.AgruPubFER where Codigo = <<transform( c_FERIADO.ANIO )>> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Anio" as "Anio", "Obs" as "Observaciones" from ZooLogic.FERIADO where  FERIADO.ANIO != 0 And Anio = <<lxFERIADOAnio>>
			endtext
			use in select('c_FERIADO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FERIADO', set( 'Datasession' ) )
			if reccount( 'c_FERIADO' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Anio" as "Anio", "Obs" as "Observaciones" from ZooLogic.FERIADO where  FERIADO.ANIO != 0 order by Anio
			endtext
			use in select('c_FERIADO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FERIADO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Anio" as "Anio", "Obs" as "Observaciones" from ZooLogic.FERIADO where  str( Anio, 4, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  FERIADO.ANIO != 0 order by Anio
			endtext
			use in select('c_FERIADO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FERIADO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Anio" as "Anio", "Obs" as "Observaciones" from ZooLogic.FERIADO where  str( Anio, 4, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  FERIADO.ANIO != 0 order by Anio desc
			endtext
			use in select('c_FERIADO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FERIADO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Anio" as "Anio", "Obs" as "Observaciones" from ZooLogic.FERIADO where  FERIADO.ANIO != 0 order by Anio desc
			endtext
			use in select('c_FERIADO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_FERIADO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Zadsfw,Smodifw,Ualtafw,Vmodifw,Saltafw,Valtafw,Umod" + ;
"ifw,Haltafw,Hmodifw,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Horaexpo,Tipagrupub,Anio,Obs" + ;
" from ZooLogic.FERIADO where  FERIADO.ANIO != 0 and " + lcFiltro )
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Anio" as "Anio", "Obs" as "Observaciones"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAgruPubliDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		Local lcAtributos As String, lcWhere As String
		lcWhere = " Where  AGRUPUBFER.CODIGO != 0"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
		...
		return this.ObtenerDatos( lcAtributos, tcHaving, tcOrder, tcFunc, lcWhere, 'AgruPubFER', 'AgruPubliDetalle', tnTope )
	Endfunc
		...
		With this
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAgrupamientodetalle = loItem.Agrupamientodetalle
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubFER("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.FERIADO set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxFeriadoFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxFeriadoFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxFeriadoFmodifw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxFeriadoFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxFeriadoFaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxFeriadoZadsfw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoSmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxFeriadoUaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoVmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxFeriadoSaltafw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxFeriadoValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoUmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxFeriadoHaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoHmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxFeriadoHoraimpo ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxFeriadoBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxFeriadoBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxFeriadoEsttrans ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxFeriadoHoraexpo ) + "'">>, "Tipagrupub" = <<lxFeriadoTipagrupub>>, "Anio" = <<lxFeriadoAnio>>, "Obs" = <<"'" + this.FormatearTextoSql( lxFeriadoObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'FERIADO' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			loColeccion.Agregar([delete from ZooLogic.AgruPubFER where "Codigo" = ] + transform( .oEntidad.ANIO ))
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Anio or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.FERIADO set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, Anio = ] + transform( &lcCursor..Anio )+ [, obs = ] + "'" + this.FormatearTextoSql( &lcCursor..obs ) + "'" + [ Where Anio = ] + transform( lcValorABuscar ) )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, ZADSFW, SMODIFW, UALTAFW, VMODIFW, SALTAFW, VALTAFW, UMODIFW, HALTAFW, HMODIFW, HORAIMPO, BDALTAFW, BDMODIFW, ESTTRANS, HORAEXPO, tipagrupub, Anio, obs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + transform( &lcCursor..tipagrupub ) + ',' + transform( &lcCursor..Anio )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirDetalles() As Void
		...
		If lcCantRegistros > 0
			...
			this.oConexion.EjecutarSql( [Delete From ZooLogic.AgruPubFER Where Codigo] + lcIn  )
	...
	lcDetalle = This.oEntidad.cPrefijoRecibir + 'ITEMAGRUPAPUBLICFER'
	Select * From &lcDetalle into cursor cDetallesExistentes ;
		where Codigo in ( select Anio from &lcCursor )
	select cDetallesExistentes
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","Codigo","Agrup","AgrupDes"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.AgruPubFER ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + transform( cDetallesExistentes.Codigo     ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Agrup      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AgrupDes   ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'FERIADO_OBS'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'ITEMAGRUPAPUBLICFER'
				llRetorno = .T.
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.ANIO = isnull( d.ANIO, t.ANIO ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.FERIADO t inner join deleted d 
							 on t.Anio = d.Anio
							 and  t.Anio = d.Anio
				-- Fin Updates
				insert into ZooLogic.FERIADO(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Zadsfw,Smodifw,Ualtafw,Vmodifw,Saltafw,Valtafw,Umodifw,Haltafw,Hmodifw,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Horaexpo,Tipagrupub,Anio,Obs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.ZADSFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.SALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.TIPAGRUPUB,0),isnull( d.ANIO,0),isnull( d.OBS,'')
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_AgruPubFER( tcTablaTrabajo ) as String

		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_FERIADO_AgruPubFER
ON ZooLogic.TablaTrabajo_FERIADO_AgruPubFER
AFTER DELETE
As
Begin
Update t Set 
...
from ZooLogic.AgruPubFER t inner join deleted d 
 on t.CODIGO = d.CODIGO
-- Fin Updates
insert into ZooLogic.AgruPubFER
( 
"NROITEM",
"CODIGO",
"AGRUP",
...
d.AGRUP,
d.AGRUPDES
From deleted d left join ZooLogic.AgruPubFER pk 
		...
		with this.oEntidad
			...
			if reccount( 'c_FERIADO' ) < 1
				...
				Try
					...
					.Tipoagrupamientopublicaciones = nvl( c_FERIADO.Tipoagrupamientopublicaciones, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="FERIADO                                 " atributo="FECHATRANSFERENCIA                      " tabla="FERIADO        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FERIADO                                 " atributo="ESTADOTRANSFERENCIA                     " tabla="FERIADO        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FERIADO                                 " atributo="TIPOAGRUPAMIENTOPUBLICACIONES           " tabla="FERIADO        " campo="TIPAGRUPUB" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FERIADO                                 " atributo="AGRUPUBLIDETALLE                        " tabla="AGRUPUBFER     " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Agrupamientos                                                                                                                                                   " dominio="DETALLEITEMAGRUPAPUBLICFER    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
