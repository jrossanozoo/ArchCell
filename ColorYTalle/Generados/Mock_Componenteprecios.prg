...
define class Mock_COMPONENTEPRECIOS as MockBase of MockBase.prg

	cClase = 'COMPONENTEPRECIOS'
	...
	lNuevo = .F.                                                                                                                                                                                                                                              
	lProcesarPrecios = .F.                                                                                                                                                                                                                                    
	nSesionDeDatosPropia = 0                                                                                                                                                                                                                                  
	oArbolCombinacionPrecios = Null                                                                                                                                                                                                                           
	oAtributosGenericos = null                                                                                                                                                                                                                                
	oColCombinacionPrecios  = Null                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function agregarsentenciasdeanulacionporentidad( tocolsentencias as zoocoleccion of zoocoleccion.prg ) as zoocoleccion of zoocoleccion.prg                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregarsentenciasdeanulacionporentidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function agregarsentenciasdeeliminacionporentidad( tocolsentencias as zoocoleccion of zoocoleccion.prg ) as zoocoleccion of zoocoleccion.prg                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregarsentenciasdeeliminacionporentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function armarcolecciondecombinaciones( toarbol  as collection, tocolcombinacion as collection, tnnivel as integer, tnnivelmax as integer ) as collection                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = toarbol
		lxParam2 = tocolcombinacion
		lxParam3 = tnnivel
		lxParam4 = tnnivelmax
		...
		return this.ObtenerResultado( 'Armarcolecciondecombinaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function contarhijos( toarbol, lnnronodo ) as integer                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Contarhijos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eslamismabasededatos( tcbasededatos as string ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eslamismabasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existepreciodearticuloencombinaciones( tccodart as string ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Existepreciodearticuloencombinaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function insertarnodo( toarbol, toelementos, tnnroitem, tnnodopadre, tnnivel ) as void                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = toarbol
		lxParam2 = toelementos
		lxParam3 = tnnroitem
		lxParam4 = tnnodopadre
		lxParam5 = tnnivel
		...
		return this.ObtenerResultado( 'Insertarnodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercadenaalpadre( toarbol as collection, loitem as object )as string                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenercadenaalpadre', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercoleccionelementoscombinacion() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercoleccionelementoscombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernodossegunnivel( toarbol, tnnivel as integer ) as collection                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenernodossegunnivel', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerpadre( toarbol, lohijo as object ) as object                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerpadre', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerprecio( toitem as object, tclistadeprecio as string, tcatributo as string, tcbasededatos as string ) as void                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
	...
	*-----------------------------------------------------------------------------------------
	function obtenerprecioqwe( toitem as object, tclistadeprecio as string, tcatributo as string, tcbasededatos as string, tnprecio as number ) as void                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5
		...
		return this.ObtenerResultado( 'Obtenerprecioqwe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolcombinacionesbuscadas_access()                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolcombinacionesbuscadas_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocolcombinacionprecios_access()                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolcombinacionprecios_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function opreciodearticulo_access()                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Opreciodearticulo_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearfechabaseparavigencia( tdfechabase as date ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tdfechabase
		...
		return this.ObtenerResultado( 'Setearfechabaseparavigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaratributosdelitem( toitem as object ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validaratributosdelitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function abrirtablaprecioarauxiliar() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Abrirtablaprecioarauxiliar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cambiarbasededatos( tcbasededatos as string ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function cerrartablaprecioarauxiliar() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cerrartablaprecioarauxiliar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearcursordepreciodearticulo( toentidad as object, tcatributodetalle as string, tccursordetalle as string, tccursorcabecera as string ) as void                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Crearcursordepreciodearticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function formatearcamporseguntipo( tcreferenciaamodificaciondeprecios as string, tccampomp as string) as string                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcreferenciaamodificaciondeprecios
		lxParam2 = tccampomp
		...
		return this.ObtenerResultado( 'Formatearcamporseguntipo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function guardarsesiondedatos() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Guardarsesiondedatos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function mapearcabecera(topreciodearticulo as object) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = topreciodearticulo
		...
		return this.ObtenerResultado( 'Mapearcabecera', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function mapearcampocodigoparacursordepreciodearticulo( toentidad as object, tcmetodoobtenercampodetallemp as string, tomodificaciondeprecios as object, topreciodearticulo as object, tcreferenciaamodificaciondeprecios as string ) as void   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = toentidad
		lxParam2 = tcmetodoobtenercampodetallemp
		lxParam3 = tomodificaciondeprecios
		lxParam4 = topreciodearticulo
		lxParam5 = tcreferenciaamodificaciondeprecios
		...
		return this.ObtenerResultado( 'Mapearcampocodigoparacursordepreciodearticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function mapearcamposcombinacionparacursordepreciodearticulo( toentidad as object, tcmetodoobtenercampodetallemp as string, tomodificaciondeprecios as object, topreciodearticulo as object ) as void                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Mapearcamposcombinacionparacursordepreciodearticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function mapearregistroparacursordepreciodearticulo( toentidad as object, tomodificaciondeprecios as object, topreciodearticulo as object, tccursorpreciodearticulo as string, tcatributodetalle as string, tccursorcabecera as string ) as voi 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6

		lnParametros = pcount()
		lxParam1 = toentidad
		lxParam2 = tomodificaciondeprecios
		lxParam3 = topreciodearticulo
		lxParam4 = tccursorpreciodearticulo
		lxParam5 = tcatributodetalle
		lxParam6 = tccursorcabecera
		...
		return this.ObtenerResultado( 'Mapearregistroparacursordepreciodearticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function modificaritemseguncombinacion( toitem, tnindice ) as object                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Modificaritemseguncombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccioncombinaciones() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercoleccioncombinaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerconcatenacionatributoscombinacion( toitem as object ) as string                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerconcatenacionatributoscombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerconcatenacionatributoscombinacionconseparador( toitem as object ) as string                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerconcatenacionatributoscombinacionconseparador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemtemporal( toitem ) as object                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obteneritemtemporal', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertimestampaltamodificar( toitem as object, tclistadeprecio as string ) as void                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenertimestampaltamodificar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenervalorpreciocombinacion( toitem as object, tclistadeprecio as string ) as number                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenervalorpreciocombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function preparartablaspararecibir( toentidad as entidad of entidad.prg ) as zoocoleccion of zoocoleccion.prg                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Preparartablaspararecibir', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function procesarexpresionfinalparacampocodigocursordepreciodearticulo( tcexpresion as string, tcreferenciaamodificaciondeprecios as string ) as string                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcexpresion
		lxParam2 = tcreferenciaamodificaciondeprecios
		...
		return this.ObtenerResultado( 'Procesarexpresionfinalparacampocodigocursordepreciodearticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function procesarprecio( toitem as object, tclistadeprecio as string, tcatributo as string, tcbasededatos as string, tnprecio as number ) as void                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5
		...
		return this.ObtenerResultado( 'Procesarprecio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function restaurarsesiondedatos() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function setearsesiondedatos( tndatasessionid as integer ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearsesiondedatos', lcParametros )
	EndFunc
