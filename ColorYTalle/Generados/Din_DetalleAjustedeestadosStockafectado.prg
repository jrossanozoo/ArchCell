...
define class Din_DetalleAJUSTEDEESTADOSStockafectado as DetalleAjustecombinacionestados of DetalleAjustecombinacionestados.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemAJUSTEDEESTADOSStockafectado' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		scan for &lcFiltro
			...
			loItem.Situacion = c_Stockafectado.Situacion
			...
			loItem.Talle_PK = c_Stockafectado.Talle
			loItem.TalleDetalle = c_Stockafectado.TalleDetalle
