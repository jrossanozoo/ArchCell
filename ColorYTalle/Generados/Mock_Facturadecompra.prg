...
define class Mock_facturadecompra as MockBase of MockBase.prg
	...
	cComprobante = ""                                                                                                                                                                                                                                         
	cComprobante = "FACTURADECOMPRA"                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Factura de compra"                                                                                                                                                                                                                       
	...
	lActivando = .f.                                                                                                                                                                                                                                          
	lActualizaPreciosPorCambioDeFecha = .t.                                                                                                                                                                                                                   
	...
	lEsEntidadConPuntoDeVentaExtendido = .t.                                                                                                                                                                                                                  
	lEsExe = .f.                                                                                                                                                                                                                                              
	lEsSubEntidad = .f.                                                                                                                                                                                                                                       
	lEstaElKontroler = .f.                                                                                                                                                                                                                                    
	...
	oColaboradorSugerirMontoDeImpuestos = null                                                                                                                                                                                                                
	...
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oCompEnBaseA = null                                                                                                                                                                                                                                       
	oCompTipoDeComprobanteDeCompra = null                                                                                                                                                                                                                     
	oComponente = null                                                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function descripcionfw_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'FACTURADECOMPRA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descripcionfw_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descripcionfw_access', lcParametros )			endif		endif		local lcLetra as String		if this.lDestroy		else			lcLetra = alltrim( this.letra )			if this.nPais = 3				this.DescripcionFW = alltrim( transform( This.cComprobante + " " + lcLetra + "-" + " " + transform( This.Numero, "@LZ 99999999" ) ) )			else				this.DescripcionFW = alltrim( transform( This.cComprobante + " " + lcLetra + " " + transform( This.PuntoDeVentaExtendido, "@LZ 99999" ) + "-" + transform( This.Numero, "@LZ 99999999" ) ) )						endif		endif		return this.DescripcionFW
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarsiactualizapreciosporcambiodefecha() as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntarsiactualizapreciosporcambiodefecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventosugerirmontoimpuesto( txatributo as variant, txitemimpuesto as variant) as void                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = txatributo
		lxParam2 = txitemimpuesto
		...
		return this.ObtenerResultado( 'Eventosugerirmontoimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function letra_despuesdeasignar() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Letra_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermensajerecalculopreciosporcambiofechaemision() as string                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermensajerecalculopreciosporcambiofechaemision', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersignodemovimientoregistroconciliable( todetalel as object ) as integer                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function ocomptipodecomprobantedecompra_access() as variant                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'FACTURADECOMPRA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocomptipodecomprobantedecompra_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocomptipodecomprobantedecompra_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oCompTipodecomprobantedecompra ) = 'O' or isnull( this.oCompTipodecomprobantedecompra ) )			this.oCompTipodecomprobantedecompra = _Screen.zoo.InstanciarComponente( 'ComponenteTipodecomprobantedecompra' )		this.oCompTipodecomprobantedecompra.Inicializar()		this.enlazar( 'oCompTipodecomprobantedecompra.EventoObtenerLogueo', 'inyectarLogueo' )		this.enlazar( 'oCompTipodecomprobantedecompra.EventoObtenerInformacion', 'inyectarInformacion' )		endif		return this.oCompTipodecomprobantedecompra
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puntodeventaextendido_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FACTURADECOMPRA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'puntodeventaextendido_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'puntodeventaextendido_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Puntodeventaextendido		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Puntodeventaextendido( lxVal )				this.Setear_Puntodeventaextendido( lxVal )			EndIf		Else			This.Setear_Puntodeventaextendido( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numint( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FACTURADECOMPRA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numint', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numint', lcParametros )			endif		endif		this.Numint = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sugerirmontoimpuesto( toitemimpuesto as object ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toitemimpuesto
		...
		return this.ObtenerResultado( 'Sugerirmontoimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numint( txval as variant ) as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FACTURADECOMPRA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numint', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numint', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_puntodeventaextendido( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FACTURADECOMPRA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_puntodeventaextendido', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_puntodeventaextendido', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardominio_fechacomprobantedecompra( txval as variant ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validardominio_fechacomprobantedecompra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechafactura() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechafactura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarnumint() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarnumint', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartipocomprobanterg1361() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validartipocomprobanterg1361', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocai() as void                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridocai', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoimpuestos() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumint() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridonumint', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopuntodeventaextendido() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridopuntodeventaextendido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipocomprobanterg1361() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotipocomprobanterg1361', lcParametros )
	EndFunc
