...
define class Din_EntidadNotadecreditoelectronicaexportacion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Notadecreditoelectronicaexportacion"
	cClaseResponse = this.cNamespaceDTOs + ".NotadecreditoelectronicaexportacionResponse"
	cClaseModelo = "NotadecreditoelectronicaexportacionModelo"
	cEntidad = "Notadecreditoelectronicaexportacion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaexportacionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaexportacionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaexportacionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "NotadecreditoelectronicaexportacionModelo"
		endcase
		return lcRetorno
