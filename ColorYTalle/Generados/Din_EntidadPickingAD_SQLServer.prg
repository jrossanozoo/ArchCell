...
define class Din_EntidadPICKINGAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxPickingFmodifw, lxPickingFectrans, lxPickingFecimpo, lxPickingFaltafw, lxPickingFecexpo, lxPickingNumero, lxPickingValtafw, lxPickingUmodifw, lxPickingVmodifw, lxPickingHaltafw, lxPickingZadsfw, lxPickingHoraexpo, lxPickingHoraimpo, lxPickingHmodifw, lxPickingSmodifw, lxPickingSaltafw, lxPickingUaltafw, lxPickingBdmodifw, lxPickingBdaltafw, lxPickingEsttrans, lxPickingPrepm, lxPickingCodigo, lxPickingObs, lxPickingFecha, lxPickingComporigen, lxPickingVendedor, lxPickingFperson, lxPickingFcliente
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PICKING ( "Fmodifw","Fectrans","Fecimpo","Faltafw","Fecexpo","Numero","Valtafw","Umodifw","Vmodifw","Haltafw","Zadsfw","Horaexpo","Horaimpo","Hmodifw","Smodifw","Saltafw","Ualtafw","Bdmodifw","Bdaltafw","Esttrans","Prepm","Codigo","Obs","Fecha","Comporigen","Vendedor","Fperson","Fcliente" ) values ( <<"'" + this.ConvertirDateSql( lxPickingFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPickingFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPickingFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPickingFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPickingFecexpo ) + "'" >>, <<lxPickingNumero >>, <<"'" + this.FormatearTextoSql( lxPickingValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingEsttrans ) + "'" >>, <<iif( lxPickingPrepm, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxPickingCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingObs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPickingFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingComporigen ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingVendedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingFperson ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPickingFcliente ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DetalleDiferencias
				if this.oEntidad.DetalleDiferencias.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetDifPicking("DPArticulo","COMP","NROITEM","ProcStock","Equiv","Codigo","DPDescArt","DPColor","DPDescColo","DPTalle","DPCantidad" ) values ( <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DetalleControlado
				if this.oEntidad.DetalleControlado.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetOkPicking("COMP","NROITEM","ProcStock","Agregado","OPArticulo","Equiv","Codigo","OPDescArt","OPColor","OPDescColo","OPTalle","OPCantidad","AfeSaldo" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<iif( lxAgregado, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>>, <<lxAfe_saldo>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DetalleCoincidencias
				if this.oEntidad.DetalleCoincidencias.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetConPicking("CPArticulo","NROITEM","CPEquiv","Codigo","CPColor","CPTalle","CPCantidad" ) values ( <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DetalleDiferenciasOriginal
				if this.oEntidad.DetalleDiferenciasOriginal.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetDifOPicking("Articulo","COMP","NROITEM","Equivalenc","Codigo","cColor","Talle","Cantidad" ) values ( <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxComportamiento>>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DetallePreparacionMercaderia
				if this.oEntidad.DetallePreparacionMercaderia.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetPrepMPicking("NROITEM","COMP","Codigo","Articulo","cColor","Talle","CantAfe","Equiv","CodigoOri","IdItem","CantOri" ) values ( <<lxNroitem>>, <<lxComportamiento>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidadafectada>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigoori_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxIditemarticulos ) + "'">>, <<lxCantidadoriginal>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DetalleComprobantes
				if this.oEntidad.DetalleComprobantes.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetCompPicking("Cliente","Cod_Afe","NROITEM","EntregaPos","tscomp","Codigo","CPNumero","FechaComp","OriDes","REMITO","OriDesDesc","Cantidad","IdCaja" ) values ( <<"'" + this.FormatearTextoSql( lxCliente ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigocompafe ) + "'">>, <<lxNroitem>>, <<lxEntregaposterior>>, <<lxTimestampcomprobante>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumero ) + "'">>, <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<"'" + this.FormatearTextoSql( lxOrigendestino_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxRemito ) + "'">>, <<"'" + this.FormatearTextoSql( lxOrigendestinodetalle ) + "'">>, <<lxCantidad>>, <<"'" + this.FormatearTextoSql( lxIddecaja ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.PICKING set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxPickingFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxPickingFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxPickingFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxPickingFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxPickingFecexpo ) + "'">>,"Numero" = <<lxPickingNumero>>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxPickingValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxPickingUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxPickingVmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxPickingHaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxPickingZadsfw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxPickingHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxPickingHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxPickingHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxPickingSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxPickingSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxPickingUaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPickingBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPickingBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxPickingEsttrans ) + "'">>,"Prepm" = <<iif( lxPickingPrepm, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxPickingCodigo ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxPickingObs ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxPickingFecha ) + "'">>,"Comporigen" = <<"'" + this.FormatearTextoSql( lxPickingComporigen ) + "'">>,"Vendedor" = <<"'" + this.FormatearTextoSql( lxPickingVendedor ) + "'">>,"Fperson" = <<"'" + this.FormatearTextoSql( lxPickingFperson ) + "'">>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxPickingFcliente ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxPickingCodigo ) + "'">> and  PICKING.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Numero" as "Numero", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Prepm" as "Espreparaciondemercaderia", "Codigo" as "Codigo", "Obs" as "Obs", "Fecha" as "Fecha", "Comporigen" as "Tipocomprobanteorigen", "Vendedor" as "Vendedor", "Fperson" as "Cliente", "Fcliente" as "Clientedescripcion" from ZooLogic.PICKING where "Codigo" = <<"'" + this.FormatearTextoSql( lxPickingCodigo ) + "'">> and  PICKING.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Dparticulo" as "Articulo", "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Equiv" as "Equivalencia", "Codigo" as "Codigo", "Dpdescart" as "Articulodetalle", "Dpcolor" as "Color", "Dpdesccolo" as "Colordetalle", "Dptalle" as "Talle", "Dpcantidad" as "Cantidad" from ZooLogic.DetDifPicking where Codigo = <<"'" + this.FormatearTextoSql( c_PICKING.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Agregado" as "Agregado", "Oparticulo" as "Articulo", "Equiv" as "Equivalencia", "Codigo" as "Codigo", "Opdescart" as "Articulodetalle", "Opcolor" as "Color", "Opdesccolo" as "Colordetalle", "Optalle" as "Talle", "Opcantidad" as "Cantidad", "Afesaldo" as "Afe_saldo" from ZooLogic.DetOkPicking where Codigo = <<"'" + this.FormatearTextoSql( c_PICKING.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Cparticulo" as "Articulo", "Nroitem" as "Nroitem", "Cpequiv" as "Equivalencia", "Codigo" as "Codigo", "Cpcolor" as "Color", "Cptalle" as "Talle", "Cpcantidad" as "Cantidad" from ZooLogic.DetConPicking where Codigo = <<"'" + this.FormatearTextoSql( c_PICKING.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Articulo" as "Articulo", "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Equivalenc" as "Equivalencia", "Codigo" as "Codigo", "Ccolor" as "Color", "Talle" as "Talle", "Cantidad" as "Cantidad" from ZooLogic.DetDifOPicking where Codigo = <<"'" + this.FormatearTextoSql( c_PICKING.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Comp" as "Comportamiento", "Codigo" as "Codigo", "Articulo" as "Articulo", "Ccolor" as "Color", "Talle" as "Talle", "Cantafe" as "Cantidadafectada", "Equiv" as "Equivalencia", "Codigoori" as "Codigoori", "Iditem" as "Iditemarticulos", "Cantori" as "Cantidadoriginal" from ZooLogic.DetPrepMPicking where Codigo = <<"'" + this.FormatearTextoSql( c_PICKING.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecimpo,Faltafw,Fecexpo,Numero,Valtafw,Umodifw,Vmodifw,Haltafw,Zadsfw,Horae" + ;
"xpo,Horaimpo,Hmodifw,Smodifw,Saltafw,Ualtafw,Bdmodifw,Bdaltafw,Esttrans,Prepm,Codigo,Obs,Fecha,Compo" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Numero" as "Numero", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Prepm" as "Espreparaciondemercaderia", "Codigo" as "Codigo", "Obs" as "Obs", "Fecha" as "Fecha", "Comporigen" as "Tipocomprobanteorigen", "Vendedor" as "Vendedor", "Fperson" as "Cliente", "Fcliente" as "Clientedescripcion"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleDiferencias( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Dparticulo" as "Articulo", "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Equiv" as "Equivalencia", "Codigo" as "Codigo", "Dpdescart" as "Articulodetalle", "Dpcolor" as "Color", "Dpdesccolo" as "Colordetalle", "Dptalle" as "Talle", "Dpcantidad" as "Cantidad"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleControlado( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Agregado" as "Agregado", "Oparticulo" as "Articulo", "Equiv" as "Equivalencia", "Codigo" as "Codigo", "Opdescart" as "Articulodetalle", "Opcolor" as "Color", "Opdesccolo" as "Colordetalle", "Optalle" as "Talle", "Opcantidad" as "Cantidad", "Afesaldo" as "Afe_saldo"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleCoincidencias( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Cparticulo" as "Articulo", "Nroitem" as "Nroitem", "Cpequiv" as "Equivalencia", "Codigo" as "Codigo", "Cpcolor" as "Color", "Cptalle" as "Talle", "Cpcantidad" as "Cantidad"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleDiferenciasOriginal( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Articulo" as "Articulo", "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Equivalenc" as "Equivalencia", "Codigo" as "Codigo", "Ccolor" as "Color", "Talle" as "Talle", "Cantidad" as "Cantidad"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetallePreparacionMercaderia( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Comp" as "Comportamiento", "Codigo" as "Codigo", "Articulo" as "Articulo", "Ccolor" as "Color", "Talle" as "Talle", "Cantafe" as "Cantidadafectada", "Equiv" as "Equivalencia", "Codigoori" as "Codigoori", "Iditem" as "Iditemarticulos", "Cantori" as "Cantidadoriginal"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleComprobantes( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Cliente" as "Cliente", "Cod_afe" as "Codigocompafe", "Nroitem" as "Nroitem", "Entregapos" as "Entregaposterior", "Tscomp" as "Timestampcomprobante", "Codigo" as "Codigo", "Cpnumero" as "Numero", "Fechacomp" as "Fecha", "Orides" as "Origendestino", "Remito" as "Remito", "Oridesdesc" as "Origendestinodetalle", "Cantidad" as "Cantidad", "Idcaja" as "Iddecaja"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.DetalleDiferencias
				if this.oEntidad.DetalleDiferencias.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetDifPicking("DPArticulo","COMP","NROITEM","ProcStock","Equiv","Codigo","DPDescArt","DPColor","DPDescColo","DPTalle","DPCantidad" ) values ( <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.DetalleControlado
				if this.oEntidad.DetalleControlado.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAfe_saldo = loItem.Afe_saldo
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetOkPicking("COMP","NROITEM","ProcStock","Agregado","OPArticulo","Equiv","Codigo","OPDescArt","OPColor","OPDescColo","OPTalle","OPCantidad","AfeSaldo" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<iif( lxAgregado, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>>, <<lxAfe_saldo>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.DetalleCoincidencias
				if this.oEntidad.DetalleCoincidencias.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetConPicking("CPArticulo","NROITEM","CPEquiv","Codigo","CPColor","CPTalle","CPCantidad" ) values ( <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.DetalleDiferenciasOriginal
				if this.oEntidad.DetalleDiferenciasOriginal.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetDifOPicking("Articulo","COMP","NROITEM","Equivalenc","Codigo","cColor","Talle","Cantidad" ) values ( <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxComportamiento>>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidad>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.DetallePreparacionMercaderia
				if this.oEntidad.DetallePreparacionMercaderia.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidadoriginal = loItem.Cantidadoriginal
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetPrepMPicking("NROITEM","COMP","Codigo","Articulo","cColor","Talle","CantAfe","Equiv","CodigoOri","IdItem","CantOri" ) values ( <<lxNroitem>>, <<lxComportamiento>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle_PK ) + "'">>, <<lxCantidadafectada>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigoori_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxIditemarticulos ) + "'">>, <<lxCantidadoriginal>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.DetalleComprobantes
				if this.oEntidad.DetalleComprobantes.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxIddecaja = loItem.Iddecaja
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DetCompPicking("Cliente","Cod_Afe","NROITEM","EntregaPos","tscomp","Codigo","CPNumero","FechaComp","OriDes","REMITO","OriDesDesc","Cantidad","IdCaja" ) values ( <<"'" + this.FormatearTextoSql( lxCliente ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigocompafe ) + "'">>, <<lxNroitem>>, <<lxEntregaposterior>>, <<lxTimestampcomprobante>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxNumero ) + "'">>, <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<"'" + this.FormatearTextoSql( lxOrigendestino_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxRemito ) + "'">>, <<"'" + this.FormatearTextoSql( lxOrigendestinodetalle ) + "'">>, <<lxCantidad>>, <<"'" + this.FormatearTextoSql( lxIddecaja ) + "'">> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.PICKING set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, PrepM = ] + Transform( iif( &lcCursor..PrepM, 1, 0 ))+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, CompOrigen = ] + "'" + this.FormatearTextoSql( &lcCursor..CompOrigen ) + "'"+ [, Vendedor = ] + "'" + this.FormatearTextoSql( &lcCursor..Vendedor ) + "'"+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FMODIFW, FECTRANS, FECIMPO, FALTAFW, FECEXPO, Numero, VALTAFW, UMODIFW, VMODIFW, HALTAFW, ZADSFW, HORAEXPO, HORAIMPO, HMODIFW, SMODIFW, SALTAFW, UALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, PrepM, Codigo, Obs, Fecha, CompOrigen, Vendedor, FPerson, FCLIENTE
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + Transform( iif( &lcCursor..PrepM, 1, 0 ))
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"DPArticulo","COMP","NROITEM","ProcStock","Equiv","Codigo","DPDescArt","DPColor","DPDescColo","DPTalle","DPCantidad"
		endText
	...
	Scan All
		Text to lcCamposInsert noShow
			"COMP","NROITEM","ProcStock","Agregado","OPArticulo","Equiv","Codigo","OPDescArt","OPColor","OPDescColo","OPTalle","OPCantidad","AfeSaldo"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.DetOkPicking ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.COMP       ) + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + Transform( iif( cDetallesExistentes.ProcStock , 1, 0 )) + ',' + Transform( iif( cDetallesExistentes.Agregado  , 1, 0 )) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPArticulo ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Equiv      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPDescArt  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPColor    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPDescColo ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OPTalle    ) + "'" + ',' + transform( cDetallesExistentes.OPCantidad ) + ',' + transform( cDetallesExistentes.AfeSaldo   ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	...
	Scan All
		Text to lcCamposInsert noShow
			"CPArticulo","NROITEM","CPEquiv","Codigo","CPColor","CPTalle","CPCantidad"
		endText
	...
	Scan All
		Text to lcCamposInsert noShow
			"Articulo","COMP","NROITEM","Equivalenc","Codigo","cColor","Talle","Cantidad"
		endText
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","COMP","Codigo","Articulo","cColor","Talle","CantAfe","Equiv","CodigoOri","IdItem","CantOri"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.DetPrepMPicking ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + transform( cDetallesExistentes.COMP       ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Articulo   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.cColor     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Talle      ) + "'" + ',' + transform( cDetallesExistentes.CantAfe    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Equiv      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.CodigoOri  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.IdItem     ) + "'" + ',' + transform( cDetallesExistentes.CantOri    ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	...
	Scan All
		Text to lcCamposInsert noShow
			"Cliente","Cod_Afe","NROITEM","EntregaPos","tscomp","Codigo","CPNumero","FechaComp","OriDes","REMITO","OriDesDesc","Cantidad","IdCaja"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.DetCompPicking ( ] + lcCamposInsert + [ ) values ( ] +  "'" + this.FormatearTextoSql( cDetallesExistentes.Cliente    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Cod_Afe    ) + "'" + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + transform( cDetallesExistentes.EntregaPos ) + ',' + transform( cDetallesExistentes.tscomp     ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.CPNumero   ) + "'" + ',' + "'" + this.ConvertirDateSql( cDetallesExistentes.FechaComp  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OriDes     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.REMITO     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.OriDesDesc ) + "'" + ',' + transform( cDetallesExistentes.Cantidad   ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.IdCaja     ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.PREPM = isnull( d.PREPM, t.PREPM ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.OBS = isnull( d.OBS, t.OBS ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.COMPORIGEN = isnull( d.COMPORIGEN, t.COMPORIGEN ),t.VENDEDOR = isnull( d.VENDEDOR, t.VENDEDOR ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE )
					from ZooLogic.PICKING t inner join deleted d 
							 on t.Codigo = d.Codigo
							 and  t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.PICKING(Fmodifw,Fectrans,Fecimpo,Faltafw,Fecexpo,Numero,Valtafw,Umodifw,Vmodifw,Haltafw,Zadsfw,Horaexpo,Horaimpo,Hmodifw,Smodifw,Saltafw,Ualtafw,Bdmodifw,Bdaltafw,Esttrans,Prepm,Codigo,Obs,Fecha,Comporigen,Vendedor,Fperson,Fcliente)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.NUMERO,0),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.ZADSFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.PREPM,0),isnull( d.CODIGO,''),isnull( d.OBS,''),isnull( d.FECHA,''),isnull( d.COMPORIGEN,''),isnull( d.VENDEDOR,''),isnull( d.FPERSON,''),isnull( d.FCLIENTE,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="PICKING                                 " atributo="FECHATRANSFERENCIA                      " tabla="PICKING        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PICKING                                 " atributo="ESTADOTRANSFERENCIA                     " tabla="PICKING        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PICKING                                 " atributo="VENDEDOR                                " tabla="PICKING        " campo="VENDEDOR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PICKING                                 " atributo="CLIENTE                                 " tabla="PICKING        " campo="FPERSON   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Cliente                                                                                                                                                         " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PICKING                                 " atributo="CLIENTEDESCRIPCION                      " tabla="PICKING        " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Cliente descripción                                                                                                                                             " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="185" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="13" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On PICKING.FPERSON = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                            " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
...
<VFPData xml:space="preserve">
	...
	<row entidad="ITEMOKPICKING                           " atributo="ARTICULO                                " tabla="DETOKPICKING   " campo="OPARTICULO" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="201" etiqueta="DetalleArtículosControlados, Artículo                                                                                                                           " dominio="CONSOPORTEPREPANTALLA         " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DETOKPICKING On PICKING.Codigo = DETOKPICKING.Codigo And  PICKING.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMOKPICKING                           " atributo="ARTICULODETALLE                         " tabla="DETOKPICKING   " campo="OPDESCART " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="202" etiqueta="DetalleArtículosControlados, Articulo descripción                                                                                                               " dominio="DESCRIPCION                   " detalle="false" tipo="I" atributoforaneo="Articulo.Descripcion                                                                                                                                                                                                                                          " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DETOKPICKING On PICKING.Codigo = DETOKPICKING.Codigo And  PICKING.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMOKPICKING                           " atributo="COLOR                                   " tabla="DETOKPICKING   " campo="OPCOLOR   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="203" etiqueta="DetalleArtículosControlados, Color                                                                                                                              " dominio="CODIGO                        " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DETOKPICKING On PICKING.Codigo = DETOKPICKING.Codigo And  PICKING.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMOKPICKING                           " atributo="COLORDETALLE                            " tabla="DETOKPICKING   " campo="OPDESCCOLO" claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="204" etiqueta="DetalleArtículosControlados, Color descripción                                                                                                                  " dominio="DESCRIPCION                   " detalle="false" tipo="I" atributoforaneo="Color.Descripcion                                                                                                                                                                                                                                             " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DETOKPICKING On PICKING.Codigo = DETOKPICKING.Codigo And  PICKING.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMOKPICKING                           " atributo="TALLE                                   " tabla="DETOKPICKING   " campo="OPTALLE   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TALLE                                   " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="205" etiqueta="DetalleArtículosControlados, Talle                                                                                                                              " dominio="CODIGO                        " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DETOKPICKING On PICKING.Codigo = DETOKPICKING.Codigo And  PICKING.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMOKPICKING                           " atributo="CANTIDAD                                " tabla="DETOKPICKING   " campo="OPCANTIDAD" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="206" etiqueta="DetalleArtículosControlados, Cantidad                                                                                                                           " dominio="NUMERICODECIMALPARAMETRIZADO  " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DETOKPICKING On PICKING.Codigo = DETOKPICKING.Codigo And  PICKING.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMOKPICKING                           " atributo="AFE_SALDO                               " tabla="DETOKPICKING   " campo="AFESALDO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="1" etiqueta="DetalleArtículosControlados, Saldo                                                                                                                              " dominio="NUMERICO                      " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join DETOKPICKING On PICKING.Codigo = DETOKPICKING.Codigo And  PICKING.CODIGO != ''                                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="false" incluiratrib="true" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
