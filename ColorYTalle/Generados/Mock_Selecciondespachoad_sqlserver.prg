...
define class Mock_Selecciondespachoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Selecciondespachoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalledetallearticulosdespachos( tcatributo as string ) as string                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercampodetalledetallearticulosdespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalledetallearticulosdespachos( tccampos as string ) as string                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalledetallearticulosdespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalledetallearticulosdespachos( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalledetallearticulosdespachos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_despseldet( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_despseldet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalledetallearticulosdespachos( tccampos as string ) as string                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Parsearcamposdetalledetallearticulosdespachos', lcParametros )
	EndFunc
