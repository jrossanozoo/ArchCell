...
define class Mock_chequesdisponibles as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Detalle de cheques disponibles"                                                                                                                                                                                                          
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'CHEQUESDISPONIBLES'                                                                                                                                                                                                                            
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function agregarchequealagrilla( toitem as object ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregarchequealagrilla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecheques() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallecheques', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cheques_access() as variant                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUESDISPONIBLES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cheques_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cheques_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Cheques ) = 'O' or isnull( this.Cheques ) )			this.Cheques = this.crearobjeto( 'Din_DetalleChequesdisponiblesCheques' )			this.Cheques.inicializar()			this.enlazar( 'Cheques.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Cheques.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Cheques, 'CambioSumarizado', this, 'CambiosDetalleCheques', 1)			this.enlazar( 'Cheques.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Cheques.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Cheques
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventodetalledechequescambio() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventodetalledechequescambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarchequesdisponibles( tochequesdisponibles as object ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tochequesdisponibles
		...
		return this.ObtenerResultado( 'Inyectarchequesdisponibles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerchequesseleccionados() as zoocoleccion of zoocoleccion                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerchequesseleccionados', lcParametros )
	EndFunc
