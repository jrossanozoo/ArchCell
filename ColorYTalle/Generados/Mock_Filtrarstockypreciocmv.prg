...
define class Mock_filtrarstockypreciocmv as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Filtros para procesar stock y precios para CMV"                                                                                                                                                                                          
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'FILTRARSTOCKYPRECIOCMV'                                                                                                                                                                                                                        
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function oejerciciocontable_access() as object                                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'FILTRARSTOCKYPRECIOCMV' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oejerciciocontable_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oejerciciocontable_access', lcParametros )			endif		endif		if !this.lDestroy and ( type( "this.oEjercicioContable" ) <> "O" or isnull( this.oEjercicioContable ) )			this.oEjercicioContable = _screen.zoo.instanciarentidad( "Ejercicio" )		endif		return this.oEjercicioContable
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechasingresadascontraejercicio() as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechasingresadascontraejercicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerultimonumerodeejerciciocontableabierto() as number                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerultimonumerodeejerciciocontableabierto', lcParametros )
	EndFunc
