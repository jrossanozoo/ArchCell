...
define class Din_DetalleNOTADECREDITOELECTRONICADECREDITOKitsdetalle as DetalleKits of DetalleKits.Prg
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.CargoParticipantes = this.Item[ tnItem ].CargoParticipantes
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'CargoParticipantes', .CargoParticipantes )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.CargoParticipantes = this.oItem.CargoParticipantes
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].CargoParticipantes = .oItem.CargoParticipantes
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Kitsdetalle' ) > 0 and reccount( 'c_Kitsdetalle' ) > 0
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemNOTADECREDITOELECTRONICADECREDITOKitsdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Kitsdetalle
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Articulo_PK = c_Kitsdetalle.Articulo
			loItem.Codigo = c_Kitsdetalle.Codigo
			loItem.MontoPorcentajeDescuentoConImpuesto = c_Kitsdetalle.MontoPorcentajeDescuentoConImpuesto
			loItem.Kit = c_Kitsdetalle.Kit
			loItem.MontoCFI = c_Kitsdetalle.MontoCFI
			loItem.MontoDTO1 = c_Kitsdetalle.MontoDTO1
			loItem.MontoIVA = c_Kitsdetalle.MontoIVA
			loItem.Neto = c_Kitsdetalle.Neto
			loItem.NroItem = c_Kitsdetalle.NroItem
			loItem.Oferta = c_Kitsdetalle.Oferta
			loItem.PorcentajeCFI = c_Kitsdetalle.PorcentajeCFI
			loItem.PorcentajeDTO1 = c_Kitsdetalle.PorcentajeDTO1
			loItem.PorcentajeIVA = c_Kitsdetalle.PorcentajeIVA
			loItem.PrecioConImpuestos = c_Kitsdetalle.PrecioConImpuestos
			loItem.PrecioSinImpuestos = c_Kitsdetalle.PrecioSinImpuestos
			loItem.PrecioUnitario = c_Kitsdetalle.PrecioUnitario
			loItem.TipoListaDePrecio = c_Kitsdetalle.TipoListaDePrecio
			loItem.Unidad_PK = c_Kitsdetalle.Unidad
			loItem.idItem = c_Kitsdetalle.idItem
			loItem.idOrigen = c_Kitsdetalle.idOrigen
			loItem.Afe_NroItem = c_Kitsdetalle.Afe_NroItem
			loItem.Afe_TipoComprobante = c_Kitsdetalle.Afe_TipoComprobante
			loItem.Afe_Letra = c_Kitsdetalle.Afe_Letra
			loItem.Afe_PuntoDeVenta = c_Kitsdetalle.Afe_PuntoDeVenta
			loItem.Afe_Numero = c_Kitsdetalle.Afe_Numero
			loItem.Afe_Cantidad = c_Kitsdetalle.Afe_Cantidad
			loItem.Afe_Saldo = c_Kitsdetalle.Afe_Saldo
			loItem.Articulo_CondicionIvaVentas = c_Kitsdetalle.Articulo_CondicionIvaVentas
			loItem.Articulo_PorcentajeIvaVentas = c_Kitsdetalle.Articulo_PorcentajeIvaVentas
			loItem.NoProcesarStock = c_Kitsdetalle.NoProcesarStock
			loItem.Afe_timeStamp = c_Kitsdetalle.Afe_timeStamp
			loItem.MontoProrrateoRecargoConImpuestos = c_Kitsdetalle.MontoProrrateoRecargoConImpuestos
			loItem.MontoProrrateoTotal = c_Kitsdetalle.MontoProrrateoTotal
			loItem.MontoProrrateoPercepciones = c_Kitsdetalle.MontoProrrateoPercepciones
			loItem.MontoProrrateoDescuentoConImpuestos = c_Kitsdetalle.MontoProrrateoDescuentoConImpuestos
			loItem.MontoProrrateoRecargoSinImpuestos = c_Kitsdetalle.MontoProrrateoRecargoSinImpuestos
			loItem.MontoProrrateoDescuentoSinImpuestos = c_Kitsdetalle.MontoProrrateoDescuentoSinImpuestos
			loItem.MontoPorcentajeDescuentoSinImpuesto = c_Kitsdetalle.MontoPorcentajeDescuentoSinImpuesto
			loItem.MontoDescuentoConImpuestos = c_Kitsdetalle.MontoDescuentoConImpuestos
			loItem.MontoDescuentoSinImpuestos = c_Kitsdetalle.MontoDescuentoSinImpuestos
			loItem.PrecioSinImpuestosSinRedondear = c_Kitsdetalle.PrecioSinImpuestosSinRedondear
			loItem.PrecioConImpuestosSinRedondear = c_Kitsdetalle.PrecioConImpuestosSinRedondear
			loItem.PrecioSinRedondear = c_Kitsdetalle.PrecioSinRedondear
			loItem.UsarPrecioDeLista = c_Kitsdetalle.UsarPrecioDeLista
			loItem.Bruto = c_Kitsdetalle.Bruto
			loItem.AjustePorRedondeoConImpuestos = c_Kitsdetalle.AjustePorRedondeoConImpuestos
			loItem.AjustePorRedondeoSinImpuestos = c_Kitsdetalle.AjustePorRedondeoSinImpuestos
			loItem.IdItemArticulos = c_Kitsdetalle.IdItemArticulos
			loItem.CodigoGTIN = c_Kitsdetalle.CodigoGTIN
			loItem.TasaImpuestoInterno = c_Kitsdetalle.TasaImpuestoInterno
			loItem.MontoImpuestoInterno = c_Kitsdetalle.MontoImpuestoInterno
			loItem.RestringirDescuentos = c_Kitsdetalle.RestringirDescuentos
			loItem.Afe_Codigo = c_Kitsdetalle.Afe_Codigo
			loItem.TieneRestriccion = c_Kitsdetalle.TieneRestriccion
			loItem.CodigoMotivoDevolucion_PK = c_Kitsdetalle.CodigoMotivoDevolucion
			loItem.CodigoMotivoDescuento_PK = c_Kitsdetalle.CodigoMotivoDescuento
			loItem.CodigoAutorizacionDJCP = c_Kitsdetalle.CodigoAutorizacionDJCP
			loItem.Comportamiento = c_Kitsdetalle.Comportamiento
			loItem.IdKit = c_Kitsdetalle.IdKit
			loItem.afe_SaldoLiquidacion = c_Kitsdetalle.afe_SaldoLiquidacion
			loItem.NumeroGiftCard_PK = c_Kitsdetalle.NumeroGiftCard
			loItem.PercepcionIvaRG5329 = c_Kitsdetalle.PercepcionIvaRG5329
			loItem.Equivalencia_PK = c_Kitsdetalle.Equivalencia
			loItem.ArticuloDetalle = c_Kitsdetalle.ArticuloDetalle
			loItem.Color_PK = c_Kitsdetalle.Color
			loItem.ColorDetalle = c_Kitsdetalle.ColorDetalle
			loItem.MontoProrrateoIVA = c_Kitsdetalle.MontoProrrateoIVA
			loItem.MontoProrrateoImpuestoInterno = c_Kitsdetalle.MontoProrrateoImpuestoInterno
			loItem.IDSeniaCancelada = c_Kitsdetalle.IDSeniaCancelada
			loItem.Talle_PK = c_Kitsdetalle.Talle
			loItem.TalleDetalle = c_Kitsdetalle.TalleDetalle
			loItem.Cantidad = c_Kitsdetalle.Cantidad
			loItem.Precio = c_Kitsdetalle.Precio
			loItem.Descuento = c_Kitsdetalle.Descuento
			loItem.MontoDescuento = c_Kitsdetalle.MontoDescuento
			loItem.Monto = c_Kitsdetalle.Monto
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Cargoparticipantes = toItemOrigen.Cargoparticipantes
