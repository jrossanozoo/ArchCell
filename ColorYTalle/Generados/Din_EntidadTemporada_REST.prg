...
define class Din_EntidadTemporada_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Temporada"
	cClaseResponse = this.cNamespaceDTOs + ".TemporadaResponse"
	cClaseModelo = "TemporadaModelo"
	cEntidad = "Temporada"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TemporadaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TemporadaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TemporadaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TemporadaModelo"
		endcase
		return lcRetorno
