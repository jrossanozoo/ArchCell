...
define class Mock_COMPONENTECONCILIACIONESCHEQUES as MockBase of MockBase.prg

	cClase = 'COMPONENTECONCILIACIONESCHEQUES'

	
	CuentaBancariaCodigo = ''                                                                                                                                                                                                                                 
	...
	oColChequesDeTerceros = null                                                                                                                                                                                                                              
	oColChequesDeTercerosAnterior = null                                                                                                                                                                                                                      
	oColChequesPropios = null                                                                                                                                                                                                                                 
	oColChequesPropiosAnterior = null                                                                                                                                                                                                                         
	oColSentencias = Null                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function cargarchequesdetalleanterior( todetalle as collection ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cargarchequesdetalleanterior', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercuentabancariadeitem( toitem ) as string                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercuentabancariadeitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneridentificadorcomprobante() as string                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obteneridentificadorcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciasrestaurarinteraccionenelhistorialdecheques() as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciasrestaurarinteraccionenelhistorialdecheques', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oherramientaconciliacion_access()                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Oherramientaconciliacion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarchequedetercero( tcidcheque as string, tocoleccion as zoocoleccion ) as void                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Agregarchequedetercero', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function agregarchequepropio( tcidcheque as string, tocoleccion as zoocoleccion ) as void                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Agregarchequepropio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardetalleactual( todetalle as collection ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cargardetalleactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esmodoagregar() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esmodoagregar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function esmodoanular() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esmodoanular', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function esmodoeditar() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esmodoeditar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function esmodoeliminar() as boolean                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Esmodoeliminar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasagregarinteraccionenelhistorialdechequedetercero( tocheque as object ) as zoocoleccion                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersentenciasagregarinteraccionenelhistorialdechequedetercero', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasagregarinteraccionenelhistorialdechequepropio( tocheque as object ) as zoocoleccion                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersentenciasagregarinteraccionenelhistorialdechequepropio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasagregarinteraccionenelhistorialdecheques() as zoocoleccion                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciasagregarinteraccionenelhistorialdecheques', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasconestadosdechequesenconciliacion() as collection                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciasconestadosdechequesenconciliacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasdeactualizaciondecheque( tocheque as object ) as collection                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersentenciasdeactualizaciondecheque', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciaspararestaurarestadosdecheques() as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciaspararestaurarestadosdecheques', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasporcambiodecheques() as zoocoleccion of zoocoleccion.prg                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciasporcambiodecheques', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasporcambiodechequesdetalleanterior() as zoocoleccion of zoocoleccion.prg                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentenciasporcambiodechequesdetalleanterior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasquitarinteraccionenelhistorialdechequedetercero( tocheque as object ) as zoocoleccion                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersentenciasquitarinteraccionenelhistorialdechequedetercero', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciasquitarinteraccionenelhistorialdechequepropio( tocheque as object ) as zoocoleccion                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenersentenciasquitarinteraccionenelhistorialdechequepropio', lcParametros )
	EndFunc
