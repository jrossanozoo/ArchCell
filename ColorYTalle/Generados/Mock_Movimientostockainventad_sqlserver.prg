...
define class Mock_Movimientostockainventad_sqlserver as MockBase of MockBase.prg

	cClase = 'Movimientostockainventad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detmstockainv( tctablatrabajo ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detmstockainv', lcParametros )
	EndFunc
