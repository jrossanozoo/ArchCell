...
define class Din_EntidadPADRONIIBBAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxPerclidetFecexpo, lxPerclidetFectrans, lxPerclidetFmodifw, lxPerclidetFaltafw, lxPerclidetFecimpo, lxPerclidetSmodifw, lxPerclidetHmodifw, lxPerclidetSaltafw, lxPerclidetHoraimpo, lxPerclidetUaltafw, lxPerclidetVmodifw, lxPerclidetZadsfw, lxPerclidetValtafw, lxPerclidetHoraexpo, lxPerclidetUmodifw, lxPerclidetEsttrans, lxPerclidetBdmodifw, lxPerclidetHaltafw, lxPerclidetBdaltafw, lxPerclidetCodigo, lxPerclidetJurisdicci, lxPerclidetCuit, lxPerclidetPorcen, lxPerclidetFecexp, lxPerclidetCod, lxPerclidetDesjur, lxPerclidetNroitem
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PERCLIDET ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Smodifw","Hmodifw","Saltafw","Horaimpo","Ualtafw","Vmodifw","Zadsfw","Valtafw","Horaexpo","Umodifw","Esttrans","Bdmodifw","Haltafw","Bdaltafw","Codigo","Jurisdicci","Cuit","Porcen","Fecexp","Cod","Desjur","Nroitem" ) values ( <<"'" + this.ConvertirDateSql( lxPerclidetFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerclidetFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerclidetFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerclidetFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPerclidetFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetJurisdicci ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetCuit ) + "'" >>, <<lxPerclidetPorcen >>, <<"'" + this.ConvertirDateSql( lxPerclidetFecexp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetCod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPerclidetDesjur ) + "'" >>, <<lxPerclidetNroitem >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.PERCLIDET set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxPerclidetFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxPerclidetFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxPerclidetFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxPerclidetFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxPerclidetFecimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxPerclidetSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxPerclidetHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxPerclidetSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxPerclidetHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxPerclidetUaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxPerclidetVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxPerclidetZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxPerclidetValtafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxPerclidetHoraexpo ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxPerclidetUmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxPerclidetEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPerclidetBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxPerclidetHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPerclidetBdaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxPerclidetCodigo ) + "'">>,"Jurisdicci" = <<"'" + this.FormatearTextoSql( lxPerclidetJurisdicci ) + "'">>,"Cuit" = <<"'" + this.FormatearTextoSql( lxPerclidetCuit ) + "'">>,"Porcen" = <<lxPerclidetPorcen>>,"Fecexp" = <<"'" + this.ConvertirDateSql( lxPerclidetFecexp ) + "'">>,"Cod" = <<"'" + this.FormatearTextoSql( lxPerclidetCod ) + "'">>,"Desjur" = <<"'" + this.FormatearTextoSql( lxPerclidetDesjur ) + "'">>,"Nroitem" = <<lxPerclidetNroitem>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxPerclidetCodigo ) + "'">> and  PERCLIDET.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaexpo" as "Horaexpo", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Codigo" as "Codigo", "Jurisdicci" as "Jurisdiccion", "Cuit" as "Cuit", "Porcen" as "Porcentaje", "Fecexp" as "Fechaexpiracion", "Cod" as "Codigocliente", "Desjur" as "Descripcion", "Nroitem" as "Nroitem" from ZooLogic.PERCLIDET where "Codigo" = <<"'" + this.FormatearTextoSql( lxPerclidetCodigo ) + "'">> and  PERCLIDET.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaexpo" as "Horaexpo", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Codigo" as "Codigo", "Jurisdicci" as "Jurisdiccion", "Cuit" as "Cuit", "Porcen" as "Porcentaje", "Fecexp" as "Fechaexpiracion", "Cod" as "Codigocliente", "Desjur" as "Descripcion", "Nroitem" as "Nroitem" from ZooLogic.PERCLIDET where  funciones.padr( COD, 10, ' ' ) + funciones.padr( jurisdicci, 8, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PERCLIDET.CODIGO != '' order by COD,jurisdicci
			endtext
			use in select('c_PADRONIIBB')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PADRONIIBB', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaexpo" as "Horaexpo", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Codigo" as "Codigo", "Jurisdicci" as "Jurisdiccion", "Cuit" as "Cuit", "Porcen" as "Porcentaje", "Fecexp" as "Fechaexpiracion", "Cod" as "Codigocliente", "Desjur" as "Descripcion", "Nroitem" as "Nroitem" from ZooLogic.PERCLIDET where  funciones.padr( COD, 10, ' ' ) + funciones.padr( jurisdicci, 8, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PERCLIDET.CODIGO != '' order by COD desc,jurisdicci desc
			endtext
			use in select('c_PADRONIIBB')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PADRONIIBB', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Smodifw,Hmodifw,Saltafw,Horaimpo,Ualtafw,Vmodifw,Za" + ;
"dsfw,Valtafw,Horaexpo,Umodifw,Esttrans,Bdmodifw,Haltafw,Bdaltafw,Codigo,Jurisdicci,Cuit,Porcen,Fecex" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, SMODIFW, HMODIFW, SALTAFW, HORAIMPO, UALTAFW, VMODIFW, ZADSFW, VALTAFW, HORAEXPO, UMODIFW, ESTTRANS, BDMODIFW, HALTAFW, BDALTAFW, CODIGO, jurisdicci, CUIT, PORCEN, FECEXP, COD, DesJur, NroItem
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..jurisdicci ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.JURISDICCI = isnull( d.JURISDICCI, t.JURISDICCI ),t.CUIT = isnull( d.CUIT, t.CUIT ),t.PORCEN = isnull( d.PORCEN, t.PORCEN ),t.FECEXP = isnull( d.FECEXP, t.FECEXP ),t.COD = isnull( d.COD, t.COD ),t.DESJUR = isnull( d.DESJUR, t.DESJUR ),t.NROITEM = isnull( d.NROITEM, t.NROITEM )
					from ZooLogic.PERCLIDET t inner join deleted d 
							 on t.CODIGO = d.CODIGO
							 and  t.COD = d.COD
							 and  t.jurisdicci = d.jurisdicci
				-- Fin Updates
				insert into ZooLogic.PERCLIDET(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Smodifw,Hmodifw,Saltafw,Horaimpo,Ualtafw,Vmodifw,Zadsfw,Valtafw,Horaexpo,Umodifw,Esttrans,Bdmodifw,Haltafw,Bdaltafw,Codigo,Jurisdicci,Cuit,Porcen,Fecexp,Cod,Desjur,Nroitem)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.UMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.CODIGO,''),isnull( d.JURISDICCI,''),isnull( d.CUIT,''),isnull( d.PORCEN,0),isnull( d.FECEXP,''),isnull( d.COD,''),isnull( d.DESJUR,''),isnull( d.NROITEM,0)
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					...
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: . ' + cast( d.COD as Varchar(10) ) + ', JURISDICCION ' + cast( d.jurisdicci as Varchar(8) ) + '','La clave principal no es la esperada'
					from ZooLogic.PERCLIDET t inner join deleted d 
							on   t.COD = d.COD
							 and  t.jurisdicci = d.jurisdicci
						left join deleted h 
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					<<loLogueo.EstadoSistema>>,'<<loLogueo.Aplicacion>>','<<loLogueo.Version>>',
					'<<loLogueo.Serie>>','<<loLogueo.Usuario>>','<<loLogueo.NombrePc>>',
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: . ' + cast( d.COD as Varchar(10) ) + ', JURISDICCION ' + cast( d.jurisdicci as Varchar(8) ) + '','La clave principal a importar ya existe'
					from ZooLogic.PERCLIDET t inner join deleted d 
							 on t.CODIGO = d.CODIGO
						left join deleted h 
							on   t.COD = h.COD
...
<VFPData xml:space="preserve">
	...
	<row entidad="PADRONIIBB                              " atributo="FECHATRANSFERENCIA                      " tabla="PERCLIDET      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PADRONIIBB                              " atributo="ESTADOTRANSFERENCIA                     " tabla="PERCLIDET      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PADRONIIBB                              " atributo="JURISDICCION                            " tabla="PERCLIDET      " campo="JURISDICCI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="JURISDICCION                            " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Jurisdicción                                                                                                                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="2" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PADRONIIBB                              " atributo="CUIT                                    " tabla="PERCLIDET      " campo="CUIT      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="11" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="CUIT                                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PADRONIIBB                              " atributo="PORCENTAJE                              " tabla="PERCLIDET      " campo="PORCEN    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje                                                                                                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PADRONIIBB                              " atributo="FECHAEXPIRACION                         " tabla="PERCLIDET      " campo="FECEXP    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha expiración                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PADRONIIBB                              " atributo="CODIGOCLIENTE                           " tabla="PERCLIDET      " campo="COD       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Cliente cödigo                                                                                                                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PADRONIIBB                              " atributo="DESCRIPCION                             " tabla="PERCLIDET      " campo="DESJUR    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descripción                                                                                                                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="7" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PADRONIIBB                              " atributo="NROITEM                                 " tabla="PERCLIDET      " campo="NROITEM   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="5" decimales="0" valorsugerido="0                                                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="0" etiqueta="Número de item                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="8" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
