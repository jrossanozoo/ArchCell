...
define class Mock_modificacionprecios as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Modificación de precios"                                                                                                                                                                                                                 
	...
	*-----------------------------------------------------------------------------------------
	function ovalidador_access() as object                                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MODIFICACIONPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ovalidador_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ovalidador_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oValidador ) # "O"			This.oValidador = _Screen.Zoo.CrearObjetoPorProducto( "ValidadorModificacionPrecios" )			this.enlazar( 'oValidador.EventoObtenerInformacion', 'inyectarInformacion' )			This.oValidador.InyectarEntidad( this )		endif		return this.oValidador
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermensajeespecificoporerroresdeformula( toexception as object ) as string                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toexception
		...
		return this.ObtenerResultado( 'Obtenermensajeespecificoporerroresdeformula', lcParametros )
	EndFunc
