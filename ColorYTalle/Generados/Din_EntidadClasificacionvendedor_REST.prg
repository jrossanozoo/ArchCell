...
define class Din_EntidadClasificacionvendedor_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Clasificacionvendedor"
	cClaseResponse = this.cNamespaceDTOs + ".ClasificacionvendedorResponse"
	cClaseModelo = "ClasificacionvendedorModelo"
	cEntidad = "Clasificacionvendedor"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ClasificacionvendedorModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ClasificacionvendedorListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ClasificacionvendedorListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ClasificacionvendedorModelo"
		endcase
		return lcRetorno
