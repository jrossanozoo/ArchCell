...
define class Mock_Itemprocesoproduccionprocesomaquina as MockBase of MockBase.prg

	cClase = 'Itemprocesoproduccionprocesomaquina'
	...
	*-----------------------------------------------------------------------------------------
	function maquinadescripcion_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Maquinadescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_maquinadescripcion( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_maquinadescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_maquinadescripcion( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_maquinadescripcion', lcParametros )
	EndFunc
