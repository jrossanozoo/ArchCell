...
define class Mock_Colorad_sqlserver as MockBase of MockBase.prg

	cClase = 'Colorad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupub001( tctablatrabajo ) as string                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupub001', lcParametros )
	EndFunc
