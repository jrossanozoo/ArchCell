	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.AGRPLTDS ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Saltafw","Horaimpo","Hmodifw","Smodifw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Horaexpo","Haltafw","Bdmodifw","Esttrans","Bdaltafw","Bloqreg","Nombre","Descrip","Filtrafec","Obs","Categoria","Favorito","Codigo" ) values ( <<"'" + this.ConvertirDateSql( lxAgrpltdsFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrpltdsFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrpltdsFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrpltdsFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAgrpltdsFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsBdaltafw ) + "'" >>, <<iif( lxAgrpltdsBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsNombre ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsDescrip ) + "'" >>, <<iif( lxAgrpltdsFiltrafec, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsObs ) + "'" >>, <<lxAgrpltdsCategoria >>, <<iif( lxAgrpltdsFavorito, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAgrpltdsCodigo ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.Referencias
				if this.oEntidad.Referencias.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.AgrpLtdsDet("NomADirect","IDListado","NROITEM","BLOQREG","EsDefault","IDPerso","Nombre","Orden","AccDirecto","NomListado","NomPerso","AtrFecha","Activado" ) values ( <<"'" + this.FormatearTextoSql( lxNombredelaccesodirecto ) + "'">>, <<"'" + this.FormatearTextoSql( lxIdlistado ) + "'">>, <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, <<iif( lxEsdefault, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxPersonalizacion_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<lxOrdenvisual>>, <<"'" + this.FormatearTextoSql( lxAccesodirecto ) + "'">>, <<"'" + this.FormatearTextoSql( lxNombrelistado ) + "'">>, <<"'" + this.FormatearTextoSql( lxNombrepersonalizacion ) + "'">>, <<"'" + this.FormatearTextoSql( lxAtributofecha ) + "'">>, <<iif( lxActivado, 1, 0 )>> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.AGRPLTDS set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAgrpltdsFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAgrpltdsFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAgrpltdsFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAgrpltdsFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAgrpltdsFecimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAgrpltdsHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAgrpltdsHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAgrpltdsEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAgrpltdsBdaltafw ) + "'">>,"Bloqreg" = <<iif( lxAgrpltdsBloqreg, 1, 0 )>>,"Nombre" = <<"'" + this.FormatearTextoSql( lxAgrpltdsNombre ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxAgrpltdsDescrip ) + "'">>,"Filtrafec" = <<iif( lxAgrpltdsFiltrafec, 1, 0 )>>,"Obs" = <<"'" + this.FormatearTextoSql( lxAgrpltdsObs ) + "'">>,"Categoria" = <<lxAgrpltdsCategoria>>,"Favorito" = <<iif( lxAgrpltdsFavorito, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAgrpltdsCodigo ) + "'">> where "Nombre" = <<"'" + this.FormatearTextoSql( lxAgrpltdsNombre ) + "'">> and  AGRPLTDS.NOMBRE != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Nombre" as "Nombre", "Descrip" as "Descripcion", "Filtrafec" as "Filtrafecha", "Obs" as "Observacion", "Categoria" as "Categoria", "Favorito" as "Favorito", "Codigo" as "Codigo" from ORGANIZACION.AGRPLTDS where  AGRPLTDS.NOMBRE != '' And Codigo = <<"'" + this.FormatearTextoSql( lxAgrpLtdsCodigo ) + "'">>
			endtext
			use in select('c_AGRUPALISTADOSPERSONALIZADOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AGRUPALISTADOSPERSONALIZADOS', set( 'Datasession' ) )
			if reccount( 'c_AGRUPALISTADOSPERSONALIZADOS' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Nombre" as "Nombre", "Descrip" as "Descripcion", "Filtrafec" as "Filtrafecha", "Obs" as "Observacion", "Categoria" as "Categoria", "Favorito" as "Favorito", "Codigo" as "Codigo" from ORGANIZACION.AGRPLTDS where  funciones.padr( Codigo, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AGRPLTDS.NOMBRE != '' order by Codigo
			endtext
			use in select('c_AGRUPALISTADOSPERSONALIZADOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AGRUPALISTADOSPERSONALIZADOS', set( 'Datasession' ) )
			local lcSentencia as string
...
"dsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Esttrans,Bdaltafw,Bloqreg,Nombre,Descrip,Filtrafec,Ob" + ;
"s,Categoria,Favorito,Codigo" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bloqreg" as "Bloquearregistro", "Nombre" as "Nombre", "Descrip" as "Descripcion", "Filtrafec" as "Filtrafecha", "Obs" as "Observacion", "Categoria" as "Categoria", "Favorito" as "Favorito", "Codigo" as "Codigo"
				endtext
			Else
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Nombre or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.AGRPLTDS set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, Nombre = ] + "'" + this.FormatearTextoSql( &lcCursor..Nombre ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, FiltraFec = ] + Transform( iif( &lcCursor..FiltraFec, 1, 0 ))+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Categoria = ] + transform( &lcCursor..Categoria )+ [, Favorito = ] + Transform( iif( &lcCursor..Favorito, 1, 0 ))+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + [ Where Nombre = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, SALTAFW, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HORAEXPO, HALTAFW, BDMODIFW, ESTTRANS, BDALTAFW, BLOQREG, Nombre, Descrip, FiltraFec, Obs, Categoria, Favorito, Codigo
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Nombre ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + Transform( iif( &lcCursor..FiltraFec, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + ',' + transform( &lcCursor..Categoria ) + ',' + Transform( iif( &lcCursor..Favorito, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"NomADirect","IDListado","NROITEM","BLOQREG","EsDefault","IDPerso","Nombre","Orden","AccDirecto","NomListado","NomPerso","AtrFecha","Activado"
		endText
		this.oConexion.EjecutarSql( [Insert into ORGANIZACION.AgrpLtdsDet ( ] + lcCamposInsert + [ ) values ( ] +  "'" + this.FormatearTextoSql( cDetallesExistentes.NomADirect ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.IDListado  ) + "'" + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + Transform( iif( cDetallesExistentes.BLOQREG   , 1, 0 )) + ',' + Transform( iif( cDetallesExistentes.EsDefault , 1, 0 )) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.IDPerso    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Nombre     ) + "'" + ',' + transform( cDetallesExistentes.Orden      ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AccDirecto ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NomListado ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NomPerso   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AtrFecha   ) + "'" + ',' + Transform( iif( cDetallesExistentes.Activado  , 1, 0 )) + ' )'  )
		select cDetallesExistentes
	EndScan
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.NOMBRE = isnull( d.NOMBRE, t.NOMBRE ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.FILTRAFEC = isnull( d.FILTRAFEC, t.FILTRAFEC ),t.OBS = isnull( d.OBS, t.OBS ),t.CATEGORIA = isnull( d.CATEGORIA, t.CATEGORIA ),t.FAVORITO = isnull( d.FAVORITO, t.FAVORITO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO )
					from ORGANIZACION.AGRPLTDS t inner join deleted d 
							 on t.Nombre = d.Nombre
							 and  t.Codigo = d.Codigo
				-- Fin Updates
				insert into ORGANIZACION.AGRPLTDS(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Saltafw,Horaimpo,Hmodifw,Smodifw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Horaexpo,Haltafw,Bdmodifw,Esttrans,Bdaltafw,Bloqreg,Nombre,Descrip,Filtrafec,Obs,Categoria,Favorito,Codigo)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BLOQREG,0),isnull( d.NOMBRE,''),isnull( d.DESCRIP,''),isnull( d.FILTRAFEC,0),isnull( d.OBS,''),isnull( d.CATEGORIA,0),isnull( d.FAVORITO,0),isnull( d.CODIGO,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_AGRUPALISTADOSPERSONALIZADOS' ) < 1
				...
				Try
					...
					.Bloquearregistro = nvl( c_AGRUPALISTADOSPERSONALIZADOS.Bloquearregistro, .F. )
...
<VFPData xml:space="preserve">
	...
	<row entidad="AGRUPALISTADOSPERSONALIZADOS            " atributo="FECHATRANSFERENCIA                      " tabla="AGRPLTDS       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AGRUPALISTADOSPERSONALIZADOS            " atributo="ESTADOTRANSFERENCIA                     " tabla="AGRPLTDS       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AGRUPALISTADOSPERSONALIZADOS            " atributo="BLOQUEARREGISTRO                        " tabla="AGRPLTDS       " campo="BLOQREG   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
