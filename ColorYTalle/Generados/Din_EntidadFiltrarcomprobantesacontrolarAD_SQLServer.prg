	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPACONT ( "Fecimpo","Fecexpo","Fmodifw","Faltafw","Fectrans","Horaimpo","Hmodifw","Haltafw","Horaexpo","Saltafw","Bdmodifw","Smodifw","Vmodifw","Zadsfw","Umodifw","Valtafw","Bdaltafw","Ualtafw","Esttrans","Codigo","Entregapos","Descrip","Cliedesde","Cliehasta","Provdesde","Provhasta","Origdesde","Orighasta","Fecomdesde","Fecomhasta","Feentdesde","Feenthasta","Vendesde","Venhasta","Motidesde","Motihasta","Trandesde","Tranhasta","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxCompacontFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontCodigo ) + "'" >>, <<lxCompacontEntregapos >>, <<"'" + this.FormatearTextoSql( lxCompacontDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontCliedesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontCliehasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontProvdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontProvhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontOrigdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontOrighasta ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFecomdesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFecomhasta ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFeentdesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompacontFeenthasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontVendesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontVenhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontMotidesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontMotihasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontTrandesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontTranhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompacontObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Bdaltafw" as "Basededatosaltafw", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Entregapos" as "Entregaposterior", "Descrip" as "Descripcion", "Cliedesde" as "Clientedesde", "Cliehasta" as "Clientehasta", "Provdesde" as "Proveedordesde", "Provhasta" as "Proveedorhasta", "Origdesde" as "Origendestinodesde", "Orighasta" as "Origendestinohasta", "Fecomdesde" as "Fechacomprobantedesde", "Fecomhasta" as "Fechacomprobantehasta", "Feentdesde" as "Fechaentregadesde", "Feenthasta" as "Fechaentregahasta", "Vendesde" as "Vendedordesde", "Venhasta" as "Vendedorhasta", "Motidesde" as "Motivodesde", "Motihasta" as "Motivohasta", "Trandesde" as "Transportistadesde", "Tranhasta" as "Transportistahasta", "Obs" as "Observacion" from ZooLogic.COMPACONT where "Codigo" = <<"'" + this.FormatearTextoSql( lxCompacontCodigo ) + "'">> and  COMPACONT.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fecexpo,Fmodifw,Faltafw,Fectrans,Horaimpo,Hmodifw,Haltafw,Horaexpo,Saltafw,Bdmodifw," + ;
"Smodifw,Vmodifw,Zadsfw,Umodifw,Valtafw,Bdaltafw,Ualtafw,Esttrans,Codigo,Entregapos,Descrip,Cliedesde" + ;
",Cliehasta,Provdesde,Provhasta,Origdesde,Orighasta,Fecomdesde,Fecomhasta,Feentdesde,Feenthasta,Vende" + ;
"sde,Venhasta,Motidesde,Motihasta,Trandesde,Tranhasta,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Bdaltafw" as "Basededatosaltafw", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Entregapos" as "Entregaposterior", "Descrip" as "Descripcion", "Cliedesde" as "Clientedesde", "Cliehasta" as "Clientehasta", "Provdesde" as "Proveedordesde", "Provhasta" as "Proveedorhasta", "Origdesde" as "Origendestinodesde", "Orighasta" as "Origendestinohasta", "Fecomdesde" as "Fechacomprobantedesde", "Fecomhasta" as "Fechacomprobantehasta", "Feentdesde" as "Fechaentregadesde", "Feenthasta" as "Fechaentregahasta", "Vendesde" as "Vendedordesde", "Venhasta" as "Vendedorhasta", "Motidesde" as "Motivodesde", "Motihasta" as "Motivohasta", "Trandesde" as "Transportistadesde", "Tranhasta" as "Transportistahasta", "Obs" as "Observacion"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.COMPACONT set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCompacontFecimpo ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCompacontFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxCompacontFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxCompacontFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxCompacontFectrans ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxCompacontHoraimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxCompacontHmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxCompacontHaltafw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxCompacontHoraexpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxCompacontSaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCompacontBdmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxCompacontSmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxCompacontVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxCompacontZadsfw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxCompacontUmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxCompacontValtafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCompacontBdaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxCompacontUaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxCompacontEsttrans ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxCompacontCodigo ) + "'">>, "Entregapos" = <<lxCompacontEntregapos>>, "Descrip" = <<"'" + this.FormatearTextoSql( lxCompacontDescrip ) + "'">>, "Cliedesde" = <<"'" + this.FormatearTextoSql( lxCompacontCliedesde ) + "'">>, "Cliehasta" = <<"'" + this.FormatearTextoSql( lxCompacontCliehasta ) + "'">>, "Provdesde" = <<"'" + this.FormatearTextoSql( lxCompacontProvdesde ) + "'">>, "Provhasta" = <<"'" + this.FormatearTextoSql( lxCompacontProvhasta ) + "'">>, "Origdesde" = <<"'" + this.FormatearTextoSql( lxCompacontOrigdesde ) + "'">>, "Orighasta" = <<"'" + this.FormatearTextoSql( lxCompacontOrighasta ) + "'">>, "Fecomdesde" = <<"'" + this.ConvertirDateSql( lxCompacontFecomdesde ) + "'">>, "Fecomhasta" = <<"'" + this.ConvertirDateSql( lxCompacontFecomhasta ) + "'">>, "Feentdesde" = <<"'" + this.ConvertirDateSql( lxCompacontFeentdesde ) + "'">>, "Feenthasta" = <<"'" + this.ConvertirDateSql( lxCompacontFeenthasta ) + "'">>, "Vendesde" = <<"'" + this.FormatearTextoSql( lxCompacontVendesde ) + "'">>, "Venhasta" = <<"'" + this.FormatearTextoSql( lxCompacontVenhasta ) + "'">>, "Motidesde" = <<"'" + this.FormatearTextoSql( lxCompacontMotidesde ) + "'">>, "Motihasta" = <<"'" + this.FormatearTextoSql( lxCompacontMotihasta ) + "'">>, "Trandesde" = <<"'" + this.FormatearTextoSql( lxCompacontTrandesde ) + "'">>, "Tranhasta" = <<"'" + this.FormatearTextoSql( lxCompacontTranhasta ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxCompacontObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'COMPACONT' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECIMPO, FECEXPO, FMODIFW, FALTAFW, FECTRANS, HORAIMPO, HMODIFW, HALTAFW, HORAEXPO, SALTAFW, BDMODIFW, SMODIFW, VMODIFW, ZADSFW, UMODIFW, VALTAFW, BDALTAFW, UALTAFW, ESTTRANS, Codigo, EntregaPos, Descrip, ClieDesde, ClieHasta, ProvDesde, ProvHasta, OrigDesde, OrigHasta, FeComDesde, FeComHasta, FeEntDesde, FeEntHasta, VenDesde, VenHasta, MotiDesde, MotiHasta, TranDesde, TranHasta, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + transform( &lcCursor..EntregaPos )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClieDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClieHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ProvDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ProvHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OrigDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OrigHasta ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotiHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TranDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TranHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
"trandesde" char( 15 )  null, 
"tranhasta" char( 15 )  null, 
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.CLIEDESDE = isnull( d.CLIEDESDE, t.CLIEDESDE ),t.CLIEHASTA = isnull( d.CLIEHASTA, t.CLIEHASTA ),t.PROVDESDE = isnull( d.PROVDESDE, t.PROVDESDE ),t.PROVHASTA = isnull( d.PROVHASTA, t.PROVHASTA ),t.ORIGDESDE = isnull( d.ORIGDESDE, t.ORIGDESDE ),t.ORIGHASTA = isnull( d.ORIGHASTA, t.ORIGHASTA ),t.FECOMDESDE = isnull( d.FECOMDESDE, t.FECOMDESDE ),t.FECOMHASTA = isnull( d.FECOMHASTA, t.FECOMHASTA ),t.FEENTDESDE = isnull( d.FEENTDESDE, t.FEENTDESDE ),t.FEENTHASTA = isnull( d.FEENTHASTA, t.FEENTHASTA ),t.VENDESDE = isnull( d.VENDESDE, t.VENDESDE ),t.VENHASTA = isnull( d.VENHASTA, t.VENHASTA ),t.MOTIDESDE = isnull( d.MOTIDESDE, t.MOTIDESDE ),t.MOTIHASTA = isnull( d.MOTIHASTA, t.MOTIHASTA ),t.TRANDESDE = isnull( d.TRANDESDE, t.TRANDESDE ),t.TRANHASTA = isnull( d.TRANHASTA, t.TRANHASTA ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.COMPACONT t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.COMPACONT(Fecimpo,Fecexpo,Fmodifw,Faltafw,Fectrans,Horaimpo,Hmodifw,Haltafw,Horaexpo,Saltafw,Bdmodifw,Smodifw,Vmodifw,Zadsfw,Umodifw,Valtafw,Bdaltafw,Ualtafw,Esttrans,Codigo,Entregapos,Descrip,Cliedesde,Cliehasta,Provdesde,Provhasta,Origdesde,Orighasta,Fecomdesde,Fecomhasta,Feentdesde,Feenthasta,Vendesde,Venhasta,Motidesde,Motihasta,Trandesde,Tranhasta,Obs)
					Select isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.SMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.UALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.CODIGO,''),isnull( d.ENTREGAPOS,0),isnull( d.DESCRIP,''),isnull( d.CLIEDESDE,''),isnull( d.CLIEHASTA,''),isnull( d.PROVDESDE,''),isnull( d.PROVHASTA,''),isnull( d.ORIGDESDE,''),isnull( d.ORIGHASTA,''),isnull( d.FECOMDESDE,''),isnull( d.FECOMHASTA,''),isnull( d.FEENTDESDE,''),isnull( d.FEENTHASTA,''),isnull( d.VENDESDE,''),isnull( d.VENHASTA,''),isnull( d.MOTIDESDE,''),isnull( d.MOTIHASTA,''),isnull( d.TRANDESDE,''),isnull( d.TRANHASTA,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="FECHATRANSFERENCIA                      " tabla="COMPACONT      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPACONT      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="CLIENTEHASTA                            " tabla="COMPACONT      " campo="CLIEHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="404" etiqueta="Cliente hasta                                                                                                                                                   " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="PROVEEDORDESDE                          " tabla="COMPACONT      " campo="PROVDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Proveedor desde                                                                                                                                                 " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="15" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="PROVEEDORHASTA                          " tabla="COMPACONT      " campo="PROVHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="408" etiqueta="Proveedor hasta                                                                                                                                                 " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="ORIGENDESTINODESDE                      " tabla="COMPACONT      " campo="ORIGDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ORIGENDEDATOS                           " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Origen/destino desde                                                                                                                                            " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="25" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="ORIGENDESTINOHASTA                      " tabla="COMPACONT      " campo="ORIGHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ORIGENDEDATOS                           " tipodato="C         " longitud="8" decimales="0" valorsugerido="ZZZZZZZZ                                                                                                                                                                                                                                                      " obligatorio="false" admitebusqueda="412" etiqueta="Origen/destino hasta                                                                                                                                            " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="FECHACOMPROBANTEDESDE                   " tabla="COMPACONT      " campo="FECOMDESDE" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Fecha de comprobante desde                                                                                                                                      " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="35" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="FECHACOMPROBANTEHASTA                   " tabla="COMPACONT      " campo="FECOMHASTA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="416" etiqueta="Fecha de comprobante hasta                                                                                                                                      " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="40" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="FECHAENTREGADESDE                       " tabla="COMPACONT      " campo="FEENTDESDE" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Fecha de entrega desde                                                                                                                                          " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="45" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="FECHAENTREGAHASTA                       " tabla="COMPACONT      " campo="FEENTHASTA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="420" etiqueta="Fecha de entrega hasta                                                                                                                                          " dominio="EtiquetaFechaDesdeHastaBusc   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="VENDEDORDESDE                           " tabla="COMPACONT      " campo="VENDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Vendedor desde                                                                                                                                                  " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="6" orden="55" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="VENDEDORHASTA                           " tabla="COMPACONT      " campo="VENHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="424" etiqueta="Vendedor hasta                                                                                                                                                  " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="6" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="MOTIVODESDE                             " tabla="COMPACONT      " campo="MOTIDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MOTIVO                                  " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Motivo desde                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="7" orden="65" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="MOTIVOHASTA                             " tabla="COMPACONT      " campo="MOTIHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MOTIVO                                  " tipodato="C         " longitud="3" decimales="0" valorsugerido="ZZZ                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="428" etiqueta="Motivo hasta                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="7" orden="70" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="TRANSPORTISTADESDE                      " tabla="COMPACONT      " campo="TRANDESDE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="430" etiqueta="Transportista desde                                                                                                                                             " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="8" orden="75" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="FILTRARCOMPROBANTESACONTROLAR           " atributo="TRANSPORTISTAHASTA                      " tabla="COMPACONT      " campo="TRANHASTA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="15" decimales="0" valorsugerido="ZZZZZZZZZZZZZZZ                                                                                                                                                                                                                                               " obligatorio="false" admitebusqueda="432" etiqueta="Transportista hasta                                                                                                                                             " dominio="EtiquetaCaracterDesdeHastaBusc" detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="8" orden="80" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VENDEDOR                                " atributo="NOMBRE                                  " tabla="VEN            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="425" etiqueta="Detalle Ven.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join VEN On COMPACONT.VENHASTA = VEN.CLCOD And  VEN.CLCOD != ''                                                                                                                                                                                         " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
