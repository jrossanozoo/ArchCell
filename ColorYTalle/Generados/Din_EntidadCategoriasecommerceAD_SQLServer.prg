...
define class Din_EntidadCATEGORIASECOMMERCEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCategecomFecimpo, lxCategecomFectrans, lxCategecomFmodifw, lxCategecomFecexpo, lxCategecomFaltafw, lxCategecomHoraexpo, lxCategecomHoraimpo, lxCategecomHaltafw, lxCategecomValtafw, lxCategecomSaltafw, lxCategecomUaltafw, lxCategecomSmodifw, lxCategecomHmodifw, lxCategecomVmodifw, lxCategecomZadsfw, lxCategecomCodrama, lxCategecomBdaltafw, lxCategecomUmodifw, lxCategecomBdmodifw, lxCategecomEsttrans, lxCategecomCodigo, lxCategecomCateg, lxCategecomSubcatde, lxCategecomOrden, lxCategecomRama, lxCategecomCatgs, lxCategecomTituloseo, lxCategecomDescseo, lxCategecomUrl, lxCategecomObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CATEGECOM ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Horaexpo","Horaimpo","Haltafw","Valtafw","Saltafw","Ualtafw","Smodifw","Hmodifw","Vmodifw","Zadsfw","Codrama","Bdaltafw","Umodifw","Bdmodifw","Esttrans","Codigo","Categ","Subcatde","Orden","Rama","Catgs","Tituloseo","Descseo","Url","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxCategecomFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCategecomFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCategecomFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCategecomFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCategecomFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomCodrama ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomCateg ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomSubcatde ) + "'" >>, <<lxCategecomOrden >>, <<"'" + this.FormatearTextoSql( lxCategecomRama ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomCatgs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomTituloseo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomDescseo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomUrl ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCategecomObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Horaexpo,Horaimpo,Haltafw,Valtafw,Saltafw,Ualtafw,S" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, HORAEXPO, HORAIMPO, HALTAFW, VALTAFW, SALTAFW, UALTAFW, SMODIFW, HMODIFW, VMODIFW, ZADSFW, CodRama, BDALTAFW, UMODIFW, BDMODIFW, ESTTRANS, Codigo, Categ, SubcatDe, Orden, Rama, CatGS, TituloSEO, DescSEO, URL, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.CODRAMA = isnull( d.CODRAMA, t.CODRAMA ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.CATEG = isnull( d.CATEG, t.CATEG ),t.SUBCATDE = isnull( d.SUBCATDE, t.SUBCATDE ),t.ORDEN = isnull( d.ORDEN, t.ORDEN ),t.RAMA = isnull( d.RAMA, t.RAMA ),t.CATGS = isnull( d.CATGS, t.CATGS ),t.TITULOSEO = isnull( d.TITULOSEO, t.TITULOSEO ),t.DESCSEO = isnull( d.DESCSEO, t.DESCSEO ),t.URL = isnull( d.URL, t.URL ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.CATEGECOM t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.CATEGECOM(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Horaexpo,Horaimpo,Haltafw,Valtafw,Saltafw,Ualtafw,Smodifw,Hmodifw,Vmodifw,Zadsfw,Codrama,Bdaltafw,Umodifw,Bdmodifw,Esttrans,Codigo,Categ,Subcatde,Orden,Rama,Catgs,Tituloseo,Descseo,Url,Obs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.VALTAFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.CODRAMA,''),isnull( d.BDALTAFW,''),isnull( d.UMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.CODIGO,''),isnull( d.CATEG,''),isnull( d.SUBCATDE,''),isnull( d.ORDEN,0),isnull( d.RAMA,''),isnull( d.CATGS,''),isnull( d.TITULOSEO,''),isnull( d.DESCSEO,''),isnull( d.URL,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CATEGORIASECOMMERCE                     " atributo="FECHATRANSFERENCIA                      " tabla="CATEGECOM      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CATEGORIASECOMMERCE                     " atributo="ESTADOTRANSFERENCIA                     " tabla="CATEGECOM      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
