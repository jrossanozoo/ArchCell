...
define class Mock_moneda as MockBase of MockBase.prg
	...
	HORAIMPO = ""                                                                                                                                                                                                                                             
	HORAMODIFICACIONFW = ""                                                                                                                                                                                                                                   
	MonedaCotizacionAFIP = null                                                                                                                                                                                                                               
	MonedaCotizacionAFIP_PK = ""                                                                                                                                                                                                                              
	Observacion = ""                                                                                                                                                                                                                                          
	RetornoExtension = .t.                                                                                                                                                                                                                                    
	SERIEALTAFW = ""                                                                                                                                                                                                                                          
	SERIEMODIFICACIONFW = ""                                                                                                                                                                                                                                  
	...
	lHabilitarMonedaCotizacionAFIP_PK = .T.                                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecotizaciones() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallecotizaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledenominaciones() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledenominaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargaobligatoria_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cargaobligatoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cargaobligatoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cargaobligatoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cargaobligatoria( lxVal )				this.Setear_Cargaobligatoria( lxVal )			EndIf		Else			This.Setear_Cargaobligatoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirimporte( tnimporte as float, tcmonedaorig as string, tcmonedadest as string, tdfecha as date  ) as float                                                                                                                                
		...
		lnParametros = pcount()
		lxParam1 = tnimporte
		lxParam2 = tcmonedaorig
		lxParam3 = tcmonedadest
		lxParam4 = tdfecha
		...
		return this.ObtenerResultado( 'Convertirimporte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirimportebase( tnimporte as float, tcmonedaorig as string, tcmonedadest as string, tdfecha as date  ) as float                                                                                                                            
		...
		return this.ObtenerResultado( 'Convertirimportebase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirimporteconredondeo( tnimporte as float, tcmonedaorig as string, tcmonedadest as string, tdfecha as date, tnredondeo as integer ) as float                                                                                               
		...
		return this.ObtenerResultado( 'Convertirimporteconredondeo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cotizaciones_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cotizaciones_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cotizaciones_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Cotizaciones ) = 'O' or isnull( this.Cotizaciones ) )			this.Cotizaciones = this.crearobjeto( 'DetalleMonedaCotizaciones' )			this.Cotizaciones.inicializar()			this.Cotizaciones.lPermitirDetalleVacio = .F.			this.enlazar( 'Cotizaciones.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Cotizaciones.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Cotizaciones, 'CambioSumarizado', this, 'CambiosDetalleCotizaciones', 1)			this.enlazar( 'Cotizaciones.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Cotizaciones.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Cotizaciones
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function denominaciones_access() as variant                                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'denominaciones_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'denominaciones_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Denominaciones ) = 'O' or isnull( this.Denominaciones ) )			this.Denominaciones = this.crearobjeto( 'Din_DetalleMonedaDenominaciones' )			this.Denominaciones.inicializar()			this.enlazar( 'Denominaciones.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Denominaciones.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Denominaciones, 'CambioSumarizado', this, 'CambiosDetalleDenominaciones', 1)			this.enlazar( 'Denominaciones.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Denominaciones.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Denominaciones
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function equivalenciaafip_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'equivalenciaafip_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'equivalenciaafip_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Equivalenciaafip ) = 'O' or isnull( this.Equivalenciaafip ) )					this.Equivalenciaafip = _Screen.zoo.instanciarentidad( 'Monedaafip' )					this.Equivalenciaafip.lEsSubEntidad = .t.					this.enlazar( 'Equivalenciaafip.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Equivalenciaafip.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Equivalenciaafip.CODIGO # this.Equivalenciaafip_PK						this.Equivalenciaafip.CODIGO = this.Equivalenciaafip_PK					endif				endif			endif		endif		return this.Equivalenciaafip
	EndFunc

	*-----------------------------------------------------------------------------------------
	function equivalenciaafip_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'equivalenciaafip_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'equivalenciaafip_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Equivalenciaafip_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 3, padr( lxVal, 3 ), lxVal )		this.Equivalenciaafip_PK = lxVal		if this.Validar_Equivalenciaafip( lxVal, lxValOld )			This.Setear_Equivalenciaafip( lxVal )			This.Equivalenciaafip_PK_DespuesDeAsignar()		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function equivalenciaafip_pk_despuesdeasignar() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Equivalenciaafip_pk_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function equivalenciadgi_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'equivalenciadgi_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'equivalenciadgi_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Equivalenciadgi		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Equivalenciadgi( lxVal )				this.Setear_Equivalenciadgi( lxVal )			EndIf		Else			This.Setear_Equivalenciadgi( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitardeshabilitarmonedacotizacionafip() as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Eventohabilitardeshabilitarmonedacotizacionafip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitarmonedacotizacionafip() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Habilitardeshabilitarmonedacotizacionafip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function monedacotizacionafip_access() as variant                                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'monedacotizacionafip_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'monedacotizacionafip_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Monedacotizacionafip ) = 'O' or isnull( this.Monedacotizacionafip ) )					this.Monedacotizacionafip = _Screen.zoo.instanciarentidad( 'Moneda' )					this.Monedacotizacionafip.lEsSubEntidad = .t.					this.enlazar( 'Monedacotizacionafip.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Monedacotizacionafip.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Monedacotizacionafip.CODIGO # this.Monedacotizacionafip_PK						this.Monedacotizacionafip.CODIGO = this.Monedacotizacionafip_PK					endif				endif			endif		endif		return this.Monedacotizacionafip
	EndFunc

	*-----------------------------------------------------------------------------------------
	function monedacotizacionafip_pk_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'monedacotizacionafip_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'monedacotizacionafip_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Monedacotizacionafip_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 10, padr( lxVal, 10 ), lxVal )		this.Monedacotizacionafip_PK = lxVal		if this.Validar_Monedacotizacionafip( lxVal, lxValOld )			if ( this.lHabilitarMonedacotizacionafip_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Monedacotizacionafip( lxVal )			else				this.Monedacotizacionafip_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Monedas - Atributo: Monedacotizacionafip)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercotizacion( tdfecha as date, tcmonedavalor as string, tcmonedacomprobante as string ) as number                                                                                                                                           
		...
		lnParametros = pcount()
		lxParam1 = tdfecha
		lxParam2 = tcmonedavalor
		lxParam3 = tcmonedacomprobante
	...
	*-----------------------------------------------------------------------------------------
	function obtenercotizacionmoneda( tcmoneda as string, tdfecha as date ) as float                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercotizacionmoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercotizacionsegunmoneda( tcfecha as date, tchora as string, tcmoneda as string ) as number                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercotizacionsegunmoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercotizacionvigente( tdfecha as date, tcmonedavalor as string, tcmonedacomprobante as string ) as number                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenercotizacionvigente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfechaultimacotizacion( tdfecha as date, tcmoneda as string ) as float                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerfechaultimacotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerhoradecotizacion( tdfecha ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerhoradecotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneritemultimacotizacion() as itemauxiliar of din_detallemonedacotizaciones.prg                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obteneritemultimacotizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersimbolodemoneda() as string                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenersimbolodemoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cargaobligatoria( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cargaobligatoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cargaobligatoria', lcParametros )			endif		endif		this.Cargaobligatoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_equivalenciaafip( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_equivalenciaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_equivalenciaafip', lcParametros )			endif		endif		this.Equivalenciaafip.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_equivalenciadgi( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_equivalenciadgi', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_equivalenciadgi', lcParametros )			endif		endif		this.Equivalenciadgi = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_monedacotizacionafip( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_monedacotizacionafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_monedacotizacionafip', lcParametros )			endif		endif		this.Monedacotizacionafip.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_simbolo( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_simbolo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_simbolo', lcParametros )			endif		endif		this.Simbolo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tolerancianegativa( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tolerancianegativa', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tolerancianegativa', lcParametros )			endif		endif		this.Tolerancianegativa = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_toleranciapositiva( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_toleranciapositiva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_toleranciapositiva', lcParametros )			endif		endif		this.Toleranciapositiva = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function simbolo_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'simbolo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'simbolo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Simbolo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Simbolo( lxVal )				this.Setear_Simbolo( lxVal )			EndIf		Else			This.Setear_Simbolo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tolerancianegativa_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tolerancianegativa_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tolerancianegativa_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tolerancianegativa		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tolerancianegativa( lxVal )				this.ValidarDominio_Numericononegativo( lxVal )				this.Setear_Tolerancianegativa( lxVal )			EndIf		Else			This.Setear_Tolerancianegativa( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function toleranciapositiva_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'toleranciapositiva_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'toleranciapositiva_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Toleranciapositiva		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Toleranciapositiva( lxVal )				this.ValidarDominio_Numericononegativo( lxVal )				this.Setear_Toleranciapositiva( lxVal )			EndIf		Else			This.Setear_Toleranciapositiva( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cargaobligatoria( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cargaobligatoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cargaobligatoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_equivalenciaafip( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_equivalenciaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_equivalenciaafip', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_equivalenciadgi( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_equivalenciadgi', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_equivalenciadgi', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_monedacotizacionafip( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_monedacotizacionafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_monedacotizacionafip', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_simbolo( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_simbolo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_simbolo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tolerancianegativa( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tolerancianegativa', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tolerancianegativa', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_toleranciapositiva( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'MONEDA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_toleranciapositiva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_toleranciapositiva', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarequivalenciaafip() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarequivalenciaafip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmonedacotizacionafip() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmonedacotizacionafip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocargaobligatoria() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridocargaobligatoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoequivalenciaafip() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoequivalenciaafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoequivalenciadgi() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoequivalenciadgi', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridomonedacotizacionafip() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomonedacotizacionafip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosimbolo() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridosimbolo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridotolerancianegativa() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotolerancianegativa', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridotoleranciapositiva() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotoleranciapositiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercotizacionefectiva( tdfecha as date, tcmonedavalor as string, tcmonedacomprobante as string ) as float                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercotizacionefectiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercotizacionespecifica( tcmonedavalor as string, tcfecha as string ) as float                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercotizacionespecifica', lcParametros )
	EndFunc
