...
define class Mock_Itemdatosfiscalesperceiibb as MockBase of MockBase.prg

	cClase = 'Itemdatosfiscalesperceiibb'
	...
	*-----------------------------------------------------------------------------------------
	function minimoderetencion_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Minimoderetencion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function rg1575regimen_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Rg1575regimen_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function rg2616regimen_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Rg2616regimen_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_minimoderetencion( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_minimoderetencion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_minimoderetencion( txval as variant ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_minimoderetencion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigointerno() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridocodigointerno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcodigointerno() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwcodigointerno', lcParametros )
	EndFunc
