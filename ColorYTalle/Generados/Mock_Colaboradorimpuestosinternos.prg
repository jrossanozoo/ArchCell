...
define class Mock_COLABORADORIMPUESTOSINTERNOS as MockBase of MockBase.prg

	cClase = 'COLABORADORIMPUESTOSINTERNOS'
	...
	*-----------------------------------------------------------------------------------------
	function aplicaimpuestosinternos() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Aplicaimpuestosinternos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerysetearparametrodecodigodedatosfiscales() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerysetearparametrodecodigodedatosfiscales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearsiaplicaimpuestosinternos() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearsiaplicaimpuestosinternos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existeimpuestointernoseteadoendatosfiscales() as boolean                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Existeimpuestointernoseteadoendatosfiscales', lcParametros )
	EndFunc
