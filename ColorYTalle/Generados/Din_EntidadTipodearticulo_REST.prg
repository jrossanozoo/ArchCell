...
define class Din_EntidadTipodearticulo_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Tipodearticulo"
	cClaseResponse = this.cNamespaceDTOs + ".TipodearticuloResponse"
	cClaseModelo = "TipodearticuloModelo"
	cEntidad = "Tipodearticulo"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "TipodearticuloModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TipodearticuloListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "TipodearticuloListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "TipodearticuloModelo"
		endcase
		return lcRetorno
