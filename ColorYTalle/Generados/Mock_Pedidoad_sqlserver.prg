...
define class Mock_Pedidoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Pedidoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfiltroespecifico() as string                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerfiltroespecifico', lcParametros )
	EndFunc
