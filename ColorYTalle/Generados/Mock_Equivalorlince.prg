...
define class Mock_equivalorlince as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Equivalencia de valores Lince"                                                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function buscardatoendatalle( tcdato as string ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Buscardatoendatalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iralprimero() as void                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Iralprimero', lcParametros )
	EndFunc
