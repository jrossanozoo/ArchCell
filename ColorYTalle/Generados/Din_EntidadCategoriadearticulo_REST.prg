...
define class Din_EntidadCategoriadearticulo_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Categoriadearticulo"
	cClaseResponse = this.cNamespaceDTOs + ".CategoriadearticuloResponse"
	cClaseModelo = "CategoriadearticuloModelo"
	cEntidad = "Categoriadearticulo"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "CategoriadearticuloModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CategoriadearticuloListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "CategoriadearticuloListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "CategoriadearticuloModelo"
		endcase
		return lcRetorno
