...
define class Mock_Cierredelotead_sqlserver as MockBase of MockBase.prg

	cClase = 'Cierredelotead_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalledetalle( tcatributo as string ) as string                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercampodetalledetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalledetalle( tccampos as string ) as string                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalledetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalledetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalledetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detcielote( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detcielote', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalledetalle( tccampos as string ) as string                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Parsearcamposdetalledetalle', lcParametros )
	EndFunc
