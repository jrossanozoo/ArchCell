...
define class Mock_Itemdisenoimpresionatributos as MockBase of MockBase.prg

	cClase = 'Itemdisenoimpresionatributos'
	...
	*-----------------------------------------------------------------------------------------
	function contenido_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Contenido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function funcionagrupar_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Funcionagrupar_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mascara_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Mascara_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function prioridadordenamiento_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Prioridadordenamiento_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function prioridadordenamiento_despuesdeasignar() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Prioridadordenamiento_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_contenido( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_contenido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_funcionagrupar( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_funcionagrupar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_mascara( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_mascara', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_prioridadordenamiento( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_prioridadordenamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_contenido( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_contenido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_funcionagrupar( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_funcionagrupar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_mascara( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_mascara', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_prioridadordenamiento( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_prioridadordenamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocontenido() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridocontenido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofuncionagrupar() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofuncionagrupar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomascara() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridomascara', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprioridadordenamiento() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridoprioridadordenamiento', lcParametros )
	EndFunc
