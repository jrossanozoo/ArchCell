...
define class Mock_movimientostockdesdeproducc as MockBase of MockBase.prg
	...
	cClase = 'movimientostockdesdeproducc'
	...
	*-----------------------------------------------------------------------------------------
	protected function fuegeneradodesdeotrocomprobante( tcestado as string, tntipocomprobanteavalidar as string ) as boolean                                                                                                                                  
		...
		lnParametros = pcount()
		lxParam1 = tcestado
		lxParam2 = tntipocomprobanteavalidar
		...
		return this.ObtenerResultado( 'Fuegeneradodesdeotrocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function tienecomprobantesrelacionadosqueimpidaneliminar() as void                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Tienecomprobantesrelacionadosqueimpidaneliminar', lcParametros )
	EndFunc
