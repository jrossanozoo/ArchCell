...
define class Mock_Itemdatostarjetadetalleplanes as MockBase of MockBase.prg

	cClase = 'Itemdatostarjetadetalleplanes'
	...
	*-----------------------------------------------------------------------------------------
	function cuota_assign( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cuota_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cuota( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_cuota', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalporcuota( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_totalporcuota', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalporcuota_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Totalporcuota_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cuota( txval as variant ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_cuota', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalporcuota( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_totalporcuota', lcParametros )
	EndFunc
