...
cCodigoPrevioGuardarComo = ""
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarTipoArchivo() as boolean
		...
		if empty( this.TipoArchivo_PK )
			this.AgregarInformacion( 'Debe cargar el campo Tipo archivo importación', 9005, 'TipoArchivo' )
			llRetorno = .F.
		else
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarTipoRegistro() as boolean
		...
		if empty( this.TipoRegistro_PK )
			this.AgregarInformacion( 'Debe cargar el campo Tipo registro importación', 9005, 'TipoRegistro' )
			llRetorno = .F.
		else
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<BLOQUEARREGISTRO><GUARDARCOMO><NOLISTAGENERICO><NOIMPO><NOEXPO><EDICIONPARCIAL>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
			...
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						...
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Archivo para la entidad Diseños de importación." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarColeccionDeAtributosConEdicionRestringida() as Void
		this.oAtributosConEdicionRestringida.Agregar( 'ARCHIVOENTRADA', 'ARCHIVOENTRADA')
		this.oAtributosConEdicionRestringida.Agregar( 'RUTAPROCESADOS', 'RUTAPROCESADOS')
		this.oAtributosConEdicionRestringida.Agregar( 'RUTAALERTAS', 'RUTAALERTAS')
		this.oAtributosConEdicionRestringida.Agregar( 'RUTAERRORES', 'RUTAERRORES')
		this.oAtributosConEdicionRestringida.Agregar( 'ACCIONCONARCHIVOENTRADASINALERTAS', 'ACCIONCONARCHIVOENTRADASINALERTAS')
		this.oAtributosConEdicionRestringida.Agregar( 'ACCIONCONARCHIVOENTRADACONALERTAS', 'ACCIONCONARCHIVOENTRADACONALERTAS')
		this.oAtributosConEdicionRestringida.Agregar( 'ACCIONCONARCHIVOERRORES', 'ACCIONCONARCHIVOERRORES')
	Endfunc
