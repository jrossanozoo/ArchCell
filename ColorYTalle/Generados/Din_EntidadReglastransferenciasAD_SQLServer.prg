...
define class Din_EntidadREGLASTRANSFERENCIASAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxReglatransFecimpo, lxReglatransFectrans, lxReglatransFmodifw, lxReglatransFecexpo, lxReglatransFaltafw, lxReglatransHaltafw, lxReglatransUaltafw, lxReglatransHoraexpo, lxReglatransHmodifw, lxReglatransSaltafw, lxReglatransUmodifw, lxReglatransHoraimpo, lxReglatransValtafw, lxReglatransVmodifw, lxReglatransZadsfw, lxReglatransBdaltafw, lxReglatransBdmodifw, lxReglatransSmodifw, lxReglatransEsttrans, lxReglatransAccion, lxReglatransTrans, lxReglatransCcod, lxReglatransObs, lxReglatransDestino, lxReglatransOrigen, lxReglatransOrigdest, lxReglatransMotivo, lxReglatransCdes, lxReglatransDdesde, lxReglatransDhasta, lxReglatransLhabilit
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.REGLATRANS ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Haltafw","Ualtafw","Horaexpo","Hmodifw","Saltafw","Umodifw","Horaimpo","Valtafw","Vmodifw","Zadsfw","Bdaltafw","Bdmodifw","Smodifw","Esttrans","Accion","Trans","Ccod","Obs","Destino","Origen","Origdest","Motivo","Cdes","Ddesde","Dhasta","Lhabilit" ) values ( <<"'" + this.ConvertirDateSql( lxReglatransFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxReglatransFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxReglatransFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxReglatransFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxReglatransFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransEsttrans ) + "'" >>, <<lxReglatransAccion >>, <<"'" + this.FormatearTextoSql( lxReglatransTrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransCcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransDestino ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransOrigen ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransOrigdest ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransMotivo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxReglatransCdes ) + "'" >>, <<"'" + this.ConvertirDateSql( lxReglatransDdesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxReglatransDhasta ) + "'" >>, <<iif( lxReglatransLhabilit, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Ualtafw" as "Usuarioaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Accion" as "Accion", "Trans" as "Transferencia", "Ccod" as "Codigo", "Obs" as "Obs", "Destino" as "Destino", "Origen" as "Origen", "Origdest" as "Origendestino", "Motivo" as "Motivo", "Cdes" as "Descripcion", "Ddesde" as "Fechadesde", "Dhasta" as "Fechahasta", "Lhabilit" as "Habilitada" from ORGANIZACION.REGLATRANS where "Ccod" = <<"'" + this.FormatearTextoSql( lxReglatransCcod ) + "'">> and  REGLATRANS.CCOD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Haltafw,Ualtafw,Horaexpo,Hmodifw,Saltafw,Umodifw,Ho" + ;
"raimpo,Valtafw,Vmodifw,Zadsfw,Bdaltafw,Bdmodifw,Smodifw,Esttrans,Accion,Trans,Ccod,Obs,Destino,Orige" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, HALTAFW, UALTAFW, HORAEXPO, HMODIFW, SALTAFW, UMODIFW, HORAIMPO, VALTAFW, VMODIFW, ZADSFW, BDALTAFW, BDMODIFW, SMODIFW, ESTTRANS, accion, trans, cCod, obs, destino, origen, OrigDest, motivo, cDes, dDesde, dHasta, lHabilit
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + transform( &lcCursor..accion ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..trans ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ACCION = isnull( d.ACCION, t.ACCION ),t.TRANS = isnull( d.TRANS, t.TRANS ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.OBS = isnull( d.OBS, t.OBS ),t.DESTINO = isnull( d.DESTINO, t.DESTINO ),t.ORIGEN = isnull( d.ORIGEN, t.ORIGEN ),t.ORIGDEST = isnull( d.ORIGDEST, t.ORIGDEST ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.CDES = isnull( d.CDES, t.CDES ),t.DDESDE = isnull( d.DDESDE, t.DDESDE ),t.DHASTA = isnull( d.DHASTA, t.DHASTA ),t.LHABILIT = isnull( d.LHABILIT, t.LHABILIT )
					from ORGANIZACION.REGLATRANS t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ORGANIZACION.REGLATRANS(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Haltafw,Ualtafw,Horaexpo,Hmodifw,Saltafw,Umodifw,Horaimpo,Valtafw,Vmodifw,Zadsfw,Bdaltafw,Bdmodifw,Smodifw,Esttrans,Accion,Trans,Ccod,Obs,Destino,Origen,Origdest,Motivo,Cdes,Ddesde,Dhasta,Lhabilit)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),convert( char(8), getdate(), 108 ),isnull( d.UALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.SMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.ACCION,0),isnull( d.TRANS,''),isnull( d.CCOD,''),isnull( d.OBS,''),isnull( d.DESTINO,''),isnull( d.ORIGEN,''),isnull( d.ORIGDEST,''),isnull( d.MOTIVO,''),isnull( d.CDES,''),isnull( d.DDESDE,''),isnull( d.DHASTA,''),isnull( d.LHABILIT,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="REGLASTRANSFERENCIAS                    " atributo="FECHATRANSFERENCIA                      " tabla="REGLATRANS     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGLASTRANSFERENCIAS                    " atributo="ESTADOTRANSFERENCIA                     " tabla="REGLATRANS     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGLASTRANSFERENCIAS                    " atributo="TRANSFERENCIA                           " tabla="REGLATRANS     " campo="TRANS     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="12" etiqueta="Paquete de datos                                                                                                                                                " dominio="COMBOTRANSFERENCIAS           " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGLASTRANSFERENCIAS                    " atributo="ORIGEN                                  " tabla="REGLATRANS     " campo="ORIGEN    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Base de datos de origen                                                                                                                                         " dominio="COMBOSUCURSALESCONVACIO       " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ORIGENDEDATOS                           " atributo="DESCRIPCION                             " tabla="ORDAT          " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="409" etiqueta="Detalle Ori.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ORDAT On REGLATRANS.ORIGDEST = ORDAT.CODIGO And  ORDAT.CODIGO != ''                                                                                                                                                                                " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
