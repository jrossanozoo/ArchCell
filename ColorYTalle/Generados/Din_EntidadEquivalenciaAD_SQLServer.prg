	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.EQUI ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Hmodifw","Saltafw","Ualtafw","Umodifw","Vmodifw","Horaimpo","Valtafw","Zadsfw","Horaexpo","Bdmodifw","Esttrans","Bdaltafw","Haltafw","Tipagrupub","Timestamp","Cobserva","Ccodigo","Carticul","Ccolor","Ctalle","Ncantidad","Lesgtin" ) values ( <<"'" + this.ConvertirDateSql( lxEquiFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEquiFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEquiFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEquiFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEquiFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiHaltafw ) + "'" >>, <<lxEquiTipagrupub >>, <<lxEquiTimestamp >>, <<"'" + this.FormatearTextoSql( lxEquiCobserva ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiCcodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiCarticul ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiCcolor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEquiCtalle ) + "'" >>, <<lxEquiNcantidad >>, <<iif( lxEquiLesgtin, 1, 0 ) >> )
			endtext
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubCBA("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.EQUI set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEquiFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEquiFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxEquiFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEquiFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEquiFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEquiSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEquiHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEquiSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEquiUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEquiUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEquiVmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEquiHoraimpo ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEquiValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEquiZadsfw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEquiHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEquiBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEquiEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEquiBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEquiHaltafw ) + "'">>,"Tipagrupub" = <<lxEquiTipagrupub>>,"Timestamp" = <<lxEquiTimestamp>>,"Cobserva" = <<"'" + this.FormatearTextoSql( lxEquiCobserva ) + "'">>,"Ccodigo" = <<"'" + this.FormatearTextoSql( lxEquiCcodigo ) + "'">>,"Carticul" = <<"'" + this.FormatearTextoSql( lxEquiCarticul ) + "'">>,"Ccolor" = <<"'" + this.FormatearTextoSql( lxEquiCcolor ) + "'">>,"Ctalle" = <<"'" + this.FormatearTextoSql( lxEquiCtalle ) + "'">>,"Ncantidad" = <<lxEquiNcantidad>>,"Lesgtin" = <<iif( lxEquiLesgtin, 1, 0 )>> where "Ccodigo" = <<"'" + this.FormatearTextoSql( lxEquiCcodigo ) + "'">> and  EQUI.CCODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
			this.ComprobarResultadoDeEjecucionDelUpdate()
		this.ComprobarTransaccion()
			this.oConexion.EjecutarSql( 'delete from ZooLogic.AgruPubCBA where "Codigo" = ' + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Cobserva" as "Observacion", "Ccodigo" as "Codigo", "Carticul" as "Articulo", "Ccolor" as "Color", "Ctalle" as "Talle", "Ncantidad" as "Cantidad", "Lesgtin" as "Esgtin" from ZooLogic.EQUI where "Ccodigo" = <<"'" + this.FormatearTextoSql( lxEquiCcodigo ) + "'">> and  EQUI.CCODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Agrup" as "Agrupamiento", "Agrupdes" as "Agrupamientodetalle" from ZooLogic.AgruPubCBA where Codigo = <<"'" + this.FormatearTextoSql( c_EQUIVALENCIA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Cobserva" as "Observacion", "Ccodigo" as "Codigo", "Carticul" as "Articulo", "Ccolor" as "Color", "Ctalle" as "Talle", "Ncantidad" as "Cantidad", "Lesgtin" as "Esgtin" from ZooLogic.EQUI where  EQUI.CCODIGO != '' order by cCodigo
			endtext
			use in select('c_EQUIVALENCIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EQUIVALENCIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Cobserva" as "Observacion", "Ccodigo" as "Codigo", "Carticul" as "Articulo", "Ccolor" as "Color", "Ctalle" as "Talle", "Ncantidad" as "Cantidad", "Lesgtin" as "Esgtin" from ZooLogic.EQUI where  funciones.padr( cCodigo, 20, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  EQUI.CCODIGO != '' order by cCodigo
			endtext
			use in select('c_EQUIVALENCIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EQUIVALENCIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Vmodifw,Hor" + ;
"aimpo,Valtafw,Zadsfw,Horaexpo,Bdmodifw,Esttrans,Bdaltafw,Haltafw,Tipagrupub,Timestamp,Cobserva,Ccodi" + ;
"go,Carticul,Ccolor,Ctalle,Ncantidad,Lesgtin" + ;
" from ZooLogic.EQUI where  EQUI.CCODIGO != '' and " + lcFiltro )
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Timestamp" as "Timestamp", "Cobserva" as "Observacion", "Ccodigo" as "Codigo", "Carticul" as "Articulo", "Ccolor" as "Color", "Ctalle" as "Talle", "Ncantidad" as "Cantidad", "Lesgtin" as "Esgtin"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAgruPubliDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		Local lcAtributos As String, lcWhere As String
		lcWhere = " Where  AGRUPUBCBA.CODIGO != ''"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
		...
		return this.ObtenerDatos( lcAtributos, tcHaving, tcOrder, tcFunc, lcWhere, 'AgruPubCBA', 'AgruPubliDetalle', tnTope )
	Endfunc
		...
		With this
			...
			for each loItem in this.oEntidad.AgruPubliDetalle
				if this.oEntidad.AgruPubliDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAgrupamientodetalle = loItem.Agrupamientodetalle
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.AgruPubCBA("NROITEM","Codigo","Agrup","AgrupDes" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAgrupamiento_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxAgrupamientodetalle ) + "'">> ) 
					endtext
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.EQUI set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEquiFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxEquiFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEquiFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxEquiFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxEquiFectrans ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxEquiSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxEquiHmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxEquiSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxEquiUaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxEquiUmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxEquiVmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxEquiHoraimpo ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxEquiValtafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxEquiZadsfw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxEquiHoraexpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEquiBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxEquiEsttrans ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEquiBdaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxEquiHaltafw ) + "'">>, "Tipagrupub" = <<lxEquiTipagrupub>>, "Timestamp" = <<lxEquiTimestamp>>, "Cobserva" = <<"'" + this.FormatearTextoSql( lxEquiCobserva ) + "'">>, "Ccodigo" = <<"'" + this.FormatearTextoSql( lxEquiCcodigo ) + "'">>, "Carticul" = <<"'" + this.FormatearTextoSql( lxEquiCarticul ) + "'">>, "Ccolor" = <<"'" + this.FormatearTextoSql( lxEquiCcolor ) + "'">>, "Ctalle" = <<"'" + this.FormatearTextoSql( lxEquiCtalle ) + "'">>, "Ncantidad" = <<lxEquiNcantidad>>, "Lesgtin" = <<iif( lxEquiLesgtin, 1, 0 )>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'EQUI' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			loColeccion.Agregar([delete from ZooLogic.AgruPubCBA where "Codigo" = ] + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'")
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.EQUI set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, cObserva = ] + "'" + this.FormatearTextoSql( &lcCursor..cObserva ) + "'"+ [, cCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'"+ [, cArticul = ] + "'" + this.FormatearTextoSql( &lcCursor..cArticul ) + "'"+ [, cColor = ] + "'" + this.FormatearTextoSql( &lcCursor..cColor ) + "'"+ [, cTalle = ] + "'" + this.FormatearTextoSql( &lcCursor..cTalle ) + "'"+ [, nCantidad = ] + transform( &lcCursor..nCantidad )+ [, lEsGtin = ] + Transform( iif( &lcCursor..lEsGtin, 1, 0 )) + [ Where cCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, HMODIFW, SALTAFW, UALTAFW, UMODIFW, VMODIFW, HORAIMPO, VALTAFW, ZADSFW, HORAEXPO, BDMODIFW, ESTTRANS, BDALTAFW, HALTAFW, tipagrupub, TIMESTAMP, cObserva, cCodigo, cArticul, cColor, cTalle, nCantidad, lEsGtin
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + transform( &lcCursor..tipagrupub ) + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cObserva ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cArticul ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cColor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cTalle ) + "'" + ',' + transform( &lcCursor..nCantidad ) + ',' + Transform( iif( &lcCursor..lEsGtin, 1, 0 ))
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirDetalles() As Void
		...
		If lcCantRegistros > 0
			lcIn = This.ObtenerInSqlServer( lcCursor, 'cCodigo','C')
			lnFragmento = goRegistry.nucleo.cantidadDeElementosEnSentenciaInSQL
			loIn = this.ObtenerColeccionInSqlServer( lcCursor,'','cCodigo')
			...
			this.oConexion.EjecutarSql( [Delete From ZooLogic.AgruPubCBA Where Codigo] + lcIn  )
			endfor
			if llEjecutaEnTransaccion
				this.oConexion.EjecutarSQL( 'COMMIT TRANSACTION' )
			endif
	...
	lcDetalle = This.oEntidad.cPrefijoRecibir + 'ITEMAGRUPAPUBLICCBA'
	Select * From &lcDetalle into cursor cDetallesExistentes ;
		where Codigo in ( select cCodigo from &lcCursor )
	select cDetallesExistentes
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","Codigo","Agrup","AgrupDes"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.AgruPubCBA ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Agrup      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.AgrupDes   ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	...
	*--------------------------------------------------------------------------------------------------------
	protected function CrearCursorMemo( tcCursorACrear as String, tcTablaConMemo as String ) as Void
		create cursor &tcCursorACrear ( cCodigo C (20) , Orden N(16), texto C(80))
	endfunc
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'EQUIVALENCIA_COBSERVA'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'ITEMAGRUPAPUBLICCBA'
				llRetorno = .T.
		EndCase
		Return llRetorno
	EndFunc
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplicarReglaDeNegocioTablaDeTrabajo( toConexion as Object ) As Void
		...
		try
			...
			toConexion.EjecutarNonQuery( 'DISABLE TRIGGER ALL ON ZooLogic.TablaTrabajo_EQUI' )
			...
			*** Valor sugerido Observacion
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "EQUIVALENCIA", "", "Observacion" )
			if !empty( NVL( lcExpresionValorSugeridoDefinidoPorElUsuario, "" ) )
				lvValor = &lcExpresionValorSugeridoDefinidoPorElUsuario
				toConexion.EjecutarNonQuery( "UPDATE ZooLogic.TablaTrabajo_EQUI SET cObserva = " + golibrerias.ValorAStringSegunTipoBase( lvValor  ) + " WHERE Funciones.Empty( cObserva ) = 1" )
			endif
			
			*** Valor sugerido Cantidad
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "EQUIVALENCIA", "", "Cantidad" )
			if !empty( NVL( lcExpresionValorSugeridoDefinidoPorElUsuario, "" ) )
				lvValor = &lcExpresionValorSugeridoDefinidoPorElUsuario
				toConexion.EjecutarNonQuery( "UPDATE ZooLogic.TablaTrabajo_EQUI SET nCantidad = " + golibrerias.ValorAStringSegunTipoBase( lvValor  ) + " WHERE Funciones.Empty( nCantidad ) = 1" )
			endif
			
			*** Valor sugerido EsGTIN
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "EQUIVALENCIA", "", "EsGTIN" )
			llNoVienePorDiseño = isnull(&lcCursor..lEsGtin ) &&El atributo no está definido en el diseño de importación. Ésta condicion es solamente para atributos boleanos
			if !empty( NVL( lcExpresionValorSugeridoDefinidoPorElUsuario, "" ) ) and llNoVienePorDiseño 
				lvValor = &lcExpresionValorSugeridoDefinidoPorElUsuario
				toConexion.EjecutarNonQuery( "UPDATE ZooLogic.TablaTrabajo_EQUI SET lEsGtin = " + golibrerias.ValorAStringSegunTipoBase( lvValor  ) + " WHERE Funciones.Empty( lEsGtin ) = 1" )
			endif
			...
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_EQUI','ZooLogic.TablaTrabajoErroresValidacion_EQUI', 'FECEXPO', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_EQUI','ZooLogic.TablaTrabajoErroresValidacion_EQUI', 'FMODIFW', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_EQUI','ZooLogic.TablaTrabajoErroresValidacion_EQUI', 'FECIMPO', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_EQUI','ZooLogic.TablaTrabajoErroresValidacion_EQUI', 'FALTAFW', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Fecha( 'ZooLogic.TablaTrabajo_EQUI','ZooLogic.TablaTrabajoErroresValidacion_EQUI', 'FECTRANS', toConexion )
			this.oEntidad.oValidacionDominios.ValidarDominioBloqueImportacion_Numericononegativo( 'ZooLogic.TablaTrabajo_EQUI','ZooLogic.TablaTrabajoErroresValidacion_EQUI', 'nCantidad', toConexion )

			* Articulo obligatorio y FK 
			lcWhere = 'WHERE Funciones.Empty( cArticul ) = 1 or cArticul NOT IN ( SELECT ARTCOD from ZooLogic.ART )'
			lcExpresionMensaje  = [CASE WHEN Funciones.Empty( cArticul ) = 1 THEN 'Debe cargar el campo Articulo.' ELSE 'El dato buscado ' + RTRIM( CAST( cArticul AS VARCHAR(255) ) ) + ' de la entidad ARTICULO no existe.' END]
			...
			* Color FK 
			...
			toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.TablaTrabajoErroresValidacion_EQUI ( NroLinea, Motivo ) SELECT NroLinea, ] + lcExpresionMensaje  + [ FROM ZooLogic.TablaTrabajo_EQUI ] + lcWhere )
			toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.Logueos ( ] + lcCamposLogueo + [ ) ] + lcValuesLogueoComunes + lcExpresionMensaje  + [ FROM ZooLogic.TablaTrabajo_EQUI ] + lcWhere )
			toConexion.EjecutarNonQuery( [DELETE FROM ZooLogic.TablaTrabajo_EQUI ] + lcWhere )
			
			* Talle FK 
			lcWhere = 'WHERE Funciones.Empty( cTalle ) = 0 AND  cTalle NOT IN ( SELECT Codigo FROM ZooLogic.Talle )'
			lcExpresionMensaje  = ['El dato buscado ' + RTRIM( CAST( cTalle AS VARCHAR(255) ) ) + ' de la entidad TALLE no existe.']
			toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.TablaTrabajoErroresValidacion_EQUI ( NroLinea, Motivo ) SELECT NroLinea, ] + lcExpresionMensaje  + [ FROM ZooLogic.TablaTrabajo_EQUI ] + lcWhere )
			toConexion.EjecutarNonQuery( [INSERT INTO ZooLogic.Logueos ( ] + lcCamposLogueo + [ ) ] + lcValuesLogueoComunes + lcExpresionMensaje  + [ FROM ZooLogic.TablaTrabajo_EQUI ] + lcWhere )
			toConexion.EjecutarNonQuery( [DELETE FROM ZooLogic.TablaTrabajo_EQUI ] + lcWhere )
			
			this.oEntidad.EjecutarReglaDeNegocioPersonalizadaImportacion( toConexion )
			toConexion.EjecutarNonQuery( 'ENABLE TRIGGER ALL ON ZooLogic.TablaTrabajo_EQUI' )
		catch to loError
			goServicios.Errores.LevantarExcepcion( loError )
		endtry
	EndFunc
...
"ccodigo" char( 20 )  null, 
"carticul" char( 15 )  null, 
"ccolor" char( 6 )  null, 
"ctalle" char( 5 )  null, 
...
"lesgtin" bit  null )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function CrearTablaDeTrabajoDetalles( toConexion as Object ) as void
		...
		* TablaTrabajo_EQUI_AgruPubCBA
		local lcSentencia as string
		text to lcSentencia textmerge noshow
		IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID('ZooLogic.TablaTrabajo_EQUI_AgruPubCBA') AND type in ('U')) DROP TABLE ZooLogic.TablaTrabajo_EQUI_AgruPubCBA
Create Table ZooLogic.TablaTrabajo_EQUI_AgruPubCBA ( 
 "Nrolinea" numeric( 20, 0 ) null, 
...
"campo0" numeric( 20, 0 )  null )
		...
		********Agrego el trigger a la tabla
		if this.oEntidad.VerificarContexto( 'CB' )
			lcSentencia = this.ObtenerTriggerDeleteTransferencia_AgruPubCBA( 'TablaTrabajo_EQUI_AgruPubCBA' )
		else
			lcSentencia = this.ObtenerTriggerDeleteImportacion_AgruPubCBA( 'TablaTrabajo_EQUI_AgruPubCBA' )
		endif
		toConexion.EjecutarNonQuery( lcSentencia )
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	protected function CargarTablaDeTrabajoDetalles( toConexion as Object ) as void
		...
		loManejador = _Screen.DotNetBridge.CrearObjeto( 'ZooLogicSA.ManejadorArchivos.CopiaMasiva' )
		if this.oEntidad.VerificarContexto( 'CB' )
			lcCursor = This.oEntidad.cPrefijoRecibir + 'ITEMAGRUPAPUBLICCBA'
		else
			lcCursor = this.oEntidad.cPrefijoImportar + 'ITEMAGRUPAPUBLICCBA'
		endif
		if used( lcCursor )
		with loManejador
			...
			.CadenaConexionOrigen = 'Provider=VFPOLEDB.1;Data Source= ' +  justpath( dbf( lcCursor ) )
			.CadenaConexionDestino = this.oConexion.oManagerConexionASql.ObtenerCadenaConexionNet()
			.NombreTablaSqlServer = 'ZooLogic.TablaTrabajo_EQUI_AgruPubCBA'
			.ConsultaOrigen = 'select * from ' + lcCursor
			Select( lcCursor )
			Count to This.nCantVeces
			This.nCantVeces = ceiling( This.nCantVeces / This.nCantABorrar )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.COBSERVA = isnull( d.COBSERVA, t.COBSERVA ),t.CCODIGO = isnull( d.CCODIGO, t.CCODIGO ),t.CARTICUL = isnull( d.CARTICUL, t.CARTICUL ),t.CCOLOR = isnull( d.CCOLOR, t.CCOLOR ),t.CTALLE = isnull( d.CTALLE, t.CTALLE ),t.NCANTIDAD = isnull( d.NCANTIDAD, t.NCANTIDAD ),t.LESGTIN = isnull( d.LESGTIN, t.LESGTIN )
					from ZooLogic.EQUI t inner join deleted d 
							 on t.cCodigo = d.cCodigo
				-- Fin Updates
				insert into ZooLogic.EQUI(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Vmodifw,Horaimpo,Valtafw,Zadsfw,Horaexpo,Bdmodifw,Esttrans,Bdaltafw,Haltafw,Tipagrupub,Timestamp,Cobserva,Ccodigo,Carticul,Ccolor,Ctalle,Ncantidad,Lesgtin)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.TIPAGRUPUB,0),isnull( d.TIMESTAMP,0),isnull( d.COBSERVA,''),isnull( d.CCODIGO,''),isnull( d.CARTICUL,''),isnull( d.CCOLOR,''),isnull( d.CTALLE,''),isnull( d.NCANTIDAD,0),isnull( d.LESGTIN,0)
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_AgruPubCBA( tcTablaTrabajo ) as String

		Text to lcCadena noshow textmerge
		CREATE TRIGGER ZooLogic.DELETE_TablaTrabajo_EQUI_AgruPubCBA
ON ZooLogic.TablaTrabajo_EQUI_AgruPubCBA
AFTER DELETE
As
Begin
Update t Set 
...
from ZooLogic.AgruPubCBA t inner join deleted d 
 on t.CODIGO = d.CODIGO
-- Fin Updates
insert into ZooLogic.AgruPubCBA
( 
"NROITEM",
"CODIGO",
"AGRUP",
...
d.AGRUP,
d.AGRUPDES
From deleted d left join ZooLogic.AgruPubCBA pk 
...
End
	...
	*--------------------------------------------------------------------------------------------------------
	protected Function EliminarTablasDeTrabajo( toConexion as Object ) as void
		...
		text to lcSentencia textmerge noshow
		IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID('ZooLogic.TablaTrabajo_AgruPubCBA') AND type in ('U')) DROP TABLE ZooLogic.TablaTrabajo_AgruPubCBA
		endtext
		toConexion.EjecutarNonQuery( lcSentencia )
	endfunc
		...
		with this.oEntidad
			...
			if reccount( 'c_EQUIVALENCIA' ) < 1
				...
				Try
					...
					.Tipoagrupamientopublicaciones = nvl( c_EQUIVALENCIA.Tipoagrupamientopublicaciones, 0 )
					...
					.Talle_PK =  nvl( c_EQUIVALENCIA.Talle, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="EQUIVALENCIA                            " atributo="FECHATRANSFERENCIA                      " tabla="EQUI           " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha de novedad                                                                                                                                                " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EQUIVALENCIA                            " atributo="ESTADOTRANSFERENCIA                     " tabla="EQUI           " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado de novedad                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EQUIVALENCIA                            " atributo="TIPOAGRUPAMIENTOPUBLICACIONES           " tabla="EQUI           " campo="TIPAGRUPUB" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EQUIVALENCIA                            " atributo="OBSERVACION                             " tabla="EQUI           " campo="COBSERVA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EQUIVALENCIA                            " atributo="CODIGO                                  " tabla="EQUI           " campo="CCODIGO   " claveprimaria="true" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="2" etiqueta="Código                                                                                                                                                          " dominio="CLAVECONCUALQUIERCARACTER     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EQUIVALENCIA                            " atributo="AGRUPUBLIDETALLE                        " tabla="AGRUPUBCBA     " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Agrupamientos                                                                                                                                                   " dominio="DETALLEITEMAGRUPAPUBLICCBA    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EQUIVALENCIA                            " atributo="ARTICULO                                " tabla="EQUI           " campo="CARTICUL  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Artículo                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EQUIVALENCIA                            " atributo="COLOR                                   " tabla="EQUI           " campo="CCOLOR    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Color                                                                                                                                                           " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EQUIVALENCIA                            " atributo="TALLE                                   " tabla="EQUI           " campo="CTALLE    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TALLE                                   " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Talle                                                                                                                                                           " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COLOR                                   " atributo="DESCRIPCION                             " tabla="COL            " campo="COLDES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="11" etiqueta="Detalle Col.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join COL On EQUI.CCOLOR = COL.COLCOD And  COL.COLCOD != ''                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TALLE                                   " atributo="DESCRIPCION                             " tabla="TALLE          " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="13" etiqueta="Detalle Tal.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join TALLE On EQUI.CTALLE = TALLE.Codigo And  TALLE.CODIGO != ''                                                                                                                                                                                        " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
