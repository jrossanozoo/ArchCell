...
define class Din_DetalleDISENOEXPOEntidades as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemDISENOEXPOEntidades' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		scan for &lcFiltro
			...
			loItem.NROITEM = c_Entidades.NROITEM
			loItem.BLOQUEARREGISTRO = c_Entidades.BLOQUEARREGISTRO
			loItem.OCULTARNODOEXPO = c_Entidades.OCULTARNODOEXPO
			loItem.Codigo = c_Entidades.Codigo
			loItem.Entidad = c_Entidades.Entidad
			loItem.NroItem = lnI 
