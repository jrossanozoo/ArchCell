...
define class Mock_Detalledisenoimpresionentidades as MockBase of MockBase.prg

	cClase = 'Detalledisenoimpresionentidades'

	
	cAtributosAgrupamiento = ""                                                                                                                                                                                                                               
	cAtributosAgrupamientoDefault = "NroItem"                                                                                                                                                                                                                 
	cAtributosUnicidad = ""                                                                                                                                                                                                                                   
	cAtributosUnicidad = 'Entidad'                                                                                                                                                                                                                            
	cContexto = ""                                                                                                                                                                                                                                            
	cCopiadorDeDetalle = "CopiadorDeDetalles"                                                                                                                                                                                                                 
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Entidades afectadas'                                                                                                                                                                                                                         
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'La columna Entidades no admite valores repetidos.'                                                                                                                                                                               
	cNombre = 'Entidades'                                                                                                                                                                                                                                     
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Entidades afectadas'                                                                                                                                                                                                                     
	datasession = 1                                                                                                                                                                                                                                           
