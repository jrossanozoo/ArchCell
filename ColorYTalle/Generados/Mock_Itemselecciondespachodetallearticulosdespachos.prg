...
define class Mock_Itemselecciondespachodetallearticulosdespachos as MockBase of MockBase.prg

	cClase = 'Itemselecciondespachodetallearticulosdespachos'
