...
define class Din_EntidadConsumoproduccion_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Colorytalle.Generados.DTO.Consumoproduccion"
	cClaseResponse = this.cNamespaceDTOs + ".ConsumoproduccionResponse"
	cClaseModelo = "ConsumoproduccionModelo"
	cEntidad = "Consumoproduccion"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ConsumoproduccionModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConsumoproduccionListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConsumoproduccionListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ConsumoproduccionModelo"
		endcase
		return lcRetorno
