...
define class Mock_Itemvalordetalleplanes as MockBase of MockBase.prg

	cClase = 'Itemvalordetalleplanes'
	...
	*-----------------------------------------------------------------------------------------
	function cantidaddedias_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cantidaddedias_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidaddedias( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_cantidaddedias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodemonto( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_tipodemonto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodemonto_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Tipodemonto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidaddedias( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_cantidaddedias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodemonto( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_tipodemonto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwtipodemonto() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridofwtipodemonto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipodemonto() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridotipodemonto', lcParametros )
	EndFunc
