...
define class Mock_Detalletransportistavehiculodetalle as MockBase of MockBase.prg

	cClase = 'Detalletransportistavehiculodetalle'

	
	cAtributosAgrupamiento = ""                                                                                                                                                                                                                               
	cAtributosAgrupamientoDefault = "NroItem"                                                                                                                                                                                                                 
	cAtributosUnicidad = ""                                                                                                                                                                                                                                   
	cAtributosUnicidad = 'Dominio'                                                                                                                                                                                                                            
	cContexto = ""                                                                                                                                                                                                                                            
	cCopiadorDeDetalle = "CopiadorDeDetalles"                                                                                                                                                                                                                 
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Vehículos'                                                                                                                                                                                                                                   
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'La columna Dominio del vehículo no admite valores repetidos.'                                                                                                                                                                    
	cNombre = 'Vehiculodetalle'                                                                                                                                                                                                                               
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Vehículos'                                                                                                                                                                                                                               
	datasession = 1                                                                                                                                                                                                                                           
