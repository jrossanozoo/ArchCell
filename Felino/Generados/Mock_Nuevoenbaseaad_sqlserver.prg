...
define class Mock_Nuevoenbaseaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Nuevoenbaseaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detenbasea( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detenbasea', lcParametros )
	EndFunc
