...
define class Mock_Itemfacturaelectronicadecreditovaloresdetalle as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicadecreditovaloresdetalle'
	...
	cAtributoPK = ""                                                                                                                                                                                                                                          
	cCodigoCondicionDePago = ""                                                                                                                                                                                                                               
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cNombre = 'FACTURAELECTRONICADECREDITO'                                                                                                                                                                                                                   
	cValorAnterior = ""                                                                                                                                                                                                                                       
	datasession = 1                                                                                                                                                                                                                                           
	lActualizarAutorizados = .F.                                                                                                                                                                                                                              
	lAjustandoRecibido = .F.                                                                                                                                                                                                                                  
	lAplicaDescuentoRecargo = .f.                                                                                                                                                                                                                             
	lAplicandoBeneficioPromocion = .f.                                                                                                                                                                                                                        
	lAplicandoCondicionDePago = .f.                                                                                                                                                                                                                           
	lAplicandoRetiroDeEfectivo = .f.                                                                                                                                                                                                                          
	lBuscandoCodigo = .f.                                                                                                                                                                                                                                     
	lCargaDesdeDatosTarjeta = .f.                                                                                                                                                                                                                             
	lCargando = .f.                                                                                                                                                                                                                                           
	lCargandoDesdeDatosTarjeta = .f.                                                                                                                                                                                                                          
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	lEdicion = .f.                                                                                                                                                                                                                                            
	lEsExe = .f.                                                                                                                                                                                                                                              
	lEsSubEntidad = .f.                                                                                                                                                                                                                                       
	lEstaCambiandoCotizacionPorCambioDeFecha = .F.                                                                                                                                                                                                            
	lEstaImportando = .f.                                                                                                                                                                                                                                     
	lEstaSeteandoCondicionDePago = .f.                                                                                                                                                                                                                        
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	lNuevo = .f.                                                                                                                                                                                                                                              
	lProcesandoDespuesDeSetearValor = .f.                                                                                                                                                                                                                     
	lRecibidoSinAjustar = .T.                                                                                                                                                                                                                                 
	lSeCargoValor = .t.                                                                                                                                                                                                                                       
	lSeteandoAtributoAcumulado = .f.                                                                                                                                                                                                                          
	lTieneAtributosSumarizados = .f.                                                                                                                                                                                                                          
	lTieneImporteEnRecibido = .f.                                                                                                                                                                                                                             
	lTieneImporteEnRecibido = .t.                                                                                                                                                                                                                             
	lUsaDescuentosYRecargos = .F.                                                                                                                                                                                                                             
	lUsaDescuentosYRecargos = .T.                                                                                                                                                                                                                             
	llPuedeEntrar = .T.                                                                                                                                                                                                                                       
	llUltimoItemDeLaCondicionDePago = .F.                                                                                                                                                                                                                     
	nCoeficienteImpuestos = 0                                                                                                                                                                                                                                 
	nDescuentoPorcentajeDeLaCondicionDePago = 0                                                                                                                                                                                                               
	nDiferenciaRedondeo = 0                                                                                                                                                                                                                                   
	nMontoOld = 0                                                                                                                                                                                                                                             
	nMontoPreEstimado = 0                                                                                                                                                                                                                                     
	nRecargoPorcentajeDeLaCondicionDePago = 0                                                                                                                                                                                                                 
	...
	*-----------------------------------------------------------------------------------------
	    function obtenermontobaserecargofinanciero( tnmontototal as decimal ) as decimal                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenermontobaserecargofinanciero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregartextoadicionaladescripciondelvalorporcuponintegrado( tcdescripcion as string ) as string                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Agregartextoadicionaladescripciondelvalorporcuponintegrado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ajustarrecibido( tndiferencia ) as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tndiferencia
		...
		return this.ObtenerResultado( 'Ajustarrecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aplicableparavuelto_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Aplicableparavuelto_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function aplicarrecargodirecto() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function asignarcajaxvalor() as void                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Asignarcajaxvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function blanquearatributosdelredondeodelrecibido() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Blanquearatributosdelredondeodelrecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calcularcoeficientedeimpuestos() as decimal                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function calculardescuentoitemactivo() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Calculardescuentoitemactivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function calcularrecargoitemactivo() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Calcularrecargoitemactivo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function calcularrecibidosugerido() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Calcularrecibidosugerido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function calculodemonto( tndescuento as float, tnrecargo as float ) as float                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tndescuento
		lxParam2 = tnrecargo
		...
		return this.ObtenerResultado( 'Calculodemonto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiarestadocampomontoorecibidoseguntipodetalle( toestado ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cambiarestadocampomontoorecibidoseguntipodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiocotizacion() as void                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiocotizacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambioestadoatributos( tnfila as integer ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cambioestadoatributos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function canttipovaloresacumulados_assign( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Canttipovaloresacumulados_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function condicionrecargo_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Condicionrecargo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cupon_pk_access() as string                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cupon_pk_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debeajustarrecibido() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debeajustarrecibido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function debecalcularrecargo( tovalor as ent_valor of ent_valor.prg ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function debeconservarfuncionalidadencomprobante() as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debeconservarfuncionalidadencomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descuentomontoenpesos_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Descuentomontoenpesos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descuentomontosinimpuestos_assign( txval as variant ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Descuentomontosinimpuestos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descuentoporcentaje_despuesdeasignar() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Descuentoporcentaje_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function despuesdesetearmonto() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Despuesdesetearmonto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function diferenciaporredondeodelrecibido_assign( txval as variant ) as void                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Diferenciaporredondeodelrecibido_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ejecutarprocesosdespuesdesetearvalor() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function esanulacion_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Esanulacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escuponanulado() as boolean                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Escuponanulado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function escuponconautorizacionpos() as boolean                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Escuponconautorizacionpos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escuponhuerfano_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Escuponhuerfano_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esvuelto_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Esvuelto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoantesdeaplicarrecargo()                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoantesdeaplicarrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoaplicarecargotarjeta( tnrecargo as integer, tnopcionboton as integer, tlmensajesinporcentaje as boolean ) as void                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tnrecargo
		lxParam2 = tnopcionboton
		lxParam3 = tlmensajesinporcentaje
		...
		return this.ObtenerResultado( 'Eventoaplicarecargotarjeta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventocalcularrecargo()                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocalcularrecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventocambioestadoatributos( toestadoatributos, tnfila ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toestadoatributos
		lxParam2 = tnfila
		...
		return this.ObtenerResultado( 'Eventocambioestadoatributos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiotipodevalor() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocambiotipodevalor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventocomponentecajero( tcatributo as string, toitem as object ) as void                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventocomponentecajero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventovalidar_valor( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventovalidar_valor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventovalidaritemantesdeprocesarvalor() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventovalidaritemantesdeprocesarvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarcuponparaanulacion() as object                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarcuponparaanulacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iditemretiroenefectivo_assign( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Iditemretiroenefectivo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iditemvalores_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Iditemvalores_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montoalcambio_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Montoalcambio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montodesrec_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Montodesrec_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montodesrecpesos_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Montodesrecpesos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montoori_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Montoori_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ncoeficienteimpuestos_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Ncoeficienteimpuestos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ndiferenciaredondeo_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Ndiferenciaredondeo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numerodecomprobante_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Numerodecomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numerovaledecambio_access() as variant                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Numerovaledecambio_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numerovaledecambio_pk_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Numerovaledecambio_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigomonedavalor() as string                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigomonedavalor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercodigomonedavuelto() as string                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigomonedavuelto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercodigovalor() as string                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigovalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercomponentechequesdeterceros() as componente of componente.prg                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function obtenercomponentechequespropios() as componente of componente.prg                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function obtenercondicionrecargo() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercondicionrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerimporteredondeado( tnimporte as float, tcatributo as string ) as float                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerimporteredondeado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermensajeportipodevalornopermitido( tovalor as object ) as string                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function obtenermonto() as integer                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermonto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerporcentajedesrec() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerporcentajedesrec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerprefijodecuponintegrado() as string                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerprefijodecuponintegrado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerrecibido() as void                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerrecibido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenervalor() as object                                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenervalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajedesrec_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Porcentajedesrec_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajediferenciaredondeorecibido_assign( txval as variant ) as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Porcentajediferenciaredondeorecibido_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetearporcentajededescuento() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesardespuesdesetearporcentajededescuento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetearporcentajederecargo() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesardespuesdesetearporcentajederecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetearvalorcheque() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesardespuesdesetearvalorcheque', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetearvalorcomprobantedecaja() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesardespuesdesetearvalorcomprobantedecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function realizarcargadedatosencomponentes() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Realizarcargadedatosencomponentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recargomonto_despuesdeasignar() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Recargomonto_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recargomontoenpesos_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Recargomontoenpesos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recargosinpercepciones_assign( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Recargosinpercepciones_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recibido_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Recibido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recibidoalcambio_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Recibidoalcambio_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recibidosugerido_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Recibidosugerido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function redondeo_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Redondeo_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function reestablecerflagseguntipodevalor() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Reestablecerflagseguntipodevalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function refrescartotalrecargovalores() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Refrescartotalrecargovalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_aplicableparavuelto( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_aplicableparavuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_canttipovaloresacumulados( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_canttipovaloresacumulados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_condicionrecargo( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_condicionrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descuentomontoenpesos( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_descuentomontoenpesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descuentomontosinimpuestos( txval as variant ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_descuentomontosinimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_diferenciaporredondeodelrecibido( txval as variant ) as void                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_diferenciaporredondeodelrecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_esanulacion( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_esanulacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_escuponhuerfano( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_escuponhuerfano', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_esvuelto( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_esvuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iditemretiroenefectivo( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_iditemretiroenefectivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_iditemvalores( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_iditemvalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montoalcambio( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_montoalcambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montodesrec( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_montodesrec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montodesrecpesos( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_montodesrecpesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montoori( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_montoori', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ncoeficienteimpuestos( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_ncoeficienteimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ndiferenciaredondeo( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_ndiferenciaredondeo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerodecomprobante( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_numerodecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerovaledecambio( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_numerovaledecambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porcentajedesrec( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_porcentajedesrec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porcentajediferenciaredondeorecibido( txval as variant ) as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_porcentajediferenciaredondeorecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_recargomontoenpesos( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_recargomontoenpesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_recargosinpercepciones( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_recargosinpercepciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_recibido( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_recibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_recibidoalcambio( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_recibidoalcambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_recibidosugerido( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_recibidosugerido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_signo( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_signo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodecomprobante( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_tipodecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearatributosporvalorvacio() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function setearcondicionrecargo( tncondicion as integer ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tncondicion
		...
		return this.ObtenerResultado( 'Setearcondicionrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearmontocupon( tndescuento as float, tnrecargo as float ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Setearmontocupon', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setearrecargo( tnrecargo as number ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function signo_assign( txval as variant ) as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Signo_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function tienedescuentosrecargoscomercialesyfinancieros() as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienedescuentosrecargoscomercialesyfinancieros', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function tienerecibidoennegativo() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienerecibidoennegativo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodecomprobante_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Tipodecomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_aplicableparavuelto( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_aplicableparavuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_canttipovaloresacumulados( txval as variant ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_canttipovaloresacumulados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_condicionrecargo( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_condicionrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descuentomontoenpesos( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_descuentomontoenpesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descuentomontosinimpuestos( txval as variant ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_descuentomontosinimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_diferenciaporredondeodelrecibido( txval as variant ) as boolean                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_diferenciaporredondeodelrecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_esanulacion( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_esanulacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_escuponhuerfano( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_escuponhuerfano', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_esvuelto( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_esvuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iditemretiroenefectivo( txval as variant ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_iditemretiroenefectivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_iditemvalores( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_iditemvalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montoalcambio( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_montoalcambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montodesrec( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_montodesrec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montodesrecpesos( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_montodesrecpesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montoori( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_montoori', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ncoeficienteimpuestos( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_ncoeficienteimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ndiferenciaredondeo( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_ndiferenciaredondeo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerodecomprobante( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_numerodecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerovaledecambio( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_numerovaledecambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajedesrec( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_porcentajedesrec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajediferenciaredondeorecibido( txval as variant ) as boolean                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_porcentajediferenciaredondeorecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_recargomontoenpesos( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_recargomontoenpesos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_recargosinpercepciones( txval as variant ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_recargosinpercepciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_recibido( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_recibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_recibidoalcambio( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_recibidoalcambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_recibidosugerido( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_recibidosugerido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_signo( txval as variant ) as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_signo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodecomprobante( txval as variant ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_tipodecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarretiroenefectivo( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validarretiroenefectivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocondicionrecargo() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridocondicionrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcondicionrecargo() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridofwcondicionrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwiditemvalores() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridofwiditemvalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoiditemvalores() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoiditemvalores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorecibido() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridorecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarsicargadatosdetarjeta( tovalor as object ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Verificarsicargadatosdetarjeta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function verificarvaloraplicableparavuelto() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarvaloraplicableparavuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function antesdesetearatributo( toitemvalor as object, tcatributo as string, txvalold as variant, txval as variant ) as void                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
	...
	*-----------------------------------------------------------------------------------------
	protected function calculardescuentoyrecargosporreferencia( tndescuento as decimal, tnrecargo as decimal ) as void                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Calculardescuentoyrecargosporreferencia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function calculoimporteconvertido( txval as variant, tndescuento as decimal, tnrecargo as decimal ) as float                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Calculoimporteconvertido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function calculomontoapartirderecibido( tndescuento as float, tnrecargo as float ) as void                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Calculomontoapartirderecibido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function convertiendoimportesegunmoneda( txval as float, tndescuento  as float, tnrecargo as float ) as float                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Convertiendoimportesegunmoneda', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function debeaplicardescuentorecargo() as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debeaplicardescuentorecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function deberealizarcalculodedescuento() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Deberealizarcalculodedescuento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function deberealizarcalculoderecargo() as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Deberealizarcalculoderecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function escomprobanteconrecargos() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Escomprobanteconrecargos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function inicializarrecibidosugerido( txval as variant ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Inicializarrecibidosugerido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function nopasopreviamenteporcalculoderedondeo() as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Nopasopreviamenteporcalculoderedondeo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercotizacionporvalor() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercotizacionporvalor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerfechaseguntipo() as date                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerfechaseguntipo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerguiddelchequesegunnrointerno( ) as string                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerguiddelchequesegunnrointerno', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenermontodedescuento( tlalcambio as boolean ) as float                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenermontodedescuento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenermontoderecargo() as float                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermontoderecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertiposdevalorespermitidosstring() as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertiposdevalorespermitidosstring', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function permiteaplicardescuentoyrecargo() as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Permiteaplicardescuentoyrecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function tienecuponasociadoanulado() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienecuponasociadoanulado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validaritemantesdeprocesarvalor() as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaritemantesdeprocesarvalor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarmontocupon() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmontocupon', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function valorpermitidoparacomprobante( tnvalor as integer ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
