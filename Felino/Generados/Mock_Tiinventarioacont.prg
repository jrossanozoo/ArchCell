...
define class Mock_tiinventarioacont as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function colordesde_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'colordesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'colordesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Colordesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Colordesde( lxVal )				this.Setear_Colordesde( lxVal )			EndIf		Else			This.Setear_Colordesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function colorhasta_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'colorhasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'colorhasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Colorhasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Colorhasta( lxVal )				this.Setear_Colorhasta( lxVal )			EndIf		Else			This.Setear_Colorhasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function materialdesde_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'materialdesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'materialdesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Materialdesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Materialdesde( lxVal )				this.Setear_Materialdesde( lxVal )			EndIf		Else			This.Setear_Materialdesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function materialhasta_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'materialhasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'materialhasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Materialhasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Materialhasta( lxVal )				this.Setear_Materialhasta( lxVal )			EndIf		Else			This.Setear_Materialhasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function proveedordesde_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'proveedordesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'proveedordesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Proveedordesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Proveedordesde( lxVal )				this.Setear_Proveedordesde( lxVal )			EndIf		Else			This.Setear_Proveedordesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function proveedorhasta_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'proveedorhasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'proveedorhasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Proveedorhasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Proveedorhasta( lxVal )				this.Setear_Proveedorhasta( lxVal )			EndIf		Else			This.Setear_Proveedorhasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_unidaddemedidadesde( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_unidaddemedidadesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_unidaddemedidadesde', lcParametros )			endif		endif		this.Unidaddemedidadesde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_unidaddemedidahasta( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_unidaddemedidahasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_unidaddemedidahasta', lcParametros )			endif		endif		this.Unidaddemedidahasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function talledesde_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'talledesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'talledesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Talledesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Talledesde( lxVal )				this.Setear_Talledesde( lxVal )			EndIf		Else			This.Setear_Talledesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function tallehasta_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tallehasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tallehasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tallehasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tallehasta( lxVal )				this.Setear_Tallehasta( lxVal )			EndIf		Else			This.Setear_Tallehasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function unidaddemedidadesde_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'unidaddemedidadesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'unidaddemedidadesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Unidaddemedidadesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Unidaddemedidadesde( lxVal )				this.Setear_Unidaddemedidadesde( lxVal )			EndIf		Else			This.Setear_Unidaddemedidadesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function unidaddemedidahasta_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'unidaddemedidahasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'unidaddemedidahasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Unidaddemedidahasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Unidaddemedidahasta( lxVal )				this.Setear_Unidaddemedidahasta( lxVal )			EndIf		Else			This.Setear_Unidaddemedidahasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_unidaddemedidadesde( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_unidaddemedidadesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_unidaddemedidadesde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_unidaddemedidahasta( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOACONT' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_unidaddemedidahasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_unidaddemedidahasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwunidaddemedidahasta() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridofwunidaddemedidahasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridounidaddemedidadesde() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridounidaddemedidadesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridounidaddemedidahasta() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridounidaddemedidahasta', lcParametros )
	EndFunc
