	...
	function Movimiento_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Movimiento( lxVal, lxValOld )
			if ( this.lHabilitarMovimiento_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones - Atributo: Movimiento)" )
			endif 
		endif
		If lxValOld != lxVal or empty( this.Fecha ) 
			this.Fecha = This.Movimiento.Fecha
		endif
		If lxValOld != lxVal or empty( this.Concepto ) 
			this.Concepto = This.Movimiento.Concepto_pk
		endif
		...
		if This.CargaManual()
			if this.Validar_Concepto( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Concepto', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones - Atributo: Concepto)" )
				endif 
			EndIf
		Else
			This.Setear_Concepto( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Numero( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Numero', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones - Atributo: Numero)" )
				endif 
			EndIf
		Else
			This.Setear_Numero( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Conceptodetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Conceptodetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliaciones - Atributo: Conceptodetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Conceptodetalle( lxVal ) 
