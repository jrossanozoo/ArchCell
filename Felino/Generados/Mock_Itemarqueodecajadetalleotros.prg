...
define class Mock_Itemarqueodecajadetalleotros as MockBase of MockBase.prg

	cClase = 'Itemarqueodecajadetalleotros'
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalarqueo( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_totalarqueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valorgrupo( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_valorgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalarqueo_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Totalarqueo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalarqueo( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_totalarqueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valorgrupo( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_valorgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorgrupo_access() as variant                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorgrupo_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorgrupo_pk_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorgrupo_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridototalarqueo() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridototalarqueo', lcParametros )
	EndFunc
