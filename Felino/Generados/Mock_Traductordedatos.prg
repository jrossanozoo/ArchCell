...
define class Mock_TRADUCTORDEDATOS as MockBase of MockBase.prg

	cClase = 'TRADUCTORDEDATOS'
	...
	llHabilitar= .f.                                                                                                                                                                                                                                          
	llVerificaEquivalencias = .f.                                                                                                                                                                                                                             
	lnAnchoRequerido = 0                                                                                                                                                                                                                                      
	lnCompletarLecturaALa = 0                                                                                                                                                                                                                                 
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function traducir( tccodigo as string ) as string                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Traducir', lcParametros )
	EndFunc
