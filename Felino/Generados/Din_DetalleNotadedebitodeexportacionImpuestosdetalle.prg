...
define class Din_DetalleNOTADEDEBITODEEXPORTACIONImpuestosdetalle as DetalleImpuestos of DetalleImpuestos.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemNOTADEDEBITODEEXPORTACIONImpuestosdetalle' )
