...
define class Din_DetalleSELECOMPAINSERTARDetallecomprobantesainsertar as detalle of detalle.prg
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.CodComprobante = this.Item[ tnItem ].CodComprobante
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'CodComprobante', .CodComprobante )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.CodComprobante = this.oItem.CodComprobante
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].CodComprobante = .oItem.CodComprobante
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemSELECOMPAINSERTARDetallecomprobantesainsertar' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Detallecomprobantesainsertar
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Detallecomprobantesainsertar.Codigo
			loItem.NROITEM = c_Detallecomprobantesainsertar.NROITEM
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Codcomprobante = toItemOrigen.Codcomprobante
