...
define class Mock_Itemnotadedebitodeexportacionimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemnotadedebitodeexportacionimpuestoscomprobante'
