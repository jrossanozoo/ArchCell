	...
	function Movimiento_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Movimiento( lxVal, lxValOld )
			if ( this.lHabilitarMovimiento_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Movimiento)" )
			endif 
		endif
		...
		if This.CargaManual()
			if this.Validar_Nroitem( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Nroitem', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Nroitem)" )
				endif 
			EndIf
		Else
			This.Setear_Nroitem( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Fecha( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Fecha', lxValOld, lxVal  )
					...
					this.Fecha = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Fecha)" )
				endif 
			EndIf
		Else
			This.Setear_Fecha( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Conceptocodigo( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Conceptocodigo', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Conceptocodigo)" )
				endif 
			EndIf
		Else
			This.Setear_Conceptocodigo( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Concepto( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Concepto', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Concepto)" )
				endif 
			EndIf
		Else
			This.Setear_Concepto( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Conceptodetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Conceptodetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Conceptodetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Conceptodetalle( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Numero( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Numero', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Numero)" )
				endif 
			EndIf
		Else
			This.Setear_Numero( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Importe( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Importe', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Importe)" )
				endif 
			EndIf
		Else
			This.Setear_Importe( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Seleccion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Seleccion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conciliación bancaria - Atributo: Seleccion)" )
				endif 
			EndIf
		Else
			This.Setear_Seleccion( lxVal ) 
