...
define class Din_DetalleSELECCIONORDENDESERVICIODetalleordenes as detalle of detalle.prg


	cAtributosUnicidad = 'Orden_PK'
	nCantidadItems = 999
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.Orden_PK = this.Item[ tnItem ].Orden_PK
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'Orden_PK', .Orden_PK )
			
				.TipoDeOrden_PK = this.Item[ tnItem ].TipoDeOrden_PK
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'TipoDeOrden_PK', .TipoDeOrden_PK )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.Orden_PK = this.oItem.Orden_PK
			.TipoDeOrden_PK = this.oItem.TipoDeOrden_PK
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].Orden_PK = .oItem.Orden_PK
			.Item[ lnItem ].TipoDeOrden_PK = .oItem.TipoDeOrden_PK
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'ItemSELECCIONORDENDESERVICIODetalleordenes' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Detalleordenes
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Detalleordenes.Codigo
			loItem.NROITEM = c_Detalleordenes.NROITEM
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarExistenciaCamposFijosItemPlano( tnItem as integer ) as Boolean
		...
		if  empty( this.item[ tnItem ].Orden_PK ) 
			llRetorno = .F.
		endif 
		return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Orden_PK = toItemOrigen.Orden_PK
		toItemDestino.Tipodeorden_PK = toItemOrigen.Tipodeorden_PK
