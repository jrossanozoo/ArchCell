...
define class Mock_Itemnotadedebitoelectronicaexportacionvaloresdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadedebitoelectronicaexportacionvaloresdetalle'
