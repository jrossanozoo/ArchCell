...
define class Din_EntidadDATOSTARJETA as entidad of entidad.prg
	...
	cDescripcion =  [Datos de cobro con tarjeta]
	lEntidadEditable =  .t.
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionDetalles() as Boolean
		...
		llRetorno = dodefault()
		llRetorno = This.ValidarUnDetalle( this.DetallePlanes, 'Planes' ) and llRetorno
		return llRetorno
	endfunc
	...
	function Pos_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Pos( lxVal, lxValOld )
			if ( this.lHabilitarPos_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Pos)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Moneda_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Moneda( lxVal, lxValOld )
			if ( this.lHabilitarMoneda_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Moneda)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Tarjeta_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Tarjeta( lxVal, lxValOld )
			if ( this.lHabilitarTarjeta_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Tarjeta)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Entidadfinanciera_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Entidadfinanciera( lxVal, lxValOld )
			if ( this.lHabilitarEntidadfinanciera_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Entidadfinanciera)" )
			endif 
		endif
		dodefault( lxVal )
		...
		if This.CargaManual()
			if this.Validar_Dispositivomovil( lxVal )
				if ( this.lHabilitarDispositivomovil or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Dispositivomovil)" )
				endif 
			EndIf
		Else
			This.Setear_Dispositivomovil( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idpuestoqr( lxVal )
				if ( this.lHabilitarIdpuestoqr or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Idpuestoqr)" )
				endif 
			EndIf
		Else
			This.Setear_Idpuestoqr( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipopagolapos( lxVal )
				if ( this.lHabilitarTipopagolapos or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Tipopagolapos)" )
				endif 
			EndIf
		Else
			This.Setear_Tipopagolapos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idpagoclover( lxVal )
				if ( this.lHabilitarIdpagoclover or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Idpagoclover)" )
				endif 
			EndIf
		Else
			This.Setear_Idpagoclover( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipocupon( lxVal )
				if ( this.lHabilitarTipocupon or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Tipocupon)" )
				endif 
			EndIf
		Else
			This.Setear_Tipocupon( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Terminalessmartlapos( lxVal )
				if ( this.lHabilitarTerminalessmartlapos or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Terminalessmartlapos)" )
				endif 
			EndIf
		Else
			This.Setear_Terminalessmartlapos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idordenclover( lxVal )
				if ( this.lHabilitarIdordenclover or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Idordenclover)" )
				endif 
			EndIf
		Else
			This.Setear_Idordenclover( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipopagosmartlapos( lxVal )
				if ( this.lHabilitarTipopagosmartlapos or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Tipopagosmartlapos)" )
				endif 
			EndIf
		Else
			This.Setear_Tipopagosmartlapos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Mailgocuotas( lxVal )
				if ( this.lHabilitarMailgocuotas or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Mailgocuotas)" )
				endif 
			EndIf
		Else
			This.Setear_Mailgocuotas( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idsmartlapos( lxVal )
				if ( this.lHabilitarIdsmartlapos or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Idsmartlapos)" )
				endif 
			EndIf
		Else
			This.Setear_Idsmartlapos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipopagoposnet( lxVal )
				if ( this.lHabilitarTipopagoposnet or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Tipopagoposnet)" )
				endif 
			EndIf
		Else
			This.Setear_Tipopagoposnet( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Cuponreferente( lxVal )
				if ( this.lHabilitarCuponreferente or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Cuponreferente)" )
				endif 
			EndIf
		Else
			This.Setear_Cuponreferente( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Fechareferente( lxVal )
				if ( this.lHabilitarFechareferente or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Fechareferente)" )
				endif 
			EndIf
		Else
			This.Setear_Fechareferente( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idgocuotas( lxVal )
				if ( this.lHabilitarIdgocuotas or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Idgocuotas)" )
				endif 
			EndIf
		Else
			This.Setear_Idgocuotas( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Lotereferente( lxVal )
				if ( this.lHabilitarLotereferente or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Lotereferente)" )
				endif 
			EndIf
		Else
			This.Setear_Lotereferente( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Autorizaciontelefonica( lxVal )
				if ( this.lHabilitarAutorizaciontelefonica or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Autorizaciontelefonica)" )
				endif 
			EndIf
		Else
			This.Setear_Autorizaciontelefonica( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Autorizaciontelefonicaoffline( lxVal )
				if ( this.lHabilitarAutorizaciontelefonicaoffline or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Autorizaciontelefonicaoffline)" )
				endif 
			EndIf
		Else
			This.Setear_Autorizaciontelefonicaoffline( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Monto( lxVal )
				if ( this.lHabilitarMonto or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					this.Monto = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Monto)" )
				endif 
			EndIf
		Else
			This.Setear_Monto( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Cuotas( lxVal )
				if ( this.lHabilitarCuotas or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Cuotas)" )
				endif 
			EndIf
		Else
			This.Setear_Cuotas( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Ultimosdigitos( lxVal )
				if ( this.lHabilitarUltimosdigitos or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Ultimosdigitos)" )
				endif 
			EndIf
		Else
			This.Setear_Ultimosdigitos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Codigoplan( lxVal )
				if ( this.lHabilitarCodigoplan or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Codigoplan)" )
				endif 
			EndIf
		Else
			This.Setear_Codigoplan( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Nombretitular( lxVal )
				if ( this.lHabilitarNombretitular or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Nombretitular)" )
				endif 
			EndIf
		Else
			This.Setear_Nombretitular( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipodocumentotitular( lxVal )
				if ( this.lHabilitarTipodocumentotitular or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Tipodocumentotitular)" )
				endif 
			EndIf
		Else
			This.Setear_Tipodocumentotitular( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Nrodocumentotitular( lxVal )
				if ( this.lHabilitarNrodocumentotitular or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Nrodocumentotitular)" )
				endif 
			EndIf
		Else
			This.Setear_Nrodocumentotitular( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Telefonotitular( lxVal )
				if ( this.lHabilitarTelefonotitular or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Telefonotitular)" )
				endif 
			EndIf
		Else
			This.Setear_Telefonotitular( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Clasedetarjeta( lxVal )
				if ( this.lHabilitarClasedetarjeta or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Clasedetarjeta)" )
				endif 
			EndIf
		Else
			This.Setear_Clasedetarjeta( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Numerocupon( lxVal )
				if ( this.lHabilitarNumerocupon or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Numerocupon)" )
				endif 
			EndIf
		Else
			This.Setear_Numerocupon( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Numerolote( lxVal )
				if ( this.lHabilitarNumerolote or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Numerolote)" )
				endif 
			EndIf
		Else
			This.Setear_Numerolote( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Numerocierredelote( lxVal )
				if ( this.lHabilitarNumerocierredelote or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Numerocierredelote)" )
				endif 
			EndIf
		Else
			This.Setear_Numerocierredelote( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Qrtransactionidposnet( lxVal )
				if ( this.lHabilitarQrtransactionidposnet or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Qrtransactionidposnet)" )
				endif 
			EndIf
		Else
			This.Setear_Qrtransactionidposnet( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Qrtranfdebinidposnet( lxVal )
				if ( this.lHabilitarQrtranfdebinidposnet or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de cobro con tarjeta - Atributo: Qrtranfdebinidposnet)" )
				endif 
			EndIf
		Else
			This.Setear_Qrtranfdebinidposnet( lxVal ) 
			...
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Móvil para la entidad Ingrese los datos para el cobro con tarjeta." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
			...
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Fecha de cupón relacionado para la entidad Ingrese los datos para el cobro con tarjeta." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es fecha." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
			...
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Últimos 4 dígitos para la entidad Ingrese los datos para el cobro con tarjeta." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
