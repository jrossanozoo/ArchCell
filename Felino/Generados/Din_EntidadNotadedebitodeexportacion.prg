...
define class Din_EntidadNOTADEDEBITODEEXPORTACION as Ent_ComprobanteExportacion of Ent_ComprobanteExportacion.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ACTUALIZAEMAILCLIENTE><ANULABLE><VENTAS><CONVALORES><FISCAL><VALORCIERRE><DESCUENTOAUTOMATICO>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
