...
define class Mock_Itemposmonedasdetalle as MockBase of MockBase.prg

	cClase = 'Itemposmonedasdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function codigodemoneda_access() as variant                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Codigodemoneda_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigodemoneda_pk_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Codigodemoneda_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigodemoneda( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_codigodemoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigodemoneda( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_codigodemoneda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigodemoneda() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridocodigodemoneda', lcParametros )
	EndFunc
