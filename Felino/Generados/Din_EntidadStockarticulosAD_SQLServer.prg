...
define class Din_EntidadSTOCKARTICULOSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxArtFecexpo, lxArtFectrans, lxArtFecimpo, lxArtFaltafw, lxArtFmodifw, lxArtAstock, lxArtUaltafw, lxArtSmodifw, lxArtUmodifw, lxArtDescfw, lxArtValtafw, lxArtSaltafw, lxArtZadsfw, lxArtVmodifw, lxArtHoraexpo, lxArtBdmodifw, lxArtBdaltafw, lxArtEsttrans, lxArtHaltafw, lxArtHoraimpo, lxArtHmodifw, lxArtAcant, lxArtAcantmin, lxArtArtcod, lxArtCorig
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ART ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Astock","Ualtafw","Smodifw","Umodifw","Descfw","Valtafw","Saltafw","Zadsfw","Vmodifw","Horaexpo","Bdmodifw","Bdaltafw","Esttrans","Haltafw","Horaimpo","Hmodifw","Acant","Acantmin","Artcod","Corig" ) values ( <<"'" + this.ConvertirDateSql( lxArtFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArtFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArtFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArtFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxArtFmodifw ) + "'" >>, <<lxArtAstock >>, <<"'" + this.FormatearTextoSql( lxArtUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxArtHmodifw ) + "'" >>, <<lxArtAcant >>, <<lxArtAcantmin >>, <<"'" + this.FormatearTextoSql( lxArtArtcod ) + "'" >>, <<lxArtCorig >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ART set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxArtFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxArtFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxArtFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxArtFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxArtFmodifw ) + "'">>,"Astock" = <<lxArtAstock>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxArtUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxArtSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxArtUmodifw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxArtDescfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxArtValtafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxArtSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxArtZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxArtVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxArtHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxArtBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxArtBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxArtEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxArtHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxArtHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxArtHmodifw ) + "'">>,"Acant" = "Acant" + <<lxArtAcant>>,"Acantmin" = <<lxArtAcantmin>>,"Artcod" = <<"'" + this.FormatearTextoSql( lxArtArtcod ) + "'">>,"Corig" = <<lxArtCorig>> where "Artcod" = <<"'" + this.FormatearTextoSql( lxArtArtcod ) + "'">> and  ART.ARTCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Astock" as "Generastock", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Acant" as "Cantidad", "Acantmin" as "Minreposicion", "Artcod" as "Codigo", "Corig" as "Cantidadoriginal" from ZooLogic.ART where "Artcod" = <<"'" + this.FormatearTextoSql( lxArtArtcod ) + "'">> and  ART.ARTCOD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Astock" as "Generastock", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Acant" as "Cantidad", "Acantmin" as "Minreposicion", "Artcod" as "Codigo", "Corig" as "Cantidadoriginal" from ZooLogic.ART where  ART.ARTCOD != '' order by ARTCOD
			endtext
			use in select('c_STOCKARTICULOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_STOCKARTICULOS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Astock" as "Generastock", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Acant" as "Cantidad", "Acantmin" as "Minreposicion", "Artcod" as "Codigo", "Corig" as "Cantidadoriginal" from ZooLogic.ART where  funciones.padr( ARTCOD, 13, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ART.ARTCOD != '' order by ARTCOD
			endtext
			use in select('c_STOCKARTICULOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_STOCKARTICULOS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Astock" as "Generastock", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Acant" as "Cantidad", "Acantmin" as "Minreposicion", "Artcod" as "Codigo", "Corig" as "Cantidadoriginal" from ZooLogic.ART where  funciones.padr( ARTCOD, 13, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ART.ARTCOD != '' order by ARTCOD desc
			endtext
			use in select('c_STOCKARTICULOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_STOCKARTICULOS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Astock" as "Generastock", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Acant" as "Cantidad", "Acantmin" as "Minreposicion", "Artcod" as "Codigo", "Corig" as "Cantidadoriginal" from ZooLogic.ART where  ART.ARTCOD != '' order by ARTCOD desc
			endtext
			use in select('c_STOCKARTICULOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_STOCKARTICULOS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Astock,Ualtafw,Smodifw,Umodifw,Descfw,Valtafw,Salta" + ;
"fw,Zadsfw,Vmodifw,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Horaimpo,Hmodifw,Acant,Acantmin,Artcod" + ;
",Corig" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Astock" as "Generastock", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Acant" as "Cantidad", "Acantmin" as "Minreposicion", "Artcod" as "Codigo", "Corig" as "Cantidadoriginal"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.ART set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxArtFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxArtFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxArtFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxArtFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxArtFmodifw ) + "'">>, "Astock" = <<lxArtAstock>>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxArtUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxArtSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxArtUmodifw ) + "'">>, "Descfw" = <<"'" + this.FormatearTextoSql( lxArtDescfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxArtValtafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxArtSaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxArtZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxArtVmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxArtHoraexpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxArtBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxArtBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxArtEsttrans ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxArtHaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxArtHoraimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxArtHmodifw ) + "'">>, "Acant" = Acant + ( <<lxArtAcant>> ), "Acantmin" = <<lxArtAcantmin>>, "Artcod" = <<"'" + this.FormatearTextoSql( lxArtArtcod ) + "'">>, "Corig" = <<lxArtCorig>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'ART' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		If llInsertarAuditoria
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.ART set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, ASTOCK = ] + transform( &lcCursor..ASTOCK )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ACANT = ZooLogic.ART.ACANT + ] + transform( &lcCursor..ACANT )+ [, ACANTMIN = ] + transform( &lcCursor..ACANTMIN )+ [, ARTCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..ARTCOD ) + "'"+ [, CORIG = ] + transform( &lcCursor..CORIG ) + [ Where ARTCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..ARTCOD ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, ASTOCK, UALTAFW, SMODIFW, UMODIFW, DescFW, VALTAFW, SALTAFW, ZADSFW, VMODIFW, HORAEXPO, BDMODIFW, BDALTAFW, ESTTRANS, HALTAFW, HORAIMPO, HMODIFW, ACANT, ACANTMIN, ARTCOD, CORIG
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad STOCKARTICULOS. Hay un error en el diseño de importación.' )
	...
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			Begin
				...
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.ASTOCK = isnull( d.ASTOCK, t.ASTOCK ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ACANT = isnull( d.ACANT, t.ACANT ),t.ACANTMIN = isnull( d.ACANTMIN, t.ACANTMIN ),t.ARTCOD = isnull( d.ARTCOD, t.ARTCOD ),t.CORIG = isnull( d.CORIG, t.CORIG )
					from ZooLogic.ART t inner join deleted d 
							 on t.ARTCOD = d.ARTCOD
				-- Fin Updates
				insert into ZooLogic.ADT_ART ( "ADT_Cod","ADT_Fecha","ADT_Hora","ADT_Serie","ADT_Usr","ADT_Ent","ADT_Comp","ADT_ADN","ADT_Vers","ADT_Ext","ARTCOD","Acant","Corig" ) 
				...
				insert into ZooLogic.ART(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Astock,Ualtafw,Smodifw,Umodifw,Descfw,Valtafw,Saltafw,Zadsfw,Vmodifw,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Horaimpo,Hmodifw,Acant,Acantmin,Artcod,Corig)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.ASTOCK,0),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.DESCFW,''),isnull( d.VALTAFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.ACANT,0),isnull( d.ACANTMIN,0),isnull( d.ARTCOD,''),isnull( d.CORIG,0)
						From deleted d left join ZooLogic.ART pk 
							 on d.ARTCOD = pk.ARTCOD
						Where pk.ARTCOD Is Null 
				-- Fin Inserts
...
<VFPData xml:space="preserve">
	...
	<row entidad="STOCKARTICULOS                          " atributo="FECHATRANSFERENCIA                      " tabla="ART            " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="STOCKARTICULOS                          " atributo="FECHAIMPO                               " tabla="ART            " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="STOCKARTICULOS                          " atributo="FECHAALTAFW                             " tabla="ART            " campo="FALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha alta                                                                                                                                                      " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="STOCKARTICULOS                          " atributo="FECHAMODIFICACIONFW                     " tabla="ART            " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="STOCKARTICULOS                          " atributo="SERIEMODIFICACIONFW                     " tabla="ART            " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="STOCKARTICULOS                          " atributo="VERSIONALTAFW                           " tabla="ART            " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="STOCKARTICULOS                          " atributo="VERSIONMODIFICACIONFW                   " tabla="ART            " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="STOCKARTICULOS                          " atributo="HORAEXPO                                " tabla="ART            " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="STOCKARTICULOS                          " atributo="ESTADOTRANSFERENCIA                     " tabla="ART            " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="STOCKARTICULOS                          " atributo="CANTIDAD                                " tabla="ART            " campo="ACANT     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="0                                                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="6" etiqueta="Cant. en Stock                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="STOCKARTICULOS                          " atributo="MINREPOSICION                           " tabla="ART            " campo="ACANTMIN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="0" valorsugerido="0                                                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="201" etiqueta="Mín. de Reposición                                                                                                                                              " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="STOCKARTICULOS                          " atributo="CODIGO                                  " tabla="ART            " campo="ARTCOD    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="1" etiqueta="Código                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="STOCKARTICULOS                          " atributo="CANTIDADORIGINAL                        " tabla="ART            " campo="CORIG     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="202" etiqueta="Stock Original                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
