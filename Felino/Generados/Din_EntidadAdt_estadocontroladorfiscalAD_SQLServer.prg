...
define class Din_EntidadADT_ESTADOCONTROLADORFISCALAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAdt_errorcfFecexpo, lxAdt_errorcfFaltafw, lxAdt_errorcfFecimpo, lxAdt_errorcfFectrans, lxAdt_errorcfAdt_fecha, lxAdt_errorcfFmodifw, lxAdt_errorcfComp, lxAdt_errorcfFptoven, lxAdt_errorcfAdt_ext, lxAdt_errorcfValtafw, lxAdt_errorcfUmodifw, lxAdt_errorcfVmodifw, lxAdt_errorcfHaltafw, lxAdt_errorcfZadsfw, lxAdt_errorcfHoraexpo, lxAdt_errorcfSmodifw, lxAdt_errorcfHmodifw, lxAdt_errorcfUaltafw, lxAdt_errorcfSaltafw, lxAdt_errorcfHoraimpo, lxAdt_errorcfEsttrans, lxAdt_errorcfAdt_usr, lxAdt_errorcfAdt_ent, lxAdt_errorcfAdt_serie, lxAdt_errorcfAdt_comp, lxAdt_errorcfAdt_hora, lxAdt_errorcfAdt_adn, lxAdt_errorcfBdmodifw, lxAdt_errorcfAdt_vers, lxAdt_errorcfBdaltafw, lxAdt_errorcfCod, lxAdt_errorcfAdt_cod
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ADT_ERRORCF ( "Fecexpo","Faltafw","Fecimpo","Fectrans","Adt_fecha","Fmodifw","Comp","Fptoven","Adt_ext","Valtafw","Umodifw","Vmodifw","Haltafw","Zadsfw","Horaexpo","Smodifw","Hmodifw","Ualtafw","Saltafw","Horaimpo","Esttrans","Adt_usr","Adt_ent","Adt_serie","Adt_comp","Adt_hora","Adt_adn","Bdmodifw","Adt_vers","Bdaltafw","Cod","Adt_cod" ) values ( <<"'" + this.ConvertirDateSql( lxAdt_errorcfFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_errorcfFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_errorcfFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_errorcfFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_errorcfAdt_fecha ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAdt_errorcfFmodifw ) + "'" >>, <<lxAdt_errorcfComp >>, <<lxAdt_errorcfFptoven >>, <<iif( lxAdt_errorcfAdt_ext, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_usr ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_ent ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_serie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_comp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_hora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_adn ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_vers ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfCod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_cod ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ADT_ERRORCF set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFectrans ) + "'">>,"Adt_fecha" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfAdt_fecha ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFmodifw ) + "'">>,"Comp" = <<lxAdt_errorcfComp>>,"Fptoven" = <<lxAdt_errorcfFptoven>>,"Adt_ext" = <<iif( lxAdt_errorcfAdt_ext, 1, 0 )>>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfVmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfZadsfw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHoraexpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfEsttrans ) + "'">>,"Adt_usr" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_usr ) + "'">>,"Adt_ent" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_ent ) + "'">>,"Adt_serie" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_serie ) + "'">>,"Adt_comp" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_comp ) + "'">>,"Adt_hora" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_hora ) + "'">>,"Adt_adn" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_adn ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfBdmodifw ) + "'">>,"Adt_vers" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_vers ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfBdaltafw ) + "'">>,"Cod" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfCod ) + "'">>,"Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_cod ) + "'">> where "Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_cod ) + "'">> and  ADT_ERRORCF.ADT_COD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Adt_fecha" as "Adt_fecha", "Fmodifw" as "Fechamodificacionfw", "Comp" as "Comprobante", "Fptoven" as "Puntodeventa", "Adt_ext" as "Adt_ext", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Adt_usr" as "Adt_usr", "Adt_ent" as "Adt_ent", "Adt_serie" as "Adt_serie", "Adt_comp" as "Adt_comp", "Adt_hora" as "Adt_hora", "Adt_adn" as "Adt_adn", "Bdmodifw" as "Basededatosmodificacionfw", "Adt_vers" as "Adt_vers", "Bdaltafw" as "Basededatosaltafw", "Cod" as "Codigo", "Adt_cod" as "Adt_cod" from ZooLogic.ADT_ERRORCF where  ADT_ERRORCF.ADT_COD != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_ADT_ESTADOCONTROLADORFISCAL')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ADT_ESTADOCONTROLADORFISCAL', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Adt_fecha" as "Adt_fecha", "Fmodifw" as "Fechamodificacionfw", "Comp" as "Comprobante", "Fptoven" as "Puntodeventa", "Adt_ext" as "Adt_ext", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Adt_usr" as "Adt_usr", "Adt_ent" as "Adt_ent", "Adt_serie" as "Adt_serie", "Adt_comp" as "Adt_comp", "Adt_hora" as "Adt_hora", "Adt_adn" as "Adt_adn", "Bdmodifw" as "Basededatosmodificacionfw", "Adt_vers" as "Adt_vers", "Bdaltafw" as "Basededatosaltafw", "Cod" as "Codigo", "Adt_cod" as "Adt_cod" from ZooLogic.ADT_ERRORCF where  funciones.dtos( FALTAFW ) + funciones.padr( HALTAFW, 8, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ADT_ERRORCF.ADT_COD != '' order by FALTAFW,HALTAFW
			endtext
			use in select('c_ADT_ESTADOCONTROLADORFISCAL')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ADT_ESTADOCONTROLADORFISCAL', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Faltafw,Fecimpo,Fectrans,Adt_fecha,Fmodifw,Comp,Fptoven,Adt_ext,Valtafw,Umodifw,Vmod" + ;
"ifw,Haltafw,Zadsfw,Horaexpo,Smodifw,Hmodifw,Ualtafw,Saltafw,Horaimpo,Esttrans,Adt_usr,Adt_ent,Adt_se" + ;
"rie,Adt_comp,Adt_hora,Adt_adn,Bdmodifw,Adt_vers,Bdaltafw,Cod,Adt_cod" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Adt_fecha" as "Adt_fecha", "Fmodifw" as "Fechamodificacionfw", "Comp" as "Comprobante", "Fptoven" as "Puntodeventa", "Adt_ext" as "Adt_ext", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Adt_usr" as "Adt_usr", "Adt_ent" as "Adt_ent", "Adt_serie" as "Adt_serie", "Adt_comp" as "Adt_comp", "Adt_hora" as "Adt_hora", "Adt_adn" as "Adt_adn", "Bdmodifw" as "Basededatosmodificacionfw", "Adt_vers" as "Adt_vers", "Bdaltafw" as "Basededatosaltafw", "Cod" as "Codigo", "Adt_cod" as "Adt_cod"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.ADT_ERRORCF set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFectrans ) + "'">>, "Adt_fecha" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfAdt_fecha ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxAdt_errorcfFmodifw ) + "'">>, "Comp" = <<lxAdt_errorcfComp>>, "Fptoven" = <<lxAdt_errorcfFptoven>>, "Adt_ext" = <<iif( lxAdt_errorcfAdt_ext, 1, 0 )>>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfUmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfVmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfZadsfw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHoraexpo ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfUaltafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfSaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfHoraimpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfEsttrans ) + "'">>, "Adt_usr" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_usr ) + "'">>, "Adt_ent" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_ent ) + "'">>, "Adt_serie" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_serie ) + "'">>, "Adt_comp" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_comp ) + "'">>, "Adt_hora" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_hora ) + "'">>, "Adt_adn" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_adn ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfBdmodifw ) + "'">>, "Adt_vers" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_vers ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfBdaltafw ) + "'">>, "Cod" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfCod ) + "'">>, "Adt_cod" = <<"'" + this.FormatearTextoSql( lxAdt_errorcfAdt_cod ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'ADT_ERRORCF' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FALTAFW, FECIMPO, FECTRANS, ADT_Fecha, FMODIFW, Comp, FPTOVEN, ADT_Ext, VALTAFW, UMODIFW, VMODIFW, HALTAFW, ZADSFW, HORAEXPO, SMODIFW, HMODIFW, UALTAFW, SALTAFW, HORAIMPO, ESTTRANS, ADT_Usr, ADT_Ent, ADT_Serie, ADT_Comp, ADT_Hora, ADT_ADN, BDMODIFW, ADT_Vers, BDALTAFW, Cod, ADT_Cod
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..ADT_Fecha ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + transform( &lcCursor..Comp )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPTOVEN ) + ',' + Transform( iif( &lcCursor..ADT_Ext, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Vers ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ADT_Cod ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.ADT_FECHA = isnull( d.ADT_FECHA, t.ADT_FECHA ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.COMP = isnull( d.COMP, t.COMP ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.ADT_EXT = isnull( d.ADT_EXT, t.ADT_EXT ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ADT_USR = isnull( d.ADT_USR, t.ADT_USR ),t.ADT_ENT = isnull( d.ADT_ENT, t.ADT_ENT ),t.ADT_SERIE = isnull( d.ADT_SERIE, t.ADT_SERIE ),t.ADT_COMP = isnull( d.ADT_COMP, t.ADT_COMP ),t.ADT_HORA = isnull( d.ADT_HORA, t.ADT_HORA ),t.ADT_ADN = isnull( d.ADT_ADN, t.ADT_ADN ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ADT_VERS = isnull( d.ADT_VERS, t.ADT_VERS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.COD = isnull( d.COD, t.COD ),t.ADT_COD = isnull( d.ADT_COD, t.ADT_COD )
					from ZooLogic.ADT_ERRORCF t inner join deleted d 
							 on t.ADT_Cod = d.ADT_Cod
				-- Fin Updates
				insert into ZooLogic.ADT_ERRORCF(Fecexpo,Faltafw,Fecimpo,Fectrans,Adt_fecha,Fmodifw,Comp,Fptoven,Adt_ext,Valtafw,Umodifw,Vmodifw,Haltafw,Zadsfw,Horaexpo,Smodifw,Hmodifw,Ualtafw,Saltafw,Horaimpo,Esttrans,Adt_usr,Adt_ent,Adt_serie,Adt_comp,Adt_hora,Adt_adn,Bdmodifw,Adt_vers,Bdaltafw,Cod,Adt_cod)
					Select isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.ADT_FECHA,''),isnull( d.FMODIFW,''),isnull( d.COMP,0),isnull( d.FPTOVEN,0),isnull( d.ADT_EXT,0),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.ZADSFW,''),isnull( d.HORAEXPO,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.ADT_USR,''),isnull( d.ADT_ENT,''),isnull( d.ADT_SERIE,''),isnull( d.ADT_COMP,''),isnull( d.ADT_HORA,''),isnull( d.ADT_ADN,''),isnull( d.BDMODIFW,''),isnull( d.ADT_VERS,''),isnull( d.BDALTAFW,''),isnull( d.COD,''),isnull( d.ADT_COD,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="ADT_ESTADOCONTROLADORFISCAL             " atributo="FECHATRANSFERENCIA                      " tabla="ADT_ERRORCF    " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_ESTADOCONTROLADORFISCAL             " atributo="ESTADOTRANSFERENCIA                     " tabla="ADT_ERRORCF    " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ADT_ESTADOCONTROLADORFISCAL             " atributo="ADT_USR                                 " tabla="ADT_ERRORCF    " campo="ADT_USR   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Usuario                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ADT_ESTADOCONTROLADORFISCAL             " atributo="ADT_ENT                                 " tabla="ADT_ERRORCF    " campo="ADT_ENT   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Entidad                                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_ESTADOCONTROLADORFISCAL             " atributo="ADT_COMP                                " tabla="ADT_ERRORCF    " campo="ADT_COMP  " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Descripción                                                                                                                                                     " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ADT_ESTADOCONTROLADORFISCAL             " atributo="ADT_ADN                                 " tabla="ADT_ERRORCF    " campo="ADT_ADN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="ADN                                                                                                                                                             " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
