...
define class Mock_Chequead_sqlserver as MockBase of MockBase.prg

	cClase = 'Chequead_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_chequehist( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_chequehist', lcParametros )
	EndFunc
