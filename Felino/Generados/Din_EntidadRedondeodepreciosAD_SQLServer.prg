...
define class Din_EntidadREDONDEODEPRECIOSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRedoFecimpo, lxRedoFectrans, lxRedoFmodifw, lxRedoFecexpo, lxRedoFaltafw, lxRedoTimestamp, lxRedoUaltafw, lxRedoSmodifw, lxRedoUmodifw, lxRedoZadsfw, lxRedoValtafw, lxRedoVmodifw, lxRedoSaltafw, lxRedoHoraexpo, lxRedoEsttrans, lxRedoBdmodifw, lxRedoHmodifw, lxRedoBdaltafw, lxRedoHoraimpo, lxRedoHaltafw, lxRedoCodigo, lxRedoDescrip, lxRedoRedoent, lxRedoRedotent, lxRedoRedotcent, lxRedoRedopre, lxRedoRobs, lxRedoRnormal, lxRedoRtabla
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.REDO ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Timestamp","Ualtafw","Smodifw","Umodifw","Zadsfw","Valtafw","Vmodifw","Saltafw","Horaexpo","Esttrans","Bdmodifw","Hmodifw","Bdaltafw","Horaimpo","Haltafw","Codigo","Descrip","Redoent","Redotent","Redotcent","Redopre","Robs","Rnormal","Rtabla" ) values ( <<"'" + this.ConvertirDateSql( lxRedoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRedoFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRedoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRedoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRedoFaltafw ) + "'" >>, <<lxRedoTimestamp >>, <<"'" + this.FormatearTextoSql( lxRedoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRedoDescrip ) + "'" >>, <<iif( lxRedoRedoent, 1, 0 ) >>, <<iif( lxRedoRedotent, 1, 0 ) >>, <<iif( lxRedoRedotcent, 1, 0 ) >>, <<iif( lxRedoRedopre, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxRedoRobs ) + "'" >>, <<lxRedoRnormal >>, <<lxRedoRtabla >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.REDO set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxRedoFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRedoFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxRedoFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxRedoFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRedoFaltafw ) + "'">>,"Timestamp" = <<lxRedoTimestamp>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRedoUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRedoSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRedoUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRedoZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRedoValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRedoVmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRedoSaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRedoHoraexpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRedoEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRedoBdmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRedoHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRedoBdaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRedoHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRedoHaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxRedoCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxRedoDescrip ) + "'">>,"Redoent" = <<iif( lxRedoRedoent, 1, 0 )>>,"Redotent" = <<iif( lxRedoRedotent, 1, 0 )>>,"Redotcent" = <<iif( lxRedoRedotcent, 1, 0 )>>,"Redopre" = <<iif( lxRedoRedopre, 1, 0 )>>,"Robs" = <<"'" + this.FormatearTextoSql( lxRedoRobs ) + "'">>,"Rnormal" = <<lxRedoRnormal>>,"Rtabla" = <<lxRedoRtabla>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxRedoCodigo ) + "'">> and  REDO.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Redoent" as "Habilitaredondearnormal", "Redotent" as "Habilitaredondeartermenteros", "Redotcent" as "Habilitaredondeartermcentavos", "Redopre" as "Habilitaredonearprecios", "Robs" as "Observacion", "Rnormal" as "Redondeonormal", "Rtabla" as "Redondeoportabla" from ZooLogic.REDO where "Codigo" = <<"'" + this.FormatearTextoSql( lxRedoCodigo ) + "'">> and  REDO.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Redoent" as "Habilitaredondearnormal", "Redotent" as "Habilitaredondeartermenteros", "Redotcent" as "Habilitaredondeartermcentavos", "Redopre" as "Habilitaredonearprecios", "Robs" as "Observacion", "Rnormal" as "Redondeonormal", "Rtabla" as "Redondeoportabla" from ZooLogic.REDO where  REDO.CODIGO != '' order by codigo
			endtext
			use in select('c_REDONDEODEPRECIOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REDONDEODEPRECIOS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Redoent" as "Habilitaredondearnormal", "Redotent" as "Habilitaredondeartermenteros", "Redotcent" as "Habilitaredondeartermcentavos", "Redopre" as "Habilitaredonearprecios", "Robs" as "Observacion", "Rnormal" as "Redondeonormal", "Rtabla" as "Redondeoportabla" from ZooLogic.REDO where  funciones.padr( codigo, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  REDO.CODIGO != '' order by codigo
			endtext
			use in select('c_REDONDEODEPRECIOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REDONDEODEPRECIOS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Ualtafw,Smodifw,Umodifw,Zadsfw,Valtafw,Vm" + ;
"odifw,Saltafw,Horaexpo,Esttrans,Bdmodifw,Hmodifw,Bdaltafw,Horaimpo,Haltafw,Codigo,Descrip,Redoent,Re" + ;
"dotent,Redotcent,Redopre,Robs,Rnormal,Rtabla" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Redoent" as "Habilitaredondearnormal", "Redotent" as "Habilitaredondeartermenteros", "Redotcent" as "Habilitaredondeartermcentavos", "Redopre" as "Habilitaredonearprecios", "Robs" as "Observacion", "Rnormal" as "Redondeonormal", "Rtabla" as "Redondeoportabla"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.REDO set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxRedoFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxRedoFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxRedoFmodifw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxRedoFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxRedoFaltafw ) + "'">>, "Timestamp" = <<lxRedoTimestamp>>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxRedoUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxRedoSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxRedoUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxRedoZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxRedoValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxRedoVmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxRedoSaltafw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxRedoHoraexpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxRedoEsttrans ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRedoBdmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxRedoHmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRedoBdaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxRedoHoraimpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxRedoHaltafw ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxRedoCodigo ) + "'">>, "Descrip" = <<"'" + this.FormatearTextoSql( lxRedoDescrip ) + "'">>, "Redoent" = <<iif( lxRedoRedoent, 1, 0 )>>, "Redotent" = <<iif( lxRedoRedotent, 1, 0 )>>, "Redotcent" = <<iif( lxRedoRedotcent, 1, 0 )>>, "Redopre" = <<iif( lxRedoRedopre, 1, 0 )>>, "Robs" = <<"'" + this.FormatearTextoSql( lxRedoRobs ) + "'">>, "Rnormal" = <<lxRedoRnormal>>, "Rtabla" = <<lxRedoRtabla>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'REDO' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.REDO set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"+ [, descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'"+ [, redoent = ] + Transform( iif( &lcCursor..redoent, 1, 0 ))+ [, redotEnt = ] + Transform( iif( &lcCursor..redotEnt, 1, 0 ))+ [, redotCent = ] + Transform( iif( &lcCursor..redotCent, 1, 0 ))+ [, redopre = ] + Transform( iif( &lcCursor..redopre, 1, 0 ))+ [, robs = ] + "'" + this.FormatearTextoSql( &lcCursor..robs ) + "'"+ [, rnormal = ] + transform( &lcCursor..rnormal )+ [, rtabla = ] + transform( &lcCursor..rtabla ) + [ Where codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, TIMESTAMP, UALTAFW, SMODIFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, SALTAFW, HORAEXPO, ESTTRANS, BDMODIFW, HMODIFW, BDALTAFW, HORAIMPO, HALTAFW, codigo, descrip, redoent, redotEnt, redotCent, redopre, robs, rnormal, rtabla
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'" + ',' + Transform( iif( &lcCursor..redoent, 1, 0 )) + ',' + Transform( iif( &lcCursor..redotEnt, 1, 0 )) + ',' + Transform( iif( &lcCursor..redotCent, 1, 0 )) + ',' + Transform( iif( &lcCursor..redopre, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..robs ) + "'" + ',' + transform( &lcCursor..rnormal ) + ',' + transform( &lcCursor..rtabla )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.REDOENT = isnull( d.REDOENT, t.REDOENT ),t.REDOTENT = isnull( d.REDOTENT, t.REDOTENT ),t.REDOTCENT = isnull( d.REDOTCENT, t.REDOTCENT ),t.REDOPRE = isnull( d.REDOPRE, t.REDOPRE ),t.ROBS = isnull( d.ROBS, t.ROBS ),t.RNORMAL = isnull( d.RNORMAL, t.RNORMAL ),t.RTABLA = isnull( d.RTABLA, t.RTABLA )
					from ZooLogic.REDO t inner join deleted d 
							 on t.codigo = d.codigo
				-- Fin Updates
				insert into ZooLogic.REDO(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Ualtafw,Smodifw,Umodifw,Zadsfw,Valtafw,Vmodifw,Saltafw,Horaexpo,Esttrans,Bdmodifw,Hmodifw,Bdaltafw,Horaimpo,Haltafw,Codigo,Descrip,Redoent,Redotent,Redotcent,Redopre,Robs,Rnormal,Rtabla)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.TIMESTAMP,0),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.REDOENT,0),isnull( d.REDOTENT,0),isnull( d.REDOTCENT,0),isnull( d.REDOPRE,0),isnull( d.ROBS,''),isnull( d.RNORMAL,0),isnull( d.RTABLA,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="REDONDEODEPRECIOS                       " atributo="FECHATRANSFERENCIA                      " tabla="REDO           " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REDONDEODEPRECIOS                       " atributo="ESTADOTRANSFERENCIA                     " tabla="REDO           " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REDONDEODEPRECIOS                       " atributo="REDONDEONORMAL                          " tabla="REDO           " campo="RNORMAL   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="0                                                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="207" etiqueta="Tipo                                                                                                                                                            " dominio="COMBO                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REDONDEODEPRECIOS                       " atributo="REDONDEOPORTABLA                        " tabla="REDO           " campo="RTABLA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="0                                                                                                                                                                                                                                                             " obligatorio="false" admitebusqueda="208" etiqueta="Tipo                                                                                                                                                            " dominio="COMBO                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REDONDEODEPRECIOS                       " atributo="DETREDONDEOPORCENTAVO                   " tabla="REDODETPORCENT " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="209" etiqueta="Detalle                                                                                                                                                         " dominio="DETALLEITEMREDONDEOCENTAVOS   " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REDONDEODEPRECIOS                       " atributo="DETREDONDEOPORENTERO                    " tabla="REDODETPORENT  " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="210" etiqueta="Detalle                                                                                                                                                         " dominio="DETALLEITEMREDONDEOENTEROS    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="2" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REDONDEODEPRECIOS                       " atributo="DETREDONDEOPORTABLA                     " tabla="REDODETPORTABLA" campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="211" etiqueta="Detalle                                                                                                                                                         " dominio="DETALLEITEMREDONDEOTABLA      " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
