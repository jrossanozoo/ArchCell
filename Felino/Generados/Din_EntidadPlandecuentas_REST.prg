...
define class Din_EntidadPlandecuentas_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Plandecuentas"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Indicesinflacion", toEntidad, "Indicesinflacion" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "IndicesInflacion", toEntidad.IndicesInflacion)
