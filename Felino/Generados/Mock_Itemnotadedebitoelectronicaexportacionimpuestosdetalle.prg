...
define class Mock_Itemnotadedebitoelectronicaexportacionimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadedebitoelectronicaexportacionimpuestosdetalle'
