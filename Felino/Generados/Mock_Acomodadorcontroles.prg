...
define class Mock_ACOMODADORCONTROLES as MockBase of MockBase.prg

	cClase = 'ACOMODADORCONTROLES'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	nEspacio = 5                                                                                                                                                                                                                                              
	nEspacioMitadColumna = 6                                                                                                                                                                                                                                  
	nEspacioPegado = 1                                                                                                                                                                                                                                        
	nEspacioVerticalControl = 0                                                                                                                                                                                                                               
	nLeftPrimerControl = 0                                                                                                                                                                                                                                    
	nMargenSuperiorEtiqueta = 0                                                                                                                                                                                                                               
	nMargenSuperiorLinea = 1                                                                                                                                                                                                                                  
	nTabulacionActiva = 0                                                                                                                                                                                                                                     
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function acomodarcontrol( tocontrol as object, tntop as integer, tnanchomaximo as integer ) as integer                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Acomodarcontrol', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inicializar(  tntabulacionactiva as integer, tnespacioverticalcontrol as integer, tnleftprimercontrol as integer ) as void                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tntabulacionactiva
		lxParam2 = tnespacioverticalcontrol
		lxParam3 = tnleftprimercontrol
	...
	*-----------------------------------------------------------------------------------------
	function seteartabulacionactiva( tntabulacionactiva as integer ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Seteartabulacionactiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarcontrolesdelcontenedor( tofila as object, tnanchomaximo as integer ) as void                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tofila
		lxParam2 = tnanchomaximo
		...
		return this.ObtenerResultado( 'Ajustarcontrolesdelcontenedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ajustarobjetosespecialesdelcontenedor( tofila as object, tnanchomaximo as integer ) as void                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Ajustarobjetosespecialesdelcontenedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function calcularmargenderecha( toobjeto as object ) as integer                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Calcularmargenderecha', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function calcularmargenizquierda( toobjeto as object ) as integer                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Calcularmargenizquierda', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function calcularposicionizquierda( tocontrol as object, tnproxposizq as integer, tnanchomaximo as integer, tnposizqanterior as integer ) as integer                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tocontrol
		lxParam2 = tnproxposizq
		lxParam3 = tnanchomaximo
		lxParam4 = tnposizqanterior
		...
		return this.ObtenerResultado( 'Calcularposicionizquierda', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function calcularposicionsuperior( toobjeto as object, tnaltocontenedor as integer ) as integer                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toobjeto
		lxParam2 = tnaltocontenedor
		...
		return this.ObtenerResultado( 'Calcularposicionsuperior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function despuesdeacomodar( tocontrol as object ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Despuesdeacomodar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function esalineadoderecho( toobjeto as object ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esalineadoderecho', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function escontrolajustable( toobjeto as object ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Escontrolajustable', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function esprimercontrol( tocontrol as object ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esprimercontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function esuncontenedor( tocontrol as object ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esuncontenedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function moverobjetosdelcontenedor( tofila as object, tnanchomaximo as integer,  tnanchoactual as integer ) as void                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Moverobjetosdelcontenedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obteneranchoseguntipoalineado( toobjeto as object, tnanchomaximo as integer ) as integer                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obteneranchoseguntipoalineado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerfilainvertida( tocoleccion as object, tnfila as integer) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerfilainvertida', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertipoordenizquierdo( toobjeto as object ) as integer                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertipoordenizquierdo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertipoordensuperior( toobjeto as object ) as integer                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertipoordensuperior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ordenarcontrol( tocontenedor as object, tnanchomaximo as integer ) as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tocontenedor
		lxParam2 = tnanchomaximo
		...
		return this.ObtenerResultado( 'Ordenarcontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ordenarcontrolcomun( tocontenedor as object, tnanchomaximo as integer ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Ordenarcontrolcomun', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ordenarcontrolextensible( tocontenedor as object, tnanchomaximo as integer ) as void                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Ordenarcontrolextensible', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function reajustarcontenedor( tocontrol as object ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Reajustarcontenedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function reordenarfilacontrol( tocontenedor as object, tnanchomaximo as integer,  tnanchoactual as integer, tnfilaactual as integer,  tnaltofila as integer, tntopfila as integer ) as void                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Reordenarfilacontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function resetearespaciomitadcolumna() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Resetearespaciomitadcolumna', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function sepuedemover( toobjeto as object ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Sepuedemover', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearposicionsuperiorobjetosdelcontenedor( tofila as object, tnaltofila as integer, tntopfila as integer ) as void                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Setearposicionsuperiorobjetosdelcontenedor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function seteartabulacioncontrol( tocontenedor as object, tocontrol as object, tntabulacion as integer ) as integer                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Seteartabulacioncontrol', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificarespaciomitadcolumna() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarespaciomitadcolumna', lcParametros )
	EndFunc
