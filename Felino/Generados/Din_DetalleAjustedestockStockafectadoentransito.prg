...
define class Din_DetalleAJUSTEDESTOCKStockafectadoentransito as DetalleAjustecombinacion of DetalleAjustecombinacion.Prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Stockafectadoentransito' ) > 0 and reccount( 'c_Stockafectadoentransito' ) > 0
					sum Cantidad;
						 to ;
						 lnSum_Cantidad
				endif
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemAJUSTEDESTOCKStockafectadoentransito' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Stockafectadoentransito
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.codigo = c_Stockafectadoentransito.codigo
			loItem.NoProcesarStock = c_Stockafectadoentransito.NoProcesarStock
			loItem.Equivalencia_PK = c_Stockafectadoentransito.Equivalencia
			loItem.Comportamiento = c_Stockafectadoentransito.Comportamiento
			loItem.NROITEM = c_Stockafectadoentransito.NROITEM
			loItem.Articulo_PK = c_Stockafectadoentransito.Articulo
			loItem.ArticuloDetalle = c_Stockafectadoentransito.ArticuloDetalle
			loItem.Color_PK = c_Stockafectadoentransito.Color
			loItem.Talle = c_Stockafectadoentransito.Talle
			loItem.ColorDetalle = c_Stockafectadoentransito.ColorDetalle
			loItem.StockAct = c_Stockafectadoentransito.StockAct
			loItem.StockProy = c_Stockafectadoentransito.StockProy
			loItem.Cantidad = c_Stockafectadoentransito.Cantidad
			loItem.NroItem = lnI 
