...
define class Din_EntidadLIQUIDACIONMENSUALAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxLiqmensualFecexpo, lxLiqmensualFaltafw, lxLiqmensualFmodifw, lxLiqmensualFecimpo, lxLiqmensualFectrans, lxLiqmensualSmodifw, lxLiqmensualZadsfw, lxLiqmensualHoraexpo, lxLiqmensualHaltafw, lxLiqmensualHmodifw, lxLiqmensualHoraimpo, lxLiqmensualUaltafw, lxLiqmensualEsttrans, lxLiqmensualValtafw, lxLiqmensualVmodifw, lxLiqmensualSaltafw, lxLiqmensualBdmodifw, lxLiqmensualBdaltafw, lxLiqmensualUmodifw, lxLiqmensualFechaliq, lxLiqmensualTotalliq, lxLiqmensualOperadora, lxLiqmensualCodigo, lxLiqmensualFechadesde, lxLiqmensualNumint, lxLiqmensualTotalgrav, lxLiqmensualPtoventa, lxLiqmensualFechahasta, lxLiqmensualTotalnogra, lxLiqmensualObs, lxLiqmensualNroliq, lxLiqmensualSubtotal, lxLiqmensualOtrosimp, lxLiqmensualIdregcta, lxLiqmensualTotiva, lxLiqmensualOtroiva
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.LIQMENSUAL ( "Fecexpo","Faltafw","Fmodifw","Fecimpo","Fectrans","Smodifw","Zadsfw","Horaexpo","Haltafw","Hmodifw","Horaimpo","Ualtafw","Esttrans","Valtafw","Vmodifw","Saltafw","Bdmodifw","Bdaltafw","Umodifw","Fechaliq","Totalliq","Operadora","Codigo","Fechadesde","Numint","Totalgrav","Ptoventa","Fechahasta","Totalnogra","Obs","Nroliq","Subtotal","Otrosimp","Idregcta","Totiva","Otroiva" ) values ( <<"'" + this.ConvertirDateSql( lxLiqmensualFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqmensualFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqmensualFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqmensualFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqmensualFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualUmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqmensualFechaliq ) + "'" >>, <<lxLiqmensualTotalliq >>, <<"'" + this.FormatearTextoSql( lxLiqmensualOperadora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqmensualCodigo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqmensualFechadesde ) + "'" >>, <<lxLiqmensualNumint >>, <<lxLiqmensualTotalgrav >>, <<lxLiqmensualPtoventa >>, <<"'" + this.ConvertirDateSql( lxLiqmensualFechahasta ) + "'" >>, <<lxLiqmensualTotalnogra >>, <<"'" + this.FormatearTextoSql( lxLiqmensualObs ) + "'" >>, <<lxLiqmensualNroliq >>, <<lxLiqmensualSubtotal >>, <<lxLiqmensualOtrosimp >>, <<"'" + this.FormatearTextoSql( lxLiqmensualIdregcta ) + "'" >>, <<lxLiqmensualTotiva >>, <<lxLiqmensualOtroiva >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.ImpuestosComprobante
				if this.oEntidad.ImpuestosComprobante.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxMonto = loItem.Monto
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ImpLiqMenCom("minoimp","NroItem","porcen","TipoI","codint","cCod","CodImp","Descri","Monto" ) values ( <<lxMinimonoimponible>>, <<lxNroitem>>, <<lxPorcentaje>>, <<"'" + this.FormatearTextoSql( lxTipoimpuesto ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigointerno ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodimp_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodimpdetalle ) + "'">>, <<lxMonto>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.LIQMENSUAL set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxLiqmensualFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxLiqmensualFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxLiqmensualFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxLiqmensualFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxLiqmensualFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualSmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxLiqmensualZadsfw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxLiqmensualHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxLiqmensualHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualUaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxLiqmensualEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualVmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualSaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualBdaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualUmodifw ) + "'">>,"Fechaliq" = <<"'" + this.ConvertirDateSql( lxLiqmensualFechaliq ) + "'">>,"Totalliq" = <<lxLiqmensualTotalliq>>,"Operadora" = <<"'" + this.FormatearTextoSql( lxLiqmensualOperadora ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxLiqmensualCodigo ) + "'">>,"Fechadesde" = <<"'" + this.ConvertirDateSql( lxLiqmensualFechadesde ) + "'">>,"Numint" = <<lxLiqmensualNumint>>,"Totalgrav" = <<lxLiqmensualTotalgrav>>,"Ptoventa" = <<lxLiqmensualPtoventa>>,"Fechahasta" = <<"'" + this.ConvertirDateSql( lxLiqmensualFechahasta ) + "'">>,"Totalnogra" = <<lxLiqmensualTotalnogra>>,"Obs" = <<"'" + this.FormatearTextoSql( lxLiqmensualObs ) + "'">>,"Nroliq" = <<lxLiqmensualNroliq>>,"Subtotal" = <<lxLiqmensualSubtotal>>,"Otrosimp" = <<lxLiqmensualOtrosimp>>,"Idregcta" = <<"'" + this.FormatearTextoSql( lxLiqmensualIdregcta ) + "'">>,"Totiva" = <<lxLiqmensualTotiva>>,"Otroiva" = <<lxLiqmensualOtroiva>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxLiqmensualCodigo ) + "'">> and  LIQMENSUAL.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Umodifw" as "Usuariomodificacionfw", "Fechaliq" as "Fechaliq", "Totalliq" as "Totalliquidacion", "Operadora" as "Operadora", "Codigo" as "Codigo", "Fechadesde" as "Fechadesde", "Numint" as "Numint", "Totalgrav" as "Totalgravado", "Ptoventa" as "Puntodeventaliquidacion", "Fechahasta" as "Fechahasta", "Totalnogra" as "Totalnogravado", "Obs" as "Obs", "Nroliq" as "Numeroliquidacion", "Subtotal" as "Subtotal", "Otrosimp" as "Otrosimpuestos", "Idregcta" as "Idregistrodecuenta", "Totiva" as "Totaliva", "Otroiva" as "Totalotroiva" from ZooLogic.LIQMENSUAL where "Codigo" = <<"'" + this.FormatearTextoSql( lxLiqmensualCodigo ) + "'">> and  LIQMENSUAL.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Minoimp" as "Minimonoimponible", "Nroitem" as "Nroitem", "Porcen" as "Porcentaje", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Ccod" as "Codigo", "Codimp" as "Codimp", "Descri" as "Codimpdetalle", "Monto" as "Monto" from ZooLogic.ImpLiqMenCom where cCod = <<"'" + this.FormatearTextoSql( c_LIQUIDACIONMENSUAL.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Umodifw" as "Usuariomodificacionfw", "Fechaliq" as "Fechaliq", "Totalliq" as "Totalliquidacion", "Operadora" as "Operadora", "Codigo" as "Codigo", "Fechadesde" as "Fechadesde", "Numint" as "Numint", "Totalgrav" as "Totalgravado", "Ptoventa" as "Puntodeventaliquidacion", "Fechahasta" as "Fechahasta", "Totalnogra" as "Totalnogravado", "Obs" as "Obs", "Nroliq" as "Numeroliquidacion", "Subtotal" as "Subtotal", "Otrosimp" as "Otrosimpuestos", "Idregcta" as "Idregistrodecuenta", "Totiva" as "Totaliva", "Otroiva" as "Totalotroiva" from ZooLogic.LIQMENSUAL where  LIQMENSUAL.CODIGO != '' And numint = <<lxliqMensualnumint>>
			endtext
			use in select('c_LIQUIDACIONMENSUAL')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONMENSUAL', set( 'Datasession' ) )
			if reccount( 'c_LIQUIDACIONMENSUAL' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Umodifw" as "Usuariomodificacionfw", "Fechaliq" as "Fechaliq", "Totalliq" as "Totalliquidacion", "Operadora" as "Operadora", "Codigo" as "Codigo", "Fechadesde" as "Fechadesde", "Numint" as "Numint", "Totalgrav" as "Totalgravado", "Ptoventa" as "Puntodeventaliquidacion", "Fechahasta" as "Fechahasta", "Totalnogra" as "Totalnogravado", "Obs" as "Obs", "Nroliq" as "Numeroliquidacion", "Subtotal" as "Subtotal", "Otrosimp" as "Otrosimpuestos", "Idregcta" as "Idregistrodecuenta", "Totiva" as "Totaliva", "Otroiva" as "Totalotroiva" from ZooLogic.LIQMENSUAL where  LIQMENSUAL.CODIGO != '' order by numint
			endtext
			use in select('c_LIQUIDACIONMENSUAL')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONMENSUAL', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Umodifw" as "Usuariomodificacionfw", "Fechaliq" as "Fechaliq", "Totalliq" as "Totalliquidacion", "Operadora" as "Operadora", "Codigo" as "Codigo", "Fechadesde" as "Fechadesde", "Numint" as "Numint", "Totalgrav" as "Totalgravado", "Ptoventa" as "Puntodeventaliquidacion", "Fechahasta" as "Fechahasta", "Totalnogra" as "Totalnogravado", "Obs" as "Obs", "Nroliq" as "Numeroliquidacion", "Subtotal" as "Subtotal", "Otrosimp" as "Otrosimpuestos", "Idregcta" as "Idregistrodecuenta", "Totiva" as "Totaliva", "Otroiva" as "Totalotroiva" from ZooLogic.LIQMENSUAL where  str( numint, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LIQMENSUAL.CODIGO != '' order by numint
			endtext
			use in select('c_LIQUIDACIONMENSUAL')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONMENSUAL', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Umodifw" as "Usuariomodificacionfw", "Fechaliq" as "Fechaliq", "Totalliq" as "Totalliquidacion", "Operadora" as "Operadora", "Codigo" as "Codigo", "Fechadesde" as "Fechadesde", "Numint" as "Numint", "Totalgrav" as "Totalgravado", "Ptoventa" as "Puntodeventaliquidacion", "Fechahasta" as "Fechahasta", "Totalnogra" as "Totalnogravado", "Obs" as "Obs", "Nroliq" as "Numeroliquidacion", "Subtotal" as "Subtotal", "Otrosimp" as "Otrosimpuestos", "Idregcta" as "Idregistrodecuenta", "Totiva" as "Totaliva", "Otroiva" as "Totalotroiva" from ZooLogic.LIQMENSUAL where  str( numint, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LIQMENSUAL.CODIGO != '' order by numint desc
			endtext
			use in select('c_LIQUIDACIONMENSUAL')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONMENSUAL', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Umodifw" as "Usuariomodificacionfw", "Fechaliq" as "Fechaliq", "Totalliq" as "Totalliquidacion", "Operadora" as "Operadora", "Codigo" as "Codigo", "Fechadesde" as "Fechadesde", "Numint" as "Numint", "Totalgrav" as "Totalgravado", "Ptoventa" as "Puntodeventaliquidacion", "Fechahasta" as "Fechahasta", "Totalnogra" as "Totalnogravado", "Obs" as "Obs", "Nroliq" as "Numeroliquidacion", "Subtotal" as "Subtotal", "Otrosimp" as "Otrosimpuestos", "Idregcta" as "Idregistrodecuenta", "Totiva" as "Totaliva", "Otroiva" as "Totalotroiva" from ZooLogic.LIQMENSUAL where  LIQMENSUAL.CODIGO != '' order by numint desc
			endtext
			use in select('c_LIQUIDACIONMENSUAL')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONMENSUAL', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Faltafw,Fmodifw,Fecimpo,Fectrans,Smodifw,Zadsfw,Horaexpo,Haltafw,Hmodifw,Horaimpo,Ua" + ;
"ltafw,Esttrans,Valtafw,Vmodifw,Saltafw,Bdmodifw,Bdaltafw,Umodifw,Fechaliq,Totalliq,Operadora,Codigo," + ;
"Fechadesde,Numint,Totalgrav,Ptoventa,Fechahasta,Totalnogra,Obs,Nroliq,Subtotal,Otrosimp,Idregcta,Tot" + ;
"iva,Otroiva" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Umodifw" as "Usuariomodificacionfw", "Fechaliq" as "Fechaliq", "Totalliq" as "Totalliquidacion", "Operadora" as "Operadora", "Codigo" as "Codigo", "Fechadesde" as "Fechadesde", "Numint" as "Numint", "Totalgrav" as "Totalgravado", "Ptoventa" as "Puntodeventaliquidacion", "Fechahasta" as "Fechahasta", "Totalnogra" as "Totalnogravado", "Obs" as "Obs", "Nroliq" as "Numeroliquidacion", "Subtotal" as "Subtotal", "Otrosimp" as "Otrosimpuestos", "Idregcta" as "Idregistrodecuenta", "Totiva" as "Totaliva", "Otroiva" as "Totalotroiva"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.LIQMENSUAL set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxLiqmensualFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxLiqmensualFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxLiqmensualFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxLiqmensualFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxLiqmensualFectrans ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualSmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxLiqmensualZadsfw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxLiqmensualHoraexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualHaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualHmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxLiqmensualHoraimpo ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualUaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxLiqmensualEsttrans ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualVmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualSaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLiqmensualBdaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxLiqmensualUmodifw ) + "'">>, "Fechaliq" = <<"'" + this.ConvertirDateSql( lxLiqmensualFechaliq ) + "'">>, "Totalliq" = <<lxLiqmensualTotalliq>>, "Operadora" = <<"'" + this.FormatearTextoSql( lxLiqmensualOperadora ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxLiqmensualCodigo ) + "'">>, "Fechadesde" = <<"'" + this.ConvertirDateSql( lxLiqmensualFechadesde ) + "'">>, "Numint" = <<lxLiqmensualNumint>>, "Totalgrav" = <<lxLiqmensualTotalgrav>>, "Ptoventa" = <<lxLiqmensualPtoventa>>, "Fechahasta" = <<"'" + this.ConvertirDateSql( lxLiqmensualFechahasta ) + "'">>, "Totalnogra" = <<lxLiqmensualTotalnogra>>, "Obs" = <<"'" + this.FormatearTextoSql( lxLiqmensualObs ) + "'">>, "Nroliq" = <<lxLiqmensualNroliq>>, "Subtotal" = <<lxLiqmensualSubtotal>>, "Otrosimp" = <<lxLiqmensualOtrosimp>>, "Idregcta" = <<"'" + this.FormatearTextoSql( lxLiqmensualIdregcta ) + "'">>, "Totiva" = <<lxLiqmensualTotiva>>, "Otroiva" = <<lxLiqmensualOtroiva>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'LIQMENSUAL' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.LIQMENSUAL set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, fechaliq = ] + "'" + this.ConvertirDateSql( &lcCursor..fechaliq ) + "'"+ [, TotalLiq = ] + transform( &lcCursor..TotalLiq )+ [, operadora = ] + "'" + this.FormatearTextoSql( &lcCursor..operadora ) + "'"+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"+ [, fechadesde = ] + "'" + this.ConvertirDateSql( &lcCursor..fechadesde ) + "'"+ [, numint = ] + transform( &lcCursor..numint )+ [, TotalGrav = ] + transform( &lcCursor..TotalGrav )+ [, ptoventa = ] + transform( &lcCursor..ptoventa )+ [, fechahasta = ] + "'" + this.ConvertirDateSql( &lcCursor..fechahasta ) + "'"+ [, TotalNoGra = ] + transform( &lcCursor..TotalNoGra )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, nroliq = ] + transform( &lcCursor..nroliq )+ [, SubTotal = ] + transform( &lcCursor..SubTotal )+ [, OtrosImp = ] + transform( &lcCursor..OtrosImp )+ [, IdRegCta = ] + "'" + this.FormatearTextoSql( &lcCursor..IdRegCta ) + "'"+ [, totiva = ] + transform( &lcCursor..totiva )+ [, OtroIva = ] + transform( &lcCursor..OtroIva ) + [ Where codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FALTAFW, FMODIFW, FECIMPO, FECTRANS, SMODIFW, ZADSFW, HORAEXPO, HALTAFW, HMODIFW, HORAIMPO, UALTAFW, ESTTRANS, VALTAFW, VMODIFW, SALTAFW, BDMODIFW, BDALTAFW, UMODIFW, fechaliq, TotalLiq, operadora, codigo, fechadesde, numint, TotalGrav, ptoventa, fechahasta, TotalNoGra, Obs, nroliq, SubTotal, OtrosImp, IdRegCta, totiva, OtroIva
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..fechaliq ) + "'" + ',' + transform( &lcCursor..TotalLiq )
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + ',' + transform( &lcCursor..nroliq ) + ',' + transform( &lcCursor..SubTotal ) + ',' + transform( &lcCursor..OtrosImp ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdRegCta ) + "'" + ',' + transform( &lcCursor..totiva ) + ',' + transform( &lcCursor..OtroIva )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.FECHALIQ = isnull( d.FECHALIQ, t.FECHALIQ ),t.TOTALLIQ = isnull( d.TOTALLIQ, t.TOTALLIQ ),t.OPERADORA = isnull( d.OPERADORA, t.OPERADORA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FECHADESDE = isnull( d.FECHADESDE, t.FECHADESDE ),t.NUMINT = isnull( d.NUMINT, t.NUMINT ),t.TOTALGRAV = isnull( d.TOTALGRAV, t.TOTALGRAV ),t.PTOVENTA = isnull( d.PTOVENTA, t.PTOVENTA ),t.FECHAHASTA = isnull( d.FECHAHASTA, t.FECHAHASTA ),t.TOTALNOGRA = isnull( d.TOTALNOGRA, t.TOTALNOGRA ),t.OBS = isnull( d.OBS, t.OBS ),t.NROLIQ = isnull( d.NROLIQ, t.NROLIQ ),t.SUBTOTAL = isnull( d.SUBTOTAL, t.SUBTOTAL ),t.OTROSIMP = isnull( d.OTROSIMP, t.OTROSIMP ),t.IDREGCTA = isnull( d.IDREGCTA, t.IDREGCTA ),t.TOTIVA = isnull( d.TOTIVA, t.TOTIVA ),t.OTROIVA = isnull( d.OTROIVA, t.OTROIVA )
					from ZooLogic.LIQMENSUAL t inner join deleted d 
							 on t.codigo = d.codigo
							 and  t.numint = d.numint
				-- Fin Updates
				insert into ZooLogic.LIQMENSUAL(Fecexpo,Faltafw,Fmodifw,Fecimpo,Fectrans,Smodifw,Zadsfw,Horaexpo,Haltafw,Hmodifw,Horaimpo,Ualtafw,Esttrans,Valtafw,Vmodifw,Saltafw,Bdmodifw,Bdaltafw,Umodifw,Fechaliq,Totalliq,Operadora,Codigo,Fechadesde,Numint,Totalgrav,Ptoventa,Fechahasta,Totalnogra,Obs,Nroliq,Subtotal,Otrosimp,Idregcta,Totiva,Otroiva)
					Select isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.ZADSFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.SALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.UMODIFW,''),isnull( d.FECHALIQ,''),isnull( d.TOTALLIQ,0),isnull( d.OPERADORA,''),isnull( d.CODIGO,''),isnull( d.FECHADESDE,''),isnull( d.NUMINT,0),isnull( d.TOTALGRAV,0),isnull( d.PTOVENTA,0),isnull( d.FECHAHASTA,''),isnull( d.TOTALNOGRA,0),isnull( d.OBS,''),isnull( d.NROLIQ,0),isnull( d.SUBTOTAL,0),isnull( d.OTROSIMP,0),isnull( d.IDREGCTA,''),isnull( d.TOTIVA,0),isnull( d.OTROIVA,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="LIQUIDACIONMENSUAL                      " atributo="FECHATRANSFERENCIA                      " tabla="LIQMENSUAL     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIQUIDACIONMENSUAL                      " atributo="ESTADOTRANSFERENCIA                     " tabla="LIQMENSUAL     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIQUIDACIONMENSUAL                      " atributo="FECHADESDE                              " tabla="LIQMENSUAL     " campo="FECHADESDE" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha() -(day(goServicios.Librerias.ObtenerFecha())-1)                                                                                                                                                                          " obligatorio="true" admitebusqueda="410" etiqueta="Desde                                                                                                                                                           " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIQUIDACIONMENSUAL                      " atributo="PUNTODEVENTALIQUIDACION                 " tabla="LIQMENSUAL     " campo="PTOVENTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Nro.liquidación                                                                                                                                                 " dominio="NUMEROCOMPROBANTEEDITSINLETRA " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="9999                     " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="LIQUIDACIONMENSUAL                      " atributo="FECHAHASTA                              " tabla="LIQMENSUAL     " campo="FECHAHASTA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerUltimoDiaDelMes(goServicios.Librerias.ObtenerFecha())                                                                                                                                                                           " obligatorio="true" admitebusqueda="414" etiqueta="Hasta                                                                                                                                                           " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
