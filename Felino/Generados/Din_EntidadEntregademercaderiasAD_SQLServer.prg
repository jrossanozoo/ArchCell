...
define class Din_EntidadENTREGADEMERCADERIASAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxEntmerFecimpo, lxEntmerFectrans, lxEntmerFmodifw, lxEntmerFaltafw, lxEntmerFecexpo, lxEntmerNumero, lxEntmerHaltafw, lxEntmerHoraexpo, lxEntmerSaltafw, lxEntmerSmodifw, lxEntmerHmodifw, lxEntmerHoraimpo, lxEntmerVmodifw, lxEntmerUmodifw, lxEntmerBdaltafw, lxEntmerZadsfw, lxEntmerEsttrans, lxEntmerBdmodifw, lxEntmerValtafw, lxEntmerUaltafw, lxEntmerCliente, lxEntmerCodigo, lxEntmerFecha, lxEntmerTransp, lxEntmerObs, lxEntmerHora, lxEntmerBultos
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ENTMER ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Numero","Haltafw","Horaexpo","Saltafw","Smodifw","Hmodifw","Horaimpo","Vmodifw","Umodifw","Bdaltafw","Zadsfw","Esttrans","Bdmodifw","Valtafw","Ualtafw","Cliente","Codigo","Fecha","Transp","Obs","Hora","Bultos" ) values ( <<"'" + this.ConvertirDateSql( lxEntmerFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntmerFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntmerFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntmerFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntmerFecexpo ) + "'" >>, <<lxEntmerNumero >>, <<"'" + this.FormatearTextoSql( lxEntmerHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerCliente ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerCodigo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntmerFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerTransp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntmerHora ) + "'" >>, <<lxEntmerBultos >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ENTMER set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEntmerFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEntmerFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEntmerFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEntmerFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxEntmerFecexpo ) + "'">>,"Numero" = <<lxEntmerNumero>>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEntmerHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEntmerHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEntmerSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEntmerSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEntmerHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEntmerHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEntmerVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEntmerUmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEntmerBdaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEntmerZadsfw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEntmerEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEntmerBdmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEntmerValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEntmerUaltafw ) + "'">>,"Cliente" = <<"'" + this.FormatearTextoSql( lxEntmerCliente ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxEntmerCodigo ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxEntmerFecha ) + "'">>,"Transp" = <<"'" + this.FormatearTextoSql( lxEntmerTransp ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxEntmerObs ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxEntmerHora ) + "'">>,"Bultos" = <<lxEntmerBultos>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxEntmerCodigo ) + "'">> and  ENTMER.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Numero,Haltafw,Horaexpo,Saltafw,Smodifw,Hmodifw,Hor" + ;
"aimpo,Vmodifw,Umodifw,Bdaltafw,Zadsfw,Esttrans,Bdmodifw,Valtafw,Ualtafw,Cliente,Codigo,Fecha,Transp," + ;
"Obs,Hora,Bultos" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, NUMERO, HALTAFW, HORAEXPO, SALTAFW, SMODIFW, HMODIFW, HORAIMPO, VMODIFW, UMODIFW, BDALTAFW, ZADSFW, ESTTRANS, BDMODIFW, VALTAFW, UALTAFW, CLIENTE, CODIGO, FECHA, TRANSP, OBS, HORA, BULTOS
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CLIENTE ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.CLIENTE = isnull( d.CLIENTE, t.CLIENTE ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.TRANSP = isnull( d.TRANSP, t.TRANSP ),t.OBS = isnull( d.OBS, t.OBS ),t.HORA = isnull( d.HORA, t.HORA ),t.BULTOS = isnull( d.BULTOS, t.BULTOS )
					from ZooLogic.ENTMER t inner join deleted d 
							 on t.CODIGO = d.CODIGO
							 and  t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.ENTMER(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Numero,Haltafw,Horaexpo,Saltafw,Smodifw,Hmodifw,Horaimpo,Vmodifw,Umodifw,Bdaltafw,Zadsfw,Esttrans,Bdmodifw,Valtafw,Ualtafw,Cliente,Codigo,Fecha,Transp,Obs,Hora,Bultos)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.NUMERO,0),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ZADSFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.CLIENTE,''),isnull( d.CODIGO,''),isnull( d.FECHA,''),isnull( d.TRANSP,''),isnull( d.OBS,''),isnull( d.HORA,''),isnull( d.BULTOS,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="ENTREGADEMERCADERIAS                    " atributo="FECHATRANSFERENCIA                      " tabla="ENTMER         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTREGADEMERCADERIAS                    " atributo="ESTADOTRANSFERENCIA                     " tabla="ENTMER         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTREGADEMERCADERIAS                    " atributo="TRANSPORTISTA                           " tabla="ENTMER         " campo="TRANSP    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Transportista                                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
...
<VFPData xml:space="preserve">
	...
	<row entidad="ITEMREMITOS                             " atributo="REMITO                                  " tabla="ENTMERDET      " campo="REMITO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="201" etiqueta="DetalleRemitoDetalle, Remito                                                                                                                                    " dominio="CARACTERREMELEC               " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTMERDET On ENTMER.CODIGO = ENTMERDET.CODIGO And  ENTMER.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMREMITOS                             " atributo="CLIENTE                                 " tabla="ENTMERDET      " campo="CLIENTE   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="202" etiqueta="DetalleRemitoDetalle, Cliente                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTMERDET On ENTMER.CODIGO = ENTMERDET.CODIGO And  ENTMER.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMREMITOS                             " atributo="CLIENTEDETALLE                          " tabla="ENTMERDET      " campo="CLIEDETA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="203" etiqueta="DetalleRemitoDetalle, Nombre                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTMERDET On ENTMER.CODIGO = ENTMERDET.CODIGO And  ENTMER.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMREMITOS                             " atributo="DIRECCION                               " tabla="ENTMERDET      " campo="DIRECCION " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="220" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="204" etiqueta="DetalleRemitoDetalle, Dirección                                                                                                                                 " dominio="CARACTER                      " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTMERDET On ENTMER.CODIGO = ENTMERDET.CODIGO And  ENTMER.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMREMITOS                             " atributo="CANTIDAD                                " tabla="ENTMERDET      " campo="CANTIDAD  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="205" etiqueta="DetalleRemitoDetalle, Cantidad                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="I" atributoforaneo="comprobante.TotalCantidad                                                                                                                                                                                                                                     " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTMERDET On ENTMER.CODIGO = ENTMERDET.CODIGO And  ENTMER.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ITEMREMITOS                             " atributo="IMPORTETOTAL                            " tabla="ENTMERDET      " campo="IMPORTE   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="206" etiqueta="DetalleRemitoDetalle, Importe total                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="I" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ENTMERDET On ENTMER.CODIGO = ENTMERDET.CODIGO And  ENTMER.CODIGO != ''                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
