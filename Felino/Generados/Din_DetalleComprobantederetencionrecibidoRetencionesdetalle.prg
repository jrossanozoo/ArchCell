...
define class Din_DetalleCOMPROBANTEDERETENCIONRECIBIDORetencionesdetalle as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemCOMPROBANTEDERETENCIONRECIBIDORetencionesdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Retencionesdetalle
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Retencionesdetalle.Codigo
			loItem.NROITEM = c_Retencionesdetalle.NROITEM
			loItem.Impuesto_PK = c_Retencionesdetalle.Impuesto
			loItem.Jurisdiccion = c_Retencionesdetalle.Jurisdiccion
			loItem.Resolucion = c_Retencionesdetalle.Resolucion
			loItem.Monto = c_Retencionesdetalle.Monto
			loItem.NroItem = lnI 
