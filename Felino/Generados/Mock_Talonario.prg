...
define class Mock_talonario as MockBase of MockBase.prg
	...
	lHabilitarAsignacion = .T.                                                                                                                                                                                                                                
	lHabilitarEntidad = .T.                                                                                                                                                                                                                                   
	lHabilitarLetra = .T.                                                                                                                                                                                                                                     
	lHabilitarNumero = .T.                                                                                                                                                                                                                                    
	lHabilitarPuntoDeVenta = .T.                                                                                                                                                                                                                              
	lHabilitarReservarNumero = .T.                                                                                                                                                                                                                            
	lHabilitarTalonariorela_PK = .T.                                                                                                                                                                                                                          
	...
	*-----------------------------------------------------------------------------------------
	function armartalonario( tctalonario as string, toentidad as entidad of entidad.prg ) as string                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Armartalonario', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function asignacion_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'asignacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'asignacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Asignacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Asignacion( lxVal )				if ( this.lHabilitarAsignacion or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Asignacion( lxVal )				else					this.Asignacion = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Talonario - Atributo: Asignacion)" )				endif			EndIf		Else			This.Setear_Asignacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function atributo_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'atributo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'atributo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Atributo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Atributo( lxVal )				this.Setear_Atributo( lxVal )			EndIf		Else			This.Setear_Atributo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function delegarnumeracion_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'delegarnumeracion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'delegarnumeracion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Delegarnumeracion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Delegarnumeracion( lxVal )				this.Setear_Delegarnumeracion( lxVal )			EndIf		Else			This.Setear_Delegarnumeracion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function electronicoexportacion() as object                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Electronicoexportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function electroniconacional() as object                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Electroniconacional', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escomprobantedeventa( tcentidad ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Escomprobantedeventa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esentidaddecheques() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Esentidaddecheques', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formula_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'formula_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'formula_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Formula		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Formula( lxVal )				this.Setear_Formula( lxVal )			EndIf		Else			This.Setear_Formula( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitadeshabilitareservarnumero() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Habilitadeshabilitareservarnumero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function informartamaniotalonario( tntamanio as integer ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Informartamaniotalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiarentidad( todelegado ) as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Limpiarentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function maximonumero_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'maximonumero_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'maximonumero_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Maximonumero		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Maximonumero( lxVal )				this.Setear_Maximonumero( lxVal )			EndIf		Else			This.Setear_Maximonumero( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerparametrobocadeexpendio() as integer                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerparametrobocadeexpendio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersireservanumeros() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenersireservanumeros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertalonario( tctalonario as string ) as string                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenertalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reservarnumero_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'reservarnumero_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'reservarnumero_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Reservarnumero		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Reservarnumero( lxVal )				if ( this.lHabilitarReservarnumero or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Reservarnumero( lxVal )				else					this.Reservarnumero = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Talonario - Atributo: Reservarnumero)" )				endif			EndIf		Else			This.Setear_Reservarnumero( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function servicio_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'servicio_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'servicio_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Servicio		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Servicio( lxVal )				this.Setear_Servicio( lxVal )			EndIf		Else			This.Setear_Servicio( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_asignacion( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_asignacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_asignacion', lcParametros )			endif		endif		this.Asignacion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_atributo( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_atributo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_atributo', lcParametros )			endif		endif		this.Atributo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_delegarnumeracion( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_delegarnumeracion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_delegarnumeracion', lcParametros )			endif		endif		dodefault( txVal )		with this			.lHabilitarNumero = !.DelegarNumeracion			.lHabilitarTalonariorela_PK = .DelegarNumeracion					endwith
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_formula( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_formula', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_formula', lcParametros )			endif		endif		dodefault( txVal )				if !empty( txVal ) and this.EsNuevo()			this.HabilitarAtributosSegunTalonario( txVal )		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_maximonumero( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_maximonumero', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_maximonumero', lcParametros )			endif		endif		this.Maximonumero = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_reservarnumero( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_reservarnumero', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_reservarnumero', lcParametros )			endif		endif		this.Reservarnumero = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_servicio( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_servicio', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_servicio', lcParametros )			endif		endif		this.Servicio = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_talonariorela( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_talonariorela', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_talonariorela', lcParametros )			endif		endif		this.Talonariorela.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearcodigo() as void                                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setearcodigo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function talonariorela_access() as variant                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'talonariorela_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'talonariorela_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Talonariorela ) = 'O' or isnull( this.Talonariorela ) )					this.Talonariorela = _Screen.zoo.instanciarentidad( 'Talonario' )					this.Talonariorela.lEsSubEntidad = .t.					this.enlazar( 'Talonariorela.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Talonariorela.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Talonariorela.CODIGO # this.Talonariorela_PK						this.Talonariorela.CODIGO = this.Talonariorela_PK					endif				endif			endif		endif		return this.Talonariorela
	EndFunc

	*-----------------------------------------------------------------------------------------
	function talonariorela_pk_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'talonariorela_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'talonariorela_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Talonariorela_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 35, padr( lxVal, 35 ), lxVal )		this.Talonariorela_PK = lxVal		if this.Validar_Talonariorela( lxVal, lxValOld )			if ( this.lHabilitarTalonariorela_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )				This.Setear_Talonariorela( lxVal )			else				this.Talonariorela_PK = lxValOld				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Talonario - Atributo: Talonariorela)" )			endif		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_asignacion( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_asignacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_asignacion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_atributo( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_atributo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_atributo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_delegarnumeracion( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_delegarnumeracion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_delegarnumeracion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_formula( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_formula', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_formula', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_maximonumero( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_maximonumero', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_maximonumero', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_reservarnumero( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_reservarnumero', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_reservarnumero', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_servicio( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_servicio', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_servicio', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_talonariorela( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TALONARIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_talonariorela', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_talonariorela', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardelegacioncomprobanteselectronicos() as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validardelegacioncomprobanteselectronicos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardelegacionnivel1() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validardelegacionnivel1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarletraypuntodeventaendelegacion() as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validarletraypuntodeventaendelegacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartalonariodelegado() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validartalonariodelegado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validartalonariorela() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validartalonariorela', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartalonariorelacion() as boolean                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validartalonariorelacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoasignacion() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoasignacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridodelegarnumeracion() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodelegarnumeracion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwentidad() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomaximonumero() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridomaximonumero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoreservarnumero() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoreservarnumero', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridotalonariorela() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridotalonariorela', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function buscarultimonumeroexistenteparaentidadseleccionada( tcentidadseleccionada as string, tcpuntodeventa as string ) as integer                                                                                                             
		...
		lnParametros = pcount()
		lxParam1 = tcentidadseleccionada
		lxParam2 = tcpuntodeventa
		...
		return this.ObtenerResultado( 'Buscarultimonumeroexistenteparaentidadseleccionada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitaratributosseguntalonario( tctalonario as string ) as void                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Habilitaratributosseguntalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function habilitaratributostalonario( tlhabilitar as boolean ) as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Habilitaratributostalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenertalonariodeentidadseleccionada( tcentidadseleccionada as string, tcpuntodeventa as string ) as string                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertalonariodeentidadseleccionada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function pertenecealtalonario( tcatributo as string, tctalonario as string ) as boolean                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Pertenecealtalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarduplicidaddetalonarioencheques() as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validarduplicidaddetalonarioencheques', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarnumeromaximo() as as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarnumeromaximo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarysetearnumerocomprobanteelectronico() as void                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validarysetearnumerocomprobanteelectronico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarysetearnumerointernocheques() as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validarysetearnumerointernocheques', lcParametros )
	EndFunc
