	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TIINVCONDET ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Zadsfw","Saltafw","Smodifw","Vmodifw","Ualtafw","Hmodifw","Valtafw","Umodifw","Haltafw","Horaimpo","Esttrans","Bdaltafw","Bdmodifw","Horaexpo","Mart","Mcolo","Idcabecera","Mtall","Mobs","Canti" ) values ( <<"'" + this.ConvertirDateSql( lxTiinvcondetFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvcondetFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvcondetFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvcondetFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTiinvcondetFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetMart ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetMcolo ) + "'" >>, <<lxTiinvcondetIdcabecera >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetMtall ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTiinvcondetMobs ) + "'" >>, <<lxTiinvcondetCanti >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TIINVCONDET set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFecimpo ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetZadsfw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetSmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetVmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetUmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTiinvcondetEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHoraexpo ) + "'">>,"Mart" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMart ) + "'">>,"Mcolo" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMcolo ) + "'">>,"Idcabecera" = <<lxTiinvcondetIdcabecera>>,"Mtall" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMtall ) + "'">>,"Mobs" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMobs ) + "'">>,"Canti" = <<lxTiinvcondetCanti>> where "Codigo" = <<lxTiinvcondetCodigo>> and  TIINVCONDET.CODIGO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Mart" as "Articulo", "Mcolo" as "Color", "Codigo" as "Codigo", "Idcabecera" as "Idcabecera", "Mtall" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVCONDET where  TIINVCONDET.CODIGO != 0 order by CODIGO
			endtext
			use in select('c_TIINVENTARIOACONTDETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOACONTDETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Mart" as "Articulo", "Mcolo" as "Color", "Codigo" as "Codigo", "Idcabecera" as "Idcabecera", "Mtall" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVCONDET where  str( CODIGO, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIINVCONDET.CODIGO != 0 order by CODIGO
			endtext
			use in select('c_TIINVENTARIOACONTDETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOACONTDETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Mart" as "Articulo", "Mcolo" as "Color", "Codigo" as "Codigo", "Idcabecera" as "Idcabecera", "Mtall" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVCONDET where  str( CODIGO, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIINVCONDET.CODIGO != 0 order by CODIGO desc
			endtext
			use in select('c_TIINVENTARIOACONTDETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOACONTDETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Zadsfw" as "Zadsfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Mart" as "Articulo", "Mcolo" as "Color", "Codigo" as "Codigo", "Idcabecera" as "Idcabecera", "Mtall" as "Talle", "Mobs" as "Obs", "Canti" as "Cantidad" from ZooLogic.TIINVCONDET where  TIINVCONDET.CODIGO != 0 order by CODIGO desc
			endtext
			use in select('c_TIINVENTARIOACONTDETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIINVENTARIOACONTDETALLE', set( 'Datasession' ) )
			Endwith
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.TIINVCONDET set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTiinvcondetFecimpo ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetZadsfw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetSaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetSmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetVmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetUaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetUmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHoraimpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxTiinvcondetEsttrans ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTiinvcondetBdmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxTiinvcondetHoraexpo ) + "'">>, "Mart" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMart ) + "'">>, "Mcolo" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMcolo ) + "'">>, "Idcabecera" = <<lxTiinvcondetIdcabecera>>, "Mtall" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMtall ) + "'">>, "Mobs" = <<"'" + this.FormatearTextoSql( lxTiinvcondetMobs ) + "'">>, "Canti" = <<lxTiinvcondetCanti>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'TIINVCONDET' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function CrearCursorMemo( tcCursorACrear as String, tcTablaConMemo as String ) as Void
		create cursor &tcCursorACrear ( CODIGO A (8) , Orden N(16), texto C(80))
	endfunc
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.MART = isnull( d.MART, t.MART ),t.MCOLO = isnull( d.MCOLO, t.MCOLO ),t.IDCABECERA = isnull( d.IDCABECERA, t.IDCABECERA ),t.MTALL = isnull( d.MTALL, t.MTALL ),t.MOBS = isnull( d.MOBS, t.MOBS ),t.CANTI = isnull( d.CANTI, t.CANTI )
					from ZooLogic.TIINVCONDET t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.TIINVCONDET(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Zadsfw,Saltafw,Smodifw,Vmodifw,Ualtafw,Hmodifw,Valtafw,Umodifw,Haltafw,Horaimpo,Esttrans,Bdaltafw,Bdmodifw,Horaexpo,Mart,Mcolo,Idcabecera,Mtall,Mobs,Canti)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.ZADSFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.VMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.MART,''),isnull( d.MCOLO,''),isnull( d.IDCABECERA,0),isnull( d.MTALL,''),isnull( d.MOBS,''),isnull( d.CANTI,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_TIINVENTARIOACONTDETALLE' ) < 1
				...
				Try
					...
					.Talle = nvl( c_TIINVENTARIOACONTDETALLE.Talle, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIINVENTARIOACONTDETALLE                " atributo="FECHATRANSFERENCIA                      " tabla="TIINVCONDET    " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIINVENTARIOACONTDETALLE                " atributo="ESTADOTRANSFERENCIA                     " tabla="TIINVCONDET    " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIINVENTARIOACONTDETALLE                " atributo="ARTICULO                                " tabla="TIINVCONDET    " campo="MART      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Artículo                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; art.astock &lt;= 1 &quot;                                                                                                                                                                                     " grupo="1" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIINVENTARIOACONTDETALLE                " atributo="COLOR                                   " tabla="TIINVCONDET    " campo="MCOLO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Color                                                                                                                                                           " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIINVENTARIOACONTDETALLE                " atributo="CODIGO                                  " tabla="TIINVCONDET    " campo="CODIGO    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="A         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Número                                                                                                                                                          " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
