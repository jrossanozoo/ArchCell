...
define class Mock_Itemtidiferenciasdeinventarioinventariosfisicosdetalle as MockBase of MockBase.prg

	cClase = 'Itemtidiferenciasdeinventarioinventariosfisicosdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function inventariofisico_access() as variant                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Inventariofisico_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariofisico_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Inventariofisico_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inventariofisicodetalle_assign( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Inventariofisicodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventariofisico( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_inventariofisico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_inventariofisicodetalle( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_inventariofisicodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventariofisico( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_inventariofisico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_inventariofisicodetalle( txval as variant ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_inventariofisicodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoinventariofisico() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridoinventariofisico', lcParametros )
	EndFunc
