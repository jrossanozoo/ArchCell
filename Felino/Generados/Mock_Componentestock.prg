...
define class Mock_COMPONENTESTOCK as MockBase of MockBase.prg

	cClase = 'COMPONENTESTOCK'

	
	*lControlaStockPorArticulos = .F.                                                                                                                                                                                                                         
	*nDataSessionStockArticulos = 0                                                                                                                                                                                                                           
	cAtributoEstadoStock = ""                                                                                                                                                                                                                                 
	cErrorValidarDisponibilidad = ""                                                                                                                                                                                                                          
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	lAjustoStock = .F.                                                                                                                                                                                                                                        
	lAnular = .f.                                                                                                                                                                                                                                             
	lColArticulosAgrupada = .f.                                                                                                                                                                                                                               
	lComponenteDetalleKits = .F.                                                                                                                                                                                                                              
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	lEdicion = .F.                                                                                                                                                                                                                                            
	lEliminar = .F.                                                                                                                                                                                                                                           
	lEsExe = .f.                                                                                                                                                                                                                                              
	lEventoNoHayStockEnArticulos = .f.                                                                                                                                                                                                                        
	...
	lNuevo = .F.                                                                                                                                                                                                                                              
	lParticipantes = .f.                                                                                                                                                                                                                                      
	lParticipantesCargados = .F.                                                                                                                                                                                                                              
	lPermitePasarStockEnNegativoRompiendoTodo = .f.                                                                                                                                                                                                           
	lProcesarStock = .T.                                                                                                                                                                                                                                      
	nCodigoDeErrorPorFaltaDeStock = 9845                                                                                                                                                                                                                      
	nDataSessionStockCombinacion = 0                                                                                                                                                                                                                          
	nFaltanteArticulos = 0                                                                                                                                                                                                                                    
	nFaltanteCombinacion = 0                                                                                                                                                                                                                                  
	nSigno = 1                                                                                                                                                                                                                                                
	nThisDataSession = 0                                                                                                                                                                                                                                      
	oAgrupadorPorArticulo = null                                                                                                                                                                                                                              
	oArticulo = null                                                                                                                                                                                                                                          
	oAtributosGenericos = null                                                                                                                                                                                                                                
	oColAdvertenciasMinimoReposicion = null                                                                                                                                                                                                                   
	oColErroresParticipantes = null                                                                                                                                                                                                                           
	oColSentencias = Null                                                                                                                                                                                                                                     
	oColStock = null                                                                                                                                                                                                                                          
	oColStockInicial = null                                                                                                                                                                                                                                   
	oColaboradorConsultasDeStock = null                                                                                                                                                                                                                       
	oColaboradorMinimoReposicion = null                                                                                                                                                                                                                       
	oCombinacion = null                                                                                                                                                                                                                                       
	oComprobante = null                                                                                                                                                                                                                                       
	...
	*-----------------------------------------------------------------------------------------
	    function obtenermaximoreposicioncombinacion( toitem as object ) as float                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenermaximoreposicioncombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	    function obtenerminimoreposicioncombinacion( toitem as object ) as float                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerminimoreposicioncombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarstockenitem() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Actualizarstockenitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function adviertenotienedisponible() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Adviertenotienedisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function alcanzominimodereposicion( toitem as object ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Alcanzominimodereposicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function antesdeverificardisponibilidaddestockalsetearcantidad() as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Antesdeverificardisponibilidaddestockalsetearcantidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function clonarcoleccionstock( tocoleccion as object ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Clonarcoleccionstock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function consultarstockdearticulo( tccodart as string ) as string                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Consultarstockdearticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function copiaritemacoleccionoriginal( tocoleccion as object, toitem as object ) as void                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Copiaritemacoleccionoriginal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debeverificarminimodereposicion() as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debeverificarminimodereposicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escomprobanteconentregaposterior( toentidadpadre as object ) as boolean                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Escomprobanteconentregaposterior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function esfacturadeventas( toentidad as object ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esfacturadeventas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esimportacion() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Esimportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esnotadecreditoenbaseacomprobanteonline() as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Esnotadecreditoenbaseacomprobanteonline', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoalcanzominimodereposicion( toinfo ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function eventonohaystockenarticulo() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventonohaystockenarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoverificarajusteautomatico( nfaltantecombinacion as integer ) as void                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = nfaltantecombinacion
		...
		return this.ObtenerResultado( 'Eventoverificarajusteautomatico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formarmensajecomb( toitemstock as object ) as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Formarmensajecomb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formarmensajecombdisponible( toitemstock as object ) as object                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Formarmensajecombdisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formarmensajecombsegundisponible( toitemstock as object ) as object                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Formarmensajecombsegundisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generastock( toitem as object ) as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Generastock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function grabarcomprobante( tocolstockactual as object, tostockinicial as object ) as zoocoleccion of zoocoleccion.prg                                                                                                                                    
		...
		lnParametros = pcount()
		lxParam1 = tocolstockactual
		lxParam2 = tostockinicial
		...
		return this.ObtenerResultado( 'Grabarcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function incorporaelstockdepedidosdecompraaldisponible() as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Incorporaelstockdepedidosdecompraaldisponible', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function incorporaelstockseniadoaldisponible() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Incorporaelstockseniadoaldisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectaritemkit( toitem as object ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Inyectaritemkit', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiarcoleccionesstock() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Limpiarcoleccionesstock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nsigno_assign( tnvalue )                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Nsigno_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oagrupadorporarticulo_access()                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oagrupadorporarticulo_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oarticulo_access()                                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Oarticulo_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributoestadostock() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obteneratributoestadostock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposatributoscombinacion() as string                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenercamposatributoscombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposatributoscombinacionasnombredeatributo() as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercamposatributoscombinacionasnombredeatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidaditemalgrabar( tlestavalidandominimoderesposicion as boolean ) as float                                                                                                                                                            
		...
		lnParametros = pcount()
		lxParam1 = tlestavalidandominimoderesposicion
		...
		return this.ObtenerResultado( 'Obtenercantidaditemalgrabar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionacumuladocombinacion( lodetalle as object ) as object                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercoleccionacumuladocombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerdetalleminimodereposicion( toitemstock as object, tnminimo as float, tndisponible as float, tnsolicitado as float ) as string                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		lxParam1 = toitemstock
		lxParam2 = tnminimo
		lxParam3 = tndisponible
		lxParam4 = tnsolicitado
		...
		return this.ObtenerResultado( 'Obtenerdetalleminimodereposicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdisponibilidadalgrabar( tcatributo as string, toitem as object ) as integer                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerdisponibilidadalgrabar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerexpresionconcamposegunestadostock( tlconinicializacion ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerexpresionconcamposegunestadostock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinvertirsigno( tcestadostock as string ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerinvertirsigno', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerparticicipantesdekit( toitem as object ) as object                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerparticicipantesdekit', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerresumendeminimoderepsocicionsuperado( toitem as object ) as zooinformacion of zooinformacion.prg                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerresumendeminimoderepsocicionsuperado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstockarticulo( tcarticulo_pk as string ) as float                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerstockarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstockcombinacion( toitem as object ) as float                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerstockcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerstockcombinacionesdearticulo( tccodigo as string, tcatributoestadodestock as string ) as string                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccodigo
		lxParam2 = tcatributoestadodestock
		...
		return this.ObtenerResultado( 'Obtenerstockcombinacionesdearticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstockcombinacionestado( toitem as object, tcestadodestock as string ) as float                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerstockcombinacionestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstockinicialcombinacion( toitem as object ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerstockinicialcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorconsultasdestock_access()                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Ocolaboradorconsultasdestock_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocolaboradorminimoreposicion_access()                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolaboradorminimoreposicion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocopiadordeitemsstockacoleccion_access()                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Ocopiadordeitemsstockacoleccion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ostockcombinacion_access()                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Ostockcombinacion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearocolstockdetalleparticipantes( todetalle as object ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearocolstockdetalleparticipantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearycargarcombinacion( toitem as object ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setearycargarcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienedisponibledeparticipantescargados( toitemkit as object ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Tienedisponibledeparticipantescargados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienehabilitadoelcontroldestock() as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Tienehabilitadoelcontroldestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardisponibilidaditems( toparticipantes ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validardisponibilidaditems', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarencombinaciones( ) as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarencombinaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarminimodereposicion( toitem as object, tlminimoreposicionparticipantes as boolean ) as void                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toitem
		lxParam2 = tlminimoreposicionparticipantes
		...
		return this.ObtenerResultado( 'Validarminimodereposicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function yaseprocesoelinsertdelacombinacion( toitem as object ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Yaseprocesoelinsertdelacombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function abrirtablassqlserver() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Abrirtablassqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarcampocantidadoriginalastockcombinacion( tccursorcombinacion as string ) as void                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Agregarcampocantidadoriginalastockcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarcampoclaveprimariaastockcombinacion( tccursorcombinacion ) as void                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Agregarcampoclaveprimariaastockcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function agregarcampostransferencias( tccursorarticulos as string ) as void                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tccursorarticulos
		...
		return this.ObtenerResultado( 'Agregarcampostransferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregardatosafectaciones( toentidad as object, tcatributodetalle as string, tccursordetalle as string, tccursorcabecera as string ) as void                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Agregardatosafectaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarsignocursordetalle( toentidad as object, tcatributodetalle as string, tccursordetalle as string , tccursorcabecera as string ) as void                                                                                          
		...
		return this.ObtenerResultado( 'Agregarsignocursordetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agruparporcombinacion( tocolcombinacionfinal as object , toitemstock as object  ) as void                                                                                                                                              
		...
		lnParametros = pcount()
		lxParam1 = tocolcombinacionfinal
		...
		return this.ObtenerResultado( 'Agruparporcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function articuloquegenerastock( tcarticulo as string ) as string                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Articuloquegenerastock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function asignarcantidadcombinaciondelagrupamientoaentidaddestock( toitem as object ) as void                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Asignarcantidadcombinaciondelagrupamientoaentidaddestock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cantidadencomprobante( toitemstock as object ) as number                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cantidadencomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cantidadrestastock() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Cantidadrestastock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cerrartablassqlserver() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Cerrartablassqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function correspondecontemplarstockafectadosegunestado( tcestadostock as string, tntipocomprobante as integer ) as boolean                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Correspondecontemplarstockafectadosegunestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearcursorfiltrado( toentidad as object, tcatributodetalle as string, tccursordetalle as string, tccursorcabecera as string ) as void                                                                                                 
		...
		return this.ObtenerResultado( 'Crearcursorfiltrado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debevalidardisponibilidad() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Debevalidardisponibilidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debevalidarstock() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Debevalidarstock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function debevalidarstockdisponible() as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Debevalidarstockdisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function factordecorrecciondedisponibleporinvertirsigno() as number                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Factordecorrecciondedisponibleporinvertirsigno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function grabarencombinacion( toitem as object, tocolart as object ) as void                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Grabarencombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function guardardatasession() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Guardardatasession', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function itemadviertestockdisponible() as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Itemadviertestockdisponible', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function itemcontrolastockdisponible() as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Itemcontrolastockdisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneracumuladoarticulo() as integer                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obteneracumuladoarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneracumuladocombinacion( toitem as object ) as integer                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obteneracumuladocombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obteneracumuladocombinacionseniacancelada( toitem as object ) as integer                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obteneracumuladocombinacionseniacancelada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercampodescripcionfw( toentidad as object ) as string                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercampodescripcionfw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercampopk( toentidad as object, tcatributodetalle as string ) as string                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercampopk', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercamposinsert( ) as string                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercamposinsert', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposselect( toentidad as object, tcatributodetalle as string ) as string                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercamposselect', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposselectstockcombinacion() as string                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercamposselectstockcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercamposvaluesinsert( toentidad as object, tcatributodetalle as string, tlinvertirsigno as boolean ) as string                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenercamposvaluesinsert', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercantidadacontemplarsiestamodificandocomprobante( toitem as object, tcestadodestock as string ) as integer                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercantidadacontemplarsiestamodificandocomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercantidadausarcomprometida( toitem as object, tcestadodestock as string ) as integer                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenercantidadausarcomprometida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercantidaditem( toitem, tlestavalidandominimoderesposicion as boolean ) as integer                                                                                                                                                
		...
		lnParametros = pcount()
		lxParam1 = toitem
		lxParam2 = tlestavalidandominimoderesposicion
		...
		return this.ObtenerResultado( 'Obtenercantidaditem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercantidaditemseniacancelada( toitem ) as integer                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercantidaditemseniacancelada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercantidadoriginaldecombinacion( toitem as object ) as number                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercantidadoriginaldecombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercantidadtotaldeitem( toitem as object ) as integer                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercantidadtotaldeitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercomportamientodelarticulo( tcarticulo as string ) as integer                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercomportamientodelarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdisponibilidad( tcatributo as string, toitem as object ) as integer                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerdisponibilidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdisponibilidaddeitem( tcatributo as string, toitem as object ) as integer                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerdisponibilidaddeitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerdisponibilidadparaminimodereposicion( toitem as object ) as float                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerdisponibilidadparaminimodereposicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function prepararxmlcombinacion( toentidad  as object ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Prepararxmlcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function prepararxmlgenerico( tccursor as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Prepararxmlgenerico', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function redefinircantidadesportipodeentrega( toentidad as object, tccursorcombinacion as string ) as void                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toentidad
		lxParam2 = tccursorcombinacion
		...
		return this.ObtenerResultado( 'Redefinircantidadesportipodeentrega', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function restastockactualdelinicial( tostockinicial as object, tocolstockagrabar as zoocoleccion of zoocoleccion.prg ) as zoocoleccion of zoocoleccion.prg                                                                                      
		...
		lnParametros = pcount()
		lxParam1 = tostockinicial
		lxParam2 = tocolstockagrabar
		...
		return this.ObtenerResultado( 'Restastockactualdelinicial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function restaurardatasession() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Restaurardatasession', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function seteardatasession( tndatasessionid as integer ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Seteardatasession', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validagenerastock() as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validagenerastock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validardisponibilidad( toitem as object ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validardisponibilidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificarexistenciaarticulo( tcarticulo as string ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Verificarexistenciaarticulo', lcParametros )
	EndFunc
