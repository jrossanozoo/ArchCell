...
define class Mock_Itemarqueodecajadetalletotalporgrupo as MockBase of MockBase.prg

	cClase = 'Itemarqueodecajadetalletotalporgrupo'
	...
	*-----------------------------------------------------------------------------------------
	function agrupa_assign( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Agrupa_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agrupadesc_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Agrupadesc_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function arqueado_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Arqueado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function arqueadoefec_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Arqueadoefec_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function arqueadootros_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Arqueadootros_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function difgrupo_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Difgrupo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_agrupa( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_agrupa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_agrupadesc( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_agrupadesc', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_arqueado( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_arqueado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_arqueadoefec( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_arqueadoefec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_arqueadootros( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_arqueadootros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_difgrupo( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_difgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalgrupo( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_totalgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalgrupo_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Totalgrupo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_agrupa( txval as variant ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_agrupa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_agrupadesc( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_agrupadesc', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_arqueado( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_arqueado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_arqueadoefec( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_arqueadoefec', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_arqueadootros( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_arqueadootros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_difgrupo( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_difgrupo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalgrupo( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_totalgrupo', lcParametros )
	EndFunc
