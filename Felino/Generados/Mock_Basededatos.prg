...
define class Mock_basededatos as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function archivar() as void                                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Archivar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiarcolorbarraestado() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Cambiarcolorbarraestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarinformaciondebasededatos() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cargarinformaciondebasededatos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function codigo_assign( txval ) as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'codigo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'codigo_assign', lcParametros )			endif		endif		dodefault( alltrim( txval ) )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function color_assign( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'color_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'color_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Color		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Color( lxVal )				this.Setear_Color( lxVal )			EndIf		Else			This.Setear_Color( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminarbasededatossqlserver() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Eliminarbasededatossqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esservidorsqlwindows() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Esservidorsqlwindows', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntararchivar() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eventopreguntararchivar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarseleccionararchivada( tolistaarchivadas as object ) as void                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Eventopreguntarseleccionararchivada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoseleccionararchivada( tolistaarchivadas as object ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eventoseleccionararchivada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechalog_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechalog_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechalog_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechalog		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechalog( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Fechalog( lxVal )			EndIf		Else			This.Setear_Fechalog( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function informarestadisticasapi() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Informarestadisticasapi', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function informastock_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'informastock_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'informastock_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Informastock		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Informastock( lxVal )				this.Setear_Informastock( lxVal )			EndIf		Else			This.Setear_Informastock( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerrutabackupdefault() as string                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerrutabackupdefault', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oseguridad_access() as void                                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oseguridad_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oseguridad_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oSeguridad ) = 'O' or isnull( this.oSeguridad ) )			this.oSeguridad = goServicios.seguridad		endif		return this.oSeguridad
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function replica_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'replica_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'replica_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Replica		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Replica( lxVal )				this.Setear_Replica( lxVal )			EndIf		Else			This.Setear_Replica( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ruta_assign( txval as variant ) as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ruta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ruta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ruta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ruta( lxVal )				this.Setear_Ruta( lxVal )			EndIf		Else			This.Setear_Ruta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function rutamdf_despuesdeasignar( tx1, tx2, tx3, tx4 ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Rutamdf_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_conectada( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_conectada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_conectada', lcParametros )			endif		endif		this.Conectada = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechalog( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechalog', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechalog', lcParametros )			endif		endif		this.Fechalog = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idbasededatos( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_idbasededatos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_idbasededatos', lcParametros )			endif		endif		this.Idbasededatos = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_informastock( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_informastock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_informastock', lcParametros )			endif		endif		this.Informastock = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_preferente( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_preferente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_preferente', lcParametros )			endif		endif		this.Preferente = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_procesapaquetes( txvariant as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvariantlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_procesapaquetes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_procesapaquetes', lcParametros )			endif		endif		if this.Replica and txVariant			this.oMensaje.Advertir( "La Base de Datos <es una Replica>, no se puede habilitar como Procesadora de paquete de datos")		else			dodefault(txVariant)		endif
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_realizabackup( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_realizabackup', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_realizabackup', lcParametros )			endif		endif		this.Realizabackup = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_replica( txvariant as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvariantlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_replica', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_replica', lcParametros )			endif		endif		local llEstado as Boolean		dodefault(txVariant)		if this.Replica && override si estan seteados			this.ForzarDeshabilitar( "ProcesaPaquetes" )			this.ForzarDeshabilitar( "Realizabackup" )		endif
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_ruta( txval as variant ) as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ruta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ruta', lcParametros )			endif		endif		this.Ruta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_rutacompleta( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rutacompleta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rutacompleta', lcParametros )			endif		endif		this.Rutacompleta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_rutamdf( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rutamdf', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rutamdf', lcParametros )			endif		endif		this.Rutamdf = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_validarsaluddelabase( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_validarsaluddelabase', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_validarsaluddelabase', lcParametros )			endif		endif		this.Validarsaluddelabase = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearconectadaznube() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setearconectadaznube', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearguid( tcguid as string ) as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setearguid', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearsucpreferente() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setearsucpreferente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearsucprocesadoradepaquetesdedatos() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setearsucprocesadoradepaquetesdedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function unidad_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'unidad_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'unidad_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Unidad		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Unidad( lxVal )				this.Setear_Unidad( lxVal )			EndIf		Else			This.Setear_Unidad( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_conectada( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_conectada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_conectada', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechalog( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechalog', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechalog', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idbasededatos( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idbasededatos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idbasededatos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_informastock( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_informastock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_informastock', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_preferente( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_preferente', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_preferente', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_procesapaquetes( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_procesapaquetes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_procesapaquetes', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_realizabackup( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_realizabackup', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_realizabackup', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_replica( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_replica', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_replica', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_ruta( txval as variant ) as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ruta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ruta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_rutacompleta( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rutacompleta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rutacompleta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_rutamdf( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rutamdf', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rutamdf', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_validarsaluddelabase( txval as variant ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_validarsaluddelabase', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_validarsaluddelabase', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarrutacompleta() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarrutacompleta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarsaluddelabase_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'BASEDEDATOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validarsaluddelabase_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validarsaluddelabase_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Validarsaluddelabase		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Validarsaluddelabase( lxVal )				this.Setear_Validarsaluddelabase( lxVal )			EndIf		Else			This.Setear_Validarsaluddelabase( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoconectada() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridoconectada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwconectada() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridofwconectada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwrutacompleta() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwrutacompleta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopreferente() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridopreferente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprocesapaquetes() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoprocesapaquetes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorealizabackup() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridorealizabackup', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorutacompleta() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridorutacompleta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorutamdf() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridorutamdf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarrecuperarbasededatosarchivadas( togestor as object, tolistaarchivadas as object ) as integer                                                                                                                                            
		...
		return this.ObtenerResultado( 'Verificarrecuperarbasededatosarchivadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarparametros() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Actualizarparametros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarrutacompleta() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Cargarrutacompleta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function configurarinformastock() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Configurarinformastock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function creardb( tlvengodeguardarcomobaseenlinux as boolean ) as void                                                                                                                                                                          
		...
		lnParametros = pcount()
		lxParam1 = tlvengodeguardarcomobaseenlinux
		...
		return this.ObtenerResultado( 'Creardb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debevalidarrutabackupsql() as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Debevalidarrutabackupsql', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function debevalidarrutamdf() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Debevalidarrutamdf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminarbd( tccodigo as string ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Eliminarbd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function forzardeshabilitar( tcpropiedad as string ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Forzardeshabilitar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarreplica() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Generarreplica', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerparametrossucursal() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerparametrossucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function puedemodificaratributoconectada() as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Puedemodificaratributoconectada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reasignaratributosruta() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Reasignaratributosruta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function refrescardespuesdeeliminar() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Refrescardespuesdeeliminar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function seteosseguncodigodebd() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Seteosseguncodigodebd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcrearbdtiporeplica() as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validarcrearbdtiporeplica', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarexistenciarutaenservidordesqlserver( tcruta as string ) as boolean                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarexistenciarutaenservidordesqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarrutaenservidordesqlserver( tcruta as string ) as boolean                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarrutaenservidordesqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarexistenciasdebases( togestor as object, tcbase as string ) as integer                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Verificarexistenciasdebases', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarorigendestino( tcorigendestino as string ) as void                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Verificarorigendestino', lcParametros )
	EndFunc
