...
define class Mock_Detallecondiciondepagopagospersonalizados as MockBase of MockBase.prg

	cClase = 'Detallecondiciondepagopagospersonalizados'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_porcentajedelcomprobante() as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Eventocambiosum_porcentajedelcomprobante', lcParametros )
	EndFunc
