...
define class Mock_NUMERACIONES as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function agregartalonario( tcatributo as string )                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Agregartalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignaratributoscai( tcatributonumero as string, tcatributofechacai as string ) as void                                                                                                                                                          
		...
		lnParametros = pcount()
		lxParam1 = tcatributonumero
		lxParam2 = tcatributofechacai
		...
		return this.ObtenerResultado( 'Asignaratributoscai', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buscarultimonumeroexistenteenentidad( tcentidad as string, tcpuntodeventa as string ) as integer                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Buscarultimonumeroexistenteenentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargartalonario( tcatributo as string, tctalonario as string ) as void                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Cargartalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function deberenumerarporvenirdeherecom() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Deberenumerarporvenirdeherecom', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoantesdegrabarnuevonumerodetalonario() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eventoantesdegrabarnuevonumerodetalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function grabartalonario( tcatributo as string, tleliminando as boolean ) as integer                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Grabartalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function liberarentidad() as void                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Liberarentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributonumerador( tcentidad as string ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obteneratributonumerador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneritementidad()                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obteneritementidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneritemtalonario()                                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obteneritemtalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernumero( tcatributo as string, tleliminando as boolean, tlnumeroreal as boolean ) as integer                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenernumero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernumerodesdeservicio( tcservicio as string, tlnumeroreal as boolean ) as integer                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenernumerodesdeservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerpuntodeventaunicoporentidaddesdetalonario() as integer                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerpuntodeventaunicoporentidaddesdetalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerservicio( tcatributo as string ) as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerserviciosegunentidad( tcentidad as string, tcatributo as string ) as string                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerserviciosegunentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersipuedereservar( tcentidad as string, tcatributo as string ) as boolean                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenersipuedereservar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocai_access()                                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Ocai_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function otalonario_access()                                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Otalonario_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearnombreentidad( tcentidad as string )                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setearnombreentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function talonarioconnumeraciondisponible() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Talonarioconnumeraciondisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ultimonumero( tcatributo as string ) as integer                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Ultimonumero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function vaciarcolecciones() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Vaciarcolecciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardisponibilidadservicio( tcservicio as string ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validardisponibilidadservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciaentidadatributo( tcentidadatributo ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarexistenciaentidadatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarreservadenumeros( tcatributo as string ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validarreservadenumeros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcolecciondeentidadesparacomprobanteselectronicosdecredito( tcentidad as string) as void                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Verificarcolecciondeentidadesparacomprobanteselectronicosdecredito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarentidadcargada( tcentidad ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Verificarentidadcargada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizartalonario( tlnuevo as boolean, tctalonario as string, tcatributo as string, tnnumero as integer, tleliminando as boolean ) as void                                                                                           
		...
		return this.ObtenerResultado( 'Actualizartalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function buscarfaltantenumeraciones( tcatributo as string) as integer                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Buscarfaltantenumeraciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function buscarnumeracionesexistentes( tcatributo as string) as integer                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Buscarnumeracionesexistentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function elatributocontalonarioesclaveprimaria( tcatributo as string ) as boolean                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Elatributocontalonarioesclaveprimaria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esnumeracionprincipal( tcatributo as string ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Esnumeracionprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function evaluarcondicion( tccondicion as string ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Evaluarcondicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function grabarentidadtalonario( tctalonario as string, tcatributo as string, tleliminando as boolean ) as void                                                                                                                                 
		...
		return this.ObtenerResultado( 'Grabarentidadtalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdescripciondeentidadparaerror( tcentidad as string ) as string                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerdescripciondeentidadparaerror', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerproximonumeroagrabar( tlnumeroagrabar as integer, tctalonario as string, tcatributo as string, tleliminando as boolean ) as number                                                                                              
		...
		lnParametros = pcount()
		lxParam1 = tlnumeroagrabar
		lxParam2 = tctalonario
		lxParam3 = tcatributo
		lxParam4 = tleliminando
		...
		return this.ObtenerResultado( 'Obtenerproximonumeroagrabar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenertalonarioentidad( tcatributo as string ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenertalonarioentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerultimonumerotalonario( tctalonario as string ) as integer                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerultimonumerotalonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearatributosrelacionados( tcatributo as string) as void                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setearatributosrelacionados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarrenumerar( tcatributo as string ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Verificarrenumerar', lcParametros )
	EndFunc
