...
define class Mock_cajaauditoria as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function asignarid() as void                                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Asignarid', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallevaloresauditoria() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallevaloresauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montototal_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAAUDITORIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'montototal_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'montototal_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Montototal		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Montototal( lxVal )				this.Setear_Montototal( lxVal )			EndIf		Else			This.Setear_Montototal( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montototal( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAAUDITORIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_montototal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_montototal', lcParametros )			endif		endif		this.Montototal = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montototal( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAJAAUDITORIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_montototal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_montototal', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwid() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridofwid', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwmontototal() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwmontototal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwtarea() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwtarea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoid() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridoid', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomontototal() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridomontototal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotarea() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridotarea', lcParametros )
	EndFunc
