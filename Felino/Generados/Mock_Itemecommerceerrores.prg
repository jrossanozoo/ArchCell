...
define class Mock_Itemecommerceerrores as MockBase of MockBase.prg

	cClase = 'Itemecommerceerrores'
	...
	*-----------------------------------------------------------------------------------------
	function opeerror_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Opeerror_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_opeerror( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_opeerror', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_opeerror( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_opeerror', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoopeerror() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoopeerror', lcParametros )
	EndFunc
