...
define class Din_EntidadZUDESCARGALANAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRutalanFecexpo, lxRutalanFmodifw, lxRutalanFaltafw, lxRutalanFectrans, lxRutalanFecimpo, lxRutalanCodigo, lxRutalanUaltafw, lxRutalanSaltafw, lxRutalanSmodifw, lxRutalanUmodifw, lxRutalanZadsfw, lxRutalanValtafw, lxRutalanVmodifw, lxRutalanHmodifw, lxRutalanHaltafw, lxRutalanHoraimpo, lxRutalanBdmodifw, lxRutalanBdaltafw, lxRutalanEsttrans, lxRutalanHoraexpo, lxRutalanClobs, lxRutalanCversion, lxRutalanUsuario, lxRutalanFecha, lxRutalanSerie, lxRutalanArchivo, lxRutalanPublicada
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.RUTALAN ( "Fecexpo","Fmodifw","Faltafw","Fectrans","Fecimpo","Codigo","Ualtafw","Saltafw","Smodifw","Umodifw","Zadsfw","Valtafw","Vmodifw","Hmodifw","Haltafw","Horaimpo","Bdmodifw","Bdaltafw","Esttrans","Horaexpo","Clobs","Cversion","Usuario","Fecha","Serie","Archivo","Publicada" ) values ( <<"'" + this.ConvertirDateSql( lxRutalanFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRutalanFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRutalanFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRutalanFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRutalanFecimpo ) + "'" >>, <<lxRutalanCodigo >>, <<"'" + this.FormatearTextoSql( lxRutalanUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanClobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanCversion ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanUsuario ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRutalanFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanSerie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRutalanArchivo ) + "'" >>, <<iif( lxRutalanPublicada, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.RUTALAN set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxRutalanFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxRutalanFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRutalanFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRutalanFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxRutalanFecimpo ) + "'">>,"Codigo" = <<lxRutalanCodigo>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRutalanUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRutalanSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRutalanSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRutalanUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRutalanZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRutalanValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRutalanVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRutalanHmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRutalanHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRutalanHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRutalanBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRutalanBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRutalanEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRutalanHoraexpo ) + "'">>,"Clobs" = <<"'" + this.FormatearTextoSql( lxRutalanClobs ) + "'">>,"Cversion" = <<"'" + this.FormatearTextoSql( lxRutalanCversion ) + "'">>,"Usuario" = <<"'" + this.FormatearTextoSql( lxRutalanUsuario ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxRutalanFecha ) + "'">>,"Serie" = <<"'" + this.FormatearTextoSql( lxRutalanSerie ) + "'">>,"Archivo" = <<"'" + this.FormatearTextoSql( lxRutalanArchivo ) + "'">>,"Publicada" = <<iif( lxRutalanPublicada, 1, 0 )>> where "Codigo" = <<lxRutalanCodigo>> and  RUTALAN.CODIGO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fmodifw,Faltafw,Fectrans,Fecimpo,Codigo,Ualtafw,Saltafw,Smodifw,Umodifw,Zadsfw,Valta" + ;
"fw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Clobs,Cversion,Usuario,Fecha" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.RUTALAN set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, Codigo = ] + transform( &lcCursor..Codigo )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, CLOBS = ] + "'" + this.FormatearTextoSql( &lcCursor..CLOBS ) + "'"+ [, CVERSION = ] + "'" + this.FormatearTextoSql( &lcCursor..CVERSION ) + "'"+ [, usuario = ] + "'" + this.FormatearTextoSql( &lcCursor..usuario ) + "'"+ [, fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..fecha ) + "'"+ [, Serie = ] + "'" + this.FormatearTextoSql( &lcCursor..Serie ) + "'"+ [, Archivo = ] + "'" + this.FormatearTextoSql( &lcCursor..Archivo ) + "'"+ [, publicada = ] + Transform( iif( &lcCursor..publicada, 1, 0 )) + [ Where Codigo = ] + transform( lcValorABuscar ) )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FMODIFW, FALTAFW, FECTRANS, FECIMPO, Codigo, UALTAFW, SALTAFW, SMODIFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HMODIFW, HALTAFW, HORAIMPO, BDMODIFW, BDALTAFW, ESTTRANS, HORAEXPO, CLOBS, CVERSION, usuario, fecha, Serie, Archivo, publicada
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + transform( &lcCursor..Codigo ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CLOBS ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CLOBS = isnull( d.CLOBS, t.CLOBS ),t.CVERSION = isnull( d.CVERSION, t.CVERSION ),t.USUARIO = isnull( d.USUARIO, t.USUARIO ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.SERIE = isnull( d.SERIE, t.SERIE ),t.ARCHIVO = isnull( d.ARCHIVO, t.ARCHIVO ),t.PUBLICADA = isnull( d.PUBLICADA, t.PUBLICADA )
					from ORGANIZACION.RUTALAN t inner join deleted d 
							 on t.Codigo = d.Codigo
							 and  t.CVERSION = d.CVERSION
				-- Fin Updates
				insert into ORGANIZACION.RUTALAN(Fecexpo,Fmodifw,Faltafw,Fectrans,Fecimpo,Codigo,Ualtafw,Saltafw,Smodifw,Umodifw,Zadsfw,Valtafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Clobs,Cversion,Usuario,Fecha,Serie,Archivo,Publicada)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.CODIGO,0),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.CLOBS,''),isnull( d.CVERSION,''),isnull( d.USUARIO,''),isnull( d.FECHA,''),isnull( d.SERIE,''),isnull( d.ARCHIVO,''),isnull( d.PUBLICADA,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="ZUDESCARGALAN                           " atributo="FECHATRANSFERENCIA                      " tabla="RUTALAN        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ZUDESCARGALAN                           " atributo="CODIGO                                  " tabla="RUTALAN        " campo="CODIGO    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="9" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="1" etiqueta="Código                                                                                                                                                          " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ZUDESCARGALAN                           " atributo="ESTADOTRANSFERENCIA                     " tabla="RUTALAN        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
