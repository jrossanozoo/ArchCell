...
define class Din_EntidadCUENTABANCARIAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCtabanFecimpo, lxCtabanFectrans, lxCtabanFmodifw, lxCtabanFecexpo, lxCtabanFaltafw, lxCtabanTimestamp, lxCtabanUmodifw, lxCtabanHoraexpo, lxCtabanHoraimpo, lxCtabanSaltafw, lxCtabanUaltafw, lxCtabanSmodifw, lxCtabanHaltafw, lxCtabanHmodifw, lxCtabanBdaltafw, lxCtabanEsttrans, lxCtabanBdmodifw, lxCtabanValtafw, lxCtabanZadsfw, lxCtabanVmodifw, lxCtabanCbcod, lxCtabanCbdes, lxCtabanCbsucban, lxCtabanCbnum, lxCtabanCbcbu, lxCtabanCbmoneda, lxCtabanCbacuerdo, lxCtabanCbcuit, lxCtabanCbrazsoc, lxCtabanCbdir, lxCtabanCbfirma, lxCtabanCbobs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CTABAN ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Timestamp","Umodifw","Horaexpo","Horaimpo","Saltafw","Ualtafw","Smodifw","Haltafw","Hmodifw","Bdaltafw","Esttrans","Bdmodifw","Valtafw","Zadsfw","Vmodifw","Cbcod","Cbdes","Cbsucban","Cbnum","Cbcbu","Cbmoneda","Cbacuerdo","Cbcuit","Cbrazsoc","Cbdir","Cbfirma","Cbobs" ) values ( <<"'" + this.ConvertirDateSql( lxCtabanFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtabanFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtabanFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtabanFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtabanFaltafw ) + "'" >>, <<lxCtabanTimestamp >>, <<"'" + this.FormatearTextoSql( lxCtabanUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbdes ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbsucban ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbnum ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbcbu ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbmoneda ) + "'" >>, <<lxCtabanCbacuerdo >>, <<"'" + this.FormatearTextoSql( lxCtabanCbcuit ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbrazsoc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbdir ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbfirma ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtabanCbobs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CTABAN set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCtabanFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCtabanFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCtabanFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCtabanFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCtabanFaltafw ) + "'">>,"Timestamp" = <<lxCtabanTimestamp>>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCtabanUmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCtabanHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCtabanHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCtabanSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCtabanUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCtabanSmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCtabanHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCtabanHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCtabanBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCtabanEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCtabanBdmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCtabanValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCtabanZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCtabanVmodifw ) + "'">>,"Cbcod" = <<"'" + this.FormatearTextoSql( lxCtabanCbcod ) + "'">>,"Cbdes" = <<"'" + this.FormatearTextoSql( lxCtabanCbdes ) + "'">>,"Cbsucban" = <<"'" + this.FormatearTextoSql( lxCtabanCbsucban ) + "'">>,"Cbnum" = <<"'" + this.FormatearTextoSql( lxCtabanCbnum ) + "'">>,"Cbcbu" = <<"'" + this.FormatearTextoSql( lxCtabanCbcbu ) + "'">>,"Cbmoneda" = <<"'" + this.FormatearTextoSql( lxCtabanCbmoneda ) + "'">>,"Cbacuerdo" = <<lxCtabanCbacuerdo>>,"Cbcuit" = <<"'" + this.FormatearTextoSql( lxCtabanCbcuit ) + "'">>,"Cbrazsoc" = <<"'" + this.FormatearTextoSql( lxCtabanCbrazsoc ) + "'">>,"Cbdir" = <<"'" + this.FormatearTextoSql( lxCtabanCbdir ) + "'">>,"Cbfirma" = <<"'" + this.FormatearTextoSql( lxCtabanCbfirma ) + "'">>,"Cbobs" = <<"'" + this.FormatearTextoSql( lxCtabanCbobs ) + "'">> where "Cbcod" = <<"'" + this.FormatearTextoSql( lxCtabanCbcod ) + "'">> and  CTABAN.CBCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Cbcod" as "Codigo", "Cbdes" as "Descripcion", "Cbsucban" as "Sucursalbancaria", "Cbnum" as "Numero", "Cbcbu" as "Cbu", "Cbmoneda" as "Monedacuenta", "Cbacuerdo" as "Acuerdo", "Cbcuit" as "Codigotributariolibrador", "Cbrazsoc" as "Razonsociallibrador", "Cbdir" as "Direccion", "Cbfirma" as "Firmantes", "Cbobs" as "Observacion" from ZooLogic.CTABAN where "Cbcod" = <<"'" + this.FormatearTextoSql( lxCtabanCbcod ) + "'">> and  CTABAN.CBCOD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Umodifw,Horaexpo,Horaimpo,Saltafw,Ualtafw" + ;
",Smodifw,Haltafw,Hmodifw,Bdaltafw,Esttrans,Bdmodifw,Valtafw,Zadsfw,Vmodifw,Cbcod,Cbdes,Cbsucban,Cbnu" + ;
"m,Cbcbu,Cbmoneda,Cbacuerdo,Cbcuit,Cbrazsoc,Cbdir,Cbfirma,Cbobs" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CTABAN set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, CBCod = ] + "'" + this.FormatearTextoSql( &lcCursor..CBCod ) + "'"+ [, CBDes = ] + "'" + this.FormatearTextoSql( &lcCursor..CBDes ) + "'"+ [, CBSucBan = ] + "'" + this.FormatearTextoSql( &lcCursor..CBSucBan ) + "'"+ [, CBNum = ] + "'" + this.FormatearTextoSql( &lcCursor..CBNum ) + "'"+ [, CBCBU = ] + "'" + this.FormatearTextoSql( &lcCursor..CBCBU ) + "'"+ [, CBMoneda = ] + "'" + this.FormatearTextoSql( &lcCursor..CBMoneda ) + "'"+ [, CBAcuerdo = ] + transform( &lcCursor..CBAcuerdo )+ [, CBCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..CBCuit ) + "'"+ [, CBRazSoc = ] + "'" + this.FormatearTextoSql( &lcCursor..CBRazSoc ) + "'"+ [, CBDir = ] + "'" + this.FormatearTextoSql( &lcCursor..CBDir ) + "'"+ [, CBFirma = ] + "'" + this.FormatearTextoSql( &lcCursor..CBFirma ) + "'"+ [, CBObs = ] + "'" + this.FormatearTextoSql( &lcCursor..CBObs ) + "'" + [ Where CBCod = ] + "'" + this.FormatearTextoSql( &lcCursor..CBCod ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, TIMESTAMP, UMODIFW, HORAEXPO, HORAIMPO, SALTAFW, UALTAFW, SMODIFW, HALTAFW, HMODIFW, BDALTAFW, ESTTRANS, BDMODIFW, VALTAFW, ZADSFW, VMODIFW, CBCod, CBDes, CBSucBan, CBNum, CBCBU, CBMoneda, CBAcuerdo, CBCuit, CBRazSoc, CBDir, CBFirma, CBObs
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBCod ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBDes ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBSucBan ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBNum ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBCBU ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBMoneda ) + "'" + ',' + transform( &lcCursor..CBAcuerdo ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBCuit ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBRazSoc ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBDir ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBFirma ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CBObs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.CBCOD = isnull( d.CBCOD, t.CBCOD ),t.CBDES = isnull( d.CBDES, t.CBDES ),t.CBSUCBAN = isnull( d.CBSUCBAN, t.CBSUCBAN ),t.CBNUM = isnull( d.CBNUM, t.CBNUM ),t.CBCBU = isnull( d.CBCBU, t.CBCBU ),t.CBMONEDA = isnull( d.CBMONEDA, t.CBMONEDA ),t.CBACUERDO = isnull( d.CBACUERDO, t.CBACUERDO ),t.CBCUIT = isnull( d.CBCUIT, t.CBCUIT ),t.CBRAZSOC = isnull( d.CBRAZSOC, t.CBRAZSOC ),t.CBDIR = isnull( d.CBDIR, t.CBDIR ),t.CBFIRMA = isnull( d.CBFIRMA, t.CBFIRMA ),t.CBOBS = isnull( d.CBOBS, t.CBOBS )
					from ZooLogic.CTABAN t inner join deleted d 
							 on t.CBCod = d.CBCod
				-- Fin Updates
				insert into ZooLogic.CTABAN(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Umodifw,Horaexpo,Horaimpo,Saltafw,Ualtafw,Smodifw,Haltafw,Hmodifw,Bdaltafw,Esttrans,Bdmodifw,Valtafw,Zadsfw,Vmodifw,Cbcod,Cbdes,Cbsucban,Cbnum,Cbcbu,Cbmoneda,Cbacuerdo,Cbcuit,Cbrazsoc,Cbdir,Cbfirma,Cbobs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.TIMESTAMP,0),isnull( d.UMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.CBCOD,''),isnull( d.CBDES,''),isnull( d.CBSUCBAN,''),isnull( d.CBNUM,''),isnull( d.CBCBU,''),isnull( d.CBMONEDA,''),isnull( d.CBACUERDO,0),isnull( d.CBCUIT,''),isnull( d.CBRAZSOC,''),isnull( d.CBDIR,''),isnull( d.CBFIRMA,''),isnull( d.CBOBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CUENTABANCARIA                          " atributo="FECHATRANSFERENCIA                      " tabla="CTABAN         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CUENTABANCARIA                          " atributo="ESTADOTRANSFERENCIA                     " tabla="CTABAN         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CUENTABANCARIA                          " atributo="NUMERO                                  " tabla="CTABAN         " campo="CBNUM     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Número de cuenta bancaria                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
