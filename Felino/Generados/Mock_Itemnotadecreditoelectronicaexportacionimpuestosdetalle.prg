...
define class Mock_Itemnotadecreditoelectronicaexportacionimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditoelectronicaexportacionimpuestosdetalle'
