...
define class Mock_Detallenotadedebitodeexportacionimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Detallenotadedebitodeexportacionimpuestoscomprobante'
