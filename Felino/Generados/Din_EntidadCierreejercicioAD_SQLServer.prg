	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CIERREEJ ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Timestamp","Smodifw","Saltafw","Umodifw","Ualtafw","Zadsfw","Valtafw","Vmodifw","Hmodifw","Haltafw","Horaimpo","Bdaltafw","Bdmodifw","Esttrans","Horaexpo","Eobs","Numero","Descrip","Ejercicio","Asieninclu","Ajuinfla","Indiceinf","Cuentaajus","Resultado","Pcuenta","Patrimonia","Fechaas" ) values ( <<"'" + this.ConvertirDateSql( lxCierreejFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCierreejFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCierreejFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCierreejFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCierreejFaltafw ) + "'" >>, <<lxCierreejTimestamp >>, <<"'" + this.FormatearTextoSql( lxCierreejSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejEobs ) + "'" >>, <<lxCierreejNumero >>, <<"'" + this.FormatearTextoSql( lxCierreejDescrip ) + "'" >>, <<lxCierreejEjercicio >>, <<lxCierreejAsieninclu >>, <<iif( lxCierreejAjuinfla, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxCierreejIndiceinf ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCierreejCuentaajus ) + "'" >>, <<iif( lxCierreejResultado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxCierreejPcuenta ) + "'" >>, <<iif( lxCierreejPatrimonia, 1, 0 ) >>, <<"'" + this.ConvertirDateSql( lxCierreejFechaas ) + "'" >> )
			endtext
		...
		this.oEntidad.Timestamp = lxCierreejTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CIERREEJ set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCierreejFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCierreejFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCierreejFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCierreejFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCierreejFaltafw ) + "'">>,"Timestamp" = <<lxCierreejTimestamp>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCierreejSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCierreejSaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCierreejUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCierreejUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCierreejZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCierreejValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCierreejVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCierreejHmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCierreejHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCierreejHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCierreejBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCierreejBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCierreejEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCierreejHoraexpo ) + "'">>,"Eobs" = <<"'" + this.FormatearTextoSql( lxCierreejEobs ) + "'">>,"Numero" = <<lxCierreejNumero>>,"Descrip" = <<"'" + this.FormatearTextoSql( lxCierreejDescrip ) + "'">>,"Ejercicio" = <<lxCierreejEjercicio>>,"Asieninclu" = <<lxCierreejAsieninclu>>,"Ajuinfla" = <<iif( lxCierreejAjuinfla, 1, 0 )>>,"Indiceinf" = <<"'" + this.FormatearTextoSql( lxCierreejIndiceinf ) + "'">>,"Cuentaajus" = <<"'" + this.FormatearTextoSql( lxCierreejCuentaajus ) + "'">>,"Resultado" = <<iif( lxCierreejResultado, 1, 0 )>>,"Pcuenta" = <<"'" + this.FormatearTextoSql( lxCierreejPcuenta ) + "'">>,"Patrimonia" = <<iif( lxCierreejPatrimonia, 1, 0 )>>,"Fechaas" = <<"'" + this.ConvertirDateSql( lxCierreejFechaas ) + "'">> where "Numero" = <<lxCierreejNumero>> and  CIERREEJ.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Numero" as "Numero", "Descrip" as "Descripcion", "Ejercicio" as "Ejercicio", "Asieninclu" as "Tiposdeasientosincluidos", "Ajuinfla" as "Asientoajusteporinflacion", "Indiceinf" as "Indice", "Cuentaajus" as "Cuentabancaria", "Resultado" as "Resultado", "Pcuenta" as "Plandecuentas", "Patrimonia" as "Patrimonial", "Fechaas" as "Fecha" from ZooLogic.CIERREEJ where  CIERREEJ.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_CIERREEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Numero" as "Numero", "Descrip" as "Descripcion", "Ejercicio" as "Ejercicio", "Asieninclu" as "Tiposdeasientosincluidos", "Ajuinfla" as "Asientoajusteporinflacion", "Indiceinf" as "Indice", "Cuentaajus" as "Cuentabancaria", "Resultado" as "Resultado", "Pcuenta" as "Plandecuentas", "Patrimonia" as "Patrimonial", "Fechaas" as "Fecha" from ZooLogic.CIERREEJ where  str( NUMERO, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CIERREEJ.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_CIERREEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Numero" as "Numero", "Descrip" as "Descripcion", "Ejercicio" as "Ejercicio", "Asieninclu" as "Tiposdeasientosincluidos", "Ajuinfla" as "Asientoajusteporinflacion", "Indiceinf" as "Indice", "Cuentaajus" as "Cuentabancaria", "Resultado" as "Resultado", "Pcuenta" as "Plandecuentas", "Patrimonia" as "Patrimonial", "Fechaas" as "Fecha" from ZooLogic.CIERREEJ where  str( NUMERO, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CIERREEJ.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_CIERREEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Numero" as "Numero", "Descrip" as "Descripcion", "Ejercicio" as "Ejercicio", "Asieninclu" as "Tiposdeasientosincluidos", "Ajuinfla" as "Asientoajusteporinflacion", "Indiceinf" as "Indice", "Cuentaajus" as "Cuentabancaria", "Resultado" as "Resultado", "Pcuenta" as "Plandecuentas", "Patrimonia" as "Patrimonial", "Fechaas" as "Fecha" from ZooLogic.CIERREEJ where  CIERREEJ.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_CIERREEJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREEJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Smodifw,Saltafw,Umodifw,Ualtafw,Zadsfw,Va" + ;
"ltafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Horaexpo,Eobs,Numero,Descrip,Ejerc" + ;
"icio,Asieninclu,Ajuinfla,Indiceinf,Cuentaajus,Resultado,Pcuenta,Patrimonia,Fechaas" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Numero" as "Numero", "Descrip" as "Descripcion", "Ejercicio" as "Ejercicio", "Asieninclu" as "Tiposdeasientosincluidos", "Ajuinfla" as "Asientoajusteporinflacion", "Indiceinf" as "Indice", "Cuentaajus" as "Cuentabancaria", "Resultado" as "Resultado", "Pcuenta" as "Plandecuentas", "Patrimonia" as "Patrimonial", "Fechaas" as "Fecha"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CIERREEJ set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, EOBS = ] + "'" + this.FormatearTextoSql( &lcCursor..EOBS ) + "'"+ [, NUMERO = ] + transform( &lcCursor..NUMERO )+ [, DESCRIP = ] + "'" + this.FormatearTextoSql( &lcCursor..DESCRIP ) + "'"+ [, EJERCICIO = ] + transform( &lcCursor..EJERCICIO )+ [, AsienInclu = ] + transform( &lcCursor..AsienInclu )+ [, AjuInfla = ] + Transform( iif( &lcCursor..AjuInfla, 1, 0 ))+ [, IndiceInf = ] + "'" + this.FormatearTextoSql( &lcCursor..IndiceInf ) + "'"+ [, CuentaAjus = ] + "'" + this.FormatearTextoSql( &lcCursor..CuentaAjus ) + "'"+ [, Resultado = ] + Transform( iif( &lcCursor..Resultado, 1, 0 ))+ [, PCUENTA = ] + "'" + this.FormatearTextoSql( &lcCursor..PCUENTA ) + "'"+ [, Patrimonia = ] + Transform( iif( &lcCursor..Patrimonia, 1, 0 ))+ [, FECHAAS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECHAAS ) + "'" + [ Where NUMERO = ] + transform( &lcCursor..NUMERO ) )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, TIMESTAMP, SMODIFW, SALTAFW, UMODIFW, UALTAFW, ZADSFW, VALTAFW, VMODIFW, HMODIFW, HALTAFW, HORAIMPO, BDALTAFW, BDMODIFW, ESTTRANS, HORAEXPO, EOBS, NUMERO, DESCRIP, EJERCICIO, AsienInclu, AjuInfla, IndiceInf, CuentaAjus, Resultado, PCUENTA, Patrimonia, FECHAAS
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..EOBS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..NUMERO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DESCRIP ) + "'" + ',' + transform( &lcCursor..EJERCICIO ) + ',' + transform( &lcCursor..AsienInclu ) + ',' + Transform( iif( &lcCursor..AjuInfla, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IndiceInf ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CuentaAjus ) + "'" + ',' + Transform( iif( &lcCursor..Resultado, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..PCUENTA ) + "'" + ',' + Transform( iif( &lcCursor..Patrimonia, 1, 0 )) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECHAAS ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.EOBS = isnull( d.EOBS, t.EOBS ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.EJERCICIO = isnull( d.EJERCICIO, t.EJERCICIO ),t.ASIENINCLU = isnull( d.ASIENINCLU, t.ASIENINCLU ),t.AJUINFLA = isnull( d.AJUINFLA, t.AJUINFLA ),t.INDICEINF = isnull( d.INDICEINF, t.INDICEINF ),t.CUENTAAJUS = isnull( d.CUENTAAJUS, t.CUENTAAJUS ),t.RESULTADO = isnull( d.RESULTADO, t.RESULTADO ),t.PCUENTA = isnull( d.PCUENTA, t.PCUENTA ),t.PATRIMONIA = isnull( d.PATRIMONIA, t.PATRIMONIA ),t.FECHAAS = isnull( d.FECHAAS, t.FECHAAS )
					from ZooLogic.CIERREEJ t inner join deleted d 
							 on t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.CIERREEJ(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Smodifw,Saltafw,Umodifw,Ualtafw,Zadsfw,Valtafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Horaexpo,Eobs,Numero,Descrip,Ejercicio,Asieninclu,Ajuinfla,Indiceinf,Cuentaajus,Resultado,Pcuenta,Patrimonia,Fechaas)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.EOBS,''),isnull( d.NUMERO,0),isnull( d.DESCRIP,''),isnull( d.EJERCICIO,0),isnull( d.ASIENINCLU,0),isnull( d.AJUINFLA,0),isnull( d.INDICEINF,''),isnull( d.CUENTAAJUS,''),isnull( d.RESULTADO,0),isnull( d.PCUENTA,''),isnull( d.PATRIMONIA,0),isnull( d.FECHAAS,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_CIERREEJERCICIO' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_CIERREEJERCICIO.Timestamp, 0 )
					...
					.Indice = nvl( c_CIERREEJERCICIO.Indice, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="CIERREEJERCICIO                         " atributo="INDICE                                  " tabla="CIERREEJ       " campo="INDICEINF " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Código de índice                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CIERREEJERCICIO                         " atributo="PLANDECUENTAS                           " tabla="CIERREEJ       " campo="PCUENTA   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PLANDECUENTAS                           " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Cuenta de refundición                                                                                                                                           " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; plancuenta.CTAIMPUT = .t. and plancuenta.CTAREFUND = 3 &quot;                                                                                                                                              " grupo="0" subgrupo="1" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CIERREEJERCICIO                         " atributo="PATRIMONIAL                             " tabla="CIERREEJ       " campo="PATRIMONIA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Asiento de cierre de cuentas patrimoniales                                                                                                                      " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
