...
define class Din_EntidadEMAILAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxMailFectrans, lxMailFecimpo, lxMailFmodifw, lxMailFaltafw, lxMailFecexpo, lxMailHaltafw, lxMailHoraexpo, lxMailSaltafw, lxMailHoraimpo, lxMailVmodifw, lxMailZadsfw, lxMailValtafw, lxMailUmodifw, lxMailSmodifw, lxMailUaltafw, lxMailHmodifw, lxMailEsttrans, lxMailBdaltafw, lxMailBdmodifw, lxMailCodigo, lxMailObs, lxMailTexto, lxMailDescr, lxMailEnvguar, lxMailServ, lxMailEnvio, lxMailMpara, lxMailMcc, lxMailMcco, lxMailAsunto
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.MAIL ( "Fectrans","Fecimpo","Fmodifw","Faltafw","Fecexpo","Haltafw","Horaexpo","Saltafw","Horaimpo","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Esttrans","Bdaltafw","Bdmodifw","Codigo","Obs","Texto","Descr","Envguar","Serv","Envio","Mpara","Mcc","Mcco","Asunto" ) values ( <<"'" + this.ConvertirDateSql( lxMailFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMailFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMailFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMailFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMailFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailTexto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailDescr ) + "'" >>, <<iif( lxMailEnvguar, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxMailServ ) + "'" >>, <<lxMailEnvio >>, <<"'" + this.FormatearTextoSql( lxMailMpara ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailMcc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailMcco ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMailAsunto ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.MAIL set "Fectrans" = <<"'" + this.ConvertirDateSql( lxMailFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxMailFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxMailFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxMailFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxMailFecexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxMailHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxMailHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxMailSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxMailHoraimpo ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxMailVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxMailZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxMailValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxMailUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxMailSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxMailUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxMailHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxMailEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxMailBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxMailBdmodifw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxMailCodigo ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxMailObs ) + "'">>,"Texto" = <<"'" + this.FormatearTextoSql( lxMailTexto ) + "'">>,"Descr" = <<"'" + this.FormatearTextoSql( lxMailDescr ) + "'">>,"Envguar" = <<iif( lxMailEnvguar, 1, 0 )>>,"Serv" = <<"'" + this.FormatearTextoSql( lxMailServ ) + "'">>,"Envio" = <<lxMailEnvio>>,"Mpara" = <<"'" + this.FormatearTextoSql( lxMailMpara ) + "'">>,"Mcc" = <<"'" + this.FormatearTextoSql( lxMailMcc ) + "'">>,"Mcco" = <<"'" + this.FormatearTextoSql( lxMailMcco ) + "'">>,"Asunto" = <<"'" + this.FormatearTextoSql( lxMailAsunto ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxMailCodigo ) + "'">> and  MAIL.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fecimpo,Fmodifw,Faltafw,Fecexpo,Haltafw,Horaexpo,Saltafw,Horaimpo,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdaltafw,Bdmodifw,Codigo,Obs,Texto,Descr,Envguar,Serv" + ;
",Envio,Mpara,Mcc,Mcco,Asunto" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FECIMPO, FMODIFW, FALTAFW, FECEXPO, HALTAFW, HORAEXPO, SALTAFW, HORAIMPO, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, ESTTRANS, BDALTAFW, BDMODIFW, codigo, obs, Texto, descr, envguar, serv, envio, mPara, mCC, mCCo, asunto
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..obs ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Texto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..descr ) + "'" + ',' + Transform( iif( &lcCursor..envguar, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..serv ) + "'" + ',' + transform( &lcCursor..envio ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..mPara ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..mCC ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..mCCo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..asunto ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.OBS = isnull( d.OBS, t.OBS ),t.TEXTO = isnull( d.TEXTO, t.TEXTO ),t.DESCR = isnull( d.DESCR, t.DESCR ),t.ENVGUAR = isnull( d.ENVGUAR, t.ENVGUAR ),t.SERV = isnull( d.SERV, t.SERV ),t.ENVIO = isnull( d.ENVIO, t.ENVIO ),t.MPARA = isnull( d.MPARA, t.MPARA ),t.MCC = isnull( d.MCC, t.MCC ),t.MCCO = isnull( d.MCCO, t.MCCO ),t.ASUNTO = isnull( d.ASUNTO, t.ASUNTO )
					from ZooLogic.MAIL t inner join deleted d 
							 on t.codigo = d.codigo
				-- Fin Updates
				insert into ZooLogic.MAIL(Fectrans,Fecimpo,Fmodifw,Faltafw,Fecexpo,Haltafw,Horaexpo,Saltafw,Horaimpo,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Esttrans,Bdaltafw,Bdmodifw,Codigo,Obs,Texto,Descr,Envguar,Serv,Envio,Mpara,Mcc,Mcco,Asunto)
					Select isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.CODIGO,''),isnull( d.OBS,''),isnull( d.TEXTO,''),isnull( d.DESCR,''),isnull( d.ENVGUAR,0),isnull( d.SERV,''),isnull( d.ENVIO,0),isnull( d.MPARA,''),isnull( d.MCC,''),isnull( d.MCCO,''),isnull( d.ASUNTO,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="EMAIL                                   " atributo="FECHATRANSFERENCIA                      " tabla="MAIL           " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EMAIL                                   " atributo="ESTADOTRANSFERENCIA                     " tabla="MAIL           " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EMAIL                                   " atributo="ENVIARALGUARDAR                         " tabla="MAIL           " campo="ENVGUAR   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Enviar al guardar                                                                                                                                               " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="20" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EMAIL                                   " atributo="SERVIDOR                                " tabla="MAIL           " campo="SERV      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CUENTACORREO                            " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="410" etiqueta="Cuenta                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EMAIL                                   " atributo="CONFIRMAENVIO                           " tabla="MAIL           " campo="ENVIO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Confirma envío                                                                                                                                                  " dominio="COMBOXML                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="20" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EMAIL                                   " atributo="ARCHIVOSDETALLE                         " tabla="MAILARCH       " campo="ARCCOD    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Adjuntos                                                                                                                                                        " dominio="DETALLEITEMARCHIVOSMAIL       " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="6" orden="20" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EMAIL                                   " atributo="MAILPARA                                " tabla="MAIL           " campo="MPARA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="200" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Para                                                                                                                                                            " dominio="MAILATRIBUTO                  " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="110" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EMAIL                                   " atributo="MAILCOPIA                               " tabla="MAIL           " campo="MCC       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="200" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Con copia                                                                                                                                                       " dominio="MAILATRIBUTO                  " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="120" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EMAIL                                   " atributo="MAILCOPIAOCULTA                         " tabla="MAIL           " campo="MCCO      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="200" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Con copia oculta                                                                                                                                                " dominio="MAILATRIBUTO                  " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="130" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="EMAIL                                   " atributo="ASUNTO                                  " tabla="MAIL           " campo="ASUNTO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="200" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Asunto                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="140" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CUENTACORREO                            " atributo="DESCRIPCION                             " tabla="CCORREO        " campo="DESCR     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="80" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="411" etiqueta="Detalle Cue.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CCORREO On MAIL.SERV = CCORREO.codigo And  CCORREO.CODIGO != ''                                                                                                                                                                                    " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
