...
define class Mock_Itemselechequeainsertardetallechequesainsertar as MockBase of MockBase.prg

	cClase = 'Itemselechequeainsertardetallechequesainsertar'
	...
	*-----------------------------------------------------------------------------------------
	function codigovalor_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Codigovalor_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function entidadfinancieradetalle_assign( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Entidadfinancieradetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechadepago_despuesdeasignar() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Fechadepago_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numeroint_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Numeroint_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seleccionado_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Seleccionado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigovalor( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_codigovalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_entidadfinancieradetalle( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_entidadfinancieradetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numeroint( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_numeroint', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_seleccionado( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_seleccionado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigovalor( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_codigovalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_entidadfinancieradetalle( txval as variant ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_entidadfinancieradetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numeroint( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_numeroint', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_seleccionado( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_seleccionado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechadepago() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechadepago', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoseleccionado() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoseleccionado', lcParametros )
	EndFunc
