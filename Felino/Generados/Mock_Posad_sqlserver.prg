...
define class Mock_Posad_sqlserver as MockBase of MockBase.prg

	cClase = 'Posad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function actualizaenrecepcion() as boolean                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Actualizaenrecepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarlosnroitemdelosdetalles() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Actualizarlosnroitemdelosdetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function antesendtransaction() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Antesendtransaction', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarcampomemo( tccursor as string, tccampomemo as string, tccampopk as string, tcatributo as string ) as void                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cargarcampomemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cerrarcursores() as void                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cerrarcursores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function consultarporatributosecundario( tcatributo ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Consultarporatributosecundario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function consultarporclaveprimaria( tlllenaratributos as boolean ) as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Consultarporclaveprimaria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesbegintransaction() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Despuesbegintransaction', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarregladenegociopersonalizadaentablatrabajo( toconexion ) as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Ejecutarregladenegociopersonalizadaentablatrabajo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarsentencias( locoleccionsentencias as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                                          
		...
		lnParametros = pcount()
		lxParam1 = locoleccionsentencias
		...
		return this.ObtenerResultado( 'Ejecutarsentencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function enviarcolawebhook() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Enviarcolawebhook', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esaliasdeproceso( tcalias as string, tcprefijo as string ) as boolean                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Esaliasdeproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esubicacionpuesto() as boolean                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Esubicacionpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esubicacionsucursal() as boolean                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Esubicacionsucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoantesdefinalizarrecibir() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventoantesdefinalizarrecibir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function finaldetransaction() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Finaldetransaction', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function formateartextosql( tccadena as string ) as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Formateartextosql', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function importartabladetrabajo( toconexion as object ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Importartabladetrabajo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inicializarmensajesconexion() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Inicializarmensajesconexion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function insertar() as boolean                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Insertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function loguearrecepcion( tcmensaje as string, tlloguea as boolean ) as void                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Loguearrecepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mirarsentencias() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Mirarsentencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleautorizadoresicarddetalle( tcatributo as string ) as string                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercampodetalleautorizadoresicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalledispositivomovilpointdetalle( tcatributo as string ) as string                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercampodetalledispositivomovilpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetallemonedasdetalle( tcatributo as string ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercampodetallemonedasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleplaneslaposdetalle( tcatributo as string ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercampodetalleplaneslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleplanesposnetdetalle( tcatributo as string ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenercampodetalleplanesposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleplanessmartlaposdetalle( tcatributo as string ) as string                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercampodetalleplanessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleserialpointdetalle( tcatributo as string ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercampodetalleserialpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalletarjetasdetalle( tcatributo as string ) as string                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercampodetalletarjetasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalletarjetasfiservdetalle( tcatributo as string ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercampodetalletarjetasfiservdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalletarjetasicarddetalle( tcatributo as string ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercampodetalletarjetasicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalletarjetaslaposdetalle( tcatributo as string ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercampodetalletarjetaslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalletarjetasposnetdetalle( tcatributo as string ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercampodetalletarjetasposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalletarjetassmartlaposdetalle( tcatributo as string ) as string                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercampodetalletarjetassmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleterminalessmartlaposdetalle( tcatributo as string ) as string                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercampodetalleterminalessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampoentidad( tcatributo as string ) as string                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercampoentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleautorizadoresicarddetalle( tccampos as string ) as string                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleautorizadoresicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalledispositivomovilpointdetalle( tccampos as string ) as string                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalledispositivomovilpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetallemonedasdetalle( tccampos as string ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetallemonedasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleplaneslaposdetalle( tccampos as string ) as string                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleplaneslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleplanesposnetdetalle( tccampos as string ) as string                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleplanesposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleplanessmartlaposdetalle( tccampos as string ) as string                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleplanessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleserialpointdetalle( tccampos as string ) as string                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleserialpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalletarjetasdetalle( tccampos as string ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalletarjetasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalletarjetasfiservdetalle( tccampos as string ) as string                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalletarjetasfiservdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalletarjetasicarddetalle( tccampos as string ) as string                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalletarjetasicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalletarjetaslaposdetalle( tccampos as string ) as string                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalletarjetaslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalletarjetasposnetdetalle( tccampos as string ) as string                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalletarjetasposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalletarjetassmartlaposdetalle( tccampos as string ) as string                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalletarjetassmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleterminalessmartlaposdetalle( tccampos as string ) as string                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleterminalessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectentidad( tccampos as string ) as string                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercamposselectentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleautorizadoresicarddetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleautorizadoresicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalledispositivomovilpointdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalledispositivomovilpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetallemonedasdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerdatosdetallemonedasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleplaneslaposdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleplaneslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleplanesposnetdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleplanesposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleplanessmartlaposdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleplanessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleserialpointdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleserialpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalletarjetasdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalletarjetasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalletarjetasfiservdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalletarjetasfiservdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalletarjetasicarddetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalletarjetasicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalletarjetaslaposdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalletarjetaslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalletarjetasposnetdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalletarjetasposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalletarjetassmartlaposdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalletarjetassmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleterminalessmartlaposdetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleterminalessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosentidadpaginado( tcorderby as string, tcfiltro as string, tncantidad as integer, tnpagina as integer )  as string                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerdatosentidadpaginado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerestructura( tctabla as string ) as string                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerestructura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfechaultimoupdateentablas() as datetime                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerfechaultimoupdateentablas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneridentificador( toentidad as entidad of entidad.prg ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obteneridentificador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneridentificadorespaginado( tcorderby as string, tcfiltro as string, tncantidad as integer, tnpagina as integer )  as string                                                                                                                 
		...
		return this.ObtenerResultado( 'Obteneridentificadorespaginado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinsqlserver( tccursor as string, tccampopk as string, tctipo as string ) as string                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerinsqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermemo( tctabla as string ) as string                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenermemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermensajesconexion() as string                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenermensajesconexion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerobjetobusqueda() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerobjetobusqueda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerrutatabla() as string                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerrutatabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertabladetalle( tcdetalle as string ) as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenertabladetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertimestampactual() as integer                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenertimestampactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion( tctablatrabajo ) as string                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_fiservtarjetas( tctablatrabajo ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_fiservtarjetas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_icardautoriz( tctablatrabajo ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_icardautoriz', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_icardtarjetas( tctablatrabajo ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_icardtarjetas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_laposplanes( tctablatrabajo ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_laposplanes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_lapostarjetas( tctablatrabajo ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_lapostarjetas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_laposterminal( tctablatrabajo ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_laposterminal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_pointdispmovil( tctablatrabajo ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_pointdispmovil', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_pointserial( tctablatrabajo ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_pointserial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_posdetalletarj( tctablatrabajo ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_posdetalletarj', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_posmonedas( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_posmonedas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_posnetplanes( tctablatrabajo ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_posnetplanes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_posnettarjetas( tctablatrabajo ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_posnettarjetas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_smartlplanes( tctablatrabajo ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_smartlplanes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_smartltarjetas( tctablatrabajo ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_smartltarjetas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerubicaciondb() as string                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerubicaciondb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocoltablascursores_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Ocoltablascursores_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oconexion_access() as object                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Oconexion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function osp_access() as object                                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Osp_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleautorizadoresicarddetalle( tccampos as string ) as string                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleautorizadoresicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalledispositivomovilpointdetalle( tccampos as string ) as string                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Parsearcamposdetalledispositivomovilpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetallemonedasdetalle( tccampos as string ) as string                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Parsearcamposdetallemonedasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleplaneslaposdetalle( tccampos as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleplaneslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleplanesposnetdetalle( tccampos as string ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleplanesposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleplanessmartlaposdetalle( tccampos as string ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleplanessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleserialpointdetalle( tccampos as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleserialpointdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalletarjetasdetalle( tccampos as string ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Parsearcamposdetalletarjetasdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalletarjetasfiservdetalle( tccampos as string ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Parsearcamposdetalletarjetasfiservdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalletarjetasicarddetalle( tccampos as string ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Parsearcamposdetalletarjetasicarddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalletarjetaslaposdetalle( tccampos as string ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Parsearcamposdetalletarjetaslaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalletarjetasposnetdetalle( tccampos as string ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Parsearcamposdetalletarjetasposnetdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalletarjetassmartlaposdetalle( tccampos as string ) as string                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Parsearcamposdetalletarjetassmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleterminalessmartlaposdetalle( tccampos as string ) as string                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleterminalessmartlaposdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposentidad( tccampos as string ) as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Parsearcamposentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recibirporbulkcopy( tolistatablas as zoocoleccion of zoocoleccion.prg, tlloguear as boolean ) as void                                                                                                                                            
		...
		return this.ObtenerResultado( 'Recibirporbulkcopy', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recibirporsentenciaindividual( tolistatablas as zoocoleccion of zoocoleccion.prg, tlloguear as boolean ) as void                                                                                                                                 
		...
		return this.ObtenerResultado( 'Recibirporsentenciaindividual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearconexionglobal() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setearconexionglobal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearconexionparatransaccion() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setearconexionparatransaccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarinsercionunicidadantesdelcommit( txvalorclaveprimaria as variant ) as void                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Verificarinsercionunicidadantesdelcommit', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarunicidad() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Verificarunicidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function abrirconexionrecibir() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Abrirconexionrecibir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function abrircursores( tcxmldatos as string, tcprefijoimportar as string ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Abrircursores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function abrircursoresrecepcion( tolistatablas as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Abrircursoresrecepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcamposimpo() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Actualizarcamposimpo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcamposrecepcion() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Actualizarcamposrecepcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function aplicarregladenegociotabladetrabajo( toconexion as object ) as void                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Aplicarregladenegociotabladetrabajo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function blanquearcampostransferencia() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Blanquearcampostransferencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargartabladetrabajo( toconexion as object ) as void                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Cargartabladetrabajo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargartabladetrabajodetalles( toconexion as object ) as void                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Cargartabladetrabajodetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cerrarconexionrecibir() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Cerrarconexionrecibir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function comprobarresultadodeejecuciondelupdate() as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Comprobarresultadodeejecuciondelupdate', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function comprobartransaccion() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Comprobartransaccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function convertiratributoscadenasql( tcnombrefuncion as string, tccadena as string ) as string                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Convertiratributoscadenasql', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function convertirdatesql( tdvalor as date ) as string                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Convertirdatesql', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function convertirfuncionessql( tccadena as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Convertirfuncionessql', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearcursormemo( tccursoracrear as string, tctablaconmemo as string ) as void                                                                                                                                                          
		...
		lnParametros = pcount()
		lxParam1 = tccursoracrear
		lxParam2 = tctablaconmemo
		...
		return this.ObtenerResultado( 'Crearcursormemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearreporteerroresimportacion( toconexion as object  ) as void                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Crearreporteerroresimportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function creartabladetrabajo( toconexion as object ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Creartabladetrabajo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function creartabladetrabajodetalles() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Creartabladetrabajodetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function creartabladetrabajoerroresvalidacion( toconexion as object ) as void                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Creartabladetrabajoerroresvalidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ejecutarconsulta( tcatributos as string, tctabla as string, tcwhereyhaving as string, tcorder as string, tcgroupby as string, tntope as integer ) as string                                                                            
		...
		return this.ObtenerResultado( 'Ejecutarconsulta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminardatosinvalidos( toconexion as object ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eliminardatosinvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminarduplicaciones() as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Eliminarduplicaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminartablasdetrabajo( toconexion as object ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eliminartablasdetrabajo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminartablasdetrabajoerroresvalidacion( toconexion ) as void                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Eliminartablasdetrabajoerroresvalidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function finalizarimportacion() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Finalizarimportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function finalizarrecibir() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Finalizarrecibir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function finalizartransaccionrecibir() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Finalizartransaccionrecibir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function funcionrecibircabecera() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Funcionrecibircabecera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function funcionrecibirdetalles() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Funcionrecibirdetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarlistadepalablas( tccadena as string, talista as array ) as integer                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Generarlistadepalablas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarimportacion() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Iniciarimportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciartransaccionrecibir() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Iniciartransaccionrecibir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llenararraymemo( tccampo as string, tcatributo as string, txvalorclaveprimaria as variant ) as void                                                                                                                                    
		...
		return this.ObtenerResultado( 'Llenararraymemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercampogenerico( tcnombrefuncion as string, tccampo as string ) as string                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenercampogenerico', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccioninsqlserver( tccursor as string, tcsucursal as string, tccampopk as string ) as zoocoleccion of zoocoleccion.prg                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercoleccioninsqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdate( tccursor as string, tcatributo as string ) as date                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerdate', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerdatos( tcatributos as string, tchaving as string, tcorder as string , tcfunc as string,  tcwhere as string, tctabla as string, tcdetalle as string, tntope as integer ) as string                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerdatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerfragmentocoleccioninsqlserver( tocoleccion as zoocoleccion of zoocoleccion.prg, tninicio as integer, tncantidad as integer ) as string                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerfragmentocoleccioninsqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneridentificadorparaloguear( tccursor as string ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obteneridentificadorparaloguear', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciainsertmemo( tctabla as string, txvalorclaveprimaria as string, tcorden as string, tctexto as string ) as string                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenersentenciainsertmemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciatriggerimportacion() as string                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenersentenciatriggerimportacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerwhereyhaving( tchaving as string, tcwhereyhaving as string, tcnombrefuncion as string )                                                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = tchaving
		lxParam2 = tcwhereyhaving
		lxParam3 = tcnombrefuncion
		...
		return this.ObtenerResultado( 'Obtenerwhereyhaving', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recibircabecera( tlloguear as boolean ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Recibircabecera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recibircabecerabulkcopy( toconexion as object, tlloguear as boolean, totransaction as object ) as void                                                                                                                                 
		...
		return this.ObtenerResultado( 'Recibircabecerabulkcopy', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recibircomponentes() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Recibircomponentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recibirdetalles() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Recibirdetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function rollbacktransaccionrecibir() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Rollbacktransaccionrecibir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validardatosaimportar() as boolean                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validardatosaimportar', lcParametros )
	EndFunc
