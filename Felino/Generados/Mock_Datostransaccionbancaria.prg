...
define class Mock_datostransaccionbancaria as MockBase of MockBase.prg
	...
	cClase = 'datostransaccionbancaria'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Datos de transacción bancaria"                                                                                                                                                                                                           
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'DATOSTRANSACCIONBANCARIA'                                                                                                                                                                                                                      
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lHabilitarCodigoBanco = .T.                                                                                                                                                                                                                               
	lHabilitarCuentaBancaria_PK = .T.                                                                                                                                                                                                                         
	lHabilitarFecha = .T.                                                                                                                                                                                                                                     
	lHabilitarHora = .T.                                                                                                                                                                                                                                      
	lHabilitarIdentificador = .T.                                                                                                                                                                                                                             
	lHabilitarImporte = .T.                                                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function codigobanco_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DATOSTRANSACCIONBANCARIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'codigobanco_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'codigobanco_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Codigobanco		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Codigobanco( lxVal )				if ( this.lHabilitarCodigobanco or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Codigobanco( lxVal )				else					this.Codigobanco = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de transacción bancaria - Atributo: Codigobanco)" )				endif			EndIf		Else			This.Setear_Codigobanco( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitaratributos( tccodigo as string ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function hora_assign( txval as variant ) as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DATOSTRANSACCIONBANCARIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'hora_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'hora_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Hora		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Hora( lxVal )				if ( this.lHabilitarHora or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Hora( lxVal )				else					this.Hora = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de transacción bancaria - Atributo: Hora)" )				endif			EndIf		Else			This.Setear_Hora( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function identificador_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DATOSTRANSACCIONBANCARIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'identificador_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'identificador_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Identificador		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Identificador( lxVal )				if ( this.lHabilitarIdentificador or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Identificador( lxVal )				else					this.Identificador = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Datos de transacción bancaria - Atributo: Identificador)" )				endif			EndIf		Else			This.Setear_Identificador( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarentidades( toentidad as object, todetalle as object, toregistro as object ) as void                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
