...
define class Mock_Itemcaeainformacaeinformadetalle as MockBase of MockBase.prg

	cClase = 'Itemcaeainformacaeinformadetalle'
	...
	*-----------------------------------------------------------------------------------------
	function codigocomp_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Codigocomp_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigocomp( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_codigocomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipocomp( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_tipocomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalcomp( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_totalcomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipocomp_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Tipocomp_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalcomp_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Totalcomp_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigocomp( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_codigocomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipocomp( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_tipocomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalcomp( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_totalcomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocomentariosafip() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridocomentariosafip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaproceso() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofechaproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotipocomp() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridotipocomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridototalcomp() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridototalcomp', lcParametros )
	EndFunc
