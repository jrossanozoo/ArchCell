...
define class Mock_disenoimpo as MockBase of MockBase.prg
	...
	cRutaExportacion = ""                                                                                                                                                                                                                                     
	cSufijoHooks = ""                                                                                                                                                                                                                                         
	cSufijoHooks = "Importacion"                                                                                                                                                                                                                              
	cTagFuncionalidad = ""                                                                                                                                                                                                                                    
	cTagFuncionalidad = "<NOIMPO>"                                                                                                                                                                                                                            
	cTagsPermitidos = "<IGNORAR>"                                                                                                                                                                                                                             
	...
	*-----------------------------------------------------------------------------------------
	function accionconarchivoentradasinalertas_despuesdeasignar() as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Accionconarchivoentradasinalertas_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function accionconarchivoerrores_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'accionconarchivoerrores_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'accionconarchivoerrores_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Accionconarchivoerrores		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Accionconarchivoerrores( lxVal )				this.Setear_Accionconarchivoerrores( lxVal )				 This.Accionconarchivoerrores_DespuesDeAsignar()			EndIf		Else			This.Setear_Accionconarchivoerrores( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function accionconarchivoerrores_despuesdeasignar() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Accionconarchivoerrores_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function archivoentrada_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'archivoentrada_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'archivoentrada_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Archivoentrada		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Archivoentrada( lxVal )				this.Setear_Archivoentrada( lxVal )			EndIf		Else			This.Setear_Archivoentrada( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarcolsubareas() as void                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcolsubareas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function comando_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'comando_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'comando_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Comando		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Comando( lxVal )				this.Setear_Comando( lxVal )			EndIf		Else			This.Setear_Comando( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function completarsubareaatributostag(loitem as object, locolsubareas as object) as void                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = loitem
		lxParam2 = locolsubareas
		...
		return this.ObtenerResultado( 'Completarsubareaatributostag', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detecciondetalle_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detecciondetalle_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detecciondetalle_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Detecciondetalle		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Detecciondetalle( lxVal )				this.Setear_Detecciondetalle( lxVal )			EndIf		Else			This.Setear_Detecciondetalle( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esarchivoporparametro( tccadena as string) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esarchivoporparametro', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function esatributodetalle( tcatributo as string ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esatributodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esatributotag( tcatributo as string ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esatributotag', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoconfiguraropcionesdemodo( toargumentos as object ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toargumentos
		...
		return this.ObtenerResultado( 'Eventoconfiguraropcionesdemodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitarcantidaddelineasdecorte() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarcantidaddelineasdecorte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitarrutaaccionarchivoentradaconalertas() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarrutaaccionarchivoentradaconalertas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitarrutaaccionarchivoentradaerrores() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarrutaaccionarchivoentradaerrores', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitarrutaaccionarchivoentradasinalertas() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarrutaaccionarchivoentradasinalertas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitarrutasarchivoentrada() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarrutasarchivoentrada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modo_despuesdeasignar() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Modo_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerarchivoporparametro( tcparametro as string ) as string                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerarchivoporparametro', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerprimeratributo( toatributos as zoocoleccion of zoocoleccion.prg ) as string                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toatributos
		...
		return this.ObtenerResultado( 'Obtenerprimeratributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function rutaalertas_access() as string                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaalertas_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaalertas_access', lcParametros )			endif		endif		local lcRetorno as String		if substr( this.RutaAlertas, 1, 2 ) = ".\"			if this.lEsEntornoCloud				lcRetorno = goServicios.Librerias.ObtenerCarpetaProductoMisDocumentos( substr( this.RutaAlertas, 3 ) )			else					lcRetorno = addbs( _screen.Zoo.cRutaInicial ) + substr( this.RutaAlertas, 3 )			endif		else			lcRetorno = this.RutaAlertas		endif		return lcRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function rutaalertas_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaalertas_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaalertas_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Rutaalertas		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Rutaalertas( lxVal )				if ( this.lHabilitarRutaalertas or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Rutaalertas( lxVal )				else					this.Rutaalertas = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Diseño de importación - Atributo: Rutaalertas)" )				endif			EndIf		Else			This.Setear_Rutaalertas( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function rutaerrores_access() as string                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaerrores_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaerrores_access', lcParametros )			endif		endif		local lcRetorno as String		if substr( this.RutaErrores, 1, 2 ) = ".\"			if this.lEsEntornoCloud				lcRetorno = goServicios.Librerias.ObtenerCarpetaProductoMisDocumentos( substr( this.RutaErrores, 3 ) )			else					lcRetorno = addbs( _screen.Zoo.cRutaInicial ) + substr( this.RutaErrores, 3 )			endif			else			lcRetorno = this.RutaErrores		endif		return lcRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function rutaerrores_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaerrores_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaerrores_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Rutaerrores		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Rutaerrores( lxVal )				if ( this.lHabilitarRutaerrores or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Rutaerrores( lxVal )				else					this.Rutaerrores = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Diseño de importación - Atributo: Rutaerrores)" )				endif			EndIf		Else			This.Setear_Rutaerrores( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function rutaprocesados_access() as string                                                                                                                                                                                                                
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaprocesados_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaprocesados_access', lcParametros )			endif		endif		local lcRetorno as String		if substr( this.RutaProcesados, 1, 2 ) = ".\"			if this.lEsEntornoCloud				lcRetorno = goServicios.Librerias.ObtenerCarpetaProductoMisDocumentos( substr( this.RutaProcesados, 3 ) )			else					lcRetorno = addbs( _screen.Zoo.cRutaInicial ) + substr( this.RutaProcesados, 3 )			endif			else			lcRetorno = this.RutaProcesados		endif		return lcRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function rutaprocesados_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaprocesados_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaprocesados_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Rutaprocesados		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Rutaprocesados( lxVal )				if ( this.lHabilitarRutaprocesados or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Rutaprocesados( lxVal )				else					this.Rutaprocesados = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Diseño de importación - Atributo: Rutaprocesados)" )				endif			EndIf		Else			This.Setear_Rutaprocesados( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_accionconarchivoentradaconalertas( txval as variant ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_accionconarchivoentradaconalertas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_accionconarchivoentradaconalertas', lcParametros )			endif		endif		this.Accionconarchivoentradaconalertas = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_accionconarchivoentradasinalertas( txval as variant ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_accionconarchivoentradasinalertas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_accionconarchivoentradasinalertas', lcParametros )			endif		endif		this.Accionconarchivoentradasinalertas = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_accionconarchivoerrores( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_accionconarchivoerrores', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_accionconarchivoerrores', lcParametros )			endif		endif		this.Accionconarchivoerrores = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_archivoentrada( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_archivoentrada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_archivoentrada', lcParametros )			endif		endif		this.Archivoentrada = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidaddelineasdecorte( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cantidaddelineasdecorte', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cantidaddelineasdecorte', lcParametros )			endif		endif		this.Cantidaddelineasdecorte = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_comando( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_comando', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_comando', lcParametros )			endif		endif		this.Comando = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_detecciondetalle( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_detecciondetalle', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_detecciondetalle', lcParametros )			endif		endif		this.Detecciondetalle = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ignorarfinal( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ignorarfinal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ignorarfinal', lcParametros )			endif		endif		this.Ignorarfinal = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_ignorarinicio( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ignorarinicio', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ignorarinicio', lcParametros )			endif		endif		this.Ignorarinicio = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_ignorarlineasenblanco( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ignorarlineasenblanco', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ignorarlineasenblanco', lcParametros )			endif		endif		this.Ignorarlineasenblanco = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_ignorarlineasqueempiezancon( txval as variant ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ignorarlineasqueempiezancon', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ignorarlineasqueempiezancon', lcParametros )			endif		endif		this.Ignorarlineasqueempiezancon = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_modo( txval as variant ) as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_modo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_modo', lcParametros )			endif		endif		this.Modo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_rutaalertas( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rutaalertas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rutaalertas', lcParametros )			endif		endif		this.Rutaalertas = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_rutaerrores( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rutaerrores', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rutaerrores', lcParametros )			endif		endif		this.Rutaerrores = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_rutaprocesados( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rutaprocesados', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rutaprocesados', lcParametros )			endif		endif		this.Rutaprocesados = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_sololineasqueempiezancon( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_sololineasqueempiezancon', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_sololineasqueempiezancon', lcParametros )			endif		endif		this.Sololineasqueempiezancon = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sololineasqueempiezancon_assign( txval as variant ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'sololineasqueempiezancon_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'sololineasqueempiezancon_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Sololineasqueempiezancon		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Sololineasqueempiezancon( lxVal )				this.Setear_Sololineasqueempiezancon( lxVal )			EndIf		Else			This.Setear_Sololineasqueempiezancon( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_accionconarchivoentradaconalertas( txval as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_accionconarchivoentradaconalertas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_accionconarchivoentradaconalertas', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_accionconarchivoentradasinalertas( txval as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_accionconarchivoentradasinalertas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_accionconarchivoentradasinalertas', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_accionconarchivoerrores( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_accionconarchivoerrores', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_accionconarchivoerrores', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_archivoentrada( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_archivoentrada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_archivoentrada', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidaddelineasdecorte( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cantidaddelineasdecorte', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cantidaddelineasdecorte', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_comando( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_comando', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_comando', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_detecciondetalle( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_detecciondetalle', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_detecciondetalle', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ignorarfinal( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ignorarfinal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ignorarfinal', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_ignorarinicio( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ignorarinicio', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ignorarinicio', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_ignorarlineasenblanco( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ignorarlineasenblanco', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ignorarlineasenblanco', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_ignorarlineasqueempiezancon( txval as variant ) as boolean                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ignorarlineasqueempiezancon', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ignorarlineasqueempiezancon', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_modo( txval as variant ) as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_modo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_modo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_rutaalertas( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rutaalertas', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rutaalertas', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_rutaerrores( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rutaerrores', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rutaerrores', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_rutaprocesados( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rutaprocesados', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rutaprocesados', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_sololineasqueempiezancon( txval as variant ) as boolean                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DISENOIMPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_sololineasqueempiezancon', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_sololineasqueempiezancon', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaraccionconarchivoentradaconalertas() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaraccionconarchivoentradaconalertas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validaraccionconarchivoentradasinalertas() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaraccionconarchivoentradasinalertas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validaraccionconarchivoerrores() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaraccionconarchivoerrores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmodo() as boolean                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarmodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoaccionconarchivoentradaconalertas() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoaccionconarchivoentradaconalertas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoaccionconarchivoentradasinalertas() as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoaccionconarchivoentradasinalertas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoaccionconarchivoerrores() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoaccionconarchivoerrores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoarchivoentrada() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridoarchivoentrada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidaddelineasdecorte() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridocantidaddelineasdecorte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocomando() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridocomando', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodetecciondetalle() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridodetecciondetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwaccionconarchivoentradaconalertas() as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwaccionconarchivoentradaconalertas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwaccionconarchivoentradasinalertas() as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwaccionconarchivoentradasinalertas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwaccionconarchivoerrores() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwaccionconarchivoerrores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwignorarlineasenblanco() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwignorarlineasenblanco', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoignorarfinal() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoignorarfinal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoignorarinicio() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoignorarinicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoignorarlineasenblanco() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridoignorarlineasenblanco', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoignorarlineasqueempiezancon() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoignorarlineasqueempiezancon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomodo() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridomodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorutaalertas() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridorutaalertas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorutaerrores() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridorutaerrores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridorutaprocesados() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridorutaprocesados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosololineasqueempiezancon() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridosololineasqueempiezancon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function creardirectorio( tcdir as string ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Creardirectorio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function extraerentidades( toentidad as object, tcatributo as string ) as void                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	protected function obteneritemsubarea( tcsubarea as string ) as empty                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obteneritemsubarea', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearcantidaddelineasdecorte() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearcantidaddelineasdecorte', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearmodo() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function validarareasdeteccion() as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarareasdeteccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarrestriccionessegunmodo() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarrestriccionessegunmodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificardirectoriosdefaults() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificardirectoriosdefaults', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarvaloressugeridosdirectoriosdefaults() as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Verificarvaloressugeridosdirectoriosdefaults', lcParametros )
	EndFunc
