...
define class Mock_tiquetdecambio as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Comprobante para cambio"                                                                                                                                                                                                                 
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'TIQUETDECAMBIO'                                                                                                                                                                                                                                
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lHabilitaGenerarTiquetDeCambio = .f.                                                                                                                                                                                                                      
	lHabilitaGenerarUnTiquetDeCambioPorArticulo = .f.                                                                                                                                                                                                         
	lHabilitaGenerarUnTiquetDeCambioPorUnidad = .f.                                                                                                                                                                                                           
	...
	lPermiteGenerarTiquetDeCambio = .f.                                                                                                                                                                                                                       
	...
	*-----------------------------------------------------------------------------------------
	function adaptaritemsparatiquetdecambio() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Adaptaritemsparatiquetdecambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallecomprobante() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallecomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cantart_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cantart_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cantart_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cantart		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cantart( lxVal )				this.Setear_Cantart( lxVal )			EndIf		Else			This.Setear_Cantart( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detallecomprobante_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallecomprobante_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallecomprobante_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallecomprobante ) = 'O' or isnull( this.Detallecomprobante ) )			this.Detallecomprobante = this.crearobjeto( 'Din_DetalleTiquetdecambioDetallecomprobante' )			this.Detallecomprobante.inicializar()			this.enlazar( 'Detallecomprobante.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallecomprobante.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallecomprobante, 'CambioSumarizado', this, 'CambiosDetalleDetallecomprobante', 1)			this.enlazar( 'Detallecomprobante.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallecomprobante.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detallecomprobante.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detallecomprobante
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nroart_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'nroart_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'nroart_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Nroart		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Nroart( lxVal )				this.Setear_Nroart( lxVal )			EndIf		Else			This.Setear_Nroart( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidaddearticulosenitem( tonroitem as integer ) as integer                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercantidaddearticulosenitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercantidaddeitemsendetalle() as integer                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercantidaddeitemsendetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerparametrosasociados() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerparametrosasociados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerticketindividual( tnnroitem as integer, tncantart as integer ) as object                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerticketindividual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oparametrostiquet_access() as object                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oparametrostiquet_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oparametrostiquet_access', lcParametros )			endif		endif		If !this.lDestroy and !( vartype( this.oParametrosTiquet ) == "O" )			this.oParametrosTiquet = newobject( "ParamAuxiliar" )			this.ObtenerParametrosAsociados()		Endif		return this.oParametrosTiquet
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oticketunico_access() as object                                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oticketunico_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oticketunico_access', lcParametros )			endif		endif		If !this.lDestroy and !( vartype( this.oTicketUnico ) == "O" )			this.oTicketUnico = _screen.Zoo.InstanciarEntidad( "TiquetDeCambio" )		Endif		return this.oTicketUnico
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantart( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cantart', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cantart', lcParametros )			endif		endif		this.Cantart = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nroart( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_nroart', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_nroart', lcParametros )			endif		endif		this.Nroart = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearsipermitegenerartiquetdecambio() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearsipermitegenerartiquetdecambio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function seteartiquetdecambioporarticulounidad( toentidad as object ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Seteartiquetdecambioporarticulounidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantart( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cantart', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cantart', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nroart( txval as variant ) as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIQUETDECAMBIO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_nroart', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_nroart', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardominio_codigovendedor( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validardominio_codigovendedor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarsigeneratiquetdecambioporarticulo() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarsigeneratiquetdecambioporarticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarsigeneratiquetdecambioporunidad() as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarsigeneratiquetdecambioporunidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function copiarcabecera( toentidad as object, tnnroitem as integer, tncantart as integer ) as void                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Copiarcabecera', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function copiaritem( tnnroitem as integer, toitemdestino as object ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
