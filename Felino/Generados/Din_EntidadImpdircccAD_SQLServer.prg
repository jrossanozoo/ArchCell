	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.IMPDIRCCC ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Timestamp","Horaimpo","Haltafw","Horaexpo","Saltafw","Hmodifw","Umodifw","Ualtafw","Smodifw","Zadsfw","Bdaltafw","Esttrans","Vmodifw","Bdmodifw","Valtafw","Obs","Numero","Descripcio","Condesde","Conhasta","Cladesde","Clahasta","Ccosto","Dccosto","Importanci" ) values ( <<"'" + this.ConvertirDateSql( lxImpdircccFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircccFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircccFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircccFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircccFecexpo ) + "'" >>, <<lxImpdircccTimestamp >>, <<"'" + this.FormatearTextoSql( lxImpdircccHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccObs ) + "'" >>, <<lxImpdircccNumero >>, <<"'" + this.FormatearTextoSql( lxImpdircccDescripcio ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccCondesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccConhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccCladesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccClahasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccCcosto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircccDccosto ) + "'" >>, <<lxImpdircccImportanci >> )
			endtext
		...
		this.oEntidad.Timestamp = lxImpdircccTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.IMPDIRCCC set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxImpdircccFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxImpdircccFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxImpdircccFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxImpdircccFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxImpdircccFecexpo ) + "'">>,"Timestamp" = <<lxImpdircccTimestamp>>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxImpdircccHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxImpdircccHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxImpdircccHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxImpdircccSaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxImpdircccHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxImpdircccUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxImpdircccUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxImpdircccSmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxImpdircccZadsfw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxImpdircccBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxImpdircccEsttrans ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxImpdircccVmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxImpdircccBdmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxImpdircccValtafw ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxImpdircccObs ) + "'">>,"Numero" = <<lxImpdircccNumero>>,"Descripcio" = <<"'" + this.FormatearTextoSql( lxImpdircccDescripcio ) + "'">>,"Condesde" = <<"'" + this.FormatearTextoSql( lxImpdircccCondesde ) + "'">>,"Conhasta" = <<"'" + this.FormatearTextoSql( lxImpdircccConhasta ) + "'">>,"Cladesde" = <<"'" + this.FormatearTextoSql( lxImpdircccCladesde ) + "'">>,"Clahasta" = <<"'" + this.FormatearTextoSql( lxImpdircccClahasta ) + "'">>,"Ccosto" = <<"'" + this.FormatearTextoSql( lxImpdircccCcosto ) + "'">>,"Dccosto" = <<"'" + this.FormatearTextoSql( lxImpdircccDccosto ) + "'">>,"Importanci" = <<lxImpdircccImportanci>> where "Numero" = <<lxImpdircccNumero>> and  IMPDIRCCC.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Timestamp,Horaimpo,Haltafw,Horaexpo,Saltafw,Hmodifw" + ;
",Umodifw,Ualtafw,Smodifw,Zadsfw,Bdaltafw,Esttrans,Vmodifw,Bdmodifw,Valtafw,Obs,Numero,Descripcio,Con" + ;
"desde,Conhasta,Cladesde,Clahasta,Ccosto,Dccosto,Importanci" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, TIMESTAMP, HORAIMPO, HALTAFW, HORAEXPO, SALTAFW, HMODIFW, UMODIFW, UALTAFW, SMODIFW, ZADSFW, BDALTAFW, ESTTRANS, VMODIFW, BDMODIFW, VALTAFW, OBS, NUMERO, Descripcio, ConDesde, ConHasta, ClaDesde, ClaHasta, CCosto, Dccosto, Importanci
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..NUMERO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descripcio ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClaDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ClaHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CCosto ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Dccosto ) + "'" + ',' + transform( &lcCursor..Importanci )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.OBS = isnull( d.OBS, t.OBS ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.DESCRIPCIO = isnull( d.DESCRIPCIO, t.DESCRIPCIO ),t.CONDESDE = isnull( d.CONDESDE, t.CONDESDE ),t.CONHASTA = isnull( d.CONHASTA, t.CONHASTA ),t.CLADESDE = isnull( d.CLADESDE, t.CLADESDE ),t.CLAHASTA = isnull( d.CLAHASTA, t.CLAHASTA ),t.CCOSTO = isnull( d.CCOSTO, t.CCOSTO ),t.DCCOSTO = isnull( d.DCCOSTO, t.DCCOSTO ),t.IMPORTANCI = isnull( d.IMPORTANCI, t.IMPORTANCI )
					from ZooLogic.IMPDIRCCC t inner join deleted d 
							 on t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.IMPDIRCCC(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Timestamp,Horaimpo,Haltafw,Horaexpo,Saltafw,Hmodifw,Umodifw,Ualtafw,Smodifw,Zadsfw,Bdaltafw,Esttrans,Vmodifw,Bdmodifw,Valtafw,Obs,Numero,Descripcio,Condesde,Conhasta,Cladesde,Clahasta,Ccosto,Dccosto,Importanci)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.TIMESTAMP,0),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.ZADSFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.VMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.VALTAFW,''),isnull( d.OBS,''),isnull( d.NUMERO,0),isnull( d.DESCRIPCIO,''),isnull( d.CONDESDE,''),isnull( d.CONHASTA,''),isnull( d.CLADESDE,''),isnull( d.CLAHASTA,''),isnull( d.CCOSTO,''),isnull( d.DCCOSTO,''),isnull( d.IMPORTANCI,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_IMPDIRCCC' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_IMPDIRCCC.Timestamp, 0 )
					...
					.F_concepto_desde = nvl( c_IMPDIRCCC.F_concepto_desde, [] )
					.F_concepto_hasta = nvl( c_IMPDIRCCC.F_concepto_hasta, [] )
					.F_clasificacion_desde = nvl( c_IMPDIRCCC.F_clasificacion_desde, [] )
					.F_clasificacion_hasta = nvl( c_IMPDIRCCC.F_clasificacion_hasta, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="IMPDIRCCC                               " atributo="FECHATRANSFERENCIA                      " tabla="IMPDIRCCC      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                                                                                                                       " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCCC                               " atributo="TIMESTAMP                               " tabla="IMPDIRCCC      " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCCC                               " atributo="ESTADOTRANSFERENCIA                     " tabla="IMPDIRCCC      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCCC                               " atributo="F_CONCEPTO_DESDE                        " tabla="IMPDIRCCC      " campo="CONDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Concepto desde                                                                                                                                                                                                                                            " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCCC                               " atributo="F_CONCEPTO_HASTA                        " tabla="IMPDIRCCC      " campo="CONHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="404" etiqueta="Concepto hasta                                                                                                                                                                                                                                            " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCCC                               " atributo="F_CLASIFICACION_DESDE                   " tabla="IMPDIRCCC      " campo="CLADESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Clasificación desde                                                                                                                                                                                                                                       " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCCC                               " atributo="F_CLASIFICACION_HASTA                   " tabla="IMPDIRCCC      " campo="CLAHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="408" etiqueta="Clasificación hasta                                                                                                                                                                                                                                       " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
