...
define class Din_EntidadImpdirart_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Impdirart"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Prioridadccosto", toEntidad, "Prioridadccosto" )
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_temporada_desde", toEntidad, "F_temporada_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_temporada_hasta", toEntidad, "F_temporada_hasta" )
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_familia_desde", toEntidad, "F_familia_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_familia_hasta", toEntidad, "F_familia_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_material_desde", toEntidad, "F_material_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_material_hasta", toEntidad, "F_material_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_linea_desde", toEntidad, "F_linea_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_linea_hasta", toEntidad, "F_linea_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_grupo_desde", toEntidad, "F_grupo_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_grupo_hasta", toEntidad, "F_grupo_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_categoria_desde", toEntidad, "F_categoria_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_categoria_hasta", toEntidad, "F_categoria_hasta" )
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_tipo_desde", toEntidad, "F_tipo_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_tipo_hasta", toEntidad, "F_tipo_hasta" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoInteger( toModeloResponse, "PrioridadCCosto", toEntidad.PrioridadCCosto)
			...
			this.SetearAtributoString( toModeloResponse, "f_Temporada_Desde", toEntidad.f_Temporada_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Temporada_Hasta", toEntidad.f_Temporada_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Anio_Desde", toEntidad.f_Anio_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Anio_Hasta", toEntidad.f_Anio_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Familia_Desde", toEntidad.f_Familia_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Familia_Hasta", toEntidad.f_Familia_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Material_Desde", toEntidad.f_Material_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Material_Hasta", toEntidad.f_Material_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Linea_Desde", toEntidad.f_Linea_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Linea_Hasta", toEntidad.f_Linea_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Grupo_Desde", toEntidad.f_Grupo_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Grupo_Hasta", toEntidad.f_Grupo_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Categoria_Desde", toEntidad.f_Categoria_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Categoria_Hasta", toEntidad.f_Categoria_Hasta)
			...
			this.SetearAtributoString( toModeloResponse, "f_Tipo_Desde", toEntidad.f_Tipo_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Tipo_Hasta", toEntidad.f_Tipo_Hasta)
			this.SetearAtributoInteger( toModeloResponse, "CondicionIvaVentas", toEntidad.CondicionIvaVentas)
			this.SetearAtributoString( toModeloResponse, "f_Ivav_Desde", toEntidad.f_Ivav_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Ivav_Hasta", toEntidad.f_Ivav_Hasta)
			this.SetearAtributoInteger( toModeloResponse, "CondicionIvaCompras", toEntidad.CondicionIvaCompras)
			this.SetearAtributoString( toModeloResponse, "f_Ivac_Desde", toEntidad.f_Ivac_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Ivac_Hasta", toEntidad.f_Ivac_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Impi_Desde", toEntidad.f_Impi_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Impi_Hasta", toEntidad.f_Impi_Hasta)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Prioridadccosto", "IMPORTANCC")
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "F_impi_desde", "IVCDESDE")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "F_impi_hasta", "IVCHASTA")
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerBusquedaSegunModeloRequest( toRequest as Object ) as String
		...
		if !isnull( lcExpresionBusqueda )
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ivvdesde LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ivvhasta LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ivcdesde LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ivchasta LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ivcdesde LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Ivchasta LIKE '%" + lcExpresionBusqueda + "%'"
