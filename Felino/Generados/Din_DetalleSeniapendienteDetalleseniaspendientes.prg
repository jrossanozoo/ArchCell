...
define class Din_DetalleSENIAPENDIENTEDetalleseniaspendientes as detalle of detalle.prg
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.IdSenia = this.Item[ tnItem ].IdSenia
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'IdSenia', .IdSenia )
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].IdSenia = .oItem.IdSenia
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Detalleseniaspendientes' ) > 0 and reccount( 'c_Detalleseniaspendientes' ) > 0
				endif
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemSENIAPENDIENTEDetalleseniaspendientes' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Detalleseniaspendientes
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Detalleseniaspendientes.Codigo
			loItem.NROITEM = c_Detalleseniaspendientes.NROITEM
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Idsenia = toItemOrigen.Idsenia
