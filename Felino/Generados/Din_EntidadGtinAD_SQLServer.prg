			...
			for each loItem in this.oEntidad.DetRangos
				if this.oEntidad.DetRangos.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DETGTIN("NROITEM","clavef","Codigo","atributo","desde","hasta" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxClaveforanea ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxAtributo ) + "'">>, <<"'" + this.FormatearTextoSql( lxDesde ) + "'">>, <<"'" + this.FormatearTextoSql( lxHasta ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Clavef" as "Claveforanea", "Codigo" as "Codigo", "Atributo" as "Atributo", "Desde" as "Desde", "Hasta" as "Hasta" from ZooLogic.DETGTIN where Codigo = <<"'" + this.FormatearTextoSql( c_GTIN.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetRangos( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Clavef" as "Claveforanea", "Codigo" as "Codigo", "Atributo" as "Atributo", "Desde" as "Desde", "Hasta" as "Hasta"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.DetRangos
				if this.oEntidad.DetRangos.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxHasta = loItem.Hasta
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DETGTIN("NROITEM","clavef","Codigo","atributo","desde","hasta" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxClaveforanea ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxAtributo ) + "'">>, <<"'" + this.FormatearTextoSql( lxDesde ) + "'">>, <<"'" + this.FormatearTextoSql( lxHasta ) + "'">> ) 
					endtext
...
<VFPData xml:space="preserve">
	...
	<row entidad="GTIN                                    " atributo="FECHATRANSFERENCIA                      " tabla="GTIN           " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="GTIN                                    " atributo="ESTADOTRANSFERENCIA                     " tabla="GTIN           " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
