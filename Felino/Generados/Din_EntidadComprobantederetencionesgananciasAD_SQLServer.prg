...
define class Din_EntidadCOMPROBANTEDERETENCIONESGANANCIASAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg

	cNombreCursor = 'c_COMPROBANTEDERETENCIONESGANANCIAS'
	colSentencias = null
	cArchivoLogPrueba = '' 
	cRutaTablas = ''
	nReintentos = 3
	...
	*--------------------------------------------------------------------------------------------------------
	function HayDatos() as boolean
		local llhaydatos as boolean, lcXml as String
			 lcXml = this.oConexion.EjecutarSql( "select Top 1 CODIGO from ZooLogic.COMPRET where " + this.ConvertirFuncionesSql( " COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'" ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Prov" as "Proveedor", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Ptoventa" as "Puntodeventa", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Tipoimp" as "Tipoimpuesto", "Obs" as "Obs", "Desprov" as "Proveedordescripcion", "Crtotal" as "Total", "Numero" as "Numero", "Fecha" as "Fecha", "Moneda" as "Monedacomprobante", "Letraop" as "Letraordendepago", "Impman" as "Impuestosmanuales", "Ptovenop" as "Puntodeventaordendepago", "Numop" as "Numeroordendepago" from ZooLogic.COMPRET where  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS' And PtoVenta = <<lxCompRetPtoVenta>> and Numero = <<lxCompRetNumero>> and TipoImp = <<"'" + this.FormatearTextoSql( lxCompRetTipoImp ) + "'">>
			endtext
			use in select('c_COMPROBANTEDERETENCIONESGANANCIAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_COMPROBANTEDERETENCIONESGANANCIAS', set( 'Datasession' ) )
			if reccount( 'c_COMPROBANTEDERETENCIONESGANANCIAS' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	function VerificarExistenciaClavePrimaria( txVal as Variant ) as Boolean
		...
		lxCompretCodigo = txVal
			...
			text to lcSentencia textmerge noshow
				select count( * ) as CantidadDeRegistros from ZooLogic.COMPRET where "Codigo" = <<"'" + this.FormatearTextoSql( lxCompretCodigo ) + "'">> and  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Prov" as "Proveedor", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Ptoventa" as "Puntodeventa", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Tipoimp" as "Tipoimpuesto", "Obs" as "Obs", "Desprov" as "Proveedordescripcion", "Crtotal" as "Total", "Numero" as "Numero", "Fecha" as "Fecha", "Moneda" as "Monedacomprobante", "Letraop" as "Letraordendepago", "Impman" as "Impuestosmanuales", "Ptovenop" as "Puntodeventaordendepago", "Numop" as "Numeroordendepago" from ZooLogic.COMPRET where  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS' order by PtoVenta,Numero,TipoImp
			endtext
			use in select('c_COMPROBANTEDERETENCIONESGANANCIAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_COMPROBANTEDERETENCIONESGANANCIAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Prov" as "Proveedor", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Ptoventa" as "Puntodeventa", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Tipoimp" as "Tipoimpuesto", "Obs" as "Obs", "Desprov" as "Proveedordescripcion", "Crtotal" as "Total", "Numero" as "Numero", "Fecha" as "Fecha", "Moneda" as "Monedacomprobante", "Letraop" as "Letraordendepago", "Impman" as "Impuestosmanuales", "Ptovenop" as "Puntodeventaordendepago", "Numop" as "Numeroordendepago" from ZooLogic.COMPRET where  str( PtoVenta, 4, 0) + str( Numero, 10, 0) + funciones.padr( TipoImp, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS' order by PtoVenta,Numero,TipoImp
			endtext
			use in select('c_COMPROBANTEDERETENCIONESGANANCIAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_COMPROBANTEDERETENCIONESGANANCIAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Prov" as "Proveedor", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Ptoventa" as "Puntodeventa", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Tipoimp" as "Tipoimpuesto", "Obs" as "Obs", "Desprov" as "Proveedordescripcion", "Crtotal" as "Total", "Numero" as "Numero", "Fecha" as "Fecha", "Moneda" as "Monedacomprobante", "Letraop" as "Letraordendepago", "Impman" as "Impuestosmanuales", "Ptovenop" as "Puntodeventaordendepago", "Numop" as "Numeroordendepago" from ZooLogic.COMPRET where  str( PtoVenta, 4, 0) + str( Numero, 10, 0) + funciones.padr( TipoImp, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS' order by PtoVenta desc,Numero desc,TipoImp desc
			endtext
			use in select('c_COMPROBANTEDERETENCIONESGANANCIAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_COMPROBANTEDERETENCIONESGANANCIAS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Prov" as "Proveedor", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Ptoventa" as "Puntodeventa", "Codigo" as "Codigo", "Monsis" as "Monedasistema", "Tipoimp" as "Tipoimpuesto", "Obs" as "Obs", "Desprov" as "Proveedordescripcion", "Crtotal" as "Total", "Numero" as "Numero", "Fecha" as "Fecha", "Moneda" as "Monedacomprobante", "Letraop" as "Letraordendepago", "Impman" as "Impuestosmanuales", "Ptovenop" as "Puntodeventaordendepago", "Numop" as "Numeroordendepago" from ZooLogic.COMPRET where  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS' order by PtoVenta desc,Numero desc,TipoImp desc
			endtext
			use in select('c_COMPROBANTEDERETENCIONESGANANCIAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_COMPROBANTEDERETENCIONESGANANCIAS', set( 'Datasession' ) )
			local lcSentencia as string
...
" from ZooLogic.COMPRET where  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS' and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosEntidad( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		lcWhere = " Where  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'"
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			lcFiltro = ["Codigo" = ] + lcValorClavePrimariaString  + [ and  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS']
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerCantidadRegistros() as integer
		local lnCantReg as integer
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select count( * ) as Total from ZooLogic.COMPRET where  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerTimestampActual() as integer
		...
		lcCursor = sys(2015)
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select TimeStamp from ZooLogic.COMPRET where CODIGO = " + "'" + this.FormatearTextoSql( this.oEntidad.CODIGO ) + "'"+ " and  COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'" )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirCabecera( tlLoguear as Boolean ) As Void
		...
		lxValorClavePK = ''
		lcMensajeExtra = ''
		lcCursor = This.oEntidad.cPrefijoRecibir + 'COMPROBANTEDERETENCIONESGANANCIAS'
		select( lcCursor )
		scan all
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			Case  lcAlias == lcPrefijo + 'COMPROBANTEDERETENCIONESGANANCIAS'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'COMPROBANTEDERETENCIONESGANANCIAS_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'COMPROBANTEDERETENCIONESGANANCIAS_OBS'
				llRetorno = .T.
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		lcCursor = This.oEntidad.cPrefijoImportar + 'COMPROBANTEDERETENCIONESGANANCIAS'
		select( lcCursor )
		llRetorno = .T.
		lxVar = &lcCursor..CODIGO
		llCondicion = isnull( lxVar ) or isnull( &lcCursor..PtoVenta ) or isnull( &lcCursor..Numero ) or isnull( &lcCursor..TipoImp )
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad COMPROBANTEDERETENCIONESGANANCIAS. Hay un error en el diseño de importación.' )
...
End
	...
	*--------------------------------------------------------------------------------------------------------
	function Cargar() as Boolean
		...
		with this.oEntidad
			llRetorno = .T.
			if reccount( 'c_COMPROBANTEDERETENCIONESGANANCIAS' ) < 1
				llRetorno = .F.
			else
				Try
					.lCargando = .t.
					...
					.Fechaexpo = GoLibrerias.ObtenerFechaFormateada( nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Fechaexpo, ctod( '  /  /    ' ) ) )
					.Fechaaltafw = GoLibrerias.ObtenerFechaFormateada( nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Fechaaltafw, ctod( '  /  /    ' ) ) )
					.Fechamodificacionfw = GoLibrerias.ObtenerFechaFormateada( nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Fechamodificacionfw, ctod( '  /  /    ' ) ) )
					.Fechaimpo = GoLibrerias.ObtenerFechaFormateada( nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Fechaimpo, ctod( '  /  /    ' ) ) )
					.Fechatransferencia = GoLibrerias.ObtenerFechaFormateada( nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Fechatransferencia, ctod( '  /  /    ' ) ) )
					.Proveedor_PK =  nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Proveedor, [] )
					.Timestamp = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Timestamp, 0 )
					.Anulado = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Anulado, .F. )
					.Horaaltafw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Horaaltafw, [] )
					lcValor = This.ObtenerMemo( 'c_Zadsfw')
					.Zadsfw = lcValor 
					.Horaexpo = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Horaexpo, [] )
					.Horamodificacionfw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Horamodificacionfw, [] )
					.Horaimpo = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Horaimpo, [] )
					.Versionaltafw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Versionaltafw, [] )
					.Estadotransferencia = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Estadotransferencia, [] )
					.Seriealtafw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Seriealtafw, [] )
					.Usuariomodificacionfw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Usuariomodificacionfw, [] )
					.Basededatosmodificacionfw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Basededatosmodificacionfw, [] )
					.Versionmodificacionfw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Versionmodificacionfw, [] )
					.Basededatosaltafw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Basededatosaltafw, [] )
					.Seriemodificacionfw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Seriemodificacionfw, [] )
					.Usuarioaltafw = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Usuarioaltafw, [] )
					.Puntodeventa = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Puntodeventa, 0 )
					...
					.Codigo = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Codigo, [] )
					.Monedasistema_PK =  nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Monedasistema, [] )
					.Tipoimpuesto_PK =  nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Tipoimpuesto, [] )
					lcValor = This.ObtenerMemo( 'c_Obs')
					.Obs = lcValor 
					.Proveedordescripcion = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Proveedordescripcion, [] )
					.Total = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Total, 0 )
					.Numero = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Numero, 0 )
					.Fecha = GoLibrerias.ObtenerFechaFormateada( nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Fecha, ctod( '  /  /    ' ) ) )
					.Monedacomprobante_PK =  nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Monedacomprobante, [] )
					.Letraordendepago = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Letraordendepago, [] )
					.Impuestosmanuales = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Impuestosmanuales, .F. )
					.Puntodeventaordendepago = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Puntodeventaordendepago, 0 )
					.Numeroordendepago = nvl( c_COMPROBANTEDERETENCIONESGANANCIAS.Numeroordendepago, 0 )
				Catch To loError
					goServicios.Errores.LevantarExcepcion( loError )
				Finally
					.lCargando = .f.
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerIdPorClaveCandidata() as variant
		...
		lxRetorno = ''
		if this.ConsultarPorClaveCandidata()
			lxRetorno = c_COMPROBANTEDERETENCIONESGANANCIAS.CODIGO
		endif
		return lxRetorno
	endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerMemo( tcTabla as String ) as string
		...
		return c_COMPROBANTEDERETENCIONESGANANCIAS.&lcAtributo
	endfunc
				...
				SELECT nro,totalRegistros,CODIGO as Id
				    ...
				    CODIGO from (
							select * 
								...
								Where   COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'
									and <<tcFiltro>>
							 ) a
					 ) b
...
define class ObjetoBusqueda as custom
	Tabla = 'COMPRET'
	Filtro = " COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'"
	oEntidad = null
	cEstructura = ''
	cEstructuraDetalle = ''
	cEstructuraSinDetalle = ''
	listadecampos = ''
	Indice = " COMPRET.CODIGO != '' AND COMPRET.TIPOIMP= 'GANANCIAS'"
	AnchoCampo = 13
	Caracteres = 13
	nrodecolumnas = 0
	signopregunta = .T.
...
<VFPData xml:space="preserve">
	...
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="FECHAEXPO                               " tabla="COMPRET        " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="FECHAALTAFW                             " tabla="COMPRET        " campo="FALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha alta                                                                                                                                                      " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="FECHAMODIFICACIONFW                     " tabla="COMPRET        " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="FECHAIMPO                               " tabla="COMPRET        " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="FECHATRANSFERENCIA                      " tabla="COMPRET        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="PROVEEDOR                               " tabla="COMPRET        " campo="PROV      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Proveedor                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="TIMESTAMP                               " tabla="COMPRET        " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="ANULADO                                 " tabla="COMPRET        " campo="ANULADO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="14" etiqueta="Anulado                                                                                                                                                         " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="5" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="HORAALTAFW                              " tabla="COMPRET        " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="ZADSFW                                  " tabla="COMPRET        " campo="ZADSFW    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Acciones del sistema                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="HORAEXPO                                " tabla="COMPRET        " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="HORAMODIFICACIONFW                      " tabla="COMPRET        " campo="HMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora modificación                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="HORAIMPO                                " tabla="COMPRET        " campo="HORAIMPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora importación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="VERSIONALTAFW                           " tabla="COMPRET        " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPRET        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="SERIEALTAFW                             " tabla="COMPRET        " campo="SALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie alta                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="USUARIOMODIFICACIONFW                   " tabla="COMPRET        " campo="UMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Usuario modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="BASEDEDATOSMODIFICACIONFW               " tabla="COMPRET        " campo="BDMODIFW  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Base de datos modificación                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="VERSIONMODIFICACIONFW                   " tabla="COMPRET        " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="BASEDEDATOSALTAFW                       " tabla="COMPRET        " campo="BDALTAFW  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Base de datos alta                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="SERIEMODIFICACIONFW                     " tabla="COMPRET        " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="USUARIOALTAFW                           " tabla="COMPRET        " campo="UALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Usuario alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="PUNTODEVENTA                            " tabla="COMPRET        " campo="PTOVENTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="6" etiqueta="Número                                                                                                                                                          " dominio="NUMEROINTERNO                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="X999-9999999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="COMPROBANTESDETALLE                     " tabla="CRCOMPDET      " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="                                                                                                                                                                " dominio="DETALLEITEMCDRCOMPROBANTES    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="0" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="IMPUESTOSDETALLE                        " tabla="CRIMPDET       " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="DETALLEITEMCDRIMPUESTOS       " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="CODIGO                                  " tabla="COMPRET        " campo="CODIGO    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="0" etiqueta="Código                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="5" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="MONEDASISTEMA                           " tabla="COMPRET        " campo="MONSIS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Moneda Sistema                                                                                                                                                  " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="5" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="TIPOIMPUESTO                            " tabla="COMPRET        " campo="TIPOIMP   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPOIMPUESTO                            " tipodato="C         " longitud="10" decimales="0" valorsugerido="='GANANCIAS'                                                                                                                                                                                                                                                  " obligatorio="false" admitebusqueda="0" etiqueta="Tipo de impuesto                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="3" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="OBS                                     " tabla="COMPRET        " campo="OBS       " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Obs.                                                                                                                                                            " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="CALCULODETALLADO                        " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Cálculo                                                                                                                                                         " dominio="OBSERVACION18R                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="TOTAL                                   " tabla="COMPRET        " campo="CRTOTAL   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                           " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="5" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="FECHA                                   " tabla="COMPRET        " campo="FECHA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=GOLIBRERIAS.OBTENERFECHA()                                                                                                                                                                                                                                   " obligatorio="false" admitebusqueda="10" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="MONEDACOMPROBANTE                       " tabla="COMPRET        " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="16" etiqueta="Moneda                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="LETRAORDENDEPAGO                        " tabla="COMPRET        " campo="LETRAOP   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Orden de pago                                                                                                                                                   " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="X 9999-9999999999        " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="IMPUESTOSMANUALES                       " tabla="COMPRET        " campo="IMPMAN    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Cálculo manual                                                                                                                                                  " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="FORMADECALCULO                          " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Forma de cálculo                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="PUNTODEVENTAORDENDEPAGO                 " tabla="COMPRET        " campo="PTOVENOP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Orden de pago                                                                                                                                                   " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="X 9999-9999999999        " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COMPROBANTEDERETENCIONESGANANCIAS       " atributo="NUMEROORDENDEPAGO                       " tabla="COMPRET        " campo="NUMOP     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Orden de pago                                                                                                                                                   " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="X 9999-9999999999        " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
