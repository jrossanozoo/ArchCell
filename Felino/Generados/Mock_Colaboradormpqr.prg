...
define class Mock_COLABORADORMPQR as MockBase of MockBase.prg

	cClase = 'COLABORADORMPQR'
	...
	*-----------------------------------------------------------------------------------------
	    function cargarmensajedeerrordetransaccion( toentidad as object, tlesdevolucion as boolean ) as void                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toentidad
		lxParam2 = tlesdevolucion
