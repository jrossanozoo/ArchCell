...
define class Mock_comportamientocodigosugeridoentidad as MockBase of MockBase.prg
	...
	cClase = 'comportamientocodigosugeridoentidad'
	...
	*-----------------------------------------------------------------------------------------
	function anchoasugerir_despuesdeasignar() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Anchoasugerir_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function anchodisponible_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'anchodisponible_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'anchodisponible_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Anchodisponible		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Anchodisponible( lxVal )				this.Setear_Anchodisponible( lxVal )			EndIf		Else			This.Setear_Anchodisponible( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function completardescripciondeentidades() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Completardescripciondeentidades', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descripciondelaentidad_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descripciondelaentidad_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descripciondelaentidad_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Descripciondelaentidad		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Descripciondelaentidad( lxVal )				this.Setear_Descripciondelaentidad( lxVal )			EndIf		Else			This.Setear_Descripciondelaentidad( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoactualizar_anchoasugerir() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoactualizar_anchoasugerir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoasignarvaloraatributo( tcatributo as string, tvvalor as variant  ) as void                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Eventoasignarvaloraatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocodigosugeridoconerror() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocodigosugeridoconerror', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventocodigosugeridovalido() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocodigosugeridovalido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idglobal_despuesdeasignar() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Idglobal_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function prefijoentidad_despuesdeasignar() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Prefijoentidad_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_anchoasugerir( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_anchoasugerir', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_anchoasugerir', lcParametros )			endif		endif		this.Anchoasugerir = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_anchodisponible( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_anchodisponible', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_anchodisponible', lcParametros )			endif		endif		this.Anchodisponible = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_busquedaextendida( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_busquedaextendida', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_busquedaextendida', lcParametros )			endif		endif		this.Busquedaextendida = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_descripciondelaentidad( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_descripciondelaentidad', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_descripciondelaentidad', lcParametros )			endif		endif		this.Descripciondelaentidad = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_entidad( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_entidad', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_entidad', lcParametros )			endif		endif		if this.EsNuevo()			this.CargarAnchoDisponible()			this.AnchoASugerir = 0			this.CargarAnchoAsugerir()			this.CargarDescripcionDeLaEntidad()		endif
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_prefijoentidad( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_prefijoentidad', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_prefijoentidad', lcParametros )			endif		endif		this.Prefijoentidad = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_salta( txval as variant ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_salta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_salta', lcParametros )			endif		endif		this.Salta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_sugerir( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_sugerir', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_sugerir', lcParametros )			endif		endif		this.Sugerir = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_usarprefijobasededatos( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_usarprefijobasededatos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_usarprefijobasededatos', lcParametros )			endif		endif		this.Usarprefijobasededatos = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_vistaprevia( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_vistaprevia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_vistaprevia', lcParametros )			endif		endif		this.Vistaprevia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sugerir_assign( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'sugerir_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'sugerir_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Sugerir		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Sugerir( lxVal )				this.Setear_Sugerir( lxVal )				 This.Sugerir_DespuesDeAsignar()			EndIf		Else			This.Setear_Sugerir( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sugerir_despuesdeasignar() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Sugerir_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function usarprefijobasededatos_despuesdeasignar() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Usarprefijobasededatos_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_anchoasugerir( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_anchoasugerir', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_anchoasugerir', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if txVal > This.AnchoDisponible			goServicios.Errores.LevantarExcepcion( 'El ancho a sugerir no puede ser mayor al ancho disponible.' )		endif				return llRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_anchodisponible( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_anchodisponible', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_anchodisponible', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_busquedaextendida( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_busquedaextendida', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_busquedaextendida', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_descripciondelaentidad( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descripciondelaentidad', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descripciondelaentidad', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_prefijoentidad( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_prefijoentidad', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_prefijoentidad', lcParametros )			endif		endif		local llRetorno as Boolean				llRetorno = dodefault( txVal )		if llRetorno			if this.validarIngreso( txVal, .f. )			else				if this.lPermiteMinusculasPK				else					goServicios.Errores.LevantarExcepcion( 'Caracter inválido en el código.' )				endif			endif		endif		return llRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_salta( txval as variant ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_salta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_salta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_sugerir( txval as variant ) as boolean                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_sugerir', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_sugerir', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_usarprefijobasededatos( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_usarprefijobasededatos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_usarprefijobasededatos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_vistaprevia( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_vistaprevia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_vistaprevia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoanchoasugerir() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridoanchoasugerir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridobusquedaextendida() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridobusquedaextendida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwbusquedaextendida() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwbusquedaextendida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwsugerir() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwsugerir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoidglobal() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoidglobal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoprefijoentidad() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridoprefijoentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosalta() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridosalta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosugerir() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridosugerir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridousarprefijobasededatos() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridousarprefijobasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function vistaprevia_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'vistaprevia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'vistaprevia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Vistaprevia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Vistaprevia( lxVal )				this.Setear_Vistaprevia( lxVal )			EndIf		Else			This.Setear_Vistaprevia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function blanquearopciones() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Blanquearopciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargaranchoasugerir() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargaranchoasugerir', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargaranchodisponible() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargaranchodisponible', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargarcursordefuncionalidades( tcentidad as string ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cargarcursordefuncionalidades', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargardescripciondelaentidad() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargardescripciondelaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarvistaprevia() as string                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarvistaprevia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function habilitardeshabilitaropciones() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitaropciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function habilitardeshabilitaropcionesygenerarvistaprevia() as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitaropcionesygenerarvistaprevia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdescripciondelaentidad( tcentidad as string ) as string                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerdescripciondelaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearvalorenatributoignorandogenhabilitar( tcatributo as string, tvvalor as variant ) as void                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Setearvalorenatributoignorandogenhabilitar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validar_idglobal( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPORTAMIENTOCODIGOSUGERIDOENTIDAD' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idglobal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idglobal', lcParametros )			endif		endif		local llRetorno as Boolean, lnLongitudMaximaDeIdentificadorGlobal as Integer		lnLongitudMaximaDeIdentificadorGlobal = goServicios.Librerias.ObtenerLongitudMaximaDeIdentificadorGlobal()		llRetorno = dodefault( txVal )		if llRetorno and txVal and this.AnchoDisponible < lnLongitudMaximaDeIdentificadorGlobal			this.IdGlobal = .f.			this.EventoAsignarValorAAtributo( "IdGlobal", .f. )			goServicios.Errores.LevantarExcepcion( "No es posible utilizar el formato para centralización en entidades cuyo ancho disponible es menor a " + transform( lnLongitudMaximaDeIdentificadorGlobal ) + "." )		endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validaranchoasugerir() as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaranchoasugerir', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validaranchosugeridoyprefijos() as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaranchosugeridoyprefijos', lcParametros )
	EndFunc
