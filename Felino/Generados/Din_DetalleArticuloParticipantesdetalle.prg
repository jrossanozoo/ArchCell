...
define class Din_DetalleARTICULOParticipantesdetalle as detalle of detalle.prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Participantesdetalle' ) > 0 and reccount( 'c_Participantesdetalle' ) > 0
					sum Cantidad;
						 to ;
						 lnSum_Cantidad
				endif
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'ItemARTICULOParticipantesdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Participantesdetalle
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Participantesdetalle.Codigo
			loItem.Comportamiento = c_Participantesdetalle.Comportamiento
			loItem.NROITEM = c_Participantesdetalle.NROITEM
			loItem.BLOQUEARREGISTRO = c_Participantesdetalle.BLOQUEARREGISTRO
			loItem.Articulo_PK = c_Participantesdetalle.Articulo
			loItem.ArticuloDetalle = c_Participantesdetalle.ArticuloDetalle
			loItem.Color_PK = c_Participantesdetalle.Color
			loItem.ColorDetalle = c_Participantesdetalle.ColorDetalle
			loItem.Talle = c_Participantesdetalle.Talle
			loItem.Cantidad = c_Participantesdetalle.Cantidad
			loItem.NroItem = lnI 
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarExistenciaCamposFijosItemPlano( tnItem as integer ) as Boolean
		...
		if  empty( this.item[ tnItem ].Articulo_PK ) or ; 			 empty( this.item[ tnItem ].Cantidad ) 
			llRetorno = .F.
		endif 
		return llRetorno
