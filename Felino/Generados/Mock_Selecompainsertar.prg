...
define class Mock_selecompainsertar as MockBase of MockBase.prg
	...
	Codigo = ""                                                                                                                                                                                                                                               
	DetalleComprobantesAInsertar = null                                                                                                                                                                                                                       
	ESTADOTRANSFERENCIA = ""                                                                                                                                                                                                                                  
	FECHAALTAFW = ctod( '  /  /    ' )                                                                                                                                                                                                                        
	FECHAEXPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	FECHAIMPO = ctod( '  /  /    ' )                                                                                                                                                                                                                          
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Selección de comprobantes"                                                                                                                                                                                                               
	...
	cXMLComprobantesPendientes = ""                                                                                                                                                                                                                           
	cXMLComprobantesSeleccionados = ""                                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallecomprobantesainsertar() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallecomprobantesainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarcomprobantesseleccionados( tcaccion as string ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cargarcomprobantesseleccionados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detallecomprobantesainsertar_access() as variant                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SELECOMPAINSERTAR' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallecomprobantesainsertar_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallecomprobantesainsertar_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallecomprobantesainsertar ) = 'O' or isnull( this.Detallecomprobantesainsertar ) )			this.Detallecomprobantesainsertar = this.crearobjeto( 'Din_DetalleSelecompainsertarDetallecomprobantesainsertar' )			this.Detallecomprobantesainsertar.inicializar()			this.enlazar( 'Detallecomprobantesainsertar.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallecomprobantesainsertar.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallecomprobantesainsertar, 'CambioSumarizado', this, 'CambiosDetalleDetallecomprobantesainsertar', 1)			this.enlazar( 'Detallecomprobantesainsertar.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallecomprobantesainsertar.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detallecomprobantesainsertar
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarcomprobantespendientes() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcomprobantespendientes', lcParametros )
	EndFunc
