...
define class Din_EntidadSCRIPTAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxScriptFecexpo, lxScriptFectrans, lxScriptFmodifw, lxScriptFaltafw, lxScriptFecimpo, lxScriptTimestamp, lxScriptBloqreg, lxScriptUaltafw, lxScriptSmodifw, lxScriptSaltafw, lxScriptValtafw, lxScriptZadsfw, lxScriptHmodifw, lxScriptVmodifw, lxScriptUmodifw, lxScriptHaltafw, lxScriptHoraimpo, lxScriptBdmodifw, lxScriptBdaltafw, lxScriptEsttrans, lxScriptHoraexpo, lxScriptCodigo, lxScriptObs, lxScriptDescrip, lxScriptUsuario, lxScriptSucursal, lxScriptRutades, lxScriptVermens, lxScriptArchivo
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.SCRIPT ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Timestamp","Bloqreg","Ualtafw","Smodifw","Saltafw","Valtafw","Zadsfw","Hmodifw","Vmodifw","Umodifw","Haltafw","Horaimpo","Bdmodifw","Bdaltafw","Esttrans","Horaexpo","Codigo","Obs","Descrip","Usuario","Sucursal","Rutades","Vermens","Archivo" ) values ( <<"'" + this.ConvertirDateSql( lxScriptFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxScriptFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxScriptFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxScriptFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxScriptFecimpo ) + "'" >>, <<lxScriptTimestamp >>, <<iif( lxScriptBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxScriptUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptUsuario ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptSucursal ) + "'" >>, <<"'" + this.FormatearTextoSql( lxScriptRutades ) + "'" >>, <<iif( lxScriptVermens, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxScriptArchivo ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.Instrucciones
				if this.oEntidad.Instrucciones.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETALLESCRIPT("NROITEM","BLOQREG","INSTRUC","DET_INS" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxInstruccion ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.SCRIPT set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxScriptFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxScriptFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxScriptFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxScriptFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxScriptFecimpo ) + "'">>,"Timestamp" = <<lxScriptTimestamp>>,"Bloqreg" = <<iif( lxScriptBloqreg, 1, 0 )>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxScriptUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxScriptSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxScriptSaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxScriptValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxScriptZadsfw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxScriptHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxScriptVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxScriptUmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxScriptHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxScriptHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxScriptBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxScriptBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxScriptEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxScriptHoraexpo ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxScriptCodigo ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxScriptObs ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxScriptDescrip ) + "'">>,"Usuario" = <<"'" + this.FormatearTextoSql( lxScriptUsuario ) + "'">>,"Sucursal" = <<"'" + this.FormatearTextoSql( lxScriptSucursal ) + "'">>,"Rutades" = <<"'" + this.FormatearTextoSql( lxScriptRutades ) + "'">>,"Vermens" = <<iif( lxScriptVermens, 1, 0 )>>,"Archivo" = <<"'" + this.FormatearTextoSql( lxScriptArchivo ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxScriptCodigo ) + "'">> and  SCRIPT.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
			this.ComprobarResultadoDeEjecucionDelUpdate()
		this.ComprobarTransaccion()
			this.oConexion.EjecutarSql( 'delete from ORGANIZACION.DETALLESCRIPT where "DET_INS" = ' + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Obs" as "Observaciones", "Descrip" as "Descripcion", "Usuario" as "Usuario", "Sucursal" as "Basededatos", "Rutades" as "Rutadestino", "Vermens" as "Visualizarmensajes", "Archivo" as "Nombrearchivo" from ORGANIZACION.SCRIPT where "Codigo" = <<"'" + this.FormatearTextoSql( lxScriptCodigo ) + "'">> and  SCRIPT.CODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Instruc" as "Instruccion", "Det_ins" as "Codigo" from ORGANIZACION.DETALLESCRIPT where DET_INS = <<"'" + this.FormatearTextoSql( c_SCRIPT.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Obs" as "Observaciones", "Descrip" as "Descripcion", "Usuario" as "Usuario", "Sucursal" as "Basededatos", "Rutades" as "Rutadestino", "Vermens" as "Visualizarmensajes", "Archivo" as "Nombrearchivo" from ORGANIZACION.SCRIPT where  SCRIPT.CODIGO != '' order by CODIGO
			endtext
			use in select('c_SCRIPT')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SCRIPT', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Obs" as "Observaciones", "Descrip" as "Descripcion", "Usuario" as "Usuario", "Sucursal" as "Basededatos", "Rutades" as "Rutadestino", "Vermens" as "Visualizarmensajes", "Archivo" as "Nombrearchivo" from ORGANIZACION.SCRIPT where  funciones.padr( CODIGO, 20, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  SCRIPT.CODIGO != '' order by CODIGO
			endtext
			use in select('c_SCRIPT')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SCRIPT', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Obs" as "Observaciones", "Descrip" as "Descripcion", "Usuario" as "Usuario", "Sucursal" as "Basededatos", "Rutades" as "Rutadestino", "Vermens" as "Visualizarmensajes", "Archivo" as "Nombrearchivo" from ORGANIZACION.SCRIPT where  funciones.padr( CODIGO, 20, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  SCRIPT.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_SCRIPT')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SCRIPT', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Obs" as "Observaciones", "Descrip" as "Descripcion", "Usuario" as "Usuario", "Sucursal" as "Basededatos", "Rutades" as "Rutadestino", "Vermens" as "Visualizarmensajes", "Archivo" as "Nombrearchivo" from ORGANIZACION.SCRIPT where  SCRIPT.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_SCRIPT')
			this.oConexion.EjecutarSql( lcSentencia, 'c_SCRIPT', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Timestamp,Bloqreg,Ualtafw,Smodifw,Saltafw,Valtafw,Z" + ;
"adsfw,Hmodifw,Vmodifw,Umodifw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Codigo,Obs,Descri" + ;
"p,Usuario,Sucursal,Rutades,Vermens,Archivo" + ;
" from ORGANIZACION.SCRIPT where  SCRIPT.CODIGO != '' and " + lcFiltro )
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Obs" as "Observaciones", "Descrip" as "Descripcion", "Usuario" as "Usuario", "Sucursal" as "Basededatos", "Rutades" as "Rutadestino", "Vermens" as "Visualizarmensajes", "Archivo" as "Nombrearchivo"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleInstrucciones( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		Local lcAtributos As String, lcWhere As String
		lcWhere = " Where  DETALLESCRIPT.DET_INS != ''"
		lcAtributos = tcAtributos
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Instruc" as "Instruccion", "Det_ins" as "Codigo"
				endtext
			Else
				lcAtributos = This.ObtenerCamposSelectDetalleInstrucciones( tcAtributos )
			endif
		endif
		return this.ObtenerDatos( lcAtributos, tcHaving, tcOrder, tcFunc, lcWhere, 'DETALLESCRIPT', 'Instrucciones', tnTope )
	Endfunc
		...
		With this
			...
			for each loItem in this.oEntidad.Instrucciones
				if this.oEntidad.Instrucciones.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxInstruccion = loItem.Instruccion
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETALLESCRIPT("NROITEM","BLOQREG","INSTRUC","DET_INS" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxInstruccion ) + "'">>, << lcValorClavePrimariaString >> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		loColeccion.cTabla = 'SCRIPT' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			loColeccion.Agregar([delete from ORGANIZACION.DETALLESCRIPT where "DET_INS" = ] + "'" + this.FormatearTextoSql( .oEntidad.CODIGO ) + "'")
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.SCRIPT set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"+ [, DESCRIP = ] + "'" + this.FormatearTextoSql( &lcCursor..DESCRIP ) + "'"+ [, USUARIO = ] + "'" + this.FormatearTextoSql( &lcCursor..USUARIO ) + "'"+ [, SUCURSAL = ] + "'" + this.FormatearTextoSql( &lcCursor..SUCURSAL ) + "'"+ [, RUTADES = ] + "'" + this.FormatearTextoSql( &lcCursor..RUTADES ) + "'"+ [, VERMENS = ] + Transform( iif( &lcCursor..VERMENS, 1, 0 ))+ [, ARCHIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..ARCHIVO ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, TIMESTAMP, BLOQREG, UALTAFW, SMODIFW, SALTAFW, VALTAFW, ZADSFW, HMODIFW, VMODIFW, UMODIFW, HALTAFW, HORAIMPO, BDMODIFW, BDALTAFW, ESTTRANS, HORAEXPO, CODIGO, OBS, DESCRIP, USUARIO, SUCURSAL, RUTADES, VERMENS, ARCHIVO
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DESCRIP ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..USUARIO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SUCURSAL ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..RUTADES ) + "'" + ',' + Transform( iif( &lcCursor..VERMENS, 1, 0 ))
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirDetalles() As Void
		...
		If lcCantRegistros > 0
			...
			this.oConexion.EjecutarSql( [Delete From ORGANIZACION.DETALLESCRIPT Where DET_INS] + lcIn  )
			endfor
			if llEjecutaEnTransaccion
				this.oConexion.EjecutarSQL( 'COMMIT TRANSACTION' )
			endif
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","BLOQREG","INSTRUC","DET_INS"
		endText
		this.oConexion.EjecutarSql( [Insert into ORGANIZACION.DETALLESCRIPT ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + Transform( iif( cDetallesExistentes.BLOQREG   , 1, 0 )) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.INSTRUC    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.DET_INS    ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.OBS = isnull( d.OBS, t.OBS ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.USUARIO = isnull( d.USUARIO, t.USUARIO ),t.SUCURSAL = isnull( d.SUCURSAL, t.SUCURSAL ),t.RUTADES = isnull( d.RUTADES, t.RUTADES ),t.VERMENS = isnull( d.VERMENS, t.VERMENS ),t.ARCHIVO = isnull( d.ARCHIVO, t.ARCHIVO )
					from ORGANIZACION.SCRIPT t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ORGANIZACION.SCRIPT(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Timestamp,Bloqreg,Ualtafw,Smodifw,Saltafw,Valtafw,Zadsfw,Hmodifw,Vmodifw,Umodifw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Codigo,Obs,Descrip,Usuario,Sucursal,Rutades,Vermens,Archivo)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.CODIGO,''),isnull( d.OBS,''),isnull( d.DESCRIP,''),isnull( d.USUARIO,''),isnull( d.SUCURSAL,''),isnull( d.RUTADES,''),isnull( d.VERMENS,0),isnull( d.ARCHIVO,'')
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion_DETALLESCRIPT( tcTablaTrabajo ) as String

		Text to lcCadena noshow textmerge
		CREATE TRIGGER ORGANIZACION.DELETE_TablaTrabajo_SCRIPT_DETALLESCRIPT
ON ORGANIZACION.TablaTrabajo_SCRIPT_DETALLESCRIPT
AFTER DELETE
As
Begin
Update t Set 
...
from ORGANIZACION.DETALLESCRIPT t inner join deleted d 
 on t.CODIGO = d.CODIGO
-- Fin Updates
insert into ORGANIZACION.DETALLESCRIPT
( 
"NROITEM",
"BLOQREG",
"INSTRUC",
...
d.INSTRUC,
d.DET_INS
From deleted d left join ORGANIZACION.DETALLESCRIPT pk 
 on d.CODIGO = pk.CODIGO
Where pk.CODIGO Is Null 
-- Fin Inserts
End
...
<VFPData xml:space="preserve">
	...
	<row entidad="SCRIPT                                  " atributo="FECHATRANSFERENCIA                      " tabla="SCRIPT         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SCRIPT                                  " atributo="ESTADOTRANSFERENCIA                     " tabla="SCRIPT         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SCRIPT                                  " atributo="OBSERVACIONES                           " tabla="SCRIPT         " campo="OBS       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="201" etiqueta="                                                                                                                                                                " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
