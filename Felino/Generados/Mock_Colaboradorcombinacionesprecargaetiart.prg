...
define class Mock_COLABORADORCOMBINACIONESPRECARGAETIART as MockBase of MockBase.prg

	cClase = 'COLABORADORCOMBINACIONESPRECARGAETIART'

	
	cAtributosConcatenados = ""                                                                                                                                                                                                                               
	cCursorPartKits = ""                                                                                                                                                                                                                                      
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function cargardetalleparticipanteskits() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargardetalleparticipanteskits', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidadtotal( tccodigocontenedor as string, tccodorig as string ) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccodigocontenedor
		lxParam2 = tccodorig
		...
		return this.ObtenerResultado( 'Obtenercantidadtotal', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercombinacionesparticipantes() as string                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercombinacionesparticipantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reasignarcantidadesdekitsanidados( tccursorkitpack as string ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tccursorkitpack
		...
		return this.ObtenerResultado( 'Reasignarcantidadesdekitsanidados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ofactory_access as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ofactory_access As Void', lcParametros )
	EndFunc
