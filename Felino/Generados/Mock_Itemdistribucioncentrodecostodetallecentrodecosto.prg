...
define class Mock_Itemdistribucioncentrodecostodetallecentrodecosto as MockBase of MockBase.prg

	cClase = 'Itemdistribucioncentrodecostodetallecentrodecosto'
	...
	*-----------------------------------------------------------------------------------------
	function centrodecostodetalle_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Centrodecostodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_centrodecostodetalle( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setear_centrodecostodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_centrodecostodetalle( txval as variant ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validar_centrodecostodetalle', lcParametros )
	EndFunc
