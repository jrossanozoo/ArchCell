...
define class Mock_VALIDADORACEPTACIONDEVALORESTARJETADECREDITO as MockBase of MockBase.prg

	cClase = 'VALIDADORACEPTACIONDEVALORESTARJETADECREDITO'
	...
	*-----------------------------------------------------------------------------------------
	function oargumentoscomprobante_access() as variant                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Oargumentoscomprobante_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocupon_access() as variant                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Ocupon_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ovalidadoradapternet_access() as variant                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Ovalidadoradapternet_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function completarargumentoscomprobante() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Completarargumentoscomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerfechayhora( ldfecha ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerfechayhora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenervalores()as zoocoleccion                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenervalores', lcParametros )
	EndFunc
