...
define class Mock_pedidodecompra as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function crearitemtransferencia() as itemfiltrotransferencia of itemfiltrotransferencia.prg                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechaentrega() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechaentrega', lcParametros )
	EndFunc
