...
define class Din_EntidadCONCEPTOCAJAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxConcecajaFecexpo, lxConcecajaFectrans, lxConcecajaFecimpo, lxConcecajaFaltafw, lxConcecajaFmodifw, lxConcecajaTimestamp, lxConcecajaSmodifw, lxConcecajaSaltafw, lxConcecajaVmodifw, lxConcecajaUmodifw, lxConcecajaUaltafw, lxConcecajaHmodifw, lxConcecajaZadsfw, lxConcecajaValtafw, lxConcecajaHaltafw, lxConcecajaBdaltafw, lxConcecajaHoraimpo, lxConcecajaBdmodifw, lxConcecajaEsttrans, lxConcecajaHoraexpo, lxConcecajaCodigo, lxConcecajaCobs, lxConcecajaDescrip, lxConcecajaEstcheque, lxConcecajaTipo, lxConcecajaCajadest, lxConcecajaCtabanc
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CONCECAJA ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Timestamp","Smodifw","Saltafw","Vmodifw","Umodifw","Ualtafw","Hmodifw","Zadsfw","Valtafw","Haltafw","Bdaltafw","Horaimpo","Bdmodifw","Esttrans","Horaexpo","Codigo","Cobs","Descrip","Estcheque","Tipo","Cajadest","Ctabanc" ) values ( <<"'" + this.ConvertirDateSql( lxConcecajaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcecajaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcecajaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcecajaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConcecajaFmodifw ) + "'" >>, <<lxConcecajaTimestamp >>, <<"'" + this.FormatearTextoSql( lxConcecajaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaCobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConcecajaEstcheque ) + "'" >>, <<lxConcecajaTipo >>, <<lxConcecajaCajadest >>, <<"'" + this.FormatearTextoSql( lxConcecajaCtabanc ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CONCECAJA set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxConcecajaFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxConcecajaFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxConcecajaFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxConcecajaFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxConcecajaFmodifw ) + "'">>,"Timestamp" = <<lxConcecajaTimestamp>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxConcecajaSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxConcecajaUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaHmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxConcecajaZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxConcecajaValtafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxConcecajaHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxConcecajaBdaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxConcecajaHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxConcecajaEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxConcecajaHoraexpo ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxConcecajaCodigo ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxConcecajaCobs ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxConcecajaDescrip ) + "'">>,"Estcheque" = <<"'" + this.FormatearTextoSql( lxConcecajaEstcheque ) + "'">>,"Tipo" = <<lxConcecajaTipo>>,"Cajadest" = <<lxConcecajaCajadest>>,"Ctabanc" = <<"'" + this.FormatearTextoSql( lxConcecajaCtabanc ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxConcecajaCodigo ) + "'">> and  CONCECAJA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion", "Estcheque" as "Estadocheque", "Tipo" as "Tipo", "Cajadest" as "Cajadestino", "Ctabanc" as "Cuentabancaria" from ZooLogic.CONCECAJA where "Codigo" = <<"'" + this.FormatearTextoSql( lxConcecajaCodigo ) + "'">> and  CONCECAJA.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Timestamp,Smodifw,Saltafw,Vmodifw,Umodifw,Ualtafw,H" + ;
"modifw,Zadsfw,Valtafw,Haltafw,Bdaltafw,Horaimpo,Bdmodifw,Esttrans,Horaexpo,Codigo,Cobs,Descrip,Estch" + ;
"eque,Tipo,Cajadest,Ctabanc" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Codigo" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion", "Estcheque" as "Estadocheque", "Tipo" as "Tipo", "Cajadest" as "Cajadestino", "Ctabanc" as "Cuentabancaria"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.CONCECAJA set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxConcecajaFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxConcecajaFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxConcecajaFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxConcecajaFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxConcecajaFmodifw ) + "'">>, "Timestamp" = <<lxConcecajaTimestamp>>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxConcecajaSaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaVmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaUmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxConcecajaUaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaHmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxConcecajaZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxConcecajaValtafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxConcecajaHaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxConcecajaBdaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxConcecajaHoraimpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxConcecajaBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxConcecajaEsttrans ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxConcecajaHoraexpo ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxConcecajaCodigo ) + "'">>, "Cobs" = <<"'" + this.FormatearTextoSql( lxConcecajaCobs ) + "'">>, "Descrip" = <<"'" + this.FormatearTextoSql( lxConcecajaDescrip ) + "'">>, "Estcheque" = <<"'" + this.FormatearTextoSql( lxConcecajaEstcheque ) + "'">>, "Tipo" = <<lxConcecajaTipo>>, "Cajadest" = <<lxConcecajaCajadest>>, "Ctabanc" = <<"'" + this.FormatearTextoSql( lxConcecajaCtabanc ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'CONCECAJA' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CONCECAJA set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, CObs = ] + "'" + this.FormatearTextoSql( &lcCursor..CObs ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, estcheque = ] + "'" + this.FormatearTextoSql( &lcCursor..estcheque ) + "'"+ [, Tipo = ] + transform( &lcCursor..Tipo )+ [, CajaDest = ] + transform( &lcCursor..CajaDest )+ [, CtaBanc = ] + "'" + this.FormatearTextoSql( &lcCursor..CtaBanc ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, TIMESTAMP, SMODIFW, SALTAFW, VMODIFW, UMODIFW, UALTAFW, HMODIFW, ZADSFW, VALTAFW, HALTAFW, BDALTAFW, HORAIMPO, BDMODIFW, ESTTRANS, HORAEXPO, Codigo, CObs, Descrip, estcheque, Tipo, CajaDest, CtaBanc
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..estcheque ) + "'" + ',' + transform( &lcCursor..Tipo ) + ',' + transform( &lcCursor..CajaDest ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CtaBanc ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.COBS = isnull( d.COBS, t.COBS ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.ESTCHEQUE = isnull( d.ESTCHEQUE, t.ESTCHEQUE ),t.TIPO = isnull( d.TIPO, t.TIPO ),t.CAJADEST = isnull( d.CAJADEST, t.CAJADEST ),t.CTABANC = isnull( d.CTABANC, t.CTABANC )
					from ZooLogic.CONCECAJA t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.CONCECAJA(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Timestamp,Smodifw,Saltafw,Vmodifw,Umodifw,Ualtafw,Hmodifw,Zadsfw,Valtafw,Haltafw,Bdaltafw,Horaimpo,Bdmodifw,Esttrans,Horaexpo,Codigo,Cobs,Descrip,Estcheque,Tipo,Cajadest,Ctabanc)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.CODIGO,''),isnull( d.COBS,''),isnull( d.DESCRIP,''),isnull( d.ESTCHEQUE,''),isnull( d.TIPO,0),isnull( d.CAJADEST,0),isnull( d.CTABANC,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CONCEPTOCAJA                            " atributo="FECHATRANSFERENCIA                      " tabla="CONCECAJA      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONCEPTOCAJA                            " atributo="ESTADOTRANSFERENCIA                     " tabla="CONCECAJA      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONCEPTOCAJA                            " atributo="DESCRIPCION                             " tabla="CONCECAJA      " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="4" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CONCEPTOCAJA                            " atributo="ESTADOCHEQUE                            " tabla="CONCECAJA      " campo="ESTCHEQUE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="6" etiqueta="Estado                                                                                                                                                          " dominio="COMBOSERVICIOESTADOCHEQUE     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONCEPTOCAJA                            " atributo="CAJADESTINO                             " tabla="CONCECAJA      " campo="CAJADEST  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CAJAESTADO                              " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Sugerir caja destino                                                                                                                                            " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CONCEPTOCAJA                            " atributo="CUENTABANCARIA                          " tabla="CONCECAJA      " campo="CTABANC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CUENTABANCARIA                          " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Cuenta bancaria                                                                                                                                                 " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CAJAESTADO                              " atributo="DESCRIPCION                             " tabla="CAJAESTA       " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="403" etiqueta="Detalle Sug.                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CAJAESTA On CONCECAJA.CAJADEST = CAJAESTA.NumCaja And  CAJAESTA.NUMCAJA != 0                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
