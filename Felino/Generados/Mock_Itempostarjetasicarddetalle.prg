...
define class Mock_Itempostarjetasicarddetalle as MockBase of MockBase.prg

	cClase = 'Itempostarjetasicarddetalle'
	...
	*-----------------------------------------------------------------------------------------
	function autorizador_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Autorizador_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numeroequivalencia_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Numeroequivalencia_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_autorizador( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_autorizador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numeroequivalencia( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_numeroequivalencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_autorizador( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_autorizador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numeroequivalencia( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_numeroequivalencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoautorizador() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridoautorizador', lcParametros )
	EndFunc
