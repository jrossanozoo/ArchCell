...
define class Mock_stockcombinacion as MockBase of MockBase.prg
	...
	cAtributoPK = ""                                                                                                                                                                                                                                          
	cAtributoVendedor = ''                                                                                                                                                                                                                                    
	cAtributosCombinacion  = "Articulo,Color,Talle"                                                                                                                                                                                                           
	cAtributosDeStock = NULL                                                                                                                                                                                                                                  
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Stock combinacion"                                                                                                                                                                                                                       
	...
	*-----------------------------------------------------------------------------------------
	function delegareventosetearcantidaddisponibleenagrupamiento() as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Delegareventosetearcantidaddisponibleenagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descripcioncomprobante_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descripcioncomprobante_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descripcioncomprobante_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Descripcioncomprobante		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Descripcioncomprobante( lxVal )				this.Setear_Descripcioncomprobante( lxVal )			EndIf		Else			This.Setear_Descripcioncomprobante( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventosetearcantidaddisponibleenagrupamientocombinacion( toitem as object ) as void                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventosetearcantidaddisponibleenagrupamientocombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function excepcionnohaystock() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Excepcionnohaystock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function incorporastockdepedidosdecompras() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Incorporastockdepedidosdecompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function maxreposicion_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'maxreposicion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'maxreposicion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Maxreposicion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Maxreposicion( lxVal )				this.Setear_Maxreposicion( lxVal )			EndIf		Else			This.Setear_Maxreposicion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function minreposicion_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'minreposicion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'minreposicion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Minreposicion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Minreposicion( lxVal )				this.Setear_Minreposicion( lxVal )			EndIf		Else			This.Setear_Minreposicion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modificarsinbuscarycargar() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Modificarsinbuscarycargar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributosauditoria( ) as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obteneratributosauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidadoriginal( ) as integer                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercantidadoriginal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciassql( tlesnuevo as boolean ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenersentenciassql', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstock( toitem ) as integer                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerstock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerstockporcombinacion( tcfiltros as string ) as string                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerstockporcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descripcioncomprobante( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_descripcioncomprobante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_descripcioncomprobante', lcParametros )			endif		endif		this.Descripcioncomprobante = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_diferenciaentrestockycantidadcomb( txval as variant ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_diferenciaentrestockycantidadcomb', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_diferenciaentrestockycantidadcomb', lcParametros )			endif		endif		this.Diferenciaentrestockycantidadcomb = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_diferenciaentrestockyreposicion( txval as variant ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_diferenciaentrestockyreposicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_diferenciaentrestockyreposicion', lcParametros )			endif		endif		this.Diferenciaentrestockyreposicion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_maxreposicion( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_maxreposicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_maxreposicion', lcParametros )			endif		endif		this.Maxreposicion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_minreposicion( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_minreposicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_minreposicion', lcParametros )			endif		endif		this.Minreposicion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descripcioncomprobante( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descripcioncomprobante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descripcioncomprobante', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_diferenciaentrestockycantidadcomb( txval as variant ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_diferenciaentrestockycantidadcomb', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_diferenciaentrestockycantidadcomb', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_diferenciaentrestockyreposicion( txval as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_diferenciaentrestockyreposicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_diferenciaentrestockyreposicion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_maxreposicion( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_maxreposicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_maxreposicion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_minreposicion( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'STOCKCOMBINACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_minreposicion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_minreposicion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcantidad() as boolean                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validarcantidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodiferenciaentrestockycantidadcomb() as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodiferenciaentrestockycantidadcomb', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridodiferenciaentrestockyreposicion() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodiferenciaentrestockyreposicion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificastockagrupamiento() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Verificastockagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function blanquearatributos()                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function noverificastock() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Noverificastock', lcParametros )
	EndFunc
