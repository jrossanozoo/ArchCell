...
define class Mock_Itemlistadospersonalizadossubtotaldetalle as MockBase of MockBase.prg

	cClase = 'Itemlistadospersonalizadossubtotaldetalle'
	...
	*-----------------------------------------------------------------------------------------
	function anchoformula_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Anchoformula_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function etiquetaformula_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Etiquetaformula_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lnuevapaginaantes_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Lnuevapaginaantes_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nsubtotal_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Nsubtotal_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_anchoformula( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_anchoformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_etiquetaformula( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_etiquetaformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_lnuevapaginaantes( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_lnuevapaginaantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nsubtotal( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_nsubtotal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_anchoformula( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_anchoformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_etiquetaformula( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_etiquetaformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_lnuevapaginaantes( txval as variant ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_lnuevapaginaantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nsubtotal( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_nsubtotal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoanchoformula() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridoanchoformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoetiquetaformula() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Valorsugeridoetiquetaformula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridolnuevapaginaantes() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridolnuevapaginaantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonsubtotal() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridonsubtotal', lcParametros )
	EndFunc
