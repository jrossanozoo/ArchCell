...
define class Mock_Itemcuponeshuerfanoscupones as MockBase of MockBase.prg

	cClase = 'Itemcuponeshuerfanoscupones'
	...
	*-----------------------------------------------------------------------------------------
	function incluido_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Incluido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pos_assign( txval as variant ) as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Pos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_incluido( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_incluido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_incluido( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_incluido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoincluido() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridoincluido', lcParametros )
	EndFunc
