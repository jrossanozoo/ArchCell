...
define class Din_EntidadNOTADEDEBITOELECTRONICADECREDITOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg

	cNombreCursor = 'c_NOTADEDEBITOELECTRONICADECREDITO'
	colSentencias = null
	cArchivoLogPrueba = '' 
	cRutaTablas = ''
	nReintentos = 3
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFecimpo, lxComprobantevFecexpo, lxComprobantevFmodifw, lxComprobantevFd2, lxComprobantevFectrans, lxComprobantevIdcaja, lxComprobantevFpodes1, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevFajxre, lxComprobantevMdcimpu, lxComprobantevTotalcant, lxComprobantevFactsec, lxComprobantevDesmntosi3, lxComprobantevDesmntosi2, lxComprobantevSubtotcisi, lxComprobantevCondivalp, lxComprobantevSubtotsisi, lxComprobantevSignomov, lxComprobantevTimestamp, lxComprobantevSitfisccli, lxComprobantevDesmntosi1, lxComprobantevFsubtot, lxComprobantevFpodes2, lxComprobantevFacttipo, lxComprobantevFsubton, lxComprobantevRecmntosi, lxComprobantevRecmntosi1, lxComprobantevRecmntosi2, lxComprobantevDesmntosi, lxComprobantevNoper, lxComprobantevAnulado, lxComprobantevDesaut, lxComprobantevFcompfis, lxComprobantevOpecomm, lxComprobantevVmodifw, lxComprobantevZadsfw, lxComprobantevUaltafw, lxComprobantevValtafw, lxComprobantevSaltafw, lxComprobantevHmodifw, lxComprobantevSmodifw, lxComprobantevUmodifw, lxComprobantevBdaltafw, lxComprobantevHoraexpo, lxComprobantevIdajuste, lxComprobantevFhora, lxComprobantevDescfw, lxComprobantevFaltafw, lxComprobantevHaltafw, lxComprobantevBdmodifw, lxComprobantevHoraimpo, lxComprobantevSimbmon, lxComprobantevEsttrans, lxComprobantevMonsis, lxComprobantevMotdescdev, lxComprobantevIdvuelto, lxComprobantevFobs, lxComprobantevFcuit, lxComprobantevMd1, lxComprobantevFcliente, lxComprobantevFmtdes1, lxComprobantevFmtdes2, lxComprobantevCodigo, lxComprobantevReceptor, lxComprobantevFven, lxComprobantevTdci, lxComprobantevTotdescsi, lxComprobantevMoneda, lxComprobantevFletra, lxComprobantevCodlista, lxComprobantevEmail, lxComprobantevFptoven, lxComprobantevTotrecarsi, lxComprobantevTrci, lxComprobantevFvuelto, lxComprobantevFnumcomp, lxComprobantevFtotal, lxComprobantevFfch, lxComprobantevFmtdes3, lxComprobantevDeuda, lxComprobantevCotiz, lxComprobantevFpodes, lxComprobantevRecmnto2, lxComprobantevFdescu, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevRecmnto, lxComprobantevRecpor, lxComprobantevMr, lxComprobantevMr2, lxComprobantevMd2, lxComprobantevMr1, lxComprobantevRecmnto1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecar, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevIvasis, lxComprobantevTipocrela, lxComprobantevLetrarela, lxComprobantevPuntorela, lxComprobantevNumerorela, lxComprobantevFeccrela
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fecimpo","Fecexpo","Fmodifw","Fd2","Fectrans","Idcaja","Fpodes1","Fperson","Fturno","Fajxre","Mdcimpu","Totalcant","Factsec","Desmntosi3","Desmntosi2","Subtotcisi","Condivalp","Subtotsisi","Signomov","Timestamp","Sitfisccli","Desmntosi1","Fsubtot","Fpodes2","Facttipo","Fsubton","Recmntosi","Recmntosi1","Recmntosi2","Desmntosi","Noper","Anulado","Desaut","Fcompfis","Opecomm","Vmodifw","Zadsfw","Ualtafw","Valtafw","Saltafw","Hmodifw","Smodifw","Umodifw","Bdaltafw","Horaexpo","Idajuste","Fhora","Descfw","Faltafw","Haltafw","Bdmodifw","Horaimpo","Simbmon","Esttrans","Monsis","Motdescdev","Idvuelto","Fobs","Fcuit","Md1","Fcliente","Fmtdes1","Fmtdes2","Codigo","Receptor","Fven","Tdci","Totdescsi","Moneda","Fletra","Codlista","Email","Fptoven","Totrecarsi","Trci","Fvuelto","Fnumcomp","Ftotal","Ffch","Fmtdes3","Deuda","Cotiz","Fpodes","Recmnto2","Fdescu","Md3","Percepcion","Recmnto","Recpor","Mr","Mr2","Md2","Mr1","Recmnto1","Gravamen","Fimpuesto","Totrecar","Totdesc","Totimpue","Ivasis","Tipocrela","Letrarela","Puntorela","Numerorela","Feccrela" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<lxComprobantevIdcaja >>, <<lxComprobantevFpodes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<lxComprobantevFajxre >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevTotalcant >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevSignomov >>, <<lxComprobantevTimestamp >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevFsubtot >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevFacttipo >>, <<lxComprobantevFsubton >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevDesmntosi >>, <<iif( lxComprobantevNoper, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevDesaut, 1, 0 ) >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevMd1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<lxComprobantevTdci >>, <<lxComprobantevTotdescsi >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<lxComprobantevFptoven >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevTrci >>, <<lxComprobantevFvuelto >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFtotal >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevFmtdes3 >>, <<lxComprobantevDeuda >>, <<lxComprobantevCotiz >>, <<lxComprobantevFpodes >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevFdescu >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecpor >>, <<lxComprobantevMr >>, <<lxComprobantevMr2 >>, <<lxComprobantevMd2 >>, <<lxComprobantevMr1 >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<lxComprobantevIvasis >>, <<lxComprobantevTipocrela >>, <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'" >>, <<lxComprobantevPuntorela >>, <<lxComprobantevNumerorela >>, <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Idcaja" = <<lxComprobantevIdcaja>>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Fajxre" = <<lxComprobantevFajxre>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Totalcant" = <<lxComprobantevTotalcant>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Signomov" = <<lxComprobantevSignomov>>,"Timestamp" = <<lxComprobantevTimestamp>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Fsubton" = <<lxComprobantevFsubton>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Noper" = <<iif( lxComprobantevNoper, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Desaut" = <<iif( lxComprobantevDesaut, 1, 0 )>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Idajuste" = <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Motdescdev" = <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'">>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Receptor" = <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Tdci" = <<lxComprobantevTdci>>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Email" = <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'">>,"Fptoven" = <<lxComprobantevFptoven>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Trci" = <<lxComprobantevTrci>>,"Fvuelto" = <<lxComprobantevFvuelto>>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Ftotal" = <<lxComprobantevFtotal>>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Deuda" = <<lxComprobantevDeuda>>,"Cotiz" = <<lxComprobantevCotiz>>,"Fpodes" = <<lxComprobantevFpodes>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Fdescu" = <<lxComprobantevFdescu>>,"Md3" = <<lxComprobantevMd3>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Recpor" = <<lxComprobantevRecpor>>,"Mr" = <<lxComprobantevMr>>,"Mr2" = <<lxComprobantevMr2>>,"Md2" = <<lxComprobantevMd2>>,"Mr1" = <<lxComprobantevMr1>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Totrecar" = <<lxComprobantevTotrecar>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Ivasis" = <<lxComprobantevIvasis>>,"Tipocrela" = <<lxComprobantevTipocrela>>,"Letrarela" = <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'">>,"Puntorela" = <<lxComprobantevPuntorela>>,"Numerorela" = <<lxComprobantevNumerorela>>,"Feccrela" = <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function HayDatos() as boolean
		local llhaydatos as boolean, lcXml as String
			 lcXml = this.oConexion.EjecutarSql( "select Top 1 CODIGO from ZooLogic.COMPROBANTEV where " + this.ConvertirFuncionesSql( " COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56" ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Montobase" as "Montobase", "Minimoper" as "Minimo", "Porcen" as "Porcentaje", "Sirecert" as "Certificadosire", "Minoimp" as "Minimonoimponible", "Monto" as "Monto", "Nroitem" as "Nroitem", "Sirecs" as "Codseguridadsire", "Base" as "Basedecalculo", "Regimenimp" as "Regimenimpositivo", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Codimp" as "Codigoimpuesto", "Descri" as "Descripcion", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_NOTADEDEBITOELECTRONICADECREDITO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Signomov" as "Signodemovimiento", "Timestamp" as "Timestamp", "Sitfisccli" as "Situacionfiscal", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubtot" as "Subtotalbruto", "Fpodes2" as "Porcentajedescuento2", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Noper" as "Nocalculapercepcion", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Opecomm" as "Nroopecommerce", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Idajuste" as "Codigoajuste", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Simbmon" as "Simbolomonetariocomprobante", "Esttrans" as "Estadotransferencia", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 And FACTTIPO = <<lxCOMPROBANTEVFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFLETRA ) + "'">> and FPTOVEN = <<lxCOMPROBANTEVFPTOVEN>> and FNUMCOMP = <<lxCOMPROBANTEVFNUMCOMP>> and FACTSEC = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFACTSEC ) + "'">>
			endtext
			use in select('c_NOTADEDEBITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICADECREDITO', set( 'Datasession' ) )
			if reccount( 'c_NOTADEDEBITOELECTRONICADECREDITO' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	function VerificarExistenciaClavePrimaria( txVal as Variant ) as Boolean
		...
		lxComprobantevCodigo = txVal
			...
			text to lcSentencia textmerge noshow
				select count( * ) as CantidadDeRegistros from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Signomov" as "Signodemovimiento", "Timestamp" as "Timestamp", "Sitfisccli" as "Situacionfiscal", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubtot" as "Subtotalbruto", "Fpodes2" as "Porcentajedescuento2", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Noper" as "Nocalculapercepcion", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Opecomm" as "Nroopecommerce", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Idajuste" as "Codigoajuste", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Simbmon" as "Simbolomonetariocomprobante", "Esttrans" as "Estadotransferencia", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_NOTADEDEBITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fectrans" as "Fechatransferencia", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Desmntosi2" as "Montodescuentosinimpuestos2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Signomov" as "Signodemovimiento", "Timestamp" as "Timestamp", "Sitfisccli" as "Situacionfiscal", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubtot" as "Subtotalbruto", "Fpodes2" as "Porcentajedescuento2", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Noper" as "Nocalculapercepcion", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Opecomm" as "Nroopecommerce", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Idajuste" as "Codigoajuste", "Fhora" as "Hora", "Descfw" as "Descripcionfw", "Faltafw" as "Fechaaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Horaimpo" as "Horaimpo", "Simbmon" as "Simbolomonetariocomprobante", "Esttrans" as "Estadotransferencia", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Receptor" as "Receptor", "Fven" as "Vendedor", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Fptoven" as "Puntodeventa", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  funciones.dtos( FAltaFW ) + funciones.padr( HAltaFW, 8, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_NOTADEDEBITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fecexpo,Fmodifw,Fd2,Fectrans,Idcaja,Fpodes1,Fperson,Fturno,Fajxre,Mdcimpu,Totalcant," + ;
"Factsec,Desmntosi3,Desmntosi2,Subtotcisi,Condivalp,Subtotsisi,Signomov,Timestamp,Sitfisccli,Desmntos" + ;
"i1,Fsubtot,Fpodes2,Facttipo,Fsubton,Recmntosi,Recmntosi1,Recmntosi2,Desmntosi,Noper,Anulado,Desaut,F" + ;
"compfis,Opecomm,Vmodifw,Zadsfw,Ualtafw,Valtafw,Saltafw,Hmodifw,Smodifw,Umodifw,Bdaltafw,Horaexpo,Ida" + ;
"juste,Fhora,Descfw,Faltafw,Haltafw,Bdmodifw,Horaimpo,Simbmon,Esttrans,Monsis,Motdescdev,Idvuelto,Fob" + ;
"s,Fcuit,Md1,Fcliente,Fmtdes1,Fmtdes2,Codigo,Receptor,Fven,Tdci,Totdescsi,Moneda,Fletra,Codlista,Emai" + ;
"l,Fptoven,Totrecarsi,Trci,Fvuelto,Fnumcomp,Ftotal,Ffch,Fmtdes3,Deuda,Cotiz,Fpodes,Recmnto2,Fdescu,Md" + ;
...
" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56 and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosEntidad( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		lcWhere = " Where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56"
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			lcFiltro = ["Codigo" = ] + lcValorClavePrimariaString  + [ and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56]
...
use in select( 'c_KITDETciditem' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerSentenciaActualizacionTimeStamp() As String
		...
		with this.oEntidad
			...
			lcRetorno = [update ZooLogic.COMPROBANTEV set TimeStamp = ] + transform( lnTimeStamp ) + lcUpdateRealTime + [ where CODIGO = ] + "'" + this.FormatearTextoSql( .Codigo ) + "'" + [ and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56] + goServicios.RealTime.ObtenerTagEstimulo( .cNombre )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerCantidadRegistros() as integer
		local lnCantReg as integer
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select count( * ) as Total from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerTimestampActual() as integer
		...
		lcCursor = sys(2015)
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select TimeStamp from ZooLogic.COMPROBANTEV where CODIGO = " + "'" + this.FormatearTextoSql( this.oEntidad.CODIGO ) + "'"+ " and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56" )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirCabecera( tlLoguear as Boolean ) As Void
		...
		lxValorClavePK = ''
		lcMensajeExtra = ''
		lcCursor = This.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO'
		select( lcCursor )
		scan all
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, noper = ] + Transform( iif( &lcCursor..noper, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, DESAUT = ] + Transform( iif( &lcCursor..DESAUT, 1, 0 ))+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, idAjuste = ] + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, MotDescDev = ] + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'"+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, Receptor = ] + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, MR = ] + transform( &lcCursor..MR )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, IvaSis = ] + transform( &lcCursor..IvaSis )+ [, TipoCRela = ] + transform( &lcCursor..TipoCRela )+ [, letraRela = ] + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'"+ [, puntoRela = ] + transform( &lcCursor..puntoRela )+ [, numeroRela = ] + transform( &lcCursor..numeroRela )+ [, FecCRela = ] + "'" + this.ConvertirDateSql( &lcCursor..FecCRela ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECEXPO, FMODIFW, FD2, FECTRANS, IdCaja, FPODES1, FPerson, FTurno, FAjXRe, MDCIMPU, TotalCant, FACTSEC, DesMntoSI3, DesMntoSI2, SubTotCISI, CondivaLp, SubTotSISI, signomov, TIMESTAMP, SitFiscCli, DesMntoSI1, FSubTOT, FPODES2, FACTTIPO, fSubToN, RecMntoSI, RecMntoSI1, RecMntoSI2, DesMntoSI, noper, Anulado, DESAUT, FCOMPFIS, OPEcomm, VMODIFW, ZADSFW, UALTAFW, VALTAFW, SALTAFW, HMODIFW, SMODIFW, UMODIFW, BDALTAFW, HORAEXPO, idAjuste, FHORA, DescFW, FAltaFW, HAltaFW, BDMODIFW, HORAIMPO, SimbMon, ESTTRANS, MonSis, MotDescDev, idVuelto, FObs, fCuit, MD1, FCLIENTE, FMTDES1, FMTDES2, CODIGO, Receptor, FVEN, TDCI, totdescSI, Moneda, FLETRA, CodLista, Email, FPTOVEN, totrecarSI, TRCI, FVuelto, FNUMCOMP, FTotal, FFCH, FMTDES3, Deuda, Cotiz, FPODES, RecMnto2, fDescu, MD3, percepcion, RecMnto, RecPor, MR, MR2, MD2, MR1, RecMnto1, gravamen, fImpuesto, totrecar, totdesc, totimpue, IvaSis, TipoCRela, letraRela, puntoRela, numeroRela, FecCRela
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FTurno ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..MDCIMPU ) + ',' + transform( &lcCursor..TotalCant ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..SubTotSISI )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMntoSI1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + Transform( iif( &lcCursor..noper, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..DESAUT, 1, 0 )) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + transform( &lcCursor..TDCI ) + ',' + transform( &lcCursor..totdescSI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + transform( &lcCursor..FPTOVEN )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..FTotal ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..FMTDES3 ) + ',' + transform( &lcCursor..Deuda ) + ',' + transform( &lcCursor..Cotiz ) + ',' + transform( &lcCursor..FPODES )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..fDescu ) + ',' + transform( &lcCursor..MD3 ) + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..RecPor ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..RecMnto1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..totdesc ) + ',' + transform( &lcCursor..totimpue ) + ',' + transform( &lcCursor..IvaSis ) + ',' + transform( &lcCursor..TipoCRela ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'" + ',' + transform( &lcCursor..puntoRela ) + ',' + transform( &lcCursor..numeroRela )
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirComponentes() As Void
		this.oEntidad.FacturaDetalle.oItem.oCompPrecios.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS',this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO')
		this.oEntidad.KitsDetalle.oItem.oCompPrecios.Recibir( this.oEntidad, 'KitsDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMKITS',this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO')
		this.oEntidad.FacturaDetalle.oItem.oCompStock.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS',this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO')
		this.oEntidad.KitsDetalle.oItem.oCompStock.Recibir( this.oEntidad, 'KitsDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMKITS',this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO')
		this.oEntidad.ValoresDetalle.oItem.oCompCajero.Recibir( this.oEntidad, 'ValoresDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMVALORES',this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO')
		this.oEntidad.FacturaDetalle.oItem.oCompGiftcard.Recibir( this.oEntidad, 'FacturaDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS',this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO')
		this.oEntidad.oCompEnBaseA.Recibir( this.oEntidad, 'FacturaDetalle', this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSVENTAS', this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICADECREDITO')
	...
	*--------------------------------------------------------------------------------------------------------
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			Case  lcAlias == lcPrefijo + 'NOTADEDEBITOELECTRONICADECREDITO'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'NOTADEDEBITOELECTRONICADECREDITO_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'NOTADEDEBITOELECTRONICADECREDITO_FOBS'
				llRetorno = .T.
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		lcCursor = This.oEntidad.cPrefijoImportar + 'NOTADEDEBITOELECTRONICADECREDITO'
		select( lcCursor )
		llRetorno = .T.
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad NOTADEDEBITOELECTRONICADECREDITO. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FD2 = isnull( d.FD2, t.FD2 ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.NOPER = isnull( d.NOPER, t.NOPER ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.DESAUT = isnull( d.DESAUT, t.DESAUT ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.RECEPTOR = isnull( d.RECEPTOR, t.RECEPTOR ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.MR = isnull( d.MR, t.MR ),t.MR2 = isnull( d.MR2, t.MR2 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.IVASIS = isnull( d.IVASIS, t.IVASIS ),t.TIPOCRELA = isnull( d.TIPOCRELA, t.TIPOCRELA ),t.LETRARELA = isnull( d.LETRARELA, t.LETRARELA ),t.PUNTORELA = isnull( d.PUNTORELA, t.PUNTORELA ),t.NUMERORELA = isnull( d.NUMERORELA, t.NUMERORELA ),t.FECCRELA = isnull( d.FECCRELA, t.FECCRELA )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fecimpo,Fecexpo,Fmodifw,Fd2,Fectrans,Idcaja,Fpodes1,Fperson,Fturno,Fajxre,Mdcimpu,Totalcant,Factsec,Desmntosi3,Desmntosi2,Subtotcisi,Condivalp,Subtotsisi,Signomov,Timestamp,Sitfisccli,Desmntosi1,Fsubtot,Fpodes2,Facttipo,Fsubton,Recmntosi,Recmntosi1,Recmntosi2,Desmntosi,Noper,Anulado,Desaut,Fcompfis,Opecomm,Vmodifw,Zadsfw,Ualtafw,Valtafw,Saltafw,Hmodifw,Smodifw,Umodifw,Bdaltafw,Horaexpo,Idajuste,Fhora,Descfw,Faltafw,Haltafw,Bdmodifw,Horaimpo,Simbmon,Esttrans,Monsis,Motdescdev,Idvuelto,Fobs,Fcuit,Md1,Fcliente,Fmtdes1,Fmtdes2,Codigo,Receptor,Fven,Tdci,Totdescsi,Moneda,Fletra,Codlista,Email,Fptoven,Totrecarsi,Trci,Fvuelto,Fnumcomp,Ftotal,Ffch,Fmtdes3,Deuda,Cotiz,Fpodes,Recmnto2,Fdescu,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Recmnto1,Gravamen,Fimpuesto,Totrecar,Totdesc,Totimpue,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela)
					Select isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FD2,''),isnull( d.FECTRANS,''),isnull( d.IDCAJA,0),isnull( d.FPODES1,0),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.FAJXRE,0),isnull( d.MDCIMPU,0),isnull( d.TOTALCANT,0),isnull( d.FACTSEC,''),isnull( d.DESMNTOSI3,0),isnull( d.DESMNTOSI2,0),isnull( d.SUBTOTCISI,0),isnull( d.CONDIVALP,0),isnull( d.SUBTOTSISI,0),isnull( d.SIGNOMOV,0),isnull( d.TIMESTAMP,0),isnull( d.SITFISCCLI,0),isnull( d.DESMNTOSI1,0),isnull( d.FSUBTOT,0),isnull( d.FPODES2,0),isnull( d.FACTTIPO,0),isnull( d.FSUBTON,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTOSI1,0),isnull( d.RECMNTOSI2,0),isnull( d.DESMNTOSI,0),isnull( d.NOPER,0),isnull( d.ANULADO,0),isnull( d.DESAUT,0),isnull( d.FCOMPFIS,0),isnull( d.OPECOMM,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.SALTAFW,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.IDAJUSTE,''),isnull( d.FHORA,''),isnull( d.DESCFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.SIMBMON,''),isnull( d.ESTTRANS,''),isnull( d.MONSIS,''),isnull( d.MOTDESCDEV,''),isnull( d.IDVUELTO,''),isnull( d.FOBS,''),isnull( d.FCUIT,''),isnull( d.MD1,0),isnull( d.FCLIENTE,''),isnull( d.FMTDES1,0),isnull( d.FMTDES2,0),isnull( d.CODIGO,''),isnull( d.RECEPTOR,''),isnull( d.FVEN,''),isnull( d.TDCI,0),isnull( d.TOTDESCSI,0),isnull( d.MONEDA,''),isnull( d.FLETRA,''),isnull( d.CODLISTA,''),isnull( d.EMAIL,''),isnull( d.FPTOVEN,0),isnull( d.TOTRECARSI,0),isnull( d.TRCI,0),isnull( d.FVUELTO,0),isnull( d.FNUMCOMP,0),isnull( d.FTOTAL,0),isnull( d.FFCH,''),isnull( d.FMTDES3,0),isnull( d.DEUDA,0),isnull( d.COTIZ,0),isnull( d.FPODES,0),isnull( d.RECMNTO2,0),isnull( d.FDESCU,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.RECMNTO,0),isnull( d.RECPOR,0),isnull( d.MR,0),isnull( d.MR2,0),isnull( d.MD2,0),isnull( d.MR1,0),isnull( d.RECMNTO1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECAR,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.IVASIS,0),isnull( d.TIPOCRELA,0),isnull( d.LETRARELA,''),isnull( d.PUNTORELA,0),isnull( d.NUMERORELA,0),isnull( d.FECCRELA,'')
...
End
	...
	*--------------------------------------------------------------------------------------------------------
	function Cargar() as Boolean
		...
		with this.oEntidad
			llRetorno = .T.
			if reccount( 'c_NOTADEDEBITOELECTRONICADECREDITO' ) < 1
				llRetorno = .F.
			else
				Try
					.lCargando = .t.
					...
					.Fechaimpo = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fechaimpo, ctod( '  /  /    ' ) ) )
					.Fechaexpo = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fechaexpo, ctod( '  /  /    ' ) ) )
					.Fechamodificacionfw = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fechamodificacionfw, ctod( '  /  /    ' ) ) )
					.Fechamodificacion = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fechamodificacion, ctod( '  /  /    ' ) ) )
					.Fechatransferencia = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fechatransferencia, ctod( '  /  /    ' ) ) )
					...
					.Caja_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Caja, 0 )
					.Porcentajedescuento1 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Porcentajedescuento1, 0 )
					.Cliente_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Cliente, [] )
					.Turno = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Turno, 0 )
					...
					.Compafec.Cargar()
					.Ajustesporredondeos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Ajustesporredondeos, 0 )
					.Montodescuentoconimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentoconimpuestos, 0 )
					.Totalcantidad = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totalcantidad, 0 )
					.Secuencia = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Secuencia, [] )
					.Montodescuentosinimpuestos3 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentosinimpuestos3, 0 )
					.Montodescuentosinimpuestos2 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentosinimpuestos2, 0 )
					.Subtotalconimpuestossobreitems = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Subtotalconimpuestossobreitems, 0 )
					.Condicioniva = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Condicioniva, 0 )
					.Subtotalsinimpuestossobreitems = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Subtotalsinimpuestossobreitems, 0 )
					.Signodemovimiento = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Signodemovimiento, 0 )
					.Timestamp = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Timestamp, 0 )
					.Situacionfiscal_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Situacionfiscal, 0 )
					.Montodescuentosinimpuestos1 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentosinimpuestos1, 0 )
					.Subtotalbruto = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Subtotalbruto, 0 )
					.Porcentajedescuento2 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Porcentajedescuento2, 0 )
					.Tipocomprobante = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Tipocomprobante, 0 )
					.Subtotalneto = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Subtotalneto, 0 )
					.Recargomontosinimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomontosinimpuestos, 0 )
					.Recargomontosinimpuestos1 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomontosinimpuestos1, 0 )
					.Recargomontosinimpuestos2 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomontosinimpuestos2, 0 )
					.Montodescuentosinimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentosinimpuestos, 0 )
					.Nocalculapercepcion = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Nocalculapercepcion, .F. )
					.Anulado = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Anulado, .F. )
					.Descuentoautomatico = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Descuentoautomatico, .F. )
					.Comprobantefiscal = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Comprobantefiscal, .F. )
					.Nroopecommerce = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Nroopecommerce, [] )
					.Versionmodificacionfw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Versionmodificacionfw, [] )
					lcValor = This.ObtenerMemo( 'c_Zadsfw')
					.Zadsfw = lcValor 
					.Usuarioaltafw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Usuarioaltafw, [] )
					.Versionaltafw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Versionaltafw, [] )
					.Seriealtafw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Seriealtafw, [] )
					.Horamodificacionfw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Horamodificacionfw, [] )
					.Seriemodificacionfw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Seriemodificacionfw, [] )
					.Usuariomodificacionfw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Usuariomodificacionfw, [] )
					.Basededatosaltafw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Basededatosaltafw, [] )
					.Horaexpo = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Horaexpo, [] )
					.Codigoajuste = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Codigoajuste, [] )
					.Hora = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Hora, [] )
					.Descripcionfw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Descripcionfw, [] )
					.Fechaaltafw = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fechaaltafw, ctod( '  /  /    ' ) ) )
					.Horaaltafw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Horaaltafw, [] )
					.Basededatosmodificacionfw = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Basededatosmodificacionfw, [] )
					.Horaimpo = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Horaimpo, [] )
					.Simbolomonetariocomprobante = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Simbolomonetariocomprobante, [] )
					.Estadotransferencia = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Estadotransferencia, [] )
					.Impuestoscomprobante.Limpiar()
					.Impuestoscomprobante.SetearEsNavegacion( .lProcesando )
					.Impuestoscomprobante.Cargar()
					.Monedasistema_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Monedasistema, [] )
					.Codigomotivodescuentoensubtotal_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Codigomotivodescuentoensubtotal, [] )
					.Idvuelto_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Idvuelto, [] )
					lcValor = This.ObtenerMemo( 'c_Obs')
					.Obs = lcValor 
					.Kitsdetalle.Limpiar()
					.Kitsdetalle.SetearEsNavegacion( .lProcesando )
					.Kitsdetalle.Cargar()
					.Cuit = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Cuit, [] )
					.Montodescuento1 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuento1, 0 )
					.Clientedescripcion = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Clientedescripcion, [] )
					.Montodescuentoconimpuestos1 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentoconimpuestos1, 0 )
					.Montodescuentoconimpuestos2 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentoconimpuestos2, 0 )
					.Codigo = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Codigo, [] )
					.Receptor_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Receptor, [] )
					.Vendedor_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Vendedor, [] )
					.Totaldescuentosconimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totaldescuentosconimpuestos, 0 )
					.Totaldescuentossinimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totaldescuentossinimpuestos, 0 )
					.Monedacomprobante_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Monedacomprobante, [] )
					.Letra = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Letra, [] )
					.Listadeprecios_PK =  nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Listadeprecios, [] )
					.Email = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Email, [] )
					.Puntodeventa = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Puntodeventa, 0 )
					.Totalrecargossinimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totalrecargossinimpuestos, 0 )
					.Totalrecargosconimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totalrecargosconimpuestos, 0 )
					.Vuelto = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Vuelto, 0 )
					.Numero = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Numero, 0 )
					.Total = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Total, 0 )
					.Fecha = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fecha, ctod( '  /  /    ' ) ) )
					.Montodescuentoconimpuestos3 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuentoconimpuestos3, 0 )
					.Deuda = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Deuda, 0 )
					.Cotizacion = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Cotizacion, 0 )
					.Porcentajedescuento = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Porcentajedescuento, 0 )
					.Recargomontoconimpuestos2 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomontoconimpuestos2, 0 )
					.Descuento = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Descuento, 0 )
					.Montodescuento3 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuento3, 0 )
					.Percepciones = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Percepciones, 0 )
					.Recargomontoconimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomontoconimpuestos, 0 )
					.Recargoporcentaje = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargoporcentaje, 0 )
					.Recargomonto = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomonto, 0 )
					.Recargomonto2 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomonto2, 0 )
					.Montodescuento2 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Montodescuento2, 0 )
					.Recargomonto1 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomonto1, 0 )
					.Recargomontoconimpuestos1 = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Recargomontoconimpuestos1, 0 )
					.Gravamenes = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Gravamenes, 0 )
					.Impuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Impuestos, 0 )
					.Totalrecargos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totalrecargos, 0 )
					.Totaldescuentos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totaldescuentos, 0 )
					.Totalimpuestos = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Totalimpuestos, 0 )
					.Ivadelsistema = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Ivadelsistema, 0 )
					.Tipocpterelacionado = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Tipocpterelacionado, 0 )
					.Letracpterelacionado = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Letracpterelacionado, [] )
					.Puntodeventacpterelacionado = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Puntodeventacpterelacionado, 0 )
					.Numerocpterelacionado = nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Numerocpterelacionado, 0 )
					.Fechacpterelacionado = GoLibrerias.ObtenerFechaFormateada( nvl( c_NOTADEDEBITOELECTRONICADECREDITO.Fechacpterelacionado, ctod( '  /  /    ' ) ) )
				Catch To loError
					goServicios.Errores.LevantarExcepcion( loError )
				Finally
					.lCargando = .f.
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerIdPorClaveCandidata() as variant
		...
		lxRetorno = ''
		if this.ConsultarPorClaveCandidata()
			lxRetorno = c_NOTADEDEBITOELECTRONICADECREDITO.CODIGO
		endif
		return lxRetorno
	endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerMemo( tcTabla as String ) as string
		...
		return c_NOTADEDEBITOELECTRONICADECREDITO.&lcAtributo
	endfunc
				...
				SELECT nro,totalRegistros,CODIGO as Id
				    ...
				    CODIGO from (
							select * 
								...
								Where   COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56
									and <<tcFiltro>>
							 ) a
					 ) b
...
define class ObjetoBusqueda as custom
	Tabla = 'COMPROBANTEV'
	Filtro = " COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56"
	oEntidad = null
	cEstructura = ''
	cEstructuraDetalle = ''
	cEstructuraSinDetalle = ''
	listadecampos = ''
	Indice = " COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 56"
	AnchoCampo = 13
	Caracteres = 13
	nrodecolumnas = 0
	signopregunta = .T.
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="FECHATRANSFERENCIA                      " tabla="COMPROBANTEV   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                                                                                                                       " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="PORCENTAJEDESCUENTO1                    " tabla="COMPROBANTEV   " campo="FPODES1   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje de descuento 1                                                                                                                                                                                                                                 " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="TOTALCANTIDAD                           " tabla="COMPROBANTEV   " campo="TOTALCANT " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="14" etiqueta="Total Cantidad                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="COMPROBANTEV   " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="PORCENTAJEDESCUENTO2                    " tabla="COMPROBANTEV   " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Porcentaje de descuento 2                                                                                                                                                                                                                                 " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="TIPOCOMPROBANTE                         " tabla="COMPROBANTEV   " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=56                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="18" etiqueta="Tipo de comprobante                                                                                                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="NOCALCULAPERCEPCION                     " tabla="COMPROBANTEV   " campo="NOPER     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="No calcula percepciones                                                                                                                                                                                                                                   " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="NROOPECOMMERCE                          " tabla="COMPROBANTEV   " campo="OPECOMM   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="HORAALTAFW                              " tabla="COMPROBANTEV   " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="=goservicios.librerias.obtenerHora()                                                                                                                                                                                                                          " obligatorio="false" admitebusqueda="0" etiqueta="Hora FW                                                                                                                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPROBANTEV   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="414" etiqueta="Moneda                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="PUNTODEVENTA                            " tabla="COMPROBANTEV   " campo="FPTOVEN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="4" etiqueta="Pto. venta                                                                                                                                                                                                                                                " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="3" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="VUELTO                                  " tabla="COMPROBANTEV   " campo="FVUELTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vuelto persistido                                                                                                                                                                                                                                         " dominio="VUELTO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                                                                                                                     " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="DEUDA                                   " tabla="COMPROBANTEV   " campo="DEUDA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Saldo de cta. cte.                                                                                                                                                                                                                                        " dominio="FECHASALDO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="COTIZACION                              " tabla="COMPROBANTEV   " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="424" etiqueta="Cotización                                                                                                                                                                                                                                                " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="PORCENTAJEDESCUENTO                     " tabla="COMPROBANTEV   " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Porcentaje de descuento                                                                                                                                                                                                                                   " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="RECARGOMONTO                            " tabla="COMPROBANTEV   " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="438" etiqueta="Recargo % monto                                                                                                                                                                                                                                           " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="42" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="RECARGOMONTO2                           " tabla="COMPROBANTEV   " campo="MR2       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="440" etiqueta="Recargo monto                                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="43" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="IMPUESTOS                               " tabla="COMPROBANTEV   " campo="FIMPUESTO " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="446" etiqueta="I.V.A.                                                                                                                                                                                                                                                    " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECAR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total recargo                                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuento                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="28" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="448" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICADECREDITO        " atributo="PUNTODEVENTACPTERELACIONADO             " tabla="COMPROBANTEV   " campo="PUNTORELA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="454" etiqueta="Pto. de venta comprobante asociado                                                                                                                                                                                                                        " dominio="COMPROBANTERELACIONADO        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="92" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
