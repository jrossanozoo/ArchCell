...
define class Mock_Itemimpuestoescaladetalle as MockBase of MockBase.prg

	cClase = 'Itemimpuestoescaladetalle'
	...
	*-----------------------------------------------------------------------------------------
	function mayora_assign( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Mayora_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_mayora( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_mayora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_sobreexcedente( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_sobreexcedente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sobreexcedente_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Sobreexcedente_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_mayora( txval as variant ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_mayora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_sobreexcedente( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_sobreexcedente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomayora() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridomayora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosobreexcedente() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridosobreexcedente', lcParametros )
	EndFunc
