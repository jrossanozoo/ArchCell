...
define class Din_DetallePAGOOrdendepago_valoresdetalle as detalle of detalle.prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Ordendepago_valoresdetalle' ) > 0 and reccount( 'c_Ordendepago_valoresdetalle' ) > 0
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemPAGOOrdendepago_valoresdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Ordendepago_valoresdetalle
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Ordendepago_valoresdetalle.Codigo
			loItem.Cotiza = c_Ordendepago_valoresdetalle.Cotiza
			loItem.FechaComp = goLibrerias.ObtenerFechaFormateada( c_Ordendepago_valoresdetalle.FechaComp )
			loItem.Letra = c_Ordendepago_valoresdetalle.Letra
			loItem.NroDocumento = c_Ordendepago_valoresdetalle.NroDocumento
			loItem.NroItem = c_Ordendepago_valoresdetalle.NroItem
			loItem.NumeroCheque_PK = c_Ordendepago_valoresdetalle.NumeroCheque
			loItem.NumeroCupon = c_Ordendepago_valoresdetalle.NumeroCupon
			loItem.NumeroTarjeta = c_Ordendepago_valoresdetalle.NumeroTarjeta
			loItem.NumerodeComprobante = c_Ordendepago_valoresdetalle.NumerodeComprobante
			loItem.PesosAlCambio = c_Ordendepago_valoresdetalle.PesosAlCambio
			loItem.PuntoDeVenta = c_Ordendepago_valoresdetalle.PuntoDeVenta
			loItem.Signo = c_Ordendepago_valoresdetalle.Signo
			loItem.Tipo = c_Ordendepago_valoresdetalle.Tipo
			loItem.TipoDocumento = c_Ordendepago_valoresdetalle.TipoDocumento
			loItem.TipodeComprobante = c_Ordendepago_valoresdetalle.TipodeComprobante
			loItem.Turno = c_Ordendepago_valoresdetalle.Turno
			loItem.Valor_PK = c_Ordendepago_valoresdetalle.Valor
			loItem.Vendedor = c_Ordendepago_valoresdetalle.Vendedor
			loItem.FechaUltCotizacion = goLibrerias.ObtenerFechaFormateada( c_Ordendepago_valoresdetalle.FechaUltCotizacion )
			loItem.UltimaCotizacion = c_Ordendepago_valoresdetalle.UltimaCotizacion
			loItem.Caja_PK = c_Ordendepago_valoresdetalle.Caja
			loItem.PersonalizarComprobante = c_Ordendepago_valoresdetalle.PersonalizarComprobante
			loItem.NumeroChequePropio_PK = c_Ordendepago_valoresdetalle.NumeroChequePropio
			loItem.VisualizarEnEstadoDeCaja = c_Ordendepago_valoresdetalle.VisualizarEnEstadoDeCaja
			loItem.ChequeElectronico = c_Ordendepago_valoresdetalle.ChequeElectronico
			loItem.ValorDetalle = c_Ordendepago_valoresdetalle.ValorDetalle
			loItem.Fecha = goLibrerias.ObtenerFechaFormateada( c_Ordendepago_valoresdetalle.Fecha )
			loItem.NumeroInterno = c_Ordendepago_valoresdetalle.NumeroInterno
			loItem.Monto = c_Ordendepago_valoresdetalle.Monto
			loItem.RecargoPorcentaje = c_Ordendepago_valoresdetalle.RecargoPorcentaje
			loItem.RecargoMonto = c_Ordendepago_valoresdetalle.RecargoMonto
			loItem.Total = c_Ordendepago_valoresdetalle.Total
			loItem.RecargoMontoSinImpuestos = c_Ordendepago_valoresdetalle.RecargoMontoSinImpuestos
			loItem.RecargoSinPercepciones = c_Ordendepago_valoresdetalle.RecargoSinPercepciones
			loItem.NumeroValeDeCambio_PK = c_Ordendepago_valoresdetalle.NumeroValeDeCambio
			loItem.PermiteVuelto = c_Ordendepago_valoresdetalle.PermiteVuelto
			loItem.IdItemComponente = c_Ordendepago_valoresdetalle.IdItemComponente
			loItem.NroItem = lnI 
