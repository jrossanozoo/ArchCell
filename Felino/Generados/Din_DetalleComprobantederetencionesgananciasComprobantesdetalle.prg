...
define class Din_DetalleCOMPROBANTEDERETENCIONESGANANCIASComprobantesdetalle as detalle of detalle.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemCOMPROBANTEDERETENCIONESGANANCIASComprobantesdetalle' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Comprobantesdetalle
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.Codigo = c_Comprobantesdetalle.Codigo
			loItem.Letra = c_Comprobantesdetalle.Letra
			loItem.PuntoDeVenta = c_Comprobantesdetalle.PuntoDeVenta
			loItem.NumeroDeComprobante = c_Comprobantesdetalle.NumeroDeComprobante
			loItem.TipoDeComprobante = c_Comprobantesdetalle.TipoDeComprobante
			loItem.CodigoComprobante = c_Comprobantesdetalle.CodigoComprobante
			loItem.NROITEM = c_Comprobantesdetalle.NROITEM
			loItem.Descripcion = c_Comprobantesdetalle.Descripcion
			loItem.NroItem = lnI 
