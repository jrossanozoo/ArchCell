...
define class Din_EntidadNOTADEDEBITOCOMPRAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxNdcompraFmodifw, lxNdcompraFecexpo, lxNdcompraFecimpo, lxNdcompraFd2, lxNdcompraFaltafw, lxNdcompraFectrans, lxNdcompraFcuit, lxNdcompraIdcaja, lxNdcompraFpodes1, lxNdcompraFpodes, lxNdcompraFpodes2, lxNdcompraFturno, lxNdcompraNumint, lxNdcompraDesmntosi, lxNdcompraRecmntosi2, lxNdcompraDesmntosi2, lxNdcompraTimestamp, lxNdcompraTotalcant, lxNdcompraRecmntosi1, lxNdcompraDesmntosi1, lxNdcompraRecmntosi, lxNdcompraFacttipo, lxNdcompraSignomov, lxNdcompraFsubton, lxNdcompraFsubtot, lxNdcompraFptoven, lxNdcompraSitfiscpro, lxNdcompraRecmnto2, lxNdcompraCondivalp, lxNdcompraRecmnto1, lxNdcompraSubtotcisi, lxNdcompraSubtotsisi, lxNdcompraDesauto, lxNdcompraFcompfis, lxNdcompraAnulado, lxNdcompraHoraexpo, lxNdcompraFhora, lxNdcompraHaltafw, lxNdcompraHoraimpo, lxNdcompraSaltafw, lxNdcompraDescfw, lxNdcompraValtafw, lxNdcompraVmodifw, lxNdcompraUmodifw, lxNdcompraUaltafw, lxNdcompraZadsfw, lxNdcompraSmodifw, lxNdcompraHmodifw, lxNdcompraSimbmon, lxNdcompraEsttrans, lxNdcompraBdaltafw, lxNdcompraBdmodifw, lxNdcompraIdvuelto, lxNdcompraMonsis, lxNdcompraMoneda, lxNdcompraFobs, lxNdcompraFfch, lxNdcompraFmtdes1, lxNdcompraFdescu, lxNdcompraFmtdes2, lxNdcompraFimpuesto, lxNdcompraTcrg1361, lxNdcompraCodigo, lxNdcompraFfchfac, lxNdcompraFletra, lxNdcompraDesmntosi3, lxNdcompraFmtdes3, lxNdcompraImpman, lxNdcompraFfchvenc, lxNdcompraRecpor, lxNdcompraFptovenext, lxNdcompraTotdescsi, lxNdcompraCondpago, lxNdcompraMr, lxNdcompraFnumcomp, lxNdcompraNcai, lxNdcompraRecmnto, lxNdcompraNroremito, lxNdcompraFvtocai, lxNdcompraFvuelto, lxNdcompraFperson, lxNdcompraCodlista, lxNdcompraCotiz, lxNdcompraCcosto, lxNdcompraFtotal, lxNdcompraRecmonto2, lxNdcompraRecmonto1, lxNdcompraDisccos, lxNdcompraTotimpue, lxNdcompraTotrecarsi, lxNdcompraTotrecar, lxNdcompraTotdesc
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.NDCOMPRA ( "Fmodifw","Fecexpo","Fecimpo","Fd2","Faltafw","Fectrans","Fcuit","Idcaja","Fpodes1","Fpodes","Fpodes2","Fturno","Numint","Desmntosi","Recmntosi2","Desmntosi2","Timestamp","Totalcant","Recmntosi1","Desmntosi1","Recmntosi","Facttipo","Signomov","Fsubton","Fsubtot","Fptoven","Sitfiscpro","Recmnto2","Condivalp","Recmnto1","Subtotcisi","Subtotsisi","Desauto","Fcompfis","Anulado","Horaexpo","Fhora","Haltafw","Horaimpo","Saltafw","Descfw","Valtafw","Vmodifw","Umodifw","Ualtafw","Zadsfw","Smodifw","Hmodifw","Simbmon","Esttrans","Bdaltafw","Bdmodifw","Idvuelto","Monsis","Moneda","Fobs","Ffch","Fmtdes1","Fdescu","Fmtdes2","Fimpuesto","Tcrg1361","Codigo","Ffchfac","Fletra","Desmntosi3","Fmtdes3","Impman","Ffchvenc","Recpor","Fptovenext","Totdescsi","Condpago","Mr","Fnumcomp","Ncai","Recmnto","Nroremito","Fvtocai","Fvuelto","Fperson","Codlista","Cotiz","Ccosto","Ftotal","Recmonto2","Recmonto1","Disccos","Totimpue","Totrecarsi","Totrecar","Totdesc" ) values ( <<"'" + this.ConvertirDateSql( lxNdcompraFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraFcuit ) + "'" >>, <<lxNdcompraIdcaja >>, <<lxNdcompraFpodes1 >>, <<lxNdcompraFpodes >>, <<lxNdcompraFpodes2 >>, <<lxNdcompraFturno >>, <<lxNdcompraNumint >>, <<lxNdcompraDesmntosi >>, <<lxNdcompraRecmntosi2 >>, <<lxNdcompraDesmntosi2 >>, <<lxNdcompraTimestamp >>, <<lxNdcompraTotalcant >>, <<lxNdcompraRecmntosi1 >>, <<lxNdcompraDesmntosi1 >>, <<lxNdcompraRecmntosi >>, <<lxNdcompraFacttipo >>, <<lxNdcompraSignomov >>, <<lxNdcompraFsubton >>, <<lxNdcompraFsubtot >>, <<lxNdcompraFptoven >>, <<lxNdcompraSitfiscpro >>, <<lxNdcompraRecmnto2 >>, <<lxNdcompraCondivalp >>, <<lxNdcompraRecmnto1 >>, <<lxNdcompraSubtotcisi >>, <<lxNdcompraSubtotsisi >>, <<iif( lxNdcompraDesauto, 1, 0 ) >>, <<iif( lxNdcompraFcompfis, 1, 0 ) >>, <<iif( lxNdcompraAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxNdcompraHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraFobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFfch ) + "'" >>, <<lxNdcompraFmtdes1 >>, <<lxNdcompraFdescu >>, <<lxNdcompraFmtdes2 >>, <<lxNdcompraFimpuesto >>, <<lxNdcompraTcrg1361 >>, <<"'" + this.FormatearTextoSql( lxNdcompraCodigo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFfchfac ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraFletra ) + "'" >>, <<lxNdcompraDesmntosi3 >>, <<lxNdcompraFmtdes3 >>, <<iif( lxNdcompraImpman, 1, 0 ) >>, <<"'" + this.ConvertirDateSql( lxNdcompraFfchvenc ) + "'" >>, <<lxNdcompraRecpor >>, <<lxNdcompraFptovenext >>, <<lxNdcompraTotdescsi >>, <<"'" + this.FormatearTextoSql( lxNdcompraCondpago ) + "'" >>, <<lxNdcompraMr >>, <<lxNdcompraFnumcomp >>, <<lxNdcompraNcai >>, <<lxNdcompraRecmnto >>, <<"'" + this.FormatearTextoSql( lxNdcompraNroremito ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNdcompraFvtocai ) + "'" >>, <<lxNdcompraFvuelto >>, <<"'" + this.FormatearTextoSql( lxNdcompraFperson ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNdcompraCodlista ) + "'" >>, <<lxNdcompraCotiz >>, <<"'" + this.FormatearTextoSql( lxNdcompraCcosto ) + "'" >>, <<lxNdcompraFtotal >>, <<lxNdcompraRecmonto2 >>, <<lxNdcompraRecmonto1 >>, <<"'" + this.FormatearTextoSql( lxNdcompraDisccos ) + "'" >>, <<lxNdcompraTotimpue >>, <<lxNdcompraTotrecarsi >>, <<lxNdcompraTotrecar >>, <<lxNdcompraTotdesc >> )
			endtext
			...
			for each loItem in this.oEntidad.FacturaDetalle
				if this.oEntidad.FacturaDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.NdCompraDet("AfePTOVEN","AfeLETRA","AfeNUMCOM","FART","AfeTS","MNTPRECCI","AfeSaldo","AfeCANT","ACondIvaC","MNTPTOT","APorcIvaC","MNTPDESSI","AjuSImp","AjuCImp","COMP","FBruto","ArtPercep","MNDESCI","MNDESSI","MNTPRECSI","MNTPDESCI","MNTPPER","MNPDSI","AfeTipoCom","FNETO","FporCFI","FX2","FmtoIVA","FmtoCFI","FmtoDTO1","FCFITot","FKIT","FporDTO1","NroItem","fporIva","FN11","AfeNroItem","iditemOrig","FPRUN","prunconimp","Prunsinimp","ProcStock","UsarPLista","IdItem","afe_Cod","FAMate","CODIGO","FUnid","Equiv","FTXT","FCOLO","FCOTXT","FTALL","FCFI","MNTDES","MNTPIVA","seniacance","FCANT","FPRECIO","FMONTO","CCOSTO","DCCOSTO" ) values ( <<lxAfe_puntodeventa>>, <<"'" + this.FormatearTextoSql( lxAfe_letra ) + "'">>, <<lxAfe_numero>>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxAfe_timestamp>>, <<lxMontoprorrateorecargoconimpuestos>>, <<lxAfe_saldo>>, <<lxAfe_cantidad>>, <<lxArticulo_condicionivacompras>>, <<lxMontoprorrateototal>>, <<lxArticulo_porcentajeivacompras>>, <<lxMontoprorrateodescuentosinimpuestos>>, <<lxAjusteporredondeosinimpuestos>>, <<lxAjusteporredondeoconimpuestos>>, <<lxComportamiento>>, <<lxBruto>>, <<lxPercepcionivarg5329>>, <<lxMontodescuentoconimpuestos>>, <<lxMontodescuentosinimpuestos>>, <<lxMontoprorrateorecargosinimpuestos>>, <<lxMontoprorrateodescuentoconimpuestos>>, <<lxMontoprorrateopercepciones>>, <<lxMontoporcentajedescuentosinimpuesto>>, <<lxAfe_tipocomprobante>>, <<lxNeto>>, <<lxPorcentajecfi>>, <<lxOferta>>, <<lxMontoiva>>, <<lxMontocfi>>, <<lxMontodto1>>, <<lxMontoporcentajedescuentoconimpuesto>>, <<lxKit>>, <<lxPorcentajedto1>>, <<lxNroitem>>, <<lxPorcentajeiva>>, <<lxTipolistadeprecio>>, <<lxAfe_nroitem>>, <<lxIdorigen>>, <<lxPreciounitario>>, <<lxPrecioconimpuestos>>, <<lxPreciosinimpuestos>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<iif( lxUsarpreciodelista, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxIditemarticulos ) + "'">>, <<"'" + this.FormatearTextoSql( lxAfe_codigo ) + "'">>, <<"'" + this.FormatearTextoSql( lxMaterial_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxUnidad_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxDescuento>>, <<lxMontodescuento>>, <<lxMontoprorrateoiva>>, <<"'" + this.FormatearTextoSql( lxIdseniacancelada ) + "'">>, <<lxCantidad>>, <<lxPrecio>>, <<lxMonto>>, <<"'" + this.FormatearTextoSql( lxCentrodecosto_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxDistribucioncentrodecosto_PK ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()

					local lcXml as string
lcXml = this.oConexion.EjecutarSql( "select max( ciditem ) as ciditem from ZooLogic.NdCompraDet" )
this.xmlacursor( lcXml, 'c_NdCompraDetciditem' )
loItem.idItem = c_NdCompraDetciditem.ciditem
use in select( 'c_NdCompraDetciditem' )
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.NDCOMPRA set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxNdcompraFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxNdcompraFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxNdcompraFecimpo ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxNdcompraFd2 ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxNdcompraFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxNdcompraFectrans ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxNdcompraFcuit ) + "'">>,"Idcaja" = <<lxNdcompraIdcaja>>,"Fpodes1" = <<lxNdcompraFpodes1>>,"Fpodes" = <<lxNdcompraFpodes>>,"Fpodes2" = <<lxNdcompraFpodes2>>,"Fturno" = <<lxNdcompraFturno>>,"Numint" = <<lxNdcompraNumint>>,"Desmntosi" = <<lxNdcompraDesmntosi>>,"Recmntosi2" = <<lxNdcompraRecmntosi2>>,"Desmntosi2" = <<lxNdcompraDesmntosi2>>,"Timestamp" = <<lxNdcompraTimestamp>>,"Totalcant" = <<lxNdcompraTotalcant>>,"Recmntosi1" = <<lxNdcompraRecmntosi1>>,"Desmntosi1" = <<lxNdcompraDesmntosi1>>,"Recmntosi" = <<lxNdcompraRecmntosi>>,"Facttipo" = <<lxNdcompraFacttipo>>,"Signomov" = <<lxNdcompraSignomov>>,"Fsubton" = <<lxNdcompraFsubton>>,"Fsubtot" = <<lxNdcompraFsubtot>>,"Fptoven" = <<lxNdcompraFptoven>>,"Sitfiscpro" = <<lxNdcompraSitfiscpro>>,"Recmnto2" = <<lxNdcompraRecmnto2>>,"Condivalp" = <<lxNdcompraCondivalp>>,"Recmnto1" = <<lxNdcompraRecmnto1>>,"Subtotcisi" = <<lxNdcompraSubtotcisi>>,"Subtotsisi" = <<lxNdcompraSubtotsisi>>,"Desauto" = <<iif( lxNdcompraDesauto, 1, 0 )>>,"Fcompfis" = <<iif( lxNdcompraFcompfis, 1, 0 )>>,"Anulado" = <<iif( lxNdcompraAnulado, 1, 0 )>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxNdcompraHoraexpo ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxNdcompraFhora ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxNdcompraHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxNdcompraHoraimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxNdcompraSaltafw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxNdcompraDescfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxNdcompraValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxNdcompraVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxNdcompraUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxNdcompraUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxNdcompraZadsfw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxNdcompraSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxNdcompraHmodifw ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxNdcompraSimbmon ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxNdcompraEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxNdcompraBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxNdcompraBdmodifw ) + "'">>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxNdcompraIdvuelto ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxNdcompraMonsis ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxNdcompraMoneda ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxNdcompraFobs ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxNdcompraFfch ) + "'">>,"Fmtdes1" = <<lxNdcompraFmtdes1>>,"Fdescu" = <<lxNdcompraFdescu>>,"Fmtdes2" = <<lxNdcompraFmtdes2>>,"Fimpuesto" = <<lxNdcompraFimpuesto>>,"Tcrg1361" = <<lxNdcompraTcrg1361>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxNdcompraCodigo ) + "'">>,"Ffchfac" = <<"'" + this.ConvertirDateSql( lxNdcompraFfchfac ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxNdcompraFletra ) + "'">>,"Desmntosi3" = <<lxNdcompraDesmntosi3>>,"Fmtdes3" = <<lxNdcompraFmtdes3>>,"Impman" = <<iif( lxNdcompraImpman, 1, 0 )>>,"Ffchvenc" = <<"'" + this.ConvertirDateSql( lxNdcompraFfchvenc ) + "'">>,"Recpor" = <<lxNdcompraRecpor>>,"Fptovenext" = <<lxNdcompraFptovenext>>,"Totdescsi" = <<lxNdcompraTotdescsi>>,"Condpago" = <<"'" + this.FormatearTextoSql( lxNdcompraCondpago ) + "'">>,"Mr" = <<lxNdcompraMr>>,"Fnumcomp" = <<lxNdcompraFnumcomp>>,"Ncai" = <<lxNdcompraNcai>>,"Recmnto" = <<lxNdcompraRecmnto>>,"Nroremito" = <<"'" + this.FormatearTextoSql( lxNdcompraNroremito ) + "'">>,"Fvtocai" = <<"'" + this.ConvertirDateSql( lxNdcompraFvtocai ) + "'">>,"Fvuelto" = <<lxNdcompraFvuelto>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxNdcompraFperson ) + "'">>,"Codlista" = <<"'" + this.FormatearTextoSql( lxNdcompraCodlista ) + "'">>,"Cotiz" = <<lxNdcompraCotiz>>,"Ccosto" = <<"'" + this.FormatearTextoSql( lxNdcompraCcosto ) + "'">>,"Ftotal" = <<lxNdcompraFtotal>>,"Recmonto2" = <<lxNdcompraRecmonto2>>,"Recmonto1" = <<lxNdcompraRecmonto1>>,"Disccos" = <<"'" + this.FormatearTextoSql( lxNdcompraDisccos ) + "'">>,"Totimpue" = <<lxNdcompraTotimpue>>,"Totrecarsi" = <<lxNdcompraTotrecarsi>>,"Totrecar" = <<lxNdcompraTotrecar>>,"Totdesc" = <<lxNdcompraTotdesc>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxNdcompraCodigo ) + "'">> and  NDCOMPRA.CODIGO != '' AND NDCOMPRA.FACTTIPO = 9 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Afeptoven" as "Afe_puntodeventa", "Afeletra" as "Afe_letra", "Afenumcom" as "Afe_numero", "Fart" as "Articulo", "Afets" as "Afe_timestamp", "Mntprecci" as "Montoprorrateorecargoconimpuestos", "Afesaldo" as "Afe_saldo", "Afecant" as "Afe_cantidad", "Acondivac" as "Articulo_condicionivacompras", "Mntptot" as "Montoprorrateototal", "Aporcivac" as "Articulo_porcentajeivacompras", "Mntpdessi" as "Montoprorrateodescuentosinimpuestos", "Ajusimp" as "Ajusteporredondeosinimpuestos", "Ajucimp" as "Ajusteporredondeoconimpuestos", "Comp" as "Comportamiento", "Fbruto" as "Bruto", "Artpercep" as "Percepcionivarg5329", "Mndesci" as "Montodescuentoconimpuestos", "Mndessi" as "Montodescuentosinimpuestos", "Mntprecsi" as "Montoprorrateorecargosinimpuestos", "Mntpdesci" as "Montoprorrateodescuentoconimpuestos", "Mntpper" as "Montoprorrateopercepciones", "Mnpdsi" as "Montoporcentajedescuentosinimpuesto", "Afetipocom" as "Afe_tipocomprobante", "Fneto" as "Neto", "Fporcfi" as "Porcentajecfi", "Fx2" as "Oferta", "Fmtoiva" as "Montoiva", "Fmtocfi" as "Montocfi", "Fmtodto1" as "Montodto1", "Fcfitot" as "Montoporcentajedescuentoconimpuesto", "Fkit" as "Kit", "Fpordto1" as "Porcentajedto1", "Nroitem" as "Nroitem", "Fporiva" as "Porcentajeiva", "Fn11" as "Tipolistadeprecio", "Afenroitem" as "Afe_nroitem", "Iditemorig" as "Idorigen", "Fprun" as "Preciounitario", "Ciditem" as "Iditem", "Prunconimp" as "Precioconimpuestos", "Prunsinimp" as "Preciosinimpuestos", "Procstock" as "Noprocesarstock", "Usarplista" as "Usarpreciodelista", "Iditem" as "Iditemarticulos", "Afe_cod" as "Afe_codigo", "Famate" as "Material", "Codigo" as "Codigo", "Funid" as "Unidad", "Equiv" as "Equivalencia", "Ftxt" as "Articulodetalle", "Fcolo" as "Color", "Fcotxt" as "Colordetalle", "Ftall" as "Talle", "Fcfi" as "Descuento", "Mntdes" as "Montodescuento", "Mntpiva" as "Montoprorrateoiva", "Seniacance" as "Idseniacancelada", "Fcant" as "Cantidad", "Fprecio" as "Precio", "Fmonto" as "Monto", "Ccosto" as "Centrodecosto", "Dccosto" as "Distribucioncentrodecosto" from ZooLogic.NdCompraDet where CODIGO = <<"'" + this.FormatearTextoSql( c_NOTADEDEBITOCOMPRA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fpodes" as "Porcentajedescuento", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Numint" as "Numint", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Facttipo" as "Tipocomprobante", "Signomov" as "Signodemovimiento", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Fptoven" as "Puntodeventa", "Sitfiscpro" as "Situacionfiscal", "Recmnto2" as "Recargomontoconimpuestos2", "Condivalp" as "Condicioniva", "Recmnto1" as "Recargomontoconimpuestos1", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Desauto" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Fhora" as "Hora", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Ffch" as "Fecha", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fimpuesto" as "Impuestos", "Tcrg1361" as "Tipocomprobanterg1361", "Codigo" as "Codigo", "Ffchfac" as "Fechafactura", "Fletra" as "Letra", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fmtdes3" as "Montodescuentoconimpuestos3", "Impman" as "Impuestosmanuales", "Ffchvenc" as "Fechavencimiento", "Recpor" as "Recargoporcentaje", "Fptovenext" as "Puntodeventaextendido", "Totdescsi" as "Totaldescuentossinimpuestos", "Condpago" as "Condicionpagopreferente", "Mr" as "Recargomonto", "Fnumcomp" as "Numero", "Ncai" as "Cai", "Recmnto" as "Recargomontoconimpuestos", "Nroremito" as "Remito", "Fvtocai" as "Fechavtocai", "Fvuelto" as "Vuelto", "Fperson" as "Proveedor", "Codlista" as "Listadeprecios", "Cotiz" as "Cotizacion", "Ccosto" as "Centrodecosto", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Disccos" as "Distribucionporcentrodecosto", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.NDCOMPRA where  NDCOMPRA.CODIGO != '' AND NDCOMPRA.FACTTIPO = 9 And NumInt = <<lxNdCompraNumInt>> and FACTTIPO = <<lxNdCompraFACTTIPO>>
			endtext
			use in select('c_NOTADEDEBITOCOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOCOMPRA', set( 'Datasession' ) )
			if reccount( 'c_NOTADEDEBITOCOMPRA' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fpodes" as "Porcentajedescuento", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Numint" as "Numint", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Facttipo" as "Tipocomprobante", "Signomov" as "Signodemovimiento", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Fptoven" as "Puntodeventa", "Sitfiscpro" as "Situacionfiscal", "Recmnto2" as "Recargomontoconimpuestos2", "Condivalp" as "Condicioniva", "Recmnto1" as "Recargomontoconimpuestos1", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Desauto" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Fhora" as "Hora", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Ffch" as "Fecha", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fimpuesto" as "Impuestos", "Tcrg1361" as "Tipocomprobanterg1361", "Codigo" as "Codigo", "Ffchfac" as "Fechafactura", "Fletra" as "Letra", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fmtdes3" as "Montodescuentoconimpuestos3", "Impman" as "Impuestosmanuales", "Ffchvenc" as "Fechavencimiento", "Recpor" as "Recargoporcentaje", "Fptovenext" as "Puntodeventaextendido", "Totdescsi" as "Totaldescuentossinimpuestos", "Condpago" as "Condicionpagopreferente", "Mr" as "Recargomonto", "Fnumcomp" as "Numero", "Ncai" as "Cai", "Recmnto" as "Recargomontoconimpuestos", "Nroremito" as "Remito", "Fvtocai" as "Fechavtocai", "Fvuelto" as "Vuelto", "Fperson" as "Proveedor", "Codlista" as "Listadeprecios", "Cotiz" as "Cotizacion", "Ccosto" as "Centrodecosto", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Disccos" as "Distribucionporcentrodecosto", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.NDCOMPRA where  NDCOMPRA.CODIGO != '' AND NDCOMPRA.FACTTIPO = 9 order by NumInt,FACTTIPO
			endtext
			use in select('c_NOTADEDEBITOCOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOCOMPRA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fpodes" as "Porcentajedescuento", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Numint" as "Numint", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Facttipo" as "Tipocomprobante", "Signomov" as "Signodemovimiento", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Fptoven" as "Puntodeventa", "Sitfiscpro" as "Situacionfiscal", "Recmnto2" as "Recargomontoconimpuestos2", "Condivalp" as "Condicioniva", "Recmnto1" as "Recargomontoconimpuestos1", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Desauto" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Fhora" as "Hora", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Ffch" as "Fecha", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fimpuesto" as "Impuestos", "Tcrg1361" as "Tipocomprobanterg1361", "Codigo" as "Codigo", "Ffchfac" as "Fechafactura", "Fletra" as "Letra", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fmtdes3" as "Montodescuentoconimpuestos3", "Impman" as "Impuestosmanuales", "Ffchvenc" as "Fechavencimiento", "Recpor" as "Recargoporcentaje", "Fptovenext" as "Puntodeventaextendido", "Totdescsi" as "Totaldescuentossinimpuestos", "Condpago" as "Condicionpagopreferente", "Mr" as "Recargomonto", "Fnumcomp" as "Numero", "Ncai" as "Cai", "Recmnto" as "Recargomontoconimpuestos", "Nroremito" as "Remito", "Fvtocai" as "Fechavtocai", "Fvuelto" as "Vuelto", "Fperson" as "Proveedor", "Codlista" as "Listadeprecios", "Cotiz" as "Cotizacion", "Ccosto" as "Centrodecosto", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Disccos" as "Distribucionporcentrodecosto", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.NDCOMPRA where  str( NumInt, 10, 0) + str( FACTTIPO, 2, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NDCOMPRA.CODIGO != '' AND NDCOMPRA.FACTTIPO = 9 order by NumInt,FACTTIPO
			endtext
			use in select('c_NOTADEDEBITOCOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOCOMPRA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fpodes" as "Porcentajedescuento", "Fpodes2" as "Porcentajedescuento2", "Fturno" as "Turno", "Numint" as "Numint", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi" as "Recargomontosinimpuestos", "Facttipo" as "Tipocomprobante", "Signomov" as "Signodemovimiento", "Fsubton" as "Subtotalneto", "Fsubtot" as "Subtotalbruto", "Fptoven" as "Puntodeventa", "Sitfiscpro" as "Situacionfiscal", "Recmnto2" as "Recargomontoconimpuestos2", "Condivalp" as "Condicioniva", "Recmnto1" as "Recargomontoconimpuestos1", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Desauto" as "Descuentoautomatico", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Fhora" as "Hora", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Saltafw" as "Seriealtafw", "Descfw" as "Descripcionfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Simbmon" as "Simbolomonetariocomprobante", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Moneda" as "Monedacomprobante", "Fobs" as "Obs", "Ffch" as "Fecha", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fdescu" as "Descuento", "Fmtdes2" as "Montodescuentoconimpuestos2", "Fimpuesto" as "Impuestos", "Tcrg1361" as "Tipocomprobanterg1361", "Codigo" as "Codigo", "Ffchfac" as "Fechafactura", "Fletra" as "Letra", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fmtdes3" as "Montodescuentoconimpuestos3", "Impman" as "Impuestosmanuales", "Ffchvenc" as "Fechavencimiento", "Recpor" as "Recargoporcentaje", "Fptovenext" as "Puntodeventaextendido", "Totdescsi" as "Totaldescuentossinimpuestos", "Condpago" as "Condicionpagopreferente", "Mr" as "Recargomonto", "Fnumcomp" as "Numero", "Ncai" as "Cai", "Recmnto" as "Recargomontoconimpuestos", "Nroremito" as "Remito", "Fvtocai" as "Fechavtocai", "Fvuelto" as "Vuelto", "Fperson" as "Proveedor", "Codlista" as "Listadeprecios", "Cotiz" as "Cotizacion", "Ccosto" as "Centrodecosto", "Ftotal" as "Total", "Recmonto2" as "Recargomonto2", "Recmonto1" as "Recargomonto1", "Disccos" as "Distribucionporcentrodecosto", "Totimpue" as "Totalimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos" from ZooLogic.NDCOMPRA where  NDCOMPRA.CODIGO != '' AND NDCOMPRA.FACTTIPO = 9 order by NumInt desc,FACTTIPO desc
			endtext
			use in select('c_NOTADEDEBITOCOMPRA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOCOMPRA', set( 'Datasession' ) )
			local lcSentencia as string
...
"o,Ftotal,Recmonto2,Recmonto1,Disccos,Totimpue,Totrecarsi,Totrecar,Totdesc" + ;
		...
		With this
			...
			for each loItem in this.oEntidad.FacturaDetalle
				if this.oEntidad.FacturaDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxDistribucioncentrodecosto_PK = loItem.Distribucioncentrodecosto_PK
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.NdCompraDet("AfePTOVEN","AfeLETRA","AfeNUMCOM","FART","AfeTS","MNTPRECCI","AfeSaldo","AfeCANT","ACondIvaC","MNTPTOT","APorcIvaC","MNTPDESSI","AjuSImp","AjuCImp","COMP","FBruto","ArtPercep","MNDESCI","MNDESSI","MNTPRECSI","MNTPDESCI","MNTPPER","MNPDSI","AfeTipoCom","FNETO","FporCFI","FX2","FmtoIVA","FmtoCFI","FmtoDTO1","FCFITot","FKIT","FporDTO1","NroItem","fporIva","FN11","AfeNroItem","iditemOrig","FPRUN","prunconimp","Prunsinimp","ProcStock","UsarPLista","IdItem","afe_Cod","FAMate","CODIGO","FUnid","Equiv","FTXT","FCOLO","FCOTXT","FTALL","FCFI","MNTDES","MNTPIVA","seniacance","FCANT","FPRECIO","FMONTO","CCOSTO","DCCOSTO" ) values ( <<lxAfe_puntodeventa>>, <<"'" + this.FormatearTextoSql( lxAfe_letra ) + "'">>, <<lxAfe_numero>>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxAfe_timestamp>>, <<lxMontoprorrateorecargoconimpuestos>>, <<lxAfe_saldo>>, <<lxAfe_cantidad>>, <<lxArticulo_condicionivacompras>>, <<lxMontoprorrateototal>>, <<lxArticulo_porcentajeivacompras>>, <<lxMontoprorrateodescuentosinimpuestos>>, <<lxAjusteporredondeosinimpuestos>>, <<lxAjusteporredondeoconimpuestos>>, <<lxComportamiento>>, <<lxBruto>>, <<lxPercepcionivarg5329>>, <<lxMontodescuentoconimpuestos>>, <<lxMontodescuentosinimpuestos>>, <<lxMontoprorrateorecargosinimpuestos>>, <<lxMontoprorrateodescuentoconimpuestos>>, <<lxMontoprorrateopercepciones>>, <<lxMontoporcentajedescuentosinimpuesto>>, <<lxAfe_tipocomprobante>>, <<lxNeto>>, <<lxPorcentajecfi>>, <<lxOferta>>, <<lxMontoiva>>, <<lxMontocfi>>, <<lxMontodto1>>, <<lxMontoporcentajedescuentoconimpuesto>>, <<lxKit>>, <<lxPorcentajedto1>>, <<lxNroitem>>, <<lxPorcentajeiva>>, <<lxTipolistadeprecio>>, <<lxAfe_nroitem>>, <<lxIdorigen>>, <<lxPreciounitario>>, <<lxPrecioconimpuestos>>, <<lxPreciosinimpuestos>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<iif( lxUsarpreciodelista, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxIditemarticulos ) + "'">>, <<"'" + this.FormatearTextoSql( lxAfe_codigo ) + "'">>, <<"'" + this.FormatearTextoSql( lxMaterial_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxUnidad_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxDescuento>>, <<lxMontodescuento>>, <<lxMontoprorrateoiva>>, <<"'" + this.FormatearTextoSql( lxIdseniacancelada ) + "'">>, <<lxCantidad>>, <<lxPrecio>>, <<lxMonto>>, <<"'" + this.FormatearTextoSql( lxCentrodecosto_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxDistribucioncentrodecosto_PK ) + "'">> ) 
					endtext
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CCosto ) + "'" + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..RecMonto2 ) + ',' + transform( &lcCursor..RecMonto1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DisCCos ) + "'" + ',' + transform( &lcCursor..totimpue ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..totdesc )
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="FECHATRANSFERENCIA                      " tabla="NDCOMPRA       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="CAJA                                    " tabla="NDCOMPRA       " campo="IDCAJA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CAJAESTADO                              " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="PORCENTAJEDESCUENTO1                    " tabla="NDCOMPRA       " campo="FPODES1   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuento %                                                                                                                                                     " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="2" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="PORCENTAJEDESCUENTO                     " tabla="NDCOMPRA       " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Des%                                                                                                                                                            " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="PORCENTAJEDESCUENTO2                    " tabla="NDCOMPRA       " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuento %                                                                                                                                                     " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="MONTODESCUENTOSINIMPUESTOS              " tabla="NDCOMPRA       " campo="DESMNTOSI " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="RECARGOMONTOSINIMPUESTOS2               " tabla="NDCOMPRA       " campo="RECMNTOSI2" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="MONTODESCUENTOSINIMPUESTOS2             " tabla="NDCOMPRA       " campo="DESMNTOSI2" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="TOTALCANTIDAD                           " tabla="NDCOMPRA       " campo="TOTALCANT " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total Cantidad                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="RECARGOMONTOSINIMPUESTOS1               " tabla="NDCOMPRA       " campo="RECMNTOSI1" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="MONTODESCUENTOSINIMPUESTOS1             " tabla="NDCOMPRA       " campo="DESMNTOSI1" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="SUBTOTALBRUTO                           " tabla="NDCOMPRA       " campo="FSUBTOT   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="PUNTODEVENTA                            " tabla="NDCOMPRA       " campo="FPTOVEN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Nro. nota débito                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="9999                     " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="SITUACIONFISCAL                         " tabla="NDCOMPRA       " campo="SITFISCPRO" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SITUACIONFISCAL                         " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Sit.Fis                                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="proveedor.SituacionFiscal                                                                                                                                                                                                                                     " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="RECARGOMONTOCONIMPUESTOS2               " tabla="NDCOMPRA       " campo="RECMNTO2  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto de recargo                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="RECARGOMONTOCONIMPUESTOS1               " tabla="NDCOMPRA       " campo="RECMNTO1  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto de recargo                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="NDCOMPRA       " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="SUBTOTALSINIMPUESTOSSOBREITEMS          " tabla="NDCOMPRA       " campo="SUBTOTSISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="ESTADOTRANSFERENCIA                     " tabla="NDCOMPRA       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="MONEDASISTEMA                           " tabla="NDCOMPRA       " campo="MONSIS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="MONEDACOMPROBANTE                       " tabla="NDCOMPRA       " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Moneda comprobante                                                                                                                                              " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="OBS                                     " tabla="NDCOMPRA       " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="                                                                                                                                                                " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="FECHA                                   " tabla="NDCOMPRA       " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="410" etiqueta="Ingreso                                                                                                                                                         " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="DESCUENTO                               " tabla="NDCOMPRA       " campo="FDESCU    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Des%                                                                                                                                                            " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="MONTODESCUENTOCONIMPUESTOS2             " tabla="NDCOMPRA       " campo="FMTDES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuento %                                                                                                                                                     " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="1" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="FECHAFACTURA                            " tabla="NDCOMPRA       " campo="FFCHFAC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="420" etiqueta="Emisión                                                                                                                                                         " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="LETRA                                   " tabla="NDCOMPRA       " campo="FLETRA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Número Nota Débito                                                                                                                                              " dominio="NUMEROCOMPROBANTEEDITABLE     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="X                        " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="MONTODESCUENTOSINIMPUESTOS3             " tabla="NDCOMPRA       " campo="DESMNTOSI3" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto de descuento                                                                                                                                              " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="2" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="FECHAVENCIMIENTO                        " tabla="NDCOMPRA       " campo="FFCHVENC  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="424" etiqueta="Vencimiento                                                                                                                                                     " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="RECARGOPORCENTAJE                       " tabla="NDCOMPRA       " campo="RECPOR    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Recargo %                                                                                                                                                       " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="RECARGOMONTO                            " tabla="NDCOMPRA       " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="430" etiqueta="% Recargo                                                                                                                                                       " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="NUMERO                                  " tabla="NDCOMPRA       " campo="FNUMCOMP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="10" etiqueta="Número nota débito                                                                                                                                              " dominio="NUMEROCOMPROBANTEEDITABLE     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="99999999                 " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="CAI                                     " tabla="NDCOMPRA       " campo="NCAI      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="14" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="C.A.I./C.A.E.                                                                                                                                                   " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="RECARGOMONTOCONIMPUESTOS                " tabla="NDCOMPRA       " campo="RECMNTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="434" etiqueta="Monto de recargo                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="REMITO                                  " tabla="NDCOMPRA       " campo="NROREMITO " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="16" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="436" etiqueta="Remito                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="A 99999-99999999         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="FECHAVTOCAI                             " tabla="NDCOMPRA       " campo="FVTOCAI   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="438" etiqueta="Vencimiento C.A.I./C.A.E.                                                                                                                                       " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="VUELTO                                  " tabla="NDCOMPRA       " campo="FVUELTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vuelto                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="1" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="PROVEEDOR                               " tabla="NDCOMPRA       " campo="FPERSON   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="4" etiqueta="Proveedor                                                                                                                                                       " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="COTIZACION                              " tabla="NDCOMPRA       " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="442" etiqueta="Cotización                                                                                                                                                      " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="TOTAL                                   " tabla="NDCOMPRA       " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                           " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="TOTALIMPUESTOS                          " tabla="NDCOMPRA       " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Impuestos                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="16" orden="51" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="TOTALRECARGOSSINIMPUESTOS               " tabla="NDCOMPRA       " campo="TOTRECARSI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="15" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="TOTALRECARGOS                           " tabla="NDCOMPRA       " campo="TOTRECAR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="15" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOCOMPRA                      " atributo="TOTALDESCUENTOS                         " tabla="NDCOMPRA       " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuentos                                                                                                                                                      " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="16" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
