...
define class Mock_Bolsasycajasad_sqlserver as MockBase of MockBase.prg

	cClase = 'Bolsasycajasad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_detbolycaj( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_detbolycaj', lcParametros )
	EndFunc
