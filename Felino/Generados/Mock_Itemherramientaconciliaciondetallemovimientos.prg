...
define class Mock_Itemherramientaconciliaciondetallemovimientos as MockBase of MockBase.prg

	cClase = 'Itemherramientaconciliaciondetallemovimientos'
	...
	*-----------------------------------------------------------------------------------------
	function conceptocodigo_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Conceptocodigo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function movimiento_access() as variant                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Movimiento_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function movimiento_pk_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Movimiento_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_conceptocodigo( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_conceptocodigo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_movimiento( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_movimiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_conceptocodigo( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_conceptocodigo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_movimiento( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_movimiento', lcParametros )
	EndFunc
