...
define class Mock_impdircli as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function f_cliente_desde_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_cliente_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_cliente_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_cliente_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_cliente_desde( lxVal )				this.Setear_F_cliente_desde( lxVal )			EndIf		Else			This.Setear_F_cliente_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_cliente_hasta_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_cliente_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_cliente_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_cliente_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_cliente_hasta( lxVal )				this.Setear_F_cliente_hasta( lxVal )			EndIf		Else			This.Setear_F_cliente_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_lista_desde_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_lista_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_lista_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_lista_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_lista_desde( lxVal )				this.Setear_F_lista_desde( lxVal )			EndIf		Else			This.Setear_F_lista_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_lista_hasta_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_lista_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_lista_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_lista_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_lista_hasta( lxVal )				this.Setear_F_lista_hasta( lxVal )			EndIf		Else			This.Setear_F_lista_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_pais_desde_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_pais_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_pais_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_pais_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_pais_desde( lxVal )				this.Setear_F_pais_desde( lxVal )			EndIf		Else			This.Setear_F_pais_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_pais_hasta_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_pais_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_pais_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_pais_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_pais_hasta( lxVal )				this.Setear_F_pais_hasta( lxVal )			EndIf		Else			This.Setear_F_pais_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_provincia_desde_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_provincia_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_provincia_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_provincia_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_provincia_desde( lxVal )				this.Setear_F_provincia_desde( lxVal )			EndIf		Else			This.Setear_F_provincia_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_provincia_hasta_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_provincia_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_provincia_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_provincia_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_provincia_hasta( lxVal )				this.Setear_F_provincia_hasta( lxVal )			EndIf		Else			This.Setear_F_provincia_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_vendedor_desde_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_vendedor_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_vendedor_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_vendedor_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_vendedor_desde( lxVal )				this.Setear_F_vendedor_desde( lxVal )			EndIf		Else			This.Setear_F_vendedor_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_vendedor_hasta_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRCLI' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_vendedor_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_vendedor_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_vendedor_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_vendedor_hasta( lxVal )				this.Setear_F_vendedor_hasta( lxVal )			EndIf		Else			This.Setear_F_vendedor_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
