...
define class Mock_Itemagrupamientodebuzonesbuzonesdetalle as MockBase of MockBase.prg

	cClase = 'Itemagrupamientodebuzonesbuzonesdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function buzon_access() as variant                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Buzon_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buzon_pk_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Buzon_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buzondetalle_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Buzondetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_buzondetalle( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_buzondetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_buzondetalle( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_buzondetalle', lcParametros )
	EndFunc
