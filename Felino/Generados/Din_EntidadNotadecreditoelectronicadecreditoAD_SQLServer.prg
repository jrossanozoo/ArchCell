...
define class Din_EntidadNOTADECREDITOELECTRONICADECREDITOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFd2, lxComprobantevFecimpo, lxComprobantevFmodifw, lxComprobantevFectrans, lxComprobantevInformnube, lxComprobantevFecexpo, lxComprobantevDatosecomm, lxComprobantevIdcaja, lxComprobantevFpodes1, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevFajxre, lxComprobantevTimestamp, lxComprobantevTotalcant, lxComprobantevFactsec, lxComprobantevMdcimpu, lxComprobantevSubtotsisi, lxComprobantevFpodes2, lxComprobantevSubtotcisi, lxComprobantevCondivalp, lxComprobantevSitfisccli, lxComprobantevFacttipo, lxComprobantevFsubton, lxComprobantevSignomov, lxComprobantevFsubtot, lxComprobantevDesmntosi1, lxComprobantevDesmntosi, lxComprobantevDesmntosi2, lxComprobantevRecmntosi, lxComprobantevRecmntosi1, lxComprobantevRecmntosi2, lxComprobantevOrigonline, lxComprobantevDesaut, lxComprobantevAnulado, lxComprobantevFcompfis, lxComprobantevUaltafw, lxComprobantevDescfw, lxComprobantevSimbmon, lxComprobantevHmodifw, lxComprobantevHoraimpo, lxComprobantevHoraexpo, lxComprobantevSmodifw, lxComprobantevBdaltafw, lxComprobantevBdmodifw, lxComprobantevFhora, lxComprobantevUmodifw, lxComprobantevEsttrans, lxComprobantevOpecomm, lxComprobantevZadsfw, lxComprobantevFaltafw, lxComprobantevSaltafw, lxComprobantevIdajuste, lxComprobantevValtafw, lxComprobantevVmodifw, lxComprobantevHaltafw, lxComprobantevIdvuelto, lxComprobantevMonsis, lxComprobantevMotdescdev, lxComprobantevFobs, lxComprobantevFcuit, lxComprobantevMd1, lxComprobantevFcliente, lxComprobantevFmtdes1, lxComprobantevFmtdes2, lxComprobantevIdsenia, lxComprobantevCodigo, lxComprobantevDesmntosi3, lxComprobantevReceptor, lxComprobantevFven, lxComprobantevTotdescsi, lxComprobantevTdci, lxComprobantevMoneda, lxComprobantevFletra, lxComprobantevCodlista, lxComprobantevEmail, lxComprobantevVtosenia, lxComprobantevFptoven, lxComprobantevTrci, lxComprobantevTotrecarsi, lxComprobantevFvuelto, lxComprobantevFnumcomp, lxComprobantevFtotal, lxComprobantevFfch, lxComprobantevFmtdes3, lxComprobantevDeuda, lxComprobantevCotiz, lxComprobantevFpodes, lxComprobantevRecmnto2, lxComprobantevEntregapos, lxComprobantevFdescu, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevRecmnto, lxComprobantevRecpor, lxComprobantevMr, lxComprobantevMr2, lxComprobantevMd2, lxComprobantevMr1, lxComprobantevRecmnto1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecar, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevMerconsign, lxComprobantevCancelar, lxComprobantevIvasis, lxComprobantevTipocrela, lxComprobantevLetrarela, lxComprobantevPuntorela, lxComprobantevNumerorela, lxComprobantevFeccrela
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fd2","Fecimpo","Fmodifw","Fectrans","Informnube","Fecexpo","Datosecomm","Idcaja","Fpodes1","Fperson","Fturno","Fajxre","Timestamp","Totalcant","Factsec","Mdcimpu","Subtotsisi","Fpodes2","Subtotcisi","Condivalp","Sitfisccli","Facttipo","Fsubton","Signomov","Fsubtot","Desmntosi1","Desmntosi","Desmntosi2","Recmntosi","Recmntosi1","Recmntosi2","Origonline","Desaut","Anulado","Fcompfis","Ualtafw","Descfw","Simbmon","Hmodifw","Horaimpo","Horaexpo","Smodifw","Bdaltafw","Bdmodifw","Fhora","Umodifw","Esttrans","Opecomm","Zadsfw","Faltafw","Saltafw","Idajuste","Valtafw","Vmodifw","Haltafw","Idvuelto","Monsis","Motdescdev","Fobs","Fcuit","Md1","Fcliente","Fmtdes1","Fmtdes2","Idsenia","Codigo","Desmntosi3","Receptor","Fven","Totdescsi","Tdci","Moneda","Fletra","Codlista","Email","Vtosenia","Fptoven","Trci","Totrecarsi","Fvuelto","Fnumcomp","Ftotal","Ffch","Fmtdes3","Deuda","Cotiz","Fpodes","Recmnto2","Entregapos","Fdescu","Md3","Percepcion","Recmnto","Recpor","Mr","Mr2","Md2","Mr1","Recmnto1","Gravamen","Fimpuesto","Totrecar","Totdesc","Totimpue","Merconsign","Cancelar","Ivasis","Tipocrela","Letrarela","Puntorela","Numerorela","Feccrela" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'" >>, <<lxComprobantevIdcaja >>, <<lxComprobantevFpodes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<lxComprobantevFajxre >>, <<lxComprobantevTimestamp >>, <<lxComprobantevTotalcant >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevFacttipo >>, <<lxComprobantevFsubton >>, <<lxComprobantevSignomov >>, <<lxComprobantevFsubtot >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevRecmntosi2 >>, <<iif( lxComprobantevOrigonline, 1, 0 ) >>, <<iif( lxComprobantevDesaut, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevMd1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<lxComprobantevDesmntosi3 >>, <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<lxComprobantevTotdescsi >>, <<lxComprobantevTdci >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'" >>, <<lxComprobantevFptoven >>, <<lxComprobantevTrci >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevFvuelto >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFtotal >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevFmtdes3 >>, <<lxComprobantevDeuda >>, <<lxComprobantevCotiz >>, <<lxComprobantevFpodes >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevEntregapos >>, <<lxComprobantevFdescu >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecpor >>, <<lxComprobantevMr >>, <<lxComprobantevMr2 >>, <<lxComprobantevMd2 >>, <<lxComprobantevMr1 >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<iif( lxComprobantevMerconsign, 1, 0 ) >>, <<iif( lxComprobantevCancelar, 1, 0 ) >>, <<lxComprobantevIvasis >>, <<lxComprobantevTipocrela >>, <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'" >>, <<lxComprobantevPuntorela >>, <<lxComprobantevNumerorela >>, <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecexpo" as "Fechaexpo", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Fajxre" as "Ajustesporredondeos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Ualtafw" as "Usuarioaltafw", "Descfw" as "Descripcionfw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Opecomm" as "Nroopecommerce", "Zadsfw" as "Zadsfw", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Idajuste" as "Codigoajuste", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Desmntosi3" as "Montodescuentosinimpuestos3", "Receptor" as "Receptor", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Entregapos" as "Entregaposterior", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 55
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Montobase" as "Montobase", "Minimoper" as "Minimo", "Porcen" as "Porcentaje", "Sirecert" as "Certificadosire", "Minoimp" as "Minimonoimponible", "Monto" as "Monto", "Nroitem" as "Nroitem", "Sirecs" as "Codseguridadsire", "Base" as "Basedecalculo", "Regimenimp" as "Regimenimpositivo", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Codimp" as "Codigoimpuesto", "Descri" as "Descripcion", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_NOTADECREDITOELECTRONICADECREDITO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecexpo" as "Fechaexpo", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Fajxre" as "Ajustesporredondeos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Ualtafw" as "Usuarioaltafw", "Descfw" as "Descripcionfw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Opecomm" as "Nroopecommerce", "Zadsfw" as "Zadsfw", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Idajuste" as "Codigoajuste", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Desmntosi3" as "Montodescuentosinimpuestos3", "Receptor" as "Receptor", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Entregapos" as "Entregaposterior", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 55 And FACTTIPO = <<lxCOMPROBANTEVFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFLETRA ) + "'">> and FPTOVEN = <<lxCOMPROBANTEVFPTOVEN>> and FNUMCOMP = <<lxCOMPROBANTEVFNUMCOMP>> and FACTSEC = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFACTSEC ) + "'">>
			endtext
			use in select('c_NOTADECREDITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADECREDITOELECTRONICADECREDITO', set( 'Datasession' ) )
			if reccount( 'c_NOTADECREDITOELECTRONICADECREDITO' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecexpo" as "Fechaexpo", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Fajxre" as "Ajustesporredondeos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Ualtafw" as "Usuarioaltafw", "Descfw" as "Descripcionfw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Opecomm" as "Nroopecommerce", "Zadsfw" as "Zadsfw", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Idajuste" as "Codigoajuste", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Desmntosi3" as "Montodescuentosinimpuestos3", "Receptor" as "Receptor", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Entregapos" as "Entregaposterior", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 55 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_NOTADECREDITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADECREDITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecexpo" as "Fechaexpo", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Fperson" as "Cliente", "Fturno" as "Turno", "Fajxre" as "Ajustesporredondeos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Mdcimpu" as "Montodescuentoconimpuestos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Signomov" as "Signodemovimiento", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Desaut" as "Descuentoautomatico", "Anulado" as "Anulado", "Fcompfis" as "Comprobantefiscal", "Ualtafw" as "Usuarioaltafw", "Descfw" as "Descripcionfw", "Simbmon" as "Simbolomonetariocomprobante", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Opecomm" as "Nroopecommerce", "Zadsfw" as "Zadsfw", "Faltafw" as "Fechaaltafw", "Saltafw" as "Seriealtafw", "Idajuste" as "Codigoajuste", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Desmntosi3" as "Montodescuentosinimpuestos3", "Receptor" as "Receptor", "Fven" as "Vendedor", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Moneda" as "Monedacomprobante", "Fletra" as "Letra", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fptoven" as "Puntodeventa", "Trci" as "Totalrecargosconimpuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Ftotal" as "Total", "Ffch" as "Fecha", "Fmtdes3" as "Montodescuentoconimpuestos3", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Entregapos" as "Entregaposterior", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  funciones.dtos( FAltaFW ) + funciones.padr( HAltaFW, 8, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 55 order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_NOTADECREDITOELECTRONICADECREDITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADECREDITOELECTRONICADECREDITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select Fd2,Fecimpo,Fmodifw,Fectrans,Informnube,Fecexpo,Datosecomm,Idcaja,Fpodes1,Fperson,Fturno,Faj" + ;
"xre,Timestamp,Totalcant,Factsec,Mdcimpu,Subtotsisi,Fpodes2,Subtotcisi,Condivalp,Sitfisccli,Facttipo," + ;
"Fsubton,Signomov,Fsubtot,Desmntosi1,Desmntosi,Desmntosi2,Recmntosi,Recmntosi1,Recmntosi2,Origonline," + ;
"Desaut,Anulado,Fcompfis,Ualtafw,Descfw,Simbmon,Hmodifw,Horaimpo,Horaexpo,Smodifw,Bdaltafw,Bdmodifw,F" + ;
"hora,Umodifw,Esttrans,Opecomm,Zadsfw,Faltafw,Saltafw,Idajuste,Valtafw,Vmodifw,Haltafw,Idvuelto,Monsi" + ;
"s,Motdescdev,Fobs,Fcuit,Md1,Fcliente,Fmtdes1,Fmtdes2,Idsenia,Codigo,Desmntosi3,Receptor,Fven,Totdesc" + ;
"si,Tdci,Moneda,Fletra,Codlista,Email,Vtosenia,Fptoven,Trci,Totrecarsi,Fvuelto,Fnumcomp,Ftotal,Ffch,F" + ;
"mtdes3,Deuda,Cotiz,Fpodes,Recmnto2,Entregapos,Fdescu,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Re" + ;
"cmnto1,Gravamen,Fimpuesto,Totrecar,Totdesc,Totimpue,Merconsign,Cancelar,Ivasis,Tipocrela,Letrarela,P" + ;
"untorela,Numerorela,Feccrela" + ;
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..IdCaja ) + ',' + transform( &lcCursor..FPODES1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..FTurno ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..TotalCant ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..MDCIMPU )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..DesMntoSI1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + Transform( iif( &lcCursor..OrigOnline, 1, 0 )) + ',' + Transform( iif( &lcCursor..DESAUT, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..FMTDES2 )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + transform( &lcCursor..totdescSI ) + ',' + transform( &lcCursor..TDCI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'NOTADECREDITOELECTRONICADECREDITO_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'NOTADECREDITOELECTRONICADECREDITO_FOBS'
				llRetorno = .T.
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FD2 = isnull( d.FD2, t.FD2 ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.INFORMNUBE = isnull( d.INFORMNUBE, t.INFORMNUBE ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.DATOSECOMM = isnull( d.DATOSECOMM, t.DATOSECOMM ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.ORIGONLINE = isnull( d.ORIGONLINE, t.ORIGONLINE ),t.DESAUT = isnull( d.DESAUT, t.DESAUT ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.IDSENIA = isnull( d.IDSENIA, t.IDSENIA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.RECEPTOR = isnull( d.RECEPTOR, t.RECEPTOR ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.VTOSENIA = isnull( d.VTOSENIA, t.VTOSENIA ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.MR = isnull( d.MR, t.MR ),t.MR2 = isnull( d.MR2, t.MR2 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.MERCONSIGN = isnull( d.MERCONSIGN, t.MERCONSIGN ),t.CANCELAR = isnull( d.CANCELAR, t.CANCELAR ),t.IVASIS = isnull( d.IVASIS, t.IVASIS ),t.TIPOCRELA = isnull( d.TIPOCRELA, t.TIPOCRELA ),t.LETRARELA = isnull( d.LETRARELA, t.LETRARELA ),t.PUNTORELA = isnull( d.PUNTORELA, t.PUNTORELA ),t.NUMERORELA = isnull( d.NUMERORELA, t.NUMERORELA ),t.FECCRELA = isnull( d.FECCRELA, t.FECCRELA )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fd2,Fecimpo,Fmodifw,Fectrans,Informnube,Fecexpo,Datosecomm,Idcaja,Fpodes1,Fperson,Fturno,Fajxre,Timestamp,Totalcant,Factsec,Mdcimpu,Subtotsisi,Fpodes2,Subtotcisi,Condivalp,Sitfisccli,Facttipo,Fsubton,Signomov,Fsubtot,Desmntosi1,Desmntosi,Desmntosi2,Recmntosi,Recmntosi1,Recmntosi2,Origonline,Desaut,Anulado,Fcompfis,Ualtafw,Descfw,Simbmon,Hmodifw,Horaimpo,Horaexpo,Smodifw,Bdaltafw,Bdmodifw,Fhora,Umodifw,Esttrans,Opecomm,Zadsfw,Faltafw,Saltafw,Idajuste,Valtafw,Vmodifw,Haltafw,Idvuelto,Monsis,Motdescdev,Fobs,Fcuit,Md1,Fcliente,Fmtdes1,Fmtdes2,Idsenia,Codigo,Desmntosi3,Receptor,Fven,Totdescsi,Tdci,Moneda,Fletra,Codlista,Email,Vtosenia,Fptoven,Trci,Totrecarsi,Fvuelto,Fnumcomp,Ftotal,Ffch,Fmtdes3,Deuda,Cotiz,Fpodes,Recmnto2,Entregapos,Fdescu,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Recmnto1,Gravamen,Fimpuesto,Totrecar,Totdesc,Totimpue,Merconsign,Cancelar,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela)
					Select isnull( d.FD2,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.INFORMNUBE,''),isnull( d.FECEXPO,''),isnull( d.DATOSECOMM,''),isnull( d.IDCAJA,0),isnull( d.FPODES1,0),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.FAJXRE,0),isnull( d.TIMESTAMP,0),isnull( d.TOTALCANT,0),isnull( d.FACTSEC,''),isnull( d.MDCIMPU,0),isnull( d.SUBTOTSISI,0),isnull( d.FPODES2,0),isnull( d.SUBTOTCISI,0),isnull( d.CONDIVALP,0),isnull( d.SITFISCCLI,0),isnull( d.FACTTIPO,0),isnull( d.FSUBTON,0),isnull( d.SIGNOMOV,0),isnull( d.FSUBTOT,0),isnull( d.DESMNTOSI1,0),isnull( d.DESMNTOSI,0),isnull( d.DESMNTOSI2,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTOSI1,0),isnull( d.RECMNTOSI2,0),isnull( d.ORIGONLINE,0),isnull( d.DESAUT,0),isnull( d.ANULADO,0),isnull( d.FCOMPFIS,0),isnull( d.UALTAFW,''),isnull( d.DESCFW,''),isnull( d.SIMBMON,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.SMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.FHORA,''),isnull( d.UMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.OPECOMM,''),isnull( d.ZADSFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.SALTAFW,''),isnull( d.IDAJUSTE,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.IDVUELTO,''),isnull( d.MONSIS,''),isnull( d.MOTDESCDEV,''),isnull( d.FOBS,''),isnull( d.FCUIT,''),isnull( d.MD1,0),isnull( d.FCLIENTE,''),isnull( d.FMTDES1,0),isnull( d.FMTDES2,0),isnull( d.IDSENIA,''),isnull( d.CODIGO,''),isnull( d.DESMNTOSI3,0),isnull( d.RECEPTOR,''),isnull( d.FVEN,''),isnull( d.TOTDESCSI,0),isnull( d.TDCI,0),isnull( d.MONEDA,''),isnull( d.FLETRA,''),isnull( d.CODLISTA,''),isnull( d.EMAIL,''),isnull( d.VTOSENIA,''),isnull( d.FPTOVEN,0),isnull( d.TRCI,0),isnull( d.TOTRECARSI,0),isnull( d.FVUELTO,0),isnull( d.FNUMCOMP,0),isnull( d.FTOTAL,0),isnull( d.FFCH,''),isnull( d.FMTDES3,0),isnull( d.DEUDA,0),isnull( d.COTIZ,0),isnull( d.FPODES,0),isnull( d.RECMNTO2,0),isnull( d.ENTREGAPOS,0),isnull( d.FDESCU,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.RECMNTO,0),isnull( d.RECPOR,0),isnull( d.MR,0),isnull( d.MR2,0),isnull( d.MD2,0),isnull( d.MR1,0),isnull( d.RECMNTO1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECAR,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.MERCONSIGN,0),isnull( d.CANCELAR,0),isnull( d.IVASIS,0),isnull( d.TIPOCRELA,0),isnull( d.LETRARELA,''),isnull( d.PUNTORELA,0),isnull( d.NUMERORELA,0),isnull( d.FECCRELA,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="FECHATRANSFERENCIA                      " tabla="COMPROBANTEV   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                                                                                                                       " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="COMPROBANTEV   " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPROBANTEV   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="NROOPECOMMERCE                          " tabla="COMPROBANTEV   " campo="OPECOMM   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="416" etiqueta="Moneda                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="VUELTO                                  " tabla="COMPROBANTEV   " campo="FVUELTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vuelto persistido                                                                                                                                                                                                                                         " dominio="VUELTO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                                                                                                                     " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="DEUDA                                   " tabla="COMPROBANTEV   " campo="DEUDA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Saldo de cta. cte.                                                                                                                                                                                                                                        " dominio="FECHASALDO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="COTIZACION                              " tabla="COMPROBANTEV   " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="428" etiqueta="Cotización                                                                                                                                                                                                                                                " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="MONTODESCUENTO3                         " tabla="COMPROBANTEV   " campo="MD3       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="438" etiqueta="Monto de descuento                                                                                                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="RECARGOMONTO                            " tabla="COMPROBANTEV   " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="Recargo % monto                                                                                                                                                                                                                                           " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="42" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="RECARGOMONTO2                           " tabla="COMPROBANTEV   " campo="MR2       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="444" etiqueta="Recargo monto                                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="43" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECAR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total recargo                                                                                                                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuento                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="28" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="452" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="PUNTODEVENTACPTERELACIONADO             " tabla="COMPROBANTEV   " campo="PUNTORELA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="458" etiqueta="Pto. de venta comprobante asociado                                                                                                                                                                                                                        " dominio="COMPROBANTERELACIONADO        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="92" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOELECTRONICADECREDITO       " atributo="ENTREGAPOSTERIORVIRTUAL                 " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="464" etiqueta="Tipo de entrega                                                                                                                                                                                                                                           " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="95" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
