...
define class Mock_COMPONENTEFACTURACIONELECTRONICA as MockBase of MockBase.prg

	cClase = 'COMPONENTEFACTURACIONELECTRONICA'

	
	CodigoDeDevolucionPorDefecto = ""                                                                                                                                                                                                                         
	CodigoDeProductoPorDefecto = ""                                                                                                                                                                                                                           
	CodigoDeRecargoPorDefecto = ""                                                                                                                                                                                                                            
	DescripcionRecargoPorDefecto = ""                                                                                                                                                                                                                         
	UnidadesPorDefecto = 0                                                                                                                                                                                                                                    
	cCuit = ""                                                                                                                                                                                                                                                
	cCursorTiposDocumento = ""                                                                                                                                                                                                                                
	cEntidad = ""                                                                                                                                                                                                                                             
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cLetra = ""                                                                                                                                                                                                                                               
	cTipoDeConcepto = "P"                                                                                                                                                                                                                                     
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	lNuevo = .F.                                                                                                                                                                                                                                              
	lProcesarComprobantesPreviosSinCAE = .f.                                                                                                                                                                                                                  
	lUsaServidorMTXCA = .f.                                                                                                                                                                                                                                   
	lYaProcesoComprobantesPreviosSinCAE = .f.                                                                                                                                                                                                                 
	nIva = 0                                                                                                                                                                                                                                                  
	nNeto = 0                                                                                                                                                                                                                                                 
	nNetoNoGravado = 0                                                                                                                                                                                                                                        
	nPuntoDeVenta = 0                                                                                                                                                                                                                                         
	...
	oColSentencias = Null                                                                                                                                                                                                                                     
	oCombinacion = null                                                                                                                                                                                                                                       
	oComprobanteSinCaePorTimeOut = null &&Obtuvo CAE en AFIP pero no se cargó el dato en la tabla de DF                                                                                                                                                       
	...
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	oParseadorDeErroresNet = null                                                                                                                                                                                                                             
	oUnidadDeMedidaFE = Null                                                                                                                                                                                                                                  
	...
	*-----------------------------------------------------------------------------------------
	function cargarcomprobante( toentidad as object, tntipo as integer, tcletra as string, tnpuntodeventa as integer, tnnumero as integer ) as boolean                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function comprobanterelacionadoestarechazadoenafip( tncuit as integer, tocomprobanteasoc as object ) as string                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tncuit
		lxParam2 = tocomprobanteasoc
		...
		return this.ObtenerResultado( 'Comprobanterelacionadoestarechazadoenafip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function encriptarcodigodebarracae( tcstring as string ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Encriptarcodigodebarracae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function enviarestimuloomnicanalidad( toentidad as object ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Enviarestimuloomnicanalidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenarcomprobanteasociado( todetalle as object, toentidad as object ) as void                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenarcomprobanteasociado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function llenarobjetocomprobantesincaeportimeout() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Llenarobjetocomprobantesincaeportimeout', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerclavecomprobanteafip( tntipocpterelacionado as number, tcletracpterelacionado as string ) as string                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tntipocpterelacionado
		lxParam2 = tcletracpterelacionado
		...
		return this.ObtenerResultado( 'Obtenerclavecomprobanteafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercodigobarracae( tncae as integer, tdfecha as date ) as string                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenercodigobarracae', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercotizacion( todetalle as object, toentidad as object ) as integer                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatoscaea( tccaearef, tdfechavtoref, tncodcaearef, tcfechacomprobante, tnpuntodeventa ) as void                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = tccaearef
		lxParam2 = tdfechavtoref
		lxParam3 = tncodcaearef
		lxParam4 = tcfechacomprobante
		...
		return this.ObtenerResultado( 'Obtenerdatoscaea', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerdatoscaeadeobjetocae( tccodigo as string, tncodigocaearef as integer, tlcaeainformadoref as boolean ) as void                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tccodigo
		lxParam2 = tncodigocaearef
		lxParam3 = tlcaeainformadoref
		...
		return this.ObtenerResultado( 'Obtenerdatoscaeadeobjetocae', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerequivalenciadetipodedocumento( tctipodedocumento as string ) as integer                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tctipodedocumento
		...
		return this.ObtenerResultado( 'Obtenerequivalenciadetipodedocumento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfechadelcomprobanteasociado( toobjetocabecera as object, toentidad as object ) as object                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toobjetocabecera
		lxParam2 = toentidad
		...
		return this.ObtenerResultado( 'Obtenerfechadelcomprobanteasociado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerfechaultimocae() as string                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerfechaultimocae', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerfechavencimientocae( tccodigo as string ) as date                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerfechavencimientocae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermensajedeobservacion( todetalle as object ) as string                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenermensajedeobservacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenernumerocae( tccodigo as string ) as string                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenernumerocae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerobservaciones( tccodigo as string ) as string                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerobservaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ounidaddemedidafe_access() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ounidaddemedidafe_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function persistircaea( tccodfac as string, tccaea as string, tdfecha as date, tncodigocaea as number ) as void                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Persistircaea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesocaeainforma( toentidad as entidad of entidad.prg, tnnumerocaea, tlcaeaporcontingencia as boolean ) as object                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = toentidad
		lxParam2 = tnnumerocaea
		lxParam3 = tlcaeaporcontingencia
		...
		return this.ObtenerResultado( 'Procesocaeainforma', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesocaeainformasinmovimientos( tnptovta as integer, tcnumerocaea as string ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tnptovta
		lxParam2 = tcnumerocaea
		...
		return this.ObtenerResultado( 'Procesocaeainformasinmovimientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesogeneracioncae( toentidad as entidad of entidad.prg ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Procesogeneracioncae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reintentarcaeportimeout( torespuesta as object , toentidad as object ) as void                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Reintentarcaeportimeout', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tieneatributoscpterelacionadocompletos( toentidad as object ) as boolean                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Tieneatributoscpterelacionadocompletos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearequivalenciasdetipodedocumento() as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Crearequivalenciasdetipodedocumento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function informarcaea( toobjetocabeceracaea as object, toobjetoconfiguracion as object )                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toobjetocabeceracaea
		lxParam2 = toobjetoconfiguracion
	...
	*-----------------------------------------------------------------------------------------
	protected function informarcaeaperiodosinmovimientos( toconfiguracion as object, tnptovta as integer, tcnumerocaea as string) as object                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
	...
	*-----------------------------------------------------------------------------------------
	protected function llenardescuentoscomprobante( todetalle as object, toentidad as object ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenardescuentoscomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenardetalledearticulos( todetalle as object, toentidad as object ) as void                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenardetalledearticulos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarobjetocabecera( toobjcabecera as object, toentidad as object ) as void                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toobjcabecera
		lxParam2 = toentidad
		...
		return this.ObtenerResultado( 'Llenarobjetocabecera', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarobjetocabeceracaea( toobjcabecera as object,toentidad as entidad of entidad.prg, tnnumerocaea as number, tlcaeaporcontingencia as boolean ) as void                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		lxParam1 = toobjcabecera
		lxParam2 = toentidad
		lxParam3 = tnnumerocaea
		lxParam4 = tlcaeaporcontingencia
		...
		return this.ObtenerResultado( 'Llenarobjetocabeceracaea', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarobjetodetalle( todetalle as object, toentidad as object )  as void                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenarobjetodetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarobjetodetallecaea( todetalle as object, toentidad as object, tnnumerocaea as number)  as void                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Llenarobjetodetallecaea', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarrecargoscomprobante( todetalle as object, toentidad as object ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenarrecargoscomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function nonecesitapersonalizarse( toentidad as object ) as boolean                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nonecesitapersonalizarse', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerarticulodescuento( tnporcentajeiva as number, tnmontoiva as long, tnimporte as long ) as object                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tnporcentajeiva
		lxParam2 = tnmontoiva
		lxParam3 = tnimporte
		...
		return this.ObtenerResultado( 'Obtenerarticulodescuento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerarticulorecargo( tnporcentajeiva as number, tnmontoiva as long, tnimporte as long, tnletra as string) as object                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Obtenerarticulorecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercae( tocabecera as object, toconfiguracion as object ) as object                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercodigodevolucion() as string                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigodevolucion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercodigomtxrecargo() as string                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercodigomtxrecargo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercolecciondescuentos( toentidad as object)  as object                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccionrecargos( toentidad as object)  as object                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerobjetocabecera() as object                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerobjetocabeceracaea() as object                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerrespuestavaciacaeaporexcepcionendll( toerror as exception ) as object                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerrespuestavaciacaeaporexcepcionendll', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerrespuestavaciaporexcepcionendll( toerror as exception ) as object                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerrespuestavaciaporexcepcionendll', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerrespuestavaciaporvalidaciones() as object                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerrespuestavaciaporvalidaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerunidadesmtx() as integer                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerunidadesmtx', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function oent_cae_access() as object                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oent_cae_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ofunciones_fe_access() as object                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ofunciones_fe_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oparseadordeerroresnet_access() as object                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oparseadordeerroresnet_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function persistircae( tccodfac as string, torespuesta as object ) as void                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Persistircae', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function recorrercolecciondeimpuestos ( todetalle as object, toentidad as object ) as void                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Recorrercolecciondeimpuestos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function recorrercolecciondeivas ( todetalle as object, toentidad as object ) as void                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Recorrercolecciondeivas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function tratamientodeliva ( todetalle as object, toentidad as object ) as void                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Tratamientodeliva', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function truncar( tnmonto ) as number                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Truncar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarparametros as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarparametros As Void', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificaciondeitempreafip( toarticulo as object, toitem as object ) as void                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Verificaciondeitempreafip', lcParametros )
	EndFunc
