...
define class Mock_GENERADORSENTENCIACOMBINACION_CONPRECIOS as MockBase of MockBase.prg

	cClase = 'GENERADORSENTENCIACOMBINACION_CONPRECIOS'
	...
	cCampoCantidad = ''                                                                                                                                                                                                                                       
	cEntidadConsulta = ""                                                                                                                                                                                                                                     
	cEntidadConsulta = "preciodearticulo"                                                                                                                                                                                                                     
	cTablaPrincipal = ""                                                                                                                                                                                                                                      
	oArticulo = null                                                                                                                                                                                                                                          
	oEntidadConsulta = null                                                                                                                                                                                                                                   
	oEntidadOrigen = null                                                                                                                                                                                                                                     
	oEntidadOrigenFiltro = null                                                                                                                                                                                                                               
	...
	*-----------------------------------------------------------------------------------------
	function obtenerwheretabladeprecioscambiadaporentidadconsulta() as string                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function oentidadorigenfiltro_access() as variant                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oentidadorigenfiltro_access', lcParametros )
	EndFunc
