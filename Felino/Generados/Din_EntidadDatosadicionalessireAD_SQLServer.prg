...
define class Din_EntidadDATOSADICIONALESSIREAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAfip4523Fecexpo, lxAfip4523Fectrans, lxAfip4523Fmodifw, lxAfip4523Faltafw, lxAfip4523Fecimpo, lxAfip4523Smodifw, lxAfip4523Saltafw, lxAfip4523Hmodifw, lxAfip4523Ualtafw, lxAfip4523Vmodifw, lxAfip4523Zadsfw, lxAfip4523Valtafw, lxAfip4523Horaimpo, lxAfip4523Umodifw, lxAfip4523Haltafw, lxAfip4523Bdmodifw, lxAfip4523Bdaltafw, lxAfip4523Esttrans, lxAfip4523Horaexpo, lxAfip4523Codigo, lxAfip4523Motivo, lxAfip4523Fecha, lxAfip4523Nrocerti, lxAfip4523Importe, lxAfip4523Motivoanul, lxAfip4523Codcomp
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.AFIP4523 ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Smodifw","Saltafw","Hmodifw","Ualtafw","Vmodifw","Zadsfw","Valtafw","Horaimpo","Umodifw","Haltafw","Bdmodifw","Bdaltafw","Esttrans","Horaexpo","Codigo","Motivo","Fecha","Nrocerti","Importe","Motivoanul","Codcomp" ) values ( <<"'" + this.ConvertirDateSql( lxAfip4523Fecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip4523Fectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip4523Fmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip4523Faltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip4523Fecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Smodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Saltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Hmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Ualtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Vmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Zadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Valtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Horaimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Umodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Haltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Bdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Bdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Esttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Horaexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Codigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Motivo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAfip4523Fecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAfip4523Nrocerti ) + "'" >>, <<lxAfip4523Importe >>, <<lxAfip4523Motivoanul >>, <<"'" + this.FormatearTextoSql( lxAfip4523Codcomp ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.AFIP4523 set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAfip4523Fecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAfip4523Fectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAfip4523Fmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAfip4523Faltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAfip4523Fecimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAfip4523Smodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAfip4523Saltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAfip4523Hmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAfip4523Ualtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAfip4523Vmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAfip4523Zadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAfip4523Valtafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAfip4523Horaimpo ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAfip4523Umodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAfip4523Haltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAfip4523Bdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAfip4523Bdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAfip4523Esttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAfip4523Horaexpo ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAfip4523Codigo ) + "'">>,"Motivo" = <<"'" + this.FormatearTextoSql( lxAfip4523Motivo ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxAfip4523Fecha ) + "'">>,"Nrocerti" = <<"'" + this.FormatearTextoSql( lxAfip4523Nrocerti ) + "'">>,"Importe" = <<lxAfip4523Importe>>,"Motivoanul" = <<lxAfip4523Motivoanul>>,"Codcomp" = <<"'" + this.FormatearTextoSql( lxAfip4523Codcomp ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxAfip4523Codigo ) + "'">> and  AFIP4523.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Smodifw,Saltafw,Hmodifw,Ualtafw,Vmodifw,Zadsfw,Valt" + ;
"afw,Horaimpo,Umodifw,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Codigo,Motivo,Fecha,Nrocerti,Import" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() 
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.AFIP4523 set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Motivo = ] + "'" + this.FormatearTextoSql( &lcCursor..Motivo ) + "'"+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, NroCerti = ] + "'" + this.FormatearTextoSql( &lcCursor..NroCerti ) + "'"+ [, Importe = ] + transform( &lcCursor..Importe )+ [, MotivoAnul = ] + transform( &lcCursor..MotivoAnul )+ [, CodComp = ] + "'" + this.FormatearTextoSql( &lcCursor..CodComp ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, SMODIFW, SALTAFW, HMODIFW, UALTAFW, VMODIFW, ZADSFW, VALTAFW, HORAIMPO, UMODIFW, HALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, HORAEXPO, Codigo, Motivo, Fecha, NroCerti, Importe, MotivoAnul, CodComp
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Motivo ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.NROCERTI = isnull( d.NROCERTI, t.NROCERTI ),t.IMPORTE = isnull( d.IMPORTE, t.IMPORTE ),t.MOTIVOANUL = isnull( d.MOTIVOANUL, t.MOTIVOANUL ),t.CODCOMP = isnull( d.CODCOMP, t.CODCOMP )
					from ZooLogic.AFIP4523 t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.AFIP4523(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Smodifw,Saltafw,Hmodifw,Ualtafw,Vmodifw,Zadsfw,Valtafw,Horaimpo,Umodifw,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Codigo,Motivo,Fecha,Nrocerti,Importe,Motivoanul,Codcomp)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HMODIFW,''),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.CODIGO,''),isnull( d.MOTIVO,''),isnull( d.FECHA,''),isnull( d.NROCERTI,''),isnull( d.IMPORTE,0),isnull( d.MOTIVOANUL,0),isnull( d.CODCOMP,'')
