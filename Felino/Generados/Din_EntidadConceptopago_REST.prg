...
define class Din_EntidadConceptopago_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Conceptopago"
	cClaseResponse = this.cNamespaceDTOs + ".ConceptopagoResponse"
	cClaseModelo = "ConceptopagoModelo"
	cEntidad = "Conceptopago"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptopagoModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptopagoListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptopagoListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ConceptopagoModelo"
		endcase
		return lcRetorno
