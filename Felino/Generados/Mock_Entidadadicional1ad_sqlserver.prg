...
define class Mock_Entidadadicional1ad_sqlserver as MockBase of MockBase.prg

	cClase = 'Entidadadicional1ad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubea1( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubea1', lcParametros )
	EndFunc
