...
define class Din_EntidadAJUSTEDESTOCKAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAjustockFecexpo, lxAjustockFectrans, lxAjustockFmodifw, lxAjustockFecimpo, lxAjustockFaltafw, lxAjustockAjnumero, lxAjustockTipocomp, lxAjustockHoraexpo, lxAjustockHaltafw, lxAjustockHoraimpo, lxAjustockUmodifw, lxAjustockHmodifw, lxAjustockZadsfw, lxAjustockDescfw, lxAjustockVmodifw, lxAjustockValtafw, lxAjustockSmodifw, lxAjustockUaltafw, lxAjustockSaltafw, lxAjustockBdmodifw, lxAjustockEsttrans, lxAjustockBdaltafw, lxAjustockAjcodigo, lxAjustockAjobs, lxAjustockAjfecha, lxAjustockAjfedesde, lxAjustockAjfehasta, lxAjustockAjdhora, lxAjustockAjserie, lxAjustockAjdusuario
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.AJUSTOCK ( "Fecexpo","Fectrans","Fmodifw","Fecimpo","Faltafw","Ajnumero","Tipocomp","Horaexpo","Haltafw","Horaimpo","Umodifw","Hmodifw","Zadsfw","Descfw","Vmodifw","Valtafw","Smodifw","Ualtafw","Saltafw","Bdmodifw","Esttrans","Bdaltafw","Ajcodigo","Ajobs","Ajfecha","Ajfedesde","Ajfehasta","Ajdhora","Ajserie","Ajdusuario" ) values ( <<"'" + this.ConvertirDateSql( lxAjustockFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjustockFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjustockFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjustockFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjustockFaltafw ) + "'" >>, <<lxAjustockAjnumero >>, <<lxAjustockTipocomp >>, <<"'" + this.FormatearTextoSql( lxAjustockHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockAjcodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockAjobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjustockAjfecha ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjustockAjfedesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjustockAjfehasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockAjdhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockAjserie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjustockAjdusuario ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.StockAfectadoAuditoriaComb
				if this.oEntidad.StockAfectadoAuditoriaComb.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajAudiCombDet("COMP","NROITEM","ajdCodigo","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.StockAfectadoAuditoriaEnTransito
				if this.oEntidad.StockAfectadoAuditoriaEnTransito.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajAuEnTranDet("COMP","NROITEM","ajdCodigo","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.AJUSTOCK set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAjustockFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAjustockFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAjustockFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAjustockFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAjustockFaltafw ) + "'">>,"Ajnumero" = <<lxAjustockAjnumero>>,"Tipocomp" = <<lxAjustockTipocomp>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAjustockHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAjustockHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAjustockHoraimpo ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAjustockUmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAjustockHmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAjustockZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxAjustockDescfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAjustockVmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAjustockValtafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAjustockSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAjustockUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAjustockSaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAjustockBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAjustockEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAjustockBdaltafw ) + "'">>,"Ajcodigo" = <<"'" + this.FormatearTextoSql( lxAjustockAjcodigo ) + "'">>,"Ajobs" = <<"'" + this.FormatearTextoSql( lxAjustockAjobs ) + "'">>,"Ajfecha" = <<"'" + this.ConvertirDateSql( lxAjustockAjfecha ) + "'">>,"Ajfedesde" = <<"'" + this.ConvertirDateSql( lxAjustockAjfedesde ) + "'">>,"Ajfehasta" = <<"'" + this.ConvertirDateSql( lxAjustockAjfehasta ) + "'">>,"Ajdhora" = <<"'" + this.FormatearTextoSql( lxAjustockAjdhora ) + "'">>,"Ajserie" = <<"'" + this.FormatearTextoSql( lxAjustockAjserie ) + "'">>,"Ajdusuario" = <<"'" + this.FormatearTextoSql( lxAjustockAjdusuario ) + "'">> where "Ajcodigo" = <<"'" + this.FormatearTextoSql( lxAjustockAjcodigo ) + "'">> and  AJUSTOCK.AJCODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Ajnumero" as "Numero", "Tipocomp" as "Tipo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Ajcodigo" as "Codigo", "Ajobs" as "Obs", "Ajfecha" as "Fecha", "Ajfedesde" as "Fechadesde", "Ajfehasta" as "Fechahasta", "Ajdhora" as "Hora", "Ajserie" as "Serie", "Ajdusuario" as "Usuario" from ZooLogic.AJUSTOCK where "Ajcodigo" = <<"'" + this.FormatearTextoSql( lxAjustockAjcodigo ) + "'">> and  AJUSTOCK.AJCODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Ajdcodigo" as "Codigo", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad" from ZooLogic.ajAudiCombDet where ajdCodigo = <<"'" + this.FormatearTextoSql( c_AJUSTEDESTOCK.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Ajdcodigo" as "Codigo", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad" from ZooLogic.ajAuEnTranDet where ajdCodigo = <<"'" + this.FormatearTextoSql( c_AJUSTEDESTOCK.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Fecimpo,Faltafw,Ajnumero,Tipocomp,Horaexpo,Haltafw,Horaimpo,Umodifw" + ;
",Hmodifw,Zadsfw,Descfw,Vmodifw,Valtafw,Smodifw,Ualtafw,Saltafw,Bdmodifw,Esttrans,Bdaltafw,Ajcodigo,A" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleStockAfectadoAuditoriaComb( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Ajdcodigo" as "Codigo", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.StockAfectadoAuditoriaComb
				if this.oEntidad.StockAfectadoAuditoriaComb.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajAudiCombDet("COMP","NROITEM","ajdCodigo","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.StockAfectadoAuditoriaEnTransito
				if this.oEntidad.StockAfectadoAuditoriaEnTransito.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajAuEnTranDet("COMP","NROITEM","ajdCodigo","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.AJUSTOCK set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, ajnumero = ] + transform( &lcCursor..ajnumero )+ [, tipocomp = ] + transform( &lcCursor..tipocomp )+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, ajCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..ajCodigo ) + "'"+ [, ajObs = ] + "'" + this.FormatearTextoSql( &lcCursor..ajObs ) + "'"+ [, ajfecha = ] + "'" + this.ConvertirDateSql( &lcCursor..ajfecha ) + "'"+ [, ajfedesde = ] + "'" + this.ConvertirDateSql( &lcCursor..ajfedesde ) + "'"+ [, ajfehasta = ] + "'" + this.ConvertirDateSql( &lcCursor..ajfehasta ) + "'"+ [, ajdHora = ] + "'" + this.FormatearTextoSql( &lcCursor..ajdHora ) + "'"+ [, ajSerie = ] + "'" + this.FormatearTextoSql( &lcCursor..ajSerie ) + "'"+ [, ajdUsuario = ] + "'" + this.FormatearTextoSql( &lcCursor..ajdUsuario ) + "'" + [ Where ajCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..ajCodigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FECIMPO, FALTAFW, ajnumero, tipocomp, HORAEXPO, HALTAFW, HORAIMPO, UMODIFW, HMODIFW, ZADSFW, DescFW, VMODIFW, VALTAFW, SMODIFW, UALTAFW, SALTAFW, BDMODIFW, ESTTRANS, BDALTAFW, ajCodigo, ajObs, ajfecha, ajfedesde, ajfehasta, ajdHora, ajSerie, ajdUsuario
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + transform( &lcCursor..ajnumero ) + ',' + transform( &lcCursor..tipocomp )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ajCodigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ajObs ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..ajfecha ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..ajfedesde ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..ajfehasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ajdHora ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"COMP","NROITEM","ajdCodigo","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.ajAudiCombDet ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.COMP       ) + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdCodigo  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdart     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdADesc   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdColor   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdCDesc   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdTalle   ) + "'" + ',' + transform( cDetallesExistentes.ajdstock   ) + ',' + transform( cDetallesExistentes.ajdstocksi ) + ',' + transform( cDetallesExistentes.ajdCant    ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	...
	Scan All
		Text to lcCamposInsert noShow
			"COMP","NROITEM","ajdCodigo","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.ajAuEnTranDet ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.COMP       ) + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdCodigo  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdart     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdADesc   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdColor   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdCDesc   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdTalle   ) + "'" + ',' + transform( cDetallesExistentes.ajdstock   ) + ',' + transform( cDetallesExistentes.ajdstocksi ) + ',' + transform( cDetallesExistentes.ajdCant    ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.AJNUMERO = isnull( d.AJNUMERO, t.AJNUMERO ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.AJCODIGO = isnull( d.AJCODIGO, t.AJCODIGO ),t.AJOBS = isnull( d.AJOBS, t.AJOBS ),t.AJFECHA = isnull( d.AJFECHA, t.AJFECHA ),t.AJFEDESDE = isnull( d.AJFEDESDE, t.AJFEDESDE ),t.AJFEHASTA = isnull( d.AJFEHASTA, t.AJFEHASTA ),t.AJDHORA = isnull( d.AJDHORA, t.AJDHORA ),t.AJSERIE = isnull( d.AJSERIE, t.AJSERIE ),t.AJDUSUARIO = isnull( d.AJDUSUARIO, t.AJDUSUARIO )
					from ZooLogic.AJUSTOCK t inner join deleted d 
							 on t.ajCodigo = d.ajCodigo
				-- Fin Updates
				insert into ZooLogic.AJUSTOCK(Fecexpo,Fectrans,Fmodifw,Fecimpo,Faltafw,Ajnumero,Tipocomp,Horaexpo,Haltafw,Horaimpo,Umodifw,Hmodifw,Zadsfw,Descfw,Vmodifw,Valtafw,Smodifw,Ualtafw,Saltafw,Bdmodifw,Esttrans,Bdaltafw,Ajcodigo,Ajobs,Ajfecha,Ajfedesde,Ajfehasta,Ajdhora,Ajserie,Ajdusuario)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.AJNUMERO,0),isnull( d.TIPOCOMP,0),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.UMODIFW,''),isnull( d.HMODIFW,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.VMODIFW,''),isnull( d.VALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.AJCODIGO,''),isnull( d.AJOBS,''),isnull( d.AJFECHA,''),isnull( d.AJFEDESDE,''),isnull( d.AJFEHASTA,''),isnull( d.AJDHORA,''),isnull( d.AJSERIE,''),isnull( d.AJDUSUARIO,'')
