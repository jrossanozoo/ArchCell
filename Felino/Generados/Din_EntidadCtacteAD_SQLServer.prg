...
define class Din_EntidadCTACTEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxCtacteFaltafw, lxCtacteFmodifw, lxCtacteFectrans, lxCtacteFecimpo, lxCtacteFecexpo, lxCtacteHoraexpo, lxCtacteHoraimpo, lxCtacteHaltafw, lxCtacteUmodifw, lxCtacteVmodifw, lxCtacteZadsfw, lxCtacteValtafw, lxCtacteUaltafw, lxCtacteSaltafw, lxCtacteSmodifw, lxCtacteHmodifw, lxCtacteCodcomp, lxCtacteEsttrans, lxCtacteClglobalid, lxCtacteBdmodifw, lxCtacteCodigo, lxCtacteMoneda, lxCtacteCliente, lxCtacteLetra, lxCtactePtovta, lxCtacteNumero, lxCtacteTotalcc, lxCtacteFactsec, lxCtacteFechaven, lxCtacteTipocomp, lxCtacteSaldocc, lxCtacteFecha, lxCtacteComprob, lxCtacteAnotacion, lxCtacteValor, lxCtacteSigno, lxCtacteBdaltafw
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CTACTE ( "Faltafw","Fmodifw","Fectrans","Fecimpo","Fecexpo","Horaexpo","Horaimpo","Haltafw","Umodifw","Vmodifw","Zadsfw","Valtafw","Ualtafw","Saltafw","Smodifw","Hmodifw","Codcomp","Esttrans","Clglobalid","Bdmodifw","Codigo","Moneda","Cliente","Letra","Ptovta","Numero","Totalcc","Factsec","Fechaven","Tipocomp","Saldocc","Fecha","Comprob","Anotacion","Valor","Signo","Bdaltafw" ) values ( <<"'" + this.ConvertirDateSql( lxCtacteFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtacteFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtacteFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtacteFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtacteFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteCodcomp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteClglobalid ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteCliente ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteLetra ) + "'" >>, <<lxCtactePtovta >>, <<lxCtacteNumero >>, <<lxCtacteTotalcc >>, <<"'" + this.FormatearTextoSql( lxCtacteFactsec ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCtacteFechaven ) + "'" >>, <<lxCtacteTipocomp >>, <<lxCtacteSaldocc >>, <<"'" + this.ConvertirDateSql( lxCtacteFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteComprob ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteAnotacion ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCtacteValor ) + "'" >>, <<lxCtacteSigno >>, <<"'" + this.FormatearTextoSql( lxCtacteBdaltafw ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CTACTE set "Faltafw" = <<"'" + this.ConvertirDateSql( lxCtacteFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCtacteFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCtacteFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCtacteFecimpo ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCtacteFecexpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCtacteHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCtacteHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCtacteHaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCtacteUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCtacteVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCtacteZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCtacteValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCtacteUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCtacteSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCtacteSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCtacteHmodifw ) + "'">>,"Codcomp" = <<"'" + this.FormatearTextoSql( lxCtacteCodcomp ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCtacteEsttrans ) + "'">>,"Clglobalid" = <<"'" + this.FormatearTextoSql( lxCtacteClglobalid ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCtacteBdmodifw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxCtacteCodigo ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxCtacteMoneda ) + "'">>,"Cliente" = <<"'" + this.FormatearTextoSql( lxCtacteCliente ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxCtacteLetra ) + "'">>,"Ptovta" = <<lxCtactePtovta>>,"Numero" = <<lxCtacteNumero>>,"Totalcc" = <<lxCtacteTotalcc>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxCtacteFactsec ) + "'">>,"Fechaven" = <<"'" + this.ConvertirDateSql( lxCtacteFechaven ) + "'">>,"Tipocomp" = <<lxCtacteTipocomp>>,"Saldocc" = "Saldocc" + <<lxCtacteSaldocc>>,"Fecha" = <<"'" + this.ConvertirDateSql( lxCtacteFecha ) + "'">>,"Comprob" = <<"'" + this.FormatearTextoSql( lxCtacteComprob ) + "'">>,"Anotacion" = <<"'" + this.FormatearTextoSql( lxCtacteAnotacion ) + "'">>,"Valor" = <<"'" + this.FormatearTextoSql( lxCtacteValor ) + "'">>,"Signo" = <<lxCtacteSigno>>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCtacteBdaltafw ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxCtacteCodigo ) + "'">> and  CTACTE.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Codcomp" as "Codigocomprobante", "Esttrans" as "Estadotransferencia", "Clglobalid" as "Idglobalcliente", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Moneda" as "Moneda", "Cliente" as "Cliente", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Factsec" as "Secuencia", "Fechaven" as "Fechavencimiento", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Valor" as "Valor", "Signo" as "Signodemovimiento", "Bdaltafw" as "Basededatosaltafw" from ZooLogic.CTACTE where "Codigo" = <<"'" + this.FormatearTextoSql( lxCtacteCodigo ) + "'">> and  CTACTE.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Codcomp" as "Codigocomprobante", "Esttrans" as "Estadotransferencia", "Clglobalid" as "Idglobalcliente", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Moneda" as "Moneda", "Cliente" as "Cliente", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Factsec" as "Secuencia", "Fechaven" as "Fechavencimiento", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Valor" as "Valor", "Signo" as "Signodemovimiento", "Bdaltafw" as "Basededatosaltafw" from ZooLogic.CTACTE where  funciones.dtos( fechaven ) + str( TipoComp, 2, 0) + funciones.padr( letra, 1, ' ' ) + str( ptovta, 4, 0) + str( numero, 8, 0) + funciones.padr( Valor, 5, ' ' ) + funciones.padr( Cliente, 5, ' ' ) + funciones.padr( factsec, 2, ' ' ) + funciones.padr( BDAltaFW, 8, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CTACTE.CODIGO != '' order by fechaven,TipoComp,letra,ptovta,numero,Valor,Cliente,factsec,BDAltaFW
			endtext
			use in select('c_CTACTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CTACTE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Codcomp" as "Codigocomprobante", "Esttrans" as "Estadotransferencia", "Clglobalid" as "Idglobalcliente", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Moneda" as "Moneda", "Cliente" as "Cliente", "Letra" as "Letra", "Ptovta" as "Puntodeventa", "Numero" as "Numero", "Totalcc" as "Totalcc", "Factsec" as "Secuencia", "Fechaven" as "Fechavencimiento", "Tipocomp" as "Tipodecomprobante", "Saldocc" as "Saldocc", "Fecha" as "Fecha", "Comprob" as "Comprobante", "Anotacion" as "Anotacion", "Valor" as "Valor", "Signo" as "Signodemovimiento", "Bdaltafw" as "Basededatosaltafw" from ZooLogic.CTACTE where  funciones.dtos( fechaven ) + str( TipoComp, 2, 0) + funciones.padr( letra, 1, ' ' ) + str( ptovta, 4, 0) + str( numero, 8, 0) + funciones.padr( Valor, 5, ' ' ) + funciones.padr( Cliente, 5, ' ' ) + funciones.padr( factsec, 2, ' ' ) + funciones.padr( BDAltaFW, 8, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CTACTE.CODIGO != '' order by fechaven desc,TipoComp desc,letra desc,ptovta desc,numero desc,Valor desc,Cliente desc,factsec desc,BDAltaFW desc
			endtext
			use in select('c_CTACTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CTACTE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Faltafw,Fmodifw,Fectrans,Fecimpo,Fecexpo,Horaexpo,Horaimpo,Haltafw,Umodifw,Vmodifw,Zadsfw,Va" + ;
"ltafw,Ualtafw,Saltafw,Smodifw,Hmodifw,Codcomp,Esttrans,Clglobalid,Bdmodifw,Codigo,Moneda,Cliente,Let" + ;
"ra,Ptovta,Numero,Totalcc,Factsec,Fechaven,Tipocomp,Saldocc,Fecha,Comprob,Anotacion,Valor,Signo,Bdalt" + ;
"afw" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() 
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.CTACTE set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, CodComp = ] + "'" + this.FormatearTextoSql( &lcCursor..CodComp ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, clGlobalID = ] + "'" + this.FormatearTextoSql( &lcCursor..clGlobalID ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, Cliente = ] + "'" + this.FormatearTextoSql( &lcCursor..Cliente ) + "'"+ [, letra = ] + "'" + this.FormatearTextoSql( &lcCursor..letra ) + "'"+ [, ptovta = ] + transform( &lcCursor..ptovta )+ [, numero = ] + transform( &lcCursor..numero )+ [, TotalCC = ] + transform( &lcCursor..TotalCC )+ [, factsec = ] + "'" + this.FormatearTextoSql( &lcCursor..factsec ) + "'"+ [, fechaven = ] + "'" + this.ConvertirDateSql( &lcCursor..fechaven ) + "'"+ [, TipoComp = ] + transform( &lcCursor..TipoComp )+ [, SaldoCC = ZooLogic.CTACTE.SaldoCC + ] + transform( &lcCursor..SaldoCC )+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, Comprob = ] + "'" + this.FormatearTextoSql( &lcCursor..Comprob ) + "'"+ [, anotacion = ] + "'" + this.FormatearTextoSql( &lcCursor..anotacion ) + "'"+ [, Valor = ] + "'" + this.FormatearTextoSql( &lcCursor..Valor ) + "'"+ [, Signo = ] + transform( &lcCursor..Signo ) + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FALTAFW, FMODIFW, FECTRANS, FECIMPO, FECEXPO, HORAEXPO, HORAIMPO, HALTAFW, UMODIFW, VMODIFW, ZADSFW, VALTAFW, UALTAFW, SALTAFW, SMODIFW, HMODIFW, CodComp, ESTTRANS, clGlobalID, BDMODIFW, Codigo, Moneda, Cliente, letra, ptovta, numero, TotalCC, factsec, fechaven, TipoComp, SaldoCC, Fecha, Comprob, anotacion, Valor, Signo, BDAltaFW
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodComp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..clGlobalID ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cliente ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..letra ) + "'" + ',' + transform( &lcCursor..ptovta ) + ',' + transform( &lcCursor..numero ) + ',' + transform( &lcCursor..TotalCC ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..factsec ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..fechaven ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.CODCOMP = isnull( d.CODCOMP, t.CODCOMP ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CLGLOBALID = isnull( d.CLGLOBALID, t.CLGLOBALID ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.CLIENTE = isnull( d.CLIENTE, t.CLIENTE ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.PTOVTA = isnull( d.PTOVTA, t.PTOVTA ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.TOTALCC = isnull( d.TOTALCC, t.TOTALCC ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.FECHAVEN = isnull( d.FECHAVEN, t.FECHAVEN ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.SALDOCC = isnull( d.SALDOCC, t.SALDOCC ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.COMPROB = isnull( d.COMPROB, t.COMPROB ),t.ANOTACION = isnull( d.ANOTACION, t.ANOTACION ),t.VALOR = isnull( d.VALOR, t.VALOR ),t.SIGNO = isnull( d.SIGNO, t.SIGNO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW )
				...
				-- Fin Updates
				insert into ZooLogic.CTACTE(Faltafw,Fmodifw,Fectrans,Fecimpo,Fecexpo,Horaexpo,Horaimpo,Haltafw,Umodifw,Vmodifw,Zadsfw,Valtafw,Ualtafw,Saltafw,Smodifw,Hmodifw,Codcomp,Esttrans,Clglobalid,Bdmodifw,Codigo,Moneda,Cliente,Letra,Ptovta,Numero,Totalcc,Factsec,Fechaven,Tipocomp,Saldocc,Fecha,Comprob,Anotacion,Valor,Signo,Bdaltafw)
					Select CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FECEXPO,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.CODCOMP,''),isnull( d.ESTTRANS,''),isnull( d.CLGLOBALID,''),isnull( d.BDMODIFW,''),isnull( d.CODIGO,''),isnull( d.MONEDA,''),isnull( d.CLIENTE,''),isnull( d.LETRA,''),isnull( d.PTOVTA,0),isnull( d.NUMERO,0),isnull( d.TOTALCC,0),isnull( d.FACTSEC,''),isnull( d.FECHAVEN,''),isnull( d.TIPOCOMP,0),isnull( d.SALDOCC,0),isnull( d.FECHA,''),isnull( d.COMPROB,''),isnull( d.ANOTACION,''),isnull( d.VALOR,''),isnull( d.SIGNO,0),isnull( d.BDALTAFW,'')
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					<<loLogueo.EstadoSistema>>,'<<loLogueo.Aplicacion>>','<<loLogueo.Version>>',
					'<<loLogueo.Serie>>','<<loLogueo.Usuario>>','<<loLogueo.NombrePc>>',
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: FECHA VENCIMIENTO ' + cast( d.fechaven as Varchar(8) ) + ', TIPO COMPROBANTE ' + cast( d.TipoComp as Varchar(2) ) + ', LETRA ' + cast( d.letra as Varchar(1) ) + ', PUNTO DE VENTA ' + cast( d.ptovta as Varchar(4) ) + ', NÚMERO ' + cast( d.numero as Varchar(8) ) + ', VALOR ' + cast( d.Valor as Varchar(5) ) + ', CLIENTE ' + cast( d.Cliente as Varchar(5) ) + ', SECUENCIA ' + cast( d.factsec as Varchar(2) ) + ', BASE DE DATOS ' + cast( d.BDAltaFW as Varchar(8) ) + '','La clave principal a importar ya existe'
					from ZooLogic.CTACTE t inner join deleted d 
							 on t.Codigo = d.Codigo
						left join deleted h 
...
<VFPData xml:space="preserve">
	...
	<row entidad="CTACTE                                  " atributo="FECHATRANSFERENCIA                      " tabla="CTACTE         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTE                                  " atributo="ESTADOTRANSFERENCIA                     " tabla="CTACTE         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTE                                  " atributo="CODIGO                                  " tabla="CTACTE         " campo="CODIGO    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="48" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Nro Interno                                                                                                                                                     " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTE                                  " atributo="TOTALCC                                 " tabla="CTACTE         " campo="TOTALCC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Total                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CTACTE                                  " atributo="SECUENCIA                               " tabla="CTACTE         " campo="FACTSEC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Secuencia                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="8" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CTACTE                                  " atributo="FECHAVENCIMIENTO                        " tabla="CTACTE         " campo="FECHAVEN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Fecha Vencimiento                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CTACTE                                  " atributo="TIPODECOMPROBANTE                       " tabla="CTACTE         " campo="TIPOCOMP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="10" etiqueta="Tipo Comprobante                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="2" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CTACTE                                  " atributo="SALDOCC                                 " tabla="CTACTE         " campo="SALDOCC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Saldo                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CTACTE                                  " atributo="BASEDEDATOSALTAFW                       " tabla="CTACTE         " campo="BDALTAFW  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Base de datos                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="9" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="21" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
