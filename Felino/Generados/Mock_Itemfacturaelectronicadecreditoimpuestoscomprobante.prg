...
define class Mock_Itemfacturaelectronicadecreditoimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicadecreditoimpuestoscomprobante'
	...
	*-----------------------------------------------------------------------------------------
	function codigoimpuesto_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Codigoimpuesto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigointerno_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Codigointerno_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoimpuesto( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_codigoimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigointerno( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_codigointerno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoimpuesto( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_codigoimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigointerno( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_codigointerno', lcParametros )
	EndFunc
