...
define class Mock_Itemnotadecreditoelectronicaexportacionvaloresdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditoelectronicaexportacionvaloresdetalle'
