...
define class Mock_fechacancelacion as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Fecha de cancelación del artículo"                                                                                                                                                                                                       
	...
	lHabilitarDetalleFechaCancelacion = .T.                                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallefechacancelacion() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallefechacancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardetalleoperacion() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargardetalleoperacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detallefechacancelacion_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'FECHACANCELACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detallefechacancelacion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detallefechacancelacion_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detallefechacancelacion ) = 'O' or isnull( this.Detallefechacancelacion ) )			this.Detallefechacancelacion = this.crearobjeto( 'Din_DetalleFechacancelacionDetallefechacancelacion' )			this.Detallefechacancelacion.inicializar()			this.enlazar( 'Detallefechacancelacion.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detallefechacancelacion.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detallefechacancelacion, 'CambioSumarizado', this, 'CambiosDetalleDetallefechacancelacion', 1)			this.enlazar( 'Detallefechacancelacion.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detallefechacancelacion.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detallefechacancelacion.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detallefechacancelacion
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarentidadpadre( toentidad as object) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function lanzarfechacancelacion() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Lanzarfechacancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitardetallefechacancelacion_assign( txval as variant ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'FECHACANCELACION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetallefechacancelacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetallefechacancelacion_assign', lcParametros )			endif		endif		this.lHabilitarDetalleFechaCancelacion = txVal		this.DetalleFechaCancelacion.habilitarItems( txVal )
	EndFunc
