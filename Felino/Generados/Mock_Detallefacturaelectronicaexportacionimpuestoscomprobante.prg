...
define class Mock_Detallefacturaelectronicaexportacionimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Detallefacturaelectronicaexportacionimpuestoscomprobante'
