...
define class Mock_MANAGERLOGUEOS as MockBase of MockBase.prg

	cClase = 'MANAGERLOGUEOS'
	...
	*-----------------------------------------------------------------------------------------
	function enviaranet( toobjetologueo as object ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Enviaranet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function guardar( toobjetologueo as object ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Guardar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function guardarparcialmente( toobjetologueo as object ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Guardarparcialmente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerobjetologueo( toquienpide as object ) as object                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerobjetologueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerxmllogueos() as string                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerxmllogueos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reconfigurar as void                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Reconfigurar As Void', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearnet() as void                                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setearnet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function terminar() as void                                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Terminar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregaraobjetosentregado( toobjetologueo as object ) as void                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Agregaraobjetosentregado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function asignarrepositorio( toobjeto as objetologueo of objetologueo.prg, toquienpide as object )as void                                                                                                                                       
		...
		return this.ObtenerResultado( 'Asignarrepositorio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function bajar( toobjetologueo as object ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Bajar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarrepositorios() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Cargarrepositorios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function delimitarstring( tcstring as string, tlretornocarro as boolean ) as string                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Delimitarstring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function eliminarobjetologueo( toobjetologueo as objet ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eliminarobjetologueo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function instanciarclasenet() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Instanciarclasenet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function instanciarlogueonet as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Instanciarlogueonet As Void', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccionrepositorios() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercoleccionrepositorios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercontenidodelarchivodin_logueos() as string                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercontenidodelarchivodin_logueos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerherencias( toquienpide as object ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerherencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenernombredenivel( tnnivel as integer ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenernombredenivel', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenertabuladodetalle( todetalle as object ) as string                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenertabuladodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reemplazarstringconnection( tcxml as string ) as string                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Reemplazarstringconnection', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function serializardetalle( todetalle as object ) as string                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Serializardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function serializarnivel( tonivel as zoocoleccion of zoocoleccion.prg ) as string                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Serializarnivel', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearcabecera( toobjetologueo as object ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setearcabecera', lcParametros )
	EndFunc
