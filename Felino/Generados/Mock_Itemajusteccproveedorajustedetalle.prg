...
define class Mock_Itemajusteccproveedorajustedetalle as MockBase of MockBase.prg

	cClase = 'Itemajusteccproveedorajustedetalle'
	...
	*-----------------------------------------------------------------------------------------
	function proveedordetalle_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Proveedordetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_proveedordetalle( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_proveedordetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_proveedordetalle( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_proveedordetalle', lcParametros )
	EndFunc
