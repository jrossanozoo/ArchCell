...
define class Mock_Itemconciliaciondecajaconciliamovimiento as MockBase of MockBase.prg

	cClase = 'Itemconciliaciondecajaconciliamovimiento'
	...
	*-----------------------------------------------------------------------------------------
	function ajuste_assign( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Ajuste_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desctipocomprobante_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Desctipocomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function saldoact_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Saldoact_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function saldoproy_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Saldoproy_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ajuste( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_ajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_desctipocomprobante( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_desctipocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_saldoact( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_saldoact', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_saldoproy( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_saldoproy', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ajuste( txval as variant ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_ajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_desctipocomprobante( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_desctipocomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_saldoact( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_saldoact', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_saldoproy( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_saldoproy', lcParametros )
	EndFunc
