...
define class Mock_Itemnotadecreditoelectronicadecreditoimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditoelectronicadecreditoimpuestosdetalle'
