	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TALLER ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Timestamp","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaexpo","Horaimpo","Bdaltafw","Esttrans","Bdmodifw","Haltafw","Obs","Codigo","Descrip","Proveedor","Inventario" ) values ( <<"'" + this.ConvertirDateSql( lxTallerFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTallerFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTallerFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTallerFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTallerFectrans ) + "'" >>, <<lxTallerTimestamp >>, <<"'" + this.FormatearTextoSql( lxTallerSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerProveedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTallerInventario ) + "'" >> )
			endtext
		...
		this.oEntidad.Timestamp = lxTallerTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TALLER set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTallerFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTallerFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTallerFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTallerFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTallerFectrans ) + "'">>,"Timestamp" = <<lxTallerTimestamp>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTallerSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTallerSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTallerUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTallerValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTallerUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTallerZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTallerVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTallerHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTallerHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTallerHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTallerBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTallerEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTallerBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTallerHaltafw ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxTallerObs ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxTallerCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxTallerDescrip ) + "'">>,"Proveedor" = <<"'" + this.FormatearTextoSql( lxTallerProveedor ) + "'">>,"Inventario" = <<"'" + this.FormatearTextoSql( lxTallerInventario ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxTallerCodigo ) + "'">> and  TALLER.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Proveedor" as "Proveedor", "Inventario" as "Inventario" from ZooLogic.TALLER where  TALLER.CODIGO != '' order by Codigo
			endtext
			use in select('c_TALLER')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALLER', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Proveedor" as "Proveedor", "Inventario" as "Inventario" from ZooLogic.TALLER where  funciones.padr( Codigo, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TALLER.CODIGO != '' order by Codigo
			endtext
			use in select('c_TALLER')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALLER', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Proveedor" as "Proveedor", "Inventario" as "Inventario" from ZooLogic.TALLER where  funciones.padr( Codigo, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TALLER.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_TALLER')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALLER', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Proveedor" as "Proveedor", "Inventario" as "Inventario" from ZooLogic.TALLER where  TALLER.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_TALLER')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TALLER', set( 'Datasession' ) )
			Endwith
...
"adsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Obs,Codigo,Descrip,Provee" + ;
"dor,Inventario" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Proveedor" as "Proveedor", "Inventario" as "Inventario"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.TALLER set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, Proveedor = ] + "'" + this.FormatearTextoSql( &lcCursor..Proveedor ) + "'"+ [, Inventario = ] + "'" + this.FormatearTextoSql( &lcCursor..Inventario ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, TIMESTAMP, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAEXPO, HORAIMPO, BDALTAFW, ESTTRANS, BDMODIFW, HALTAFW, Obs, Codigo, Descrip, Proveedor, Inventario
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Proveedor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Inventario ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.OBS = isnull( d.OBS, t.OBS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.PROVEEDOR = isnull( d.PROVEEDOR, t.PROVEEDOR ),t.INVENTARIO = isnull( d.INVENTARIO, t.INVENTARIO )
					from ZooLogic.TALLER t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.TALLER(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Timestamp,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Obs,Codigo,Descrip,Proveedor,Inventario)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.OBS,''),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.PROVEEDOR,''),isnull( d.INVENTARIO,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_TALLER' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_TALLER.Timestamp, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="TALLER                                  " atributo="FECHATRANSFERENCIA                      " tabla="TALLER         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TALLER                                  " atributo="TIMESTAMP                               " tabla="TALLER         " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TALLER                                  " atributo="ESTADOTRANSFERENCIA                     " tabla="TALLER         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TALLER                                  " atributo="DESCRIPCION                             " tabla="TALLER         " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="4" etiqueta="Descripción                                                                                                                                                     " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
