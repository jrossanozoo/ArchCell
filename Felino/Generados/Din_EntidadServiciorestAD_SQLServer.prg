...
define class Din_EntidadSERVICIORESTAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxServrestFecexpo, lxServrestFectrans, lxServrestFecimpo, lxServrestFaltafw, lxServrestFmodifw, lxServrestHoraexpo, lxServrestHoraimpo, lxServrestHaltafw, lxServrestSaltafw, lxServrestVmodifw, lxServrestZadsfw, lxServrestValtafw, lxServrestUmodifw, lxServrestSmodifw, lxServrestUaltafw, lxServrestHmodifw, lxServrestBdmodifw, lxServrestBdaltafw, lxServrestEsttrans, lxServrestCodigo, lxServrestObs, lxServrestImpresora, lxServrestDescrip, lxServrestPuerto, lxServrestBasedatos, lxServrestOrigcomp, lxServrestPuesto, lxServrestTipocomp, lxServrestCaja, lxServrestActivo, lxServrestOcvtas, lxServrestLoghasta, lxServrestPercctacte, lxServrestValor
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.SERVREST ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Horaexpo","Horaimpo","Haltafw","Saltafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Smodifw","Ualtafw","Hmodifw","Bdmodifw","Bdaltafw","Esttrans","Codigo","Obs","Impresora","Descrip","Puerto","Basedatos","Origcomp","Puesto","Tipocomp","Caja","Activo","Ocvtas","Loghasta","Percctacte","Valor" ) values ( <<"'" + this.ConvertirDateSql( lxServrestFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxServrestFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxServrestFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxServrestFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxServrestFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestImpresora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestDescrip ) + "'" >>, <<lxServrestPuerto >>, <<"'" + this.FormatearTextoSql( lxServrestBasedatos ) + "'" >>, <<lxServrestOrigcomp >>, <<"'" + this.FormatearTextoSql( lxServrestPuesto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxServrestTipocomp ) + "'" >>, <<lxServrestCaja >>, <<iif( lxServrestActivo, 1, 0 ) >>, <<iif( lxServrestOcvtas, 1, 0 ) >>, <<"'" + this.ConvertirDateSql( lxServrestLoghasta ) + "'" >>, <<iif( lxServrestPercctacte, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxServrestValor ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.dominiosCORS
				if this.oEntidad.dominiosCORS.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.SERVRESTCORS("NROITEM","ruta","Codigo" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxRuta ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.SERVREST set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxServrestFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxServrestFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxServrestFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxServrestFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxServrestFmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxServrestHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxServrestHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxServrestHaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxServrestSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxServrestVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxServrestZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxServrestValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxServrestUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxServrestSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxServrestUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxServrestHmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxServrestBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxServrestBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxServrestEsttrans ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxServrestCodigo ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxServrestObs ) + "'">>,"Impresora" = <<"'" + this.FormatearTextoSql( lxServrestImpresora ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxServrestDescrip ) + "'">>,"Puerto" = <<lxServrestPuerto>>,"Basedatos" = <<"'" + this.FormatearTextoSql( lxServrestBasedatos ) + "'">>,"Origcomp" = <<lxServrestOrigcomp>>,"Puesto" = <<"'" + this.FormatearTextoSql( lxServrestPuesto ) + "'">>,"Tipocomp" = <<"'" + this.FormatearTextoSql( lxServrestTipocomp ) + "'">>,"Caja" = <<lxServrestCaja>>,"Activo" = <<iif( lxServrestActivo, 1, 0 )>>,"Ocvtas" = <<iif( lxServrestOcvtas, 1, 0 )>>,"Loghasta" = <<"'" + this.ConvertirDateSql( lxServrestLoghasta ) + "'">>,"Percctacte" = <<iif( lxServrestPercctacte, 1, 0 )>>,"Valor" = <<"'" + this.FormatearTextoSql( lxServrestValor ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxServrestCodigo ) + "'">> and  SERVREST.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Ruta" as "Ruta", "Codigo" as "Codigo" from ORGANIZACION.SERVRESTCORS where Codigo = <<"'" + this.FormatearTextoSql( c_SERVICIOREST.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Horaexpo,Horaimpo,Haltafw,Saltafw,Vmodifw,Zadsfw,Va" + ;
"ltafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Bdmodifw,Bdaltafw,Esttrans,Codigo,Obs,Impresora,Descrip,Puerto" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalledominiosCORS( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Ruta" as "Ruta", "Codigo" as "Codigo"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.dominiosCORS
				if this.oEntidad.dominiosCORS.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxRuta = loItem.Ruta
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.SERVRESTCORS("NROITEM","ruta","Codigo" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxRuta ) + "'">>, << lcValorClavePrimariaString >> ) 
					endtext
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.SERVREST set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"+ [, impresora = ] + "'" + this.FormatearTextoSql( &lcCursor..impresora ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, Puerto = ] + transform( &lcCursor..Puerto )+ [, BaseDatos = ] + "'" + this.FormatearTextoSql( &lcCursor..BaseDatos ) + "'"+ [, origComp = ] + transform( &lcCursor..origComp )+ [, puesto = ] + "'" + this.FormatearTextoSql( &lcCursor..puesto ) + "'"+ [, tipoComp = ] + "'" + this.FormatearTextoSql( &lcCursor..tipoComp ) + "'"+ [, Caja = ] + transform( &lcCursor..Caja )+ [, activo = ] + Transform( iif( &lcCursor..activo, 1, 0 ))+ [, ocVtas = ] + Transform( iif( &lcCursor..ocVtas, 1, 0 ))+ [, LogHasta = ] + "'" + this.ConvertirDateSql( &lcCursor..LogHasta ) + "'"+ [, PercCtaCte = ] + Transform( iif( &lcCursor..PercCtaCte, 1, 0 ))+ [, Valor = ] + "'" + this.FormatearTextoSql( &lcCursor..Valor ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, HORAEXPO, HORAIMPO, HALTAFW, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SMODIFW, UALTAFW, HMODIFW, BDMODIFW, BDALTAFW, ESTTRANS, Codigo, OBS, impresora, Descrip, Puerto, BaseDatos, origComp, puesto, tipoComp, Caja, activo, ocVtas, LogHasta, PercCtaCte, Valor
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..impresora ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + transform( &lcCursor..Puerto ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..BaseDatos ) + "'" + ',' + transform( &lcCursor..origComp ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..puesto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..tipoComp ) + "'"
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","ruta","Codigo"
		endText
		this.oConexion.EjecutarSql( [Insert into ORGANIZACION.SERVRESTCORS ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ruta       ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Codigo     ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.OBS = isnull( d.OBS, t.OBS ),t.IMPRESORA = isnull( d.IMPRESORA, t.IMPRESORA ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.PUERTO = isnull( d.PUERTO, t.PUERTO ),t.BASEDATOS = isnull( d.BASEDATOS, t.BASEDATOS ),t.ORIGCOMP = isnull( d.ORIGCOMP, t.ORIGCOMP ),t.PUESTO = isnull( d.PUESTO, t.PUESTO ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.CAJA = isnull( d.CAJA, t.CAJA ),t.ACTIVO = isnull( d.ACTIVO, t.ACTIVO ),t.OCVTAS = isnull( d.OCVTAS, t.OCVTAS ),t.LOGHASTA = isnull( d.LOGHASTA, t.LOGHASTA ),t.PERCCTACTE = isnull( d.PERCCTACTE, t.PERCCTACTE ),t.VALOR = isnull( d.VALOR, t.VALOR )
					from ORGANIZACION.SERVREST t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ORGANIZACION.SERVREST(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Horaexpo,Horaimpo,Haltafw,Saltafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Smodifw,Ualtafw,Hmodifw,Bdmodifw,Bdaltafw,Esttrans,Codigo,Obs,Impresora,Descrip,Puerto,Basedatos,Origcomp,Puesto,Tipocomp,Caja,Activo,Ocvtas,Loghasta,Percctacte,Valor)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.CODIGO,''),isnull( d.OBS,''),isnull( d.IMPRESORA,''),isnull( d.DESCRIP,''),isnull( d.PUERTO,0),isnull( d.BASEDATOS,''),isnull( d.ORIGCOMP,0),isnull( d.PUESTO,''),isnull( d.TIPOCOMP,''),isnull( d.CAJA,0),isnull( d.ACTIVO,0),isnull( d.OCVTAS,0),isnull( d.LOGHASTA,''),isnull( d.PERCCTACTE,0),isnull( d.VALOR,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="SERVICIOREST                            " atributo="FECHATRANSFERENCIA                      " tabla="SERVREST       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SERVICIOREST                            " atributo="ESTADOTRANSFERENCIA                     " tabla="SERVREST       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SERVICIOREST                            " atributo="IMPRESORAPREDETERMINADA                 " tabla="SERVREST       " campo="IMPRESORA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="240" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Impresora                                                                                                                                                       " dominio="COMBOIMPRESORAS               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVALORES       " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="423" etiqueta="Detalle Val.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVALORES On SERVREST.VALOR = XVALORES.CLCOD And  XVALORES.CLCOD != '' AND XVALORES.CLCOD != ''                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
