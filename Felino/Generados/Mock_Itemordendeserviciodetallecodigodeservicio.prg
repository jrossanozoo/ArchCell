...
define class Mock_Itemordendeserviciodetallecodigodeservicio as MockBase of MockBase.prg

	cClase = 'Itemordendeserviciodetallecodigodeservicio'
	...
	*-----------------------------------------------------------------------------------------
	function codigoserv_access() as variant                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Codigoserv_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigoserv_pk_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Codigoserv_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoserv( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_codigoserv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoserv( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_codigoserv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigoserv() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridocodigoserv', lcParametros )
	EndFunc
