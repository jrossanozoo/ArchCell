...
define class Mock_SERVICIOESTRUCTURANATIVA as MockBase of MockBase.prg

	cClase = 'SERVICIOESTRUCTURANATIVA'
	...
	*-----------------------------------------------------------------------------------------
	function copiartablassucursal( tcrutaorigen as string, tcrutadestino as string, tcsucursalorigen as string, tcsucursaldestino as string ) as void                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = tcrutaorigen
		lxParam2 = tcrutadestino
		lxParam3 = tcsucursalorigen
		lxParam4 = tcsucursaldestino
		...
		return this.ObtenerResultado( 'Copiartablassucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existearchivodeestructura() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Existearchivodeestructura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarestructuraadn() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Iniciarestructuraadn', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneragrupamientoyordenconsultaprecios() as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obteneragrupamientoyordenconsultaprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneranchoatributopk( tcentidad as string ) as number                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obteneranchoatributopk', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneratributosdefiltrosdedescuentos() as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obteneratributosdefiltrosdedescuentos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampoclavearticulo() as string                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercampoclavearticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampoclaveprimariaparticipantes() as string                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenercampoclaveprimariaparticipantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposatributoscombinacionconcatenados() as string                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercamposatributoscombinacionconcatenados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposatributoscombinaciondestock() as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercamposatributoscombinaciondestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposauditoriadetalle( tndatasessionid as integer, tccursor as string ) as void                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercamposauditoriadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposauditoriaentidad( tndatasessionid as integer, tccursor as string ) as void                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercamposauditoriaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionentidadesconmotivo() as object                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercoleccionentidadesconmotivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionentidadesconorigendestino() as object                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercoleccionentidadesconorigendestino', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionmodulosporentidad() as object                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenercoleccionmodulosporentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionoperaciones( tndatasessionid as integer, tcclavepadre as string, tocoloperaciones as zoocoleccion of zoocoleccion.prg ) as zoocoleccion of zoocoleccion.prg                                                                      
		...
		lnParametros = pcount()
		lxParam1 = tndatasessionid
		lxParam2 = tcclavepadre
		lxParam3 = tocoloperaciones
		...
		return this.ObtenerResultado( 'Obtenercoleccionoperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercursorconfuncionalidades( tndatasessionid as integer ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercursorconfuncionalidades', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercursorestructuraadn( tndatasessionid as integer, tccursor as string ) as void                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercursorestructuraadn', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerentidadesmenuprincipalitems( tndatasessionid as integer ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerentidadesmenuprincipalitems', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneresquema( tctabla as string ) as string                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obteneresquema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerestructuraprecios() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerestructuraprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerestructuratabla( tctabla as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerestructuratabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfuncionpreciorealdelacombinacionconvigencia( tdfechavigencia as date, tclistadeprecios as string, tlnoverificarcalculadaalmomento as boolean, tclistaactual as string ) as string                                                         
		...
		lnParametros = pcount()
		lxParam1 = tdfechavigencia
		lxParam2 = tclistadeprecios
		lxParam3 = tlnoverificarcalculadaalmomento
		lxParam4 = tclistaactual
		...
		return this.ObtenerResultado( 'Obtenerfuncionpreciorealdelacombinacionconvigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfuncionpreciorealdelstockconvigencia( tdfechavigencia as date, tclistadeprecios as string, tlnoverificarcalculadaalmomento as boolean, tclistaactual as string ) as string                                                                
		...
		return this.ObtenerResultado( 'Obtenerfuncionpreciorealdelstockconvigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfuncionpreciorealparticipanteskitsypacksconvigencia( tdfechavigencia as date, tclistadeprecios as string, tlnoverificarcalculadaalmomento as boolean, tclistaactual as string ) as string                                                 
		...
		return this.ObtenerResultado( 'Obtenerfuncionpreciorealparticipanteskitsypacksconvigencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerindices( tndatasessionid as integer, tccursor as string ) as void                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerindices', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerleftjoinscombinacion() as string                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerleftjoinscombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerleftjoinscombinacionprecios() as string                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerleftjoinscombinacionprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombrecursorestructura() as string                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenernombrecursorestructura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneroperaciones( tndatasessionid as integer, tccursor as string ) as void                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obteneroperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerselectconsultaprecios( tdfechavigencia as date, tclistadeprecios as string, tlnoverificarcalculadaalmomento as boolean ) as string                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerselectconsultaprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerselectconsultapreciosconprecioactual( tdfechavigencia as date, tclistadeprecios as string, tlnoverificarcalculadaalmomento as boolean, tclistaactual as string ) as string                                                                
		...
		return this.ObtenerResultado( 'Obtenerselectconsultapreciosconprecioactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerselectpreciosvigentes( tdfechavigencia as date, tclistadeprecios as string ) as string                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerselectpreciosvigentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerselectstockarticulo() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerselectstockarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerselectstockarticulocombinacion() as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerselectstockarticulocombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerselectstockarticulocombinacionconprecios( tdfechavigencia as date, tclistaprecios as string, tlnoverificarcalculadaalmomento as boolean, tclistaactual as string ) as string                                                              
		...
		return this.ObtenerResultado( 'Obtenerselectstockarticulocombinacionconprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciainsertatributosarticulos( tccursor as string ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenersentenciainsertatributosarticulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentenciainsertatributoscombinacion( tccursor as string ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenersentenciainsertatributoscombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertablaconesquema( tctabla as string ) as string                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenertablaconesquema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertablasconsultaprecios() as string                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenertablasconsultaprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertablasparticipantes() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertablasparticipantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertablasstockarticulo() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertablasstockarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertablasstockarticulocombinacion() as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenertablasstockarticulocombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertablasstockcombinacion() as string                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenertablasstockcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerubicacion( tctabla as string ) as string                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerubicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenervalidacionesdefiltrosdedescuentos() as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenervalidacionesdefiltrosdedescuentos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerversion() as string                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerversion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerwherearticulodeproveedor() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerwherearticulodeproveedor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerwherestockarticulo() as string                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerwherestockarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerwherestockarticulocombinacion() as string                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerwherestockarticulocombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerwherevigenciaconsultaprecios( tdfechavigencia as date, tclista as string ) as string                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerwherevigenciaconsultaprecios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerxmlcamposauditoriadetalle() as string                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerxmlcamposauditoriadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerxmlcamposauditoriaentidad() as string                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerxmlcamposauditoriaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerxmlestructura() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerxmlestructura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerxmlindices() as string                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerxmlindices', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerxmloperaciones() as string                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerxmloperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function odinestructuraadn_access() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Odinestructuraadn_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificararchivodeestructura() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Verificararchivodeestructura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarfuncionalidad( tcentidad as string, tcfuncionalidad as string ) as boolean                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Verificarfuncionalidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function compilar( tcarchivo as string ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Compilar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function hayqueiniciarestructuraadn() as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Hayqueiniciarestructuraadn', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursorxml( tcxml as string, tndatasessionid as integer, tccursor as string ) as void                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercursorxml', lcParametros )
	EndFunc
