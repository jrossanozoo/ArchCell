...
define class Mock_VALIDADORESDECOMPROBANTES as MockBase of MockBase.prg

	cClase = 'VALIDADORESDECOMPROBANTES'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	oColeccionDeNombresValidadores = null                                                                                                                                                                                                                     
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function inyectarnombresdevalidadores( tocolecciondenombresvalidadores as string ) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocolecciondenombresvalidadores
		...
		return this.ObtenerResultado( 'Inyectarnombresdevalidadores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pasarinformacion() as void                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Pasarinformacion', lcParametros )
	EndFunc
