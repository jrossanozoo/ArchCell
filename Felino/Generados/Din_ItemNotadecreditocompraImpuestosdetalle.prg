...
define class Din_ItemNOTADECREDITOCOMPRAImpuestosdetalle as ItemIMPUESTOS of ItemIMPUESTOS.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'NOTADECREDITOCOMPRA', 'Impuestosdetalle')
