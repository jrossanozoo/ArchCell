...
define class Mock_Itempickingdetallecontrolado as MockBase of MockBase.prg

	cClase = 'Itempickingdetallecontrolado'
	...
	*-----------------------------------------------------------------------------------------
	function agregado_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Agregado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_agregado( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_agregado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_agregado( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_agregado', lcParametros )
	EndFunc
