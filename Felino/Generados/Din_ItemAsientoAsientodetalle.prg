	...
	function Plandecuentas_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Plandecuentas( lxVal, lxValOld )
			...
			If lxValOld != lxVal or empty( this.Plandecuentasdetalle ) 
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Plandecuentas)" )
			endif 
		endif
		...
		if This.CargaManual()
			if this.Validar_Nroitem( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Nroitem', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Nroitem)" )
				endif 
			EndIf
		Else
			This.Setear_Nroitem( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Plandecuentasdetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Plandecuentasdetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Plandecuentasdetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Plandecuentasdetalle( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Leyenda( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Leyenda', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Leyenda)" )
				endif 
			EndIf
		Else
			This.Setear_Leyenda( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Debe( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Debe', lxValOld, lxVal  )
					...
					this.Debe = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Debe)" )
				endif 
			EndIf
		Else
			This.Setear_Debe( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Haber( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Haber', lxValOld, lxVal  )
					...
					this.Haber = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Haber)" )
				endif 
			EndIf
		Else
			This.Setear_Haber( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Saldo( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Saldo', lxValOld, lxVal  )
					...
					this.Saldo = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Saldo)" )
				endif 
			EndIf
		Else
			This.Setear_Saldo( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Requierecc( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Requierecc', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asientos contables - Atributo: Requierecc)" )
				endif 
			EndIf
		Else
			This.Setear_Requierecc( lxVal ) 
