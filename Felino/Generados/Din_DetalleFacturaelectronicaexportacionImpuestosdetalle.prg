...
define class Din_DetalleFACTURAELECTRONICAEXPORTACIONImpuestosdetalle as DetalleImpuestos of DetalleImpuestos.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemFACTURAELECTRONICAEXPORTACIONImpuestosdetalle' )
