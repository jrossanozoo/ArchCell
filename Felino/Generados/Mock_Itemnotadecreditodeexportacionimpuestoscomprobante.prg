...
define class Mock_Itemnotadecreditodeexportacionimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditodeexportacionimpuestoscomprobante'
