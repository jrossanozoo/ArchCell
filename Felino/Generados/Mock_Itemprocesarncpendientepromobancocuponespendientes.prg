...
define class Mock_Itemprocesarncpendientepromobancocuponespendientes as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function idcliente_access() as variant                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Idcliente_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idcliente_pk_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Idcliente_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofacttipo() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridofacttipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomontoajuste() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridomontoajuste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridotiponotadecredito() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridotiponotadecredito', lcParametros )
	EndFunc
