...
define class Din_DetalleMOVIMIENTODESTOCKMovimientodetalle as DetalleMovstock of DetalleMovstock.Prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemMOVIMIENTODESTOCKMovimientodetalle' )
