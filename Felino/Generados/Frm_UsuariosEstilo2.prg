...
define class Frm_UsuariosEstilo2 as Usuarios of Usuarios.vcx
	ColControles = null
	...
	function SeteosVisuales() as boolean
		...
		************* usuarios/78d1cqa0r/Form
		...
		with this
			...
			with .Pageframe1
				...
				************* Page1/Page/Page
				...
				with .Page1
					...
					************* cmdSegunPerfil/Cmdbase/Commandbutton
					if type( '.cmdSegunPerfil' ) # 'O'
						.newobject( 'cmdSegunPerfil', 'CMDBASE', 'CMDBASE.VCX' )
					endif

					with .cmdSegunPerfil
						.THEMES = .T.
						.DISABLEDPICTURE = ''
						.PICTURE = 'segunperfil.bmp'
			...
			************* cmdBloquear/Cmdbase/Commandbutton
			if type( '.cmdBloquear' ) # 'O'
				.newobject( 'cmdBloquear', 'CMDBASE', 'CMDBASE.VCX' )
			endif
			...
			************* cmdRestaurarClave/Cmdbase/Commandbutton
			if type( '.cmdRestaurarClave' ) # 'O'
				.newobject( 'cmdRestaurarClave', 'CMDBASE', 'CMDBASE.VCX' )
			endif

			with .cmdRestaurarClave
				.THEMES = .T.
				.DISABLEDPICTURE = ''
				.PICTURE = ''
			...
			************* CmdEditar/Cmdbase/Commandbutton
			if type( '.CmdEditar' ) # 'O'
				.newobject( 'CmdEditar', 'CMDBASE', 'CMDBASE.VCX' )
			endif
