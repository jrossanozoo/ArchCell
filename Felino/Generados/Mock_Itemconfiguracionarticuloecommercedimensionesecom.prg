...
define class Mock_Itemconfiguracionarticuloecommercedimensionesecom as MockBase of MockBase.prg

	cClase = 'Itemconfiguracionarticuloecommercedimensionesecom'
