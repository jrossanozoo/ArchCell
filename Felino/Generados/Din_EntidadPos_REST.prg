...
define class Din_EntidadPos_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Pos"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearDetalleTarjetasdetalle( toEntidad, toModeloEnRequest )
			this.SetearDetalleMonedasdetalle( toEntidad, toModeloEnRequest )
			this.SetearDetalleTarjetasicarddetalle( toEntidad, toModeloEnRequest )
			this.SetearDetalleAutorizadoresicarddetalle( toEntidad, toModeloEnRequest )
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleTarjetasDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		local lnI as Integer, loItem as Object, lnCantidad as Integer, loDetalle as Object 
		local loError as Exception
		loDetalle = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest, "TarjetasDetalle" )
		lnCantidad = _Screen.DotNetBridge.ObtenerValorPropiedad( loDetalle, "Count" )
		for lnI = 1 to lnCantidad 
			loItem = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest,"TarjetasDetalle[" + transform( lnI -1 ) + "]" )
			lnNroItem = _Screen.DotNetBridge.ObtenerValorPropiedad( loItem ,"NroItem" )
			if isnull( lnNroItem )
				toEntidad.TarjetasDetalle.LimpiarItem()
			else
				try
					toEntidad.TarjetasDetalle.CargarItem( lnNroItem )
				Catch To loError
					toEntidad.TarjetasDetalle.LimpiarItem()
				endtry 
			endif
			this.SetearAtributoModeloEnEntidad( loItem, "Operadoradetarjeta", toEntidad.TarjetasDetalle.oItem, "OperadoraDeTarjeta_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Operadoradetarjetadetalle", toEntidad.TarjetasDetalle.oItem, "OperadoraDeTarjetaDetalle" )
			this.SetearAtributoModeloEnEntidad( loItem, "Numerocomercio", toEntidad.TarjetasDetalle.oItem, "NumeroComercio" )
			toEntidad.TarjetasDetalle.Actualizar()
			
		endfor
	endfunc
	
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleMonedasDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		local lnI as Integer, loItem as Object, lnCantidad as Integer, loDetalle as Object 
		local loError as Exception
		loDetalle = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest, "MonedasDetalle" )
		lnCantidad = _Screen.DotNetBridge.ObtenerValorPropiedad( loDetalle, "Count" )
		for lnI = 1 to lnCantidad 
			loItem = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest,"MonedasDetalle[" + transform( lnI -1 ) + "]" )
			lnNroItem = _Screen.DotNetBridge.ObtenerValorPropiedad( loItem ,"NroItem" )
			if isnull( lnNroItem )
				toEntidad.MonedasDetalle.LimpiarItem()
			else
				try
					toEntidad.MonedasDetalle.CargarItem( lnNroItem )
				Catch To loError
					toEntidad.MonedasDetalle.LimpiarItem()
				endtry 
			endif
			this.SetearAtributoModeloEnEntidad( loItem, "Simbolo", toEntidad.MonedasDetalle.oItem, "Simbolo" )
			this.SetearAtributoModeloEnEntidad( loItem, "Codigodemoneda", toEntidad.MonedasDetalle.oItem, "CodigoDeMoneda_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Descripcion", toEntidad.MonedasDetalle.oItem, "Descripcion" )
			toEntidad.MonedasDetalle.Actualizar()
			
		endfor
	endfunc
	
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleTarjetasICardDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		local lnI as Integer, loItem as Object, lnCantidad as Integer, loDetalle as Object 
		local loError as Exception
		loDetalle = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest, "TarjetasICardDetalle" )
		lnCantidad = _Screen.DotNetBridge.ObtenerValorPropiedad( loDetalle, "Count" )
		for lnI = 1 to lnCantidad 
			loItem = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest,"TarjetasICardDetalle[" + transform( lnI -1 ) + "]" )
			lnNroItem = _Screen.DotNetBridge.ObtenerValorPropiedad( loItem ,"NroItem" )
			if isnull( lnNroItem )
				toEntidad.TarjetasICardDetalle.LimpiarItem()
			else
				try
					toEntidad.TarjetasICardDetalle.CargarItem( lnNroItem )
				Catch To loError
					toEntidad.TarjetasICardDetalle.LimpiarItem()
				endtry 
			endif
			this.SetearAtributoModeloEnEntidad( loItem, "Numeroequivalencia", toEntidad.TarjetasICardDetalle.oItem, "NumeroEquivalencia" )
			this.SetearAtributoModeloEnEntidad( loItem, "Descripcion", toEntidad.TarjetasICardDetalle.oItem, "Descripcion" )
			this.SetearAtributoModeloEnEntidad( loItem, "Operadora", toEntidad.TarjetasICardDetalle.oItem, "Operadora_PK" )
			this.SetearAtributoModeloEnEntidad( loItem, "Autorizador", toEntidad.TarjetasICardDetalle.oItem, "Autorizador" )
			toEntidad.TarjetasICardDetalle.Actualizar()
			
		endfor
	endfunc
	
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleAutorizadoresICardDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		local lnI as Integer, loItem as Object, lnCantidad as Integer, loDetalle as Object 
		local loError as Exception
		loDetalle = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest, "AutorizadoresICardDetalle" )
		lnCantidad = _Screen.DotNetBridge.ObtenerValorPropiedad( loDetalle, "Count" )
		for lnI = 1 to lnCantidad 
			loItem = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloEnRequest,"AutorizadoresICardDetalle[" + transform( lnI -1 ) + "]" )
			lnNroItem = _Screen.DotNetBridge.ObtenerValorPropiedad( loItem ,"NroItem" )
			if isnull( lnNroItem )
				toEntidad.AutorizadoresICardDetalle.LimpiarItem()
			else
				try
					toEntidad.AutorizadoresICardDetalle.CargarItem( lnNroItem )
				Catch To loError
					toEntidad.AutorizadoresICardDetalle.LimpiarItem()
				endtry 
			endif
			this.SetearAtributoModeloEnEntidad( loItem, "Numeroequivalencia", toEntidad.AutorizadoresICardDetalle.oItem, "NumeroEquivalencia" )
			this.SetearAtributoModeloEnEntidad( loItem, "Descripcion", toEntidad.AutorizadoresICardDetalle.oItem, "Descripcion" )
			toEntidad.AutorizadoresICardDetalle.Actualizar()
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.CargarColeccionModeloTarjetasDetalle( toModeloResponse, toEntidad )
			this.CargarColeccionModeloMonedasDetalle( toModeloResponse, toEntidad )
			this.CargarColeccionModeloTarjetasICardDetalle( toModeloResponse, toEntidad )
			this.CargarColeccionModeloAutorizadoresICardDetalle( toModeloResponse, toEntidad )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarColeccionModeloTarjetasDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		local lnI as Integer, loColeccionModelo as Object
		loColeccionModelo = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloResponse, "TarjetasDetalle" ) 
		with toEntidad
			for lnI = 1 to .TarjetasDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemOperadorasdetarjeta" )
				this.SetearAtributoString( loItem, "Codigo", .TarjetasDetalle.Item(lnI).Codigo)
				this.SetearAtributoString( loItem, "OperadoraDeTarjeta", .TarjetasDetalle.Item(lnI).OperadoraDeTarjeta_PK)
				this.SetearAtributoString( loItem, "OperadoraDeTarjetaDetalle", .TarjetasDetalle.Item(lnI).OperadoraDeTarjetaDetalle)
				this.SetearAtributoString( loItem, "NumeroComercio", .TarjetasDetalle.Item(lnI).NumeroComercio)
				this.SetearAtributoInteger( loItem, "NroItem", .TarjetasDetalle.Item(lnI).NroItem )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarColeccionModeloMonedasDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		local lnI as Integer, loColeccionModelo as Object
		loColeccionModelo = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloResponse, "MonedasDetalle" ) 
		with toEntidad
			for lnI = 1 to .MonedasDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemMonedasdetarjeta" )
				this.SetearAtributoString( loItem, "Codigo", .MonedasDetalle.Item(lnI).Codigo)
				this.SetearAtributoString( loItem, "Simbolo", .MonedasDetalle.Item(lnI).Simbolo)
				this.SetearAtributoString( loItem, "CodigoDeMoneda", .MonedasDetalle.Item(lnI).CodigoDeMoneda_PK)
				this.SetearAtributoString( loItem, "Descripcion", .MonedasDetalle.Item(lnI).Descripcion)
				this.SetearAtributoInteger( loItem, "NroItem", .MonedasDetalle.Item(lnI).NroItem )
				_Screen.DotNetBridge.InvocarMetodo( loColeccionModelo, "Add", loItem) 
			endfor
		endwith
	endfunc
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarColeccionModeloTarjetasICardDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		local lnI as Integer, loColeccionModelo as Object
		loColeccionModelo = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloResponse, "TarjetasICardDetalle" ) 
		with toEntidad
			for lnI = 1 to .TarjetasICardDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemTarjetasicard" )
				this.SetearAtributoString( loItem, "Codigo", .TarjetasICardDetalle.Item(lnI).Codigo)
				this.SetearAtributoInteger( loItem, "NumeroEquivalencia", .TarjetasICardDetalle.Item(lnI).NumeroEquivalencia)
				this.SetearAtributoString( loItem, "Descripcion", .TarjetasICardDetalle.Item(lnI).Descripcion)
				this.SetearAtributoString( loItem, "Operadora", .TarjetasICardDetalle.Item(lnI).Operadora_PK)
				this.SetearAtributoInteger( loItem, "Autorizador", .TarjetasICardDetalle.Item(lnI).Autorizador)
				this.SetearAtributoInteger( loItem, "NroItem", .TarjetasICardDetalle.Item(lnI).NroItem )
				_Screen.DotNetBridge.InvocarMetodo( loColeccionModelo, "Add", loItem) 
			endfor
		endwith
	endfunc
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarColeccionModeloAutorizadoresICardDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		local lnI as Integer, loColeccionModelo as Object
		loColeccionModelo = _Screen.DotNetBridge.ObtenerValorPropiedad( toModeloResponse, "AutorizadoresICardDetalle" ) 
		with toEntidad
			for lnI = 1 to .AutorizadoresICardDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemAutorizicard" )
				this.SetearAtributoString( loItem, "Codigo", .AutorizadoresICardDetalle.Item(lnI).Codigo)
				this.SetearAtributoInteger( loItem, "NumeroEquivalencia", .AutorizadoresICardDetalle.Item(lnI).NumeroEquivalencia)
				this.SetearAtributoString( loItem, "Descripcion", .AutorizadoresICardDetalle.Item(lnI).Descripcion)
				this.SetearAtributoInteger( loItem, "NroItem", .AutorizadoresICardDetalle.Item(lnI).NroItem )
				_Screen.DotNetBridge.InvocarMetodo( loColeccionModelo, "Add", loItem) 
			endfor
		endwith
	endfunc
