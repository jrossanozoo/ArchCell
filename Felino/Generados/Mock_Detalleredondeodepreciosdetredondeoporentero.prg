...
define class Mock_Detalleredondeodepreciosdetredondeoporentero as MockBase of MockBase.prg

	cClase = 'Detalleredondeodepreciosdetredondeoporentero'
	...
	cNombre = 'Detredondeoporentero'                                                                                                                                                                                                                          
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Redondear terminación de enteros'                                                                                                                                                                                                        
	datasession = 1                                                                                                                                                                                                                                           
