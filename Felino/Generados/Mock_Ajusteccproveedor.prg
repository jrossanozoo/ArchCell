...
define class Mock_ajusteccproveedor as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleajustedetalle() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cambiosdetalleajustedetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopedircotizacion() as string                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function tipocomprobante_access() as variant                                                                                                                                                                                                              
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTECCPROVEEDOR' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tipocomprobante_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tipocomprobante_access', lcParametros )			endif		endif		return This.TipoComprobante
	EndFunc
