...
define class Din_DetallePROCESARNCPENDIENTEPROMOBANCOCuponespendientes as detalle of detalle.prg
	...
	Protected Function _CargarItem( tnItem as integer )
		...
		With this.oItem
			Try
				...
				.IdCliente_PK = this.Item[ tnItem ].IdCliente_PK
				llVacio = llVacio and this.VerificarSiElAtributoEstaVacio( 'IdCliente_PK', .IdCliente_PK )
	...
	*--------------------------------------------------------------------------------------------------------
	protected function AplanarItem() as Object
		...
		with loRetorno
			...
			.IdCliente_PK = this.oItem.IdCliente_PK
	...
	*--------------------------------------------------------------------------------------------------------
	...
	with this
		if .ValidarItem()
			...
			.Item[ lnItem ].IdCliente_PK = .oItem.IdCliente_PK
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarExistenciaCamposFijosItemPlano( tnItem as integer ) as Boolean
		...
		if  empty( this.item[ tnItem ].Codigo ) or ; 			 empty( this.item[ tnItem ].Idcupon ) 
			llRetorno = .F.
		endif 
		return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function CopiarItemaItem( toItemOrigen as Object, toItemDestino as Object ) as Object
		...
		toItemDestino.Idcliente_PK = toItemOrigen.Idcliente_PK
