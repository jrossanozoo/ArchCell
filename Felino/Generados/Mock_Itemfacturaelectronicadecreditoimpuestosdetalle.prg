...
define class Mock_Itemfacturaelectronicadecreditoimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicadecreditoimpuestosdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function montodeimpuestointerno_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Montodeimpuestointerno_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function montodeimpuestointernosindescuento_assign( txval as variant ) as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Montodeimpuestointernosindescuento_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montodeiva_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Montodeiva_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montodeivasindescuento_assign( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Montodeivasindescuento_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montonogravado_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Montonogravado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montonogravadosindescuento_assign( txval as variant ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Montonogravadosindescuento_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porcentajedeiva_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Porcentajedeiva_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montodeimpuestointerno( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_montodeimpuestointerno', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_montodeimpuestointernosindescuento( txval as variant ) as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_montodeimpuestointernosindescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montodeiva( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_montodeiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montonogravado( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_montonogravado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porcentajedeiva( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_porcentajedeiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montodeimpuestointerno( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validar_montodeimpuestointerno', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_montodeimpuestointernosindescuento( txval as variant ) as boolean                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validar_montodeimpuestointernosindescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montodeiva( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_montodeiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montodeivasindescuento( txval as variant ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_montodeivasindescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montonogravado( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_montonogravado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montonogravadosindescuento( txval as variant ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_montonogravadosindescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porcentajedeiva( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_porcentajedeiva', lcParametros )
	EndFunc
