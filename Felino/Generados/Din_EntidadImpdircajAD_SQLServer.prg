	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.IMPDIRCAJ ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Timestamp","Horaimpo","Hmodifw","Smodifw","Umodifw","Horaexpo","Ualtafw","Saltafw","Vmodifw","Haltafw","Bdaltafw","Zadsfw","Bdmodifw","Esttrans","Valtafw","Obs","Numero","Descripcio","Condesde","Conhasta","Cladesde","Clahasta","Pcuenta","Importanci" ) values ( <<"'" + this.ConvertirDateSql( lxImpdircajFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircajFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircajFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircajFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdircajFecimpo ) + "'" >>, <<lxImpdircajTimestamp >>, <<"'" + this.FormatearTextoSql( lxImpdircajHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajObs ) + "'" >>, <<lxImpdircajNumero >>, <<"'" + this.FormatearTextoSql( lxImpdircajDescripcio ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajCondesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajConhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajCladesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajClahasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdircajPcuenta ) + "'" >>, <<lxImpdircajImportanci >> )
			endtext
		...
		this.oEntidad.Timestamp = lxImpdircajTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.IMPDIRCAJ set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxImpdircajFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxImpdircajFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxImpdircajFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxImpdircajFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxImpdircajFecimpo ) + "'">>,"Timestamp" = <<lxImpdircajTimestamp>>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxImpdircajHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxImpdircajHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxImpdircajSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxImpdircajUmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxImpdircajHoraexpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxImpdircajUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxImpdircajSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxImpdircajVmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxImpdircajHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxImpdircajBdaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxImpdircajZadsfw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxImpdircajBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxImpdircajEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxImpdircajValtafw ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxImpdircajObs ) + "'">>,"Numero" = <<lxImpdircajNumero>>,"Descripcio" = <<"'" + this.FormatearTextoSql( lxImpdircajDescripcio ) + "'">>,"Condesde" = <<"'" + this.FormatearTextoSql( lxImpdircajCondesde ) + "'">>,"Conhasta" = <<"'" + this.FormatearTextoSql( lxImpdircajConhasta ) + "'">>,"Cladesde" = <<"'" + this.FormatearTextoSql( lxImpdircajCladesde ) + "'">>,"Clahasta" = <<"'" + this.FormatearTextoSql( lxImpdircajClahasta ) + "'">>,"Pcuenta" = <<"'" + this.FormatearTextoSql( lxImpdircajPcuenta ) + "'">>,"Importanci" = <<lxImpdircajImportanci>> where "Numero" = <<lxImpdircajNumero>> and  IMPDIRCAJ.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCAJ where "Numero" = <<lxImpdircajNumero>> and  IMPDIRCAJ.NUMERO != 0
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCAJ where  IMPDIRCAJ.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_IMPDIRCAJ')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCAJ', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCAJ where  str( NUMERO, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPDIRCAJ.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_IMPDIRCAJ')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCAJ', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCAJ where  str( NUMERO, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPDIRCAJ.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_IMPDIRCAJ')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCAJ', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia" from ZooLogic.IMPDIRCAJ where  IMPDIRCAJ.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_IMPDIRCAJ')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRCAJ', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Timestamp,Horaimpo,Hmodifw,Smodifw,Umodifw,Horaexpo" + ;
",Ualtafw,Saltafw,Vmodifw,Haltafw,Bdaltafw,Zadsfw,Bdmodifw,Esttrans,Valtafw,Obs,Numero,Descripcio,Con" + ;
"desde,Conhasta,Cladesde,Clahasta,Pcuenta,Importanci" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Condesde" as "F_concepto_desde", "Conhasta" as "F_concepto_hasta", "Cladesde" as "F_clasificacion_desde", "Clahasta" as "F_clasificacion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.IMPDIRCAJ set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"+ [, NUMERO = ] + transform( &lcCursor..NUMERO )+ [, Descripcio = ] + "'" + this.FormatearTextoSql( &lcCursor..Descripcio ) + "'"+ [, ConDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..ConDesde ) + "'"+ [, ConHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..ConHasta ) + "'"+ [, ClaDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..ClaDesde ) + "'"+ [, ClaHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..ClaHasta ) + "'"+ [, PCUENTA = ] + "'" + this.FormatearTextoSql( &lcCursor..PCUENTA ) + "'"+ [, Importanci = ] + transform( &lcCursor..Importanci ) + [ Where NUMERO = ] + transform( &lcCursor..NUMERO ) )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, TIMESTAMP, HORAIMPO, HMODIFW, SMODIFW, UMODIFW, HORAEXPO, UALTAFW, SALTAFW, VMODIFW, HALTAFW, BDALTAFW, ZADSFW, BDMODIFW, ESTTRANS, VALTAFW, OBS, NUMERO, Descripcio, ConDesde, ConHasta, ClaDesde, ClaHasta, PCUENTA, Importanci
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.OBS = isnull( d.OBS, t.OBS ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.DESCRIPCIO = isnull( d.DESCRIPCIO, t.DESCRIPCIO ),t.CONDESDE = isnull( d.CONDESDE, t.CONDESDE ),t.CONHASTA = isnull( d.CONHASTA, t.CONHASTA ),t.CLADESDE = isnull( d.CLADESDE, t.CLADESDE ),t.CLAHASTA = isnull( d.CLAHASTA, t.CLAHASTA ),t.PCUENTA = isnull( d.PCUENTA, t.PCUENTA ),t.IMPORTANCI = isnull( d.IMPORTANCI, t.IMPORTANCI )
					from ZooLogic.IMPDIRCAJ t inner join deleted d 
							 on t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.IMPDIRCAJ(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Timestamp,Horaimpo,Hmodifw,Smodifw,Umodifw,Horaexpo,Ualtafw,Saltafw,Vmodifw,Haltafw,Bdaltafw,Zadsfw,Bdmodifw,Esttrans,Valtafw,Obs,Numero,Descripcio,Condesde,Conhasta,Cladesde,Clahasta,Pcuenta,Importanci)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.TIMESTAMP,0),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.ZADSFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.OBS,''),isnull( d.NUMERO,0),isnull( d.DESCRIPCIO,''),isnull( d.CONDESDE,''),isnull( d.CONHASTA,''),isnull( d.CLADESDE,''),isnull( d.CLAHASTA,''),isnull( d.PCUENTA,''),isnull( d.IMPORTANCI,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_IMPDIRCAJ' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_IMPDIRCAJ.Timestamp, 0 )
					...
					.F_concepto_desde = nvl( c_IMPDIRCAJ.F_concepto_desde, [] )
					.F_concepto_hasta = nvl( c_IMPDIRCAJ.F_concepto_hasta, [] )
					.F_clasificacion_desde = nvl( c_IMPDIRCAJ.F_clasificacion_desde, [] )
					.F_clasificacion_hasta = nvl( c_IMPDIRCAJ.F_clasificacion_hasta, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="IMPDIRCAJ                               " atributo="FECHATRANSFERENCIA                      " tabla="IMPDIRCAJ      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCAJ                               " atributo="TIMESTAMP                               " tabla="IMPDIRCAJ      " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCAJ                               " atributo="ESTADOTRANSFERENCIA                     " tabla="IMPDIRCAJ      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCAJ                               " atributo="F_CONCEPTO_DESDE                        " tabla="IMPDIRCAJ      " campo="CONDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Concepto                                                                                                                                                        " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCAJ                               " atributo="F_CONCEPTO_HASTA                        " tabla="IMPDIRCAJ      " campo="CONHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="404" etiqueta="Concepto                                                                                                                                                        " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRCAJ                               " atributo="F_CLASIFICACION_HASTA                   " tabla="IMPDIRCAJ      " campo="CLAHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="408" etiqueta="Clasificación                                                                                                                                                   " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRCAJ                               " atributo="PLANDECUENTAS                           " tabla="IMPDIRCAJ      " campo="PCUENTA   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PLANDECUENTAS                           " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="410" etiqueta="Cuenta                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; plancuenta.CTAIMPUT = .t. &quot;                                                                                                                                                                           " grupo="0" subgrupo="1" orden="46" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
