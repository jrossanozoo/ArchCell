...
define class Din_EntidadIMPDIRIMPAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxImpdirimpFecimpo, lxImpdirimpFectrans, lxImpdirimpFmodifw, lxImpdirimpFecexpo, lxImpdirimpFaltafw, lxImpdirimpTimestamp, lxImpdirimpHaltafw, lxImpdirimpSmodifw, lxImpdirimpHoraimpo, lxImpdirimpHoraexpo, lxImpdirimpUaltafw, lxImpdirimpHmodifw, lxImpdirimpUmodifw, lxImpdirimpSaltafw, lxImpdirimpVmodifw, lxImpdirimpZadsfw, lxImpdirimpValtafw, lxImpdirimpBdmodifw, lxImpdirimpBdaltafw, lxImpdirimpEsttrans, lxImpdirimpObs, lxImpdirimpNumero, lxImpdirimpDescripcio, lxImpdirimpImpdesde, lxImpdirimpImphasta, lxImpdirimpTipdesde, lxImpdirimpAplicacion, lxImpdirimpTiphasta, lxImpdirimpJurdesde, lxImpdirimpJurhasta, lxImpdirimpPcuenta, lxImpdirimpImportanci, lxImpdirimpTipoasi
				lxImpdirimpFecimpo =  .Fechaimpo			lxImpdirimpFectrans =  .Fechatransferencia			lxImpdirimpFmodifw =  .Fechamodificacionfw			lxImpdirimpFecexpo =  .Fechaexpo			lxImpdirimpFaltafw =  .Fechaaltafw			lxImpdirimpTimestamp = goLibrerias.ObtenerTimestamp()			lxImpdirimpHaltafw =  .Horaaltafw			lxImpdirimpSmodifw =  .Seriemodificacionfw			lxImpdirimpHoraimpo =  .Horaimpo			lxImpdirimpHoraexpo =  .Horaexpo			lxImpdirimpUaltafw =  .Usuarioaltafw			lxImpdirimpHmodifw =  .Horamodificacionfw			lxImpdirimpUmodifw =  .Usuariomodificacionfw			lxImpdirimpSaltafw =  .Seriealtafw			lxImpdirimpVmodifw =  .Versionmodificacionfw			lxImpdirimpZadsfw =  .Zadsfw			lxImpdirimpValtafw =  .Versionaltafw			lxImpdirimpBdmodifw =  .Basededatosmodificacionfw			lxImpdirimpBdaltafw =  .Basededatosaltafw			lxImpdirimpEsttrans =  .Estadotransferencia			lxImpdirimpObs =  .Observacion			lxImpdirimpNumero =  .Numero			lxImpdirimpDescripcio =  .Descripcion			lxImpdirimpImpdesde =  .F_impuesto_desde			lxImpdirimpImphasta =  .F_impuesto_hasta			lxImpdirimpTipdesde =  .F_tipoimp_desde			lxImpdirimpAplicacion =  .Aplicacion			lxImpdirimpTiphasta =  .F_tipoimp_hasta			lxImpdirimpJurdesde =  .F_jurisdiccion_desde			lxImpdirimpJurhasta =  .F_jurisdiccion_hasta			lxImpdirimpPcuenta =  upper( .PlanDeCuentas_PK ) 			lxImpdirimpImportanci =  .Importancia			lxImpdirimpTipoasi =  .Tipodeasiento
		endwith
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.IMPDIRIMP ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Timestamp","Haltafw","Smodifw","Horaimpo","Horaexpo","Ualtafw","Hmodifw","Umodifw","Saltafw","Vmodifw","Zadsfw","Valtafw","Bdmodifw","Bdaltafw","Esttrans","Obs","Numero","Descripcio","Impdesde","Imphasta","Tipdesde","Aplicacion","Tiphasta","Jurdesde","Jurhasta","Pcuenta","Importanci","Tipoasi" ) values ( <<"'" + this.ConvertirDateSql( lxImpdirimpFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirimpFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirimpFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirimpFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpdirimpFaltafw ) + "'" >>, <<lxImpdirimpTimestamp >>, <<"'" + this.FormatearTextoSql( lxImpdirimpHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpObs ) + "'" >>, <<lxImpdirimpNumero >>, <<"'" + this.FormatearTextoSql( lxImpdirimpDescripcio ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpImpdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpImphasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpTipdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpAplicacion ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpTiphasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpJurdesde ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpJurhasta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpdirimpPcuenta ) + "'" >>, <<lxImpdirimpImportanci >>, <<lxImpdirimpTipoasi >> )
			endtext
		...
		this.oEntidad.Timestamp = lxImpdirimpTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.IMPDIRIMP set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxImpdirimpFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxImpdirimpFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxImpdirimpFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxImpdirimpFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxImpdirimpFaltafw ) + "'">>,"Timestamp" = <<lxImpdirimpTimestamp>>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxImpdirimpHaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxImpdirimpSmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxImpdirimpHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxImpdirimpHoraexpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxImpdirimpUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxImpdirimpHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxImpdirimpUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxImpdirimpSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxImpdirimpVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxImpdirimpZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxImpdirimpValtafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxImpdirimpBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxImpdirimpBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxImpdirimpEsttrans ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxImpdirimpObs ) + "'">>,"Numero" = <<lxImpdirimpNumero>>,"Descripcio" = <<"'" + this.FormatearTextoSql( lxImpdirimpDescripcio ) + "'">>,"Impdesde" = <<"'" + this.FormatearTextoSql( lxImpdirimpImpdesde ) + "'">>,"Imphasta" = <<"'" + this.FormatearTextoSql( lxImpdirimpImphasta ) + "'">>,"Tipdesde" = <<"'" + this.FormatearTextoSql( lxImpdirimpTipdesde ) + "'">>,"Aplicacion" = <<"'" + this.FormatearTextoSql( lxImpdirimpAplicacion ) + "'">>,"Tiphasta" = <<"'" + this.FormatearTextoSql( lxImpdirimpTiphasta ) + "'">>,"Jurdesde" = <<"'" + this.FormatearTextoSql( lxImpdirimpJurdesde ) + "'">>,"Jurhasta" = <<"'" + this.FormatearTextoSql( lxImpdirimpJurhasta ) + "'">>,"Pcuenta" = <<"'" + this.FormatearTextoSql( lxImpdirimpPcuenta ) + "'">>,"Importanci" = <<lxImpdirimpImportanci>>,"Tipoasi" = <<lxImpdirimpTipoasi>> where "Numero" = <<lxImpdirimpNumero>> and  IMPDIRIMP.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Impdesde" as "F_impuesto_desde", "Imphasta" as "F_impuesto_hasta", "Tipdesde" as "F_tipoimp_desde", "Aplicacion" as "Aplicacion", "Tiphasta" as "F_tipoimp_hasta", "Jurdesde" as "F_jurisdiccion_desde", "Jurhasta" as "F_jurisdiccion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia", "Tipoasi" as "Tipodeasiento" from ZooLogic.IMPDIRIMP where "Numero" = <<lxImpdirimpNumero>> and  IMPDIRIMP.NUMERO != 0
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Impdesde" as "F_impuesto_desde", "Imphasta" as "F_impuesto_hasta", "Tipdesde" as "F_tipoimp_desde", "Aplicacion" as "Aplicacion", "Tiphasta" as "F_tipoimp_hasta", "Jurdesde" as "F_jurisdiccion_desde", "Jurhasta" as "F_jurisdiccion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia", "Tipoasi" as "Tipodeasiento" from ZooLogic.IMPDIRIMP where  IMPDIRIMP.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_IMPDIRIMP')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRIMP', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Impdesde" as "F_impuesto_desde", "Imphasta" as "F_impuesto_hasta", "Tipdesde" as "F_tipoimp_desde", "Aplicacion" as "Aplicacion", "Tiphasta" as "F_tipoimp_hasta", "Jurdesde" as "F_jurisdiccion_desde", "Jurhasta" as "F_jurisdiccion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia", "Tipoasi" as "Tipodeasiento" from ZooLogic.IMPDIRIMP where  str( NUMERO, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPDIRIMP.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_IMPDIRIMP')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRIMP', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Impdesde" as "F_impuesto_desde", "Imphasta" as "F_impuesto_hasta", "Tipdesde" as "F_tipoimp_desde", "Aplicacion" as "Aplicacion", "Tiphasta" as "F_tipoimp_hasta", "Jurdesde" as "F_jurisdiccion_desde", "Jurhasta" as "F_jurisdiccion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia", "Tipoasi" as "Tipodeasiento" from ZooLogic.IMPDIRIMP where  str( NUMERO, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  IMPDIRIMP.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_IMPDIRIMP')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRIMP', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Impdesde" as "F_impuesto_desde", "Imphasta" as "F_impuesto_hasta", "Tipdesde" as "F_tipoimp_desde", "Aplicacion" as "Aplicacion", "Tiphasta" as "F_tipoimp_hasta", "Jurdesde" as "F_jurisdiccion_desde", "Jurhasta" as "F_jurisdiccion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia", "Tipoasi" as "Tipodeasiento" from ZooLogic.IMPDIRIMP where  IMPDIRIMP.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_IMPDIRIMP')
			this.oConexion.EjecutarSql( lcSentencia, 'c_IMPDIRIMP', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Haltafw,Smodifw,Horaimpo,Horaexpo,Ualtafw" + ;
",Hmodifw,Umodifw,Saltafw,Vmodifw,Zadsfw,Valtafw,Bdmodifw,Bdaltafw,Esttrans,Obs,Numero,Descripcio,Imp" + ;
"desde,Imphasta,Tipdesde,Aplicacion,Tiphasta,Jurdesde,Jurhasta,Pcuenta,Importanci,Tipoasi" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Obs" as "Observacion", "Numero" as "Numero", "Descripcio" as "Descripcion", "Impdesde" as "F_impuesto_desde", "Imphasta" as "F_impuesto_hasta", "Tipdesde" as "F_tipoimp_desde", "Aplicacion" as "Aplicacion", "Tiphasta" as "F_tipoimp_hasta", "Jurdesde" as "F_jurisdiccion_desde", "Jurhasta" as "F_jurisdiccion_hasta", "Pcuenta" as "Plandecuentas", "Importanci" as "Importancia", "Tipoasi" as "Tipodeasiento"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.IMPDIRIMP set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"+ [, NUMERO = ] + transform( &lcCursor..NUMERO )+ [, Descripcio = ] + "'" + this.FormatearTextoSql( &lcCursor..Descripcio ) + "'"+ [, ImpDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..ImpDesde ) + "'"+ [, ImpHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..ImpHasta ) + "'"+ [, TipDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..TipDesde ) + "'"+ [, Aplicacion = ] + "'" + this.FormatearTextoSql( &lcCursor..Aplicacion ) + "'"+ [, TipHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..TipHasta ) + "'"+ [, JurDesde = ] + "'" + this.FormatearTextoSql( &lcCursor..JurDesde ) + "'"+ [, JurHasta = ] + "'" + this.FormatearTextoSql( &lcCursor..JurHasta ) + "'"+ [, PCUENTA = ] + "'" + this.FormatearTextoSql( &lcCursor..PCUENTA ) + "'"+ [, Importanci = ] + transform( &lcCursor..Importanci )+ [, TipoAsi = ] + transform( &lcCursor..TipoAsi ) + [ Where NUMERO = ] + transform( &lcCursor..NUMERO ) )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, TIMESTAMP, HALTAFW, SMODIFW, HORAIMPO, HORAEXPO, UALTAFW, HMODIFW, UMODIFW, SALTAFW, VMODIFW, ZADSFW, VALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, OBS, NUMERO, Descripcio, ImpDesde, ImpHasta, TipDesde, Aplicacion, TipHasta, JurDesde, JurHasta, PCUENTA, Importanci, TipoAsi
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..NUMERO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descripcio ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ImpDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ImpHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TipDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Aplicacion ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TipHasta ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..JurDesde ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..JurHasta ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..PCUENTA ) + "'" + ',' + transform( &lcCursor..Importanci ) + ',' + transform( &lcCursor..TipoAsi )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.OBS = isnull( d.OBS, t.OBS ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.DESCRIPCIO = isnull( d.DESCRIPCIO, t.DESCRIPCIO ),t.IMPDESDE = isnull( d.IMPDESDE, t.IMPDESDE ),t.IMPHASTA = isnull( d.IMPHASTA, t.IMPHASTA ),t.TIPDESDE = isnull( d.TIPDESDE, t.TIPDESDE ),t.APLICACION = isnull( d.APLICACION, t.APLICACION ),t.TIPHASTA = isnull( d.TIPHASTA, t.TIPHASTA ),t.JURDESDE = isnull( d.JURDESDE, t.JURDESDE ),t.JURHASTA = isnull( d.JURHASTA, t.JURHASTA ),t.PCUENTA = isnull( d.PCUENTA, t.PCUENTA ),t.IMPORTANCI = isnull( d.IMPORTANCI, t.IMPORTANCI ),t.TIPOASI = isnull( d.TIPOASI, t.TIPOASI )
					from ZooLogic.IMPDIRIMP t inner join deleted d 
							 on t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.IMPDIRIMP(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Haltafw,Smodifw,Horaimpo,Horaexpo,Ualtafw,Hmodifw,Umodifw,Saltafw,Vmodifw,Zadsfw,Valtafw,Bdmodifw,Bdaltafw,Esttrans,Obs,Numero,Descripcio,Impdesde,Imphasta,Tipdesde,Aplicacion,Tiphasta,Jurdesde,Jurhasta,Pcuenta,Importanci,Tipoasi)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.TIMESTAMP,0),convert( char(8), getdate(), 108 ),isnull( d.SMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.OBS,''),isnull( d.NUMERO,0),isnull( d.DESCRIPCIO,''),isnull( d.IMPDESDE,''),isnull( d.IMPHASTA,''),isnull( d.TIPDESDE,''),isnull( d.APLICACION,''),isnull( d.TIPHASTA,''),isnull( d.JURDESDE,''),isnull( d.JURHASTA,''),isnull( d.PCUENTA,''),isnull( d.IMPORTANCI,0),isnull( d.TIPOASI,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_IMPDIRIMP' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_IMPDIRIMP.Timestamp, 0 )
					...
					.F_impuesto_desde = nvl( c_IMPDIRIMP.F_impuesto_desde, [] )
					.F_impuesto_hasta = nvl( c_IMPDIRIMP.F_impuesto_hasta, [] )
					.F_tipoimp_desde = nvl( c_IMPDIRIMP.F_tipoimp_desde, [] )
					.Aplicacion = nvl( c_IMPDIRIMP.Aplicacion, [] )
					.F_tipoimp_hasta = nvl( c_IMPDIRIMP.F_tipoimp_hasta, [] )
					.F_jurisdiccion_desde = nvl( c_IMPDIRIMP.F_jurisdiccion_desde, [] )
					.F_jurisdiccion_hasta = nvl( c_IMPDIRIMP.F_jurisdiccion_hasta, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="IMPDIRIMP                               " atributo="FECHATRANSFERENCIA                      " tabla="IMPDIRIMP      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRIMP                               " atributo="TIMESTAMP                               " tabla="IMPDIRIMP      " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRIMP                               " atributo="ESTADOTRANSFERENCIA                     " tabla="IMPDIRIMP      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPDIRIMP                               " atributo="F_IMPUESTO_DESDE                        " tabla="IMPDIRIMP      " campo="IMPDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Impuesto                                                                                                                                                        " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRIMP                               " atributo="F_IMPUESTO_HASTA                        " tabla="IMPDIRIMP      " campo="IMPHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="404" etiqueta="Impuesto                                                                                                                                                        " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRIMP                               " atributo="F_TIPOIMP_DESDE                         " tabla="IMPDIRIMP      " campo="TIPDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Tipo de impuesto                                                                                                                                                " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRIMP                               " atributo="APLICACION                              " tabla="IMPDIRIMP      " campo="APLICACION" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Aplicación                                                                                                                                                      " dominio="COMBOXMLIMPUESTOCONTODOS      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRIMP                               " atributo="F_TIPOIMP_HASTA                         " tabla="IMPDIRIMP      " campo="TIPHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="ZZZZZZZZZZ                                                                                                                                                                                                                                                    " obligatorio="false" admitebusqueda="410" etiqueta="Tipo de impuesto                                                                                                                                                " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="4" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRIMP                               " atributo="F_JURISDICCION_DESDE                    " tabla="IMPDIRIMP      " campo="JURDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Jurisdicción                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRIMP                               " atributo="F_JURISDICCION_HASTA                    " tabla="IMPDIRIMP      " campo="JURHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="ZZZZZZZZ                                                                                                                                                                                                                                                      " obligatorio="false" admitebusqueda="414" etiqueta="Jurisdicción                                                                                                                                                    " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="5" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPDIRIMP                               " atributo="PLANDECUENTAS                           " tabla="IMPDIRIMP      " campo="PCUENTA   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PLANDECUENTAS                           " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="416" etiqueta="Cuenta                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; plancuenta.CTAIMPUT = .t. &quot;                                                                                                                                                                           " grupo="0" subgrupo="1" orden="46" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
