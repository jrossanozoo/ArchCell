...
define class Mock_Itemcomprobantederetencionesivacomprobantesdetalle as MockBase of MockBase.prg

	cClase = 'Itemcomprobantederetencionesivacomprobantesdetalle'
