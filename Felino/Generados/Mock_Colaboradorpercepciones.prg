...
define class Mock_COLABORADORPERCEPCIONES as MockBase of MockBase.prg

	cClase = 'COLABORADORPERCEPCIONES'
	...
	*-----------------------------------------------------------------------------------------
	function debeautocompletarjurisdiccionesdepercepcionesenclientes() as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Debeautocompletarjurisdiccionesdepercepcionesenclientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debeautocompletarpercepcionesdealtoriesgofiscalenclientes() as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Debeautocompletarpercepcionesdealtoriesgofiscalenclientes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debetenerseteadonrodeiibbparaconveniolocalomultilateral() as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Debetenerseteadonrodeiibbparaconveniolocalomultilateral', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function instanciardatosfiscales() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Instanciardatosfiscales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripciondetipoimpuesto( tctipoimpuesto as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerdescripciondetipoimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerimpuesto( tctipo as string  ) as object                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerimpuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function estaseteadoelparametrodedatosfiscales() as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Estaseteadoelparametrodedatosfiscales', lcParametros )
	EndFunc
