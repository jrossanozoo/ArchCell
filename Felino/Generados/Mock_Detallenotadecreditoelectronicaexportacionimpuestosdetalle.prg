...
define class Mock_Detallenotadecreditoelectronicaexportacionimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Detallenotadecreditoelectronicaexportacionimpuestosdetalle'
	...
	nMontoBaseDescuentoFinanciero = 0                                                                                                                                                                                                                         
	nMontoBaseRecargoFinanciero = 0                                                                                                                                                                                                                           
	nPorcentajeDescuentoGlobal = 0                                                                                                                                                                                                                            
	nPorcentajeDescuentoGlobal2 = 0                                                                                                                                                                                                                           
	nPorcentajeDescuentoGlobal4 = 0                                                                                                                                                                                                                           
	nPorcentajeRecargoGlobal = 0                                                                                                                                                                                                                              
	nPorcentajeRecargoGlobal3 = 0                                                                                                                                                                                                                             
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montodeimpuestointerno() as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eventocambiosum_montodeimpuestointerno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montodeimpuestointernosindescuento() as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Eventocambiosum_montodeimpuestointernosindescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montodeiva() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventocambiosum_montodeiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montodeivasindescuento() as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eventocambiosum_montodeivasindescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montonogravado() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Eventocambiosum_montonogravado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montonogravadosindescuento() as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventocambiosum_montonogravadosindescuento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nmontobasedescuentofinanciero_assign( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nmontobasedescuentofinanciero_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function nmontobaserecargofinanciero_assign( txval as variant ) as void                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nmontobaserecargofinanciero_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function nporcentajedescuentoglobal2_assign( txval ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nporcentajedescuentoglobal2_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function nporcentajedescuentoglobal4_assign( txval ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nporcentajedescuentoglobal4_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function nporcentajedescuentoglobal_assign( txval ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nporcentajedescuentoglobal_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function nporcentajerecargoglobal3_assign( txval ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nporcentajerecargoglobal3_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function nporcentajerecargoglobal_assign( txval ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nporcentajerecargoglobal_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function recalcularmontoscondescuentosyrecargos() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function sumarrecargosdescuentosfinancieros() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Sumarrecargosdescuentosfinancieros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregaritemdeivadelparametro( tnmontobase as float, tnmontoiva as float, tnporcentajeiva as float )  as void                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tnmontobase
		lxParam2 = tnmontoiva
		lxParam3 = tnporcentajeiva
		...
		return this.ObtenerResultado( 'Agregaritemdeivadelparametro', lcParametros )
	EndFunc
