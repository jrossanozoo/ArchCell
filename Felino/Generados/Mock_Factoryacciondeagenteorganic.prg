...
define class Mock_FACTORYACCIONDEAGENTEORGANIC as MockBase of MockBase.prg

	cClase = 'FACTORYACCIONDEAGENTEORGANIC'
	...
	*-----------------------------------------------------------------------------------------
	function obtener( tctipo as string ) as acciondeagenteorganic of acciondeagenteorganic.prg                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
