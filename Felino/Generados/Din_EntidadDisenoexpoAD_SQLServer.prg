...
define class Din_EntidadDISENOEXPOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxDisexpoFecimpo, lxDisexpoFaltafw, lxDisexpoFmodifw, lxDisexpoFecexpo, lxDisexpoFectrans, lxDisexpoAgrup, lxDisexpoClasehook, lxDisexpoCtiparch, lxDisexpoCtipreg, lxDisexpoTimestamp, lxDisexpoBloqreg, lxDisexpoHabgcomo, lxDisexpoSinnodo, lxDisexpoHoraimpo, lxDisexpoHaltafw, lxDisexpoHoraexpo, lxDisexpoSaltafw, lxDisexpoUaltafw, lxDisexpoUmodifw, lxDisexpoSmodifw, lxDisexpoHmodifw, lxDisexpoEsttrans, lxDisexpoZadsfw, lxDisexpoValtafw, lxDisexpoVmodifw, lxDisexpoBdaltafw, lxDisexpoBdmodifw, lxDisexpoCcod, lxDisexpoCobs, lxDisexpoEntafe, lxDisexpoCxml, lxDisexpoCdes, lxDisexpoActfecexp, lxDisexpoCexten, lxDisexpoCdelimi, lxDisexpoCategoria, lxDisexpoCrutasal, lxDisexpoCentidad, lxDisexpoFavorito, lxDisexpoCarchsal, lxDisexpoLagrfh, lxDisexpoLseparachr, lxDisexpoComext, lxDisexpoAppendarch, lxDisexpoParcoma, lxDisexpoCrutabkp, lxDisexpoCarchbkp, lxDisexpoLagrfhbp, lxDisexpoAppendback
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.DISEXPO ( "Fecimpo","Faltafw","Fmodifw","Fecexpo","Fectrans","Agrup","Clasehook","Ctiparch","Ctipreg","Timestamp","Bloqreg","Habgcomo","Sinnodo","Horaimpo","Haltafw","Horaexpo","Saltafw","Ualtafw","Umodifw","Smodifw","Hmodifw","Esttrans","Zadsfw","Valtafw","Vmodifw","Bdaltafw","Bdmodifw","Ccod","Cobs","Entafe","Cxml","Cdes","Actfecexp","Cexten","Cdelimi","Categoria","Crutasal","Centidad","Favorito","Carchsal","Lagrfh","Lseparachr","Comext","Appendarch","Parcoma","Crutabkp","Carchbkp","Lagrfhbp","Appendback" ) values ( <<"'" + this.ConvertirDateSql( lxDisexpoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisexpoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisexpoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisexpoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisexpoFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoAgrup ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoClasehook ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCtiparch ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCtipreg ) + "'" >>, <<lxDisexpoTimestamp >>, <<iif( lxDisexpoBloqreg, 1, 0 ) >>, <<iif( lxDisexpoHabgcomo, 1, 0 ) >>, <<iif( lxDisexpoSinnodo, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisexpoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoEntafe ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCxml ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCdes ) + "'" >>, <<iif( lxDisexpoActfecexp, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisexpoCexten ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCdelimi ) + "'" >>, <<lxDisexpoCategoria >>, <<"'" + this.FormatearTextoSql( lxDisexpoCrutasal ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCentidad ) + "'" >>, <<iif( lxDisexpoFavorito, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisexpoCarchsal ) + "'" >>, <<iif( lxDisexpoLagrfh, 1, 0 ) >>, <<iif( lxDisexpoLseparachr, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisexpoComext ) + "'" >>, <<iif( lxDisexpoAppendarch, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisexpoParcoma ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCrutabkp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisexpoCarchbkp ) + "'" >>, <<iif( lxDisexpoLagrfhbp, 1, 0 ) >>, <<iif( lxDisexpoAppendback, 1, 0 ) >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.Areas
				if this.oEntidad.Areas.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxOrden = loItem.Orden
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DisExpoArea("NROITEM","BLOQREG","SINNODO","iCod","cArea","cTipDet","cTipo","nOrden" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, <<iif( lxOcultarnodoexpo, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArea ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipo_PK ) + "'">>, <<lxOrden>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.DISEXPO set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDisexpoFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxDisexpoFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxDisexpoFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxDisexpoFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxDisexpoFectrans ) + "'">>,"Agrup" = <<"'" + this.FormatearTextoSql( lxDisexpoAgrup ) + "'">>,"Clasehook" = <<"'" + this.FormatearTextoSql( lxDisexpoClasehook ) + "'">>,"Ctiparch" = <<"'" + this.FormatearTextoSql( lxDisexpoCtiparch ) + "'">>,"Ctipreg" = <<"'" + this.FormatearTextoSql( lxDisexpoCtipreg ) + "'">>,"Timestamp" = <<lxDisexpoTimestamp>>,"Bloqreg" = <<iif( lxDisexpoBloqreg, 1, 0 )>>,"Habgcomo" = <<iif( lxDisexpoHabgcomo, 1, 0 )>>,"Sinnodo" = <<iif( lxDisexpoSinnodo, 1, 0 )>>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxDisexpoHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxDisexpoHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxDisexpoHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxDisexpoSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxDisexpoUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxDisexpoUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxDisexpoSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxDisexpoHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxDisexpoEsttrans ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxDisexpoZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxDisexpoValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxDisexpoVmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDisexpoBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDisexpoBdmodifw ) + "'">>,"Ccod" = <<"'" + this.FormatearTextoSql( lxDisexpoCcod ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxDisexpoCobs ) + "'">>,"Entafe" = <<"'" + this.FormatearTextoSql( lxDisexpoEntafe ) + "'">>,"Cxml" = <<"'" + this.FormatearTextoSql( lxDisexpoCxml ) + "'">>,"Cdes" = <<"'" + this.FormatearTextoSql( lxDisexpoCdes ) + "'">>,"Actfecexp" = <<iif( lxDisexpoActfecexp, 1, 0 )>>,"Cexten" = <<"'" + this.FormatearTextoSql( lxDisexpoCexten ) + "'">>,"Cdelimi" = <<"'" + this.FormatearTextoSql( lxDisexpoCdelimi ) + "'">>,"Categoria" = <<lxDisexpoCategoria>>,"Crutasal" = <<"'" + this.FormatearTextoSql( lxDisexpoCrutasal ) + "'">>,"Centidad" = <<"'" + this.FormatearTextoSql( lxDisexpoCentidad ) + "'">>,"Favorito" = <<iif( lxDisexpoFavorito, 1, 0 )>>,"Carchsal" = <<"'" + this.FormatearTextoSql( lxDisexpoCarchsal ) + "'">>,"Lagrfh" = <<iif( lxDisexpoLagrfh, 1, 0 )>>,"Lseparachr" = <<iif( lxDisexpoLseparachr, 1, 0 )>>,"Comext" = <<"'" + this.FormatearTextoSql( lxDisexpoComext ) + "'">>,"Appendarch" = <<iif( lxDisexpoAppendarch, 1, 0 )>>,"Parcoma" = <<"'" + this.FormatearTextoSql( lxDisexpoParcoma ) + "'">>,"Crutabkp" = <<"'" + this.FormatearTextoSql( lxDisexpoCrutabkp ) + "'">>,"Carchbkp" = <<"'" + this.FormatearTextoSql( lxDisexpoCarchbkp ) + "'">>,"Lagrfhbp" = <<iif( lxDisexpoLagrfhbp, 1, 0 )>>,"Appendback" = <<iif( lxDisexpoAppendback, 1, 0 )>> where "Ccod" = <<"'" + this.FormatearTextoSql( lxDisexpoCcod ) + "'">> and  DISEXPO.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Agrup" as "Agrupamiento", "Clasehook" as "Clasehook", "Ctiparch" as "Tipoarchivo", "Ctipreg" as "Tiporegistro", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Habgcomo" as "Habilitarguardarcomocondicionado", "Sinnodo" as "Ocultarnodoexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Ccod" as "Codigo", "Cobs" as "Obs", "Entafe" as "Entafectadas", "Cxml" as "Xmlconfig", "Cdes" as "Descripcion", "Actfecexp" as "Actualizarfechaexportacion", "Cexten" as "Extension", "Cdelimi" as "Delimitadores", "Categoria" as "Categoria", "Crutasal" as "Rutasalida", "Centidad" as "Entidad", "Favorito" as "Favorito", "Carchsal" as "Archivosalida", "Lagrfh" as "Agregarfh", "Lseparachr" as "Separacionporcaracter", "Comext" as "Comandoexterno", "Appendarch" as "Appendarchivo", "Parcoma" as "Parametroscomando", "Crutabkp" as "Rutabackup", "Carchbkp" as "Archivobackup", "Lagrfhbp" as "Agregarfhbk", "Appendback" as "Appendbackup" from ORGANIZACION.DISEXPO where "Ccod" = <<"'" + this.FormatearTextoSql( lxDisexpoCcod ) + "'">> and  DISEXPO.CCOD != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Sinnodo" as "Ocultarnodoexpo", "Icod" as "Codigo", "Carea" as "Area", "Ctipdet" as "Tipodetalle", "Ctipo" as "Tipo", "Norden" as "Orden" from ORGANIZACION.DisExpoArea where iCod = <<"'" + this.FormatearTextoSql( c_DISENOEXPO.CODIGO ) + "'">> Order by Orden
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Faltafw,Fmodifw,Fecexpo,Fectrans,Agrup,Clasehook,Ctiparch,Ctipreg,Timestamp,Bloqreg," + ;
"Habgcomo,Sinnodo,Horaimpo,Haltafw,Horaexpo,Saltafw,Ualtafw,Umodifw,Smodifw,Hmodifw,Esttrans,Zadsfw,V" + ;
"altafw,Vmodifw,Bdaltafw,Bdmodifw,Ccod,Cobs,Entafe,Cxml,Cdes,Actfecexp,Cexten,Cdelimi,Categoria,Cruta" + ;
"sal,Centidad,Favorito,Carchsal,Lagrfh,Lseparachr,Comext,Appendarch,Parcoma,Crutabkp,Carchbkp,Lagrfhb" + ;
"p,Appendback" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAreas( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Sinnodo" as "Ocultarnodoexpo", "Icod" as "Codigo", "Carea" as "Area", "Ctipdet" as "Tipodetalle", "Ctipo" as "Tipo", "Norden" as "Orden"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.Areas
				if this.oEntidad.Areas.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxOrden = loItem.Orden
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DisExpoArea("NROITEM","BLOQREG","SINNODO","iCod","cArea","cTipDet","cTipo","nOrden" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, <<iif( lxOcultarnodoexpo, 1, 0 )>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArea ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipo_PK ) + "'">>, <<lxOrden>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.DISEXPO set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, Agrup = ] + "'" + this.FormatearTextoSql( &lcCursor..Agrup ) + "'"+ [, clasehook = ] + "'" + this.FormatearTextoSql( &lcCursor..clasehook ) + "'"+ [, cTipArch = ] + "'" + this.FormatearTextoSql( &lcCursor..cTipArch ) + "'"+ [, cTipReg = ] + "'" + this.FormatearTextoSql( &lcCursor..cTipReg ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, habgcomo = ] + Transform( iif( &lcCursor..habgcomo, 1, 0 ))+ [, SINNODO = ] + Transform( iif( &lcCursor..SINNODO, 1, 0 ))+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"+ [, cObs = ] + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"+ [, EntAfe = ] + "'" + this.FormatearTextoSql( &lcCursor..EntAfe ) + "'"+ [, cXml = ] + "'" + this.FormatearTextoSql( &lcCursor..cXml ) + "'"+ [, cDes = ] + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'"+ [, ActFecExp = ] + Transform( iif( &lcCursor..ActFecExp, 1, 0 ))+ [, cExten = ] + "'" + this.FormatearTextoSql( &lcCursor..cExten ) + "'"+ [, cDelimi = ] + "'" + this.FormatearTextoSql( &lcCursor..cDelimi ) + "'"+ [, categoria = ] + transform( &lcCursor..categoria )+ [, cRutaSal = ] + "'" + this.FormatearTextoSql( &lcCursor..cRutaSal ) + "'"+ [, cEntidad = ] + "'" + this.FormatearTextoSql( &lcCursor..cEntidad ) + "'"+ [, favorito = ] + Transform( iif( &lcCursor..favorito, 1, 0 ))+ [, cArchSal = ] + "'" + this.FormatearTextoSql( &lcCursor..cArchSal ) + "'"+ [, lAgrFH = ] + Transform( iif( &lcCursor..lAgrFH, 1, 0 ))+ [, lSeparaChr = ] + Transform( iif( &lcCursor..lSeparaChr, 1, 0 ))+ [, ComExt = ] + "'" + this.FormatearTextoSql( &lcCursor..ComExt ) + "'"+ [, appendArch = ] + Transform( iif( &lcCursor..appendArch, 1, 0 ))+ [, ParComa = ] + "'" + this.FormatearTextoSql( &lcCursor..ParComa ) + "'"+ [, cRutabkp = ] + "'" + this.FormatearTextoSql( &lcCursor..cRutabkp ) + "'"+ [, cArchbkp = ] + "'" + this.FormatearTextoSql( &lcCursor..cArchbkp ) + "'"+ [, lAgrFHBP = ] + Transform( iif( &lcCursor..lAgrFHBP, 1, 0 ))+ [, appendBack = ] + Transform( iif( &lcCursor..appendBack, 1, 0 )) + [ Where cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" )
...
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Agrup ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..clasehook ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cTipArch ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cTipReg ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + Transform( iif( &lcCursor..habgcomo, 1, 0 )) + ',' + Transform( iif( &lcCursor..SINNODO, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..EntAfe ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cXml ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'" + ',' + Transform( iif( &lcCursor..ActFecExp, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cExten ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDelimi ) + "'" + ',' + transform( &lcCursor..categoria )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cRutaSal ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cEntidad ) + "'" + ',' + Transform( iif( &lcCursor..favorito, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cArchSal ) + "'" + ',' + Transform( iif( &lcCursor..lAgrFH, 1, 0 )) + ',' + Transform( iif( &lcCursor..lSeparaChr, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ComExt ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.AGRUP = isnull( d.AGRUP, t.AGRUP ),t.CLASEHOOK = isnull( d.CLASEHOOK, t.CLASEHOOK ),t.CTIPARCH = isnull( d.CTIPARCH, t.CTIPARCH ),t.CTIPREG = isnull( d.CTIPREG, t.CTIPREG ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.HABGCOMO = isnull( d.HABGCOMO, t.HABGCOMO ),t.SINNODO = isnull( d.SINNODO, t.SINNODO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.COBS = isnull( d.COBS, t.COBS ),t.ENTAFE = isnull( d.ENTAFE, t.ENTAFE ),t.CXML = isnull( d.CXML, t.CXML ),t.CDES = isnull( d.CDES, t.CDES ),t.ACTFECEXP = isnull( d.ACTFECEXP, t.ACTFECEXP ),t.CEXTEN = isnull( d.CEXTEN, t.CEXTEN ),t.CDELIMI = isnull( d.CDELIMI, t.CDELIMI ),t.CATEGORIA = isnull( d.CATEGORIA, t.CATEGORIA ),t.CRUTASAL = isnull( d.CRUTASAL, t.CRUTASAL ),t.CENTIDAD = isnull( d.CENTIDAD, t.CENTIDAD ),t.FAVORITO = isnull( d.FAVORITO, t.FAVORITO ),t.CARCHSAL = isnull( d.CARCHSAL, t.CARCHSAL ),t.LAGRFH = isnull( d.LAGRFH, t.LAGRFH ),t.LSEPARACHR = isnull( d.LSEPARACHR, t.LSEPARACHR ),t.COMEXT = isnull( d.COMEXT, t.COMEXT ),t.APPENDARCH = isnull( d.APPENDARCH, t.APPENDARCH ),t.PARCOMA = isnull( d.PARCOMA, t.PARCOMA ),t.CRUTABKP = isnull( d.CRUTABKP, t.CRUTABKP ),t.CARCHBKP = isnull( d.CARCHBKP, t.CARCHBKP ),t.LAGRFHBP = isnull( d.LAGRFHBP, t.LAGRFHBP ),t.APPENDBACK = isnull( d.APPENDBACK, t.APPENDBACK )
					from ORGANIZACION.DISEXPO t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ORGANIZACION.DISEXPO(Fecimpo,Faltafw,Fmodifw,Fecexpo,Fectrans,Agrup,Clasehook,Ctiparch,Ctipreg,Timestamp,Bloqreg,Habgcomo,Sinnodo,Horaimpo,Haltafw,Horaexpo,Saltafw,Ualtafw,Umodifw,Smodifw,Hmodifw,Esttrans,Zadsfw,Valtafw,Vmodifw,Bdaltafw,Bdmodifw,Ccod,Cobs,Entafe,Cxml,Cdes,Actfecexp,Cexten,Cdelimi,Categoria,Crutasal,Centidad,Favorito,Carchsal,Lagrfh,Lseparachr,Comext,Appendarch,Parcoma,Crutabkp,Carchbkp,Lagrfhbp,Appendback)
					Select isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.AGRUP,''),isnull( d.CLASEHOOK,''),isnull( d.CTIPARCH,''),isnull( d.CTIPREG,''),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.HABGCOMO,0),isnull( d.SINNODO,0),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.CCOD,''),isnull( d.COBS,''),isnull( d.ENTAFE,''),isnull( d.CXML,''),isnull( d.CDES,''),isnull( d.ACTFECEXP,0),isnull( d.CEXTEN,''),isnull( d.CDELIMI,''),isnull( d.CATEGORIA,0),isnull( d.CRUTASAL,''),isnull( d.CENTIDAD,''),isnull( d.FAVORITO,0),isnull( d.CARCHSAL,''),isnull( d.LAGRFH,0),isnull( d.LSEPARACHR,0),isnull( d.COMEXT,''),isnull( d.APPENDARCH,0),isnull( d.PARCOMA,''),isnull( d.CRUTABKP,''),isnull( d.CARCHBKP,''),isnull( d.LAGRFHBP,0),isnull( d.APPENDBACK,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="DISENOEXPO                              " atributo="FECHATRANSFERENCIA                      " tabla="DISEXPO        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DISENOEXPO                              " atributo="ATRIBUTOS                               " tabla="DISEXPOATRI    " campo="ICOD      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Atributos                                                                                                                                                       " dominio="DETALLEITEMATRIBUTOSEXPO      " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DISENOEXPO                              " atributo="AREAS                                   " tabla="DISEXPOAREA    " campo="ICOD      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Área                                                                                                                                                            " dominio="DETALLEITEMAREASEXPO          " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DISENOEXPO                              " atributo="AGRUPAMIENTO                            " tabla="DISEXPO        " campo="AGRUP     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Origen                                                                                                                                                          " dominio="COMBOSUCYAGRU                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="7" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOEXPO                              " atributo="TIPOARCHIVO                             " tabla="DISEXPO        " campo="CTIPARCH  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPOARCHIVOEXPORTACION                  " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="406" etiqueta="Tipo                                                                                                                                                            " dominio="COMBOTABLA                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="5" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DISENOEXPO                              " atributo="TIPOREGISTRO                            " tabla="DISEXPO        " campo="CTIPREG   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPOREGISTROEXPORTACION                 " tipodato="C         " longitud="3" decimales="0" valorsugerido="=&quot;LFI&quot;                                                                                                                                                                                                                                                        " obligatorio="true" admitebusqueda="408" etiqueta="Tipo                                                                                                                                                            " dominio="COMBOTABLA                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="6" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOEXPO                              " atributo="ESTADOTRANSFERENCIA                     " tabla="DISEXPO        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOEXPO                              " atributo="DELIMITADORES                           " tabla="DISEXPO        " campo="CDELIMI   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Delimitadores                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="6" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DISENOEXPO                              " atributo="CATEGORIA                               " tabla="DISEXPO        " campo="CATEGORIA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=1                                                                                                                                                                                                                                                            " obligatorio="false" admitebusqueda="418" etiqueta="Categoría                                                                                                                                                       " dominio="COMBOXML                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="21" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DISENOEXPO                              " atributo="RUTASALIDA                              " tabla="DISEXPO        " campo="CRUTASAL  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="420" etiqueta="Ruta                                                                                                                                                            " dominio="DIRECTORIOPORPARAMETRO        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOEXPO                              " atributo="COMANDOEXTERNO                          " tabla="DISEXPO        " campo="COMEXT    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="430" etiqueta="Archivo                                                                                                                                                         " dominio="ARCHIVOPORPARAMETRO           " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="20" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DISENOEXPO                              " atributo="APPENDARCHIVO                           " tabla="DISEXPO        " campo="APPENDARCH" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="Agregar al existente                                                                                                                                            " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
