...
define class Mock_liquidaciondiaria as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Liquidación diaria"                                                                                                                                                                                                                      
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'LIQUIDACIONDIARIA'                                                                                                                                                                                                                             
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function descuentos_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDIARIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descuentos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descuentos_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Descuentos		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Descuentos( lxVal )				this.Setear_Descuentos( lxVal )			EndIf		Else			This.Setear_Descuentos( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esunconceptodiario( toitem ) as boolean                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esunconceptodiario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerconceptos() as void                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerconceptos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertotalporconceptos() as integer                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertotalporconceptos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descuentos( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDIARIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_descuentos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_descuentos', lcParametros )			endif		endif		this.Descuentos = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descuentos( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDIARIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descuentos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descuentos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_operadora( txval, txvalold ) as boolean                                                                                                                                                                                                  
	...
	*-----------------------------------------------------------------------------------------
	protected function oconceptostarjeta_access() as object                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONDIARIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oconceptostarjeta_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oconceptostarjeta_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oConceptosTarjeta ) = 'O' or isnull( this.oConceptosTarjeta) )			this.oConceptosTarjeta = _Screen.zoo.InstanciarEntidad( "CONCEPTOLIQUIDACIONTARJETA" )		endif		return this.oConceptosTarjeta
	EndFunc
