...
define class Mock_asientotipo as MockBase of MockBase.prg
	...
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	cRutaDatosDefaultCabecera = ""                                                                                                                                                                                                                            
	cRutaDatosDefaultDetalle = ""                                                                                                                                                                                                                             
	...
	lHabilitarDiaDelMes = .T.                                                                                                                                                                                                                                 
	lHabilitarLeyendaPropia = .T.                                                                                                                                                                                                                             
	lHabilitarPorLetra = .T.                                                                                                                                                                                                                                  
	lHabilitarPorTipoComp = .T.                                                                                                                                                                                                                               
	...
	*-----------------------------------------------------------------------------------------
	function agrupaasientosporcomprobante() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Agrupaasientosporcomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function agrupaasientospordia() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Agrupaasientospordia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function agrupaasientospormes() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Agrupaasientospormes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asientospor_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'asientospor_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'asientospor_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Asientospor		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Asientospor( lxVal )				this.Setear_Asientospor( lxVal )			EndIf		Else			This.Setear_Asientospor( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function asientotipodetalle_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'asientotipodetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'asientotipodetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Asientotipodetalle ) = 'O' or isnull( this.Asientotipodetalle ) )			this.Asientotipodetalle = this.crearobjeto( 'Din_DetalleAsientotipoAsientotipodetalle' )			this.Asientotipodetalle.inicializar()			this.enlazar( 'Asientotipodetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Asientotipodetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Asientotipodetalle, 'CambioSumarizado', this, 'CambiosDetalleAsientotipodetalle', 1)			this.enlazar( 'Asientotipodetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Asientotipodetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Asientotipodetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleasientotipodetalle() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleasientotipodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function diadelmes_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'diadelmes_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'diadelmes_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Diadelmes		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Diadelmes( lxVal )				if ( this.lHabilitarDiadelmes or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.ValidarDominio_Numericononegativo( lxVal )					this.Setear_Diadelmes( lxVal )				else					this.Diadelmes = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asiento tipo - Atributo: Diadelmes)" )				endif			EndIf		Else			This.Setear_Diadelmes( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generaleyendaautomaticamente() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generaleyendaautomaticamente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hayasientostiponuevosdisponibles() as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Hayasientostiponuevosdisponibles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function leyendapropia_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'leyendapropia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'leyendapropia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Leyendapropia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Leyendapropia( lxVal )				if ( this.lHabilitarLeyendapropia or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Leyendapropia( lxVal )				else					this.Leyendapropia = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asiento tipo - Atributo: Leyendapropia)" )				endif			EndIf		Else			This.Setear_Leyendapropia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenaraltasconxml() as integer                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Llenaraltasconxml', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function porletra_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'porletra_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'porletra_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Porletra		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Porletra( lxVal )				if ( this.lHabilitarPorletra or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Porletra( lxVal )				else					this.Porletra = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asiento tipo - Atributo: Porletra)" )				endif			EndIf		Else			This.Setear_Porletra( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function portipocomp_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'portipocomp_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'portipocomp_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Portipocomp		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Portipocomp( lxVal )				if ( this.lHabilitarPortipocomp or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Portipocomp( lxVal )				else					this.Portipocomp = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Asiento tipo - Atributo: Portipocomp)" )				endif			EndIf		Else			This.Setear_Portipocomp( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_asientospor( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_asientospor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_asientospor', lcParametros )			endif		endif		dodefault( txVal )		this.SetearHabilitacionDeTipoYLetra()		this.SetearHabilitacionDeDiaDelMes()
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_diadelmes( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_diadelmes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_diadelmes', lcParametros )			endif		endif		this.Diadelmes = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_leyenda( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_leyenda', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_leyenda', lcParametros )			endif		endif		dodefault( txVal )		this.SetearHabilitacionDeLeyendaPropia()
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_leyendapropia( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_leyendapropia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_leyendapropia', lcParametros )			endif		endif		this.Leyendapropia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_porletra( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_porletra', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_porletra', lcParametros )			endif		endif		this.Porletra = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_portipocomp( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_portipocomp', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_portipocomp', lcParametros )			endif		endif		this.Portipocomp = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_asientospor( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_asientospor', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_asientospor', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_diadelmes( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_diadelmes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_diadelmes', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal )		if this.AgrupaAsientosPorMes() and !between( txVal, 1, 31 )			llRetorno = .F.			goServicios.Errores.LevantarExcepcion( "El valor del campo día debe estar entre 1 y 31." )		Endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_leyendapropia( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_leyendapropia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_leyendapropia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_porletra( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_porletra', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_porletra', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_portipocomp( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'ASIENTOTIPO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_portipocomp', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_portipocomp', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoasientospor() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoasientospor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridodiadelmes() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodiadelmes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoleyendapropia() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoleyendapropia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoporletra() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoporletra', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoportipocomp() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoportipocomp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function yaexisteasientotipo( tccodigo as string ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Yaexisteasientotipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardocumentocabeceraxml() as object                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargardocumentocabeceraxml', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existeitem( tcatributo as string, tcvalor as string ) as boolean                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Existeitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function llenardetalle( tccodigo as string ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Llenardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearhabilitaciondediadelmes() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearhabilitaciondediadelmes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearhabilitaciondeleyendapropia() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearhabilitaciondeleyendapropia', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearhabilitaciondetipoyletra() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearhabilitaciondetipoyletra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcuentasimputables() as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcuentasimputables', lcParametros )
	EndFunc
