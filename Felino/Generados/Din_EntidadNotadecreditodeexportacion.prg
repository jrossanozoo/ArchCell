...
define class Din_EntidadNOTADECREDITODEEXPORTACION as Ent_ComprobanteExportacion of Ent_ComprobanteExportacion.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><VENTAS><CONVALORES><FISCAL><VALORCIERRE><DESCUENTOAUTOMATICO><ACTUALIZAEMAILCLIENTE>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
