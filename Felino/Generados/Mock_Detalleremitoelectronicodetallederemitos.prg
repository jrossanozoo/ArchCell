...
define class Mock_Detalleremitoelectronicodetallederemitos as MockBase of MockBase.prg

	cClase = 'Detalleremitoelectronicodetallederemitos'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_importeneto() as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Eventocambiosum_importeneto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_importetotal() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Eventocambiosum_importetotal', lcParametros )
	EndFunc
