...
define class Din_EntidadMODIFICACIONDECOSTOSDEPRODUCCION as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Modcostos_Access() as variant
		if !this.ldestroy and ( !vartype( this.Modcostos ) = 'O' or isnull( this.Modcostos ) )
			this.Modcostos = this.crearobjeto( 'Din_DetalleModificaciondecostosdeproduccionModcostos' )
			...
			this.Modcostos.lVerificarLimitesEnDisenoImpresion = .t.
		endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoDescripcion() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "MODIFICACIONDECOSTOSDEPRODUCCION", "", "Descripcion" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
