...
define class Mock_Itemchequehistorialdetalle as MockBase of MockBase.prg

	cClase = 'Itemchequehistorialdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function basedeorigen_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Basedeorigen_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cajaestado_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Cajaestado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cajaestadodetalle_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cajaestadodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function conceptodetalle_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Conceptodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cuentabancariadescripcion_assign( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cuentabancariadescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function destinodedescarga_access() as variant                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Destinodedescarga_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function destinodedescarga_pk_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Destinodedescarga_pk_assign', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function destinodedescargadescripcion_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Destinodedescargadescripcion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function identificadorentidadcomprobante_assign( txval as variant ) as void                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Identificadorentidadcomprobante_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function proveedor_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Proveedor_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_basedeorigen( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_basedeorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cajaestadodetalle( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_cajaestadodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_conceptodetalle( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_conceptodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cuentabancariadescripcion( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_cuentabancariadescripcion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_destinodedescarga( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_destinodedescarga', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_destinodedescargadescripcion( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setear_destinodedescargadescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_identificadorentidadcomprobante( txval as variant ) as void                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_identificadorentidadcomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_basedeorigen( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_basedeorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cajaestadodetalle( txval as variant ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_cajaestadodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_conceptodetalle( txval as variant ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_conceptodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cuentabancariadescripcion( txval as variant ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_cuentabancariadescripcion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_destinodedescarga( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validar_destinodedescarga', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_destinodedescargadescripcion( txval as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validar_destinodedescargadescripcion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_identificadorentidadcomprobante( txval as variant ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_identificadorentidadcomprobante', lcParametros )
	EndFunc
