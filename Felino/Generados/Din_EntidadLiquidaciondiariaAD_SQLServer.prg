...
define class Din_EntidadLIQUIDACIONDIARIAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxLiqdiariaFecexpo, lxLiqdiariaFectrans, lxLiqdiariaFmodifw, lxLiqdiariaFaltafw, lxLiqdiariaFecimpo, lxLiqdiariaUaltafw, lxLiqdiariaSaltafw, lxLiqdiariaSmodifw, lxLiqdiariaUmodifw, lxLiqdiariaZadsfw, lxLiqdiariaValtafw, lxLiqdiariaVmodifw, lxLiqdiariaHmodifw, lxLiqdiariaHaltafw, lxLiqdiariaHoraimpo, lxLiqdiariaHoraexpo, lxLiqdiariaBdaltafw, lxLiqdiariaBdmodifw, lxLiqdiariaEsttrans, lxLiqdiariaFecha, lxLiqdiariaTotalliq, lxLiqdiariaDescuentos, lxLiqdiariaCodigo, lxLiqdiariaOperadora, lxLiqdiariaMonto, lxLiqdiariaObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.LIQDIARIA ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Ualtafw","Saltafw","Smodifw","Umodifw","Zadsfw","Valtafw","Vmodifw","Hmodifw","Haltafw","Horaimpo","Horaexpo","Bdaltafw","Bdmodifw","Esttrans","Fecha","Totalliq","Descuentos","Codigo","Operadora","Monto","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxLiqdiariaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqdiariaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqdiariaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqdiariaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqdiariaFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaEsttrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqdiariaFecha ) + "'" >>, <<lxLiqdiariaTotalliq >>, <<lxLiqdiariaDescuentos >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaOperadora ) + "'" >>, <<lxLiqdiariaMonto >>, <<"'" + this.FormatearTextoSql( lxLiqdiariaObs ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.Conceptos
				if this.oEntidad.Conceptos.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.liqdiariaDet("NROITEM","Concepto","codigo","ConDescri","monto","Suma" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxConcepto_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxConceptodetalle ) + "'">>, <<lxMonto>>, <<iif( lxSuma, 1, 0 )>> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.LIQDIARIA set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxLiqdiariaFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxLiqdiariaFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxLiqdiariaFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxLiqdiariaFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxLiqdiariaFecimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaHmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxLiqdiariaHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxLiqdiariaHoraexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLiqdiariaBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxLiqdiariaEsttrans ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxLiqdiariaFecha ) + "'">>,"Totalliq" = <<lxLiqdiariaTotalliq>>,"Descuentos" = <<lxLiqdiariaDescuentos>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxLiqdiariaCodigo ) + "'">>,"Operadora" = <<"'" + this.FormatearTextoSql( lxLiqdiariaOperadora ) + "'">>,"Monto" = <<lxLiqdiariaMonto>>,"Obs" = <<"'" + this.FormatearTextoSql( lxLiqdiariaObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxLiqdiariaCodigo ) + "'">> and  LIQDIARIA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Concepto" as "Concepto", "Codigo" as "Codigo", "Condescri" as "Conceptodetalle", "Monto" as "Monto", "Suma" as "Suma" from ZooLogic.liqdiariaDet where codigo = <<"'" + this.FormatearTextoSql( c_LIQUIDACIONDIARIA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fecha" as "Fecha", "Totalliq" as "Total", "Descuentos" as "Descuentos", "Codigo" as "Codigo", "Operadora" as "Operadora", "Monto" as "Monto", "Obs" as "Obs" from ZooLogic.LIQDIARIA where  LIQDIARIA.CODIGO != '' order by codigo
			endtext
			use in select('c_LIQUIDACIONDIARIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONDIARIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fecha" as "Fecha", "Totalliq" as "Total", "Descuentos" as "Descuentos", "Codigo" as "Codigo", "Operadora" as "Operadora", "Monto" as "Monto", "Obs" as "Obs" from ZooLogic.LIQDIARIA where  funciones.padr( codigo, 24, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LIQDIARIA.CODIGO != '' order by codigo
			endtext
			use in select('c_LIQUIDACIONDIARIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONDIARIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fecha" as "Fecha", "Totalliq" as "Total", "Descuentos" as "Descuentos", "Codigo" as "Codigo", "Operadora" as "Operadora", "Monto" as "Monto", "Obs" as "Obs" from ZooLogic.LIQDIARIA where  funciones.padr( codigo, 24, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LIQDIARIA.CODIGO != '' order by codigo desc
			endtext
			use in select('c_LIQUIDACIONDIARIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONDIARIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fecha" as "Fecha", "Totalliq" as "Total", "Descuentos" as "Descuentos", "Codigo" as "Codigo", "Operadora" as "Operadora", "Monto" as "Monto", "Obs" as "Obs" from ZooLogic.LIQDIARIA where  LIQDIARIA.CODIGO != '' order by codigo desc
			endtext
			use in select('c_LIQUIDACIONDIARIA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONDIARIA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Ualtafw,Saltafw,Smodifw,Umodifw,Zadsfw,Valtafw,Vmod" + ;
"ifw,Hmodifw,Haltafw,Horaimpo,Horaexpo,Bdaltafw,Bdmodifw,Esttrans,Fecha,Totalliq,Descuentos,Codigo,Op" + ;
"eradora,Monto,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fecha" as "Fecha", "Totalliq" as "Total", "Descuentos" as "Descuentos", "Codigo" as "Codigo", "Operadora" as "Operadora", "Monto" as "Monto", "Obs" as "Obs"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleConceptos( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Concepto" as "Concepto", "Codigo" as "Codigo", "Condescri" as "Conceptodetalle", "Monto" as "Monto", "Suma" as "Suma"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.Conceptos
				if this.oEntidad.Conceptos.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxSuma = loItem.Suma
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.liqdiariaDet("NROITEM","Concepto","codigo","ConDescri","monto","Suma" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxConcepto_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxConceptodetalle ) + "'">>, <<lxMonto>>, <<iif( lxSuma, 1, 0 )>> ) 
					endtext
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.LIQDIARIA set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..fecha ) + "'"+ [, Totalliq = ] + transform( &lcCursor..Totalliq )+ [, Descuentos = ] + transform( &lcCursor..Descuentos )+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"+ [, operadora = ] + "'" + this.FormatearTextoSql( &lcCursor..operadora ) + "'"+ [, monto = ] + transform( &lcCursor..monto )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, UALTAFW, SALTAFW, SMODIFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HMODIFW, HALTAFW, HORAIMPO, HORAEXPO, BDALTAFW, BDMODIFW, ESTTRANS, fecha, Totalliq, Descuentos, codigo, operadora, monto, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..fecha ) + "'" + ',' + transform( &lcCursor..Totalliq )
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","Concepto","codigo","ConDescri","monto","Suma"
		endText
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.TOTALLIQ = isnull( d.TOTALLIQ, t.TOTALLIQ ),t.DESCUENTOS = isnull( d.DESCUENTOS, t.DESCUENTOS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.OPERADORA = isnull( d.OPERADORA, t.OPERADORA ),t.MONTO = isnull( d.MONTO, t.MONTO ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.LIQDIARIA t inner join deleted d 
							 on t.codigo = d.codigo
				-- Fin Updates
				insert into ZooLogic.LIQDIARIA(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Ualtafw,Saltafw,Smodifw,Umodifw,Zadsfw,Valtafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Horaexpo,Bdaltafw,Bdmodifw,Esttrans,Fecha,Totalliq,Descuentos,Codigo,Operadora,Monto,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.FECHA,''),isnull( d.TOTALLIQ,0),isnull( d.DESCUENTOS,0),isnull( d.CODIGO,''),isnull( d.OPERADORA,''),isnull( d.MONTO,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="LIQUIDACIONDIARIA                       " atributo="FECHATRANSFERENCIA                      " tabla="LIQDIARIA      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIQUIDACIONDIARIA                       " atributo="ESTADOTRANSFERENCIA                     " tabla="LIQDIARIA      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
