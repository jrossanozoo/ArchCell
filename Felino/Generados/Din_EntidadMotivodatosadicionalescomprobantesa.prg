...
define class Din_EntidadMOTIVODATOSADICIONALESCOMPROBANTESA as entidad of entidad.prg
	...
	cDescripcion =  [Motivo en datos adicionales d comprobantes A]
	lEntidadEditable =  .t.
			...
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						...
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Descripción para la entidad Motivo en datos adicionales d comprobantes A." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
