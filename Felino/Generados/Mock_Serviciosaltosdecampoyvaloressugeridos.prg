...
define class Mock_SERVICIOSALTOSDECAMPOYVALORESSUGERIDOS as MockBase of MockBase.prg

	cClase = 'SERVICIOSALTOSDECAMPOYVALORESSUGERIDOS'
	...
	*-----------------------------------------------------------------------------------------
	function debesaltarelcampo( tcentidad as string, tcdetalle as string, tcatributo as string ) as boolean                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Debesaltarelcampo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionatributosnovisibles( tcentidad as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercoleccionatributosnovisibles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionatributosobligatorios( tcentidad as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercoleccionatributosobligatorios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerpersonalizaciondeetiquetas( tcentidad as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerpersonalizaciondeetiquetas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersaltodecampoyvalorsugeridodeunatributo( tcentidad as string, tcdetalle as string, tcatributo as string ) as object                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenersaltodecampoyvalorsugeridodeunatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenervalorsugeridodeunaentidaddetalle( tcentidad as string, tcdetalle as string ) as object                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenervalorsugeridodeunaentidaddetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function osaltosdecampoyvaloressugeridosdeentidades_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Osaltosdecampoyvaloressugeridosdeentidades_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reiniciarsaltosdecampoyvaloressugeridosdeentidad( tcentidad as string ) as void                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Reiniciarsaltosdecampoyvaloressugeridosdeentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reiniciarsaltosdecampoyvaloressugeridosdetodaslasentidades() as void                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Reiniciarsaltosdecampoyvaloressugeridosdetodaslasentidades', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarsaltosdecampoyvaloressugeridosdeunaentidad( tcentidad as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                            
		...
		return this.ObtenerResultado( 'Cargarsaltosdecampoyvaloressugeridosdeunaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercursordesaltosdecampoyvaloressugeridosdeunaentidad( tcentidad as string ) as string                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercursordesaltosdecampoyvaloressugeridosdeunaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenersaltosdecampoyvaloressugeridosdeunaentidad( tcentidad as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenersaltosdecampoyvaloressugeridosdeunaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerstringparaclave( tcclave as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerstringparaclave', lcParametros )
	EndFunc
