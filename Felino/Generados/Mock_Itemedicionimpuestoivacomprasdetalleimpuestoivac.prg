...
define class Mock_Itemedicionimpuestoivacomprasdetalleimpuestoivac as MockBase of MockBase.prg

	cClase = 'Itemedicionimpuestoivacomprasdetalleimpuestoivac'
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridomontodeiva() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridomontodeiva', lcParametros )
	EndFunc
