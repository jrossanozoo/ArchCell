	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CIELOTE ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Timestamp","Horaimpo","Horaexpo","Ualtafw","Hmodifw","Umodifw","Smodifw","Saltafw","Zadsfw","Haltafw","Bdaltafw","Bdmodifw","Esttrans","Valtafw","Guid","Vmodifw","Cod","Txticard","Numeroc","Falta","Fcielote","Hora","Hcielote","Serie","Equipopos","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxCieloteFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCieloteFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCieloteFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCieloteFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCieloteFecexpo ) + "'" >>, <<lxCieloteTimestamp >>, <<"'" + this.FormatearTextoSql( lxCieloteHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteGuid ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteCod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteTxticard ) + "'" >>, <<lxCieloteNumeroc >>, <<"'" + this.ConvertirDateSql( lxCieloteFalta ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCieloteFcielote ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteHora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteHcielote ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteSerie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteEquipopos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCieloteObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CIELOTE set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCieloteFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCieloteFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCieloteFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCieloteFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxCieloteFecexpo ) + "'">>,"Timestamp" = <<lxCieloteTimestamp>>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCieloteHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCieloteHoraexpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCieloteUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCieloteHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCieloteUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCieloteSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCieloteSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCieloteZadsfw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCieloteHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCieloteBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCieloteBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCieloteEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCieloteValtafw ) + "'">>,"Guid" = <<"'" + this.FormatearTextoSql( lxCieloteGuid ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCieloteVmodifw ) + "'">>,"Cod" = <<"'" + this.FormatearTextoSql( lxCieloteCod ) + "'">>,"Txticard" = <<"'" + this.FormatearTextoSql( lxCieloteTxticard ) + "'">>,"Numeroc" = <<lxCieloteNumeroc>>,"Falta" = <<"'" + this.ConvertirDateSql( lxCieloteFalta ) + "'">>,"Fcielote" = <<"'" + this.ConvertirDateSql( lxCieloteFcielote ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxCieloteHora ) + "'">>,"Hcielote" = <<"'" + this.FormatearTextoSql( lxCieloteHcielote ) + "'">>,"Serie" = <<"'" + this.FormatearTextoSql( lxCieloteSerie ) + "'">>,"Equipopos" = <<"'" + this.FormatearTextoSql( lxCieloteEquipopos ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxCieloteObs ) + "'">> where "Cod" = <<"'" + this.FormatearTextoSql( lxCieloteCod ) + "'">> and  CIELOTE.COD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Guid" as "Guid", "Vmodifw" as "Versionmodificacionfw", "Cod" as "Codigo", "Txticard" as "Ticketicard", "Numeroc" as "Numeroc", "Falta" as "Fechaalta", "Fcielote" as "Fechacierredelote", "Hora" as "Horaalta", "Hcielote" as "Horacierredelote", "Serie" as "Serieorigen", "Equipopos" as "Equipopos", "Obs" as "Observacion" from ZooLogic.CIELOTE where "Cod" = <<"'" + this.FormatearTextoSql( lxCieloteCod ) + "'">> and  CIELOTE.COD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Guid" as "Guid", "Vmodifw" as "Versionmodificacionfw", "Cod" as "Codigo", "Txticard" as "Ticketicard", "Numeroc" as "Numeroc", "Falta" as "Fechaalta", "Fcielote" as "Fechacierredelote", "Hora" as "Horaalta", "Hcielote" as "Horacierredelote", "Serie" as "Serieorigen", "Equipopos" as "Equipopos", "Obs" as "Observacion" from ZooLogic.CIELOTE where  CIELOTE.COD != '' And numeroC = <<lxCIELOTEnumeroC>>
			endtext
			use in select('c_CIERREDELOTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREDELOTE', set( 'Datasession' ) )
			if reccount( 'c_CIERREDELOTE' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Guid" as "Guid", "Vmodifw" as "Versionmodificacionfw", "Cod" as "Codigo", "Txticard" as "Ticketicard", "Numeroc" as "Numeroc", "Falta" as "Fechaalta", "Fcielote" as "Fechacierredelote", "Hora" as "Horaalta", "Hcielote" as "Horacierredelote", "Serie" as "Serieorigen", "Equipopos" as "Equipopos", "Obs" as "Observacion" from ZooLogic.CIELOTE where  CIELOTE.COD != '' order by numeroC
			endtext
			use in select('c_CIERREDELOTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREDELOTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Guid" as "Guid", "Vmodifw" as "Versionmodificacionfw", "Cod" as "Codigo", "Txticard" as "Ticketicard", "Numeroc" as "Numeroc", "Falta" as "Fechaalta", "Fcielote" as "Fechacierredelote", "Hora" as "Horaalta", "Hcielote" as "Horacierredelote", "Serie" as "Serieorigen", "Equipopos" as "Equipopos", "Obs" as "Observacion" from ZooLogic.CIELOTE where  str( numeroC, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CIELOTE.COD != '' order by numeroC
			endtext
			use in select('c_CIERREDELOTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREDELOTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Guid" as "Guid", "Vmodifw" as "Versionmodificacionfw", "Cod" as "Codigo", "Txticard" as "Ticketicard", "Numeroc" as "Numeroc", "Falta" as "Fechaalta", "Fcielote" as "Fechacierredelote", "Hora" as "Horaalta", "Hcielote" as "Horacierredelote", "Serie" as "Serieorigen", "Equipopos" as "Equipopos", "Obs" as "Observacion" from ZooLogic.CIELOTE where  str( numeroC, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CIELOTE.COD != '' order by numeroC desc
			endtext
			use in select('c_CIERREDELOTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREDELOTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Guid" as "Guid", "Vmodifw" as "Versionmodificacionfw", "Cod" as "Codigo", "Txticard" as "Ticketicard", "Numeroc" as "Numeroc", "Falta" as "Fechaalta", "Fcielote" as "Fechacierredelote", "Hora" as "Horaalta", "Hcielote" as "Horacierredelote", "Serie" as "Serieorigen", "Equipopos" as "Equipopos", "Obs" as "Observacion" from ZooLogic.CIELOTE where  CIELOTE.COD != '' order by numeroC desc
			endtext
			use in select('c_CIERREDELOTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CIERREDELOTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Timestamp,Horaimpo,Horaexpo,Ualtafw,Hmodifw,Umodifw" + ;
",Smodifw,Saltafw,Zadsfw,Haltafw,Bdaltafw,Bdmodifw,Esttrans,Valtafw,Guid,Vmodifw,Cod,Txticard,Numeroc" + ;
",Falta,Fcielote,Hora,Hcielote,Serie,Equipopos,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Guid" as "Guid", "Vmodifw" as "Versionmodificacionfw", "Cod" as "Codigo", "Txticard" as "Ticketicard", "Numeroc" as "Numeroc", "Falta" as "Fechaalta", "Fcielote" as "Fechacierredelote", "Hora" as "Horaalta", "Hcielote" as "Horacierredelote", "Serie" as "Serieorigen", "Equipopos" as "Equipopos", "Obs" as "Observacion"
				endtext
			Else
		...
		for i = 1 To getwordcount( tcCampos, ',' )
			...
			Do Case
				...
				Case lcAtributo == 'HORAALTA'
					lcSelect = lcSelect + iif( Empty( lcSelect ),'', ',' ) + 'HORA AS HORAALTA'
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.CIELOTE set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxCieloteFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxCieloteFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxCieloteFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxCieloteFaltafw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCieloteFecexpo ) + "'">>, "Timestamp" = <<lxCieloteTimestamp>>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxCieloteHoraimpo ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxCieloteHoraexpo ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxCieloteUaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxCieloteHmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxCieloteUmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxCieloteSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxCieloteSaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxCieloteZadsfw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxCieloteHaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCieloteBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCieloteBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxCieloteEsttrans ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxCieloteValtafw ) + "'">>, "Guid" = <<"'" + this.FormatearTextoSql( lxCieloteGuid ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxCieloteVmodifw ) + "'">>, "Cod" = <<"'" + this.FormatearTextoSql( lxCieloteCod ) + "'">>, "Txticard" = <<"'" + this.FormatearTextoSql( lxCieloteTxticard ) + "'">>, "Numeroc" = <<lxCieloteNumeroc>>, "Falta" = <<"'" + this.ConvertirDateSql( lxCieloteFalta ) + "'">>, "Fcielote" = <<"'" + this.ConvertirDateSql( lxCieloteFcielote ) + "'">>, "Hora" = <<"'" + this.FormatearTextoSql( lxCieloteHora ) + "'">>, "Hcielote" = <<"'" + this.FormatearTextoSql( lxCieloteHcielote ) + "'">>, "Serie" = <<"'" + this.FormatearTextoSql( lxCieloteSerie ) + "'">>, "Equipopos" = <<"'" + this.FormatearTextoSql( lxCieloteEquipopos ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxCieloteObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'CIELOTE' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Cod or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.CIELOTE set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, GUID = ] + "'" + this.FormatearTextoSql( &lcCursor..GUID ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, Cod = ] + "'" + this.FormatearTextoSql( &lcCursor..Cod ) + "'"+ [, txticard = ] + "'" + this.FormatearTextoSql( &lcCursor..txticard ) + "'"+ [, numeroC = ] + transform( &lcCursor..numeroC )+ [, fAlta = ] + "'" + this.ConvertirDateSql( &lcCursor..fAlta ) + "'"+ [, FCieLote = ] + "'" + this.ConvertirDateSql( &lcCursor..FCieLote ) + "'"+ [, hora = ] + "'" + this.FormatearTextoSql( &lcCursor..hora ) + "'"+ [, HCieLote = ] + "'" + this.FormatearTextoSql( &lcCursor..HCieLote ) + "'"+ [, Serie = ] + "'" + this.FormatearTextoSql( &lcCursor..Serie ) + "'"+ [, EquipoPOS = ] + "'" + this.FormatearTextoSql( &lcCursor..EquipoPOS ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where Cod = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, TIMESTAMP, HORAIMPO, HORAEXPO, UALTAFW, HMODIFW, UMODIFW, SMODIFW, SALTAFW, ZADSFW, HALTAFW, BDALTAFW, BDMODIFW, ESTTRANS, VALTAFW, GUID, VMODIFW, Cod, txticard, numeroC, fAlta, FCieLote, hora, HCieLote, Serie, EquipoPOS, Obs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..GUID ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..txticard ) + "'" + ',' + transform( &lcCursor..numeroC ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..fAlta ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FCieLote ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..hora ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HCieLote ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.GUID = isnull( d.GUID, t.GUID ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.COD = isnull( d.COD, t.COD ),t.TXTICARD = isnull( d.TXTICARD, t.TXTICARD ),t.NUMEROC = isnull( d.NUMEROC, t.NUMEROC ),t.FALTA = isnull( d.FALTA, t.FALTA ),t.FCIELOTE = isnull( d.FCIELOTE, t.FCIELOTE ),t.HORA = isnull( d.HORA, t.HORA ),t.HCIELOTE = isnull( d.HCIELOTE, t.HCIELOTE ),t.SERIE = isnull( d.SERIE, t.SERIE ),t.EQUIPOPOS = isnull( d.EQUIPOPOS, t.EQUIPOPOS ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.CIELOTE t inner join deleted d 
							 on t.Cod = d.Cod
							 and  t.numeroC = d.numeroC
				-- Fin Updates
				insert into ZooLogic.CIELOTE(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Timestamp,Horaimpo,Horaexpo,Ualtafw,Hmodifw,Umodifw,Smodifw,Saltafw,Zadsfw,Haltafw,Bdaltafw,Bdmodifw,Esttrans,Valtafw,Guid,Vmodifw,Cod,Txticard,Numeroc,Falta,Fcielote,Hora,Hcielote,Serie,Equipopos,Obs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.TIMESTAMP,0),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.GUID,''),isnull( d.VMODIFW,''),isnull( d.COD,''),isnull( d.TXTICARD,''),isnull( d.NUMEROC,0),isnull( d.FALTA,''),isnull( d.FCIELOTE,''),isnull( d.HORA,''),isnull( d.HCIELOTE,''),isnull( d.SERIE,''),isnull( d.EQUIPOPOS,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CIERREDELOTE                            " atributo="FECHATRANSFERENCIA                      " tabla="CIELOTE        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CIERREDELOTE                            " atributo="ESTADOTRANSFERENCIA                     " tabla="CIELOTE        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CIERREDELOTE                            " atributo="FECHAALTA                               " tabla="CIELOTE        " campo="FALTA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="4" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CIERREDELOTE                            " atributo="FECHACIERREDELOTE                       " tabla="CIELOTE        " campo="FCIELOTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="402" etiqueta="Fecha hasta                                                                                                                                                     " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CIERREDELOTE                            " atributo="HORAALTA                                " tabla="CIELOTE        " campo="HORA      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerHora()                                                                                                                                                                                                                          " obligatorio="false" admitebusqueda="6" etiqueta="Hora                                                                                                                                                            " dominio="HORA                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="99X99                    " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CIERREDELOTE                            " atributo="HORACIERREDELOTE                        " tabla="CIELOTE        " campo="HCIELOTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Hora hasta                                                                                                                                                      " dominio="HORA                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
