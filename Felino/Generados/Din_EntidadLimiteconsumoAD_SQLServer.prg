...
define class Din_EntidadLIMITECONSUMOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxLconsumoFecexpo, lxLconsumoFectrans, lxLconsumoFecimpo, lxLconsumoFaltafw, lxLconsumoFmodifw, lxLconsumoNumero, lxLconsumoTimestamp, lxLconsumoSmodifw, lxLconsumoUaltafw, lxLconsumoUmodifw, lxLconsumoVmodifw, lxLconsumoDescfw, lxLconsumoSaltafw, lxLconsumoZadsfw, lxLconsumoValtafw, lxLconsumoHoraexpo, lxLconsumoHmodifw, lxLconsumoBdmodifw, lxLconsumoHaltafw, lxLconsumoBdaltafw, lxLconsumoEsttrans, lxLconsumoHoraimpo, lxLconsumoCodint, lxLconsumoCliente, lxLconsumoFechadesde, lxLconsumoFechahasta, lxLconsumoMonto, lxLconsumoObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.LCONSUMO ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Numero","Timestamp","Smodifw","Ualtafw","Umodifw","Vmodifw","Descfw","Saltafw","Zadsfw","Valtafw","Horaexpo","Hmodifw","Bdmodifw","Haltafw","Bdaltafw","Esttrans","Horaimpo","Codint","Cliente","Fechadesde","Fechahasta","Monto","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxLconsumoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLconsumoFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLconsumoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLconsumoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLconsumoFmodifw ) + "'" >>, <<lxLconsumoNumero >>, <<lxLconsumoTimestamp >>, <<"'" + this.FormatearTextoSql( lxLconsumoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoCodint ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLconsumoCliente ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLconsumoFechadesde ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLconsumoFechahasta ) + "'" >>, <<lxLconsumoMonto >>, <<"'" + this.FormatearTextoSql( lxLconsumoObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.LCONSUMO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxLconsumoFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxLconsumoFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxLconsumoFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxLconsumoFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxLconsumoFmodifw ) + "'">>,"Numero" = <<lxLconsumoNumero>>,"Timestamp" = <<lxLconsumoTimestamp>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxLconsumoSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxLconsumoUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxLconsumoUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxLconsumoVmodifw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxLconsumoDescfw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxLconsumoSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxLconsumoZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxLconsumoValtafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxLconsumoHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxLconsumoHmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLconsumoBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxLconsumoHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLconsumoBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxLconsumoEsttrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxLconsumoHoraimpo ) + "'">>,"Codint" = <<"'" + this.FormatearTextoSql( lxLconsumoCodint ) + "'">>,"Cliente" = <<"'" + this.FormatearTextoSql( lxLconsumoCliente ) + "'">>,"Fechadesde" = <<"'" + this.ConvertirDateSql( lxLconsumoFechadesde ) + "'">>,"Fechahasta" = <<"'" + this.ConvertirDateSql( lxLconsumoFechahasta ) + "'">>,"Monto" = <<lxLconsumoMonto>>,"Obs" = <<"'" + this.FormatearTextoSql( lxLconsumoObs ) + "'">> where "Codint" = <<"'" + this.FormatearTextoSql( lxLconsumoCodint ) + "'">> and  LCONSUMO.CODINT != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Numero,Timestamp,Smodifw,Ualtafw,Umodifw,Vmodifw,De" + ;
"scfw,Saltafw,Zadsfw,Valtafw,Horaexpo,Hmodifw,Bdmodifw,Haltafw,Bdaltafw,Esttrans,Horaimpo,Codint,Clie" + ;
"nte,Fechadesde,Fechahasta,Monto,Obs" + ;
" from ZooLogic.LCONSUMO where  LCONSUMO.CODINT != '' and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirCabecera( tlLoguear as Boolean ) As Void
		local lcCursor as String, ldFecha as Date, lcHora as string, lcValorABuscar As String, lxValorClavePK As variant, lxValorClavePrimaria As variant, lcIdentificadorParaLoguear as string, lxLCONSUMONUMERO as variant, lxLCONSUMOCliente as variant, lxLCONSUMOFechaDesde as variant, lxLCONSUMOFechaHasta as variant, lxLCONSUMOMonto as variant, lcMensajeExtra as String
		lcValorABuscar = ''
		lxValorClavePK = ''
		lcMensajeExtra = ''
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, NUMERO, TIMESTAMP, SMODIFW, UALTAFW, UMODIFW, VMODIFW, DescFW, SALTAFW, ZADSFW, VALTAFW, HORAEXPO, HMODIFW, BDMODIFW, HALTAFW, BDALTAFW, ESTTRANS, HORAIMPO, CodInt, Cliente, FechaDesde, FechaHasta, Monto, Obs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + transform( &lcCursor..NUMERO ) + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodInt ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Cliente ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaDesde ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaHasta ) + "'" + ',' + transform( &lcCursor..Monto ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				insert into ZooLogic.ADT_LCONSUMO ( "ADT_Cod","ADT_Fecha","ADT_Hora","ADT_Serie","ADT_Usr","ADT_Ent","ADT_Comp","ADT_ADN","ADT_Vers","ADT_Ext","NUMERO","CodInt","Cliente","Fechadesde","Fechahasta","Monto" ) 
					Select <<lcCabecera1>>, <<lcCabecera2>>, <<lcCabecera3>>, <<lcCabecera4>>, <<lcCabecera5>>, <<lcCabecera6>>, case when funciones.empty( d.DescFw ) = 1 then 'IMPORTACION' else d.descFw end, <<lcCabecera7>>, <<lcCabecera8>>, <<lcCabecera9>>, d.Numero,d.Codint,Isnull( d.Cliente,t.Cliente),Isnull( d.Fechadesde,t.Fechadesde),Isnull( d.Fechahasta,t.Fechahasta),Isnull( d.Monto,t.Monto)
						from ZooLogic.LCONSUMO t inner join deleted d 
							 on t.CodInt = d.CodInt
							 and  t.NUMERO = d.NUMERO
					where ( d.Cliente is not null and d.Cliente <> t.Cliente ) or ( d.FechaDesde is not null and d.FechaDesde <> t.FechaDesde ) or ( d.FechaHasta is not null and d.FechaHasta <> t.FechaHasta ) or ( d.Monto is not null and d.Monto <> t.Monto )
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.CODINT = isnull( d.CODINT, t.CODINT ),t.CLIENTE = isnull( d.CLIENTE, t.CLIENTE ),t.FECHADESDE = isnull( d.FECHADESDE, t.FECHADESDE ),t.FECHAHASTA = isnull( d.FECHAHASTA, t.FECHAHASTA ),t.MONTO = isnull( d.MONTO, t.MONTO ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.LCONSUMO t inner join deleted d 
							 on t.CodInt = d.CodInt
							 and  t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.ADT_LCONSUMO ( "ADT_Cod","ADT_Fecha","ADT_Hora","ADT_Serie","ADT_Usr","ADT_Ent","ADT_Comp","ADT_ADN","ADT_Vers","ADT_Ext","NUMERO","CodInt","Cliente","Fechadesde","Fechahasta","Monto" ) 
					Select <<lcCabecera1>>, <<lcCabecera2>>, <<lcCabecera3>>, <<lcCabecera4>>, <<lcCabecera5>>, <<lcCabecera6>>, case when funciones.empty( d.DescFw ) = 1 then 'IMPORTACION' else d.descFw end, <<lcCabecera7>>, <<lcCabecera8>>, <<lcCabecera9>>, d.Numero,d.Codint,isnull( d.CLIENTE,''),isnull( d.FECHADESDE,''),isnull( d.FECHAHASTA,''),isnull( d.MONTO,0)
				...
				insert into ZooLogic.LCONSUMO(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Numero,Timestamp,Smodifw,Ualtafw,Umodifw,Vmodifw,Descfw,Saltafw,Zadsfw,Valtafw,Horaexpo,Hmodifw,Bdmodifw,Haltafw,Bdaltafw,Esttrans,Horaimpo,Codint,Cliente,Fechadesde,Fechahasta,Monto,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.NUMERO,0),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.DESCFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAIMPO,''),isnull( d.CODINT,''),isnull( d.CLIENTE,''),isnull( d.FECHADESDE,''),isnull( d.FECHAHASTA,''),isnull( d.MONTO,0),isnull( d.OBS,'')
						From deleted d left join ZooLogic.LCONSUMO pk 
							 on d.CodInt = pk.CodInt
						 left join ZooLogic.LCONSUMO cc 
							 on  d.NUMERO = cc.NUMERO
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerSentenciasInsertAuditoria( tcCursor as string ) as String
		...
		if empty( tcCursor )
			...
			lcEntidad5 = "'" + this.ConvertirDateSql( this.oEntidad.Fechahasta ) + "'"
			lcEntidad6 = transform( this.oEntidad.Monto )
			...
			lcEntidad5 = "'" + this.ConvertirDateSql( &tcCursor..Fechahasta ) + "'"
			lcEntidad6 = transform( &tcCursor..Monto )
			
		endif
			local lcSentencia as string

			text to lcSentencia textmerge noshow
				insert into ZooLogic.ADT_LCONSUMO ( "ADT_Cod","ADT_Fecha","ADT_Hora","ADT_Serie","ADT_Usr","ADT_Ent","ADT_Comp","ADT_ADN","ADT_Vers","ADT_Ext","NUMERO","CodInt","Cliente","Fechadesde","Fechahasta","Monto" ) values ( <<lcCabecera1>>, <<lcCabecera2>>, <<lcCabecera3>>, <<lcCabecera4>>, <<lcCabecera5>>, <<lcCabecera6>>, <<lcCabecera7>>, <<lcCabecera8>>, <<lcCabecera9>>, <<lcCabecera10>>, <<lcEntidad1>>, <<lcEntidad2>>, <<lcEntidad3>>, <<lcEntidad4>>, <<lcEntidad5>>, <<lcEntidad6>> ) 
			endtext
		return lcSentencia
	endfunc
	*--------------------------------------------------------------------------------------------------------
...
<VFPData xml:space="preserve">
	...
	<row entidad="LIMITECONSUMO                           " atributo="FECHATRANSFERENCIA                      " tabla="LCONSUMO       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIMITECONSUMO                           " atributo="ESTADOTRANSFERENCIA                     " tabla="LCONSUMO       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIMITECONSUMO                           " atributo="FECHADESDE                              " tabla="LCONSUMO       " campo="FECHADESDE" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="402" etiqueta="Fecha desde                                                                                                                                                     " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="LIMITECONSUMO                           " atributo="FECHAHASTA                              " tabla="LCONSUMO       " campo="FECHAHASTA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=gomonth(goServicios.Librerias.ObtenerFecha(),1)                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="404" etiqueta="Fecha hasta                                                                                                                                                     " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="LIMITECONSUMO                           " atributo="MONTO                                   " tabla="LCONSUMO       " campo="MONTO     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="406" etiqueta="Monto                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="LIMITECONSUMO                           " atributo="MONTOUTILIZADO                          " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Monto utilizado                                                                                                                                                 " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="LIMITECONSUMO                           " atributo="OBSERVACION                             " tabla="LCONSUMO       " campo="OBS       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Observacion                                                                                                                                                     " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
