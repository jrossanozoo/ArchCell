...
define class Mock_Gestionchcustodiaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Gestionchcustodiaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalledetallechcustodia( tcatributo as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercampodetalledetallechcustodia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalledetallechcustodia( tccampos as string ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalledetallechcustodia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalledetallechcustodia( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                              
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalledetallechcustodia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_chcustodiadet( tctablatrabajo ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_chcustodiadet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalledetallechcustodia( tccampos as string ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Parsearcamposdetalledetallechcustodia', lcParametros )
	EndFunc
