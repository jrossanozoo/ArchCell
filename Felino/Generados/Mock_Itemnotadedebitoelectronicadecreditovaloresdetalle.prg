...
define class Mock_Itemnotadedebitoelectronicadecreditovaloresdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadedebitoelectronicadecreditovaloresdetalle'
