...
define class Din_EntidadImpoagrupadas_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Impoagrupadas"
	cClaseResponse = this.cNamespaceDTOs + ".ImpoagrupadasResponse"
	cClaseModelo = "ImpoagrupadasModelo"
	cEntidad = "Impoagrupadas"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpoagrupadasModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpoagrupadasListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "ImpoagrupadasListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "ImpoagrupadasModelo"
		endcase
		return lcRetorno
	...
	protected function CargarColeccionModeloDisenos( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .Disenos.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemImpoagrupadas" )
