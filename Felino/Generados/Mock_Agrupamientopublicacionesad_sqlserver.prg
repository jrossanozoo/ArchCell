...
define class Mock_Agrupamientopublicacionesad_sqlserver as MockBase of MockBase.prg

	cClase = 'Agrupamientopublicacionesad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubdet( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubdet', lcParametros )
	EndFunc
