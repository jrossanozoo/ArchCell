...
define class Din_EntidadImpdircli_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Impdircli"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_cliente_desde", toEntidad, "F_cliente_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_cliente_hasta", toEntidad, "F_cliente_hasta" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "f_Cliente_Desde", toEntidad.f_Cliente_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Cliente_Hasta", toEntidad.f_Cliente_Hasta)
