...
define class Mock_Itemgtindetrangos as MockBase of MockBase.prg

	cClase = 'Itemgtindetrangos'
	...
	*-----------------------------------------------------------------------------------------
	function claveforanea_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Claveforanea_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_claveforanea( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_claveforanea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_claveforanea( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_claveforanea', lcParametros )
	EndFunc
