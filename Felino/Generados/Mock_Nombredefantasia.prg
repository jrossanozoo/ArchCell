...
define class Mock_nombredefantasia as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallerazonsocial() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cambiosdetallerazonsocial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorefrescarrazonsocial() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorefrescarrazonsocial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nombrefantasia_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'NOMBREDEFANTASIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'nombrefantasia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'nombrefantasia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Nombrefantasia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Nombrefantasia( lxVal )				this.Setear_Nombrefantasia( lxVal )			EndIf		Else			This.Setear_Nombrefantasia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerrazonessociales() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerrazonessociales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nombrefantasia( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'NOMBREDEFANTASIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_nombrefantasia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_nombrefantasia', lcParametros )			endif		endif		this.Nombrefantasia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nombrefantasia( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'NOMBREDEFANTASIA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_nombrefantasia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_nombrefantasia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonombrefantasia() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridonombrefantasia', lcParametros )
	EndFunc
