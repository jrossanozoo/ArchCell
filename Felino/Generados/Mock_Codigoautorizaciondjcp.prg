...
define class Mock_codigoautorizaciondjcp as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Código de autorización de DJCP"                                                                                                                                                                                                          
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'CODIGOAUTORIZACIONDJCP'                                                                                                                                                                                                                        
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleautorizaciones() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleautorizaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detalleautorizaciones_access() as variant                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CODIGOAUTORIZACIONDJCP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalleautorizaciones_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalleautorizaciones_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalleautorizaciones ) = 'O' or isnull( this.Detalleautorizaciones ) )			this.Detalleautorizaciones = this.crearobjeto( 'Din_DetalleCodigoautorizaciondjcpDetalleautorizaciones' )			this.Detalleautorizaciones.inicializar()			this.enlazar( 'Detalleautorizaciones.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalleautorizaciones.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalleautorizaciones, 'CambioSumarizado', this, 'CambiosDetalleDetalleautorizaciones', 1)			this.enlazar( 'Detalleautorizaciones.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalleautorizaciones.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detalleautorizaciones.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detalleautorizaciones
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function paisorigen_access() as variant                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CODIGOAUTORIZACIONDJCP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'paisorigen_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'paisorigen_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Paisorigen ) = 'O' or isnull( this.Paisorigen ) )					this.Paisorigen = _Screen.zoo.instanciarentidad( 'Paises' )					this.Paisorigen.lEsSubEntidad = .t.					this.enlazar( 'Paisorigen.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Paisorigen.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Paisorigen.CODIGO # this.Paisorigen_PK						this.Paisorigen.CODIGO = this.Paisorigen_PK					endif				endif			endif		endif		return this.Paisorigen
	EndFunc

	*-----------------------------------------------------------------------------------------
	function paisorigen_pk_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CODIGOAUTORIZACIONDJCP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'paisorigen_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'paisorigen_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Paisorigen_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		lxVal = iif( len( lxVal ) < 3, padr( lxVal, 3 ), lxVal )		this.Paisorigen_PK = lxVal		if this.Validar_Paisorigen( lxVal, lxValOld )			This.Setear_Paisorigen( lxVal )		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_paisorigen( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CODIGOAUTORIZACIONDJCP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_paisorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_paisorigen', lcParametros )			endif		endif		this.Paisorigen.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_paisorigen( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CODIGOAUTORIZACIONDJCP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_paisorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_paisorigen', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcodigosautorizacion() as boolean                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcodigosautorizacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validardetallevacio() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validardetallevacio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarpaisorigen() as boolean                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarpaisorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopaisorigen() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridopaisorigen', lcParametros )
	EndFunc
