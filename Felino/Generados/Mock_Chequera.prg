...
define class Mock_chequera as MockBase of MockBase.prg
	...
	lHabilitarCantidadCheques = .T.                                                                                                                                                                                                                           
	lHabilitarCantidadPersonalizada = .T.                                                                                                                                                                                                                     
	lHabilitarDiferido = .T.                                                                                                                                                                                                                                  
	lHabilitarFechaRecepcion = .T.                                                                                                                                                                                                                            
	lHabilitarNumeroInicial = .T.                                                                                                                                                                                                                             
	...
	*-----------------------------------------------------------------------------------------
	function cantidadcheques_assign( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cantidadcheques_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cantidadcheques_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cantidadcheques		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cantidadcheques( lxVal )				if ( this.lHabilitarCantidadcheques or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Cantidadcheques( lxVal )					 This.Cantidadcheques_DespuesDeAsignar()				else					this.Cantidadcheques = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Chequera - Atributo: Cantidadcheques)" )				endif			EndIf		Else			This.Setear_Cantidadcheques( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cantidadcheques_despuesdeasignar() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cantidadcheques_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cantidadpersonalizada_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cantidadpersonalizada_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cantidadpersonalizada_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cantidadpersonalizada		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Cantidadpersonalizada( lxVal )				if ( this.lHabilitarCantidadpersonalizada or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Cantidadpersonalizada( lxVal )				else					this.Cantidadpersonalizada = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Chequera - Atributo: Cantidadpersonalizada)" )				endif			EndIf		Else			This.Setear_Cantidadpersonalizada( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function chequeraelectronica_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'chequeraelectronica_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'chequeraelectronica_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Chequeraelectronica		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Chequeraelectronica( lxVal )				this.Setear_Chequeraelectronica( lxVal )				 This.Chequeraelectronica_DespuesDeAsignar()			EndIf		Else			This.Setear_Chequeraelectronica( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function chequeraelectronica_despuesdeasignar() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Chequeraelectronica_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function diferido_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'diferido_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'diferido_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Diferido		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Diferido( lxVal )				if ( this.lHabilitarDiferido or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Diferido( lxVal )				else					this.Diferido = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Chequera - Atributo: Diferido)" )				endif			EndIf		Else			This.Setear_Diferido( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitarcantidadpersonalizada() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventohabilitarcantidadpersonalizada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fecharecepcion_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fecharecepcion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fecharecepcion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fecharecepcion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fecharecepcion( lxVal )				if ( this.lHabilitarFecharecepcion or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.ValidarDominio_Fecha( lxVal )					this.Setear_Fecharecepcion( lxVal )				else					this.Fecharecepcion = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Chequera - Atributo: Fecharecepcion)" )				endif			EndIf		Else			This.Setear_Fecharecepcion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitarcantidadcheques() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitarcantidadcheques', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitarcantidadpersonalizada() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitarcantidadpersonalizada', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitardiferido() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitardiferido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitarfecharecepcion() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitarfecharecepcion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitardeshabilitarnumeroinicial() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitardeshabilitarnumeroinicial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numeroinicial_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numeroinicial_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numeroinicial_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numeroinicial		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numeroinicial( lxVal )				if ( this.lHabilitarNumeroinicial or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.ValidarDominio_Numericononegativo( lxVal )					this.Setear_Numeroinicial( lxVal )				else					this.Numeroinicial = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Chequera - Atributo: Numeroinicial)" )				endif			EndIf		Else			This.Setear_Numeroinicial( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oad_access() as variant                                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oad_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oad_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oAD ) = 'O' or isnull( this.oAD ) )			this.oAD = this.crearobjeto( 'Din_EntidadCHEQUERAAD_' + alltrim( _screen.zoo.app.TipoDeBase ))			this.oAD.InyectarEntidad( this )			this.oAD.Inicializar()		endif		return this.oAD
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetear_chequeraelectronica() as void                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'procesardespuesdesetear_chequeraelectronica', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'procesardespuesdesetear_chequeraelectronica', lcParametros )			endif		endif		this.HabilitarDeshabilitarNumeroInicial()		this.HabilitarDeshabilitarDiferido()		this.HabilitarDeshabilitarFechaRecepcion()		this.HabilitarDeshabilitarCantidadCheques()			this.HabilitarDeshabilitarCantidadPersonalizada()	
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cantidadcheques( txval as variant ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cantidadcheques', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cantidadcheques', lcParametros )			endif		endif		this.Cantidadcheques = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_cantidadpersonalizada( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cantidadpersonalizada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cantidadpersonalizada', lcParametros )			endif		endif		this.Cantidadpersonalizada = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_chequeraelectronica( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_chequeraelectronica', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_chequeraelectronica', lcParametros )			endif		endif		this.Chequeraelectronica = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_diferido( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_diferido', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_diferido', lcParametros )			endif		endif		this.Diferido = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fecharecepcion( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fecharecepcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fecharecepcion', lcParametros )			endif		endif		this.Fecharecepcion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numeroinicial( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numeroinicial', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numeroinicial', lcParametros )			endif		endif		this.Numeroinicial = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cantidadcheques( txval as variant ) as boolean                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cantidadcheques', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cantidadcheques', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_cantidadpersonalizada( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cantidadpersonalizada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cantidadpersonalizada', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_chequeraelectronica( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_chequeraelectronica', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_chequeraelectronica', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_diferido( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_diferido', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_diferido', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fecharecepcion( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fecharecepcion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fecharecepcion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numeroinicial( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CHEQUERA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numeroinicial', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numeroinicial', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidadcheques() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridocantidadcheques', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridocantidadpersonalizada() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridocantidadpersonalizada', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridochequeraelectronica() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridochequeraelectronica', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodiferido() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodiferido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofecharecepcion() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofecharecepcion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcantidadcheques() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwcantidadcheques', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwchequeraelectronica() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwchequeraelectronica', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridonumeroinicial() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridonumeroinicial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcantidadpersonalizada() as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcantidadpersonalizada', lcParametros )
	EndFunc
