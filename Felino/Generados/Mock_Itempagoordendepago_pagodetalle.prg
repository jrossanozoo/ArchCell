...
define class Mock_Itempagoordendepago_pagodetalle as MockBase of MockBase.prg

	cClase = 'Itempagoordendepago_pagodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function ocompcuentacorrientepagocompras_access() as variant                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ocompcuentacorrientepagocompras_access', lcParametros )
	EndFunc
