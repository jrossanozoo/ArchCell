...
define class Mock_Itemposdispositivomovilpointdetalle as MockBase of MockBase.prg

	cClase = 'Itemposdispositivomovilpointdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function disponible_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Disponible_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_disponible( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_disponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_sugerido( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_sugerido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_vinculacionpdv( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_vinculacionpdv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sugerido_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Sugerido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_disponible( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_disponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_sugerido( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_sugerido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_vinculacionpdv( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_vinculacionpdv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodisponible() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridodisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridosugerido() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridosugerido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovinculacionpdv() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridovinculacionpdv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function vinculacionpdv_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Vinculacionpdv_assign', lcParametros )
	EndFunc
