...
define class Mock_Detalledistribucioncentrodecostodetallecentrodecosto as MockBase of MockBase.prg

	cClase = 'Detalledistribucioncentrodecostodetallecentrodecosto'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_porcentaje() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventocambiosum_porcentaje', lcParametros )
	EndFunc
