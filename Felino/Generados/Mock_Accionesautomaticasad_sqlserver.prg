...
define class Mock_Accionesautomaticasad_sqlserver as MockBase of MockBase.prg

	cClase = 'Accionesautomaticasad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_daccaut( tctablatrabajo ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_daccaut', lcParametros )
	EndFunc
