...
define class Mock_APLICACIONFELINO as MockBase of MockBase.prg

	cClase = 'APLICACIONFELINO'
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Destruirobjetofiserv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function  configurarparametrosparapromocionesbancarias() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Configurarparametrosparapromocionesbancarias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function activarmoduloventasfiserv() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Activarmoduloventasfiserv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarbarradeestado() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Actualizarbarradeestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarlibreriascrystal() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Actualizarlibreriascrystal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function actualizarmenuservicio() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Actualizarmenuservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregarorigendedatos( toorigendedatos as string, tccodigo as string ) as void                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Agregarorigendedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function aperturaautomaticadeentidades() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Aperturaautomaticadeentidades', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignarclavemenu() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Asignarclavemenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function bajarservicio( tcobjetoapp as string, tcobjetoglobal as string ) as void                                                                                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = tcobjetoapp
		lxParam2 = tcobjetoglobal
		...
		return this.ObtenerResultado( 'Bajarservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function bajarserviciosysalirsifallo( tcmensaje as string, tlnoespera as boolean ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Bajarserviciosysalirsifallo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiars( tncantidadpantallas as integer, tlnomostraradvertencia as boolean ) as boolean                                                                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = tncantidadpantallas
		lxParam2 = tlnomostraradvertencia
		...
		return this.ObtenerResultado( 'Cambiars', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarparametrosyregistros() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Cargarparametrosyregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarsucursales( tcbasededatos as string ) as boolean                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Cargarsucursales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cbdmaster_access() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Cbdmaster_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function chequeoalarmachecklinehost( tdfecha as datetime ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Chequeoalarmachecklinehost', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cnombredriversql_access() as string                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cnombredriversql_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function configuraradministraciondeenergia( tlevitarqueentreenmodosuspendido as boolean ) as void                                                                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = tlevitarqueentreenmodosuspendido
		...
		return this.ObtenerResultado( 'Configuraradministraciondeenergia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function configuraragente() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Configuraragente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function copiardbsucursales( tcsucursalorigen as string, tcrutaorigen as string, tcsucursaldestino as string, tcrutadestino as string ) as void                                                                                                           
		...
		lnParametros = pcount()
		lxParam1 = tcsucursalorigen
		lxParam2 = tcrutaorigen
		lxParam3 = tcsucursaldestino
		lxParam4 = tcrutadestino
		...
		return this.ObtenerResultado( 'Copiardbsucursales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearconfig() as void                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Crearconfig', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearformprincipal() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Crearformprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crutaappdatalocal_access() as variant                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Crutaappdatalocal_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function csucursalactiva_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Csucursalactiva_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function despuesdellogin() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Despuesdellogin', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detenertimeralarmachecklinehost() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Detenertimeralarmachecklinehost', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function efectuarsalidadelsistema() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Efectuarsalidadelsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutandosalidadelsistema() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Ejecutandosalidadelsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarayuda() as void                                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Ejecutarayuda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarcomandomenu( tccomando as string, tcidentificadorparaopcionesdemenuytoolbar as string, tcidseguridad as string ) as void                                                                                                                 
		...
		lnParametros = pcount()
		lxParam1 = tccomando
		lxParam2 = tcidentificadorparaopcionesdemenuytoolbar
		lxParam3 = tcidseguridad
		...
		return this.ObtenerResultado( 'Ejecutarcomandomenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarmigradordeparametros() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Ejecutarmigradordeparametros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutarreindexador( tcbasededatos as string ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Ejecutarreindexador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutodesdeexe() as boolean                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Ejecutodesdeexe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutodesdeformulario() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ejecutodesdeformulario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutodesdemain() as boolean                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Ejecutodesdemain', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function establadesucursal( tctabla as string ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Establadesucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esunatablaquepermiteabmenreplica( tctabla as string ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Esunatablaquepermiteabmenreplica', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoconfigurarlogo( tlconfigura as boolean ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Eventoconfigurarlogo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocreacionocxfiscal() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eventocreacionocxfiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajeadvertencia( tcmensaje as string ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventomensajeadvertencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitapooldeaplicaciones() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Habilitapooldeaplicaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function informarestado( tctexto as string, tlespera as boolean ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Informarestado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inicializarbasededatos()                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Inicializarbasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inicializartimeralarmachecklinehost() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Inicializartimeralarmachecklinehost', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarcaja() as void                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Iniciarcaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarconserviciosbasicos() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Iniciarconserviciosbasicos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarcontrolador() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Iniciarcontrolador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarinterfazfiserv() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Iniciarinterfazfiserv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarmenuprincipal() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Iniciarmenuprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarregistroterminal() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Iniciarregistroterminal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarservicio( tcclase as string, tcobjetoapp as string, tcobjetoglobal as string, txpar1 as variant, tcdescripcion as string ) as void                                                                                                        
		...
		lnParametros = pcount()
		lxParam1 = tcclase
		lxParam2 = tcobjetoapp
		lxParam3 = tcobjetoglobal
		lxParam4 = txpar1
		lxParam5 = tcdescripcion
	...
	*-----------------------------------------------------------------------------------------
	function iniciarserviciomodulos() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Iniciarserviciomodulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarservicioscondependencia() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Iniciarservicioscondependencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarserviciossindependencia() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Iniciarserviciossindependencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function instanciarnetextender() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Instanciarnetextender', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function instanciarwwdotnetbridge() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Instanciarwwdotnetbridge', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function levantardatosdeaplicacionini( tcarchivo as string ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Levantardatosdeaplicacionini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function levantardatosdedataconfigini( tcarchivo as string ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Levantardatosdedataconfigini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function levantarseteosaplicacionini( tcarchivo as string, tcnombreaplicacion as string ) as void                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Levantarseteosaplicacionini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function levantarseteosdataconfigini( tcarchivo as string ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Levantarseteosdataconfigini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function levantarseteosini() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Levantarseteosini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llamaacercade() as void                                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Llamaacercade', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function login() as boolean                                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Login', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function loguearerrormodulosonline( toerror as object ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Loguearerrormodulosonline', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mostrarformularioprincipal() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Mostrarformularioprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oadmistradordeenergia_access() as object                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Oadmistradordeenergia_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oaspectoaplicacion_access() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Oaspectoaplicacion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbuild() as string                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerbuild', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerclaselogin() as string                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerclaselogin', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercolorbd() as integer                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercolorbd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercontroladorfiscal() as object                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercontroladorfiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenericonodelaaplicacion() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenericonodelaaplicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinstanciacontroladorfiscal( tcclase as string ) as object                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerinstanciacontroladorfiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinstanciacontroladorfiscalespecifica( tcclase as string ) as object                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerinstanciacontroladorfiscalespecifica', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermajor() as string                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenermajor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermesaniodecompilaciondelaversionactual() as string                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenermesaniodecompilaciondelaversionactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermodulosonline() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenermodulosonline', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombreproyecto() as string                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenernombreproyecto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerprefijodb() as string                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerprefijodb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerprimerasucursalexistente() as string                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerprimerasucursalexistente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerrelease() as string                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerrelease', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerrutaseguntablaysucursal( tctabla as string, tcsucursal as string ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerrutaseguntablaysucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerrutasucursal( tcsucursal ) as string                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerrutasucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersucursalactiva() as string                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenersucursalactiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersucursaldefault() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenersucursaldefault', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenervalorreplicabd() as boolean                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenervalorreplicabd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerversioncfapp() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerversioncfapp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerversionpkw() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerversionpkw', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradoraccionesautomaticas_access() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Ocolaboradoraccionesautomaticas_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omanagerdeconfiguraciondeagentedeaccionesorganic_access() as variant                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Omanagerdeconfiguraciondeagentedeaccionesorganic_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omonitordeingresoysalida_access() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Omonitordeingresoysalida_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function opoolconexiones_access() as variant                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Opoolconexiones_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function otablaspermitenabmreplica_access() as object                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Otablaspermitenabmreplica_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function permiteabm( tctabla as string ) as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Permiteabm', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function permitemodificaroeliminarenbase( tcsentencia as string, tctablas as string ) as boolean                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Permitemodificaroeliminarenbase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function persistirnumerodecaja() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Persistirnumerodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesarinstanciacionerroneadeaplicacion() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Procesarinstanciacionerroneadeaplicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesodedatosfixparametros() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Procesodedatosfixparametros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puedoaccederaparametrosyregistros() as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Puedoaccederaparametrosyregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puedoeliminarbasededatos( tcbasededatos ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Puedoeliminarbasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function registrarterminalsicorresponde() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Registrarterminalsicorresponde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reiniciarservicios( tlsaltafiscal as boolean ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Reiniciarservicios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function resetearserieapp( tcserie as string, tcclave as string, tcsitio as string ) as void                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Resetearserieapp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reubicarstatusbar()                                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Reubicarstatusbar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sacaratributossololectura( tcruta as string ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Sacaratributossololectura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sepuedeingresar() as boolean                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Sepuedeingresar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setarusodetimers() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setarusodetimers', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearaplicacion() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setearaplicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearentornocloud() as void                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setearentornocloud', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearestadomenuprincipal( tlhabilitado as boolean ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setearestadomenuprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seteoesquemaseguridad() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Seteoesquemaseguridad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function utilizacf() as boolean                                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Utilizacf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function utilizarelaao() as boolean                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Utilizarelaao', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function utilizaroptimizaciondeconsultasporfechamodificacion() as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Utilizaroptimizaciondeconsultasporfechamodificacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaractualizaciondelibreriascrystal() as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validaractualizaciondelibreriascrystal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarconfig() as void                                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validarconfig', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarconsistenciainternatabla( tctabla as string ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validarconsistenciainternatabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistencia_din_parametros_y_din_registros_y_din_menuprincipal() as boolean                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validarexistencia_din_parametros_y_din_registros_y_din_menuprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciadefuentes() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarexistenciadefuentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarexistenciaejecutables() as boolean                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validarexistenciaejecutables', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarversiondemo() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validarversiondemo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarversionlibreriascrystal() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarversionlibreriascrystal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificaciondeparametrosrz() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Verificaciondeparametrosrz', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificacionesgenerales() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificacionesgenerales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarbdpreferente() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Verificarbdpreferente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcargaajustedecupon() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Verificarcargaajustedecupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarcontroladorfiscal() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Verificarcontroladorfiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarexistenciabase( tcsucursal as string ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Verificarexistenciabase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarexistenciaconfig() as boolean                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Verificarexistenciaconfig', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarexistenciadeejecutables() as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Verificarexistenciadeejecutables', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarexistenciadll() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Verificarexistenciadll', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarinicializacioncontroladorfiscal() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Verificarinicializacioncontroladorfiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificariniciodeserviciosrest() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Verificariniciodeserviciosrest', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarmemoriaservidordedatos() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Verificarmemoriaservidordedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarmodulodfcloud() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Verificarmodulodfcloud', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarorigendedatosfaltantes( tccodigobase as string ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificarorigendedatosfaltantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarentornoporcambiodeversion( tltienescriptcargado as boolean ) as void                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Actualizarentornoporcambiodeversion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarserieenaplicacionini() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Actualizarserieenaplicacionini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarconfiguradoresadicionalesalagente() as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Agregarconfiguradoresadicionalesalagente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function bajarserviciosparareindexar() as void  &&este metodo vuela cuando pertenescan a una collecion que administre los servicios 15-12-08 (malu)                                                                                             
		...
		return this.ObtenerResultado( 'Bajarserviciosparareindexar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function borrartabla( tctabla as string ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Borrartabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function buscaractualizacionessegunparametro() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Buscaractualizacionessegunparametro', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function chequearpametrosporcambiodesucursal() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Chequearpametrosporcambiodesucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function creargolibrerias()  as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Creargolibrerias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearserieenusuariosystemsinoexiste() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Crearserieenusuariosystemsinoexiste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function desregistrarregistroterminal() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Desregistrarregistroterminal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function disparareventosdll() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Disparareventosdll', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function enlazarparametros() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Enlazarparametros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function essentenciadeupdateoinsertodelete( tcsentencia as string ) as boolean                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Essentenciadeupdateoinsertodelete', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ficharingresoalsistema() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Ficharingresoalsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function informarproblemaenlabasededatos() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Informarproblemaenlabasededatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarbascula() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Iniciarbascula', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarmanagerdeconfiguraciondeagentedeaccionesorganic() as void                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Iniciarmanagerdeconfiguraciondeagentedeaccionesorganic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function instanciarmonitorqa() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Instanciarmonitorqa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function matarcf() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Matarcf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdescripcionadvertenciacambiodeserie() as string                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerdescripcionadvertenciacambiodeserie', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerextencionprocesoenejecucion( tipoarchivo as string ) as boolean                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenerextencionprocesoenejecucion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermemoriafisicaservidordedatos() as integer                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenermemoriafisicaservidordedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reasignarguiddeserie() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Reasignarguiddeserie', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reasignarserieensesion() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Reasignarserieensesion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function reportarregistroterminal() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Reportarregistroterminal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearbasesdedatos( tltienescriptcargado as boolean ) as void                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setearbasesdedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearbufferdememoria() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearbufferdememoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearcomplejidadenconsultas() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearcomplejidadenconsultas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function seteariconodelaaplicacion() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Seteariconodelaaplicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearmemoriaminimadisponibleparaelservidordedatos( tnporcentajedememoria as float ) as void                                                                                                                                           
		...
		lnParametros = pcount()
		lxParam1 = tnporcentajedememoria
		...
		return this.ObtenerResultado( 'Setearmemoriaminimadisponibleparaelservidordedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearmemoriaminimaparaservidordedatos( tnminimo as float ) as void                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setearmemoriaminimaparaservidordedatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearparametrosmodoavanzadoyestilo() as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Setearparametrosmodoavanzadoyestilo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearpropiedadesbasicas() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setearpropiedadesbasicas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function seteartitulodelaaplicacion() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Seteartitulodelaaplicacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validaraperturaauditoria( tcrutatabla as string, tctabla as string  ) as boolean                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validaraperturaauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarejecucionmantenimientobd() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validarejecucionmantenimientobd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarexistenciadebackup() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarexistenciadebackup', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificaraccesoaparametrosyregistros( tltienescriptcargado as boolean ) as void                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Verificaraccesoaparametrosyregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarpantallasabiertas( tncantidadpantallas as integer ) as boolean                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Verificarpantallasabiertas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarrutadataconfig() as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Verificarrutadataconfig', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function verificarservidordataconfig() as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Verificarservidordataconfig', lcParametros )
	EndFunc
