...
define class Din_ItemFACTURAELECTRONICADECREDITOArticulosseniadosdetalle as ItemARTICULOSSENIADOS of ItemARTICULOSSENIADOS.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'FACTURAELECTRONICADECREDITO', 'Articulosseniadosdetalle')
	...
	function Articulo_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Articulo( lxVal, lxValOld )
			...
			If lxValOld != lxVal or empty( this.Articulodetalle ) 
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Articulo)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Material_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Material( lxVal, lxValOld )
			if ( this.lHabilitarMaterial_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Material)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Numerogiftcard_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Numerogiftcard( lxVal, lxValOld )
			if ( this.lHabilitarNumerogiftcard_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Numerogiftcard)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Equivalencia_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Equivalencia( lxVal, lxValOld )
			if ( this.lHabilitarEquivalencia_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Equivalencia)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Unidad_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Unidad( lxVal, lxValOld )
			if ( this.lHabilitarUnidad_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Unidad)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Codigomotivodescuento_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Codigomotivodescuento( lxVal, lxValOld )
			if ( this.lHabilitarCodigomotivodescuento_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Codigomotivodescuento)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Codigomotivodevolucion_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Codigomotivodevolucion( lxVal, lxValOld )
			if ( this.lHabilitarCodigomotivodevolucion_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Codigomotivodevolucion)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Color_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Color( lxVal, lxValOld )
			if ( this.lHabilitarColor_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Color)" )
			endif 
		endif
		dodefault( lxVal )
		...
		if This.CargaManual()
			if this.Validar_Afe_puntodeventa( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_puntodeventa', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_puntodeventa)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_puntodeventa( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_letra( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_letra', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_letra)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_letra( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_numero( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_numero', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_numero)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_numero( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Codigogtin( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Codigogtin', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Codigogtin)" )
				endif 
			EndIf
		Else
			This.Setear_Codigogtin( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montodescuentosinimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montodescuentosinimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montodescuentosinimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Montodescuentosinimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montodescuentoconimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montodescuentoconimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montodescuentoconimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Montodescuentoconimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateodescuentosinimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateodescuentosinimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateodescuentosinimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateodescuentosinimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoporcentajedescuentosinimpuesto( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoporcentajedescuentosinimpuesto', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoporcentajedescuentosinimpuesto)" )
				endif 
			EndIf
		Else
			This.Setear_Montoporcentajedescuentosinimpuesto( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateorecargoconimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateorecargoconimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateorecargoconimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateorecargoconimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Articulo_porcentajeivaventas( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Articulo_porcentajeivaventas', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Articulo_porcentajeivaventas)" )
				endif 
			EndIf
		Else
			This.Setear_Articulo_porcentajeivaventas( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateopercepciones( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateopercepciones', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateopercepciones)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateopercepciones( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateototal( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateototal', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateototal)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateototal( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateorecargosinimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateorecargosinimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateorecargosinimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateorecargosinimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateodescuentoconimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateodescuentoconimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateodescuentoconimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateodescuentoconimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Preciosinredondear( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Preciosinredondear', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Preciosinredondear)" )
				endif 
			EndIf
		Else
			This.Setear_Preciosinredondear( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tienerestriccion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Tienerestriccion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Tienerestriccion)" )
				endif 
			EndIf
		Else
			This.Setear_Tienerestriccion( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateodescuentofinancierosinimp( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateodescuentofinancierosinimp', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateodescuentofinancierosinimp)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateodescuentofinancierosinimp( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Comportamiento( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Comportamiento', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Comportamiento)" )
				endif 
			EndIf
		Else
			This.Setear_Comportamiento( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateorecargofinancierosinimp( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateorecargofinancierosinimp', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateorecargofinancierosinimp)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateorecargofinancierosinimp( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Percepcionivarg5329( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Percepcionivarg5329', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Percepcionivarg5329)" )
				endif 
			EndIf
		Else
			This.Setear_Percepcionivarg5329( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_saldoliquidacion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_saldoliquidacion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_saldoliquidacion)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_saldoliquidacion( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoimpuestointerno( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoimpuestointerno', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoimpuestointerno)" )
				endif 
			EndIf
		Else
			This.Setear_Montoimpuestointerno( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tasaimpuestointerno( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Tasaimpuestointerno', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Tasaimpuestointerno)" )
				endif 
			EndIf
		Else
			This.Setear_Tasaimpuestointerno( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Articulo_condicionivaventas( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Articulo_condicionivaventas', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Articulo_condicionivaventas)" )
				endif 
			EndIf
		Else
			This.Setear_Articulo_condicionivaventas( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Precioconimpuestossinredondear( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Precioconimpuestossinredondear', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Precioconimpuestossinredondear)" )
				endif 
			EndIf
		Else
			This.Setear_Precioconimpuestossinredondear( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipodeitem( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Tipodeitem', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Tipodeitem)" )
				endif 
			EndIf
		Else
			This.Setear_Tipodeitem( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Ajusteporredondeoconimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Ajusteporredondeoconimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Ajusteporredondeoconimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Ajusteporredondeoconimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Bruto( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Bruto', lxValOld, lxVal  )
					...
					this.Bruto = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Bruto)" )
				endif 
			EndIf
		Else
			This.Setear_Bruto( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Stock( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Stock', lxValOld, lxVal  )
					...
					this.Stock = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Stock)" )
				endif 
			EndIf
		Else
			This.Setear_Stock( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Ajusteporredondeosinimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Ajusteporredondeosinimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Ajusteporredondeosinimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Ajusteporredondeosinimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Preciosinimpuestossinredondear( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Preciosinimpuestossinredondear', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Preciosinimpuestossinredondear)" )
				endif 
			EndIf
		Else
			This.Setear_Preciosinimpuestossinredondear( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_timestamp( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_timestamp', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_timestamp)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_timestamp( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_saldooriginal( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_saldooriginal', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_saldooriginal)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_saldooriginal( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Nroitem( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Nroitem', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Nroitem)" )
				endif 
			EndIf
		Else
			This.Setear_Nroitem( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_saldoactual( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_saldoactual', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_saldoactual)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_saldoactual( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Oferta( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Oferta', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Oferta)" )
				endif 
			EndIf
		Else
			This.Setear_Oferta( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Porcentajecfi( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Porcentajecfi', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Porcentajecfi)" )
				endif 
			EndIf
		Else
			This.Setear_Porcentajecfi( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Porcentajeiva( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Porcentajeiva', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Porcentajeiva)" )
				endif 
			EndIf
		Else
			This.Setear_Porcentajeiva( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Porcentajedto1( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Porcentajedto1', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Porcentajedto1)" )
				endif 
			EndIf
		Else
			This.Setear_Porcentajedto1( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoiva( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoiva', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoiva)" )
				endif 
			EndIf
		Else
			This.Setear_Montoiva( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montodto1( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montodto1', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montodto1)" )
				endif 
			EndIf
		Else
			This.Setear_Montodto1( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoporcentajedescuentoconimpuesto( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoporcentajedescuentoconimpuesto', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoporcentajedescuentoconimpuesto)" )
				endif 
			EndIf
		Else
			This.Setear_Montoporcentajedescuentoconimpuesto( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Impuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Impuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Impuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Impuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Kit( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Kit', lxValOld, lxVal  )
					...
					this.Kit = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Kit)" )
				endif 
			EndIf
		Else
			This.Setear_Kit( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montocfi( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montocfi', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montocfi)" )
				endif 
			EndIf
		Else
			This.Setear_Montocfi( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Precioconimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Precioconimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Precioconimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Precioconimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Neto( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Neto', lxValOld, lxVal  )
					...
					this.Neto = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Neto)" )
				endif 
			EndIf
		Else
			This.Setear_Neto( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Preciodelista( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Preciodelista', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Preciodelista)" )
				endif 
			EndIf
		Else
			This.Setear_Preciodelista( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_tipocomprobante( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_tipocomprobante', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_tipocomprobante)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_tipocomprobante( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_nroitem( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_nroitem', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_nroitem)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_nroitem( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_saldo( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_saldo', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_saldo)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_saldo( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Codigoorigen( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Codigoorigen', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Codigoorigen)" )
				endif 
			EndIf
		Else
			This.Setear_Codigoorigen( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_cantidad( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_cantidad', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_cantidad)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_cantidad( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idorigen( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Idorigen', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Idorigen)" )
				endif 
			EndIf
		Else
			This.Setear_Idorigen( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Preciosinimpuestos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Preciosinimpuestos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Preciosinimpuestos)" )
				endif 
			EndIf
		Else
			This.Setear_Preciosinimpuestos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_cantidadoriginal( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_cantidadoriginal', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_cantidadoriginal)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_cantidadoriginal( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Preciounitario( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Preciounitario', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Preciounitario)" )
				endif 
			EndIf
		Else
			This.Setear_Preciounitario( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Iditem( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Iditem', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Iditem)" )
				endif 
			EndIf
		Else
			This.Setear_Iditem( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tipolistadeprecio( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Tipolistadeprecio', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Tipolistadeprecio)" )
				endif 
			EndIf
		Else
			This.Setear_Tipolistadeprecio( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Eslibre( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Eslibre', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Eslibre)" )
				endif 
			EndIf
		Else
			This.Setear_Eslibre( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Noprocesarstock( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Noprocesarstock', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Noprocesarstock)" )
				endif 
			EndIf
		Else
			This.Setear_Noprocesarstock( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Restringirdescuentos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Restringirdescuentos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Restringirdescuentos)" )
				endif 
			EndIf
		Else
			This.Setear_Restringirdescuentos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Fueautorizadodevolucion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Fueautorizadodevolucion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Fueautorizadodevolucion)" )
				endif 
			EndIf
		Else
			This.Setear_Fueautorizadodevolucion( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Usarpreciodelista( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Usarpreciodelista', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Usarpreciodelista)" )
				endif 
			EndIf
		Else
			This.Setear_Usarpreciodelista( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idkit( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Idkit', lxValOld, lxVal  )
					...
					this.Idkit = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Idkit)" )
				endif 
			EndIf
		Else
			This.Setear_Idkit( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Ordendeservicio( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Ordendeservicio', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Ordendeservicio)" )
				endif 
			EndIf
		Else
			This.Setear_Ordendeservicio( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Iditemarticulos_aux( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Iditemarticulos_aux', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Iditemarticulos_aux)" )
				endif 
			EndIf
		Else
			This.Setear_Iditemarticulos_aux( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_codigo_aux( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_codigo_aux', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_codigo_aux)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_codigo_aux( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Codigoautorizaciondjcp( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Codigoautorizaciondjcp', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Codigoautorizaciondjcp)" )
				endif 
			EndIf
		Else
			This.Setear_Codigoautorizaciondjcp( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Iditemarticulos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Iditemarticulos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Iditemarticulos)" )
				endif 
			EndIf
		Else
			This.Setear_Iditemarticulos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Codigodebarras( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Codigodebarras', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Codigodebarras)" )
				endif 
			EndIf
		Else
			This.Setear_Codigodebarras( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_codigo( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_codigo', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Afe_codigo)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_codigo( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Articulodetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Articulodetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Articulodetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Articulodetalle( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Colordetalle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Colordetalle', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Colordetalle)" )
				endif 
			EndIf
		Else
			This.Setear_Colordetalle( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Talle( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Talle', lxValOld, lxVal  )
					...
					this.Talle = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Talle)" )
				endif 
			EndIf
		Else
			This.Setear_Talle( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Descuento( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Descuento', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Descuento)" )
				endif 
			EndIf
		Else
			This.Setear_Descuento( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateoiva( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateoiva', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateoiva)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateoiva( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montodescuento( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montodescuento', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montodescuento)" )
				endif 
			EndIf
		Else
			This.Setear_Montodescuento( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateoimpuestointerno( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateoimpuestointerno', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Montoprorrateoimpuestointerno)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateoimpuestointerno( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Cantidad( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Cantidad', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Cantidad)" )
				endif 
			EndIf
		Else
			This.Setear_Cantidad( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Precio( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Precio', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Precio)" )
				endif 
			EndIf
		Else
			This.Setear_Precio( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Monto( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Monto', lxValOld, lxVal  )
					...
					this.Monto = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Factura de crédito electrónica MiPyME de venta - Atributo: Monto)" )
				endif 
			EndIf
		Else
			This.Setear_Monto( lxVal ) 
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoArticulo() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Articulo" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoArticulodetalle() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Articulodetalle" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Descripción para el detalle Artículos señados." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoColor() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Color" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoColordetalle() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Colordetalle" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Detalle para el detalle Artículos señados." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoTalle() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Talle" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Tal para el detalle Artículos señados." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoDescuento() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Descuento" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Des% para el detalle Artículos señados." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es numérico." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoMontodescuento() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Montodescuento" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Monto Desc. para el detalle Artículos señados." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es numérico." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoCantidad() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "FACTURAELECTRONICADECREDITO", "Articulosseniadosdetalle", "Cantidad" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Cant para el detalle Artículos señados." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es numérico." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			else
