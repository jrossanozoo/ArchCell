...
define class Mock_Itemfacturaelectronicaexportacionimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemfacturaelectronicaexportacionimpuestoscomprobante'
