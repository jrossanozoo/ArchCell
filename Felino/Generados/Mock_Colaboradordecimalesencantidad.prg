...
define class Mock_COLABORADORDECIMALESENCANTIDAD as MockBase of MockBase.prg

	cClase = 'COLABORADORDECIMALESENCANTIDAD'
	...
	*-----------------------------------------------------------------------------------------
	function ajustarenimpoexpo( toatributo as object, topropiedades as object, tcentidad as string )                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = toatributo
		lxParam2 = topropiedades
		lxParam3 = tcentidad
		...
		return this.ObtenerResultado( 'Ajustarenimpoexpo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ajustarmascara( tcatributo as string, tcmascara as object, tcentidad as string ) as string                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Ajustarmascara', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdecimalessegunatributo( tcatributo as string, tcentidad as string ) as string                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerdecimalessegunatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ooverwrite_access()                                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Ooverwrite_access', lcParametros )
	EndFunc
