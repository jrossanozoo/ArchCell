...
define class Mock_Detallemonedacotizaciones as MockBase of MockBase.prg

	cClase = 'Detallemonedacotizaciones'

	
	cAtributosAgrupamiento = ""                                                                                                                                                                                                                               
	cAtributosAgrupamientoDefault = "NroItem"                                                                                                                                                                                                                 
	cAtributosUnicidad = ""                                                                                                                                                                                                                                   
	cAtributosUnicidad = 'Fecha,Hora'                                                                                                                                                                                                                         
	cContexto = ""                                                                                                                                                                                                                                            
	cCopiadorDeDetalle = "CopiadorDeDetalles"                                                                                                                                                                                                                 
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Cotizaciones'                                                                                                                                                                                                                                
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'Las columnas Fecha + Hora no admiten valores repetidos.'                                                                                                                                                                         
	cNombre = 'Cotizaciones'                                                                                                                                                                                                                                  
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Cotizaciones'                                                                                                                                                                                                                            
	datasession = 1                                                                                                                                                                                                                                           
