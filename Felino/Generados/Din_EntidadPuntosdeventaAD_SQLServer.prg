...
define class Din_EntidadPUNTOSDEVENTAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxPtovtaFecexpo, lxPtovtaFectrans, lxPtovtaFmodifw, lxPtovtaFaltafw, lxPtovtaFecimpo, lxPtovtaNum, lxPtovtaSaltafw, lxPtovtaUaltafw, lxPtovtaSmodifw, lxPtovtaValtafw, lxPtovtaZadsfw, lxPtovtaHmodifw, lxPtovtaVmodifw, lxPtovtaUmodifw, lxPtovtaHoraimpo, lxPtovtaEsttrans, lxPtovtaBdmodifw, lxPtovtaHoraexpo, lxPtovtaBdaltafw, lxPtovtaHaltafw, lxPtovtaComp, lxPtovtaDescri, lxPtovtaLetra, lxPtovtaCobs, lxPtovtaPto, lxPtovtaPvsug, lxPtovtaBocaexp
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PTOVTA ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Num","Saltafw","Ualtafw","Smodifw","Valtafw","Zadsfw","Hmodifw","Vmodifw","Umodifw","Horaimpo","Esttrans","Bdmodifw","Horaexpo","Bdaltafw","Haltafw","Comp","Descri","Letra","Cobs","Pto","Pvsug","Bocaexp" ) values ( <<"'" + this.ConvertirDateSql( lxPtovtaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPtovtaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPtovtaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPtovtaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPtovtaFecimpo ) + "'" >>, <<lxPtovtaNum >>, <<"'" + this.FormatearTextoSql( lxPtovtaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaComp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaDescri ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaLetra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPtovtaCobs ) + "'" >>, <<lxPtovtaPto >>, <<iif( lxPtovtaPvsug, 1, 0 ) >>, <<lxPtovtaBocaexp >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.PTOVTA set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxPtovtaFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxPtovtaFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxPtovtaFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxPtovtaFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxPtovtaFecimpo ) + "'">>,"Num" = <<lxPtovtaNum>>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxPtovtaSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxPtovtaUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxPtovtaSmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxPtovtaValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxPtovtaZadsfw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxPtovtaHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxPtovtaVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxPtovtaUmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxPtovtaHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxPtovtaEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPtovtaBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxPtovtaHoraexpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPtovtaBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxPtovtaHaltafw ) + "'">>,"Comp" = <<"'" + this.FormatearTextoSql( lxPtovtaComp ) + "'">>,"Descri" = <<"'" + this.FormatearTextoSql( lxPtovtaDescri ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxPtovtaLetra ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxPtovtaCobs ) + "'">>,"Pto" = <<lxPtovtaPto>>,"Pvsug" = <<iif( lxPtovtaPvsug, 1, 0 )>>,"Bocaexp" = <<lxPtovtaBocaexp>> where "Num" = <<lxPtovtaNum>> and  PTOVTA.NUM != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	Function Primero() As Boolean
		...
		try
			With This.oEntidad
				...
				lcOrden =  .Descripcion + .Comprobante + .Letra + str( .PuntoDeVenta, 4, 0) + str( .Numero, 10, 0) + str( .BocaDeExpendio, 4, 0)
			local lcSentencia as string

			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Num" as "Numero", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Comp" as "Comprobante", "Descri" as "Descripcion", "Letra" as "Letra", "Cobs" as "Observacion", "Pto" as "Puntodeventa", "Pvsug" as "Puntodeventasugerido", "Bocaexp" as "Bocadeexpendio" from ZooLogic.PTOVTA where  PTOVTA.NUM != 0 order by DESCRI,COMP,LETRA,PTO,NUM,BOCAEXP
			endtext
			use in select('c_PUNTOSDEVENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PUNTOSDEVENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Num" as "Numero", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Comp" as "Comprobante", "Descri" as "Descripcion", "Letra" as "Letra", "Cobs" as "Observacion", "Pto" as "Puntodeventa", "Pvsug" as "Puntodeventasugerido", "Bocaexp" as "Bocadeexpendio" from ZooLogic.PTOVTA where  funciones.padr( DESCRI, 50, ' ' ) + funciones.padr( COMP, 40, ' ' ) + funciones.padr( LETRA, 1, ' ' ) + str( PTO, 4, 0) + str( NUM, 10, 0) + str( BOCAEXP, 4, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PTOVTA.NUM != 0 order by DESCRI,COMP,LETRA,PTO,NUM,BOCAEXP
			endtext
			use in select('c_PUNTOSDEVENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PUNTOSDEVENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Num" as "Numero", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Comp" as "Comprobante", "Descri" as "Descripcion", "Letra" as "Letra", "Cobs" as "Observacion", "Pto" as "Puntodeventa", "Pvsug" as "Puntodeventasugerido", "Bocaexp" as "Bocadeexpendio" from ZooLogic.PTOVTA where  funciones.padr( DESCRI, 50, ' ' ) + funciones.padr( COMP, 40, ' ' ) + funciones.padr( LETRA, 1, ' ' ) + str( PTO, 4, 0) + str( NUM, 10, 0) + str( BOCAEXP, 4, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PTOVTA.NUM != 0 order by DESCRI desc,COMP desc,LETRA desc,PTO desc,NUM desc,BOCAEXP desc
			endtext
			use in select('c_PUNTOSDEVENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PUNTOSDEVENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Num" as "Numero", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Comp" as "Comprobante", "Descri" as "Descripcion", "Letra" as "Letra", "Cobs" as "Observacion", "Pto" as "Puntodeventa", "Pvsug" as "Puntodeventasugerido", "Bocaexp" as "Bocadeexpendio" from ZooLogic.PTOVTA where  PTOVTA.NUM != 0 order by DESCRI desc,COMP desc,LETRA desc,PTO desc,NUM desc,BOCAEXP desc
			endtext
			use in select('c_PUNTOSDEVENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PUNTOSDEVENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Num,Saltafw,Ualtafw,Smodifw,Valtafw,Zadsfw,Hmodifw," + ;
"Vmodifw,Umodifw,Horaimpo,Esttrans,Bdmodifw,Horaexpo,Bdaltafw,Haltafw,Comp,Descri,Letra,Cobs,Pto,Pvsu" + ;
"g,Bocaexp" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.NUM or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.PTOVTA set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, NUM = ] + transform( &lcCursor..NUM )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, COMP = ] + "'" + this.FormatearTextoSql( &lcCursor..COMP ) + "'"+ [, DESCRI = ] + "'" + this.FormatearTextoSql( &lcCursor..DESCRI ) + "'"+ [, LETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..LETRA ) + "'"+ [, COBS = ] + "'" + this.FormatearTextoSql( &lcCursor..COBS ) + "'"+ [, PTO = ] + transform( &lcCursor..PTO )+ [, PVSUG = ] + Transform( iif( &lcCursor..PVSUG, 1, 0 ))+ [, BOCAEXP = ] + transform( &lcCursor..BOCAEXP ) + [ Where NUM = ] + transform( lcValorABuscar ) )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, NUM, SALTAFW, UALTAFW, SMODIFW, VALTAFW, ZADSFW, HMODIFW, VMODIFW, UMODIFW, HORAIMPO, ESTTRANS, BDMODIFW, HORAEXPO, BDALTAFW, HALTAFW, COMP, DESCRI, LETRA, COBS, PTO, PVSUG, BOCAEXP
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..COMP ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.NUM = isnull( d.NUM, t.NUM ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.COMP = isnull( d.COMP, t.COMP ),t.DESCRI = isnull( d.DESCRI, t.DESCRI ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.COBS = isnull( d.COBS, t.COBS ),t.PTO = isnull( d.PTO, t.PTO ),t.PVSUG = isnull( d.PVSUG, t.PVSUG ),t.BOCAEXP = isnull( d.BOCAEXP, t.BOCAEXP )
				...
				-- Fin Updates
				insert into ZooLogic.PTOVTA(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Num,Saltafw,Ualtafw,Smodifw,Valtafw,Zadsfw,Hmodifw,Vmodifw,Umodifw,Horaimpo,Esttrans,Bdmodifw,Horaexpo,Bdaltafw,Haltafw,Comp,Descri,Letra,Cobs,Pto,Pvsug,Bocaexp)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.NUM,0),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.COMP,''),isnull( d.DESCRI,''),isnull( d.LETRA,''),isnull( d.COBS,''),isnull( d.PTO,0),isnull( d.PVSUG,0),isnull( d.BOCAEXP,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="PUNTOSDEVENTA                           " atributo="FECHATRANSFERENCIA                      " tabla="PTOVTA         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PUNTOSDEVENTA                           " atributo="ESTADOTRANSFERENCIA                     " tabla="PTOVTA         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
