...
define class Mock_aperturaautomaticaentidades as MockBase of MockBase.prg
	...
	cClase = 'aperturaautomaticaentidades'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Apertura automática de entidades"                                                                                                                                                                                                        
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'APERTURAAUTOMATICAENTIDADES'                                                                                                                                                                                                                   
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	cUsuarioHabilitado = ''                                                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function setearfiltrobuscador( toobjeto ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearfiltrobuscador', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarusuariohabilitado( txval ) as boolean                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarusuariohabilitado', lcParametros )
	EndFunc
