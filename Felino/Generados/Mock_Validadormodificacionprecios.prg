...
define class Mock_VALIDADORMODIFICACIONPRECIOS as MockBase of MockBase.prg

	cClase = 'VALIDADORMODIFICACIONPRECIOS'
	...
	*-----------------------------------------------------------------------------------------
	function tienelistasanidadas() as boolean                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tienelistasanidadas', lcParametros )
	EndFunc
