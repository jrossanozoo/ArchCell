...
define class Din_EntidadPAGOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxPagoFaltafw, lxPagoFectrans, lxPagoFecexpo, lxPagoFmodifw, lxPagoFecimpo, lxPagoFacttipo, lxPagoTimestamp, lxPagoHaltafw, lxPagoVmodifw, lxPagoHoraexpo, lxPagoZadsfw, lxPagoHmodifw, lxPagoUmodifw, lxPagoUaltafw, lxPagoSaltafw, lxPagoValtafw, lxPagoHoraimpo, lxPagoSmodifw, lxPagoBdaltafw, lxPagoEsttrans, lxPagoBdmodifw, lxPagoOpago, lxPagoFletra, lxPagoFperson, lxPagoFptoven, lxPagoMoneda, lxPagoFopobs, lxPagoFfch, lxPagoFnumcomp, lxPagoFechap, lxPagoCotiz, lxPagoRecibo, lxPagoFtotal, lxPagoAnulado, lxPagoFobs, lxPagoCodigo
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PAGO ( "Faltafw","Fectrans","Fecexpo","Fmodifw","Fecimpo","Facttipo","Timestamp","Haltafw","Vmodifw","Horaexpo","Zadsfw","Hmodifw","Umodifw","Ualtafw","Saltafw","Valtafw","Horaimpo","Smodifw","Bdaltafw","Esttrans","Bdmodifw","Opago","Fletra","Fperson","Fptoven","Moneda","Fopobs","Ffch","Fnumcomp","Fechap","Cotiz","Recibo","Ftotal","Anulado","Fobs","Codigo" ) values ( <<"'" + this.ConvertirDateSql( lxPagoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPagoFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPagoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPagoFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPagoFecimpo ) + "'" >>, <<lxPagoFacttipo >>, <<lxPagoTimestamp >>, <<"'" + this.FormatearTextoSql( lxPagoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoOpago ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoFperson ) + "'" >>, <<lxPagoFptoven >>, <<"'" + this.FormatearTextoSql( lxPagoMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoFopobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPagoFfch ) + "'" >>, <<lxPagoFnumcomp >>, <<"'" + this.ConvertirDateSql( lxPagoFechap ) + "'" >>, <<lxPagoCotiz >>, <<"'" + this.FormatearTextoSql( lxPagoRecibo ) + "'" >>, <<lxPagoFtotal >>, <<iif( lxPagoAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxPagoFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPagoCodigo ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.OrdenDePago_PagoDetalle
				if this.oEntidad.OrdenDePago_PagoDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.PagoDet("Fecha","IdCaja","Rtipo","Numafec","NROITEM","PtoAfec","lPagoACta","CodComp","Tipo","LetraAfec","RVal","CODIGO","FecEmi","RFecVen","Descrip","SaldoAux","RMonto","anotacion" ) values ( <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<lxCaja_PK>>, <<lxTipo>>, <<lxNumerodecomprobante>>, <<lxNroitem>>, <<lxPuntodeventa>>, <<iif( lxEspagoacuenta, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxCodigocomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodecomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxLetra ) + "'">>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.ConvertirDateSql( lxEmision ) + "'">>, <<"'" + this.ConvertirDateSql( lxVencimiento ) + "'">>, <<"'" + this.FormatearTextoSql( lxDescripcion ) + "'">>, <<lxSaldoaux>>, <<lxMonto>>, <<"'" + this.FormatearTextoSql( lxAnotacion ) + "'">> ) 
					endtext
			...
			for each loItem in this.oEntidad.OrdenDePago_ValoresDetalle
				if this.oEntidad.OrdenDePago_ValoresDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.PagoVal("JJfecha","FechCoti","IdCaja","JJT","Signo","PtoVenta","JJTurno","NumCompr","NroItem","Pesos","NroCupon","JJCotiz","Cotiza","CElectro","VisualCaja","PersComp","TIPCOMP","Letra","NroDoc","NroTarjeta","TipoDoc","JJVen","JJCO","NroChProp","NroCheque","JJNUM","JJDE","JJFE","NroInterno","JJM","jrecporc","jrecmnt","JJTotFac","jrecmntsi","jrrecsperc","permvuelto","guidComp","ValeCambio" ) values ( <<"'" + this.ConvertirDateSql( lxFechacomp ) + "'">>, <<"'" + this.ConvertirDateSql( lxFechaultcotizacion ) + "'">>, <<lxCaja_PK>>, <<lxTipo>>, <<lxSigno>>, <<lxPuntodeventa>>, <<lxTurno>>, <<lxNumerodecomprobante>>, <<lxNroitem>>, <<lxPesosalcambio>>, <<lxNumerocupon>>, <<lxCotiza>>, <<lxUltimacotizacion>>, <<iif( lxChequeelectronico, 1, 0 )>>, <<iif( lxVisualizarenestadodecaja, 1, 0 )>>, <<iif( lxPersonalizarcomprobante, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxTipodecomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxLetra ) + "'">>, <<"'" + this.FormatearTextoSql( lxNrodocumento ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerotarjeta ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodocumento ) + "'">>, <<"'" + this.FormatearTextoSql( lxVendedor ) + "'">>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerochequepropio_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerocheque_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxValordetalle ) + "'">>, <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerointerno ) + "'">>, <<lxMonto>>, <<lxRecargoporcentaje>>, <<lxRecargomonto>>, <<lxTotal>>, <<lxRecargomontosinimpuestos>>, <<lxRecargosinpercepciones>>, <<iif( lxPermitevuelto, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxIditemcomponente ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerovaledecambio_PK ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.PAGO set "Faltafw" = <<"'" + this.ConvertirDateSql( lxPagoFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxPagoFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxPagoFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxPagoFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxPagoFecimpo ) + "'">>,"Facttipo" = <<lxPagoFacttipo>>,"Timestamp" = <<lxPagoTimestamp>>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxPagoHaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxPagoVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxPagoHoraexpo ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxPagoZadsfw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxPagoHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxPagoUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxPagoUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxPagoSaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxPagoValtafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxPagoHoraimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxPagoSmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPagoBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxPagoEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPagoBdmodifw ) + "'">>,"Opago" = <<"'" + this.FormatearTextoSql( lxPagoOpago ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxPagoFletra ) + "'">>,"Fperson" = <<"'" + this.FormatearTextoSql( lxPagoFperson ) + "'">>,"Fptoven" = <<lxPagoFptoven>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxPagoMoneda ) + "'">>,"Fopobs" = <<"'" + this.FormatearTextoSql( lxPagoFopobs ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxPagoFfch ) + "'">>,"Fnumcomp" = <<lxPagoFnumcomp>>,"Fechap" = <<"'" + this.ConvertirDateSql( lxPagoFechap ) + "'">>,"Cotiz" = <<lxPagoCotiz>>,"Recibo" = <<"'" + this.FormatearTextoSql( lxPagoRecibo ) + "'">>,"Ftotal" = <<lxPagoFtotal>>,"Anulado" = <<iif( lxPagoAnulado, 1, 0 )>>,"Fobs" = <<"'" + this.FormatearTextoSql( lxPagoFobs ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxPagoCodigo ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxPagoCodigo ) + "'">> and  PAGO.CODIGO != '' AND PAGO.FACTTIPO = 37 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Opago" as "Ordendepago", "Fletra" as "Letra", "Fperson" as "Ordendepago_proveedor", "Fptoven" as "Puntodeventa", "Moneda" as "Ordendepago_monedacomprobante", "Fopobs" as "Ordendepago_obs", "Ffch" as "Ordendepago_fecha", "Fnumcomp" as "Numero", "Fechap" as "Fecha", "Cotiz" as "Ordendepago_cotizacion", "Recibo" as "Recibo", "Ftotal" as "Ordendepago_total", "Anulado" as "Anulado", "Fobs" as "Obs", "Codigo" as "Codigo" from ZooLogic.PAGO where "Codigo" = <<"'" + this.FormatearTextoSql( lxPagoCodigo ) + "'">> and  PAGO.CODIGO != '' AND PAGO.FACTTIPO = 37
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Fecha" as "Fecha", "Idcaja" as "Caja", "Rtipo" as "Tipo", "Numafec" as "Numerodecomprobante", "Nroitem" as "Nroitem", "Ptoafec" as "Puntodeventa", "Lpagoacta" as "Espagoacuenta", "Codcomp" as "Codigocomprobante", "Tipo" as "Tipodecomprobante", "Letraafec" as "Letra", "Rval" as "Valor", "Codigo" as "Codigo", "Fecemi" as "Emision", "Rfecven" as "Vencimiento", "Descrip" as "Descripcion", "Saldoaux" as "Saldoaux", "Rmonto" as "Monto", "Anotacion" as "Anotacion" from ZooLogic.PagoDet where CODIGO = <<"'" + this.FormatearTextoSql( c_PAGO.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Jjfecha" as "Fechacomp", "Fechcoti" as "Fechaultcotizacion", "Idcaja" as "Caja", "Jjt" as "Tipo", "Signo" as "Signo", "Ptoventa" as "Puntodeventa", "Jjturno" as "Turno", "Numcompr" as "Numerodecomprobante", "Nroitem" as "Nroitem", "Pesos" as "Pesosalcambio", "Nrocupon" as "Numerocupon", "Jjcotiz" as "Cotiza", "Cotiza" as "Ultimacotizacion", "Celectro" as "Chequeelectronico", "Visualcaja" as "Visualizarenestadodecaja", "Perscomp" as "Personalizarcomprobante", "Tipcomp" as "Tipodecomprobante", "Letra" as "Letra", "Nrodoc" as "Nrodocumento", "Nrotarjeta" as "Numerotarjeta", "Tipodoc" as "Tipodocumento", "Jjven" as "Vendedor", "Jjco" as "Valor", "Nrochprop" as "Numerochequepropio", "Nrocheque" as "Numerocheque", "Jjnum" as "Codigo", "Jjde" as "Valordetalle", "Jjfe" as "Fecha", "Nrointerno" as "Numerointerno", "Jjm" as "Monto", "Jrecporc" as "Recargoporcentaje", "Jrecmnt" as "Recargomonto", "Jjtotfac" as "Total", "Jrecmntsi" as "Recargomontosinimpuestos", "Jrrecsperc" as "Recargosinpercepciones", "Permvuelto" as "Permitevuelto", "Guidcomp" as "Iditemcomponente", "Valecambio" as "Numerovaledecambio" from ZooLogic.PagoVal where JJNUM = <<"'" + this.FormatearTextoSql( c_PAGO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Opago" as "Ordendepago", "Fletra" as "Letra", "Fperson" as "Ordendepago_proveedor", "Fptoven" as "Puntodeventa", "Moneda" as "Ordendepago_monedacomprobante", "Fopobs" as "Ordendepago_obs", "Ffch" as "Ordendepago_fecha", "Fnumcomp" as "Numero", "Fechap" as "Fecha", "Cotiz" as "Ordendepago_cotizacion", "Recibo" as "Recibo", "Ftotal" as "Ordendepago_total", "Anulado" as "Anulado", "Fobs" as "Obs", "Codigo" as "Codigo" from ZooLogic.PAGO where  PAGO.CODIGO != '' AND PAGO.FACTTIPO = 37 And FACTTIPO = <<lxPagoFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxPagoFLETRA ) + "'">> and FPTOVEN = <<lxPagoFPTOVEN>> and FNUMCOMP = <<lxPagoFNUMCOMP>>
			endtext
			use in select('c_PAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PAGO', set( 'Datasession' ) )
			if reccount( 'c_PAGO' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Opago" as "Ordendepago", "Fletra" as "Letra", "Fperson" as "Ordendepago_proveedor", "Fptoven" as "Puntodeventa", "Moneda" as "Ordendepago_monedacomprobante", "Fopobs" as "Ordendepago_obs", "Ffch" as "Ordendepago_fecha", "Fnumcomp" as "Numero", "Fechap" as "Fecha", "Cotiz" as "Ordendepago_cotizacion", "Recibo" as "Recibo", "Ftotal" as "Ordendepago_total", "Anulado" as "Anulado", "Fobs" as "Obs", "Codigo" as "Codigo" from ZooLogic.PAGO where  PAGO.CODIGO != '' AND PAGO.FACTTIPO = 37 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP
			endtext
			use in select('c_PAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PAGO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Opago" as "Ordendepago", "Fletra" as "Letra", "Fperson" as "Ordendepago_proveedor", "Fptoven" as "Puntodeventa", "Moneda" as "Ordendepago_monedacomprobante", "Fopobs" as "Ordendepago_obs", "Ffch" as "Ordendepago_fecha", "Fnumcomp" as "Numero", "Fechap" as "Fecha", "Cotiz" as "Ordendepago_cotizacion", "Recibo" as "Recibo", "Ftotal" as "Ordendepago_total", "Anulado" as "Anulado", "Fobs" as "Obs", "Codigo" as "Codigo" from ZooLogic.PAGO where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 10, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PAGO.CODIGO != '' AND PAGO.FACTTIPO = 37 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP
			endtext
			use in select('c_PAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PAGO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Opago" as "Ordendepago", "Fletra" as "Letra", "Fperson" as "Ordendepago_proveedor", "Fptoven" as "Puntodeventa", "Moneda" as "Ordendepago_monedacomprobante", "Fopobs" as "Ordendepago_obs", "Ffch" as "Ordendepago_fecha", "Fnumcomp" as "Numero", "Fechap" as "Fecha", "Cotiz" as "Ordendepago_cotizacion", "Recibo" as "Recibo", "Ftotal" as "Ordendepago_total", "Anulado" as "Anulado", "Fobs" as "Obs", "Codigo" as "Codigo" from ZooLogic.PAGO where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 10, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PAGO.CODIGO != '' AND PAGO.FACTTIPO = 37 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc
			endtext
			use in select('c_PAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PAGO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Opago" as "Ordendepago", "Fletra" as "Letra", "Fperson" as "Ordendepago_proveedor", "Fptoven" as "Puntodeventa", "Moneda" as "Ordendepago_monedacomprobante", "Fopobs" as "Ordendepago_obs", "Ffch" as "Ordendepago_fecha", "Fnumcomp" as "Numero", "Fechap" as "Fecha", "Cotiz" as "Ordendepago_cotizacion", "Recibo" as "Recibo", "Ftotal" as "Ordendepago_total", "Anulado" as "Anulado", "Fobs" as "Obs", "Codigo" as "Codigo" from ZooLogic.PAGO where  PAGO.CODIGO != '' AND PAGO.FACTTIPO = 37 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc
			endtext
			use in select('c_PAGO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PAGO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Faltafw,Fectrans,Fecexpo,Fmodifw,Fecimpo,Facttipo,Timestamp,Haltafw,Vmodifw,Horaexpo,Zadsfw," + ;
"Hmodifw,Umodifw,Ualtafw,Saltafw,Valtafw,Horaimpo,Smodifw,Bdaltafw,Esttrans,Bdmodifw,Opago,Fletra,Fpe" + ;
"rson,Fptoven,Moneda,Fopobs,Ffch,Fnumcomp,Fechap,Cotiz,Recibo,Ftotal,Anulado,Fobs,Codigo" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Facttipo" as "Tipocomprobante", "Timestamp" as "Timestamp", "Haltafw" as "Horaaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Opago" as "Ordendepago", "Fletra" as "Letra", "Fperson" as "Ordendepago_proveedor", "Fptoven" as "Puntodeventa", "Moneda" as "Ordendepago_monedacomprobante", "Fopobs" as "Ordendepago_obs", "Ffch" as "Ordendepago_fecha", "Fnumcomp" as "Numero", "Fechap" as "Fecha", "Cotiz" as "Ordendepago_cotizacion", "Recibo" as "Recibo", "Ftotal" as "Ordendepago_total", "Anulado" as "Anulado", "Fobs" as "Obs", "Codigo" as "Codigo"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleOrdenDePago_PagoDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecha" as "Fecha", "Idcaja" as "Caja", "Rtipo" as "Tipo", "Numafec" as "Numerodecomprobante", "Nroitem" as "Nroitem", "Ptoafec" as "Puntodeventa", "Lpagoacta" as "Espagoacuenta", "Codcomp" as "Codigocomprobante", "Tipo" as "Tipodecomprobante", "Letraafec" as "Letra", "Rval" as "Valor", "Codigo" as "Codigo", "Fecemi" as "Emision", "Rfecven" as "Vencimiento", "Descrip" as "Descripcion", "Saldoaux" as "Saldoaux", "Rmonto" as "Monto", "Anotacion" as "Anotacion"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleOrdenDePago_ValoresDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Jjfecha" as "Fechacomp", "Fechcoti" as "Fechaultcotizacion", "Idcaja" as "Caja", "Jjt" as "Tipo", "Signo" as "Signo", "Ptoventa" as "Puntodeventa", "Jjturno" as "Turno", "Numcompr" as "Numerodecomprobante", "Nroitem" as "Nroitem", "Pesos" as "Pesosalcambio", "Nrocupon" as "Numerocupon", "Jjcotiz" as "Cotiza", "Cotiza" as "Ultimacotizacion", "Celectro" as "Chequeelectronico", "Visualcaja" as "Visualizarenestadodecaja", "Perscomp" as "Personalizarcomprobante", "Tipcomp" as "Tipodecomprobante", "Letra" as "Letra", "Nrodoc" as "Nrodocumento", "Nrotarjeta" as "Numerotarjeta", "Tipodoc" as "Tipodocumento", "Jjven" as "Vendedor", "Jjco" as "Valor", "Nrochprop" as "Numerochequepropio", "Nrocheque" as "Numerocheque", "Jjnum" as "Codigo", "Jjde" as "Valordetalle", "Jjfe" as "Fecha", "Nrointerno" as "Numerointerno", "Jjm" as "Monto", "Jrecporc" as "Recargoporcentaje", "Jrecmnt" as "Recargomonto", "Jjtotfac" as "Total", "Jrecmntsi" as "Recargomontosinimpuestos", "Jrrecsperc" as "Recargosinpercepciones", "Permvuelto" as "Permitevuelto", "Guidcomp" as "Iditemcomponente", "Valecambio" as "Numerovaledecambio"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.OrdenDePago_PagoDetalle
				if this.oEntidad.OrdenDePago_PagoDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAnotacion = loItem.Anotacion
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.PagoDet("Fecha","IdCaja","Rtipo","Numafec","NROITEM","PtoAfec","lPagoACta","CodComp","Tipo","LetraAfec","RVal","CODIGO","FecEmi","RFecVen","Descrip","SaldoAux","RMonto","anotacion" ) values ( <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<lxCaja_PK>>, <<lxTipo>>, <<lxNumerodecomprobante>>, <<lxNroitem>>, <<lxPuntodeventa>>, <<iif( lxEspagoacuenta, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxCodigocomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodecomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxLetra ) + "'">>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.ConvertirDateSql( lxEmision ) + "'">>, <<"'" + this.ConvertirDateSql( lxVencimiento ) + "'">>, <<"'" + this.FormatearTextoSql( lxDescripcion ) + "'">>, <<lxSaldoaux>>, <<lxMonto>>, <<"'" + this.FormatearTextoSql( lxAnotacion ) + "'">> ) 
					endtext
			...
			for each loItem in this.oEntidad.OrdenDePago_ValoresDetalle
				if this.oEntidad.OrdenDePago_ValoresDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxNumerovaledecambio_PK = loItem.Numerovaledecambio_PK
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.PagoVal("JJfecha","FechCoti","IdCaja","JJT","Signo","PtoVenta","JJTurno","NumCompr","NroItem","Pesos","NroCupon","JJCotiz","Cotiza","CElectro","VisualCaja","PersComp","TIPCOMP","Letra","NroDoc","NroTarjeta","TipoDoc","JJVen","JJCO","NroChProp","NroCheque","JJNUM","JJDE","JJFE","NroInterno","JJM","jrecporc","jrecmnt","JJTotFac","jrecmntsi","jrrecsperc","permvuelto","guidComp","ValeCambio" ) values ( <<"'" + this.ConvertirDateSql( lxFechacomp ) + "'">>, <<"'" + this.ConvertirDateSql( lxFechaultcotizacion ) + "'">>, <<lxCaja_PK>>, <<lxTipo>>, <<lxSigno>>, <<lxPuntodeventa>>, <<lxTurno>>, <<lxNumerodecomprobante>>, <<lxNroitem>>, <<lxPesosalcambio>>, <<lxNumerocupon>>, <<lxCotiza>>, <<lxUltimacotizacion>>, <<iif( lxChequeelectronico, 1, 0 )>>, <<iif( lxVisualizarenestadodecaja, 1, 0 )>>, <<iif( lxPersonalizarcomprobante, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxTipodecomprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxLetra ) + "'">>, <<"'" + this.FormatearTextoSql( lxNrodocumento ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerotarjeta ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodocumento ) + "'">>, <<"'" + this.FormatearTextoSql( lxVendedor ) + "'">>, <<"'" + this.FormatearTextoSql( lxValor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerochequepropio_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerocheque_PK ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxValordetalle ) + "'">>, <<"'" + this.ConvertirDateSql( lxFecha ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerointerno ) + "'">>, <<lxMonto>>, <<lxRecargoporcentaje>>, <<lxRecargomonto>>, <<lxTotal>>, <<lxRecargomontosinimpuestos>>, <<lxRecargosinpercepciones>>, <<iif( lxPermitevuelto, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxIditemcomponente ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerovaledecambio_PK ) + "'">> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.PAGO set  FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, OPago = ] + "'" + this.FormatearTextoSql( &lcCursor..OPago ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, FOPObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FOPObs ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FechaP = ] + "'" + this.ConvertirDateSql( &lcCursor..FechaP ) + "'"+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, Recibo = ] + "'" + this.FormatearTextoSql( &lcCursor..Recibo ) + "'"+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, FOBS = ] + "'" + this.FormatearTextoSql( &lcCursor..FOBS ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FALTAFW, FECTRANS, FECEXPO, FMODIFW, FECIMPO, FACTTIPO, TIMESTAMP, HALTAFW, VMODIFW, HORAEXPO, ZADSFW, HMODIFW, UMODIFW, UALTAFW, SALTAFW, VALTAFW, HORAIMPO, SMODIFW, BDALTAFW, ESTTRANS, BDMODIFW, OPago, FLETRA, FPerson, FPTOVEN, Moneda, FOPObs, FFCH, FNUMCOMP, FechaP, Cotiz, Recibo, FTotal, Anulado, FOBS, CODIGO
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPago ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..FPTOVEN ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FOPObs ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaP ) + "'" + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Recibo ) + "'" + ',' + transform( &lcCursor..FTotal ) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FOBS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"JJfecha","FechCoti","IdCaja","JJT","Signo","PtoVenta","JJTurno","NumCompr","NroItem","Pesos","NroCupon","JJCotiz","Cotiza","CElectro","VisualCaja","PersComp","TIPCOMP","Letra","NroDoc","NroTarjeta","TipoDoc","JJVen","JJCO","NroChProp","NroCheque","JJNUM","JJDE","JJFE","NroInterno","JJM","jrecporc","jrecmnt","JJTotFac","jrecmntsi","jrrecsperc","permvuelto","guidComp","ValeCambio"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.PagoVal ( ] + lcCamposInsert + [ ) values ( ] +  "'" + this.ConvertirDateSql( cDetallesExistentes.JJfecha    ) + "'" + ',' + "'" + this.ConvertirDateSql( cDetallesExistentes.FechCoti   ) + "'" + ',' + transform( cDetallesExistentes.IdCaja     ) + ',' + transform( cDetallesExistentes.JJT        ) + ',' + transform( cDetallesExistentes.Signo      ) + ',' + transform( cDetallesExistentes.PtoVenta   ) + ',' + transform( cDetallesExistentes.JJTurno    ) + ',' + transform( cDetallesExistentes.NumCompr   ) + ',' + transform( cDetallesExistentes.NroItem    ) + ',' + transform( cDetallesExistentes.Pesos      ) + ',' + transform( cDetallesExistentes.NroCupon   ) + ',' + transform( cDetallesExistentes.JJCotiz    ) + ',' + transform( cDetallesExistentes.Cotiza     ) + ',' + Transform( iif( cDetallesExistentes.CElectro  , 1, 0 )) + ',' + Transform( iif( cDetallesExistentes.VisualCaja, 1, 0 )) + ',' + Transform( iif( cDetallesExistentes.PersComp  , 1, 0 )) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.TIPCOMP    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Letra      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NroDoc     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NroTarjeta ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.TipoDoc    ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.JJVen      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.JJCO       ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NroChProp  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NroCheque  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.JJNUM      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.JJDE       ) + "'" + ',' + "'" + this.ConvertirDateSql( cDetallesExistentes.JJFE       ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.NroInterno ) + "'" + ',' + transform( cDetallesExistentes.JJM        ) + ',' + transform( cDetallesExistentes.jrecporc   ) + ',' + transform( cDetallesExistentes.jrecmnt    ) + ',' + transform( cDetallesExistentes.JJTotFac   ) + ',' + transform( cDetallesExistentes.jrecmntsi  ) + ',' + transform( cDetallesExistentes.jrrecsperc ) + ',' + Transform( iif( cDetallesExistentes.permvuelto, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.guidComp   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ValeCambio ) + "'" + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.OPAGO = isnull( d.OPAGO, t.OPAGO ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FOPOBS = isnull( d.FOPOBS, t.FOPOBS ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FECHAP = isnull( d.FECHAP, t.FECHAP ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.RECIBO = isnull( d.RECIBO, t.RECIBO ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO )
				...
				-- Fin Updates
				insert into ZooLogic.PAGO(Faltafw,Fectrans,Fecexpo,Fmodifw,Fecimpo,Facttipo,Timestamp,Haltafw,Vmodifw,Horaexpo,Zadsfw,Hmodifw,Umodifw,Ualtafw,Saltafw,Valtafw,Horaimpo,Smodifw,Bdaltafw,Esttrans,Bdmodifw,Opago,Fletra,Fperson,Fptoven,Moneda,Fopobs,Ffch,Fnumcomp,Fechap,Cotiz,Recibo,Ftotal,Anulado,Fobs,Codigo)
					Select CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FACTTIPO,0),isnull( d.TIMESTAMP,0),convert( char(8), getdate(), 108 ),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.ZADSFW,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.VALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.SMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.OPAGO,''),isnull( d.FLETRA,''),isnull( d.FPERSON,''),isnull( d.FPTOVEN,0),isnull( d.MONEDA,''),isnull( d.FOPOBS,''),isnull( d.FFCH,''),isnull( d.FNUMCOMP,0),isnull( d.FECHAP,''),isnull( d.COTIZ,0),isnull( d.RECIBO,''),isnull( d.FTOTAL,0),isnull( d.ANULADO,0),isnull( d.FOBS,''),isnull( d.CODIGO,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="PAGO                                    " atributo="FECHATRANSFERENCIA                      " tabla="PAGO           " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAGO                                    " atributo="TIPOCOMPROBANTE                         " tabla="PAGO           " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=37                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="0" etiqueta="Tipo de comprobante                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAGO                                    " atributo="HORAALTAFW                              " tabla="PAGO           " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAGO                                    " atributo="ESTADOTRANSFERENCIA                     " tabla="PAGO           " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAGO                                    " atributo="ORDENDEPAGO_MONEDACOMPROBANTE           " tabla="PAGO           " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Moneda                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="OrdendePago.MonedaComprobante                                                                                                                                                                                                                                 " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAGO                                    " atributo="ORDENDEPAGO_OBS                         " tabla="PAGO           " campo="FOPOBS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Obs. orden de pago                                                                                                                                              " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="OrdendePago.Obs                                                                                                                                                                                                                                               " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="2" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAGO                                    " atributo="ORDENDEPAGO_FECHA                       " tabla="PAGO           " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Fecha                                                                                                                                                           " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="OrdendePago.Fecha                                                                                                                                                                                                                                             " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAGO                                    " atributo="NUMERO                                  " tabla="PAGO           " campo="FNUMCOMP  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Número                                                                                                                                                          " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="4" mascara="X 9999-9999999999        " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAGO                                    " atributo="FECHA                                   " tabla="PAGO           " campo="FECHAP    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=GOLIBRERIAS.OBTENERFECHA()                                                                                                                                                                                                                                   " obligatorio="true" admitebusqueda="416" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAGO                                    " atributo="ORDENDEPAGO_COTIZACION                  " tabla="PAGO           " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Cotización                                                                                                                                                      " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="OrdendePago.Cotizacion                                                                                                                                                                                                                                        " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAGO                                    " atributo="RECIBO                                  " tabla="PAGO           " campo="RECIBO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Recibo                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAGO                                    " atributo="ORDENDEPAGO_TOTAL                       " tabla="PAGO           " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Total                                                                                                                                                           " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="OrdendePago.Total                                                                                                                                                                                                                                             " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PAGO                                    " atributo="OBS                                     " tabla="PAGO           " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Obs.                                                                                                                                                            " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="13" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PROVEEDOR                               " atributo="NOMBRE                                  " tabla="PROVEED        " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="409" etiqueta="Detalle Pro.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join PROVEED On PAGO.FPERSON = PROVEED.CLCOD And  PROVEED.CLCOD != ''                                                                                                                                                                                   " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
