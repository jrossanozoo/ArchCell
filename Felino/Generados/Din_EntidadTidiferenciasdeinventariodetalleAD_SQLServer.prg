	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TIDIFINVDET ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Horaexpo","Saltafw","Horaimpo","Ualtafw","Haltafw","Smodifw","Hmodifw","Vmodifw","Bdaltafw","Zadsfw","Bdmodifw","Valtafw","Umodifw","Esttrans","Rechazado","Codigo","Mart","Mcolo","Mtall","Diferencia","Idcabecera","Mobs","Tipo" ) values ( <<"'" + this.ConvertirDateSql( lxTidifinvdetFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvdetFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvdetFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvdetFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvdetFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetEsttrans ) + "'" >>, <<iif( lxTidifinvdetRechazado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetMart ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetMcolo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetMtall ) + "'" >>, <<lxTidifinvdetDiferencia >>, <<lxTidifinvdetIdcabecera >>, <<"'" + this.FormatearTextoSql( lxTidifinvdetMobs ) + "'" >>, <<lxTidifinvdetTipo >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TIDIFINVDET set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFecexpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetUaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetVmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetBdaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetZadsfw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetBdmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetUmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTidifinvdetEsttrans ) + "'">>,"Rechazado" = <<iif( lxTidifinvdetRechazado, 1, 0 )>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetCodigo ) + "'">>,"Mart" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMart ) + "'">>,"Mcolo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMcolo ) + "'">>,"Mtall" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMtall ) + "'">>,"Diferencia" = <<lxTidifinvdetDiferencia>>,"Idcabecera" = <<lxTidifinvdetIdcabecera>>,"Mobs" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMobs ) + "'">>,"Tipo" = <<lxTidifinvdetTipo>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetCodigo ) + "'">> and  TIDIFINVDET.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Numero" as "Numero", "Rechazado" as "Rechazado", "Codigo" as "Codigo", "Mart" as "Articulo", "Mcolo" as "Color", "Mtall" as "Talle", "Diferencia" as "Diferencia", "Idcabecera" as "Idcabecera", "Mobs" as "Obs", "Tipo" as "Tipo" from ZooLogic.TIDIFINVDET where "Codigo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetCodigo ) + "'">> and  TIDIFINVDET.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Numero" as "Numero", "Rechazado" as "Rechazado", "Codigo" as "Codigo", "Mart" as "Articulo", "Mcolo" as "Color", "Mtall" as "Talle", "Diferencia" as "Diferencia", "Idcabecera" as "Idcabecera", "Mobs" as "Obs", "Tipo" as "Tipo" from ZooLogic.TIDIFINVDET where  TIDIFINVDET.CODIGO != '' And Numero = <<lxTIDifInvDetNumero>>
			endtext
			use in select('c_TIDIFERENCIASDEINVENTARIODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIDIFERENCIASDEINVENTARIODETALLE', set( 'Datasession' ) )
			if reccount( 'c_TIDIFERENCIASDEINVENTARIODETALLE' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Numero" as "Numero", "Rechazado" as "Rechazado", "Codigo" as "Codigo", "Mart" as "Articulo", "Mcolo" as "Color", "Mtall" as "Talle", "Diferencia" as "Diferencia", "Idcabecera" as "Idcabecera", "Mobs" as "Obs", "Tipo" as "Tipo" from ZooLogic.TIDIFINVDET where  TIDIFINVDET.CODIGO != '' order by Numero
			endtext
			use in select('c_TIDIFERENCIASDEINVENTARIODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIDIFERENCIASDEINVENTARIODETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Numero" as "Numero", "Rechazado" as "Rechazado", "Codigo" as "Codigo", "Mart" as "Articulo", "Mcolo" as "Color", "Mtall" as "Talle", "Diferencia" as "Diferencia", "Idcabecera" as "Idcabecera", "Mobs" as "Obs", "Tipo" as "Tipo" from ZooLogic.TIDIFINVDET where  str( Numero, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIDIFINVDET.CODIGO != '' order by Numero
			endtext
			use in select('c_TIDIFERENCIASDEINVENTARIODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIDIFERENCIASDEINVENTARIODETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Numero" as "Numero", "Rechazado" as "Rechazado", "Codigo" as "Codigo", "Mart" as "Articulo", "Mcolo" as "Color", "Mtall" as "Talle", "Diferencia" as "Diferencia", "Idcabecera" as "Idcabecera", "Mobs" as "Obs", "Tipo" as "Tipo" from ZooLogic.TIDIFINVDET where  str( Numero, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIDIFINVDET.CODIGO != '' order by Numero desc
			endtext
			use in select('c_TIDIFERENCIASDEINVENTARIODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIDIFERENCIASDEINVENTARIODETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Numero" as "Numero", "Rechazado" as "Rechazado", "Codigo" as "Codigo", "Mart" as "Articulo", "Mcolo" as "Color", "Mtall" as "Talle", "Diferencia" as "Diferencia", "Idcabecera" as "Idcabecera", "Mobs" as "Obs", "Tipo" as "Tipo" from ZooLogic.TIDIFINVDET where  TIDIFINVDET.CODIGO != '' order by Numero desc
			endtext
			use in select('c_TIDIFERENCIASDEINVENTARIODETALLE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIDIFERENCIASDEINVENTARIODETALLE', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Horaexpo,Saltafw,Horaimpo,Ualtafw,Haltafw,Smodifw,H" + ;
"modifw,Vmodifw,Bdaltafw,Zadsfw,Bdmodifw,Valtafw,Umodifw,Esttrans,Numero,Rechazado,Codigo,Mart,Mcolo," + ;
"Mtall,Diferencia,Idcabecera,Mobs,Tipo" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Haltafw" as "Horaaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Numero" as "Numero", "Rechazado" as "Rechazado", "Codigo" as "Codigo", "Mart" as "Articulo", "Mcolo" as "Color", "Mtall" as "Talle", "Diferencia" as "Diferencia", "Idcabecera" as "Idcabecera", "Mobs" as "Obs", "Tipo" as "Tipo"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.TIDIFINVDET set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFaltafw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTidifinvdetFecexpo ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHoraexpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetSaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHoraimpo ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetUaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetHmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetVmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetBdaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetZadsfw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetBdmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvdetUmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxTidifinvdetEsttrans ) + "'">>, "Rechazado" = <<iif( lxTidifinvdetRechazado, 1, 0 )>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetCodigo ) + "'">>, "Mart" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMart ) + "'">>, "Mcolo" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMcolo ) + "'">>, "Mtall" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMtall ) + "'">>, "Diferencia" = <<lxTidifinvdetDiferencia>>, "Idcabecera" = <<lxTidifinvdetIdcabecera>>, "Mobs" = <<"'" + this.FormatearTextoSql( lxTidifinvdetMobs ) + "'">>, "Tipo" = <<lxTidifinvdetTipo>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'TIDIFINVDET' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.CODIGO or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.TIDIFINVDET set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, Rechazado = ] + Transform( iif( &lcCursor..Rechazado, 1, 0 ))+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, MART = ] + "'" + this.FormatearTextoSql( &lcCursor..MART ) + "'"+ [, MCOLO = ] + "'" + this.FormatearTextoSql( &lcCursor..MCOLO ) + "'"+ [, MTALL = ] + "'" + this.FormatearTextoSql( &lcCursor..MTALL ) + "'"+ [, DIFERENCIA = ] + transform( &lcCursor..DIFERENCIA )+ [, IDCABECERA = ] + transform( &lcCursor..IDCABECERA )+ [, MObs = ] + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'"+ [, TIPO = ] + transform( &lcCursor..TIPO ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, HORAEXPO, SALTAFW, HORAIMPO, UALTAFW, HALTAFW, SMODIFW, HMODIFW, VMODIFW, BDALTAFW, ZADSFW, BDMODIFW, VALTAFW, UMODIFW, ESTTRANS, Numero, Rechazado, CODIGO, MART, MCOLO, MTALL, DIFERENCIA, IDCABECERA, MObs, TIPO
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + Transform( iif( &lcCursor..Rechazado, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MART ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MCOLO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MTALL ) + "'" + ',' + transform( &lcCursor..DIFERENCIA ) + ',' + transform( &lcCursor..IDCABECERA ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'" + ',' + transform( &lcCursor..TIPO )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.RECHAZADO = isnull( d.RECHAZADO, t.RECHAZADO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MART = isnull( d.MART, t.MART ),t.MCOLO = isnull( d.MCOLO, t.MCOLO ),t.MTALL = isnull( d.MTALL, t.MTALL ),t.DIFERENCIA = isnull( d.DIFERENCIA, t.DIFERENCIA ),t.IDCABECERA = isnull( d.IDCABECERA, t.IDCABECERA ),t.MOBS = isnull( d.MOBS, t.MOBS ),t.TIPO = isnull( d.TIPO, t.TIPO )
					from ZooLogic.TIDIFINVDET t inner join deleted d 
							 on t.CODIGO = d.CODIGO
							 and  t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.TIDIFINVDET(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Horaexpo,Saltafw,Horaimpo,Ualtafw,Haltafw,Smodifw,Hmodifw,Vmodifw,Bdaltafw,Zadsfw,Bdmodifw,Valtafw,Umodifw,Esttrans,Rechazado,Codigo,Mart,Mcolo,Mtall,Diferencia,Idcabecera,Mobs,Tipo)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ZADSFW,''),isnull( d.BDMODIFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.RECHAZADO,0),isnull( d.CODIGO,''),isnull( d.MART,''),isnull( d.MCOLO,''),isnull( d.MTALL,''),isnull( d.DIFERENCIA,0),isnull( d.IDCABECERA,0),isnull( d.MOBS,''),isnull( d.TIPO,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_TIDIFERENCIASDEINVENTARIODETALLE' ) < 1
				...
				Try
					...
					.Talle = nvl( c_TIDIFERENCIASDEINVENTARIODETALLE.Talle, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIDIFERENCIASDEINVENTARIODETALLE        " atributo="FECHATRANSFERENCIA                      " tabla="TIDIFINVDET    " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIDIFERENCIASDEINVENTARIODETALLE        " atributo="ESTADOTRANSFERENCIA                     " tabla="TIDIFINVDET    " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIDIFERENCIASDEINVENTARIODETALLE        " atributo="NUMERO                                  " tabla="TIDIFINVDET    " campo="NUMERO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="A         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Número                                                                                                                                                          " dominio="CLAVECANDIDATA                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIDIFERENCIASDEINVENTARIODETALLE        " atributo="ARTICULO                                " tabla="TIDIFINVDET    " campo="MART      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Artículo                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; art.astock &lt;= 1 &quot;                                                                                                                                                                                     " grupo="1" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIDIFERENCIASDEINVENTARIODETALLE        " atributo="COLOR                                   " tabla="TIDIFINVDET    " campo="MCOLO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Color                                                                                                                                                           " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIDIFERENCIASDEINVENTARIODETALLE        " atributo="TALLE                                   " tabla="TIDIFINVDET    " campo="MTALL     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Talle                                                                                                                                                           " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIDIFERENCIASDEINVENTARIODETALLE        " atributo="DIFERENCIA                              " tabla="TIDIFINVDET    " campo="DIFERENCIA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Diferencia                                                                                                                                                      " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
