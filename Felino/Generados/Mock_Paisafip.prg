...
define class Mock_paisafip as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetallecuits() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cambiosdetalledetallecuits', lcParametros )
	EndFunc
