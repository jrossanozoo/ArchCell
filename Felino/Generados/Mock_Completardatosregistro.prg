...
define class Mock_completardatosregistro as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Completar datos de cuentas bancartias"                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function actualizarregistros() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalledatosregistros() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalledatosregistros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detalledatosregistros_access() as variant                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDATOSREGISTRO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalledatosregistros_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalledatosregistros_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalledatosregistros ) = 'O' or isnull( this.Detalledatosregistros ) )			this.Detalledatosregistros = this.crearobjeto( 'Din_DetalleCompletardatosregistroDetalledatosregistros' )			this.Detalledatosregistros.inicializar()			this.enlazar( 'Detalledatosregistros.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalledatosregistros.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalledatosregistros, 'CambioSumarizado', this, 'CambiosDetalleDetalledatosregistros', 1)			this.enlazar( 'Detalledatosregistros.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalledatosregistros.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Detalledatosregistros
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentencias() as void                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenersentencias', lcParametros )
	EndFunc
