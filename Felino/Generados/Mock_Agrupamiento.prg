...
define class Mock_agrupamiento as MockBase of MockBase.prg
	...
	AgrupamientoDetalle = null                                                                                                                                                                                                                                
	BASEDEDATOSALTAFW = ""                                                                                                                                                                                                                                    
	BASEDEDATOSMODIFICACIONFW = ""                                                                                                                                                                                                                            
	BaseDeDatosDetalle = null                                                                                                                                                                                                                                 
	BloquearRegistro = .f.                                                                                                                                                                                                                                    
	...
	cCursorAgrup = ""                                                                                                                                                                                                                                         
	cCursorBase = ""                                                                                                                                                                                                                                          
	cDescripcion =  "Agrupamientos de Bases de Datos"                                                                                                                                                                                                         
	...
	*-----------------------------------------------------------------------------------------
	function agrupamientodetalle_access() as variant                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AGRUPAMIENTO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'agrupamientodetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'agrupamientodetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Agrupamientodetalle ) = 'O' or isnull( this.Agrupamientodetalle ) )			this.Agrupamientodetalle = this.crearobjeto( 'Din_DetalleAgrupamientoAgrupamientodetalle' )			this.Agrupamientodetalle.inicializar()			this.enlazar( 'Agrupamientodetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Agrupamientodetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Agrupamientodetalle, 'CambioSumarizado', this, 'CambiosDetalleAgrupamientodetalle', 1)			this.enlazar( 'Agrupamientodetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Agrupamientodetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Agrupamientodetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function basededatosdetalle_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AGRUPAMIENTO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'basededatosdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'basededatosdetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Basededatosdetalle ) = 'O' or isnull( this.Basededatosdetalle ) )			this.Basededatosdetalle = this.crearobjeto( 'Din_DetalleAgrupamientoBasededatosdetalle' )			this.Basededatosdetalle.inicializar()			this.enlazar( 'Basededatosdetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Basededatosdetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Basededatosdetalle, 'CambioSumarizado', this, 'CambiosDetalleBasededatosdetalle', 1)			this.enlazar( 'Basededatosdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Basededatosdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Basededatosdetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleagrupamientodetalle() as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleagrupamientodetalle', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallebasededatosdetalle() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallebasededatosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escentralizado() as boolean                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Escentralizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventotieneestadobusqueda() as boolean                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventotieneestadobusqueda', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function finalizovalidar() as void                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Finalizovalidar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbasesdedatos( tcagrupamiento as string ) as string                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function registrocargado() as void                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Registrocargado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function registronuevo() as void                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Registronuevo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function recorrerbasededatosdetalle( toagrupamientos as object ) as void                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Recorrerbasededatosdetalle', lcParametros )
	EndFunc
