...
define class Mock_tratamientocomprobantes as MockBase of MockBase.prg
	...
	cClase = 'tratamientocomprobantes'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Tratamiento de comprobantes fiscales"                                                                                                                                                                                                    
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'TRATAMIENTOCOMPROBANTES'                                                                                                                                                                                                                       
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	cSecuencia = ""                                                                                                                                                                                                                                           
	...
	lAnular = .f.                                                                                                                                                                                                                                             
	lAplicarTratamientoConLetraEnBlanco = .t.                                                                                                                                                                                                                 
	lBuscandoCodigo = .f.                                                                                                                                                                                                                                     
	lCargando = .f.                                                                                                                                                                                                                                           
	...
	oColaboradorReimpresion = null                                                                                                                                                                                                                            
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oComportamientoCodigoSugerido = null                                                                                                                                                                                                                      
	oComprobantes = null                                                                                                                                                                                                                                      
	oCorrectoresTalonario = null                                                                                                                                                                                                                              
	oExtension = null                                                                                                                                                                                                                                         
	oGeneradores = null                                                                                                                                                                                                                                       
	oGestorDeMail = null                                                                                                                                                                                                                                      
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	oManagerTratamientoComprobantes = null                                                                                                                                                                                                                    
	oMensaje = null                                                                                                                                                                                                                                           
	oNumeraciones =  null                                                                                                                                                                                                                                     
	oObservadoresDeImportacion = null                                                                                                                                                                                                                         
	oProveedorAtributosAnulacion = null                                                                                                                                                                                                                       
	oProveedorletrafiscal = null                                                                                                                                                                                                                              
	oRegistrosDeActividadesAlGrabar = Null                                                                                                                                                                                                                    
	oRenderRangoComprobantes = null                                                                                                                                                                                                                           
	oTalle = null                                                                                                                                                                                                                                             
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarporletraenblanco() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntarporletraenblanco', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numerodesde_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numerodesde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numerodesde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numerodesde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numerodesde( lxVal )				this.Setear_Numerodesde( lxVal )			EndIf		Else			This.Setear_Numerodesde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function numerohasta_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numerohasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numerohasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numerohasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numerohasta( lxVal )				this.Setear_Numerohasta( lxVal )			EndIf		Else			This.Setear_Numerohasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oad_access() as variant                                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oad_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oad_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oAD ) = 'O' or isnull( this.oAD ) )			this.oAD = this.crearobjeto( 'Din_EntidadTRATAMIENTOCOMPROBANTESAD_' + alltrim( _screen.zoo.app.TipoDeBase ))			this.oAD.InyectarEntidad( this )			this.oAD.Inicializar()		endif		return this.oAD
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorreimpresion_access() as void                                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorreimpresion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorreimpresion_access', lcParametros )			endif		endif		if !this.ldestroy and ( vartype( this.oColaboradorReimpresion ) != "O" or isnull( this.oColaboradorReimpresion ) )			this.oColaboradorReimpresion = newobject( "ColaboradorReimpresionComprobantesFiscales", "ColaboradorReimpresionComprobantesFiscales.prg" )		endif		return this.oColaboradorReimpresion
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocomprobantes_access() as void                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocomprobantes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocomprobantes_access', lcParametros )			endif		endif		if !this.ldestroy and ( vartype( this.oComprobantes ) != "O" or isnull( this.oComprobantes ) )			this.oComprobantes = newobject( "din_comprobante", "din_comprobante.prg" )		endif		return this.oComprobantes
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocorrectorestalonario_access() as object                                                                                                                                                                                                         
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocorrectorestalonario_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocorrectorestalonario_access', lcParametros )			endif		endif		local loCorrector as Object, loColaboradorCorrector as Object		if !this.ldestroy and ( vartype( this.oCorrectoresTalonario ) != "O" or isnull( this.oCorrectoresTalonario ) )			this.oCorrectoresTalonario = newobject( "collection" )			****Anulacion			loColaboradorCorrector = newobject( "CorrectorEspecificoAnulacion", "CorrectorTalonario.prg" )			loCorrector = newobject( "CorrectorTalonario", "CorrectorTalonario.prg","" , loColaboradorCorrector )			this.oCorrectoresTalonario.add( loCorrector, transform(1))			****Eliminacion			loColaboradorCorrector = newobject( "CorrectorEspecificoEliminacion", "CorrectorTalonario.prg" )			loCorrector = newobject( "CorrectorTalonario", "CorrectorTalonario.prg","" , loColaboradorCorrector )			this.oCorrectoresTalonario.add( loCorrector, transform(2))		endif		return this.oCorrectoresTalonario
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ogeneradores_access() as void                                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ogeneradores_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ogeneradores_access', lcParametros )			endif		endif		local loGenerador as Object		if !this.ldestroy and ( vartype( this.oGeneradores ) != "O" or isnull( this.oGeneradores ) )			this.oGeneradores = newobject( "ZooColeccion", "ZooColeccion.prg" )			***Poblar la coleccion de validadores				loGenerador = newobject( "GeneradorSentenciaAnulacion", "GeneradorSentenciaAnulacion.prg" )			this.oGeneradores.Agregar( loGenerador, transform(1) )			loGenerador = newobject( "GeneradorSentenciaEliminacion", "GeneradorSentenciaEliminacion.prg" )			this.oGeneradores.Agregar( loGenerador, transform(2) )		endif		return this.oGeneradores
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omanagertratamientocomprobantes_access() as void                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'omanagertratamientocomprobantes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'omanagertratamientocomprobantes_access', lcParametros )			endif		endif		if !this.ldestroy and ( vartype( this.oManagerTratamientoComprobantes ) != "O" or isnull( this.oManagerTratamientoComprobantes ) )			this.oManagerTratamientoComprobantes = newobject( "ManagerTratamientoComprobantes", "ManagerTratamientoComprobantes.prg" )		endif		return this.oManagerTratamientoComprobantes
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oproveedorletrafiscal_access() as void                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oproveedorletrafiscal_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oproveedorletrafiscal_access', lcParametros )			endif		endif		local loProveedorletrafiscal as Object, loSFCliente as Object, loSFEmpresa as Object, lnSFEmpresa as Object, loComprobantes as Object		if !this.ldestroy and ( vartype( this.oProveedorletrafiscal ) != "O" or isnull( this.oProveedorletrafiscal ) )			loSFCliente = newobject( "SituacionFiscal", "componentefiscal.prg" )			loSFEmpresa = newobject( "SituacionFiscalEmpresa", "componentefiscal.prg" )			loComprobantes = newobject( "Comprobantes", "componentefiscal.prg" )			lnSFEmpresa = goParametros.Felino.DatosGenerales.SituacionFiscal			this.oProveedorletrafiscal = newobject( "Proveedorletrafiscal", "Proveedorletrafiscal.prg", "",loSFEmpresa.lComprobantesAMonotributistas, loComprobantes, loSFCliente, loSFEmpresa, lnSFEmpresa  )		endif		return this.oProveedorletrafiscal
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function orenderrangocomprobantes_access() as void                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'orenderrangocomprobantes_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'orenderrangocomprobantes_access', lcParametros )			endif		endif		if !this.ldestroy and ( vartype( this.oRenderRangoComprobantes ) != "O" or isnull( this.oRenderRangoComprobantes ) )			this.oRenderRangoComprobantes = newobject( "RenderRangoComprobantes", "RenderRangoComprobantes.prg", "", this.oComprobantes )		endif		return this.oRenderRangoComprobantes
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ovalidadores_access() as void                                                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ovalidadores_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ovalidadores_access', lcParametros )			endif		endif		local loValidador as Object		if !this.ldestroy and ( vartype( this.oValidadores ) != "O" or isnull( this.oValidadores ) )			this.oValidadores = newobject( "ZooColeccion", "ZooColeccion.prg" )			***Poblar la coleccion de validadores				loValidador = newobject( "ValidadorComprobantesInexistentes", "ValidadorComprobantesInexistentes.prg" )			this.oValidadores.Agregar( loValidador, transform(1) )			loValidador = newobject( "ValidadorComprobantesExistentesYAnulados", "ValidadorComprobantesExistentesYAnulados.prg" )			this.oValidadores.Agregar( loValidador, transform(2) )			loValidador = newobject( "ValidadorComprobantesExistentes", "ValidadorComprobantesExistentes.prg" )			this.oValidadores.Agregar( loValidador, transform(3) )		endif		return this.oValidadores
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function secuencia_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'secuencia_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'secuencia_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Secuencia		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Secuencia( lxVal )				this.Setear_Secuencia( lxVal )			EndIf		Else			This.Setear_Secuencia( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerodesde( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numerodesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numerodesde', lcParametros )			endif		endif		this.Numerodesde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_numerohasta( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numerohasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numerohasta', lcParametros )			endif		endif		this.Numerohasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_secuencia( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_secuencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_secuencia', lcParametros )			endif		endif		this.Secuencia = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_letra( tcval as string ) as boolean                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = tcvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_letra', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_letra', lcParametros )			endif		endif		local llRetorno as Boolean, loInfo as zooinformacion of zooInformacion.prg		llRetorno = dodefault()		if llRetorno			loInfo = this.ValidacionAtributoLetra( tcVal )			if loInfo.HayInformacion()				goServicios.Errores.LevantarExcepcion( loInfo )						endif		endif		return llRetorno
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerodesde( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numerodesde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numerodesde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_numerohasta( txval as variant ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numerohasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numerohasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_secuencia( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TRATAMIENTOCOMPROBANTES' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_secuencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_secuencia', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaraccion() as boolean                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaraccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechacomprobante() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechacomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarnumerodesde() as boolean                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarnumerodesde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarnumerohasta() as boolean                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarnumerohasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechacomprobante() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofechacomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwaccion() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridofwaccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwserie() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwserie', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumerodesde() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridonumerodesde', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridonumerohasta() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridonumerohasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function aplicartratamiento( torango as object, toad as object, toerrores as object ) as void                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Aplicartratamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function lasecuenciaestadisponible() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Lasecuenciaestadisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenermensajeerrorcf() as string                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermensajeerrorcf', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerrango() as object                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerrango', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertipocomprobante( tntipo as integer ) as string                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenertipocomprobantefiscales() as string                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertipocomprobantefiscales', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerultimasecuencia( tnaccion as integer ) as string                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerultimasecuencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validacionatributoletra( tcletra as string ) as zooinformacion of zooinformacion.prg                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validacionatributoletra', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validacionatributosecuencia() as zooinformacion of zooinformacion.prg                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validacionatributosecuencia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarfechaencomprobantesanterioryposterior( tnaccion as integer ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarfechaencomprobantesanterioryposterior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarfechafutura() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechafutura', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarsihayerroresenerrorcf() as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarsihayerroresenerrorcf', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validartratamiento( torango as object, toad as object ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validartratamiento', lcParametros )
	EndFunc
