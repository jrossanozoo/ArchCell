...
define class Mock_Itemcaicaidetalle as MockBase of MockBase.prg

	cClase = 'Itemcaicaidetalle'
	...
	*-----------------------------------------------------------------------------------------
	function numerocai_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Numerocai_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerocai( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_numerocai', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerocai( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_numerocai', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumerocai() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridonumerocai', lcParametros )
	EndFunc
