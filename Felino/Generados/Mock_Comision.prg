...
define class Mock_comision as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Comisiones por venta"                                                                                                                                                                                                                    
	...
	f_Color_desde = ""                                                                                                                                                                                                                                        
	f_Color_hasta = ""                                                                                                                                                                                                                                        
	f_Sucursal_Codigo_desde = ""                                                                                                                                                                                                                              
	f_Sucursal_Codigo_hasta = ""                                                                                                                                                                                                                              
	f_Sucursal_Linea_Desde = ""                                                                                                                                                                                                                               
	f_Sucursal_Linea_Hasta = ""                                                                                                                                                                                                                               
	f_Sucursal_Segmentacion_Desde = ""                                                                                                                                                                                                                        
	f_Sucursal_Segmentacion_Hasta = ""                                                                                                                                                                                                                        
	f_Sucursal_Tipo_Desde = ""                                                                                                                                                                                                                                
	f_Sucursal_Tipo_Hasta = ""                                                                                                                                                                                                                                
	f_Talle_Desde = ""                                                                                                                                                                                                                                        
	f_Talle_Hasta = ""                                                                                                                                                                                                                                        
	...
	lHabilitarf_Color_desde = .T.                                                                                                                                                                                                                             
	lHabilitarf_Color_hasta = .T.                                                                                                                                                                                                                             
	lHabilitarf_Sucursal_Codigo_desde = .T.                                                                                                                                                                                                                   
	lHabilitarf_Sucursal_Codigo_hasta = .T.                                                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function f_articulo_material_desde_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_material_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_material_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_material_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_material_desde( lxVal )				this.Setear_F_articulo_material_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_material_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_material_hasta_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_material_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_material_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_material_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_material_hasta( lxVal )				this.Setear_F_articulo_material_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_material_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_proveedor_desde_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_proveedor_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_proveedor_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_proveedor_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_proveedor_desde( lxVal )				this.Setear_F_articulo_proveedor_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_proveedor_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_proveedor_hasta_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_proveedor_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_proveedor_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_proveedor_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_proveedor_hasta( lxVal )				this.Setear_F_articulo_proveedor_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_proveedor_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_unidad_desde_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_unidad_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_unidad_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_unidad_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_unidad_desde( lxVal )				this.Setear_F_articulo_unidad_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_unidad_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_unidad_hasta_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_unidad_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_unidad_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_unidad_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_unidad_hasta( lxVal )				this.Setear_F_articulo_unidad_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_unidad_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_color_desde_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_color_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_color_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_color_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_color_desde( lxVal )				if ( this.lHabilitarF_color_desde or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_F_color_desde( lxVal )				else					this.F_color_desde = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comisiones por venta - Atributo: F_color_desde)" )				endif			EndIf		Else			This.Setear_F_color_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_color_hasta_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_color_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_color_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_color_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_color_hasta( lxVal )				if ( this.lHabilitarF_color_hasta or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_F_color_hasta( lxVal )				else					this.F_color_hasta = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comisiones por venta - Atributo: F_color_hasta)" )				endif			EndIf		Else			This.Setear_F_color_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_codigo_desde_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_codigo_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_codigo_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_codigo_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_codigo_desde( lxVal )				if ( this.lHabilitarF_sucursal_codigo_desde or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_F_sucursal_codigo_desde( lxVal )				else					this.F_sucursal_codigo_desde = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comisiones por venta - Atributo: F_sucursal_codigo_desde)" )				endif			EndIf		Else			This.Setear_F_sucursal_codigo_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_codigo_hasta_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_codigo_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_codigo_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_codigo_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_codigo_hasta( lxVal )				if ( this.lHabilitarF_sucursal_codigo_hasta or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_F_sucursal_codigo_hasta( lxVal )				else					this.F_sucursal_codigo_hasta = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comisiones por venta - Atributo: F_sucursal_codigo_hasta)" )				endif			EndIf		Else			This.Setear_F_sucursal_codigo_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_linea_desde_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_linea_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_linea_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_linea_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_linea_desde( lxVal )				this.Setear_F_sucursal_linea_desde( lxVal )			EndIf		Else			This.Setear_F_sucursal_linea_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_linea_hasta_assign( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_linea_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_linea_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_linea_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_linea_hasta( lxVal )				this.Setear_F_sucursal_linea_hasta( lxVal )			EndIf		Else			This.Setear_F_sucursal_linea_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_segmentacion_desde_assign( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_segmentacion_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_segmentacion_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_segmentacion_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_segmentacion_desde( lxVal )				this.Setear_F_sucursal_segmentacion_desde( lxVal )			EndIf		Else			This.Setear_F_sucursal_segmentacion_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_segmentacion_hasta_assign( txval as variant ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_segmentacion_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_segmentacion_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_segmentacion_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_segmentacion_hasta( lxVal )				this.Setear_F_sucursal_segmentacion_hasta( lxVal )			EndIf		Else			This.Setear_F_sucursal_segmentacion_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_tipo_desde_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_tipo_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_tipo_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_tipo_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_tipo_desde( lxVal )				this.Setear_F_sucursal_tipo_desde( lxVal )			EndIf		Else			This.Setear_F_sucursal_tipo_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_sucursal_tipo_hasta_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_sucursal_tipo_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_sucursal_tipo_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_sucursal_tipo_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_sucursal_tipo_hasta( lxVal )				this.Setear_F_sucursal_tipo_hasta( lxVal )			EndIf		Else			This.Setear_F_sucursal_tipo_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_talle_desde_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_talle_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_talle_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_talle_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_talle_desde( lxVal )				if ( this.lHabilitarF_talle_desde or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_F_talle_desde( lxVal )				else					this.F_talle_desde = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comisiones por venta - Atributo: F_talle_desde)" )				endif			EndIf		Else			This.Setear_F_talle_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_talle_hasta_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMISION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_talle_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_talle_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_talle_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_talle_hasta( lxVal )				if ( this.lHabilitarF_talle_hasta or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_F_talle_hasta( lxVal )				else					this.F_talle_hasta = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Comisiones por venta - Atributo: F_talle_hasta)" )				endif			EndIf		Else			This.Setear_F_talle_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_codigo_desde( txval as variant ) as boolean                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_codigo_hasta( txval as variant ) as boolean                                                                                                                                                                                   
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_linea_desde( txval as variant ) as boolean                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_linea_hasta( txval as variant ) as boolean                                                                                                                                                                                    
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_segmentacion_desde( txval as variant ) as boolean                                                                                                                                                                             
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_segmentacion_hasta( txval as variant ) as boolean                                                                                                                                                                             
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_tipo_desde( txval as variant ) as boolean                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_sucursal_tipo_hasta( txval as variant ) as boolean                                                                                                                                                                                     
