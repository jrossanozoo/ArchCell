...
define class Mock_VALIDADORDETALLEDECOMPROBANTESDESDEPICKING as MockBase of MockBase.prg

	cClase = 'VALIDADORDETALLEDECOMPROBANTESDESDEPICKING'
	...
	*-----------------------------------------------------------------------------------------
	function omercaderiaentransito_access() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function validarunicidaddatoscabeceracomprobantessegunatributos() as boolean                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarunicidaddatoscabeceracomprobantessegunatributos', lcParametros )
	EndFunc
