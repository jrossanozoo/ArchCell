...
define class Din_EntidadCIERREEJERCICIO as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local lnLargoDecimal as integer, lnLargoEntero as Integer, lnLargoDecimal as integer, llRetorno as boolean 
		...
		if ( vartype( this.Indice) = 'C' )
			if len( alltrim( this.INDICE ) ) > 10
				This.AgregarInformacion( 'La longitud del valor del atributo INDICE es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo INDICE no es el correcto.')
			llRetorno = .F.
		Endif
