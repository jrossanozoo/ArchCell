...
define class Mock_Detallecaicaidetalle as MockBase of MockBase.prg

	cClase = 'Detallecaicaidetalle'

	
	cAtributosAgrupamiento = ""                                                                                                                                                                                                                               
	cAtributosAgrupamientoDefault = "NroItem"                                                                                                                                                                                                                 
	cAtributosUnicidad = ""                                                                                                                                                                                                                                   
	cAtributosUnicidad = 'NumeroCAI'                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cCopiadorDeDetalle = "CopiadorDeDetalles"                                                                                                                                                                                                                 
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Caidetalle'                                                                                                                                                                                                                                  
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'La columna CAI no admite valores repetidos.'                                                                                                                                                                                     
	cNombre = 'Caidetalle'                                                                                                                                                                                                                                    
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Códigos de Autorización de Impresión'                                                                                                                                                                                                    
	datasession = 1                                                                                                                                                                                                                                           
