...
define class Din_COMPONENTEENBASEA as Componente of Componente.prg
	...
	*-----------------------------------------------------------------------------------------
	function SoportaBasadoEn( tcComprobante as string ) as Boolean
		...
		llretorno = .f.
						llRetorno = inlist( upper( alltrim( tcComprobante ) ), 'FACTURA', 'TICKETFACTURA', 'NOTADECREDITO', 'NOTADEDEBITO', 'TICKETNOTADECREDITO', 'TICKETNOTADEDEBITO', 'FACTURADECOMPRA', 'REMITO', 'DEVOLUCION', 'PEDIDO', 'FACTURAELECTRONICA', 'NOTADECREDITOELECTRONICA', 'FACTURAELECTRONICAEXPORTACION', 'NOTADECREDITOELECTRONICAEXPORTACION', 'REMITODECOMPRA', 'FACTURADEEXPORTACION', 'NOTADECREDITODEEXPORTACION', 'NOTADEDEBITODEEXPORTACION', 'FACTURAAGRUPADA', 'NOTADECREDITOAGRUPADA', 'NOTADEDEBITOAGRUPADA', 'FACTURAELECTRONICADECREDITO', 'NOTADECREDITOELECTRONICADECREDITO', 'NOTADEDEBITOELECTRONICADECREDITO' ) ;
							or inlist( upper( alltrim( tcComprobante ) ), 'PREPARACIONDEMERCADERIA' )
		return llRetorno
	endfunc
	...
	*-----------------------------------------------------------------------------------------
	function EsComprobanteAfectado( tcComprobante as string ) as Boolean
		...
		llretorno = .f.
						llRetorno = inlist( upper( alltrim( tcComprobante ) ), 'FACTURA', 'TICKETFACTURA', 'NOTADECREDITO', 'NOTADEDEBITO', 'TICKETNOTADECREDITO', 'TICKETNOTADEDEBITO', 'REMITO', 'DEVOLUCION', 'PEDIDO', 'PRESUPUESTO', 'FACTURAELECTRONICA', 'NOTADECREDITOELECTRONICA', 'NOTADEDEBITOELECTRONICA', 'FACTURAELECTRONICAEXPORTACION', 'NOTADECREDITOELECTRONICAEXPORTACION', 'NOTADEDEBITOELECTRONICAEXPORTACION', 'PEDIDODECOMPRA', 'REMITODECOMPRA', 'FACTURADEEXPORTACION', 'NOTADECREDITODEEXPORTACION', 'NOTADEDEBITODEEXPORTACION', 'FACTURAELECTRONICADECREDITO', 'NOTADECREDITOELECTRONICADECREDITO', 'NOTADEDEBITOELECTRONICADECREDITO' ) ;
							or inlist( upper( alltrim( tcComprobante ) ), 'PREPARACIONDEMERCADERIA' )
		return llRetorno
	endfunc
