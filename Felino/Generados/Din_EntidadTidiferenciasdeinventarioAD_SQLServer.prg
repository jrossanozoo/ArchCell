...
define class Din_EntidadTIDIFERENCIASDEINVENTARIOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTidifinvFecimpo, lxTidifinvFectrans, lxTidifinvFmodifw, lxTidifinvFecexpo, lxTidifinvFaltafw, lxTidifinvSmodifw, lxTidifinvHmodifw, lxTidifinvSaltafw, lxTidifinvUaltafw, lxTidifinvUmodifw, lxTidifinvZadsfw, lxTidifinvValtafw, lxTidifinvVmodifw, lxTidifinvHoraimpo, lxTidifinvHaltafw, lxTidifinvHoraexpo, lxTidifinvBdmodifw, lxTidifinvBdaltafw, lxTidifinvEsttrans, lxTidifinvCodigo, lxTidifinvIdinvcont, lxTidifinvDescrip, lxTidifinvIdinvfis, lxTidifinvMobs, lxTidifinvFecha, lxTidifinvMsorigdest, lxTidifinvMsmotivo, lxTidifinvMsfecha, lxTidifinvMovgen
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TIDIFINV ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Smodifw","Hmodifw","Saltafw","Ualtafw","Umodifw","Zadsfw","Valtafw","Vmodifw","Horaimpo","Haltafw","Horaexpo","Bdmodifw","Bdaltafw","Esttrans","Codigo","Idinvcont","Descrip","Idinvfis","Mobs","Fecha","Msorigdest","Msmotivo","Msfecha","Movgen" ) values ( <<"'" + this.ConvertirDateSql( lxTidifinvFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvEsttrans ) + "'" >>, <<lxTidifinvCodigo >>, <<lxTidifinvIdinvcont >>, <<"'" + this.FormatearTextoSql( lxTidifinvDescrip ) + "'" >>, <<lxTidifinvIdinvfis >>, <<"'" + this.FormatearTextoSql( lxTidifinvMobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvMsorigdest ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvMsmotivo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTidifinvMsfecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTidifinvMovgen ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			local lxIDInventarioAControlar, lxCodigo
			...
			this.oSP.InsertarDiferenciasDeInventario(lxIDInventarioAControlar, lxCodigo)
			local lxCodigo
			if empty( this.oEntidad.Codigo )
				lxCodigo = null
			else
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TIDIFINV set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTidifinvFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTidifinvFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTidifinvFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxTidifinvFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTidifinvFaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTidifinvUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTidifinvZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTidifinvValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvVmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTidifinvHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTidifinvHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTidifinvBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTidifinvBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTidifinvEsttrans ) + "'">>,"Codigo" = <<lxTidifinvCodigo>>,"Idinvcont" = <<lxTidifinvIdinvcont>>,"Descrip" = <<"'" + this.FormatearTextoSql( lxTidifinvDescrip ) + "'">>,"Idinvfis" = <<lxTidifinvIdinvfis>>,"Mobs" = <<"'" + this.FormatearTextoSql( lxTidifinvMobs ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxTidifinvFecha ) + "'">>,"Msorigdest" = <<"'" + this.FormatearTextoSql( lxTidifinvMsorigdest ) + "'">>,"Msmotivo" = <<"'" + this.FormatearTextoSql( lxTidifinvMsmotivo ) + "'">>,"Msfecha" = <<"'" + this.ConvertirDateSql( lxTidifinvMsfecha ) + "'">>,"Movgen" = <<"'" + this.FormatearTextoSql( lxTidifinvMovgen ) + "'">> where "Codigo" = <<lxTidifinvCodigo>> and  TIDIFINV.CODIGO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Valt" + ;
"afw,Vmodifw,Horaimpo,Haltafw,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Codigo,Idinvcont,Descrip,Idinvfis,M" + ;
"obs,Fecha,Msorigdest,Msmotivo,Msfecha,Movgen" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.TIDIFINV set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, CODIGO = ] + transform( &lcCursor..CODIGO )+ [, IDInvCont = ] + transform( &lcCursor..IDInvCont )+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, IDInvFis = ] + transform( &lcCursor..IDInvFis )+ [, MObs = ] + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'"+ [, FECHA = ] + "'" + this.ConvertirDateSql( &lcCursor..FECHA ) + "'"+ [, MSORIGDEST = ] + "'" + this.FormatearTextoSql( &lcCursor..MSORIGDEST ) + "'"+ [, MSMOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MSMOTIVO ) + "'"+ [, MSFECHA = ] + "'" + this.ConvertirDateSql( &lcCursor..MSFECHA ) + "'"+ [, MovGen = ] + "'" + this.FormatearTextoSql( &lcCursor..MovGen ) + "'" + [ Where CODIGO = ] + transform( &lcCursor..CODIGO ) )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, SMODIFW, HMODIFW, SALTAFW, UALTAFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HORAIMPO, HALTAFW, HORAEXPO, BDMODIFW, BDALTAFW, ESTTRANS, CODIGO, IDInvCont, Descrip, IDInvFis, MObs, FECHA, MSORIGDEST, MSMOTIVO, MSFECHA, MovGen
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + transform( &lcCursor..CODIGO ) + ',' + transform( &lcCursor..IDInvCont )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + transform( &lcCursor..IDInvFis ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..MObs ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECHA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MSORIGDEST ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MSMOTIVO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..MSFECHA ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..MovGen ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.IDINVCONT = isnull( d.IDINVCONT, t.IDINVCONT ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.IDINVFIS = isnull( d.IDINVFIS, t.IDINVFIS ),t.MOBS = isnull( d.MOBS, t.MOBS ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.MSORIGDEST = isnull( d.MSORIGDEST, t.MSORIGDEST ),t.MSMOTIVO = isnull( d.MSMOTIVO, t.MSMOTIVO ),t.MSFECHA = isnull( d.MSFECHA, t.MSFECHA ),t.MOVGEN = isnull( d.MOVGEN, t.MOVGEN )
					from ZooLogic.TIDIFINV t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.TIDIFINV(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Smodifw,Hmodifw,Saltafw,Ualtafw,Umodifw,Zadsfw,Valtafw,Vmodifw,Horaimpo,Haltafw,Horaexpo,Bdmodifw,Bdaltafw,Esttrans,Codigo,Idinvcont,Descrip,Idinvfis,Mobs,Fecha,Msorigdest,Msmotivo,Msfecha,Movgen)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.CODIGO,0),isnull( d.IDINVCONT,0),isnull( d.DESCRIP,''),isnull( d.IDINVFIS,0),isnull( d.MOBS,''),isnull( d.FECHA,''),isnull( d.MSORIGDEST,''),isnull( d.MSMOTIVO,''),isnull( d.MSFECHA,''),isnull( d.MOVGEN,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIDIFERENCIASDEINVENTARIO               " atributo="INVENTARIOSFISICOSDETALLE               " tabla="TIITEMDIFINV   " campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Inventarios físicos                                                                                                                                             " dominio="DETALLEITEMINVENTARIOSFISICO  " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIDIFERENCIASDEINVENTARIO               " atributo="IDINVENTARIOFISICO                      " tabla="TIDIFINV       " campo="IDINVFIS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIInventarioFisico                      " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Inventario físico                                                                                                                                               " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="3" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIDIFERENCIASDEINVENTARIO               " atributo="OBS                                     " tabla="TIDIFINV       " campo="MOBS      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="200" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ORIGENDEDATOS                           " atributo="DESCRIPCION                             " tabla="ORDAT          " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="15" etiqueta="Detalle Ori.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ORDAT On TIDIFINV.MSORIGDEST = ORDAT.codigo And  ORDAT.CODIGO != ''                                                                                                                                                                                " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
