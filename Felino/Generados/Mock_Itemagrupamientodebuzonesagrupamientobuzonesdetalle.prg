...
define class Mock_Itemagrupamientodebuzonesagrupamientobuzonesdetalle as MockBase of MockBase.prg

	cClase = 'Itemagrupamientodebuzonesagrupamientobuzonesdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function agrupamientobuzones_access() as variant                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Agrupamientobuzones_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agrupamientobuzones_pk_assign( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Agrupamientobuzones_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agrupamientobuzonesdetalle_assign( txval as variant ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Agrupamientobuzonesdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function incluye_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Incluye_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_agrupamientobuzones( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_agrupamientobuzones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_agrupamientobuzonesdetalle( txval as variant ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_agrupamientobuzonesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_incluye( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_incluye', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_agrupamientobuzones( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_agrupamientobuzones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_agrupamientobuzonesdetalle( txval as variant ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_agrupamientobuzonesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_incluye( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_incluye', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoincluye() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoincluye', lcParametros )
	EndFunc
