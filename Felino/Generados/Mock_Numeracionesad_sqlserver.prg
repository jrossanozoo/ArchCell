...
define class Mock_Numeracionesad_sqlserver as MockBase of MockBase.prg

	cClase = 'Numeracionesad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalletalonarios( tcatributo as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercampodetalletalonarios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalletalonarios( tccampos as string ) as string                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalletalonarios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalletalonarios( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalletalonarios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalletalonarios( tccampos as string ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Parsearcamposdetalletalonarios', lcParametros )
	EndFunc
