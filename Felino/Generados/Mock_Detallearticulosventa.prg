...
define class Mock_DETALLEARTICULOSVENTA as MockBase of MockBase.prg

	cClase = 'DETALLEARTICULOSVENTA'
	...
	*-----------------------------------------------------------------------------------------
	function elatributoesverificablecomovacio( tcatributo as string, txvalor as variant ) as boolean                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
