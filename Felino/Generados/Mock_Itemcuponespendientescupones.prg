...
define class Mock_Itemcuponespendientescupones as MockBase of MockBase.prg

	cClase = 'Itemcuponespendientescupones'
	...
	*-----------------------------------------------------------------------------------------
	function codigocupon_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Codigocupon_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigocupon( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_codigocupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigocupon( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_codigocupon', lcParametros )
	EndFunc
