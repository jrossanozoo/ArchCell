...
define class Mock_Itemseniapendientedetalleseniaspendientes as MockBase of MockBase.prg

	cClase = 'Itemseniapendientedetalleseniaspendientes'
	...
	*-----------------------------------------------------------------------------------------
	function idsenia_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Idsenia_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idsenia( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_idsenia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idsenia( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_idsenia', lcParametros )
	EndFunc
