...
define class Mock_BUSCADORCODIGOSGTIN as MockBase of MockBase.prg

	cClase = 'BUSCADORCODIGOSGTIN'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	oColaboradoresDeBusquedaDeGTIN = null                                                                                                                                                                                                                     
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function obtener( toitem as object ) as string                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtener', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reiniciarbuscadores() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Reiniciarbuscadores', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocolaboradoresdebusquedadegtin_access() as object                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolaboradoresdebusquedadegtin_access', lcParametros )
	EndFunc
