...
define class Mock_SELECCIONIMPORTACIONES as MockBase of MockBase.prg

	cClase = 'SELECCIONIMPORTACIONES'
	...
	*-----------------------------------------------------------------------------------------
	function obtenerformulario( toimportacion as objetoimportacion of objetoimportacion.prg ) as void                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toimportacion
		...
		return this.ObtenerResultado( 'Obtenerformulario', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerformularioagrupadas( toobjetoagrupado as object )                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toobjetoagrupado
		...
		return this.ObtenerResultado( 'Obtenerformularioagrupadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarimportacioncongrupoindicesinflacion( toform as object ) as object                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarimportacioncongrupoindicesinflacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarimportacioncongrupoparametros( toform as object ) as object                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarimportacioncongrupoparametros', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarimportacioncongrupoparametros05( toform as object ) as object                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarimportacioncongrupoparametros05', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarimportacioncongrupoparametros06( toform as object ) as object                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarimportacioncongrupoparametros06', lcParametros )
	EndFunc
