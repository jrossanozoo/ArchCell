...
define class Din_EntidadCONCEPTOLIQUIDACIONTARJETAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxConliqtarFecexpo, lxConliqtarFectrans, lxConliqtarFmodifw, lxConliqtarFaltafw, lxConliqtarFecimpo, lxConliqtarSaltafw, lxConliqtarHmodifw, lxConliqtarSmodifw, lxConliqtarHoraimpo, lxConliqtarUaltafw, lxConliqtarVmodifw, lxConliqtarUmodifw, lxConliqtarValtafw, lxConliqtarZadsfw, lxConliqtarHaltafw, lxConliqtarBdmodifw, lxConliqtarBdaltafw, lxConliqtarEsttrans, lxConliqtarHoraexpo, lxConliqtarComporta, lxConliqtarCodigo, lxConliqtarCondiva, lxConliqtarPorciva, lxConliqtarDescrip, lxConliqtarCodimp, lxConliqtarObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.CONLIQTAR ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Saltafw","Hmodifw","Smodifw","Horaimpo","Ualtafw","Vmodifw","Umodifw","Valtafw","Zadsfw","Haltafw","Bdmodifw","Bdaltafw","Esttrans","Horaexpo","Comporta","Codigo","Condiva","Porciva","Descrip","Codimp","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxConliqtarFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConliqtarFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConliqtarFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConliqtarFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxConliqtarFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarHoraexpo ) + "'" >>, <<lxConliqtarComporta >>, <<"'" + this.FormatearTextoSql( lxConliqtarCodigo ) + "'" >>, <<lxConliqtarCondiva >>, <<lxConliqtarPorciva >>, <<"'" + this.FormatearTextoSql( lxConliqtarDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarCodimp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxConliqtarObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.CONLIQTAR set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxConliqtarFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxConliqtarFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxConliqtarFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxConliqtarFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxConliqtarFecimpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxConliqtarSaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarSmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxConliqtarHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxConliqtarUaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarUmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxConliqtarValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxConliqtarZadsfw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxConliqtarHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxConliqtarBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxConliqtarEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxConliqtarHoraexpo ) + "'">>,"Comporta" = <<lxConliqtarComporta>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxConliqtarCodigo ) + "'">>,"Condiva" = <<lxConliqtarCondiva>>,"Porciva" = <<lxConliqtarPorciva>>,"Descrip" = <<"'" + this.FormatearTextoSql( lxConliqtarDescrip ) + "'">>,"Codimp" = <<"'" + this.FormatearTextoSql( lxConliqtarCodimp ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxConliqtarObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxConliqtarCodigo ) + "'">> and  CONLIQTAR.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Comporta" as "Comportamiento", "Codigo" as "Codigo", "Condiva" as "Condicioniva", "Porciva" as "Porcentajeiva", "Descrip" as "Descripcion", "Codimp" as "Impuesto", "Obs" as "Obs" from ZooLogic.CONLIQTAR where "Codigo" = <<"'" + this.FormatearTextoSql( lxConliqtarCodigo ) + "'">> and  CONLIQTAR.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Saltafw,Hmodifw,Smodifw,Horaimpo,Ualtafw,Vmodifw,Um" + ;
"odifw,Valtafw,Zadsfw,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Comporta,Codigo,Condiva,Porciva,Des" + ;
"crip,Codimp,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Saltafw" as "Seriealtafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaexpo" as "Horaexpo", "Comporta" as "Comportamiento", "Codigo" as "Codigo", "Condiva" as "Condicioniva", "Porciva" as "Porcentajeiva", "Descrip" as "Descripcion", "Codimp" as "Impuesto", "Obs" as "Obs"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.CONLIQTAR set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxConliqtarFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxConliqtarFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxConliqtarFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxConliqtarFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxConliqtarFecimpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxConliqtarSaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarHmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarSmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxConliqtarHoraimpo ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxConliqtarUaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarVmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarUmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxConliqtarValtafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxConliqtarZadsfw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxConliqtarHaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxConliqtarBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxConliqtarBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxConliqtarEsttrans ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxConliqtarHoraexpo ) + "'">>, "Comporta" = <<lxConliqtarComporta>>, "Codigo" = <<"'" + this.FormatearTextoSql( lxConliqtarCodigo ) + "'">>, "Condiva" = <<lxConliqtarCondiva>>, "Porciva" = <<lxConliqtarPorciva>>, "Descrip" = <<"'" + this.FormatearTextoSql( lxConliqtarDescrip ) + "'">>, "Codimp" = <<"'" + this.FormatearTextoSql( lxConliqtarCodimp ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxConliqtarObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'CONLIQTAR' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.CONLIQTAR set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Comporta = ] + transform( &lcCursor..Comporta )+ [, codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"+ [, CONDIVA = ] + transform( &lcCursor..CONDIVA )+ [, PORCIVA = ] + transform( &lcCursor..PORCIVA )+ [, descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'"+ [, CodImp = ] + "'" + this.FormatearTextoSql( &lcCursor..CodImp ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, SALTAFW, HMODIFW, SMODIFW, HORAIMPO, UALTAFW, VMODIFW, UMODIFW, VALTAFW, ZADSFW, HALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, HORAEXPO, Comporta, codigo, CONDIVA, PORCIVA, descrip, CodImp, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + transform( &lcCursor..Comporta ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..codigo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..CONDIVA ) + ',' + transform( &lcCursor..PORCIVA ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodImp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.COMPORTA = isnull( d.COMPORTA, t.COMPORTA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.CONDIVA = isnull( d.CONDIVA, t.CONDIVA ),t.PORCIVA = isnull( d.PORCIVA, t.PORCIVA ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.CODIMP = isnull( d.CODIMP, t.CODIMP ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.CONLIQTAR t inner join deleted d 
							 on t.codigo = d.codigo
				-- Fin Updates
				insert into ZooLogic.CONLIQTAR(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Saltafw,Hmodifw,Smodifw,Horaimpo,Ualtafw,Vmodifw,Umodifw,Valtafw,Zadsfw,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Horaexpo,Comporta,Codigo,Condiva,Porciva,Descrip,Codimp,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.SALTAFW,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.COMPORTA,0),isnull( d.CODIGO,''),isnull( d.CONDIVA,0),isnull( d.PORCIVA,0),isnull( d.DESCRIP,''),isnull( d.CODIMP,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="CONCEPTOLIQUIDACIONTARJETA              " atributo="FECHATRANSFERENCIA                      " tabla="CONLIQTAR      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONCEPTOLIQUIDACIONTARJETA              " atributo="ESTADOTRANSFERENCIA                     " tabla="CONLIQTAR      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
