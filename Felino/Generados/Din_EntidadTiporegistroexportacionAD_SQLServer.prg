...
define class Din_EntidadTIPOREGISTROEXPORTACIONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTipregexpFecimpo, lxTipregexpFectrans, lxTipregexpFmodifw, lxTipregexpFecexpo, lxTipregexpFaltafw, lxTipregexpBloqreg, lxTipregexpUmodifw, lxTipregexpUaltafw, lxTipregexpSmodifw, lxTipregexpValtafw, lxTipregexpZadsfw, lxTipregexpVmodifw, lxTipregexpHaltafw, lxTipregexpSaltafw, lxTipregexpEsttrans, lxTipregexpBdmodifw, lxTipregexpHoraexpo, lxTipregexpHmodifw, lxTipregexpBdaltafw, lxTipregexpHoraimpo, lxTipregexpCcod, lxTipregexpCdes, lxTipregexpNascii
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.TIPREGEXP ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Bloqreg","Umodifw","Ualtafw","Smodifw","Valtafw","Zadsfw","Vmodifw","Haltafw","Saltafw","Esttrans","Bdmodifw","Horaexpo","Hmodifw","Bdaltafw","Horaimpo","Ccod","Cdes","Nascii" ) values ( <<"'" + this.ConvertirDateSql( lxTipregexpFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipregexpFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipregexpFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipregexpFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTipregexpFaltafw ) + "'" >>, <<iif( lxTipregexpBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxTipregexpUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpCcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTipregexpCdes ) + "'" >>, <<lxTipregexpNascii >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.TIPREGEXP set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTipregexpFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTipregexpFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTipregexpFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxTipregexpFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTipregexpFaltafw ) + "'">>,"Bloqreg" = <<iif( lxTipregexpBloqreg, 1, 0 )>>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTipregexpUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpSmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTipregexpValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTipregexpZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpVmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTipregexpHaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTipregexpSaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTipregexpEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTipregexpHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTipregexpBdaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTipregexpHoraimpo ) + "'">>,"Ccod" = <<"'" + this.FormatearTextoSql( lxTipregexpCcod ) + "'">>,"Cdes" = <<"'" + this.FormatearTextoSql( lxTipregexpCdes ) + "'">>,"Nascii" = <<lxTipregexpNascii>> where "Ccod" = <<"'" + this.FormatearTextoSql( lxTipregexpCcod ) + "'">> and  TIPREGEXP.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bloqreg" as "Bloquearregistro", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Nascii" as "Ascii" from ORGANIZACION.TIPREGEXP where  TIPREGEXP.CCOD != '' order by cCod
			endtext
			use in select('c_TIPOREGISTROEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOREGISTROEXPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bloqreg" as "Bloquearregistro", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Nascii" as "Ascii" from ORGANIZACION.TIPREGEXP where  funciones.padr( cCod, 3, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIPREGEXP.CCOD != '' order by cCod
			endtext
			use in select('c_TIPOREGISTROEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOREGISTROEXPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bloqreg" as "Bloquearregistro", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Nascii" as "Ascii" from ORGANIZACION.TIPREGEXP where  funciones.padr( cCod, 3, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TIPREGEXP.CCOD != '' order by cCod desc
			endtext
			use in select('c_TIPOREGISTROEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOREGISTROEXPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bloqreg" as "Bloquearregistro", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Nascii" as "Ascii" from ORGANIZACION.TIPREGEXP where  TIPREGEXP.CCOD != '' order by cCod desc
			endtext
			use in select('c_TIPOREGISTROEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TIPOREGISTROEXPORTACION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Bloqreg,Umodifw,Ualtafw,Smodifw,Valtafw,Zadsfw,Vmod" + ;
"ifw,Haltafw,Saltafw,Esttrans,Bdmodifw,Horaexpo,Hmodifw,Bdaltafw,Horaimpo,Ccod,Cdes,Nascii" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Bloqreg" as "Bloquearregistro", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Ccod" as "Codigo", "Cdes" as "Descripcion", "Nascii" as "Ascii"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.TIPREGEXP set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTipregexpFecimpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxTipregexpFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTipregexpFmodifw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTipregexpFecexpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxTipregexpFaltafw ) + "'">>, "Bloqreg" = <<iif( lxTipregexpBloqreg, 1, 0 )>>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpUmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxTipregexpUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpSmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxTipregexpValtafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxTipregexpZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpVmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxTipregexpHaltafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxTipregexpSaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxTipregexpEsttrans ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpBdmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxTipregexpHoraexpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxTipregexpHmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTipregexpBdaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxTipregexpHoraimpo ) + "'">>, "Ccod" = <<"'" + this.FormatearTextoSql( lxTipregexpCcod ) + "'">>, "Cdes" = <<"'" + this.FormatearTextoSql( lxTipregexpCdes ) + "'">>, "Nascii" = <<lxTipregexpNascii>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'TIPREGEXP' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FECEXPO, FALTAFW, BLOQREG, UMODIFW, UALTAFW, SMODIFW, VALTAFW, ZADSFW, VMODIFW, HALTAFW, SALTAFW, ESTTRANS, BDMODIFW, HORAEXPO, HMODIFW, BDALTAFW, HORAIMPO, cCod, cDes, nAscii
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad TIPOREGISTROEXPORTACION. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.CDES = isnull( d.CDES, t.CDES ),t.NASCII = isnull( d.NASCII, t.NASCII )
					from ORGANIZACION.TIPREGEXP t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ORGANIZACION.TIPREGEXP(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Bloqreg,Umodifw,Ualtafw,Smodifw,Valtafw,Zadsfw,Vmodifw,Haltafw,Saltafw,Esttrans,Bdmodifw,Horaexpo,Hmodifw,Bdaltafw,Horaimpo,Ccod,Cdes,Nascii)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.BLOQREG,0),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.SALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.CCOD,''),isnull( d.CDES,''),isnull( d.NASCII,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="FECHAIMPO                               " tabla="TIPREGEXP      " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="FECHATRANSFERENCIA                      " tabla="TIPREGEXP      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="FECHAMODIFICACIONFW                     " tabla="TIPREGEXP      " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="FECHAEXPO                               " tabla="TIPREGEXP      " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="SERIEMODIFICACIONFW                     " tabla="TIPREGEXP      " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="VERSIONALTAFW                           " tabla="TIPREGEXP      " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="VERSIONMODIFICACIONFW                   " tabla="TIPREGEXP      " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="ESTADOTRANSFERENCIA                     " tabla="TIPREGEXP      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="HORAEXPO                                " tabla="TIPREGEXP      " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="CODIGO                                  " tabla="TIPREGEXP      " campo="CCOD      " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="1" etiqueta="Código                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TIPOREGISTROEXPORTACION                 " atributo="DESCRIPCION                             " tabla="TIPREGEXP      " campo="CDES      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="2" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
