...
define class Mock_Itemherramientaconciliaciondetalleregistros as MockBase of MockBase.prg

	cClase = 'Itemherramientaconciliaciondetalleregistros'
	...
	*-----------------------------------------------------------------------------------------
	function fechadeoperacion_assign( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Fechadeoperacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function registro_access() as variant                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Registro_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function registro_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Registro_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechadeoperacion( txval as variant ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Setear_fechadeoperacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechadeoperacion( txval as variant ) as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_fechadeoperacion', lcParametros )
	EndFunc
