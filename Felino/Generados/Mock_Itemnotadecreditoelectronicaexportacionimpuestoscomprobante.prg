...
define class Mock_Itemnotadecreditoelectronicaexportacionimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditoelectronicaexportacionimpuestoscomprobante'
