...
define class Mock_liquidacionmensual as MockBase of MockBase.prg
	...
	lGrabaSinGenerarRegistroConciliable = .f.                                                                                                                                                                                                                 
	...
	lTieneRegistrosConciliablesAntiguos = .f.                                                                                                                                                                                                                 
	...
	oConceptosDeLiquidacion = null                                                                                                                                                                                                                            
	oExtension = null                                                                                                                                                                                                                                         
	oGestorDeMail = null                                                                                                                                                                                                                                      
	oInformacion = null                                                                                                                                                                                                                                       
	oLiquidacionesDiarias = null                                                                                                                                                                                                                              
	oLogueo = null                                                                                                                                                                                                                                            
	oMensaje = null                                                                                                                                                                                                                                           
	oNumeraciones =  null                                                                                                                                                                                                                                     
	oObservadoresDeImportacion = null                                                                                                                                                                                                                         
	oProcedimientosAlmacenados = null                                                                                                                                                                                                                         
	...
	*-----------------------------------------------------------------------------------------
	function agregarconceptosmensuales() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Agregarconceptosmensuales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function asignartotal() as void                                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Asignartotal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleconceptosdiarios() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cambiosdetalleconceptosdiarios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleconceptosgenerales() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Cambiosdetalleconceptosgenerales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarimpuestosliquidacion() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarimpuestosliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarliquidaciones()                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cargarliquidaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarliquidacionesdiarias() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarliquidacionesdiarias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarliquidacionesgenerales() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarliquidacionesgenerales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventobusquedadeliquidacion( tobusqueda as object ) as void                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventobusquedadeliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajerecalculo() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventomensajerecalculo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntasideseagrabarsingenerarregistroconciliable() as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntasideseagrabarsingenerarregistroconciliable', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorefrescardetallegral() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorefrescardetallegral', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaliq_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaliq_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaliq_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaliq		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaliq( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Fechaliq( lxVal )			EndIf		Else			This.Setear_Fechaliq( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarcodigoderegistrodecuenta() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarcodigoderegistrodecuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function idregistrodecuenta_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'idregistrodecuenta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'idregistrodecuenta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Idregistrodecuenta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Idregistrodecuenta( lxVal )				this.Setear_Idregistrodecuenta( lxVal )			EndIf		Else			This.Setear_Idregistrodecuenta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiariditemcomponente( todetalle as object ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Limpiariditemcomponente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function loguearpersonalizado( tcpregunta ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Loguearpersonalizado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function modificarliq() as void                                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Modificarliq', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numeroliquidacion_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numeroliquidacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numeroliquidacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numeroliquidacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numeroliquidacion( lxVal )				this.Setear_Numeroliquidacion( lxVal )			EndIf		Else			This.Setear_Numeroliquidacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripcioncomplementariavalorcomprobante( tovalor as object ) as string                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function obtenerliqudacionesdiarias() as object                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerliqudacionesdiarias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerliqudacionesgenerales() as collection                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerliqudacionesgenerales', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerliquidacionesdiariasincluidas() as string                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerliquidacionesdiariasincluidas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function otrosimpuestos_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'otrosimpuestos_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'otrosimpuestos_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Otrosimpuestos		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Otrosimpuestos( lxVal )				this.Setear_Otrosimpuestos( lxVal )			EndIf		Else			This.Setear_Otrosimpuestos( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function poblarcoleccionesdeimpuestos( toitem as object ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Poblarcoleccionesdeimpuestos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function poblarimpuestoscomprobantes( toitem as object ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Poblarimpuestoscomprobantes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function poblarimpuestosdetalle( toitem as object ) as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Poblarimpuestosdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puntodeventaliquidacion_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'puntodeventaliquidacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'puntodeventaliquidacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Puntodeventaliquidacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Puntodeventaliquidacion( lxVal )				this.Setear_Puntodeventaliquidacion( lxVal )			EndIf		Else			This.Setear_Puntodeventaliquidacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaliq( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaliq', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaliq', lcParametros )			endif		endif		this.Fechaliq = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_idregistrodecuenta( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_idregistrodecuenta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_idregistrodecuenta', lcParametros )			endif		endif		this.Idregistrodecuenta = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_numeroliquidacion( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numeroliquidacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numeroliquidacion', lcParametros )			endif		endif		this.Numeroliquidacion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_operadora( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_operadora', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_operadora', lcParametros )			endif		endif		this.Operadora.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_otrosimpuestos( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_otrosimpuestos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_otrosimpuestos', lcParametros )			endif		endif		this.Otrosimpuestos = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_puntodeventaliquidacion( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_puntodeventaliquidacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_puntodeventaliquidacion', lcParametros )			endif		endif		this.Puntodeventaliquidacion = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_subtotal( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_subtotal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_subtotal', lcParametros )			endif		endif		this.Subtotal = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_totalgravado( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_totalgravado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_totalgravado', lcParametros )			endif		endif		this.Totalgravado = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_totaliva( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_totaliva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_totaliva', lcParametros )			endif		endif		this.Totaliva = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_totalliquidacion( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_totalliquidacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_totalliquidacion', lcParametros )			endif		endif		this.Totalliquidacion = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_totalnogravado( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_totalnogravado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_totalnogravado', lcParametros )			endif		endif		this.Totalnogravado = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_totalotroiva( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_totalotroiva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_totalotroiva', lcParametros )			endif		endif		this.Totalotroiva = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function subtotal_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'subtotal_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'subtotal_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Subtotal		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Subtotal( lxVal )				this.Setear_Subtotal( lxVal )			EndIf		Else			This.Setear_Subtotal( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalgravado_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'totalgravado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'totalgravado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Totalgravado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Totalgravado( lxVal )				this.Setear_Totalgravado( lxVal )			EndIf		Else			This.Setear_Totalgravado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function totaliva_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'totaliva_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'totaliva_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Totaliva		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Totaliva( lxVal )				this.Setear_Totaliva( lxVal )			EndIf		Else			This.Setear_Totaliva( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function totalliquidacion_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'totalliquidacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'totalliquidacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Totalliquidacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Totalliquidacion( lxVal )				this.Setear_Totalliquidacion( lxVal )			EndIf		Else			This.Setear_Totalliquidacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function totalnogravado_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'totalnogravado_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'totalnogravado_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Totalnogravado		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Totalnogravado( lxVal )				this.Setear_Totalnogravado( lxVal )			EndIf		Else			This.Setear_Totalnogravado( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function totalotroiva_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'totalotroiva_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'totalotroiva_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Totalotroiva		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Totalotroiva( lxVal )				this.Setear_Totalotroiva( lxVal )			EndIf		Else			This.Setear_Totalotroiva( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaliq( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaliq', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaliq', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_idregistrodecuenta( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_idregistrodecuenta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_idregistrodecuenta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_numeroliquidacion( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numeroliquidacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numeroliquidacion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_operadora( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_operadora', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_operadora', lcParametros )			endif		endif		local llRetorno as Boolean		llRetorno = dodefault( txVal, txValOld )		if llRetorno and txVal <> txValOld			this.CargarLiquidaciones()		endif 			return llRetorno
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_otrosimpuestos( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_otrosimpuestos', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_otrosimpuestos', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_puntodeventaliquidacion( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_puntodeventaliquidacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_puntodeventaliquidacion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_subtotal( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_subtotal', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_subtotal', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_totalgravado( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_totalgravado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_totalgravado', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_totaliva( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_totaliva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_totaliva', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_totalliquidacion( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_totalliquidacion', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_totalliquidacion', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_totalnogravado( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_totalnogravado', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_totalnogravado', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_totalotroiva( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_totalotroiva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_totalotroiva', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechaliq() as boolean                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validarfechaliq', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarmodificacionliquidacionesdiarias() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarmodificacionliquidacionesdiarias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaroperadora() as boolean                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validaroperadora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechaliq() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorsugeridofechaliq', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechadesde() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechadesde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwfechaliq() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridofwfechaliq', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumeroliquidacion() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridonumeroliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridooperadora() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridooperadora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopuntodeventaliquidacion() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridopuntodeventaliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function oconceptosdeliquidacion_access() as object                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oconceptosdeliquidacion_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oconceptosdeliquidacion_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oConceptosDeLiquidacion ) = 'O' or isnull( this.oConceptosDeLiquidacion ))			this.oConceptosDeLiquidacion = _Screen.zoo.InstanciarEntidad( "CONCEPTOLIQUIDACIONTARJETA" )		endif		return this.oConceptosDeLiquidacion
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oliquidacionesdiarias_access() as object                                                                                                                                                                                               
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oliquidacionesdiarias_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oliquidacionesdiarias_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oLiquidacionesDiarias ) = 'O' or isnull( this.oLiquidacionesDiarias) )			this.oLiquidacionesDiarias = _Screen.zoo.InstanciarEntidad( "LiquidacionDiaria" )		endif		return this.oLiquidacionesDiarias
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function oprocedimientosalmacenados_access() as object                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'LIQUIDACIONMENSUAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oprocedimientosalmacenados_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oprocedimientosalmacenados_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oProcedimientosAlmacenados ) = 'O' or isnull( this.oProcedimientosAlmacenados ) )			this.oProcedimientosAlmacenados = _screen.zoo.CrearObjeto( "Din_ProcedimientosAlmacenados" )			this.oProcedimientosAlmacenados.oConexion = goServicios.Datos		endif		return this.oProcedimientosAlmacenados
	EndFunc
