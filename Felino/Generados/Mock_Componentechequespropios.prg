...
*!* -->		#INCLUDE VALORES.H
*!*		#INCLUDE VALORES.H   <--
define class Mock_COMPONENTECHEQUESPROPIOS as MockBase of MockBase.prg

	cClase = 'COMPONENTECHEQUESPROPIOS'
	...
	*-----------------------------------------------------------------------------------------
	function actualizarmemoriachequepropio( tocheque as componente_itemdatoscheque ) as void                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Actualizarmemoriachequepropio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function invocarobtenerobjetocheque(toitem as object) as object                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Invocarobtenerobjetocheque', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernumerochequepropiodeunregistroconciliable( tccodigoregistroconciliable ) as string                                                                                                                                                        
		...
		lnParametros = pcount()
		lxParam1 = tccodigoregistroconciliable
		...
		return this.ObtenerResultado( 'Obtenernumerochequepropiodeunregistroconciliable', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ochequepropio_access()                                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Ochequepropio_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompcuentabancariachequespropios_access() as variant                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Ocompcuentabancariachequespropios_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargardesdelaconciliacionlosvalorescircuitochequepropio() as void                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Cargardesdelaconciliacionlosvalorescircuitochequepropio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esordendepagousandocarteradecheques( toentidad as entidad of entidad.prg ) as boolean                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Esordendepagousandocarteradecheques', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerchequera( tcchequera_pk as string ) as entidad of entidad.prg                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerchequera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearenelchequeacancelardatosdecancelacionsegunentidadpadre() as void                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setearenelchequeacancelardatosdecancelacionsegunentidadpadre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarunicidadnumeroychequeraencoleccion( tcchequera as string, tnnumero as integer , tlchequeraelectronica as boolean) as boolean                                                                                                    
		...
		lxParam1 = tcchequera
		lxParam2 = tnnumero
		lxParam3 = tlchequeraelectronica
		...
		return this.ObtenerResultado( 'Validarunicidadnumeroychequeraencoleccion', lcParametros )
	EndFunc
