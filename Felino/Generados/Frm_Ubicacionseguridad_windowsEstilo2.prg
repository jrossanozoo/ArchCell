...
define class Frm_Ubicacionseguridad_windowsEstilo2 as Ubicacionseguridad_windows of Ubicacionseguridad_windows.vcx
	ColControles = null
	...
	*-----------------------------------------------------------------------------------------
	...
	function SeteosVisuales() as boolean
		...
		************* ubicacionseguridad_windows/78d1cq9ei/Form
		...
		with this
			...
			.HEIGHT = 164
			.LEFT = 301
			.NAME = [ubicacionseguridad_windows]
			.TOP = 209
			.WIDTH = 497
			.WINDOWTYPE = 0
