...
define class Mock_COMPONENTECUENTACORRIENTEVALORESCOMPRAS as MockBase of MockBase.prg

	cClase = 'COMPONENTECUENTACORRIENTEVALORESCOMPRAS'

	
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	colInfoAdicionalAuxiliar = null                                                                                                                                                                                                                           
	lAnular = .f.                                                                                                                                                                                                                                             
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	lEdicion = .F.                                                                                                                                                                                                                                            
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	lNuevo = .F.                                                                                                                                                                                                                                              
	nDataSessionCtaCte = 0                                                                                                                                                                                                                                    
	nSignoDeMovimiento = 0                                                                                                                                                                                                                                    
	nSignoDeMovimiento = 1 && Signo del movimiento que va a realizar en la cuenta corriente                                                                                                                                                                   
	nThisDataSession = 0                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function colinfoadicionalauxiliar_access() as variant                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Colinfoadicionalauxiliar_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debeprocesarelitem( tntipo as integer ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Debeprocesarelitem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercolsentenciasfinal() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercolsentenciasfinal', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercursordeimpuestos( tcentidad ) as string                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercursordeimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oinformacionadicional_access() as variant                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oinformacionadicional_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ovalidaciones_access() as variant                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ovalidaciones_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearcombinacion( toitem as object ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function setearcombinacionycargar( toitem as object ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearcombinacionycargar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearsignodelmovimiento( tnsigno ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Setearsignodelmovimiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarcamposfaltantescursordetalle( toentidad as object, tccursordetalle as string ) as void                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toentidad
		lxParam2 = tccursordetalle
		...
		return this.ObtenerResultado( 'Agregarcamposfaltantescursordetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function armarcodigocuentacorriente ( toentidad as object, toitem as object ) as string                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Armarcodigocuentacorriente', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function asignarmontosenentidad( toitem as object ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Asignarmontosenentidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function asignarproveedorenentidadpadre( toitem as object ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Asignarproveedorenentidadpadre', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function asignarvalorenitem( toitem as object ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Asignarvalorenitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function asignarvencimientoenentidad( toitem as object ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Asignarvencimientoenentidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function asignaryvalidar( tntotal as float, tnsaldo as float ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Asignaryvalidar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existenformasdepagoencuentacorrienteendetallevalores() as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existenformasdepagoencuentacorrienteendetallevalores', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function generarconsultaprincipalagrupada( toentidad as object, tcatributodetalle as string, tccursordetalle as string , tccursorcabecera as string ) as void                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Generarconsultaprincipalagrupada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function insertarencoleccionagrupada( tocolagrupada as zoocoleccion of zoocoleccion.prg, tcvalor_pk as string, tdfecha as date, toitem as object,  tlagrupaporcomprobante as boolean, tlespagoacuenta as boolean ) as void                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6

		lnParametros = pcount()
		lxParam1 = tocolagrupada
		lxParam2 = tcvalor_pk
		lxParam3 = tdfecha
		lxParam4 = toitem
		lxParam5 = tlagrupaporcomprobante
		lxParam6 = tlespagoacuenta
		...
		return this.ObtenerResultado( 'Insertarencoleccionagrupada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function mensajecomprobanteafectado( tcaccionactual as string ) as void                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcaccionactual
		...
		return this.ObtenerResultado( 'Mensajecomprobanteafectado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function modificacioncuentacorriente ( toitem as object ) as string                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Modificacioncuentacorriente', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function nuevoencuentacorriente ( toitem as object ) as string                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Nuevoencuentacorriente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccionvaloresagrupados( tocolvalores as zoocoleccion of zoocoleccion.prg ) as zoocoleccion of zoocoleccion.prg                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocolvalores
		...
		return this.ObtenerResultado( 'Obtenercoleccionvaloresagrupados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercolsentenciasanterior() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercolsentenciasanterior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercolsentenciasdentrodelfor( tocolsentencias as zoocoleccion of zoocoleccion.prg, toitem as object ) as void                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tocolsentencias
		lxParam2 = toitem
		...
		return this.ObtenerResultado( 'Obtenercolsentenciasdentrodelfor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercolsentenciasdespuesdelfor( tocolsentencias as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercolsentenciasdespuesdelfor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenermontovalortipoccendetalleactual() as number                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermontovalortipoccendetalleactual', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenermontovalortipoccendetalleanterior() as number                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermontovalortipoccendetalleanterior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertotalcuentacorriente() as float                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertotalcuentacorriente', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertotaldevaloresendetalleactual() as number                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertotaldevaloresendetalleactual', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertotaldevaloresendetalleanterior() as number                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertotaldevaloresendetalleanterior', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenervotoanularmodificar( tcaccionactual as string ) as boolean                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenervotoanularmodificar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function prepararxmlctacte( toentidad  as object, tccursordetalle as string ) as zoocoleccion of zoocoleccion.prg                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Prepararxmlctacte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function procesarvaloresctacte( tccursordetalle as string ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tccursordetalle
		...
		return this.ObtenerResultado( 'Procesarvaloresctacte', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function serealizocambiodeproveedor() as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Serealizocambiodeproveedor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function setearcombinacionenentidad( tcvalor_pk, tdfecha, tntipocomprobante, tcletra, tnpuntodeventa,  tnpuntodeventaextendido, tnnumero, tnsignodemovimiento, tccodigocomprobante ) as void                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6, lxParam7, lxParam8, lxParam9
		...
		lxParam4 = tcletra
		lxParam5 = tnpuntodeventa
		lxParam6 = tnpuntodeventaextendido
		lxParam7 = tnnumero
		lxParam8 = tnsignodemovimiento
		lxParam9 = tccodigocomprobante
		...
		return this.ObtenerResultado( 'Setearcombinacionenentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function seteardescripcionenitem( toitemnuevo as object, toitem as object ) as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toitemnuevo
		lxParam2 = toitem
		...
		return this.ObtenerResultado( 'Seteardescripcionenitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearfechaenitem( toitem as object, tdfecha as date ) as void                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Setearfechaenitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function setearpagoacuentaenitem( toitem as object, tlespagoacuenta as boolean  ) as void                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toitem
		lxParam2 = tlespagoacuenta
		...
		return this.ObtenerResultado( 'Setearpagoacuentaenitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarbasicasantesdegrabar() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarbasicasantesdegrabar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarcomponenteantesdeanular() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcomponenteantesdeanular', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarcomponenteantesdegrabar() as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcomponenteantesdegrabar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarentidad() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function validarentidadesexcluidas() as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarentidadesexcluidas', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validartotalcuentacorriente() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validartotalcuentacorriente', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validarvalores_ctacte_vs_otrosvalores() as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarvalores_ctacte_vs_otrosvalores', lcParametros )
	EndFunc
