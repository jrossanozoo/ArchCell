...
define class Din_EntidadIMPRESIONDEETIQUETAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxImpetFecexpo, lxImpetFectrans, lxImpetFmodifw, lxImpetFaltafw, lxImpetFecimpo, lxImpetNumero, lxImpetTimestamp, lxImpetSmodifw, lxImpetUaltafw, lxImpetSaltafw, lxImpetUmodifw, lxImpetZadsfw, lxImpetValtafw, lxImpetVmodifw, lxImpetHmodifw, lxImpetHaltafw, lxImpetHoraimpo, lxImpetBdaltafw, lxImpetBdmodifw, lxImpetEsttrans, lxImpetHoraexpo, lxImpetClobs, lxImpetFecha, lxImpetDescri, lxImpetDhora, lxImpetSerie, lxImpetDusuario
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.IMPET ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Numero","Timestamp","Smodifw","Ualtafw","Saltafw","Umodifw","Zadsfw","Valtafw","Vmodifw","Hmodifw","Haltafw","Horaimpo","Bdaltafw","Bdmodifw","Esttrans","Horaexpo","Clobs","Fecha","Descri","Dhora","Serie","Dusuario" ) values ( <<"'" + this.ConvertirDateSql( lxImpetFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpetFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpetFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpetFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpetFecimpo ) + "'" >>, <<lxImpetNumero >>, <<lxImpetTimestamp >>, <<"'" + this.FormatearTextoSql( lxImpetSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetClobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxImpetFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetDescri ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetDhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetSerie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxImpetDusuario ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.IMPET set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxImpetFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxImpetFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxImpetFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxImpetFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxImpetFecimpo ) + "'">>,"Numero" = <<lxImpetNumero>>,"Timestamp" = <<lxImpetTimestamp>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxImpetSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxImpetUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxImpetSaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxImpetUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxImpetZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxImpetValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxImpetVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxImpetHmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxImpetHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxImpetHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxImpetBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxImpetBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxImpetEsttrans ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxImpetHoraexpo ) + "'">>,"Clobs" = <<"'" + this.FormatearTextoSql( lxImpetClobs ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxImpetFecha ) + "'">>,"Descri" = <<"'" + this.FormatearTextoSql( lxImpetDescri ) + "'">>,"Dhora" = <<"'" + this.FormatearTextoSql( lxImpetDhora ) + "'">>,"Serie" = <<"'" + this.FormatearTextoSql( lxImpetSerie ) + "'">>,"Dusuario" = <<"'" + this.FormatearTextoSql( lxImpetDusuario ) + "'">> where "Numero" = <<lxImpetNumero>> and  IMPET.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Mart" as "Articulo", "Nroitem" as "Nroitem", "Comp" as "Comportamiento", "Numero" as "Numero", "Descrip" as "Articulodetalle", "Equiv" as "Equivalencia", "Mcolo" as "Color", "Mdes" as "Colordetalle", "Mtall" as "Talle", "Canti" as "Cantidad" from ZooLogic.ImpEtDet where numero = <<transform( c_IMPRESIONDEETIQUETA.NUMERO )>> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Numero,Timestamp,Smodifw,Ualtafw,Saltafw,Umodifw,Za" + ;
"dsfw,Valtafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Horaexpo,Clobs,Fecha,Descri" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleETIQUETADETALLE( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Mart" as "Articulo", "Nroitem" as "Nroitem", "Comp" as "Comportamiento", "Numero" as "Numero", "Descrip" as "Articulodetalle", "Equiv" as "Equivalencia", "Mcolo" as "Color", "Mdes" as "Colordetalle", "Mtall" as "Talle", "Canti" as "Cantidad"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.ETIQUETADETALLE
				if this.oEntidad.ETIQUETADETALLE.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ImpEtDet("MART","NROITEM","COMP","NUMERO","DESCRIP","Equiv","MCOLO","MDES","MTALL","CANTI" ) values ( <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<lxNroitem>>, <<lxComportamiento>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxCantidad>> ) 
					endtext
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.IMPET set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, numero = ] + transform( &lcCursor..numero )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, CLOBS = ] + "'" + this.FormatearTextoSql( &lcCursor..CLOBS ) + "'"+ [, fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..fecha ) + "'"+ [, Descri = ] + "'" + this.FormatearTextoSql( &lcCursor..Descri ) + "'"+ [, dHora = ] + "'" + this.FormatearTextoSql( &lcCursor..dHora ) + "'"+ [, Serie = ] + "'" + this.FormatearTextoSql( &lcCursor..Serie ) + "'"+ [, dUsuario = ] + "'" + this.FormatearTextoSql( &lcCursor..dUsuario ) + "'" + [ Where numero = ] + transform( &lcCursor..numero ) )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, numero, TIMESTAMP, SMODIFW, UALTAFW, SALTAFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, HMODIFW, HALTAFW, HORAIMPO, BDALTAFW, BDMODIFW, ESTTRANS, HORAEXPO, CLOBS, fecha, Descri, dHora, Serie, dUsuario
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + transform( &lcCursor..numero ) + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CLOBS = isnull( d.CLOBS, t.CLOBS ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.DESCRI = isnull( d.DESCRI, t.DESCRI ),t.DHORA = isnull( d.DHORA, t.DHORA ),t.SERIE = isnull( d.SERIE, t.SERIE ),t.DUSUARIO = isnull( d.DUSUARIO, t.DUSUARIO )
					from ZooLogic.IMPET t inner join deleted d 
							 on t.numero = d.numero
				-- Fin Updates
				insert into ZooLogic.IMPET(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Numero,Timestamp,Smodifw,Ualtafw,Saltafw,Umodifw,Zadsfw,Valtafw,Vmodifw,Hmodifw,Haltafw,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Horaexpo,Clobs,Fecha,Descri,Dhora,Serie,Dusuario)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.NUMERO,0),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAEXPO,''),isnull( d.CLOBS,''),isnull( d.FECHA,''),isnull( d.DESCRI,''),isnull( d.DHORA,''),isnull( d.SERIE,''),isnull( d.DUSUARIO,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="IMPRESIONDEETIQUETA                     " atributo="FECHATRANSFERENCIA                      " tabla="IMPET          " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPRESIONDEETIQUETA                     " atributo="ESTADOTRANSFERENCIA                     " tabla="IMPET          " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
