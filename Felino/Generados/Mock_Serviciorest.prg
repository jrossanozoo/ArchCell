...
define class Mock_serviciorest as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Servicio REST"                                                                                                                                                                                                                           
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'SERVICIOREST'                                                                                                                                                                                                                                  
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
		...
		return this.ObtenerResultado( 'Prepararentornoorganic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function activo_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'activo_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'activo_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Activo		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Activo( lxVal )				this.Setear_Activo( lxVal )			EndIf		Else			This.Setear_Activo( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cajaactiva_access() as variant                                                                                                                                                                                                                   
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cajaactiva_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cajaactiva_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Cajaactiva ) = 'O' or isnull( this.Cajaactiva ) )					this.Cajaactiva = _Screen.zoo.instanciarentidad( 'Cajaestado' )					this.Cajaactiva.lEsSubEntidad = .t.					this.enlazar( 'Cajaactiva.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Cajaactiva.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Cajaactiva.ID # this.Cajaactiva_PK						this.Cajaactiva.ID = this.Cajaactiva_PK					endif				endif			endif		endif		return this.Cajaactiva
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cajaactiva_pk_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'cajaactiva_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'cajaactiva_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Cajaactiva_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		this.Cajaactiva_PK = lxVal		if this.Validar_Cajaactiva( lxVal, lxValOld )			This.Setear_Cajaactiva( lxVal )		endif		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetalledominioscors() as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledominioscors', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cerrarhost() as void                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Cerrarhost', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cerrarhostasync() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Cerrarhostasync', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cerrarservicio() as void                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Cerrarservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function definirgenerarlogueos() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Definirgenerarlogueos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function dominioscors_access() as variant                                                                                                                                                                                                                 
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'dominioscors_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'dominioscors_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Dominioscors ) = 'O' or isnull( this.Dominioscors ) )			this.Dominioscors = this.crearobjeto( 'Din_DetalleServiciorestDominioscors' )			this.Dominioscors.inicializar()			this.enlazar( 'Dominioscors.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Dominioscors.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Dominioscors, 'CambioSumarizado', this, 'CambiosDetalleDominioscors', 1)			this.enlazar( 'Dominioscors.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Dominioscors.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Dominioscors
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoactualizarcontrolvalor( ) as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventoactualizarcontrolvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoinformarestadocierreservicio( tcmensaje as string ) as void                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Eventoinformarestadocierreservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoinformarreinicioservicio() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Eventoinformarreinicioservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoprogresodeinstanciaservicio( tcmensaje as string ) as void                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Eventoprogresodeinstanciaservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoservicioinstanciado() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eventoservicioinstanciado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existeimpresora( tcimpresora ) as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Existeimpresora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function huboalguncambiodeconfiguracion() as as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Huboalguncambiodeconfiguracion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function impresorapredeterminada_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'impresorapredeterminada_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'impresorapredeterminada_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Impresorapredeterminada		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Impresorapredeterminada( lxVal )				this.Setear_Impresorapredeterminada( lxVal )			EndIf		Else			This.Setear_Impresorapredeterminada( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarservicio() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Iniciarservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function logueoshasta_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'logueoshasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'logueoshasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Logueoshasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Logueoshasta( lxVal )				this.ValidarDominio_Fechacalendario( lxVal )				this.Setear_Logueoshasta( lxVal )			EndIf		Else			This.Setear_Logueoshasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerimpresorapredeterminadadelsistema() as string                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerimpresorapredeterminadadelsistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocultarventasenapp_assign( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocultarventasenapp_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocultarventasenapp_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Ocultarventasenapp		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Ocultarventasenapp( lxVal )				this.Setear_Ocultarventasenapp( lxVal )			EndIf		Else			This.Setear_Ocultarventasenapp( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadaux_access() as void                                                                                                                                                                                                                     
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oentidadaux_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oentidadaux_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oEntidadAux ) = 'O' or isnull( this.oEntidadAux ) )			this.oEntidadAux = _screen.zoo.instanciarentidad(  "SERVICIOREST", , .t. )		endif		return this.oEntidadAux
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ofactoryservicioproducto_access() as void                                                                                                                                                                                                        
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ofactoryservicioproducto_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ofactoryservicioproducto_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oFactoryServicioProducto ) = 'O' or isnull( this.oFactoryServicioProducto ) )			this.oFactoryServicioProducto = _screen.zoo.crearobjetoPorProducto( "FactoryServicioProducto" )		endif		return this.oFactoryServicioProducto
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function origencomprobante_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'origencomprobante_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'origencomprobante_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Origencomprobante		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Origencomprobante( lxVal )				this.Setear_Origencomprobante( lxVal )			EndIf		Else			This.Setear_Origencomprobante( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puesto_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'puesto_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'puesto_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Puesto		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Puesto( lxVal )				this.Setear_Puesto( lxVal )			EndIf		Else			This.Setear_Puesto( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_activo( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_activo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_activo', lcParametros )			endif		endif		this.Activo = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cajaactiva( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_cajaactiva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_cajaactiva', lcParametros )			endif		endif		this.Cajaactiva.ID = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_impresorapredeterminada( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_impresorapredeterminada', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_impresorapredeterminada', lcParametros )			endif		endif		this.Impresorapredeterminada = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_logueoshasta( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_logueoshasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_logueoshasta', lcParametros )			endif		endif		this.Logueoshasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_ocultarventasenapp( txval as variant ) as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_ocultarventasenapp', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_ocultarventasenapp', lcParametros )			endif		endif		this.Ocultarventasenapp = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_origencomprobante( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_origencomprobante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_origencomprobante', lcParametros )			endif		endif		this.Origencomprobante = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_puesto( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_puesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_puesto', lcParametros )			endif		endif		this.Puesto = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_activo( txval as variant ) as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_activo', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_activo', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cajaactiva( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_cajaactiva', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_cajaactiva', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_ocultarventasenapp( txval as variant ) as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_ocultarventasenapp', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_ocultarventasenapp', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_origencomprobante( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_origencomprobante', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_origencomprobante', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_puesto( txval as variant ) as boolean                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'SERVICIOREST' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_puesto', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_puesto', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcajaactiva() as boolean                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcajaactiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarpuertoenuso( txval ) as string                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validarpuertoenuso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoactivo() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoactivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocajaactiva() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridocajaactiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwactivo() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwactivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcajaactiva() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwcajaactiva', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofworigencomprobante() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofworigencomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwpuerto() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwpuerto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwpuesto() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwpuesto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoimpresorapredeterminada() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoimpresorapredeterminada', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridologueoshasta() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridologueoshasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoocultarventasenapp() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoocultarventasenapp', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridoorigencomprobante() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoorigencomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridopuesto() as void                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridopuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificariniciarservicios() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Verificariniciarservicios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function enviarsolicituddecierre( tcnombreendpoint as string, tnpuerto as integer ) as integer                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Enviarsolicituddecierre', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function estainiciado( tccodigoservicio as string, tnpuerto as integer ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Estainiciado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarcontroladorfiscal( tnorigencomprobante as integer ) as void                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Iniciarcontroladorfiscal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarlizarinformacionserie() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Iniciarlizarinformacionserie', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarlizarinformacionserieenusuariosyste() as void                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Iniciarlizarinformacionserieenusuariosyste', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarscriptservicio( tccodigoservicio as string, tnpuerto as integer ) as void                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Iniciarscriptservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function invocarmetodoobtenerinformacionservicio( tcnombreendpoint as string, tnpuerto as integer ) as void                                                                                                                                     
		...
		return this.ObtenerResultado( 'Invocarmetodoobtenerinformacionservicio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenernombewarchivoscript( tccodigoservicio as string, tnpuerto as integer ) as string                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenernombewarchivoscript', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenervalorcodigo( tojsoninformacionservicio as string ) as string                                                                                                                                                                    
		...
		lnParametros = pcount()
		lxParam1 = tojsoninformacionservicio
		...
		return this.ObtenerResultado( 'Obtenervalorcodigo', lcParametros )
	EndFunc
