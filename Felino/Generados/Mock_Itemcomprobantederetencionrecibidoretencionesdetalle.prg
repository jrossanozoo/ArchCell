...
define class Mock_Itemcomprobantederetencionrecibidoretencionesdetalle as MockBase of MockBase.prg

	cClase = 'Itemcomprobantederetencionrecibidoretencionesdetalle'
