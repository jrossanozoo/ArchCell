...
define class Din_EntidadREMITOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFecimpo, lxComprobantevFectrans, lxComprobantevFecexpo, lxComprobantevFd2, lxComprobantevFaltafw, lxComprobantevFmodifw, lxComprobantevDatosecomm, lxComprobantevFfch, lxComprobantevFpodes1, lxComprobantevMr, lxComprobantevRecpor, lxComprobantevFpodes2, lxComprobantevFletra, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevCotiz, lxComprobantevTimestamp, lxComprobantevMdcimpu, lxComprobantevFajxre, lxComprobantevFactsec, lxComprobantevMr2, lxComprobantevTotalcant, lxComprobantevSubtotsisi, lxComprobantevSubtotcisi, lxComprobantevSignomov, lxComprobantevCondivalp, lxComprobantevSitfisccli, lxComprobantevFsubton, lxComprobantevRecmnto, lxComprobantevFacttipo, lxComprobantevFsubtot, lxComprobantevRecmnto1, lxComprobantevRecmnto2, lxComprobantevDesmntosi2, lxComprobantevDesmntosi3, lxComprobantevRecmntosi2, lxComprobantevDesmntosi, lxComprobantevRecmntosi, lxComprobantevRecmntosi1, lxComprobantevDesmntosi1, lxComprobantevFcompfis, lxComprobantevOrigonline, lxComprobantevAnulado, lxComprobantevDesauto, lxComprobantevUmodifw, lxComprobantevUaltafw, lxComprobantevValtafw, lxComprobantevSmodifw, lxComprobantevEsttrans, lxComprobantevFhora, lxComprobantevHoraexpo, lxComprobantevHoraimpo, lxComprobantevHaltafw, lxComprobantevHmodifw, lxComprobantevBdmodifw, lxComprobantevVmodifw, lxComprobantevDespachos, lxComprobantevDescfw, lxComprobantevBdaltafw, lxComprobantevSimbmon, lxComprobantevSaltafw, lxComprobantevZadsfw, lxComprobantevOpecomm, lxComprobantevMonsis, lxComprobantevFobs, lxComprobantevFven, lxComprobantevFcuit, lxComprobantevMd1, lxComprobantevMd2, lxComprobantevFptoven, lxComprobantevFcliente, lxComprobantevFmtdes1, lxComprobantevFmtdes2, lxComprobantevCodigo, lxComprobantevFnumcomp, lxComprobantevFmtdes3, lxComprobantevMoneda, lxComprobantevTdci, lxComprobantevEntregapos, lxComprobantevTotdescsi, lxComprobantevCodlista, lxComprobantevFpago, lxComprobantevMotivo, lxComprobantevFtransp, lxComprobantevFtotal, lxComprobantevDirentr, lxComprobantevFpodes, lxComprobantevFdescu, lxComprobantevMerconsign, lxComprobantevDeuda, lxComprobantevMd3, lxComprobantevMr1, lxComprobantevPercepcion, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTrci, lxComprobantevTotrecar, lxComprobantevTotrecarsi, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevIvasis
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fecimpo","Fectrans","Fecexpo","Fd2","Faltafw","Fmodifw","Datosecomm","Ffch","Fpodes1","Mr","Recpor","Fpodes2","Fletra","Fperson","Fturno","Cotiz","Timestamp","Mdcimpu","Fajxre","Factsec","Mr2","Totalcant","Subtotsisi","Subtotcisi","Signomov","Condivalp","Sitfisccli","Fsubton","Recmnto","Facttipo","Fsubtot","Recmnto1","Recmnto2","Desmntosi2","Desmntosi3","Recmntosi2","Desmntosi","Recmntosi","Recmntosi1","Desmntosi1","Fcompfis","Origonline","Anulado","Desauto","Umodifw","Ualtafw","Valtafw","Smodifw","Esttrans","Fhora","Horaexpo","Horaimpo","Haltafw","Hmodifw","Bdmodifw","Vmodifw","Despachos","Descfw","Bdaltafw","Simbmon","Saltafw","Zadsfw","Opecomm","Monsis","Fobs","Fven","Fcuit","Md1","Md2","Fptoven","Fcliente","Fmtdes1","Fmtdes2","Codigo","Fnumcomp","Fmtdes3","Moneda","Tdci","Entregapos","Totdescsi","Codlista","Fpago","Motivo","Ftransp","Ftotal","Direntr","Fpodes","Fdescu","Merconsign","Deuda","Md3","Mr1","Percepcion","Gravamen","Fimpuesto","Trci","Totrecar","Totrecarsi","Totdesc","Totimpue","Ivasis" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevFpodes1 >>, <<lxComprobantevMr >>, <<lxComprobantevRecpor >>, <<lxComprobantevFpodes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<lxComprobantevCotiz >>, <<lxComprobantevTimestamp >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevFajxre >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevMr2 >>, <<lxComprobantevTotalcant >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevSignomov >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevFsubton >>, <<lxComprobantevRecmnto >>, <<lxComprobantevFacttipo >>, <<lxComprobantevFsubtot >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevDesmntosi1 >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevOrigonline, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevDesauto, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevMd1 >>, <<lxComprobantevMd2 >>, <<lxComprobantevFptoven >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevFmtdes3 >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<lxComprobantevTdci >>, <<lxComprobantevEntregapos >>, <<lxComprobantevTotdescsi >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotivo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFtransp ) + "'" >>, <<lxComprobantevFtotal >>, <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'" >>, <<lxComprobantevFpodes >>, <<lxComprobantevFdescu >>, <<iif( lxComprobantevMerconsign, 1, 0 ) >>, <<lxComprobantevDeuda >>, <<lxComprobantevMd3 >>, <<lxComprobantevMr1 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTrci >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<lxComprobantevIvasis >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Datosecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Mr" = <<lxComprobantevMr>>,"Recpor" = <<lxComprobantevRecpor>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Cotiz" = <<lxComprobantevCotiz>>,"Timestamp" = <<lxComprobantevTimestamp>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Fajxre" = <<lxComprobantevFajxre>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Mr2" = <<lxComprobantevMr2>>,"Totalcant" = <<lxComprobantevTotalcant>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Signomov" = <<lxComprobantevSignomov>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Fsubton" = <<lxComprobantevFsubton>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Origonline" = <<iif( lxComprobantevOrigonline, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Desauto" = <<iif( lxComprobantevDesauto, 1, 0 )>>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Despachos" = <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Md2" = <<lxComprobantevMd2>>,"Fptoven" = <<lxComprobantevFptoven>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Tdci" = <<lxComprobantevTdci>>,"Entregapos" = <<lxComprobantevEntregapos>>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Fpago" = <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'">>,"Motivo" = <<"'" + this.FormatearTextoSql( lxComprobantevMotivo ) + "'">>,"Ftransp" = <<"'" + this.FormatearTextoSql( lxComprobantevFtransp ) + "'">>,"Ftotal" = <<lxComprobantevFtotal>>,"Direntr" = <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'">>,"Fpodes" = <<lxComprobantevFpodes>>,"Fdescu" = <<lxComprobantevFdescu>>,"Merconsign" = <<iif( lxComprobantevMerconsign, 1, 0 )>>,"Deuda" = <<lxComprobantevDeuda>>,"Md3" = <<lxComprobantevMd3>>,"Mr1" = <<lxComprobantevMr1>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Trci" = <<lxComprobantevTrci>>,"Totrecar" = <<lxComprobantevTotrecar>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Ivasis" = <<lxComprobantevIvasis>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Ffch" as "Fecha", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fpodes2" as "Porcentajedescuento2", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Timestamp" as "Timestamp", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Factsec" as "Secuencia", "Mr2" as "Recargomonto2", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Recmnto" as "Recargomontoconimpuestos", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Despachos" as "Despachos", "Descfw" as "Descripcionfw", "Bdaltafw" as "Basededatosaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Opecomm" as "Nroopecommerce", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Tdci" as "Totaldescuentosconimpuestos", "Entregapos" as "Entregaposterior", "Totdescsi" as "Totaldescuentossinimpuestos", "Codlista" as "Listadeprecios", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftransp" as "Transportista", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Montobase" as "Montobase", "Minimoper" as "Minimo", "Porcen" as "Porcentaje", "Sirecert" as "Certificadosire", "Minoimp" as "Minimonoimponible", "Monto" as "Monto", "Nroitem" as "Nroitem", "Sirecs" as "Codseguridadsire", "Base" as "Basedecalculo", "Regimenimp" as "Regimenimpositivo", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Codimp" as "Codigoimpuesto", "Descri" as "Descripcion", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_REMITO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Ffch" as "Fecha", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fpodes2" as "Porcentajedescuento2", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Timestamp" as "Timestamp", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Factsec" as "Secuencia", "Mr2" as "Recargomonto2", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Recmnto" as "Recargomontoconimpuestos", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Despachos" as "Despachos", "Descfw" as "Descripcionfw", "Bdaltafw" as "Basededatosaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Opecomm" as "Nroopecommerce", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Tdci" as "Totaldescuentosconimpuestos", "Entregapos" as "Entregaposterior", "Totdescsi" as "Totaldescuentossinimpuestos", "Codlista" as "Listadeprecios", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftransp" as "Transportista", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 And FACTTIPO = <<lxComprobanteVFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxComprobanteVFLETRA ) + "'">> and FPTOVEN = <<lxComprobanteVFPTOVEN>> and FNUMCOMP = <<lxComprobanteVFNUMCOMP>> and FACTSEC = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFACTSEC ) + "'">>
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			if reccount( 'c_REMITO' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Ffch" as "Fecha", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fpodes2" as "Porcentajedescuento2", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Timestamp" as "Timestamp", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Factsec" as "Secuencia", "Mr2" as "Recargomonto2", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Recmnto" as "Recargomontoconimpuestos", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Despachos" as "Despachos", "Descfw" as "Descripcionfw", "Bdaltafw" as "Basededatosaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Opecomm" as "Nroopecommerce", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Tdci" as "Totaldescuentosconimpuestos", "Entregapos" as "Entregaposterior", "Totdescsi" as "Totaldescuentossinimpuestos", "Codlista" as "Listadeprecios", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftransp" as "Transportista", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Ffch" as "Fecha", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fpodes2" as "Porcentajedescuento2", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Timestamp" as "Timestamp", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Factsec" as "Secuencia", "Mr2" as "Recargomonto2", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Recmnto" as "Recargomontoconimpuestos", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Despachos" as "Despachos", "Descfw" as "Descripcionfw", "Bdaltafw" as "Basededatosaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Opecomm" as "Nroopecommerce", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Tdci" as "Totaldescuentosconimpuestos", "Entregapos" as "Entregaposterior", "Totdescsi" as "Totaldescuentossinimpuestos", "Codlista" as "Listadeprecios", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftransp" as "Transportista", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Ffch" as "Fecha", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fpodes2" as "Porcentajedescuento2", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Timestamp" as "Timestamp", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Factsec" as "Secuencia", "Mr2" as "Recargomonto2", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Recmnto" as "Recargomontoconimpuestos", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Despachos" as "Despachos", "Descfw" as "Descripcionfw", "Bdaltafw" as "Basededatosaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Opecomm" as "Nroopecommerce", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Tdci" as "Totaldescuentosconimpuestos", "Entregapos" as "Entregaposterior", "Totdescsi" as "Totaldescuentossinimpuestos", "Codlista" as "Listadeprecios", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftransp" as "Transportista", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Ffch" as "Fecha", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fpodes2" as "Porcentajedescuento2", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Timestamp" as "Timestamp", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Factsec" as "Secuencia", "Mr2" as "Recargomonto2", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Recmnto" as "Recargomontoconimpuestos", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Despachos" as "Despachos", "Descfw" as "Descripcionfw", "Bdaltafw" as "Basededatosaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Opecomm" as "Nroopecommerce", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Tdci" as "Totaldescuentosconimpuestos", "Entregapos" as "Entregaposterior", "Totdescsi" as "Totaldescuentossinimpuestos", "Codlista" as "Listadeprecios", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftransp" as "Transportista", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 11 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_REMITO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fecexpo,Fd2,Faltafw,Fmodifw,Datosecomm,Ffch,Fpodes1,Mr,Recpor,Fpodes2,Fletr" + ;
"a,Fperson,Fturno,Cotiz,Timestamp,Mdcimpu,Fajxre,Factsec,Mr2,Totalcant,Subtotsisi,Subtotcisi,Signomov" + ;
",Condivalp,Sitfisccli,Fsubton,Recmnto,Facttipo,Fsubtot,Recmnto1,Recmnto2,Desmntosi2,Desmntosi3,Recmn" + ;
"tosi2,Desmntosi,Recmntosi,Recmntosi1,Desmntosi1,Fcompfis,Origonline,Anulado,Desauto,Umodifw,Ualtafw," + ;
"Valtafw,Smodifw,Esttrans,Fhora,Horaexpo,Horaimpo,Haltafw,Hmodifw,Bdmodifw,Vmodifw,Despachos,Descfw,B" + ;
"daltafw,Simbmon,Saltafw,Zadsfw,Opecomm,Monsis,Fobs,Fven,Fcuit,Md1,Md2,Fptoven,Fcliente,Fmtdes1,Fmtde" + ;
"s2,Codigo,Fnumcomp,Fmtdes3,Moneda,Tdci,Entregapos,Totdescsi,Codlista,Fpago,Motivo,Ftransp,Ftotal,Dir" + ;
"entr,Fpodes,Fdescu,Merconsign,Deuda,Md3,Mr1,Percepcion,Gravamen,Fimpuesto,Trci,Totrecar,Totrecarsi,T" + ;
"otdesc,Totimpue,Ivasis" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Datosecomm" as "Dataecom", "Ffch" as "Fecha", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fpodes2" as "Porcentajedescuento2", "Fletra" as "Letra", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Timestamp" as "Timestamp", "Mdcimpu" as "Montodescuentoconimpuestos", "Fajxre" as "Ajustesporredondeos", "Factsec" as "Secuencia", "Mr2" as "Recargomonto2", "Totalcant" as "Totalcantidad", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Recmnto" as "Recargomontoconimpuestos", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Desmntosi3" as "Montodescuentosinimpuestos3", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fcompfis" as "Comprobantefiscal", "Origonline" as "Basadoencomprobanteonline", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Despachos" as "Despachos", "Descfw" as "Descripcionfw", "Bdaltafw" as "Basededatosaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Opecomm" as "Nroopecommerce", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fcuit" as "Cuit", "Md1" as "Montodescuento1", "Md2" as "Montodescuento2", "Fptoven" as "Puntodeventa", "Fcliente" as "Clientedescripcion", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fnumcomp" as "Numero", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Tdci" as "Totaldescuentosconimpuestos", "Entregapos" as "Entregaposterior", "Totdescsi" as "Totaldescuentossinimpuestos", "Codlista" as "Listadeprecios", "Fpago" as "Forpago", "Motivo" as "Motivo", "Ftransp" as "Transportista", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Merconsign" as "Mercaderiaconsignacion", "Deuda" as "Deuda", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Trci" as "Totalrecargosconimpuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema"
				endtext
			Else
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, DatosEComm = ] + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, MR = ] + transform( &lcCursor..MR )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, fTurno = ] + transform( &lcCursor..fTurno )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, OrigOnline = ] + Transform( iif( &lcCursor..OrigOnline, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, DesAuto = ] + Transform( iif( &lcCursor..DesAuto, 1, 0 ))+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, Despachos = ] + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, EntregaPos = ] + transform( &lcCursor..EntregaPos )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, FPago = ] + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'"+ [, MOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"+ [, FTransp = ] + "'" + this.FormatearTextoSql( &lcCursor..FTransp ) + "'"+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, DIRENTR = ] + "'" + this.FormatearTextoSql( &lcCursor..DIRENTR ) + "'"+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MerConsign = ] + Transform( iif( &lcCursor..MerConsign, 1, 0 ))+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, IvaSis = ] + transform( &lcCursor..IvaSis ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FECEXPO, FD2, FALTAFW, FMODIFW, DatosEComm, FFCH, FPODES1, MR, RecPor, FPODES2, FLETRA, FPerson, fTurno, Cotiz, TIMESTAMP, MDCIMPU, FAjXRe, FACTSEC, MR2, TotalCant, SubTotSISI, SubTotCISI, signomov, CondivaLp, SitFiscCli, fSubToN, RecMnto, FACTTIPO, FSubTOT, RecMnto1, RecMnto2, DesMntoSI2, DesMntoSI3, RecMntoSI2, DesMntoSI, RecMntoSI, RecMntoSI1, DesMntoSI1, FCOMPFIS, OrigOnline, Anulado, DesAuto, UMODIFW, UALTAFW, VALTAFW, SMODIFW, ESTTRANS, FHORA, HORAEXPO, HORAIMPO, HALTAFW, HMODIFW, BDMODIFW, VMODIFW, Despachos, DescFW, BDALTAFW, SimbMon, SALTAFW, ZADSFW, OPEcomm, MonSis, FObs, FVEN, fCuit, MD1, MD2, FPTOVEN, FCLIENTE, FMTDES1, FMTDES2, CODIGO, FNUMCOMP, FMTDES3, Moneda, TDCI, EntregaPos, totdescSI, CodLista, FPago, MOTIVO, FTransp, FTotal, DIRENTR, FPODES, fDescu, MerConsign, Deuda, MD3, MR1, percepcion, gravamen, fImpuesto, TRCI, totrecar, totrecarSI, totdesc, totimpue, IvaSis
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..FPODES1 ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..RecPor ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..fTurno ) + ',' + transform( &lcCursor..Cotiz )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..MDCIMPU ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..TotalCant ) + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..CondivaLp )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..RecMntoSI2 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..OrigOnline, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..DesAuto, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..FPTOVEN ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + transform( &lcCursor..FNUMCOMP )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FMTDES3 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + transform( &lcCursor..TDCI ) + ',' + transform( &lcCursor..EntregaPos ) + ',' + transform( &lcCursor..totdescSI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FTransp ) + "'" + ',' + transform( &lcCursor..FTotal ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DIRENTR ) + "'" + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..fDescu ) + ',' + Transform( iif( &lcCursor..MerConsign, 1, 0 )) + ',' + transform( &lcCursor..Deuda ) + ',' + transform( &lcCursor..MD3 ) + ',' + transform( &lcCursor..MR1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..totdesc ) + ',' + transform( &lcCursor..totimpue ) + ',' + transform( &lcCursor..IvaSis )
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'REMITO_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'REMITO_FOBS'
				llRetorno = .T.
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FD2 = isnull( d.FD2, t.FD2 ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.DATOSECOMM = isnull( d.DATOSECOMM, t.DATOSECOMM ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.MR = isnull( d.MR, t.MR ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.MR2 = isnull( d.MR2, t.MR2 ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.ORIGONLINE = isnull( d.ORIGONLINE, t.ORIGONLINE ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.DESAUTO = isnull( d.DESAUTO, t.DESAUTO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.DESPACHOS = isnull( d.DESPACHOS, t.DESPACHOS ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.MD1 = isnull( d.MD1, t.MD1 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FPAGO = isnull( d.FPAGO, t.FPAGO ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.FTRANSP = isnull( d.FTRANSP, t.FTRANSP ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.DIRENTR = isnull( d.DIRENTR, t.DIRENTR ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MERCONSIGN = isnull( d.MERCONSIGN, t.MERCONSIGN ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.MD3 = isnull( d.MD3, t.MD3 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.IVASIS = isnull( d.IVASIS, t.IVASIS )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fecimpo,Fectrans,Fecexpo,Fd2,Faltafw,Fmodifw,Datosecomm,Ffch,Fpodes1,Mr,Recpor,Fpodes2,Fletra,Fperson,Fturno,Cotiz,Timestamp,Mdcimpu,Fajxre,Factsec,Mr2,Totalcant,Subtotsisi,Subtotcisi,Signomov,Condivalp,Sitfisccli,Fsubton,Recmnto,Facttipo,Fsubtot,Recmnto1,Recmnto2,Desmntosi2,Desmntosi3,Recmntosi2,Desmntosi,Recmntosi,Recmntosi1,Desmntosi1,Fcompfis,Origonline,Anulado,Desauto,Umodifw,Ualtafw,Valtafw,Smodifw,Esttrans,Fhora,Horaexpo,Horaimpo,Haltafw,Hmodifw,Bdmodifw,Vmodifw,Despachos,Descfw,Bdaltafw,Simbmon,Saltafw,Zadsfw,Opecomm,Monsis,Fobs,Fven,Fcuit,Md1,Md2,Fptoven,Fcliente,Fmtdes1,Fmtdes2,Codigo,Fnumcomp,Fmtdes3,Moneda,Tdci,Entregapos,Totdescsi,Codlista,Fpago,Motivo,Ftransp,Ftotal,Direntr,Fpodes,Fdescu,Merconsign,Deuda,Md3,Mr1,Percepcion,Gravamen,Fimpuesto,Trci,Totrecar,Totrecarsi,Totdesc,Totimpue,Ivasis)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),isnull( d.FD2,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.DATOSECOMM,''),isnull( d.FFCH,''),isnull( d.FPODES1,0),isnull( d.MR,0),isnull( d.RECPOR,0),isnull( d.FPODES2,0),isnull( d.FLETRA,''),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.COTIZ,0),isnull( d.TIMESTAMP,0),isnull( d.MDCIMPU,0),isnull( d.FAJXRE,0),isnull( d.FACTSEC,''),isnull( d.MR2,0),isnull( d.TOTALCANT,0),isnull( d.SUBTOTSISI,0),isnull( d.SUBTOTCISI,0),isnull( d.SIGNOMOV,0),isnull( d.CONDIVALP,0),isnull( d.SITFISCCLI,0),isnull( d.FSUBTON,0),isnull( d.RECMNTO,0),isnull( d.FACTTIPO,0),isnull( d.FSUBTOT,0),isnull( d.RECMNTO1,0),isnull( d.RECMNTO2,0),isnull( d.DESMNTOSI2,0),isnull( d.DESMNTOSI3,0),isnull( d.RECMNTOSI2,0),isnull( d.DESMNTOSI,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTOSI1,0),isnull( d.DESMNTOSI1,0),isnull( d.FCOMPFIS,0),isnull( d.ORIGONLINE,0),isnull( d.ANULADO,0),isnull( d.DESAUTO,0),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.SMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.FHORA,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.VMODIFW,''),isnull( d.DESPACHOS,''),isnull( d.DESCFW,''),isnull( d.BDALTAFW,''),isnull( d.SIMBMON,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.OPECOMM,''),isnull( d.MONSIS,''),isnull( d.FOBS,''),isnull( d.FVEN,''),isnull( d.FCUIT,''),isnull( d.MD1,0),isnull( d.MD2,0),isnull( d.FPTOVEN,0),isnull( d.FCLIENTE,''),isnull( d.FMTDES1,0),isnull( d.FMTDES2,0),isnull( d.CODIGO,''),isnull( d.FNUMCOMP,0),isnull( d.FMTDES3,0),isnull( d.MONEDA,''),isnull( d.TDCI,0),isnull( d.ENTREGAPOS,0),isnull( d.TOTDESCSI,0),isnull( d.CODLISTA,''),isnull( d.FPAGO,''),isnull( d.MOTIVO,''),isnull( d.FTRANSP,''),isnull( d.FTOTAL,0),isnull( d.DIRENTR,''),isnull( d.FPODES,0),isnull( d.FDESCU,0),isnull( d.MERCONSIGN,0),isnull( d.DEUDA,0),isnull( d.MD3,0),isnull( d.MR1,0),isnull( d.PERCEPCION,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TRCI,0),isnull( d.TOTRECAR,0),isnull( d.TOTRECARSI,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.IVASIS,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_REMITO' ) < 1
				...
				Try
					...
					.Descuentoautomatico = nvl( c_REMITO.Descuentoautomatico, .F. )
...
<VFPData xml:space="preserve">
	...
	<row entidad="REMITO                                  " atributo="FECHA                                   " tabla="COMPROBANTEV   " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="8" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="PORCENTAJEDESCUENTO1                    " tabla="COMPROBANTEV   " campo="FPODES1   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuento %                                                                                                                                                     " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="RECARGOMONTO                            " tabla="COMPROBANTEV   " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto recargo                                                                                                                                                   " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="PORCENTAJEDESCUENTO2                    " tabla="COMPROBANTEV   " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuento %                                                                                                                                                     " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="COTIZACION                              " tabla="COMPROBANTEV   " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="404" etiqueta="Cotización                                                                                                                                                      " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="RECARGOMONTO2                           " tabla="COMPROBANTEV   " campo="MR2       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto recargo 2                                                                                                                                                 " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="TIPOCOMPROBANTE                         " tabla="COMPROBANTEV   " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=11                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="                                                                                                                                                                " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="                                                                                                                                                                " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="416" etiqueta="Moneda                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="ENTREGAPOSTERIORVIRTUAL                 " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Tipo de entrega                                                                                                                                                 " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="TRANSPORTISTA                           " tabla="COMPROBANTEV   " campo="FTRANSP   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Transportista                                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Total                                                                                                                                                           " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="PORCENTAJEDESCUENTO                     " tabla="COMPROBANTEV   " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="430" etiqueta="Des%                                                                                                                                                            " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="DESCUENTO                               " tabla="COMPROBANTEV   " campo="FDESCU    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="Des%                                                                                                                                                            " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITO                                  " atributo="MERCADERIACONSIGNACION                  " tabla="COMPROBANTEV   " campo="MERCONSIGN" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="434" etiqueta="Mercadería en consignación                                                                                                                                      " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="MONTODESCUENTO3                         " tabla="COMPROBANTEV   " campo="MD3       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto descuento 3                                                                                                                                               " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="30" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITO                                  " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Impuestos                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="26" orden="60" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
