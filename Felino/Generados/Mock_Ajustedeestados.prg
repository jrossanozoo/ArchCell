...
define class Mock_ajustedeestados as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Ajuste de situaciones de estado según comprobantes"                                                                                                                                                                                      
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'AJUSTEDEESTADOS'                                                                                                                                                                                                                               
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lTieneDatosEnGrilla = .f.                                                                                                                                                                                                                                 
	lTieneDiseñosParaEnviarMail = .t.                                                                                                                                                                                                                         
	lTieneVendedorComoClaveForanea = .f.                                                                                                                                                                                                                      
	lValidacionGrillaOK = .t.                                                                                                                                                                                                                                 
	lWHEliminar = .f.                                                                                                                                                                                                                                         
	lWHIngresar = .f.                                                                                                                                                                                                                                         
	lWHModificar = .f.                                                                                                                                                                                                                                        
	lYaAjustoPendientesDeEntrega = .F.                                                                                                                                                                                                                        
	nTipoComprobanteDevolucion = 0                                                                                                                                                                                                                            
	oAD = null                                                                                                                                                                                                                                                
	...
	oCamposCombinacionComprobantesCompraVenta = NULL                                                                                                                                                                                                          
	oCamposCombinacionMercaderiaEnTransito = NULL                                                                                                                                                                                                             
	oColAtributosObligatoriosDefinidosPorUsuario = null                                                                                                                                                                                                       
	oColCombinaciones = null                                                                                                                                                                                                                                  
	oColCombinacionesADT = null                                                                                                                                                                                                                               
	oColComprobanteCombinacion = null                                                                                                                                                                                                                         
	oColExcedenAfectados = null                                                                                                                                                                                                                               
	oColItemsMalAfectados = null                                                                                                                                                                                                                              
	oColItemsNoEnCompAfe = null                                                                                                                                                                                                                               
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function buscarerroresincorregiblesenafectaciones() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Buscarerroresincorregiblesenafectaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiaritemsmalafectadosporitemslibres() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiaritemsmalafectadosporitemslibres', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cambiosdetallecomprobantesmodificados() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallecomprobantesmodificados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallestockafectado() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Cambiosdetallestockafectado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallestockafectadoauditoriacomb() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cambiosdetallestockafectadoauditoriacomb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardetalles( ) as void                                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargardetalles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function comprobantesmodificados_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'AJUSTEDEESTADOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'comprobantesmodificados_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'comprobantesmodificados_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Comprobantesmodificados ) = 'O' or isnull( this.Comprobantesmodificados ) )			this.Comprobantesmodificados = this.crearobjeto( 'Din_DetalleAjustedeestadosComprobantesmodificados' )			this.Comprobantesmodificados.inicializar()			this.enlazar( 'Comprobantesmodificados.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Comprobantesmodificados.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Comprobantesmodificados, 'CambioSumarizado', this, 'CambiosDetalleComprobantesmodificados', 1)			this.enlazar( 'Comprobantesmodificados.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Comprobantesmodificados.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')		endif		return this.Comprobantesmodificados
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoadvertirgrabar() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoadvertirgrabar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventoclickcmdaceptar() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoclickcmdaceptar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventoconsultardatos() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoconsultardatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerconsultainsertstockmercaderiaentransitoadt( tctablaprincipal as string, tctabladetalle as string, tctablastock as string ) as string                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tctablaprincipal
		lxParam2 = tctabladetalle
		lxParam3 = tctablastock
		...
		return this.ObtenerResultado( 'Obtenerconsultainsertstockmercaderiaentransitoadt', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdetalledeestados() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerdetalledeestados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermensajeporerrorincorregible() as string                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenermensajeporerrorincorregible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertiposdecomprobanteconentregaposterior() as string                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenertiposdecomprobanteconentregaposterior', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sentenciamodificarcomprobantesajustedeestados( toitem as object, tctabladetalle as string ) as string                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Sentenciamodificarcomprobantesajustedeestados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcompafe( tocolitemsnoencompafe as object ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tocolitemsnoencompafe
		...
		return this.ObtenerResultado( 'Actualizarcompafe', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function actualizarobservacionesajuste( tocoldevolucionesgeneradas as zoocoleccion of zoocoleccion.prg, tctipomov as string ) as void                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tocoldevolucionesgeneradas
		lxParam2 = tctipomov
		...
		return this.ObtenerResultado( 'Actualizarobservacionesajuste', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function agregaraliasencolecciondecampos( tocol as zoocoleccion of zoocoleccion.prg, tcalias as string ) as zoocoleccion of zoocoleccion.prg                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Agregaraliasencolecciondecampos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ajustarstock( toherramienta as object, tocoldevolucionesgeneradasventas as zoocoleccion of zoocoleccion.prg, tocoldevolucionesgeneradascompras as zoocoleccion of zoocoleccion.prg ) as void                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = toherramienta
		lxParam2 = tocoldevolucionesgeneradasventas
		lxParam3 = tocoldevolucionesgeneradascompras
		...
		return this.ObtenerResultado( 'Ajustarstock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ajustarstockmercaderiaentransito() as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ajustarstockmercaderiaentransito', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function completarcamposcombinacion( tccursor as string, tcentidad as string, tocamposcombinacion as object ) as void                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Completarcamposcombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function desafectarcombinacionencomprobante( toitem as object )                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Desafectarcombinacionencomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existemercaderiaentransitoaajustar() as boolean                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Existemercaderiaentransitoaajustar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function generarcancelacionesdeexcedenteafectados( tocolexcedenafectados as object, tocoldevolucionesgeneradas as object,  tcentidad as string, tocolaboradorcomprobantescancelacion as object ) as void                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tocolexcedenafectados
		lxParam2 = tocoldevolucionesgeneradas
		lxParam3 = tcentidad
		lxParam4 = tocolaboradorcomprobantescancelacion
		...
		return this.ObtenerResultado( 'Generarcancelacionesdeexcedenteafectados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercamposcombinacion( tocol as zoocoleccion of zoocoleccion.prg) as string                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercamposcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercamposcursor( tccursor as string ) as string                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercamposcursor', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercamposgroupbycombinacion( tocol as zoocoleccion of zoocoleccion.prg) as string                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercamposgroupbycombinacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccioncamposcombinacion( tntipocomprobante as integer ) as zoocoleccion of zoocoleccion.prg                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercoleccioncamposcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercoleccionvalorescombinacion( toitem as object ) as zoocoleccion of zoocoleccion.prg                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercoleccionvalorescombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercomprobantesafectantes( tntipocomprobante as integer ) as void                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercomprobantesafectantes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercondicionwhereatributoscombinacion( tovalorescombinacion as collection, tcentidad as string ) as string                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tovalorescombinacion
		lxParam2 = tcentidad
		...
		return this.ObtenerResultado( 'Obtenercondicionwhereatributoscombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerconsultainsertstockmercaderiaentransito( tctablaprincipal as string, tctabladetalle as string, tctablastock as string ) as string                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenerconsultainsertstockmercaderiaentransito', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerconsultaupdatestockmercaderiaentransito( tctablaprincipal as string, tctabladetalle as string, tctablastock as string ) as string                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenerconsultaupdatestockmercaderiaentransito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerobservacion( tocoldevolucionesgeneradas as zoocoleccion of zoocoleccion.prg, tctipomov as string ) as string                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerobservacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciainnerjoinporcombinacion( tocamposentidadcomprobante as object, tcalias1 as string, tcalias2 as string ) as string                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tocamposentidadcomprobante
		lxParam2 = tcalias1
		lxParam3 = tcalias2
		...
		return this.ObtenerResultado( 'Obtenersentenciainnerjoinporcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentencialeftjoinparacombinaciones( tctablacomb as string, tctablacomprobantedet as string, tntipocomprobante as integer ) as string                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tctablacomb
		lxParam2 = tctablacomprobantedet
		lxParam3 = tntipocomprobante
		...
		return this.ObtenerResultado( 'Obtenersentencialeftjoinparacombinaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciaselectcocodcomprobante( tocamposentidadcomprobante as object, tcalias as string ) as string                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenersentenciaselectcocodcomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciaselectcomprobante( tocamposentidadcomprobante as object, tcalias as string ) as string                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenersentenciaselectcomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersolonombrecampo( tcfullcampo as string ) as string                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcfullcampo
		...
		return this.ObtenerResultado( 'Obtenersolonombrecampo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertabladetalle( toitem as object, toentidadad as object ) as string                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toitem
		lxParam2 = toentidadad
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenertabladetalledecomprobante( toitem as object, tocomprobantes as object ) as string                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toitem
		lxParam2 = tocomprobantes
		...
		return this.ObtenerResultado( 'Obtenertabladetalledecomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertablaprincipal( toitem as object, toentidadad as object ) as string                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenertablaprincipal', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function restaurarcantidadencombinaciondecomprobantedesafectado( tovalorescombinacion as collection, tccursor as string ) as void                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Restaurarcantidadencombinaciondecomprobantedesafectado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function sentenciaajustarcombinacionesestados( tccomprobante as string, tocomponentecomprobante as object, tntipocomprobante as integer,  tctabla as string, tctabladet as string ) as string                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = tccomprobante
		lxParam2 = tocomponentecomprobante
		lxParam3 = tntipocomprobante
		lxParam4 = tctabla
		lxParam5 = tctabladet
		...
		return this.ObtenerResultado( 'Sentenciaajustarcombinacionesestados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function sentenciaajustarstockcombinacionessincomprobante( tccomprobante as string, tntipocomprobante as integer, tctabla as string, tctabladet as string ) as string                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Sentenciaajustarstockcombinacionessincomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function sentenciainsertarcombinacionesestados( tccomprobante as string, tocomponentecomprobante as object, tntipocomprobante as integer,  tctabla as string, tctabladet as string ) as string                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5
		...
		return this.ObtenerResultado( 'Sentenciainsertarcombinacionesestados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function sentenciainsertarcombinacionesestadosadt( tccomprobante as string, tocomponentecomprobante as object ) as string                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Sentenciainsertarcombinacionesestadosadt', lcParametros )
	EndFunc
