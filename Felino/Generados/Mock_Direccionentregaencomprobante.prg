...
define class Mock_direccionentregaencomprobante as MockBase of MockBase.prg
	...
	cClase = 'direccionentregaencomprobante'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Establecer domicilio de entrega"                                                                                                                                                                                                         
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'DIRECCIONENTREGAENCOMPROBANTE'                                                                                                                                                                                                                 
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function direccionentrega_assign( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DIRECCIONENTREGAENCOMPROBANTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'direccionentrega_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'direccionentrega_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Direccionentrega		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Direccionentrega( lxVal )				this.Setear_Direccionentrega( lxVal )			EndIf		Else			This.Setear_Direccionentrega( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocargardireccionesentregacliente() as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocargardireccionesentregacliente', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lanzardireccionentregaencomprobante() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Lanzardireccionentregaencomprobante', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_direccionentrega( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DIRECCIONENTREGAENCOMPROBANTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_direccionentrega', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_direccionentrega', lcParametros )			endif		endif		this.Direccionentrega = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_direccionentrega( txval as variant ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'DIRECCIONENTREGAENCOMPROBANTE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_direccionentrega', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_direccionentrega', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodireccionentrega() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Valorsugeridodireccionentrega', lcParametros )
	EndFunc
