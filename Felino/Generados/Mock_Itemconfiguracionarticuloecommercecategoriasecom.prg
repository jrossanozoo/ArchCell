...
define class Mock_Itemconfiguracionarticuloecommercecategoriasecom as MockBase of MockBase.prg

	cClase = 'Itemconfiguracionarticuloecommercecategoriasecom'
	...
	*-----------------------------------------------------------------------------------------
	function codcategoria_access() as variant                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Codcategoria_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codcategoria_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Codcategoria_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desccategoria_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Desccategoria_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codcategoria( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_codcategoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_desccategoria( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_desccategoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codcategoria( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_codcategoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_desccategoria( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_desccategoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodcategoria() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridocodcategoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodesccategoria() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Valorsugeridodesccategoria', lcParametros )
	EndFunc
