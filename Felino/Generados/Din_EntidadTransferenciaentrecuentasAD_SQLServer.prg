...
define class Din_EntidadTRANSFERENCIAENTRECUENTASAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTranctasFaltafw, lxTranctasFecexpo, lxTranctasFecimpo, lxTranctasFectrans, lxTranctasFmodifw, lxTranctasHoraimpo, lxTranctasHoraexpo, lxTranctasHaltafw, lxTranctasHmodifw, lxTranctasSmodifw, lxTranctasVmodifw, lxTranctasZadsfw, lxTranctasUmodifw, lxTranctasValtafw, lxTranctasSaltafw, lxTranctasUaltafw, lxTranctasBdaltafw, lxTranctasEsttrans, lxTranctasBdmodifw, lxTranctasCodigo, lxTranctasFecrec, lxTranctasFectran, lxTranctasNumero, lxTranctasIngreso, lxTranctasHorarec, lxTranctasHoratran, lxTranctasDescri, lxTranctasCtatran, lxTranctasCtarec, lxTranctasMontorec, lxTranctasMontotra, lxTranctasIdtran, lxTranctasIdrec, lxTranctasRegrec, lxTranctasRegtran, lxTranctasCodrec, lxTranctasCodtran, lxTranctasCottra, lxTranctasCotrec, lxTranctasRecpesos, lxTranctasTrapesos, lxTranctasObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TRANCTAS ( "Faltafw","Fecexpo","Fecimpo","Fectrans","Fmodifw","Horaimpo","Horaexpo","Haltafw","Hmodifw","Smodifw","Vmodifw","Zadsfw","Umodifw","Valtafw","Saltafw","Ualtafw","Bdaltafw","Esttrans","Bdmodifw","Codigo","Fecrec","Fectran","Numero","Ingreso","Horarec","Horatran","Descri","Ctatran","Ctarec","Montorec","Montotra","Idtran","Idrec","Regrec","Regtran","Codrec","Codtran","Cottra","Cotrec","Recpesos","Trapesos","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxTranctasFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTranctasFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTranctasFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTranctasFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTranctasFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasCodigo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTranctasFecrec ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTranctasFectran ) + "'" >>, <<lxTranctasNumero >>, <<"'" + this.ConvertirDateSql( lxTranctasIngreso ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasHorarec ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasHoratran ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasDescri ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasCtatran ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasCtarec ) + "'" >>, <<lxTranctasMontorec >>, <<lxTranctasMontotra >>, <<"'" + this.FormatearTextoSql( lxTranctasIdtran ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasIdrec ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasRegrec ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasRegtran ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasCodrec ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTranctasCodtran ) + "'" >>, <<lxTranctasCottra >>, <<lxTranctasCotrec >>, <<lxTranctasRecpesos >>, <<lxTranctasTrapesos >>, <<"'" + this.FormatearTextoSql( lxTranctasObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TRANCTAS set "Faltafw" = <<"'" + this.ConvertirDateSql( lxTranctasFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxTranctasFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTranctasFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTranctasFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTranctasFmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTranctasHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTranctasHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTranctasHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTranctasHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTranctasSmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTranctasVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTranctasZadsfw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTranctasUmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTranctasValtafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTranctasSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTranctasUaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTranctasBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTranctasEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTranctasBdmodifw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxTranctasCodigo ) + "'">>,"Fecrec" = <<"'" + this.ConvertirDateSql( lxTranctasFecrec ) + "'">>,"Fectran" = <<"'" + this.ConvertirDateSql( lxTranctasFectran ) + "'">>,"Numero" = <<lxTranctasNumero>>,"Ingreso" = <<"'" + this.ConvertirDateSql( lxTranctasIngreso ) + "'">>,"Horarec" = <<"'" + this.FormatearTextoSql( lxTranctasHorarec ) + "'">>,"Horatran" = <<"'" + this.FormatearTextoSql( lxTranctasHoratran ) + "'">>,"Descri" = <<"'" + this.FormatearTextoSql( lxTranctasDescri ) + "'">>,"Ctatran" = <<"'" + this.FormatearTextoSql( lxTranctasCtatran ) + "'">>,"Ctarec" = <<"'" + this.FormatearTextoSql( lxTranctasCtarec ) + "'">>,"Montorec" = <<lxTranctasMontorec>>,"Montotra" = <<lxTranctasMontotra>>,"Idtran" = <<"'" + this.FormatearTextoSql( lxTranctasIdtran ) + "'">>,"Idrec" = <<"'" + this.FormatearTextoSql( lxTranctasIdrec ) + "'">>,"Regrec" = <<"'" + this.FormatearTextoSql( lxTranctasRegrec ) + "'">>,"Regtran" = <<"'" + this.FormatearTextoSql( lxTranctasRegtran ) + "'">>,"Codrec" = <<"'" + this.FormatearTextoSql( lxTranctasCodrec ) + "'">>,"Codtran" = <<"'" + this.FormatearTextoSql( lxTranctasCodtran ) + "'">>,"Cottra" = <<lxTranctasCottra>>,"Cotrec" = <<lxTranctasCotrec>>,"Recpesos" = <<lxTranctasRecpesos>>,"Trapesos" = <<lxTranctasTrapesos>>,"Obs" = <<"'" + this.FormatearTextoSql( lxTranctasObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxTranctasCodigo ) + "'">> and  TRANCTAS.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Fecrec" as "Fecharecibe", "Fectran" as "Fechatransfiere", "Numero" as "Numero", "Ingreso" as "Fechaingreso", "Horarec" as "Horarecibe", "Horatran" as "Horatransfiere", "Descri" as "Descripcion", "Ctatran" as "Cuentabancariatransfiere", "Ctarec" as "Cuentabancariarecibe", "Montorec" as "Montorecibe", "Montotra" as "Montotransfiere", "Idtran" as "Identificadortransfiere", "Idrec" as "Identificadorrecibe", "Regrec" as "Idregistrorecibe", "Regtran" as "Idregistrotransfiere", "Codrec" as "Codigorecibe", "Codtran" as "Codigotransfiere", "Cottra" as "Cotizacionmonedatransfiere", "Cotrec" as "Cotizacionmonedarecibe", "Recpesos" as "Recibealcambio", "Trapesos" as "Transfierealcambio", "Obs" as "Observacion" from ZooLogic.TRANCTAS where "Codigo" = <<"'" + this.FormatearTextoSql( lxTranctasCodigo ) + "'">> and  TRANCTAS.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Fecrec" as "Fecharecibe", "Fectran" as "Fechatransfiere", "Numero" as "Numero", "Ingreso" as "Fechaingreso", "Horarec" as "Horarecibe", "Horatran" as "Horatransfiere", "Descri" as "Descripcion", "Ctatran" as "Cuentabancariatransfiere", "Ctarec" as "Cuentabancariarecibe", "Montorec" as "Montorecibe", "Montotra" as "Montotransfiere", "Idtran" as "Identificadortransfiere", "Idrec" as "Identificadorrecibe", "Regrec" as "Idregistrorecibe", "Regtran" as "Idregistrotransfiere", "Codrec" as "Codigorecibe", "Codtran" as "Codigotransfiere", "Cottra" as "Cotizacionmonedatransfiere", "Cotrec" as "Cotizacionmonedarecibe", "Recpesos" as "Recibealcambio", "Trapesos" as "Transfierealcambio", "Obs" as "Observacion" from ZooLogic.TRANCTAS where  TRANCTAS.CODIGO != '' And Numero = <<lxTranCtasNumero>>
			endtext
			use in select('c_TRANSFERENCIAENTRECUENTAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TRANSFERENCIAENTRECUENTAS', set( 'Datasession' ) )
			if reccount( 'c_TRANSFERENCIAENTRECUENTAS' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Fecrec" as "Fecharecibe", "Fectran" as "Fechatransfiere", "Numero" as "Numero", "Ingreso" as "Fechaingreso", "Horarec" as "Horarecibe", "Horatran" as "Horatransfiere", "Descri" as "Descripcion", "Ctatran" as "Cuentabancariatransfiere", "Ctarec" as "Cuentabancariarecibe", "Montorec" as "Montorecibe", "Montotra" as "Montotransfiere", "Idtran" as "Identificadortransfiere", "Idrec" as "Identificadorrecibe", "Regrec" as "Idregistrorecibe", "Regtran" as "Idregistrotransfiere", "Codrec" as "Codigorecibe", "Codtran" as "Codigotransfiere", "Cottra" as "Cotizacionmonedatransfiere", "Cotrec" as "Cotizacionmonedarecibe", "Recpesos" as "Recibealcambio", "Trapesos" as "Transfierealcambio", "Obs" as "Observacion" from ZooLogic.TRANCTAS where  TRANCTAS.CODIGO != '' order by Numero,Codigo
			endtext
			use in select('c_TRANSFERENCIAENTRECUENTAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TRANSFERENCIAENTRECUENTAS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Fecrec" as "Fecharecibe", "Fectran" as "Fechatransfiere", "Numero" as "Numero", "Ingreso" as "Fechaingreso", "Horarec" as "Horarecibe", "Horatran" as "Horatransfiere", "Descri" as "Descripcion", "Ctatran" as "Cuentabancariatransfiere", "Ctarec" as "Cuentabancariarecibe", "Montorec" as "Montorecibe", "Montotra" as "Montotransfiere", "Idtran" as "Identificadortransfiere", "Idrec" as "Identificadorrecibe", "Regrec" as "Idregistrorecibe", "Regtran" as "Idregistrotransfiere", "Codrec" as "Codigorecibe", "Codtran" as "Codigotransfiere", "Cottra" as "Cotizacionmonedatransfiere", "Cotrec" as "Cotizacionmonedarecibe", "Recpesos" as "Recibealcambio", "Trapesos" as "Transfierealcambio", "Obs" as "Observacion" from ZooLogic.TRANCTAS where  str( Numero, 10, 0) + funciones.padr( Codigo, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TRANCTAS.CODIGO != '' order by Numero,Codigo
			endtext
			use in select('c_TRANSFERENCIAENTRECUENTAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TRANSFERENCIAENTRECUENTAS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Fecrec" as "Fecharecibe", "Fectran" as "Fechatransfiere", "Numero" as "Numero", "Ingreso" as "Fechaingreso", "Horarec" as "Horarecibe", "Horatran" as "Horatransfiere", "Descri" as "Descripcion", "Ctatran" as "Cuentabancariatransfiere", "Ctarec" as "Cuentabancariarecibe", "Montorec" as "Montorecibe", "Montotra" as "Montotransfiere", "Idtran" as "Identificadortransfiere", "Idrec" as "Identificadorrecibe", "Regrec" as "Idregistrorecibe", "Regtran" as "Idregistrotransfiere", "Codrec" as "Codigorecibe", "Codtran" as "Codigotransfiere", "Cottra" as "Cotizacionmonedatransfiere", "Cotrec" as "Cotizacionmonedarecibe", "Recpesos" as "Recibealcambio", "Trapesos" as "Transfierealcambio", "Obs" as "Observacion" from ZooLogic.TRANCTAS where  str( Numero, 10, 0) + funciones.padr( Codigo, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TRANCTAS.CODIGO != '' order by Numero desc,Codigo desc
			endtext
			use in select('c_TRANSFERENCIAENTRECUENTAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TRANSFERENCIAENTRECUENTAS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Fecrec" as "Fecharecibe", "Fectran" as "Fechatransfiere", "Numero" as "Numero", "Ingreso" as "Fechaingreso", "Horarec" as "Horarecibe", "Horatran" as "Horatransfiere", "Descri" as "Descripcion", "Ctatran" as "Cuentabancariatransfiere", "Ctarec" as "Cuentabancariarecibe", "Montorec" as "Montorecibe", "Montotra" as "Montotransfiere", "Idtran" as "Identificadortransfiere", "Idrec" as "Identificadorrecibe", "Regrec" as "Idregistrorecibe", "Regtran" as "Idregistrotransfiere", "Codrec" as "Codigorecibe", "Codtran" as "Codigotransfiere", "Cottra" as "Cotizacionmonedatransfiere", "Cotrec" as "Cotizacionmonedarecibe", "Recpesos" as "Recibealcambio", "Trapesos" as "Transfierealcambio", "Obs" as "Observacion" from ZooLogic.TRANCTAS where  TRANCTAS.CODIGO != '' order by Numero desc,Codigo desc
			endtext
			use in select('c_TRANSFERENCIAENTRECUENTAS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TRANSFERENCIAENTRECUENTAS', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Faltafw,Fecexpo,Fecimpo,Fectrans,Fmodifw,Horaimpo,Horaexpo,Haltafw,Hmodifw,Smodifw,Vmodifw,Z" + ;
"adsfw,Umodifw,Valtafw,Saltafw,Ualtafw,Bdaltafw,Esttrans,Bdmodifw,Codigo,Fecrec,Fectran,Numero,Ingres" + ;
"o,Horarec,Horatran,Descri,Ctatran,Ctarec,Montorec,Montotra,Idtran,Idrec,Regrec,Regtran,Codrec,Codtra" + ;
"n,Cottra,Cotrec,Recpesos,Trapesos,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Codigo" as "Codigo", "Fecrec" as "Fecharecibe", "Fectran" as "Fechatransfiere", "Numero" as "Numero", "Ingreso" as "Fechaingreso", "Horarec" as "Horarecibe", "Horatran" as "Horatransfiere", "Descri" as "Descripcion", "Ctatran" as "Cuentabancariatransfiere", "Ctarec" as "Cuentabancariarecibe", "Montorec" as "Montorecibe", "Montotra" as "Montotransfiere", "Idtran" as "Identificadortransfiere", "Idrec" as "Identificadorrecibe", "Regrec" as "Idregistrorecibe", "Regtran" as "Idregistrotransfiere", "Codrec" as "Codigorecibe", "Codtran" as "Codigotransfiere", "Cottra" as "Cotizacionmonedatransfiere", "Cotrec" as "Cotizacionmonedarecibe", "Recpesos" as "Recibealcambio", "Trapesos" as "Transfierealcambio", "Obs" as "Observacion"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.TRANCTAS set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, FecRec = ] + "'" + this.ConvertirDateSql( &lcCursor..FecRec ) + "'"+ [, FecTran = ] + "'" + this.ConvertirDateSql( &lcCursor..FecTran ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, Ingreso = ] + "'" + this.ConvertirDateSql( &lcCursor..Ingreso ) + "'"+ [, HoraRec = ] + "'" + this.FormatearTextoSql( &lcCursor..HoraRec ) + "'"+ [, HoraTran = ] + "'" + this.FormatearTextoSql( &lcCursor..HoraTran ) + "'"+ [, Descri = ] + "'" + this.FormatearTextoSql( &lcCursor..Descri ) + "'"+ [, CtaTran = ] + "'" + this.FormatearTextoSql( &lcCursor..CtaTran ) + "'"+ [, CtaRec = ] + "'" + this.FormatearTextoSql( &lcCursor..CtaRec ) + "'"+ [, MontoRec = ] + transform( &lcCursor..MontoRec )+ [, MontoTra = ] + transform( &lcCursor..MontoTra )+ [, IdTran = ] + "'" + this.FormatearTextoSql( &lcCursor..IdTran ) + "'"+ [, IdRec = ] + "'" + this.FormatearTextoSql( &lcCursor..IdRec ) + "'"+ [, RegRec = ] + "'" + this.FormatearTextoSql( &lcCursor..RegRec ) + "'"+ [, RegTran = ] + "'" + this.FormatearTextoSql( &lcCursor..RegTran ) + "'"+ [, CodRec = ] + "'" + this.FormatearTextoSql( &lcCursor..CodRec ) + "'"+ [, CodTran = ] + "'" + this.FormatearTextoSql( &lcCursor..CodTran ) + "'"+ [, CotTra = ] + transform( &lcCursor..CotTra )+ [, CotRec = ] + transform( &lcCursor..CotRec )+ [, RecPesos = ] + transform( &lcCursor..RecPesos )+ [, TraPesos = ] + transform( &lcCursor..TraPesos )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FALTAFW, FECEXPO, FECIMPO, FECTRANS, FMODIFW, HORAIMPO, HORAEXPO, HALTAFW, HMODIFW, SMODIFW, VMODIFW, ZADSFW, UMODIFW, VALTAFW, SALTAFW, UALTAFW, BDALTAFW, ESTTRANS, BDMODIFW, Codigo, FecRec, FecTran, Numero, Ingreso, HoraRec, HoraTran, Descri, CtaTran, CtaRec, MontoRec, MontoTra, IdTran, IdRec, RegRec, RegTran, CodRec, CodTran, CotTra, CotRec, RecPesos, TraPesos, Obs
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FecRec ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FecTran ) + "'" + ',' + transform( &lcCursor..Numero ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..Ingreso ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HoraRec ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HoraTran ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descri ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CtaTran ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CtaRec ) + "'" + ',' + transform( &lcCursor..MontoRec ) + ',' + transform( &lcCursor..MontoTra ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdTran ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdRec ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..RegRec ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..RegTran ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodRec ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodTran ) + "'" + ',' + transform( &lcCursor..CotTra ) + ',' + transform( &lcCursor..CotRec ) + ',' + transform( &lcCursor..RecPesos ) + ',' + transform( &lcCursor..TraPesos ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FECREC = isnull( d.FECREC, t.FECREC ),t.FECTRAN = isnull( d.FECTRAN, t.FECTRAN ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.INGRESO = isnull( d.INGRESO, t.INGRESO ),t.HORAREC = isnull( d.HORAREC, t.HORAREC ),t.HORATRAN = isnull( d.HORATRAN, t.HORATRAN ),t.DESCRI = isnull( d.DESCRI, t.DESCRI ),t.CTATRAN = isnull( d.CTATRAN, t.CTATRAN ),t.CTAREC = isnull( d.CTAREC, t.CTAREC ),t.MONTOREC = isnull( d.MONTOREC, t.MONTOREC ),t.MONTOTRA = isnull( d.MONTOTRA, t.MONTOTRA ),t.IDTRAN = isnull( d.IDTRAN, t.IDTRAN ),t.IDREC = isnull( d.IDREC, t.IDREC ),t.REGREC = isnull( d.REGREC, t.REGREC ),t.REGTRAN = isnull( d.REGTRAN, t.REGTRAN ),t.CODREC = isnull( d.CODREC, t.CODREC ),t.CODTRAN = isnull( d.CODTRAN, t.CODTRAN ),t.COTTRA = isnull( d.COTTRA, t.COTTRA ),t.COTREC = isnull( d.COTREC, t.COTREC ),t.RECPESOS = isnull( d.RECPESOS, t.RECPESOS ),t.TRAPESOS = isnull( d.TRAPESOS, t.TRAPESOS ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.TRANCTAS t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.TRANCTAS(Faltafw,Fecexpo,Fecimpo,Fectrans,Fmodifw,Horaimpo,Horaexpo,Haltafw,Hmodifw,Smodifw,Vmodifw,Zadsfw,Umodifw,Valtafw,Saltafw,Ualtafw,Bdaltafw,Esttrans,Bdmodifw,Codigo,Fecrec,Fectran,Numero,Ingreso,Horarec,Horatran,Descri,Ctatran,Ctarec,Montorec,Montotra,Idtran,Idrec,Regrec,Regtran,Codrec,Codtran,Cottra,Cotrec,Recpesos,Trapesos,Obs)
					Select CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.CODIGO,''),isnull( d.FECREC,''),isnull( d.FECTRAN,''),isnull( d.NUMERO,0),isnull( d.INGRESO,''),isnull( d.HORAREC,''),isnull( d.HORATRAN,''),isnull( d.DESCRI,''),isnull( d.CTATRAN,''),isnull( d.CTAREC,''),isnull( d.MONTOREC,0),isnull( d.MONTOTRA,0),isnull( d.IDTRAN,''),isnull( d.IDREC,''),isnull( d.REGREC,''),isnull( d.REGTRAN,''),isnull( d.CODREC,''),isnull( d.CODTRAN,''),isnull( d.COTTRA,0),isnull( d.COTREC,0),isnull( d.RECPESOS,0),isnull( d.TRAPESOS,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="FECHATRANSFERENCIA                      " tabla="TRANCTAS       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                                                                                                                       " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="ESTADOTRANSFERENCIA                     " tabla="TRANCTAS       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="FECHARECIBE                             " tabla="TRANCTAS       " campo="FECREC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="400" etiqueta="Fecha recepción                                                                                                                                                                                                                                           " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="FECHATRANSFIERE                         " tabla="TRANCTAS       " campo="FECTRAN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="402" etiqueta="Fecha transferencia                                                                                                                                                                                                                                       " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="FECHAINGRESO                            " tabla="TRANCTAS       " campo="INGRESO   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="404" etiqueta="Fecha de ingreso                                                                                                                                                                                                                                          " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="HORARECIBE                              " tabla="TRANCTAS       " campo="HORAREC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Hora recepción                                                                                                                                                                                                                                            " dominio="HORA                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="HORATRANSFIERE                          " tabla="TRANCTAS       " campo="HORATRAN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Hora transferencia                                                                                                                                                                                                                                        " dominio="HORA                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="DESCRIPCION                             " tabla="TRANCTAS       " campo="DESCRI    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Descripción                                                                                                                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="CUENTABANCARIATRANSFIERE                " tabla="TRANCTAS       " campo="CTATRAN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CUENTABANCARIA                          " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="412" etiqueta="Cuenta bancaria transferencia                                                                                                                                                                                                                             " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="CUENTABANCARIARECIBE                    " tabla="TRANCTAS       " campo="CTAREC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CUENTABANCARIA                          " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="414" etiqueta="Cuenta bancaria recepción                                                                                                                                                                                                                                 " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="MONTORECIBE                             " tabla="TRANCTAS       " campo="MONTOREC  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="416" etiqueta="Monto                                                                                                                                                                                                                                                     " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="MONTOTRANSFIERE                         " tabla="TRANCTAS       " campo="MONTOTRA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="418" etiqueta="Monto                                                                                                                                                                                                                                                     " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="IDENTIFICADORTRANSFIERE                 " tabla="TRANCTAS       " campo="IDTRAN    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Identificador transferencia                                                                                                                                                                                                                               " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="IDENTIFICADORRECIBE                     " tabla="TRANCTAS       " campo="IDREC     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Identificador recepción                                                                                                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="IDREGISTRORECIBE                        " tabla="TRANCTAS       " campo="REGREC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Id registro recepción                                                                                                                                                                                                                                     " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="6" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="IDREGISTROTRANSFIERE                    " tabla="TRANCTAS       " campo="REGTRAN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Id registro transferencia                                                                                                                                                                                                                                 " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="CODIGORECIBE                            " tabla="TRANCTAS       " campo="CODREC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="Código del banco recepción                                                                                                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="CODIGOTRANSFIERE                        " tabla="TRANCTAS       " campo="CODTRAN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Código del banco transferencia                                                                                                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="COTIZACIONMONEDATRANSFIERE              " tabla="TRANCTAS       " campo="COTTRA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="16" etiqueta="Cotización transfiere                                                                                                                                                                                                                                     " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="9" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="COTIZACIONMONEDARECIBE                  " tabla="TRANCTAS       " campo="COTREC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="16" etiqueta="Cotización Recibe                                                                                                                                                                                                                                         " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="9" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="RECIBEALCAMBIO                          " tabla="TRANCTAS       " campo="RECPESOS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="16" etiqueta="Importe recibe al cambio                                                                                                                                                                                                                                  " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="10" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="TRANSFIEREALCAMBIO                      " tabla="TRANCTAS       " campo="TRAPESOS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="16" etiqueta="Importe transfiere al cambio                                                                                                                                                                                                                              " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="10" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSFERENCIAENTRECUENTAS               " atributo="OBSERVACION                             " tabla="TRANCTAS       " campo="OBS       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="428" etiqueta="Observación                                                                                                                                                                                                                                               " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CUENTABANCARIA                          " atributo="DESCRIPCION                             " tabla="CTABAN         " campo="CBDES     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="413" etiqueta="Detalle Cue.                                                                                                                                                                                                                                              " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CTABAN On TRANCTAS.CTATRAN = CTABAN.CBCod And  CTABAN.CBCOD != ''                                                                                                                                                                                  " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
