...
define class Mock_Informacionadicionalcompvtasad_sqlserver as MockBase of MockBase.prg

	cClase = 'Informacionadicionalcompvtasad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetallecomprobantes( tcatributo as string ) as string                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercampodetallecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetallecomprobantes( tccampos as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetallecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetallecomprobantes( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerdatosdetallecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetallecomprobantes( tccampos as string ) as string                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Parsearcamposdetallecomprobantes', lcParametros )
	EndFunc
