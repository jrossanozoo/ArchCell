...
define class Din_EntidadAperturaautomaticaentidades_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Aperturaautomaticaentidades"
	cClaseResponse = this.cNamespaceDTOs + ".AperturaautomaticaentidadesResponse"
	cClaseModelo = "AperturaautomaticaentidadesModelo"
	cEntidad = "Aperturaautomaticaentidades"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "AperturaautomaticaentidadesModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AperturaautomaticaentidadesListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "AperturaautomaticaentidadesListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "AperturaautomaticaentidadesModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleAccionesDetalle( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Entidad", toEntidad.AccionesDetalle.oItem, "Entidad" )
	...
	protected function CargarColeccionModeloAccionesDetalle( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .AccionesDetalle.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemAperautomaticas" )
				this.SetearAtributoString( loItem, "Codigo", .AccionesDetalle.Item(lnI).Codigo)
				this.SetearAtributoString( loItem, "Entidad", .AccionesDetalle.Item(lnI).Entidad)
