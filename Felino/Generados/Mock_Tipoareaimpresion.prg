...
define class Mock_tipoareaimpresion as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	protected function generardato( tccodigo as string, tcdescripcion as string, tldetalle as boolean ) as void                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Generardato', lcParametros )
	EndFunc
