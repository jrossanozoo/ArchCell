...
define class Din_EntidadAJUSTEDEESTADOSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxAjuestadosFecexpo, lxAjuestadosFectrans, lxAjuestadosFmodifw, lxAjuestadosFaltafw, lxAjuestadosFecimpo, lxAjuestadosTipocomp, lxAjuestadosAjnumero, lxAjuestadosSmodifw, lxAjuestadosUaltafw, lxAjuestadosSaltafw, lxAjuestadosUmodifw, lxAjuestadosZadsfw, lxAjuestadosDescfw, lxAjuestadosVmodifw, lxAjuestadosHmodifw, lxAjuestadosValtafw, lxAjuestadosHaltafw, lxAjuestadosHoraimpo, lxAjuestadosBdmodifw, lxAjuestadosBdaltafw, lxAjuestadosHoraexpo, lxAjuestadosEsttrans, lxAjuestadosAjcodigo, lxAjuestadosAjobs, lxAjuestadosAjfecha
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.AJUESTADOS ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Tipocomp","Ajnumero","Smodifw","Ualtafw","Saltafw","Umodifw","Zadsfw","Descfw","Vmodifw","Hmodifw","Valtafw","Haltafw","Horaimpo","Bdmodifw","Bdaltafw","Horaexpo","Esttrans","Ajcodigo","Ajobs","Ajfecha" ) values ( <<"'" + this.ConvertirDateSql( lxAjuestadosFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuestadosFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuestadosFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuestadosFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuestadosFecimpo ) + "'" >>, <<lxAjuestadosTipocomp >>, <<lxAjuestadosAjnumero >>, <<"'" + this.FormatearTextoSql( lxAjuestadosSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosAjcodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuestadosAjobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuestadosAjfecha ) + "'" >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.StockAfectado
				if this.oEntidad.StockAfectado.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajuestadosDet("COMP","NROITEM","ProcStock","ajdCodigo","Equiv","ajSituac","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxSituacion ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
			...
			for each loItem in this.oEntidad.StockAfectadoAuditoriaComb
				if this.oEntidad.StockAfectadoAuditoriaComb.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajEstAudCombDet("COMP","NROITEM","ajdCodigo","AjdSituac","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxSituacion ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.ComprobantesModificados
				if this.oEntidad.ComprobantesModificados.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajCompDet("COMP","NROITEM","ProcStock","Equiv","ajComprob","ajCompCod","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxComprobante ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.AJUESTADOS set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAjuestadosFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAjuestadosFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAjuestadosFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAjuestadosFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAjuestadosFecimpo ) + "'">>,"Tipocomp" = <<lxAjuestadosTipocomp>>,"Ajnumero" = <<lxAjuestadosAjnumero>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAjuestadosSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAjuestadosUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAjuestadosSaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAjuestadosUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAjuestadosZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxAjuestadosDescfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAjuestadosVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAjuestadosHmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAjuestadosValtafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAjuestadosHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAjuestadosHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAjuestadosBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAjuestadosBdaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAjuestadosHoraexpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAjuestadosEsttrans ) + "'">>,"Ajcodigo" = <<"'" + this.FormatearTextoSql( lxAjuestadosAjcodigo ) + "'">>,"Ajobs" = <<"'" + this.FormatearTextoSql( lxAjuestadosAjobs ) + "'">>,"Ajfecha" = <<"'" + this.ConvertirDateSql( lxAjuestadosAjfecha ) + "'">> where "Ajcodigo" = <<"'" + this.FormatearTextoSql( lxAjuestadosAjcodigo ) + "'">> and  AJUESTADOS.AJCODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Tipocomp" as "Tipo", "Ajnumero" as "Numero", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Ajcodigo" as "Codigo", "Ajobs" as "Obs", "Ajfecha" as "Fecha" from ZooLogic.AJUESTADOS where "Ajcodigo" = <<"'" + this.FormatearTextoSql( lxAjuestadosAjcodigo ) + "'">> and  AJUESTADOS.AJCODIGO != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Ajdcodigo" as "Codigo", "Equiv" as "Equivalencia", "Ajsituac" as "Situacion", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad" from ZooLogic.ajuestadosDet where ajdCodigo = <<"'" + this.FormatearTextoSql( c_AJUSTEDEESTADOS.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Ajdcodigo" as "Codigo", "Ajdsituac" as "Situacion", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad" from ZooLogic.ajEstAudCombDet where ajdCodigo = <<"'" + this.FormatearTextoSql( c_AJUSTEDEESTADOS.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Equiv" as "Equivalencia", "Ajcomprob" as "Comprobante", "Ajcompcod" as "Codigo", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad" from ZooLogic.ajCompDet where ajCompCod = <<"'" + this.FormatearTextoSql( c_AJUSTEDEESTADOS.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Tipocomp" as "Tipo", "Ajnumero" as "Numero", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Ajcodigo" as "Codigo", "Ajobs" as "Obs", "Ajfecha" as "Fecha" from ZooLogic.AJUESTADOS where  AJUESTADOS.AJCODIGO != '' order by ajnumero,ajCodigo
			endtext
			use in select('c_AJUSTEDEESTADOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDEESTADOS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Tipocomp" as "Tipo", "Ajnumero" as "Numero", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Ajcodigo" as "Codigo", "Ajobs" as "Obs", "Ajfecha" as "Fecha" from ZooLogic.AJUESTADOS where  str( ajnumero, 10, 0) + funciones.padr( ajCodigo, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUESTADOS.AJCODIGO != '' order by ajnumero,ajCodigo
			endtext
			use in select('c_AJUSTEDEESTADOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDEESTADOS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Tipocomp" as "Tipo", "Ajnumero" as "Numero", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Ajcodigo" as "Codigo", "Ajobs" as "Obs", "Ajfecha" as "Fecha" from ZooLogic.AJUESTADOS where  str( ajnumero, 10, 0) + funciones.padr( ajCodigo, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUESTADOS.AJCODIGO != '' order by ajnumero desc,ajCodigo desc
			endtext
			use in select('c_AJUSTEDEESTADOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDEESTADOS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Tipocomp" as "Tipo", "Ajnumero" as "Numero", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Ajcodigo" as "Codigo", "Ajobs" as "Obs", "Ajfecha" as "Fecha" from ZooLogic.AJUESTADOS where  AJUESTADOS.AJCODIGO != '' order by ajnumero desc,ajCodigo desc
			endtext
			use in select('c_AJUSTEDEESTADOS')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTEDEESTADOS', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Tipocomp,Ajnumero,Smodifw,Ualtafw,Saltafw,Umodifw,Z" + ;
"adsfw,Descfw,Vmodifw,Hmodifw,Valtafw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Horaexpo,Esttrans,Ajcodigo,A" + ;
"jobs,Ajfecha" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Tipocomp" as "Tipo", "Ajnumero" as "Numero", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Esttrans" as "Estadotransferencia", "Ajcodigo" as "Codigo", "Ajobs" as "Obs", "Ajfecha" as "Fecha"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleStockAfectado( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Ajdcodigo" as "Codigo", "Equiv" as "Equivalencia", "Ajsituac" as "Situacion", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleStockAfectadoAuditoriaComb( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Ajdcodigo" as "Codigo", "Ajdsituac" as "Situacion", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleComprobantesModificados( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Comp" as "Comportamiento", "Nroitem" as "Nroitem", "Procstock" as "Noprocesarstock", "Equiv" as "Equivalencia", "Ajcomprob" as "Comprobante", "Ajcompcod" as "Codigo", "Ajdart" as "Articulo", "Ajdadesc" as "Articulodetalle", "Ajdcolor" as "Color", "Ajdcdesc" as "Colordetalle", "Ajdtalle" as "Talle", "Ajdstock" as "Stockact", "Ajdstocksi" as "Stockproy", "Ajdcant" as "Cantidad"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.StockAfectado
				if this.oEntidad.StockAfectado.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajuestadosDet("COMP","NROITEM","ProcStock","ajdCodigo","Equiv","ajSituac","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxSituacion ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
			...
			for each loItem in this.oEntidad.StockAfectadoAuditoriaComb
				if this.oEntidad.StockAfectadoAuditoriaComb.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajEstAudCombDet("COMP","NROITEM","ajdCodigo","AjdSituac","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxSituacion ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.ComprobantesModificados
				if this.oEntidad.ComprobantesModificados.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCantidad = loItem.Cantidad
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.ajCompDet("COMP","NROITEM","ProcStock","Equiv","ajComprob","ajCompCod","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant" ) values ( <<lxComportamiento>>, <<lxNroitem>>, <<iif( lxNoprocesarstock, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxEquivalencia_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxComprobante ) + "'">>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxStockact>>, <<lxStockproy>>, <<lxCantidad>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.AJUESTADOS set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, tipocomp = ] + transform( &lcCursor..tipocomp )+ [, ajnumero = ] + transform( &lcCursor..ajnumero )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, ajCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..ajCodigo ) + "'"+ [, ajObs = ] + "'" + this.FormatearTextoSql( &lcCursor..ajObs ) + "'"+ [, ajfecha = ] + "'" + this.ConvertirDateSql( &lcCursor..ajfecha ) + "'" + [ Where ajCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..ajCodigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, tipocomp, ajnumero, SMODIFW, UALTAFW, SALTAFW, UMODIFW, ZADSFW, DescFW, VMODIFW, HMODIFW, VALTAFW, HALTAFW, HORAIMPO, BDMODIFW, BDALTAFW, HORAEXPO, ESTTRANS, ajCodigo, ajObs, ajfecha
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + transform( &lcCursor..tipocomp ) + ',' + transform( &lcCursor..ajnumero )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ajCodigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ajObs ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..ajfecha ) + "'"
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"COMP","NROITEM","ProcStock","ajdCodigo","Equiv","ajSituac","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant"
		endText
	...
	Scan All
		Text to lcCamposInsert noShow
			"COMP","NROITEM","ajdCodigo","AjdSituac","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant"
		endText
	...
	Scan All
		Text to lcCamposInsert noShow
			"COMP","NROITEM","ProcStock","Equiv","ajComprob","ajCompCod","ajdart","ajdADesc","ajdColor","ajdCDesc","ajdTalle","ajdstock","ajdstocksi","ajdCant"
		endText
		this.oConexion.EjecutarSql( [Insert into ZooLogic.ajCompDet ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.COMP       ) + ',' + transform( cDetallesExistentes.NROITEM    ) + ',' + Transform( iif( cDetallesExistentes.ProcStock , 1, 0 )) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Equiv      ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajComprob  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajCompCod  ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdart     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdADesc   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdColor   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdCDesc   ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.ajdTalle   ) + "'" + ',' + transform( cDetallesExistentes.ajdstock   ) + ',' + transform( cDetallesExistentes.ajdstocksi ) + ',' + transform( cDetallesExistentes.ajdCant    ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.AJNUMERO = isnull( d.AJNUMERO, t.AJNUMERO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.AJCODIGO = isnull( d.AJCODIGO, t.AJCODIGO ),t.AJOBS = isnull( d.AJOBS, t.AJOBS ),t.AJFECHA = isnull( d.AJFECHA, t.AJFECHA )
					from ZooLogic.AJUESTADOS t inner join deleted d 
							 on t.ajCodigo = d.ajCodigo
				-- Fin Updates
				insert into ZooLogic.AJUESTADOS(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Tipocomp,Ajnumero,Smodifw,Ualtafw,Saltafw,Umodifw,Zadsfw,Descfw,Vmodifw,Hmodifw,Valtafw,Haltafw,Horaimpo,Bdmodifw,Bdaltafw,Horaexpo,Esttrans,Ajcodigo,Ajobs,Ajfecha)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.TIPOCOMP,0),isnull( d.AJNUMERO,0),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.VALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.ESTTRANS,''),isnull( d.AJCODIGO,''),isnull( d.AJOBS,''),isnull( d.AJFECHA,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="AJUSTEDEESTADOS                         " atributo="FECHATRANSFERENCIA                      " tabla="AJUESTADOS     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTEDEESTADOS                         " atributo="ESTADOTRANSFERENCIA                     " tabla="AJUESTADOS     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
