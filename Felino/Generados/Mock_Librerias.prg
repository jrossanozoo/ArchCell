...
define class Mock_LIBRERIAS as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function abrirenlaceweb( tcenlace as string ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Abrirenlaceweb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function abrirventanadeexplorer( tcurl as string ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Abrirventanadeexplorer', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buscaractualizaciones( tlejecutoaplicacionbase as boolean ) as void                                                                                                                                                                              
		...
		lnParametros = pcount()
		lxParam1 = tlejecutoaplicacionbase
		...
		return this.ObtenerResultado( 'Buscaractualizaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cadenaconsolonumeros( tcval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Cadenaconsolonumeros', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function calcularedad( tdnac as date, tdhoy as date )                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Calcularedad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargarfuentevalida( tcfuente as string, tntamañofuente as integer )  as void                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcfuente
		lxParam2 = tntamañofuente
		...
		return this.ObtenerResultado( 'Cargarfuentevalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cerrardescargasenproceso() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Cerrardescargasenproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function compararhash( tctexto as string, tchash as string ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Compararhash', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function compararvalores( txvalor1 as variant, txvalor2 as variant, tldesactivarcasesensitive as boolean ) as boolean                                                                                                                                     
		...
		lxParam1 = txvalor1
		lxParam2 = txvalor2
		lxParam3 = tldesactivarcasesensitive
		...
		return this.ObtenerResultado( 'Compararvalores', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function comprimir( tcarchivo as string, tocoleccionarchivos as zoocoleccion of zoocoleccion.prg,  tccontraseña as string, tlprocsubfolders as boolean, tlpreservepaths as boolean, tldragon as boolean ) as boolean                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6

		lnParametros = pcount()
		lxParam1 = tcarchivo
		lxParam2 = tocoleccionarchivos
		lxParam3 = tccontraseña
		lxParam4 = tlprocsubfolders
		lxParam5 = tlpreservepaths
		lxParam6 = tldragon
		...
		return this.ObtenerResultado( 'Comprimir', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function comprimirdragonlince( tcarchivo as string, tocoleccionarchivos as zoocoleccion of zoocoleccion.prg,  tccontraseña as string, tlprocsubfolders as boolean, tlpreservepaths as boolean, tlesdragon as boolean ) as boolean                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6
		...
		return this.ObtenerResultado( 'Comprimirdragonlince', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function comprimirlince( tcarchivo as string, tocoleccionarchivos as zoocoleccion of zoocoleccion.prg,  tccontraseña as string, tlprocsubfolders as boolean, tlpreservepaths as boolean, tldragon as boolean ) as boolean                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6
		...
		return this.ObtenerResultado( 'Comprimirlince', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function consttextoandgo( tctexto as string, tlnoespera as boolean, tlnoctrluparrow as boolean ) as void                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Consttextoandgo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function contenidozip( tcnombrearchivo as string ) as object                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Contenidozip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirabaseseguncaracteresvalidosparacodigos( nnumero as integer ) as string                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Convertirabaseseguncaracteresvalidosparacodigos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirastring( txvalor as variant ) as string                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Convertirastring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirfechaacaracterconformato( tdfecha as date, tcformato as string ) as string                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Convertirfechaacaracterconformato', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convertirnumerosistemadecimalaotrabase( tnnumero as integer, tnbase as integer ) as string                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Convertirnumerosistemadecimalaotrabase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function convierteabase32( tcnumero as string, tcsimbolos as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Convierteabase32', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function decimalargb                                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Decimalargb', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function dectobin( tnnumero )                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Dectobin', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function dectohex( tndecnumber )                                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Dectohex', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function dectohexfisica( tndecnumber, tndigits )                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Dectohexfisica', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desactivarvalidacionregistroterminal() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Desactivarvalidacionregistroterminal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descomprimir( tcarchivo as string, tcruta as string, tccontraseña as string ) as boolean                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Descomprimir', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desencriptar( tctexto ) as string                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Desencriptar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desencriptar192( tctexto as string ) as string                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Desencriptar192', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desencriptarmodo( tcidcampo as string, tcidope as string, tcstrencriptado as string ) as void                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Desencriptarmodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desencriptarperfilusuario( tcstrperfilencriptado as string, tcstrusuarioencriptado as string, tnusuario as int ) as string                                                                                                                       
		...
		lnParametros = pcount()
		lxParam1 = tcstrperfilencriptado
		lxParam2 = tcstrusuarioencriptado
		lxParam3 = tnusuario
		...
		return this.ObtenerResultado( 'Desencriptarperfilusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function dia as string                                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Dia As String', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function diadelasemanaennumero as integer                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Diadelasemanaennumero As Integer', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function digitoverificadordeluhn( tcnumero as string ) as integer                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Digitoverificadordeluhn', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutareditordetextoplano( tcarchivo as string, tosuscriptoracambiosdearchivo as object, tcdelegadoanotificar as string ) as object                                                                                                             
		...
		lnParametros = pcount()
		lxParam1 = tcarchivo
		lxParam2 = tosuscriptoracambiosdearchivo
		lxParam3 = tcdelegadoanotificar
		...
		return this.ObtenerResultado( 'Ejecutareditordetextoplano', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutargenerarmail( tcdestinatario as string ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Ejecutargenerarmail', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function encriptar( tctexto ) as string                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Encriptar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function encriptar192( tctexto as string ) as string                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Encriptar192', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function encriptarmodo( tcidcampo as string, tcidope as string, tcidmodo as string ) as string                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Encriptarmodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function encriptarperfilusuario( tcperfil as string, tcusuario as string ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Encriptarperfilusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function entidadpura( tcentidad as string ) as string                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Entidadpura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esautobuilddistribuido() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Esautobuilddistribuido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escapecaracteressqlserver( tctexto as textbox ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Escapecaracteressqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escodigoasciiparaarmarexpresiontipostring( tnkeycode as integer ) as boolean                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Escodigoasciiparaarmarexpresiontipostring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escribirdatosdeini( tcarchivo as string, tcseccion as string, tcentrada as string, tcvalor as string ) as integer                                                                                                                                
		...
		return this.ObtenerResultado( 'Escribirdatosdeini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function establecerfechadesistema( lddatetime as date ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Establecerfechadesistema', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function establecerventanaenprimerplano( tnhnwd as long ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Establecerventanaenprimerplano', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existeaplicacionenejecucion( tcaplicacion as string ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Existeaplicacionenejecucion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existebasededatos( tcrutabasededatos as string, tlvengodeguardarcomobaseenlinux as boolean ) as void                                                                                                                                             
		...
		lnParametros = pcount()
		lxParam1 = tcrutabasededatos
		lxParam2 = tlvengodeguardarcomobaseenlinux
	...
	*-----------------------------------------------------------------------------------------
	function existebasededatossqlserver( tcbasededatos as string, tlvengodeguardarcomobaseenlinux as boolean ) as void                                                                                                                                        
		...
		return this.ObtenerResultado( 'Existebasededatossqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existeprocesopornombredeventana( tcnombredeventana as string )                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Existeprocesopornombredeventana', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existeservidorsqlserver() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Existeservidorsqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existetabla( tcrutabasededatos as string, tctabla as string, tcesquema as string ) as void                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Existetabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function extraermodo( tcclave as string ) as integer                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Extraermodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function extraerperfilusuario( tcclave as string, tnusuario as int ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Extraerperfilusuario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function finalizarproceso() as void                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Finalizarproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hashear( tctexto as string ) as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Hashear', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hayformularioprincipal() as boolean                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Hayformularioprincipal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function iniciarservicioaao() as boolean                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Iniciarservicioaao', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inttostr( tnintval )                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Inttostr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function invertircadena( tcstring as string ) as string                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Invertircadena', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function invertirmayusculasminusculas( tctexto as string, tlltrim as boolean ) as string                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Invertirmayusculasminusculas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function invertirstring( tcstring as string )                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Invertirstring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function leercarpetascriptslancelot( tcxml as string ) as string                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Leercarpetascriptslancelot', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function lmodopuestoporusuarioterminal_access() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Lmodopuestoporusuarioterminal_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function longtostr                                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Longtostr', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mail( tcdestinatario as string, tcasunto as string, tcmensaje as string, tcadjunto  as string ) as void                                                                                                                                          
		...
		return this.ObtenerResultado( 'Mail', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mes as string                                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Mes As String', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function mostrarmensajesalida( tctexto as string, tlnoespera as boolean, tlnoctrluparrow as boolean ) as integer                                                                                                                                          
		...
		return this.ObtenerResultado( 'Mostrarmensajesalida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function notificaciondescargarmodulo( tosender as object , toeventsarg as object ) as void                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Notificaciondescargarmodulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function notificacionfallodescargarmodulo( tosender as object , toeventsarg as object ) as void                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Notificacionfallodescargarmodulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function notificaractualizacionesqueestenpendientesdepublicar( tlpuedemostrarentidad as boolean ) as void                                                                                                                                                 
		...
		lnParametros = pcount()
		lxParam1 = tlpuedemostrarentidad
		...
		return this.ObtenerResultado( 'Notificaractualizacionesqueestenpendientesdepublicar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numeroaletras( tnmonto as number, tlsindecimales as boolean ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Numeroaletras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneragrupamiento( tcvalor as string ) as string                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obteneragrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneranchotexto( tctexto as string, tocontrol as label, tlmanetenerespacios as boolean) as integer                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obteneranchotexto', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obteneranchotextopixeles( tctexto as string, tcfuente as string, tntamañofuente as integer ) as integer                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obteneranchotextopixeles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerarchivoplano( tcnombre as string, tnlineas as integer, tndesde as integer, tnposicion as integer) as string                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenerarchivoplano', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposseguridadperfiles( tccampos as string ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercamposseguridadperfiles', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposseguridadusuarios( tccampos as string ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercamposseguridadusuarios', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercaracteresbasicosvalidos() as string                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercaracteresbasicosvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercaracteresespecialesskuvalidos() as string                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercaracteresespecialesskuvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercaracteresespecialesvalidos() as string                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercaracteresespecialesvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercaracteresinvalidos( tccadena as string  ) as string                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercaracteresinvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercaracteresmasskuvalidos( tlpermitemayusculas as boolean ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercaracteresmasskuvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercarpetaproductomisdocumentos( tccarpeta as string ) as void                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenercarpetaproductomisdocumentos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigosasciiparaarmarexpresionestipostring() as zoocoleccion of zoocoleccion.prg                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercodigosasciiparaarmarexpresionestipostring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionarchivos( tcruta as string, tcextencion as string, tlagregardatos as boolean ) as zoocoleccion of zoocoleccion.prg                                                                                                               
		...
		lnParametros = pcount()
		lxParam1 = tcruta
		lxParam2 = tcextencion
		lxParam3 = tlagregardatos
		...
		return this.ObtenerResultado( 'Obtenercoleccionarchivos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercursordesdearchivoxml( tcarchivo as string, tccursor as string, tndatasessionid as integer  ) as void                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercursordesdearchivoxml', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdeini( tcarchivo as string, tcseccion as string, tcentrada as string ) as string                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerdatosdeini', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdeinitextoplano( tcarchivo as string, tcseccion as string, tcentrada as string ) as void                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerdatosdeinitextoplano', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripcionsituacionfiscalparaimpresion( tnsituacionfiscal as integer ) as string                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerdescripcionsituacionfiscalparaimpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdirectorio( tcdirectorio as string , tctexto as string , tctitulo as string ) as string                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerdirectorio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerestadodelservicioaao() as string                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerestadodelservicioaao', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfechaformateada( txdate as variant, tctipodb as string ) as date                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerfechaformateada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerformatosimagen() as string                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerformatosimagen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfswatcher( tcarchivo as string, tosuscriptoracambiosdearchivo as object, tcdelegadoanotificar as string  ) as object                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenerfswatcher', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerguid() as string                                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerguid', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerguidpk() as string                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerguidpk', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerhora() as date                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerhora', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneridaplicacionenejecucion( tcaplicacion as string ) as integer                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obteneridaplicacionenejecucion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneridentificadorglobal() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obteneridentificadorglobal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obteneridprocesoactual() as integer                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obteneridprocesoactual', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinfoproceso( tcnombreproceso as string ) as object                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerinfoproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerip() as string                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerip', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerletrasynumerosvalidos( tlincluyeminusculas as boolean ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenerletrasynumerosvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerleyendamonotributo() as string                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenerleyendamonotributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerleyendataxfree() as void                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerleyendataxfree', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerleyendataxfreevacia() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerleyendataxfreevacia', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerlongitudmaximadeidentificadorglobal() as integer                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenerlongitudmaximadeidentificadorglobal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermacadress() as string                                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenermacadress', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermascarafecha() as string                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenermascarafecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermisdocumentos() as string                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenermisdocumentos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombreequipo() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenernombreequipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombrepuesto() as string                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenernombrepuesto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombresucursal( tcsucursal as string ) as string                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenernombresucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernombreusuarioso() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenernombreusuarioso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenernumerosvalidos() as string                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenernumerosvalidos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerprogramaasociado( tcextension as string ) as string                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerprogramaasociado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerpropiedadestexto( tctexto as string, tnanchomax as integer, tcfuente as string, tntamañofuente as integer ) as custom                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Obtenerpropiedadestexto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertimestamp() as integer                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenertimestamp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertipodeiniciodelservicioaao() as string                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenertipodeiniciodelservicioaao', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerultimodiadelmes( ldfecha as date ) as date                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerultimodiadelmes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenervalorregistrowindows( tcclave as string, tcubicacion as string, tcraiz  as string) as string                                                                                                                                              
		...
		return this.ObtenerResultado( 'Obtenervalorregistrowindows', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerversionexcelinstalada() as integer                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerversionexcelinstalada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerversionsistemaoperativo() as string                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerversionsistemaoperativo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obv( tcdisco as string, tnforma as integer ) as string                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradoractivedir_access() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Ocolaboradoractivedir_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolcodigosasciiparaarmarstring_access() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Ocolcodigosasciiparaarmarstring_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocrypto_access() as void                                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Ocrypto_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oencriptador_access() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Oencriptador_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oini_access() as void                                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Oini_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function okgsd() as boolean                                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Okgsd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function omanagerdeserviciosdewindows_access() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Omanagerdeserviciosdewindows_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function pixelstotwips( tnpixels as long, tndirection as long ) as long                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Pixelstotwips', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function redondearsegunmascara( tnnumero as float ) as float                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Redondearsegunmascara', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function redondearsegunprecision( tnnumero as float, tnprecision as integer ) as float                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Redondearsegunprecision', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reemplazarcaracteresespeciales( tccadena as string ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Reemplazarcaracteresespeciales', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reemplazarcaracteresparalince( tccadena as string ) as string                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Reemplazarcaracteresparalince', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reemplazarcodigosasciiparaarmarexpresionestipostring( tccadena as string, toclase as object ) as string                                                                                                                                          
		...
		return this.ObtenerResultado( 'Reemplazarcodigosasciiparaarmarexpresionestipostring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reencriptarseguridad( tcclave as string ) as string                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Reencriptarseguridad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function registrarversionactualenzoologic() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Registrarversionactualenzoologic', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function reparartabla( tcruta as string, tcfilename as string ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Reparartabla', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function salirforce( tctexto as string, tlnoespera as boolean, tlnoctrluparrow as boolean ) as void                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Salirforce', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function separarensegmentos( tctexto as string, tnancho as long, tcseparador as string ) as string                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Separarensegmentos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearentornoab() as void                                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setearentornoab', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearpixelsporpulgadas() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setearpixelsporpulgadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sha1( cmessage ) as string                                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Sha1', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function terminarprocesosrelacionados( tniddeproceso as integer, toprocesosamantenerabiertos as collection ) as void                                                                                                                                      
		...
		lnParametros = pcount()
		lxParam1 = tniddeproceso
		lxParam2 = toprocesosamantenerabiertos
		...
		return this.ObtenerResultado( 'Terminarprocesosrelacionados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function traducircaracteresmenu ( tccadena ) as string                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Traducircaracteresmenu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function transformarcadenacaracteres( tcparametro as string ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Transformarcadenacaracteres', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function twipstopixels( tntwips as long, tndirection as long ) as long                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Twipstopixels', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcaracteres( tctexto as string, tlaceptarminusculas as boolean, tccaracteresvalidar as string) as boolean                                                                                                                                  
		...
		lnParametros = pcount()
		lxParam1 = tctexto
		lxParam2 = tlaceptarminusculas
		lxParam3 = tccaracteresvalidar
	...
	*-----------------------------------------------------------------------------------------
	function validarcbu( tccbu as string ) as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarcbu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarnombrearchivo( tctexto as string, tlaceptarminusculas as boolean ) as boolean                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validarnombrearchivo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarrut( tcrut as string ) as boolean                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validarrut', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarrutchile( tcrut as string ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarrutchile', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarruturuguay( tcrut as string ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validarruturuguay', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorastring( txvalor as variant ) as string                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorastring', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorastringalanular( toitem as object ) as string                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorastringalanular', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorastringseguntipobase( txvalor as variant ) as string                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorastringseguntipobase', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorastringsqlserver( txvalor as variant ) as string                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorastringsqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorstringsegundato( tcvalor, tctipodato ) as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorstringsegundato', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorvacio( txvalor ) as variant                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorvacio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorvacioseguntipo( tctipo as string ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Valorvacioseguntipo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificardescargazooupdate() as void                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Verificardescargazooupdate', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarespaciodisponible( tcunidad as string ) as boolean                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Verificarespaciodisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarexcelinstalado() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Verificarexcelinstalado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarexistenciadeproceso( tcnombreproceso as string, tchandle as string ) as boolean                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Verificarexistenciadeproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	hidden function esletra( tccaracter as string ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Esletra', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	hidden function invertircaracter( tccaracter as string ) as string                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Invertircaracter', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function _10to256(lnnumero as integer, lncant as integer ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( '_10to256', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcachepais() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Actualizarcachepais', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function asegurarexistenciaruta( tcruta as string ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Asegurarexistenciaruta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function buscaractualizacionesseguntipodescarga( tlejecutoaplicacionbase as boolean, tctipodescarga as string, tldebepublicar as boolean ) as void                                                                                              
		...
		lnParametros = pcount()
		lxParam1 = tlejecutoaplicacionbase
		lxParam2 = tctipodescarga
		lxParam3 = tldebepublicar
		...
		return this.ObtenerResultado( 'Buscaractualizacionesseguntipodescarga', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cargarcamposseguridad() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Cargarcamposseguridad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargarpropiedaestexto( tcmensaje as string, tcfuente as string, tntamañofuente as integer, tnanchomax as integer, tnancho as integer, tnalto as integer, tnlineas as integer ) as void                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarpropiedaestexto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ccaracteresbasicosvalidos_access() as string                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Ccaracteresbasicosvalidos_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ccaracteresespecialesskuvalidos_access() as string                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Ccaracteresespecialesskuvalidos_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ccaracteresespecialesvalidos_access() as string                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Ccaracteresespecialesvalidos_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cletrasvalidas_access() as string                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Cletrasvalidas_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cnumerosvalidos_access() as string                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Cnumerosvalidos_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearrutadedescarga( loparametros as object ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Crearrutadedescarga', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function crearsemillafecha() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Crearsemillafecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function divisionentera( tcnumerador as string, tcdivisor as string ) as string                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Divisionentera', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ejecutarbuscaractualizacionesas( tlejecutoaplicacionbase as boolean ) as void                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Ejecutarbuscaractualizacionesas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esentero( tcnumero as string ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Esentero', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existebasededatosnativa( tcbasededatos as string ) as void                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Existebasededatosnativa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existetablanativa( tcruta as string, tctabla as string )                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Existetablanativa', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function existetablasqlserver( tcbasededatos as string, tctabla as string, tcesquema as string ) as void                                                                                                                                        
		...
		return this.ObtenerResultado( 'Existetablasqlserver', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function iniciarsemillafecha() as void                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Iniciarsemillafecha', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercaposseguridad( tccampos as string, tocoleccion as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercaposseguridad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdatetimesegunsemilla as datetime                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerdatetimesegunsemilla As Datetime', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdatosdescargalan() as object                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerdatosdescargalan', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerdiferenciareloj()as integer                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerdiferenciareloj', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerfechaservidorsql() as datetime                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerfechaservidorsql', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerparametroscargados( tlejecutoaplicacionbase as boolean, tldebepublicar as boolean ) as object                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerparametroscargados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerresto( tcnumerador as string, tcdivisor as string ) as long                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerresto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerrutalogzu() as string                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerrutalogzu', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerrutatemporaldescargazooupdate() as string                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenerrutatemporaldescargazooupdate', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerultimodigitodeunacadena( tccadena as string ) as integer                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerultimodigitodeunacadena', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerzooupdate( tlesaplicacionbase as boolean, tctipodescarga as string ) as object                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerzooupdate', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function regyvalid( toobjeto as object ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Regyvalid', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function sumadelosdigitosdeunnumero( tcnumero as string ) as integer                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Sumadelosdigitosdeunnumero', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validaranchomaximo( tnanchomax as integer, tnwidth as integer, tnanchopalabra as integer, tcfuente as string, tntamañofuente as integer, tnancho as integer, tnlineas as integer ) as void                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5, lxParam6, lxParam7
		...
		lxParam1 = tnanchomax
		lxParam2 = tnwidth
		lxParam3 = tnanchopalabra
		lxParam4 = tcfuente
		lxParam5 = tntamañofuente
		lxParam6 = tnancho
		lxParam7 = tnlineas
		...
		return this.ObtenerResultado( 'Validaranchomaximo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarcantappmultiseries() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validarcantappmultiseries', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validardigitocbu( tcbloque as string ) as string                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validardigitocbu', lcParametros )
	EndFunc
