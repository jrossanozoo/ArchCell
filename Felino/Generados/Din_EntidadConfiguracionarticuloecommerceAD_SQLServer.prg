		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.CategoriasEcom
				if this.oEntidad.CategoriasEcom.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.CfgArtEcomCat("NROITEM","Codigo","PlatafCat","CodCat","DescCat" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxPlataforma_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodcategoria_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxDesccategoria ) + "'">> ) 
					endtext
			...
			for each loItem in this.oEntidad.EtiquetasEcom
				if this.oEntidad.EtiquetasEcom.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.CfgArtEcomEti("NROITEM","Codigo","PlatafEti","CodEti","DescEti" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxPlataforma_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodetiqueta_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxDescetiqueta ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.DimensionesEcom
				if this.oEntidad.DimensionesEcom.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAlto = loItem.Alto
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.CfgArtEcomDim("NROITEM","Codigo","codColor","ColorDet","Talle","Peso","Largo","Ancho","Alto" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxPeso>>, <<lxLargo>>, <<lxAncho>>, <<lxAlto>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Platafcat" as "Plataforma", "Codcat" as "Codcategoria", "Desccat" as "Desccategoria" from ZooLogic.CfgArtEcomCat where Codigo = <<"'" + this.FormatearTextoSql( c_CONFIGURACIONARTICULOECOMMERCE.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Platafeti" as "Plataforma", "Codeti" as "Codetiqueta", "Desceti" as "Descetiqueta" from ZooLogic.CfgArtEcomEti where Codigo = <<"'" + this.FormatearTextoSql( c_CONFIGURACIONARTICULOECOMMERCE.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Codigo" as "Codigo", "Artic" as "Articulo", "Obs" as "Obs" from ZooLogic.CFGARTECOM where  funciones.padr( Artic, 13, ' ' ) + funciones.padr( Codigo, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CFGARTECOM.CODIGO != '' order by Artic,Codigo
			endtext
			use in select('c_CONFIGURACIONARTICULOECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CONFIGURACIONARTICULOECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Codigo" as "Codigo", "Artic" as "Articulo", "Obs" as "Obs" from ZooLogic.CFGARTECOM where  funciones.padr( Artic, 13, ' ' ) + funciones.padr( Codigo, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  CFGARTECOM.CODIGO != '' order by Artic desc,Codigo desc
			endtext
			use in select('c_CONFIGURACIONARTICULOECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CONFIGURACIONARTICULOECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleCategoriasEcom( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Platafcat" as "Plataforma", "Codcat" as "Codcategoria", "Desccat" as "Desccategoria"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleEtiquetasEcom( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Platafeti" as "Plataforma", "Codeti" as "Codetiqueta", "Desceti" as "Descetiqueta"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.CategoriasEcom
				if this.oEntidad.CategoriasEcom.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxDesccategoria = loItem.Desccategoria
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.CfgArtEcomCat("NROITEM","Codigo","PlatafCat","CodCat","DescCat" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxPlataforma_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodcategoria_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxDesccategoria ) + "'">> ) 
					endtext
			...
			for each loItem in this.oEntidad.EtiquetasEcom
				if this.oEntidad.EtiquetasEcom.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxDescetiqueta = loItem.Descetiqueta
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.CfgArtEcomEti("NROITEM","Codigo","PlatafEti","CodEti","DescEti" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxPlataforma_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodetiqueta_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxDescetiqueta ) + "'">> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.DimensionesEcom
				if this.oEntidad.DimensionesEcom.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAlto = loItem.Alto
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.CfgArtEcomDim("NROITEM","Codigo","codColor","ColorDet","Talle","Peso","Largo","Ancho","Alto" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxPeso>>, <<lxLargo>>, <<lxAncho>>, <<lxAlto>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","Codigo","PlatafCat","CodCat","DescCat"
		endText
...
<VFPData xml:space="preserve">
	...
	<row entidad="CONFIGURACIONARTICULOECOMMERCE          " atributo="FECHATRANSFERENCIA                      " tabla="CFGARTECOM     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONFIGURACIONARTICULOECOMMERCE          " atributo="ESTADOTRANSFERENCIA                     " tabla="CFGARTECOM     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONFIGURACIONARTICULOECOMMERCE          " atributo="ARTICULO                                " tabla="CFGARTECOM     " campo="ARTIC     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="4" etiqueta="Artículo                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
