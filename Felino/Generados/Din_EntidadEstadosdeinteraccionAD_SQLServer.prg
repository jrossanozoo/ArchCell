...
define class Din_EntidadESTADOSDEINTERACCIONAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxEstinteracFecexpo, lxEstinteracFmodifw, lxEstinteracFecimpo, lxEstinteracFaltafw, lxEstinteracFectrans, lxEstinteracTipagrupub, lxEstinteracHmodifw, lxEstinteracSaltafw, lxEstinteracSmodifw, lxEstinteracValtafw, lxEstinteracUaltafw, lxEstinteracZadsfw, lxEstinteracVmodifw, lxEstinteracUmodifw, lxEstinteracHoraexpo, lxEstinteracHoraimpo, lxEstinteracEsttrans, lxEstinteracBdaltafw, lxEstinteracBdmodifw, lxEstinteracHaltafw, lxEstinteracCodigo, lxEstinteracDescri, lxEstinteracTipoorden, lxEstinteracReglaest, lxEstinteracReglafac, lxEstinteracObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ESTINTERAC ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Tipagrupub","Hmodifw","Saltafw","Smodifw","Valtafw","Ualtafw","Zadsfw","Vmodifw","Umodifw","Horaexpo","Horaimpo","Esttrans","Bdaltafw","Bdmodifw","Haltafw","Codigo","Descri","Tipoorden","Reglaest","Reglafac","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxEstinteracFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEstinteracFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEstinteracFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEstinteracFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEstinteracFectrans ) + "'" >>, <<lxEstinteracTipagrupub >>, <<"'" + this.FormatearTextoSql( lxEstinteracHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracDescri ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEstinteracTipoorden ) + "'" >>, <<lxEstinteracReglaest >>, <<lxEstinteracReglafac >>, <<"'" + this.FormatearTextoSql( lxEstinteracObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ESTINTERAC set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEstinteracFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEstinteracFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxEstinteracFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEstinteracFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEstinteracFectrans ) + "'">>,"Tipagrupub" = <<lxEstinteracTipagrupub>>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEstinteracSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracSmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEstinteracValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEstinteracUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEstinteracZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracUmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEstinteracHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEstinteracHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEstinteracEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEstinteracBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEstinteracHaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxEstinteracCodigo ) + "'">>,"Descri" = <<"'" + this.FormatearTextoSql( lxEstinteracDescri ) + "'">>,"Tipoorden" = <<"'" + this.FormatearTextoSql( lxEstinteracTipoorden ) + "'">>,"Reglaest" = <<lxEstinteracReglaest>>,"Reglafac" = <<lxEstinteracReglafac>>,"Obs" = <<"'" + this.FormatearTextoSql( lxEstinteracObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxEstinteracCodigo ) + "'">> and  ESTINTERAC.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descri" as "Descripcion", "Tipoorden" as "Tipodeorden", "Reglaest" as "Reglaestado", "Reglafac" as "Reglafacturacion", "Obs" as "Obs" from ZooLogic.ESTINTERAC where "Codigo" = <<"'" + this.FormatearTextoSql( lxEstinteracCodigo ) + "'">> and  ESTINTERAC.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descri" as "Descripcion", "Tipoorden" as "Tipodeorden", "Reglaest" as "Reglaestado", "Reglafac" as "Reglafacturacion", "Obs" as "Obs" from ZooLogic.ESTINTERAC where  ESTINTERAC.CODIGO != '' order by Codigo
			endtext
			use in select('c_ESTADOSDEINTERACCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ESTADOSDEINTERACCION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descri" as "Descripcion", "Tipoorden" as "Tipodeorden", "Reglaest" as "Reglaestado", "Reglafac" as "Reglafacturacion", "Obs" as "Obs" from ZooLogic.ESTINTERAC where  funciones.padr( Codigo, 30, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ESTINTERAC.CODIGO != '' order by Codigo
			endtext
			use in select('c_ESTADOSDEINTERACCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ESTADOSDEINTERACCION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descri" as "Descripcion", "Tipoorden" as "Tipodeorden", "Reglaest" as "Reglaestado", "Reglafac" as "Reglafacturacion", "Obs" as "Obs" from ZooLogic.ESTINTERAC where  funciones.padr( Codigo, 30, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ESTINTERAC.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_ESTADOSDEINTERACCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ESTADOSDEINTERACCION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descri" as "Descripcion", "Tipoorden" as "Tipodeorden", "Reglaest" as "Reglaestado", "Reglafac" as "Reglafacturacion", "Obs" as "Obs" from ZooLogic.ESTINTERAC where  ESTINTERAC.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_ESTADOSDEINTERACCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ESTADOSDEINTERACCION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Tipagrupub,Hmodifw,Saltafw,Smodifw,Valtafw,Ualtafw," + ;
"Zadsfw,Vmodifw,Umodifw,Horaexpo,Horaimpo,Esttrans,Bdaltafw,Bdmodifw,Haltafw,Codigo,Descri,Tipoorden," + ;
"Reglaest,Reglafac,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Codigo" as "Codigo", "Descri" as "Descripcion", "Tipoorden" as "Tipodeorden", "Reglaest" as "Reglaestado", "Reglafac" as "Reglafacturacion", "Obs" as "Obs"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.ESTINTERAC set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEstinteracFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxEstinteracFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEstinteracFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxEstinteracFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxEstinteracFectrans ) + "'">>, "Tipagrupub" = <<lxEstinteracTipagrupub>>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracHmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxEstinteracSaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracSmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxEstinteracValtafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxEstinteracUaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxEstinteracZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracVmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracUmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxEstinteracHoraexpo ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxEstinteracHoraimpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxEstinteracEsttrans ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEstinteracBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEstinteracBdmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxEstinteracHaltafw ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxEstinteracCodigo ) + "'">>, "Descri" = <<"'" + this.FormatearTextoSql( lxEstinteracDescri ) + "'">>, "Tipoorden" = <<"'" + this.FormatearTextoSql( lxEstinteracTipoorden ) + "'">>, "Reglaest" = <<lxEstinteracReglaest>>, "Reglafac" = <<lxEstinteracReglafac>>, "Obs" = <<"'" + this.FormatearTextoSql( lxEstinteracObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'ESTINTERAC' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.ESTINTERAC set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, tipagrupub = ] + transform( &lcCursor..tipagrupub )+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Descri = ] + "'" + this.FormatearTextoSql( &lcCursor..Descri ) + "'"+ [, TipoOrden = ] + "'" + this.FormatearTextoSql( &lcCursor..TipoOrden ) + "'"+ [, ReglaEst = ] + transform( &lcCursor..ReglaEst )+ [, ReglaFac = ] + transform( &lcCursor..ReglaFac )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, tipagrupub, HMODIFW, SALTAFW, SMODIFW, VALTAFW, UALTAFW, ZADSFW, VMODIFW, UMODIFW, HORAEXPO, HORAIMPO, ESTTRANS, BDALTAFW, BDMODIFW, HALTAFW, Codigo, Descri, TipoOrden, ReglaEst, ReglaFac, Obs
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + transform( &lcCursor..tipagrupub ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descri ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TipoOrden ) + "'" + ',' + transform( &lcCursor..ReglaEst ) + ',' + transform( &lcCursor..ReglaFac ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad ESTADOSDEINTERACCION. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRI = isnull( d.DESCRI, t.DESCRI ),t.TIPOORDEN = isnull( d.TIPOORDEN, t.TIPOORDEN ),t.REGLAEST = isnull( d.REGLAEST, t.REGLAEST ),t.REGLAFAC = isnull( d.REGLAFAC, t.REGLAFAC ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.ESTINTERAC t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.ESTINTERAC(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Tipagrupub,Hmodifw,Saltafw,Smodifw,Valtafw,Ualtafw,Zadsfw,Vmodifw,Umodifw,Horaexpo,Horaimpo,Esttrans,Bdaltafw,Bdmodifw,Haltafw,Codigo,Descri,Tipoorden,Reglaest,Reglafac,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.TIPAGRUPUB,0),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.CODIGO,''),isnull( d.DESCRI,''),isnull( d.TIPOORDEN,''),isnull( d.REGLAEST,0),isnull( d.REGLAFAC,0),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="FECHAEXPO                               " tabla="ESTINTERAC     " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ESTADOSDEINTERACCION                    " atributo="FECHAMODIFICACIONFW                     " tabla="ESTINTERAC     " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ESTADOSDEINTERACCION                    " atributo="FECHAIMPO                               " tabla="ESTINTERAC     " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="FECHATRANSFERENCIA                      " tabla="ESTINTERAC     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="SERIEMODIFICACIONFW                     " tabla="ESTINTERAC     " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ESTADOSDEINTERACCION                    " atributo="VERSIONALTAFW                           " tabla="ESTINTERAC     " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="VERSIONMODIFICACIONFW                   " tabla="ESTINTERAC     " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="HORAEXPO                                " tabla="ESTINTERAC     " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="ESTADOTRANSFERENCIA                     " tabla="ESTINTERAC     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="CODIGO                                  " tabla="ESTINTERAC     " campo="CODIGO    " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="2" etiqueta="Código                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOSDEINTERACCION                    " atributo="DESCRIPCION                             " tabla="ESTINTERAC     " campo="DESCRI    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="4" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
