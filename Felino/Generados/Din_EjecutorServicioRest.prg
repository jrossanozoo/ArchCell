...
define class Din_EjecutorServicioRest as EjecutorServicioRest of EjecutorServicioRest.prg
	...
	oOperacionesEntidadClasificacionproduccion = null
	...
	oOperacionesEntidadCompletardatosregistro = null
	...
	oOperacionesEntidadConsumocliente = null
	oOperacionesEntidadConsumoproduccion = null
	oOperacionesEntidadContabilizacion = null
	oOperacionesEntidadContacto = null
	oOperacionesEntidadConveniomultilateral = null
	oOperacionesEntidadCotizaciongestiondeordendeproduccion = null
	...
	oOperacionesEntidadCurvadeproduccion = null
	oOperacionesEntidadDatosadicionalescomprobantesa = null
	...
	oOperacionesEntidadDatostarjeta = null
	...
	oOperacionesEntidadFiltrarcomprobantesacontrolar = null
	...
	oOperacionesEntidadInformacionadicionalcompvtas = null
	...
	oOperacionesEntidadMotivodescarte = null
	...
	oOperacionesEntidadProcesoproduccion = null
	...
	oOperacionesEntidadRubroproduccion = null
	...
	oOperacionesEntidadTaller = null
	...
	oOperacionesEntidadTipificacionproduccion1 = null
	oOperacionesEntidadTipificacionproduccion2 = null
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadClasificacionproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadClasificacionproduccion ) = 'O' or isnull( this.oOperacionesEntidadClasificacionproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Clasificacionproduccion")
			this.oOperacionesEntidadClasificacionproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadClasificacionproduccion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadCompletardatosregistro_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadCompletardatosregistro ) = 'O' or isnull( this.oOperacionesEntidadCompletardatosregistro ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Completardatosregistro")
			this.oOperacionesEntidadCompletardatosregistro = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadCompletardatosregistro
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadConsumocliente_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadConsumocliente ) = 'O' or isnull( this.oOperacionesEntidadConsumocliente ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Consumocliente")
			this.oOperacionesEntidadConsumocliente = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadConsumocliente
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadConsumoproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadConsumoproduccion ) = 'O' or isnull( this.oOperacionesEntidadConsumoproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Consumoproduccion")
			this.oOperacionesEntidadConsumoproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadConsumoproduccion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadContacto_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadContacto ) = 'O' or isnull( this.oOperacionesEntidadContacto ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Contacto")
			this.oOperacionesEntidadContacto = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadContacto
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadCotizaciongestiondeordendeproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadCotizaciongestiondeordendeproduccion ) = 'O' or isnull( this.oOperacionesEntidadCotizaciongestiondeordendeproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Cotizaciongestiondeordendeproduccion")
			this.oOperacionesEntidadCotizaciongestiondeordendeproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadCotizaciongestiondeordendeproduccion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadCurvadeproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadCurvadeproduccion ) = 'O' or isnull( this.oOperacionesEntidadCurvadeproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Curvadeproduccion")
			this.oOperacionesEntidadCurvadeproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadCurvadeproduccion
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadDatosadicionalescomprobantesa_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadDatosadicionalescomprobantesa ) = 'O' or isnull( this.oOperacionesEntidadDatosadicionalescomprobantesa ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Datosadicionalescomprobantesa")
			this.oOperacionesEntidadDatosadicionalescomprobantesa = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadDatosadicionalescomprobantesa
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadDatostarjeta_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadDatostarjeta ) = 'O' or isnull( this.oOperacionesEntidadDatostarjeta ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Datostarjeta")
			this.oOperacionesEntidadDatostarjeta = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadDatostarjeta
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadFiltrarcomprobantesacontrolar_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadFiltrarcomprobantesacontrolar ) = 'O' or isnull( this.oOperacionesEntidadFiltrarcomprobantesacontrolar ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Filtrarcomprobantesacontrolar")
			this.oOperacionesEntidadFiltrarcomprobantesacontrolar = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadFiltrarcomprobantesacontrolar
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadInformacionadicionalcompvtas_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadInformacionadicionalcompvtas ) = 'O' or isnull( this.oOperacionesEntidadInformacionadicionalcompvtas ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Informacionadicionalcompvtas")
			this.oOperacionesEntidadInformacionadicionalcompvtas = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadInformacionadicionalcompvtas
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadLiquidaciondetaller_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadLiquidaciondetaller ) = 'O' or isnull( this.oOperacionesEntidadLiquidaciondetaller ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Liquidaciondetaller")
			this.oOperacionesEntidadLiquidaciondetaller = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadLiquidaciondetaller
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadListadecostosdeproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadListadecostosdeproduccion ) = 'O' or isnull( this.oOperacionesEntidadListadecostosdeproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Listadecostosdeproduccion")
			this.oOperacionesEntidadListadecostosdeproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadListadecostosdeproduccion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadMaquinaria_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadMaquinaria ) = 'O' or isnull( this.oOperacionesEntidadMaquinaria ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Maquinaria")
			this.oOperacionesEntidadMaquinaria = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadMaquinaria
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadModificaciondecostosdeproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadModificaciondecostosdeproduccion ) = 'O' or isnull( this.oOperacionesEntidadModificaciondecostosdeproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Modificaciondecostosdeproduccion")
			this.oOperacionesEntidadModificaciondecostosdeproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadModificaciondecostosdeproduccion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadMotivodescarte_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadMotivodescarte ) = 'O' or isnull( this.oOperacionesEntidadMotivodescarte ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Motivodescarte")
			this.oOperacionesEntidadMotivodescarte = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadMotivodescarte
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadPercepcion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadPercepcion ) = 'O' or isnull( this.oOperacionesEntidadPercepcion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Percepcion")
			this.oOperacionesEntidadPercepcion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadPercepcion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadPrecargaetiart_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadPrecargaetiart ) = 'O' or isnull( this.oOperacionesEntidadPrecargaetiart ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Precargaetiart")
			this.oOperacionesEntidadPrecargaetiart = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadPrecargaetiart
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadProcesoproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadProcesoproduccion ) = 'O' or isnull( this.oOperacionesEntidadProcesoproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Procesoproduccion")
			this.oOperacionesEntidadProcesoproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadProcesoproduccion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadRubroproduccion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadRubroproduccion ) = 'O' or isnull( this.oOperacionesEntidadRubroproduccion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Rubroproduccion")
			this.oOperacionesEntidadRubroproduccion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadRubroproduccion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadSelecciondisenoimpresion_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadSelecciondisenoimpresion ) = 'O' or isnull( this.oOperacionesEntidadSelecciondisenoimpresion ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Selecciondisenoimpresion")
			this.oOperacionesEntidadSelecciondisenoimpresion = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadSelecciondisenoimpresion
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadSeleccionparainsertar_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadSeleccionparainsertar ) = 'O' or isnull( this.oOperacionesEntidadSeleccionparainsertar ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Seleccionparainsertar")
			this.oOperacionesEntidadSeleccionparainsertar = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadSeleccionparainsertar
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadTaller_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadTaller ) = 'O' or isnull( this.oOperacionesEntidadTaller ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Taller")
			this.oOperacionesEntidadTaller = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadTaller
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadTipificacionproduccion1_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadTipificacionproduccion1 ) = 'O' or isnull( this.oOperacionesEntidadTipificacionproduccion1 ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Tipificacionproduccion1")
			this.oOperacionesEntidadTipificacionproduccion1 = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadTipificacionproduccion1
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function oOperacionesEntidadTipificacionproduccion2_Access() as Void
		if !this.ldestroy and ( !vartype( this.oOperacionesEntidadTipificacionproduccion2 ) = 'O' or isnull( this.oOperacionesEntidadTipificacionproduccion2 ) )
			lcClase = this.ObtenerNombreClaseServicioEntidad("Tipificacionproduccion2")
			this.oOperacionesEntidadTipificacionproduccion2 = _screen.zoo.crearObjeto( lcClase )
		endif
		return this.oOperacionesEntidadTipificacionproduccion2
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function ClasificacionproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadClasificacionproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function ClasificacionproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadClasificacionproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ClasificacionproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadClasificacionproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ClasificacionproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadClasificacionproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ClasificacionproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadClasificacionproduccion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function CompletardatosregistroNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadCompletardatosregistro, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function CompletardatosregistroMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCompletardatosregistro, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CompletardatosregistroListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCompletardatosregistro, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CompletardatosregistroEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCompletardatosregistro, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CompletardatosregistroModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCompletardatosregistro, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function ComprobantederetencionrecibidoAnular( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadComprobantederetencionrecibido, "Anular", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function ConsumoclienteNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumocliente, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function ConsumoclienteMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumocliente, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ConsumoclienteListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumocliente, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ConsumoclienteEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumocliente, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ConsumoclienteModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumocliente, "Modificar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ConsumoproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumoproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function ConsumoproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumoproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ConsumoproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumoproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ConsumoproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumoproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ConsumoproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadConsumoproduccion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function ContactoNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadContacto, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function ContactoMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadContacto, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ContactoListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadContacto, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ContactoEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadContacto, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ContactoModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadContacto, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function CotizaciongestiondeordendeproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadCotizaciongestiondeordendeproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function CotizaciongestiondeordendeproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCotizaciongestiondeordendeproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CotizaciongestiondeordendeproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCotizaciongestiondeordendeproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CotizaciongestiondeordendeproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCotizaciongestiondeordendeproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CotizaciongestiondeordendeproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCotizaciongestiondeordendeproduccion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function CurvadeproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadCurvadeproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function CurvadeproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCurvadeproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CurvadeproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCurvadeproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CurvadeproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCurvadeproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function CurvadeproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadCurvadeproduccion, "Modificar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function DatosadicionalescomprobantesaNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadDatosadicionalescomprobantesa, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function DatosadicionalescomprobantesaMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatosadicionalescomprobantesa, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function DatosadicionalescomprobantesaListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatosadicionalescomprobantesa, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function DatosadicionalescomprobantesaEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatosadicionalescomprobantesa, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function DatosadicionalescomprobantesaModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatosadicionalescomprobantesa, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function DatostarjetaNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadDatostarjeta, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function DatostarjetaMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatostarjeta, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function DatostarjetaListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatostarjeta, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function DatostarjetaEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatostarjeta, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function DatostarjetaModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadDatostarjeta, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function FiltrarcomprobantesacontrolarNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadFiltrarcomprobantesacontrolar, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function FiltrarcomprobantesacontrolarMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadFiltrarcomprobantesacontrolar, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function FiltrarcomprobantesacontrolarListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadFiltrarcomprobantesacontrolar, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function FiltrarcomprobantesacontrolarEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadFiltrarcomprobantesacontrolar, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function FiltrarcomprobantesacontrolarModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadFiltrarcomprobantesacontrolar, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function InformacionadicionalcompvtasNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadInformacionadicionalcompvtas, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function InformacionadicionalcompvtasMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadInformacionadicionalcompvtas, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function InformacionadicionalcompvtasListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadInformacionadicionalcompvtas, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function InformacionadicionalcompvtasEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadInformacionadicionalcompvtas, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function InformacionadicionalcompvtasModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadInformacionadicionalcompvtas, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function LiquidaciondetallerNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadLiquidaciondetaller, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function LiquidaciondetallerMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadLiquidaciondetaller, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function LiquidaciondetallerListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadLiquidaciondetaller, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function LiquidaciondetallerEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadLiquidaciondetaller, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function LiquidaciondetallerModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadLiquidaciondetaller, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function ListadecostosdeproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadListadecostosdeproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function ListadecostosdeproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadListadecostosdeproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ListadecostosdeproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadListadecostosdeproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ListadecostosdeproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadListadecostosdeproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ListadecostosdeproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadListadecostosdeproduccion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function MaquinariaNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadMaquinaria, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function MaquinariaMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMaquinaria, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function MaquinariaListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMaquinaria, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function MaquinariaEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMaquinaria, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function MaquinariaModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMaquinaria, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function ModificaciondecostosdeproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadModificaciondecostosdeproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function ModificaciondecostosdeproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadModificaciondecostosdeproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ModificaciondecostosdeproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadModificaciondecostosdeproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ModificaciondecostosdeproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadModificaciondecostosdeproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ModificaciondecostosdeproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadModificaciondecostosdeproduccion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function MotivodescarteNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadMotivodescarte, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function MotivodescarteMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMotivodescarte, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function MotivodescarteListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMotivodescarte, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function MotivodescarteEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMotivodescarte, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function MotivodescarteModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadMotivodescarte, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function PercepcionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadPercepcion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function PercepcionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPercepcion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function PercepcionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPercepcion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function PercepcionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPercepcion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function PercepcionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPercepcion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function PrecargaetiartNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadPrecargaetiart, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function PrecargaetiartMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPrecargaetiart, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function PrecargaetiartListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPrecargaetiart, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function PrecargaetiartEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPrecargaetiart, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function PrecargaetiartModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadPrecargaetiart, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function ProcesoproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadProcesoproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function ProcesoproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadProcesoproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ProcesoproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadProcesoproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ProcesoproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadProcesoproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function ProcesoproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadProcesoproduccion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function RubroproduccionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadRubroproduccion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function RubroproduccionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadRubroproduccion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function RubroproduccionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadRubroproduccion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function RubroproduccionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadRubroproduccion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function RubroproduccionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadRubroproduccion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function SelecciondisenoimpresionNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadSelecciondisenoimpresion, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function SelecciondisenoimpresionMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSelecciondisenoimpresion, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function SelecciondisenoimpresionListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSelecciondisenoimpresion, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function SelecciondisenoimpresionEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSelecciondisenoimpresion, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function SelecciondisenoimpresionModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSelecciondisenoimpresion, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function SeleccionparainsertarNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadSeleccionparainsertar, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function SeleccionparainsertarMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSeleccionparainsertar, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function SeleccionparainsertarListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSeleccionparainsertar, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function SeleccionparainsertarEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSeleccionparainsertar, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function SeleccionparainsertarModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadSeleccionparainsertar, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function TallerNuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadTaller, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function TallerMostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTaller, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function TallerListar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTaller, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function TallerEliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTaller, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function TallerModificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTaller, "Modificar", tcRequest )
	endfunc 
	...
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion1Nuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion1, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion1Mostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion1, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion1Listar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion1, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion1Eliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion1, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion1Modificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion1, "Modificar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion2Nuevo( tcRequest as String ) as Object
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion2, "Nuevo", tcRequest )
	endfunc
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion2Mostrar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion2, "Mostrar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion2Listar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion2, "Listar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion2Eliminar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion2, "Eliminar", tcRequest )
	endfunc 
	
	*-----------------------------------------------------------------------------------------
	function Tipificacionproduccion2Modificar( tcRequest as String ) as Void
		return this.EjecutarOperacion( this.oOperacionesEntidadTipificacionproduccion2, "Modificar", tcRequest )
	endfunc 
