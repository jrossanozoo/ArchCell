...
define class Din_EntidadAJUSTECCCLIENTEAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.AJUCCCLI ( "Fecexpo","Fecimpo","Fmodifw","Fectrans","Faltafw","Timestamp","Anulado","Horaimpo","Hmodifw","Valtafw","Saltafw","Zadsfw","Descfw","Vmodifw","Horaexpo","Ualtafw","Umodifw","Smodifw","Esttrans","Bdaltafw","Haltafw","Bdmodifw","Fven","Valor","Moneda","Motivo","Facttipo","Fletra","Fptoven","Fnumcomp","Ffch","Codigo","Fobs" ) values ( <<"'" + this.ConvertirDateSql( lxAjucccliFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucccliFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucccliFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucccliFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjucccliFaltafw ) + "'" >>, <<lxAjucccliTimestamp >>, <<iif( lxAjucccliAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAjucccliHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliFven ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliValor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliMotivo ) + "'" >>, <<lxAjucccliFacttipo >>, <<"'" + this.FormatearTextoSql( lxAjucccliFletra ) + "'" >>, <<lxAjucccliFptoven >>, <<lxAjucccliFnumcomp >>, <<"'" + this.ConvertirDateSql( lxAjucccliFfch ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjucccliFobs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.AJUCCCLI set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAjucccliFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAjucccliFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAjucccliFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAjucccliFectrans ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAjucccliFaltafw ) + "'">>,"Timestamp" = <<lxAjucccliTimestamp>>,"Anulado" = <<iif( lxAjucccliAnulado, 1, 0 )>>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAjucccliHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAjucccliHmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAjucccliValtafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAjucccliSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAjucccliZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxAjucccliDescfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAjucccliVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAjucccliHoraexpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAjucccliUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAjucccliUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAjucccliSmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAjucccliEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAjucccliBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAjucccliHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAjucccliBdmodifw ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxAjucccliFven ) + "'">>,"Valor" = <<"'" + this.FormatearTextoSql( lxAjucccliValor ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxAjucccliMoneda ) + "'">>,"Motivo" = <<"'" + this.FormatearTextoSql( lxAjucccliMotivo ) + "'">>,"Facttipo" = <<lxAjucccliFacttipo>>,"Fletra" = <<"'" + this.FormatearTextoSql( lxAjucccliFletra ) + "'">>,"Fptoven" = <<lxAjucccliFptoven>>,"Fnumcomp" = <<lxAjucccliFnumcomp>>,"Ffch" = <<"'" + this.ConvertirDateSql( lxAjucccliFfch ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAjucccliCodigo ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxAjucccliFobs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxAjucccliCodigo ) + "'">> and  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Codigo" as "Codigo", "Fobs" as "Obs" from ZooLogic.AJUCCCLI where "Codigo" = <<"'" + this.FormatearTextoSql( lxAjucccliCodigo ) + "'">> and  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		llRetorno = .t.
		with this.oEntidad
			Local lxajucccliFLETRA As Variant, lxajucccliFPTOVEN As Variant, lxajucccliFNUMCOMP As Variant
			lxajucccliFLETRA = .Letra
			lxajucccliFPTOVEN = .PuntoDeVenta
			lxajucccliFNUMCOMP = .Numero
			local lcSentencia as string
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Codigo" as "Codigo", "Fobs" as "Obs" from ZooLogic.AJUCCCLI where  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43 And FLETRA = <<"'" + this.FormatearTextoSql( lxajucccliFLETRA ) + "'">> and FPTOVEN = <<lxajucccliFPTOVEN>> and FNUMCOMP = <<lxajucccliFNUMCOMP>>
			endtext
			use in select('c_AJUSTECCCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCCLIENTE', set( 'Datasession' ) )
			if reccount( 'c_AJUSTECCCLIENTE' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Codigo" as "Codigo", "Fobs" as "Obs" from ZooLogic.AJUCCCLI where  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43 order by FLETRA,FPTOVEN,FNUMCOMP,CODIGO
			endtext
			use in select('c_AJUSTECCCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCCLIENTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Codigo" as "Codigo", "Fobs" as "Obs" from ZooLogic.AJUCCCLI where  funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43 order by FLETRA,FPTOVEN,FNUMCOMP,CODIGO
			endtext
			use in select('c_AJUSTECCCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCCLIENTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Codigo" as "Codigo", "Fobs" as "Obs" from ZooLogic.AJUCCCLI where  funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( CODIGO, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43 order by FLETRA desc,FPTOVEN desc,FNUMCOMP desc,CODIGO desc
			endtext
			use in select('c_AJUSTECCCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCCLIENTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Codigo" as "Codigo", "Fobs" as "Obs" from ZooLogic.AJUCCCLI where  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43 order by FLETRA desc,FPTOVEN desc,FNUMCOMP desc,CODIGO desc
			endtext
			use in select('c_AJUSTECCCLIENTE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCCLIENTE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fecimpo,Fmodifw,Fectrans,Faltafw,Timestamp,Anulado,Horaimpo,Hmodifw,Valtafw,Saltafw," + ;
"Zadsfw,Descfw,Vmodifw,Horaexpo,Ualtafw,Umodifw,Smodifw,Esttrans,Bdaltafw,Haltafw,Bdmodifw,Fven,Valor" + ;
",Moneda,Motivo,Facttipo,Fletra,Fptoven,Fnumcomp,Ffch,Codigo,Fobs" + ;
" from ZooLogic.AJUCCCLI where  AJUCCCLI.CODIGO != '' AND AJUCCCLI.FACTTIPO = 43 and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirCabecera( tlLoguear as Boolean ) As Void
		local lcCursor as String, ldFecha as Date, lcHora as string, lcValorABuscar As String, lxValorClavePK As variant, lxValorClavePrimaria As variant, lcIdentificadorParaLoguear as string, lxajucccliFLETRA as variant, lxajucccliFPTOVEN as variant, lxajucccliFNUMCOMP as variant, lcMensajeExtra as String
		lcValorABuscar = ''
		lxValorClavePK = ''
		lcMensajeExtra = ''
		...
		scan all
			...
			this.oConexion.EjecutarSql( [Select * From ZooLogic.AJUCCCLI Where  FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA     ) + "'" + [ and FPTOVEN = ] + transform( &lcCursor..FPTOVEN    ) + [ and FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP   ), 'curSeek', this.datasessionid )
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.AJUCCCLI set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, VALOR = ] + "'" + this.FormatearTextoSql( &lcCursor..VALOR ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, MOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECIMPO, FMODIFW, FECTRANS, FALTAFW, TIMESTAMP, Anulado, HORAIMPO, HMODIFW, VALTAFW, SALTAFW, ZADSFW, DescFW, VMODIFW, HORAEXPO, UALTAFW, UMODIFW, SMODIFW, ESTTRANS, BDALTAFW, HALTAFW, BDMODIFW, FVEN, VALOR, Moneda, MOTIVO, FACTTIPO, FLETRA, FPTOVEN, FNUMCOMP, FFCH, CODIGO, FObs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALOR ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'" + ',' + transform( &lcCursor..FACTTIPO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPTOVEN ) + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.VALOR = isnull( d.VALOR, t.VALOR ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FOBS = isnull( d.FOBS, t.FOBS )
				...
				-- Fin Updates
				insert into ZooLogic.AJUCCCLI(Fecexpo,Fecimpo,Fmodifw,Fectrans,Faltafw,Timestamp,Anulado,Horaimpo,Hmodifw,Valtafw,Saltafw,Zadsfw,Descfw,Vmodifw,Horaexpo,Ualtafw,Umodifw,Smodifw,Esttrans,Bdaltafw,Haltafw,Bdmodifw,Fven,Valor,Moneda,Motivo,Facttipo,Fletra,Fptoven,Fnumcomp,Ffch,Codigo,Fobs)
					Select isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.TIMESTAMP,0),isnull( d.ANULADO,0),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.VALTAFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.FVEN,''),isnull( d.VALOR,''),isnull( d.MONEDA,''),isnull( d.MOTIVO,''),isnull( d.FACTTIPO,0),isnull( d.FLETRA,''),isnull( d.FPTOVEN,0),isnull( d.FNUMCOMP,0),isnull( d.FFCH,''),isnull( d.CODIGO,''),isnull( d.FOBS,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_AJUSTECCCLIENTE' ) < 1
				...
				Try
					...
					.Vendedor_PK =  nvl( c_AJUSTECCCLIENTE.Vendedor, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="AJUSTECCCLIENTE                         " atributo="FECHATRANSFERENCIA                      " tabla="AJUCCCLI       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTECCCLIENTE                         " atributo="ESTADOTRANSFERENCIA                     " tabla="AJUCCCLI       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTECCCLIENTE                         " atributo="HORAALTAFW                              " tabla="AJUCCCLI       " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTECCCLIENTE                         " atributo="VENDEDOR                                " tabla="AJUCCCLI       " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="8" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTECCCLIENTE                         " atributo="TIPOCOMPROBANTE                         " tabla="AJUCCCLI       " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=43                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="0" etiqueta="Tipo de comprobante                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="50" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
