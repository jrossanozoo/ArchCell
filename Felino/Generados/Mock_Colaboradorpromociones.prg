...
define class Mock_COLABORADORPROMOCIONES as MockBase of MockBase.prg

	cClase = 'COLABORADORPROMOCIONES'
	...
	*-----------------------------------------------------------------------------------------
	function agregarcomprobanteparaevaluacion( tocomprobante as object ) as void                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Agregarcomprobanteparaevaluacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function debeevaluarpromocionesbancarias( tdfecha as date ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Debeevaluarpromocionesbancarias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function espromocionbancariaconcuotas( tcpromocion as string ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Espromocionbancariaconcuotas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estaconfiguradoparapromocionesbancarias() as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Estaconfiguradoparapromocionesbancarias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existencuotassinrecargo() as boolean                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Existencuotassinrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existenpromocionesbancariasvigentes( tdfechacomprobante as date ) as boolean                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Existenpromocionesbancariasvigentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function existenpromocionesbancariasvigentesconcuotassinrecargo( tdfechacomprobante as date ) as boolean                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Existenpromocionesbancariasvigentesconcuotassinrecargo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function haypromocionesautomaticasvigentes( tdfecha as date ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Haypromocionesautomaticasvigentes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function implementapromociones() as boolean                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Implementapromociones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercodigodepromocionsugerida( toentidad as object, topromociones as collection ) as string                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercodigodepromocionsugerida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionpromocionesbancariasespecificas( tdvigencia as date, tlhaycuotassinrecargo as boolean, tlsoloconcuotassinrecargo as boolean ) as collection                                                                                      
		...
		lnParametros = pcount()
		lxParam1 = tdvigencia
		lxParam2 = tlhaycuotassinrecargo
		lxParam3 = tlsoloconcuotassinrecargo
		...
		return this.ObtenerResultado( 'Obtenercoleccionpromocionesbancariasespecificas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionpromocionesbancariaspriorizadas( tdvigencia as date, tlhaycuotassinrecargo as boolean, tlsoloconcuotassinrecargo as boolean ) as collection                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercoleccionpromocionesbancariaspriorizadas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerpromocionevaluada( toentidad as object, topromociones as collection ) as object                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenerpromocionevaluada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertopedecuotasconrecargo( tccodigo as string ) as integer                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenertopedecuotasconrecargo', lcParametros )
	EndFunc
