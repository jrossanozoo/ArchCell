...
case @TipoDeComprobante
	...
	when 40 then 'Requerimiento De Compra'
	when 41 then 'Remito De Compra'
	when 42 then 'Ajuste De Cuenta Corriente De Proveedores'
	when 43 then 'Ajuste De Cuenta Corriente De Clientes'
	when 44 then 'Cancelación De Compra'
