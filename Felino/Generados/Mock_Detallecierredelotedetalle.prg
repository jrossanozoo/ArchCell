...
define class Mock_Detallecierredelotedetalle as MockBase of MockBase.prg

	cClase = 'Detallecierredelotedetalle'
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montototal() as boolean                                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventocambiosum_montototal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montototalanulacioncompras() as boolean                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Eventocambiosum_montototalanulacioncompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montototalanulaciondevoluciones() as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Eventocambiosum_montototalanulaciondevoluciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montototalcompras() as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Eventocambiosum_montototalcompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocambiosum_montototaldevoluciones() as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Eventocambiosum_montototaldevoluciones', lcParametros )
	EndFunc
