...
define class Mock_ADAPTERVALIDADORACEPTACIONDEVALORES as MockBase of MockBase.prg

	cClase = 'ADAPTERVALIDADORACEPTACIONDEVALORES'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	oAceptadorDeValoresFactoria = null                                                                                                                                                                                                                        
	oArgumentos = null                                                                                                                                                                                                                                        
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	oValidadorDeValores = null                                                                                                                                                                                                                                
	...
	*-----------------------------------------------------------------------------------------
	function agregarvaloresalargumento( toargumentos as object, tocolvalores as collection ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toargumentos
		lxParam2 = tocolvalores
		...
		return this.ObtenerResultado( 'Agregarvaloresalargumento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oaceptadordevaloresfactoria_access() as variant                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oaceptadordevaloresfactoria_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oargumentos_access() as variant                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oargumentos_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ovalidadordevalores_access() as variant                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ovalidadordevalores_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar( toargumentos, tocolvalores ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
