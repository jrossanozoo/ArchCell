...
define class Din_EntidadFACTURADEEXPORTACION as Ent_ComprobanteExportacion of Ent_ComprobanteExportacion.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><VENTAS><CONVALORES><FISCAL><PICKING><INTERVINIENTE><VALORCIERRE><DESCUENTOAUTOMATICO><ACTUALIZAEMAILCLIENTE>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
