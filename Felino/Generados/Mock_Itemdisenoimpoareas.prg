...
define class Mock_Itemdisenoimpoareas as MockBase of MockBase.prg

	cClase = 'Itemdisenoimpoareas'
	...
	*-----------------------------------------------------------------------------------------
	function cargaparcial_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Cargaparcial_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detecciondetallevalor_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Detecciondetallevalor_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cargaparcial( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_cargaparcial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_detecciondetallevalor( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Setear_detecciondetallevalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cargaparcial( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_cargaparcial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_detecciondetallevalor( txval as variant ) as boolean                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Validar_detecciondetallevalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocargaparcial() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridocargaparcial', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodetecciondetallevalor() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridodetecciondetallevalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwcargaparcial() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridofwcargaparcial', lcParametros )
	EndFunc
