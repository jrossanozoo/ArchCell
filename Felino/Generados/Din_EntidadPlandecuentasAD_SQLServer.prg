	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PLANCUENTA ( "Faltafw","Fecexpo","Fmodifw","Fecimpo","Fectrans","Ctacodigo","Horaexpo","Horaimpo","Ualtafw","Vmodifw","Zadsfw","Valtafw","Umodifw","Saltafw","Smodifw","Hmodifw","Bdmodifw","Haltafw","Esttrans","Bdaltafw","Ctamayor","Obs","Ctanumero","Descrip","Apodo","Ctaimput","Ctatipo","Derefund","Reqccosto","Ctarefund","Ajustainf","Cajuste","Indiceaju" ) values ( <<"'" + this.ConvertirDateSql( lxPlancuentaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPlancuentaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPlancuentaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPlancuentaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxPlancuentaFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaCtacodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaCtamayor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaCtanumero ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaApodo ) + "'" >>, <<iif( lxPlancuentaCtaimput, 1, 0 ) >>, <<lxPlancuentaCtatipo >>, <<lxPlancuentaDerefund >>, <<iif( lxPlancuentaReqccosto, 1, 0 ) >>, <<iif( lxPlancuentaCtarefund, 1, 0 ) >>, <<iif( lxPlancuentaAjustainf, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxPlancuentaCajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxPlancuentaIndiceaju ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.PLANCUENTA set "Faltafw" = <<"'" + this.ConvertirDateSql( lxPlancuentaFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxPlancuentaFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxPlancuentaFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxPlancuentaFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxPlancuentaFectrans ) + "'">>,"Ctacodigo" = <<"'" + this.FormatearTextoSql( lxPlancuentaCtacodigo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxPlancuentaHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxPlancuentaHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxPlancuentaUaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxPlancuentaVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxPlancuentaZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxPlancuentaValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxPlancuentaUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxPlancuentaSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxPlancuentaSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxPlancuentaHmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxPlancuentaBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxPlancuentaHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxPlancuentaEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxPlancuentaBdaltafw ) + "'">>,"Ctamayor" = <<"'" + this.FormatearTextoSql( lxPlancuentaCtamayor ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxPlancuentaObs ) + "'">>,"Ctanumero" = <<"'" + this.FormatearTextoSql( lxPlancuentaCtanumero ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxPlancuentaDescrip ) + "'">>,"Apodo" = <<"'" + this.FormatearTextoSql( lxPlancuentaApodo ) + "'">>,"Ctaimput" = <<iif( lxPlancuentaCtaimput, 1, 0 )>>,"Ctatipo" = <<lxPlancuentaCtatipo>>,"Derefund" = <<lxPlancuentaDerefund>>,"Reqccosto" = <<iif( lxPlancuentaReqccosto, 1, 0 )>>,"Ctarefund" = <<iif( lxPlancuentaCtarefund, 1, 0 )>>,"Ajustainf" = <<iif( lxPlancuentaAjustainf, 1, 0 )>>,"Cajuste" = <<"'" + this.FormatearTextoSql( lxPlancuentaCajuste ) + "'">>,"Indiceaju" = <<"'" + this.FormatearTextoSql( lxPlancuentaIndiceaju ) + "'">> where "Ctacodigo" = <<"'" + this.FormatearTextoSql( lxPlancuentaCtacodigo ) + "'">> and  PLANCUENTA.CTACODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Ctacodigo" as "Codigo", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Ctamayor" as "Mayor", "Obs" as "Obs", "Ctanumero" as "Cuenta", "Descrip" as "Descripcion", "Apodo" as "Apodo", "Ctaimput" as "Esimputable", "Ctatipo" as "Tipo", "Derefund" as "Derefundicion", "Reqccosto" as "Requierecdc", "Ctarefund" as "Esderefundicion", "Ajustainf" as "Ajustaporinflacion", "Cajuste" as "Cuentaajusteporinflacion", "Indiceaju" as "Indicesinflacion" from ZooLogic.PLANCUENTA where "Ctacodigo" = <<"'" + this.FormatearTextoSql( lxPlancuentaCtacodigo ) + "'">> and  PLANCUENTA.CTACODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Faltafw,Fecexpo,Fmodifw,Fecimpo,Fectrans,Ctacodigo,Horaexpo,Horaimpo,Ualtafw,Vmodifw,Zadsfw," + ;
"Valtafw,Umodifw,Saltafw,Smodifw,Hmodifw,Bdmodifw,Haltafw,Esttrans,Bdaltafw,Ctamayor,Obs,Ctanumero,De" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FALTAFW, FECEXPO, FMODIFW, FECIMPO, FECTRANS, ctacodigo, HORAEXPO, HORAIMPO, UALTAFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SALTAFW, SMODIFW, HMODIFW, BDMODIFW, HALTAFW, ESTTRANS, BDALTAFW, ctamayor, Obs, ctanumero, descrip, apodo, ctaimput, ctatipo, Derefund, reqccosto, ctarefund, AjustaInf, CAjuste, IndiceAju
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ctamayor ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad PLANDECUENTAS. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.CTACODIGO = isnull( d.CTACODIGO, t.CTACODIGO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.CTAMAYOR = isnull( d.CTAMAYOR, t.CTAMAYOR ),t.OBS = isnull( d.OBS, t.OBS ),t.CTANUMERO = isnull( d.CTANUMERO, t.CTANUMERO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.APODO = isnull( d.APODO, t.APODO ),t.CTAIMPUT = isnull( d.CTAIMPUT, t.CTAIMPUT ),t.CTATIPO = isnull( d.CTATIPO, t.CTATIPO ),t.DEREFUND = isnull( d.DEREFUND, t.DEREFUND ),t.REQCCOSTO = isnull( d.REQCCOSTO, t.REQCCOSTO ),t.CTAREFUND = isnull( d.CTAREFUND, t.CTAREFUND ),t.AJUSTAINF = isnull( d.AJUSTAINF, t.AJUSTAINF ),t.CAJUSTE = isnull( d.CAJUSTE, t.CAJUSTE ),t.INDICEAJU = isnull( d.INDICEAJU, t.INDICEAJU )
				...
				insert into ZooLogic.PLANCUENTA(Faltafw,Fecexpo,Fmodifw,Fecimpo,Fectrans,Ctacodigo,Horaexpo,Horaimpo,Ualtafw,Vmodifw,Zadsfw,Valtafw,Umodifw,Saltafw,Smodifw,Hmodifw,Bdmodifw,Haltafw,Esttrans,Bdaltafw,Ctamayor,Obs,Ctanumero,Descrip,Apodo,Ctaimput,Ctatipo,Derefund,Reqccosto,Ctarefund,Ajustainf,Cajuste,Indiceaju)
					Select CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.CTACODIGO,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.CTAMAYOR,''),isnull( d.OBS,''),isnull( d.CTANUMERO,''),isnull( d.DESCRIP,''),isnull( d.APODO,''),isnull( d.CTAIMPUT,0),isnull( d.CTATIPO,0),isnull( d.DEREFUND,0),isnull( d.REQCCOSTO,0),isnull( d.CTAREFUND,0),isnull( d.AJUSTAINF,0),isnull( d.CAJUSTE,''),isnull( d.INDICEAJU,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_PLANDECUENTAS' ) < 1
				...
				Try
					...
					.Indicesinflacion = nvl( c_PLANDECUENTAS.Indicesinflacion, [] )
				Catch To loError
					goServicios.Errores.LevantarExcepcion( loError )
				Finally
					.lCargando = .f.
...
<VFPData xml:space="preserve">
	...
	<row entidad="PLANDECUENTAS                           " atributo="FECHAEXPO                               " tabla="PLANCUENTA     " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="FECHAMODIFICACIONFW                     " tabla="PLANCUENTA     " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="FECHAIMPO                               " tabla="PLANCUENTA     " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="FECHATRANSFERENCIA                      " tabla="PLANCUENTA     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="CODIGO                                  " tabla="PLANCUENTA     " campo="CTACODIGO " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="1" etiqueta="Cuenta                                                                                                                                                          " dominio="CODIGOSOLONUMEROS             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="HORAEXPO                                " tabla="PLANCUENTA     " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PLANDECUENTAS                           " atributo="VERSIONMODIFICACIONFW                   " tabla="PLANCUENTA     " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PLANDECUENTAS                           " atributo="VERSIONALTAFW                           " tabla="PLANCUENTA     " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PLANDECUENTAS                           " atributo="SERIEMODIFICACIONFW                     " tabla="PLANCUENTA     " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PLANDECUENTAS                           " atributo="ESTADOTRANSFERENCIA                     " tabla="PLANCUENTA     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PLANDECUENTAS                           " atributo="LISTADECUENTAS                          " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Plan de cuentas                                                                                                                                                 " dominio="COMBO                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="MAYOR                                   " tabla="PLANCUENTA     " campo="CTAMAYOR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PLANDECUENTAS                           " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="3" etiqueta="Mayor                                                                                                                                                           " dominio="CODIGOSOLONUMEROS             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="&quot; plancuenta.ctaimput = .f. &quot;                                                                                                                                                                           " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PLANDECUENTAS                           " atributo="AJUSTAPORINFLACION                      " tabla="PLANCUENTA     " campo="AJUSTAINF " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="207" etiqueta="Ajusta por inflación                                                                                                                                            " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="CUENTAAJUSTEPORINFLACION                " tabla="PLANCUENTA     " campo="CAJUSTE   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PLANDECUENTAS                           " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="208" etiqueta="Cuenta de ajuste                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="11" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PLANDECUENTAS                           " atributo="INDICESINFLACION                        " tabla="PLANCUENTA     " campo="INDICEAJU " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="209" etiqueta="Indice                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="12" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
