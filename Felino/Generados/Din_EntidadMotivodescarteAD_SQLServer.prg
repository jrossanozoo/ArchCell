	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.MOTIVODESCARTE ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Timestamp","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaimpo","Bdaltafw","Esttrans","Bdmodifw","Haltafw","Horaexpo","Obs","Codigo","Descrip","Inventario" ) values ( <<"'" + this.ConvertirDateSql( lxMotivodescarteFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMotivodescarteFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMotivodescarteFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMotivodescarteFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxMotivodescarteFectrans ) + "'" >>, <<lxMotivodescarteTimestamp >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxMotivodescarteInventario ) + "'" >> )
			endtext
		...
		this.oEntidad.Timestamp = lxMotivodescarteTimestamp
		endwith
...
"adsfw,Vmodifw,Hmodifw,Horaimpo,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Horaexpo,Obs,Codigo,Descrip,Invent" + ;
"ario" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Obs" as "Obs", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Inventario" as "Inventario"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, TIMESTAMP, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAIMPO, BDALTAFW, ESTTRANS, BDMODIFW, HALTAFW, HORAEXPO, Obs, Codigo, Descrip, Inventario
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Inventario ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.OBS = isnull( d.OBS, t.OBS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.INVENTARIO = isnull( d.INVENTARIO, t.INVENTARIO )
					from ZooLogic.MOTIVODESCARTE t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.MOTIVODESCARTE(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Timestamp,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaimpo,Bdaltafw,Esttrans,Bdmodifw,Haltafw,Horaexpo,Obs,Codigo,Descrip,Inventario)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.OBS,''),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.INVENTARIO,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_MOTIVODESCARTE' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_MOTIVODESCARTE.Timestamp, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="MOTIVODESCARTE                          " atributo="FECHATRANSFERENCIA                      " tabla="MOTIVODESCARTE " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                                                                                                                       " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="MOTIVODESCARTE                          " atributo="TIMESTAMP                               " tabla="MOTIVODESCARTE " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOTIVODESCARTE                          " atributo="ESTADOTRANSFERENCIA                     " tabla="MOTIVODESCARTE " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="MOTIVODESCARTE                          " atributo="DESCRIPCION                             " tabla="MOTIVODESCARTE " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Descripción del imotivo de descarte                                                                                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
