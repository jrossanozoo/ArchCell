...
define class Mock_Valoresentransitoad_sqlserver as MockBase of MockBase.prg

	cClase = 'Valoresentransitoad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_vtransdet( tctablatrabajo ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_vtransdet', lcParametros )
	EndFunc
