...
define class Mock_tiinventariofisicodetalletmp as MockBase of MockBase.prg
	...
	cClase = 'tiinventariofisicodetalletmp'
	...
	Cantidad = 0                                                                                                                                                                                                                                              
	Codigo = 0                                                                                                                                                                                                                                                
	CodigoDiferencia = null                                                                                                                                                                                                                                   
	CodigoDiferencia_PK = 0                                                                                                                                                                                                                                   
	Color = null                                                                                                                                                                                                                                              
	Color_PK = ""                                                                                                                                                                                                                                             
	ESTADOTRANSFERENCIA = ""                                                                                                                                                                                                                                  
	FECHAALTAFW = ctod( '  /  /    ' )                                                                                                                                                                                                                        
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Detalle de inventario físico temporal"                                                                                                                                                                                                   
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'TIINVENTARIOFISICODETALLETMP'                                                                                                                                                                                                                  
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	*-----------------------------------------------------------------------------------------
	function codigodiferencia_access() as variant                                                                                                                                                                                                             
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOFISICODETALLETMP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'codigodiferencia_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'codigodiferencia_access', lcParametros )			endif		endif		if this.ldestroy		else			if This.lInstanciarSubEntidadaDemanda				if ( !vartype( this.Codigodiferencia ) = 'O' or isnull( this.Codigodiferencia ) )					this.Codigodiferencia = _Screen.zoo.instanciarentidad( 'Tiinventariofisicodetalle' )					this.Codigodiferencia.lEsSubEntidad = .t.					this.enlazar( 'Codigodiferencia.EventoObtenerLogueo', 'inyectarLogueo' )					this.enlazar( 'Codigodiferencia.EventoObtenerInformacion', 'inyectarInformacion' )				endif				if !this.lBuscandoCodigo					if this.Codigodiferencia.CODIGO # this.Codigodiferencia_PK						this.Codigodiferencia.CODIGO = this.Codigodiferencia_PK					endif				endif			endif		endif		return this.Codigodiferencia
	EndFunc

	*-----------------------------------------------------------------------------------------
	function codigodiferencia_pk_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOFISICODETALLETMP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'codigodiferencia_pk_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'codigodiferencia_pk_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Codigodiferencia_PK		local lxVal as Variant		local loSugerido as Object				lxVal = txVal		this.Codigodiferencia_PK = lxVal		if this.Validar_Codigodiferencia( lxVal, lxValOld )			This.Setear_Codigodiferencia( lxVal )		endif		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigodiferencia( txval as variant ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOFISICODETALLETMP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_codigodiferencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_codigodiferencia', lcParametros )			endif		endif		this.Codigodiferencia.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigodiferencia( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'TIINVENTARIOFISICODETALLETMP' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_codigodiferencia', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_codigodiferencia', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcodigodiferencia() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarcodigodiferencia', lcParametros )
	EndFunc
