	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.EJERCICIO ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Timestamp","Ualtafw","Smodifw","Umodifw","Zadsfw","Valtafw","Vmodifw","Saltafw","Haltafw","Hmodifw","Bdmodifw","Bdaltafw","Esttrans","Horaimpo","Horaexpo","Eobs","Fechades","Numero","Fechahas","Descrip","Razons" ) values ( <<"'" + this.ConvertirDateSql( lxEjercicioFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEjercicioFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEjercicioFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEjercicioFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEjercicioFmodifw ) + "'" >>, <<lxEjercicioTimestamp >>, <<"'" + this.FormatearTextoSql( lxEjercicioUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioEobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEjercicioFechades ) + "'" >>, <<lxEjercicioNumero >>, <<"'" + this.ConvertirDateSql( lxEjercicioFechahas ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEjercicioRazons ) + "'" >> )
			endtext
		...
		this.oEntidad.Timestamp = lxEjercicioTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.EJERCICIO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEjercicioFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEjercicioFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxEjercicioFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEjercicioFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEjercicioFmodifw ) + "'">>,"Timestamp" = <<lxEjercicioTimestamp>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEjercicioUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEjercicioZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEjercicioValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioVmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEjercicioSaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEjercicioHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioHmodifw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEjercicioBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEjercicioEsttrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEjercicioHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEjercicioHoraexpo ) + "'">>,"Eobs" = <<"'" + this.FormatearTextoSql( lxEjercicioEobs ) + "'">>,"Fechades" = <<"'" + this.ConvertirDateSql( lxEjercicioFechades ) + "'">>,"Numero" = <<lxEjercicioNumero>>,"Fechahas" = <<"'" + this.ConvertirDateSql( lxEjercicioFechahas ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxEjercicioDescrip ) + "'">>,"Razons" = <<"'" + this.FormatearTextoSql( lxEjercicioRazons ) + "'">> where "Numero" = <<lxEjercicioNumero>> and  EJERCICIO.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Fechades" as "Fechadesde", "Numero" as "Numero", "Fechahas" as "Fechahasta", "Descrip" as "Descripcion", "Razons" as "Razonsocial" from ZooLogic.EJERCICIO where "Numero" = <<lxEjercicioNumero>> and  EJERCICIO.NUMERO != 0
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Fechades" as "Fechadesde", "Numero" as "Numero", "Fechahas" as "Fechahasta", "Descrip" as "Descripcion", "Razons" as "Razonsocial" from ZooLogic.EJERCICIO where  EJERCICIO.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_EJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Fechades" as "Fechadesde", "Numero" as "Numero", "Fechahas" as "Fechahasta", "Descrip" as "Descripcion", "Razons" as "Razonsocial" from ZooLogic.EJERCICIO where  str( NUMERO, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  EJERCICIO.NUMERO != 0 order by NUMERO
			endtext
			use in select('c_EJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Fechades" as "Fechadesde", "Numero" as "Numero", "Fechahas" as "Fechahasta", "Descrip" as "Descripcion", "Razons" as "Razonsocial" from ZooLogic.EJERCICIO where  str( NUMERO, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  EJERCICIO.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_EJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EJERCICIO', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Fechades" as "Fechadesde", "Numero" as "Numero", "Fechahas" as "Fechahasta", "Descrip" as "Descripcion", "Razons" as "Razonsocial" from ZooLogic.EJERCICIO where  EJERCICIO.NUMERO != 0 order by NUMERO desc
			endtext
			use in select('c_EJERCICIO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_EJERCICIO', set( 'Datasession' ) )
			Endwith
...
"odifw,Saltafw,Haltafw,Hmodifw,Bdmodifw,Bdaltafw,Esttrans,Horaimpo,Horaexpo,Eobs,Fechades,Numero,Fech" + ;
"ahas,Descrip,Razons" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Eobs" as "Observacion", "Fechades" as "Fechadesde", "Numero" as "Numero", "Fechahas" as "Fechahasta", "Descrip" as "Descripcion", "Razons" as "Razonsocial"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.EJERCICIO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEjercicioFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxEjercicioFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEjercicioFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxEjercicioFaltafw ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxEjercicioFmodifw ) + "'">>, "Timestamp" = <<lxEjercicioTimestamp>>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxEjercicioUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxEjercicioZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxEjercicioValtafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioVmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxEjercicioSaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxEjercicioHaltafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioHmodifw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEjercicioBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEjercicioBdaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxEjercicioEsttrans ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxEjercicioHoraimpo ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxEjercicioHoraexpo ) + "'">>, "Eobs" = <<"'" + this.FormatearTextoSql( lxEjercicioEobs ) + "'">>, "Fechades" = <<"'" + this.ConvertirDateSql( lxEjercicioFechades ) + "'">>, "Numero" = <<lxEjercicioNumero>>, "Fechahas" = <<"'" + this.ConvertirDateSql( lxEjercicioFechahas ) + "'">>, "Descrip" = <<"'" + this.FormatearTextoSql( lxEjercicioDescrip ) + "'">>, "Razons" = <<"'" + this.FormatearTextoSql( lxEjercicioRazons ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'EJERCICIO' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.EJERCICIO set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, EOBS = ] + "'" + this.FormatearTextoSql( &lcCursor..EOBS ) + "'"+ [, FECHADES = ] + "'" + this.ConvertirDateSql( &lcCursor..FECHADES ) + "'"+ [, NUMERO = ] + transform( &lcCursor..NUMERO )+ [, FECHAHAS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECHAHAS ) + "'"+ [, DESCRIP = ] + "'" + this.FormatearTextoSql( &lcCursor..DESCRIP ) + "'"+ [, Razons = ] + "'" + this.FormatearTextoSql( &lcCursor..Razons ) + "'" + [ Where NUMERO = ] + transform( &lcCursor..NUMERO ) )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, TIMESTAMP, UALTAFW, SMODIFW, UMODIFW, ZADSFW, VALTAFW, VMODIFW, SALTAFW, HALTAFW, HMODIFW, BDMODIFW, BDALTAFW, ESTTRANS, HORAIMPO, HORAEXPO, EOBS, FECHADES, NUMERO, FECHAHAS, DESCRIP, Razons
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..EOBS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECHADES ) + "'" + ',' + transform( &lcCursor..NUMERO ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECHAHAS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DESCRIP ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Razons ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.EOBS = isnull( d.EOBS, t.EOBS ),t.FECHADES = isnull( d.FECHADES, t.FECHADES ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.FECHAHAS = isnull( d.FECHAHAS, t.FECHAHAS ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.RAZONS = isnull( d.RAZONS, t.RAZONS )
					from ZooLogic.EJERCICIO t inner join deleted d 
							 on t.NUMERO = d.NUMERO
				-- Fin Updates
				insert into ZooLogic.EJERCICIO(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Timestamp,Ualtafw,Smodifw,Umodifw,Zadsfw,Valtafw,Vmodifw,Saltafw,Haltafw,Hmodifw,Bdmodifw,Bdaltafw,Esttrans,Horaimpo,Horaexpo,Eobs,Fechades,Numero,Fechahas,Descrip,Razons)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.SALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.EOBS,''),isnull( d.FECHADES,''),isnull( d.NUMERO,0),isnull( d.FECHAHAS,''),isnull( d.DESCRIP,''),isnull( d.RAZONS,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_EJERCICIO' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_EJERCICIO.Timestamp, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="EJERCICIO                               " atributo="FECHATRANSFERENCIA                      " tabla="EJERCICIO      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EJERCICIO                               " atributo="TIMESTAMP                               " tabla="EJERCICIO      " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="EJERCICIO                               " atributo="ESTADOTRANSFERENCIA                     " tabla="EJERCICIO      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
