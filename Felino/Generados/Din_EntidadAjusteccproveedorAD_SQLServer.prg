	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.AJUCCPRO ( "Fecexpo","Fecimpo","Faltafw","Fmodifw","Fectrans","Timestamp","Anulado","Hmodifw","Horaimpo","Ualtafw","Saltafw","Zadsfw","Descfw","Vmodifw","Valtafw","Horaexpo","Umodifw","Smodifw","Bdaltafw","Haltafw","Bdmodifw","Esttrans","Fven","Valor","Moneda","Motivo","Facttipo","Fletra","Fptoven","Fnumcomp","Ffch","Cotiz","Codigo","Fobs","Montosin","Montocon","Fsubton" ) values ( <<"'" + this.ConvertirDateSql( lxAjuccproFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuccproFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuccproFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuccproFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxAjuccproFectrans ) + "'" >>, <<lxAjuccproTimestamp >>, <<iif( lxAjuccproAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxAjuccproHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproFven ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproValor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproMotivo ) + "'" >>, <<lxAjuccproFacttipo >>, <<"'" + this.FormatearTextoSql( lxAjuccproFletra ) + "'" >>, <<lxAjuccproFptoven >>, <<lxAjuccproFnumcomp >>, <<"'" + this.ConvertirDateSql( lxAjuccproFfch ) + "'" >>, <<lxAjuccproCotiz >>, <<"'" + this.FormatearTextoSql( lxAjuccproCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxAjuccproFobs ) + "'" >>, <<lxAjuccproMontosin >>, <<lxAjuccproMontocon >>, <<lxAjuccproFsubton >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.AJUCCPRO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxAjuccproFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxAjuccproFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxAjuccproFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxAjuccproFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxAjuccproFectrans ) + "'">>,"Timestamp" = <<lxAjuccproTimestamp>>,"Anulado" = <<iif( lxAjuccproAnulado, 1, 0 )>>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxAjuccproHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxAjuccproHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxAjuccproUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxAjuccproSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxAjuccproZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxAjuccproDescfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxAjuccproVmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxAjuccproValtafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxAjuccproHoraexpo ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxAjuccproUmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxAjuccproSmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxAjuccproBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxAjuccproHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxAjuccproBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxAjuccproEsttrans ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxAjuccproFven ) + "'">>,"Valor" = <<"'" + this.FormatearTextoSql( lxAjuccproValor ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxAjuccproMoneda ) + "'">>,"Motivo" = <<"'" + this.FormatearTextoSql( lxAjuccproMotivo ) + "'">>,"Facttipo" = <<lxAjuccproFacttipo>>,"Fletra" = <<"'" + this.FormatearTextoSql( lxAjuccproFletra ) + "'">>,"Fptoven" = <<lxAjuccproFptoven>>,"Fnumcomp" = <<lxAjuccproFnumcomp>>,"Ffch" = <<"'" + this.ConvertirDateSql( lxAjuccproFfch ) + "'">>,"Cotiz" = <<lxAjuccproCotiz>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxAjuccproCodigo ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxAjuccproFobs ) + "'">>,"Montosin" = <<lxAjuccproMontosin>>,"Montocon" = <<lxAjuccproMontocon>>,"Fsubton" = <<lxAjuccproFsubton>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxAjuccproCodigo ) + "'">> and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function HayDatos() as boolean
		local llhaydatos as boolean, lcXml as String
			 lcXml = this.oConexion.EjecutarSql( "select Top 1 CODIGO from ZooLogic.AJUCCPRO where " + this.ConvertirFuncionesSql( " AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42" ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Horaexpo" as "Horaexpo", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Cotiz" as "Cotizacion", "Codigo" as "Codigo", "Fobs" as "Obs", "Montosin" as "Montocomprobantesinimpuesto", "Montocon" as "Montocomprobanteconimpuesto", "Fsubton" as "Subtotalneto" from ZooLogic.AJUCCPRO where "Codigo" = <<"'" + this.FormatearTextoSql( lxAjuccproCodigo ) + "'">> and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function VerificarExistenciaClavePrimaria( txVal as Variant ) as Boolean
		...
		lxAjuccproCodigo = txVal
			...
			text to lcSentencia textmerge noshow
				select count( * ) as CantidadDeRegistros from ZooLogic.AJUCCPRO where "Codigo" = <<"'" + this.FormatearTextoSql( lxAjuccproCodigo ) + "'">> and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Horaexpo" as "Horaexpo", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Cotiz" as "Cotizacion", "Codigo" as "Codigo", "Fobs" as "Obs", "Montosin" as "Montocomprobantesinimpuesto", "Montocon" as "Montocomprobanteconimpuesto", "Fsubton" as "Subtotalneto" from ZooLogic.AJUCCPRO where  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42 order by FLETRA,FPTOVEN,FNUMCOMP,CODIGO
			endtext
			use in select('c_AJUSTECCPROVEEDOR')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCPROVEEDOR', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Horaexpo" as "Horaexpo", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Cotiz" as "Cotizacion", "Codigo" as "Codigo", "Fobs" as "Obs", "Montosin" as "Montocomprobantesinimpuesto", "Montocon" as "Montocomprobanteconimpuesto", "Fsubton" as "Subtotalneto" from ZooLogic.AJUCCPRO where  funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42 order by FLETRA,FPTOVEN,FNUMCOMP,CODIGO
			endtext
			use in select('c_AJUSTECCPROVEEDOR')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCPROVEEDOR', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Horaexpo" as "Horaexpo", "Umodifw" as "Usuariomodificacionfw", "Smodifw" as "Seriemodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Fven" as "Vendedor", "Valor" as "Valor", "Moneda" as "Monedacomprobante", "Motivo" as "Motivo", "Facttipo" as "Tipocomprobante", "Fletra" as "Letra", "Fptoven" as "Puntodeventa", "Fnumcomp" as "Numero", "Ffch" as "Fecha", "Cotiz" as "Cotizacion", "Codigo" as "Codigo", "Fobs" as "Obs", "Montosin" as "Montocomprobantesinimpuesto", "Montocon" as "Montocomprobanteconimpuesto", "Fsubton" as "Subtotalneto" from ZooLogic.AJUCCPRO where  funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( CODIGO, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42 order by FLETRA desc,FPTOVEN desc,FNUMCOMP desc,CODIGO desc
			endtext
			use in select('c_AJUSTECCPROVEEDOR')
			this.oConexion.EjecutarSql( lcSentencia, 'c_AJUSTECCPROVEEDOR', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fecimpo,Faltafw,Fmodifw,Fectrans,Timestamp,Anulado,Hmodifw,Horaimpo,Ualtafw,Saltafw," + ;
"Zadsfw,Descfw,Vmodifw,Valtafw,Horaexpo,Umodifw,Smodifw,Bdaltafw,Haltafw,Bdmodifw,Esttrans,Fven,Valor" + ;
",Moneda,Motivo,Facttipo,Fletra,Fptoven,Fnumcomp,Ffch,Cotiz,Codigo,Fobs,Montosin,Montocon,Fsubton" + ;
" from ZooLogic.AJUCCPRO where  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42 and " + lcFiltro )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosEntidad( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		lcWhere = " Where  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42"
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			lcFiltro = ["Codigo" = ] + lcValorClavePrimariaString  + [ and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42]
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerSentenciaActualizacionTimeStamp() As String
		...
		with this.oEntidad
			...
			lcRetorno = [update ZooLogic.AJUCCPRO set TimeStamp = ] + transform( lnTimeStamp ) + lcUpdateRealTime + [ where CODIGO = ] + "'" + this.FormatearTextoSql( .Codigo ) + "'" + [ and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42] + goServicios.RealTime.ObtenerTagEstimulo( .cNombre )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerCantidadRegistros() as integer
		local lnCantReg as integer
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select count( * ) as Total from ZooLogic.AJUCCPRO where  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42" )
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerTimestampActual() as integer
		...
		lcCursor = sys(2015)
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select TimeStamp from ZooLogic.AJUCCPRO where CODIGO = " + "'" + this.FormatearTextoSql( this.oEntidad.CODIGO ) + "'"+ " and  AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42" )
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.AJUCCPRO set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, VALOR = ] + "'" + this.FormatearTextoSql( &lcCursor..VALOR ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, MOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, MontoSin = ] + transform( &lcCursor..MontoSin )+ [, MontoCon = ] + transform( &lcCursor..MontoCon )+ [, fSubToN = ] + transform( &lcCursor..fSubToN ) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECIMPO, FALTAFW, FMODIFW, FECTRANS, TIMESTAMP, Anulado, HMODIFW, HORAIMPO, UALTAFW, SALTAFW, ZADSFW, DescFW, VMODIFW, VALTAFW, HORAEXPO, UMODIFW, SMODIFW, BDALTAFW, HALTAFW, BDMODIFW, ESTTRANS, FVEN, VALOR, Moneda, MOTIVO, FACTTIPO, FLETRA, FPTOVEN, FNUMCOMP, FFCH, Cotiz, CODIGO, FObs, MontoSin, MontoCon, fSubToN
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALOR ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'" + ',' + transform( &lcCursor..FACTTIPO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPTOVEN ) + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + transform( &lcCursor..MontoSin ) + ',' + transform( &lcCursor..MontoCon ) + ',' + transform( &lcCursor..fSubToN )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.VALOR = isnull( d.VALOR, t.VALOR ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.MONTOSIN = isnull( d.MONTOSIN, t.MONTOSIN ),t.MONTOCON = isnull( d.MONTOCON, t.MONTOCON ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON )
				...
				-- Fin Updates
				insert into ZooLogic.AJUCCPRO(Fecexpo,Fecimpo,Faltafw,Fmodifw,Fectrans,Timestamp,Anulado,Hmodifw,Horaimpo,Ualtafw,Saltafw,Zadsfw,Descfw,Vmodifw,Valtafw,Horaexpo,Umodifw,Smodifw,Bdaltafw,Haltafw,Bdmodifw,Esttrans,Fven,Valor,Moneda,Motivo,Facttipo,Fletra,Fptoven,Fnumcomp,Ffch,Cotiz,Codigo,Fobs,Montosin,Montocon,Fsubton)
					Select isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.TIMESTAMP,0),isnull( d.ANULADO,0),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.VMODIFW,''),isnull( d.VALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.UMODIFW,''),isnull( d.SMODIFW,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.FVEN,''),isnull( d.VALOR,''),isnull( d.MONEDA,''),isnull( d.MOTIVO,''),isnull( d.FACTTIPO,0),isnull( d.FLETRA,''),isnull( d.FPTOVEN,0),isnull( d.FNUMCOMP,0),isnull( d.FFCH,''),isnull( d.COTIZ,0),isnull( d.CODIGO,''),isnull( d.FOBS,''),isnull( d.MONTOSIN,0),isnull( d.MONTOCON,0),isnull( d.FSUBTON,0)
		...
		with this.oEntidad
			...
			if reccount( 'c_AJUSTECCPROVEEDOR' ) < 1
				...
				Try
					...
					.Vendedor_PK =  nvl( c_AJUSTECCPROVEEDOR.Vendedor, [] )
				...
				SELECT nro,totalRegistros,CODIGO as Id
				    ...
				    CODIGO from (
							select * 
								...
								Where   AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42
									and <<tcFiltro>>
							 ) a
					 ) b
...
define class ObjetoBusqueda as custom
	Tabla = 'AJUCCPRO'
	Filtro = " AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42"
	oEntidad = null
	cEstructura = ''
	cEstructuraDetalle = ''
	cEstructuraSinDetalle = ''
	listadecampos = ''
	Indice = " AJUCCPRO.CODIGO != '' AND AJUCCPRO.FACTTIPO = 42"
	AnchoCampo = 13
	Caracteres = 13
	nrodecolumnas = 0
	signopregunta = .T.
...
<VFPData xml:space="preserve">
	...
	<row entidad="AJUSTECCPROVEEDOR                       " atributo="FECHATRANSFERENCIA                      " tabla="AJUCCPRO       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTECCPROVEEDOR                       " atributo="HORAALTAFW                              " tabla="AJUCCPRO       " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTECCPROVEEDOR                       " atributo="ESTADOTRANSFERENCIA                     " tabla="AJUCCPRO       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="AJUSTECCPROVEEDOR                       " atributo="VENDEDOR                                " tabla="AJUCCPRO       " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="8" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="AJUSTECCPROVEEDOR                       " atributo="TIPOCOMPROBANTE                         " tabla="AJUCCPRO       " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=42                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="0" etiqueta="Tipo de comprobante                                                                                                                                             " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="50" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VENDEDOR                                " atributo="NOMBRE                                  " tabla="VEN            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="9" etiqueta="Detalle Ven.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join VEN On AJUCCPRO.FVEN = VEN.CLCOD And  VEN.CLCOD != ''                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVALORES       " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="11" etiqueta="Detalle Val.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVALORES On AJUCCPRO.VALOR = XVALORES.CLCOD And  XVALORES.CLCOD != '' AND XVALORES.CLCOD != ''                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
