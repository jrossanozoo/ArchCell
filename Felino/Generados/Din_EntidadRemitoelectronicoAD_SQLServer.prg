...
define class Din_EntidadREMITOELECTRONICOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRemelecFmodifw, lxRemelecFectrans, lxRemelecFecexpo, lxRemelecFecimpo, lxRemelecFaltafw, lxRemelecFecha, lxRemelecFecsal, lxRemelecNumero, lxRemelecEntrega, lxRemelecHmodifw, lxRemelecUmodifw, lxRemelecVmodifw, lxRemelecZadsfw, lxRemelecValtafw, lxRemelecHoraimpo, lxRemelecSmodifw, lxRemelecUaltafw, lxRemelecSaltafw, lxRemelecEsttrans, lxRemelecBdaltafw, lxRemelecHoraexpo, lxRemelecCodint, lxRemelecBdmodifw, lxRemelecHaltafw, lxRemelecTransporti, lxRemelecObs, lxRemelecDomveh, lxRemelecHora, lxRemelecSucursal, lxRemelecDomacop, lxRemelecBultos
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.REMELEC ( "Fmodifw","Fectrans","Fecexpo","Fecimpo","Faltafw","Fecha","Fecsal","Numero","Entrega","Hmodifw","Umodifw","Vmodifw","Zadsfw","Valtafw","Horaimpo","Smodifw","Ualtafw","Saltafw","Esttrans","Bdaltafw","Horaexpo","Codint","Bdmodifw","Haltafw","Transporti","Obs","Domveh","Hora","Sucursal","Domacop","Bultos" ) values ( <<"'" + this.ConvertirDateSql( lxRemelecFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRemelecFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRemelecFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRemelecFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRemelecFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRemelecFecha ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRemelecFecsal ) + "'" >>, <<lxRemelecNumero >>, <<iif( lxRemelecEntrega, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxRemelecHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecCodint ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecTransporti ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecDomveh ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecHora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecSucursal ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRemelecDomacop ) + "'" >>, <<lxRemelecBultos >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.REMELEC set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxRemelecFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRemelecFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxRemelecFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxRemelecFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRemelecFaltafw ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxRemelecFecha ) + "'">>,"Fecsal" = <<"'" + this.ConvertirDateSql( lxRemelecFecsal ) + "'">>,"Numero" = <<lxRemelecNumero>>,"Entrega" = <<iif( lxRemelecEntrega, 1, 0 )>>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRemelecHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRemelecUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRemelecVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRemelecZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRemelecValtafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRemelecHoraimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRemelecSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRemelecUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRemelecSaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRemelecEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRemelecBdaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRemelecHoraexpo ) + "'">>,"Codint" = <<"'" + this.FormatearTextoSql( lxRemelecCodint ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRemelecBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRemelecHaltafw ) + "'">>,"Transporti" = <<"'" + this.FormatearTextoSql( lxRemelecTransporti ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxRemelecObs ) + "'">>,"Domveh" = <<"'" + this.FormatearTextoSql( lxRemelecDomveh ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxRemelecHora ) + "'">>,"Sucursal" = <<"'" + this.FormatearTextoSql( lxRemelecSucursal ) + "'">>,"Domacop" = <<"'" + this.FormatearTextoSql( lxRemelecDomacop ) + "'">>,"Bultos" = <<lxRemelecBultos>> where "Numero" = <<lxRemelecNumero>> and  REMELEC.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecha" as "Fecha", "Fecsal" as "Fechasalida", "Numero" as "Numero", "Entrega" as "Entregaenorigen", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Codint" as "Codigointegridad", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Transporti" as "Transportista", "Obs" as "Observacion", "Domveh" as "Dominiovehiculo", "Hora" as "Hora", "Sucursal" as "Sucursal", "Domacop" as "Dominioacoplado", "Bultos" as "Bultos" from ZooLogic.REMELEC where "Numero" = <<lxRemelecNumero>> and  REMELEC.NUMERO != 0
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecha" as "Fecha", "Fecsal" as "Fechasalida", "Numero" as "Numero", "Entrega" as "Entregaenorigen", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Codint" as "Codigointegridad", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Transporti" as "Transportista", "Obs" as "Observacion", "Domveh" as "Dominiovehiculo", "Hora" as "Hora", "Sucursal" as "Sucursal", "Domacop" as "Dominioacoplado", "Bultos" as "Bultos" from ZooLogic.REMELEC where  REMELEC.NUMERO != 0 order by Numero
			endtext
			use in select('c_REMITOELECTRONICO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITOELECTRONICO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecha" as "Fecha", "Fecsal" as "Fechasalida", "Numero" as "Numero", "Entrega" as "Entregaenorigen", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Codint" as "Codigointegridad", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Transporti" as "Transportista", "Obs" as "Observacion", "Domveh" as "Dominiovehiculo", "Hora" as "Hora", "Sucursal" as "Sucursal", "Domacop" as "Dominioacoplado", "Bultos" as "Bultos" from ZooLogic.REMELEC where  str( Numero, 8, 0) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  REMELEC.NUMERO != 0 order by Numero
			endtext
			use in select('c_REMITOELECTRONICO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITOELECTRONICO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecha" as "Fecha", "Fecsal" as "Fechasalida", "Numero" as "Numero", "Entrega" as "Entregaenorigen", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Codint" as "Codigointegridad", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Transporti" as "Transportista", "Obs" as "Observacion", "Domveh" as "Dominiovehiculo", "Hora" as "Hora", "Sucursal" as "Sucursal", "Domacop" as "Dominioacoplado", "Bultos" as "Bultos" from ZooLogic.REMELEC where  str( Numero, 8, 0) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  REMELEC.NUMERO != 0 order by Numero desc
			endtext
			use in select('c_REMITOELECTRONICO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITOELECTRONICO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecha" as "Fecha", "Fecsal" as "Fechasalida", "Numero" as "Numero", "Entrega" as "Entregaenorigen", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Codint" as "Codigointegridad", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Transporti" as "Transportista", "Obs" as "Observacion", "Domveh" as "Dominiovehiculo", "Hora" as "Hora", "Sucursal" as "Sucursal", "Domacop" as "Dominioacoplado", "Bultos" as "Bultos" from ZooLogic.REMELEC where  REMELEC.NUMERO != 0 order by Numero desc
			endtext
			use in select('c_REMITOELECTRONICO')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REMITOELECTRONICO', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fectrans,Fecexpo,Fecimpo,Faltafw,Fecha,Fecsal,Numero,Entrega,Hmodifw,Umodifw,Vmodifw" + ;
",Zadsfw,Valtafw,Horaimpo,Smodifw,Ualtafw,Saltafw,Esttrans,Bdaltafw,Horaexpo,Codint,Bdmodifw,Haltafw," + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecha" as "Fecha", "Fecsal" as "Fechasalida", "Numero" as "Numero", "Entrega" as "Entregaenorigen", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Horaexpo" as "Horaexpo", "Codint" as "Codigointegridad", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Transporti" as "Transportista", "Obs" as "Observacion", "Domveh" as "Dominiovehiculo", "Hora" as "Hora", "Sucursal" as "Sucursal", "Domacop" as "Dominioacoplado", "Bultos" as "Bultos"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.REMELEC set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, Fecha = ] + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'"+ [, FECSAL = ] + "'" + this.ConvertirDateSql( &lcCursor..FECSAL ) + "'"+ [, Numero = ] + transform( &lcCursor..Numero )+ [, Entrega = ] + Transform( iif( &lcCursor..Entrega, 1, 0 ))+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Codint = ] + "'" + this.FormatearTextoSql( &lcCursor..Codint ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, Transporti = ] + "'" + this.FormatearTextoSql( &lcCursor..Transporti ) + "'"+ [, obs = ] + "'" + this.FormatearTextoSql( &lcCursor..obs ) + "'"+ [, DomVeh = ] + "'" + this.FormatearTextoSql( &lcCursor..DomVeh ) + "'"+ [, Hora = ] + "'" + this.FormatearTextoSql( &lcCursor..Hora ) + "'"+ [, Sucursal = ] + "'" + this.FormatearTextoSql( &lcCursor..Sucursal ) + "'"+ [, DomAcop = ] + "'" + this.FormatearTextoSql( &lcCursor..DomAcop ) + "'"+ [, Bultos = ] + transform( &lcCursor..Bultos ) + [ Where Numero = ] + transform( &lcCursor..Numero ) )
				...
				Text to lcCampos noShow
					 FMODIFW, FECTRANS, FECEXPO, FECIMPO, FALTAFW, Fecha, FECSAL, Numero, Entrega, HMODIFW, UMODIFW, VMODIFW, ZADSFW, VALTAFW, HORAIMPO, SMODIFW, UALTAFW, SALTAFW, ESTTRANS, BDALTAFW, HORAEXPO, Codint, BDMODIFW, HALTAFW, Transporti, obs, DomVeh, Hora, Sucursal, DomAcop, Bultos
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECSAL ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..Numero ) + ',' + Transform( iif( &lcCursor..Entrega, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codint ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Transporti ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..obs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DomVeh ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Hora ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.FECSAL = isnull( d.FECSAL, t.FECSAL ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.ENTREGA = isnull( d.ENTREGA, t.ENTREGA ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CODINT = isnull( d.CODINT, t.CODINT ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.TRANSPORTI = isnull( d.TRANSPORTI, t.TRANSPORTI ),t.OBS = isnull( d.OBS, t.OBS ),t.DOMVEH = isnull( d.DOMVEH, t.DOMVEH ),t.HORA = isnull( d.HORA, t.HORA ),t.SUCURSAL = isnull( d.SUCURSAL, t.SUCURSAL ),t.DOMACOP = isnull( d.DOMACOP, t.DOMACOP ),t.BULTOS = isnull( d.BULTOS, t.BULTOS )
					from ZooLogic.REMELEC t inner join deleted d 
							 on t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.REMELEC(Fmodifw,Fectrans,Fecexpo,Fecimpo,Faltafw,Fecha,Fecsal,Numero,Entrega,Hmodifw,Umodifw,Vmodifw,Zadsfw,Valtafw,Horaimpo,Smodifw,Ualtafw,Saltafw,Esttrans,Bdaltafw,Horaexpo,Codint,Bdmodifw,Haltafw,Transporti,Obs,Domveh,Hora,Sucursal,Domacop,Bultos)
					Select isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECHA,''),isnull( d.FECSAL,''),isnull( d.NUMERO,0),isnull( d.ENTREGA,0),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.HORAEXPO,''),isnull( d.CODINT,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.TRANSPORTI,''),isnull( d.OBS,''),isnull( d.DOMVEH,''),isnull( d.HORA,''),isnull( d.SUCURSAL,''),isnull( d.DOMACOP,''),isnull( d.BULTOS,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="REMITOELECTRONICO                       " atributo="FECHATRANSFERENCIA                      " tabla="REMELEC        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITOELECTRONICO                       " atributo="FECHA                                   " tabla="REMELEC        " campo="FECHA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="4" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REMITOELECTRONICO                       " atributo="FECHASALIDA                             " tabla="REMELEC        " campo="FECSAL    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="8" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITOELECTRONICO                       " atributo="ESTADOTRANSFERENCIA                     " tabla="REMELEC        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REMITOELECTRONICO                       " atributo="TRANSPORTISTA                           " tabla="REMELEC        " campo="TRANSPORTI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="10" etiqueta="Transportista                                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SUCURSAL                                " atributo="NOMBRE                                  " tabla="SUC            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="7" etiqueta="Detalle Suc.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join SUC On REMELEC.SUCURSAL = SUC.codigo And  SUC.CODIGO != ''                                                                                                                                                                                         " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
