...
define class Frm_ResumenmodificacionesEstilo2 as Resumenmodificaciones of Resumenmodificaciones.vcx
	ColControles = null
	...
	*-----------------------------------------------------------------------------------------
	...
	function SeteosVisuales() as boolean
		...
		************* resumenmodificaciones/78d1cq85r/Form
		...
		with this
			...
			.HEIGHT = 290
			.LEFT = 209
			.NAME = [resumenmodificaciones]
			.TOP = 252
			.WIDTH = 600
			.WINDOWTYPE = 0

			************* edtModificaciones/Edtbase/Editbox
			if type( '.edtModificaciones' ) # 'O'
				.newobject( 'edtModificaciones', 'EDTBASE', 'EDTBASE.VCX' )
			endif

			with .edtModificaciones
				.THEMES = .T.
