...
define class Mock_COLABORADORPRECARGAETIQUETAS as MockBase of MockBase.prg

	cClase = 'COLABORADORPRECARGAETIQUETAS'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	oColaboradorCantidadesEnStock = Null                                                                                                                                                                                                                      
	oColaboradorCombinacionesParticipantes = Null                                                                                                                                                                                                             
	oEntidad = Null                                                                                                                                                                                                                                           
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function armarcursorinsertardesdearticulos( tcxmlorigen, tccursorretorno ) as void                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcxmlorigen
		lxParam2 = tccursorretorno
		...
		return this.ObtenerResultado( 'Armarcursorinsertardesdearticulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposegunatributo( tcatributo ) as string                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercamposegunatributo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercombinacionesainsertar() as string                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenercombinacionesainsertar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercadenajoin( tcori as string, tcdes as string ) as string                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenercadenajoin', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerhavingdestock() as string                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerhavingdestock', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ocolaboradorcantidadesenstock_access as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolaboradorcantidadesenstock_access As Void', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function ocolaboradorcombinacionesparticipantes_access as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolaboradorcombinacionesparticipantes_access As Void', lcParametros )
	EndFunc
