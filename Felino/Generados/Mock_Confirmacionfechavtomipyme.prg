...
define class Mock_confirmacionfechavtomipyme as MockBase of MockBase.prg
	...
	cClase = 'confirmacionfechavtomipyme'
	...
	*-----------------------------------------------------------------------------------------
	function opciontransmisionmipyme_assign( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIRMACIONFECHAVTOMIPYME' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'opciontransmisionmipyme_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'opciontransmisionmipyme_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Opciontransmisionmipyme		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Opciontransmisionmipyme( lxVal )				this.Setear_Opciontransmisionmipyme( lxVal )			EndIf		Else			This.Setear_Opciontransmisionmipyme( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechavencimientomipyme( txval as variant ) as void                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIRMACIONFECHAVTOMIPYME' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechavencimientomipyme', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechavencimientomipyme', lcParametros )			endif		endif		this.Fechavencimientomipyme = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_opciontransmisionmipyme( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIRMACIONFECHAVTOMIPYME' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_opciontransmisionmipyme', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_opciontransmisionmipyme', lcParametros )			endif		endif		this.Opciontransmisionmipyme = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechavencimientomipyme( txval as variant ) as boolean                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIRMACIONFECHAVTOMIPYME' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechavencimientomipyme', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechavencimientomipyme', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_opciontransmisionmipyme( txval as variant ) as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONFIRMACIONFECHAVTOMIPYME' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_opciontransmisionmipyme', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_opciontransmisionmipyme', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechavencimientomipyme() as boolean                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validarfechavencimientomipyme', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaropciontransmisionmipyme() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validaropciontransmisionmipyme', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechavencimientomipyme() as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridofechavencimientomipyme', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoopciontransmisionmipyme() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridoopciontransmisionmipyme', lcParametros )
	EndFunc
