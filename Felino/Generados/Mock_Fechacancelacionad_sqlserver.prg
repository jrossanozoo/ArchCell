...
define class Mock_Fechacancelacionad_sqlserver as MockBase of MockBase.prg

	cClase = 'Fechacancelacionad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalledetallefechacancelacion( tcatributo as string ) as string                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenercampodetalledetallefechacancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalledetallefechacancelacion( tccampos as string ) as string                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalledetallefechacancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalledetallefechacancelacion( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                        
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalledetallefechacancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_feccandet( tctablatrabajo ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_feccandet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalledetallefechacancelacion( tccampos as string ) as string                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Parsearcamposdetalledetallefechacancelacion', lcParametros )
	EndFunc
