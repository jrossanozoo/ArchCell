...
define class Din_EntidadTIQUETDECAMBIOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTicketcambioFecexpo, lxTicketcambioFaltafw, lxTicketcambioFecimpo, lxTicketcambioFmodifw, lxTicketcambioFectrans, lxTicketcambioHoraimpo, lxTicketcambioHmodifw, lxTicketcambioSmodifw, lxTicketcambioVmodifw, lxTicketcambioZadsfw, lxTicketcambioValtafw, lxTicketcambioUmodifw, lxTicketcambioHoraexpo, lxTicketcambioUaltafw, lxTicketcambioSaltafw, lxTicketcambioBdmodifw, lxTicketcambioHaltafw, lxTicketcambioBdaltafw, lxTicketcambioEsttrans, lxTicketcambioCodigo, lxTicketcambioTobs, lxTicketcambioTfecha, lxTicketcambioTletra, lxTicketcambioTpventa, lxTicketcambioTnumero, lxTicketcambioTcliente, lxTicketcambioTclides, lxTicketcambioTcuit, lxTicketcambioThora, lxTicketcambioTvende, lxTicketcambioTipocomp, lxTicketcambioTnroart, lxTicketcambioTcantart
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TICKETCAMBIO ( "Fecexpo","Faltafw","Fecimpo","Fmodifw","Fectrans","Horaimpo","Hmodifw","Smodifw","Vmodifw","Zadsfw","Valtafw","Umodifw","Horaexpo","Ualtafw","Saltafw","Bdmodifw","Haltafw","Bdaltafw","Esttrans","Codigo","Tobs","Tfecha","Tletra","Tpventa","Tnumero","Tcliente","Tclides","Tcuit","Thora","Tvende","Tipocomp","Tnroart","Tcantart" ) values ( <<"'" + this.ConvertirDateSql( lxTicketcambioFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTicketcambioFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTicketcambioFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTicketcambioFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTicketcambioFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTobs ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTicketcambioTfecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTletra ) + "'" >>, <<lxTicketcambioTpventa >>, <<lxTicketcambioTnumero >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTcliente ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTclides ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTcuit ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioThora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTvende ) + "'" >>, <<lxTicketcambioTipocomp >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTnroart ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTicketcambioTcantart ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.DetalleComprobante
				if this.oEntidad.DetalleComprobante.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.TICKETCAMBIODET("Codigo","tdArt","tdArtDes","tdColor","tdColDes","tdTalle","tdCant","Comp","NroItem" ) values ( <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxCantidad>>, <<lxComportamiento>>, <<lxNroitem>> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TICKETCAMBIO set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTicketcambioFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTicketcambioFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTicketcambioFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTicketcambioFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTicketcambioFectrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTicketcambioHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTicketcambioHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTicketcambioSmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTicketcambioVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTicketcambioZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTicketcambioValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTicketcambioUmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTicketcambioHoraexpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTicketcambioUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTicketcambioSaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTicketcambioBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTicketcambioHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTicketcambioBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTicketcambioEsttrans ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxTicketcambioCodigo ) + "'">>,"Tobs" = <<"'" + this.FormatearTextoSql( lxTicketcambioTobs ) + "'">>,"Tfecha" = <<"'" + this.ConvertirDateSql( lxTicketcambioTfecha ) + "'">>,"Tletra" = <<"'" + this.FormatearTextoSql( lxTicketcambioTletra ) + "'">>,"Tpventa" = <<lxTicketcambioTpventa>>,"Tnumero" = <<lxTicketcambioTnumero>>,"Tcliente" = <<"'" + this.FormatearTextoSql( lxTicketcambioTcliente ) + "'">>,"Tclides" = <<"'" + this.FormatearTextoSql( lxTicketcambioTclides ) + "'">>,"Tcuit" = <<"'" + this.FormatearTextoSql( lxTicketcambioTcuit ) + "'">>,"Thora" = <<"'" + this.FormatearTextoSql( lxTicketcambioThora ) + "'">>,"Tvende" = <<"'" + this.FormatearTextoSql( lxTicketcambioTvende ) + "'">>,"Tipocomp" = <<lxTicketcambioTipocomp>>,"Tnroart" = <<"'" + this.FormatearTextoSql( lxTicketcambioTnroart ) + "'">>,"Tcantart" = <<"'" + this.FormatearTextoSql( lxTicketcambioTcantart ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxTicketcambioCodigo ) + "'">> and  TICKETCAMBIO.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Codigo" as "Codigo", "Tdart" as "Articulo", "Tdartdes" as "Articulodetalle", "Tdcolor" as "Color", "Tdcoldes" as "Colordetalle", "Tdtalle" as "Talle", "Tdcant" as "Cantidad", "Comp" as "Comportamiento", "Nroitem" as "Nroitem" from ZooLogic.TICKETCAMBIODET where Codigo = <<"'" + this.FormatearTextoSql( c_TIQUETDECAMBIO.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Faltafw,Fecimpo,Fmodifw,Fectrans,Horaimpo,Hmodifw,Smodifw,Vmodifw,Zadsfw,Valtafw,Umo" + ;
"difw,Horaexpo,Ualtafw,Saltafw,Bdmodifw,Haltafw,Bdaltafw,Esttrans,Codigo,Tobs,Tfecha,Tletra,Tpventa,T" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleDetalleComprobante( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Codigo" as "Codigo", "Tdart" as "Articulo", "Tdartdes" as "Articulodetalle", "Tdcolor" as "Color", "Tdcoldes" as "Colordetalle", "Tdtalle" as "Talle", "Tdcant" as "Cantidad", "Comp" as "Comportamiento", "Nroitem" as "Nroitem"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.DetalleComprobante
				if this.oEntidad.DetalleComprobante.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxNroitem = lnContadorNroItem
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.TICKETCAMBIODET("Codigo","tdArt","tdArtDes","tdColor","tdColDes","tdTalle","tdCant","Comp","NroItem" ) values ( << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArticulo_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxArticulodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxColor_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxColordetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTalle ) + "'">>, <<lxCantidad>>, <<lxComportamiento>>, <<lxNroitem>> ) 
					endtext
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.Codigo or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.TICKETCAMBIO set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, tObs = ] + "'" + this.FormatearTextoSql( &lcCursor..tObs ) + "'"+ [, tFecha = ] + "'" + this.ConvertirDateSql( &lcCursor..tFecha ) + "'"+ [, tLetra = ] + "'" + this.FormatearTextoSql( &lcCursor..tLetra ) + "'"+ [, tPVenta = ] + transform( &lcCursor..tPVenta )+ [, tNumero = ] + transform( &lcCursor..tNumero )+ [, tCliente = ] + "'" + this.FormatearTextoSql( &lcCursor..tCliente ) + "'"+ [, tCliDes = ] + "'" + this.FormatearTextoSql( &lcCursor..tCliDes ) + "'"+ [, tCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..tCuit ) + "'"+ [, tHora = ] + "'" + this.FormatearTextoSql( &lcCursor..tHora ) + "'"+ [, tVende = ] + "'" + this.FormatearTextoSql( &lcCursor..tVende ) + "'"+ [, TipoComp = ] + transform( &lcCursor..TipoComp )+ [, tNroArt = ] + "'" + this.FormatearTextoSql( &lcCursor..tNroArt ) + "'"+ [, tCantArt = ] + "'" + this.FormatearTextoSql( &lcCursor..tCantArt ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FALTAFW, FECIMPO, FMODIFW, FECTRANS, HORAIMPO, HMODIFW, SMODIFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, HORAEXPO, UALTAFW, SALTAFW, BDMODIFW, HALTAFW, BDALTAFW, ESTTRANS, Codigo, tObs, tFecha, tLetra, tPVenta, tNumero, tCliente, tCliDes, tCuit, tHora, tVende, TipoComp, tNroArt, tCantArt
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..tObs ) + "'"
...
"tcliente" char( 5 )  null, 
"tclides" char( 30 )  null, 
"tcuit" char( 15 )  null, 
"thora" char( 8 )  null, 
"tvende" char( 5 )  null, 
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.TOBS = isnull( d.TOBS, t.TOBS ),t.TFECHA = isnull( d.TFECHA, t.TFECHA ),t.TLETRA = isnull( d.TLETRA, t.TLETRA ),t.TPVENTA = isnull( d.TPVENTA, t.TPVENTA ),t.TNUMERO = isnull( d.TNUMERO, t.TNUMERO ),t.TCLIENTE = isnull( d.TCLIENTE, t.TCLIENTE ),t.TCLIDES = isnull( d.TCLIDES, t.TCLIDES ),t.TCUIT = isnull( d.TCUIT, t.TCUIT ),t.THORA = isnull( d.THORA, t.THORA ),t.TVENDE = isnull( d.TVENDE, t.TVENDE ),t.TIPOCOMP = isnull( d.TIPOCOMP, t.TIPOCOMP ),t.TNROART = isnull( d.TNROART, t.TNROART ),t.TCANTART = isnull( d.TCANTART, t.TCANTART )
				...
				-- Fin Updates
				insert into ZooLogic.TICKETCAMBIO(Fecexpo,Faltafw,Fecimpo,Fmodifw,Fectrans,Horaimpo,Hmodifw,Smodifw,Vmodifw,Zadsfw,Valtafw,Umodifw,Horaexpo,Ualtafw,Saltafw,Bdmodifw,Haltafw,Bdaltafw,Esttrans,Codigo,Tobs,Tfecha,Tletra,Tpventa,Tnumero,Tcliente,Tclides,Tcuit,Thora,Tvende,Tipocomp,Tnroart,Tcantart)
					Select isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.CODIGO,''),isnull( d.TOBS,''),isnull( d.TFECHA,''),isnull( d.TLETRA,''),isnull( d.TPVENTA,0),isnull( d.TNUMERO,0),isnull( d.TCLIENTE,''),isnull( d.TCLIDES,''),isnull( d.TCUIT,''),isnull( d.THORA,''),isnull( d.TVENDE,''),isnull( d.TIPOCOMP,0),isnull( d.TNROART,''),isnull( d.TCANTART,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="TIQUETDECAMBIO                          " atributo="FECHATRANSFERENCIA                      " tabla="TICKETCAMBIO   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIQUETDECAMBIO                          " atributo="ESTADOTRANSFERENCIA                     " tabla="TICKETCAMBIO   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIQUETDECAMBIO                          " atributo="CLIENTEDESCRIPCION                      " tabla="TICKETCAMBIO   " campo="TCLIDES   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descripción                                                                                                                                                     " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="35" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIQUETDECAMBIO                          " atributo="VENDEDOR                                " tabla="TICKETCAMBIO   " campo="TVENDE    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="50" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
