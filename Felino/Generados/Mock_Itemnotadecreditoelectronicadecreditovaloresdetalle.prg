...
define class Mock_Itemnotadecreditoelectronicadecreditovaloresdetalle as MockBase of MockBase.prg

	cClase = 'Itemnotadecreditoelectronicadecreditovaloresdetalle'
