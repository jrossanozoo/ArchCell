...
define class Din_EntidadLiquidaciondiaria_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg

	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Liquidaciondiaria"
	cClaseResponse = this.cNamespaceDTOs + ".LiquidaciondiariaResponse"
	cClaseModelo = "LiquidaciondiariaModelo"
	cEntidad = "Liquidaciondiaria"
	...
	function ObtenerClaseRequest( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Nuevo"
				lcRetorno = this.cNamespaceDTOs + "." + "LiquidaciondiariaModelo"
			...
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "LiquidaciondiariaListarRequest"
	...
	*-----------------------------------------------------------------------------------------
	function ObtenerClaseResponse( tcOperacion as String ) as String
		...
		do case
			case tcOperacion == "Listar"
				lcRetorno = this.cNamespaceDTOs + "." + "LiquidaciondiariaListarResponse"
			otherwise
				lcRetorno = this.cNamespaceDTOs + "." + "LiquidaciondiariaModelo"
		endcase
		return lcRetorno
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearDetalleConceptos( toEntidad as Object, toModeloEnRequest as Object ) as Void
		...
		for lnI = 1 to lnCantidad 
			...
			this.SetearAtributoModeloEnEntidad( loItem, "Monto", toEntidad.Conceptos.oItem, "Monto" )
	...
	protected function CargarColeccionModeloConceptos( toModeloResponse as Object, toEntidad as Object ) as Void
		...
		with toEntidad
			for lnI = 1 to .Conceptos.Count
				loItem = _Screen.DotNetBridge.CrearObjeto( this.cNamespaceDTOs + ".ItemConceptoliq" )
				...
				this.SetearAtributoDecimal( loItem, "Monto", .Conceptos.Item(lnI).Monto)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "Total", "TOTALLIQ")
