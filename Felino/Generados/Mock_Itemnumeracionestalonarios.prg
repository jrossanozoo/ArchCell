...
define class Mock_Itemnumeracionestalonarios as MockBase of MockBase.prg

	cClase = 'Itemnumeracionestalonarios'
	...
	*-----------------------------------------------------------------------------------------
	function descripcionentidad_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Descripcionentidad_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descripcionentidad( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_descripcionentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_talonario( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_talonario', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function talonario_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Talonario_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descripcionentidad( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_descripcionentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_talonario( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_talonario', lcParametros )
	EndFunc
