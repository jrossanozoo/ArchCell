...
define class Frm_ZoomformEstilo2 as Zoomform of Zoomform.vcx
	ColControles = null
	...
	function SeteosVisuales() as boolean
		...
		************* zoomform/78d1cqbfz/Form
		...
		with this
			...
			************* oEditBox/Edtbase/Editbox
			if type( '.oEditBox' ) # 'O'
				.newobject( 'oEditBox', 'EDTBASE', 'EDTBASE.VCX' )
			endif

			with .oEditBox
				.THEMES = .T.

				.addproperty( 'LPERMITECARACTERESCOMILLA', .F.)
				.addproperty( 'LPERMITEEXPRESION', .F.)
