...
define class Mock_Calculodepreciosad_sqlserver as MockBase of MockBase.prg

	cClase = 'Calculodepreciosad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_calcprecdet( tctablatrabajo ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_calcprecdet', lcParametros )
	EndFunc
