...
define class Mock_Itemaccionesautomaticasaccionesdetalle as MockBase of MockBase.prg

	cClase = 'Itemaccionesautomaticasaccionesdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function metodo_assign( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Metodo_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_metodo( txval as variant ) as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_metodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_metodo( txval as variant ) as boolean                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_metodo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridometodo() as void                                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Valorsugeridometodo', lcParametros )
	EndFunc
