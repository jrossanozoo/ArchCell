...
define class Mock_Itemordendepagoordendepagodetalle as MockBase of MockBase.prg

	cClase = 'Itemordendepagoordendepagodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function cuentaparaimpresion_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Cuentaparaimpresion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function emision_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Emision_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function espagoacuenta_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Espagoacuenta_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompcuentacorrienteordendepagocompras_access() as variant                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Ocompcuentacorrienteordendepagocompras_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function saldoaux_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Saldoaux_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_cuentaparaimpresion( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_cuentaparaimpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_emision( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_emision', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_espagoacuenta( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_espagoacuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_saldoaux( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_saldoaux', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalcomprobanteconimpuestos( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_totalcomprobanteconimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalcomprobantegravado( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_totalcomprobantegravado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalcomprobanteiva( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_totalcomprobanteiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_totalcomprobantesinimpuestos( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_totalcomprobantesinimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_vencimiento( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_vencimiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalcomprobanteconimpuestos_assign( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Totalcomprobanteconimpuestos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalcomprobantegravado_assign( txval as variant ) as void                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Totalcomprobantegravado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalcomprobanteiva_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Totalcomprobanteiva_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function totalcomprobantesinimpuestos_assign( txval as variant ) as void                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Totalcomprobantesinimpuestos_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_cuentaparaimpresion( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_cuentaparaimpresion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_emision( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_emision', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_espagoacuenta( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_espagoacuenta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_saldoaux( txval as variant ) as boolean                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_saldoaux', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalcomprobanteconimpuestos( txval as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_totalcomprobanteconimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalcomprobantegravado( txval as variant ) as boolean                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_totalcomprobantegravado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalcomprobanteiva( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_totalcomprobanteiva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_totalcomprobantesinimpuestos( txval as variant ) as boolean                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_totalcomprobantesinimpuestos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_vencimiento( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_vencimiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoanotacion() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridoanotacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function vencimiento_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Vencimiento_assign', lcParametros )
	EndFunc
