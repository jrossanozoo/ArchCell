...
define class Din_EntidadNOMENCLADORARBAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxNmcarbaFecexpo, lxNmcarbaFmodifw, lxNmcarbaFecimpo, lxNmcarbaFaltafw, lxNmcarbaFectrans, lxNmcarbaUaltafw, lxNmcarbaSmodifw, lxNmcarbaUmodifw, lxNmcarbaZadsfw, lxNmcarbaValtafw, lxNmcarbaSaltafw, lxNmcarbaVmodifw, lxNmcarbaHoraexpo, lxNmcarbaHmodifw, lxNmcarbaHoraimpo, lxNmcarbaEsttrans, lxNmcarbaHaltafw, lxNmcarbaBdaltafw, lxNmcarbaBdmodifw, lxNmcarbaNmcobs, lxNmcarbaNmccod, lxNmcarbaNmcdes, lxNmcarbaNmcum
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.NMCARBA ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Ualtafw","Smodifw","Umodifw","Zadsfw","Valtafw","Saltafw","Vmodifw","Horaexpo","Hmodifw","Horaimpo","Esttrans","Haltafw","Bdaltafw","Bdmodifw","Nmcobs","Nmccod","Nmcdes","Nmcum" ) values ( <<"'" + this.ConvertirDateSql( lxNmcarbaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNmcarbaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNmcarbaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNmcarbaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNmcarbaFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaNmcobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaNmccod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaNmcdes ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNmcarbaNmcum ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.NMCARBA set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxNmcarbaFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxNmcarbaFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxNmcarbaFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxNmcarbaFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxNmcarbaFectrans ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxNmcarbaZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaValtafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaVmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxNmcarbaHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxNmcarbaHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxNmcarbaEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaBdmodifw ) + "'">>,"Nmcobs" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmcobs ) + "'">>,"Nmccod" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmccod ) + "'">>,"Nmcdes" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmcdes ) + "'">>,"Nmcum" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmcum ) + "'">> where "Nmccod" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmccod ) + "'">> and  NMCARBA.NMCCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Nmcobs" as "Observacion", "Nmccod" as "Codigo", "Nmcdes" as "Descripcion", "Nmcum" as "Unidaddemedida" from ZooLogic.NMCARBA where  NMCARBA.NMCCOD != '' order by NMCCOD
			endtext
			use in select('c_NOMENCLADORARBA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMENCLADORARBA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Nmcobs" as "Observacion", "Nmccod" as "Codigo", "Nmcdes" as "Descripcion", "Nmcum" as "Unidaddemedida" from ZooLogic.NMCARBA where  funciones.padr( NMCCOD, 6, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NMCARBA.NMCCOD != '' order by NMCCOD
			endtext
			use in select('c_NOMENCLADORARBA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMENCLADORARBA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Nmcobs" as "Observacion", "Nmccod" as "Codigo", "Nmcdes" as "Descripcion", "Nmcum" as "Unidaddemedida" from ZooLogic.NMCARBA where  funciones.padr( NMCCOD, 6, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NMCARBA.NMCCOD != '' order by NMCCOD desc
			endtext
			use in select('c_NOMENCLADORARBA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMENCLADORARBA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Nmcobs" as "Observacion", "Nmccod" as "Codigo", "Nmcdes" as "Descripcion", "Nmcum" as "Unidaddemedida" from ZooLogic.NMCARBA where  NMCARBA.NMCCOD != '' order by NMCCOD desc
			endtext
			use in select('c_NOMENCLADORARBA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOMENCLADORARBA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Ualtafw,Smodifw,Umodifw,Zadsfw,Valtafw,Saltafw,Vmod" + ;
"ifw,Horaexpo,Hmodifw,Horaimpo,Esttrans,Haltafw,Bdaltafw,Bdmodifw,Nmcobs,Nmccod,Nmcdes,Nmcum" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Nmcobs" as "Observacion", "Nmccod" as "Codigo", "Nmcdes" as "Descripcion", "Nmcum" as "Unidaddemedida"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.NMCARBA set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxNmcarbaFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxNmcarbaFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxNmcarbaFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxNmcarbaFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxNmcarbaFectrans ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxNmcarbaZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaValtafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaSaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaVmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxNmcarbaHoraexpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaHmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxNmcarbaHoraimpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxNmcarbaEsttrans ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaHaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxNmcarbaBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxNmcarbaBdmodifw ) + "'">>, "Nmcobs" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmcobs ) + "'">>, "Nmccod" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmccod ) + "'">>, "Nmcdes" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmcdes ) + "'">>, "Nmcum" = <<"'" + this.FormatearTextoSql( lxNmcarbaNmcum ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'NMCARBA' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, UALTAFW, SMODIFW, UMODIFW, ZADSFW, VALTAFW, SALTAFW, VMODIFW, HORAEXPO, HMODIFW, HORAIMPO, ESTTRANS, HALTAFW, BDALTAFW, BDMODIFW, NMCOBS, NMCCOD, NMCDES, NMCUM
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..NMCOBS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..NMCCOD ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..NMCDES ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..NMCUM ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.NMCOBS = isnull( d.NMCOBS, t.NMCOBS ),t.NMCCOD = isnull( d.NMCCOD, t.NMCCOD ),t.NMCDES = isnull( d.NMCDES, t.NMCDES ),t.NMCUM = isnull( d.NMCUM, t.NMCUM )
					from ZooLogic.NMCARBA t inner join deleted d 
							 on t.NMCCOD = d.NMCCOD
				-- Fin Updates
				insert into ZooLogic.NMCARBA(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Ualtafw,Smodifw,Umodifw,Zadsfw,Valtafw,Saltafw,Vmodifw,Horaexpo,Hmodifw,Horaimpo,Esttrans,Haltafw,Bdaltafw,Bdmodifw,Nmcobs,Nmccod,Nmcdes,Nmcum)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.NMCOBS,''),isnull( d.NMCCOD,''),isnull( d.NMCDES,''),isnull( d.NMCUM,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOMENCLADORARBA                         " atributo="FECHATRANSFERENCIA                      " tabla="NMCARBA        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOMENCLADORARBA                         " atributo="ESTADOTRANSFERENCIA                     " tabla="NMCARBA        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
