...
define class Mock_Itemreciboretencionesrecibidas as MockBase of MockBase.prg

	cClase = 'Itemreciboretencionesrecibidas'
	...
	*-----------------------------------------------------------------------------------------
	function ocompretencionesrecibidas_access() as variant                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Ocompretencionesrecibidas_access', lcParametros )
	EndFunc
