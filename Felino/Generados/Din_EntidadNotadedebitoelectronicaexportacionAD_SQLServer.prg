	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fd2","Faltafw","Fecexpo","Fmodifw","Fectrans","Fecimpo","Ffch","Idcaja","Fperson","Cotiz","Mdcimpu","Timestamp","Totalcant","Desmntosi3","Factsec","Fajxre","Subtotsisi","Condivalp","Subtotcisi","Fsubtot","Sitfisccli","Facttipo","Fsubton","Desmntosi2","Signomov","Recmntosi1","Desmntosi1","Desmntosi","Recmntosi","Recmntosi2","Fcompfis","Noper","Anulado","Desauto","Bdaltafw","Bdmodifw","Descfw","Smodifw","Saltafw","Zadsfw","Fhora","Horaexpo","Horaimpo","Simbmon","Haltafw","Esttrans","Valtafw","Vmodifw","Umodifw","Idajuste","Ualtafw","Hmodifw","Idvuelto","Monsis","Fobs","Fven","Fletra","Fcuit","Fcliente","Fturno","Idsenia","Codigo","Fptoven","Fpodes1","Fvuelto","Fnumcomp","Md1","Fmtdes1","Totrecarci","Fpodes2","Moneda","Codlista","Email","Vtosenia","Md2","Totrecarsi","Trci","Fmtdes2","Totdescci","Fmtdes3","Recpor","Ftotal","Tdci","Totdescsi","Mr","Recmnto","Recmnto1","Fpodes","Mr2","Recmnto2","Fdescu","Md3","Percepcion","Mr1","Fimpuesto","Gravamen","Totimpue","Cotizdesp","Ivasis","Tipocrela","Letrarela","Puntorela","Numerorela","Feccrela" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevIdcaja >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevCotiz >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevTimestamp >>, <<lxComprobantevTotalcant >>, <<lxComprobantevDesmntosi3 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevFajxre >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevFsubtot >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevFacttipo >>, <<lxComprobantevFsubton >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevSignomov >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmntosi2 >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevNoper, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevDesauto, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevFturno >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<lxComprobantevFptoven >>, <<lxComprobantevFpodes1 >>, <<lxComprobantevFvuelto >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevMd1 >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevTotrecarci >>, <<lxComprobantevFpodes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'" >>, <<lxComprobantevMd2 >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevTrci >>, <<lxComprobantevFmtdes2 >>, <<lxComprobantevTotdescci >>, <<lxComprobantevFmtdes3 >>, <<lxComprobantevRecpor >>, <<lxComprobantevFtotal >>, <<lxComprobantevTdci >>, <<lxComprobantevTotdescsi >>, <<lxComprobantevMr >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevFpodes >>, <<lxComprobantevMr2 >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevFdescu >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevMr1 >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevGravamen >>, <<lxComprobantevTotimpue >>, <<lxComprobantevCotizdesp >>, <<lxComprobantevIvasis >>, <<lxComprobantevTipocrela >>, <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'" >>, <<lxComprobantevPuntorela >>, <<lxComprobantevNumerorela >>, <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Montobase" as "Montobase", "Minimoper" as "Minimo", "Porcen" as "Porcentaje", "Sirecert" as "Certificadosire", "Minoimp" as "Minimonoimponible", "Monto" as "Monto", "Nroitem" as "Nroitem", "Sirecs" as "Codseguridadsire", "Base" as "Basedecalculo", "Regimenimp" as "Regimenimpositivo", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Codimp" as "Codigoimpuesto", "Descri" as "Descripcion", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_NOTADEDEBITOELECTRONICAEXPORTACION.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Ffch" as "Fecha", "Idcaja" as "Caja", "Fperson" as "Cliente", "Cotiz" as "Cotizacion", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Desmntosi3" as "Montodescuentosinimpuestos3", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Desmntosi2" as "Montodescuentosinimpuestos2", "Signomov" as "Signodemovimiento", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Simbmon" as "Simbolomonetariocomprobante", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Idajuste" as "Codigoajuste", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fletra" as "Letra", "Fcuit" as "Cuit", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Fptoven" as "Puntodeventa", "Fpodes1" as "Porcentajedescuento1", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Totrecarci" as "Totalrecargos", "Fpodes2" as "Porcentajedescuento2", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Md2" as "Montodescuento2", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Fmtdes2" as "Montodescuentoconimpuestos2", "Totdescci" as "Totaldescuentos", "Fmtdes3" as "Montodescuentoconimpuestos3", "Recpor" as "Recargoporcentaje", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Mr" as "Recargomonto", "Recmnto" as "Recargomontoconimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Fpodes" as "Porcentajedescuento", "Mr2" as "Recargomonto2", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Fimpuesto" as "Impuestos", "Gravamen" as "Gravamenes", "Totimpue" as "Totalimpuestos", "Cotizdesp" as "Cotizaciondespacho", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 36 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_NOTADEDEBITOELECTRONICAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICAEXPORTACION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Ffch" as "Fecha", "Idcaja" as "Caja", "Fperson" as "Cliente", "Cotiz" as "Cotizacion", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Desmntosi3" as "Montodescuentosinimpuestos3", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Desmntosi2" as "Montodescuentosinimpuestos2", "Signomov" as "Signodemovimiento", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Simbmon" as "Simbolomonetariocomprobante", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Idajuste" as "Codigoajuste", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fletra" as "Letra", "Fcuit" as "Cuit", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Fptoven" as "Puntodeventa", "Fpodes1" as "Porcentajedescuento1", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Totrecarci" as "Totalrecargos", "Fpodes2" as "Porcentajedescuento2", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Md2" as "Montodescuento2", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Fmtdes2" as "Montodescuentoconimpuestos2", "Totdescci" as "Totaldescuentos", "Fmtdes3" as "Montodescuentoconimpuestos3", "Recpor" as "Recargoporcentaje", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Mr" as "Recargomonto", "Recmnto" as "Recargomontoconimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Fpodes" as "Porcentajedescuento", "Mr2" as "Recargomonto2", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Fimpuesto" as "Impuestos", "Gravamen" as "Gravamenes", "Totimpue" as "Totalimpuestos", "Cotizdesp" as "Cotizaciondespacho", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 36 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_NOTADEDEBITOELECTRONICAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICAEXPORTACION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Ffch" as "Fecha", "Idcaja" as "Caja", "Fperson" as "Cliente", "Cotiz" as "Cotizacion", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Desmntosi3" as "Montodescuentosinimpuestos3", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Desmntosi2" as "Montodescuentosinimpuestos2", "Signomov" as "Signodemovimiento", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Simbmon" as "Simbolomonetariocomprobante", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Idajuste" as "Codigoajuste", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fletra" as "Letra", "Fcuit" as "Cuit", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Fptoven" as "Puntodeventa", "Fpodes1" as "Porcentajedescuento1", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Totrecarci" as "Totalrecargos", "Fpodes2" as "Porcentajedescuento2", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Md2" as "Montodescuento2", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Fmtdes2" as "Montodescuentoconimpuestos2", "Totdescci" as "Totaldescuentos", "Fmtdes3" as "Montodescuentoconimpuestos3", "Recpor" as "Recargoporcentaje", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Mr" as "Recargomonto", "Recmnto" as "Recargomontoconimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Fpodes" as "Porcentajedescuento", "Mr2" as "Recargomonto2", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Fimpuesto" as "Impuestos", "Gravamen" as "Gravamenes", "Totimpue" as "Totalimpuestos", "Cotizdesp" as "Cotizaciondespacho", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 36 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_NOTADEDEBITOELECTRONICAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICAEXPORTACION', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fd2" as "Fechamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Ffch" as "Fecha", "Idcaja" as "Caja", "Fperson" as "Cliente", "Cotiz" as "Cotizacion", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Desmntosi3" as "Montodescuentosinimpuestos3", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Condivalp" as "Condicioniva", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fsubtot" as "Subtotalbruto", "Sitfisccli" as "Situacionfiscal", "Facttipo" as "Tipocomprobante", "Fsubton" as "Subtotalneto", "Desmntosi2" as "Montodescuentosinimpuestos2", "Signomov" as "Signodemovimiento", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi1" as "Montodescuentosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Fhora" as "Hora", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Simbmon" as "Simbolomonetariocomprobante", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Idajuste" as "Codigoajuste", "Ualtafw" as "Usuarioaltafw", "Hmodifw" as "Horamodificacionfw", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fven" as "Vendedor", "Fletra" as "Letra", "Fcuit" as "Cuit", "Fcliente" as "Clientedescripcion", "Fturno" as "Turno", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Fptoven" as "Puntodeventa", "Fpodes1" as "Porcentajedescuento1", "Fvuelto" as "Vuelto", "Fnumcomp" as "Numero", "Md1" as "Montodescuento1", "Fmtdes1" as "Montodescuentoconimpuestos1", "Totrecarci" as "Totalrecargos", "Fpodes2" as "Porcentajedescuento2", "Moneda" as "Monedacomprobante", "Codlista" as "Listadeprecios", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Md2" as "Montodescuento2", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Fmtdes2" as "Montodescuentoconimpuestos2", "Totdescci" as "Totaldescuentos", "Fmtdes3" as "Montodescuentoconimpuestos3", "Recpor" as "Recargoporcentaje", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Mr" as "Recargomonto", "Recmnto" as "Recargomontoconimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Fpodes" as "Porcentajedescuento", "Mr2" as "Recargomonto2", "Recmnto2" as "Recargomontoconimpuestos2", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Fimpuesto" as "Impuestos", "Gravamen" as "Gravamenes", "Totimpue" as "Totalimpuestos", "Cotizdesp" as "Cotizaciondespacho", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 36 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_NOTADEDEBITOELECTRONICAEXPORTACION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICAEXPORTACION', set( 'Datasession' ) )
			local lcSentencia as string
...
"alcant,Desmntosi3,Factsec,Fajxre,Subtotsisi,Condivalp,Subtotcisi,Fsubtot,Sitfisccli,Facttipo,Fsubton" + ;
",Desmntosi2,Signomov,Recmntosi1,Desmntosi1,Desmntosi,Recmntosi,Recmntosi2,Fcompfis,Noper,Anulado,Des" + ;
"auto,Bdaltafw,Bdmodifw,Descfw,Smodifw,Saltafw,Zadsfw,Fhora,Horaexpo,Horaimpo,Simbmon,Haltafw,Esttran" + ;
"s,Valtafw,Vmodifw,Umodifw,Idajuste,Ualtafw,Hmodifw,Idvuelto,Monsis,Fobs,Fven,Fletra,Fcuit,Fcliente,F" + ;
"turno,Idsenia,Codigo,Fptoven,Fpodes1,Fvuelto,Fnumcomp,Md1,Fmtdes1,Totrecarci,Fpodes2,Moneda,Codlista" + ;
",Email,Vtosenia,Md2,Totrecarsi,Trci,Fmtdes2,Totdescci,Fmtdes3,Recpor,Ftotal,Tdci,Totdescsi,Mr,Recmnt" + ;
"o,Recmnto1,Fpodes,Mr2,Recmnto2,Fdescu,Md3,Percepcion,Mr1,Fimpuesto,Gravamen,Totimpue,Cotizdesp,Ivasi" + ;
"s,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela" + ;
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..RecMntoSI1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..noper, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..DesAuto, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..FTurno ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + transform( &lcCursor..FPTOVEN )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPODES1 ) + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..MD1 ) + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..totrecarCI ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'" + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..FMTDES2 ) + ',' + transform( &lcCursor..totdescCI ) + ',' + transform( &lcCursor..FMTDES3 ) + ',' + transform( &lcCursor..RecPor )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..TDCI ) + ',' + transform( &lcCursor..totdescSI ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..fDescu ) + ',' + transform( &lcCursor..MD3 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..totimpue ) + ',' + transform( &lcCursor..CotizDesp ) + ',' + transform( &lcCursor..IvaSis ) + ',' + transform( &lcCursor..TipoCRela ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'" + ',' + transform( &lcCursor..puntoRela )
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function RecibirComponentes() As Void
		...
		this.oEntidad.ArticulosSeniadosDetalle.oItem.oCompPrecios.Recibir( this.oEntidad, 'ArticulosSeniadosDetalle',this.oEntidad.cPrefijoRecibir + 'ITEMARTICULOSSENIADOS',this.oEntidad.cPrefijoRecibir + 'NOTADEDEBITOELECTRONICAEXPORTACION')
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'NOTADEDEBITOELECTRONICAEXPORTACION_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'NOTADEDEBITOELECTRONICAEXPORTACION_FOBS'
				llRetorno = .T.
	...
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			Begin
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fd2,Faltafw,Fecexpo,Fmodifw,Fectrans,Fecimpo,Ffch,Idcaja,Fperson,Cotiz,Mdcimpu,Timestamp,Totalcant,Desmntosi3,Factsec,Fajxre,Subtotsisi,Condivalp,Subtotcisi,Fsubtot,Sitfisccli,Facttipo,Fsubton,Desmntosi2,Signomov,Recmntosi1,Desmntosi1,Desmntosi,Recmntosi,Recmntosi2,Fcompfis,Noper,Anulado,Desauto,Bdaltafw,Bdmodifw,Descfw,Smodifw,Saltafw,Zadsfw,Fhora,Horaexpo,Horaimpo,Simbmon,Haltafw,Esttrans,Valtafw,Vmodifw,Umodifw,Idajuste,Ualtafw,Hmodifw,Idvuelto,Monsis,Fobs,Fven,Fletra,Fcuit,Fcliente,Fturno,Idsenia,Codigo,Fptoven,Fpodes1,Fvuelto,Fnumcomp,Md1,Fmtdes1,Totrecarci,Fpodes2,Moneda,Codlista,Email,Vtosenia,Md2,Totrecarsi,Trci,Fmtdes2,Totdescci,Fmtdes3,Recpor,Ftotal,Tdci,Totdescsi,Mr,Recmnto,Recmnto1,Fpodes,Mr2,Recmnto2,Fdescu,Md3,Percepcion,Mr1,Fimpuesto,Gravamen,Totimpue,Cotizdesp,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela)
					Select isnull( d.FD2,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FFCH,''),isnull( d.IDCAJA,0),isnull( d.FPERSON,''),isnull( d.COTIZ,0),isnull( d.MDCIMPU,0),isnull( d.TIMESTAMP,0),isnull( d.TOTALCANT,0),isnull( d.DESMNTOSI3,0),isnull( d.FACTSEC,''),isnull( d.FAJXRE,0),isnull( d.SUBTOTSISI,0),isnull( d.CONDIVALP,0),isnull( d.SUBTOTCISI,0),isnull( d.FSUBTOT,0),isnull( d.SITFISCCLI,0),isnull( d.FACTTIPO,0),isnull( d.FSUBTON,0),isnull( d.DESMNTOSI2,0),isnull( d.SIGNOMOV,0),isnull( d.RECMNTOSI1,0),isnull( d.DESMNTOSI1,0),isnull( d.DESMNTOSI,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTOSI2,0),isnull( d.FCOMPFIS,0),isnull( d.NOPER,0),isnull( d.ANULADO,0),isnull( d.DESAUTO,0),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.DESCFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.FHORA,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.SIMBMON,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.IDAJUSTE,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.IDVUELTO,''),isnull( d.MONSIS,''),isnull( d.FOBS,''),isnull( d.FVEN,''),isnull( d.FLETRA,''),isnull( d.FCUIT,''),isnull( d.FCLIENTE,''),isnull( d.FTURNO,0),isnull( d.IDSENIA,''),isnull( d.CODIGO,''),isnull( d.FPTOVEN,0),isnull( d.FPODES1,0),isnull( d.FVUELTO,0),isnull( d.FNUMCOMP,0),isnull( d.MD1,0),isnull( d.FMTDES1,0),isnull( d.TOTRECARCI,0),isnull( d.FPODES2,0),isnull( d.MONEDA,''),isnull( d.CODLISTA,''),isnull( d.EMAIL,''),isnull( d.VTOSENIA,''),isnull( d.MD2,0),isnull( d.TOTRECARSI,0),isnull( d.TRCI,0),isnull( d.FMTDES2,0),isnull( d.TOTDESCCI,0),isnull( d.FMTDES3,0),isnull( d.RECPOR,0),isnull( d.FTOTAL,0),isnull( d.TDCI,0),isnull( d.TOTDESCSI,0),isnull( d.MR,0),isnull( d.RECMNTO,0),isnull( d.RECMNTO1,0),isnull( d.FPODES,0),isnull( d.MR2,0),isnull( d.RECMNTO2,0),isnull( d.FDESCU,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.MR1,0),isnull( d.FIMPUESTO,0),isnull( d.GRAVAMEN,0),isnull( d.TOTIMPUE,0),isnull( d.COTIZDESP,0),isnull( d.IVASIS,0),isnull( d.TIPOCRELA,0),isnull( d.LETRARELA,''),isnull( d.PUNTORELA,0),isnull( d.NUMERORELA,0),isnull( d.FECCRELA,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_NOTADEDEBITOELECTRONICAEXPORTACION' ) < 1
				...
				Try
					...
					.Monedacomprobante = nvl( c_NOTADEDEBITOELECTRONICAEXPORTACION.Monedacomprobante, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="FECHATRANSFERENCIA                      " tabla="COMPROBANTEV   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="FECHA                                   " tabla="COMPROBANTEV   " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="8" etiqueta="Fecha                                                                                                                                                           " dominio="FECHACOMPROBANTE              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="CAJA                                    " tabla="COMPROBANTEV   " campo="IDCAJA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CAJAESTADO                              " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="TOTALCANTIDAD                           " tabla="COMPROBANTEV   " campo="TOTALCANT " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total Cantidad                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="COMPROBANTEV   " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="SITUACIONFISCAL                         " tabla="COMPROBANTEV   " campo="SITFISCCLI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SITUACIONFISCAL                         " tipodato="N         " longitud="2" decimales="0" valorsugerido="=3                                                                                                                                                                                                                                                            " obligatorio="false" admitebusqueda="0" etiqueta="Sit.Fis                                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="TIPOCOMPROBANTE                         " tabla="COMPROBANTEV   " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=36                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="DESCUENTOAUTOMATICO                     " tabla="COMPROBANTEV   " campo="DESAUTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="HORAALTAFW                              " tabla="COMPROBANTEV   " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPROBANTEV   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="MONEDASISTEMA                           " tabla="COMPROBANTEV   " campo="MONSIS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="                                                                                                                                                                " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="                                                                                                                                                                " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="PUNTODEVENTA                            " tabla="COMPROBANTEV   " campo="FPTOVEN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="4" etiqueta="Pto. Venta                                                                                                                                                      " dominio="NUMEROPTOVTAEDITABLE          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="3" mascara="9999                     " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="PORCENTAJEDESCUENTO1                    " tabla="COMPROBANTEV   " campo="FPODES1   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Descuento %                                                                                                                                                     " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="VUELTO                                  " tabla="COMPROBANTEV   " campo="FVUELTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vuelto persistido                                                                                                                                               " dominio="VUELTO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="40" orden="2" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="MONTODESCUENTO1                         " tabla="COMPROBANTEV   " campo="MD1       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Monto descuento 1                                                                                                                                               " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECARCI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos Con impuestos.                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="25" orden="4" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="PORCENTAJEDESCUENTO2                    " tabla="COMPROBANTEV   " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="428" etiqueta="Descuento %                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="=goParametros.Felino.GestionDeVentas.FacturacionElectronica.Exportacion.CodigoDeMonedaExtranjeraSugerida                                                                                                                                                      " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="4" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="TOTALRECARGOSCONIMPUESTOS               " tabla="COMPROBANTEV   " campo="TRCI      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos con impuestos                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="25" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="MONTODESCUENTOCONIMPUESTOS2             " tabla="COMPROBANTEV   " campo="FMTDES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuento %                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="5" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESCCI " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuentos Con impuestos.                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="25" orden="6" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="RECARGOMONTO                            " tabla="COMPROBANTEV   " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="440" etiqueta="Monto recargo                                                                                                                                                   " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="RECARGOMONTOCONIMPUESTOS                " tabla="COMPROBANTEV   " campo="RECMNTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto de recargo                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="8" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="PORCENTAJEDESCUENTO                     " tabla="COMPROBANTEV   " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="Des%                                                                                                                                                            " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="RECARGOMONTO2                           " tabla="COMPROBANTEV   " campo="MR2       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="444" etiqueta="Monto recargo 2                                                                                                                                                 " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="RECARGOMONTOCONIMPUESTOS2               " tabla="COMPROBANTEV   " campo="RECMNTO2  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto de recargo                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="10" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="MONTODESCUENTO3                         " tabla="COMPROBANTEV   " campo="MD3       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="448" etiqueta="Monto descuento 3                                                                                                                                               " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="458" etiqueta="Impuestos                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="25" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="COTIZACIONDESPACHO                      " tabla="COMPROBANTEV   " campo="COTIZDESP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="460" etiqueta="Cotización despacho                                                                                                                                             " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="70" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICAEXPORTACION      " atributo="PUNTODEVENTACPTERELACIONADO             " tabla="COMPROBANTEV   " campo="PUNTORELA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="466" etiqueta="Pto. de venta comprobante asociado                                                                                                                              " dominio="COMPROBANTERELACIONADO        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="92" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
