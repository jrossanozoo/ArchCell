...
define class Din_EntidadNOTADECREDITOAGRUPADA as Ent_ComprobanteAgrupado of Ent_ComprobanteAgrupado.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><VENTAS><CONVALORES><FISCAL><NOLISTAGENERICO><VALIDACENTRALIZADOR><VALORCIERRE><DESCUENTOAUTOMATICO><ACTUALIZAEMAILCLIENTE><MIPYME:55><AGRUPACOMPROBANTES:3;5;28><MIPYMEORIGINAL:28><CF>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
