...
define class Mock_Itemvaloresentransitovalores as MockBase of MockBase.prg

	cClase = 'Itemvaloresentransitovalores'
	...
	*-----------------------------------------------------------------------------------------
	function codigocheque_access() as variant                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Codigocheque_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigocheque_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Codigocheque_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigochequepropio_access() as variant                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Codigochequepropio_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigochequepropio_pk_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Codigochequepropio_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estadoenorigen_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Estadoenorigen_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigocheque( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_codigocheque', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigochequepropio( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_codigochequepropio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_estadoenorigen( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_estadoenorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigocheque( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_codigocheque', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigochequepropio( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_codigochequepropio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_estadoenorigen( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_estadoenorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoestadoenorigen() as void                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Valorsugeridoestadoenorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofechapago() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofechapago', lcParametros )
	EndFunc
