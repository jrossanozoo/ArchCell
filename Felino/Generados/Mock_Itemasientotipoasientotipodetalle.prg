...
define class Mock_Itemasientotipoasientotipodetalle as MockBase of MockBase.prg

	cClase = 'Itemasientotipoasientotipodetalle'
	...
	*-----------------------------------------------------------------------------------------
	function codigoconcepto_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Codigoconcepto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function concepto_assign( txval as variant ) as void                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Concepto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitadebe_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Habilitadebe_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitahaber_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Habilitahaber_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plandecuentasdebe_access() as variant                                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Plandecuentasdebe_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plandecuentasdebe_pk_assign( txval as variant ) as void                                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Plandecuentasdebe_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plandecuentasdebedetalle_assign( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Plandecuentasdebedetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plandecuentashaber_access() as variant                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Plandecuentashaber_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plandecuentashaber_pk_assign( txval as variant ) as void                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Plandecuentashaber_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function plandecuentashaberdetalle_assign( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Plandecuentashaberdetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoconcepto( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_codigoconcepto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_habilitadebe( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_habilitadebe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_habilitahaber( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_habilitahaber', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_plandecuentasdebe( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_plandecuentasdebe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_plandecuentasdebedetalle( txval as variant ) as void                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Setear_plandecuentasdebedetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_plandecuentashaber( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_plandecuentashaber', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_plandecuentashaberdetalle( txval as variant ) as void                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_plandecuentashaberdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoconcepto( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_codigoconcepto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_habilitadebe( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_habilitadebe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_habilitahaber( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_habilitahaber', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_plandecuentasdebe( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_plandecuentasdebe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_plandecuentasdebedetalle( txval as variant ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Validar_plandecuentasdebedetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_plandecuentashaber( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_plandecuentashaber', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_plandecuentashaberdetalle( txval as variant ) as boolean                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_plandecuentashaberdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoplandecuentasdebe() as void                                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Valorsugeridoplandecuentasdebe', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoplandecuentashaber() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridoplandecuentashaber', lcParametros )
	EndFunc
