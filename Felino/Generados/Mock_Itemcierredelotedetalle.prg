...
define class Mock_Itemcierredelotedetalle as MockBase of MockBase.prg

	cClase = 'Itemcierredelotedetalle'
	...
	*-----------------------------------------------------------------------------------------
	function montototalanulacioncompras_assign( txval as variant ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Montototalanulacioncompras_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montototalanulaciondevoluciones_assign( txval as variant ) as void                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Montototalanulaciondevoluciones_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montototalcompras_assign( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Montototalcompras_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function montototaldevoluciones_assign( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Montototaldevoluciones_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function nrolote_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Nrolote_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montototalanulacioncompras( txval as variant ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_montototalanulacioncompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montototalanulaciondevoluciones( txval as variant ) as void                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Setear_montototalanulaciondevoluciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montototalcompras( txval as variant ) as void                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Setear_montototalcompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_montototaldevoluciones( txval as variant ) as void                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Setear_montototaldevoluciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_nrolote( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_nrolote', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tarjetadetalle( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Setear_tarjetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tarjetadetalle_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Tarjetadetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montototalanulacioncompras( txval as variant ) as boolean                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_montototalanulacioncompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montototalanulaciondevoluciones( txval as variant ) as boolean                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Validar_montototalanulaciondevoluciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montototalcompras( txval as variant ) as boolean                                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Validar_montototalcompras', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_montototaldevoluciones( txval as variant ) as boolean                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Validar_montototaldevoluciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_nrolote( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_nrolote', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tarjetadetalle( txval as variant ) as boolean                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Validar_tarjetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonrolote() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridonrolote', lcParametros )
	EndFunc
