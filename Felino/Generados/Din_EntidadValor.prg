...
define class Din_EntidadVALOR as entidad of entidad.prg
	...
	TipoTarjetaPoint = []
	DiasPresentacion4 = 0
	SeDepositaEnBanco_PK = []
	SeDepositaEnBanco = null
	Clasificacion_PK = []
	Clasificacion = null
	GeneraCanje = 0
	VisualizarEnCaja = .F.
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local lnLargoDecimal as integer, lnLargoEntero as Integer, lnLargoDecimal as integer, llRetorno as boolean 
		...
		if ( vartype( this.DescuentoSobreBruto) = 'N' )
			lnLargoEntero  = len( transform( int( this.DESCUENTOSOBREBRUTO ) ) ) 
			lnValorDelDecimal = this.DESCUENTOSOBREBRUTO - int( this.DESCUENTOSOBREBRUTO)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 3
				This.AgregarInformacion( 'La longitud entera del valor del atributo DESCUENTOSOBREBRUTO es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DESCUENTOSOBREBRUTO no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.DiasPresentacion1) = 'N' )
			lnLargoEntero  = len( transform( int( this.DIASPRESENTACION1 ) ) ) 
			lnValorDelDecimal = this.DIASPRESENTACION1 - int( this.DIASPRESENTACION1)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 2
				This.AgregarInformacion( 'La longitud entera del valor del atributo DIASPRESENTACION1 es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DIASPRESENTACION1 no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.DiasAcreditacion) = 'N' )
			lnLargoEntero  = len( transform( int( this.DIASACREDITACION ) ) ) 
			lnValorDelDecimal = this.DIASACREDITACION - int( this.DIASACREDITACION)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 2
				This.AgregarInformacion( 'La longitud entera del valor del atributo DIASACREDITACION es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DIASACREDITACION no es el correcto.')
			llRetorno = .F.
		Endif
		...
		if ( vartype( this.CobroAdelantado) = 'N' )
			lnLargoEntero  = len( transform( int( this.COBROADELANTADO ) ) ) 
			lnValorDelDecimal = this.COBROADELANTADO - int( this.COBROADELANTADO)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 1
				This.AgregarInformacion( 'La longitud entera del valor del atributo COBROADELANTADO es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo COBROADELANTADO no es el correcto.')
			llRetorno = .F.
		Endif
		...
		if ( vartype( this.DescuentoAdelantado) = 'N' )
			lnLargoEntero  = len( transform( int( this.DESCUENTOADELANTADO ) ) ) 
			lnValorDelDecimal = this.DESCUENTOADELANTADO - int( this.DESCUENTOADELANTADO)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 3
				This.AgregarInformacion( 'La longitud entera del valor del atributo DESCUENTOADELANTADO es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DESCUENTOADELANTADO no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.Habiles) = 'N' )
			lnLargoEntero  = len( transform( int( this.HABILES ) ) ) 
			lnValorDelDecimal = this.HABILES - int( this.HABILES)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 1
				This.AgregarInformacion( 'La longitud entera del valor del atributo HABILES es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo HABILES no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.DiasPresentacion2) = 'N' )
			lnLargoEntero  = len( transform( int( this.DIASPRESENTACION2 ) ) ) 
			lnValorDelDecimal = this.DIASPRESENTACION2 - int( this.DIASPRESENTACION2)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 2
				This.AgregarInformacion( 'La longitud entera del valor del atributo DIASPRESENTACION2 es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DIASPRESENTACION2 no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.PideCotizacion) = 'L' )
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo PIDECOTIZACION no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.TarjetaMadre) = 'L' )
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo TARJETAMADRE no es el correcto.')
			llRetorno = .F.
		Endif
		...
		if ( vartype( this.DiasEntreCuotas) = 'N' )
			lnLargoEntero  = len( transform( int( this.DIASENTRECUOTAS ) ) ) 
			lnValorDelDecimal = this.DIASENTRECUOTAS - int( this.DIASENTRECUOTAS)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 2
				This.AgregarInformacion( 'La longitud entera del valor del atributo DIASENTRECUOTAS es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DIASENTRECUOTAS no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.DiasPresentacion3) = 'N' )
			lnLargoEntero  = len( transform( int( this.DIASPRESENTACION3 ) ) ) 
			lnValorDelDecimal = this.DIASPRESENTACION3 - int( this.DIASPRESENTACION3)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 2
				This.AgregarInformacion( 'La longitud entera del valor del atributo DIASPRESENTACION3 es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DIASPRESENTACION3 no es el correcto.')
			llRetorno = .F.
		Endif
		...
		if ( vartype( this.DiasPresentacion4) = 'N' )
			lnLargoEntero  = len( transform( int( this.DIASPRESENTACION4 ) ) ) 
			lnValorDelDecimal = this.DIASPRESENTACION4 - int( this.DIASPRESENTACION4)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 2
				This.AgregarInformacion( 'La longitud entera del valor del atributo DIASPRESENTACION4 es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo DIASPRESENTACION4 no es el correcto.')
			llRetorno = .F.
		Endif
		 
		if ( vartype( this.GeneraCanje) = 'N' )
			lnLargoEntero  = len( transform( int( this.GENERACANJE ) ) ) 
			lnValorDelDecimal = this.GENERACANJE - int( this.GENERACANJE)
			lnLargoDecimal = iif( lnValorDelDecimal = 0, 0, len( transform( lnValorDelDecimal ) ) - 2 )
			if lnLargoEntero > 10
				This.AgregarInformacion( 'La longitud entera del valor del atributo GENERACANJE es mayor a la permitida.' )
				llRetorno = .F.
			Endif
		else
			This.AgregarInformacion( 'El tipo de dato para el atributo GENERACANJE no es el correcto.')
			llRetorno = .F.
		Endif
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionBasica() as boolean
		...
		With This
			...
			llRetorno = .ValidarSedepositaenbanco() and llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionDetalles() as Boolean
		...
		llRetorno = dodefault()
		llRetorno = This.ValidarUnDetalle( this.DetalleAcreditacionPlanes, 'Datos de acreditación de planes' ) and llRetorno
		llRetorno = This.ValidarUnDetalle( this.DetallePlanes, 'Cuotas y recargos' ) and llRetorno
		return llRetorno
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidarSeDepositaEnBanco() as boolean
		local llRetorno as boolean
		llRetorno = dodefault()
		if empty( this.SeDepositaEnBanco_PK )
		else
			If this.SeDepositaEnBanco.oAD.ConsultarPorClavePrimaria()
			Else
				this.AgregarInformacion( 'El dato buscado ' + alltrim(transform( this.SeDepositaEnBanco_PK ))+ ' de la entidad ' +  upper( this.SeDepositaEnBanco.cDescripcion ) + ' no existe.')
				llRetorno = .F.
			endif
		endif
		Return llRetorno
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as Void
		...
		this.oColeccionVSFW.agregar('.ValorSugeridoFWHabiles()','Habiles')
		...
		this.oColeccionVSFW.agregar('.ValorSugeridoFWDiasentrecuotas()','Diasentrecuotas')
		this.oColeccionVSFW.agregar('.ValorSugeridoFWGeneracanje()','Generacanje')
	...
	*--------------------------------------------------------------------------------------------------------
	function Sedepositaenbanco_PK_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Sedepositaenbanco_PK
		local lxVal as Variant
		local loSugerido as Object
		
		lxVal = txVal
		lxVal = iif( len( lxVal ) < 5, padr( lxVal, 5 ), lxVal )
		this.Sedepositaenbanco_PK = lxVal

		if this.Validar_Sedepositaenbanco( lxVal, lxValOld )
			This.Setear_Sedepositaenbanco( lxVal )
		endif
		dodefault( lxVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Sedepositaenbanco( txVal as variant ) as void

		this.Sedepositaenbanco.CODIGO = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Sedepositaenbanco( txVal as variant, txValOld as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Descuentosobrebruto_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Descuentosobrebruto
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Descuentosobrebruto( lxVal )
				this.Setear_Descuentosobrebruto( lxVal )
			EndIf
		Else
			This.Setear_Descuentosobrebruto( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Diaspresentacion1_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Diaspresentacion1
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Diaspresentacion1( lxVal )
				this.Setear_Diaspresentacion1( lxVal )
			EndIf
		Else
			This.Setear_Diaspresentacion1( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Diasacreditacion_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Diasacreditacion
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Diasacreditacion( lxVal )
				this.Setear_Diasacreditacion( lxVal )
			EndIf
		Else
			This.Setear_Diasacreditacion( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Cobroadelantado_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Cobroadelantado
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Cobroadelantado( lxVal )
				this.Setear_Cobroadelantado( lxVal )
			EndIf
		Else
			This.Setear_Cobroadelantado( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Descuentoadelantado_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Descuentoadelantado
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Descuentoadelantado( lxVal )
				this.Setear_Descuentoadelantado( lxVal )
			EndIf
		Else
			This.Setear_Descuentoadelantado( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Habiles_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Habiles
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Habiles( lxVal )
				this.Setear_Habiles( lxVal )
			EndIf
		Else
			This.Setear_Habiles( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Diaspresentacion2_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Diaspresentacion2
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Diaspresentacion2( lxVal )
				this.Setear_Diaspresentacion2( lxVal )
			EndIf
		Else
			This.Setear_Diaspresentacion2( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Pidecotizacion_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Pidecotizacion
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Pidecotizacion( lxVal )
				this.Setear_Pidecotizacion( lxVal )
			EndIf
		Else
			This.Setear_Pidecotizacion( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Diasentrecuotas_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Diasentrecuotas
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Diasentrecuotas( lxVal )
				this.Setear_Diasentrecuotas( lxVal )
			EndIf
		Else
			This.Setear_Diasentrecuotas( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Diaspresentacion3_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Diaspresentacion3
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Diaspresentacion3( lxVal )
				this.Setear_Diaspresentacion3( lxVal )
			EndIf
		Else
			This.Setear_Diaspresentacion3( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Diaspresentacion4_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Diaspresentacion4
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Diaspresentacion4( lxVal )
				this.Setear_Diaspresentacion4( lxVal )
			EndIf
		Else
			This.Setear_Diaspresentacion4( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Generacanje_Assign( txVal as variant ) as void

		Local lxValOld As Variant
		lxValOld = this.Generacanje
		local lxVal as Variant
		lxVal = txVal

		if This.CargaManual()
			if this.Validar_Generacanje( lxVal )
				this.Setear_Generacanje( lxVal )
			EndIf
		Else
			This.Setear_Generacanje( lxVal ) 
		EndIf
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Descuentosobrebruto( txVal as variant ) as void

		this.Descuentosobrebruto = txVal
		dodefault( txVal )

	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Setear_Diaspresentacion1( txVal as variant ) as void

		this.Diaspresentacion1 = txVal
		dodefault( txVal )

	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Setear_Diasacreditacion( txVal as variant ) as void

		this.Diasacreditacion = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Cobroadelantado( txVal as variant ) as void

		this.Cobroadelantado = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Descuentoadelantado( txVal as variant ) as void

		this.Descuentoadelantado = txVal
		dodefault( txVal )

	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Setear_Habiles( txVal as variant ) as void
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Diaspresentacion2( txVal as variant ) as void

		this.Diaspresentacion2 = txVal
		dodefault( txVal )

	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Setear_Pidecotizacion( txVal as variant ) as void

		this.Pidecotizacion = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Diasentrecuotas( txVal as variant ) as void

		this.Diasentrecuotas = txVal
		dodefault( txVal )

	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Setear_Diaspresentacion3( txVal as variant ) as void

		this.Diaspresentacion3 = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Setear_Diaspresentacion4( txVal as variant ) as void

		this.Diaspresentacion4 = txVal
		dodefault( txVal )

	endfunc

	*--------------------------------------------------------------------------------------------------------
	function Setear_Generacanje( txVal as variant ) as void

		this.Generacanje = txVal
		dodefault( txVal )
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Descuentosobrebruto( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Diaspresentacion1( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Diasacreditacion( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Cobroadelantado( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Descuentoadelantado( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Habiles( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Diaspresentacion2( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Pidecotizacion( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Diasentrecuotas( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Diaspresentacion3( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Diaspresentacion4( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Validar_Generacanje( txVal as variant ) as Boolean
	...
	*--------------------------------------------------------------------------------------------------------
	function Sedepositaenbanco_Access() as variant
		if this.ldestroy
		else
			if This.lInstanciarSubEntidadaDemanda
				if ( !vartype( this.Sedepositaenbanco ) = 'O' or isnull( this.Sedepositaenbanco ) )
					this.Sedepositaenbanco = _Screen.zoo.instanciarentidad( 'Banco' )
					this.Sedepositaenbanco.lEsSubEntidad = .t.
					this.enlazar( 'Sedepositaenbanco.EventoObtenerLogueo', 'inyectarLogueo' )
					this.enlazar( 'Sedepositaenbanco.EventoObtenerInformacion', 'inyectarInformacion' )
				endif
				if !this.lBuscandoCodigo
					if this.Sedepositaenbanco.CODIGO # this.Sedepositaenbanco_PK
						this.Sedepositaenbanco.CODIGO = this.Sedepositaenbanco_PK
					endif
				endif
			endif
		endif
		return this.Sedepositaenbanco
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoCuit() as void
		...
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Cuit" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						...
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Cuit para la entidad Valores." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoDireccion() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Direccion" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoTelefono() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Telefono" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWHabiles() as void
		with this
			.Habiles = 1
		endwith
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoHabiles() as void
		with this
			.ValorSugeridoFWHabiles()
		endwith
	endfunc
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoPidecotizacion() as void
		local lcExpresionValorSugeridoDefinidoPorElUsuario as String, lvValorSugeridoDefinidoPorElUsuario as Variant, loError as Object, loEx as Object, loExTipoDato as Object
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Pidecotizacion" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						This.EventoEstaSeteandoValorSugerido( 'Pidecotizacion' )
						.Pidecotizacion = lvValorSugeridoDefinidoPorElUsuario
					catch to loError
						loEx = newobject("zooexception", "zooexception.prg" )
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Pedir Cotización para la entidad Valores." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es lógico." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoLocalidad() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Localidad" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFax() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Fax" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Fax para la entidad Valores." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
		...
		with this
			...
			Catch to loError
				...
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					...
					loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Sumarizar en grupo para la entidad Valores." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
					goServicios.Errores.LevantarExcepcion( loEx )
				endif
			endtry 
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWDiasentrecuotas() as void
		with this
			.Diasentrecuotas = 30
		endwith
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoDiasentrecuotas() as void
		with this
			.ValorSugeridoFWDiasentrecuotas()
		endwith
	endfunc
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoCodigopostal() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Codigopostal" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoTipotarjetapoint() as void
		local lcExpresionValorSugeridoDefinidoPorElUsuario as String, lvValorSugeridoDefinidoPorElUsuario as Variant, loError as Object, loEx as Object, loExTipoDato as Object
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Tipotarjetapoint" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						...
						This.EventoEstaSeteandoValorSugerido( 'Tipotarjetapoint' )
						.Tipotarjetapoint = lvValorSugeridoDefinidoPorElUsuario
					catch to loError
						loEx = newobject("zooexception", "zooexception.prg" )
						loEx.Grabar( loError )
						loEx.AgregarInformacion( iif( type( "loError.UserValue.Message" ) == "C", loError.UserValue.Message, loError.Message ) )
						loEx.AgregarInformacion( "Se produjo un error al intentar asignar el valor sugerido " + lcExpresionValorSugeridoDefinidoPorElUsuario + " del atributo Tipo tarjetas para la entidad Valores." + chr( 10 ) + "Verifique el valor especificado en la entidad Comportamiento de atributos." + chr( 10 ) + "El tipo de dato del atributo es caracter." )
						goServicios.Errores.LevantarExcepcion( loEx )
					endtry
				endif
			endif
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoClasificacion() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "VALOR", "", "Clasificacion" )
				if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
					if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
						if vartype( lvValorSugeridoDefinidoPorElUsuario ) # "C"
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoFWGeneracanje() as void
		with this
			.Generacanje = 1
		endwith
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoGeneracanje() as void
		with this
			.ValorSugeridoFWGeneracanje()
		endwith
	endfunc
	*--------------------------------------------------------------------------------------------------------
