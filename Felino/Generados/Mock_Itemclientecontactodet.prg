...
define class Mock_Itemclientecontactodet as MockBase of MockBase.prg

	cClase = 'Itemclientecontactodet'
	...
	*-----------------------------------------------------------------------------------------
	function contacto_pk_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Contacto_pk_assign', lcParametros )
	EndFunc
