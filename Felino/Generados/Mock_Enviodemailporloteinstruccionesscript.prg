...
define class Mock_ENVIODEMAILPORLOTEINSTRUCCIONESSCRIPT as MockBase of MockBase.prg

	cClase = 'ENVIODEMAILPORLOTEINSTRUCCIONESSCRIPT'

	
	cArchivo = ""                                                                                                                                                                                                                                             
	cBaseDeDatos = ""                                                                                                                                                                                                                                         
	cDescripcion = ""                                                                                                                                                                                                                                         
	cDescripcion = "enviando email por lote"                                                                                                                                                                                                                  
	cTipo = ""                                                                                                                                                                                                                                                
	cTipo = "EmailPorLote"                                                                                                                                                                                                                                    
	lDestroy = .f.                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function actualizar( toparametros as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                                                           
	...
	*-----------------------------------------------------------------------------------------
	function loguearmio( tcstring as string ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Loguearmio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function persistirconfiguracion as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Persistirconfiguracion As Void', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function validar( toparametros as zoocoleccion of zoocoleccion.prg ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
