...
define class Mock_Serviciorestad_sqlserver as MockBase of MockBase.prg

	cClase = 'Serviciorestad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalledominioscors( tcatributo as string ) as string                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenercampodetalledominioscors', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalledominioscors( tccampos as string ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalledominioscors', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalledominioscors( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalledominioscors', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_servrestcors( tctablatrabajo ) as string                                                                                                                                                                         
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_servrestcors', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalledominioscors( tccampos as string ) as string                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Parsearcamposdetalledominioscors', lcParametros )
	EndFunc
