...
define class Mock_Detalleajustedestockstockafectadoauditoriaentransito as MockBase of MockBase.prg

	cClase = 'Detalleajustedestockstockafectadoauditoriaentransito'
	...
	cDisenoLimitador = ""                                                                                                                                                                                                                                     
	cEtiqueta = 'Stockafectadoauditoriaentransito'                                                                                                                                                                                                            
	cMensajeErrorUnicidad = "La columna Impuesto no admite valores repetidos."                                                                                                                                                                                
	cMensajeErrorUnicidad = 'La columna  no admite valores repetidos.'                                                                                                                                                                                        
	cNombre = 'Stockafectadoauditoriaentransito'                                                                                                                                                                                                              
	...
	*-----------------------------------------------------------------------------------------
	function cargardetalle( tccursor as string, toatributoscombinacion as object ) as void                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function asignarcombinacionalitem( tccursor as string, toatributoscombinacion as object ) as void                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
