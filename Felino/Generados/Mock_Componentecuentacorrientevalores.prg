...
define class Mock_COMPONENTECUENTACORRIENTEVALORES as MockBase of MockBase.prg

	cClase = 'COMPONENTECUENTACORRIENTEVALORES'
	...
	*-----------------------------------------------------------------------------------------
	function imprimir( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as void                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function inyectardetalle( todetallepadre as detalle of detalle.prg ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = todetallepadre
	...
	*-----------------------------------------------------------------------------------------
	function inyectardetalleanterior( todetalleanterior as detalle of detalle.prg ) as void                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = todetalleanterior
	...
	*-----------------------------------------------------------------------------------------
	function inyectarentidad( toentidadpadre as entidad of entidad.prg ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function ocompcuentacorrientevalorescompras_access()                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Ocompcuentacorrientevalorescompras_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocompcuentacorrientevaloresventas_access()                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Ocompcuentacorrientevaloresventas_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomponente( todetalle as object ) as object                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
