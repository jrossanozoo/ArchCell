...
define class Din_EntidadNOTADECREDITOAGRUPADAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFmodifw, lxComprobantevFd2, lxComprobantevFecexpo, lxComprobantevFectrans, lxComprobantevInformnube, lxComprobantevFecimpo, lxComprobantevFcuit, lxComprobantevIdcaja, lxComprobantevMdcimpu, lxComprobantevTimestamp, lxComprobantevDesmntosi3, lxComprobantevTotalcant, lxComprobantevFactsec, lxComprobantevFajxre, lxComprobantevSubtotsisi, lxComprobantevSubtotcisi, lxComprobantevFpodes2, lxComprobantevSignomov, lxComprobantevCondivalp, lxComprobantevSitfisccli, lxComprobantevDesmntosi2, lxComprobantevFsubtot, lxComprobantevFsubton, lxComprobantevRecmntosi, lxComprobantevRecmntosi1, lxComprobantevDesmntosi, lxComprobantevDesmntosi1, lxComprobantevRecmntosi2, lxComprobantevOrigonline, lxComprobantevFcompfis, lxComprobantevAnulado, lxComprobantevDesaut, lxComprobantevSaltafw, lxComprobantevUaltafw, lxComprobantevSmodifw, lxComprobantevHmodifw, lxComprobantevHoraexpo, lxComprobantevBdmodifw, lxComprobantevEsttrans, lxComprobantevBdaltafw, lxComprobantevFhora, lxComprobantevUmodifw, lxComprobantevOpecomm, lxComprobantevHoraimpo, lxComprobantevValtafw, lxComprobantevDescfw, lxComprobantevVmodifw, lxComprobantevFaltafw, lxComprobantevSimbmon, lxComprobantevIdajuste, lxComprobantevHaltafw, lxComprobantevZadsfw, lxComprobantevMotdescdev, lxComprobantevIdvuelto, lxComprobantevMonsis, lxComprobantevFobs, lxComprobantevFpodes1, lxComprobantevFturno, lxComprobantevFmtdes2, lxComprobantevIdsenia, lxComprobantevFacttipo, lxComprobantevCodigo, lxComprobantevMd1, lxComprobantevFperson, lxComprobantevFmtdes1, lxComprobantevReceptor, lxComprobantevFcliente, lxComprobantevFven, lxComprobantevFletra, lxComprobantevVtosenia, lxComprobantevTotrecarsi, lxComprobantevTrci, lxComprobantevMoneda, lxComprobantevFptoven, lxComprobantevCodlista, lxComprobantevFnumcomp, lxComprobantevEmail, lxComprobantevFtotal, lxComprobantevTdci, lxComprobantevTotdescsi, lxComprobantevFfch, lxComprobantevDeuda, lxComprobantevCotiz, lxComprobantevFmtdes3, lxComprobantevFpodes, lxComprobantevRecmnto2, lxComprobantevFvuelto, lxComprobantevFdescu, lxComprobantevEntregapos, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevRecmnto, lxComprobantevRecpor, lxComprobantevMr, lxComprobantevMr2, lxComprobantevMd2, lxComprobantevMr1, lxComprobantevRecmnto1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecarci, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevChequer, lxComprobantevMerconsign, lxComprobantevCancelar, lxComprobantevIvasis, lxComprobantevTipocrela, lxComprobantevLetrarela, lxComprobantevPuntorela, lxComprobantevNumerorela, lxComprobantevFeccrela
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fmodifw","Fd2","Fecexpo","Fectrans","Informnube","Fecimpo","Fcuit","Idcaja","Mdcimpu","Timestamp","Desmntosi3","Totalcant","Factsec","Fajxre","Subtotsisi","Subtotcisi","Fpodes2","Signomov","Condivalp","Sitfisccli","Desmntosi2","Fsubtot","Fsubton","Recmntosi","Recmntosi1","Desmntosi","Desmntosi1","Recmntosi2","Origonline","Fcompfis","Anulado","Desaut","Saltafw","Ualtafw","Smodifw","Hmodifw","Horaexpo","Bdmodifw","Esttrans","Bdaltafw","Fhora","Umodifw","Opecomm","Horaimpo","Valtafw","Descfw","Vmodifw","Faltafw","Simbmon","Idajuste","Haltafw","Zadsfw","Motdescdev","Idvuelto","Monsis","Fobs","Fpodes1","Fturno","Fmtdes2","Idsenia","Facttipo","Codigo","Md1","Fperson","Fmtdes1","Receptor","Fcliente","Fven","Fletra","Vtosenia","Totrecarsi","Trci","Moneda","Fptoven","Codlista","Fnumcomp","Email","Ftotal","Tdci","Totdescsi","Ffch","Deuda","Cotiz","Fmtdes3","Fpodes","Recmnto2","Fvuelto","Fdescu","Entregapos","Md3","Percepcion","Recmnto","Recpor","Mr","Mr2","Md2","Mr1","Recmnto1","Gravamen","Fimpuesto","Totrecarci","Totdesc","Totimpue","Chequer","Merconsign","Cancelar","Ivasis","Tipocrela","Letrarela","Puntorela","Numerorela","Feccrela" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevIdcaja >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevTimestamp >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevTotalcant >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevFajxre >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevSignomov >>, <<lxComprobantevCondivalp >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevFsubtot >>, <<lxComprobantevFsubton >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevRecmntosi2 >>, <<iif( lxComprobantevOrigonline, 1, 0 ) >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevDesaut, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<lxComprobantevFpodes1 >>, <<lxComprobantevFturno >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'" >>, <<lxComprobantevFacttipo >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<lxComprobantevMd1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFmtdes1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'" >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevTrci >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<lxComprobantevFptoven >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<lxComprobantevFnumcomp >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<lxComprobantevFtotal >>, <<lxComprobantevTdci >>, <<lxComprobantevTotdescsi >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevDeuda >>, <<lxComprobantevCotiz >>, <<lxComprobantevFmtdes3 >>, <<lxComprobantevFpodes >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevFvuelto >>, <<lxComprobantevFdescu >>, <<lxComprobantevEntregapos >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevRecmnto >>, <<lxComprobantevRecpor >>, <<lxComprobantevMr >>, <<lxComprobantevMr2 >>, <<lxComprobantevMd2 >>, <<lxComprobantevMr1 >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecarci >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<"'" + this.FormatearTextoSql( lxComprobantevChequer ) + "'" >>, <<iif( lxComprobantevMerconsign, 1, 0 ) >>, <<iif( lxComprobantevCancelar, 1, 0 ) >>, <<lxComprobantevIvasis >>, <<lxComprobantevTipocrela >>, <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'" >>, <<lxComprobantevPuntorela >>, <<lxComprobantevNumerorela >>, <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Informnube" = <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Idcaja" = <<lxComprobantevIdcaja>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Timestamp" = <<lxComprobantevTimestamp>>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Totalcant" = <<lxComprobantevTotalcant>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Fajxre" = <<lxComprobantevFajxre>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Signomov" = <<lxComprobantevSignomov>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Fsubton" = <<lxComprobantevFsubton>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Origonline" = <<iif( lxComprobantevOrigonline, 1, 0 )>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Desaut" = <<iif( lxComprobantevDesaut, 1, 0 )>>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Idajuste" = <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Motdescdev" = <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'">>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Fturno" = <<lxComprobantevFturno>>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Idsenia" = <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'">>,"Facttipo" = <<lxComprobantevFacttipo>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Receptor" = <<"'" + this.FormatearTextoSql( lxComprobantevReceptor ) + "'">>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Vtosenia" = <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'">>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Trci" = <<lxComprobantevTrci>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Fptoven" = <<lxComprobantevFptoven>>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Email" = <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'">>,"Ftotal" = <<lxComprobantevFtotal>>,"Tdci" = <<lxComprobantevTdci>>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Deuda" = <<lxComprobantevDeuda>>,"Cotiz" = <<lxComprobantevCotiz>>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Fpodes" = <<lxComprobantevFpodes>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Fvuelto" = <<lxComprobantevFvuelto>>,"Fdescu" = <<lxComprobantevFdescu>>,"Entregapos" = <<lxComprobantevEntregapos>>,"Md3" = <<lxComprobantevMd3>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Recpor" = <<lxComprobantevRecpor>>,"Mr" = <<lxComprobantevMr>>,"Mr2" = <<lxComprobantevMr2>>,"Md2" = <<lxComprobantevMd2>>,"Mr1" = <<lxComprobantevMr1>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Totrecarci" = <<lxComprobantevTotrecarci>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Chequer" = <<"'" + this.FormatearTextoSql( lxComprobantevChequer ) + "'">>,"Merconsign" = <<iif( lxComprobantevMerconsign, 1, 0 )>>,"Cancelar" = <<iif( lxComprobantevCancelar, 1, 0 )>>,"Ivasis" = <<lxComprobantevIvasis>>,"Tipocrela" = <<lxComprobantevTipocrela>>,"Letrarela" = <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'">>,"Puntorela" = <<lxComprobantevPuntorela>>,"Numerorela" = <<lxComprobantevNumerorela>>,"Feccrela" = <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 55 OR COMPROBANTEV.FACTTIPO = 3 OR COMPROBANTEV.FACTTIPO = 5 OR COMPROBANTEV.FACTTIPO = 28) << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecimpo" as "Fechaimpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Desmntosi3" as "Montodescuentosinimpuestos3", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Faltafw" as "Fechaaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fturno" as "Turno", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Facttipo" as "Tipocomprobante", "Codigo" as "Codigo", "Md1" as "Montodescuento1", "Fperson" as "Cliente", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fcliente" as "Clientedescripcion", "Fven" as "Vendedor", "Fletra" as "Letra", "Vtosenia" as "Fechavtosenia", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Moneda" as "Monedacomprobante", "Fptoven" as "Puntodeventa", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Email" as "Email", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Fdescu" as "Descuento", "Entregapos" as "Entregaposterior", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 55 OR COMPROBANTEV.FACTTIPO = 3 OR COMPROBANTEV.FACTTIPO = 5 OR COMPROBANTEV.FACTTIPO = 28)
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Montobase" as "Montobase", "Minimoper" as "Minimo", "Porcen" as "Porcentaje", "Sirecert" as "Certificadosire", "Minoimp" as "Minimonoimponible", "Monto" as "Monto", "Nroitem" as "Nroitem", "Sirecs" as "Codseguridadsire", "Base" as "Basedecalculo", "Regimenimp" as "Regimenimpositivo", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Codimp" as "Codigoimpuesto", "Descri" as "Descripcion", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_NOTADECREDITOAGRUPADA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClaveCandidata() as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecimpo" as "Fechaimpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Desmntosi3" as "Montodescuentosinimpuestos3", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Faltafw" as "Fechaaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fturno" as "Turno", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Facttipo" as "Tipocomprobante", "Codigo" as "Codigo", "Md1" as "Montodescuento1", "Fperson" as "Cliente", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fcliente" as "Clientedescripcion", "Fven" as "Vendedor", "Fletra" as "Letra", "Vtosenia" as "Fechavtosenia", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Moneda" as "Monedacomprobante", "Fptoven" as "Puntodeventa", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Email" as "Email", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Fdescu" as "Descuento", "Entregapos" as "Entregaposterior", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 55 OR COMPROBANTEV.FACTTIPO = 3 OR COMPROBANTEV.FACTTIPO = 5 OR COMPROBANTEV.FACTTIPO = 28) And FACTTIPO = <<lxCOMPROBANTEVFACTTIPO>> and FLETRA = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFLETRA ) + "'">> and FPTOVEN = <<lxCOMPROBANTEVFPTOVEN>> and FNUMCOMP = <<lxCOMPROBANTEVFNUMCOMP>> and FACTSEC = <<"'" + this.FormatearTextoSql( lxCOMPROBANTEVFACTSEC ) + "'">>
			endtext
			use in select('c_NOTADECREDITOAGRUPADA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADECREDITOAGRUPADA', set( 'Datasession' ) )
			if reccount( 'c_NOTADECREDITOAGRUPADA' ) = 0
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecimpo" as "Fechaimpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Desmntosi3" as "Montodescuentosinimpuestos3", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Faltafw" as "Fechaaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fturno" as "Turno", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Facttipo" as "Tipocomprobante", "Codigo" as "Codigo", "Md1" as "Montodescuento1", "Fperson" as "Cliente", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fcliente" as "Clientedescripcion", "Fven" as "Vendedor", "Fletra" as "Letra", "Vtosenia" as "Fechavtosenia", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Moneda" as "Monedacomprobante", "Fptoven" as "Puntodeventa", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Email" as "Email", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Fdescu" as "Descuento", "Entregapos" as "Entregaposterior", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 55 OR COMPROBANTEV.FACTTIPO = 3 OR COMPROBANTEV.FACTTIPO = 5 OR COMPROBANTEV.FACTTIPO = 28) order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_NOTADECREDITOAGRUPADA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADECREDITOAGRUPADA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fmodifw" as "Fechamodificacionfw", "Fd2" as "Fechamodificacion", "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Informnube" as "Fueinformadoalanube", "Fecimpo" as "Fechaimpo", "Fcuit" as "Cuit", "Idcaja" as "Caja", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Desmntosi3" as "Montodescuentosinimpuestos3", "Totalcant" as "Totalcantidad", "Factsec" as "Secuencia", "Fajxre" as "Ajustesporredondeos", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Sitfisccli" as "Situacionfiscal", "Desmntosi2" as "Montodescuentosinimpuestos2", "Fsubtot" as "Subtotalbruto", "Fsubton" as "Subtotalneto", "Recmntosi" as "Recargomontosinimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi" as "Montodescuentosinimpuestos", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi2" as "Recargomontosinimpuestos2", "Origonline" as "Basadoencomprobanteonline", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desaut" as "Descuentoautomatico", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Fhora" as "Hora", "Umodifw" as "Usuariomodificacionfw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Valtafw" as "Versionaltafw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Faltafw" as "Fechaaltafw", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Haltafw" as "Horaaltafw", "Zadsfw" as "Zadsfw", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fpodes1" as "Porcentajedescuento1", "Fturno" as "Turno", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Facttipo" as "Tipocomprobante", "Codigo" as "Codigo", "Md1" as "Montodescuento1", "Fperson" as "Cliente", "Fmtdes1" as "Montodescuentoconimpuestos1", "Receptor" as "Receptor", "Fcliente" as "Clientedescripcion", "Fven" as "Vendedor", "Fletra" as "Letra", "Vtosenia" as "Fechavtosenia", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Moneda" as "Monedacomprobante", "Fptoven" as "Puntodeventa", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Email" as "Email", "Ftotal" as "Total", "Tdci" as "Totaldescuentosconimpuestos", "Totdescsi" as "Totaldescuentossinimpuestos", "Ffch" as "Fecha", "Deuda" as "Deuda", "Cotiz" as "Cotizacion", "Fmtdes3" as "Montodescuentoconimpuestos3", "Fpodes" as "Porcentajedescuento", "Recmnto2" as "Recargomontoconimpuestos2", "Fvuelto" as "Vuelto", "Fdescu" as "Descuento", "Entregapos" as "Entregaposterior", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Recmnto" as "Recargomontoconimpuestos", "Recpor" as "Recargoporcentaje", "Mr" as "Recargomonto", "Mr2" as "Recargomonto2", "Md2" as "Montodescuento2", "Mr1" as "Recargomonto1", "Recmnto1" as "Recargomontoconimpuestos1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarci" as "Totalrecargos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Merconsign" as "Mercaderiaconsignacion", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado" from ZooLogic.COMPROBANTEV where  funciones.dtos( FAltaFW ) + funciones.padr( HAltaFW, 8, ' ' ) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 55 OR COMPROBANTEV.FACTTIPO = 3 OR COMPROBANTEV.FACTTIPO = 5 OR COMPROBANTEV.FACTTIPO = 28) order by FAltaFW,HAltaFW,CODIGO
			endtext
			use in select('c_NOTADECREDITOAGRUPADA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADECREDITOAGRUPADA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fd2,Fecexpo,Fectrans,Informnube,Fecimpo,Fcuit,Idcaja,Mdcimpu,Timestamp,Desmntosi3,To" + ;
"talcant,Factsec,Fajxre,Subtotsisi,Subtotcisi,Fpodes2,Signomov,Condivalp,Sitfisccli,Desmntosi2,Fsubto" + ;
"t,Fsubton,Recmntosi,Recmntosi1,Desmntosi,Desmntosi1,Recmntosi2,Origonline,Fcompfis,Anulado,Desaut,Sa" + ;
"ltafw,Ualtafw,Smodifw,Hmodifw,Horaexpo,Bdmodifw,Esttrans,Bdaltafw,Fhora,Umodifw,Opecomm,Horaimpo,Val" + ;
"tafw,Descfw,Vmodifw,Faltafw,Simbmon,Idajuste,Haltafw,Zadsfw,Motdescdev,Idvuelto,Monsis,Fobs,Fpodes1," + ;
"Fturno,Fmtdes2,Idsenia,Facttipo,Codigo,Md1,Fperson,Fmtdes1,Receptor,Fcliente,Fven,Fletra,Vtosenia,To" + ;
"trecarsi,Trci,Moneda,Fptoven,Codlista,Fnumcomp,Email,Ftotal,Tdci,Totdescsi,Ffch,Deuda,Cotiz,Fmtdes3," + ;
"Fpodes,Recmnto2,Fvuelto,Fdescu,Entregapos,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Recmnto1,Grav" + ;
"amen,Fimpuesto,Totrecarci,Totdesc,Totimpue,Chequer,Merconsign,Cancelar,Ivasis,Tipocrela,Letrarela,Pu" + ;
"ntorela,Numerorela,Feccrela" + ;
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, InformNube = ] + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, OrigOnline = ] + Transform( iif( &lcCursor..OrigOnline, 1, 0 ))+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, DESAUT = ] + Transform( iif( &lcCursor..DESAUT, 1, 0 ))+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, idAjuste = ] + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, MotDescDev = ] + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'"+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, IDSenia = ] + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'"+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, Receptor = ] + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'"+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, vtosenia = ] + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'"+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, EntregaPos = ] + transform( &lcCursor..EntregaPos )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, MR = ] + transform( &lcCursor..MR )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecarCI = ] + transform( &lcCursor..totrecarCI )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, ChequeR = ] + "'" + this.FormatearTextoSql( &lcCursor..ChequeR ) + "'"+ [, MerConsign = ] + Transform( iif( &lcCursor..MerConsign, 1, 0 ))+ [, Cancelar = ] + Transform( iif( &lcCursor..Cancelar, 1, 0 ))+ [, IvaSis = ] + transform( &lcCursor..IvaSis )+ [, TipoCRela = ] + transform( &lcCursor..TipoCRela )+ [, letraRela = ] + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'"+ [, PuntoRela = ] + transform( &lcCursor..PuntoRela )+ [, NumeroRela = ] + transform( &lcCursor..NumeroRela )+ [, FecCRela = ] + "'" + this.ConvertirDateSql( &lcCursor..FecCRela ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FMODIFW, FD2, FECEXPO, FECTRANS, InformNube, FECIMPO, fCuit, IdCaja, MDCIMPU, TIMESTAMP, DesMntoSI3, TotalCant, FACTSEC, FAjXRe, SubTotSISI, SubTotCISI, FPODES2, signomov, CondivaLp, SitFiscCli, DesMntoSI2, FSubTOT, fSubToN, RecMntoSI, RecMntoSI1, DesMntoSI, DesMntoSI1, RecMntoSI2, OrigOnline, FCOMPFIS, Anulado, DESAUT, SALTAFW, UALTAFW, SMODIFW, HMODIFW, HORAEXPO, BDMODIFW, ESTTRANS, BDALTAFW, FHORA, UMODIFW, OPEcomm, HORAIMPO, VALTAFW, DescFW, VMODIFW, FAltaFW, SimbMon, idAjuste, HAltaFW, ZADSFW, MotDescDev, idVuelto, MonSis, FObs, FPODES1, FTurno, FMTDES2, IDSenia, FACTTIPO, CODIGO, MD1, FPerson, FMTDES1, Receptor, FCLIENTE, FVEN, FLETRA, vtosenia, totrecarSI, TRCI, Moneda, FPTOVEN, CodLista, FNUMCOMP, Email, FTotal, TDCI, totdescSI, FFCH, Deuda, Cotiz, FMTDES3, FPODES, RecMnto2, FVuelto, fDescu, EntregaPos, MD3, percepcion, RecMnto, RecPor, MR, MR2, MD2, MR1, RecMnto1, gravamen, fImpuesto, totrecarCI, totdesc, totimpue, ChequeR, MerConsign, Cancelar, IvaSis, TipoCRela, letraRela, PuntoRela, NumeroRela, FecCRela
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..IdCaja ) + ',' + transform( &lcCursor..MDCIMPU ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..TotalCant ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..FPODES2 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..DesMntoSI1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + Transform( iif( &lcCursor..OrigOnline, 1, 0 )) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..DESAUT, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FPODES1 ) + ',' + transform( &lcCursor..FTurno ) + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'" + ',' + transform( &lcCursor..FACTTIPO ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..FMTDES1 )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Receptor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'" + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..TRCI )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + transform( &lcCursor..FPTOVEN ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..TDCI ) + ',' + transform( &lcCursor..totdescSI ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..Deuda ) + ',' + transform( &lcCursor..Cotiz ) + ',' + transform( &lcCursor..FMTDES3 ) + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..fDescu ) + ',' + transform( &lcCursor..EntregaPos ) + ',' + transform( &lcCursor..MD3 ) + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..RecMnto )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..RecPor ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..totrecarCI ) + ',' + transform( &lcCursor..totdesc ) + ',' + transform( &lcCursor..totimpue )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ChequeR ) + "'" + ',' + Transform( iif( &lcCursor..MerConsign, 1, 0 )) + ',' + Transform( iif( &lcCursor..Cancelar, 1, 0 )) + ',' + transform( &lcCursor..IvaSis ) + ',' + transform( &lcCursor..TipoCRela ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'" + ',' + transform( &lcCursor..PuntoRela ) + ',' + transform( &lcCursor..NumeroRela )
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'NOTADECREDITOAGRUPADA_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'NOTADECREDITOAGRUPADA_FOBS'
				llRetorno = .T.
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FD2 = isnull( d.FD2, t.FD2 ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.INFORMNUBE = isnull( d.INFORMNUBE, t.INFORMNUBE ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.ORIGONLINE = isnull( d.ORIGONLINE, t.ORIGONLINE ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.DESAUT = isnull( d.DESAUT, t.DESAUT ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.IDSENIA = isnull( d.IDSENIA, t.IDSENIA ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.RECEPTOR = isnull( d.RECEPTOR, t.RECEPTOR ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.VTOSENIA = isnull( d.VTOSENIA, t.VTOSENIA ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.MR = isnull( d.MR, t.MR ),t.MR2 = isnull( d.MR2, t.MR2 ),t.MD2 = isnull( d.MD2, t.MD2 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECARCI = isnull( d.TOTRECARCI, t.TOTRECARCI ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.CHEQUER = isnull( d.CHEQUER, t.CHEQUER ),t.MERCONSIGN = isnull( d.MERCONSIGN, t.MERCONSIGN ),t.CANCELAR = isnull( d.CANCELAR, t.CANCELAR ),t.IVASIS = isnull( d.IVASIS, t.IVASIS ),t.TIPOCRELA = isnull( d.TIPOCRELA, t.TIPOCRELA ),t.LETRARELA = isnull( d.LETRARELA, t.LETRARELA ),t.PUNTORELA = isnull( d.PUNTORELA, t.PUNTORELA ),t.NUMERORELA = isnull( d.NUMERORELA, t.NUMERORELA ),t.FECCRELA = isnull( d.FECCRELA, t.FECCRELA )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fmodifw,Fd2,Fecexpo,Fectrans,Informnube,Fecimpo,Fcuit,Idcaja,Mdcimpu,Timestamp,Desmntosi3,Totalcant,Factsec,Fajxre,Subtotsisi,Subtotcisi,Fpodes2,Signomov,Condivalp,Sitfisccli,Desmntosi2,Fsubtot,Fsubton,Recmntosi,Recmntosi1,Desmntosi,Desmntosi1,Recmntosi2,Origonline,Fcompfis,Anulado,Desaut,Saltafw,Ualtafw,Smodifw,Hmodifw,Horaexpo,Bdmodifw,Esttrans,Bdaltafw,Fhora,Umodifw,Opecomm,Horaimpo,Valtafw,Descfw,Vmodifw,Faltafw,Simbmon,Idajuste,Haltafw,Zadsfw,Motdescdev,Idvuelto,Monsis,Fobs,Fpodes1,Fturno,Fmtdes2,Idsenia,Facttipo,Codigo,Md1,Fperson,Fmtdes1,Receptor,Fcliente,Fven,Fletra,Vtosenia,Totrecarsi,Trci,Moneda,Fptoven,Codlista,Fnumcomp,Email,Ftotal,Tdci,Totdescsi,Ffch,Deuda,Cotiz,Fmtdes3,Fpodes,Recmnto2,Fvuelto,Fdescu,Entregapos,Md3,Percepcion,Recmnto,Recpor,Mr,Mr2,Md2,Mr1,Recmnto1,Gravamen,Fimpuesto,Totrecarci,Totdesc,Totimpue,Chequer,Merconsign,Cancelar,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela)
					Select isnull( d.FMODIFW,''),isnull( d.FD2,''),isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.INFORMNUBE,''),isnull( d.FECIMPO,''),isnull( d.FCUIT,''),isnull( d.IDCAJA,0),isnull( d.MDCIMPU,0),isnull( d.TIMESTAMP,0),isnull( d.DESMNTOSI3,0),isnull( d.TOTALCANT,0),isnull( d.FACTSEC,''),isnull( d.FAJXRE,0),isnull( d.SUBTOTSISI,0),isnull( d.SUBTOTCISI,0),isnull( d.FPODES2,0),isnull( d.SIGNOMOV,0),isnull( d.CONDIVALP,0),isnull( d.SITFISCCLI,0),isnull( d.DESMNTOSI2,0),isnull( d.FSUBTOT,0),isnull( d.FSUBTON,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTOSI1,0),isnull( d.DESMNTOSI,0),isnull( d.DESMNTOSI1,0),isnull( d.RECMNTOSI2,0),isnull( d.ORIGONLINE,0),isnull( d.FCOMPFIS,0),isnull( d.ANULADO,0),isnull( d.DESAUT,0),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.FHORA,''),isnull( d.UMODIFW,''),isnull( d.OPECOMM,''),isnull( d.HORAIMPO,''),isnull( d.VALTAFW,''),isnull( d.DESCFW,''),isnull( d.VMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.SIMBMON,''),isnull( d.IDAJUSTE,''),convert( char(8), getdate(), 108 ),isnull( d.ZADSFW,''),isnull( d.MOTDESCDEV,''),isnull( d.IDVUELTO,''),isnull( d.MONSIS,''),isnull( d.FOBS,''),isnull( d.FPODES1,0),isnull( d.FTURNO,0),isnull( d.FMTDES2,0),isnull( d.IDSENIA,''),isnull( d.FACTTIPO,0),isnull( d.CODIGO,''),isnull( d.MD1,0),isnull( d.FPERSON,''),isnull( d.FMTDES1,0),isnull( d.RECEPTOR,''),isnull( d.FCLIENTE,''),isnull( d.FVEN,''),isnull( d.FLETRA,''),isnull( d.VTOSENIA,''),isnull( d.TOTRECARSI,0),isnull( d.TRCI,0),isnull( d.MONEDA,''),isnull( d.FPTOVEN,0),isnull( d.CODLISTA,''),isnull( d.FNUMCOMP,0),isnull( d.EMAIL,''),isnull( d.FTOTAL,0),isnull( d.TDCI,0),isnull( d.TOTDESCSI,0),isnull( d.FFCH,''),isnull( d.DEUDA,0),isnull( d.COTIZ,0),isnull( d.FMTDES3,0),isnull( d.FPODES,0),isnull( d.RECMNTO2,0),isnull( d.FVUELTO,0),isnull( d.FDESCU,0),isnull( d.ENTREGAPOS,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.RECMNTO,0),isnull( d.RECPOR,0),isnull( d.MR,0),isnull( d.MR2,0),isnull( d.MD2,0),isnull( d.MR1,0),isnull( d.RECMNTO1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECARCI,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.CHEQUER,''),isnull( d.MERCONSIGN,0),isnull( d.CANCELAR,0),isnull( d.IVASIS,0),isnull( d.TIPOCRELA,0),isnull( d.LETRARELA,''),isnull( d.PUNTORELA,0),isnull( d.NUMERORELA,0),isnull( d.FECCRELA,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="FECHATRANSFERENCIA                      " tabla="COMPROBANTEV   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                                                                                                                       " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="SUBTOTALCONIMPUESTOSSOBREITEMS          " tabla="COMPROBANTEV   " campo="SUBTOTCISI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPROBANTEV   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="NROOPECOMMERCE                          " tabla="COMPROBANTEV   " campo="OPECOMM   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                                                                                                          " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Observaciones                                                                                                                                                                                                                                             " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Cliente descripción                                                                                                                                                                                                                                       " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="VENDEDOR                                " tabla="COMPROBANTEV   " campo="FVEN      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Vendedor                                                                                                                                                                                                                                                  " dominio="CODIGOVENDEDOR                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="416" etiqueta="Moneda                                                                                                                                                                                                                                                    " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Total                                                                                                                                                                                                                                                     " dominio="TOTALMULTIMONEDA              " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="DEUDA                                   " tabla="COMPROBANTEV   " campo="DEUDA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Saldo de cta. cte.                                                                                                                                                                                                                                        " dominio="FECHASALDO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="ENTREGAPOSTERIORVIRTUAL                 " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Tipo de entrega                                                                                                                                                                                                                                           " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="PORCENTAJEDESCUENTO                     " tabla="COMPROBANTEV   " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="430" etiqueta="Porcentaje de descuento                                                                                                                                                                                                                                   " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="VUELTO                                  " tabla="COMPROBANTEV   " campo="FVUELTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Vuelto persistido                                                                                                                                                                                                                                         " dominio="VUELTO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="10" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="DESCUENTO                               " tabla="COMPROBANTEV   " campo="FDESCU    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="436" etiqueta="Monto % descuento                                                                                                                                                                                                                                         " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="IMPUESTOS                               " tabla="COMPROBANTEV   " campo="FIMPUESTO " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="450" etiqueta="I.V.A.                                                                                                                                                                                                                                                    " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="50" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECARCI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos total                                                                                                                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Total descuentos                                                                                                                                                                                                                                          " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="28" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADECREDITOAGRUPADA                   " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="452" etiqueta="Total impuestos                                                                                                                                                                                                                                           " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
