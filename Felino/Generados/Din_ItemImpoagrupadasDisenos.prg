...
define class Din_ItemIMPOAGRUPADASDisenos as ItemActivo of ItemActivo.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'IMPOAGRUPADAS', 'Disenos')
		...
		if this.ldestroy
			...
			if This.lInstanciarSubEntidadaDemanda
				if ( !vartype( this.Diseno ) = 'O' or isnull( this.Diseno ) )
					this.Diseno = _Screen.zoo.instanciarentidad( 'Disenoimpo' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoDiseno() as void
		...
		with this
			try
				lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "IMPOAGRUPADAS", "Disenos", "Diseno" )
