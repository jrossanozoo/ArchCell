...
define class Mock_Detallefacturaelectronicaexportacionimpuestosdetalle as MockBase of MockBase.prg

	cClase = 'Detallefacturaelectronicaexportacionimpuestosdetalle'
