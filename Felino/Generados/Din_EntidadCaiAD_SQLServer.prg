...
define class Din_EntidadCAIAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxNumeracionesFecexpo, lxNumeracionesFectrans, lxNumeracionesFecimpo, lxNumeracionesFaltafw, lxNumeracionesFmodifw, lxNumeracionesTimestamp, lxNumeracionesSmodifw, lxNumeracionesSaltafw, lxNumeracionesUaltafw, lxNumeracionesValtafw, lxNumeracionesZadsfw, lxNumeracionesHmodifw, lxNumeracionesVmodifw, lxNumeracionesUmodifw, lxNumeracionesHoraexpo, lxNumeracionesHoraimpo, lxNumeracionesBdaltafw, lxNumeracionesBdmodifw, lxNumeracionesEsttrans, lxNumeracionesHaltafw, lxNumeracionesTalonario, lxNumeracionesPobs, lxNumeracionesEntidad, lxNumeracionesLetra, lxNumeracionesPtoven
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.NUMERACIONES ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Timestamp","Smodifw","Saltafw","Ualtafw","Valtafw","Zadsfw","Hmodifw","Vmodifw","Umodifw","Horaexpo","Horaimpo","Bdaltafw","Bdmodifw","Esttrans","Haltafw","Talonario","Pobs","Entidad","Letra","Ptoven" ) values ( <<"'" + this.ConvertirDateSql( lxNumeracionesFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxNumeracionesFmodifw ) + "'" >>, <<lxNumeracionesTimestamp >>, <<"'" + this.FormatearTextoSql( lxNumeracionesSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesPobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesEntidad ) + "'" >>, <<"'" + this.FormatearTextoSql( lxNumeracionesLetra ) + "'" >>, <<lxNumeracionesPtoven >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.NUMERACIONES set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxNumeracionesFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxNumeracionesFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxNumeracionesFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxNumeracionesFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxNumeracionesFmodifw ) + "'">>,"Timestamp" = <<lxNumeracionesTimestamp>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesValtafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxNumeracionesZadsfw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesUmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxNumeracionesHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxNumeracionesHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxNumeracionesBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxNumeracionesEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxNumeracionesHaltafw ) + "'">>,"Talonario" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'">>,"Pobs" = <<"'" + this.FormatearTextoSql( lxNumeracionesPobs ) + "'">>,"Entidad" = <<"'" + this.FormatearTextoSql( lxNumeracionesEntidad ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxNumeracionesLetra ) + "'">>,"Ptoven" = <<lxNumeracionesPtoven>> where "Talonario" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'">> and  NUMERACIONES.TALONARIO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Letra" as "Letra", "Ptoven" as "Puntodeventa" from ZooLogic.NUMERACIONES where "Talonario" = <<"'" + this.FormatearTextoSql( lxNumeracionesTalonario ) + "'">> and  NUMERACIONES.TALONARIO != ''
			endtext
			use in select('c_CAI')
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Letra" as "Letra", "Ptoven" as "Puntodeventa" from ZooLogic.NUMERACIONES where  NUMERACIONES.TALONARIO != '' order by Talonario
			endtext
			use in select('c_CAI')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAI', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Letra" as "Letra", "Ptoven" as "Puntodeventa" from ZooLogic.NUMERACIONES where  funciones.padr( Talonario, 35, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NUMERACIONES.TALONARIO != '' order by Talonario
			endtext
			use in select('c_CAI')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAI', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Letra" as "Letra", "Ptoven" as "Puntodeventa" from ZooLogic.NUMERACIONES where  funciones.padr( Talonario, 35, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  NUMERACIONES.TALONARIO != '' order by Talonario desc
			endtext
			use in select('c_CAI')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAI', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Letra" as "Letra", "Ptoven" as "Puntodeventa" from ZooLogic.NUMERACIONES where  NUMERACIONES.TALONARIO != '' order by Talonario desc
			endtext
			use in select('c_CAI')
			this.oConexion.EjecutarSql( lcSentencia, 'c_CAI', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Timestamp,Smodifw,Saltafw,Ualtafw,Valtafw,Zadsfw,Hm" + ;
"odifw,Vmodifw,Umodifw,Horaexpo,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Haltafw,Talonario,Pobs,Entidad,Le" + ;
"tra,Ptoven" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Talonario" as "Codigo", "Pobs" as "Obs", "Entidad" as "Entidad", "Letra" as "Letra", "Ptoven" as "Puntodeventa"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.NUMERACIONES set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Talonario = ] + "'" + this.FormatearTextoSql( &lcCursor..Talonario ) + "'"+ [, pobs = ] + "'" + this.FormatearTextoSql( &lcCursor..pobs ) + "'"+ [, Entidad = ] + "'" + this.FormatearTextoSql( &lcCursor..Entidad ) + "'"+ [, Letra = ] + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'"+ [, PtoVen = ] + transform( &lcCursor..PtoVen ) + [ Where Talonario = ] + "'" + this.FormatearTextoSql( &lcCursor..Talonario ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, TIMESTAMP, SMODIFW, SALTAFW, UALTAFW, VALTAFW, ZADSFW, HMODIFW, VMODIFW, UMODIFW, HORAEXPO, HORAIMPO, BDALTAFW, BDMODIFW, ESTTRANS, HALTAFW, Talonario, pobs, Entidad, Letra, PtoVen
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Talonario ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.TALONARIO = isnull( d.TALONARIO, t.TALONARIO ),t.POBS = isnull( d.POBS, t.POBS ),t.ENTIDAD = isnull( d.ENTIDAD, t.ENTIDAD ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.PTOVEN = isnull( d.PTOVEN, t.PTOVEN )
					from ZooLogic.NUMERACIONES t inner join deleted d 
							 on t.Talonario = d.Talonario
				-- Fin Updates
				insert into ZooLogic.NUMERACIONES(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Timestamp,Smodifw,Saltafw,Ualtafw,Valtafw,Zadsfw,Hmodifw,Vmodifw,Umodifw,Horaexpo,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Haltafw,Talonario,Pobs,Entidad,Letra,Ptoven)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.ZADSFW,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.TALONARIO,''),isnull( d.POBS,''),isnull( d.ENTIDAD,''),isnull( d.LETRA,''),isnull( d.PTOVEN,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="CAI                                     " atributo="FECHATRANSFERENCIA                      " tabla="NUMERACIONES   " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CAI                                     " atributo="ESTADOTRANSFERENCIA                     " tabla="NUMERACIONES   " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
