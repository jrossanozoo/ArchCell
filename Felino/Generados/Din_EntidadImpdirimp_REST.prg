...
define class Din_EntidadImpdirimp_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Impdirimp"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_impuesto_desde", toEntidad, "F_impuesto_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_impuesto_hasta", toEntidad, "F_impuesto_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "Aplicacion", toEntidad, "Aplicacion" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_tipoimp_desde", toEntidad, "F_tipoimp_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_tipoimp_hasta", toEntidad, "F_tipoimp_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_jurisdiccion_desde", toEntidad, "F_jurisdiccion_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_jurisdiccion_hasta", toEntidad, "F_jurisdiccion_hasta" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "f_Impuesto_Desde", toEntidad.f_Impuesto_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Impuesto_Hasta", toEntidad.f_Impuesto_Hasta)
			this.SetearAtributoString( toModeloResponse, "Aplicacion", toEntidad.Aplicacion)
			this.SetearAtributoString( toModeloResponse, "f_TipoImp_Desde", toEntidad.f_TipoImp_Desde)
			this.SetearAtributoString( toModeloResponse, "f_TipoImp_Hasta", toEntidad.f_TipoImp_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_Jurisdiccion_Desde", toEntidad.f_Jurisdiccion_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Jurisdiccion_Hasta", toEntidad.f_Jurisdiccion_Hasta)
