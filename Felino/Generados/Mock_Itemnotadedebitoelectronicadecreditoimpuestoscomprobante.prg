...
define class Mock_Itemnotadedebitoelectronicadecreditoimpuestoscomprobante as MockBase of MockBase.prg

	cClase = 'Itemnotadedebitoelectronicadecreditoimpuestoscomprobante'
