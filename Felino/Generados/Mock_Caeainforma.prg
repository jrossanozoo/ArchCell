...
define class Mock_caeainforma as MockBase of MockBase.prg
	...
	cDiasRestringidosPorAFIPParaInformarCAEA = ""                                                                                                                                                                                                             
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallecaeinformadetalle() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Cambiosdetallecaeinformadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargarcomprobantesainformar() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcomprobantesainformar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function cargardatosdeentidadcaea() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargardatosdeentidadcaea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventocancelarcomprobante() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventocancelarcomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventoenviarmensajeadvertir( tcmensaje ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventoenviarmensajeadvertir', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventoenviarmensajeprocesando( tcmensaje as string ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventoenviarmensajeprocesando', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventoenviarprocesando() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoenviarprocesando', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopreguntarinformarsinmvimientos() as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopreguntarinformarsinmvimientos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechaproceso2_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechaproceso2_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechaproceso2_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechaproceso2		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechaproceso2( lxVal )				this.ValidarDominio_Fecha( lxVal )				this.Setear_Fechaproceso2( lxVal )			EndIf		Else			This.Setear_Fechaproceso2( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function informarcomprobantes() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Informarcomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function loguearmensaje( tocolerrcomprobanteadjunto as object, tcfechacomp as string, tccomprobante as string ) as string                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tocolerrcomprobanteadjunto
		lxParam2 = tcfechacomp
		lxParam3 = tccomprobante
		...
		return this.ObtenerResultado( 'Loguearmensaje', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerconsultacomrpobantes() as string                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerconsultacomrpobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerparametrosyregistrosparautilizarcaea() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerparametrosyregistrosparautilizarcaea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstringcomprobanes() as string                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerstringcomprobanes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function persistirrespueta( torespuesta as object, tccodcomp as string ) as void                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Persistirrespueta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function persistirrespuetasinmovimientos( torespuesta as object ) as void                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Persistirrespuetasinmovimientos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function resultado2_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'resultado2_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'resultado2_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Resultado2		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Resultado2( lxVal )				this.Setear_Resultado2( lxVal )			EndIf		Else			This.Setear_Resultado2( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codcaea( txval as variant ) as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_codcaea', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_codcaea', lcParametros )			endif		endif		dodefault( txVal )		try			this.CargarDatosDeEntidadCAEA()			if this.ValidarDiasRestringidoPorAFIPParaInformarCAEA()				this.CargarComprobantesAInformar()			endif		catch to loError			this.AgregarInformacion( 'No se puede cargar datos.')			goServicios.Errores.LevantarExcepcion( this.ObtenerInformacion() )		endtry
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechaproceso2( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechaproceso2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechaproceso2', lcParametros )			endif		endif		this.Fechaproceso2 = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_resultado2( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_resultado2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_resultado2', lcParametros )			endif		endif		this.Resultado2 = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function usaservidormtxca() as boolean                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Usaservidormtxca', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codcaea( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_codcaea', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_codcaea', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechaproceso2( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechaproceso2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechaproceso2', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_resultado2( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CAEAINFORMA' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_resultado2', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_resultado2', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarcodcaea() as boolean                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarcodcaea', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validardiasrestringidoporafipparainformarcaea() as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validardiasrestringidoporafipparainformarcaea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodcaea() as void                                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridocodcaea', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenernombreportipocomprobante( tntipocomprobante as integer ) as string                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenernombreportipocomprobante', lcParametros )
	EndFunc
