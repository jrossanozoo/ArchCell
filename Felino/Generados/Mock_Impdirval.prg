...
define class Mock_impdirval as MockBase of MockBase.prg
	...
	f_Moneda_Desde = ""                                                                                                                                                                                                                                       
	f_Moneda_Hasta = ""                                                                                                                                                                                                                                       
	f_OperadoraDeTarjeta_Desde = ""                                                                                                                                                                                                                           
	f_OperadoraDeTarjeta_Hasta = ""                                                                                                                                                                                                                           
	f_Valor_Desde = ""                                                                                                                                                                                                                                        
	f_Valor_Hasta = ""                                                                                                                                                                                                                                        
	...
	*-----------------------------------------------------------------------------------------
	function f_moneda_desde_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRVAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_moneda_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_moneda_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_moneda_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_moneda_desde( lxVal )				this.Setear_F_moneda_desde( lxVal )			EndIf		Else			This.Setear_F_moneda_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_moneda_hasta_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRVAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_moneda_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_moneda_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_moneda_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_moneda_hasta( lxVal )				this.Setear_F_moneda_hasta( lxVal )			EndIf		Else			This.Setear_F_moneda_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_operadoradetarjeta_desde_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRVAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_operadoradetarjeta_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_operadoradetarjeta_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_operadoradetarjeta_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_operadoradetarjeta_desde( lxVal )				this.Setear_F_operadoradetarjeta_desde( lxVal )			EndIf		Else			This.Setear_F_operadoradetarjeta_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_operadoradetarjeta_hasta_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRVAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_operadoradetarjeta_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_operadoradetarjeta_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_operadoradetarjeta_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_operadoradetarjeta_hasta( lxVal )				this.Setear_F_operadoradetarjeta_hasta( lxVal )			EndIf		Else			This.Setear_F_operadoradetarjeta_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_valor_desde_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRVAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_valor_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_valor_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_valor_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_valor_desde( lxVal )				this.Setear_F_valor_desde( lxVal )			EndIf		Else			This.Setear_F_valor_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_valor_hasta_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'IMPDIRVAL' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_valor_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_valor_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_valor_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_valor_hasta( lxVal )				this.Setear_F_valor_hasta( lxVal )			EndIf		Else			This.Setear_F_valor_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_moneda_desde( txval as variant ) as boolean                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_moneda_hasta( txval as variant ) as boolean                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_operadoradetarjeta_desde( txval as variant ) as boolean                                                                                                                                                                                
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_operadoradetarjeta_hasta( txval as variant ) as boolean                                                                                                                                                                                
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_valor_desde( txval as variant ) as boolean                                                                                                                                                                                             
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_valor_hasta( txval as variant ) as boolean                                                                                                                                                                                             
