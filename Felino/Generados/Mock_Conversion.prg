...
define class Mock_conversion as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Conversión de datos"                                                                                                                                                                                                                     
	...
	oColErrorDeConversion = null                                                                                                                                                                                                                              
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oComportamientoCodigoSugerido = null                                                                                                                                                                                                                      
	oConversionValores = null                                                                                                                                                                                                                                 
	oExtension = null                                                                                                                                                                                                                                         
	oGestorDeMail = null                                                                                                                                                                                                                                      
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function accion_despuesdeasignar() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Accion_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function buscaragrupamientos( tcbasededatos as string, tccadenaconversion as string ) as string                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcbasededatos
		lxParam2 = tccadenaconversion
		...
		return this.ObtenerResultado( 'Buscaragrupamientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function buscarbasededatosenagrupamiento( tcagrupamiento as string, tcbasededatos as string ) as boolean                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Buscarbasededatosenagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esagrupamiento( tcagrupamiento as string ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerconversionespecifica( txcodigo as string, txvalor as variant, tcarea as string, tcatributo as string, tcbasededatos as string ) as string                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerconversionespecifica', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oconversionvalores_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'CONVERSION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oconversionvalores_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oconversionvalores_access', lcParametros )			endif		endif		if this.ldestroy		else			if !vartype( this.oConversionValores ) = 'O' or isnull( this.oConversionValores )				this.oConversionValores = _Screen.zoo.instanciarentidad( 'ConversionValores' )			endif		endif		return this.oConversionValores
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function quitarcorchetesdeagrupamiento( tcagrupamiento as string ) as string                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Quitarcorchetesdeagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function resolverconversiones( tcxmlmapeotablas as string ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcxmlmapeotablas
		...
		return this.ObtenerResultado( 'Resolverconversiones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_valordefault( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONVERSION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_valordefault', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_valordefault', lcParametros )			endif		endif		this.Valordefault = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_valordefault( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONVERSION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_valordefault', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_valordefault', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valordefault_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CONVERSION' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'valordefault_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'valordefault_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Valordefault		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Valordefault( lxVal )				if ( this.lHabilitarValordefault or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Valordefault( lxVal )				else					this.Valordefault = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Conversión de datos - Atributo: Valordefault)" )				endif			EndIf		Else			This.Setear_Valordefault( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridovalordefault() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridovalordefault', lcParametros )
	EndFunc
