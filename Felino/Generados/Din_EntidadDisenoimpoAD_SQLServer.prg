...
define class Din_EntidadDISENOIMPOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxDisimpoFecimpo, lxDisimpoFaltafw, lxDisimpoFecexpo, lxDisimpoFectrans, lxDisimpoFmodifw, lxDisimpoClasehook, lxDisimpoTimestamp, lxDisimpoBloqreg, lxDisimpoHmodifw, lxDisimpoHoraexpo, lxDisimpoHoraimpo, lxDisimpoUaltafw, lxDisimpoSaltafw, lxDisimpoVmodifw, lxDisimpoZadsfw, lxDisimpoUmodifw, lxDisimpoValtafw, lxDisimpoSmodifw, lxDisimpoHaltafw, lxDisimpoBdmodifw, lxDisimpoBdaltafw, lxDisimpoEsttrans, lxDisimpoCentidad, lxDisimpoCarchent, lxDisimpoAccsinaler, lxDisimpoCcod, lxDisimpoCmodo, lxDisimpoCrutaproc, lxDisimpoCdes, lxDisimpoCtiparch, lxDisimpoCanlincort, lxDisimpoAccconaler, lxDisimpoCcomando, lxDisimpoCrutaalert, lxDisimpoParcoma, lxDisimpoAccconerr, lxDisimpoCrutaerr, lxDisimpoCtipreg, lxDisimpoCdelimi, lxDisimpoIgnorini, lxDisimpoIgnorfin, lxDisimpoIgnorblanc, lxDisimpoCbdatos, lxDisimpoCsololin, lxDisimpoClinignor, lxDisimpoDetecdet, lxDisimpoCobs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.DISIMPO ( "Fecimpo","Faltafw","Fecexpo","Fectrans","Fmodifw","Clasehook","Timestamp","Bloqreg","Hmodifw","Horaexpo","Horaimpo","Ualtafw","Saltafw","Vmodifw","Zadsfw","Umodifw","Valtafw","Smodifw","Haltafw","Bdmodifw","Bdaltafw","Esttrans","Centidad","Carchent","Accsinaler","Ccod","Cmodo","Crutaproc","Cdes","Ctiparch","Canlincort","Accconaler","Ccomando","Crutaalert","Parcoma","Accconerr","Crutaerr","Ctipreg","Cdelimi","Ignorini","Ignorfin","Ignorblanc","Cbdatos","Csololin","Clinignor","Detecdet","Cobs" ) values ( <<"'" + this.ConvertirDateSql( lxDisimpoFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpoFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpoFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpoFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDisimpoFmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoClasehook ) + "'" >>, <<lxDisimpoTimestamp >>, <<iif( lxDisimpoBloqreg, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisimpoHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCentidad ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCarchent ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoAccsinaler ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCmodo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCrutaproc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCdes ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCtiparch ) + "'" >>, <<lxDisimpoCanlincort >>, <<"'" + this.FormatearTextoSql( lxDisimpoAccconaler ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCcomando ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCrutaalert ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoParcoma ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoAccconerr ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCrutaerr ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCtipreg ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCdelimi ) + "'" >>, <<lxDisimpoIgnorini >>, <<lxDisimpoIgnorfin >>, <<iif( lxDisimpoIgnorblanc, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDisimpoCbdatos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCsololin ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoClinignor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoDetecdet ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDisimpoCobs ) + "'" >> )
			endtext
			...
			for each loItem in this.oEntidad.Areas
				if this.oEntidad.Areas.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DisImpoArea("NROITEM","BLOQREG","iCod","cArea","cTipDet","cTipo","nOrden","cDetDetall","lParcial" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxArea ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipo_PK ) + "'">>, <<lxOrden>>, <<"'" + this.FormatearTextoSql( lxDetecciondetallevalor ) + "'">>, <<iif( lxCargaparcial, 1, 0 )>> ) 
					endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.DISIMPO set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDisimpoFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxDisimpoFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxDisimpoFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxDisimpoFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxDisimpoFmodifw ) + "'">>,"Clasehook" = <<"'" + this.FormatearTextoSql( lxDisimpoClasehook ) + "'">>,"Timestamp" = <<lxDisimpoTimestamp>>,"Bloqreg" = <<iif( lxDisimpoBloqreg, 1, 0 )>>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpoHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxDisimpoHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxDisimpoHoraimpo ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxDisimpoUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxDisimpoSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpoVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxDisimpoZadsfw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxDisimpoUmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxDisimpoValtafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxDisimpoSmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxDisimpoHaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDisimpoBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDisimpoBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxDisimpoEsttrans ) + "'">>,"Centidad" = <<"'" + this.FormatearTextoSql( lxDisimpoCentidad ) + "'">>,"Carchent" = <<"'" + this.FormatearTextoSql( lxDisimpoCarchent ) + "'">>,"Accsinaler" = <<"'" + this.FormatearTextoSql( lxDisimpoAccsinaler ) + "'">>,"Ccod" = <<"'" + this.FormatearTextoSql( lxDisimpoCcod ) + "'">>,"Cmodo" = <<"'" + this.FormatearTextoSql( lxDisimpoCmodo ) + "'">>,"Crutaproc" = <<"'" + this.FormatearTextoSql( lxDisimpoCrutaproc ) + "'">>,"Cdes" = <<"'" + this.FormatearTextoSql( lxDisimpoCdes ) + "'">>,"Ctiparch" = <<"'" + this.FormatearTextoSql( lxDisimpoCtiparch ) + "'">>,"Canlincort" = <<lxDisimpoCanlincort>>,"Accconaler" = <<"'" + this.FormatearTextoSql( lxDisimpoAccconaler ) + "'">>,"Ccomando" = <<"'" + this.FormatearTextoSql( lxDisimpoCcomando ) + "'">>,"Crutaalert" = <<"'" + this.FormatearTextoSql( lxDisimpoCrutaalert ) + "'">>,"Parcoma" = <<"'" + this.FormatearTextoSql( lxDisimpoParcoma ) + "'">>,"Accconerr" = <<"'" + this.FormatearTextoSql( lxDisimpoAccconerr ) + "'">>,"Crutaerr" = <<"'" + this.FormatearTextoSql( lxDisimpoCrutaerr ) + "'">>,"Ctipreg" = <<"'" + this.FormatearTextoSql( lxDisimpoCtipreg ) + "'">>,"Cdelimi" = <<"'" + this.FormatearTextoSql( lxDisimpoCdelimi ) + "'">>,"Ignorini" = <<lxDisimpoIgnorini>>,"Ignorfin" = <<lxDisimpoIgnorfin>>,"Ignorblanc" = <<iif( lxDisimpoIgnorblanc, 1, 0 )>>,"Cbdatos" = <<"'" + this.FormatearTextoSql( lxDisimpoCbdatos ) + "'">>,"Csololin" = <<"'" + this.FormatearTextoSql( lxDisimpoCsololin ) + "'">>,"Clinignor" = <<"'" + this.FormatearTextoSql( lxDisimpoClinignor ) + "'">>,"Detecdet" = <<"'" + this.FormatearTextoSql( lxDisimpoDetecdet ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxDisimpoCobs ) + "'">> where "Ccod" = <<"'" + this.FormatearTextoSql( lxDisimpoCcod ) + "'">> and  DISIMPO.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Clasehook" as "Clasehook", "Timestamp" as "Timestamp", "Bloqreg" as "Bloquearregistro", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Centidad" as "Entidad", "Carchent" as "Archivoentrada", "Accsinaler" as "Accionconarchivoentradasinalertas", "Ccod" as "Codigo", "Cmodo" as "Modo", "Crutaproc" as "Rutaprocesados", "Cdes" as "Descripcion", "Ctiparch" as "Tipoarchivo", "Canlincort" as "Cantidaddelineasdecorte", "Accconaler" as "Accionconarchivoentradaconalertas", "Ccomando" as "Comando", "Crutaalert" as "Rutaalertas", "Parcoma" as "Parametroscomando", "Accconerr" as "Accionconarchivoerrores", "Crutaerr" as "Rutaerrores", "Ctipreg" as "Tiporegistro", "Cdelimi" as "Delimitadores", "Ignorini" as "Ignorarinicio", "Ignorfin" as "Ignorarfinal", "Ignorblanc" as "Ignorarlineasenblanco", "Cbdatos" as "Basededatos", "Csololin" as "Sololineasqueempiezancon", "Clinignor" as "Ignorarlineasqueempiezancon", "Detecdet" as "Detecciondetalle", "Cobs" as "Obs" from ORGANIZACION.DISIMPO where "Ccod" = <<"'" + this.FormatearTextoSql( lxDisimpoCcod ) + "'">> and  DISIMPO.CCOD != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Icod" as "Codigo", "Carea" as "Area", "Ctipdet" as "Tipodetalle", "Ctipo" as "Tipo", "Norden" as "Orden", "Cdetdetall" as "Detecciondetallevalor", "Lparcial" as "Cargaparcial" from ORGANIZACION.DisImpoArea where iCod = <<"'" + this.FormatearTextoSql( c_DISENOIMPO.CODIGO ) + "'">> Order by Orden
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Faltafw,Fecexpo,Fectrans,Fmodifw,Clasehook,Timestamp,Bloqreg,Hmodifw,Horaexpo,Horaim" + ;
"po,Ualtafw,Saltafw,Vmodifw,Zadsfw,Umodifw,Valtafw,Smodifw,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Centida" + ;
"d,Carchent,Accsinaler,Ccod,Cmodo,Crutaproc,Cdes,Ctiparch,Canlincort,Accconaler,Ccomando,Crutaalert,P" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleAreas( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Bloqreg" as "Bloquearregistro", "Icod" as "Codigo", "Carea" as "Area", "Ctipdet" as "Tipodetalle", "Ctipo" as "Tipo", "Norden" as "Orden", "Cdetdetall" as "Detecciondetallevalor", "Lparcial" as "Cargaparcial"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.Areas
				if this.oEntidad.Areas.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxCargaparcial = loItem.Cargaparcial
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DisImpoArea("NROITEM","BLOQREG","iCod","cArea","cTipDet","cTipo","nOrden","cDetDetall","lParcial" ) values ( <<lxNroitem>>, <<iif( lxBloquearregistro, 1, 0 )>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxArea ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipodetalle ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipo_PK ) + "'">>, <<lxOrden>>, <<"'" + this.FormatearTextoSql( lxDetecciondetallevalor ) + "'">>, <<iif( lxCargaparcial, 1, 0 )>> ) 
					endtext
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.cCod or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.DISIMPO set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, clasehook = ] + "'" + this.FormatearTextoSql( &lcCursor..clasehook ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, BLOQREG = ] + Transform( iif( &lcCursor..BLOQREG, 1, 0 ))+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, cEntidad = ] + "'" + this.FormatearTextoSql( &lcCursor..cEntidad ) + "'"+ [, cArchEnt = ] + "'" + this.FormatearTextoSql( &lcCursor..cArchEnt ) + "'"+ [, AccSinAler = ] + "'" + this.FormatearTextoSql( &lcCursor..AccSinAler ) + "'"+ [, cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"+ [, cModo = ] + "'" + this.FormatearTextoSql( &lcCursor..cModo ) + "'"+ [, cRutaProc = ] + "'" + this.FormatearTextoSql( &lcCursor..cRutaProc ) + "'"+ [, cDes = ] + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'"+ [, cTipArch = ] + "'" + this.FormatearTextoSql( &lcCursor..cTipArch ) + "'"+ [, CanLinCort = ] + transform( &lcCursor..CanLinCort )+ [, AccConAler = ] + "'" + this.FormatearTextoSql( &lcCursor..AccConAler ) + "'"+ [, cComando = ] + "'" + this.FormatearTextoSql( &lcCursor..cComando ) + "'"+ [, cRutaAlert = ] + "'" + this.FormatearTextoSql( &lcCursor..cRutaAlert ) + "'"+ [, ParComa = ] + "'" + this.FormatearTextoSql( &lcCursor..ParComa ) + "'"+ [, AccConErr = ] + "'" + this.FormatearTextoSql( &lcCursor..AccConErr ) + "'"+ [, cRutaErr = ] + "'" + this.FormatearTextoSql( &lcCursor..cRutaErr ) + "'"+ [, cTipReg = ] + "'" + this.FormatearTextoSql( &lcCursor..cTipReg ) + "'"+ [, cDelimi = ] + "'" + this.FormatearTextoSql( &lcCursor..cDelimi ) + "'"+ [, IgnorIni = ] + transform( &lcCursor..IgnorIni )+ [, IgnorFin = ] + transform( &lcCursor..IgnorFin )+ [, IgnorBlanc = ] + Transform( iif( &lcCursor..IgnorBlanc, 1, 0 ))+ [, cBdatos = ] + "'" + this.FormatearTextoSql( &lcCursor..cBdatos ) + "'"+ [, cSoloLin = ] + "'" + this.FormatearTextoSql( &lcCursor..cSoloLin ) + "'"+ [, cLinIgnor = ] + "'" + this.FormatearTextoSql( &lcCursor..cLinIgnor ) + "'"+ [, DetecDet = ] + "'" + this.FormatearTextoSql( &lcCursor..DetecDet ) + "'"+ [, cObs = ] + "'" + this.FormatearTextoSql( &lcCursor..cObs ) + "'" + [ Where cCod = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FALTAFW, FECEXPO, FECTRANS, FMODIFW, clasehook, TIMESTAMP, BLOQREG, HMODIFW, HORAEXPO, HORAIMPO, UALTAFW, SALTAFW, VMODIFW, ZADSFW, UMODIFW, VALTAFW, SMODIFW, HALTAFW, BDMODIFW, BDALTAFW, ESTTRANS, cEntidad, cArchEnt, AccSinAler, cCod, cModo, cRutaProc, cDes, cTipArch, CanLinCort, AccConAler, cComando, cRutaAlert, ParComa, AccConErr, cRutaErr, cTipReg, cDelimi, IgnorIni, IgnorFin, IgnorBlanc, cBdatos, cSoloLin, cLinIgnor, DetecDet, cObs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..clasehook ) + "'" + ',' + transform( &lcCursor..TIMESTAMP )
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..BLOQREG, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cEntidad ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cArchEnt ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..AccSinAler ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cModo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cRutaProc ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cDes ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cTipArch ) + "'" + ',' + transform( &lcCursor..CanLinCort ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..AccConAler ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cComando ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cRutaAlert ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ParComa ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.CLASEHOOK = isnull( d.CLASEHOOK, t.CLASEHOOK ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.BLOQREG = isnull( d.BLOQREG, t.BLOQREG ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CENTIDAD = isnull( d.CENTIDAD, t.CENTIDAD ),t.CARCHENT = isnull( d.CARCHENT, t.CARCHENT ),t.ACCSINALER = isnull( d.ACCSINALER, t.ACCSINALER ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.CMODO = isnull( d.CMODO, t.CMODO ),t.CRUTAPROC = isnull( d.CRUTAPROC, t.CRUTAPROC ),t.CDES = isnull( d.CDES, t.CDES ),t.CTIPARCH = isnull( d.CTIPARCH, t.CTIPARCH ),t.CANLINCORT = isnull( d.CANLINCORT, t.CANLINCORT ),t.ACCCONALER = isnull( d.ACCCONALER, t.ACCCONALER ),t.CCOMANDO = isnull( d.CCOMANDO, t.CCOMANDO ),t.CRUTAALERT = isnull( d.CRUTAALERT, t.CRUTAALERT ),t.PARCOMA = isnull( d.PARCOMA, t.PARCOMA ),t.ACCCONERR = isnull( d.ACCCONERR, t.ACCCONERR ),t.CRUTAERR = isnull( d.CRUTAERR, t.CRUTAERR ),t.CTIPREG = isnull( d.CTIPREG, t.CTIPREG ),t.CDELIMI = isnull( d.CDELIMI, t.CDELIMI ),t.IGNORINI = isnull( d.IGNORINI, t.IGNORINI ),t.IGNORFIN = isnull( d.IGNORFIN, t.IGNORFIN ),t.IGNORBLANC = isnull( d.IGNORBLANC, t.IGNORBLANC ),t.CBDATOS = isnull( d.CBDATOS, t.CBDATOS ),t.CSOLOLIN = isnull( d.CSOLOLIN, t.CSOLOLIN ),t.CLINIGNOR = isnull( d.CLINIGNOR, t.CLINIGNOR ),t.DETECDET = isnull( d.DETECDET, t.DETECDET ),t.COBS = isnull( d.COBS, t.COBS )
					from ORGANIZACION.DISIMPO t inner join deleted d 
							 on t.cCod = d.cCod
							 and  t.clasehook = d.clasehook
				-- Fin Updates
				insert into ORGANIZACION.DISIMPO(Fecimpo,Faltafw,Fecexpo,Fectrans,Fmodifw,Clasehook,Timestamp,Bloqreg,Hmodifw,Horaexpo,Horaimpo,Ualtafw,Saltafw,Vmodifw,Zadsfw,Umodifw,Valtafw,Smodifw,Haltafw,Bdmodifw,Bdaltafw,Esttrans,Centidad,Carchent,Accsinaler,Ccod,Cmodo,Crutaproc,Cdes,Ctiparch,Canlincort,Accconaler,Ccomando,Crutaalert,Parcoma,Accconerr,Crutaerr,Ctipreg,Cdelimi,Ignorini,Ignorfin,Ignorblanc,Cbdatos,Csololin,Clinignor,Detecdet,Cobs)
					Select isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),isnull( d.CLASEHOOK,''),isnull( d.TIMESTAMP,0),isnull( d.BLOQREG,0),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.SMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.CENTIDAD,''),isnull( d.CARCHENT,''),isnull( d.ACCSINALER,''),isnull( d.CCOD,''),isnull( d.CMODO,''),isnull( d.CRUTAPROC,''),isnull( d.CDES,''),isnull( d.CTIPARCH,''),isnull( d.CANLINCORT,0),isnull( d.ACCCONALER,''),isnull( d.CCOMANDO,''),isnull( d.CRUTAALERT,''),isnull( d.PARCOMA,''),isnull( d.ACCCONERR,''),isnull( d.CRUTAERR,''),isnull( d.CTIPREG,''),isnull( d.CDELIMI,''),isnull( d.IGNORINI,0),isnull( d.IGNORFIN,0),isnull( d.IGNORBLANC,0),isnull( d.CBDATOS,''),isnull( d.CSOLOLIN,''),isnull( d.CLINIGNOR,''),isnull( d.DETECDET,''),isnull( d.COBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="DISENOIMPO                              " atributo="FECHATRANSFERENCIA                      " tabla="DISIMPO        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOIMPO                              " atributo="ESTADOTRANSFERENCIA                     " tabla="DISIMPO        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOIMPO                              " atributo="ARCHIVOENTRADA                          " tabla="DISIMPO        " campo="CARCHENT  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Archivo                                                                                                                                                         " dominio="ARCHIVO                       " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOIMPO                              " atributo="RUTAPROCESADOS                          " tabla="DISIMPO        " campo="CRUTAPROC " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Ruta sin alertas                                                                                                                                                " dominio="DIRECTORIO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="7" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOIMPO                              " atributo="TIPOARCHIVO                             " tabla="DISIMPO        " campo="CTIPARCH  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPOARCHIVOIMPORTACION                  " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="408" etiqueta="Tipo                                                                                                                                                            " dominio="COMBOTABLA                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOIMPO                              " atributo="COMANDO                                 " tabla="DISIMPO        " campo="CCOMANDO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="254" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Archivo                                                                                                                                                         " dominio="ARCHIVOPORPARAMETRO           " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DISENOIMPO                              " atributo="TIPOREGISTRO                            " tabla="DISIMPO        " campo="CTIPREG   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TIPOREGISTROEXPORTACION                 " tipodato="C         " longitud="3" decimales="0" valorsugerido="=&quot;LFI&quot;                                                                                                                                                                                                                                                        " obligatorio="true" admitebusqueda="424" etiqueta="Tipo                                                                                                                                                            " dominio="COMBOTABLA                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TIPOARCHIVOIMPORTACION                  " atributo="DESCRIPCION                             " tabla="TIPARCIMP      " campo="CDES      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="409" etiqueta="Detalle Tip.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join TIPARCIMP On DISIMPO.CTIPARCH = TIPARCIMP.cCod And  TIPARCIMP.CCOD != ''                                                                                                                                                                           " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
