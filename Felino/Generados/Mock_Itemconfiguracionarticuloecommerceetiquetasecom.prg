...
define class Mock_Itemconfiguracionarticuloecommerceetiquetasecom as MockBase of MockBase.prg

	cClase = 'Itemconfiguracionarticuloecommerceetiquetasecom'
	...
	*-----------------------------------------------------------------------------------------
	function codetiqueta_access() as variant                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Codetiqueta_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codetiqueta_pk_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Codetiqueta_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descetiqueta_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Descetiqueta_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codetiqueta( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_codetiqueta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descetiqueta( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_descetiqueta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codetiqueta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Validar_codetiqueta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descetiqueta( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_descetiqueta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodetiqueta() as void                                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridocodetiqueta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridodescetiqueta() as void                                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridodescetiqueta', lcParametros )
	EndFunc
