...
define class Mock_Datostareaprogramadaecommercead_sqlserver as MockBase of MockBase.prg

	cClase = 'Datostareaprogramadaecommercead_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleplataforma( tcatributo as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenercampodetalleplataforma', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleplataforma( tccampos as string ) as string                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleplataforma', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleplataforma( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                     
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleplataforma', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_plataf( tctablatrabajo ) as string                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_plataf', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleplataforma( tccampos as string ) as string                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleplataforma', lcParametros )
	EndFunc
