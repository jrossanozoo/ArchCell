...
define class Mock_Detallealiviodecajadetallealivio as MockBase of MockBase.prg

	cClase = 'Detallealiviodecajadetallealivio'
	...
	cMensajeErrorUnicidad = 'Las columnas Número de caja + Valor no admiten valores repetidos.'                                                                                                                                                               
	cNombre = 'Detallealivio'                                                                                                                                                                                                                                 
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Cajas,valores y montos'                                                                                                                                                                                                                  
	datasession = 1                                                                                                                                                                                                                                           
