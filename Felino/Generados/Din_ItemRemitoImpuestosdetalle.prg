...
define class Din_ItemREMITOImpuestosdetalle as ItemIMPUESTOS of ItemIMPUESTOS.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'REMITO', 'Impuestosdetalle')
