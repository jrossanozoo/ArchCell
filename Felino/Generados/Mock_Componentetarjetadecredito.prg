...
define class Mock_COMPONENTETARJETADECREDITO as MockBase of MockBase.prg

	cClase = 'COMPONENTETARJETADECREDITO'

	
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cNombre = "TARJETADECREDITO"                                                                                                                                                                                                                              
	cNombre = "VALORES"                                                                                                                                                                                                                                       
	cPkDispositivoPos = ""   && Levantar de parametro.                                                                                                                                                                                                        
	lAnular = .f.                                                                                                                                                                                                                                             
	lDebeMostrarFormularioParaAgregarDatosDeTarjeta = .f. && Levantar de parametro.                                                                                                                                                                           
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	lEdicion = .F.                                                                                                                                                                                                                                            
	lEliminar = .F.                                                                                                                                                                                                                                           
	...
	oCUPON = NULL                                                                                                                                                                                                                                             
	oColSentencias = Null                                                                                                                                                                                                                                     
	oColSentenciasAdicionales = null                                                                                                                                                                                                                          
	oCombinacion = null                                                                                                                                                                                                                                       
	oConjuntoDeCupones = null                                                                                                                                                                                                                                 
	...
	*-----------------------------------------------------------------------------------------
	    protected function actualizarnumerointernoencuponesintegrados( tccupon as object, tcitemvalor as object) void                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccupon
		lxParam2 = tcitemvalor
		...
		return this.ObtenerResultado( 'Actualizarnumerointernoencuponesintegrados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregarnuevocuponhuerfanoalconjuntodecupones( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as void                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function asignarclienteentidadaclientecupon( tocupon as object ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Asignarclienteentidadaclientecupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercuponexistente( toitem as object ) as object                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercuponexistente', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercuponparaanulacion( toitem as object ) as zoocoleccion of zoocoleccion.prg                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function obtenersentencias( tocolsentencias as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function ocolsentenciasadicionales_access() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ocolsentenciasadicionales_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function preguntarsiaplicarecargotarjeta( toitem as itemvaloresventa.prg of itemvaloresventa.prg, tnrecargo as integer, tnboton as integer, tlmensajesinporcentaje as boolean ) as void                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		lxParam2 = tnrecargo
		lxParam3 = tnboton
		lxParam4 = tlmensajesinporcentaje
		...
		return this.ObtenerResultado( 'Preguntarsiaplicarecargotarjeta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function preguntarsiaplicarecargotarjeta_obtenermensaje( tnrecargo as integer, tlmensajesinporcentaje as boolean ) as void                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tnrecargo
		lxParam2 = tlmensajesinporcentaje
		...
		return this.ObtenerResultado( 'Preguntarsiaplicarecargotarjeta_obtenermensaje', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearyverificardatos( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function validarantesdesetarvalor( toitem as object ) as boolean                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarantesdesetarvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarigualdaddenrodecuotas( todetalle ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Validarigualdaddenrodecuotas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function verificarsicargadatos( tovalor as object ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Verificarsicargadatos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function actualizarcuponasociado( tocupon as ent_cupon of ent_cupon.prg ) as void                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Actualizarcuponasociado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarcuponalconjuntodecupones( tocupon as din_entidadcupon of din_entidadcupon.prg, tccodigo as string ) as void                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Agregarcuponalconjuntodecupones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function agregarcuponexistentealconjuntodecupones( tocupon as din_entidadcupon of din_entidadcupon.prg, tccodigo as string ) as void                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Agregarcuponexistentealconjuntodecupones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function agregarnuevocuponalconjuntodecupones( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as void                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Agregarnuevocuponalconjuntodecupones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cancelaryliberarconjuntodecupones() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cancelaryliberarconjuntodecupones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargarcuponesgeneradosantesdemodificar() as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarcuponesgeneradosantesdemodificar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function completarcuotasenitem( toitem as itemvaloresventa.prg of itemvaloresventa.prg, tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Completarcuotasenitem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function completardatosentidadcupon( toitem as itemvaloresventa.prg of itemvaloresventa.prg, tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Completardatosentidadcupon', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function completarnumerodecomercio( toitem as itemvaloresventa.prg of itemvaloresventa.prg, tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Completarnumerodecomercio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function completarnumerointernodelitemvalor( toitem as itemvaloresventa.prg of itemvaloresventa.prg, tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Completarnumerointernodelitemvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function cuponautorizadoporpos( tocupon as din_entidadcupon of din_entidadcupon.prg ) as boolean                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Cuponautorizadoporpos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function debemostrarformularioparaagregardatosdetarjeta( tovalor as object ) as void                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Debemostrarformularioparaagregardatosdetarjeta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function elitemvalorestipotarjeta( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as boolean                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Elitemvalorestipotarjeta', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function estaenmodorecepcion() as boolean                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estaenmodorecepcion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function evaluarytipificarcupon( tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Evaluarytipificarcupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercupon( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as din_entidadcupon of din_entidadcupon.prg                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerinformacionenstring( tomensajes as zoocoleccion of zoocoleccion.prg ) as string                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenerinformacionenstring', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenermontorecargo() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenernuevocupon( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as void                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenernuevocupon', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenernumerodecomercio( toitem as itemvaloresventa.prg of itemvaloresventa.prg, tocupon as din_entidadcupon of din_entidadcupon.prg ) as string                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenernumerodecomercio', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciadejarcuponhuerfano( tocolsentencias as zoocoleccion of zoocoleccion.prg , tocupon as entidad of entidad.prg ) as void                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenersentenciadejarcuponhuerfano', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciascuponeliminado( tocolsentencias as zoocoleccion of zoocoleccion.prg , tocupon as entidad of entidad.prg ) as void                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenersentenciascuponeliminado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenersentenciascuponnuevoopreexistente( tocolsentencias as zoocoleccion of zoocoleccion.prg,  tocupon as entidad of entidad.prg, toitemvalor as object ) as void                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenersentenciascuponnuevoopreexistente', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function refrescarletraynumerodeentidadpadre( tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Refrescarletraynumerodeentidadpadre', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function reinicializarpropiedades() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Reinicializarpropiedades', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function resolvernumeraciones( tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Resolvernumeraciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function sacarcaracteresnosoportadosdelcampoobservacion( tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Sacarcaracteresnosoportadosdelcampoobservacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function salvarinconsistenciadetipodevalorcerosinguid( toitem as itemvaloresventa.prg of itemvaloresventa.prg ) as void                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Salvarinconsistenciadetipodevalorcerosinguid', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function tipificarcupon( tocupon as din_entidadcupon of din_entidadcupon.prg ) as void                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Tipificarcupon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function validarintegridadentreitemvalorycupon( toitem as itemvaloresventa.prg of itemvaloresventa.prg, tocupon as din_entidadcupon of din_entidadcupon.prg ) as boolean                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validarintegridadentreitemvalorycupon', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificarsiestaanulado( toitemvalor as object, tcatributo as string, txvalold as string, txval as string ) as void                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Verificarsiestaanulado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificarsiestaintegrado( toitemvalor as object, tcatributo as string, txvalold as string, txval as string ) as void                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Verificarsiestaintegrado', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificarsiposeecanjedecupon( toitemvalor as object , tcatributo as string, txvalold as variant, txval as variant ) as void                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Verificarsiposeecanjedecupon', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function verificarsiposeecierredelote( toitemvalor as object, tcatributo as string, txvalold as string, txval as string ) as void                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Verificarsiposeecierredelote', lcParametros )
	EndFunc
