...
define class Din_EntidadNOTADEDEBITOAGRUPADA as Ent_ComprobanteAgrupado of Ent_ComprobanteAgrupado.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><VENTAS><CONVALORES><FISCAL><NOLISTAGENERICO><VALIDACENTRALIZADOR><VALORCIERRE><DESCUENTOAUTOMATICO><ACTUALIZAEMAILCLIENTE><MIPYME:56><AGRUPACOMPROBANTES:4;6;29><MIPYMEORIGINAL:29><CF>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
