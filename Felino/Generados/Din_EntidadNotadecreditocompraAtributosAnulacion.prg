...
define class Din_EntidadNOTADECREDITOCOMPRAAtributosAnulacion as custom
	*----------------------------------------------
	function ObtenerAtributosAnulacion() as zoocoleccion OF zoocoleccion.prg
		...
		loItem.cValorDefault = ""
		loItem.xValor = ""
		loItem.cCampo = "FFCHVENC"
		loItem.nLongitud = 8
		loItem.nDecimales = 0
		loRetorno.Add( loItem, upper( loItem.cAtributo ) )
		
		loItem = newobject( "ItemAtributoAnulacion", "ItemAtributoAnulacion.prg" )
		loItem.cAtributo = "FECHAVTOCAI"
		loItem.cValorDefault = ""
		loItem.xValor = ""
		loItem.cCampo = "FVTOCAI"
		loItem.nLongitud = 8
		loItem.nDecimales = 0
		loRetorno.Add( loItem, upper( loItem.cAtributo ) )
