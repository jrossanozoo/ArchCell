...
define class Din_EntidadLISTADEPRECIOSCALCULADAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxLcalculadaFecexpo, lxLcalculadaFectrans, lxLcalculadaFecimpo, lxLcalculadaFaltafw, lxLcalculadaFmodifw, lxLcalculadaTimestamp, lxLcalculadaUaltafw, lxLcalculadaSaltafw, lxLcalculadaSmodifw, lxLcalculadaValtafw, lxLcalculadaUmodifw, lxLcalculadaZadsfw, lxLcalculadaVmodifw, lxLcalculadaHmodifw, lxLcalculadaHoraexpo, lxLcalculadaHoraimpo, lxLcalculadaBdmodifw, lxLcalculadaEsttrans, lxLcalculadaBdaltafw, lxLcalculadaHaltafw, lxLcalculadaNumero, lxLcalculadaLpc_lista, lxLcalculadaLpc_form, lxLcalculadaLpc_prov, lxLcalculadaLpc_obs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.LCALCULADA ( "Fecexpo","Fectrans","Fecimpo","Faltafw","Fmodifw","Timestamp","Ualtafw","Saltafw","Smodifw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaexpo","Horaimpo","Bdmodifw","Esttrans","Bdaltafw","Haltafw","Numero","Lpc_lista","Lpc_form","Lpc_prov","Lpc_obs" ) values ( <<"'" + this.ConvertirDateSql( lxLcalculadaFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLcalculadaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLcalculadaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLcalculadaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLcalculadaFmodifw ) + "'" >>, <<lxLcalculadaTimestamp >>, <<"'" + this.FormatearTextoSql( lxLcalculadaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaHaltafw ) + "'" >>, <<lxLcalculadaNumero >>, <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_lista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_form ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_prov ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_obs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.LCALCULADA set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxLcalculadaFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxLcalculadaFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxLcalculadaFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxLcalculadaFaltafw ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxLcalculadaFmodifw ) + "'">>,"Timestamp" = <<lxLcalculadaTimestamp>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxLcalculadaUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxLcalculadaSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxLcalculadaSmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxLcalculadaValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxLcalculadaUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxLcalculadaZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxLcalculadaVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxLcalculadaHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxLcalculadaHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxLcalculadaHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLcalculadaBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxLcalculadaEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLcalculadaBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxLcalculadaHaltafw ) + "'">>,"Numero" = <<lxLcalculadaNumero>>,"Lpc_lista" = <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_lista ) + "'">>,"Lpc_form" = <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_form ) + "'">>,"Lpc_prov" = <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_prov ) + "'">>,"Lpc_obs" = <<"'" + this.FormatearTextoSql( lxLcalculadaLpc_obs ) + "'">> where "Numero" = <<lxLcalculadaNumero>> and  LCALCULADA.NUMERO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Numero" as "Numero", "Lpc_lista" as "Listadeprecios", "Lpc_form" as "Formula", "Lpc_prov" as "Proveedor", "Lpc_obs" as "Obs" from ZooLogic.LCALCULADA where "Numero" = <<lxLcalculadaNumero>> and  LCALCULADA.NUMERO != 0
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Numero" as "Numero", "Lpc_lista" as "Listadeprecios", "Lpc_form" as "Formula", "Lpc_prov" as "Proveedor", "Lpc_obs" as "Obs" from ZooLogic.LCALCULADA where  str( NUMERO, 8, 0) + funciones.padr( LPC_LISTA, 6, ' ' ) + funciones.padr( LPC_PROV, 5, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LCALCULADA.NUMERO != 0 order by NUMERO,LPC_LISTA,LPC_PROV
			endtext
			use in select('c_LISTADEPRECIOSCALCULADA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LISTADEPRECIOSCALCULADA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fmodifw" as "Fechamodificacionfw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Numero" as "Numero", "Lpc_lista" as "Listadeprecios", "Lpc_form" as "Formula", "Lpc_prov" as "Proveedor", "Lpc_obs" as "Obs" from ZooLogic.LCALCULADA where  str( NUMERO, 8, 0) + funciones.padr( LPC_LISTA, 6, ' ' ) + funciones.padr( LPC_PROV, 5, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LCALCULADA.NUMERO != 0 order by NUMERO desc,LPC_LISTA desc,LPC_PROV desc
			endtext
			use in select('c_LISTADEPRECIOSCALCULADA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LISTADEPRECIOSCALCULADA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Timestamp,Ualtafw,Saltafw,Smodifw,Valtafw,Umodifw,Z" + ;
"adsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Esttrans,Bdaltafw,Haltafw,Numero,Lpc_lista,Lpc_form" + ;
",Lpc_prov,Lpc_obs" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				if lxValorClavePK == curSeek.NUMERO or this.oEntidad.lIgnorarClaveprimariaEnRecepcionBD 
					...
					if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
						...
						this.oConexion.EjecutarSql( [UPDATE ZooLogic.LCALCULADA set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, NUMERO = ] + transform( &lcCursor..NUMERO )+ [, LPC_LISTA = ] + "'" + this.FormatearTextoSql( &lcCursor..LPC_LISTA ) + "'"+ [, LPC_FORM = ] + "'" + this.FormatearTextoSql( &lcCursor..LPC_FORM ) + "'"+ [, LPC_PROV = ] + "'" + this.FormatearTextoSql( &lcCursor..LPC_PROV ) + "'"+ [, LPC_OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..LPC_OBS ) + "'" + [ Where NUMERO = ] + transform( lcValorABuscar ) )
				...
				Else
					...
					Text to lcCampos noShow
						 FECEXPO, FECTRANS, FECIMPO, FALTAFW, FMODIFW, TIMESTAMP, UALTAFW, SALTAFW, SMODIFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAEXPO, HORAIMPO, BDMODIFW, ESTTRANS, BDALTAFW, HALTAFW, NUMERO, LPC_LISTA, LPC_FORM, LPC_PROV, LPC_OBS
					EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + transform( &lcCursor..NUMERO )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.LPC_LISTA = isnull( d.LPC_LISTA, t.LPC_LISTA ),t.LPC_FORM = isnull( d.LPC_FORM, t.LPC_FORM ),t.LPC_PROV = isnull( d.LPC_PROV, t.LPC_PROV ),t.LPC_OBS = isnull( d.LPC_OBS, t.LPC_OBS )
					from ZooLogic.LCALCULADA t inner join deleted d 
							 on t.NUMERO = d.NUMERO
							 and  t.LPC_LISTA = d.LPC_LISTA
							 and  t.LPC_PROV = d.LPC_PROV
				-- Fin Updates
				insert into ZooLogic.LCALCULADA(Fecexpo,Fectrans,Fecimpo,Faltafw,Fmodifw,Timestamp,Ualtafw,Saltafw,Smodifw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Esttrans,Bdaltafw,Haltafw,Numero,Lpc_lista,Lpc_form,Lpc_prov,Lpc_obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FMODIFW,''),isnull( d.TIMESTAMP,0),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.NUMERO,0),isnull( d.LPC_LISTA,''),isnull( d.LPC_FORM,''),isnull( d.LPC_PROV,''),isnull( d.LPC_OBS,'')
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					...
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: LISTA DE PRECIOS ' + cast( d.LPC_LISTA as Varchar(6) ) + ', PROVEEDOR ' + cast( d.LPC_PROV as Varchar(5) ) + '','La clave principal no es la esperada'
					from ZooLogic.LCALCULADA t inner join deleted d 
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					<<loLogueo.EstadoSistema>>,'<<loLogueo.Aplicacion>>','<<loLogueo.Version>>',
					'<<loLogueo.Serie>>','<<loLogueo.Usuario>>','<<loLogueo.NombrePc>>',
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: LISTA DE PRECIOS ' + cast( d.LPC_LISTA as Varchar(6) ) + ', PROVEEDOR ' + cast( d.LPC_PROV as Varchar(5) ) + '','La clave principal a importar ya existe'
					from ZooLogic.LCALCULADA t inner join deleted d 
							 on t.NUMERO = d.NUMERO
						left join deleted h 
...
<VFPData xml:space="preserve">
	...
	<row entidad="LISTADEPRECIOSCALCULADA                 " atributo="FECHATRANSFERENCIA                      " tabla="LCALCULADA     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LISTADEPRECIOSCALCULADA                 " atributo="ESTADOTRANSFERENCIA                     " tabla="LCALCULADA     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LISTADEPRECIOSCALCULADA                 " atributo="PROVEEDOR                               " tabla="LCALCULADA     " campo="LPC_PROV  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVEEDOR                               " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Proveedor                                                                                                                                                       " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="2" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
