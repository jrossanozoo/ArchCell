...
define class Din_EntidadREGISTRODECUENTAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRegctaFectrans, lxRegctaFecimpo, lxRegctaFmodifw, lxRegctaFaltafw, lxRegctaFecexpo, lxRegctaHaltafw, lxRegctaHoraexpo, lxRegctaSaltafw, lxRegctaVmodifw, lxRegctaZadsfw, lxRegctaValtafw, lxRegctaUaltafw, lxRegctaUmodifw, lxRegctaHmodifw, lxRegctaSmodifw, lxRegctaHoraimpo, lxRegctaEsttrans, lxRegctaBdmodifw, lxRegctaEntidad, lxRegctaCodigo, lxRegctaFechacarga, lxRegctaFecha, lxRegctaHora, lxRegctaTipoval, lxRegctaCtabanc, lxRegctaIdent, lxRegctaCodbco, lxRegctaImporte, lxRegctaComp, lxRegctaIdcomp, lxRegctaIdvalor, lxRegctaBdaltafw, lxRegctaObs, lxRegctaPendiente
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.REGCTA ( "Fectrans","Fecimpo","Fmodifw","Faltafw","Fecexpo","Haltafw","Horaexpo","Saltafw","Vmodifw","Zadsfw","Valtafw","Ualtafw","Umodifw","Hmodifw","Smodifw","Horaimpo","Esttrans","Bdmodifw","Entidad","Codigo","Fechacarga","Fecha","Hora","Tipoval","Ctabanc","Ident","Codbco","Importe","Comp","Idcomp","Idvalor","Bdaltafw","Obs","Pendiente" ) values ( <<"'" + this.ConvertirDateSql( lxRegctaFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegctaFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegctaFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegctaFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegctaFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaEntidad ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaCodigo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegctaFechacarga ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegctaFecha ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaHora ) + "'" >>, <<lxRegctaTipoval >>, <<"'" + this.FormatearTextoSql( lxRegctaCtabanc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaIdent ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaCodbco ) + "'" >>, <<lxRegctaImporte >>, <<"'" + this.FormatearTextoSql( lxRegctaComp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaIdcomp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaIdvalor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegctaObs ) + "'" >>, <<iif( lxRegctaPendiente, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.REGCTA set "Fectrans" = <<"'" + this.ConvertirDateSql( lxRegctaFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxRegctaFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxRegctaFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRegctaFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxRegctaFecexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRegctaHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRegctaHoraexpo ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRegctaSaltafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRegctaVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRegctaZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRegctaValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRegctaUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRegctaUmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRegctaHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRegctaSmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRegctaHoraimpo ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRegctaEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRegctaBdmodifw ) + "'">>,"Entidad" = <<"'" + this.FormatearTextoSql( lxRegctaEntidad ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxRegctaCodigo ) + "'">>,"Fechacarga" = <<"'" + this.ConvertirDateSql( lxRegctaFechacarga ) + "'">>,"Fecha" = <<"'" + this.ConvertirDateSql( lxRegctaFecha ) + "'">>,"Hora" = <<"'" + this.FormatearTextoSql( lxRegctaHora ) + "'">>,"Tipoval" = <<lxRegctaTipoval>>,"Ctabanc" = <<"'" + this.FormatearTextoSql( lxRegctaCtabanc ) + "'">>,"Ident" = <<"'" + this.FormatearTextoSql( lxRegctaIdent ) + "'">>,"Codbco" = <<"'" + this.FormatearTextoSql( lxRegctaCodbco ) + "'">>,"Importe" = <<lxRegctaImporte>>,"Comp" = <<"'" + this.FormatearTextoSql( lxRegctaComp ) + "'">>,"Idcomp" = <<"'" + this.FormatearTextoSql( lxRegctaIdcomp ) + "'">>,"Idvalor" = <<"'" + this.FormatearTextoSql( lxRegctaIdvalor ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRegctaBdaltafw ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxRegctaObs ) + "'">>,"Pendiente" = <<iif( lxRegctaPendiente, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxRegctaCodigo ) + "'">> and  REGCTA.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Entidad" as "Entidadcomprobante", "Codigo" as "Codigo", "Fechacarga" as "Fechacargaoperacion", "Fecha" as "Fecha", "Hora" as "Hora", "Tipoval" as "Tipovalor", "Ctabanc" as "Cuentabancaria", "Ident" as "Identificador", "Codbco" as "Codigobanco", "Importe" as "Importe", "Comp" as "Comprobante", "Idcomp" as "Idcomprobante", "Idvalor" as "Idvalor", "Bdaltafw" as "Basededatosaltafw", "Obs" as "Observacion", "Pendiente" as "Pendiente" from ZooLogic.REGCTA where "Codigo" = <<"'" + this.FormatearTextoSql( lxRegctaCodigo ) + "'">> and  REGCTA.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Entidad" as "Entidadcomprobante", "Codigo" as "Codigo", "Fechacarga" as "Fechacargaoperacion", "Fecha" as "Fecha", "Hora" as "Hora", "Tipoval" as "Tipovalor", "Ctabanc" as "Cuentabancaria", "Ident" as "Identificador", "Codbco" as "Codigobanco", "Importe" as "Importe", "Comp" as "Comprobante", "Idcomp" as "Idcomprobante", "Idvalor" as "Idvalor", "Bdaltafw" as "Basededatosaltafw", "Obs" as "Observacion", "Pendiente" as "Pendiente" from ZooLogic.REGCTA where  REGCTA.CODIGO != '' order by Fecha,FechaCarga,Hora,Codigo
			endtext
			use in select('c_REGISTRODECUENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REGISTRODECUENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Entidad" as "Entidadcomprobante", "Codigo" as "Codigo", "Fechacarga" as "Fechacargaoperacion", "Fecha" as "Fecha", "Hora" as "Hora", "Tipoval" as "Tipovalor", "Ctabanc" as "Cuentabancaria", "Ident" as "Identificador", "Codbco" as "Codigobanco", "Importe" as "Importe", "Comp" as "Comprobante", "Idcomp" as "Idcomprobante", "Idvalor" as "Idvalor", "Bdaltafw" as "Basededatosaltafw", "Obs" as "Observacion", "Pendiente" as "Pendiente" from ZooLogic.REGCTA where  funciones.dtos( Fecha ) + funciones.dtos( FechaCarga ) + funciones.padr( Hora, 5, ' ' ) + funciones.padr( Codigo, 20, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  REGCTA.CODIGO != '' order by Fecha,FechaCarga,Hora,Codigo
			endtext
			use in select('c_REGISTRODECUENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REGISTRODECUENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Entidad" as "Entidadcomprobante", "Codigo" as "Codigo", "Fechacarga" as "Fechacargaoperacion", "Fecha" as "Fecha", "Hora" as "Hora", "Tipoval" as "Tipovalor", "Ctabanc" as "Cuentabancaria", "Ident" as "Identificador", "Codbco" as "Codigobanco", "Importe" as "Importe", "Comp" as "Comprobante", "Idcomp" as "Idcomprobante", "Idvalor" as "Idvalor", "Bdaltafw" as "Basededatosaltafw", "Obs" as "Observacion", "Pendiente" as "Pendiente" from ZooLogic.REGCTA where  funciones.dtos( Fecha ) + funciones.dtos( FechaCarga ) + funciones.padr( Hora, 5, ' ' ) + funciones.padr( Codigo, 20, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  REGCTA.CODIGO != '' order by Fecha desc,FechaCarga desc,Hora desc,Codigo desc
			endtext
			use in select('c_REGISTRODECUENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REGISTRODECUENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Entidad" as "Entidadcomprobante", "Codigo" as "Codigo", "Fechacarga" as "Fechacargaoperacion", "Fecha" as "Fecha", "Hora" as "Hora", "Tipoval" as "Tipovalor", "Ctabanc" as "Cuentabancaria", "Ident" as "Identificador", "Codbco" as "Codigobanco", "Importe" as "Importe", "Comp" as "Comprobante", "Idcomp" as "Idcomprobante", "Idvalor" as "Idvalor", "Bdaltafw" as "Basededatosaltafw", "Obs" as "Observacion", "Pendiente" as "Pendiente" from ZooLogic.REGCTA where  REGCTA.CODIGO != '' order by Fecha desc,FechaCarga desc,Hora desc,Codigo desc
			endtext
			use in select('c_REGISTRODECUENTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_REGISTRODECUENTA', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fectrans,Fecimpo,Fmodifw,Faltafw,Fecexpo,Haltafw,Horaexpo,Saltafw,Vmodifw,Zadsfw,Valtafw,Ual" + ;
"tafw,Umodifw,Hmodifw,Smodifw,Horaimpo,Esttrans,Bdmodifw,Entidad,Codigo,Fechacarga,Fecha,Hora,Tipoval" + ;
",Ctabanc,Ident,Codbco,Importe,Comp,Idcomp,Idvalor,Bdaltafw,Obs,Pendiente" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fectrans" as "Fechatransferencia", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Saltafw" as "Seriealtafw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Hmodifw" as "Horamodificacionfw", "Smodifw" as "Seriemodificacionfw", "Horaimpo" as "Horaimpo", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Entidad" as "Entidadcomprobante", "Codigo" as "Codigo", "Fechacarga" as "Fechacargaoperacion", "Fecha" as "Fecha", "Hora" as "Hora", "Tipoval" as "Tipovalor", "Ctabanc" as "Cuentabancaria", "Ident" as "Identificador", "Codbco" as "Codigobanco", "Importe" as "Importe", "Comp" as "Comprobante", "Idcomp" as "Idcomprobante", "Idvalor" as "Idvalor", "Bdaltafw" as "Basededatosaltafw", "Obs" as "Observacion", "Pendiente" as "Pendiente"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.REGCTA set "Fectrans" = <<"'" + this.ConvertirDateSql( lxRegctaFectrans ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxRegctaFecimpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxRegctaFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxRegctaFaltafw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxRegctaFecexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxRegctaHaltafw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxRegctaHoraexpo ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxRegctaSaltafw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxRegctaVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxRegctaZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxRegctaValtafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxRegctaUaltafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxRegctaUmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxRegctaHmodifw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxRegctaSmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxRegctaHoraimpo ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxRegctaEsttrans ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRegctaBdmodifw ) + "'">>, "Entidad" = <<"'" + this.FormatearTextoSql( lxRegctaEntidad ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxRegctaCodigo ) + "'">>, "Fechacarga" = <<"'" + this.ConvertirDateSql( lxRegctaFechacarga ) + "'">>, "Fecha" = <<"'" + this.ConvertirDateSql( lxRegctaFecha ) + "'">>, "Hora" = <<"'" + this.FormatearTextoSql( lxRegctaHora ) + "'">>, "Tipoval" = <<lxRegctaTipoval>>, "Ctabanc" = <<"'" + this.FormatearTextoSql( lxRegctaCtabanc ) + "'">>, "Ident" = <<"'" + this.FormatearTextoSql( lxRegctaIdent ) + "'">>, "Codbco" = <<"'" + this.FormatearTextoSql( lxRegctaCodbco ) + "'">>, "Importe" = <<lxRegctaImporte>>, "Comp" = <<"'" + this.FormatearTextoSql( lxRegctaComp ) + "'">>, "Idcomp" = <<"'" + this.FormatearTextoSql( lxRegctaIdcomp ) + "'">>, "Idvalor" = <<"'" + this.FormatearTextoSql( lxRegctaIdvalor ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRegctaBdaltafw ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxRegctaObs ) + "'">>, "Pendiente" = <<iif( lxRegctaPendiente, 1, 0 )>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'REGCTA' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECTRANS, FECIMPO, FMODIFW, FALTAFW, FECEXPO, HALTAFW, HORAEXPO, SALTAFW, VMODIFW, ZADSFW, VALTAFW, UALTAFW, UMODIFW, HMODIFW, SMODIFW, HORAIMPO, ESTTRANS, BDMODIFW, Entidad, Codigo, FechaCarga, Fecha, Hora, TipoVal, CtaBanc, Ident, CodBco, Importe, Comp, IdComp, idValor, BDAltaFW, Obs, Pendiente
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Entidad ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FechaCarga ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..Fecha ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Hora ) + "'" + ',' + transform( &lcCursor..TipoVal ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CtaBanc ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Ident ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodBco ) + "'" + ',' + transform( &lcCursor..Importe ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Comp ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..IdComp ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idValor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDAltaFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'" + ',' + Transform( iif( &lcCursor..Pendiente, 1, 0 ))
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ENTIDAD = isnull( d.ENTIDAD, t.ENTIDAD ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FECHACARGA = isnull( d.FECHACARGA, t.FECHACARGA ),t.FECHA = isnull( d.FECHA, t.FECHA ),t.HORA = isnull( d.HORA, t.HORA ),t.TIPOVAL = isnull( d.TIPOVAL, t.TIPOVAL ),t.CTABANC = isnull( d.CTABANC, t.CTABANC ),t.IDENT = isnull( d.IDENT, t.IDENT ),t.CODBCO = isnull( d.CODBCO, t.CODBCO ),t.IMPORTE = isnull( d.IMPORTE, t.IMPORTE ),t.COMP = isnull( d.COMP, t.COMP ),t.IDCOMP = isnull( d.IDCOMP, t.IDCOMP ),t.IDVALOR = isnull( d.IDVALOR, t.IDVALOR ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.OBS = isnull( d.OBS, t.OBS ),t.PENDIENTE = isnull( d.PENDIENTE, t.PENDIENTE )
					from ZooLogic.REGCTA t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.REGCTA(Fectrans,Fecimpo,Fmodifw,Faltafw,Fecexpo,Haltafw,Horaexpo,Saltafw,Vmodifw,Zadsfw,Valtafw,Ualtafw,Umodifw,Hmodifw,Smodifw,Horaimpo,Esttrans,Bdmodifw,Entidad,Codigo,Fechacarga,Fecha,Hora,Tipoval,Ctabanc,Ident,Codbco,Importe,Comp,Idcomp,Idvalor,Bdaltafw,Obs,Pendiente)
					Select isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.SALTAFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.ENTIDAD,''),isnull( d.CODIGO,''),isnull( d.FECHACARGA,''),isnull( d.FECHA,''),isnull( d.HORA,''),isnull( d.TIPOVAL,0),isnull( d.CTABANC,''),isnull( d.IDENT,''),isnull( d.CODBCO,''),isnull( d.IMPORTE,0),isnull( d.COMP,''),isnull( d.IDCOMP,''),isnull( d.IDVALOR,''),isnull( d.BDALTAFW,''),isnull( d.OBS,''),isnull( d.PENDIENTE,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="REGISTRODECUENTA                        " atributo="FECHATRANSFERENCIA                      " tabla="REGCTA         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODECUENTA                        " atributo="ESTADOTRANSFERENCIA                     " tabla="REGCTA         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODECUENTA                        " atributo="FECHACARGAOPERACION                     " tabla="REGCTA         " campo="FECHACARGA" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="false" admitebusqueda="10" etiqueta="Fecha de carga de operación                                                                                                                                     " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="FECHA                                   " tabla="REGCTA         " campo="FECHA     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="4" etiqueta="Fecha de conciliación                                                                                                                                           " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="HORA                                    " tabla="REGCTA         " campo="HORA      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="=left( goservicios.libreRIAS.obtenerhora() , 5)                                                                                                                                                                                                               " obligatorio="true" admitebusqueda="6" etiqueta="Hora                                                                                                                                                            " dominio="HORA                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="NUMEROCUENTA                            " tabla="CTABAN         " campo="CBNUM     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="15" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="14" etiqueta="Número de cuenta bancaria                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="CuentaBancaria.Numero                                                                                                                                                                                                                                         " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" left join CtaBan on RegCta.CtaBanc = CtaBan.CBCod                                                                                                                                                                                                            " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="TIPOVALOR                               " tabla="REGCTA         " campo="TIPOVAL   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Tipo de valor                                                                                                                                                   " dominio="COMBOTIPODEVALORES            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="CUENTABANCARIA                          " tabla="REGCTA         " campo="CTABANC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CUENTABANCARIA                          " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="8" etiqueta="Cuenta bancaria                                                                                                                                                 " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="IDENTIFICADOR                           " tabla="REGCTA         " campo="IDENT     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Identificador para conciliar                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="CODIGOBANCO                             " tabla="REGCTA         " campo="CODBCO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Código asignado por el banco                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="IMPORTE                                 " tabla="REGCTA         " campo="IMPORTE   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="14" etiqueta="Importe                                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="MONEDA                                  " tabla="CTABAN         " campo="CBMONEDA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="14" etiqueta="Moneda                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="CuentaBancaria.MonedaCuenta                                                                                                                                                                                                                                   " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" left join CtaBan on REGCTA.CTABANC = CtaBan.CBCod                                                                                                                                                                                                            " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="COMPROBANTE                             " tabla="REGCTA         " campo="COMP      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="250" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="18" etiqueta="Comprobante relacionado                                                                                                                                         " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODECUENTA                        " atributo="IDCOMPROBANTE                           " tabla="REGCTA         " campo="IDCOMP    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="20" etiqueta="Id comprobante relacionado                                                                                                                                      " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODECUENTA                        " atributo="BASEDEDATOSALTAFW                       " tabla="REGCTA         " campo="BDALTAFW  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Base de datos CC                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="11" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
